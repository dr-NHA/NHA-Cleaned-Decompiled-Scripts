...
if(!MISC::IS_BIT_SET(Global_113386.f_24986, 8)){
if(!func_245()){
...
MemCopy(&Var3,{
func_10(Global_44257[iVar7 /*12*/].f_1)
}
, 4);
}else{
Var3={
...
iVar2=iVar20;
Var3={
func_10(Global_44257[iVar20 /*12*/].f_1) 
};
...
Var3={
func_10(Global_44257[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(func_36()){
if(MISC::IS_BIT_SET(Global_113386.f_24986, func_71(Local_43.f_4))){
iLocal_218=func_201();
...
iVar0=(iVar0 - 1);
if(iVar0 >=0 && MISC::IS_BIT_SET(Global_113386.f_24986, func_71(iVar0))){
Local_43.f_5=1;
}else{
Local_43.f_5=0;
}
...
bVar0=false;
while (bVar0 <=(4 - 1)){
if(!MISC::IS_BIT_SET(Global_113386.f_24986, bVar0)){
return bVar0;
}
bVar0++;
}
...
int iVar0;
if(!MISC::IS_BIT_SET(Global_113386.f_24986, 9)){
if(func_17(Global_113386.f_24986.f_3)){
if(func_247()){
if(func_223(4, 62, 2, -1, 0)){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_208() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_208() /*5567*/].f_681.f_10, iParam0);
}
...
Var0={
func_246(PLAYER::GET_PLAYER_INDEX()) 
};
fVar3=Local_43.f_3;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
