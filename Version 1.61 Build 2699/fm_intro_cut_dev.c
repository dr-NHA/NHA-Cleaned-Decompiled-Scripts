...
Global_1931930=1;
}elseif(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1931927)){
if(!Global_1931929){
...
iParam0->f_295=1;
iParam0->f_294=1;
}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(func_216()) > 0){
iParam0->f_295=1;
}
...
}}elseif(AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_START") && (STREAMING::IS_NEW_LOAD_SCENE_LOADED() || func_134(&(iParam0->f_17), 5000, 0))){
...
func_109(iParam0);
}elseif(func_108(iParam0) && func_101(iParam0)){
func_99(iParam0);
}
func_132(iParam0, 15);
...
iParam0->f_6=22;
}elseif(func_130(iParam0, 19, -4968)){
if(!MISC::IS_BIT_SET(*iParam0, 12)){
HUD::CLEAR_HELP(true);
MISC::SET_BIT(iParam0, 12);
}}elseif(func_130(iParam0, 19, -5618)){
...
}}elseif(func_134(&(iParam0->f_17), 10000, 0)){
if(func_32(iParam0)){
func_124(iParam0);
func_70(iParam0);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
return 1;
}}elseif(iVar0 + iParam2) <=func_37(iParam0){
return 1;
}
return 0;
}
...
if(func_180(PLAYER::PLAYER_ID()) && MISC::IS_BIT_SET(Global_1946250.f_4, 22)){
return 0;
}
if(Global_1577870){
return 0;
...
}}elseif(func_130(iParam0, 33, -3390)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 33, -450)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 36, -4740)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 36, -600)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 37, -1350)){
...
func_220("prog", 0,16f);
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 38, -4320)){
func_219("prog", 0,16f);
iParam0->f_5++;
}
break;
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 38, -870)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 39, -1620)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 40, -1470)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 41, -1200)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 42, -1320)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 43, -1320)){
...
func_220("uides", 0f);
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 45, -1650)){
...
func_220("concre", 0f);
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 46, -1950)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 48, -1320)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 49, -5070)){
...
MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
}}elseif(func_130(iParam0, 49, -720)){
