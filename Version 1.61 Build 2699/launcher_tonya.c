...
func_286("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_175(uParam0->f_27)){
func_174(uParam0->f_27, *uParam0);
func_286("RC5_IN_ACTIVATION_RANGE:
...
if(func_175(1)){
func_174(1, *uParam0);
func_286("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_286("RC_STOP_PLAYER_VEHICLE_CHECK:
...
return (func_188(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
}}
return iParam0->f_1;
}
...
iParam0->f_1=(func_188(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
struct<27> Var0;
if(Global_78319){
func_286("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_220(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
float fVar6;
Var0={
func_237(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_237(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
