...
if(func_13()){
func_413();
}elseif(func_12(&uLocal_196, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true))){
...
iLocal_87[iParam0]=1;
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam1, 345,1542f, -1604,173f, 28,29278f, 360,8858f, -1617,23f, 31,29278f, 3,63f, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344,9844f, -1604,011f, 28,29278f, 339,7212f, -1599,484f, 31,29056f, 3,38f, false, true, 0)){
iLocal_665=1;
iLocal_87[iParam0]=1;
return 1;
}}
...
}elseif(func_78(Local_389[iParam0 /*22*/], -1098463898) || func_78(Local_389[iParam0 /*22*/], 993674639)){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_389[iParam0 /*22*/]);
}
...
iLocal_659=1;
}elseif(!func_124(iParam0, 15) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 362,6359f, -1581,256f, 31,54774f, 358,1074f, -1586,615f, 34,29774f, 2f, false, true, 0)){
func_129();
iLocal_656=0;
if(iParam0==2){
...
float fVar6;
Var0={
func_163(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_163(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
iLocal_382=0;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, false, true, 0)){
...
}}}elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, false, true, 0) || MISC::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12)){
func_191(iParam0, iVar0);
}
iVar0++;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3, Local_309[3 /*7*/].f_6, false, true, 0)){
func_193(iParam0, 3);
}else{
func_191(iParam0, 3);
}}
...
if(bLocal_374){
func_125();
}elseif(func_154(Local_389[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_389[iParam0 /*22*/], true), 100f)){
func_125();
...
iLocal_656=1;
}}}elseif((func_380(Local_389[2 /*22*/]) && func_12(&uLocal_144, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true))) && func_63(Local_389[2 /*22*/], Local_389[2 /*22*/].f_1, 3f, 1)){
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_276(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_276(iParam1))){
return 1;
}
return 0;
}
