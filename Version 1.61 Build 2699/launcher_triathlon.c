...
Local_87={
ENTITY::GET_ENTITY_COORDS(iLocal_85, true) 
};
...
func_114(108, 1, 0);
func_20(114, 1, 0, 1, 0);
}elseif(Global_113386.f_20011.f_8==2){
func_114(109, 1, 0);
func_20(115, 1, 0, 1, 0);
}
...
return (func_35(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
}}
return iParam0->f_1;
}
...
iParam0->f_1=(func_35(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
func_75(iLocal_105);
}elseif((PED::IS_PED_INJURED(iLocal_129) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(91, ENTITY::GET_ENTITY_COORDS(iLocal_129, true), 40f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(118, ENTITY::GET_ENTITY_COORDS(iLocal_129, true), 40f)){
func_81("TRI_DEATH", -1);
iVar0=iLocal_105;
func_75(iLocal_105);
iLocal_105=iVar0;
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_129, 150319005)==1){
