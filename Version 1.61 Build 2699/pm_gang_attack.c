...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam0, -653332088) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iParam0, -653332088) !=0){
TASK::TASK_SHOOT_AT_COORD(iParam0, Param1, -1, joaat("FIRING_PATTERN_BURST_FIRE"));
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam0, -982327190) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iParam0, -982327190) !=0){
...
}elseif(!PED::IS_PED_IN_VEHICLE(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], false)){
...
elseif(!func_38(uLocal_284[iVar0], -1794415470, 1)){
...
}}elseif(!func_38(uLocal_284[iVar0], 538064912, 1)){
...
}}elseif(!func_38(uLocal_284[iVar0], -1273030092, 1) || iLocal_276 !=iLocal_277){
...
}elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_284[iVar0], -1273030092)==1){
...
if(!func_38(uLocal_284[iVar0], 355471868, 1)){
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_284[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iVar0], false), 0);
}}elseif(!func_38(uLocal_284[iVar0], 2104565373, 1) || iLocal_276 !=iLocal_277){
TASK::TASK_DRIVE_BY(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, true, -753768974);
}
}}
break;
