...
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_338, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > 6f){
func_83();
}}else{
func_83();
}}}
...
Local_338={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_334, sLocal_335, Local_348, Local_351, 0f, 2) 
};
Var3={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_334, sLocal_335, Local_348, Local_351, 0f, 2) 
};
fLocal_341=Var3.f_2;
...
return MISC::IS_BIT_SET(Global_1648034.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
...
if((((((MISC::IS_BIT_SET(Global_1835485, iParam0) || Global_1835486 !=-1) || func_64()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_63()) || func_60(iParam0)){
return 0;
}
