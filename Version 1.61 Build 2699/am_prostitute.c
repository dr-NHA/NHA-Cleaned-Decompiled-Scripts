...
Var4={
ENTITY::GET_ENTITY_COORDS(func_12(iVar1), false) 
};
Var7={
ENTITY::GET_ENTITY_COORDS(iVar0, false) 
};
Var10={
...
if(iParam0 !=func_31()){
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_348, 29);
}
return 0;
}
...
if(iParam0 !=func_31()){
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_408.f_2, 16);
}
return 0;
}
