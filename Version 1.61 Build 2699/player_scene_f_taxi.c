...
if(!func_3(&uVar0)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_72, false) 
};
...
if(!PED::IS_PED_INJURED(Global_100162)){}else{
iLocal_69=3;
return 1;
}
if(!PED::IS_PED_INJURED(iLocal_72)){}else{
iLocal_69=3;
return 1;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_74, false)){}else{
iLocal_69=3;
return 1;
}
return 0;
...
return 0;
}}}elseif(iParam1==func_9(Global_100162) && iParam1 !=0){
Global_100162=0;
}}
return 1;
}
