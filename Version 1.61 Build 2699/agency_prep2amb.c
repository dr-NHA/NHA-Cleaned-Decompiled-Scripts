...
if(bParam1){
if(iParam0 !=46){
if((!func_2(func_3(iParam0)) && !Global_112026) && !MISC::IS_BIT_SET(uLocal_105, 15)){
MISC::SET_BIT(&uLocal_105, 15);
HUD::CLEAR_HELP(true);
}}elseif((HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_112026) && !MISC::IS_BIT_SET(uLocal_105, 15)){
MISC::SET_BIT(&uLocal_105, 15);
HUD::CLEAR_HELP(true);
}}}
...
if(Global_78319){
iVar3=145;
}elseif(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20247)==1){
if(func_11()){
if(func_10()){
iVar6=0;
...
iVar0=0;
while (iVar0 <=2){
Global_32338[iParam0 /*23*/][iVar0 /*3*/]={
Param1 
};
iVar0++;
}}
...
if(func_87(iLocal_109)){
Local_110={
ENTITY::GET_ENTITY_COORDS(iLocal_109, true) 
};
...
void func_177(){
if((MISC::IS_BIT_SET(uLocal_105, 0) && Global_43052==15) && !func_210()){
if(iLocal_38==0){
...
if((PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && !MISC::IS_BIT_SET(uLocal_105, 20)){
if(iLocal_1438 !=-1){
...
if(!bParam3 || MISC::IS_BIT_SET(Global_113386.f_7229.f_17[iVar0], 0)){
...
if(!bParam3 || MISC::IS_BIT_SET(Global_113386.f_7229.f_11[iVar0], 0)){
...
return 1;
}elseif(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 111,8564f, -751,7169f, 44,757f) <=160000f){
if(func_13()){
func_71(31);
}
return 1;
...
int func_210(){
if(Global_97363 !=-1){
return MISC::IS_BIT_SET(Global_91229[Global_97363 /*34*/].f_15, 13);
}
return 0;
}
...
int iVar0;
bool bVar1;
if(((((((Global_43052==15 && iLocal_37 !=3) && MISC::IS_BIT_SET(uLocal_105, 5)) && !func_210()) && Global_78316==-1) && !func_236()) && !func_86(9)) || func_105(35)){
func_235();
func_233();
switch (iLocal_39){
case 0:
...
break;
}}elseif(((((((Global_43052 !=15 || Global_43052 !=0) || Global_43052 !=2) || Global_43052 !=4) || Global_43052 !=17) || func_210()) || Global_78316==-1) || Global_112441){
bVar1=false;
if(func_134()){
bVar1=true;
}elseif(Global_112441){
...
if(MISC::IS_BIT_SET(Global_113386.f_7688.f_651[iVar0 /*14*/].f_2, bParam0)){
return 1;
}
iVar0++;
}
...
if(MISC::IS_BIT_SET(Global_113386.f_7688.f_765[iVar0 /*10*/].f_2, bParam0)){
return 1;
}
iVar0++;
}
...
if(Global_78579){
return 1;
}elseif(Global_63148 && !Global_63154){
return 1;
}
return 0;
}
...
if(MISC::IS_BIT_SET(Global_113386.f_9085.f_99.f_219[iVar0], bVar1)){
