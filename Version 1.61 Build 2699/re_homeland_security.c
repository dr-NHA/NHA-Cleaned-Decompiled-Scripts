...
elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_65, false)){
...
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_52[0], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[0], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, false, true, 0)){
}elseif(HUD::DOES_BLIP_EXIST(iLocal_121[0])){
HUD::REMOVE_BLIP(&(iLocal_121[0]));
}
...
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_52[1], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[1], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, false, true, 0)){
}elseif(HUD::DOES_BLIP_EXIST(iLocal_121[1])){
HUD::REMOVE_BLIP(&(iLocal_121[1]));
}
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_52[1], 1785177548) !=1){
TASK::OPEN_SEQUENCE_TASK(&iLocal_136);
TASK::TASK_CLEAR_LOOK_AT(0);
...
return 1;
}}elseif((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52[0], 0,5f, 0,5f, 5f, false, true, 1) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52[1], 0,5f, 0,5f, 5f, false, true, 1)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 0,5f, 0,5f, 5f, false, true, 1)){
return 1;
}}
return 0;
}
...
iLocal_50=2;
return 1;
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_65, PLAYER::PLAYER_PED_ID(), true)){
iLocal_50=2;
return 1;
}}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
...
iLocal_50=4;
return 1;
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), true)){
iLocal_50=4;
return 1;
}}
return 0;
