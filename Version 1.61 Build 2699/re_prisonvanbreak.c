...
Local_271={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_222, 1,2f, 1,5f) 
};
...
if(STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01"))){
Local_271={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_223, 1,2f, 1,5f) 
};
Local_271.f_2=(Local_271.f_2 + 0,3f);
...
func_6(5);
func_7();
}}}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 310,6203f, 2642,854f, 43,5173f, 200f, 200f, 180f, false, true, 0)){
func_5();
}}}
if(bLocal_284){
if(func_38()){
...
Local_271={
ENTITY::GET_ENTITY_COORDS(iLocal_222, true) 
};
}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_223, false)){
Local_271={
ENTITY::GET_ENTITY_COORDS(iLocal_223, true) 
};
}
