...
}elseif(!ENTITY::IS_ENTITY_DEAD(PED::GET_PEDS_JACKER(iParam0), false)){
...
struct<3> Var3;
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_96, true) 
};
Var3={
Local_90 
};
...
Local_90={
func_60(ENTITY::GET_ENTITY_COORDS(iLocal_96, true)) 
};
...
}elseif(!PED::IS_PED_IN_VEHICLE(iParam0, iLocal_99, false)){
...
if(!func_10(&iLocal_107)){
func_472(&iLocal_107);
}elseif(func_7(&iLocal_107) > MISC::GET_RANDOM_FLOAT_IN_RANGE(2f, 5f)){
...
}elseif(((PAD::IS_CONTROL_JUST_PRESSED(2, 188) || (PAD::_IS_USING_KEYBOARD(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 241))) || (PAD::_IS_USING_KEYBOARD(2) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 32))) || (((MISC::IS_PC_VERSION() && !PAD::_IS_USING_KEYBOARD(2)) && iVar7 < -100) && (MISC::GET_GAME_TIMER() - iLocal_89) > 300)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
func_492("UP pressed!");
if(iLocal_70 > 0){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_254() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_254() /*5567*/].f_681.f_10, iParam0);
}
...
int iVar0;
if(!STREAMING::HAS_ANIM_DICT_LOADED(func_50(PLAYER::PLAYER_PED_ID(), 0, 0))){}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_110(bParam1), 3) && TASK::GET_SCRIPT_TASK_STATUS(iParam0, -2017877118) !=1){
if(func_551()){
if(iParam0==PLAYER::PLAYER_PED_ID()){
if(!func_205(PLAYER::PLAYER_ID())){
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_99, true) 
};
...
return 1;
}}elseif(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Param0) > 56,25f){
return 1;
}}elseif(!PATHFIND::GET_VEHICLE_NODE_IS_SWITCHED_OFF(iVar0)){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Param0) > 400f){
return 1;
}}else{
...
return 1;
}elseif(PATHFIND::GET_CLOSEST_MAJOR_VEHICLE_NODE(Var0[1 /*3*/], uParam1, 3f, 0)){
return 1;
}elseif(PATHFIND::GET_CLOSEST_MAJOR_VEHICLE_NODE(Var0[2 /*3*/], uParam1, 3f, 0)){
return 1;
}elseif(PATHFIND::GET_CLOSEST_MAJOR_VEHICLE_NODE(Var0[3 /*3*/], uParam1, 3f, 0)){
return 1;
}
return 0;
}
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_99, false)){
iLocal_99=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
}elseif(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_96, iLocal_99, 0, false, false)){
if(!func_112()){
if(!func_491(iLocal_75, 1)){
func_40(&iLocal_119);
func_482(&iLocal_75, 1);
}elseif(func_7(&iLocal_119) > 20f){
func_126();
...
}elseif(Global_32114==SCRIPT::GET_ID_OF_THIS_THREAD()){
Global_32113=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_96, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
}else{
func_5(&iLocal_49, 32);
}}
...
func_96(12);
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_96, PLAYER::PLAYER_PED_ID(), true)){
iLocal_67++;
if(iLocal_67 >=2){
...
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_99)){
if(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32 <=0 && !MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_30, 11)){
