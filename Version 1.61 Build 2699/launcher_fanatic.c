...
return 0;
}}elseif(func_200(iParam0->f_28[0])){
if(func_176(iParam0)){
if(func_180(2)){
if(func_178(iParam0->f_27)){
func_177(iParam0->f_27, *iParam0);
...
uParam1->f_3=5;
}elseif((func_212(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
float fVar6;
Var0={
func_229(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_229(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__229(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_229(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
