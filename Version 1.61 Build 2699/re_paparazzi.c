...
ENTITY::GET_ENTITY_COORDS(Local_131[iVar0 /*18*/], true) 
};
}
iVar0++;
}
...
ENTITY::GET_ENTITY_COORDS(Local_204[iVar0 /*18*/], true) 
};
}
iVar0++;
}
...
Local_63={
ENTITY::GET_ENTITY_COORDS(iLocal_86, true) 
};
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_91) && !ENTITY::IS_ENTITY_DEAD(iLocal_91, false)){
Local_66={
ENTITY::GET_ENTITY_COORDS(iLocal_91, true) 
};
}
if(!func_230()){
...
elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 281,0074f, 192,4805f, 58,08817f, 228,8291f, 50,88667f, 111,6104f, 82,75f, false, true, 0)){
func_190(1);
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1273030092) !=1 && TASK::GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1817882002) !=1){
...
*uParam3=*uParam5;
*uParam2={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam2, *uParam3, Param7) 
};
*uParam4={
...
float fVar3;
Var0={
func_41(ENTITY::GET_ENTITY_COORDS(iParam4, true) - Param0) 
};
...
}elseif(PED::IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], false)){
HUD::REMOVE_BLIP(&(Local_204[iVar0 /*18*/].f_1));
}}elseif(!PED::IS_PED_INJURED(Local_204[iVar0 /*18*/]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], false)){
...
bVar0=true;
}}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, false)){
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_204[iVar0 /*18*/], -1146898486) !=1){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_120() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_120() /*5567*/].f_681.f_10, iParam0);
}
...
SYSTEM::SETTIMERA(0);
iLocal_369=100;
}}elseif(!PED::IS_PED_IN_VEHICLE(iLocal_86, iLocal_91, false)){
...
if(!HUD::DOES_BLIP_EXIST(iLocal_360)){
iLocal_360=func_189(iLocal_86, 0, 145);
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_360)){
HUD::REMOVE_BLIP(&iLocal_360);
}}}}
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_86, 713668775) !=1){
func_145(bParam3);
TASK::TASK_LOOK_AT_ENTITY(iLocal_86, PLAYER::PLAYER_PED_ID(), -1, 16, 2);
}}
