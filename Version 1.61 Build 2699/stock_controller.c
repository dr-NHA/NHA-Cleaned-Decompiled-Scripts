...
iVar0=0;
while (iVar0 < 8){
if(!MISC::IS_BIT_SET(Global_113386.f_20564.f_461[iVar0], 1)){
...
}elseif(Global_55453[iVar0 /*36*/].f_9 < Global_58608[iVar4 /*7*/].f_4){
...
}elseif(Global_55453[iVar1 /*36*/].f_32 < Global_113386.f_20564.f_189[iVar0]){
Global_113386.f_20564.f_189[iVar0]=Global_55453[iVar1 /*36*/].f_32;
}
iVar0++;
}}
...
if(MISC::IS_BIT_SET(Global_77137.f_555[0 /*21*/].f_9, 10) && Global_77137.f_555[0 /*21*/].f_4==ENTITY::GET_ENTITY_MODEL(iParam0)){
*uParam1=iVar0;
return 1;
}}}
iVar0++;
...
Global_63000[iVar0 /*34*/][iVar3 /*11*/].f_1={
uParam0->f_1 
};
Global_63000[iVar0 /*34*/][iVar3 /*11*/].f_5={
uParam0->f_5 
};
...
fVar2=1,1f;
}elseif(Global_55453[iVar0 /*36*/].f_9 < 10f){
fVar2=0,95f;
}elseif(Global_55453[iVar0 /*36*/].f_9 > 285f){
fVar3=0,97f;
}elseif(Global_55453[iVar0 /*36*/].f_9 > 270f){
fVar3=1,05f;
}
