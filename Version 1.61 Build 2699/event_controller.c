...
iVar3++;
}}elseif(ENTITY::IS_ENTITY_A_PED(iVar1)){
if(func_2(iVar5)){
...
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(bVar0){
}elseif(!NETWORK::NETWORK_IS_FRIEND(&Param23)){
func_47(iParam22);
return 0;
}
if(Global_20209){
...
iVar81=(iVar80 - 1);
while (iVar81 >=0){
Global_2655137[iVar80 /*99*/]={
Global_2655137[iVar81 /*99*/] 
};
iVar80=(iVar80 - 1);
iVar81=(iVar81 - 1);
}
...
Global_2655137[iVar82 /*99*/].f_57={
Var36 
};
Global_2655137[iVar82 /*99*/].f_73={
Var52 
};
...
iVar0=0;
if(func_25(uParam0)){
return MISC::IS_BIT_SET(Global_2657492.f_356[uParam0->f_9 /*75*/].f_10.f_63, 14);
}
if(func_24(uParam0->f_1)){
if(func_23(uParam0)){
return MISC::IS_BIT_SET(Global_2660249.f_1.f_63, 14);
}
return iVar0;
}
...
iVar0=0;
if(func_25(uParam0)){
return MISC::IS_BIT_SET(Global_2657492.f_356[uParam0->f_9 /*75*/].f_10.f_63, 17);
}
if(func_24(uParam0->f_1)){
if(func_23(uParam0)){
return MISC::IS_BIT_SET(Global_2660249.f_1.f_63, 17);
}
return iVar0;
}
iVar1=func_22(uParam0);
...
*iParam1=11;
}elseif(MISC::ARE_STRINGS_EQUAL(&cVar3, "TENNIS_")){
*iParam1=12;
}elseif(MISC::ARE_STRINGS_EQUAL(&cVar3, "PILOTS_")){
*iParam1=122;
}elseif(MISC::ARE_STRINGS_EQUAL(&cVar3, "SHOOTR_")){
*iParam1=13;
}elseif(MISC::ARE_STRINGS_EQUAL(&cVar3, "DARTS__")){
*iParam1=14;
}elseif(MISC::ARE_STRINGS_EQUAL(&cVar3, "ARMWRS_")){
*iParam1=15;
}else{
return 0;
}
...
Global_2655137[iVar1 /*99*/]={
Global_2655137[iVar2 /*99*/] 
};
iVar1++;
iVar2++;
}
...
MemCopy(&(Global_1931618.f_16[iParam0 /*44*/].f_6),{
Var1
}
, 6);
}else{
...
Global_1931618.f_16[iParam0 /*44*/].f_12={
Var1 
};
}else{
bVar0=false;
...
Global_1931618.f_16[iParam0 /*44*/].f_28={
Var1 
};
}else{
bVar0=false;
...
}elseif(func_131(Global_2821909.f_20)){
