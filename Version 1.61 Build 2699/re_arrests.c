...
Local_68={
ENTITY::GET_ENTITY_COORDS(iLocal_55, true) 
};
...
func_177();
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_54, -1794415470)==7){
TASK::CLEAR_PED_TASKS(iLocal_54);
...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_57, true) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Var0 
};
...
iLocal_247=6;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, 242628503)==7){
TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
TASK::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_54, false), 1000, 0, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_54, false), 2f, -1, 3f, false, 40000f);
TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
...
iLocal_247=4;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), 75f, 75f, 75f, false, true, 0)){
if(!func_89()){
TASK::CLEAR_PED_TASKS(iLocal_55);
TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_21() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_21() /*5567*/].f_681.f_10, iParam0);
}
...
PED::SET_PED_KEEP_TASK(iLocal_55, true);
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, false) && !PED::IS_PED_RAGDOLL(iLocal_55)){
TASK::CLEAR_PED_TASKS(iLocal_55);
TASK::TASK_COWER(iLocal_55, -1);
PED::SET_PED_KEEP_TASK(iLocal_55, true);
}
...
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 40f, 40f, 40f, false, true, 0)){
func_58();
SYSTEM::WAIT(0);
...
if(PED::IS_PED_INJURED(iLocal_55)){
return 1;
}elseif(!MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_55, 31086, 0f, 0f, 0f), 2f, true)){
return 1;
}}
...
func_74(&uLocal_78, "REARRAU", "REARR_PRAND", 4, iLocal_254, 0, 0);
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 10f, 10f, 10f, false, true, 0)){
func_74(&uLocal_78, "REARRAU", sLocal_268, 4, iLocal_254, 0, 0);
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 10f, 10f, 10f, false, true, 0)){
func_74(&uLocal_78, "REARRAU", sLocal_268, 4, iLocal_254, 0, 0);
}else{
func_74(&uLocal_78, "REARRAU", sLocal_272, 4, iLocal_254, 0, 0);
}
