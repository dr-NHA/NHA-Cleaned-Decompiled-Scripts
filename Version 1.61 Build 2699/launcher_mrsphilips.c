...
func_262("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_175(uParam0->f_27)){
func_174(uParam0->f_27, *uParam0);
func_262("RC5_IN_ACTIVATION_RANGE:
...
if(func_175(1)){
func_174(1, *uParam0);
func_262("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_262("RC_STOP_PLAYER_VEHICLE_CHECK:
...
struct<27> Var0;
if(Global_78319){
func_262("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_198(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
Vector3 func__211(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_215(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_215(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__215(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_215(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
iParam0->f_16=5;
iParam0->f_17[0 /*3*/]={
1973,324f, 3815,594f, 31,42936f 
};
iParam0->f_17[1 /*3*/]={
1974,936f, 3812,747f, 34,438f 
};
iParam0->f_24=6,5f;
iParam0->f_27=0;
