...
Local_143.f_1=0,5f;
Local_143.f_0=0;
}}elseif(Global_1853348[iLocal_111 /*834*/].f_267.f_362 !=iLocal_124){
...
func_21();
func_6();
}elseif(iLocal_115 !=-1 && iLocal_115 <=128){
Local_134={
func_1() 
};
...
Local_137={
ENTITY::GET_ENTITY_COORDS(iLocal_110, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_110) * Vector(0,6f, 0,6f, 0,6f) 
};
Local_137.f_2=(Local_137.f_2 + 0,5f);
Local_140={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_110, 0f, -0,12f, -0,0315f) 
};
}}else{
func_211(0);
}
...
}elseif(func_18(&uLocal_132, 180000, 0)){
func_8(iLocal_112);
...
if(MISC::IS_BIT_SET(uLocal_120, 6) !=bVar0){
func_176(bVar0);
...
}elseif((iLocal_117 !=-1 && func_158(iLocal_117, 1)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())){
func_157(2);
func_155(&iLocal_117);
...
func_141(&uLocal_130);
}elseif(Local_143.f_2 !=-1 || !func_142()){
func_157(0);
MISC::CLEAR_BIT(&(Local_148[PLAYER::PLAYER_ID() /*3*/]), 0);
...
break;
case 3:
if(MISC::IS_BIT_SET(uLocal_120, 4)){
if(func_135()){
...
break;
case 4:
if(MISC::IS_BIT_SET(uLocal_120, 3)){
...
func_30(MISC::IS_BIT_SET(uLocal_120, 5));
if(iLocal_113 !=-1){
if((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_125, "INSERT_COINS", 3) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >=0,82f) || !MISC::IS_BIT_SET(uLocal_120, 5)){
func_29(iLocal_113);
}}}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar0) >=0,96f){
...
if(MISC::IS_BIT_SET(uLocal_120, 1)){
func_90();
...
var func__66(int iParam0, bool bParam1){
char* sVar0[2];
var uVar3;
struct<13> Var19;
...
var func__80(int iParam0, int iParam1){
switch (iParam0){
case 5:
if(iParam1 > -1){
...
if(!MISC::IS_BIT_SET(uLocal_120, 0)){
if(PAD::_IS_USING_KEYBOARD_2(2)){
...
}}elseif(func_18(&uLocal_128, iVar1, 0)){
func_141(&uLocal_128);
...
func_31(0);
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_110, 0,06f, -0,8958f, 0,2f) 
};
if(!func_20(&uLocal_130)){
func_19(&uLocal_130, 0, 0);
}elseif(func_18(&uLocal_130, 2000, 0)){
iLocal_118=1;
}
...
}elseif(bVar14 || (!func_56(PLAYER::PLAYER_ID(), 0) && !func_153())){
...
void func_172(){
if(func_167()){
if(MISC::IS_BIT_SET(Local_148[Local_143.f_2 /*3*/], 2)){
...
Local_143.f_4=1;
}}}elseif(Local_143.f_3 !=Local_148[Local_143.f_2 /*3*/].f_1){
...
if(MISC::IS_BIT_SET(Local_148[Local_143.f_2 /*3*/], 3)){
if(Local_143.f_1 !=Local_148[Local_143.f_2 /*3*/].f_2){
Local_143.f_1=Local_148[Local_143.f_2 /*3*/].f_2;
}}
if(!MISC::IS_BIT_SET(Local_148[Local_143.f_2 /*3*/], 1) && !MISC::IS_BIT_SET(Local_148[Local_143.f_2 /*3*/], 0)){
Local_143.f_2=-1;
}}elseif(MISC::IS_BIT_SET(Local_148[iLocal_116 /*3*/], 0)){
if(!func_167()){
...
Local_143.f_4=0;
}}elseif(Global_1853348[iLocal_111 /*834*/].f_267.f_362==Local_143.f_3 && (!func_174() && Global_1853348[iLocal_111 /*834*/].f_267.f_362==iLocal_124)){
Local_143.f_4=0;
}}
iLocal_116++;
if(iLocal_116==32){
...
if(iParam0==PLAYER::PLAYER_ID()){
return MISC::IS_BIT_SET(func_16(8726, -1, 0), 4);
}
if(iParam0 !=-1){
...
if(iParam0 !=func_185()){
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_408.f_1, 2);
}
return 0;
}
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_192(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
...
*uParam1={
Global_1853348[iParam0 /*834*/].f_267.f_69 
};
}
...
void func_195(){
int iVar0;
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !MISC::IS_BIT_SET(uLocal_120, 2)){
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_192(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
func_211(0);
}elseif(MISC::IS_BIT_SET(Global_2787701, 1)){
MISC::CLEAR_BIT(&Global_2787701, 1);
func_211(0);
}elseif(MISC::IS_BIT_SET(Global_1946250.f_6, 10)){
if(iLocal_127 !=0){
if(MISC::IS_BIT_SET(uLocal_120, 3)){
MISC::CLEAR_BIT(&uLocal_120, 3);
func_39(1, -1);
...
iLocal_126=0;
func_157(0);
}}elseif(!func_210(PLAYER::PLAYER_ID())){
func_211(0);
...
iLocal_126=0;
func_157(0);
}}elseif(iLocal_115 !=Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32){
func_211(0);
}}
