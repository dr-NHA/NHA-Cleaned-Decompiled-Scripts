...
func_292("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_179(iParam0->f_27)){
func_178(iParam0->f_27, *iParam0);
func_292("RC5_IN_ACTIVATION_RANGE:
...
if(func_179(1)){
func_178(1, *iParam0);
func_292("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_292("RC_STOP_PLAYER_VEHICLE_CHECK:
...
*uParam10=3;
return 1;
}}}elseif(((func_196(sParam5) && !*uParam10==1) && func_129(PLAYER::PLAYER_PED_ID())) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) >=20f){
...
struct<27> Var0;
if(Global_78319){
func_292("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_215(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
float fVar6;
Var0={
func_230(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_230(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
