...
case 0:
Var8={
ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], true) 
};
Var11={
...
iLocal_486[iVar0]=MISC::GET_GAME_TIMER();
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_290[iVar0])){
...
if(MISC::IS_BIT_SET(Global_32338[iVar0 /*23*/].f_11, 19)){
iVar5=3;
iVar4=0;
while (iVar4 < iVar5){
Var6={
...
float fVar6;
Var0={
func_40(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return 0;
}}}elseif(iParam1==func_49(Global_100162) && iParam1 !=0){
Global_100162=0;
}}
return 1;
}
