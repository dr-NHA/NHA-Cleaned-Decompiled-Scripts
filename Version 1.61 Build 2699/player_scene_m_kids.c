...
return 0;
}}}elseif(iParam1==func_39(Global_100162) && iParam1 !=0){
Global_100162=0;
}}
return 1;
}
...
iLocal_243[iVar0]=0;
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_253[iVar0], false)){
...
iVar0=12;
iVar1=32;
if(MISC::IS_BIT_SET(Global_113386.f_2363.f_539.f_3816[0 /*166*/][iVar0 /*11*/][(iVar1 / 32)], (iVar1 % 32))){
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_50(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_50(iParam1))){
return 1;
}
return 0;
}
