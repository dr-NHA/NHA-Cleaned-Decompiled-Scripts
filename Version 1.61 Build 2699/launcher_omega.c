...
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
...
uParam1->f_3=5;
}elseif((func_208(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
float fVar6;
Var0={
func_225(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_225(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__225(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_225(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
