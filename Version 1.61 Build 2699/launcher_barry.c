...
func_313("ARE_RC_TRIGGER_CONDITIONS_MET:
RC_TRIG_CHAR - Used special case Eps 4 trigger.");
return 1;
}}
}}else{
return 0;
}}elseif(func_207(iParam0->f_28[0])){
if(func_176(iParam0)){
if(func_180(2)){
if(func_178(iParam0->f_27)){
func_177(iParam0->f_27, *iParam0);
...
if(func_178(iParam0->f_27)){
func_177(iParam0->f_27, *iParam0);
func_313("RC5_IN_ACTIVATION_RANGE:
...
if(func_178(1)){
func_177(1, *iParam0);
func_313("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_313("RC_STOP_PLAYER_VEHICLE_CHECK:
...
iLocal_271=MISC::GET_GAME_TIMER();
*uParam0=0;
}elseif(func_203(PLAYER::PLAYER_PED_ID(), Param1, 1) >=25f){
func_145();
*uParam0=0;
}
break;
...
var func__196(int iParam0, int iParam1){
...
struct<27> Var0;
if(Global_78319){
func_313("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_219(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
Vector3 func__232(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_236(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_236(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__236(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_236(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
bVar8=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0])){
if(func_273(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER:
BARRY 3", 1)){
...
bVar11=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0])){
if(func_273(&(uParam0->f_28[0]), 49, Var6, fVar9, "RC LAUNCHER:
BARRY 2", 1)){
PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false);
}else{
bVar11=false;
...
bVar13=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0])){
if(func_273(&(uParam0->f_28[0]), 49, Var8, fVar11, "RC LAUNCHER:
BARRY 1", 1)){
PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false);
}else{
bVar13=false;
