...
iLocal_43=5;
}}elseif(MISC::CREATE_INCIDENT(7, Local_45, 2, 3f, &iLocal_49, 0, 0)){
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}
break;
...
elseif(MISC::CREATE_INCIDENT_WITH_ENTITY(5, PLAYER::PLAYER_PED_ID(), 2, 3f, &iLocal_49, 0, 0)){
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}}elseif(MISC::CREATE_INCIDENT(5, Local_45, 2, 3f, &iLocal_49, 0, 0)){
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}
break;
...
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}}elseif(MISC::CREATE_INCIDENT(3, Local_45, 4, 3f, &iLocal_49, 0, 0)){
...
if(fVar13 < 0f){
fVar17=0f;
}elseif(PATHFIND::GET_VEHICLE_NODE_IS_SWITCHED_OFF(PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_ID(*uParam1, 1, 1, 3f, 0f))){
fVar17=0f;
}else{
...
*uParam1={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam1, *uParam2, fVar17, 0f, 0f) 
};
