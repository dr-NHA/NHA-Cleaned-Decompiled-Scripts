...
bool func_8(){
return MISC::IS_BIT_SET(Global_2715699.f_1.f_2810, 3);
}
...
struct<53> Var3;
int iVar61;
if(!MISC::IS_BIT_SET(Global_1946250.f_3, 27)){
...
if(MISC::IS_BIT_SET(Global_1946250, 15)){
MISC::CLEAR_BIT(&Global_1946250, 15);
}
if(MISC::IS_BIT_SET(Global_1946250.f_2, 6)){
...
if(iVar0==0){
if(iParam0==1){
if(!MISC::IS_BIT_SET(Global_100441.f_20, 2)){
MISC::SET_GAME_PAUSED(true);
MISC::SET_BIT(&(Global_100441.f_20), 2);
}}elseif(MISC::IS_BIT_SET(Global_100441.f_20, 2)){
MISC::SET_GAME_PAUSED(false);
...
}elseif(bVar14 || (!func_100(PLAYER::PLAYER_ID(), 0) && !func_99())){
...
}}elseif(PED::IS_PED_MALE(Local_43.f_1)){
iVar4="FACIALS@GEN_MALE@BASE";
}else{
iVar4="FACIALS@GEN_FEMALE@BASE";
}
...
Var0={
ENTITY::GET_ENTITY_COORDS(Local_43.f_1, true) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(Local_43.f_4, true) 
};
...
if((Global_44024[iLocal_64 /*5*/].f_3 >=10 || Global_44024[iLocal_64 /*5*/].f_4 >=15) || MISC::IS_BIT_SET(Global_44241, 9)){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_43.f_1, 1785177548)==1 && !MISC::IS_BIT_SET(Global_1946250.f_3, 27)){
return;
}
...
iVar0=iVar1;
}elseif(!PLAYER::PLAYER_PED_ID()==Local_43.f_1){
return;
...
if(Local_55.f_0==-1){
Global_44024[iLocal_64 /*5*/].f_2=0;
}elseif(Global_44024[iLocal_64 /*5*/].f_3 < 3 && Global_44024[iLocal_64 /*5*/].f_3 !=0){
Global_44024[iLocal_64 /*5*/].f_2=-1;
}else{
iVar0=(Local_55.f_0 - SYSTEM::TIMERA());
if(iVar0 <=0){
...
func_157(iVar1);
func_156(iVar1);
}elseif(Global_44105[iVar1 /*6*/].f_1==2){
if(!iLocal_49==-1){
...
if(Local_55.f_0==-1){
Global_44024[iLocal_64 /*5*/].f_2=0;
}elseif(Global_44024[iLocal_64 /*5*/].f_4 < 9 && Global_44024[iLocal_64 /*5*/].f_4 !=0){
Global_44024[iLocal_64 /*5*/].f_2=-1;
}else{
iVar0=(Local_55.f_0 - SYSTEM::TIMERA());
if(iVar0 <=0){
...
iVar0=iVar1;
}elseif(!CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4 || !PLAYER::PLAYER_PED_ID()==Local_43.f_1){
return;
}
fLocal_53=0f;
func_142(iVar0, 0f);
