...
MemCopy(&(Global_95233[Global_95442 /*4*/]),{
func_24(iVar1)
}
, 4);
Global_95442++;
...
bVar0=false;
while (bVar0 < 63){
if((MISC::IS_BIT_SET(Global_113386.f_18574[bVar0 /*6*/], 0) && MISC::IS_BIT_SET(Global_113386.f_18574[bVar0 /*6*/], 1)) && !MISC::IS_BIT_SET(Global_113386.f_18574[bVar0 /*6*/], 3)){
if(Global_95442 < 52){
MemCopy(&(Global_95233[Global_95442 /*4*/]),{
func_22(bVar0)
}
...
bVar0=false;
while (bVar0 < 20){
if(MISC::IS_BIT_SET(Global_113386.f_9085.f_99.f_219[0], bVar0)){
if(Global_95442 < 52){
