...
func_7(iParam4);
}}}elseif(ENTITY::IS_ENTITY_AT_COORD(iParam0, Param1, fParam12, fParam12, 2f, false, true, 2)){
if(*iParam9==-1){
...
Var0={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_109, iVar3) 
};
Var0={
...
iParam0->f_6=12;
iParam0->f_1=MISC::GET_GAME_TIMER();
}elseif(!func_184(*iParam0, 474215631)){
if(func_184(*iParam0, 780511057)){
TASK::CLEAR_PED_TASKS(*iParam0);
}
...
func_163(iParam0);
iParam0->f_1=MISC::GET_GAME_TIMER();
}elseif(func_177(Local_111[func_171(iParam0->f_10) /*11*/], *iParam0, 1126825984, 1, 250, 7)){
func_176(iParam0, 0);
}else{
func_162(iParam0);
iParam0->f_1=MISC::GET_GAME_TIMER();
...
float fVar6;
Var0={
func_160(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
if(iParam0->f_9==1){
func_164(iParam0);
}elseif(iParam0->f_10==0){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(1)), 1f, -1, 0,25f, false, 40000f);
iParam0->f_7=1;
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(0)), 1f, -1, 0,25f, false, 40000f);
iParam0->f_7=1;
}}elseif(!PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_109, false)){
if(iParam0->f_10==0){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(1)), 1f, -1, 0,25f, false, 40000f);
iParam0->f_7=1;
}else{
...
float fVar6;
Var0={
func_160(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
uParam0->f_7=3;
}}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_109, true)){
func_176(uParam0, 0);
return;
}
break;
...
func_190(uParam0);
return;
}}elseif(!func_184(*uParam0, 713668775)){
if(func_37(iLocal_109)){
...
func_197(uParam0);
}elseif(!func_184(*uParam0, 1227113341) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, true) + Vector(2f, 0f, 0f), 9f, false, true, 0)){
...
Local_667={
ENTITY::GET_ENTITY_COORDS(Local_111[func_171(iParam1) /*11*/], true) 
};
iParam0->f_1=MISC::GET_GAME_TIMER();
iParam0->f_8=iParam0->f_7;
iParam0->f_5=1;
...
iParam0->f_5=1;
}elseif(PED::IS_PED_BEING_JACKED(*iParam0)){
func_169(iParam0);
TASK::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, false, true);
iParam0->f_6=2;
iParam0->f_5=1;
...
return 1;
}}}elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Param1, fParam11, fParam11, 2f, true, true, 2)){
return 1;
}
if(func_106(func_114(func_77()), 0, 0)){
HUD::CLEAR_THIS_PRINT(func_114(func_77()));
...
}}}}elseif(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, true)){
if(func_231(iVar2)){
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
