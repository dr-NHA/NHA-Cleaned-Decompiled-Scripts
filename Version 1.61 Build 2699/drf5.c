...
HUD::CLEAR_HELP(true);
bVar2=true;
}elseif(func_135(&iLocal_251) >=14f){
Local_61.f_20=2;
bVar2=true;
HUD::CLEAR_HELP(true);
}elseif(!bVar3 && func_135(&iLocal_251) >=7f){
StringCopy(&cVar18, "DRF_PROMPT", 16);
func_96(&uLocal_83, &cVar14, &cVar18, 9, 0, 0, 0);
bVar3=true;
}}elseif((func_135(&iLocal_251) > 5f && func_134()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_61.f_20 !=1 || func_135(&iLocal_251) > fVar22) || func_93(iLocal_82, iLocal_399, &iLocal_404)))){
func_90();
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &Local_407, 0, 0, 0);
}
...
if(!func_75(&iVar9)){
func_243(&iVar9);
}elseif(func_135(&iVar9) > func_74(func_252())){
if(func_252()==4){
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
}}elseif(CAM::DOES_CAM_EXIST(iLocal_405)){
...
HUD::SET_BLIP_COLOUR(iLocal_403, 1);
func_119(&iLocal_257);
}}elseif(HUD::GET_BLIP_COLOUR(iLocal_403) !=3){
HUD::SET_BLIP_COLOUR(iLocal_403, 3);
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_8() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_8() /*5567*/].f_681.f_10, iParam0);
}
...
iLocal_429=1;
func_119(&iLocal_269);
}}elseif(func_135(&iLocal_269) > 12f){
...
iLocal_431=1;
func_119(&iLocal_272);
}}elseif(func_135(&iLocal_272) > 10,3f){
...
bVar2=MISC::IS_BIT_SET(iParam0->f_2[iVar6 /*15*/].f_13, bVar7);
if(!MISC::IS_BIT_SET(iParam0->f_2[iVar6 /*15*/].f_12, bVar7)){
...
iVar2[iParam0]=0;
}elseif((iParam1 > 0 && iParam1 < 13) && !func_115(&(Global_113386.f_19961), iParam1)){
iVar2[iParam1]=0;
}elseif((iParam2 > 0 && iParam2 < 13) && !func_115(&(Global_113386.f_19961), iParam2)){
iVar2[iParam2]=0;
}elseif((iParam3 > 0 && iParam3 < 13) && !func_115(&(Global_113386.f_19961), iParam3)){
iVar2[iParam3]=0;
}elseif((iParam4 > 0 && iParam4 < 13) && !func_115(&(Global_113386.f_19961), iParam4)){
iVar2[iParam4]=0;
}
