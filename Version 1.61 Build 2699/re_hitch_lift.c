...
iLocal_159=2;
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_85, false)){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_81() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_81() /*5567*/].f_681.f_10, iParam0);
}
...
if(HUD::DOES_BLIP_EXIST(iLocal_121)){
HUD::REMOVE_BLIP(&iLocal_121);
}}}elseif(!HUD::DOES_BLIP_EXIST(iLocal_121)){
iLocal_121=func_69(iLocal_85, 0, 145);
}
...
if(!HUD::DOES_BLIP_EXIST(iLocal_83)){
iLocal_83=func_131(Local_93, 1);
}}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_93, 50f, 50f, 50f, false, true, 0)){
if(HUD::DOES_BLIP_EXIST(iLocal_83)){
HUD::REMOVE_BLIP(&iLocal_83);
}}}}
...
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_190, fLocal_189, Param7) 
};
if(!func_146(Var0)){
