...
Local_83.f_7=1;
}elseif(func_9(&(Local_83.f_8), 480000, 0)){
Var0.f_2=1584592718;
...
if(!MISC::IS_BIT_SET(Local_83.f_1, 0)){
if(MISC::IS_BIT_SET(Local_103[iLocal_238 /*4*/].f_1, 0)){
iLocal_239=1;
...
var uVar1;
var uVar5;
if(!MISC::IS_BIT_SET(uLocal_232, 1)){
if((MISC::IS_BIT_SET(Local_103[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) >=(Local_83.f_16 - 1)) && Local_103[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 < 10){
...
if(MISC::IS_BIT_SET(uLocal_232, 4)){
if(!MISC::IS_BIT_SET(uLocal_232, 5)){
func_15(66, 1, -1);
}}}
...
if(((func_73(PLAYER::PLAYER_ID()) || (func_72() && func_71())) && !MISC::IS_BIT_SET(Global_2815059.f_4660, 31)) && !bParam4){
iVar1=func_70();
...
if(bParam1){
if(iParam2 > -1){
if(func_44(iVar0, iParam2, 0) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)){
if(iVar0==iParam2){
return func_43(1);
}else{
return func_43(0);
...
if((func_52(iParam1, iParam0, iVar0, 0) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)) || ((func_44(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(iParam0), 0) && MISC::IS_BIT_SET(Global_4718592.f_15, 23)) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18))){
return func_43(1);
...
if(MISC::IS_BIT_SET(Global_4718592.f_15, 26) && !func_44(iParam0, PLAYER::GET_PLAYER_TEAM(iParam1), 0)){
iVar0=func_51(1);
}}else{
iVar0=1;
}
...
Global_1641031.f_59[iParam0 /*16*/].f_3={
Var0 
};
}
...
return MISC::IS_BIT_SET(Global_1641031.f_59[iParam0 /*16*/], 0);
}
...
}}elseif(!func_281(PLAYER::PLAYER_ID(), 1, 1)){
MISC::SET_BIT(&uLocal_232, 5);
}}}
...
Vector3 func__148(int iParam0, bool bParam1){
struct<3> Var0;
struct<3> Var3;
float fVar6;
struct<3> Var7;
...
var func__154(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7){
var uVar0;
...
return;
}elseif(iParam0==Global_1659759[func_18(-1)]){
return;
}}}
...
}}elseif(func_192() || func_188(PLAYER::PLAYER_ID())){
...
}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_83.f_2, Local_83.f_6, Local_83.f_6, 950f, false, true, 0)){
if(!MISC::IS_BIT_SET(uLocal_232, 0) && MISC::IS_BIT_SET(uLocal_232, 3)){
...
if(!MISC::IS_BIT_SET(uLocal_232, 3)){
MISC::SET_BIT(&uLocal_232, 3);
}
if(MISC::IS_BIT_SET(uLocal_232, 0)){
...
void func_204(){
if(MISC::IS_BIT_SET(uLocal_232, 2)){
func_205(1, 1, 0);
...
if(MISC::IS_BIT_SET(Global_2689235[Global_2703735.f_1571.f_703.f_16 /*453*/].f_416, 0) && func_213()){
iParam0=23;
}}
...
void func_251(){
if(!MISC::IS_BIT_SET(uLocal_232, 6)){
