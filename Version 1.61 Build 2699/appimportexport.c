...
case 0:
func_361();
if(!MISC::IS_BIT_SET(uLocal_552, 3)){
func_358();
func_335();
}
if(!MISC::IS_BIT_SET(uLocal_552, 1)){
func_327();
}
if(!iLocal_548){
func_322();
...
}elseif(func_257(&uLocal_754, 301000, 0)){
Global_1946220=0;
func_411(0, 1);
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_2(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(func_20(iVar17)){
Var21={
Global_1946250.f_533[func_72(func_21(iVar17)) /*3*/] 
};
Var21.f_2=0f;
}else{
return -1;
...
if(bParam1){
if(iParam0 !=func_3()){
if(!MISC::IS_BIT_SET(Global_2689235[iParam0 /*453*/].f_197, 19)){
...
return MISC::IS_BIT_SET(Global_2689235[iParam0 /*453*/].f_197, 19);
}
...
return MISC::IS_BIT_SET(Global_2689235[iParam0 /*453*/].f_197, 18);
}
...
func_317("AH_VEH_SEL_T", "AHA_ARCADE_BLCK", "OR_OVRLY_OK", "", -1, -1);
}elseif((iLocal_554[0]==0 && iLocal_551==0) || (iLocal_559[0]==0 && iLocal_551==1)){
...
if(bParam0){
if(!MISC::IS_BIT_SET(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_198, 6)){
MISC::SET_BIT(&(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_198), 6);
}}elseif(MISC::IS_BIT_SET(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_198, 6)){
...
if(bParam0){
if(!MISC::IS_BIT_SET(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_197, 18)){
MISC::SET_BIT(&(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_197), 18);
}}elseif(MISC::IS_BIT_SET(Global_2689235[PLAYER::PLAYER_ID() /*453*/].f_197, 18)){
...
if(iVar0==3){
iLocal_554[iVar0]=0;
}elseif(iLocal_554[iVar0]==iParam0){
...
return 0;
}}elseif(func_259(&(Global_2789228.f_146)) && !func_257(&(Global_2789228.f_146), Global_262145.f_19359, 1)){
return 0;
}
return 1;
}
...
func_308(1, 1);
iLocal_570=2000;
}elseif(func_76(0) > 0 && iLocal_551==0){
func_285();
}else{
func_411(0, 1);
}}
...
void func_327(){
char* sVar0;
if(!MISC::IS_BIT_SET(uLocal_552, 0) && !MISC::IS_BIT_SET(uLocal_552, 2)){
if(func_332(16)){
sVar0="IE_SEC_TUT7";
iLocal_585=9000;
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && !MISC::IS_BIT_SET(uLocal_552, 0)){
func_328(sVar0, iLocal_585);
MISC::SET_BIT(&uLocal_552, false);
}elseif(MISC::IS_BIT_SET(uLocal_552, 0)){
if(!func_259(&uLocal_756)){
func_258(&uLocal_756, 0, 0);
}elseif(func_257(&uLocal_756, iLocal_585, 0)){
...
switch (iParam0){
case 16:
if((!func_334(iLocal_583, uLocal_584, 18) && !MISC::IS_BIT_SET(Global_1946101, bVar0)) && !MISC::IS_BIT_SET(uLocal_552, 4)){
return 1;
}
break;
case 17:
if(((!func_334(iLocal_583, uLocal_584, 21) && !MISC::IS_BIT_SET(Global_1946101, bVar0)) && !MISC::IS_BIT_SET(uLocal_552, 5)) && iLocal_551==2){
return 1;
}
break;
case 18:
if(((!func_334(iLocal_583, uLocal_584, 24) && !MISC::IS_BIT_SET(Global_1946101, bVar0)) && !MISC::IS_BIT_SET(uLocal_552, 5)) && iLocal_551==2){
return 1;
}
break;
case 19:
if(((!func_334(iLocal_583, uLocal_584, 27) && !MISC::IS_BIT_SET(Global_1946101, bVar0)) && !MISC::IS_BIT_SET(uLocal_552, 6)) && iLocal_551==1){
return 1;
}
break;
case 20:
if((((!func_334(iLocal_583, uLocal_584, 30) && !MISC::IS_BIT_SET(Global_1946101, bVar0)) && !MISC::IS_BIT_SET(uLocal_552, 6)) && iLocal_551==1) && func_333()){
return 1;
}
break;
case 21:
if((!func_334(iLocal_583, uLocal_584, 33) && !MISC::IS_BIT_SET(Global_1946101, bVar0)) && !func_320(8)){
return 1;
}
break;
case 22:
if(((!func_334(iLocal_583, uLocal_584, 36) && !MISC::IS_BIT_SET(Global_1946101, bVar0)) && !MISC::IS_BIT_SET(uLocal_552, 5)) && iLocal_551==2){
return 1;
}
break;
}
...
void func_358(){
bool bVar0;
if(!MISC::IS_BIT_SET(uLocal_552, 2) && !func_299()){
if(!func_360(3814, -1)){
bVar0=true;
iLocal_585=6750;
iLocal_586=0;
...
}elseif(iLocal_551==2 && !func_360(3815, -1)){
bVar0=true;
iLocal_585=8000;
iLocal_586=1;
func_359(3815, 1, -1);
MISC::SET_BIT(&uLocal_552, 5);
}elseif(iLocal_551==1 && !func_360(3816, -1)){
bVar0=true;
iLocal_585=6000;
iLocal_586=2;
func_359(3816, 1, -1);
...
}elseif(MISC::IS_BIT_SET(uLocal_552, 2)){
if(!func_259(&uLocal_756)){
func_258(&uLocal_756, 0, 0);
}elseif(func_257(&uLocal_756, iLocal_585, 0)){
...
iVar3=2;
}elseif(iVar0 >=Global_262145.f_19458){
iVar3=1;
}
