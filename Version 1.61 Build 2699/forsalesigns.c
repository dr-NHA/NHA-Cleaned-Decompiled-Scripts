...
}}elseif(!MISC::IS_BIT_SET(Global_113386.f_10049.f_108, bVar0)){
...
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_108, func_3(func_4(iParam0), iVar0))){
return 0;
}
iVar0++;
}}
...
if(MISC::IS_BIT_SET(Global_113386.f_10049.f_108, func_3(func_4(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
...
struct<3> Var0;
Var0={
ENTITY::GET_ENTITY_ROTATION(iParam0, 0) 
};
