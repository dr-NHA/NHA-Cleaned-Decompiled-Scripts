...
iVar0=0;
}elseif(((!PED::IS_PED_INJURED(iVar2) && ((bParam5 || iParam4==4) || iParam4==1)) && !func_104(uParam0[iParam2 /*94*/], 8192)) && TASK::GET_SCRIPT_TASK_STATUS(iVar2, 242628503)==7){
if(iParam2==iParam3){
...
}}elseif(func_104(uParam0, 2048) && TASK::GET_SCRIPT_TASK_STATUS(func_265(uParam0), 713668775) !=1){
...
Var13={
MISC::GET_CLOSEST_POINT_ON_LINE(Var10, uParam1->f_189.f_32[0 /*3*/], uParam1->f_189.f_32[1 /*3*/], false) 
};
...
Var15={
MISC::GET_CLOSEST_POINT_ON_LINE(uParam0->f_37, uParam1->f_3[iVar9 /*3*/], uParam1->f_3[iVar10 /*3*/], true) 
};
...
iVar55++;
Var44={
MISC::GET_CLOSEST_POINT_ON_LINE(Var41, *(uParam4[(iVar3 - iVar55) /*3*/]), *(uParam4[((iVar3 - iVar55) - 1) /*3*/]), true) 
};
Var50={
Var41 - Var44 
};
...
Var6={
func_122(Var9, Var6, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f)) 
};
...
}elseif((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_70(&(uParam0->f_4)), Var6, false, true, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_265(uParam0), 2106541073)==7) && !func_228(&(uParam0->f_4), 256)){
func_235(&(uParam0->f_4), 0);
func_217(&(uParam0->f_4), 4);
...
*iParam1=SYSTEM::ROUND((Var0.f_0 * 128f));
*iParam2=SYSTEM::ROUND((Var0.f_1 * 128f));
}elseif(SYSTEM::VDIST2(uParam0->f_37, Var3) <=(0f * 0f) || TASK::GET_SCRIPT_TASK_STATUS(func_265(uParam0), 2106541073)==7){
