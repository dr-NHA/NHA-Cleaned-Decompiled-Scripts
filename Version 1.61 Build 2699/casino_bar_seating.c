...
if((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1946250.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13)){
...
Var20={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0f, 2) 
};
Var23={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0f, 2) 
};
fVar26=Var23.f_2;
fVar27=0,05f;
...
func_42(uParam0);
}elseif(Global_2789734 || Global_2789737){
func_42(uParam0);
...
var func__15(){
return MISC::IS_BIT_SET(Global_1946250.f_3, 25);
}
...
return 1;
}}elseif(func_16(ENTITY::GET_ENTITY_HEADING(iParam0), Param1.f_2, 45f)){
return 1;
}}
return 0;
}
...
}elseif(bVar14 || (!func_94(PLAYER::PLAYER_ID(), 0) && !func_93())){
...
func_102(func_104(), func_103(iParam3, fVar3)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_102(func_101(), func_103(iParam3, fVar3)) + Var0 
};
