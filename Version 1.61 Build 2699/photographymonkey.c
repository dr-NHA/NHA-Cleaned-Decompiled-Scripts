...
iLocal_461=MISC::IS_BIT_SET(Global_8137, 28);
if(iLocal_48 !=-1){
if(fVar0 < fLocal_46){
Var1={
Local_455 
...
return MISC::IS_BIT_SET(Global_113386.f_10049.f_135[iVar0], uVar1);
}
