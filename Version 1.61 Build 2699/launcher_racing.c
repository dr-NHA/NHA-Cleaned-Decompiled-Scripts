...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_24() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_24() /*5567*/].f_681.f_10, iParam0);
}
...
iLocal_196=1;
iLocal_195=1;
}elseif(func_136(&iLocal_198) >=10f && !iLocal_197){
iLocal_197=1;
iLocal_195=1;
}
break;
...
iLocal_95=MISC::GET_GAME_TIMER() + 1000;
return 0;
}elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_0, -1, false) !=PLAYER::PLAYER_PED_ID()){
func_147();
return 0;
}else{
...
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_166[iVar0], PLAYER::PLAYER_PED_ID(), true) && ENTITY::GET_ENTITY_HEALTH(iLocal_166[iVar0]) < 900){
return 1;
}}
iVar0++;
}
...
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_111, PLAYER::PLAYER_PED_ID(), true) && ENTITY::GET_ENTITY_HEALTH(iLocal_111) < 900){
return 1;
}}
return 0;
}
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_111, false)){
return 1;
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_111, true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_111, PLAYER::PLAYER_PED_ID(), true)){
return 1;
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_117)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_117, false)){
return 1;
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_117, true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117, PLAYER::PLAYER_PED_ID(), true)){
return 1;
}}
iVar0=0;
while (iVar0 <=(iLocal_174 - 1)){
...
return 1;
}elseif(func_185(iLocal_103[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
return 1;
}}
iVar0++;
}
...
switch (Local_83.f_0){
case 5:
return MISC::IS_BIT_SET(Global_113386.f_24976.f_2, 0);
break;
case 6:
return MISC::IS_BIT_SET(Global_113386.f_24976.f_2, 1);
break;
case 7:
return MISC::IS_BIT_SET(Global_113386.f_24976.f_2, 2);
break;
case 8:
return MISC::IS_BIT_SET(Global_113386.f_24976.f_2, 3);
break;
case 0:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_3, 0);
break;
case 1:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_3, 1);
break;
case 2:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_3, 2);
break;
case 3:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_3, 3);
break;
case 4:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_3, 4);
break;
}
return 0;
}
...
switch (iParam0){
case 0:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_1, 0);
break;
case 1:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_1, 1);
break;
case 2:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_1, 2);
break;
case 3:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_1, 3);
break;
case 4:
return MISC::IS_BIT_SET(Global_113386.f_24979.f_1, 4);
break;
}
return 0;
}
