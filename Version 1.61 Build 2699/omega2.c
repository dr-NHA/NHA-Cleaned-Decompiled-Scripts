...
float fVar6;
Var0={
func_198(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_198(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
if(func_29(Local_81.f_35[0])){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_81.f_35[0], true) 
};
...
Var4={
func_255(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
