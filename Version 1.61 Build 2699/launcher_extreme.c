...
return 1;
}elseif((!func_174(PLAYER::PLAYER_PED_ID(), -828834893) && func_191(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_149(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, 0, 1, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}
return 0;
}
...
func_287("ARE_RC_TRIGGER_CONDITIONS_MET:
RC_TRIG_CHAR - Used special case Eps 4 trigger.");
return 1;
}}
}}else{
return 0;
}}elseif(func_191(uParam0->f_28[0])){
if(func_177(uParam0)){
if(func_181(2)){
if(func_179(uParam0->f_27)){
func_178(uParam0->f_27, *uParam0);
...
if(func_179(uParam0->f_27)){
func_178(uParam0->f_27, *uParam0);
func_287("RC5_IN_ACTIVATION_RANGE:
...
if(func_179(1)){
func_178(1, *uParam0);
func_287("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_287("RC_STOP_PLAYER_VEHICLE_CHECK:
...
struct<27> Var0;
if(Global_78319){
func_287("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_210(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
Vector3 func__223(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_227(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_227(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__227(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_227(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
