...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_55(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_55(iParam1))){
return 1;
}
return 0;
}
...
func_176(1);
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_253, false)){
...
if(iLocal_52==1){
Local_59={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(-1f, 8,8f, 0f) 
};
PATHFIND::GET_SAFE_COORD_FOR_PED(Local_59, false, &Local_59, 0);
Local_62={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector(-1f, 0f, 8,8f) 
};
