...
void func_1(){
if(!MISC::IS_BIT_SET(Global_41747, 0)){
...
}}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_167[0])){
OBJECT::DELETE_OBJECT(&(iLocal_167[0]));
}
if((!MISC::IS_BIT_SET(Global_41747, 1) && func_3()==0) && !(NETWORK::NETWORK_IS_ACTIVITY_SESSION() && (func_2(Global_4718592.f_116524)==14 || func_2(Global_4718592.f_116524)==15))){
...
}}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_167[1])){
...
if(!MISC::IS_BIT_SET(Global_4718592.f_162495, 14)){
...
}}}elseif(MISC::IS_BIT_SET(Global_4718592.f_162495, 13)){
if(!STREAMING::IS_IPL_ACTIVE("xm_siloentranceclosed_x17")){
STREAMING::REQUEST_IPL("xm_siloentranceclosed_x17");
}
if(!STREAMING::IS_IPL_ACTIVE("xm_hatches_terrain")){
...
if(MISC::IS_BIT_SET(Global_1946250.f_1489, 8)){
...
if(!Global_1836152){
if(MISC::IS_BIT_SET(Global_1946250.f_5, 18)){
...
if(MISC::IS_BIT_SET(Global_1946250.f_5, 19)){
...
if(func_17()){
iLocal_165=1;
}}elseif(!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && !func_17()){
func_5();
iLocal_165=0;
}
...
if(MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 4)){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
if(!MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 6)){
func_37(bParam0, 1);
}}elseif(MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 6)){
func_37(bParam0, 0);
}}}
...
if((MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 6) || MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 5)) || func_34(bParam0)){
func_33(bParam0);
bLocal_52=bParam0;
...
if(MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 7)){
func_32(bParam0, 1);
}
if(!MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 2)){
if(MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 1)){
...
}}elseif(Global_41748[bParam0 /*31*/].f_22 < 1f){
Global_41748[bParam0 /*31*/].f_22=(Global_41748[bParam0 /*31*/].f_22 + (Global_41748[bParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41748[bParam0 /*31*/].f_22 > 1f){
Global_41748[bParam0 /*31*/].f_22=1f;
}
...
}elseif(MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 1)){
if(Global_41748[bParam0 /*31*/].f_22 > -1f){
...
if(!MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 3)){
bVar2=false;
...
}}elseif(Global_41748[bParam0 /*31*/].f_22 > 0f){
if(!bVar2){
Global_41748[bParam0 /*31*/].f_22=(Global_41748[bParam0 /*31*/].f_22 - (Global_41748[bParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41748[bParam0 /*31*/].f_22 < 0f){
Global_41748[bParam0 /*31*/].f_22=0f;
...
iVar0=23;
}elseif(Global_41748[bParam0 /*31*/]==65926040){
iVar0=22;
}elseif(Global_41748[bParam0 /*31*/]==1423193534){
iVar0=26;
}elseif(Global_41748[bParam0 /*31*/]==-1958174046){
iVar0=25;
}
if(bParam1){
if(!MISC::IS_BIT_SET(Global_41748[iVar0 /*31*/].f_1, 2)){
if(MISC::IS_BIT_SET(Global_41748[iVar0 /*31*/].f_1, 1)){
...
}}elseif(Global_41748[iVar0 /*31*/].f_22 < 1f){
Global_41748[iVar0 /*31*/].f_22=(Global_41748[iVar0 /*31*/].f_22 + (Global_41748[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41748[iVar0 /*31*/].f_22 > 1f){
Global_41748[iVar0 /*31*/].f_22=1f;
}
...
}elseif(MISC::IS_BIT_SET(Global_41748[iVar0 /*31*/].f_1, 1)){
if(Global_41748[iVar0 /*31*/].f_22 > -1f){
MISC::CLEAR_BIT(&(Global_41748[iVar0 /*31*/].f_1), 2);
}}elseif(Global_41748[iVar0 /*31*/].f_22 < 1f){
MISC::CLEAR_BIT(&(Global_41748[iVar0 /*31*/].f_1), 2);
}}elseif(!MISC::IS_BIT_SET(Global_41748[iVar0 /*31*/].f_1, 3)){
bVar1=false;
...
}}elseif(Global_41748[iVar0 /*31*/].f_22 > 0f){
if(!bVar1){
Global_41748[iVar0 /*31*/].f_22=(Global_41748[iVar0 /*31*/].f_22 - (Global_41748[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41748[iVar0 /*31*/].f_22 < 0f){
Global_41748[iVar0 /*31*/].f_22=0f;
...
if(MISC::IS_BIT_SET(Global_41748[bParam0 /*31*/].f_1, 0)){
...
Var3.f_0=0f;
Var9={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar2, Var6) 
};
Var12={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar2, Var3) 
};
...
}elseif(iParam1==Global_41748[bParam0 /*31*/].f_25[iVar0]){
Global_41748[bParam0 /*31*/].f_25[iVar0]=0;
bVar1=true;
}
iVar0++;
...
}}elseif(func_49(13, PLAYER::PLAYER_PED_ID())){
func_36(13, PLAYER::PLAYER_PED_ID(), 0);
}
}}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_91229[78 /*34*/].f_6)==0){
if(func_49(13, PLAYER::PLAYER_PED_ID())){
func_36(13, PLAYER::PLAYER_PED_ID(), 0);
}}
break;
...
elseif(!func_49(24, PLAYER::PLAYER_PED_ID())){
func_48(24, PLAYER::PLAYER_PED_ID());
}}
break;
case 25:
...
elseif(SYSTEM::VDIST2(Global_41748[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f){
func_48(4, PLAYER::PLAYER_PED_ID());
}}
break;
case 2:
...
if((MISC::IS_BIT_SET(Global_38421[(iParam0 / 32)], (iParam0 % 32)) && Global_38884[iParam0] !=2) && !MISC::IS_BIT_SET(Global_38657[(iParam0 / 32)], (iParam0 % 32))){
...
void func_88(){
if(!iLocal_66 && MISC::IS_BIT_SET(Global_113386.f_9085.f_2[27 /*3*/], 2)){
iLocal_66=1;
bLocal_65=true;
}
...
void func_106(){
if(func_75()){
if(((!Global_113386.f_7261.f_426 || MISC::IS_BIT_SET(iLocal_46, 0)) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) || Global_38410){
if(!Global_2726949){
if(MISC::IS_BIT_SET(iLocal_46, 0) || Global_38410){
iLocal_162=1;
}
iLocal_64=0;
}}}elseif(((!Global_42586.f_426 || MISC::IS_BIT_SET(iLocal_46, 1)) || ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_96()) && !func_107())) || Global_38410){
if(func_3()==2){
