...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_88(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_88(iParam1))){
return 1;
}
return 0;
}
...
Var4={
func_305(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
