...
iVar0=0;
}elseif(((!PED::IS_PED_INJURED(iVar2) && ((bParam5 || iParam4==4) || iParam4==1)) && !func_105(uParam0[iParam2 /*94*/], 8192)) && TASK::GET_SCRIPT_TASK_STATUS(iVar2, 242628503)==7){
if(iParam2==iParam3){
...
}}elseif(func_105(uParam0, 2048) && TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 713668775) !=1){
...
}elseif((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_71(&(uParam0->f_4)), Var6, false, true, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 2106541073)==7) && !func_229(&(uParam0->f_4), 256)){
func_236(&(uParam0->f_4), 0);
func_218(&(uParam0->f_4), 4);
...
*iParam1=SYSTEM::ROUND((Var0.f_0 * 128f));
*iParam2=SYSTEM::ROUND((Var0.f_1 * 128f));
}elseif(SYSTEM::VDIST2(uParam0->f_37, Var3) <=(0f * 0f) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), 2106541073)==7){
