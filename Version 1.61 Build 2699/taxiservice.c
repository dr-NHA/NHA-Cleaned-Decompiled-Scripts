...
}}elseif(!PED::IS_PED_FLEEING(Global_112418)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
}}elseif(!PED::IS_PED_INJURED(Global_112418) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112417, false)){
if(PED::IS_PED_IN_VEHICLE(Global_112418, Global_112417, false)){
...
elseif(ENTITY::GET_ENTITY_SPEED(Global_112417) > 5f){
if(!func_8()){
iLocal_828=12;
func_44(Global_112418, &iLocal_828);
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_15() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_15() /*5567*/].f_681.f_10, iParam0);
}
...
if(bVar1){
if(((func_55()==0 && !MISC::IS_BIT_SET(Global_91229[iLocal_825 /*34*/].f_15, 8)) || (func_55()==1 && !MISC::IS_BIT_SET(Global_91229[iLocal_825 /*34*/].f_15, 9))) || (func_55()==2 && !MISC::IS_BIT_SET(Global_91229[iLocal_825 /*34*/].f_15, 10))){
bVar1=false;
}}
if(bVar1){
...
if(fVar3 < 100f){
Var0={
func_82(Global_112424 - Var0) 
};
Var0={
(Global_112424 + (Var0.f_0 * IntToFloat((100 - SYSTEM::ROUND(fVar3))))), (Global_112424.f_1 + (Var0.f_1 * IntToFloat((100 - SYSTEM::ROUND(fVar3))))), Global_112424.f_2 
};
...
while (iVar37 < 63){
iVar32=iVar37;
if(MISC::IS_BIT_SET(Global_113386.f_18574[iVar32 /*6*/], 2) && !MISC::IS_BIT_SET(Global_113386.f_18574[iVar32 /*6*/], 3)){
func_97(iVar32, &Var0);
...
*uParam7={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam7, *fParam8, fVar15, 0f, 0f) 
};
...
while (iVar6 < 63){
*iParam1=iVar6;
if(MISC::IS_BIT_SET(Global_113386.f_18574[*iParam1 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113386.f_18574[*iParam1 /*6*/], 3)){
...
Var3={
HUD::GET_BLIP_COORDS(Global_32338[Global_97374[iVar6 /*17*/].f_9 /*23*/].f_19) 
};
if(uParam0->f_2==1f){
Var3.f_2=1f;
}
...
func_174(&Global_112417, iLocal_992);
}elseif(!func_2(Global_112418, -272084098)){
Var0={
ENTITY::GET_ENTITY_COORDS(Global_112417, true) 
};
...
bLocal_67=true;
iLocal_952=2;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112418, &cLocal_954, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112418, &cLocal_954, "leanover_idle", 3)){
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112418, &cLocal_954, "leanover_exit", 3)){
ENTITY::SET_ENTITY_ANIM_SPEED(Global_112418, &cLocal_954, "leanover_exit", 1,2f);
iLocal_92=MISC::GET_GAME_TIMER();
func_174(&Global_112417, iLocal_992);
}elseif(!func_2(Global_112418, 242628503)){
...
if(bLocal_63){
return 1;
}elseif(func_124(&Local_43, &Global_112424, &Global_112430)){
iLocal_105=0;
Local_974={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) 
};
...
}}elseif(CAM::IS_CAM_ACTIVE(iLocal_70)){
CAM::SET_CAM_ACTIVE(iLocal_70, false);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
...
fVar5=Var0.f_1;
Var6={
func_82(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112417, Param2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112417, Local_980)) 
};
...
Var5={
ENTITY::GET_ENTITY_COORDS(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_829[bVar0 /*3*/])), true) 
};
...
Var5={
ENTITY::GET_ENTITY_COORDS(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_829[bVar0 /*3*/]), true) 
};
}}else{
Var5={
...
if(HUD::DOES_BLIP_EXIST(iParam0)){
Var0={
func_47(iParam0) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
}}
...
Var0={
ENTITY::GET_ENTITY_COORDS(Global_112417, false) 
};
...
Local_971={
ENTITY::GET_ENTITY_COORDS(Global_112417, true) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
Local_971.f_2=0f;
...
TASK::TASK_SMART_FLEE_PED(Global_112418, PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
}}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Global_112418, -1146898486) !=1 && TASK::GET_SCRIPT_TASK_STATUS(Global_112418, -1146898486) !=0){
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112418, &cLocal_954, "leanover_idle", 3)){
