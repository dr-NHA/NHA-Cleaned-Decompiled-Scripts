...
func_2(0);
}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&Global_112442))==0){
func_2(0);
}}}
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112418, &cLocal_270, "Aknowledge_L", 3)){
...
}elseif(func_41(Global_112454, 30000)){
...
struct<3> Var0;
Var0={
ENTITY::GET_ENTITY_COORDS(Local_56.f_0, false) 
};
if(!Local_56.f_2){
if(!Local_56.f_3){
...
Local_56.f_2=1;
}}elseif(!func_19(Local_56.f_1, -272084098)){
...
Var0={
ENTITY::GET_ENTITY_COORDS(Local_56.f_0, true) 
};
...
return 1;
}elseif(!func_19(Local_56.f_1, -1817882002)){
Local_56.f_2=0;
Local_56.f_8=0;
}}
return 0;
...
Var9={
ENTITY::GET_ENTITY_COORDS(uVar19[iVar4], false) 
};
...
if(MISC::IS_BIT_SET(Global_113386.f_7688[iVar4 /*15*/].f_2, bVar0)){
...
if(MISC::IS_BIT_SET(Global_113386.f_7688.f_651[iVar4 /*14*/].f_2, bVar0)){
...
if(MISC::IS_BIT_SET(Global_113386.f_7688.f_765[iVar4 /*10*/].f_2, bVar0)){
...
return 1;
}elseif(Global_43053[iParam3 /*5*/].f_4 !=-1){
