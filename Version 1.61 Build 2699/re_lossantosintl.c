...
}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_89, false) && !PED::IS_PED_INJURED(iLocal_90)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_89);
PED::SET_PED_KEEP_TASK(iLocal_90, true);
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_89, true) 
};
...
Var6={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var0, fVar9, Var3) 
};
