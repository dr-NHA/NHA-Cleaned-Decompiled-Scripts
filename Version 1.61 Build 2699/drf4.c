...
iLocal_48=2;
}}elseif(func_75(iLocal_1261, &uLocal_74, 36, "DrfAud", &uLocal_239, &uLocal_287, "SHRINK_CELL_Q", 9, 1, 0, 0, 0)){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_19() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_19() /*5567*/].f_681.f_10, iParam0);
}
...
Var1={
func_116(iParam11, &uVar5, &uVar6, 1) 
};
iVar0=func_115(&Var1);
...
Var0={
func_93(uParam6, &iVar5, iParam7, 1) 
};
...
iVar2[iParam0]=0;
}elseif((iParam1 > 0 && iParam1 < 13) && !func_99(&(Global_113386.f_19961), iParam1)){
iVar2[iParam1]=0;
}elseif((iParam2 > 0 && iParam2 < 13) && !func_99(&(Global_113386.f_19961), iParam2)){
iVar2[iParam2]=0;
}elseif((iParam3 > 0 && iParam3 < 13) && !func_99(&(Global_113386.f_19961), iParam3)){
iVar2[iParam3]=0;
}elseif((iParam4 > 0 && iParam4 < 13) && !func_99(&(Global_113386.f_19961), iParam4)){
iVar2[iParam4]=0;
}
...
int iVar5;
Var0={
func_116(iParam3, &iVar4, &iVar5, 1) 
};
...
iVar0=1;
}elseif(MISC::ARE_STRINGS_EQUAL(sParam0, "DRF_EXILE")){
iVar0=2;
}elseif(MISC::ARE_STRINGS_EQUAL(sParam0, "DRF_SOL2")){
iVar0=1;
}elseif(MISC::ARE_STRINGS_EQUAL(sParam0, "DRF_MIC2")){
iVar0=1;
}
return iVar0;
}
