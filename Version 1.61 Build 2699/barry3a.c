...
func_213(3);
iLocal_436=0;
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false)){
HUD::CLEAR_PRINTS();
iLocal_437=0;
iLocal_436=1;
func_217(&iLocal_144);
...
iLocal_436=1;
func_217(&iLocal_144);
}elseif(ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, true, true, 0)){
func_217(&iLocal_144);
iLocal_143=0;
iLocal_142=6;
}
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_75(iParam1))){
return 1;
}
return 0;
}
...
return func_306(2, 2);
}elseif(func_305(Global_1853185)){
...
Var18={
func_308(Var18, -Var0.f_3.f_2) 
};
Var18={
func_308(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__308(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_326(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
}}elseif(!ENTITY::IS_ENTITY_DEAD(Local_186[iParam0 /*29*/].f_1, false)){
...
}elseif((func_388(Local_186[iParam0 /*29*/]) || func_375(Local_186[iParam0 /*29*/].f_1)) || func_375(Local_186[iParam0 /*29*/].f_2)){
func_373(iParam0, 0);
}elseif(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
func_373(iParam0, 0);
}}else{
...
func_373(iParam0, 1);
}elseif((func_375(Local_186[iParam0 /*29*/].f_1) || func_375(Local_186[iParam0 /*29*/].f_2)) || func_388(Local_186[iParam0 /*29*/])){
func_373(iParam0, 0);
}
break;
case 3:
...
return 1;
}elseif(MISC::IS_PROJECTILE_IN_AREA(Var0 - Vector(3f, 3f, 3f), Var0 + Vector(3f, 3f, 3f), true)){
return 1;
}elseif(func_376(iParam0, 1126825984)){
return 1;
}}
return 0;
}
...
float fVar6;
Var0={
func_384(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return 1;
}elseif(MISC::IS_PROJECTILE_IN_AREA(Var0 - Vector(5f, 5f, 5f), Var0 + Vector(5f, 5f, 5f), true)){
return 1;
}}
return 0;
}
...
return 1;
}elseif(Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7 !=0f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7, false, true, 0)){
return 1;
}
return 0;
}
...
Var4={
func_409(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_436(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
Vector3 func__464(char* sParam0, int iParam1){
struct<3> Var0;
Var0.f_2=sParam0;
Var0.f_0=iParam1;
Var0.f_1=0;
