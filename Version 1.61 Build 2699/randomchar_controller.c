...
void func_46(){
if(!func_45(39)){
if(MISC::IS_BIT_SET(Global_113386.f_18574[27 /*6*/], 3)){
...
if(func_75()){
if(!func_43(114)){
if(MISC::IS_BIT_SET(Global_113386.f_18574[46 /*6*/], 3)){
func_72(552744224, 6, 2, 50, 60000, 10000, -1, 181, -1, 0, 1);
func_71(114, 1);
}}elseif(!func_43(83)){
if(MISC::IS_BIT_SET(Global_113386.f_18574[51 /*6*/], 3)){
...
if(!MISC::IS_BIT_SET(Global_113386.f_18574.f_390[iLocal_52], bLocal_51)){
func_18(iVar0, &Var1);
if(iVar0==58){
MISC::SET_BIT(&(Global_113386.f_18574.f_390[iLocal_52]), bLocal_51);
}elseif(HUD::GET_MINIMAP_FOW_COORDINATE_IS_REVEALED(Var1.f_6)){
MISC::SET_BIT(&(Global_113386.f_18574.f_390[iLocal_52]), bLocal_51);
}elseif(Global_112473[iVar0 /*10*/].f_8 !=-1){
if(iLocal_53[Global_112473[iVar0 /*10*/].f_8]){
if(MISC::IS_BIT_SET(Global_32338[iLocal_74[Global_112473[iVar0 /*10*/].f_8] /*23*/].f_11, 6)){
...
if(!MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 1)){
if(!Var0.f_23){
MISC::SET_BIT(&(Global_113386.f_18574[iParam0 /*6*/]), true);
}}
if(MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 3)){
...
if(MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 2) && !MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 3)){
bVar59=true;
if(func_128(iParam0)){
bVar59=false;
}
...
Global_112473[iParam0 /*10*/].f_3=1;
}elseif(Global_112473[iParam0 /*10*/].f_3){
...
iVar62=0;
if((((iVar60 && !MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 3)) && MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 0)) && MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 1)) && MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 2)){
...
if(!MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 4)){
...
if(iParam0==2){
if(MISC::IS_BIT_SET(Global_113386.f_18574[3 /*6*/], 3) && Global_112473[3 /*10*/].f_3==1){
return 1;
}}elseif(iParam0==3){
if(MISC::IS_BIT_SET(Global_113386.f_18574[2 /*6*/], 3) && Global_112473[2 /*10*/].f_3==1){
return 1;
}}
return 0;
}
...
if(MISC::IS_BIT_SET(Global_113386.f_18574[2 /*6*/], 0) && MISC::IS_BIT_SET(Global_113386.f_18574[3 /*6*/], 0)){
...
if(bParam1 !=MISC::IS_BIT_SET(Global_32338[iVar0 /*23*/].f_11, 8)){
MISC::SET_BIT(&(Global_32338[iVar0 /*23*/].f_11), 18);
}
MISC::SET_BIT(&(Global_32338[iVar0 /*23*/].f_11), 8);
}else{
Global_32338[iVar0 /*23*/].f_18=iParam2;
if(bParam1 !=MISC::IS_BIT_SET(Global_32338[iVar0 /*23*/].f_11, 10)){
MISC::SET_BIT(&(Global_32338[iVar0 /*23*/].f_11), 18);
}
...
if(MISC::IS_BIT_SET(Global_32338[iVar0 /*23*/].f_11, 8) || MISC::IS_BIT_SET(Global_32338[iVar0 /*23*/].f_11, 10)){
MISC::SET_BIT(&(Global_32338[iVar0 /*23*/].f_11), 18);
}
...
if((MISC::IS_BIT_SET(Global_113386.f_18574[2 /*6*/], 3) || MISC::IS_BIT_SET(Global_113386.f_18574[3 /*6*/], 3)) || MISC::IS_BIT_SET(Global_113386.f_18574[4 /*6*/], 3)){
