...
bVar13=false;
}}elseif((!Global_113386.f_9085 && !func_52(0)) || !MISC::IS_BIT_SET(Global_113386.f_9085.f_2[27 /*3*/], 2)){
bVar13=false;
}
iVar14=iVar4;
...
if(MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_833, 16)){
return 0;
}
if(func_42()){
return 0;
...
func_34(3, -1);
}elseif(func_37(&Global_2727873, 7000, 0)==0){
return 0;
}}}else{
return 0;
}}
...
if(MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_833, 6)){
return 0;
}
...
return MISC::IS_BIT_SET(Global_1888862[iParam0 /*120*/].f_14, 0);
}
...
break;
default:
if(MISC::IS_BIT_SET(Global_1648034.f_1046, bParam0)){
return 1;
}
if(MISC::IS_BIT_SET(Global_1648034.f_1047, bParam0)){
return 1;
}
break;
}
...
}}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && *iParam1) && ENTITY::GET_ENTITY_SPEED(*iParam0) < 20f) && !ENTITY::IS_ENTITY_IN_AIR(*iParam0)){
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(!MISC::IS_BIT_SET(Global_2359296[func_81() /*5567*/].f_681.f_1274, 2)){
