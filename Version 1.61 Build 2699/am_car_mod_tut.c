...
if(!func_190(0)){
func_78();
}elseif(!MISC::IS_BIT_SET(Local_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
func_8();
}}elseif(func_191()==6){
Local_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]=5;
}
...
if(func_4(iVar1, 0, 1)){
if(!MISC::IS_BIT_SET(Global_1853348[iLocal_139 /*834*/].f_143, 4)){
}}}
iLocal_139++;
if(iLocal_139==32){
if(MISC::IS_BIT_SET(uLocal_238, 1)){
...
var func__49(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
if(!MISC::IS_BIT_SET(uLocal_238, 5)){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(MISC::IS_BIT_SET(uLocal_238, 3)){
...
if(MISC::IS_BIT_SET(uLocal_238, 7)){
MISC::CLEAR_BIT(&uLocal_238, 7);
}
if(MISC::IS_BIT_SET(uLocal_238, 8)){
MISC::CLEAR_BIT(&uLocal_238, 8);
}
if(MISC::IS_BIT_SET(uLocal_238, 11)){
MISC::CLEAR_BIT(&uLocal_238, 11);
}
if(!MISC::IS_BIT_SET(uLocal_238, 2)){
if(iLocal_237 !=-1){
func_76(iLocal_237, 0);
func_75(iLocal_237, 0);
iLocal_237=-1;
...
elseif(!func_157(iVar0)){
MISC::SET_BIT(&uLocal_238, 8);
func_148("FM_CTUT_DRI", -1);
}
elseif(!func_158(iVar0, 0, &uVar1)){
MISC::SET_BIT(&uLocal_238, 8);
func_148("FM_CTUT_HMD", -1);
}}}
}
}
elseif(MISC::IS_BIT_SET(uLocal_238, 11)){
...
elseif(func_144() && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())){
if(!MISC::IS_BIT_SET(uLocal_238, 3)){
MISC::SET_BIT(&uLocal_238, 3);
}
}}}
if(!MISC::IS_BIT_SET(uLocal_238, 4)){
if(MISC::IS_BIT_SET(uLocal_238, 3)){
...
if(!MISC::IS_BIT_SET(uLocal_238, 10)){
if(!MISC::IS_BIT_SET(uLocal_238, 9)){
...
if(MISC::IS_BIT_SET(uLocal_238, 3) || (func_144() && MISC::IS_BIT_SET(uLocal_238, 10))){
if(func_144()){
...
if(func_121()){
if(!MISC::IS_BIT_SET(Global_2815059.f_1792, 25)){
MISC::SET_BIT(&(Global_2815059.f_1792), 25);
}
...
func_23();
}}elseif(MISC::IS_BIT_SET(uLocal_238, 9)){
...
}}elseif(!MISC::IS_BIT_SET(Local_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0)){
MISC::SET_BIT(&(Local_140[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
}}elseif(MISC::IS_BIT_SET(uLocal_238, 9)){
MISC::CLEAR_BIT(&uLocal_238, 9);
...
func_23();
}}elseif(PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_144()){
if(CAM::IS_SCREEN_FADED_IN()){
if((((!func_86(PLAYER::PLAYER_ID(), 1, 0) && !func_85()) && func_84()==0) && func_82()) || func_144()){
if(!func_81(&uLocal_241)){
func_7(&uLocal_241, 0, 0);
}elseif(func_147(&uLocal_241, 7000, 0) || func_144()){
...
}elseif(func_147(&uLocal_247, 1000, 0)){
...
if(!func_81(&uLocal_247)){
func_7(&uLocal_247, 0, 0);
}elseif(func_147(&uLocal_247, 5000, 0)){
...
}elseif(bVar14 || (!func_98(PLAYER::PLAYER_ID(), 0) && !func_97())){
...
if(func_102() >=0){
if(MISC::IS_BIT_SET(Global_1585857[func_102() /*142*/].f_103, 2)){
return 1;
}}
return 0;
}
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_143, 19);
}
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_143, 20);
}
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_143, 21);
}
...
return func_131(2, 2);
}elseif(func_130(Global_1853185)){
...
Vector3 func__131(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_133(Var18, -Var0.f_3.f_2) 
};
Var18={
func_133(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__133(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_143, 18);
}
...
bool func_155(){
return MISC::IS_BIT_SET(Global_2815059.f_1795, 4);
}
...
return 1;
}elseif(func_171(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
