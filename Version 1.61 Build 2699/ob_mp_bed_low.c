...
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_343, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > (3f + 2f)){
func_82();
}}else{
func_82();
}}}
...
Local_343={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_333, sLocal_334, Local_347, Local_350, 0f, 2) 
};
Var3={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_333, sLocal_334, Local_347, Local_350, 0f, 2) 
};
fLocal_346=Var3.f_2;
...
return MISC::IS_BIT_SET(Global_1648034.f_241.f_136[func_47(9) /*33*/][iParam0], func_46(9));
}
