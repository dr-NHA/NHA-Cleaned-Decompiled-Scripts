...
iLocal_21=1;
}}elseif((MISC::GET_GAME_TIMER() - iLocal_187) > 12000 && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_188, true)) <=900f){
if(func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0)){
iLocal_21=1;
}}
break;
