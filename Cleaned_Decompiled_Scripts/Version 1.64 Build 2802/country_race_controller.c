...
int func_43(){
if((!Global_113648.f_25075.f_9 && !Global_113648.f_25075.f_8) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_60()) < 84100f){
...
uLocal_157=PED::CREATE_PED(26, joaat("a_m_y_motox_02"), func_47(), func_46(), 1, 1);
func_45(uLocal_157);
...
if(!func_53(uLocal_157, joaat("script_task_start_scenario_in_place"), 1)){
TASK::TASK_START_SCENARIO_IN_PLACE(uLocal_157, "WORLD_HUMAN_STAND_IMPATIENT", -1, 1);
}
if(func_52(uLocal_156) || Global_113648.f_25075.f_9){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(uLocal_157);
TASK::TASK_COMBAT_PED(uLocal_157, PLAYER::PLAYER_PED_ID(), 0, 16);
}
fLocal_160=ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID());
}elseif(PED::IS_PED_RAGDOLL(uLocal_157)){
if(!func_53(uLocal_157, joaat("script_task_combat"), 1)){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(uLocal_157);
TASK::TASK_COMBAT_PED(uLocal_157, PLAYER::PLAYER_PED_ID(), 0, 16);
}}}}
...
return 1;
}elseif(PED::IS_PED_FLEEING(uLocal_157)){
return 1;
}elseif(PED::IS_PED_IN_COMBAT(uLocal_157, 0)){
return 1;
}elseif(PED::IS_PED_RAGDOLL(uLocal_157)){
return 1;
...
func_12(&Global_113646);
if(func_61(uLocal_157)){
if(func_53(uLocal_157, joaat("script_task_start_scenario_at_position"), 1) || func_53(uLocal_157, joaat("script_task_start_scenario_in_place"), 1)){
