...
iLocal_70=318;
iLocal_71=1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_34();
SYSTEM::WAIT(0);
func_22();
func_21();
func_17();
...
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_104) > 100f) return true;
return false;
}
...
i < iLocal_82;
i=i + 1){
if(iParam1 !=i)if(iLocal_82[i] < 2 && iLocal_82[iParam1] >=0) iLocal_82[i]=2;
}
iLocal_82[iParam1]=3;
return 0;
case 3:
...
i < iLocal_72;
i=i + 1){
if(pedParam0 !=iLocal_72[i])if(iLocal_82[i] < 0) return true;
}
return false;
}
...
if(func_16(14)) return 0;
if(MISC::GET_IS_PLAYER_IN_ANIMAL_FORM()) return 0;
if(!func_9(iParam0, func_10())) return 0;
...
}elseif(eParam1==func_8(Global_100402) && eParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_20();
return;
}
...
if(!SCRIPT::HAS_SCRIPT_LOADED(&uLocal_87[i /*4*/])) flag=false;
}}
if(!flag) num=num + 1;
SYSTEM::WAIT(0);
}
...
uLocal_108[0 /*3*/]={
{
45.5004f, -205.8167f, -1416.5402f 
}
- uLocal_104 
};
uLocal_108[1 /*3*/]={
{
45.5004f, -207.5375f, -1423.8984f 
}
- uLocal_104 
};
uLocal_108[2 /*3*/]={
{
45.5004f, -210.4254f, -1428.5013f 
}
- uLocal_104 
};
uLocal_108[3 /*3*/]={
{
45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.5402f, -1428.5013f) 
}
- uLocal_104 
};
...
case 158:
uLocal_108[0 /*3*/]={
1.2712f, 6.071f, -0.75f 
};
uLocal_108[1 /*3*/]={
3.8061f, 5.7599f, -0.5f 
};
uLocal_108[2 /*3*/]={
4.541f, 7.8487f, -0.4f 
};
uLocal_108[3 /*3*/]={
3.1051f, 13.7474f, -0.3463f 
};
...
uParam109->f_109=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
uParam109->f_110=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
func_24(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"),{
...
, -66f + -56f);
if(uParam0.f_2==80) func_25(uParam109);
uParam109->f_118=1;
return 1;
case 124:
*uParam109={
...
uParam109->f_109=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
uParam109->f_110=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
if(uParam0.f_2==94) func_24(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -1.71f, 1.05f, 0f, -138f);
uParam109->f_118=1;
return 1;
case 95:
*uParam109={
...
if(uParam0.f_2==267) func_24(uParam109, 144, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -2.4166f, -0.15f, 0f, -148.7555f);
if(uParam0.f_2==266) func_24(uParam109, 144, joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -5.7915f, -11.0439f, 0.67f, -72.589f);
return 1;
case 246:
*uParam109={
uParam0 
...
if(func_28(entityCoords, 0f, 0f, 0f, false)) entityCoords={
...
i < iLocal_77;
i=i + 1){
if(iLocal_77[i] !=0) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_77[i]);
}
