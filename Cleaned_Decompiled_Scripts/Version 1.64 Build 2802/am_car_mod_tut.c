...
if(func_4(iVar1, 0, 1)){
if(!MISC::IS_BIT_SET(Global_1853910[iLocal_139 /*862*/].f_143, 4)){
}}}
iLocal_139++;
if(iLocal_139==32){
...
if(iLocal_237==-1){
iLocal_237=func_128(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4, -1);
if(iLocal_237 !=-1){
...
elseif(func_147() && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())){
if(!MISC::IS_BIT_SET(uLocal_238, 3)){
MISC::SET_BIT(&uLocal_238, 3);
}
}}}
...
if(MISC::IS_BIT_SET(uLocal_238, 3) || (func_147() && MISC::IS_BIT_SET(uLocal_238, 10))){
if(func_147()){
...
if(func_121()){
if(!MISC::IS_BIT_SET(Global_2793044.f_1822, 25)){
MISC::SET_BIT(&(Global_2793044.f_1822), 25);
}
...
iVar3=func_108(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0);
if(iVar3 > 0){
...
func_23();
}}elseif(PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_147()){
if(CAM::IS_SCREEN_FADED_IN()){
if((((!func_86(PLAYER::PLAYER_ID(), 1, 0) && !func_85()) && func_84()==0) && func_82()) || func_147()){
if(!func_81(&uLocal_241)){
func_7(&uLocal_241, 0, 0);
}elseif(func_150(&uLocal_241, 7000, 0) || func_147()){
...
}elseif(func_150(&uLocal_247, 1000, 0)){
...
if(!func_81(&uLocal_247)){
func_7(&uLocal_247, 0, 0);
}elseif(func_150(&uLocal_247, 5000, 0)){
...
if(func_102() >=0){
if(MISC::IS_BIT_SET(Global_1586468[func_102() /*142*/].f_103, 2)){
return 1;
}}
return 0;
}
...
return MISC::IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_143, 19);
}
...
return MISC::IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_143, 20);
}
...
return MISC::IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_143, 21);
}
...
return MISC::IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_143, 18);
}
...
bool func_158(){
return MISC::IS_BIT_SET(Global_2793044.f_1825, 4);
}
...
return 1;
}elseif(func_177(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
