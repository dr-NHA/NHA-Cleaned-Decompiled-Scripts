...
if(func_297(PLAYER::PLAYER_PED_ID())) hLocal_328=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
...
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false)) OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, false, 0f, false);
...
bLocal_160=true;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_149)){
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_147)) ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(obLocal_147, -8f, true);
iLocal_162=1;
}
...
if(iLocal_162==0) PED::FORCE_PED_MOTION_STATE(uLocal_83.f_28[0], joaat("MotionState_Walk"), false, 0, true);
}
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false)) OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, false, 0f, false);
if(iLocal_162==0){
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(904342475, 0f, true, true);
_DEBUG_PRINT("Josh 4:
PROP_LRGGATE_01c_L - Closed");
}
func_2();
break;
}
...
if(func_213(echParam0, echParam1)==1 && func_212(echParam0, echParam1)==1) bParam2=false;
num=echParam1;
...
if(func_223(PLAYER::PLAYER_ID())) return false;
...
if(iParam1==1) func_236(500, false);
return;
}
...
if(func_297(PLAYER::PLAYER_PED_ID())) PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), false, 0);
return;
}
...
if(!func_228()) Global_20383.f_1=3;
Global_21725=5;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_242(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_239() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_242(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_241(-1, false)==8;
...
if(func_243())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0])) CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Josh", uLocal_83.f_28[0], 0);
}
switch (iLocal_145){
case 0:
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0])) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_83.f_28[0], "Josh", 0, 0, 0);
...
if(iParam5==1) func_236(500, false);
}
return;
}
...
if(bParam18) func_260(playersLastVehicle);
...
if(entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)if(func_257(playersLastVehicle, vParam0, vParam3, fParam6)) flag=true;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
...
Vector3 func__259(float fParam0, var uParam1, var uParam2) // Position - 0x295E3{
float num;
float num2;
...
num=0;
if(!func_268(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE)) TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
if(func_297(pedParam0))if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, esthParam1)==1 || TASK::GET_SCRIPT_TASK_STATUS(pedParam0, esthParam1)==0) return true;
return false;
}
...
iLocal_145=2;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_148)){
...
if(func_278(0)) func_275(iParam0);
...
if(func_279()) return;
if(Global_20584)if(func_277()) func_276(true, true);
else func_276(false, false);
...
if(!func_291(0, uParam0)) Global_78815=MISC::GET_GAME_TIMER() - 9000;
...
text={
func_282(Global_78814, Global_78816, iParam10) 
};
y==-0.014f;
...
if(!func_293(0) || Global_78828 || Global_78817==1 || !CAM::IS_SCREEN_FADED_IN()) return false;
switch (Global_78813){
case 0:
...
break;
case 1:
if(!func_309(&num) || !func_307(&(uParam0->f_48))) return false;
iLocal_79=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_304(&uParam0->f_28[0], CHAR_JOSH, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1)) flag=false;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) func_301(&uParam0->f_35[0], true);
if(!func_300(true, true)) flag=false;
if(flag) iLocal_79=3;
break;
case 3:
...
func_261();
if(func_325()) _DEBUG_PRINT("...Random Character Script was triggered so additional cleanup required");
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_317(&uParam0->[i]);
else func_316(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_303(&uParam0->[i]);
else func_320(&uParam0->[i]);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_323(&uParam0->[i]);
else func_324(&uParam0->[i], false, 1, 0);
}
return;
}
...
if(Global_100681 !=12)if(func_328(sParam0, 6, iParam1)) Global_100681.f_1=iParam1;
return;
}
...
if(func_334()){
if(func_333()){
if(Global_100718 >=func_330())if(!IS_BIT_SET(Global_91469[iParam2 /*34*/].f_15, 16))if(Global_113648.f_9087.f_330[iParam2 /*6*/].f_1 >=2) Global_94857=1;
...
if(Global_100681.f_11==5)if(func_329(&(Global_100681.f_3)) > -1) return true;
return false;
}
