...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_83.f_28[0], uLocal_328);
...
iLocal_147=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
}
iLocal_145=1;
}
break;
...
uLocal_149=PED::CREATE_SYNCHRONIZED_SCENE(Local_150, Local_153, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
...
iLocal_160=1;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.29f){
if(!iLocal_161){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, -8f, 1);
}
iLocal_162=1;
}
if(func_218(Local_83.f_28[0], PLAYER::PLAYER_PED_ID(), 1) > 17.5f){
if(func_296(Local_83.f_28[0])){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_83.f_28[0], -8f, 1);
TASK::CLEAR_PED_TASKS(Local_83.f_28[0]);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, -8f, 1);
...
if((PED::IS_PED_INJURED(Local_83.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(Local_83.f_28[0])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 1), 5f)){
if(func_296(Local_83.f_28[0])){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_83.f_28[0], -8f, 1);
TASK::CLEAR_PED_TASKS(Local_83.f_28[0]);
}
...
TASK::TASK_PERFORM_SEQUENCE(Local_83.f_28[0], uLocal_146);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_146);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_83.f_28[0], 0);
if(iLocal_162==0){
PED::FORCE_PED_MOTION_STATE(Local_83.f_28[0], joaat("MotionState_Walk"), 0, 0, 1);
}}
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0)){
OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 0, 0f, 0);
}
...
MISC::CLEAR_AREA_OF_VEHICLES(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_ANGLED_AREA_OF_VEHICLES(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 0, 0, 0, 0, 0);
...
if(func_297(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
uLocal_149=PED::CREATE_SYNCHRONIZED_SCENE(Local_150, Local_153, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
func_246("Done Josh leadout anim on Josh exit state");
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_147);
PED::FORCE_PED_MOTION_STATE(Local_83.f_28[0], joaat("MotionState_Idle"), 0, 1, 1);
iLocal_160=1;
}}}
...
if(func_297(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
uLocal_149=PED::CREATE_SYNCHRONIZED_SCENE(Local_150, Local_153, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
func_246("Done Josh leadout anim on non active cutscene");
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_147);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_83.f_28[0], 0, 0);
iLocal_160=1;
}}
iLocal_145=2;
}
...
int func_248(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_296(iParam0)){
...
if(!func_269(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
if(func_297(Local_83.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
uLocal_148=PED::CREATE_SYNCHRONIZED_SCENE(Local_150, Local_153, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_148, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_147, uLocal_148, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
...
iLocal_145=2;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_148)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_148) > 0.15f){
if(!iLocal_157){
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_269(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
func_302(uParam0, iLocal_81, Var0, fVar3);
...
void func_302(var uParam0, int iParam1, struct<3> Param2, float fParam5){
func_303(uParam0);
...
int func_304(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7){
if(func_305(uParam0, iParam1, Param2, fParam5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_305(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_153(iParam1)){
