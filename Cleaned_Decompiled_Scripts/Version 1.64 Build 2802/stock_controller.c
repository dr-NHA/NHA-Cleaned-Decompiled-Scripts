...
iLocal_22=-1;
iLocal_26=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(2)) func_99();
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("stock_controller")) > 1) func_99();
Global_63346=1;
...
j < 3;
j=j + 1){
if(!Global_113648.f_20566.f_233[j /*69*/].f_1 < 11) Global_113648.f_20566.f_233[j /*69*/].f_1=0;
}
func_80();
...
if(ENTITY::IS_ENTITY_DEAD(playerPed, false)) return;
dlcVehicleIndex=func_3(playerPed);
if(FILES::GET_DLC_VEHICLE_FLAGS(dlcVehicleIndex)){
func_2(89, 1);
if(ENTITY::GET_ENTITY_SPEED(dlcVehicleIndex) > 5f) func_2(90, 1);
}
return;
}
...
float outValue;
float num3;
if(!NETWORK::NETWORK_IS_SIGNED_ONLINE() || !unk_0x8BD41D5945F5762B()) return 1;
i=0;
num=0;
for (i=0;
i < 80;
...
if(outValue > Global_55661[i /*36*/].f_31) Global_55661[i /*36*/].f_31=outValue;
if(outValue < Global_55661[i /*36*/].f_32) Global_55661[i /*36*/].f_32=outValue;
num2=num2 + outValue;
}
num2=num2 / 5f;
num3=func_6(i);
if(num3 > Global_55661[i /*36*/].f_31) Global_55661[i /*36*/].f_31=num3;
if(num3 < Global_55661[i /*36*/].f_32) Global_55661[i /*36*/].f_32=num3;
...
if(func_10(74) || func_10(75)) num=num * 0.95f;
if(func_10(14)) num=num * 0.98f;
if(func_10(16)) num=num * 0.98f;
if(func_10(48)) num=num * 0.98f;
if(func_10(24)) num=num * 0.98f;
if(func_10(27)) num=num * 0.5f;
}
break;
case 66:
if(func_10(49)) num=num * 0.5f;
if(func_10(10)) num=num * 0.95f;
break;
case 59:
if(func_10(93))if(!func_10(47)) num=num * 0.9f;
if(func_10(38))if(!func_10(28)) num=num * 0.9f;
if(func_10(84))if(!func_10(28)) num=num * 0.9f;
break;
case 69:
if(func_10(90))if(!func_10(14)) num=num * 0.7f;
break;
case 16:
if(func_10(28)) num=num * 2f;
break;
case 52:
if(func_10(93))if(!func_10(28)) num=num * 0.6f;
break;
case 56:
if(func_10(61))if(!func_10(49)) num=num * 0.5f;
break;
}
...
if(num2 > -1) num=func_9(Global_113648.f_20566.f_452[num2], Global_113648.f_20566.f_461[num2]);
if(num > 1f){
num3=num - 1f;
num4=iParam0;
num5=func_8(0, num4);
...
if(IS_BIT_SET(iParam1, 1))if(func_10(21)) return 1f;
...
l=func_21(*uParam0);
m=func_20(*uParam0);
if(iParam4==0 && iParam3==0 && iParam2==0 && iParam1==0) return;
if(iParam1 < 0) return;
if(iParam2 < 0) return;
if(iParam3 < 0) return;
if(iParam4 < 0) return;
...
if(iParam1 < 1 || iParam1 > func_19(num, num2)) return;
...
var func__26(BOOL bParam0, var uParam1, var uParam2) // Position - 0xF0F{
...
int i;
if(Global_113648.f_20566.f_442 < 1) return;
for (i=0;
i < 8;
i=i + 1){
...
if(func_36(num, 0, 8)){
func_16(&iLocal_20, 8);
}elseif(func_36(num, 8, 16)){
func_16(&iLocal_20, 16);
}elseif(func_36(num, 16, 24)){
func_16(&iLocal_20, 0);
...
if(func_31(&iLocal_20, true, 8)) return false;
...
func_17(&num, num3);
func_18(&num, 0);
if(func_32(func_37(), num)) func_35(&num, 0, 0, 0, 1, 0, 0);
for (i=0;
func_32(num, *uParam0) && i < 24;
i=i + iParam2){
...
int num;
int num2;
if(!func_33(iParam1) || !func_33(iParam0)) return 1;
num=func_25(iParam0);
...
if(num6 < 1 || num6 > func_19(num5, num4)) return false;
return true;
}
...
if(iParam1 < 0 || iParam1 >=24) return false;
if(iParam2==24) iParam2=0;
if(iParam2 < 0 || iParam2 >=24) return false;
if(iParam1==iParam2) return true;
flag=iParam2 < iParam1;
num=iParam1;
num2=iParam2;
if(flag) num2=24;
if(iParam0 >=num && iParam0 < num2) return true;
...
if(Global_59104[i /*7*/].f_5 < num) outValue=num;
else outValue=Global_59104[i /*7*/].f_5;
}
...
i < 80;
i=i + 1){
if(!Global_55661[i /*36*/].f_8)if(!Global_55661[i /*36*/].f_10==0f) Global_55661[i /*36*/].f_11=Global_55661[i /*36*/].f_10;
if(i % 40==0){
SYSTEM::WAIT(0);
func_68();
}}
...
if(!Global_55661[i /*36*/].f_8){
num3=0f;
if(Global_55661[i /*36*/].f_10 !=0f) num3=num3 + ((0.02f * Global_55661[i /*36*/].f_9 * Global_55661[i /*36*/].f_10) - Global_55661[i /*36*/].f_9);
...
if(num3 < 0f) num3=num3 * Global_58816[num2 /*7*/].f_2;
elseif(num3 > 0f) num3=num3 * Global_58816[num2 /*7*/].f_1;
...
}elseif(Global_55661[i /*36*/].f_9 < Global_58816[num2 /*7*/].f_4){
...
i < 204;
i=i + 1){
if(!Global_59104[i /*7*/])if(Global_59104[i /*7*/].f_2) Global_59104[i /*7*/].f_5=Global_59104[i /*7*/].f_5 + Global_59104[i /*7*/].f_6;
}
return;
}
...
if(Global_55661[i /*36*/].f_31 > Global_113648.f_20566.f_146[num]) Global_113648.f_20566.f_146[num]=Global_55661[i /*36*/].f_31;
if(Global_113648.f_20566.f_189[num]==0f) Global_113648.f_20566.f_189[num]=Global_55661[i /*36*/].f_32;
elseif(Global_55661[i /*36*/].f_32 < Global_113648.f_20566.f_189[num]) Global_113648.f_20566.f_189[num]=Global_55661[i /*36*/].f_32;
num=num + 1;
}}}
return;
}
...
float num9;
float num10;
if(Global_55661[iParam0 /*36*/].f_8) return 1f;
num=func_8(0, iParam0);
num2=func_8(1, iParam0);
num3=func_8(2, iParam0);
if(num + num2 + num3 < 1) return 1f;
num4=1000000000;
num5=Global_60536[0] + Global_60536[1] + Global_60536[2];
if(Global_60536[0] > num4) return 0f;
if(Global_60536[1] > num4) return 0f;
if(Global_60536[2] > num4) return 0f;
value=0f;
for (i=0;
i < 10;
i=i + 1){
num6=func_8(0, i);
if(num6 > 0) value=value + (func_6(func_44(0, i)) * (float)num6);
if(func_8(1, i) > 0) value=value + (func_6(func_44(1, i)) * (float)num6);
if(func_8(2, i) > 0) value=value + (func_6(func_44(2, i)) * (float)num6);
}
num7=SYSTEM::FLOOR(value) + num5;
num8=700000000;
if(num7 > num4) return 0f;
if(num7 < num8) return 1f;
num9=SYSTEM::TO_FLOAT(num7 - num8);
num10=SYSTEM::TO_FLOAT(num4 - num8);
if(!num10 > 0f) return 1f;
...
if(playerWantedLevel==0) func_2(75, 1);
playerPed=PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX());
...
var unk;
if(Global_78558) return VEHICLE::IS_VEHICLE_STOLEN(veParam0);
if(func_61(veParam0, &unk)) return false;
if(func_60(veParam0)) return false;
if(func_59(veParam0)) return false;
return true;
}
...
if(!func_63(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false)) *uParam0={
...
if(iLocal_21==-15) return false;
if(func_34(iLocal_21)){
if(func_31(&iLocal_21, true, 8)) return false;
...
func_78(eventData);
flag=true;
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(ENTITY::DOES_ENTITY_EXIST(eventData))if(!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(eventData)) flag=false;
else flag=false;
if(flag){
...
elseif(ENTITY::IS_ENTITY_A_VEHICLE(eventData)){
if(func_73(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(eventData))) func_2(3, 1);
func_72(ENTITY::GET_ENTITY_MODEL(eventData));
}
elseif(ENTITY::IS_ENTITY_AN_OBJECT(eventData)){
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL && pedIndexFromEntityIndex !=PLAYER::PLAYER_PED_ID())if(ENTITY::IS_ENTITY_DEAD(eventData, false) || (float)ENTITY::GET_ENTITY_HEALTH(eventData) < 0.5f * (float)PED::GET_PED_MAX_HEALTH(pedIndexFromEntityIndex))if(ENTITY::IS_ENTITY_A_PED(eventData) && PED::IS_PED_HUMAN(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(eventData)))if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) func_70(3);
func_2(111, 1);
func_2(124, 1);
if(FILES::GET_DLC_VEHICLE_FLAGS(eventData)) func_2(130, 1);
}
elseif(ENTITY::IS_ENTITY_A_VEHICLE(eventData)){
...
if(hParam0==joaat("taxi")) func_2(100, 1);
func_2(111, 1);
return;
}
BOOL func_73(Vehicle veParam0) // Position - 0x459A{
if(VEHICLE::GET_VEHICLE_MOD_KIT(veParam0) >=0){
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 0) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 3) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 4) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 5) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 6) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 7) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 10) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 11) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 12) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 13) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 14) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 15) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 16) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 23) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 24) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 1) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 2) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 8) !=-1) return true;
if(VEHICLE::GET_VEHICLE_MOD(veParam0, 9) !=-1) return true;
if(VEHICLE::IS_TOGGLE_MOD_ON(veParam0, 18)) return true;
if(VEHICLE::IS_TOGGLE_MOD_ON(veParam0, 22)) return true;
if(!VEHICLE::GET_VEHICLE_TYRES_CAN_BURST(veParam0)) return true;
}
return false;
}
...
if(FILES::GET_DLC_VEHICLE_FLAGS(eParam0)) func_2(129, 1);
if(!func_75(eParam0)) return;
func_2(111, 1);
...
if(iLocal_24==3) func_2(127, 1);
}
return;
}
BOOL func_75(Entity eParam0) // Position - 0x47B6{
Ped pedSourceOfDeath;
if(!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(eParam0)) return false;
pedSourceOfDeath=PED::GET_PED_SOURCE_OF_DEATH(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(eParam0));
if(func_3(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()))==pedSourceOfDeath) return true;
return false;
}
...
entityModel=ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn);
if(func_81(entityModel, MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_27, uLocal_30, false))) uLocal_30={
uLocal_27 
};
}
return;
...
if(Global_55661[i /*36*/].f_9 <=0f) value=0;
...
switch (iParam0){
case 0:
if(Global_113648.f_20566[i]==iParam1)if(Global_113648.f_20566.f_22[i] > 0) return Global_113648.f_20566.f_22[i];
break;
case 1:
if(Global_113648.f_20566.f_33[i]==iParam1)if(Global_113648.f_20566.f_55[i] > 0) return Global_113648.f_20566.f_55[i];
break;
case 2:
if(Global_113648.f_20566.f_66[i]==iParam1)if(Global_113648.f_20566.f_88[i] > 0) return Global_113648.f_20566.f_88[i];
break;
}}
return 0;
}
...
Global_63208[num /*34*/][num3 /*11*/].f_1={
iParam0->f_1 
};
Global_63208[num /*34*/][num3 /*11*/].f_5={
iParam0->f_5 
};
...
for (i=Global_55661[num /*36*/].f_13;
i > 15;
i=i - 16){}
for (j=i - 10;
j < 0;
...
if(Global_55661[num /*36*/].f_14[num8] < Global_55661[num /*36*/].f_14[num9] && Global_55661[num /*36*/].f_14[num10] < Global_55661[num /*36*/].f_14[num9]) num4=num4 + 1;
if(Global_55661[num /*36*/].f_14[num8] > Global_55661[num /*36*/].f_14[num9] && Global_55661[num /*36*/].f_14[num10] > Global_55661[num /*36*/].f_14[num9]) num4=num4 + 1;
num8=num8 + 1;
if(num8==16) num8=0;
}
if(num5 < 0) num11=num11 / (float)num5;
if(num6 > 0) num12=num12 / (float)num6;
num13=num2 - num3;
if(num13 < 0f) num13=num13 * -1f;
switch (Global_60826[iParam0 /*14*/].f_11){
case 0:
if(num5 < 6) return false;
if(num11 < num3 * 0.04f) return false;
return true;
case 1:
if(num6 < 6) return false;
if(num12 < num3 * 0.04f) return false;
return true;
case 2:
if(num4 < 7) return false;
if(num13 > num3 * 0.01f) return false;
return true;
}
return false;
}
...
if(num < 42){
if(!Global_55661[i /*36*/].f_8){
if(Global_113648.f_20566.f_103[num] > 0f) Global_55661[i /*36*/].f_9=Global_113648.f_20566.f_103[num];
if(Global_113648.f_20566.f_146[num] > 0f) Global_55661[i /*36*/].f_31=Global_113648.f_20566.f_146[num];
if(Global_113648.f_20566.f_189[num] > 0f) Global_55661[i /*36*/].f_32=Global_113648.f_20566.f_189[num];
num=num + 1;
}
if(Global_55661[i /*36*/].f_32 > 0f && Global_55661[i /*36*/].f_31 > 0f && Global_55661[i /*36*/].f_9 > 0f){
num2=Global_55661[i /*36*/].f_9;
if(num2 > Global_55661[i /*36*/].f_31) Global_55661[i /*36*/].f_31=num2;
if(num2 < Global_55661[i /*36*/].f_32) Global_55661[i /*36*/].f_32=num2;
j=0;
...
if(num10 < 0.2f) num6=num10 / 0.2f;
num11=(Global_55661[i /*36*/].f_9 - Global_55661[i /*36*/].f_32) / num3;
if(num11 < 0.2f) num7=num11 / 0.2f;
...
if(j==15) Global_55661[i /*36*/].f_14[j]=Global_55661[i /*36*/].f_9 * num14;
num4=num4 + Global_55661[i /*36*/].f_14[j];
...
i < 80;
i=i + 1){
if(!Global_55661[i /*36*/].f_8) Global_55661[i /*36*/].f_9=MISC::GET_RANDOM_FLOAT_IN_RANGE(15f, 290f);
}
i=0;
j=0;
for (j=0;
...
startRange=0.85f;
endRange=1.15f;
if(Global_55661[i /*36*/].f_9 < 5f) startRange=1.1f;
elseif(Global_55661[i /*36*/].f_9 < 10f) startRange=0.95f;
elseif(Global_55661[i /*36*/].f_9 > 285f) endRange=0.97f;
elseif(Global_55661[i /*36*/].f_9 > 270f) endRange=1.05f;
...
func_96(59, "GRU_P_RF_H" /*GruppeSechs unsteadyifinvestors decide whether to join in.*/, "GRU_P_RF_C", 2, 0);
