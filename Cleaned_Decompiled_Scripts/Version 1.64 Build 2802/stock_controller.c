...
STATS::STAT_GET_FLOAT(uVar2, &(Global_55661[iVar0 /*36*/].f_9), -1);
if(Global_55661[iVar0 /*36*/].f_9 > 0f){
fVar3=0f;
STATS::STAT_COMMUNITY_GET_HISTORY(uVar2, 0, &(Global_55661[iVar0 /*36*/].f_33));
...
while (iVar4 < 4){
fVar5=0f;
STATS::STAT_COMMUNITY_GET_HISTORY(uVar2, iVar4 + 1, &fVar5);
...
iVar0=0;
while (iVar0 < 8){
if(!MISC::IS_BIT_SET(Global_113648.f_20566.f_461[iVar0], 1)){
...
func_16(&iLocal_20, 8);
}elseif(func_36(iVar0, 8, 16)){
func_16(&iLocal_20, 16);
}elseif(func_36(iVar0, 16, 24)){
func_16(&iLocal_20, 0);
...
}elseif(Global_55661[iVar0 /*36*/].f_9 < Global_58816[iVar4 /*7*/].f_4){
...
}elseif(Global_55661[iVar1 /*36*/].f_32 < Global_113648.f_20566.f_189[iVar0]){
Global_113648.f_20566.f_189[iVar0]=Global_55661[iVar1 /*36*/].f_32;
}
iVar0++;
}}
...
if(MISC::IS_BIT_SET(Global_77348.f_555[0 /*21*/].f_9, 10) && Global_77348.f_555[0 /*21*/].f_4==ENTITY::GET_ENTITY_MODEL(iParam0)){
*uParam1=iVar0;
return 1;
}}}
iVar0++;
...
if(func_81(iVar1, MISC::GET_DISTANCE_BETWEEN_COORDS(Local_27, Local_30, 0))){
Local_30={
Local_27 
};
}}}
...
STATS::STAT_SET_INT(Global_58542[iVar1 /*7*/].f_3[iParam0], iVar2, 1);
}}
iVar0++;
}}
...
Global_63208[iVar0 /*34*/][iVar3 /*11*/].f_1={
uParam0->f_1 
};
Global_63208[iVar0 /*34*/][iVar3 /*11*/].f_5={
uParam0->f_5 
};
...
fVar2=1.1f;
}elseif(Global_55661[iVar0 /*36*/].f_9 < 10f){
fVar2=0.95f;
}elseif(Global_55661[iVar0 /*36*/].f_9 > 285f){
fVar3=0.97f;
}elseif(Global_55661[iVar0 /*36*/].f_9 > 270f){
fVar3=1.05f;
}
