...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Local_85.f_2[iVar0], iVar1);
}
...
MISC::CLEAR_AREA(Local_138, 5f, 1, 0, 0, 0);
...
iVar104=DECORATOR::DECOR_GET_INT(uVar0, "MPBitset");
}
MISC::SET_BIT(&iVar104, 11);
DECORATOR::DECOR_SET_INT(uVar0, "MPBitset", iVar104);
}
...
if(func_80(ENTITY::GET_ENTITY_MODEL(uParam0))){
if(uParam1->f_9[44]==2){
...
if(uParam1->f_9[16]==5){
VEHICLE::SET_VEHICLE_DAMAGE_SCALE(uParam0, (Global_262145.f_21747 + 0.05f));
}
else{
VEHICLE::SET_VEHICLE_DAMAGE_SCALE(uParam0, Global_262145.f_21747);
}
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0)){
if(GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(uParam0, 0) || func_52(uParam0)){
return 1;
}}
return 0;
}
...
iVar1=iParam0;
return MISC::IS_BIT_SET(uVar0, func_65(iVar1));
}
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_102(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_102(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_102(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_102(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_102(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_102(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_99(uParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_98()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_102(iVar7 + 1))){
...
var func__87(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(func_94(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
return 1;
}}elseif(func_118(func_255(iVar1), Param0, fParam3, iParam4, 1036831949)){
return 1;
}}elseif(Global_2648605.f_261[iVar0]){
if(func_118(Global_2648605.f_131[iVar0 /*3*/], Param0, fParam3, iParam4, 1036831949)){
return 1;
}}elseif(func_329(iVar1, 0, 0)){
...
var func__140(var uParam0, var uParam1, var uParam2){
char cVar0[64];
var uVar16;
StringCopy(&cVar0, "", 64);
...
if(!func_173(Var1)){
Var1={
func_168(Var1, &fVar4, iVar9, uParam2->f_9, *uParam2, iVar10, uParam2->f_11, uParam2->f_34, &bVar11, bVar12, 1, uParam2->f_51, uParam2->f_60) 
};
...
elseif(func_199(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_117(Var1, fVar4, uParam2->f_34, 1, 1, 0, 0, 0, 0)){
iVar23=1;
}
}
...
return 1;
}}elseif(SYSTEM::VDIST(func_255(iVar1), Param0) < 1f){
return 1;
}}elseif(Global_2648605.f_261[iVar0]){
if(SYSTEM::VDIST(Global_2648605.f_131[iVar0 /*3*/], Param0) < fParam3){
return 1;
}}elseif(func_329(iVar1, 0, 1)){
...
*uParam5={
func_168(*uParam5, fParam6, iParam9, uParam7->f_9, *uParam7, iParam8, uParam7->f_11, uParam7->f_34, &bParam13, 0, 0, uParam7->f_51, uParam7->f_60) 
};
if(!func_173(*uParam5)){
iVar0=999;
return;
...
while (iVar5 <=31){
iVar1=iVar5;
if(((!func_329(iVar1, 1, 1) || func_31(iVar1, 0)) || MISC::IS_BIT_SET(Global_2657589[iVar1 /*466*/].f_199, 2)) || func_155(iVar1)){
...
if(func_118(Param0, ENTITY::GET_ENTITY_COORDS(Global_1058070.f_233[iVar0], 1), ENTITY::GET_ENTITY_HEADING(Global_1058070.f_233[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_1058070.f_233[iVar0]), 0.5f)){
return 1;
}}
iVar0++;
}}
...
if(func_118(Param0, ENTITY::GET_ENTITY_COORDS(Global_1058070.f_119[iVar0], 1), ENTITY::GET_ENTITY_HEADING(Global_1058070.f_119[iVar0]), ENTITY::GET_ENTITY_MODEL(Global_1058070.f_119[iVar0]), 0.5f)){
return 1;
}}
iVar0++;
}}}
...
Vector3 func__168(struct<3> Param0, var uParam3, int iParam4, bool bParam5, struct<3> Param6, int iParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16){
struct<3> Var0;
var uVar3;
var uVar4;
var uVar5;
...
if(bParam1){
*uParam0={
func_184(*uParam0, Global_2635559.f_26.f_10, Global_2635559.f_26.f_13, Global_2635559.f_26.f_16, Global_2635559.f_26.f_17, 1036831949, 0) 
};
}}}
return bVar0;
}
...
Vector3 func__184(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, int iParam10, float fParam11, bool bParam12){
int iVar0;
struct<3> Var1;
switch (iParam10){
case 0:
...
case 0:
*uParam0={
func_184(*uParam0, *uParam1, 0f, 0f, 0f, (uParam1->f_6 + (IntToFloat(Global_2635559.f_2735) * uParam1->f_8)), 0, fParam2, bParam3) 
};
break;
case 1:
*uParam0={
func_184(*uParam0, *uParam1, uParam1->f_3, 0f, 1, fParam2, bParam3) 
};
break;
case 2:
*uParam0={
func_184(*uParam0, *uParam1, uParam1->f_3, uParam1->f_6, 2, fParam2, bParam3) 
};
break;
}}else{
switch (uParam1->f_10){
...
bVar12=true;
}}elseif(func_199(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_117(Var3, fVar6, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0)){
bVar12=true;
}
}
if(bVar12){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_255(iVar1), Param0, 1) < fParam3){
return 1;
}}
}}}}}
iVar0++;
...
break;
}}elseif(func_229(Param0, &iVar2, &iVar6) || (func_206(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam3)))){
func_248();
iVar0=0;
while (iVar0 < iVar2){
if(iVar2[iVar0] > 1000){
...
return 1;
}elseif(func_191(&Param0, 0, 1, 0, 1)){
return 1;
}}else{
iVar0=func_243(Param0, 1008981770);
if(iVar0 > -1){
Var1={
func_242(&(Global_2635559.f_45[iVar0 /*12*/])) 
};
if(!func_191(&Var1, 0, 0, 0, 1)){
if(!func_191(&Param0, 0, 0, 0, 1)){
return 1;
...
func_264();
}}elseif(func_266(PLAYER::PLAYER_ID())){
func_262();
}}
...
iVar0=(iParam1 / 32);
iVar1=(iParam1 % 32);
return MISC::IS_BIT_SET(Local_93[iParam0 /*4*/].f_2[iVar0], iVar1);
}
...
if(!func_268(NETWORK::PARTICIPANT_ID(), 1)){
func_279(1);
}}elseif(func_268(NETWORK::PARTICIPANT_ID(), 1)){
func_278(1);
}
...
void func_294(){
if(func_300()){
if(!HUD::DOES_BLIP_EXIST(uLocal_142)){
uLocal_142=HUD::ADD_BLIP_FOR_ENTITY(func_16());
HUD::SET_BLIP_SPRITE(uLocal_142, func_299());
func_296(&uLocal_142, func_298());
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_142, func_295());
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_142)){
HUD::REMOVE_BLIP(&uLocal_142);
}}
...
uVar1=NETWORK::NETWORK_GET_PLAYER_INDEX(iLocal_126[iVar0]);
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(uLocal_135[iVar0], iVar1);
}
