...
void func_177(){
if((MISC::IS_BIT_SET(uLocal_105, 0) && Global_43257==15) && !func_209()){
if(iLocal_38==0){
if(!MISC::IS_BIT_SET(uLocal_105, 1)){
if(!func_78(PLAYER::PLAYER_PED_ID(), Local_106, 5f, 1)){
...
return 1;
}elseif(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1383.21f, -2068.02f, 51.87057f) <=160000f){
if(func_13()){
func_71(29);
}
return 1;
...
int iVar0;
bool bVar1;
if(((((((Global_43257==15 && iLocal_37 !=3) && MISC::IS_BIT_SET(uLocal_105, 5)) && !func_209()) && Global_78555==-1) && !func_234()) && !func_86(9)) || func_105(35)){
func_233();
func_231();
switch (iLocal_39){
case 0:
