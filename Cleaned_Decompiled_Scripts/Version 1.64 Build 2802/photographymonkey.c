...
iLocal_461=MISC::IS_BIT_SET(Global_8254, 28);
if(iLocal_48 !=-1){
if(fVar0 < fLocal_46){
Var1={
Local_455 
...
if(bVar16){
func_96(iLocal_48, 1);
STATS::STAT_SET_INT(joaat("num_hidden_packages_6"), func_93(), 1);
bLocal_460=true;
if(func_106()){
func_6();
}
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_24(iParam0));
if(iVar57 > iVar56){
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_24(iParam2));
...
return MISC::IS_BIT_SET(Global_113648.f_10051.f_135[iVar0], uVar1);
}
...
func_95(iParam0, &iVar0, &uVar1);
if(bParam1){
MISC::SET_BIT(&(Global_113648.f_10051.f_135[iVar0]), uVar1);
}else{
...
fVar9=0.51f;
fVar10=0.35f;
}elseif(iParam0==29 && Var0.f_2 <=36f){
Var3={
...
fVar13=(fVar10 / 2f);
Var14={
func_101(func_102(Var6, 0f, 0f, -1f)) 
};
Var17={
func_101(func_102(Var6, Var14)) 
};
*uParam1={
Var3 + Vector(fVar12, fVar12, fVar12) * Var14 + Vector(fVar13, fVar13, fVar13) * Var17 + Var6 * Vector(fVar11, fVar11, fVar11) 
};
*uParam2={
Var3 + Vector(fVar12, fVar12, fVar12) * -Var14 + Vector(fVar13, fVar13, fVar13) * Var17 + Var6 * Vector(fVar11, fVar11, fVar11) 
};
...
Vector3 func__101(struct<3> Param0){
float fVar0;
...
Vector3 func__102(struct<3> Param0, struct<3> Param3){
...
void func_107(){
if(bLocal_460){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_459)){
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_459, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
}
switch (iLocal_458){
case 0:
...
if(!func_113()){
uLocal_459=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
iLocal_462=MISC::GET_GAME_TIMER() + 5000;
iLocal_458++;
}}
break;
case 2:
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_459) || iLocal_462 < MISC::GET_GAME_TIMER()){
if(iLocal_462 < MISC::GET_GAME_TIMER()){
bLocal_460=false;
iLocal_458=0;
}else{
...
break;
case 3:
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_459, "SHOW_BRIDGES_KNIVES_PROGRESS");
func_112("PM_TITLE");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_459, "SHARD_ANIM_OUT");
