...
while (true){
func_107();
if(func_106() && iLocal_47==0) iLocal_47=2;
...
if(bParam0==1) MISC::SET_BIT(&Global_8254, 28);
...
if(bParam5) func_79(iParam0, iParam1, iParam2, false);
if(iParam6==1) func_8(iParam0, iParam1, iParam2, false);
return;
}

int func_8(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6E1{
Global_78341[1 /*14*/]={
func_10(iParam0, iParam1, iParam2, -1) 
};
if(IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_78341[1 /*14*/].f_6, 6)){
if(bParam3) func_9(iParam1, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 2, Global_78341[1 /*14*/].f_1, 0, 1);
else func_9(iParam1, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 2, Global_78341[1 /*14*/].f_1, 1, 0);
return 1;
}
return 0;
}
...
func_78();
if(iParam0==joaat("Player_Zero")) func_60(iParam1, iParam2);
elseif(iParam0==joaat("Player_One")) func_41(iParam1, iParam2);
elseif(iParam0==joaat("Player_Two")) func_11(iParam1, iParam2);
...
if(iParam1==12){
if(!func_20(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_20(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
}elseif(iParam1==13){
}elseif(iParam1==14){
if(!func_20(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_20(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
...
if(func_9(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 1);
if(func_9(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 2);
if(!func_9(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 4);
}else{
MISC::SET_BIT(&(iParam0->f_6), 0);
...
if(iParam0 < 136) func_38(iParam0);
else func_37(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_23(3, iParam0, 242, -1);
return;
}
...
if(iParam0 < 107) func_57(iParam0);
elseif(iParam0 < 227) func_56(iParam0);
else func_55(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_23(3, iParam0, 318, -1);
return;
}
...
if(iParam0 < 60) func_75(iParam0);
else func_74(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_23(3, iParam0, 181, -1);
return;
}
...
if(iParam2==-99) return;
switch (iParam0){
case joaat("Player_Zero"):
if(!bParam3 || IS_BIT_SET(Global_113648.f_7231[1], 0)) MISC::SET_BIT(&Global_113648.f_2365.f_539.f_3816[0 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
break;
case joaat("Player_Two"):
if(!bParam3 || IS_BIT_SET(Global_113648.f_7231[3], 0)) MISC::SET_BIT(&Global_113648.f_2365.f_539.f_3816[1 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
if(!bParam3 || IS_BIT_SET(Global_113648.f_7231[4], 0)) MISC::SET_BIT(&Global_113648.f_2365.f_539.f_3816[2 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
break;
}
return;
}
...
break;
case 12:
if(iParam2==2) func_80(iParam0, 14, 17, true, 0);
break;
}
break;
}}
...
i < itemHash.f_3;
i=i + 1){
if(FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_1, i, &outPropVariant) && outPropVariant.f_2 !=-1)if(outPropVariant !=0 && outPropVariant !=-1 && outPropVariant !=joaat("0")) uParam0->[outPropVariant.f_2]=func_83(iParam1, outPropVariant, 14, num);
...
if(unk.f_1==hParam1) return func_86(iParam0) + i;
}}elseif(iParam2==13){}elseif(iParam2==14){
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, true, -1, -1);
shopPedQueryPropIndex=FILES::GET_SHOP_PED_QUERY_PROP_INDEX(hParam1);
if(shopPedQueryPropIndex !=-1) return func_85(iParam0) + shopPedQueryPropIndex;
}else{
...
if(shopPedQueryComponentIndex !=-1) return func_84(iParam0, func_24(iParam2)) + shopPedQueryComponentIndex;
}
return -99;
}
...
if(IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_78341[1 /*14*/].f_6, 6)){
if(bParam3) func_9(iParam1, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 0, Global_78341[1 /*14*/].f_1, 1, 0);
else func_9(iParam1, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 0, Global_78341[1 /*14*/].f_1, 0, 1);
return 1;
}
return 0;
}
...
if(bParam1) MISC::SET_BIT(&Global_113648.f_10051.f_135[num], offset);
else MISC::CLEAR_BIT(&Global_113648.f_10051.f_135[num], offset);
return;
}
...
float screenX;
float screenY;
if(GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(vParam0, &screenX, &screenY))if(screenX >=fParam3 && screenX <=fParam4)if(screenY >=fParam3 && screenY <=fParam4) return true;
return false;
}
...
num=0.51f;
num2=0.35f;
}elseif(iParam0==29 && entityCoords.f_2 <=36f){
unk3={
-95.4013f, -744.5073f, 37.1846f 
};
unk6={
0.9047f, 0.4261f, 0f 
};
...
num5=num2 / 2f;
unk9={
func_101(func_102(unk6, 0f, 0f, -1f)) 
};
unk12={
func_101(func_102(unk6, unk9)) 
};
*uParam1={
unk3 + ({
num4, num4, num4 
...
Vector3 func__101(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1AE2D{
float num;
...
Vector3 func__102(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1AE47{
...
int num2;
int i;
if(Global_113648.f_10051.f_135[1]==-1) return true;
func_95(49, &num, &num2);
if(num > 0){
for (i=0;
i <=num - 1;
i=i + 1){
if(Global_113648.f_10051.f_135[i] !=-1) return false;
}}
if(num2==31) return Global_113648.f_10051.f_135[num]==-1;
...
if(bLocal_460){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(plLocal_459)) GRAPHICS::DRAW_SCALEFORM_MOVIE(plLocal_459, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
switch (iLocal_458){
case 0:
...
break;
case 5:
if(iLocal_462 < MISC::GET_GAME_TIMER() || CAM::IS_SCREEN_FADED_OUT() || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) || func_113() || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_111() || func_110()) iLocal_458=iLocal_458 + 1;
break;
case 6:
...
case 7:
if(iLocal_462 < MISC::GET_GAME_TIMER()){
if(func_109(62) && !func_109(24)) _DISPLAY_HELP_TEXT("PM_CLOTHES" /*New clothes have been added to Trevor's wardrobe.*/, 10000);
bLocal_460=false;
}
break;
}}
