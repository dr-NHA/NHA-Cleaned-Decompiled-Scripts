...
iLocal_308=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_309){
if(fLocal_310 < fVar1){
...
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_297, func_75(), func_45(0), 1000f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, uLocal_297, func_44(0), func_75(), 1000f, -8f, 0, 1148846080);
if(!PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_297)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_297, 1);
}
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
...
iLocal_293=4;
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_297) > 0.35f){
if(!iLocal_295){
...
case 0:
Local_302={
1546.069f, 3821.222f, 29.9139f 
};
fLocal_305=235.002f;
break;
case 1:
Local_302={
2515.749f, 3783.202f, 52.0043f 
};
fLocal_305=0f;
break;
case 2:
Local_302={
1902.893f, 4921.095f, 47f 
};
fLocal_305=69.8293f;
break;
case 3:
Local_302={
-194.0443f, 3638.538f, 63.4521f 
};
fLocal_305=156.1723f;
break;
case 4:
Local_302={
560.8397f, 2738.103f, 41.2029f 
};
fLocal_305=91.5686f;
break;
case 5:
Local_302={
-455.5521f, 1598.692f, 358.1478f 
};
fLocal_305=270f;
break;
}
...
uLocal_297=PED::CREATE_SYNCHRONIZED_SCENE(Var9.f_0, Var9.f_1, Var9.f_2, 0f, 0f, fLocal_305, 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_297, func_75(), sLocal_300, 1000f, -4f, 0, 0, 1148846080, 0);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_297)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_297, 0);
}
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
uLocal_296=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
...
STATS::STAT_SET_INT(joaat("num_sh_gas_huffed"), iLocal_299 + 1, 1);
}
iLocal_295=0;
...
fVar4=MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Local_273[0 /*3*/], 1);
fVar5=MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Local_273[1 /*3*/], 1);
if(fVar4 < fVar5){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_41)){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_41, 1) 
};
...
return 1;
}}elseif(iLocal_40==joaat("p_w_grass_gls_s")){
if(func_65(ENTITY::GET_ENTITY_COORDS(iLocal_41, 0), func_69(), 5f, 0)){
return 1;
}}elseif(iLocal_40==joaat("prop_mr_raspberry_01")){
if(func_65(ENTITY::GET_ENTITY_COORDS(iLocal_41, 0), func_69(), 5f, 0)){
return 1;
}}elseif(INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_FROM_ENTITY(iParam0)){
return 1;
}}
return 0;
}
