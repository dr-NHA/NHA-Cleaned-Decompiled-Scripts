...
if(!iLocal_730){
if(fVar1 < fLocal_729){
}elseif(func_3(&uLocal_71, "PRSAUD", &Local_725, 3, 0, 0, 0)){
iLocal_730=1;
}}}}
Var2={
...
Var5={
ENTITY::GET_ENTITY_COORDS(iLocal_237[iVar0], 1) 
};
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, Local_273 + Local_284[iParam1 /*3*/], fVar3, -1, (fLocal_294[iParam1] * 0.1f), 0, 1193033728);
...
Local_284[iParam1 /*3*/]={
Var5 - Local_273 * Vector(4f, 4f, 4f) 
};
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_691[iParam1 /*16*/]))){
PED::SET_PED_MOVEMENT_CLIPSET(iParam0, &(Local_691[iParam1 /*16*/]), 1048576000);
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, Local_273 + Local_284[iParam1 /*3*/], 1f, -1, 0.25f, 0, 1193033728);
iLocal_240[iParam1]=1;
}else{
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_237[iParam1], 1);
...
PED::SET_PED_SUFFERS_CRITICAL_HITS(iLocal_237[iParam1], 0);
PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 64, 1);
PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, 1);
PED::SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, 1);
iVar11=0;
while (iVar11 < iLocal_253){
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_253[iVar11], 0);
OBJECT::SET_OBJECT_TARGETTABLE(iLocal_253[iVar11], 0);
iVar11++;
}
}
if(!func_31(iVar9, 16)){
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar11], iLocal_724, &(Local_592[iVar11 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
}}
iVar11++;
}
Local_284[iParam1 /*3*/]={
...
break;
case 1:
if(!PED::IS_PED_GROUP_MEMBER(iLocal_237[iParam1], uLocal_252)){
if(!PED::DOES_GROUP_EXIST(uLocal_252)){
uLocal_252=PED::CREATE_GROUP(0);
}
if(iParam1==0){
PED::SET_PED_AS_GROUP_LEADER(iLocal_237[iParam1], uLocal_252);
}else{
...
TASK::TASK_WANDER_IN_AREA(iParam0, Local_273 + Local_284[iParam1 /*3*/], fLocal_294[iParam1], 1077936128, 1086324736);
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar16], iLocal_724, &(Local_592[iVar16 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
}
}
iVar16++;
}}
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_237[iParam1], PLAYER::PLAYER_PED_ID(), 1)){
}
bVar18=false;
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar22], iLocal_724, &(Local_625[iVar22 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724)){
bVar23=false;
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_724) >=0.99f){
bVar23=false;
}
if(!bVar23){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724)){
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar27], iLocal_724, &(Local_658[iVar27 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
}
}
iVar27++;
}
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
iVar28=0;
while (iVar28 < iLocal_253){
if(iLocal_256[iVar28] !=0){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_658[iVar28 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar28], iLocal_724, &(Local_658[iVar28 /*16*/]), &cLocal_345, 8f, 8f, 0, 1148846080);
}
}
iVar28++;
}}
...
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar29], -8f, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_253[iVar29], 0);
ENTITY::SET_ENTITY_DYNAMIC(iLocal_253[iVar29], 1);
...
void func_33(var uParam0, char* sParam1, char* sParam2, int iParam3){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_34(iParam3), 0);
}
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_98011, &cLocal_345, &(Local_394[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
iLocal_240[iVar0]=0;
}
iVar0++;
}
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_98011, &(Local_559[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
}}
iVar0++;
}
...
while (iVar0 < iLocal_237){
if(!PED::IS_PED_INJURED(iLocal_237[iVar0])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_98010, &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
}
iVar0++;
}
iVar0=0;
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_98010, &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
}}
iVar0++;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_725)){
...
return 0;
}}}elseif(iParam1==func_40(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
while (iVar0 < iLocal_237){
if(iLocal_243[iVar0] !=0){
iLocal_237[iVar0]=PED::CREATE_PED(26, iLocal_243[iVar0], Local_273 + Local_277[iVar0 /*3*/], 0, 1, 1);
...
TASK::TASK_PLAY_ANIM(iLocal_237[iVar0], &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
}
iVar0++;
}
iVar0=0;
while (iVar0 < iLocal_253){
if(iLocal_256[iVar0] !=0){
iLocal_253[iVar0]=OBJECT::CREATE_OBJECT(iLocal_256[iVar0], Local_273 + Local_277[iVar0 /*3*/] + Local_259[iVar0 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_253[iVar0], Vector((fLocal_276 + fLocal_291[iVar0]), 0f, 0f) + Local_266[iVar0 /*3*/], 2, 1);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_526[iVar0 /*16*/]))){
ENTITY::PLAY_ENTITY_ANIM(iLocal_253[iVar0], &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, 1, 0, 0, 0, 0);
}}
iVar0++;
}}
...
Local_284[0 /*3*/]={
Vector(1.5806f, -1719.606f, -1291.475f) - Local_273 
};
Local_284[1 /*3*/]={
Local_284[0 /*3*/] 
};
...
Local_284[0 /*3*/]={
Vector(10.9545f, -1419.537f, -605.8271f) - Local_273 
};
fLocal_291[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
fLocal_294[0]=40f;
...
Local_284[0 /*3*/]={
Vector(28.2925f, -1451.728f, 507.6885f) - Local_273 
};
fLocal_291[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
fLocal_294[0]=40f;
