...
fLocal_729=0f;
iLocal_731=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_58();
SYSTEM::WAIT(0);
func_48();
func_47();
func_43();
...
switch (iLocal_69){
case 0:
if(func_38()) iLocal_69=1;
break;
case 1:
if(func_36()) iLocal_69=2;
break;
case 2:
if(func_2()) iLocal_69=3;
break;
case 3:
func_1();
break;
...
}elseif(_CONVERSATION_ADD_LINE(&uLocal_71, "PRSAUD", &uLocal_725, 3, 0, 0, 0)){
bLocal_730=true;
}}}}
entityCoords={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
if(SYSTEM::VDIST(entityCoords, uLocal_273) < 100f) return false;
for (i=0;
i < iLocal_237;
i=i + 1){
if(!PED::IS_PED_INJURED(iLocal_237[i])){
entityCoords2={
ENTITY::GET_ENTITY_COORDS(iLocal_237[i], true) 
};
if(SYSTEM::VDIST(entityCoords, entityCoords2) < 100f) return false;
}}
return true;
}
...
uLocal_284[iParam1 /*3*/]={
(entityCoords - uLocal_273) *{
4f, 4f, 4f 
}};
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_691[iParam1 /*16*/])) PED::SET_PED_MOVEMENT_CLIPSET(pedParam0, &uLocal_691[iParam1 /*16*/], 1048576000);
...
if(!func_31(flags, 4)) func_30(&flags, 4);
if(!func_31(flags, 1)) func_30(&flags, 1);
if(!func_31(ragdollBlockingFlags, 16)) func_30(&ragdollBlockingFlags, 16);
if(!func_31(ragdollBlockingFlags, 128)) func_30(&ragdollBlockingFlags, 128);
if(!func_31(ikFlags, 0)) func_30(&ikFlags, 0);
...
if(!func_31(ragdollBlockingFlags, 16)) PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_237[iParam1], false);
...
i < iLocal_253;
i=i + 1){
if(iLocal_256[i] !=0)if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_592[i /*16*/])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[i], iLocal_724, &uLocal_592[i /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
}
uLocal_284[iParam1 /*3*/]={
uLocal_277[iParam1 /*3*/] 
};
...
if(!PED::DOES_GROUP_EXIST(iLocal_252)) iLocal_252=PED::CREATE_GROUP(0);
if(iParam1==0) PED::SET_PED_AS_GROUP_LEADER(iLocal_237[iParam1], iLocal_252);
else PED::SET_PED_AS_GROUP_MEMBER(iLocal_237[iParam1], iLocal_252);
}
if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) !=1){
if(uLocal_294[iParam1]==0f) uLocal_294[iParam1]=SYSTEM::VMAG(uLocal_284[iParam1 /*3*/]) * 0.75f;
...
j < iLocal_240;
j=j + 1){
if(iParam1 !=j)if(iLocal_240[j] !=3 && iLocal_240[j] !=4) iLocal_240[j]=3;
}
...
break;
case 4:
if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_SMART_FLEE_PED) !=1) iLocal_240[iParam1]=1;
break;
case 10:
...
if(iLocal_70==288){
if(iLocal_731 <=0) iLocal_731=MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(10000, 15000);
if(AUDIO::IS_ANY_SPEECH_PLAYING(pedParam0)) iLocal_731=-1;
if(iLocal_731 > 0){
if(MISC::GET_GAME_TIMER() > iLocal_731){
_CONVERSATION_INITIALIZE_ACTOR(&uLocal_71, 3, iLocal_237[iParam1], "PIERWOMAN", 0, 1);
if(_CONVERSATION_ADD_LINE(&uLocal_71, "PRSAUD", "TRVS_STRUG", 3, 0, 0, 0)) iLocal_731=-1;
}
}}}else{
flags2=0;
...
ikFlags2=0;
if(iLocal_256[0]==joaat("p_trev_rope_01_s") || iLocal_256[1]==joaat("p_trev_rope_01_s")){
if(!func_31(flags2, 4)) func_30(&flags2, 4);
if(!func_31(flags2, 1)) func_30(&flags2, 1);
if(!func_31(ragdollBlockingFlags2, 16)) func_30(&ragdollBlockingFlags2, 16);
if(!func_31(ragdollBlockingFlags2, 128)) func_30(&ragdollBlockingFlags2, 128);
if(!func_31(ikFlags2, 0)) func_30(&ikFlags2, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_237[iParam1], true);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_237[iParam1], false);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_237[iParam1], false);
}
...
k < iLocal_253;
k=k + 1){
if(iLocal_256[k] !=0)if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_592[k /*16*/])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[k], iLocal_724, &uLocal_592[k /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
}}
...
flag=false;
if(ENTITY::GET_ENTITY_HEALTH(iLocal_237[iParam1]) < ENTITY::GET_ENTITY_MAX_HEALTH(iLocal_237[iParam1])) flag=true;
if(FILES::GET_DLC_VEHICLE_FLAGS(iLocal_237[iParam1])) flag=true;
if(flag){
...
case 11:
flag2=true;
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724)) flag2=false;
elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_724) >=0.99f) flag2=false;
if(!flag2){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724)) iLocal_724=PED::CREATE_SYNCHRONIZED_SCENE(uLocal_273, 0f, 0f, fLocal_276, 2);
...
m < iLocal_253;
m=m + 1){
if(iLocal_256[m] !=0)if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_658[m /*16*/])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[m], iLocal_724, &uLocal_658[m /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
}
...
n < iLocal_253;
n=n + 1){
if(iLocal_256[n] !=0)if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_658[n /*16*/])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[n], iLocal_724, &uLocal_658[n /*16*/], &uLocal_345, 8f, 1090519040, 0, 1148846080);
}}
break;
default:
break;
...
int i;
if(iLocal_256[0]==joaat("p_trev_rope_01_s") || iLocal_256[1]==joaat("p_trev_rope_01_s")) return false;
...
if(PED::IS_PED_IN_COMBAT(pedParam0, PLAYER::PLAYER_PED_ID())) return true;
for (i=0;
i < iLocal_237;
i=i + 1){
if(pedParam0 !=iLocal_237[i])if(iLocal_240[i] < 0 && ENTITY::DOES_ENTITY_EXIST(iLocal_237[i])) return true;
}
return false;
}
...
i < iLocal_253;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_253[i]))if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_559[i /*16*/])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[i], Global_98011, &uLocal_559[i /*16*/], &uLocal_345, 8f, -1000f, 0, 1148846080);
}
...
i < iLocal_237;
i=i + 1){
if(!PED::IS_PED_INJURED(iLocal_237[i])) TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[i], Global_98010, &uLocal_345, &uLocal_361[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
}
for (i=0;
i < iLocal_253;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_253[i]))if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_526[i /*16*/])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[i], Global_98010, &uLocal_526[i /*16*/], &uLocal_345, 8f, -1000f, 0, 1148846080);
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_725)){
...
if(func_21(14)) return 0;
if(MISC::GET_IS_PLAYER_IN_ANIMAL_FORM()) return 0;
if(!func_41(iParam0, func_42())) return 0;
...
}elseif(eParam1==func_40(Global_100402) && eParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_46();
return;
}
...
if(!STREAMING::HAS_CLIP_SET_LOADED(&uLocal_691[i /*16*/])) flag=false;
}}
for (i=0;
i < iLocal_256;
i=i + 1){
...
if(iLocal_243[i]==joaat("A_F_Y_Beach_01"))if(iLocal_70==288) PED::SET_PED_COMPONENT_VARIATION(iLocal_237[i], PV_COMP_ACCS, 1, 0, 0);
...
ENTITY::SET_ENTITY_ROTATION(iLocal_253[i],{
fLocal_276 + uLocal_291[i], 0f, 0f 
}
+ uLocal_266[i /*3*/], 2, true);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_526[i /*16*/])) ENTITY::PLAY_ENTITY_ANIM(iLocal_253[i], &uLocal_526[i /*16*/], &uLocal_345, 8f, true, false, false, 0, 0);
}}
return;
}
...
uLocal_284[0 /*3*/]={
8.2284f, -35.8652f, -1.0334f 
};
uLocal_284[1 /*3*/]={
28.4066f, -23.8848f, -0.7887f 
};
...
uLocal_277[0 /*3*/]={
-1.5421f, 0.8274f, -1.0288f 
};
uLocal_277[1 /*3*/]={
-0.9636f, 1.1757f, -1.0243f 
};
uLocal_284[0 /*3*/]={
0f, 0f, 0f 
};
...
if(clockHours < 8 || clockHours > 20) iLocal_243[0]=joaat("S_F_Y_Stripper_02");
else iLocal_243[0]=joaat("S_F_Y_Stripper_01");
...
if(func_32(entityCoords, 0f, 0f, 0f, false)) entityCoords={
...
i < iLocal_243;
i=i + 1){
if(iLocal_243[i] !=0) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_243[i]);
}
for (i=0;
i < iLocal_256;
i=i + 1){
if(iLocal_256[i] !=0) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_256[i]);
}
STREAMING::REMOVE_ANIM_DICT(&uLocal_345);
if(PED::DOES_GROUP_EXIST(iLocal_252)) PED::REMOVE_GROUP(iLocal_252);
