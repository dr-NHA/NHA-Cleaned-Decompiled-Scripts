...
if(STREAMING::HAS_ANIM_DICT_LOADED(&animDict)) func_78(uParam0, 4);
break;
case 4:
func_57(uParam0, &animDict);
...
if(uParam0->f_1.f_1==2) distanceToSlide=0.15f;
...
if(uParam0->f_1.f_1==3 || uParam0->f_1.f_1==4 || uParam0->f_1.f_1==1) return uParam0->f_1.f_2;
if(func_27())if(uParam0->f_1.f_1==2)if(num==0 || num==4) num=1;
elseif(uParam0->f_1.f_1==2)if(num==1 || num==2) num=3;
return num;
}
...
var func__30(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1226{
...
if(uParam0->f_6==-1)if(uParam0->f_1.f_1==2 || uParam0->f_1.f_1==0)if(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL)) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPOF_AC_PC_EXIT" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
...
Vector3 func__52(var uParam0) // Position - 0x1A2D{
var unk;
unk={
uParam0->f_16[uParam0->f_9 /*14*/].f_3 
};
if(func_27() && uParam0->f_1.f_1==0 || uParam0->f_1.f_1==1) unk.f_2=unk.f_2 - 4f;
return unk;
}


Vector3 func__53(var uParam0) // Position - 0x1A77{
...
if(uParam0->f_1.f_1==4)if(uParam0->f_1.f_3==5) TEXT_LABEL_ASSIGN_STRING(sParam1, "BASE_A", 16);
...
if(uParam0->f_1.f_1==2)if(func_27())if(randomIntInRange==0 || randomIntInRange==4) randomIntInRange=1;
elseif(randomIntInRange==1 || randomIntInRange==2) randomIntInRange=3;
if(uParam0->f_1.f_1==4)if(uParam0->f_9 >=118 && uParam0->f_9 <=122) randomIntInRange=2;
...
i < 10;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(sizeAndPeds[i]) && !PED::IS_PED_INJURED(sizeAndPeds[i]) && ENTITY::IS_ENTITY_VISIBLE(sizeAndPeds[i]) && func_76(sizeAndPeds[i], &uParam0->f_16[uParam0->f_9 /*14*/])) return true;
}
return false;
}
...
if(playerIndex !=PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))if(func_76(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->f_16[uParam0->f_9 /*14*/]) || func_71(playerIndex)==uParam0->f_9) return 1;
}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(iParam4==4 || iParam4==5)if(func_39(ENTITY::GET_ENTITY_HEADING(pedParam0), uParam1.f_2 - 180f, 45f)) return 1;
...
i < 5;
i=i + 1){
if(func_76(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9 /*14*/]) && func_75(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13)) return true;
...
if(!func_97(PLAYER::PLAYER_ID())) return true;
if(func_94(PLAYER::PLAYER_ID()) && CAM::IS_SCREEN_FADED_OUT()) return true;
...
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_90()) return true;
...
if(plParam0 !=_INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(func_96(plParam0) && !func_95(plParam0)) return true;
return false;
}
...
if(plParam0 !=_INVALID_PLAYER_INDEX()) return IS_BIT_SET(Global_2657589[plParam0 /*466*/].f_321.f_5, 25);
return false;
}
BOOL func_98() // Position - 0x29A3{
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("simeon_showroom_seating", -1, false, 0)) return false;
...
Vector3 func__101() // Position - 0x2AAA{
return 0.45f, -0.5f, 2f;
}


Vector3 func__102(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2ABD{
float num;
float num2;
float num3;
...
Vector3 func__104() // Position - 0x2B40{
...
case 0:
*uParam1={
-57.555f, -1089.778f, 25.386f 
};
*uParam2=70f;
break;
case 1:
*uParam1={
-57.255f, -1088.989f, 25.386f 
};
*uParam2=70f;
break;
case 2:
*uParam1={
-56.99f, -1088.208f, 25.386f 
};
*uParam2=70f;
break;
case 3:
*uParam1={
-55.26f, -1087.475f, 25.386f 
};
*uParam2=-20f;
break;
case 4:
*uParam1={
-54.484f, -1087.758f, 25.386f 
};
*uParam2=-20f;
break;
case 5:
*uParam1={
-53.706f, -1088.041f, 25.386f 
};
*uParam2=-20f;
break;
}
...
if(func_93())if(!bNoTerminate) func_2();
else return 0;
