...
if(*uParam6 > 6){
Global_95704=3;
}}elseif((FIRE::IS_EXPLOSION_IN_AREA(0, Param0, Param3) || FIRE::IS_EXPLOSION_IN_AREA(2, Param0, Param3)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Param0, Param3, joaat("weapon_grenadelauncher"), 1)){
Global_95704=5;
}}}
...
iVar1=func_11(iVar0);
if(iVar1==145){
}elseif(iVar1==func_22()){
}elseif(!func_33(uParam0, func_30(iVar1))){
}elseif(ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("bagger")){
Global_95704=6;
}else{
Global_95704=4;
}
...
}elseif(MISC::GET_GAME_TIMER() > *uParam6 + 10000){
Global_95704=1;
}}else{
*uParam6=-1;
}}else{
...
if(!func_31(iParam0)){}
if(!MISC::IS_BIT_SET(Global_113648.f_9087.f_2[27 /*3*/], 1)){
return 0;
}
return 1;
}
...
if(iVar4 !=226){
}elseif(!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iVar5)){
}else{
...
if(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, joaat("script_task_play_anim")) !=0){
