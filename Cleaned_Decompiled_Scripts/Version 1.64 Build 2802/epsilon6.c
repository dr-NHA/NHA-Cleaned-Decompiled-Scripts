...
iLocal_252=5;
Local_253={
1720.961f, 3254.951f, 42.5f 
};
Local_256={
1620.34f, 3228.95f, 37.65051f 
};
iLocal_263=-1;
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_156.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_156.f_0, 1);
}
if(func_484(PLAYER::PLAYER_PED_ID())){
uLocal_760=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_483(Local_95.f_28[0])){
Local_182.f_0=Local_95.f_28[0];
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_182.f_0, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_182.f_0, uLocal_760);
PED::SET_PED_CONFIG_FLAG(Local_182.f_0, 132, 1);
}
func_475();
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_261);
TASK::TASK_PLANE_MISSION(0, Local_156.f_0, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
TASK::TASK_PLANE_MISSION(0, Local_156.f_0, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_261, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_261);
TASK::TASK_PERFORM_SEQUENCE(Local_174.f_0, uLocal_261);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_261);
iLocal_191=2;
}
if(((((!func_22() && !PED::IS_PED_FLEEING(Local_174.f_0)) && !PED::IS_PED_RAGDOLL(Local_174.f_0)) && !PED::IS_PED_PRONE(Local_174.f_0)) && !PED::IS_PED_INJURED(Local_174.f_0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_174.f_0, 0)){
...
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_156.f_0, 501, "Eps6_Takeoff", 1);
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(Local_156.f_0, 1);
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_156.f_0, 1, 1, 0);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_261);
iLocal_243++;
}
...
iLocal_191=0;
iLocal_190=6;
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.f_0, 0)){
bLocal_233=true;
}
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
}}
...
Global_78341[1 /*14*/]={
func_106(iVar0, iParam1, iParam2, -1) 
};
...
Global_78341[1 /*14*/]={
func_106(iVar0, iParam1, uVar31[iParam1], -1) 
};
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_106(iVar10, iParam1, iParam2, -1) 
};
if(!func_96(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_106(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar28=9;
...
uVar28={
func_99(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_106(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_106(iVar10, iVar0, func_63(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_99(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_106(iVar10, 14, uVar69[iVar1], -1) 
};
func_73(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_89(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_106(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_84(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_83(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_98(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_98(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_98(iParam0));
if(iVar57 > iVar56){
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_98(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_98(iParam1))){
return 1;
}
return 0;
}
...
return 0;
}elseif(VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_156.f_0)){
func_526("Detected plane is stuck on roof");
return 0;
}elseif(VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_156.f_0) <=0f){
func_526("Detected plane engine health is <=0");
return 0;
}elseif(VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Local_156.f_0, 3, 30000)){
...
if(func_247(Local_174.f_0, 0, 1116471296, 1126825984, 1, 0, 0, 0) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_174.f_0, 1), 3f, 1)){
...
func_245();
}elseif((func_244(PLAYER::PLAYER_PED_ID(), Local_174.f_0, 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_174.f_0, 1), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_174.f_0)){
if(iLocal_190 !=5 && iLocal_190 !=3){
bLocal_233=true;
}
iLocal_264=5;
...
func_245();
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_174.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
if(func_484(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(func_484(iParam1)){
...
PED::SET_PED_KEEP_TASK(Local_174.f_0, 1);
TASK::TASK_SMART_FLEE_PED(Local_174.f_0, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
}}
...
if(bParam4){
return 0;
}elseif(func_248(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__252(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_256(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_256(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__256(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_256(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
int func_269(){
if(func_242()){
if(MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 0), joaat("weapon_stickybomb"), 10f, 0)){
...
if(func_242()){
if(!func_271()){
func_276(ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1), 200f, 12, 5000, 0, 0);
}
if(func_242()){
ENTITY::FREEZE_ENTITY_POSITION(Local_156.f_0, 0);
if(VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Eps6_LandingSkip")){
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_156.f_0)){
if(!func_271()){
func_526("Doing plane boost");
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_156.f_0, 500, "Eps6_LandingSkip", 1);
}
}}}}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_761);
break;
...
if(iLocal_263==-1){
iLocal_263=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1687.954f, 3277.727f, 40.25f, 6f, 6f, 6f, 0f, 0, 7);
...
case 5:
if(!func_486(Local_163.f_0)){
Local_163.f_0=VEHICLE::CREATE_VEHICLE(Local_163.f_1, Local_163.f_3, Local_163.f_6, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_163.f_0, 1084227584);
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Local_163.f_0, 1);
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_163.f_1, 1);
...
ENTITY::SET_ENTITY_COORDS(Local_182.f_0, -2881.755f, 3188.125f, 10.1136f, 1, 0, 0, 1);
TASK::CLEAR_PED_TASKS(Local_182.f_0);
func_285();
}else{
func_4(&Local_182);
Local_182.f_0=PED::CREATE_PED(26, iLocal_762, -2881.755f, 3188.125f, 10.1136f, 254.1723f, 1, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_182.f_0, 1);
PED::SET_PED_CONFIG_FLAG(Local_182.f_0, 167, 1);
AUDIO::STOP_PED_SPEAKING(Local_182.f_0, 1);
PED::SET_PED_DIES_WHEN_INJURED(Local_182.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_182.f_0, 0);
PED::SET_PED_CONFIG_FLAG(Local_182.f_0, 185, 1);
PED::SET_PED_CONFIG_FLAG(Local_182.f_0, 188, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_182.f_0, uLocal_760);
PED::SET_PED_CONFIG_FLAG(Local_182.f_0, 132, 1);
...
if(func_483(Local_182.f_0)){
ENTITY::SET_ENTITY_HEADING(Local_182.f_0, 254.1723f);
ENTITY::SET_ENTITY_COORDS(Local_182.f_0, -2889.89f, 3198.69f, 10.11f, 1, 0, 0, 1);
TASK::CLEAR_PED_TASKS(Local_182.f_0);
}else{
func_4(&Local_182);
Local_182.f_0=PED::CREATE_PED(26, iLocal_762, -2889.89f, 3198.69f, 10.11f, 254.1723f, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_182.f_0);
}
if(func_483(Local_182.f_0)){
PED::SET_PED_MAX_MOVE_BLEND_RATIO(Local_182.f_0, 0f);
...
void func_285(){
WEAPON::GIVE_WEAPON_TO_PED(Local_182.f_0, joaat("weapon_digiscanner"), 0, 1, 1);
PED::SET_PED_CAN_SWITCH_WEAPON(Local_182.f_0, 0);
AUDIO::STOP_PED_SPEAKING(Local_182.f_0, 1);
PED::SET_PED_DIES_WHEN_INJURED(Local_182.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_182.f_0, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_261);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::TASK_PLAY_ANIM(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_261, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_261);
TASK::TASK_PERFORM_SEQUENCE(Local_182.f_0, uLocal_261);
}
...
Local_156.f_0=VEHICLE::CREATE_VEHICLE(iLocal_761, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.f_0, 1084227584);
...
VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(Local_156.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_156.f_0, 1);
func_485(Local_156.f_0, 0);
...
ENTITY::FREEZE_ENTITY_POSITION(Local_156.f_0, 1);
}else{
Local_156.f_0=VEHICLE::CREATE_VEHICLE(iLocal_761, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_156.f_0);
VEHICLE::SET_VEHICLE_COLOURS(Local_156.f_0, 157, 157);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_156.f_0, 157, 5);
...
Local_156.f_0=VEHICLE::CREATE_VEHICLE(Local_156.f_1, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1, 0);
if(func_486(Local_156.f_0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_156.f_0);
...
Local_156.f_0=VEHICLE::CREATE_VEHICLE(Local_156.f_1, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
if(func_486(Local_156.f_0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_156.f_0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_156.f_0, 3);
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_156.f_1, 1);
}
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_174.f_0, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_174.f_0, 0);
PED::SET_PED_CAN_BE_TARGETTED(Local_174.f_0, 0);
PED::SET_PED_CONFIG_FLAG(Local_174.f_0, 185, 1);
PED::SET_PED_PROP_INDEX(Local_174.f_0, 1, 0, 0, false, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_174.f_0, uLocal_760);
PED::SET_PED_CONFIG_FLAG(Local_174.f_0, 132, 1);
TASK::TASK_PLAY_ANIM(Local_174.f_0, Local_174.f_6, Local_174.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
}else{
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_262)){
iLocal_262=OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), ENTITY::GET_ENTITY_COORDS(Local_174.f_0, 1), 1, 1, 0);
}
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_262)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_262, Local_174.f_0, PED::GET_PED_BONE_INDEX(Local_174.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
}
func_291(55);
break;
case 5:
...
TASK::TASK_ENTER_VEHICLE(0, Local_156.f_0, 20000, -1, 1073741824, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_261);
TASK::TASK_PERFORM_SEQUENCE(Local_174.f_0, uLocal_261);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_261);
}
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_174.f_0, 0, 0);
}else{
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_174.f_0, 1, 0);
}
func_289(&iLocal_262);
}else{
func_16(&(Local_174.f_1));
...
if(func_175(iVar0) && !PED::IS_PED_INJURED(uParam0)){
...
if(func_356()){
*uParam0=func_337(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_31()==0){
return MISC::IS_BIT_SET(func_93(func_335(iParam0), -1, 0), iParam1);
}}else{
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_338(iVar0, 0), 1);
...
Vector3 func__338(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_343(2, 2);
}elseif(func_342(Global_1853747)){
...
Var18={
func_345(Var18, -Var0.f_3.f_2) 
};
Var18={
func_345(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__345(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
func_16(&(Local_156.f_2));
if(func_242()){
ENTITY::SET_ENTITY_COORDS(Local_156.f_0, 1674.91f, 3252.47f, 41.69f, 1, 0, 0, 1);
...
STREAMING::STREAMVOL_DELETE(uLocal_260);
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_380(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(func_242()){
ENTITY::SET_ENTITY_COORDS(Local_156.f_0, 1684.78f, 3255.58f, 41.78f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_156.f_0, 284.26f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_156.f_0, 1084227584);
}else{
func_5(&Local_156);
...
PED::FORCE_PED_MOTION_STATE(Local_174.f_0, joaat("MotionState_Run"), 0, 1, 0);
}}}
...
if(!func_403(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
if(func_242()){
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_156.f_0, 0, 0, 0);
}
if(!HUD::DOES_BLIP_EXIST(Local_174.f_1)){
Local_174.f_1=func_290(Local_174.f_0, 1, 1, 9);
}
...
CUTSCENE::REQUEST_CUTSCENE("ep_6_rcm", 8);
func_526("Requesting cutscene now");
}}elseif(func_241(PLAYER::PLAYER_PED_ID(), Local_174.f_0, 1) > 120f){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
...
iLocal_191=2;
}}}elseif(func_406(PLAYER::PLAYER_PED_ID(), Local_174.f_0, 5f, 1)){
if(func_483(PLAYER::PLAYER_PED_ID()) && func_483(Local_174.f_0)){
Local_764={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
Local_767={
ENTITY::GET_ENTITY_COORDS(Local_174.f_0, 1) 
};
...
if(!STREAMING::IS_STREAMVOL_ACTIVE()){
if(!STREAMING::STREAMVOL_HAS_LOADED(uLocal_260)){
func_526("Loading streamvol");
uLocal_260=STREAMING::STREAMVOL_CREATE_FRUSTUM(1684.85f, 3276.16f, 39.93f, func_408(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
}}}elseif(STREAMING::IS_STREAMVOL_ACTIVE()){
func_526("Removing streamvol");
STREAMING::STREAMVOL_DELETE(uLocal_260);
}}


Vector3 func__408(struct<3> Param0){
...
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174.f_0, 1), 1);
}
if(fVar0 < 50f){
fLocal_250=100f;
fLocal_251=150f;
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174.f_0, 1), 1) > fLocal_250){
if(!iLocal_214){
func_410("EPS6_GOBACK", 7500, 1);
iLocal_214=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_174.f_0, 1), 1) > fLocal_251){
iLocal_264=2;
iLocal_191=0;
iLocal_190=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
}}elseif(func_241(PLAYER::PLAYER_PED_ID(), Local_174.f_0, 1) <=25f && func_22()){
if(!PED::IS_PED_HEADTRACKING_PED(Local_174.f_0, PLAYER::PLAYER_PED_ID())){
func_526("Jimmy headlooking (during conv)");
TASK::TASK_LOOK_AT_ENTITY(Local_174.f_0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(Local_174.f_0, PLAYER::PLAYER_PED_ID()) && !func_22()){
...
Var67={
func_106(iVar81, 2, uParam1->f_59, -1) 
};
...
Var67={
func_106(iVar81, 1, uParam1->f_62, -1) 
};
...
MISC::CLEAR_ANGLED_AREA_OF_VEHICLES(1727.442f, 3288.315f, 39.406f, 1706.909f, 3280.669f, 45.13256f, 14.25f, 0, 0, 0, 0, 0, 0, 0);
if(func_492()){
if(func_271()){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_156.f_0, Local_253, Local_256, 33.25f, 0, 1, 2)){
...
func_16(&(Local_170.f_3));
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1), 1) > 80f){
if(func_426(Local_156.f_0, 1654.72f, 3239.21f, 39.55f, 1) >=50f){
if(!iLocal_214){
func_410("EPS6_BACKPL", 7500, 1);
iLocal_214=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1), 1) > 150f){
if(func_419()){
bLocal_233=true;
}
iLocal_264=1;
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1), 1) > 250f){
if(func_419()){
bLocal_233=true;
}
iLocal_264=1;
...
if(func_418() && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.f_0, 0)){
func_526("*** Finishing Landing cleanup");
func_417("*** Plane 'entity' health:
", ENTITY::GET_ENTITY_HEALTH(Local_156.f_0));
func_416("*** Plane engine health:
", VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_156.f_0));
func_416("*** Plane petrol tank health:
", VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_156.f_0));
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_156.f_0, 1, 0, 0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_156.f_0, 1);
iLocal_191=1;
}}else{
...
bLocal_224=false;
}}}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_174.f_0, Local_174.f_6, Local_174.f_7, 3)){
...
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 10f, 1);
iLocal_195=1;
}elseif(func_225(&uLocal_265, "EPS6AUD", "EPS6_SPOT", 8, 0, 0, 0)){
iLocal_248=0;
func_526("EPSILONIST:
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.f_0, 1)){
if(func_22()){
func_20();
...
if(iLocal_211==0){
if((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.f_0, 1)){
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 10f, 1);
...
if(iLocal_190==0){
if(iLocal_211==0){
if((!func_420("EPS6_SPOT") && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.f_0, 1)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())){
func_431("EPS6_GETIN", 7500, 1);
...
TASK::TASK_SMART_FLEE_PED(Local_182.f_0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
func_16(&(Local_182.f_1));
}}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_433(iParam3), 0);
}
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_156.f_0, 1)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_156.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_261);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_764, 1f, 20000, 0.25f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_261);
TASK::TASK_PERFORM_SEQUENCE(Local_182.f_0, uLocal_261);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_261);
iLocal_196=2;
...
TASK::TASK_PLAY_ANIM(Local_182.f_0, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
iLocal_197=1;
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_182.f_0, Local_199[iLocal_198 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
func_526("Eps 6:
Nav tasking Tom...");
iLocal_197=2;
}
...
case 3:
TASK::CLEAR_PED_TASKS(Local_182.f_0);
TASK::TASK_PLAY_ANIM(Local_182.f_0, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_182.f_0, 0, 0);
iLocal_197=4;
func_526("Eps 6:
Done Tom idle anim");
break;
...
TASK::TASK_PLAY_ANIM(Local_182.f_0, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_182.f_0, 0, 0);
iLocal_197=1;
func_526("Eps 6:
Tom idle anim >0.98");
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_182.f_0, PLAYER::PLAYER_PED_ID(), 1)){
func_526("Player damaged cultist");
return 1;
}}elseif(ENTITY::DOES_ENTITY_EXIST(Local_182.f_0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_182.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_182.f_0, PLAYER::PLAYER_PED_ID(), 1)){
if(ENTITY::IS_ENTITY_DEAD(Local_182.f_0, 0)){
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1), 1) > 120f){
if(func_419()){
bLocal_233=true;
}
iLocal_264=1;
...
if(func_242()){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1) 
};
if(Var0.f_2 > 15f){
...
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_236, "DEVICE", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_182.f_0, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_237, "IDLE_BEEP_NPC", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_182.f_0, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
}
...
iLocal_190=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1), 1) > 50f){
if(!iLocal_214){
if(AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, 1), 1) > 100f){
iLocal_264=1;
iLocal_191=0;
iLocal_190=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
MISC::CLEAR_AREA_OF_VEHICLES(-2892.93f, 3192.37f, 11.66f, 11f, 0, 0, 0, 0, 0, 0, 0);
