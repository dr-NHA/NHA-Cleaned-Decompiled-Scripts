...
var unk6;
float num;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(2)) func_4();
...
uLocal_7={
ENTITY::GET_ENTITY_ROTATION(obScriptParam_0, 2) 
};
}
while (true){
SYSTEM::WAIT(0);
...
if(STREAMING::HAS_ANIM_DICT_LOADED("map_objects")) iLocal_2=2;
}
}
break;
case 2:
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(obLocal_3, true) 
};
if(!func_2(entityCoords, unk, 0.1f, false)){
unk6={
unk - entityCoords 
};
ENTITY::SET_ENTITY_COORDS(obLocal_3, entityCoords + (func_1(unk6) * F2V(MISC::GET_FRAME_TIME()) *{
num, num, num 
}
...
Vector3 func__1(float fParam0, var uParam1, var uParam2) // Position - 0x1C6{
float num;
float num2;
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_3)) OBJECT::DELETE_OBJECT(&obLocal_3);
