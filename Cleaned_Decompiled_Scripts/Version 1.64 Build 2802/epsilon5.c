...
iVar2=iVar20;
Var3={
func_210(Global_44465[iVar20 /*12*/].f_1) 
};
...
Var3={
func_210(Global_44465[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(bVar1){
func_206(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_207(iParam1)), 0));
}else{
func_206(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_207(iParam1)), 0));
}
switch (Global_20383){
case 0:
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_224(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(func_274()){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_86.f_28[0], 0f, 0f, 0.5f, 1, 30000, 2000, 2000, 0);
}else{
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_86.f_28[0], -1f, 0f, 0f, 0, 30000, 2000, 2000, 0);
}
...
TASK::TASK_PLAY_ANIM(Local_86.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, 0, 0, 0, 0);
iLocal_84=2;
}}}}
break;
case 2:
...
var func__264(int iParam0, int iParam1){
...
if(func_330()){}
if(func_247(Local_86.f_28[0])){
PED::SET_PED_CAN_BE_TARGETTED(Local_86.f_28[0], 0);
