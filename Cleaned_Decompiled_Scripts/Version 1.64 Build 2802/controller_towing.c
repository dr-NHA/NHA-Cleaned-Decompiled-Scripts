...
elseif(func_22(Global_113648.f_19975.f_1, 4096)){
iLocal_253=10000;
}
elseif(func_22(Global_113648.f_19975.f_1, 8192)){
iLocal_253=60000;
}
elseif(func_22(Global_113648.f_19975.f_1, 16384)){
iLocal_253=120000;
}
else{
iLocal_253=30000;
...
if(HUD::DOES_BLIP_EXIST(uLocal_273)){
HUD::REMOVE_BLIP(&uLocal_273);
}
...
func_142(&uLocal_62);
}elseif(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_144(&uLocal_62)){
...
return (func_140(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
uParam0->f_1=(func_140(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_275)){
iLocal_275=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Param1, uParam4, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
iLocal_75=3;
}}}
break;
case 3:
if(PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(PED::GET_VEHICLE_PED_IS_IN(iParam0, 0)==iLocal_275){
iLocal_75=0;
}}
