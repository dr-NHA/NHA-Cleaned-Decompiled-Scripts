...
flag=false;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(114)) func_191(true);
pedLocal_86=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
iLocal_96=0;
func_189(&Global_112299, 0);
func_184();
if(func_183(iLocal_95, 1)) iLocal_101=10;
else iLocal_101=9;
while (!Global_38596){
SYSTEM::WAIT(0);
}
if(!func_183(iLocal_95, 8))if(!_CAN_ENTER_FREEROAM_STATE(iLocal_101))if(func_180(0, iLocal_100)) func_191(false);
else func_191(true);
if(iLocal_100 !=-1)if(!func_180(0, iLocal_100)) bLocal_127=false;
if(func_183(iLocal_95, 8388608)) func_191(true);
if(func_183(iLocal_95, 524288) && func_179() && !func_178()) func_191(true);
...
while (true){
if(Global_3) func_191(true);
pedLocal_86=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
if(func_183(iLocal_95, 1048576))if(ENTITY::IS_ENTITY_DEAD(pedLocal_86, false)) func_191(true);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_86) && !ENTITY::IS_ENTITY_DEAD(pedLocal_86, false)){
uLocal_88={
ENTITY::GET_ENTITY_COORDS(pedLocal_86, true) 
};
...
if(func_183(iLocal_95, 524288) && func_179() && !func_178()) func_191(true);
if(func_166()) func_191(true);
if(!func_156(6) || Global_112695 || func_155()) flag3=false;
if(!bLocal_127){
...
if(func_148(true)) flag3=false;
if(Global_78558) flag3=false;
if(func_147()) flag3=false;
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) flag3=false;
if(func_146() || func_145(8, -1)) flag3=false;
...
if(func_144(0) || func_143()) flag3=false;
if(flag3){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_118, uLocal_121, fLocal_124, true, false, iLocal_104) || fLocal_126 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_142(uLocal_118, uLocal_121, 0.5f), false) > fLocal_126) flag3=false;
elseif(fLocal_125 > 0f)if(MISC::ABSF(uLocal_88.f_2 - uLocal_118.f_2) > fLocal_125) flag3=false;
...
elseif(!func_183(iLocal_95, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
if(iLocal_97 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_97);
num=2;
flag=false;
if(func_183(iLocal_95, 1)){
...
if(num !=1) num=func_37(&iLocal_99, 6, iLocal_101, false, 0);
if(num==1){
...
if(func_183(iLocal_95, 2097152))if(!func_168(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_53)) func_176(10);
...
func_6();
func_189(&Global_112299, 0);
if(func_183(iLocal_95, 16777216)) func_191(true);
if(iLocal_100 !=-1)if(Global_113648.f_9087)if(!func_180(0, iLocal_100)) func_191(true);
}
func_5();
break;
case 8:
...
case 7:
func_2();
if(iLocal_106 !=263) func_177(iLocal_106, false, false);
if(iLocal_97 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_97);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_102))if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sLocal_102)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
func_176(4);
break;
case 4:
if(iLocal_105 % 150==0){
...
func_184();
if(iLocal_106 !=263) func_177(iLocal_106, true, false);
func_176(0);
}}}elseif(iLocal_107==0){
if(fLocal_111 > fLocal_103 * fLocal_103){
if(iLocal_106 !=263){
...
func_4(128);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) func_3(PLAYER::PLAYER_PED_ID());
return;
}
...
bLocal_131=true;
}elseif(SCRIPT::HAS_SCRIPT_LOADED("tennis_family")){
SYSTEM::START_NEW_SCRIPT("tennis_family", MULTIPLAYER_MISSION);
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("tennis_family");
bLocal_130=true;
}}}elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis_family"))==0){
bLocal_130=false;
bLocal_131=false;
}
if(!func_132()){
...
i=i + 1){
unk={
func_57(hParam1, func_125(i), uParam2->[func_125(i)], -1) 
};
if(unk.f_3 !=-1 && unk.f_4 !=-1) PED::SET_PED_PRELOAD_VARIATION_DATA(pedParam0, i, unk.f_3, unk.f_4);
}
unk15={
func_49(hParam1, uParam2->[13]) 
};
for (j=0;
j <=8;
j=j + 1){
...
if(unk15[j] !=num2){
unk={
func_57(hParam1, 14, unk15[j], -1) 
};
if(unk.f_3 !=-1 && unk.f_3 !=255) PED::SET_PED_PRELOAD_PROP_DATA(pedParam0, componentId, unk.f_3, unk.f_4);
}}
return;
}
...
i < itemHash.f_3;
i=i + 1){
if(FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_1, i, &outPropVariant) && outPropVariant.f_2 !=-1)if(outPropVariant !=0 && outPropVariant !=-1 && outPropVariant !=joaat("0")) uParam0->[outPropVariant.f_2]=func_51(hParam1, outPropVariant, 14, num);
...
if(unk.f_1==hParam1) return func_55(hParam0) + i;
...
if(shopPedQueryComponentIndex !=-1) return func_52(hParam0, func_53(iParam2)) + shopPedQueryComponentIndex;
}
return -99;
}
...
func_124();
if(hParam0==joaat("Player_Zero")) func_106(iParam1, iParam2);
elseif(hParam0==joaat("Player_One")) func_87(iParam1, iParam2);
elseif(hParam0==joaat("Player_Two")) func_58(iParam1, iParam2);
...
if(iParam1==12){
if(!func_68(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_68(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
}elseif(iParam1==13){
}elseif(iParam1==14){
if(!func_68(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_68(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
...
if(func_67(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 1);
if(func_67(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 2);
if(!func_67(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 4);
}else{
MISC::SET_BIT(&(iParam0->f_6), 0);
...
if(iParam0 < 136) func_84(iParam0);
else func_83(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_70(3, iParam0, 242, -1);
return;
}
...
if(iParam0 < 107) func_103(iParam0);
elseif(iParam0 < 227) func_102(iParam0);
else func_101(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_70(3, iParam0, 318, -1);
return;
}
...
if(iParam0 < 60) func_121(iParam0);
else func_120(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_70(3, iParam0, 181, -1);
return;
}
...
switch (iParam1){
case 0:
if(Global_113648.f_9087.f_99.f_58[120]) func_128(&unk, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
else func_128(&unk, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
break;
case 1:
...
if(func_170(6) || func_170(7)) return true;
return false;
}
...
if(func_136(character)) return func_135(character);
...
Vector3 func__142(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1BB18{
return ({
...
Vector3 func__151(int iParam0) // Position - 0x1BD39{
int num;
num=iParam0;
switch (num){
case 1:
...
Vector3 func__152(int iParam0, int iParam1) // Position - 0x1BE17{
int num;
num=iParam0;
...
break;
case 4:
if(func_163() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_145(8, -1) || func_147() || func_158() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_145(8, -1) || func_161() || func_160() || func_158() || func_157()) return false;
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_136(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
case 1:
if(func_170(6) || func_170(7)) return true;
else return func_168(3);
break;
case 2:
return true;
case 3:
if(_CAN_ENTER_FREEROAM_STATE(5))if(func_156(4)) return true;
break;
}
return false;
}
...
if(bLocal_129)if(iLocal_128==1) return SCRIPT::HAS_SCRIPT_LOADED("tennis_ambient");
return true;
}


void func_175() // Position - 0x1CA85{
if(bLocal_129)if(iLocal_128==1) SCRIPT::REQUEST_SCRIPT("tennis_ambient");
return;
}
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) iLocal_128=func_150(uLocal_91);
...
bLocal_129=true;
uLocal_118={
-765.014f, 154.244f, 67.25f 
};
uLocal_121={
-782.014f, 154.244f, 67.25f 
};
fLocal_124=28f;
fLocal_125=2f;
break;
case 1:
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
-1164.9576f, -1667.2617f, 4.28f 
};
uLocal_121={
-1200.9193f, -1615.8724f, 4.28f 
};
fLocal_124=65.5f;
fLocal_125=5f;
break;
...
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
491.2348f, -206.72147f, 52.788494f 
};
uLocal_121={
469.6835f, -266.50696f, 53.786392f 
};
fLocal_124=14f;
fLocal_125=5f;
break;
...
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
-1218.9388f, 321.685f, 79.02952f 
};
uLocal_121={
-1228.746f, 355.2947f, 79.985886f 
};
fLocal_124=20f;
fLocal_125=2f;
break;
...
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
-1250.0034f, 367.62833f, 79.94628f 
};
uLocal_121={
-1216.3693f, 377.55026f, 80.10213f 
};
fLocal_124=20f;
fLocal_125=2f;
break;
...
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
-1610.8618f, 249.70062f, 60.116802f 
};
uLocal_121={
-1626.5161f, 282.9467f, 59.83001f 
};
fLocal_124=32f;
fLocal_125=5f;
break;
...
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
-942.1958f, -1251.2074f, 7.1391f 
};
uLocal_121={
-930.3892f, -1271.5867f, 8.0366f 
};
fLocal_124=12f;
fLocal_125=5f;
break;
...
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
-1373.602f, -83.734f, 50f 
};
uLocal_121={
-1369.198f, -120.774f, 50f 
};
fLocal_124=20.84f;
fLocal_125=5f;
fLocal_126=19.6f;
...
if(clockHours < 6 || clockHours > 18) bLocal_129=false;
uLocal_118={
-2860.7622f, 13.3794f, 10.6083f 
};
uLocal_121={
-2924.066f, 31.5452f, 10.6083f 
};
fLocal_124=28f;
fLocal_125=5f;
break;
}
if(func_170(6) || func_170(7)) iLocal_104=0;
...
if(MISC::GET_RAIN_LEVEL() + MISC::GET_SNOW_LEVEL() > 0.1f) bLocal_129=false;
return;
}
BOOL func_185() // Position - 0x1D271{
if(func_42(20)) return true;
return false;
}
BOOL func_186(eCharacter echParam0) // Position - 0x1D287{
if(func_136(echParam0))if(Global_113648.f_9087 || Global_3 || _IS_MISSION_REPEAT_ACTIVE(false)) return Global_113648.f_2365.f_539.f_2348[echParam0];
else return true;
return false;
}
...
if(bParam0)if(iLocal_106 !=263) func_177(iLocal_106, 0, false);
_CONTEXT_REMOVE_HELP_TEXT(&iLocal_97);
...
func_193();
if(SCRIPT::IS_THREAD_ACTIVE(iLocal_53)) PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(iLocal_53, 3);
if(!MISC::IS_STRING_NULL(&uLocal_70))if(HUD::GET_LENGTH_OF_LITERAL_STRING(&uLocal_70) !=0) SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&uLocal_70);
return;
}
