...
fLocal_634=100f;
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
Global_63356=false;
Global_63363=false;
value=1;
...
if(Global_75457 > 0){
func_107();
if(Global_63390==-1) Global_63390=MISC::GET_GAME_TIMER();
elseif(MISC::GET_GAME_TIMER() - Global_63390 > 1000) func_106();
}
if(Global_63363){
func_115();
Global_63357=0;
...
i < Global_75457;
i=i + 1){
if(Global_75458[i /*9*/] > 0)if(Global_63587[Global_75458[i /*9*/] /*13*/]==4)if(!Global_63587[Global_75458[i /*9*/] /*13*/].f_7)if(Global_63587[Global_75458[i /*9*/] /*13*/].f_3)if(Global_75458[i /*9*/].f_1==0) Global_75458[i /*9*/].f_3=5;
}
flag3=false;
if(Global_78819 && !Global_63352 || Global_63364) flag3=true;
flag4=false;
if(CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN()){
flag4=true;
}else{
if(Global_100720.f_8) flag4=true;
if(Global_63382) flag4=true;
}
...
if(num==69 || num==70) func_96(&uLocal_45, 3, "ACTATAKE_AG", "", Global_113648.f_1.f_126[Global_63366 /*23*/], 0, 0, 0);
else func_96(&uLocal_45, 3, "POTATAKE", "", Global_113648.f_1.f_126[Global_63366 /*23*/], 0, 0, 0);
j=0;
for (j=0;
j < Global_96911[Global_63366 /*38*/].f_37;
j=j + 1){
if(Global_96911[Global_63366 /*38*/].f_31[j] > 0) func_96(&uLocal_45, 3, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(Global_96911[Global_63366 /*38*/].f_25[j]), "", -1 * Global_96911[Global_63366 /*38*/].f_31[j], 0, 0, 0);
}
if(Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[0] > 0 || num==74 || num==75 || num==69 || num==70) func_96(&uLocal_45, 3, "ACTATAKE_M", "", Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[0], 0, 0, 0);
if(Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[1] > 0 || num==74 || num==75) func_96(&uLocal_45, 3, "ACTATAKE_F", "", Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[1], 0, 0, 0);
if(Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[2] > 0 || num==74 || num==75) func_96(&uLocal_45, 3, "ACTATAKE_T", "", Global_113648.f_1.f_126[Global_63366 /*23*/].f_2[2], 0, 0, 0);
if(Global_96901.f_7 > 0) func_96(&uLocal_45, 3, "ACTATAKE_L", "", Global_96901.f_7, 0, 0, 0);
num2=func_93(func_94(Global_63366));
num3=0;
value2=0;
for (j=0;
j < Global_96710[num2 /*19*/];
j=j + 1){
if(!func_92(Global_113648.f_1.f_12[num2 /*6*/][j])) num3=num3 + Global_113648.f_1.f_126[Global_63366 /*23*/].f_17[j];
else value2=value2 + Global_113648.f_1.f_126[Global_63366 /*23*/].f_17[j];
}
if(num==74 || num==75) func_96(&uLocal_45, 3, "LACKTAKE", "", num3, 0, 0, 0);
else func_96(&uLocal_45, 3, "CREWTAKE", "", num3, 0, 0, 0);
if(value2 > 0){
if(!_IS_MISSION_REPEAT_ACTIVE(false)){
switch (num){
case 90:
...
if(Global_75457 > 0) func_77(&uLocal_45);
if(!Global_63352) func_71();
while (!flag4){
if(CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN()) flag4=true;
SYSTEM::WAIT(0);
}
if(flag4 || Global_63382 && !flag3){
if(!Global_63364) func_67(&uLocal_45, false, 0);
flag5=false;
if(!Global_75607){
switch (Global_75608){
case 50:
...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("appcamera")) > 0) func_58(0);
if(Global_75457 > 0 || Global_63352){
if(Global_63382) GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(7);
if(flag && !Global_63352) Global_44200=1;
if(!Global_63364){
if(func_21(&uLocal_45, false, SYSTEM::TO_FLOAT(value), false, false, false)) Global_63363=true;
func_20();
}
if(Global_63382) GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(7);
}
func_19(1);
if(!CAM::IS_SCREEN_FADED_IN()) func_17();
if(!func_16(0)){
switch (func_14("AM_H_PASS" /*On passing a mission you will be awarded a score based on mission challenges. Missions can be replayed to obtain better scores. Mission results cannot be uploaded to Rockstar Social Club or savedifa retry is used.*/)){
case 2:
func_11("AM_H_PASS" /*On passing a mission you will be awarded a score based on mission challenges. Missions can be replayed to obtain better scores. Mission results cannot be uploaded to Rockstar Social Club or savedifa retry is used.*/, 3, 2000, 2500, 10000, 7, 0, 0, 0);
break;
case 1:
func_10(0);
break;
...
if(ENTITY::GET_ENTITY_HEALTH(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX())) < 1) Global_63364=true;
...
if(uParam0->f_562==0) uParam0->f_562=uParam0->f_576 + SYSTEM::FLOOR(15000f * fParam2);
...
if(uParam0->f_56 > 0) uParam0->f_564=uParam0->f_564 + func_50(25f * 0.5f);
if(uParam0->f_549) uParam0->f_564=uParam0->f_564 + (func_50(30f) - func_50(2f));
}
flag=true;
while (flag){
func_19(1);
...
if((float)uParam0->f_576 > (float)uParam0->f_562 + 666 - (15000f * fParam2))if(uParam0->f_30 < 1f) uParam0->f_30=uParam0->f_30 + 0f + ((1f / 0.225f) * SYSTEM::TIMESTEP());
...
if(uParam0->f_566)if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL))if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam0->f_4))if(!uParam0->f_571) func_22(uParam0, !uParam0->f_569 && uParam0->f_56 > 0);
...
func_23(&(uParam0->f_5));
if(uParam0->f_560==4) func_48(&(uParam0->f_13));
else func_23(&(uParam0->f_13));
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_554))) num6=func_45(&(uParam0->f_550), &(uParam0->f_554));
else num6=func_46(&(uParam0->f_550));
...
if(uParam0->f_56 > 0) num=num + func_50(25f * 0.2f);
i=0;
for (i=0;
i < uParam0->f_56;
i=i + 1){
...
HUD::SET_TEXT_SCALE(1f, 0.4f);
if(MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_554))) func_29(&(uParam0->f_550), start2, num + func_50(2f * 2f), false, false, 0);
else func_28(&(uParam0->f_550), &(uParam0->f_554), start2, num + func_50(2f * 2f), false, 0);
HUD::SET_TEXT_WRAP(start2, end2);
...
if(NETWORK::NETWORK_CLAN_GET_EMBLEM_TXD_NAME(&netHandle, &txdName)) return func_35(&txdName);
}else{
...
i <=9;
i=i + 1){
if(num==-1)if(func_44(7, i)==false) num=i;
}
if(num > -1){
...
if(func_54(character)) return func_53(character);
...
i < Global_75457;
i=i + 1){
if(Global_75458[i /*9*/] > 0)if(Global_63587[Global_75458[i /*9*/] /*13*/].f_7==false) return 1;
}
return 0;
}
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_54(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(uParam0->f_566)if(uParam0->f_571) func_68(uParam0);
elseif(uParam0->f_56 !=0) func_22(uParam0, true);
else func_22(uParam0, false);
Global_78820=1;
return 1;
}
...
if(Global_75608==-1) return;
i=0;
for (i=0;
i < Global_75457;
i=i + 1){
if(Global_75458[i /*9*/].f_3 !=0) return;
}
num=0;
i=0;
num2=0;
...
flag3=false;
flag3=false;
if(func_76(num3, Global_75458[i /*9*/].f_1)) flag3=true;
if(flag)if(flag3) num=num + 100000000;
if(flag2){
...
var clanDesc;
num.f_2.f_1=4;
if(!NETWORK::NETWORK_IS_SIGNED_ONLINE()) return;
...
i < 5;
i=i + 1){
if(Global_113648.f_1.f_126[Global_63366 /*23*/].f_11[i]==1) num=num + Global_113648.f_1.f_126[Global_63366 /*23*/].f_17[i];
}
return num;
default:
}
...
i < Global_75457;
i=i + 1){
if(Global_75458[i /*9*/]==iParam0) return Global_75458[i /*9*/].f_1;
}
return 0;
}
...
if(Global_75458[i /*9*/].f_3==2) flag=true;
}}
switch (Global_75458[i /*9*/]){
case 84:
case 100:
...
if(flag) MISC::ADD_REPLAY_STAT_VALUE(1);
else MISC::ADD_REPLAY_STAT_VALUE(0);
if(Global_75607) MISC::ADD_REPLAY_STAT_VALUE(1);
else MISC::ADD_REPLAY_STAT_VALUE(0);
MISC::END_REPLAY_STATS();
Global_63354=false;
}
Global_63367=0;
if(value > -1) value2=SYSTEM::TO_FLOAT(value);
func_78(value2, flag);
return;
}
...
num2=Global_75608;
num=func_82(num2);
if(num < 100f)if(fParam0 >=100f) Global_113648.f_10018.f_22=Global_113648.f_10018.f_22 + 1;
if(fParam0 >=num) func_81(num2, fParam0, bParam1);
}elseif(Global_75608==-1){}else{
num3=Global_75608;
num=func_80(num3);
if(num < 100f)if(fParam0 >=100f) Global_113648.f_10018.f_22=Global_113648.f_10018.f_22 + 1;
if(fParam0 >=num) func_79(num3, fParam0, bParam1);
}
return;
}
...
if(bParam2) Global_113648.f_9087.f_330[iParam0 /*6*/].f_5=50f;
else Global_113648.f_9087.f_330[iParam0 /*6*/].f_5=fParam1;
Global_32173=1;
return;
}
...
if(bParam2) Global_113648.f_18576[iParam0 /*6*/].f_5=50f;
else Global_113648.f_18576[iParam0 /*6*/].f_5=fParam1;
Global_32173=1;
return;
}
...
num=0f;
num2=0f;
if(Global_75458[iParam1 /*9*/] >=0){}else{
return false;
}
num3={
Global_63587[Global_75458[iParam1 /*9*/] /*13*/] 
};
if(num3==15) Global_75458[iParam1 /*9*/].f_1=iLocal_635;
if(num3==9) Global_75458[iParam1 /*9*/].f_2=fLocal_634;
if(num3==14) Global_75458[iParam1 /*9*/].f_1=SYSTEM::FLOOR(Global_75458[iParam1 /*9*/].f_2);
if(func_76(Global_75458[iParam1 /*9*/], Global_75458[iParam1 /*9*/].f_1)) num=1f;
if(Global_75458[iParam1 /*9*/].f_3 !=0) num=0f;
if(!num3.f_2==0){
num2=SYSTEM::TO_FLOAT(SYSTEM::FLOOR((SYSTEM::TO_FLOAT(Global_75458[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f));
if(num2 > 100f) num2=100f;
}
...
if(Global_75458[iParam1 /*9*/].f_3==0 || flag)if(num3.f_3)if(num4 > Global_75458[iParam1 /*9*/].f_1 || num4 < 0 || num4==-1) func_90(Global_75458[iParam1 /*9*/].f_1, Global_75458[iParam1 /*9*/]);
elseif(Global_75458[iParam1 /*9*/].f_1 > num4 || num4 < 0 || num4==-1) func_90(Global_75458[iParam1 /*9*/].f_1, Global_75458[iParam1 /*9*/]);
num5=Global_75458[iParam1 /*9*/].f_1;
if(num3.f_7) return true;
num6=1;
if(num==1f){
...
if(!_IS_MISSION_REPEAT_ACTIVE(false)) func_90(-1, Global_75458[iParam1 /*9*/]);
...
if(iLocal_632==Global_75458[iParam1 /*9*/].f_3) str2="";
...
num3=0;
for (i=0;
i < Global_96911[iParam0 /*38*/].f_37;
i=i + 1){
...
if(Global_113648.f_1.f_126[iParam0 /*23*/].f_6[0] !=-1f) Global_113648.f_1.f_126[iParam0 /*23*/].f_6[0]=(SYSTEM::TO_FLOAT(Global_113648.f_1.f_126[iParam0 /*23*/].f_2[0]) / SYSTEM::TO_FLOAT(value)) * 100f;
if(Global_113648.f_1.f_126[iParam0 /*23*/].f_6[1] !=-1f) Global_113648.f_1.f_126[iParam0 /*23*/].f_6[1]=(SYSTEM::TO_FLOAT(Global_113648.f_1.f_126[iParam0 /*23*/].f_2[1]) / SYSTEM::TO_FLOAT(value)) * 100f;
if(Global_113648.f_1.f_126[iParam0 /*23*/].f_6[2] !=-1f) Global_113648.f_1.f_126[iParam0 /*23*/].f_6[2]=(SYSTEM::TO_FLOAT(Global_113648.f_1.f_126[iParam0 /*23*/].f_2[2]) / SYSTEM::TO_FLOAT(value)) * 100f;
if(Global_96901.f_6 !=-1f) Global_96901.f_6=(SYSTEM::TO_FLOAT(Global_96901.f_7) / SYSTEM::TO_FLOAT(value)) * 100f;
switch (iParam0){
case 0:
...
if(num < 0) num=num * -1;
flag=false;
if(Global_96911[iParam0 /*38*/].f_37==5) flag=true;
...
int i;
int num;
if(Global_75457 > 16) return;
i=0;
for (i=0;
i < Global_75457;
i=i + 1){
if(Global_75458[i /*9*/].f_1==0)if(Global_75458[i /*9*/].f_2 !=0f) Global_75458[i /*9*/].f_1=SYSTEM::FLOOR(Global_75458[i /*9*/].f_2);
num=Global_75458[i /*9*/];
if(num > 0){
if(Global_63587[num /*13*/]==9) Global_75458[i /*9*/].f_1=SYSTEM::ROUND(fLocal_634);
if(Global_63587[num /*13*/]==15) Global_75458[i /*9*/].f_1=iLocal_635;
}}
return;
}
...
int i;
if(Global_32413==0 && !Global_32417) return;
i=0;
for (i=0;
i < Global_75457;
i=i + 1){
...
int num;
func_108();
if(Global_63368 && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()) && !CUTSCENE::IS_CUTSCENE_ACTIVE() && !HUD::IS_PAUSE_MENU_ACTIVE()) Global_63368=false;
if(Global_63361){
Global_63361=false;
iLocal_626=0;
}
flag=true;
flag2=true;
if(HUD::IS_PAUSE_MENU_ACTIVE()) flag=false;
...
if(flag) iLocal_626=SYSTEM::ROUND(MISC::GET_FRAME_TIME() * 1000f);
i=0;
entitySpeed=0f;
for (i=0;
i < Global_75457;
...
elseif(ENTITY::DOES_ENTITY_EXIST(Global_75458[i /*9*/].f_6)){
...
if(Global_75458[i /*9*/].f_1 < 0) Global_75458[i /*9*/].f_1=Global_75458[i /*9*/].f_1 * -1;
}
...
break;
case 2:
if(Global_63369) Global_75458[i /*9*/].f_1=Global_75458[i /*9*/].f_1 + iLocal_626;
break;
case 3:
break;
case 4:
if(Global_63370)if(Global_63372==-1 || Global_75458[i /*9*/]==Global_63372)if(Global_75458[i /*9*/]==339 || Global_75458[i /*9*/]==179 || Global_75458[i /*9*/]==342 || Global_75458[i /*9*/]==234) Global_75458[i /*9*/].f_1=Global_75458[i /*9*/].f_1 + SYSTEM::ROUND(MISC::GET_FRAME_TIME() * 1000f);
else Global_75458[i /*9*/].f_1=Global_75458[i /*9*/].f_1 + iLocal_626;
break;
case 5:
if(flag2){
...
if(entitySpeed > Global_75458[i /*9*/].f_2) Global_75458[i /*9*/].f_2=entitySpeed;
}
}}}
}}
break;
...
break;
case 17:
if(func_54(_GET_CURRENT_PLAYER_CHARACTER()))if(PLAYER::IS_SPECIAL_ABILITY_ACTIVE(PLAYER::GET_PLAYER_INDEX(), 0) && PLAYER::IS_SPECIAL_ABILITY_ENABLED(PLAYER::GET_PLAYER_INDEX(), 0)) Global_75458[i /*9*/].f_1=Global_75458[i /*9*/].f_1 + iLocal_626;
break;
case 15:
break;
default:
...
if(Global_75653==0 && Global_75643==0 && Global_63521==0 && Global_63391==0 && !Global_75609) return;
num2=0;
if(Global_63391 > 0){
i=0;
for (i=0;
...
j < Global_63521;
j=j + 1){
if(Global_63522[j /*2*/]==entityModel) num2=num2 + Global_63522[j /*2*/].f_1;
}}
...
else vehiclePedIsIn=PLAYER::GET_PLAYERS_LAST_VEHICLE();
if(ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(pedSourceOfDeath)==vehiclePedIsIn) flag2=true;
}
}
...
j < Global_75653;
j=j + 1){
if(Global_75644[j /*2*/]==pedCauseOfDeath) func_99(Global_75644[j /*2*/].f_1, 1, false);
}}}
if(Global_75609){
...
case 1:
case 2:
if(PED::IS_PED_HUMAN(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(eventData))) func_110();
break;
default:
break;
}}}
...
j=j + 1;
if(j==16 || num==0) flag=true;
}
if(Global_75643 > 0){
while (Global_75610[Global_75643 - 1 /*2*/]==0 && Global_75643 > 1){
if(Global_75643 > 1) Global_75643=Global_75643 - 1;
}}}
}}}
break;
}}
if(num2 > 0) func_109(num2);
return;
}
...
i=i + 1){
num=Global_75458[i /*9*/];
if(Global_63587[num /*13*/]==13) Global_75458[i /*9*/].f_1=Global_75458[i /*9*/].f_1 + iParam0;
}
return;
}
...
i=i + 1){
num=Global_75458[i /*9*/];
if(Global_63587[num /*13*/]==16) Global_75458[i /*9*/].f_1=Global_75458[i /*9*/].f_1 + 1;
}
return;
}
...
int i;
if(Global_63391==0) return -1;
i=0;
for (i=0;
i < 64;
i=i + 1){
if(Global_63392[i /*2*/]==eParam0) return i;
}
return -1;
}
...
flag=false;
if(MISC::GET_REPLAY_STAT_AT_INDEX(num + 2) > 0) flag=true;
flag2=0;
if(MISC::GET_REPLAY_STAT_AT_INDEX(num + 3) > 0) flag2=1;
Global_75607=flag2;
Global_75608=replayStatAtIndex3;
if(value==-1) func_78(SYSTEM::TO_FLOAT(replayStatAtIndex4), flag);
else func_78(SYSTEM::TO_FLOAT(value), flag);
}
func_114();
}}
