...
TASK::OPEN_SEQUENCE_TASK(&uLocal_136);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_136);
TASK::TASK_PERFORM_SEQUENCE(iLocal_72, uLocal_136);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_136);
iLocal_117=1;
}else{
...
elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_65, 0)){
...
elseif(!PED::IS_PED_INJURED(iLocal_52[1])){
...
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_52[0], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[0], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
}elseif(HUD::DOES_BLIP_EXIST(uLocal_121[0])){
HUD::REMOVE_BLIP(&(uLocal_121[0]));
}
...
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_52[1], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_52[1], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
}elseif(HUD::DOES_BLIP_EXIST(uLocal_121[1])){
HUD::REMOVE_BLIP(&(uLocal_121[1]));
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_52[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_52[1])){
if(((WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_52[0], joaat("weapon_stungun"), 0) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_52[1], joaat("weapon_stungun"), 0)) || (PED::IS_PED_DEAD_OR_DYING(iLocal_52[0], 1) && PED::IS_PED_DEAD_OR_DYING(iLocal_52[1], 1))) || func_112()){
if(HUD::DOES_BLIP_EXIST(uLocal_121[0])){
HUD::REMOVE_BLIP(&(uLocal_121[0]));
}
if(HUD::DOES_BLIP_EXIST(uLocal_121[1])){
...
if(HUD::DOES_BLIP_EXIST(uLocal_125)){
HUD::REMOVE_BLIP(&uLocal_125);
}
if(PED::IS_PED_IN_GROUP(iLocal_72)){
PED::REMOVE_PED_FROM_GROUP(iLocal_72);
}
...
iLocal_77=0;
}}}elseif(!iLocal_77 && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
Local_84={
func_70() 
};
Local_78={
...
HUD::SET_BLIP_SPRITE(uLocal_125, 269);
func_99();
}}}}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_120)){
uLocal_120=func_107(iLocal_72, 0, 145);
...
var func__102(struct<3> Param0, int iParam3){
var uVar0;
...
var func__107(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_136);
TASK::TASK_PERFORM_SEQUENCE(iLocal_52[0], uLocal_136);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_136);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_136);
TASK::TASK_PERFORM_SEQUENCE(iLocal_52[1], uLocal_136);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_136);
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_120(iParam2), 1);
}
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_72, uLocal_149, "random@homelandsecurity", "exit_girl", 2f, -4f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_52[0], uLocal_149, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_52[1], uLocal_149, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_52[1], joaat("script_task_synchronized_scene")) !=1){
TASK::OPEN_SEQUENCE_TASK(&uLocal_136);
TASK::TASK_CLEAR_LOOK_AT(0);
...
return 1;
}}elseif((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52[0], 0.5f, 0.5f, 5f, 0, 1, 1) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52[1], 0.5f, 0.5f, 5f, 0, 1, 1)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 0.5f, 0.5f, 5f, 0, 1, 1)){
return 1;
}}
return 0;
}
...
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_121[iLocal_126], 0);
}}else{
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_121[iLocal_126], 1);
}
iLocal_126++;
}}
...
var uVar1;
if(!bLocal_133){
if(MISC::IS_PROJECTILE_IN_AREA(Local_66 - Vector(30f, 30f, 30f), Local_66 + Vector(30f, 30f, 30f), 1) || MISC::IS_BULLET_IN_BOX(Local_66 - Vector(30f, 30f, 30f), Local_66 + Vector(30f, 30f, 30f), 1)){
iLocal_50=2;
return 1;
}
if(!PED::IS_PED_INJURED(iLocal_52[0]) && !PED::IS_PED_INJURED(iLocal_52[1])){
...
iLocal_50=2;
return 1;
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_65, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_50=2;
return 1;
}}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
iLocal_50=4;
return 1;
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_50=4;
return 1;
}}
return 0;
...
iLocal_126=0;
while (iLocal_126 <=1){
iLocal_52[iLocal_126]=PED::CREATE_PED(6, iLocal_70, Local_55[iLocal_126 /*3*/], fLocal_62[iLocal_126], 1, 1);
...
uLocal_149=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_149, iLocal_65, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_72, uLocal_149, "random@homelandsecurity", "idle_girl", 4f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_52[0], uLocal_149, "random@homelandsecurity", "idle_cop_gun", 4f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_52[1], uLocal_149, "random@homelandsecurity", "idle_cop_ground", 4f, -2f, 1, 0, 1148846080, 0);
...
Local_73={
-174.0522f, 1905.611f, 197.0466f 
};
Local_55[0 /*3*/]={
-174.3279f, 1903.972f, 197.0502f 
};
fLocal_62[0]=147.8596f;
Local_55[1 /*3*/]={
-174.3233f, 1906.384f, 197.0145f 
};
fLocal_62[1]=164.5974f;
Local_66={
-172.4207f, 1905.183f, 197.1163f 
};
fLocal_69=187.3899f;
Local_93={
469.8768f, 2617.532f, 42.2566f 
};
Local_96={
472.2393f, 2611.611f, 42.2676f 
};
Local_99={
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_112695) || Global_32166) || func_203()) || func_84(8, -1)) || func_202()) || func_201()) || func_200()) || func_199()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_204()) || Global_32166) || func_203()) || func_84(8, -1)) || func_200()) || func_202()) || func_201()) || func_199()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_112695) || Global_32166) || func_203()) || func_84(8, -1)) || func_202()) || func_201()) || func_199()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_204()) || Global_32166) || func_203()) || func_84(8, -1)) || func_201()) || func_200()) || func_199()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_204()) || func_201()) || Global_112695) || Global_32166) || func_203()) || Global_44446) || func_84(8, -1)) || func_200()) || func_198()) || func_199()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_204()) || Global_112695) || Global_32166) || func_203()) || func_84(8, -1)) || func_200()) || func_198()) || func_202()) || func_201()) || func_199()){
return 0;
}
break;
}}else{
...
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_AIM_GUN_AT_COORD(iLocal_52[iVar0], func_224(PLAYER::PLAYER_ID()), -1, 0, 0);
