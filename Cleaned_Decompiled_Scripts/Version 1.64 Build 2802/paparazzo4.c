...
iLocal_96=joaat("pcj");
uLocal_328={
-498.84396f, 230.90865f, 81.10313f 
};
uLocal_331={
-487.0969f, 230.15756f, 84.066666f 
};
fLocal_334=11f;
uLocal_346={
0f, 0f, 0f 
...
uLocal_352={
0.1181f, 0.2229f, -0.1535f 
};
uLocal_355={
259.2501f, 24.08f, -51.2899f 
};
iLocal_358=-1;
uLocal_359={
-512.9788f, 225.16649f, 80.20329f 
};
uLocal_362={
-463.98053f, 219.81311f, 84.14708f 
};
fLocal_365=18.5f;
iLocal_367=-1;
...
uLocal_401={
-493.76434f, 232.17636f, 82.057274f 
};
uLocal_404={
0f, 0f, 0f 
};
...
bLocal_408=true;
uLocal_412={
-489.37982f, 232.07132f, 82.05263f 
};
uLocal_415={
-488.27f, 229.89f, 83.23f 
};
uLocal_418={
-493.3992f, 226.2236f, 82.1179f 
};
uLocal_421={
-497.99f, 224.97f, 82.67f 
};
uLocal_424={
-501.55f, 230.7f, 83.1f 
};
fLocal_427=115.15f;
fLocal_428=-64.85f;
...
fLocal_431=233.87f;
uLocal_432={
-489.4534f, 233.7212f, 82.0251f 
};
fLocal_435=294.5672f;
uLocal_438={
-494.3458f, 229.29216f, 82.11426f 
};
uLocal_441={
-499.68f, 232.26f, 82.1f 
};
bLocal_461=true;
bLocal_466=true;
uLocal_467={
-477.6708f, 236.90958f, 84.02463f 
};
uLocal_470={
-488.68292f, 232.33574f, 81.01718f 
};
uLocal_473={
-526.3283f, 245.77834f, 80.97247f 
};
uLocal_476={
-439.6462f, 235.06168f, 84.04542f 
};
fLocal_479=6f;
...
iLocal_483=15;
uLocal_484={
-492.67786f, 227.60219f, 82.13477f 
};
fLocal_487=15f;
...
if(MISC::GET_GAME_TIMER() > iLocal_338) iLocal_327=2;
break;
case 2:
func_211();
func_2();
...
break;
case 65:
if(iParam1==1) func_188(0, false);
else func_188(0, true);
break;
case 6:
...
if(func_190()) num=Global_113648.f_7263.f_227[iParam0];
...
if(func_9()==-1 || func_9()==999 && !func_191()==0) return true;
return false;
}
...
if(!func_199(68)) func_196("DI_HLP_STRY" /*Story characters become available in Rockstar Editor's 'Director Mode' as the GTAV story progresses.*/, 2, 0, 20000, 10000, 7, 0, 208, 0);
}}}
return;
}
...
if(!bLocal_491)if(iLocal_492==-1)if(!func_209(uLocal_98.f_28[0]) || !func_209(uLocal_98.f_28[1]) || !func_209(uLocal_98.f_28[2])) iLocal_492=MISC::GET_GAME_TIMER() + 500;
elseif(iLocal_492 > MISC::GET_GAME_TIMER())if(!func_209(uLocal_98.f_28[0]) && !func_209(uLocal_98.f_28[1]) && !func_209(uLocal_98.f_28[2])) bLocal_491=true;
return;
}
...
if(!bParam0) iLocal_326=iLocal_325 + 1;
elseif(iLocal_325 > 0) iLocal_326=iLocal_325 - 1;
iLocal_327=0;
return;
}
...
if(func_209(uLocal_98.f_28[0]) && func_218(uLocal_98.f_35[0]) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))if(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_98.f_35[0]))if(TASK::GET_VEHICLE_WAYPOINT_PROGRESS(uLocal_98.f_35[0]) >=iLocal_482)if(bLocal_407) TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_98.f_28[0], uLocal_98.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 15f, 786468, 100f, 1f, true);
else TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_98.f_28[0], uLocal_98.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 100f, 1f, true);
if(func_209(uLocal_98.f_28[1]) && func_218(uLocal_98.f_35[1]) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481))if(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_98.f_35[1]))if(TASK::GET_VEHICLE_WAYPOINT_PROGRESS(uLocal_98.f_35[1]) >=iLocal_483)if(func_209(uLocal_98.f_28[0]))if(bLocal_407) TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_98.f_28[1], uLocal_98.f_35[1], uLocal_98.f_28[0], 7, 15f, 786468, 100f, 1f, true);
else TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_98.f_28[1], uLocal_98.f_35[1], uLocal_98.f_28[0], 7, 40f, 786468, 100f, 1f, true);
else TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_98.f_28[1], uLocal_98.f_35[1], 15f, 786597);
return;
}
BOOL func_218(Vehicle veParam0) // Position - 0x275D5{
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(!FILES::GET_DLC_VEHICLE_FLAGS(veParam0)) return 1;
return 0;
}
...
func_220(true);
if(PED::IS_PED_IN_GROUP(uLocal_98.f_28[2])) PED::REMOVE_PED_FROM_GROUP(uLocal_98.f_28[2]);
...
if(bParam0) PATHFIND::SET_PED_PATHS_IN_AREA(uLocal_467, uLocal_470, true, 0);
else PATHFIND::SET_PED_PATHS_IN_AREA(uLocal_467, uLocal_470, false, 0);
return;
}
BOOL func_221(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x2776B{
if(func_209(pedParam0))if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, esthParam1)==1 || TASK::GET_SCRIPT_TASK_STATUS(pedParam0, esthParam1)==0) return true;
return false;
}
...
}}elseif(PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[1], true)){
AUDIO::STOP_SOUND(iLocal_488);
...
if(!func_209(uLocal_98.f_28[0])) RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 0f, 0);
iLocal_327=0;
iLocal_326=4;
}
return;
...
if(MISC::GET_GAME_TIMER() - uParam4 < 7500 && bParam5)if(!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_233(sParam1, 0, 0)) _SHOW_SUBTITLE_CLEAR_EXISTING(sParam2, 7500, 0);
*uParam3=MISC::GET_GAME_TIMER();
}else{
HUD::SET_BLIP_COLOUR(*uParam0, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, "BLIP_ENEMY" /*Enemy*/);
if(MISC::GET_GAME_TIMER() - uParam4 < 7500 && bParam5)if(!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_233(sParam2, 0, 0)) _SHOW_SUBTITLE_CLEAR_EXISTING(sParam1, 7500, 0);
*uParam3=MISC::GET_GAME_TIMER();
}}}
if(MISC::GET_GAME_TIMER() - uParam4 > 7500){
if(func_233(sParam1, 0, 0)) HUD::CLEAR_THIS_PRINT(sParam1);
if(func_233(sParam2, 0, 0)) HUD::CLEAR_THIS_PRINT(sParam2);
}
return;
}
...
if(func_239(PLAYER::PLAYER_ID())) return false;
...
if(HUD::DOES_BLIP_EXIST(blLocal_159)) HUD::SET_BLIP_SCALE(blLocal_159, 0.7f);
}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[0], false)){
...
if(ENTITY::DOES_ENTITY_EXIST(randomVehicleInSphere))if(!randomVehicleInSphere==veParam0)if(VEHICLE::IS_VEHICLE_DRIVEABLE(randomVehicleInSphere, false))if(VEHICLE::IS_VEHICLE_STOPPED(randomVehicleInSphere)) return 1;
return 0;
}
...
}}elseif(_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_BEG", 7, 0, 0, 0)){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_98.f_28[0]);
iLocal_373=MISC::GET_GAME_TIMER() + 15000;
}}}}}
return;
...
if(func_270(pedParam0, bParam1, bParam5, bParam6, bParam7)) return true;
if(!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
if(PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())){
num={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true) 
};
if((num * num) + (num.f_1 * num.f_1) + (num.f_2 * num.f_2) <=5f) return func_269(PLAYER::PLAYER_PED_ID(), pedParam0, iParam2);
}}
if(bParam4) return false;
elseif(func_257(pedParam0, iParam3)) return true;
}
return false;
}
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_258(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_266(&iLocal_52[num /*4*/]);
return false;
}
if(!func_263(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_262();
...
Vector3 func__261(Ped pedParam0, int iParam1) // Position - 0x28B9B{
...
float num;
unk={
func_265(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_265(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__265(float fParam0, var uParam1, var uParam2) // Position - 0x28D5C{
float num;
float num2;
...
i < iLocal_52;
i=i + 1){
if(iLocal_52[i /*4*/].f_1==uParam0 && iLocal_52[i /*4*/].f_2==pedParam1) return i;
}
return -1;
}
...
if(!bParam2){
if(func_274(pedParam0, bParam1, radius, num)) return true;
if(func_271(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_272(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_272(pedParam0, fParam1)) return true;
...
float num;
unk={
func_265(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_209(uLocal_98.f_28[1]) && func_218(uLocal_98.f_35[1]))if(PED::IS_PED_IN_VEHICLE(uLocal_98.f_28[1], uLocal_98.f_35[1], false)) TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_98.f_28[1], uLocal_98.f_35[1], sLocal_481, 786597, 0, 8, -1, -1082130432, false, 1073741824);
return;
}
...
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_223();
_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_VSTEAL", 8, 0, 0, 0);
func_220(true);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[1], sLocal_377, sLocal_393, 3))if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_390)) ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_98.f_28[1], -4f, true);
else TASK::STOP_ANIM_TASK(uLocal_98.f_28[1], sLocal_377, sLocal_393, -1056964608);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_98.f_41[1])){
AUDIO::STOP_SOUND(iLocal_488);
func_227(&uLocal_98.f_41[1], false);
}
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_35[0], PLAYER::PLAYER_PED_ID(), true)) func_279();
}}elseif(!PED::IS_PED_FLEEING(uLocal_98.f_28[0])){
func_220(true);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 3)) TASK::STOP_ANIM_TASK(uLocal_98.f_28[0], sLocal_377, sLocal_378, -1056964608);
...
if(PED::IS_PED_IN_COMBAT(uLocal_98.f_28[0], 0) || PED::IS_PED_IN_MELEE_COMBAT(uLocal_98.f_28[0])) TASK::CLEAR_PED_TASKS(uLocal_98.f_28[0]);
PED::SET_PED_FLEE_ATTRIBUTES(uLocal_98.f_28[0], 2, false);
func_227(&uLocal_98.f_41[0], false);
bLocal_389=true;
...
bLocal_385=false;
bLocal_386=true;
}}elseif(!bLocal_386 && bLocal_385 && !func_280(uLocal_98.f_28[0]) && !FILES::GET_DLC_VEHICLE_FLAGS(uLocal_98.f_28[0]) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_COMBAT(uLocal_98.f_28[0], 0) || PED::IS_PED_IN_MELEE_COMBAT(uLocal_98.f_28[0])) TASK::CLEAR_PED_TASKS(uLocal_98.f_28[0]);
...
if(func_209(PLAYER::PLAYER_PED_ID()) && func_209(pedParam0))if(PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_BEING_STEALTH_KILLED(pedParam0)) return true;
return false;
}
...
flag=false;
func_223();
if(func_218(uLocal_98.f_35[0]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_35[0], PLAYER::PLAYER_PED_ID(), true) && func_275(PLAYER::PLAYER_PED_ID(), uLocal_98.f_28[0], 5f, true)) flag=_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_CARSHOT", 7, 0, 0, 0);
elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_98.f_35[0], false) || func_285(uLocal_98.f_35[0])) flag=_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_STEAL", 7, 0, 0, 0);
else flag=func_235(&uLocal_160, "PAP4AUD", "PAP4_STEAL", "PAP4_STEAL_1", 7, 0, 0);
if(flag){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 3)){
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_98.f_35[0], false)) TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, uLocal_438, 2f, 20000, 1048576000, 0, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
TASK::TASK_PERFORM_SEQUENCE(uLocal_98.f_28[0], taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
func_227(&uLocal_98.f_41[0], false);
if(func_209(uLocal_98.f_28[1]) && !PED::IS_PED_FLEEING(uLocal_98.f_28[1]))if(PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[1], false)) TASK::TASK_LEAVE_ANY_VEHICLE(uLocal_98.f_28[1], 0, 0);
else TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_98.f_28[1], uLocal_98.f_28[0], -1);
if(func_209(uLocal_98.f_28[2]) && !PED::IS_PED_FLEEING(uLocal_98.f_28[2]) && !bLocal_387 && !bLocal_465 && !PED::IS_PED_RAGDOLL(uLocal_98.f_28[2]))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_35[0], PLAYER::PLAYER_PED_ID(), true)) TASK::TASK_SMART_FLEE_PED(uLocal_98.f_28[2], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
elseif(PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[2], false)) TASK::TASK_LEAVE_ANY_VEHICLE(uLocal_98.f_28[2], 0, 4416);
else TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_98.f_28[2], PLAYER::PLAYER_PED_ID(), -1);
...
iLocal_436=4;
}elseif(MISC::GET_GAME_TIMER() > iLocal_437){
if(func_209(uLocal_98.f_28[0]) && !PED::IS_PED_IN_COMBAT(uLocal_98.f_28[0], 0) && bLocal_385){
if(bLocal_444){
TASK::TASK_COMBAT_PED(uLocal_98.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
func_227(&uLocal_98.f_41[0], false);
iLocal_436=3;
}elseif(_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_RETAL", 7, 0, 0, 0)){
bLocal_444=true;
TASK::TASK_COMBAT_PED(uLocal_98.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
func_227(&uLocal_98.f_41[0], false);
iLocal_436=3;
...
if(HUD::DOES_BLIP_EXIST(blLocal_159)) HUD::SET_BLIP_SCALE(blLocal_159, 0.7f);
}elseif(bLocal_385==false && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[0], true)){
...
if(func_209(uLocal_98.f_28[1])) TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_98.f_28[1], -1);
else TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
...
func_283();
}elseif(_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_RETURN", 7, 0, 0, 0)){
bLocal_445=true;
func_283();
}}
return;
...
if(num > 20f)if(!func_221(uLocal_98.f_28[1], SCRIPT_TASK_GOTO_ENTITY_OFFSET)) TASK::TASK_GOTO_ENTITY_OFFSET(uLocal_98.f_28[1], uLocal_98.f_28[0], 20000, 0.5f, 0f, 2f, 2);
elseif(num < 10f)if(!func_221(uLocal_98.f_28[1], SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY)) TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_98.f_28[1], uLocal_98.f_28[0], -1);
}
return;
}
...
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 3)){
...
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_98.f_28[0], 3f, 0f, 0f) 
};
...
if(bLocal_385==false && func_209(uLocal_98.f_28[0]) && iLocal_436==0)if(!TASK::IS_PED_GETTING_UP(uLocal_98.f_28[0]) && !PED::IS_PED_PRONE(uLocal_98.f_28[0]) && !PED::IS_PED_RAGDOLL(uLocal_98.f_28[0]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[0], true) && !func_221(uLocal_98.f_28[0], SCRIPT_TASK_ENTER_VEHICLE) && !PED::IS_PED_FLEEING(uLocal_98.f_28[0]) || PED::IS_PED_BEING_STEALTH_KILLED(uLocal_98.f_28[0]))if(!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 3) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_377)) TASK::TASK_PLAY_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 4f, -8f, -1, 57, 0, false, false, false);
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 3)) TASK::STOP_ANIM_TASK(uLocal_98.f_28[0], sLocal_377, sLocal_378, -1056964608);
return;
}
...
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() < uLocal_455[iLocal_462]) return 1;
return 0;
}
...
Vector3 vector2;
vector={
ENTITY::GET_ENTITY_COORDS(uLocal_98.f_28[0], true) +{
1f, 0f, 0f 
}};
vector2={
ENTITY::GET_ENTITY_COORDS(uLocal_98.f_28[1], true) -{
1f, 0f, 0f 
}};
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vector, vector2, 0.5f, false, true, 0)) return true;
return false;
}
...
if(bParam0) blendIn=1000f;
else blendIn=4f;
if(func_209(uLocal_98.f_28[0])) TASK::TASK_SYNCHRONIZED_SCENE(uLocal_98.f_28[0], iLocal_390, sLocal_377, animationName, blendIn, -4f, 1, 16, 1148846080, 0);
if(func_209(uLocal_98.f_28[1])) TASK::TASK_SYNCHRONIZED_SCENE(uLocal_98.f_28[1], iLocal_390, sLocal_377, animationName2, 1000f, -2f, 1, 16, 1148846080, 0);
if(func_209(uLocal_98.f_28[2])) TASK::TASK_SYNCHRONIZED_SCENE(uLocal_98.f_28[2], iLocal_390, sLocal_377, animationName3, blendIn, -4f, 1, 16, 1148846080, 0);
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_390)){
...
if(func_209(uLocal_98.f_28[0]) && func_209(PLAYER::PLAYER_PED_ID()))if(PED::IS_PED_IN_COMBAT(uLocal_98.f_28[0], 0))if(MISC::GET_GAME_TIMER() > iLocal_374)if(_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_FIST", 7, 0, 0, 0)) iLocal_374=MISC::GET_GAME_TIMER() + 5000;
return;
}
...
if(!MISC::ARE_STRINGS_EQUAL(string1, "PAP4_THREAT")) func_223();
}
func_227(&uLocal_98.f_41[0], false);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_28[1], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_28[2], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_28[0], PLAYER::PLAYER_PED_ID(), true) && func_301(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_UNARMED") && func_301(PLAYER::PLAYER_PED_ID()) !=joaat("OBJECT")){
func_279();
bLocal_461=true;
iLocal_460=3;
iLocal_436=5;
...
if(!MISC::ARE_STRINGS_EQUAL(string12, "PAP4_THREAT")) func_223();
}}elseif(func_257(uLocal_98.f_28[0], 1126825984) && func_304() && func_301(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_UNARMED") && func_301(PLAYER::PLAYER_PED_ID()) !=joaat("OBJECT") || PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID())){
...
if(!MISC::ARE_STRINGS_EQUAL(string13, "PAP4_THREAT")) func_223();
}
func_227(&uLocal_98.f_41[0], false);
}else{
bLocal_461=true;
...
if(!MISC::ARE_STRINGS_EQUAL(string14, "PAP4_THREAT")) func_223();
}
func_227(&uLocal_98.f_41[0], false);
}}elseif(func_257(uLocal_98.f_28[0], 1126825984) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_28[1], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_28[2], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_98.f_28[0], PLAYER::PLAYER_PED_ID(), true) || bLocal_387 && func_301(PLAYER::PLAYER_PED_ID())==joaat("WEAPON_UNARMED") || func_301(PLAYER::PLAYER_PED_ID())==joaat("OBJECT")){
...
elseif(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_98.f_28[0], sLocal_379, "flinch_additive_a") > 0.7f){
...
if(!MISC::ARE_STRINGS_EQUAL(string15, "PAP4_THREAT") && !MISC::ARE_STRINGS_EQUAL(string15, "PAP4_ATTACK")) func_223();
}
...
if(!MISC::ARE_STRINGS_EQUAL(string16, "PAP4_THREAT") && !MISC::ARE_STRINGS_EQUAL(string16, "PAP4_ATTACK")) func_223();
}
func_220(true);
bLocal_465=true;
bLocal_391=false;
bLocal_387=true;
if(func_301(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_UNARMED")) func_279();
iLocal_460=3;
}}}
...
if(func_209(uLocal_98.f_28[1])){
if(PED::IS_PED_IN_GROUP(uLocal_98.f_28[1])) PED::REMOVE_PED_FROM_GROUP(uLocal_98.f_28[1]);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[1], sLocal_377, sLocal_393, 3)){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_390)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_98.f_28[1], -4f, true);
PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_390, 1f);
...
if(PED::IS_PED_IN_COMBAT(uLocal_98.f_28[0], 0) || PED::IS_PED_IN_MELEE_COMBAT(uLocal_98.f_28[0])) TASK::CLEAR_PED_TASKS(uLocal_98.f_28[0]);
if(STREAMING::HAS_ANIM_DICT_LOADED(sLocal_377)) TASK::TASK_PLAY_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 4f, -8f, -1, 57, 0, false, false, false);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_98.f_28[0], PLAYER::PLAYER_PED_ID(), -1);
bLocal_385=false;
}}
iLocal_345=MISC::GET_GAME_TIMER() + 15000;
...
char* func_302(var uParam0) // Position - 0x2B283{
return uParam0;
}
...
if(func_301(PLAYER::PLAYER_PED_ID())==joaat("WEAPON_STICKYBOMB"))if(func_258(uLocal_98.f_28[0], 1126825984) || func_258(uLocal_98.f_28[1], 1126825984) || func_258(uLocal_98.f_28[2], 1126825984)) return true;
else return true;
return false;
}
...
if(func_209(uLocal_98.f_28[2]) && !PED::IS_PED_IN_COMBAT(uLocal_98.f_28[2], 0) && !PED::IS_PED_IN_MELEE_COMBAT(uLocal_98.f_28[2]) && !PED::IS_PED_FLEEING(uLocal_98.f_28[2])) TASK::TASK_SMART_FLEE_PED(uLocal_98.f_28[2], PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
return true;
}
return false;
}
...
if(HUD::DOES_BLIP_EXIST(blLocal_159)) HUD::SET_BLIP_SCALE(blLocal_159, 1f);
func_216(false);
}elseif(PED::IS_PED_IN_VEHICLE(uLocal_98.f_28[0], uLocal_98.f_35[0], true)){
...
if(iLocal_436==0) func_309();
}elseif(bParam0 || !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() || !func_275(PLAYER::PLAYER_PED_ID(), uLocal_98.f_28[0], 30f, true)){
...
flag=false;
if(!bParam0){
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_213();
num=0;
if(!func_275(PLAYER::PLAYER_PED_ID(), uLocal_98.f_28[0], 30f, true)) num=1;
if(iLocal_463 > 1) flag=_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_LEAVE2", 7, num, 0, 0);
else flag=_CONVERSATION_ADD_LINE(&uLocal_160, "PAP4AUD", "PAP4_LEAVE", 7, num, 0, 0);
}
if(flag || bParam0){
func_220(true);
...
if(bParam1) TASK::TASK_ENTER_VEHICLE(uLocal_98.f_28[0], uLocal_98.f_35[0], 20000, -1, 2f, 1, 0);
else TASK::TASK_ENTER_VEHICLE(uLocal_98.f_28[0], uLocal_98.f_35[0], 20000, -1, 1f, 1, 0);
if(func_209(uLocal_98.f_28[1])) TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_98.f_28[1], uLocal_98.f_28[0], -1);
if(func_209(uLocal_98.f_28[2]) && !PED::IS_PED_FLEEING(uLocal_98.f_28[2]) && !bLocal_387 && !bLocal_465 && !PED::IS_PED_RAGDOLL(uLocal_98.f_28[2])){
...
}elseif(func_218(uLocal_98.f_35[0])){
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
...
TASK::TASK_SMART_FLEE_PED(uLocal_98.f_28[2], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
}}elseif(func_218(uLocal_98.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(uLocal_98.f_35[1], 0, false)){
...
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
if(func_209(uLocal_98.f_28[0])) TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_98.f_28[0], 6000);
...
HUD::SET_BLIP_COLOUR(*uParam0, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, "BLIP_ENEMY" /*Enemy*/);
if(bParam6 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_233(sParam2, 0, 0)) _SHOW_SUBTITLE_CLEAR_EXISTING(sParam1, 7500, 0);
}else{
HUD::SET_BLIP_COLOUR(*uParam0, 3);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, "BLIP_FRIEND" /*Friend*/);
if(bParam6 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_233(sParam1, 0, 0)) _SHOW_SUBTITLE_CLEAR_EXISTING(sParam2, 7500, 0);
}
*uParam3=MISC::GET_GAME_TIMER();
...
if(func_209(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_359, uLocal_362, fLocal_365, false, true, 0)) bLocal_366=true;
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Franklin", 0, 0, 0);
}
if(func_209(uLocal_98.f_28[0])) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_98.f_28[0], "Beverley", 0, 0, 0);
if(func_209(uLocal_98.f_28[1])) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_98.f_28[1], "film_guy", 0, 0, 0);
if(func_209(uLocal_98.f_28[2])) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_98.f_28[2], "makeup_artist", 0, 0, 0);
...
if(func_209(PLAYER::PLAYER_PED_ID())) PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), false, 0);
return;
}
...
if(!func_244()) Global_20383.f_1=3;
Global_21725=5;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_318(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_315() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_318(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_317(-1, false)==8;
...
if(func_319())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_390, false);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_390, false);
if(func_209(uLocal_98.f_28[0])) TASK::TASK_SYNCHRONIZED_SCENE(uLocal_98.f_28[0], iLocal_390, sLocal_377, sLocal_392, 1000f, -4f, 1, 16, 1148846080, 0);
if(func_209(uLocal_98.f_28[1])) TASK::TASK_SYNCHRONIZED_SCENE(uLocal_98.f_28[1], iLocal_390, sLocal_377, sLocal_393, 1000f, -4f, 1, 16, 1148846080, 0);
if(func_209(uLocal_98.f_28[2])) TASK::TASK_SYNCHRONIZED_SCENE(uLocal_98.f_28[2], iLocal_390, sLocal_377, sLocal_394, 1000f, -4f, 1, 16, 1148846080, 0);
bLocal_391=true;
return;
}
...
if(func_332(0)) func_329(iParam0);
...
if(func_333()) return;
if(Global_20584)if(func_331()) func_330(true, true);
else func_330(false, false);
...
if(iParam5==1) func_346(500, false);
}
return;
}
...
if(bParam18) func_344(playersLastVehicle);
...
if(entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)if(func_342(playersLastVehicle, vParam0, vParam3, fParam6)) flag=true;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
...
if(bParam16)if(func_340(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true)) flag=false;
if(flag){
...
for (i=0;
func_341(echParam1, i, &garageName, &num);
i=i + 1){
...
num=0;
if(!func_221(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE)) TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
if(iParam0==1)if(!func_349()) return false;
...
if(func_209(PLAYER::PLAYER_PED_ID())) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_160, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
func_363();
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_98.f_41[1])) AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_488, sLocal_490, uLocal_98.f_41[1], sLocal_489, false, 0);
iLocal_327=2;
}
break;
case 2:
...
func_322();
if(func_359()) func_356(0, -1, 1);
else func_354(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, false, false);
func_353(1, 1, 1);
return;
}
...
if(iParam1==1) func_346(500, false);
return;
}
...
Vector3 func__357(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x2DB84{
var groundZ;
vParam1.f_2=vParam1.f_2 + 0.15f;
if(MISC::GET_GROUND_Z_FOR_3D_COORD(vParam1, &groundZ, false, false)) vParam1.f_2=groundZ;
if(func_358(pedParam0)) ENTITY::SET_ENTITY_COORDS(pedParam0, vParam1, true, false, false, true);
return vParam1;
}
...
if(bParam0) func_313(iParam1, iParam2, 1, true);
}
return;
}
...
if(func_209(uLocal_98.f_28[1])) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_160, 4, uLocal_98.f_28[1], "Pap4Cameraman", 0, 1);
return;
}
...
if(!func_376(0, uParam0)) Global_78815=MISC::GET_GAME_TIMER() - 9000;
...
text={
func_367(Global_78814, Global_78816, iParam10) 
};
y==-0.014f;
...
if(!func_378(0) || Global_78828 || Global_78817==1 || !CAM::IS_SCREEN_FADED_IN()) return false;
switch (Global_78813){
case 0:
...
if(func_385(echParam0, echParam1)==1 && func_384(echParam0, echParam1)==1) bParam2=false;
num=echParam1;
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-476.36862f, 229.57437f, 82.07077f 
};
uParam0->f_17[1 /*3*/]={
-513.6883f, 234.2165f, 87.28937f 
};
uParam0->f_24=25f;
uParam0->f_27=0;
uParam0->f_26=1;
...
break;
case 1:
if(!func_398(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict)) return false;
iLocal_94=2;
break;
case 2:
flag=true;
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_28[0], PED::GET_PED_BONE_INDEX(uParam0->f_28[0], 57005), 0.1561f, -0.003f, -0.0344f, 202.8703f, -124.43f, -121.5398f, false, false, false, false, 2, true, 0);
else flag=false;
}
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1])){
func_390(&uParam0->f_41[1], num[6], -490.11f, 233.15f, 82.1f, 0f);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1])) ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[1], PED::GET_PED_BONE_INDEX(uParam0->f_28[1], 57005), 0.1181f, 0.2229f, -0.1535f, 259.2501f, 24.08f, -51.2899f, false, false, false, false, 2, true, 0);
else flag=false;
}
if(flag) iLocal_94=3;
break;
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_226(&uParam0->[i]);
else func_227(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_392(&uParam0->[i]);
else func_406(&uParam0->[i]);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_394(&uParam0->[i]);
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_98.f_28[0], sLocal_377, sLocal_378, 3)) TASK::STOP_ANIM_TASK(uLocal_98.f_28[0], sLocal_377, sLocal_378, -1056964608);
if(!PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[0], false)) TASK::TASK_WANDER_STANDARD(uLocal_98.f_28[0], 1193033728, 0);
}
if(func_209(uLocal_98.f_28[1]) && !FILES::GET_DLC_VEHICLE_FLAGS(uLocal_98.f_28[1])){
if(func_209(PLAYER::PLAYER_PED_ID())){
...
}elseif(!PED::IS_PED_FLEEING(uLocal_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_98.f_28[1], true)){
func_297();
PED::SET_PED_FLEE_ATTRIBUTES(uLocal_98.f_28[1], 128, true);
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_98.f_28[2], taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
}}elseif(!PED::IS_PED_FLEEING(uLocal_98.f_28[2])){
PED::SET_PED_FLEE_ATTRIBUTES(uLocal_98.f_28[2], 128, true);
...
if(TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480)) TASK::REMOVE_WAYPOINT_RECORDING(sLocal_480);
if(TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481)) TASK::REMOVE_WAYPOINT_RECORDING(sLocal_481);
AUDIO::STOP_SOUND(iLocal_488);
func_215(&blLocal_159);
func_227(&uLocal_98.f_41[0], false);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_98.f_41[1])) ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_98.f_41[1]);
...
if(Global_100681 !=12)if(func_415(sParam0, 6, iParam1)) Global_100681.f_1=iParam1;
return;
}
...
if(func_421()){
if(func_420()){
if(Global_100718 >=func_417())if(!IS_BIT_SET(Global_91469[iParam2 /*34*/].f_15, 16))if(Global_113648.f_9087.f_330[iParam2 /*6*/].f_1 >=2) Global_94857=1;
...
if(Global_100681.f_11==5)if(func_416(&(Global_100681.f_3)) > -1) return true;
return false;
}
