...
case 6:
if(!func_11()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE(func_6(Global_2756257.f_3.f_1), -1, 0, 0)){
func_347(7);
...
if(MISC::IS_BIT_SET(Global_2756257.f_1, bParam0)){
...
iVar0=18;
while (iVar0 >=0){
Global_2756257.f_136[iVar0 + 1 /*2*/]={
Global_2756257.f_136[iVar0 /*2*/] 
};
iVar0=(iVar0 + -1);
}
...
func_17(3);
}elseif(func_15(&(Global_2756257.f_177), (Global_262145.f_45 * 120000), 0)){
func_2(3);
func_347(6);
}}else{
func_347(6);
...
return 0;
}elseif(!func_23(iParam20)){
return 0;
}elseif(NETWORK::NETWORK_GET_HOST_OF_SCRIPT(func_22(), -1, 0) !=PLAYER::PLAYER_ID()){
return 0;
}
func_21();
iVar0=0;
...
Var2={
Global_2650102.f_199.f_962[iVar1 /*75*/] 
};
Global_2650102.f_199.f_962[iVar1 /*75*/]={
Global_2650102.f_199.f_962[iVar0 /*75*/] 
};
Global_2650102.f_199.f_962[iVar0 /*75*/]={
Var2 
};
...
}elseif(func_296(iParam0, iVar76, iParam2)){
}elseif(!func_107(iParam0, iParam1, iVar76, iParam2)){
}elseif(!func_87(iParam0, iParam1, iVar76, iParam2)){
}else{
...
int func_110(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, int iParam18){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_116(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam3)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_116(iVar1), Param0, 1) <=(fVar2 + fParam3)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_117(iVar1), Param0, 1) < fParam3){
return 1;
}}
}}}}}
iVar0++;
...
struct<13> func_125(var uParam0){
struct<13> Var0;
...
var func__129(var uParam0, int iParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=iParam1;
...
case 2:
if(iParam2 !=func_324()){
if(!func_146(uParam0->f_129, uParam0->f_767, uParam0->f_1220, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam2), 0))){
return 0;
}}
break;
case 1:
...
Var3={
func_152(uParam0, iParam1, iParam2, iParam3, Var0) 
};
...
Vector3 func__152(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4){
switch (iParam1){
case 271:
switch (iParam2){
case 14:
...
Vector3 func__153(int iParam0, struct<3> Param1){
int iVar0;
float fVar1;
int iVar2;
float fVar3;
...
Vector3 func__154(int iParam0, int iParam1){
switch (iParam0){
case 10:
switch (iParam1){
case 0:
...
Vector3 func__158(struct<3> Param0){
var uVar0;
var uVar1;
if(func_163(0)){
uVar0=func_161(func_162());
if(func_160(uVar0)){
return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar0, Param0);
}else{
return func_159(904, func_162(), 0);
}}else{
uVar1=func_161(PLAYER::PLAYER_ID());
if(func_160(uVar1)){
return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar1, Param0);
}}
return 0f, 0f, 0f;
}


Vector3 func__159(int iParam0, int iParam1, bool bParam2){
int iVar0;
int iVar1;
if(iParam1==func_324()){
return 0f, 0f, 0f;
...
Vector3 func__165(int iParam0, int iParam1){
struct<3> Var0[2];
Var0[0 /*3*/]={
0f, 0f, 0f 
};
...
case 2:
Var0={
-1082.958f, -1254.855f, 4.4214f 
};
break;
case 3:
Var0={
900.0288f, -1029.762f, 33.9714f 
};
break;
case 4:
Var0={
247.7398f, -1950.657f, 22.0817f 
};
break;
case 5:
Var0={
...
case 6:
Var0={
-1048.123f, -2017.136f, 12.1616f 
};
break;
case 7:
Var0={
-1267.888f, -818.313f, 16.0992f 
};
break;
case 8:
Var0={
-879.1935f, -2731.856f, 12.8285f 
};
break;
case 9:
Var0={
...
case 10:
Var0={
1566.514f, -2137.776f, 76.6229f 
};
break;
case 11:
Var0={
-314.3864f, -2721.792f, 5.0003f 
};
break;
case 12:
Var0={
...
case 13:
Var0={
-546.1532f, -1775.258f, 20.6843f 
};
break;
case 14:
Var0={
-307.6485f, -1364.914f, 30.2957f 
};
break;
case 15:
Var0={
...
case 18:
Var0={
1042.462f, -2177.798f, 30.4457f 
};
break;
case 19:
Var0={
1013.842f, -2514.939f, 27.3049f 
};
break;
case 20:
Var0={
...
case 21:
Var0={
549.6728f, -1929.794f, 23.8145f 
};
break;
case 22:
Var0={
126.5327f, -2200.172f, 5.0333f 
};
break;
}
return Var0;
...
Vector3 func__175(struct<3> Param0){
var uVar0;
var uVar1;
if(func_163(0)){
uVar0=func_176(func_162());
if(func_160(uVar0)){
return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar0, Param0);
}else{
return func_159(757, func_162(), 0);
}}else{
uVar1=func_176(PLAYER::PLAYER_ID());
if(func_160(uVar1)){
return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar1, Param0);
}}
return 0f, 0f, 0f;
...
Vector3 func__178(int iParam0, var uParam1, var uParam2, int iParam3){
switch (iParam0){
case 181:
return 0f, 0f, 0f;
default:
...
}}}elseif(func_217(iParam0) && !func_216(iParam0)){
...
}}elseif(func_206(iParam0) && !func_205(iParam0)){
...
}}}}elseif(func_202(iParam0) && !func_201(iParam0)){
...
}}}}elseif(func_193(iParam0)){
return -366.7f, -1909.6f, 20f;
}elseif(func_192(iParam0)){
...
}elseif(((Global_1575060 || Global_2635559.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_120(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7;
}}
return -1;
}
...
}}elseif(((Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1 && Global_1575060) && iParam0==PLAYER::PLAYER_ID()) && func_120(iParam0, 1, 0)){
return func_186(Global_2657589[iParam0 /*466*/].f_321.f_7)==20;
}}
return 0;
}
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_120(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(iVar1867==iParam3){
}elseif(!func_238(&Var11, iParam1, iParam2, iVar1867)){
}else{
Var1868={
func_236(&Var11, iParam1) 
};
if(func_118(Var1868)){
}else{
...
Vector3 func__236(var uParam0, int iParam1){
switch (iParam1){
case 181:
return uParam0->f_129.f_1[0 /*21*/].f_3;
default:
...
func_258();
if(!DATAFILE::DATAFILE_LOAD_OFFLINE_UGC(uParam0, 0)){
return 0;
}
func_241(uParam1);
func_240(uParam2);
...
uParam1->f_19.f_5[iVar4 /*13*/].f_3={
func_247(uVar17, iVar4, 0f, 0f, 0f, bVar18) 
};
uParam1->f_19.f_5[iVar4 /*13*/].f_6=func_246(uVar19, iVar4, 0f, bVar20);
uParam1->f_19.f_5[iVar4 /*13*/].f_7={
func_247(uVar21, iVar4, 0f, 0f, 0f, bVar22) 
};
...
uParam1->f_129.f_1[iVar4 /*21*/].f_3={
func_247(uVar37, iVar4, 0f, 0f, 0f, bVar38) 
};
...
uParam1->f_767.f_1[iVar4 /*15*/].f_4={
func_247(uVar90, iVar4, 0f, 0f, 0f, bVar91) 
};
...
uParam1->f_1220.f_1[iVar4 /*12*/].f_4={
func_247(uVar119, iVar4, 0f, 0f, 0f, bVar120) 
};
uParam1->f_1220.f_1[iVar4 /*12*/].f_7=func_246(uVar121, iVar4, 0f, bVar122);
uParam1->f_1220.f_1[iVar4 /*12*/].f_8={
func_247(uVar123, iVar4, 0f, 0f, 0f, bVar124) 
};
...
iVar4=0;
while (iVar4 < 1){
uParam1->f_1609.f_1[iVar4 /*11*/]={
func_247(uVar135, iVar4, 0f, 0f, 0f, bVar136) 
};
...
uParam1->f_1622.f_1[iVar4 /*9*/].f_2={
func_247(uVar160, iVar4, 0f, 0f, 0f, bVar161) 
};
uParam1->f_1622.f_1[iVar4 /*9*/].f_5={
func_247(uVar162, iVar4, 0f, 0f, 0f, bVar163) 
};
...
uParam1->f_1633.f_1[iVar4 /*10*/].f_1[iVar5 /*8*/].f_1={
func_247(uVar175[iVar5], iVar4, 0f, 0f, 0f, iVar177[iVar5]) 
};
uParam1->f_1633.f_1[iVar4 /*10*/].f_1[iVar5 /*8*/].f_4={
func_247(uVar179[iVar5], iVar4, 0f, 0f, 0f, iVar181[iVar5]) 
};
...
iVar4=0;
while (iVar4 < 12){
uParam1->f_1645[iVar4 /*16*/]={
func_244(uVar188, iVar4, "", bVar189) 
};
iVar4++;
}
iVar4=0;
while (iVar4 < 2){
uParam1->f_1838[iVar4 /*8*/]={
func_247(uVar191, iVar4, 0f, 0f, 0f, bVar192) 
};
...
Vector3 func__247(var uParam0, int iParam1, struct<3> Param2, bool bParam5){
...
var func__259(int iParam0, var uParam1, int iParam2){
var uVar0;
switch (iParam0){
case 150:
...
}elseif(!func_306(iParam0, iVar0, iParam1)){
}else{
...
if(iParam0 !=-1){
return MISC::IS_BIT_SET(Global_1979596[iParam0 /*53*/].f_3, iParam1);
}
return 0;
}
...
return MISC::IS_BIT_SET(Global_2756257.f_1, iParam0);
}
...
if(MISC::IS_BIT_SET(Local_232[iVar0 /*3*/].f_1, 0)){
if(!MISC::IS_BIT_SET(Local_232[iVar0 /*3*/].f_1, 4)){
iLocal_223++;
}
if(Param0.f_1==18){
...
return 1;
}}elseif(MISC::IS_BIT_SET(Local_232[iVar0 /*3*/].f_1, 1)){
}elseif(!MISC::IS_BIT_SET(Local_232[iVar0 /*3*/].f_1, 1)){
return 0;
}}
iVar0++;
...
if(MISC::IS_BIT_SET(uLocal_201, 1)){
iVar0=500;
}
...
if(!func_422(PLAYER::PLAYER_ID(), 0)){
if(!func_381() && !MISC::IS_BIT_SET(uLocal_201, 0)){
...
func_421(6);
}elseif(func_329(3) && func_380(&(Global_2756257.f_177))){
func_361();
}
break;
case 6:
...
}}}elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&cVar1)) !=0){
...
iVar9++;
}}elseif(NETWORK::NETWORK_IS_SCRIPT_ACTIVE(&cVar0, Param0.f_16, iVar8, 0)){
return 0;
}
...
if(!MISC::IS_BIT_SET(Global_2793044.f_206.f_1, 1)){
...
}}elseif(((Global_262145.f_45 * 120000) - func_379(&(Global_2756257.f_177), 0, 0)) < 600000){
if(!MISC::IS_BIT_SET(Global_2793044.f_206.f_1, 2)){
if(func_368(31, 0, 0) && !func_367()){
func_362("ACD_TSCH", 5, 0);
}
MISC::SET_BIT(&(Global_2793044.f_206.f_1), 2);
}}elseif(((Global_262145.f_45 * 120000) - func_379(&(Global_2756257.f_177), 0, 0)) < 1200000){
if(!MISC::IS_BIT_SET(Global_2793044.f_206.f_1, 3)){
if(func_368(31, 0, 0) && !func_367()){
...
void func_363(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11){
int iVar0;
...
var uVar0;
var uVar1;
uVar0=Global_2848280[iParam0 /*3*/][func_370(iParam1)];
...
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1284.885f, -3184.986f, 4.906164f, 833.8964f, -3182.306f, 54.90125f, 250f, 0, 1, 0)){
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1284.793f, -3270.265f, 4.902858f, 838.3597f, -3268.248f, 55.07449f, 250f, 0, 1, 0)){
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 864.6642f, -2900.037f, 4.900886f, 864.0037f, -3345.969f, 54.90067f, 250f, 0, 1, 0)){
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 447.0059f, -2983.689f, 5.00868f, 750.05f, -2981.953f, 54.88502f, 250f, 0, 1, 0)){
return 1;
}
return 0;
}
...
uVar0=Global_2805027[iParam0 /*3*/][func_370(iParam1)];
...
var func__413(var uParam0, int iParam1){
...
return MISC::IS_BIT_SET(Local_232[iParam0 /*3*/].f_1, iParam1);
}
...
void func_439(var uParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_438();
}
