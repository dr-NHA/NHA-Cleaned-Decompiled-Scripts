...
iLocal_45=-1;
iLocal_126=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_312();
func_311(5);
func_300(&(uLocal_176.f_1), Global_96710[5 /*19*/]);
func_299(&uLocal_176, 2);
if(Global_113648.f_9087.f_99.f_205[9] !=5) Global_113648.f_9087.f_99.f_205[9]=5;
while (!func_298(5)){
...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("rural_bank_heist")) > 0) func_2();
SYSTEM::WAIT(0);
}
func_1(5);
func_312();
...
num2=num;
if(num2 !=uParam0->f_464 && !(num2==2 && uParam0->f_464==4) && !(*uParam0==1 && num2==3 && uParam0->f_464==4))if(IS_BIT_SET(uParam0->f_449, 2)) func_5(uParam0, num2, 0);
...
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_20[0 /*4*/], "")) func_21(&uParam0->f_1.f_20[0 /*4*/], 3, 0, -1, 10000, 7, 0, 0, 0);
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_20[1 /*4*/], "")) func_21(&uParam0->f_1.f_20[1 /*4*/], 3, 1000, -1, 10000, 7, 0, 0, 0);
Global_113648.f_1[*uParam0]=true;
}elseif(func_20() && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_108[0 /*4*/], "")) func_21(&uParam0->f_1.f_108[0 /*4*/], 3, 0, -1, 10000, 7, 0, 0, 0);
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_108[1 /*4*/], "")) func_21(&uParam0->f_1.f_108[1 /*4*/], 3, 1000, -1, 10000, 7, 0, 0, 0);
Global_113648.f_1.f_6[*uParam0]=true;
}elseif(func_20() && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
Vector3 func__27(var uParam0, var uParam1) // Position - 0x13D0{
float num;
float num2;
float num3;
float num4;
...
if(*uParam0 !=1) func_8("H_LBL_CRW" /*CREW*/);
func_8("H_LBL_TODO" /*TODO*/);
if(*uParam0 !=2) func_8("H_LBL_APP" /*APPROACH*/);
switch (*uParam0){
case 0:
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_68(uParam0);
return;
}
...
}elseif(func_139(uParam0->f_451, true)){
...
if(func_77()) return;
if(Global_20584)if(func_76()) func_75(true, true);
else func_75(false, false);
if(Global_20383.f_1==10 || Global_20383.f_1==9) MISC::SET_BIT(&Global_8254, 16);
...
if(!MISC::ARE_STRINGS_EQUAL(controlGroupInstructionalButtonsString, uParam0->f_466)) func_7(uParam0);
uParam0->f_466=controlGroupInstructionalButtonsString;
func_121();
func_109(uParam0);
func_87(uParam0);
if(uParam0->f_464==1) func_84(uParam0);
if(func_20()) func_18(uParam0);
...
if(bParam3) uParam0->f_17=func_81(uParam0->f_17, uParam0->f_7 - uParam0->f_19, uParam0->f_7);
else uParam0->f_17=func_81(uParam0->f_17, uParam0->f_7 - uParam0->f_19, uParam0->f_7 + uParam0->f_19);
}elseif(bParam8){
...
if(!flag) func_85(3, *uParam0, true);
}}}
return;
}
...
if(func_92(PLAYER::PLAYER_ID())) return false;
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_101(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_101(character)) return func_104(character);
...
if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL)) func_7(uParam0);
...
if(func_37(uParam0, num3)) flag=false;
}else{
flag=false;
}}
}
...
k < 2;
k=k + 1){
if(uParam0->f_1.f_30[k] !=13) func_115(*uParam0, uParam0->f_1.f_30[k], false);
}
uParam0->f_427=0;
func_11(uParam0, true);
uParam0->f_456=MISC::GET_GAME_TIMER();
...
l < 2;
l=l + 1){
if(uParam0->f_1.f_30[l] !=13) func_115(*uParam0, uParam0->f_1.f_30[l], false);
}
func_113(8, 0);
func_85(5, 1, false);
uParam0->f_427=0;
...
num=func_30(*uParam0);
func_113(num, num2);
if(!_IS_MISSION_REPEAT_ACTIVE(false)) func_112(*uParam0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "SELECT" /*Filter List*/, "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
func_62(uParam0, num2, 0);
if(uParam0->f_1.f_30[scaleformMovieMethodReturnValueInt] !=13) func_115(*uParam0, uParam0->f_1.f_30[scaleformMovieMethodReturnValueInt], true);
for (m=0;
m < uParam0->f_1.f_96;
m=m + 1){
func_61(uParam0, m);
...
if(uParam0->f_427 !=0) func_110(uParam0, uParam0->f_427);
return;
}
...
switch (iParam1){
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 0)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 1)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
}
break;
case 3:
switch (iParam1){
case 12:
if(IS_BIT_SET(Global_113648.f_1.f_117, 3)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
break;
case 9:
if(IS_BIT_SET(Global_113648.f_1.f_117, 6)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
break;
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 0))if(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 1))if(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
break;
case 6:
if(IS_BIT_SET(Global_113648.f_1.f_117, 4)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 7:
if(IS_BIT_SET(Global_113648.f_1.f_117, 2)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 8:
if(IS_BIT_SET(Global_113648.f_1.f_117, 5)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
}
break;
case 4:
switch (iParam1){
case 12:
if(IS_BIT_SET(Global_113648.f_1.f_117, 15))if(IS_BIT_SET(Global_113648.f_1.f_117, 3)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[25 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
break;
case 7:
if(IS_BIT_SET(Global_113648.f_1.f_117, 2))if(IS_BIT_SET(Global_113648.f_1.f_117, 14)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[30 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[28 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 14)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[29 /*2*/], 1);
break;
case 9:
if(IS_BIT_SET(Global_113648.f_1.f_117, 18))if(IS_BIT_SET(Global_113648.f_1.f_117, 6)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[27 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
break;
case 4:
if(IS_BIT_SET(Global_113648.f_1.f_117, 17)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
break;
case 5:
if(IS_BIT_SET(Global_113648.f_1.f_117, 12)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
break;
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 10))if(IS_BIT_SET(Global_113648.f_1.f_117, 0))if(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 11))if(IS_BIT_SET(Global_113648.f_1.f_117, 1))if(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 3:
if(IS_BIT_SET(Global_113648.f_1.f_117, 13)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 6:
if(IS_BIT_SET(Global_113648.f_1.f_117, 19))if(IS_BIT_SET(Global_113648.f_1.f_117, 4)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 8:
if(IS_BIT_SET(Global_113648.f_1.f_117, 16))if(IS_BIT_SET(Global_113648.f_1.f_117, 5)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 13:
if(IS_BIT_SET(Global_113648.f_1.f_117, 20)) func_24(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
}
break;
}}
...
if(!CUTSCENE::IS_CUTSCENE_PLAYING()){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(Global_44446==true) func_128(PLAYER::PLAYER_PED_ID());
vector={
uParam0->f_401 
};
vector={
...
if(iParam1==-1) return;
if(iParam2==6) return;
if(func_134(iParam0, iParam1, iParam2)) return;
num=func_133();
if(num==-1) return;
...
if(func_135(iParam0, iParam1, iParam2)==-1) return false;
return true;
}
...
if(!func_101(character)) return false;
switch (iParam0){
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_149() || Global_112695 || Global_32166 || func_148() || func_106(8, -1) || func_147() || func_146() || func_145() || func_144() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_149() || Global_32166 || func_148() || func_106(8, -1) || func_145() || func_147() || func_146() || func_144() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_149() || Global_112695 || Global_32166 || func_148() || func_106(8, -1) || func_145() || func_147() || func_146() || func_144() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_149() || Global_112695 || Global_32166 || func_148() || func_106(8, -1) || func_147() || func_146() || func_144() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_149() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_106(8, -1) || func_144() || func_143() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_106(8, -1) || func_147() || func_146() || func_143() || func_142()) return false;
...
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_128, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_128, "LESTER", 1, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_129, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_129, "MICHAEL", 0, joaat("Player_Zero"), 0);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_132[2], false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_132[2], "TREVOR", 0, joaat("Player_Two"), 0);
func_125(true);
func_72(true);
func_265(true, true, true, false, false, false, false);
iLocal_42=-1;
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) bLocal_131=true;
else bLocal_131=false;
...
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_129, false)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_129, true, false);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_128, false)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_128, true, false);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_132[2])) ENTITY::SET_ENTITY_VISIBLE(uLocal_132[2], true, false);
MISC::CLEAR_BIT(&iLocal_41, 18);
}
if(!CAM::DOES_CAM_EXIST(caLocal_127)) caLocal_127=CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), 1398.167f, 3605.4375f, 39.6443f, -8.2882f, 0f, 126.8884f, 50f, true, 2);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
...
if(_GET_CURRENT_PLAYER_CHARACTER() !=CHAR_TREVOR)if(func_260(&uLocal_132, 2)) func_198(&uLocal_132, false, false, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("Player_Two"));
if(!_IS_MISSION_REPEAT_ACTIVE(false)){
AUDIO::START_AUDIO_SCENE("PS_1_TREVOR_PUKING");
vector={
1391.8099f, 3614.6062f, 37.97f 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(vector, &(vector.f_2), false, false);
...
if(!_IS_MISSION_REPEAT_ACTIVE(false)) CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_128)) PED::DELETE_PED(&pedLocal_128);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_129)) PED::DELETE_PED(&pedLocal_129);
func_197(15000);
GRAPHICS::RESET_ADAPTATION(6);
}}elseif(IS_BIT_SET(iLocal_41, 11)){
...
if(_CONVERSATION_ADD_LINE(&(uLocal_176.f_484), "RBS1AUD", "RBS1_VOMIT", 8, 0, 0, 0)) MISC::SET_BIT(&iLocal_41, 12);
}
...
if(!bLocal_131) CAM::SET_FIRST_PERSON_FLASH_EFFECT_TYPE(3);
CAM::RENDER_SCRIPT_CAMS(false, true, 1000, true, false, 0);
if(CAM::DOES_CAM_EXIST(caLocal_127)) CAM::DESTROY_CAM(caLocal_127, false);
}}
}
elseif(entityAnimCurrentTime > 0.22f && entityAnimCurrentTime < 0.3f){
...
elseif(entityAnimCurrentTime > 0.34f && entityAnimCurrentTime < 0.36f){
...
elseif(entityAnimCurrentTime > 0.4222f && entityAnimCurrentTime < 0.516f){
...
elseif(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_130)){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_130, false);
iLocal_130=0;
}
if(entityAnimCurrentTime > 0.98f){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==FIRST_PERSON) TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LeadOut_FPS", 4f, -1.5f, -1, 48, 0, false, false, false);
else TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LEADOUT", 4f, -1.5f, -1, 48, 0, false, false, false);
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("PS_1_TREVOR_PUKING")) AUDIO::STOP_AUDIO_SCENE("PS_1_TREVOR_PUKING");
}}}elseif(IS_BIT_SET(iLocal_41, 16)){
MISC::CLEAR_BIT(&iLocal_41, 11);
}}}elseif(iLocal_42==-1){
...
}}elseif(MISC::GET_GAME_TIMER() > iLocal_42){
if(!_IS_MISSION_REPEAT_ACTIVE(false)){
Global_63362=false;
Global_100720=0;
func_195();
...
if(ENTITY::DOES_ENTITY_EXIST(veLocal_46))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_46, false)) VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(veLocal_46, 0, true);
func_162(&iLocal_44);
MISC::CLEAR_BIT(&iLocal_41, 1);
PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_125, false);
if(iLocal_126 !=-1)if(PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_126)) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_126);
...
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("RBHS_MSC_3_P3")) CUTSCENE::REMOVE_CUTSCENE();
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LEADOUT", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "MISSHEISTPALETOSCORE1LEADINOUT", "TRV_UPPERBODY_LeadOut_FPS", 3)) iLocal_43=MISC::GET_GAME_TIMER() + 4000;
...
break;
case 11:
if(func_158(91)) func_159(0, true);
break;
case 5:
if(func_158(91)) func_159(2, true);
break;
case 3:
if(func_158(67)) func_159(5, true);
break;
case 2:
if(func_158(77)) func_159(7, true);
break;
}}}}
if(!func_39(10) && IS_BIT_SET(Global_113648.f_24997.f_8[4], 0)) func_159(9, true);
if(!func_39(13) && IS_BIT_SET(Global_113648.f_24997.f_8[16], 0)) func_159(12, true);
if(!func_39(12))if(iParam0==4) func_159(11, true);
if(!bParam1){
if(!func_157(69)) func_21("DI_HLP_HST" /*Heist characters become available in Rockstar Editor's 'Director Mode' after being up for selection on a GTAV heist.*/, 2, 0, 20000, 10000, 7, 0, 209, 0);
...
if(!bParam1) func_156(func_160(iParam0));
}}
return;
}
...
if(!func_181(iParam2, &uParam0->f_2300[iParam1 /*3*/], &uParam0->f_2310[iParam1])) return 0;
if(!func_180(uParam0->f_2300[iParam1 /*3*/], 0f, 0f, 0f, false)){
if(!func_180(Global_99120[iParam2 /*3*/], 0f, 0f, 0f, false)){
unk.f_11=12;
unk.f_31=49;
unk.f_81=2;
if(func_165(iParam1, iParam2, &unk, &unk99, &unk102, &unk103, &unk106)) Global_100085[iParam1 /*98*/]={
unk 
};
}}
...
*uParam3={
Global_100388[iParam0 /*3*/] - Global_113648.f_2365.f_539.f_2300[iParam0 /*3*/] 
};
...
return true;
case 282:
if(func_165(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
case 283:
if(func_165(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
...
if(hParam0==joaat("blimp"))if(!func_177() && !func_176() && !func_175() && !func_174() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_173() || MISC::IS_PC_VERSION() || func_172()){
}elseif(!func_175()){
return false;
}}
if(bParam1)if(!func_171(hParam0, iParam2)) return false;
if(!func_169(hParam0)) return false;
return true;
}
...
if(Global_100085[iParam0 /*98*/]==joaat("blimp") || Global_100085[iParam0 /*98*/]==joaat("blimp2")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("submersible") || Global_100085[iParam0 /*98*/]==joaat("submersible2")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("freight")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("packer")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("asea2")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("burrito2") || Global_100085[iParam0 /*98*/]==joaat("fbi2")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("entityxf") && !Global_113648.f_9087.f_330[8 /*6*/]) return true;
if(Global_100085[iParam0 /*98*/]==joaat("cheetah") && !Global_113648.f_9087.f_330[8 /*6*/]) return true;
if(Global_100085[iParam0 /*98*/]==joaat("policeb") && !Global_113648.f_9087.f_330[8 /*6*/]) return true;
if(Global_100085[iParam0 /*98*/]==joaat("ztype") && !Global_113648.f_9087.f_330[9 /*6*/]) return true;
if(Global_100085[iParam0 /*98*/]==joaat("polmav") && !Global_113648.f_9087.f_330[9 /*6*/]) return true;
if(Global_100085[iParam0 /*98*/]==joaat("jb700") && !Global_113648.f_9087.f_330[10 /*6*/]) return true;
if(Global_100085[iParam0 /*98*/]==joaat("monroe") && !Global_113648.f_9087.f_330[11 /*6*/]) return true;
if(Global_100085[iParam0 /*98*/]==joaat("firetruk")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("handler")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("monroe")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("phantom")) return true;
if(Global_100085[iParam0 /*98*/]==joaat("gauntlet") && !Global_113648.f_9087.f_330[80 /*6*/] && !Global_113648.f_9087.f_330[81 /*6*/] && !Global_113648.f_9087.f_330[82 /*6*/]) return true;
return false;
}
...
if(iParam1 < 1 || iParam1 > func_186(num, num2)) return;
...
var func__188(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1034B{
...
character=_GET_CURRENT_PLAYER_CHARACTER();
if(!uParam0->f_23) func_247(ped, false);
...
if(func_101(_GET_CURRENT_PLAYER_CHARACTER()))if(PLAYER::IS_SPECIAL_ABILITY_ACTIVE(PLAYER::PLAYER_ID(), 0)) PLAYER::SPECIAL_ABILITY_DEACTIVATE_FAST(PLAYER::PLAYER_ID(), 0);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SET_AUTO_GIVE_PARACHUTE_WHEN_ENTER_PLANE(PLAYER::PLAYER_ID(), func_298(67));
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SET_AUTO_GIVE_SCUBA_GEAR_WHEN_EXIT_VEHICLE(PLAYER::PLAYER_ID(), func_298(68));
...
break;
case CHAR_FRANKLIN:
if(Global_113648.f_9087.f_330[2 /*6*/]) func_203(4, *uParam1);
func_203(7, *uParam1);
func_203(8, *uParam1);
func_203(11, *uParam1);
if(Global_113648.f_9087.f_99.f_58[126]) func_203(12, *uParam1);
break;
case CHAR_TREVOR:
if(Global_113648.f_9087.f_330[20 /*6*/]) func_203(4, *uParam1);
func_203(7, *uParam1);
func_203(8, *uParam1);
func_203(11, *uParam1);
break;
...
if(func_204(iParam0, pedParam1)) return;
...
func_208(iParam0);
if(IS_BIT_SET(Global_38617[iParam0 / 32], iParam0 % 32)) func_207(iParam0);
}}
return;
}
...
if(IS_BIT_SET(vector.f_4, 2)) func_213(iParam0, &vector);
...
if(Global_113648.f_9087) num=func_210(iParam0);
else num=0;
if(func_297(14)) num=0;
...
if(func_101(character))if(IS_BIT_SET(Global_95708[0], character))if(iParam0 !=40) return 0;
else return 1;
break;
case 47:
case 48:
...
if(func_101(character))if(IS_BIT_SET(Global_95708[6], character)) return 0;
break;
case 51:
case 52:
if(character==CHAR_TREVOR){
if(IS_BIT_SET(Global_113648.f_7231[2], 0)) return 0;
if(func_101(character))if(IS_BIT_SET(Global_95708[2], character)) return 0;
}elseif(character==CHAR_MICHAEL){
if(IS_BIT_SET(Global_113648.f_7231[1], 0)) return 0;
if(func_101(character))if(IS_BIT_SET(Global_95708[1], character)) return 0;
}
break;
case 53:
if(character==CHAR_TREVOR)if(IS_BIT_SET(Global_113648.f_7231[3], 0)) return 0;
if(func_101(character))if(IS_BIT_SET(Global_95708[3], character)) return 0;
break;
default:
return 0;
}
...
if(func_219()==-1 || func_219()==999 && !func_218()==0) return true;
return false;
}
...
var unk;
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !func_101(_GET_CURRENT_PLAYER_CHARACTER()) || !func_234()) return;
unk=12;
unk.f_13=12;
unk.f_26=12;
unk.f_39=9;
...
if(func_231(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && pedParam0==PLAYER::PLAYER_PED_ID())if(func_231(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
else uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO, iParam3, 0);
}
return;
}
...
if(func_236() && func_235(0)) return true;
return false;
}


var func__235(int iParam0) // Position - 0x16082{
return Global_1574538[iParam0];
}


var func__236() // Position - 0x16092{
...
if(func_297(14)) character=_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID());
...
func_246(8, *uParam1, false);
func_246(11, *uParam1, false);
if(Global_113648.f_9087.f_99.f_58[126]) func_246(12, *uParam1, false);
break;
case CHAR_TREVOR:
func_246(4, *uParam1, false);
func_246(7, *uParam1, false);
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_101(character) && !PED::IS_PED_INJURED(pedParam0))if(pedParam0==PLAYER::PLAYER_PED_ID()) Global_113648.f_2365.f_539.f_2328[character]=PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
return;
}
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_101(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_2318[character /*3*/]={
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_101(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_294[character]=PED::GET_PED_ARMOUR(pedParam0);
return;
}
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_101(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_290[character]=((SYSTEM::TO_FLOAT(ENTITY::GET_ENTITY_HEALTH(pedParam0)) - 100f) / (SYSTEM::TO_FLOAT(PED::GET_PED_MAX_HEALTH(pedParam0)) - 100f)) * 100f;
return;
}
...
j=0;
for (k=func_257(pedWeapontypeInSlot, j);
k !=0;
k=func_257(pedWeapontypeInSlot, j)){
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_101(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_2296[character]=func_182();
return;
}
...
flag2=false;
if(flag || uParam0->f_24[iParam1] !=0 || func_264(iParam1) && func_261(iParam1) && !uParam0->f_18[iParam1])if(!uParam0->f_23)if(!PED::IS_PED_INJURED(uParam0->[iParam1]) || flag)if(uParam0->f_34[iParam1] !=1 && uParam0->f_34[iParam1] !=3) flag2=true;
...
if(Global_113648.f_9087 || Global_3)if(!Global_78558 || Global_78558 && iParam0 !=func_242(func_263()))if(!func_262(func_244(iParam0))) return 0;
return 1;
}
BOOL func_262(eCharacter echParam0) // Position - 0x18050{
if(func_101(echParam0))if(Global_113648.f_9087 || Global_3 || _IS_MISSION_REPEAT_ACTIVE(false)) return Global_113648.f_2365.f_539.f_2348[echParam0];
else return true;
return false;
}
...
if(Global_113648.f_9087 || Global_3 || _IS_MISSION_REPEAT_ACTIVE(false))if(!Global_78558 || Global_78558 && iParam0 !=func_242(func_263()))if(iParam0==0 && !func_298(115) || iParam0==1 && !func_298(116) || iParam0==2 && !func_298(117)) return 0;
return 1;
}
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_286(uParam0);
elseif(num < fParam1 * fParam1 || IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(uParam0->f_449, 0))if(func_285(uParam0))if(IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(Global_96692, *uParam0)) func_280(uParam0);
else func_280(uParam0);
else func_279(uParam0);
if(num > fParam2 * fParam2 && !IS_BIT_SET(Global_96690, *uParam0)){
if(IS_BIT_SET(uParam0->f_449, 0)){
if(IS_BIT_SET(uParam0->f_449, 1)) func_277(uParam0);
func_276(uParam0);
}}}
return;
}
...
if(IS_BIT_SET(uParam0->f_449, 1)){
if(!CUTSCENE::IS_CUTSCENE_PLAYING())if(IS_BIT_SET(uParam0->f_449, 2)) func_69(uParam0, false);
func_278(uParam0);
...
vector={
func_282(uParam0, &uParam0->f_1.f_34[i /*2*/]) 
};
...
Vector3 func__282(var uParam0, var uParam1) // Position - 0x1885B{
float num;
float num2;
float num3;
float num4;
...
value2=0;
if(func_32(num, uParam0->f_1.f_258[i])) value2=1;
NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(uParam0->f_413, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(value);
...
iLocal_126=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uLocal_176.f_1.f_394, uLocal_176.f_1.f_397 *{
1.5f, 1.5f, 1.5f 
}
, 0f, false, 7);
...
func_72(true);
func_265(true, true, true, false, false, false, false);
if(ENTITY::DOES_ENTITY_EXIST(veLocal_46))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_46, false)) VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(veLocal_46, 0, false);
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, joaat("Player_Zero"), 0);
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "TREVOR", 0, joaat("Player_Two"), 0);
...
if(!IS_BIT_SET(iLocal_41, 18)){
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_129, false)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_129, false, false);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_128, false)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_128, false, false);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_132[2])) ENTITY::SET_ENTITY_VISIBLE(uLocal_132[2], false, false);
MISC::SET_BIT(&iLocal_41, 18);
}
}
if(CUTSCENE::WAS_CUTSCENE_SKIPPED()) MISC::SET_BIT(&iLocal_41, 20);
elseif(!CAM::IS_SCREEN_FADED_IN() && !CAM::IS_SCREEN_FADING_IN()) CAM::DO_SCREEN_FADE_IN(800);
...
if(IS_BIT_SET(iLocal_41, 8)) MISC::CLEAR_BIT(&iLocal_41, 8);
if(IS_BIT_SET(iLocal_41, 9)) MISC::CLEAR_BIT(&iLocal_41, 9);
func_114(37, 0);
func_114(38, 0);
if(!IS_BIT_SET(iLocal_41, 4)){
func_115(2, 0, true);
...
if(_CAN_ENTER_FREEROAM_STATE(0))if(func_295(&iLocal_44, 0, 0, false, 0)==1) MISC::SET_BIT(&iLocal_41, 1);
if(IS_BIT_SET(iLocal_41, 1)){
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_176.f_484), 0, 0, "MICHAEL", 1, 1);
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_176.f_484), 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 1, 1);
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_176.f_484), 3, 0, "LESTER", 1, 1);
...
if(iLocal_45 !=-1) func_290(&iLocal_45);
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("RBHS_MCS_3")) CUTSCENE::REMOVE_CUTSCENE();
if(IS_BIT_SET(iLocal_41, 8)) MISC::CLEAR_BIT(&iLocal_41, 8);
if(IS_BIT_SET(iLocal_41, 9)) MISC::CLEAR_BIT(&iLocal_41, 9);
}
return;
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_291(*uParam0, false);
...
if(!Global_78557)if(!hasThisCutsceneLoaded) Global_78557=true;
...
if(iParam4 !=0) func_296(uParam0, iParam4);
}
return 2;
}
...
PLAYER::SET_MAX_WANTED_LEVEL(5);
CUTSCENE::REMOVE_CUTSCENE();
if(iLocal_44 !=-1) func_162(&iLocal_44);
SCRIPT::TERMINATE_THIS_THREAD();
return;
}
BOOL func_313(var uParam0) // Position - 0x1A28A{
if(IS_BIT_SET(uParam0->f_449, 1)) func_277(uParam0);
if(IS_BIT_SET(uParam0->f_449, 0)) func_276(uParam0);
return true;
}