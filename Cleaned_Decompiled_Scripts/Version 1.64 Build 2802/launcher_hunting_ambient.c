...
}}}elseif(iVar3 < iLocal_120 || iVar3 >=iLocal_121){
func_61(&uLocal_94, 128);
bVar2=false;
if(fLocal_93 < ((fLocal_117 * fLocal_117) + 4f)){
if(!func_89(uLocal_94, 134217728)){
...
elseif(!func_89(uLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_44(&iLocal_96);
...
if(func_89(uLocal_94, 2097152)){
if(!func_75(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52)){
func_82(10);
}}
...
iLocal_128=1;
}elseif((iLocal_128 && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterIntro")) && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterOutro")){
STREAMING::REMOVE_ANIM_DICT("oddjobs@hunterIntro");
STREAMING::REMOVE_ANIM_DICT("oddjobs@hunterOutro");
iLocal_128=0;
}}
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_123)){
iLocal_123=VEHICLE::CREATE_VEHICLE(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, 1, 1, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_124)){
iLocal_124=VEHICLE::CREATE_VEHICLE(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, 1, 1, 0);
