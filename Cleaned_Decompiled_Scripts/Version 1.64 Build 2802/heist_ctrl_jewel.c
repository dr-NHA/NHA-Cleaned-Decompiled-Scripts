...
iLocal_45=-1;
iLocal_738=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_245();
func_244(3);
func_233(&(uLocal_46.f_1), func_243(Global_96710[1 /*19*/], Global_96710[2 /*19*/]));
func_232(&uLocal_46, 0);
while (!func_231(4)){
if(!Global_78828){
if(!func_230(86) && !func_229(14)) func_218(&uLocal_46, 32f, 35f);
elseif(IS_BIT_SET(uLocal_46.f_449, 0)) func_216(&uLocal_46);
...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("jewelry_heist")) > 0) func_2();
SYSTEM::WAIT(0);
}
func_1(3);
func_245();
...
Vector3 func__27(var uParam0, var uParam1) // Position - 0x13F6{
float num;
float num2;
float num3;
float num4;
...
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_729, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_729, "Lester", 0, joaat("CS_LesterCrest"), 0);
else CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_729, "Lester", 2, joaat("CS_LesterCrest"), 0);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_732))if(ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(pedLocal_732)) ENTITY::DETACH_ENTITY(pedLocal_732, true, true);
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_732)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_732, "WalkingStick_Lester", 1, joaat("prop_cs_walking_stick"), 0);
else CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_732, "WalkingStick_Lester", 2, joaat("prop_cs_walking_stick"), 0);
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_732)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_732, true, false);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_730)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_730, true, false);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_729)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_729, true, false);
...
}}elseif(iLocal_43==-1 && !_IS_MISSION_REPEAT_ACTIVE(false)){
iLocal_43=MISC::GET_GAME_TIMER() + 1500;
}elseif(MISC::GET_GAME_TIMER() > iLocal_43 || _IS_MISSION_REPEAT_ACTIVE(false)){
...
if(iLocal_738 !=-1)if(PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_738)) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_738);
...
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("JH_1_MCS_4P2")) CUTSCENE::REMOVE_CUTSCENE();
}
if(IS_BIT_SET(iLocal_41, 18)){
PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_LOOK_BEHIND, true);
if(MISC::GET_GAME_TIMER() > iLocal_739 + 1000) MISC::CLEAR_BIT(&iLocal_41, 18);
}
return;
}
...
break;
case 11:
if(func_157(91)) func_158(0, true);
break;
case 5:
if(func_157(91)) func_158(2, true);
break;
case 3:
if(func_157(67)) func_158(5, true);
break;
case 2:
if(func_157(77)) func_158(7, true);
break;
}}}}
if(!func_39(10) && IS_BIT_SET(Global_113648.f_24997.f_8[4], 0)) func_158(9, true);
if(!func_39(13) && IS_BIT_SET(Global_113648.f_24997.f_8[16], 0)) func_158(12, true);
if(!func_39(12))if(iParam0==4) func_158(11, true);
if(!bParam1){
if(!func_156(69)) func_21("DI_HLP_HST" /*Heist characters become available in Rockstar Editor's 'Director Mode' after being up for selection on a GTAV heist.*/, 2, 0, 20000, 10000, 7, 0, 209, 0);
...
if(!bParam1) func_155(func_159(iParam0));
}}
return;
}
...
if(!func_180(iParam2, &uParam0->f_2300[iParam1 /*3*/], &uParam0->f_2310[iParam1])) return 0;
if(!func_179(uParam0->f_2300[iParam1 /*3*/], 0f, 0f, 0f, false)){
if(!func_179(Global_99120[iParam2 /*3*/], 0f, 0f, 0f, false)){
unk.f_11=12;
unk.f_31=49;
unk.f_81=2;
if(func_164(iParam1, iParam2, &unk, &unk99, &unk102, &unk103, &unk106)) Global_100085[iParam1 /*98*/]={
unk 
};
}}
...
return true;
case 282:
if(func_164(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
case 283:
if(func_164(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
...
if(hParam0==joaat("blimp"))if(!func_176() && !func_175() && !func_174() && !func_173() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_172() || MISC::IS_PC_VERSION() || func_171()){
}elseif(!func_174()){
return false;
}}
if(bParam1)if(!func_170(hParam0, iParam2)) return false;
if(!func_168(hParam0)) return false;
return true;
}
...
if(iParam1 < 1 || iParam1 > func_185(num, num2)) return;
...
var func__187(BOOL bParam0, var uParam1, var uParam2) // Position - 0x100DD{
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_200(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_196() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_200(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_198(-1, false)==8;
...
if(func_201())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
iLocal_738=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uLocal_46.f_1.f_394, uLocal_46.f_1.f_397 *{
1.5f, 1.5f, 1.5f 
}
, 0f, false, 7);
...
switch (iLocal_42){
case 0:
if(CAM::DOES_CAM_EXIST(caLocal_734)) CAM::DESTROY_CAM(caLocal_734, false);
if(CAM::DOES_CAM_EXIST(caLocal_735)) CAM::DESTROY_CAM(caLocal_735, false);
...
if(ENTITY::DOES_ENTITY_EXIST(Global_97178[0]))if(!ENTITY::IS_ENTITY_DEAD(Global_97178[0], false)) veLocal_731=Global_97178[0];
...
if(ENTITY::DOES_ENTITY_EXIST(veLocal_731))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_731, false)) CAM::POINT_CAM_AT_ENTITY(caLocal_734, veLocal_731, 0f, 0f, 0f, true);
...
break;
case 4:
if(MISC::GET_GAME_TIMER() - iLocal_43 > 5000) MISC::CLEAR_BIT(&iLocal_41, 2);
break;
}}
...
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_730, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_730, "Michael", 0, joaat("Player_Zero"), 0);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_729, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_729, "Lester", 2, joaat("IG_LesterCrest"), 0);
...
if(CUTSCENE::WAS_CUTSCENE_SKIPPED()) MISC::SET_BIT(&iLocal_41, 16);
...
if(CAM::DOES_CAM_EXIST(caLocal_734)) CAM::SET_CAM_ACTIVE(caLocal_734, false);
if(CAM::DOES_CAM_EXIST(caLocal_735)) CAM::SET_CAM_ACTIVE(caLocal_735, false);
CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
if(CAM::DOES_CAM_EXIST(caLocal_735)) CAM::DESTROY_CAM(caLocal_735, false);
if(CAM::DOES_CAM_EXIST(caLocal_735)) CAM::DESTROY_CAM(caLocal_735, false);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_729)) PED::DELETE_PED(&pedLocal_729);
MISC::SET_BIT(&iLocal_41, 5);
}
if(!IS_BIT_SET(iLocal_41, 6))if(iLocal_44 > 0) MISC::SET_BIT(&iLocal_41, 6);
if(!IS_BIT_SET(iLocal_41, 12)){
...
elseif(!IS_BIT_SET(iLocal_41, 13)){
if(MISC::GET_GAME_TIMER() - iLocal_43 > 22887){
func_115(0, 2, true);
MISC::SET_BIT(&iLocal_41, 13);
}
}
elseif(!IS_BIT_SET(iLocal_41, 14)){
...
elseif(!IS_BIT_SET(iLocal_41, 15)){
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Lester", 0)){
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_729, false))if(ENTITY::DOES_ENTITY_EXIST(pedLocal_732)) ENTITY::ATTACH_ENTITY_TO_ENTITY(pedLocal_732, pedLocal_729, PED::GET_PED_BONE_INDEX(pedLocal_729, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_729, false)){
...
if(!IS_BIT_SET(iLocal_41, 7)){
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_730, false)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_730, false, false);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_729, false)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_729, false, false);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_732)) ENTITY::SET_ENTITY_VISIBLE(pedLocal_732, false, false);
...
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_46.f_484), 0, 0, "MICHAEL", 1, 1);
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_46.f_484), 3, 0, "LESTER", 1, 1);
if(_CAN_ENTER_FREEROAM_STATE(0))if(func_209(&iLocal_45, 0, 0, false, 0)==1) MISC::SET_BIT(&iLocal_41, 1);
if(IS_BIT_SET(iLocal_41, 1)){
func_205();
func_114(16, 0);
}}}else{
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("JH_1_MCS_4_P1_ALT1")) CUTSCENE::REMOVE_CUTSCENE();
if(IS_BIT_SET(iLocal_41, 10)) MISC::CLEAR_BIT(&iLocal_41, 10);
}
return;
}
...
if(iParam4 !=0) func_210(uParam0, iParam4);
}
return 2;
}
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_206(uParam0);
if(IS_BIT_SET(uParam0->f_449, 0)) func_217(uParam0);
return true;
}
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_226(uParam0);
elseif(num < fParam1 * fParam1 || IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(uParam0->f_449, 0))if(func_225(uParam0))if(IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(Global_96692, *uParam0)) func_220(uParam0);
else func_220(uParam0);
else func_219(uParam0);
...
vector={
func_222(uParam0, &uParam0->f_1.f_34[i /*2*/]) 
};
...
Vector3 func__222(var uParam0, var uParam1) // Position - 0x116BE{
float num;
float num2;
float num3;
float num4;
...
var func__243(var uParam0, var uParam1) // Position - 0x124E5{
...
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("JH_1_MCS_4P2") || CUTSCENE::HAS_THIS_CUTSCENE_LOADED("JH_1_MCS_4_P1_ALT1")) CUTSCENE::REMOVE_CUTSCENE();
func_114(16, 0);
func_114(17, 0);
func_114(18, 0);
func_85(1, 0, 0);
...
PATHFIND::SET_PED_PATHS_IN_AREA(uLocal_46.f_1.f_394 - uLocal_46.f_1.f_397, uLocal_46.f_1.f_394 + uLocal_46.f_1.f_397, true, 0);
PLAYER::SET_MAX_WANTED_LEVEL(5);
if(iLocal_45 !=-1) func_161(&iLocal_45);
while (!func_216(&uLocal_46)){
SYSTEM::WAIT(0);
}
