...
case 1:
Local_47.f_3.f_26=1;
if(iLocal_154==0 && !MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 30)){
if(func_43(&Local_47, 0, 0, 1)){
func_31();
}}else{
if(MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 29)){
if(func_2()){
func_1();
}
}
...
int func_6(){
if(MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 30)){
return 0;
}
if(MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_36.f_18, 29)){
return 1;
...
var uVar0;
var uVar1;
uVar0=Global_2848280[iParam0 /*3*/][func_15(iParam1)];
...
func_4(uParam0, 12);
}elseif(NETWORK::NETWORK_PLAYER_IS_CHEATER()){
func_4(uParam0, 10);
}else{
func_4(uParam0, 7);
}}else{
...
func_34(uParam0, 2);
}}elseif(func_270(iParam2, uParam0->f_12, iParam4, iParam5, iParam7, uParam1, iParam6, iParam11, iParam12, 0)){
if(iParam2==0){
...
if(MISC::IS_BIT_SET(Global_1835450[iVar1], bVar2)){
iVar3=iVar0;
while (iVar3 <=(iVar4 - 2)){
Global_1021887.f_4[iVar3 /*88*/]={
Global_1021887.f_4[iVar3 + 1 /*88*/] 
};
iVar3++;
}
...
iVar3=iVar0;
while (iVar3 <=(iVar4 - 2)){
Global_1010831.f_4[iVar3 /*88*/]={
Global_1010831.f_4[iVar3 + 1 /*88*/] 
};
iVar3++;
}
MISC::CLEAR_BIT(&(Global_1835450[iVar1]), bVar2);
...
StringCopy(&(Global_1053582.f_354[uParam0->f_9 /*16*/]), DATAFILE::DATADICT_GET_STRING(iVar1, "crewnm"), 64);
...
Global_1053582.f_884[uParam0->f_9]=DATAFILE::DATADICT_GET_INT(iVar1, "cash");
Global_1053582.f_901[uParam0->f_9]=DATAFILE::DATADICT_GET_INT(iVar2, "scr");
Global_1053582.f_918[uParam0->f_9]=DATAFILE::DATADICT_GET_INT(iVar2, "time");
...
if(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&Var13, &Var0)){
return 1;
}elseif(!NETWORK::NETWORK_IS_FRIEND(&Var0)){
return 0;
}}elseif(func_59()){
if(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&Var13, &Var0)){
return 1;
}elseif((unk_0x66955BC2BF0032B5(&Var0) && NETWORK::NETWORK_HAS_VIEW_GAMER_USER_CONTENT_RESULT(&Var0)) && !NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0)){
return 0;
}}else{
Var13={
func_55(PLAYER::PLAYER_ID()) 
...
Var7.f_66=-1;
Var7.f_67=2;
Global_1027415.f_33[iVar3 /*88*/]={
Var7 
};
Global_1027415.f_33[iVar3 /*88*/].f_65=iVar4;
Global_1027415.f_33[iVar3 /*88*/].f_56={
func_107(iVar2) 
};
if(DATAFILE::DATADICT_GET_TYPE(iVar2, "cam")==5){
Global_1027415.f_33[iVar3 /*88*/].f_59={
func_106(iVar2, "cam") 
};
}elseif(DATAFILE::DATADICT_GET_TYPE(iVar2, "cam")==6){
iVar95=DATAFILE::DATADICT_GET_DICT(iVar2, "cam");
if(DATAFILE::DATADICT_GET_TYPE(iVar95, "x")==2){
Global_1027415.f_33[iVar3 /*88*/].f_59=SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(iVar95, "x"));
}else{
Global_1027415.f_33[iVar3 /*88*/].f_59=DATAFILE::DATADICT_GET_FLOAT(iVar95, "x");
}
if(DATAFILE::DATADICT_GET_TYPE(iVar95, "y")==2){
Global_1027415.f_33[iVar3 /*88*/].f_59.f_1=SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(iVar95, "y"));
}else{
Global_1027415.f_33[iVar3 /*88*/].f_59.f_1=DATAFILE::DATADICT_GET_FLOAT(iVar95, "y");
}
if(DATAFILE::DATADICT_GET_TYPE(iVar95, "z")==2){
Global_1027415.f_33[iVar3 /*88*/].f_59.f_2=SYSTEM::TO_FLOAT(DATAFILE::DATADICT_GET_INT(iVar95, "z"));
}else{
Global_1027415.f_33[iVar3 /*88*/].f_59.f_2=DATAFILE::DATADICT_GET_FLOAT(iVar95, "z");
}}
Global_1027415.f_33[iVar3 /*88*/].f_62={
func_105(iVar2) 
};
...
if(MISC::IS_BIT_SET(Global_1027415.f_33[iVar3 /*88*/].f_76, 27)){
bVar96=true;
}
...
}elseif(func_96(iParam0)){
MISC::SET_BIT(uParam1, 29);
}elseif(func_95(iParam0, 1)){
MISC::SET_BIT(uParam1, 28);
}elseif(func_94(iParam0)){
MISC::SET_BIT(uParam2, 0);
}elseif(func_93(iParam0)){
MISC::SET_BIT(uParam2, 1);
}elseif(func_92(iParam0)){
MISC::SET_BIT(uParam2, 2);
}elseif(func_91(iParam0)){
MISC::SET_BIT(uParam2, 3);
}elseif(func_90(iParam0)){
MISC::SET_BIT(uParam2, 4);
}elseif(func_89(iParam0)){
...
if(NETWORK::UGC_GET_CONTENT_HAS_HI_RES_PHOTO(uParam0)){
return 2;
}elseif(NETWORK::UGC_GET_CONTENT_HAS_LO_RES_PHOTO(uParam0)){
return 1;
}
return 1;
}
...
Vector3 func__106(int iParam0, char* sParam1){
struct<3> Var0;
var uVar3;
...
Var3={
func_57(NETWORK::UGC_GET_CONTENT_USER_ID(uParam0->f_7)) 
};
if(bParam4){
...
Global_1021887++;
uParam0->f_9++;
}}elseif(func_215(uParam0, &(Global_1016359.f_4[iVar0 /*88*/]), iParam1, 1, iParam2, 0)){
Global_1016359++;
...
uParam0->f_9++;
}elseif(func_215(uParam0, &(Global_1010831.f_4[iVar0 /*88*/]), iParam1, 1, iParam2, 0)){
func_129(uParam0, iParam1);
if(iParam2==0){
Global_1010831++;
}else{
...
}elseif(Global_1010831.f_4[iParam2 /*88*/].f_65==1){
func_127(Global_1016359.f_4[iParam2 /*88*/].f_22);
}elseif(Global_1010831.f_4[iParam2 /*88*/].f_65==4){
...
MemCopy(&(Global_2645068[iVar0 /*83*/].f_18[3 /*16*/]),{
...
uVar0=Global_2805027[iParam0 /*3*/][func_15(iParam1)];
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 10, -1, 0, -1, func_148(iParam0));
if(iVar57 > iVar56){
...
}}elseif(func_190(iParam0, iParam2)){
...
iVar1=uParam0;
return MISC::IS_BIT_SET(uVar0, func_188(iVar1));
}
...
var func__209(var uParam0, int iParam1){
var uVar0;
...
iVar88=DATAFILE::DATAFILE_GET_FILE_DICT(0);
...
if(((Param0.f_2 < 0f || func_218(Param0, 999, 2f)) || func_217(Param0)) || (Global_4718592.f_98303[0 /*60*/].f_2 < -2f && !MISC::IS_BIT_SET(Global_4718592.f_98303[0 /*60*/].f_31, 5))){
return 1;
}
return 0;
}
...
int iVar0;
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, 986.8618f, 74.74512f, 112.0391f, 975.716f, 57.44831f, 118.0387f, 14.5625f, 0, 1)){
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, 1093.315f, 219.7407f, -50.98997f, 1084.527f, 219.227f, -45.92859f, 8.75f, 0, 1)){
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, 380.203f, -70.9054f, 102.181f, 382.593f, -62.2445f, 104.988f, 21.56f, 0, 1)){
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -1016f, -437.619f, 62.6791f, -1020.69f, -429.961f, 65.4861f, 21.56f, 0, 1)){
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -588.595f, -705.387f, 111.823f, -587.902f, -714.344f, 114.63f, 21.56f, 0, 1)){
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -992.769f, -760.456f, 60.7122f, -1001.73f, -761.172f, 63.5192f, 21.56f, 0, 1)){
return 1;
}
if(Global_2765947){
iVar0=0;
while (iVar0 < 3){
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, Global_2765947.f_1[iVar0 /*3*/], Global_2765947.f_11[iVar0 /*3*/], Global_2765947.f_21[iVar0], 0, 1)){
return 1;
}
iVar0++;
}}
...
uParam0->f_1804[iVar3 /*88*/].f_56={
func_107(iVar2) 
};
uParam0->f_1804[iVar3 /*88*/].f_59={
func_106(iVar2, "cam") 
};
uParam0->f_1804[iVar3 /*88*/].f_62={
func_105(iVar2) 
};
...
unk_0xA64B051C7606A077(uParam0->f_28205[iVar3 /*13*/].f_1, iVar3 + 1818);
}
if(func_102() !=2){
...
if(!bParam2){
func_231(uParam0->f_1804[iVar3 /*88*/].f_65, uParam0->f_1804[iVar3 /*88*/].f_68, MISC::IS_BIT_SET(uParam0->f_1804[iVar3 /*88*/].f_76, 14), uParam0->f_1804[iVar3 /*88*/].f_70, 1);
...
uVar93=MISC::GET_HASH_KEY(&(Global_794709.f_4[uParam0->f_9 /*88*/]));
Global_794709.f_159989[uParam0->f_9 /*13*/].f_3=uVar93;
...
Global_1030213.f_598[Global_1030213.f_684]=uVar93;
Global_794709.f_4[uParam0->f_9 /*88*/].f_56={
Global_794709.f_4[uParam0->f_9 /*88*/].f_59 
};
...
}elseif(func_255(uParam0->f_9)){
Global_794709.f_183669[4]++;
}elseif(func_254(uParam0->f_9)){
Global_794709.f_183669[10]++;
}elseif(func_253(uParam0->f_9)){
...
if(!bParam1 && !bVar94){
if(func_19()){
func_231(Global_794709.f_4[uParam0->f_9 /*88*/].f_65, Global_794709.f_4[uParam0->f_9 /*88*/].f_68, MISC::IS_BIT_SET(Global_794709.f_4[uParam0->f_9 /*88*/].f_76, 14), Global_794709.f_4[uParam0->f_9 /*88*/].f_70, 0);
...
func_244(Global_794709.f_4[uParam0->f_9 /*88*/].f_65, Global_794709.f_4[uParam0->f_9 /*88*/].f_68, Global_794709.f_4[uParam0->f_9 /*88*/].f_75, Global_794709.f_4[uParam0->f_9 /*88*/].f_70, MISC::IS_BIT_SET(Global_794709.f_4[uParam0->f_9 /*88*/].f_76, 14));
...
}}elseif(iParam0==Global_262145.f_9503[iVar0]){
Global_794709.f_159989[iParam1 /*13*/].f_12=0;
Global_794709.f_4[iParam1 /*88*/].f_68=8;
Global_794709.f_4[iParam1 /*88*/].f_75=0;
Global_794709.f_4[iParam1 /*88*/].f_78=16777215;
...
Vector3 func__250(int iParam0, int iParam1){
switch (iParam0){
case 0:
switch (iParam1){
case 0:
...
Vector3 func__251(int iParam0, int iParam1){
switch (iParam0){
case 0:
switch (iParam1){
case 0:
...
iVar0=0;
while (iVar0 <=84){
Global_1030213[iVar0 /*3*/]={
0f, 0f, 0f 
};
Global_1030213.f_256[iVar0 /*3*/]={
0f, 0f, 0f 
};
...
int func_270(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, var uParam6, var uParam7, int iParam8, int iParam9){
switch (iParam0){
case 0:
if(iParam3==4 || iParam8 !=-1){
if(NETWORK::UGC_QUERY_MY_CONTENT(uParam1, uParam6, func_272(iParam3), 0, iParam8, uParam7)){
return 1;
}}elseif(NETWORK::UGC_GET_MY_CONTENT(uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
case 1:
if(NETWORK::UGC_QUERY_MY_CONTENT(uParam1, uParam6, func_272(iParam3), 1, iParam8, uParam7)){
return 1;
}
break;
case 2:
if(NETWORK::UGC_QUERY_MY_CONTENT(uParam1, uParam6, func_272(iParam3), 2, iParam8, uParam7)){
return 1;
}
break;
case 3:
if(NETWORK::UGC_GET_FRIEND_CONTENT(uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
case 4:
...
if(NETWORK::UGC_GET_CREW_CONTENT(iParam4, uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
case 5:
if((((iParam2==3 || iParam2==4) || iParam2==5) || iParam2==6) && iParam9){
if(NETWORK::UGC_QUERY_BY_CATEGORY(iParam2, uParam1, uParam6, func_272(iParam3), 0, 0)){
return 1;
}}elseif(NETWORK::UGC_GET_GET_BY_CATEGORY(iParam2, uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
case 6:
if(NETWORK::UGC_GET_TOP_RATED_CONTENT(uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
case 7:
if(NETWORK::UGC_GET_MOST_RECENTLY_PLAYED_CONTENT(uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
case 8:
if(NETWORK::UGC_GET_BOOKMARKED_CONTENT(uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
case 9:
if(iParam3==4){
if(NETWORK::UGC_QUERY_MOST_RECENTLY_CREATED_CONTENT(uParam1, uParam6, func_272(iParam3), uParam7)){
return 1;
}}elseif(NETWORK::UGC_GET_MOST_RECENTLY_CREATED_CONTENT(uParam1, uParam6, func_272(iParam3), uParam5)){
return 1;
}
break;
}
...
iVar1=0;
while (iVar1 <=30){
if(MISC::IS_BIT_SET(Global_1010831.f_4[iVar1 /*88*/].f_76, 13)){
iVar0=iParam0;
...
iVar1=0;
while (iVar1 <=299){
if(MISC::IS_BIT_SET(Global_978406.f_1804[iVar1 /*88*/].f_76, 13)){
iVar0=uParam0;
...
while (iVar0 <=63){
if(iVar0 < 35){
Global_1050140.f_1179[iVar0 /*6*/]={
func_310((iVar0 + uParam0->f_12)) 
};
...
break;
case 1:
if(NETWORK::UGC_QUERY_BY_CONTENT_IDS(&(Global_1050140.f_1179), uParam0->f_13, 1, func_272(0))){
func_34(uParam0, 2);
}
break;
case 2:
...
bVar1=false;
}elseif(!Global_786550.f_3538[iVar0 /*132*/].f_129.f_2){
bVar1=false;
}}}
iVar0++;
}
...
iVar5=0;
bVar6=false;
uVar2=func_305(Global_786550.f_1[iVar0 /*88*/].f_54, 500);
...
StringCopy(&(Global_786550.f_3538[iVar0 /*132*/][iVar5 /*16*/]), HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME_WITH_BYTE_LIMIT(uVar2, iVar3, iVar4, 63), 64);
...
var func__305(int iParam0, int iParam1){
if(iParam0==-1){
return func_306();
}
