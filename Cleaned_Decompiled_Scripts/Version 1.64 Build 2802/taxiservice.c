...
iLocal_107=-1;
iLocal_108=-1;
sLocal_109=PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 195, 1);
...
func_5();
if(func_3(Global_112679) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112679, 1)){
...
if(!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
if(PED::IS_PED_IN_VEHICLE(Global_112680, Global_112679, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Global_112680, Global_112679, PLAYER::PLAYER_PED_ID(), 8, 25f, 790564, 300f, 15f, 1);
}}elseif(!PED::IS_PED_FLEEING(Global_112680)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_SMART_FLEE_PED(Global_112680, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
}}
PED::SET_PED_KEEP_TASK(Global_112680, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112680, 0);
}}elseif(!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
if(PED::IS_PED_IN_VEHICLE(Global_112680, Global_112679, 0)){
...
if(!ENTITY::IS_ENTITY_DEAD(Global_112679, 0)){
if(PED::IS_PED_IN_VEHICLE(iVar2, Global_112679, 0)){
...
void func_7(){
bool bVar0;
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_15() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_15() /*5568*/].f_681.f_10, iParam0);
}
...
}elseif(MISC::ARE_STRINGS_EQUAL("Alamo", &cVar0)){
return "LOCATION_ALAMO_SEA";
}elseif(MISC::ARE_STRINGS_EQUAL("Alta", &cVar0)){
return "LOCATION_ALTA";
}elseif(MISC::ARE_STRINGS_EQUAL("Airp", &cVar0)){
return "LOCATION_LOS_SANTOS_INTERNATIONAL_AIRPORT";
}elseif(MISC::ARE_STRINGS_EQUAL("ArmyB", &cVar0)){
return "LOCATION_FORT_ZANCUDO";
}elseif(MISC::ARE_STRINGS_EQUAL("BhamCa", &cVar0)){
return "LOCATION_BANHAM_CANYON";
}elseif(MISC::ARE_STRINGS_EQUAL("Banning", &cVar0)){
return "LOCATION_BANNING";
}elseif(MISC::ARE_STRINGS_EQUAL("Baytre", &cVar0)){
return "LOCATION_BAYTREE_CANYON";
}elseif(MISC::ARE_STRINGS_EQUAL("Beach", &cVar0)){
return "LOCATION_VESPUCCI_BEACH";
}elseif(MISC::ARE_STRINGS_EQUAL("BradT", &cVar0)){
return "LOCATION_BRADDOCK_TUNNEL";
}elseif(MISC::ARE_STRINGS_EQUAL("BradP", &cVar0)){
return "LOCATION_BRADDOCK_PASS";
}elseif(MISC::ARE_STRINGS_EQUAL("Burton", &cVar0)){
return "LOCATION_BURTON";
}elseif(MISC::ARE_STRINGS_EQUAL("CANNY", &cVar0)){
return "LOCATION_RATON_CANYON";
}elseif(MISC::ARE_STRINGS_EQUAL("CCreak", &cVar0)){
return "LOCATION_CASSIDY_CREEK";
}elseif(MISC::ARE_STRINGS_EQUAL("CalafB", &cVar0)){
return "LOCATION_CALAFIA_BRIDGE";
}elseif(MISC::ARE_STRINGS_EQUAL("ChamH", &cVar0)){
return "LOCATION_CHAMBERLAIN_HILLS";
}elseif(MISC::ARE_STRINGS_EQUAL("CHU", &cVar0)){
return "LOCATION_CHUMASH";
}elseif(MISC::ARE_STRINGS_EQUAL("CHIL", &cVar0)){
return "LOCATION_VINEWOOD_HILLS";
}elseif(MISC::ARE_STRINGS_EQUAL("COSI", &cVar0)){
return "LOCATION_COUNTRYSIDE";
}elseif(MISC::ARE_STRINGS_EQUAL("CMSW", &cVar0)){
return "LOCATION_CHILIAD_MOUNTAIN_STATE_WILDERNESS";
}elseif(MISC::ARE_STRINGS_EQUAL("Cypre", &cVar0)){
return "LOCATION_CYPRESS_FLATS";
}elseif(MISC::ARE_STRINGS_EQUAL("Davis", &cVar0)){
return "LOCATION_DAVIS";
}elseif(MISC::ARE_STRINGS_EQUAL("Desrt", &cVar0)){
return "LOCATION_GRAND_SENORA_DESERT";
}elseif(MISC::ARE_STRINGS_EQUAL("DelBe", &cVar0)){
return "LOCATION_DEL_PERRO_BEACH";
}elseif(MISC::ARE_STRINGS_EQUAL("DelPe", &cVar0)){
return "LOCATION_DEL_PERRO";
}elseif(MISC::ARE_STRINGS_EQUAL("DelSol", &cVar0)){
return "LOCATION_LA_PUERTA";
}elseif(MISC::ARE_STRINGS_EQUAL("Downt", &cVar0)){
return "LOCATION_DOWNTOWN";
}elseif(MISC::ARE_STRINGS_EQUAL("DTVine", &cVar0)){
return "LOCATION_DOWNTOWN_VINEWOOD";
}elseif(MISC::ARE_STRINGS_EQUAL("Eclips", &cVar0)){
return "LOCATION_ECLIPSE";
}elseif(MISC::ARE_STRINGS_EQUAL("ELSant", &cVar0)){
return "LOCATION_EAST_LOS_SANTOS";
}elseif(MISC::ARE_STRINGS_EQUAL("EBuro", &cVar0)){
return "LOCATION_EL_BURRO_HEIGHTS";
}elseif(MISC::ARE_STRINGS_EQUAL("ELGorl", &cVar0)){
return "LOCATION_EL_GORDO_LIGHTHOUSE";
}elseif(MISC::ARE_STRINGS_EQUAL("Elysian", &cVar0)){
return "LOCATION_ELYSIAN_ISLAND";
}elseif(MISC::ARE_STRINGS_EQUAL("Galli", &cVar0)){
return "LOCATION_GALILEO_PARK";
}elseif(MISC::ARE_STRINGS_EQUAL("Galfish", &cVar0)){
return "LOCATION_GALILEE";
}elseif(MISC::ARE_STRINGS_EQUAL("Greatc", &cVar0)){
return "LOCATION_GREAT_CHAPARRAL";
}elseif(MISC::ARE_STRINGS_EQUAL("Golf", &cVar0)){
return "LOCATION_GWC_AND_GOLFING_SOCIETY";
}elseif(MISC::ARE_STRINGS_EQUAL("GrapeS", &cVar0)){
return "LOCATION_GRAPESEED";
}elseif(MISC::ARE_STRINGS_EQUAL("Hawick", &cVar0)){
return "LOCATION_HAWICK";
}elseif(MISC::ARE_STRINGS_EQUAL("Harmo", &cVar0)){
return "LOCATION_HARMONY";
}elseif(MISC::ARE_STRINGS_EQUAL("Heart", &cVar0)){
return "LOCATION_HEART_ATTACKS_BEACH";
}elseif(MISC::ARE_STRINGS_EQUAL("HumLab", &cVar0)){
return "LOCATION_HUMANE_LABS_AND_RESEARCH";
}elseif(MISC::ARE_STRINGS_EQUAL("HORS", &cVar0)){
return "LOCATION_VINEWOOD_RACETRACK";
}elseif(MISC::ARE_STRINGS_EQUAL("Koreat", &cVar0)){
return "LOCATION_LITTLE_SEOUL";
}elseif(MISC::ARE_STRINGS_EQUAL("Jail", &cVar0)){
return "LOCATION_BOLINGBROKE_PENITENTIARY";
}elseif(MISC::ARE_STRINGS_EQUAL("LAct", &cVar0)){
return "LOCATION_LAND_ACT_RESERVOIR";
}elseif(MISC::ARE_STRINGS_EQUAL("LDam", &cVar0)){
return "LOCATION_LAND_ACT_DAM";
}elseif(MISC::ARE_STRINGS_EQUAL("Lago", &cVar0)){
return "LOCATION_LAGO_ZANCUDO";
}elseif(MISC::ARE_STRINGS_EQUAL("LegSqu", &cVar0)){
return "LOCATION_LEGION_SQUARE";
}elseif(MISC::ARE_STRINGS_EQUAL("LosSF", &cVar0)){
return "LOCATION_LOS_SANTOS_FREEWAY";
}elseif(MISC::ARE_STRINGS_EQUAL("LMesa", &cVar0)){
return "LOCATION_LA_MESA";
}elseif(MISC::ARE_STRINGS_EQUAL("LosPuer", &cVar0)){
return "LOCATION_LA_PUERTA";
}elseif(MISC::ARE_STRINGS_EQUAL("LosPFy", &cVar0)){
return "LOCATION_LA_PUERTA_FWY";
}elseif(MISC::ARE_STRINGS_EQUAL("Mirr", &cVar0)){
return "LOCATION_MIRROR_PARK";
}elseif(MISC::ARE_STRINGS_EQUAL("Morn", &cVar0)){
return "LOCATION_MORNINGWOOD";
}elseif(MISC::ARE_STRINGS_EQUAL("Murri", &cVar0)){
return "LOCATION_MURRIETA_HEIGHTS";
}elseif(MISC::ARE_STRINGS_EQUAL("MTChil", &cVar0)){
return "LOCATION_MOUNT_CHILIAD";
}elseif(MISC::ARE_STRINGS_EQUAL("MTJose", &cVar0)){
return "LOCATION_MOUNT_JOSIAH";
}elseif(MISC::ARE_STRINGS_EQUAL("MTGordo", &cVar0)){
return "LOCATION_MOUNT_GORDO";
}elseif(MISC::ARE_STRINGS_EQUAL("Movie", &cVar0)){
return "LOCATION_RICHARDS_MAJESTIC";
}elseif(MISC::ARE_STRINGS_EQUAL("NCHU", &cVar0)){
return "LOCATION_NORTH_CHUMASH";
}elseif(MISC::ARE_STRINGS_EQUAL("Oceana", &cVar0)){
return "LOCATION_PACIFIC_OCEAN";
}elseif(MISC::ARE_STRINGS_EQUAL("Observ", &cVar0)){
return "LOCATION_GALILEO_OBSERVATORY";
}elseif(MISC::ARE_STRINGS_EQUAL("Palmpow", &cVar0)){
return "LOCATION_PALMER-TAYLOR_POWER_STATION";
}elseif(MISC::ARE_STRINGS_EQUAL("PBOX", &cVar0)){
return "LOCATION_PILLBOX_HILL";
}elseif(MISC::ARE_STRINGS_EQUAL("PBluff", &cVar0)){
return "LOCATION_PACIFIC_BLUFFS";
}elseif(MISC::ARE_STRINGS_EQUAL("Paleto", &cVar0)){
return "LOCATION_PALETO_BAY";
}elseif(MISC::ARE_STRINGS_EQUAL("PalCov", &cVar0)){
return "LOCATION_PALETO_COVE";
}elseif(MISC::ARE_STRINGS_EQUAL("PalFor", &cVar0)){
return "LOCATION_PALETO_FOREST";
}elseif(MISC::ARE_STRINGS_EQUAL("PalHigh", &cVar0)){
return "LOCATION_PALOMINO_HIGHLANDS";
}elseif(MISC::ARE_STRINGS_EQUAL("ProcoB", &cVar0)){
return "LOCATION_PROCOPIO_BEACH";
}elseif(MISC::ARE_STRINGS_EQUAL("Prol", &cVar0)){
return "LOCATION_NORTH_YANKTON";
}elseif(MISC::ARE_STRINGS_EQUAL("RTRAK", &cVar0)){
return "LOCATION_REDWOOD_LIGHTS_TRACK";
}elseif(MISC::ARE_STRINGS_EQUAL("Rancho", &cVar0)){
return "LOCATION_RANCHO";
}elseif(MISC::ARE_STRINGS_EQUAL("RGLEN", &cVar0)){
return "LOCATION_RICHMAN_GLEN";
}elseif(MISC::ARE_STRINGS_EQUAL("Richm", &cVar0)){
return "LOCATION_RICHMAN";
}elseif(MISC::ARE_STRINGS_EQUAL("Rockf", &cVar0)){
return "LOCATION_ROCKFORD_HILLS";
}elseif(MISC::ARE_STRINGS_EQUAL("SANDY", &cVar0)){
return "LOCATION_SANDY_SHORES";
}elseif(MISC::ARE_STRINGS_EQUAL("TongvaH", &cVar0)){
return "LOCATION_TONGVA_HILLS";
}elseif(MISC::ARE_STRINGS_EQUAL("TongvaV", &cVar0)){
return "LOCATION_TONGVA_VALLEY";
}elseif(MISC::ARE_STRINGS_EQUAL("East_V", &cVar0)){
return "LOCATION_EAST_VINEWOOD";
}elseif(MISC::ARE_STRINGS_EQUAL("Zenora", &cVar0)){
return "LOCATION_SENORA_FREEWAY";
}elseif(MISC::ARE_STRINGS_EQUAL("Slab", &cVar0)){
return "LOCATION_SLAB_CITY";
}elseif(MISC::ARE_STRINGS_EQUAL("SKID", &cVar0)){
return "LOCATION_MISSION_ROW";
}elseif(MISC::ARE_STRINGS_EQUAL("SLSant", &cVar0)){
return "LOCATION_SOUTH_LOS_SANTOS";
}elseif(MISC::ARE_STRINGS_EQUAL("Stad", &cVar0)){
return "LOCATION_MAZE_BANK_ARENA";
}elseif(MISC::ARE_STRINGS_EQUAL("Tatamo", &cVar0)){
return "LOCATION_TATAVIAM_MOUNTAINS";
}elseif(MISC::ARE_STRINGS_EQUAL("Termina", &cVar0)){
return "LOCATION_TERMINAL";
}elseif(MISC::ARE_STRINGS_EQUAL("TEXTI", &cVar0)){
return "LOCATION_TEXTILE_CITY";
}elseif(MISC::ARE_STRINGS_EQUAL("WVine", &cVar0)){
return "LOCATION_WEST_VINEWOOD";
}elseif(MISC::ARE_STRINGS_EQUAL("UtopiaG", &cVar0)){
return "LOCATION_UTOPIA_GARDENS";
}elseif(MISC::ARE_STRINGS_EQUAL("Vesp", &cVar0)){
return "LOCATION_VESPUCCI";
}elseif(MISC::ARE_STRINGS_EQUAL("VCana", &cVar0)){
return "LOCATION_VESPUCCI_CANALS";
}elseif(MISC::ARE_STRINGS_EQUAL("Vine", &cVar0)){
return "LOCATION_VINEWOOD";
}elseif(MISC::ARE_STRINGS_EQUAL("WMirror", &cVar0)){
return "LOCATION_W_MIRROR_DRIVE";
}elseif(MISC::ARE_STRINGS_EQUAL("WindF", &cVar0)){
return "LOCATION_RON_ALTERNATES_WIND_WARM";
}elseif(MISC::ARE_STRINGS_EQUAL("Zancudo", &cVar0)){
return "LOCATION_ZANCUDO_RIVER";
}elseif(MISC::ARE_STRINGS_EQUAL("SanChia", &cVar0)){
return "LOCATION_SAN_CHIANSKI_MOUNTAIN_RANGE";
}elseif(MISC::ARE_STRINGS_EQUAL("STRAW", &cVar0)){
return "LOCATION_STRAWBERRY";
}elseif(MISC::ARE_STRINGS_EQUAL("zQ_UAR", &cVar0)){
return "LOCATION_DAVIS_QUARTZ";
}elseif(MISC::ARE_STRINGS_EQUAL("ZP_ORT", &cVar0)){
...
Var0={
ENTITY::GET_ENTITY_COORDS(iVar4, 1) 
};
}}elseif(iVar7==3){
...
Var0={
OBJECT::GET_PICKUP_COORDS(uVar6) 
};
}}elseif(iVar7==5){
Var0={
HUD::GET_BLIP_COORDS(iParam0) 
...
if(iLocal_951 !=0){
sVar0=PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 218, 1);
...
func_69(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar2, 1));
if(iVar3 < 363){
func_69(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar3, 1));
}}else{
uVar4=uParam2->f_1[bVar0 /*57*/].f_54;
uVar5=uParam2->f_1[bVar0 /*57*/].f_55;
func_69(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(uVar4, uVar5, 1));
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_112679, 0);
}
HUD::CLEAR_PRINTS();
...
func_116();
func_115();
MISC::CLEAR_AREA(Global_112686, 5f, 1, 0, 0, 0);
func_111(1097859072);
if(!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
ENTITY::SET_ENTITY_COORDS(Global_112679, Global_112686, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Global_112679, Global_112692);
ENTITY::FREEZE_ENTITY_POSITION(Global_112679, 1);
}
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
STREAMING::NEW_LOAD_SCENE_STOP();
MISC::CLEAR_AREA(Global_112686, 5000f, 1, 0, 0, 0);
...
if(bVar1){
if(((func_55()==0 && !MISC::IS_BIT_SET(Global_91469[iLocal_825 /*34*/].f_15, 8)) || (func_55()==1 && !MISC::IS_BIT_SET(Global_91469[iLocal_825 /*34*/].f_15, 9))) || (func_55()==2 && !MISC::IS_BIT_SET(Global_91469[iLocal_825 /*34*/].f_15, 10))){
bVar1=false;
}}
if(bVar1){
...
if(iLocal_69){
iLocal_69=0;
MISC::GET_GROUND_Z_FOR_3D_COORD(Global_112686 + Vector(100f, 0f, 0f), &fVar2, 0, 0);
...
func_81();
if(!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
ENTITY::FREEZE_ENTITY_POSITION(Global_112679, 0);
ENTITY::SET_ENTITY_HEADING(Global_112679, Global_112692);
ENTITY::SET_ENTITY_COORDS(Global_112679, Global_112686, 1, 0, 0, 1);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_112679, 1);
}
if(!func_80()){
...
func_161(0);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112679, 1)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}
TASK::TASK_VEHICLE_TEMP_ACTION(Global_112680, Global_112679, 24, 5000);
PED::SET_PED_KEEP_TASK(Global_112680, 1);
...
fVar3=MISC::GET_DISTANCE_BETWEEN_COORDS(Global_112686, Var0, 1);
if(fVar3 < 100f){
Var0={
func_82(Global_112686 - Var0) 
};
Var0={
(Global_112686 + (Var0.f_0 * IntToFloat((100 - SYSTEM::ROUND(fVar3))))), (Global_112686.f_1 + (Var0.f_1 * IntToFloat((100 - SYSTEM::ROUND(fVar3))))), Global_112686.f_2 
};
PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(Var0, &Global_112686, &Global_112692, 1, 1077936128, 0);
ENTITY::SET_ENTITY_COORDS(Global_112679, Global_112686, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Global_112679, Global_112692);
}
break;
...
Vector3 func__83(int iParam0, int iParam1){
int iVar0;
iVar0=iParam0;
...
bVar1=false;
if(PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Global_112686, iVar2, &Var3, 1, 1077936128, 0)){
iVar2++;
}}}
if(SYSTEM::VDIST2(Var3, Global_112686) > 2f){
PATHFIND::GET_SAFE_COORD_FOR_PED(Var3, 0, &Global_112686, 0);
}}
...
fVar0=func_119(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112686);
if(bLocal_66){
...
float fVar0;
int iVar1;
fVar0=(((func_119(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112686) / 50f) * fLocal_75) * 2.4f);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_974, 0) > 50f){
fLocal_84=(fLocal_84 + fLocal_75);
iLocal_105=0;
Local_974={
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
fLocal_85=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112686);
...
if(!func_38(14)){
fVar1=PATHFIND::CALCULATE_TRAVEL_DISTANCE_BETWEEN_POINT(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Global_112686);
...
if(func_125(&Global_112679, ENTITY::GET_ENTITY_COORDS(Global_112679, 0), Local_962, uParam1, uParam2, &iLocal_90, iParam0, 1000)){
iLocal_950=3;
return 0;
}else{
return 0;
...
elseif(iVar12==iVar13){
bVar22=true;
}
if(fVar16 < 0f){
fVar15=0f;
}
elseif(PATHFIND::GET_VEHICLE_NODE_IS_SWITCHED_OFF(uVar18) || !PATHFIND::GET_VEHICLE_NODE_IS_GPS_ALLOWED(uVar18)){
fVar15=0f;
}
else{
if(bVar23){
...
*uParam7={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(*uParam7, *uParam8, fVar15, 0f, 0f) 
};
if(VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, 0)){
iVar11=*uParam0;
}
...
*uParam4=163.87f;
return 1;
}elseif(func_143(Param0, -3800f, 5400f, -100f, -1900f, 8500f, 100f)){
*uParam3={
-1577.16f, 5166.51f, 19.1864f 
};
*uParam4=0f;
return 1;
}elseif(func_143(Param0, -874.9833f, 125.7645f, -100f, -768.6254f, 193.0297f, 100f)){
*uParam3={
-856.6151f, 163.7361f, 65.093f 
};
*uParam4=355.3355f;
return 1;
}elseif(func_143(Param0, -39.2005f, -1473.55f, -100f, 10.6133f, -1430.099f, 100f)){
*uParam3={
-15.5181f, -1456.4f, 29.4244f 
};
*uParam4=94.6893f;
return 1;
}elseif(func_143(Param0, 1964.742f, 3792.59f, -100f, 1992.636f, 3840.253f, 100f)){
*uParam3={
1996.372f, 3818.831f, 31.1612f 
};
*uParam4=170.0221f;
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -68.2187f, -1086.951f, -100f, -10.54518f, -1106.895f, 100f, 43.5f, 0, 1)){
*uParam3={
-63.5854f, -1074.732f, 26.0995f 
};
*uParam4=324.1257f;
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, 398.7899f, -1651.417f, -100f, 423.8372f, -1619.432f, 100f, 45f, 0, 1)){
*uParam3={
416.871f, -1613.081f, 28.1401f 
};
*uParam4=227.9333f;
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -988.8535f, -2553.177f, -100f, -1041.486f, -2644.97f, 100f, 49.75f, 0, 1) && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
*uParam3={
-1039.542f, -2574.467f, 12.7566f 
};
*uParam4=162.2744f;
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -906.902f, -2600.461f, -100f, -959.7651f, -2692.057f, 100f, 49.75f, 0, 1) && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
*uParam3={
-911.1597f, -2676.132f, 12.7567f 
};
*uParam4=338.9414f;
return 1;
}
...
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -1061.018f, -2540.235f, 18.66932f, -1023.332f, -2562.115f, 31.57616f, 250f, 0, 1)){
iVar0=(iParam5 % 8);
switch (iVar0){
case 1:
*uParam3={
...
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -1061.059f, -2540.254f, 10.94467f, -1023.297f, -2562.052f, 18.51685f, 250f, 0, 1)){
iVar0=(iParam5 % 8);
switch (iVar0){
case 1:
*uParam3={
...
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -1043.364f, -2747.29f, 16.96057f, -991.5368f, -2657.682f, 69.12349f, 200f, 0, 1)){
iVar0=(iParam5 % 8);
switch (iVar0){
case 1:
*uParam3={
...
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Param0, -1047.646f, -2754.947f, 2.941969f, -991.7314f, -2653.153f, 16.89228f, 200f, 0, 1)){
iVar0=(iParam5 % 8);
switch (iVar0){
case 1:
*uParam3={
...
case 0:
*uParam3={
-979.95f, -2746.109f, 12.7091f 
};
*uParam4=91.4929f;
break;
case 1:
*uParam3={
-1025.193f, -2728.218f, 12.6647f 
};
*uParam4=239.0041f;
break;
case 2:
*uParam3={
-1051.315f, -2713.069f, 12.6676f 
};
*uParam4=236.4666f;
break;
case 3:
*uParam3={
-1095.742f, -2637.871f, 12.6461f 
};
*uParam4=188.9897f;
break;
}}else{
...
*uParam4=52.3086f;
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, 1137.022f, 89.06853f, 71.89022f, 1010.046f, -91.56699f, 103.4568f, 180f, 0, 1)){
*uParam3={
...
*uParam4=-20f;
return 1;
}elseif(OBJECT::IS_POINT_IN_ANGLED_AREA(Var1, 8.1f, -685.5f, 31.2f, 26.3f, -665.7f, 35.2f, 10f, 0, 1)){
*uParam3={
61.4f, -653.2f, 32f 
};
*uParam4=160f;
...
return 1;
}}}elseif(fVar1 < fVar0 && fVar1 < fVar2){
...
case 0:
*uParam1={
-1646.118f, 4206.743f, 82.9658f 
};
*uParam2=251.0217f;
break;
case 1:
*uParam1={
-1582.89f, 4201.409f, 79.5905f 
};
*uParam2=95.4232f;
break;
}
...
case 0:
*uParam1={
1885.446f, 4738.612f, 39.4154f 
};
*uParam2=43.9908f;
break;
case 1:
*uParam1={
1702.424f, 4687.697f, 41.9431f 
};
*uParam2=2.4487f;
break;
}
...
case 0:
*uParam1={
-2934.66f, 3238.404f, 9.4456f 
};
*uParam2=228.5574f;
break;
case 1:
*uParam1={
-2842.023f, 3145.086f, 9.24f 
};
*uParam2=45.7287f;
break;
}
...
case 0:
*uParam1={
-43.9252f, -1460.432f, 30.7052f 
};
*uParam2=104.5827f;
break;
case 1:
*uParam1={
14.0313f, -1460.48f, 29.4397f 
};
*uParam2=61.9499f;
break;
}
...
case 0:
*uParam1={
504.1742f, -1652.472f, 28.1893f 
};
*uParam2=52.3367f;
break;
case 1:
*uParam1={
275.9677f, -1554.22f, 28.0311f 
};
*uParam2=303.3013f;
break;
}
...
case 0:
*uParam1={
853.9595f, -1590.922f, 30.5996f 
};
*uParam2=7.148f;
break;
case 1:
*uParam1={
847.5631f, -1559.719f, 28.7923f 
};
*uParam2=20.965f;
break;
}
...
case 0:
*uParam1={
2602.427f, 2852.173f, 35.28f 
};
*uParam2=19.36f;
break;
case 1:
*uParam1={
2686.404f, 2957.39f, 35.4683f 
};
*uParam2=106.36f;
break;
}
...
while (iVar6 < 63){
*iParam1=iVar6;
if(MISC::IS_BIT_SET(Global_113648.f_18576[*iParam1 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113648.f_18576[*iParam1 /*6*/], 3)){
...
Var3={
HUD::GET_BLIP_COORDS(Global_32543[Global_97614[iVar6 /*17*/].f_9 /*23*/].f_19) 
};
if(uParam0->f_2==1f){
Var3.f_2=1f;
}
...
iVar3=0;
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, iVar3, 0)){
...
func_174(&Global_112679, iLocal_992);
}elseif(!func_2(Global_112680, joaat("script_task_vehicle_park"))){
Var0={
ENTITY::GET_ENTITY_COORDS(Global_112679, 1) 
};
uVar3=ENTITY::GET_ENTITY_HEADING(Global_112679);
TASK::TASK_VEHICLE_PARK(Global_112680, Global_112679, Var0, uVar3, 3, 60f, 0);
}}}}
...
bLocal_67=true;
iLocal_952=2;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_954, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_954, "leanover_idle", 3)){
if(PED::IS_PED_HEADTRACKING_PED(Global_112680, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(Global_112680);
}
TASK::TASK_PLAY_ANIM(Global_112680, &cLocal_954, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_954, "leanover_exit", 3)){
ENTITY::SET_ENTITY_ANIM_SPEED(Global_112680, &cLocal_954, "leanover_exit", 1.2f);
iLocal_92=MISC::GET_GAME_TIMER();
func_174(&Global_112679, iLocal_992);
}elseif(!func_2(Global_112680, joaat("script_task_perform_sequence"))){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_815);
TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_112679, Global_112686, fVar1, iVar0, 45f);
TASK::TASK_VEHICLE_PARK(0, Global_112679, Global_112686, Global_112692, iLocal_112, 60f, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_815);
TASK::TASK_PERFORM_SEQUENCE(Global_112680, uLocal_815);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_815);
}}}}}}}
...
bVar4=true;
iVar2=VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112679, iVar6, 0);
...
int func_172(){
if((ENTITY::IS_ENTITY_AT_COORD(Global_112679, Global_112686, 45f, 45f, 20f, 0, 1, 0) || iLocal_58) || iLocal_951==4){
iLocal_58=1;
...
if(bLocal_63){
return 1;
}elseif(func_124(&Local_43, &Global_112686, &Global_112692)){
iLocal_105=0;
Local_974={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) 
};
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_815);
TASK::TASK_PLAY_ANIM(0, &cLocal_954, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, &cLocal_954, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_815);
TASK::TASK_PERFORM_SEQUENCE(Global_112680, uLocal_815);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_815);
return 1;
...
if(ENTITY::DOES_ENTITY_EXIST(Global_112679)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
iLocal_111=OBJECT::CREATE_OBJECT(iLocal_110, ENTITY::GET_ENTITY_COORDS(Global_112679, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_111, Global_112679, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(Global_112679, "Chassis"), Local_986, Local_989, 0, 0, 0, 0, 2, 1, 0);
VEHICLE::SET_TAXI_LIGHTS(Global_112679, 0);
if(!HUD::IS_NAMED_RENDERTARGET_REGISTERED("taxi")){
HUD::REGISTER_NAMED_RENDERTARGET("taxi", 0);
HUD::LINK_NAMED_RENDERTARGET(ENTITY::GET_ENTITY_MODEL(iLocal_111));
}
uLocal_95=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("taxi");
}}
return 0;
}
...
CAM::ATTACH_CAM_TO_ENTITY(uLocal_70, Global_112679, Local_980, 1);
func_182();
CAM::SET_CAM_CONTROLS_MINI_MAP_HEADING(uLocal_70, 1);
...
}}elseif(CAM::IS_CAM_ACTIVE(uLocal_70)){
CAM::SET_CAM_ACTIVE(uLocal_70, 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
...
Var0={
HUD::GET_BLIP_COORDS(Local_43.f_0) 
};
...
CAM::SET_CAM_IS_INSIDE_VEHICLE(uLocal_70, 1);
...
uVar5=Var0.f_1;
Var6={
func_82(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112679, Param2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112679, Local_980)) 
};
...
}elseif(func_127(Local_829[iVar0 /*3*/])==-1){
}elseif(func_131(HUD::GET_BLIP_COORDS(Local_829[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0)){
}else{
...
Var5={
ENTITY::GET_ENTITY_COORDS(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_829[bVar0 /*3*/])), 1) 
};
}}elseif(HUD::GET_BLIP_INFO_ID_TYPE(Local_829[bVar0 /*3*/])==1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_829[bVar0 /*3*/]), 0)){
Var5={
ENTITY::GET_ENTITY_COORDS(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_829[bVar0 /*3*/]), 1) 
};
}}else{
Var5={
HUD::GET_BLIP_COORDS(Local_829[bVar0 /*3*/]) 
};
}
...
iLocal_99=iParam3;
Local_977={
HUD::GET_BLIP_COORDS(Local_829[iParam3 /*3*/]) 
};
}}
...
if(HUD::DOES_BLIP_EXIST(uParam0)){
Var0={
func_47(iParam0) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
}}
...
return 1;
}elseif((iVar0==12 || iVar0==14) || iVar0==13){
return 1;
}}
return 0;
}
...
if(func_207(HUD::GET_BLIP_COORDS(*uParam0), 0f, 0f, 0f, 0)){
return 1;
}
...
Var1={
HUD::GET_BLIP_COORDS(Local_829[iLocal_99 /*3*/]) 
};
...
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, -1, 0)){
iVar0++;
}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 0, 0)){
iVar0++;
}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 1, 0)){
iVar0++;
}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 2, 0)){
iVar0++;
}}
return iVar0;
}
...
if(HUD::DOES_BLIP_EXIST(Local_829[bLocal_94 /*3*/])){
Var0={
HUD::GET_BLIP_COORDS(Local_829[bLocal_94 /*3*/]) 
};
if(!func_216(Var0)){
HUD::LOCK_MINIMAP_POSITION(Var0.f_0, Var0.f_1);
}}}
...
PAD::ALLOW_ALTERNATIVE_SCRIPT_CONTROLS_LAYOU(1);
...
if(func_227(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
...
Var0={
ENTITY::GET_ENTITY_COORDS(Global_112679, 0) 
};
...
Local_971={
ENTITY::GET_ENTITY_COORDS(Global_112679, 1) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
Local_971.f_2=0f;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 1, 0)){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112679, 1, 0);
...
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 2, 0)){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112679, 2, 0);
if(PLAYER::PLAYER_PED_ID() !=iVar0){
if(!PED::IS_PED_GROUP_MEMBER(iVar0, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()))){
TASK::TASK_SMART_FLEE_PED(iVar0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
}}}}}
...
Global_112694=1;
if(bParam2){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112680, 1, 1);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112679, 1, 1);
StringCopy(&Global_112710, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
}else{
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112680)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112680, 1, 0);
}
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112679)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112679, 1, 0);
StringCopy(&Global_112710, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
}}
PED::SET_PED_CONFIG_FLAG(Global_112680, 251, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Global_112680, 5, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Global_112680, 17, 1);
PED::SET_PED_FLEE_ATTRIBUTES(Global_112680, 512, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112680, 1);
...
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_112679, 1);
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_112679, 0, 0);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Global_112679, 1);
return 1;
}}}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(Global_112680)){
if(!PED::IS_PED_INJURED(Global_112680)){
PED::SET_PED_CONFIG_FLAG(Global_112680, 251, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112680, 0);
if(!PED::IS_PED_FLEEING(Global_112680) && !PED::IS_PED_IN_COMBAT(Global_112680, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(Global_112680, 0)){
if(ENTITY::DOES_ENTITY_EXIST(Global_112679)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(Global_112680, Global_112679)){
...
if((!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 1, 0) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 2, 0)) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112679, 0, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(Global_112680, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}}else{
TASK::TASK_SMART_FLEE_PED(Global_112680, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}
}
else{
TASK::TASK_SMART_FLEE_PED(Global_112680, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Global_112680, joaat("script_task_wander_standard")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(Global_112680, joaat("script_task_wander_standard")) !=0){
TASK::TASK_WANDER_STANDARD(Global_112680, 1193033728, 0);
}}}}
if(ENTITY::DOES_ENTITY_EXIST(Global_112680)){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112680)){
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_112680, 0)){
if(!PED::IS_PED_INJURED(Global_112680)){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Global_112680, 0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112680, 0);
}
...
if(ENTITY::DOES_ENTITY_EXIST(Global_112679)){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112679)){
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_112679, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_112679, 0);
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_112679, 1, 0);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Global_112679, 0);
}
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_954, "leanover_idle", 3)){
...
if(func_3(Global_112679)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112679, 1)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112679, -1, 0) !=PLAYER::PLAYER_PED_ID()){
if(!func_2(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle")) && !func_2(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_vehicle"))){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}}}
func_5();
