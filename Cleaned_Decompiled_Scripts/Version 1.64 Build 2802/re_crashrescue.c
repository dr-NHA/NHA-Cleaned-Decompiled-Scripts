...
TASK::TASK_WANDER_STANDARD(iLocal_75, 1193033728, 0);
...
if(!func_340()){
if(HUD::DOES_BLIP_EXIST(uLocal_74)){
HUD::REMOVE_BLIP(&uLocal_74);
}
...
PED::SET_PED_CONFIG_FLAG(iLocal_75, 137, 1);
iLocal_283++;
}}else{
func_323();
}
...
PED::SET_PED_DIES_IN_VEHICLE(iLocal_75, 1);
PED::APPLY_DAMAGE_TO_PED(iLocal_75, 200, 0, 0);
}else{
...
var func__14(int iParam0, int iParam1){
...
if(PED::IS_PED_IN_GROUP(iLocal_75) || ENTITY::IS_ENTITY_AT_COORD(iLocal_75, Local_60, Global_22, 0, 1, 0)){
func_209(1, 0, 1, 0);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_207(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 5f, 1, 1056964608, 0, 1, 0)){
iVar0=1;
}}else{
...
MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_76, 1), 20f, 1, 0, 0, 0);
MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_76, 1), 20f, 0);
SYSTEM::WAIT(0);
iLocal_55=1;
}
break;
...
ENTITY::SET_ENTITY_COORDS(iVar1, Local_60, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iVar1, 119f);
}
...
ENTITY::SET_ENTITY_COORDS(iLocal_75, 1738.047f, 3842.438f, 33.7707f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_75, 36.8203f);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_75, 0, 0);
MISC::CLEAR_AREA(Local_60, 4f, 1, 0, 0, 0);
func_66(&iVar1);
uLocal_271=PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, uLocal_271, sLocal_269, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_76, uLocal_271, sLocal_269, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
uLocal_87=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_87, uLocal_271, "HELPING_FRIEND_INSIDE_CAM", sLocal_269);
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_271, fLocal_281);
CAM::SET_CAM_ACTIVE(uLocal_87, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
iLocal_55=4;
}}
break;
case 4:
if((iLocal_288 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_271)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_271) > 0.97f){
GRAPHICS::ANIMPOSTFX_PLAY("CamPushInNeutral", 0, 0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
iLocal_288=0;
}
if((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_271) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_271) >=fLocal_282) || func_63()){
PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
CAM::SET_CAM_ACTIVE(uLocal_87, 0);
...
return MISC::IS_BIT_SET(Global_113648.f_26436.f_1, iParam0);
}
return 0;
}
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_271) < 1f){
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_271, 1f);
}
return 1;
}
return 0;
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_73(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
Global_78341[1 /*14*/]={
func_131(iVar10, iVar0, func_89(iParam0, iVar0, -1), -1) 
};
...
return 1;
}elseif(func_118(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_117(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
Vector3 func__205(struct<3> Param0){
float fVar0;
float fVar1;
...
PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_75, 0);
...
func_66(&iLocal_79);
if(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_279)){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(uLocal_279, 0);
}
iLocal_78=0;
}else{
func_219();
...
bLocal_286=true;
iLocal_54=2;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_76, PLAYER::PLAYER_PED_ID(), 1) || func_215(iLocal_76, PLAYER::PLAYER_PED_ID(), 1.25f, 1)){
...
TASK::TASK_SMART_FLEE_PED(iLocal_76, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_76, 1);
bLocal_286=true;
iLocal_54=2;
iLocal_283=0;
}elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60, Global_19, 1, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, 1, 0)){
iLocal_54=1;
iLocal_55=0;
}}else{
func_213();
...
TASK::TASK_PLAY_ANIM(iLocal_75, sLocal_268, "LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
}}}}else{
if(HUD::DOES_BLIP_EXIST(uLocal_74)){
HUD::REMOVE_BLIP(&uLocal_74);
}
...
int iVar1;
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_75, 0)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(iLocal_75, 0);
...
if((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_269)) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 0)){
uLocal_257=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 1, 0, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_257, 1);
Local_80={
...
iLocal_76=PED::CREATE_PED(26, iLocal_258, 1728.778f, 3851.287f, 33.7826f, 211.7722f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_76, 1);
func_214(&uLocal_88, 5, iLocal_76, "CrashSafehouse", 0, 1);
uLocal_271=PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_76, uLocal_271, sLocal_269, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
bLocal_256=true;
}}}
...
VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(iLocal_79, 1);
}elseif((iLocal_69 - iLocal_70) > 2000){
VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(iLocal_79, 0);
...
}elseif(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, 20f, 20f, 20f, 0, 1, 0) || !func_231()){
PED::REMOVE_PED_FROM_GROUP(iLocal_75);
...
return 1;
}elseif(HUD::DOES_BLIP_EXIST(uLocal_73)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, Global_19, 0, 1, 0) && func_231()){
...
var func__223(int iParam0, bool bParam1, int iParam2){
var uVar0;
iParam2=iParam2;
if(ENTITY::DOES_ENTITY_EXIST(iParam0)){
if(ENTITY::IS_ENTITY_A_PED(iParam0)){
uVar0=func_229(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0), bParam1, 0);
}elseif(ENTITY::IS_ENTITY_A_VEHICLE(iParam0)){
...
var func__229(int iParam0, bool bParam1, int iParam2){
iParam2=iParam2;
return func_230(iParam0, bParam1, 145);
}


var func__230(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
if(!PED::IS_PED_INJURED(iLocal_75)){
if(PED::IS_PED_IN_VEHICLE(iLocal_75, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
iLocal_278=0;
return 1;
}}}elseif(func_232()){
}else{
...
if(func_222()){
if(func_231() && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_9(&uLocal_88, "RECRAAU", "RECRA_PAIN", 3, 0, 0, 0)){
iLocal_67++;
}
}
elseif(func_9(&uLocal_88, "RECRAAU", "RECRA_GETOUT", 3, 0, 0, 0)){
iLocal_67++;
}}}}elseif(iLocal_67==1){
func_235(100, 1);
}elseif(iLocal_67==2){
...
Local_80={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_75, 0f, 0f, 5f) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Local_80, &(Local_80.f_2), 0, 0);
Local_83={
func_242() 
};
Local_83.f_2=func_241((fLocal_275 + 180f), 0f, 360f);
uLocal_270=PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
uLocal_86=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_86, uLocal_270, "HELPING_VICTIM_TO_FEET_CAM", sLocal_263);
...
MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_75, 1), 5f, 1, 0, 0, 0);
MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_75, 1), 20f, 0);
GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(ENTITY::GET_ENTITY_COORDS(iLocal_75, 1), 7f);
uLocal_280=GRAPHICS::ADD_DECAL(1110, Local_272, 0f, 0f, -1f, func_205(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
if(PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID())==1){
PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), 0, 0);
}
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, uLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_270, 0);
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_270, 0.25f);
...
iLocal_254=1;
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_270) > 0.5f){
iLocal_71++;
}
break;
case 3:
...
CAM::DO_SCREEN_FADE_OUT(250);
iLocal_254=1;
}elseif(func_238(uLocal_270, 0.9f)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), -4f, 1);
iLocal_71=4;
bLocal_255=true;
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_270) > 0.99f){
iLocal_71++;
}
break;
case 4:
...
if(func_25(iLocal_75)){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_75, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_75, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_75, 172, 0);
}
GRAPHICS::REMOVE_DECAL(uLocal_280);
...
PED::FORCE_PED_MOTION_STATE(iLocal_75, joaat("MotionState_Idle"), 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_75, 0, 0);
Var0={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", Local_80, Local_83, 1f, 2) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &(Var0.f_2), 0, 0);
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Var0, 1, 0, 0, 1);
Var0={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", Local_80, Local_83, 1f, 2) 
};
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), Var0.f_2);
Var0={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", Local_80, Local_83, 1f, 2) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &(Var0.f_2), 0, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_75, Var0, 1, 0, 0, 1);
Var0={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", Local_80, Local_83, 1f, 2) 
};
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_253, 0);
uLocal_253=PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.813f, 3847.646f, 1731.052f) + Vector(-5f, -20f, -20f), Vector(33.813f, 3847.646f, 1731.052f) + Vector(5f, 25f, 35f), 0, 1, 1, 1);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, 80f, 80f, 15f, 0, 1, 0)){
STREAMING::REQUEST_ANIM_DICT(sLocal_263);
if(!iLocal_287){
func_259(1);
iLocal_287=1;
}
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, 2.5f, 2.5f, 2.5f, 0, 1, 1) && func_258(1, 0, 1)){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_75, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_75, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_75, 206, 1);
iLocal_53=2;
}elseif(func_215(PLAYER::PLAYER_PED_ID(), iLocal_75, 15f, 1) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f){
if(func_340()){
func_256();
}
if(!HUD::DOES_BLIP_EXIST(uLocal_73)){
...
if(!HUD::DOES_BLIP_EXIST(uLocal_73)){
uLocal_73=func_255(iLocal_75, 1, 1, 5);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_73, 0);
}
...
int func_261(){
if(!PED::IS_PED_INJURED(iLocal_75)){
if(MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_75, 31086, 0f, 0f, 0f), 1f, 1)){
return 1;
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
iLocal_79=VEHICLE::CREATE_VEHICLE(iLocal_260, 1932.98f, 6291.91f, 41.08f, 350.85f, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_260);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_79, 0, 0, 0);
...
VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, Var3.f_1, 0f, 500f, 10000f, 1);
VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, Var3.f_0, (Var3.f_1 * 0.75f), 0f, 500f, 10000f, 1);
VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, Var3.f_0, 0f, 0f, 500f, 10000f, 1);
VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, 0f, Var3.f_2, 500f, 10000f, 1);
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_79, 5, 1, 1);
VEHICLE::SET_VEHICLE_DIRT_LEVEL(iLocal_79, 12f);
VEHICLE::START_VEHICLE_ALARM(iLocal_79);
ENTITY::SET_ENTITY_PROOFS(iLocal_79, 0, 1, 0, 0, 0, 0, 0, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_79, 0f, 180f, 0f, 2, 1);
VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(iLocal_79, 1);
VEHICLE::SET_VEHICLE_UNDRIVEABLE(iLocal_79, 1);
uLocal_279=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_recrash_rescue_fire", iLocal_79, -0.45f, -1.25f, -0.5f, 0f, 0f, 0f, 1f, 0, 0, 1);
if(bLocal_276){
iLocal_75=PED::CREATE_PED(26, iLocal_259, Local_272, (fLocal_275 - 180f), 1, 1);
}else{
iLocal_75=PED::CREATE_PED(26, iLocal_259, Local_272, fLocal_275, 1, 1);
}
PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_75, 0, 0.7f, 0.5f, 2);
Local_63={
ENTITY::GET_ENTITY_COORDS(iLocal_75, 1) 
};
MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_63.f_0, (Local_63.f_1 + 0.1f), (Local_63.f_2 + 0.1f), Local_63.f_0, (Local_63.f_1 - 0.1f), (Local_63.f_2 - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
TASK::TASK_PLAY_ANIM(iLocal_75, sLocal_261, "BASE", 8f, -8f, -1, 9, 0, 0, 0, 0);
if(func_25(iLocal_75)){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_75, 0);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_75, 1);
ENTITY::SET_ENTITY_HEALTH(iLocal_75, 115, 0);
PED::SET_PED_DIES_WHEN_INJURED(iLocal_75, 1);
PED::SET_PED_KEEP_TASK(iLocal_75, 1);
PED::SET_PED_DIES_IN_VEHICLE(iLocal_75, 1);
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(iLocal_75, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_75, 13, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_75, 17, 1);
PED::SET_PED_MOVEMENT_CLIPSET(iLocal_75, sLocal_262, 1048576000);
PED::SET_PED_CONFIG_FLAG(iLocal_75, 229, 1);
...
iLocal_77=PED::CREATE_PED(26, iLocal_258, 1935.53f, 6291.888f, 41.144f, -28.44f, 1, 1);
iLocal_78=1;
Local_63={
ENTITY::GET_ENTITY_COORDS(iLocal_77, 1) 
};
PED::APPLY_PED_BLOOD(iLocal_77, 3, 0f, 0f, 0f, "wound_sheet");
MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_63.f_0, (Local_63.f_1 + 0.1f), (Local_63.f_2 + 0.1f), Local_63.f_0, (Local_63.f_1 - 0.1f), (Local_63.f_2 - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
PED::SET_PED_CONFIG_FLAG(iLocal_77, 227, 1);
TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_77, sLocal_264, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
...
uLocal_253=PED::ADD_SCENARIO_BLOCKING_AREA(Vector(33.7286f, 3850.767f, 1729.311f) - Vector(3f, 25f, 25f), Vector(33.7286f, 3850.767f, 1729.311f) + Vector(3f, 25f, 25f), 0, 1, 1, 1);
iLocal_53=1;
}}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_313()) || Global_112695) || Global_32166) || func_312()) || func_22(8, -1)) || func_311()) || func_310()) || func_309()) || func_308()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_313()) || Global_32166) || func_312()) || func_22(8, -1)) || func_309()) || func_311()) || func_310()) || func_308()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_313()) || Global_112695) || Global_32166) || func_312()) || func_22(8, -1)) || func_309()) || func_311()) || func_310()) || func_308()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_313()) || Global_112695) || Global_32166) || func_312()) || func_22(8, -1)) || func_311()) || func_310()) || func_308()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_313()) || Global_32166) || func_312()) || func_22(8, -1)) || func_310()) || func_309()) || func_308()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_313()) || func_310()) || Global_112695) || Global_32166) || func_312()) || Global_44446) || func_22(8, -1)) || func_309()) || func_307()) || func_308()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_313()) || Global_112695) || Global_32166) || func_312()) || func_22(8, -1)) || func_309()) || func_307()) || func_311()) || func_310()) || func_308()){
return 0;
}
break;
}}else{
...
ENTITY::SET_ENTITY_PROOFS(iLocal_79, 0, 0, 0, 0, 0, 0, 0, 0);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_257)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_257, 0);
...
uVar7=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cVar1), iVar0 * 3, iVar0 * 3 + 1);
