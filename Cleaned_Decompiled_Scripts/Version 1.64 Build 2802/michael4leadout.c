...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_28(iParam0, 0, 0)) || func_28(iParam0, 1, 0)) || func_28(iParam0, 2, 0)) || func_51(iParam0) !=145) || func_27(iParam0)) || func_26(iParam0)) || func_25(iParam0)) || func_24(iParam0)) || !func_12(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_26(iParam0)){
}
if(func_26(iParam0)){
}
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_37(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
return 1;
}elseif(func_82(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
int func_96(int iParam0, bool bParam1, var uParam2){
bool bVar0;
if(!bParam1){
...
int func_101(var uParam0, var uParam1, var uParam2){
int iVar0;
int iVar1;
...
}elseif(func_106(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
int func_106(var uParam0, int iParam1, int iParam2){
...
Global_78341[1 /*14*/]={
func_163(iVar10, iVar0, func_120(iParam0, iVar0, -1), -1) 
};
...
if(!func_112(uParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63)){
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_121(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_121(iParam1))){
return 1;
}
return 0;
}
...
return 1;
}elseif(func_148(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
if(!func_112(uParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
int func_123(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
int iVar0;
int iVar1;
int iVar2;
int iVar3;
...
switch (iParam2){
case 2:
iVar1=func_152(uParam0, 1);
iVar0=func_130(iParam1, iParam3, iVar1);
break;
case 1:
iVar2=func_152(uParam0, 2);
...
if(iParam2==11){
iVar5=iParam3;
iVar4=func_152(uParam0, 3);
}elseif(iParam2==3){
iVar4=iParam3;
iVar5=func_152(uParam0, 11);
iVar5=func_125(iParam1, iVar4, iVar5, 0);
}
iVar3=func_152(uParam0, 8);
...
iVar7=func_152(uParam0, 8);
iVar8=func_152(uParam0, 11);
...
int func_124(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4){
int iVar0;
switch (iParam0){
case joaat("player_zero"):
break;
...
int iVar0;
iVar0=func_152(uParam0, iParam1);
...
if(iParam1==0){
iVar0=func_136(uParam0, iParam2, iParam3, iParam1);
if(func_132(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3))){
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_121(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_121(iParam2));
...
struct<10> func_141(int iParam0, int iParam1){
int iVar0;
struct<10> Var1;
Var1=9;
iVar0=0;
...
void func_143(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9){
(*iParam0)[0]=iParam1;
(*iParam0)[1]=iParam2;
(*iParam0)[2]=iParam3;
(*iParam0)[3]=iParam4;
...
void func_147(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13){
(*uParam0)[0]=iParam1;
(*uParam0)[2]=iParam2;
(*uParam0)[3]=iParam3;
(*uParam0)[4]=iParam4;
...
func_156(iVar2, uVar3, iVar0, 1, 0);
}}


void func_156(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4){
int iVar0;
if(bParam4){}
...
uVar0=Global_2805027[iParam0 /*3*/][func_157(iParam1)];
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_121(iParam0));
if(iVar57 > iVar56){
...
void func_229(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6){
int iVar0;
if(bParam6){
