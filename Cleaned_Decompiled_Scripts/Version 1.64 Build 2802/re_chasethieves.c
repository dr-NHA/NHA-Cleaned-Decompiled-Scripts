...
HUD::SET_BLIP_COLOUR(uLocal_174, 1);
}
func_309(1);
...
if(OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_588)){
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_588)) > 100f){
func_401();
}}elseif(bLocal_69==1){
func_2(2);
func_421();
}else{
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_578, joaat("player"));
if(func_1(iLocal_82)){
...
func_4();
break;
}}elseif(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_87, 1), 20f)){
func_4();
}}}
...
iLocal_246=1;
if(func_1(iLocal_87)){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_87, 17, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_87, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
...
switch (iLocal_202){
case 0:
if(!STREAMING::STREAMVOL_IS_VALID(uLocal_593)){
uLocal_593=STREAMING::STREAMVOL_CREATE_SPHERE(ENTITY::GET_ENTITY_COORDS(iLocal_87, 1), 200f, 12, 127);
}
STREAMING::REQUEST_ANIM_DICT(sLocal_227);
if(func_226(2)){
HUD::CLEAR_HELP(1);
}
if(!func_1(iLocal_106) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_106=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
VEHICLE::SET_LAST_DRIVEN_VEHICLE(iLocal_106);
}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_224(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1093140480, 1, 1056964608, 0, 1, 0)){
}else{
func_223(0);
...
func_217(0);
func_216();
if(((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !func_215()) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_227)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_wallet_01"))){
if(iLocal_591==-1){
...
uLocal_173=OBJECT::CREATE_OBJECT(joaat("prop_ld_wallet_01"), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_173, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
uLocal_180=ENTITY::GET_ENTITY_HEADING(iLocal_87);
Var0={
Local_177 
};
...
Var3={
ENTITY::GET_ENTITY_ROTATION(iLocal_87, 2) 
};
uLocal_200=PED::CREATE_SYNCHRONIZED_SCENE(Var0, Var3, 2);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_200, 0);
uLocal_201=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_201, uLocal_200, sLocal_230, sLocal_227);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_200, sLocal_227, sLocal_228, 1000f, -1000f, 1, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_87);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_87, uLocal_200, sLocal_227, sLocal_229, 1000f, -1000f, 1, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_87, 0, 0);
...
MISC::CLEAR_AREA_OF_VEHICLES(Var0, 5f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA(Var0, 2f, 1, 0, 0, 0);
MISC::CLEAR_AREA(PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_227, sLocal_229, Var0, Var3, 0, 2), 2f, 1, 0, 0, 0);
CAM::SET_CAM_ACTIVE(uLocal_201, 1);
...
break;
case 2:
if(((iLocal_628==0 && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4) && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_200)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_200) >=0.96f){
GRAPHICS::ANIMPOSTFX_PLAY("CamPushInNeutral", 0, 0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
iLocal_628=1;
}
if(((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_200) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_200)==1f) || func_92()) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -571081548)){
...
if((ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_173, PLAYER::PLAYER_PED_ID()) && iLocal_247==0) && func_96(&uLocal_248, "RECHAAU", sVar6, sVar7, 4, 0, 0)){
ENTITY::DETACH_ENTITY(uLocal_173, 0, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_173, iLocal_87, PED::GET_PED_BONE_INDEX(iLocal_87, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
iLocal_247=1;
}}else{
if(iLocal_247==0 && func_96(&uLocal_248, "RECHAAU", sVar6, sVar7, 4, 0, 0)){
iLocal_247=1;
}
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_200) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_200) > 0.9f){
func_88();
}}}
break;
case 3:
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_47() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_47() /*5568*/].f_681.f_10, iParam0);
}
...
if(WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_59, 0)){
WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_59, 0);
}}}}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_80(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
func_90(iLocal_87, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0f, 2f, 1f), uLocal_180, 1, 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_87, 0, 0);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_149(iVar10, iParam1, iParam2, -1) 
};
if(!func_148(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_149(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_131(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_149(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_149(iVar10, iVar0, func_110(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_149(iVar10, 14, uVar69[iVar1], -1) 
};
func_121(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_144(14);
if(Global_78339==1){
...
return 1;
}elseif(func_138(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_111(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_111(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_111(iParam0));
if(iVar57 > iVar56){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78341[1 /*14*/]={
func_149(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_111(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_111(iParam1))){
return 1;
}
return 0;
}
...
}}elseif(PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_87)){
...
func_2(2);
func_421();
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 1, 0)){
func_230();
iLocal_60=6;
}elseif(iLocal_194==1){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 50f, 50f, 20f, 0, 1, 0)){
func_2(2);
func_421();
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 30f, 30f, 20f, 0, 1, 0)){
iLocal_194=1;
}elseif(fLocal_196 > -1f){
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_62) > (fLocal_196 + 120f)){
func_2(2);
func_421();
}}}}
...
case 0:
if(!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_87)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 30f, 30f, 30f, 0, 0, 0) && func_96(&uLocal_248, "RECHAAU", "RECHA_TK", "RECHA_TK_1", 4, 0, 0)){
iLocal_79++;
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 40f, 40f, 40f, 0, 0, 0) && func_5(&uLocal_248, "RECHAAU", "RECHA_WT", 4, 0, 0, 0)){
iLocal_79++;
}
break;
case 1:
...
}}elseif(HUD::GET_BLIP_ALPHA(uParam0) !=0){
...
if(iLocal_68==1){
if((!func_215() && SYSTEM::TIMERA() > 8000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 12f, 12f, 5f, 0, 0, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_186);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 12f, 12f, 5f, 0, 0, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_186);
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 12f, 12f, 5f, 0, 0, 0) && func_5(&uLocal_248, "RECHAAU", "RECHA_SRDN", 4, 0, 0, 0)){
iLocal_68=1;
}
SYSTEM::SETTIMERA(0);
}}}
...
void func_241(){
if(OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_588)){
PAD::SET_CONTROL_SHAKE(0, 200, 250);
bLocal_69=true;
fLocal_196=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_62);
...
func_243(2);
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_240) > 150f){
func_242();
}}}


void func_242(){
if(OBJECT::DOES_PICKUP_EXIST(uLocal_588)){
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_588)) > 100f){
func_401();
}}elseif(bLocal_69){
func_2(2);
...
EVENT::REMOVE_ALL_SHOCKING_EVENTS(0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_186);
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_87, Local_177, 1f, 1f, 2f, 0, 1, 0)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_177, 1f, 20000, 0.25f, 0, 1193033728);
}
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_186);
TASK::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
...
func_2(3);
func_421();
}}elseif((((bLocal_69==0 && OBJECT::DOES_PICKUP_EXIST(uLocal_588)) && func_1(iLocal_87)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_87, OBJECT::GET_PICKUP_COORDS(uLocal_588), 15f, 15f, 2f, 0, 1, 0)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_87, sLocal_583, sLocal_584, 3)){
STREAMING::REQUEST_ANIM_DICT(sLocal_589);
Var0={
OBJECT::GET_PICKUP_COORDS(uLocal_588) - Vector(15f, 15f, 15f) 
};
Var3={
OBJECT::GET_PICKUP_COORDS(uLocal_588) + Vector(15f, 15f, 15f) 
};
if(STREAMING::HAS_ANIM_DICT_LOADED(sLocal_589) && !PED::IS_ANY_PED_SHOOTING_IN_AREA(Var0, Var3, 0, 1)){
iLocal_71=1;
if(!func_91(iLocal_87, joaat("script_task_perform_sequence"))){
TASK::OPEN_SEQUENCE_TASK(&uLocal_186);
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_87, OBJECT::GET_PICKUP_COORDS(uLocal_588), 1f, 1f, 2f, 0, 1, 0)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_588), 2f, 20000, 0.25f, 0, 1193033728);
}
TASK::TASK_TURN_PED_TO_FACE_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_588), 0);
TASK::TASK_PLAY_ANIM(0, sLocal_589, "pickup_low", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_186);
TASK::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_186);
}
...
Local_240={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_82, 0), 1067030938, 1069547520) 
};
MISC::SET_BIT(&uLocal_221, 3);
MISC::SET_BIT(&uLocal_221, 4);
MISC::SET_BIT(&uLocal_221, true);
uLocal_588=OBJECT::CREATE_PICKUP(joaat("pickup_money_wallet"), Local_240, uLocal_221, iLocal_199, 1, iLocal_226);
func_246();
...
if(MISC::IS_BULLET_IN_AREA(Local_62, 50f, 0)){
func_223(0);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 8f, 8f, 8f, 0, 1, 0) && PED::IS_PED_FACING_PED(iLocal_87, PLAYER::PLAYER_PED_ID(), 40f)){
TASK::TASK_LOOK_AT_ENTITY(iLocal_87, PLAYER::PLAYER_PED_ID(), 3500, 2048, 2);
iLocal_77=8;
}}}
switch (iLocal_77){
case 0:
if(((iLocal_197==0 && !func_215()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 40f, 40f, 40f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_GET", 4, 0, 0, 0)){
iLocal_197=1;
}
...
break;
case 1:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_78) > 1000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCA", 4, 0, 0, 0)){
iLocal_78=MISC::GET_GAME_TIMER();
iLocal_220=2;
iLocal_77++;
}
break;
case 2:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_78) > 5000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCB", 4, 0, 0, 0)){
iLocal_78=MISC::GET_GAME_TIMER();
iLocal_220=3;
iLocal_77++;
}
break;
case 3:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_78) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCC", 4, 0, 0, 0)){
iLocal_78=MISC::GET_GAME_TIMER();
iLocal_220=4;
iLocal_77++;
}
break;
case 4:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_78) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 15f, 15f, 15f, 0, 0, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_PCD", 4, 0, 0, 0)){
iLocal_220=5;
iLocal_77++;
}
break;
...
if(func_253()){
if(!PED::IS_PED_INJURED(iLocal_82)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_87, iLocal_82, 20f, 20f, 10f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_87, iLocal_82, 17)){
return 1;
}}elseif(((ENTITY::DOES_ENTITY_EXIST(iLocal_82) && ENTITY::IS_ENTITY_DEAD(iLocal_82, 0)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_87, ENTITY::GET_ENTITY_COORDS(iLocal_82, 0), 20f, 20f, 10f, 0, 1, 0)) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_87, iLocal_82, 17)){
return 1;
}}}
return 0;
}
...
int func_253(){
if(!PED::IS_PED_INJURED(iLocal_82)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_82, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}else{
return 1;
}
...
switch (iLocal_61){
case 0:
if((func_1(iLocal_82) && func_1(iLocal_83)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0)){
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_92, 1, 1, 0);
PED::FORCE_PED_MOTION_STATE(iLocal_82, joaat("MotionState_Sprint"), 0, 0, 0);
iLocal_61=1;
}else{
iLocal_61=3;
}
...
case 1:
if((func_1(iLocal_82) && func_1(iLocal_83)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_82, iLocal_92, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_186);
if(bLocal_203==2){
}
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_92, PLAYER::PLAYER_PED_ID(), 8, 25f, 786724, -1f, -1f, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_186);
TASK::TASK_PERFORM_SEQUENCE(iLocal_83, uLocal_186);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_186);
iLocal_61=2;
}}else{
iLocal_61=3;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0)){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_92, Local_93, 30f, 30f, 5f, 0, 1, 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_83, 0)){
...
if(((((((iLocal_75 < 4 && (MISC::GET_GAME_TIMER() - iLocal_76) > 10000) && func_1(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_215()) && !PED::IS_PED_INJURED(iLocal_82)) && func_254(PLAYER::PLAYER_PED_ID(), iLocal_82, 1) < 40f) && func_5(&uLocal_248, "RECHAAU", "RECHA_YELL", 4, 0, 0, 0)){
iLocal_75++;
iLocal_76=MISC::GET_GAME_TIMER();
}
break;
...
void func_257(){
if(((((((iLocal_191==1 && (MISC::GET_GAME_TIMER() - iLocal_80) > 8000) && !func_215()) && func_1(iLocal_82)) && func_1(iLocal_87)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_82, 20f, 20f, 20f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_82, iLocal_87, 30f, 30f, 30f, 0, 1, 0)) && func_5(&uLocal_248, "RECHAAU", "RECHA_taunt", 4, 0, 0, 0)){
iLocal_80=MISC::GET_GAME_TIMER();
}}
...
iLocal_188=0;
iVar9=10;
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_97[0], 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_97[1], 0)){
...
TASK::TASK_DRIVE_BY(iLocal_100[0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 1, -753768974);
}}}
...
TASK::TASK_DRIVE_BY(iLocal_100[1], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 1, -753768974);
}}}
return 1;
}else{
...
uLocal_97[iLocal_188]=VEHICLE::CREATE_VEHICLE(joaat("hexer"), Var0, Var3.f_2, 1, 1, 0);
iLocal_100[iLocal_188]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_97[iLocal_188], 22, iLocal_222, -1, 1, 1);
iLocal_103[iLocal_188]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_97[iLocal_188], 22, iLocal_222, 0, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_103[iLocal_188], uLocal_578);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_100[iLocal_188], uLocal_578);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_VEHICLE_MISSION(iLocal_100[iLocal_188], uLocal_97[iLocal_188], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar9, 40f, 786469, 5f, 10f, 1);
}
else{
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_100[iLocal_188], uLocal_97[iLocal_188], PLAYER::PLAYER_PED_ID(), iVar9, 40f, 786469, 5f, 10f, 1);
}
WEAPON::GIVE_WEAPON_TO_PED(iLocal_100[iLocal_188], joaat("weapon_sawnoffshotgun"), 999999, 1, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_97[iLocal_188], ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()));
iVar9=11;
WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_188], joaat("weapon_sawnoffshotgun"), 999999, 1, 1);
TASK::TASK_DRIVE_BY(iLocal_103[iLocal_188], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 0, -753768974);
...
if(!PED::IS_PED_IN_VEHICLE(iLocal_82, iLocal_92, 0)){
return 1;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_82, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
if(PED::IS_PED_BEING_JACKED(iLocal_82)){
return 1;
}
if((iLocal_61==1 && !PED::IS_PED_IN_VEHICLE(iLocal_82, iLocal_92, 1)) && !VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_82, iLocal_92, 0, 0, 0)){
return 1;
}}else{
return 1;
}
...
if(!PED::IS_PED_IN_VEHICLE(iLocal_83, iLocal_92, 0)){
return 1;
}}else{
return 1;
}
...
int func_264(){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_92, 20f, 20f, 10f, 0, 1, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_92, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_189++;
iLocal_191=1;
...
void func_265(){
if(iLocal_66==0){
if((func_1(iLocal_82) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_82, 0)) && !PED::IS_PED_IN_COMBAT(iLocal_82, 0)){
TASK::TASK_DRIVE_BY(iLocal_82, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, 0, -753768974);
}
if((((func_1(iLocal_83) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_83, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_83, joaat("script_task_vehicle_mission"))==1) && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_83)) && !PED::IS_PED_IN_COMBAT(iLocal_83, 0)){
TASK::TASK_DRIVE_BY(iLocal_83, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 30f, 60, 1, -753768974);
TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_83, 40f);
}
if((func_1(iLocal_84) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_84, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_84, joaat("script_task_perform_sequence"))==7){
TASK::TASK_DRIVE_BY(iLocal_84, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, 0, -753768974);
}
if((func_1(iLocal_85) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_85, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_85, joaat("script_task_perform_sequence"))==7){
TASK::TASK_DRIVE_BY(iLocal_85, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, 0, -753768974);
}}}

int func_266(){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0)){
if(((VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_92, 0, 0) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_92, 1, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_92, 4, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_92, 5, 0)){
return 1;
}}
return 0;
}
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_276(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(!func_290(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(!func_291(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_288(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_289(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
HUD::SET_BLIP_SCALE(uVar0, func_297(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
return uVar0;
}
...
int func_298(){
if(ENTITY::IS_ENTITY_DEAD(iLocal_82, 0) && ENTITY::GET_ENTITY_SPEED(iLocal_82) < 1f){
return 1;
}
return 0;
}
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_92, fLocal_590, fLocal_590, fLocal_590, 0, 0, 0) || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_92)){
return 1;
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_82, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_82, fLocal_590, fLocal_590, fLocal_590, 0, 0, 0) || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_82)){
return 1;
}}else{
return 1;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0) && !func_263()){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_186);
TASK::TASK_PLAY_ANIM(0, sLocal_583, sLocal_584, 8f, -4f, 8200, 0, 0, 0, 0, 0);
if(func_1(iLocal_82)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 10f, 10f, 10f, 0, 1, 0)){
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
}else{
TASK::TASK_LOOK_AT_ENTITY(0, iLocal_92, -1, 2048, 2);
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_177, 2f, 20000, 2f, 8192, 1193033728);
TASK::TASK_PLAY_ANIM(0, sLocal_586, sLocal_587, 8f, -8f, -1, 0, 0, 0, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_186);
TASK::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_186);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_186);
if(func_1(iLocal_82)){
TASK::TASK_PLAY_ANIM(iLocal_82, sLocal_583, sLocal_585, 8f, -4f, -1, 0, 0, 0, 0, 0);
}
iLocal_195=1;
}}}}
...
var uVar2;
if(func_1(iLocal_82)){
TASK::TASK_SMART_FLEE_PED(iLocal_82, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if(func_1(iLocal_83)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_83, uVar0);
...
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_174, 1);
if(HUD::GET_BLIP_COLOUR(uLocal_174)==1){
}else{
HUD::SET_BLIP_AS_FRIENDLY(uLocal_174, 0);
HUD::SET_BLIP_COLOUR(uLocal_174, 1);
}}}else{
if(HUD::DOES_BLIP_EXIST(uLocal_174)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_174, 0);
func_307(uLocal_174, &uLocal_190);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_92, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_92, 25f, 25f, 25f, 0, 0, 0) && ENTITY::GET_ENTITY_SPEED(iLocal_92) > 5f){
...
var func__308(int iParam0){
return MISC::IS_BIT_SET(Global_113644, iParam0);
}
...
if(func_1(iLocal_92)){
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_92, "RE_CHASE_THIEVES_BIKE", 0);
...
var func__310(int iParam0, bool bParam1, int iParam2){
iParam2=iParam2;
return func_311(iParam0, bParam1, 145);
}


var func__311(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
if(ENTITY::IS_ENTITY_A_VEHICLE(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_297(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
if(!bParam2){
...
if(bLocal_203==1){
Var0={
18.22177f, -141.8601f, 65.03339f 
};
Var3={
212.9326f, -210.4915f, 46.54869f 
};
fVar6=167.5f;
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, fVar6, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_204, 20f, 20f, 20f, 0, 1, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(Var0, Var3, fVar6, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var3, fVar6, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_82)){
return 1;
}}elseif(bLocal_203==2){
Var0={
445.474f, -851.1226f, 26.59859f 
};
Var3={
211.7756f, -850.9274f, 39.31448f 
};
fVar6=100f;
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, fVar6, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_207, 20f, 20f, 20f, 0, 1, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(Var0, Var3, fVar6, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var3, fVar6, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_82)){
return 1;
}}elseif(bLocal_203==3){
Var0={
1665.565f, 4932.071f, 51.11494f 
};
Var3={
1695.932f, 4731.498f, 34.67516f 
};
fVar6=96.75f;
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, fVar6, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_177, 20f, 20f, 20f, 0, 1, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(Var0, Var3, fVar6, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var3, fVar6, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_82)){
return 1;
}}elseif(bLocal_203==4){
Var0={
1322.306f, 2690.29f, 46.55696f 
};
Var3={
1092.25f, 2690.501f, 31.29549f 
};
fVar6=197.25f;
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var3, fVar6, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_177, 20f, 20f, 20f, 0, 1, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(Var0, Var3, fVar6, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var3, fVar6, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_82)){
return 1;
...
struct<3> Var3[2];
float fVar10[2];
MISC::CLEAR_AREA(Local_88, 20f, 1, 0, 0, 0);
iLocal_87=PED::CREATE_PED(26, iLocal_223, Local_88, fLocal_91, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_87, 1, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_87, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_87, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_87, 128, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_87, 285, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_87, "S_M_Y_BusBoy_01_WHITE_MINI_01");
if(!func_89(Local_182)){
iLocal_181=VEHICLE::CREATE_VEHICLE(iLocal_225, Local_182, fLocal_185, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_181, 1084227584);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_181, 0);
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_87, 1, 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_87, 0);
PED::SET_PED_MONEY(iLocal_87, 0);
PED::SET_PED_LOD_MULTIPLIER(iLocal_87, 1.5f);
iLocal_82=PED::CREATE_PED(26, iLocal_222, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_87, Local_243), fLocal_86, 1, 1);
iLocal_92=VEHICLE::CREATE_VEHICLE(iLocal_224, Local_93, fLocal_96, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_92, 1084227584);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_224, 1);
VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_92, 1);
VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_92, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_92, 1, 1, 0);
PED::ADD_RELATIONSHIP_GROUP("re_chasethieves badGuys", &uLocal_578);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_578, joaat("player"));
switch (bLocal_203){
case 1:
iLocal_83=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, -1, 1, 1);
...
case 2:
iLocal_83=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_83, joaat("weapon_sawnoffshotgun"), -1, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_82, joaat("weapon_pistol"), -1, 0, 1);
func_336(iLocal_83);
func_336(iLocal_82);
break;
...
iLocal_84=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, 1, 1, 1);
iLocal_85=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 22, iLocal_222, 2, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_84, joaat("weapon_pistol"), -1, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_85, joaat("weapon_pistol"), -1, 0, 1);
func_336(iLocal_84);
func_336(iLocal_85);
}
break;
...
if(bLocal_203==2){}else{
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_92, 1, 0, 0);
}
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_82, PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_580, sLocal_582, Local_231, Local_234, 0, 2), 0, 0, 1);
Local_237={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_580, sLocal_582, Local_231, Local_234, 0, 2) 
};
ENTITY::SET_ENTITY_HEADING(iLocal_82, Local_237.f_2);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_87, PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_580, sLocal_581, Local_231, Local_234, 0, 2), 0, 0, 1);
Local_237={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_580, sLocal_581, Local_231, Local_234, 0, 2) 
};
ENTITY::SET_ENTITY_HEADING(iLocal_87, Local_237.f_2);
TASK::TASK_PLAY_ANIM(iLocal_82, sLocal_580, sLocal_582, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(iLocal_87, sLocal_580, sLocal_581, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
if(bLocal_203==2){
PED::GIVE_PED_HELMET(iLocal_82, 1, 4096, -1);
Var3[0 /*3*/]={
...
iLocal_188=0;
while (iLocal_188 <=1){
uVar0[iLocal_188]=VEHICLE::CREATE_VEHICLE(iLocal_224, Var3[iLocal_188 /*3*/], fVar10[iLocal_188], 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uVar0[iLocal_188], 1084227584);
iLocal_188++;
}}
if(bLocal_203==3){
uLocal_187=PED::ADD_SCENARIO_BLOCKING_AREA(1608.8f, 4824.81f, 0f, 1730.9f, 4856.1f, 51.1f, 0, 1, 1, 1);
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iParam0, uLocal_578);
...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_56) < (75f * 75f)){
return 1;
}
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_330()){
return 0;
...
Local_177={
1663.009f, 4827.769f, 41.1046f 
};
Local_182={
1653.974f, 4826.029f, 41.0037f 
};
...
fLocal_86=84.7987f;
Local_88={
1218.718f, 2715.338f, 37.0041f 
};
fLocal_91=148.661f;
Local_93={
1207.095f, 2694.214f, 36.7963f 
};
fLocal_96=226.0923f;
Local_177={
1213.264f, 2690.394f, 36.5998f 
};
Local_182={
1207.287f, 2706.879f, 37.0047f 
};
fLocal_185=179.416f;
Local_231={
1201.656f, 2696.762f, 36.9226f 
};
Local_234={
0f, 0f, 42.7858f 
};
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_391()) || Global_112695) || Global_32166) || func_390()) || func_25(8, -1)) || func_389()) || func_388()) || func_387()) || func_386()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_391()) || Global_32166) || func_390()) || func_25(8, -1)) || func_387()) || func_389()) || func_388()) || func_386()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_391()) || Global_112695) || Global_32166) || func_390()) || func_25(8, -1)) || func_387()) || func_389()) || func_388()) || func_386()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_391()) || Global_112695) || Global_32166) || func_390()) || func_25(8, -1)) || func_389()) || func_388()) || func_386()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_391()) || Global_32166) || func_390()) || func_25(8, -1)) || func_388()) || func_387()) || func_386()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_391()) || func_388()) || Global_112695) || Global_32166) || func_390()) || Global_44446) || func_25(8, -1)) || func_387()) || func_385()) || func_386()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_391()) || Global_112695) || Global_32166) || func_390()) || func_25(8, -1)) || func_387()) || func_385()) || func_389()) || func_388()) || func_386()){
return 0;
}
break;
}}else{
...
float fVar0;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_204, 1);
bLocal_203=true;
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_207, 1) < fVar0){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_207, 1);
bLocal_203=2;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_210, 1) < fVar0){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_210, 1);
bLocal_203=3;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_213, 1) < fVar0){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_213, 1);
bLocal_203=4;
}
if(bLocal_203==1){
return Local_204;
...
void func_401(){
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_187, 0);
...
PED::SET_PED_CAN_BE_TARGETTED(iLocal_87, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_87, 1);
...
TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_87, "WORLD_HUMAN_STAND_MOBILE", 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_87, 0, 0);
}
PED::SET_PED_KEEP_TASK(iLocal_87, 1);
}
func_309(0);
