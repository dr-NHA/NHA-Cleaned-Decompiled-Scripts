...
case 1:
if(!iLocal_99){
if((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, 0, 1, 0) && CAM::IS_SPHERE_VISIBLE(Local_106, 1f)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_106, 20f, 20f, 20f, 0, 1, 0)){
func_149();
func_140(1);
iLocal_99=1;
}}else{
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_106, 50f, 50f, 50f, 0, 1, 0)){
func_138();
}
if(!PED::IS_PED_INJURED(iLocal_58)){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_58, Local_63, 30f, 30f, 30f, 0, 1, 0)){
iLocal_49=11;
}
}}
break;
...
if(!iLocal_89){
if(func_52()){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_112, 23f, 60f, 20f, 0, 1, 0)){
func_57(0);
func_55();
SYSTEM::WAIT(0);
if(!func_155()){
...
if(!PED::IS_PED_INJURED(iLocal_58)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_58, Local_118, 5f, 5f, 5f, 0, 1, 0)){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[8], iLocal_58, PED::GET_PED_BONE_INDEX(iLocal_58, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1, 0);
}
func_46(0);
SYSTEM::WAIT(0);
func_55();
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 1, 1);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_152, joaat("player"));
if(bLocal_59){
...
if((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_63, 80f, 80f, 80f, 0, 1, 0) || OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_133)) || !(ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]) && !OBJECT::DOES_PICKUP_EXIST(uLocal_133))){
func_226();
}}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_50(iParam3), 0);
}
...
iLocal_71=0;
}}}elseif((!iLocal_71 && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && !func_62()){
Local_78={
func_61() 
};
Local_72={
...
var func__69(int iParam0, int iParam1){
...
if(iLocal_68 > 18){
iLocal_70++;
}elseif(!PED::IS_PED_INJURED(iLocal_58)){
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_112, 10f, 10f, 10f, 0, 1, 0)){
HUD::CLEAR_ALL_HELP_MESSAGES();
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_58)){
if(!PED::IS_PED_INJURED(iLocal_58)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_58, Local_112, Global_19, 1, 1, 0) && func_115(1, 0, 1)){
...
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_58, 0)){
VEHICLE::BRING_VEHICLE_TO_HALT(PED::GET_VEHICLE_PED_IS_IN(iLocal_58, 0), 10.5f, 3, 0);
iLocal_70++;
}
else{
iLocal_70=4;
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_58, uLocal_95);
...
var func__92(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_8();
}
...
iLocal_85=1;
}}elseif(!PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())){
iLocal_85=0;
}
if(!iLocal_86){
...
if(!PED::IS_PED_INJURED(iLocal_58)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_58, Local_115, 200f, 200f, 200f, 0, 1, 0)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_58, Local_115, 1f, -1, 0.25f, 0, 1193033728);
}else{
...
if((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_58, 0)) && !PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID())){
if(!HUD::DOES_BLIP_EXIST(uLocal_102[0])){
...
HUD::SET_BLIP_SPRITE(uLocal_101, 269);
func_120();
}}}}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_102[0])){
uLocal_102[0]=func_123(iLocal_58, 0, 145);
...
var func__121(struct<3> Param0, int iParam3){
var uVar0;
...
var func__123(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
TASK::TASK_GO_TO_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
}
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_58, 0)){
...
}}}elseif(!PED::IS_PED_IN_GROUP(iLocal_58)){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_121[8], 1) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_133(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_121[8], 1)));
...
iLocal_69=7;
}}elseif(SYSTEM::TIMERB() > 10000 || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_121[8], 1), 1.5f, 1.5f, 3f, 0, 1, 0)){
...
var func__133(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5){
...
TASK::TASK_PLAY_ANIM(iLocal_58, "random@domestic", "balcony_fight_male", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
TASK::TASK_PLAY_ANIM(iLocal_57, "random@domestic", "balcony_fight_female", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
iLocal_68++;
}}}}
break;
case 1:
if(!PED::IS_PED_INJURED(iLocal_57) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[8])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[8], iLocal_57, PED::GET_PED_BONE_INDEX(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
iLocal_68++;
}
break;
case 2:
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[9], iLocal_57, PED::GET_PED_BONE_INDEX(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
iLocal_68++;
}}}
break;
case 5:
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_121[10], iLocal_57, PED::GET_PED_BONE_INDEX(iLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
iLocal_68++;
}}}
break;
case 9:
...
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_57, Local_109, 1f, 1f, 5f, 0, 1, 0) && ENTITY::IS_ENTITY_OCCLUDED(iLocal_57)){
...
if(!PED::IS_PED_INJURED(iLocal_58)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 6f, 4f, 5f, 0, 1, 0) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 12f, 12f, 5f, 0, 1, 2) && PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()))){
TASK::CLEAR_PED_TASKS(iLocal_58);
func_139();
if(iLocal_68 > 18){
iLocal_49=3;
...
if(HUD::DOES_BLIP_EXIST(uLocal_102[0])){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_102[0], 1);
}
TASK::CLEAR_PED_TASKS(iLocal_58);
func_139();
if(iLocal_68 > 18){
...
if(!PED::IS_PED_INJURED(iLocal_57)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
TASK::TASK_GO_STRAIGHT_TO_COORD(0, Local_109, 1f, -1, 1193033728, 1056964608);
TASK::TASK_PLAY_ANIM(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_95);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57, uLocal_95);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
...
if(!HUD::DOES_BLIP_EXIST(uLocal_102[0])){
uLocal_102[0]=func_123(iLocal_58, 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_102[0], 0);
}}
...
func_4(43, 1);
func_4(44, 1);
MISC::CLEAR_AREA(Local_63, 2f, 1, 0, 0, 0);
MISC::CLEAR_AREA(Local_60, 2f, 1, 0, 0, 0);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 0, 1);
PATHFIND::SET_ROADS_IN_ANGLED_AREA(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, 0, 0, 1);
PED::ADD_SCENARIO_BLOCKING_AREA(Local_63 - Vector(10f, 10f, 10f), Local_63 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
PED::ADD_SCENARIO_BLOCKING_AREA(Local_112 - Vector(3f, 2f, 2f), Local_112 + Vector(3f, 2f, 2f), 0, 1, 1, 1);
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_152, joaat("player"));
iLocal_57=PED::CREATE_PED(26, iLocal_96, Local_60, fLocal_66, 1, 1);
...
TASK::TASK_PLAY_ANIM(iLocal_57, "random@domestic", "balcony_fight_idle_female", 8f, -4f, -1, 1, 0, 0, 0, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_57, uLocal_152);
func_153(iLocal_57, "GENERIC_WHATEVER", 24);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_96);
PED::SET_PED_CONFIG_FLAG(iLocal_57, 185, 1);
iLocal_58=PED::CREATE_PED(26, iLocal_97, Local_63, fLocal_67, 1, 1);
...
TASK::TASK_PLAY_ANIM(iLocal_58, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0, 0, 0, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_58, uLocal_152);
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_50(iParam2), 1);
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_58)){
if(func_159(iLocal_58) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), 1)){
func_157();
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_57)){
if(func_159(iLocal_57) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), 1)){
func_157();
}}
if(!PED::IS_PED_INJURED(iLocal_58)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 250f, 250f, 250f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_WATER(iLocal_58)){
iLocal_49=11;
}}
if(PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())){
func_157();
...
if(!PED::IS_PED_INJURED(iLocal_58)){
TASK::CLEAR_PED_TASKS(iLocal_58);
TASK::TASK_SMART_FLEE_COORD(iLocal_58, ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1), 150f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_58, 1);
}
iLocal_49=11;
}
...
Local_60={
-472.6554f, 536.469f, 123.3555f 
};
fLocal_66=348.9152f;
Local_63={
-470.1328f, 542.9949f, 119.6873f 
};
fLocal_67=156.0666f;
Local_109={
-469.082f, 535.0479f, 123.3553f 
};
Local_112={
-1378.273f, 40.2254f, 52.6774f 
};
Local_115={
-1368.188f, 57.2309f, 52.7045f 
};
bLocal_59=true;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_77(8, -1)) || func_215()) || func_214()) || func_213()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_217()) || Global_32166) || func_216()) || func_77(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_77(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_77(8, -1)) || func_215()) || func_214()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_217()) || Global_32166) || func_216()) || func_77(8, -1)) || func_214()) || func_213()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_217()) || func_214()) || Global_112695) || Global_32166) || func_216()) || Global_44446) || func_77(8, -1)) || func_213()) || func_211()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_77(8, -1)) || func_213()) || func_211()) || func_215()) || func_214()) || func_212()){
return 0;
}
break;
}}else{
