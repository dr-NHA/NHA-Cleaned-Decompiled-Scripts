...
Local_197={
-1335.314f, -1277.943f, 3.8649f 
};
Local_200={
-1336.378f, -1279.056f, 3.855f 
};
iLocal_205=-1;
sLocal_212="FBIPRAU";
...
iLocal_81=2;
}elseif(!func_93(PLAYER::PLAYER_PED_ID(), Local_197, 75f, 1)){
if(!iLocal_207){
func_22(&uLocal_192);
iLocal_207=1;
}
func_84(&uLocal_192, Local_200, 1, 1, "PRD_SHOP");
}elseif(func_93(PLAYER::PLAYER_PED_ID(), Local_200, 12f, 1)){
if(iLocal_207){
func_22(&uLocal_192);
iLocal_207=0;
}
...
HUD::SET_BLIP_COLOUR(uLocal_192, 2);
HUD::SET_BLIP_ROUTE_COLOUR(uLocal_192, 2);
}}}
break;
case 2:
...
return 1;
}elseif(func_139(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_177(iParam0, 0, 0)) || func_177(iParam0, 1, 0)) || func_177(iParam0, 2, 0)) || func_176(iParam0) !=145) || func_175(iParam0)) || func_174(iParam0)) || func_122(iParam0)) || func_173(iParam0)) || !func_161(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_174(iParam0)){
}
if(func_174(iParam0)){
}
...
}elseif(func_187(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
}elseif((!func_206(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_207(iParam0, uVar1[iVar6], 1) && func_98(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_202(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_157(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_157(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_157(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_157(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_157(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_157(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_216(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_215()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_157(iVar7 + 1))){
...
}elseif(Global_113648.f_2365.f_539.f_2395[1]==-99){
func_247(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
}elseif(Global_113648.f_2365.f_539.f_2395[2]==-99){
...
func_247(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
}elseif(Global_113648.f_2365.f_539.f_2395[0]==-99){
func_247(sLocal_208[0], sLocal_208[1], sLocal_208[2]);
}elseif(Global_113648.f_2365.f_539.f_2395[2]==-99){
func_247(sLocal_208[2], sLocal_208[1], sLocal_208[0]);
}
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_258() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_258() /*5568*/].f_681.f_10, iParam0);
}


var func__263(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_32();
}
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 10, -1, 0, -1, func_300(iParam0));
if(iVar57 > iVar56){
...
if(CAM::DOES_CAM_EXIST(uLocal_193)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_193, 0);
}}
