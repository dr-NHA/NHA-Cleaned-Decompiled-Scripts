...
uLocal_197={
-1335.3142f, -1277.9427f, 3.8649f 
};
uLocal_200={
-1336.3777f, -1279.0555f, 3.855f 
};
iLocal_205=-1;
sLocal_212="FBIPRAU";
MISC::SET_MISSION_FLAG(true);
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_DEAD(PLAYER::PLAYER_ID())) PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
...
func_355();
func_286();
if(_IS_MISSION_REPLAY_IN_PROGRESS()) func_284(-1339.7863f, -1277.5099f, 3.8874f, 261.2839f, 1, 0);
...
if(iLocal_80 !=3) iLocal_80 >=0 && !bLocal_28;
}
SYSTEM::WAIT(0);
}
return;
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_187)) func_19(sLocal_187);
...
if(func_14(character)) return func_17(character);
...
if(func_86("PRD_BUYM", 0, 0) || func_86("PRD_BUYT", 0, 0) || func_86("PRD_BUYF", 0, 0)) HUD::CLEAR_PRINTS();
if(bLocal_190){
iLocal_204=MISC::GET_GAME_TIMER();
iLocal_81=2;
}elseif(!func_93(PLAYER::PLAYER_PED_ID(), uLocal_197, 75f, true)){
if(!bLocal_207){
func_22(&blLocal_192);
bLocal_207=true;
}
func_84(&blLocal_192, uLocal_200, true, true, "PRD_SHOP");
}elseif(func_93(PLAYER::PLAYER_PED_ID(), uLocal_200, 12f, true)){
if(bLocal_207){
func_22(&blLocal_192);
bLocal_207=false;
}
...
func_42(false, -1);
if(Global_113648.f_2365.f_539.f_2395[0]==38 && Global_113648.f_2365.f_539.f_2395[1]==33 && Global_113648.f_2365.f_539.f_2395[2]==54) func_41(821);
func_38();
}}
break;
case 3:
...
if(func_250(PLAYER::PLAYER_PED_ID())) PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), false, 0);
return;
}
...
if(!func_49()){
if(!func_45(0)){
if(!func_81(3) && func_82()) func_44(50, 0);
return true;
}}
break;
case 4:
...
i=i + 1){
ped=func_57(i);
if(!PED::IS_PED_INJURED(ped))if(func_56(ped, 0)) return;
}
...
if(func_64(PLAYER::PLAYER_ID())) return false;
...
if(bParam0) func_51(1527885205, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 0, -1, 0);
elseif(!func_81(3)) func_51(-224691627, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 50, -1, 0);
else func_51(-224691627, 0, _GET_CURRENT_PLAYER_CHARACTER(), CHAR_STEVE, 3, 6000, 6000, -1, 0, -1, 0);
return;
}
BOOL func_80() // Position - 0x2C52{
if(func_81(41) && func_81(3) && func_81(21)) return true;
return false;
}
...
i <=37;
i=i + 1){
if(func_81(i)) num=num + 1;
}
if(func_83(45)) num=num + 1;
...
if(bParam5) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, sParam6);
}
return;
}
...
elseif(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(func_92()==0) return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_91(iParam0), -1, 0), iParam1);
...
if(func_250(pedParam0)) TASK::CLEAR_PED_TASKS(pedParam0);
...
switch (iParam0){
case 0:
if(func_98(uParam1, uLocal_194, 1056964608, false) && iParam4==0f) return true;
break;
case 1:
HUD::REQUEST_ADDITIONAL_TEXT(sLocal_188, 0);
HUD::REQUEST_ADDITIONAL_TEXT(sLocal_212, 6);
if(HUD::HAS_ADDITIONAL_TEXT_LOADED(0) && HUD::HAS_ADDITIONAL_TEXT_LOADED(6)) return true;
break;
}
return false;
}
...
switch (iLocal_81){
case 0:
if(func_94(iLocal_80, bLocal_28)) iLocal_81=1;
break;
case 1:
if(!bLocal_203){
...
if(!bParam0) iLocal_80=iLocal_186 + 1;
elseif(iLocal_186 > 0) iLocal_80=iLocal_186 - 1;
iLocal_189=0;
iLocal_81=0;
return;
}
...
int num;
num=1;
if(!_IS_MISSION_REPLAY_IN_PROGRESS() || !func_234()) num=0;
if(num==1)if(!func_231(iParam6, iParam7, iParam8, iParam13)) num=0;
if(num==1){
func_229();
while (!func_228()){
SYSTEM::WAIT(0);
...
if(echParam1==CHAR_TREVOR)if(ENTITY::GET_ENTITY_MODEL(*uParam0)==joaat("bodhi2")) func_180(uParam0);
...
if(ENTITY::GET_ENTITY_MODEL(*uParam0)==joaat("bodhi2")) func_180(uParam0);
...
if(flag) func_179(*uParam0, echParam1);
return true;
}}}
return false;
}
...
if(!func_153(entityModel, bParam1, uParam2) && !func_152(PLAYER::PLAYER_ID()) && !func_133(veParam0)) return false;
if(func_152(PLAYER::PLAYER_ID()))if(func_131(entityModel)) return true;
else return false;
flag=false;
if(func_130(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(entityModel) || VEHICLE::IS_THIS_MODEL_A_PLANE(entityModel)) flag=true;
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==11;
return false;
}
...
case joaat("monster4"):
case joaat("monster5"):
if(func_129(PLAYER::PLAYER_ID())) return true;
break;
case joaat("minitank"):
case joaat("burrito2"):
return true;
case -1576586413:
if(func_128(PLAYER::PLAYER_ID())) return true;
break;
case -1627077503:
return true;
}
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==26;
return false;
}
BOOL func_129(Player plParam0) // Position - 0x7568{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==13;
return false;
}
BOOL func_130(Player plParam0) // Position - 0x75AF{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==7;
return false;
}
BOOL func_131(Hash hParam0) // Position - 0x75F5{
if(hParam0==joaat("oppressor2")) return false;
if(!func_132(PLAYER::PLAYER_ID()) && hParam0 !=joaat("thruster") && hParam0 !=joaat("avenger")) return false;
return true;
}
...
if(func_151(PLAYER::PLAYER_ID()) || func_150(PLAYER::PLAYER_ID()))if(func_134(veParam0)) return true;
return false;
}
...
if(func_138(veParam0, false)) return true;
if(func_137(PLAYER::PLAYER_ID()) && !func_131(ENTITY::GET_ENTITY_MODEL(veParam0)) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("thruster"))) return false;
if(DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))if(DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle")==NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))if(!func_135(veParam0)) return true;
return false;
}
...
entityModel=ENTITY::GET_ENTITY_MODEL(veParam0);
if(VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_127(veParam0) || func_136(entityModel)) return true;
switch (entityModel){
...
if(func_152(plParam0) && Global_2657589[plParam0 /*466*/].f_321.f_10==plParam0) return true;
return false;
}
...
if(func_140(ENTITY::GET_ENTITY_MODEL(veParam0), 0))if(Global_2793044.f_304==veParam0) return true;
elseif(func_139(veParam0) !=-1 && !bParam1) return true;
break;
}
return false;
}
...
if(iParam1==0)if(func_149(hParam0, 0)) return true;
switch (hParam0){
case joaat("faction"):
...
return func_148();
case joaat("sabregt"):
if(Global_262145.f_14734) return func_147();
break;
case joaat("tornado"):
case joaat("tornado2"):
case joaat("tornado3"):
if(Global_262145.f_14735) return func_147();
break;
case joaat("virgo3"):
if(Global_262145.f_14733) return func_147();
break;
case joaat("minivan"):
if(Global_262145.f_14736) return func_147();
break;
case joaat("slamvan"):
if(Global_262145.f_14738) return func_147();
break;
case joaat("sultan"):
case joaat("banshee"):
return func_146();
case joaat("comet2"):
if(Global_262145.f_19141) return func_145();
break;
case joaat("diablous"):
if(Global_262145.f_19143) return func_145();
break;
case joaat("fcr"):
if(Global_262145.f_19147) return func_145();
break;
case joaat("elegy2"):
if(Global_262145.f_19144) return func_145();
break;
case joaat("nero"):
if(Global_262145.f_19151) return func_145();
break;
case joaat("italigtb"):
if(Global_262145.f_19149) return func_145();
break;
case joaat("specter"):
if(Global_262145.f_19154) return func_145();
break;
case joaat("technical"):
if(Global_262145.f_21100) return func_144();
break;
case joaat("insurgent"):
if(Global_262145.f_21101) return func_144();
break;
case joaat("ratloader"):
case joaat("ratloader2"):
return func_143();
case joaat("glendale"):
if(func_143() || func_142()) return true;
break;
case joaat("impaler"):
return func_143();
case joaat("issi3"):
...
return func_143();
case joaat("youga2"):
if(Global_262145.f_29332) return func_142();
break;
case joaat("gauntlet3"):
if(Global_262145.f_29682) return func_142();
break;
case joaat("manana"):
if(Global_262145.f_29331) return func_142();
break;
case joaat("peyote"):
if(Global_262145.f_29681) return func_142();
break;
case joaat("yosemite"):
if(Global_262145.f_29680) return func_142();
break;
}
switch (hParam0){
case joaat("tenf"):
if(*Global_262145.f_33139) return func_141();
break;
case joaat("weevil"):
if(*Global_262145.f_33138) return func_141();
break;
case joaat("brioso2"):
if(*Global_262145.f_33131) return func_141();
break;
case joaat("sentinel3"):
if(*Global_262145.f_33140) return func_141();
break;
}
return false;
}
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1 && Global_2657589[plParam0 /*466*/].f_321.f_10 !=_INVALID_PLAYER_INDEX()) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==5;
return false;
}
BOOL func_151(Player plParam0) // Position - 0x8215{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1 && Global_2657589[plParam0 /*466*/].f_321.f_10 !=_INVALID_PLAYER_INDEX()) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==8;
return false;
}
BOOL func_152(Player plParam0) // Position - 0x8275{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==9;
return false;
}
...
flag=false;
if(func_130(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(hParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(hParam0)) flag=true;
...
if(uParam1->f_65==-1 && !func_158(uParam1->f_66)) uParam1->f_65=0;
...
i <=11;
i=i + 1){
if(VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1)) MISC::SET_BIT(&(uParam1->f_77), func_157(i + 1));
}
...
if(!func_162(hParam0, false, -1)) return false;
...
if(hParam0==joaat("blimp"))if(!func_171() && !func_170() && !func_169() && !func_168() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_167() || MISC::IS_PC_VERSION() || func_166()){
}elseif(!func_169()){
return false;
}}
if(bParam1)if(!func_165(hParam0, iParam2)) return false;
if(!func_163(hParam0)) return false;
return true;
}
...
if(!func_162(entityModel, false, -1)) return true;
return false;
}
...
for (i=0;
func_178(iParam1, i, &garageName, &num);
i=i + 1){
...
if(!func_181(*uParam0)) VEHICLE::SET_VEHICLE_EXTRA(*uParam0, 5, !Global_113648.f_9087.f_99.f_58[119]);
return;
}
...
}elseif(func_187(*uParam0, modType, uParam1->[i] - 1)){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, modType, uParam1->[i] - 1, false);
}}}}
if(func_149(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_185(*uParam0, uParam1->[38] - 1)) VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_185(*uParam0, uParam1->[38] - 1), false);
func_184(uParam0);
if(func_183(*uParam0)){
...
i >=0 && func_187(veParam0, iParam1, i);
i=i - 1){}
return i;
}
BOOL func_187(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xD203{
if(!func_188() && PED::APPLY_PED_BLOOD_SPECIFIC(veParam0, iParam1, iParam2)) return true;
return false;
}
...
i < 68;
i=i + 1){
if(func_201(&Global_77348.f_555[0 /*21*/], i))if(MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_77348.f_555[0 /*21*/], bParam4) <=fParam3) func_194(i);
}
return;
}
...
if(iParam0 < 0 || iParam0 >=func_199(&Global_113648.f_32751.f_5038[num /*157*/])) return false;
...
if(!func_202(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false)) *uParam0={
...
if(uParam0->f_7==1){
if(bParam5)if(VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(vehicle))) func_191(uParam0->f_11, 1);
elseif(VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(vehicle))) func_191(uParam0->f_11, 2);
...
}elseif(!func_206(vehicle, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(uParam0->f_9==1) func_155(vehicle, uParam0->f_11);
...
if(uParam1->f_69 > -1 && uParam1->f_69 < 255)if(!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(uParam1->f_69==6) func_214(veParam0, uParam1->f_69);
else func_214(veParam0, uParam1->f_69);
...
if(bParam3) func_182(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
if(!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66)){
for (n=0;
n <=11;
n=n + 1){
if(IS_BIT_SET(uParam1->f_77, func_157(n + 1)))if(!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, n + 1)) VEHICLE::SET_VEHICLE_EXTRA(veParam0, n + 1, false);
...
if(func_209() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")))if(!IS_BIT_SET(uParam1->f_77, 23))if(IS_BIT_SET(uParam1->f_77, 22)) VEHICLE::CONTROL_LANDING_GEAR(veParam0, 2);
...
if(func_212(7))if(func_211(Global_2672505.f_4.f_16) || func_210(Global_2672505.f_4.f_16)) return false;
return true;
}
...
int num;
num=iParam0;
if(num !=-1) return func_65(iParam0, 9);
return false;
}
...
if(!func_188() && func_218(uParam0)) return 1;
return 0;
}
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false)) return false;
if(func_221(PLAYER::PLAYER_ID())==3)if(ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(func_220(veParam0) !=-1) return true;
return false;
}
...
if(func_224(plParam0)==233) return func_222(plParam0);
return -1;
}

int func_222(Player plParam0) // Position - 0x100A3{
if(func_223(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_182;
return -1;
}
...
if(func_223(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_33;
return -1;
}
...
if(!func_162(uParam0->f_12.f_66, false, -1)) return 0;
if(uParam0->f_12.f_66==joaat("stunt") && func_98(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false)) return 0;
return 1;
}
...
if(func_227(uParam0)) STREAMING::REQUEST_MODEL(uParam0->f_12.f_66);
return;
}
...
if(iLocal_80 > 0){
if(!bLocal_190){
if(!func_110(21)) func_243(1);
if(func_242(21)) func_243(1);
...
int num;
num=150;
if(iLocal_191==1) num=100;
elseif(iLocal_191==2) num=50;
if(!func_239(bLocal_190, num) && !bLocal_190) return false;
return true;
}
...
if(func_240(num, iParam1) < 0) return false;
}
return true;
}
...
switch (_GET_CURRENT_PLAYER_CHARACTER()){
case CHAR_MICHAEL:
if(Global_113648.f_2365.f_539.f_2395[0]==-99) func_247(uLocal_208[0], uLocal_208[1], uLocal_208[2]);
elseif(Global_113648.f_2365.f_539.f_2395[1]==-99) func_247(uLocal_208[1], uLocal_208[0], uLocal_208[2]);
elseif(Global_113648.f_2365.f_539.f_2395[2]==-99) func_247(uLocal_208[2], uLocal_208[1], uLocal_208[0]);
break;
case CHAR_FRANKLIN:
if(Global_113648.f_2365.f_539.f_2395[1]==-99) func_247(uLocal_208[1], uLocal_208[0], uLocal_208[2]);
elseif(Global_113648.f_2365.f_539.f_2395[0]==-99) func_247(uLocal_208[0], uLocal_208[1], uLocal_208[2]);
elseif(Global_113648.f_2365.f_539.f_2395[2]==-99) func_247(uLocal_208[2], uLocal_208[1], uLocal_208[0]);
break;
case CHAR_TREVOR:
if(Global_113648.f_2365.f_539.f_2395[2]==-99) func_247(uLocal_208[2], uLocal_208[1], uLocal_208[0]);
elseif(Global_113648.f_2365.f_539.f_2395[0]==-99) func_247(uLocal_208[0], uLocal_208[1], uLocal_208[2]);
elseif(Global_113648.f_2365.f_539.f_2395[1]==-99) func_247(uLocal_208[1], uLocal_208[0], uLocal_208[2]);
break;
}}
...
if(func_86(sParam1, 0, 0) || func_86(sParam2, 0, 0)) HUD::CLEAR_PRINTS();
if(!func_86(sParam0, 0, 0)) _SHOW_SUBTITLE_CLEAR_EXISTING(sParam0, 60000, 0);
return;
}
...
i <=2;
i=i + 1){
if(Global_113648.f_2365.f_539.f_2395[i] !=-99) num=num + 1;
}
return num;
}
...
if(func_241(num) < 1500) func_252(_GET_CURRENT_PLAYER_CHARACTER(), 96, 1500, false, false);
return;
}
...
int outValue;
Hash statHash;
if(func_282(echParam0)==3) return;
if(func_282(echParam0)==4) return;
...
func_255(iParam0);
if(Global_43257==15) func_254(false);
return 1;
}
...
}}elseif(IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_258() /*5568*/].f_681.f_10, iParam0)){
flag=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
int cloudTimeAsInt6;
int num6;
if(iParam0==8) return func_263(129, -1);
if(iParam0==9) return func_263(135, -1);
if(iParam0==10) return func_263(136, -1);
if(iParam0==11) return func_263(137, -1);
if(iParam0==12){
cloudTimeAsInt=NETWORK::GET_CLOUD_TIME_AS_INT();
...
if(func_13(14) && !func_277(iParam0)) return 0;
...
if(func_274(&Global_4542597, iParam0)) return 0;
if(func_267(&Global_4542597, iParam0)) return 1;
}else{
...
if(func_13(14) && !func_277(iParam1)) return false;
if(func_274(uParam0, iParam1)) return false;
if(func_273(uParam0) < 0f) func_272(uParam0, 0);
func_270(&unk);
i=0;
for (i=0;
i < *uParam0 - 1;
...
if(func_13(14) && !func_277(iParam1)) return 0;
if(func_274(uParam0, iParam1)) return 0;
if(func_273(uParam0) < 0f) func_272(uParam0, 0);
for (i=0;
i < *uParam0;
i=i + 1){
...
Global_78341[1 /*14*/]={
func_289(iParam0, iParam1, iParam2, -1) 
};
if(IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_78341[1 /*14*/].f_6, 6)){
if(bParam3) func_288(iParam1, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 0, Global_78341[1 /*14*/].f_1, 1, 0);
else func_288(iParam1, Global_78341[1 /*14*/].f_5, Global_78341[1 /*14*/].f_2, 0, Global_78341[1 /*14*/].f_1, 0, 1);
return 1;
}
return 0;
}
...
func_354();
if(iParam0==joaat("Player_Zero")) func_336(iParam1, iParam2);
elseif(iParam0==joaat("Player_One")) func_317(iParam1, iParam2);
elseif(iParam0==joaat("Player_Two")) func_290(iParam1, iParam2);
...
if(iParam1==12){
if(!func_296(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_296(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
}elseif(iParam1==13){
}elseif(iParam1==14){
if(!func_296(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_296(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
...
if(func_288(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 1);
if(func_288(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 2);
if(!func_288(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 4);
}else{
MISC::SET_BIT(&(iParam0->f_6), 0);
...
if(iParam0 < 136) func_314(iParam0);
else func_313(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_299(3, iParam0, 242, -1);
return;
}
...
if(iParam0 < 107) func_333(iParam0);
elseif(iParam0 < 227) func_332(iParam0);
else func_331(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_299(3, iParam0, 318, -1);
return;
}
...
if(iParam0 < 60) func_351(iParam0);
else func_350(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_299(3, iParam0, 181, -1);
return;
}
...
unk=8;
unk[0 /*3*/]={
344.0985f, -1605.1539f, 28.2928f 
};
unk[1 /*3*/]={
365.6985f, -1580.435f, 28.2928f 
};
unk[2 /*3*/]={
407.9943f, -1616.2589f, 28.2928f 
};
unk[3 /*3*/]={
387.3322f, -1641.2583f, 29.0912f 
};
func_357(&unk, 4);
return;
}
...
if(func_359(uParam1, uParam1->[num2 /*3*/] + num6)) num6={
-num6 
};
uParam0->[num2 /*3*/]={
uParam1->[num2 /*3*/] + (num6 *{
