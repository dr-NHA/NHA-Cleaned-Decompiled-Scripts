...
bVar0=false;
}elseif(!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_96)){
bVar0=false;
...
break;
case 8:
if(SYSTEM::VDIST2(Local_90, ENTITY::GET_ENTITY_COORDS(iLocal_96, 1)) < 25f && TASK::GET_SCRIPT_TASK_STATUS(iLocal_97, joaat("script_task_vehicle_drive_to_coord")) !=1){
...
return func_53();
}}elseif(ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("vstr")){
...
}elseif(!ENTITY::IS_ENTITY_DEAD(PED::GET_PEDS_JACKER(iParam0), 0)){
...
struct<3> Var3;
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_96, 1) 
};
Var3={
Local_90 
};
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_97, uLocal_101);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_101);
Local_90={
func_60(ENTITY::GET_ENTITY_COORDS(iLocal_96, 1)) 
};
...
Vector3 func__60(struct<3> Param0){
int iVar0;
int iVar1;
iVar0=0;
iVar1=0;
...
Vector3 func__61(int iParam0){
struct<3> Var0;
switch (iParam0){
case 0:
Var0={
-1449.075f, -634.0139f, 29.094f 
};
break;
case 1:
Var0={
-1266.291f, -1361.175f, 3.222f 
};
break;
case 2:
Var0={
...
case 5:
Var0={
-192.1116f, -1332.385f, 30.3304f 
};
break;
case 6:
Var0={
196.6188f, -1850.396f, 26.2005f 
};
break;
case 7:
Var0={
322.9744f, -1000.23f, 28.2401f 
};
break;
case 8:
Var0={
...
case 9:
Var0={
-1800.76f, -404.1213f, 43.8109f 
};
break;
case 10:
Var0={
1421.334f, -1618.83f, 58.3324f 
};
break;
case 11:
Var0={
...
case 13:
Var0={
1591.921f, 6516.841f, 16.3155f 
};
break;
case 14:
Var0={
1278.73f, 3624.059f, 32.0408f 
};
break;
case 15:
Var0={
2464.667f, 5526.815f, 44.2143f 
};
break;
case 16:
Var0={
2052.58f, 4637.477f, 39.642f 
};
break;
case 17:
Var0={
1435.608f, 4483.951f, 49.2513f 
};
break;
case 18:
Var0={
...
case 22:
Var0={
-1663.641f, 2477.778f, 30.9941f 
};
break;
case 23:
Var0={
-2505.643f, 3677.825f, 12.1719f 
};
break;
case 24:
Var0={
-2179.209f, 4264.236f, 47.9904f 
};
break;
case 25:
Var0={
-758.9616f, 5612.78f, 29.4536f 
};
break;
case 26:
Var0={
-276.8032f, 6327.188f, 31.4262f 
};
break;
case 27:
Var0={
1483.839f, 6366.199f, 22.6875f 
};
break;
case 28:
Var0={
949.013f, 3551.753f, 32.9687f 
};
break;
case 29:
Var0={
180.9372f, 3051.781f, 42.1131f 
};
break;
case 30:
Var0={
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_101);
TASK::TASK_PERFORM_SEQUENCE(iLocal_96, uLocal_101);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_101);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_96, uVar0);
...
if(!TASK::DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(Var0, func_65(0), 20f, 1) && !TASK::DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(Var0, func_65(1), 20f, 1)){
if(bParam0){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_96, uVar1);
...
return PED::GET_PED_TEXTURE_VARIATION(uParam0, uVar0)==func_81(iParam1, iParam2);
}
...
return PED::GET_PED_DRAWABLE_VARIATION(uParam0, uVar0)==func_85(iParam1, iParam2);
}
...
Var7={
Var7 / Vector(2f, 2f, 2f) 
};
Var10={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_98, 0.2f, 0.2f, 0f) 
};
Var13={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_98, 0.2f, 0.2f, 0f) 
};
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_101);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var10.f_0, Var10.f_1, Var10.f_2, 1f, -1, 0.5f, 8192, 1193033728);
...
if(func_90(ENTITY::GET_ENTITY_COORDS(iLocal_97, 1), 1106247680)){
return;
}
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_96, 1) 
...
TASK::TASK_VEHICLE_PARK(iLocal_97, iLocal_98, Var0, 0f, 3, 360f, 1);
...
}}elseif(iLocal_296 !=0 && !func_470("PROS_NO_MONEY")){
func_64(0);
switch (func_23()){
case 0:
...
switch (iLocal_303){
case 0:
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_96) || func_121(&uLocal_107) > 4f){
func_116(iLocal_96);
...
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_101(1), 4f, -8f, -1, 0, 0, 0, 0, 0);
}
...
if(iLocal_72 > 0){
TASK::TASK_PLAY_ANIM(0, func_50(iParam0, 0, 0), func_101(0), 4f, -4f, -1, 0, 0, 0, 0, 0);
}
else{
TASK::TASK_PLAY_ANIM(0, func_50(iParam0, 0, 0), func_108(0), 4f, -4f, -1, 0, 0, 0, 0, 0);
}}
func_109(iParam0, 1);
}}
...
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(uParam0, PED::GET_VEHICLE_PED_IS_IN(uParam0, 0), 0, 0, 0)){
...
}elseif(((iVar0 > 333 && iVar0 <=666) && iLocal_306==0) || iLocal_306==1){
...
}elseif(iLocal_306==0 || iLocal_306==2){
...
if(bParam0){
Var0={
ENTITY::GET_ENTITY_ROTATION(iLocal_99, 2) 
};
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(180f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH((-5.5f - Var0.f_0), 1065353216);
}
...
var func__164(struct<3> Param0, struct<3> Param3, bool bParam6, int iParam7, int iParam8){
var uVar0;
if(func_551()){
if(bParam6){
iParam7=0;
...
var func__171(int iParam0, int iParam1){
var uVar0;
var uVar1;
...
var uVar0;
if(func_551()){
uVar0=PED::GET_SYNCHRONIZED_SCENE_PHASE(NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iParam0));
}else{
...
}elseif(!PED::IS_PED_IN_VEHICLE(iParam0, iLocal_99, 0)){
...
var func__185(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5){
...
Var9={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_99, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_99, "windscreen")) 
};
Var12={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_99, Var9) 
};
switch (iParam0){
case 0:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_99, 0f, (Var6.f_1 + 1.4f), Var12.f_2) 
};
break;
case 1:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_99, 1.5f, (Var6.f_1 + 1.2f), (Var12.f_2 - 0.1f)) 
};
break;
case 2:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_99, -3.7f, 0.7f, Var12.f_2) 
};
break;
case 3:
Var0={
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_99, Var0) 
};
...
func_528(512);
}}}elseif(ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_96, 876132797)){
PAD::SET_CONTROL_SHAKE(0, 200, 252);
ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_99, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
func_197();
}
...
var uVar0;
if(func_551()){
uVar0=PED::IS_SYNCHRONIZED_SCENE_RUNNING(NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iParam0));
}else{
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_222(), 1, 0, 0, 1);
...
void func_223(){
int iVar0;
if(func_225(&uLocal_104, 3f) && !CAM::IS_CAM_ACTIVE(uLocal_103)){
iVar0=SYSTEM::FLOOR(((func_224() - 2f) * 1000f));
CAM::SET_CAM_ACTIVE(uLocal_102, 0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_103, uLocal_102, iVar0, 1, 1);
}
...
VEHICLE::SET_VEHICLE_RESPECTS_LOCKS_WHEN_HAS_DRIVER(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1);
}}
}}}
...
if(((PAD::IS_CONTROL_JUST_PRESSED(2, 187) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 242))) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 33))) || (((MISC::IS_PC_VERSION() && !PAD::IS_USING_KEYBOARD_AND_MOUSE(2)) && iVar7 > 100) && (MISC::GET_GAME_TIMER() - iLocal_89) > 300)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
...
}elseif(((PAD::IS_CONTROL_JUST_PRESSED(2, 188) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 241))) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 32))) || (((MISC::IS_PC_VERSION() && !PAD::IS_USING_KEYBOARD_AND_MOUSE(2)) && iVar7 < -100) && (MISC::GET_GAME_TIMER() - iLocal_89) > 300)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
func_492("UP pressed!");
if(iLocal_70 > 0){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_254() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_254() /*5568*/].f_681.f_10, iParam0);
}


var func__257(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_140();
}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_5165), func_316(Global_23270.f_5165, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_4540953.f_67), func_316(Global_4540953.f_67, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
fVar51=(fVar51 + (((HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_319(26), func_316(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}}
}
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_319(27), func_316(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}}
}
}
iVar25=0;
...
if(iVar5==1){
if(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar28)]), func_316(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar28)]), func_316(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar14)]), func_316(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (Global_23267 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
elseif(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar14)]), func_316(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar14)]), func_316(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
}
}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[iVar22]), func_316(Global_23270.f_4824[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_297(Global_23270.f_4824[iVar22])), (fVar37 * func_297(Global_23270.f_4824[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
}
}}
bVar41=true;
...
var func__316(int iParam0, bool bParam1){
char* sVar0[2];
var uVar3;
struct<13> Var19;
...
int iVar0;
if(!STREAMING::HAS_ANIM_DICT_LOADED(func_50(PLAYER::PLAYER_PED_ID(), 0, 0))){}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_110(bParam1), 3) && TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("script_task_play_anim")) !=1){
if(func_551()){
if(iParam0==PLAYER::PLAYER_PED_ID()){
if(!func_205(PLAYER::PLAYER_ID())){
...
TASK::TASK_PLAY_ANIM(iParam0, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_110(bParam1), 8f, -2f, -1, 1, 0, 0, 0, 0);
}}
...
int func_370(){
if(func_371(0, -1, 0) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\HUD_321_GO", 1, -1)){
return 1;
}
return 0;
}
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_99, 1) 
};
...
}elseif(((ENTITY::GET_ENTITY_MODEL(iLocal_99)==joaat("casco") || ENTITY::GET_ENTITY_MODEL(iLocal_99)==joaat("feltzer3")) || ENTITY::GET_ENTITY_MODEL(iLocal_99)==joaat("fagaloa")) || ENTITY::GET_ENTITY_MODEL(iLocal_99)==joaat("warrener2")){
...
bool func_386(){
return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_388()) < (func_387() * func_387());
}
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_307, joaat("player"));
...
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &fVar6, 0, 0);
Var0.f_2=(fVar6 + 0.15f);
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_99, 0f, 0f, -2f) 
};
iLocal_100=SHAPETEST::START_SHAPE_TEST_CAPSULE(Var0, Var3, 2f, 511, iLocal_99, 7);
}elseif(SHAPETEST::GET_SHAPE_TEST_RESULT_INCLUDING_MATERIAL(iLocal_100, &iVar8, &uVar9, &uVar12, &iVar7, &uVar15)==2){
if(iVar8 !=0){
...
if(TASK::DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(Var1, func_65(0), 12f, 0) || TASK::DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(Var1, func_65(1), 12f, 0)){
return 0;
}
if(func_402()){
return 0;
...
if(func_90(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), (30f * 0.5f))){
return 0;
}
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_96, iLocal_99, 0, 0, 0)){
return 0;
}
...
return 1;
}}elseif(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Param0) > 56.25f){
return 1;
}}elseif(!PATHFIND::GET_VEHICLE_NODE_IS_SWITCHED_OFF(uVar0)){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Param0) > 400f){
return 1;
}}else{
...
struct<3> Var0[4];
Var0[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 2f, 0f, 0f) 
};
Var0[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, -2f, 0f, 0f) 
};
Var0[2 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, 2f, 0f) 
};
Var0[3 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, -2f, 0f) 
};
...
return 1;
}elseif(PATHFIND::GET_CLOSEST_MAJOR_VEHICLE_NODE(Var0[1 /*3*/], uParam1, 1077936128, 0)){
return 1;
}elseif(PATHFIND::GET_CLOSEST_MAJOR_VEHICLE_NODE(Var0[2 /*3*/], uParam1, 1077936128, 0)){
return 1;
}elseif(PATHFIND::GET_CLOSEST_MAJOR_VEHICLE_NODE(Var0[3 /*3*/], uParam1, 1077936128, 0)){
return 1;
}
return 0;
}
...
if(func_153()==0){
return MISC::IS_BIT_SET(func_141(func_407(iParam0), -1, 0), iParam1);
}}else{
...
void func_411(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_96, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_96, PLAYER::PLAYER_PED_ID(), 5f, 5f, 5f, 0, 1, 0) || func_491(iLocal_49, 8192)){
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_99, 0)){
iLocal_99=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
}elseif(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_96, iLocal_99, 0, 0, 0)){
if(!func_112()){
...
if(func_121(&uLocal_113) >=20f || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_96, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0)){
if(func_491(iLocal_75, 524288)){
func_115(&uLocal_113);
iLocal_295=6;
}elseif(func_437()){
...
func_69(iLocal_96);
if(((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_96, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0) || func_491(iLocal_75, 1)) && !func_217(0)) && !func_402()){
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_96, iLocal_99, 0, 0, 0)){
if(!func_112()){
if(!func_491(iLocal_75, 1)){
func_40(&uLocal_119);
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_96, joaat("script_task_enter_vehicle")) !=1 && !PED::IS_PED_IN_VEHICLE(iLocal_96, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1)){
...
if(func_551()){
if(VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0, 1) > 1){
return 0;
}}
if(bParam0){
...
if(func_90(ENTITY::GET_ENTITY_COORDS(iLocal_96, 1), 1106247680)){
...
Var0={
Var0 / Vector(2f, 2f, 2f) 
};
Var9={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_99, -(Var0.f_0 + 0.2f), 0f, 0f) 
};
Var12={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_99, (Var0.f_0 + 0.2f), 0f, 0f) 
};
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var9.f_0, Var9.f_1, Var9.f_2, 1f, -1, 1f, 8192, 1193033728);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_96, uVar18);
...
int func_489(){
if((!func_488() || !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) || func_491(iLocal_49, 4096)){
return 0;
}
if(func_491(iLocal_49, 32)){
iLocal_296=2;
...
TASK::TASK_CLEAR_LOOK_AT(iLocal_96);
TASK::TASK_LOOK_AT_ENTITY(iLocal_96, iParam0, -1, 2048, 4);
}}}elseif(PED::IS_PED_HEADTRACKING_PED(iLocal_96, iParam0)){
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_96)){
TASK::TASK_CLEAR_LOOK_AT(iLocal_96);
}}else{
...
if((SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_96, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < Global_32318 || Global_32318==0f) && iLocal_296 !=4){
Global_32318=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_96, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
...
func_96(12);
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_96, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_67++;
if(iLocal_67 >=2){
...
if(!func_551()){
return 1;
}elseif(ENTITY::DOES_ENTITY_EXIST(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
if(NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), -1, 0)==PLAYER::PLAYER_PED_ID()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
...
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_99)){
if(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_267.f_33 <=0 && !MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_267.f_31, 11)){
...
}}}elseif(NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(iLocal_99)){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_99)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_99, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(iLocal_99, 0);
VEHICLE::SET_VEHICLE_RESPECTS_LOCKS_WHEN_HAS_DRIVER(iLocal_99, 0);
}else{
