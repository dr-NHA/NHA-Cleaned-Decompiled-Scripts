...
iLocal_1093=1;
}}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_1088, 200f, 200f, 200f, 0, 1, 0)){
iLocal_1093=0;
}
if(!iLocal_1098){
...
}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_909, 0)){
func_36(iLocal_909);
...
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_909, 0)){
if(VEHICLE::IS_VEHICLE_SIREN_ON(iLocal_909)){
VEHICLE::SET_VEHICLE_SIREN(iLocal_909, 0);
}
...
}}elseif(!HUD::DOES_BLIP_EXIST(uLocal_908)){
...
var func__37(struct<3> Param0, int iParam3){
var uVar0;
...
VEHICLE::SET_VEHICLE_CUSTOM_PATH_NODE_STREAMING_RADIUS(iVar0, SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_909, 1), Local_1088));
}
iLocal_1133++;
break;
case 3:
...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_97178.f_9[iLocal_1134], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 900f){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97178.f_9[iLocal_1134], 1, 1);
iLocal_911[iLocal_1134]=Global_97178.f_9[iLocal_1134];
bVar0=true;
Global_97178.f_9[iLocal_1134]=0;
}elseif(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_97178.f_9[iLocal_1134], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 2500f && ENTITY::IS_ENTITY_OCCLUDED(Global_97178.f_9[iLocal_1134])){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97178.f_9[iLocal_1134], 1, 1);
...
bLocal_1099=false;
}}elseif((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_910, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_910, 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_909, iLocal_910)){
bLocal_1099=true;
}}
...
iLocal_911[0]=PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 215.7186f, -1644.622f, 28.7719f, 357.5736f, 1, 1);
iLocal_911[1]=PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 214.4446f, -1643.72f, 28.7776f, 279.1055f, 1, 1);
iLocal_911[2]=PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 217.0826f, -1644.117f, 28.7155f, 72.8262f, 1, 1);
iVar3=0;
