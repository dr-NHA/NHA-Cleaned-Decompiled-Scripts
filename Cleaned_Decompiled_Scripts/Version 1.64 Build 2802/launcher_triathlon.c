...
flag=false;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_126(true);
pedLocal_85=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
iLocal_95=0;
func_124(&Global_112299, 0);
func_121();
MISC::SET_THIS_IS_A_TRIGGER_SCRIPT(true);
if(func_120(iLocal_94, 1)) iLocal_100=10;
else iLocal_100=9;
while (!Global_38596){
SYSTEM::WAIT(0);
}
if(!func_120(iLocal_94, 8))if(!_CAN_ENTER_FREEROAM_STATE(iLocal_100))if(func_117(0, iLocal_99)) func_126(false);
else func_126(true);
if(iLocal_99 !=-1)if(!func_117(0, iLocal_99)) func_126(true);
if(func_120(iLocal_94, 8388608)) func_126(true);
if(func_120(iLocal_94, 524288) && func_116() && !func_115()) func_126(true);
...
pedLocal_85=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
if(func_120(iLocal_94, 1048576))if(ENTITY::IS_ENTITY_DEAD(pedLocal_85, false)) func_126(true);
...
if(func_120(iLocal_94, 524288) && func_116() && !func_115()) func_126(true);
if(func_100()) func_126(true);
if(!func_92(6) || Global_112695 || func_91()) flag3=false;
...
if(func_87(true)) flag3=false;
if(Global_78558) flag3=false;
if(func_86()) flag3=false;
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) flag3=false;
if(func_85() || func_84(8, -1)) flag3=false;
...
if(func_83(0) || func_82()) flag3=false;
if(flag3){
...
}}elseif(func_120(iLocal_94, 1024)){
...
elseif(!func_120(iLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
if(num !=1) num=func_59(&iLocal_98, 6, iLocal_100, false, 0);
if(num==1){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
func_58();
if(Global_44446) func_49(PLAYER::PLAYER_PED_ID());
...
break;
case 6:
if(!func_120(iLocal_94, 256))if(CAM::IS_SCREEN_FADING_OUT() || CAM::IS_SCREEN_FADED_IN()) PAD::SET_INPUT_EXCLUSIVE(PLAYER_CONTROL, INPUT_CONTEXT);
elseif(CAM::IS_SCREEN_FADED_OUT()) func_88(&iLocal_94, 256);
if(func_120(Global_112299, 262144)){
func_124(&Global_112299, 262144);
func_38();
}
if(func_120(iLocal_94, 2097152))if(!func_102(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_52)) func_113(10);
...
func_4();
func_124(&Global_112299, 0);
if(func_120(iLocal_94, 16777216)) func_126(true);
if(iLocal_99 !=-1)if(Global_113648.f_9087)if(!func_117(0, iLocal_99)) func_126(true);
}
func_3();
break;
case 8:
...
case 7:
func_2();
if(iLocal_105 !=263) func_114(iLocal_105, false, false);
if(iLocal_96 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_96);
...
func_121();
if(iLocal_105 !=263) func_114(iLocal_105, true, false);
func_113(0);
}}}elseif(iLocal_106==0){
if(fLocal_110 > fLocal_102 * fLocal_102){
if(iLocal_105 !=263){
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_129)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(pedLocal_129, true, true);
if(ENTITY::DOES_ENTITY_EXIST(obLocal_127)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(obLocal_127, true, true);
if(ENTITY::DOES_ENTITY_EXIST(obLocal_128)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(obLocal_128, true, true);
...
}elseif(Global_113648.f_20013.f_8==2){
...
if(func_24()) num=Global_113648.f_7263.f_227[iParam0];
...
if(func_26()==-1 || func_26()==999 && !func_25()==0) return true;
return false;
}
...
if(func_37(piParam0))if(func_36(piParam0)) return piParam0->f_2;
else return func_35(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;
return piParam0->f_1;
}
...
if(!func_37(piParam0)) func_46(piParam0);
else func_44(piParam0);
return;
}
...
if(!func_37(piParam0)) func_44(piParam0);
return;
}
...
i < iLocal_136;
i=i + 1){
if(PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_136[i])) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_136[i]);
}
...
if(iParam4 !=0) func_60(uParam0, iParam4);
}
return 2;
}
...
func_75(iLocal_105);
}elseif(PED::IS_PED_INJURED(pedLocal_129) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(EVENT_SHOCKING_GUNSHOT_FIRED, ENTITY::GET_ENTITY_COORDS(pedLocal_129, true), 40f) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(EVENT_SHOCKING_SEEN_WEAPON_THREAT, ENTITY::GET_ENTITY_COORDS(pedLocal_129, true), 40f)){
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_129))if(!ENTITY::IS_ENTITY_DEAD(pedLocal_129, false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedLocal_129, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) <=144f)if(TASK::GET_SCRIPT_TASK_STATUS(pedLocal_129, SCRIPT_TASK_LOOK_AT_ENTITY) !=1) TASK::TASK_LOOK_AT_ENTITY(pedLocal_129, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
elseif(TASK::GET_SCRIPT_TASK_STATUS(pedLocal_129, SCRIPT_TASK_LOOK_AT_ENTITY)==1) TASK::TASK_CLEAR_LOOK_AT(pedLocal_129);
if(bLocal_131) func_63();
return;
}
...
if(character==CHAR_MICHAEL) ignore=0;
elseif(character==CHAR_FRANKLIN) ignore=1;
elseif(character==CHAR_TREVOR) ignore=3;
sizeAndPeds=10;
...
i < pedNearbyPeds;
i=i + 1){
if(!PED::IS_PED_INJURED(sizeAndPeds[i]) && !ENTITY::DOES_ENTITY_EXIST(ped))if(ENTITY::GET_ENTITY_MODEL(sizeAndPeds[i])==joaat("A_M_Y_RoadCyc_01")) ped=sizeAndPeds[i];
}
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_68(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_68(character)) return func_71(character);
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
character=_GET_CURRENT_PLAYER_CHARACTER();
if(!func_68(character)) return false;
switch (iParam0){
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_99() || Global_112695 || Global_32166 || func_98() || func_84(8, -1) || func_97() || func_96() || func_95() || func_86() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_99() || Global_32166 || func_98() || func_84(8, -1) || func_95() || func_97() || func_96() || func_86() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
...
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_99() || Global_112695 || Global_32166 || func_98() || func_84(8, -1) || func_97() || func_96() || func_86() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_99() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_84(8, -1) || func_86() || func_94() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_84(8, -1) || func_97() || func_96() || func_94() || func_93()) return false;
...
break;
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_99() || Global_32166 || func_98() || func_84(8, -1) || func_96() || func_95() || func_86() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 7:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_99() || func_96() || Global_112695 || Global_32166 || func_98() || Global_44446 || func_84(8, -1) || func_95() || func_94() || func_86() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 8:
...
return true;
case 1:
if(func_104(6) || func_104(7)) return true;
else return func_102(3);
break;
case 2:
return true;
case 3:
...
if(TASK::DOES_SCENARIO_GROUP_EXIST("Triathlon_1_Start") && iLocal_135==1) TASK::SET_SCENARIO_GROUP_ENABLED("Triathlon_1_Start", true);
if(TASK::DOES_SCENARIO_GROUP_EXIST("Triathlon_2_Start") && iLocal_135==0) TASK::SET_SCENARIO_GROUP_ENABLED("Triathlon_2_Start", true);
if(TASK::DOES_SCENARIO_GROUP_EXIST("Triathlon_3_Start") && iLocal_135==2) TASK::SET_SCENARIO_GROUP_ENABLED("Triathlon_3_Start", true);
if(!ENTITY::DOES_ENTITY_EXIST(obLocal_125)){
vector={
func_109(iLocal_135==1, 2434.162f, 4282.7744f, 35.5112f, func_109(iLocal_135==0, -1231.2026f, -2051.5308f, 12.9317f, func_109(iLocal_135==2, 1591.0991f, 3814.0264f, 33.2697f, 0f, 0f, 0f))) 
};
heading=iLocal_135==1 ? 264.0724f :
iLocal_135==0 ? 256.2876f :
iLocal_135==2 ? 222.6197f :
0f;
...
fLocal_121={
func_109(iLocal_135==1, 2434.955f, 4282.711f, 35.5333f, func_109(iLocal_135==0, -1230.3606f, -2051.7612f, 12.918f, func_109(iLocal_135==2, 1591.686f, 3813.4014f, 33.3371f, 0f, 0f, 0f))) 
};
heading=iLocal_135==1 ? 264.3256f :
iLocal_135==0 ? 253.044f :
iLocal_135==2 ? 220.7912f :
0f;
...
heading=iLocal_135==1 ? 79.9315f :
iLocal_135==0 ? 77.5972f :
iLocal_135==2 ? 47.2081f :
0f;
...
if(iLocal_135==1) vector2={
2433.74f, 4283.08f, 36.235f 
};
elseif(iLocal_135==0) vector2={
-1231.47f, -2051.23f, 13.68f 
};
elseif(iLocal_135==2) vector2={
...
case 0:
vector3={
-1230.3704f, -2051.7656f, 13.4441f 
};
heading2=69.8085f;
break;
case 1:
vector3={
2435.042f, 4282.7163f, 36.0357f 
};
heading2=83.5805f;
break;
case 2:
vector3={
1591.7103f, 3813.3552f, 33.8383f 
};
heading2=41.0251f;
break;
}
...
if(!_IS_NULL_VECTOR(unk7)) iLocal_136[i]=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(unk7, unk10, num, false, 7);
}}
return;
}
...
case 0:
*uParam2={
-1285.2881f, -2039.9432f, 1.60045f 
};
*uParam3={
4f, 10.2f, 10f 
};
...
case 2:
*uParam2={
-1227.0847f, -2053.458f, 12.98837f 
};
*uParam3={
5f, 14f, 10f 
};
...
case 1:
*uParam2={
2384.9753f, 4289.719f, 30.32816f 
};
*uParam3={
4f, 10f, 10f 
};
...
case 3:
*uParam2={
2411.2502f, 4298.0063f, 34.98311f 
};
*uParam3={
2.1f, 3.2f, 10f 
};
...
case 2:
*uParam2={
1594.0022f, 3810.7175f, 33.55904f 
};
*uParam3={
4f, 12f, 10f 
};
...
case 3:
*uParam2={
1604.679f, 3828.3079f, 33.82485f 
};
*uParam3={
1.96f, 3f, 10f 
};
...
case 4:
*uParam2={
1607.1351f, 3824.388f, 33.06039f 
};
*uParam3={
1.63f, 2.9f, 0f 
};
...
var func__108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7AA0{
if(bParam0) return uParam1;
return uParam2;
}


Vector3 func__109(BOOL bParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x7AB7{
if(bParam0) return fParam1;
return fParam4;
}
BOOL func_110() // Position - 0x7AD2{
if(bLocal_131){
if(!STREAMING::HAS_MODEL_LOADED(joaat("prop_tri_table_01"))) return false;
if(!STREAMING::HAS_MODEL_LOADED(joaat("prop_chair_08"))) return false;
if(!STREAMING::HAS_MODEL_LOADED(joaat("A_M_Y_RoadCyc_01"))) return false;
if(!STREAMING::HAS_ANIM_DICT_LOADED("amb@prop_human_seat_chair@male@generic@idle_a")) return false;
if(!STREAMING::HAS_MODEL_LOADED(joaat("p_cs_clipboard"))) return false;
if(!STREAMING::HAS_MODEL_LOADED(joaat("prop_pencil_01"))) return false;
}
return true;
}
...
switch (iLocal_135){
case 0:
if(!STREAMING::IS_IPL_ACTIVE("AP1_04_TriAf01")) STREAMING::REQUEST_IPL("AP1_04_TriAf01");
break;
case 1:
if(!STREAMING::IS_IPL_ACTIVE("CS2_06_TriAf02")) STREAMING::REQUEST_IPL("CS2_06_TriAf02");
break;
case 2:
if(!STREAMING::IS_IPL_ACTIVE("CS4_04_TriAf03")) STREAMING::REQUEST_IPL("CS4_04_TriAf03");
break;
}}
return;
}
...
if(Global_113648.f_20013.f_8==-1) Global_113648.f_20013.f_8=0;
if(Global_113648.f_20013.f_8 < iLocal_135) func_88(&iLocal_94, 8388608);
return;
}
...
Vector3 func__123(int iParam0) // Position - 0x80FF{
if(iParam0 >=3 || iParam0 <=-1) return 0f, 0f, 0f;
switch (iParam0){
case 1:
...
if(bParam0)if(iLocal_105 !=263) func_114(iLocal_105, 0, false);
_CONTEXT_REMOVE_HELP_TEXT(&iLocal_96);
...
int i;
if(fLocal_110 > fLocal_102 * fLocal_102)if(ENTITY::DOES_ENTITY_EXIST(eLocal_124)) OBJECT::DELETE_OBJECT(&eLocal_124);
func_129(true, -1);
for (i=0;
i < iLocal_136;
i=i + 1){
...
int num;
if(!func_131(&num, false, iParam1)) return;
