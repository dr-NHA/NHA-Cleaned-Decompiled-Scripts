...
void func_1(){
if(!MISC::IS_BIT_SET(Global_41952, 0)){
...
uLocal_167[0]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_x17dlc_rep_sign_01a"), 2222.883f, 5612.299f, 55.291f, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_167[0], 0.5f, 0f, 15.325f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_167[0], 1);
...
if((!MISC::IS_BIT_SET(Global_41952, 1) && func_3()==0) && !(NETWORK::NETWORK_IS_ACTIVITY_SESSION() && (func_2(Global_4718592.f_113724)==14 || func_2(Global_4718592.f_113724)==15))){
...
uLocal_167[1]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_base_cabinet_door_01"), -362.402f, 4829.89f, 142.477f, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_167[1], 0f, 0f, 320f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_167[1], 1);
...
if(!MISC::IS_BIT_SET(Global_4718592.f_160048, 14)){
...
}}}elseif(MISC::IS_BIT_SET(Global_4718592.f_160048, 13)){
if(!STREAMING::IS_IPL_ACTIVE("xm_siloentranceclosed_x17")){
STREAMING::REQUEST_IPL("xm_siloentranceclosed_x17");
}
if(!STREAMING::IS_IPL_ACTIVE("xm_hatches_terrain")){
...
if(MISC::IS_BIT_SET(Global_1950108.f_1516, 8)){
...
}}elseif(!STREAMING::IS_IPL_ACTIVE("h4_ClubPoster_KeineMusik")){
...
}}elseif(!STREAMING::IS_IPL_ACTIVE("h4_ClubPoster_MoodyMann")){
...
}}elseif(!STREAMING::IS_IPL_ACTIVE("h4_ClubPoster_PalmsTraxx")){
...
}}elseif(!STREAMING::IS_IPL_ACTIVE("xm3_doc_sign")){
...
}}elseif(STREAMING::IS_IPL_ACTIVE("xm3_stash_cams")){
...
}}elseif(!STREAMING::IS_IPL_ACTIVE("xm3_warehouse_grnd")){
...
}}elseif(!STREAMING::IS_IPL_ACTIVE("xs_arena_banners_ipl")){
STREAMING::REQUEST_IPL("xs_arena_banners_ipl");
}
if(!Global_1836162){
if(MISC::IS_BIT_SET(Global_1950108.f_5, 18)){
if(STREAMING::IS_IPL_ACTIVE("hei_dlc_windows_casino")){
STREAMING::REMOVE_IPL("hei_dlc_windows_casino");
}}elseif(!STREAMING::IS_IPL_ACTIVE("hei_dlc_windows_casino")){
STREAMING::REQUEST_IPL("hei_dlc_windows_casino");
}
if(MISC::IS_BIT_SET(Global_1950108.f_5, 19)){
...
void func_18(){
ENTITY::CREATE_MODEL_HIDE(-1785.189f, 444.5226f, 127.1124f, 0.5f, joaat("prop_parasol_01"), 1);
ENTITY::CREATE_MODEL_HIDE(-1785.292f, 432.9928f, 127.1134f, 0.5f, joaat("prop_parasol_01"), 1);
ENTITY::CREATE_MODEL_HIDE(-1784.235f, 444.5237f, 127.6224f, 0.5f, joaat("prop_yaught_chair_01"), 1);
ENTITY::CREATE_MODEL_HIDE(-1785.358f, 445.6732f, 127.6216f, 0.5f, joaat("prop_yaught_chair_01"), 1);
ENTITY::CREATE_MODEL_HIDE(-1783.141f, 446.3715f, 127.6272f, 0.5f, joaat("prop_yaught_chair_01"), 1);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Var1, 1) > 250f && !bVar8){
func_23(iVar0, 0);
func_21(iVar0, 1);
if(iVar0==17){
if(OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1773088812)){
...
struct<6> func_30(int iParam0, bool bParam1){
struct<6> Var0;
switch (iParam0){
case -1:
Var0={
...
fLocal_51=MISC::GET_DISTANCE_BETWEEN_COORDS(Global_41953[iLocal_49 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
}else{
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(Global_41953[iLocal_49 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1);
if(fVar0 < fLocal_51){
fLocal_51=fVar0;
bLocal_50=iLocal_49;
}}
...
int iVar3;
float fVar4;
if(MISC::IS_BIT_SET(iLocal_63, bParam0)){
return;
}
MISC::SET_BIT(&iLocal_63, bParam0);
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 4)){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
if(!MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 6)){
func_39(bParam0, 1);
}}elseif(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 6)){
func_39(bParam0, 0);
}}}
...
if((MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 6) || MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 5)) || func_36(bParam0)){
func_35(bParam0);
bLocal_52=bParam0;
...
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_41953[bParam0 /*31*/], 1);
}
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 7)){
func_34(bParam0, 1);
}
if(!MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 2)){
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 1)){
...
}}elseif(Global_41953[bParam0 /*31*/].f_22 < 1f){
Global_41953[bParam0 /*31*/].f_22=(Global_41953[bParam0 /*31*/].f_22 + (Global_41953[bParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41953[bParam0 /*31*/].f_22 > 1f){
Global_41953[bParam0 /*31*/].f_22=1f;
}
...
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_41953[bParam0 /*31*/], Global_41953[bParam0 /*31*/].f_22, 0, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_41953[bParam0 /*31*/], 1, 0, 1);
}elseif(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 1)){
if(Global_41953[bParam0 /*31*/].f_22 > -1f){
...
if(!MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 3)){
bVar2=false;
iVar3=VEHICLE::GET_CLOSEST_VEHICLE(Global_41953[bParam0 /*31*/].f_2, 15f, 0, 2175);
if(ENTITY::DOES_ENTITY_EXIST(iVar3)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar3, 0)){
fVar4=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar3, 1), Global_41953[bParam0 /*31*/].f_2);
...
}}elseif(Global_41953[bParam0 /*31*/].f_22 > 0f){
if(!bVar2){
Global_41953[bParam0 /*31*/].f_22=(Global_41953[bParam0 /*31*/].f_22 - (Global_41953[bParam0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41953[bParam0 /*31*/].f_22 < 0f){
Global_41953[bParam0 /*31*/].f_22=0f;
...
if((((((((Global_41953[bParam0 /*31*/]==-1735618852 || Global_41953[bParam0 /*31*/]==213039352) || Global_41953[bParam0 /*31*/]==-1247364148) || Global_41953[bParam0 /*31*/]==935592315) || Global_41953[bParam0 /*31*/]==179480401) || Global_41953[bParam0 /*31*/]==-804938986) || Global_41953[bParam0 /*31*/]==-599111730) || Global_41953[bParam0 /*31*/]==1423193534) || Global_41953[bParam0 /*31*/]==-1958174046){
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_41953[bParam0 /*31*/], 0);
}
func_33(bParam0);
}}}
...
}elseif(iLocal_58[iVar0]==bParam0){
...
iVar0=23;
}elseif(Global_41953[bParam0 /*31*/]==65926040){
iVar0=22;
}elseif(Global_41953[bParam0 /*31*/]==1423193534){
iVar0=26;
}elseif(Global_41953[bParam0 /*31*/]==-1958174046){
iVar0=25;
}
if(bParam1){
if(!MISC::IS_BIT_SET(Global_41953[iVar0 /*31*/].f_1, 2)){
if(MISC::IS_BIT_SET(Global_41953[iVar0 /*31*/].f_1, 1)){
...
}}elseif(Global_41953[iVar0 /*31*/].f_22 < 1f){
Global_41953[iVar0 /*31*/].f_22=(Global_41953[iVar0 /*31*/].f_22 + (Global_41953[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41953[iVar0 /*31*/].f_22 > 1f){
Global_41953[iVar0 /*31*/].f_22=1f;
}
...
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_41953[iVar0 /*31*/], Global_41953[iVar0 /*31*/].f_22, 0, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_41953[iVar0 /*31*/], 1, 0, 1);
}elseif(MISC::IS_BIT_SET(Global_41953[iVar0 /*31*/].f_1, 1)){
if(Global_41953[iVar0 /*31*/].f_22 > -1f){
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), 2);
}}elseif(Global_41953[iVar0 /*31*/].f_22 < 1f){
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), 2);
}}elseif(!MISC::IS_BIT_SET(Global_41953[iVar0 /*31*/].f_1, 3)){
bVar1=false;
iVar2=VEHICLE::GET_CLOSEST_VEHICLE(Global_41953[iVar0 /*31*/].f_2, 15f, 0, 2175);
if(ENTITY::DOES_ENTITY_EXIST(iVar2)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar2, 0)){
fVar3=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar2, 1), Global_41953[iVar0 /*31*/].f_2);
...
}}elseif(Global_41953[iVar0 /*31*/].f_22 > 0f){
if(!bVar1){
Global_41953[iVar0 /*31*/].f_22=(Global_41953[iVar0 /*31*/].f_22 - (Global_41953[iVar0 /*31*/].f_23 * SYSTEM::TIMESTEP()));
if(Global_41953[iVar0 /*31*/].f_22 < 0f){
Global_41953[iVar0 /*31*/].f_22=0f;
...
if(SYSTEM::VDIST2(Global_41953[bParam0 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(iVar1, 1)) < Global_41953[bParam0 /*31*/].f_6){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar1, Global_41953[bParam0 /*31*/].f_9, Global_41953[bParam0 /*31*/].f_12, Global_41953[bParam0 /*31*/].f_8, 0, 1, 0)){
iLocal_54=iVar0;
return 1;
}
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar1, Global_41953[bParam0 /*31*/].f_16, Global_41953[bParam0 /*31*/].f_19, Global_41953[bParam0 /*31*/].f_15, 0, 1, 0)){
iLocal_54=iVar0;
return 1;
}
}
...
Var3.f_0=0f;
Var9={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar2, Var6) 
};
Var12={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar2, Var3) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var9, Global_41953[bParam0 /*31*/].f_9, Global_41953[bParam0 /*31*/].f_12, Global_41953[bParam0 /*31*/].f_8, 0, 1)){
iLocal_54=iVar0;
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var12, Global_41953[bParam0 /*31*/].f_9, Global_41953[bParam0 /*31*/].f_12, Global_41953[bParam0 /*31*/].f_8, 0, 1)){
iLocal_54=iVar0;
return 1;
}
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 0)){
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var9, Global_41953[bParam0 /*31*/].f_16, Global_41953[bParam0 /*31*/].f_19, Global_41953[bParam0 /*31*/].f_15, 0, 1)){
iLocal_54=iVar0;
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var12, Global_41953[bParam0 /*31*/].f_16, Global_41953[bParam0 /*31*/].f_19, Global_41953[bParam0 /*31*/].f_15, 0, 1)){
iLocal_54=iVar0;
return 1;
}}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar15, Global_41953[bParam0 /*31*/].f_9, Global_41953[bParam0 /*31*/].f_12, Global_41953[bParam0 /*31*/].f_8, 0, 1, 0)){
iLocal_54=iVar0;
return 1;
}
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar15, Global_41953[bParam0 /*31*/].f_16, Global_41953[bParam0 /*31*/].f_19, Global_41953[bParam0 /*31*/].f_15, 0, 1, 0)){
iLocal_54=iVar0;
return 1;
}
}}}
...
void func_38(bool bParam0, int iParam1, bool bParam2){
int iVar0;
bool bVar1;
if(!bParam2){
...
}elseif(iParam1==Global_41953[bParam0 /*31*/].f_25[iVar0]){
Global_41953[bParam0 /*31*/].f_25[iVar0]=0;
bVar1=true;
}
iVar0++;
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_41953[13 /*31*/].f_2, 1) <=100f){
if(!func_51(13, PLAYER::PLAYER_PED_ID())){
func_50(13, PLAYER::PLAYER_PED_ID());
}}elseif(func_51(13, PLAYER::PLAYER_PED_ID())){
func_38(13, PLAYER::PLAYER_PED_ID(), 0);
}
}}elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91469[78 /*34*/].f_6)==0){
if(func_51(13, PLAYER::PLAYER_PED_ID())){
func_38(13, PLAYER::PLAYER_PED_ID(), 0);
}}
break;
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_41953[17 /*31*/].f_2, 1) <=100f){
switch (func_44()){
case 0:
if(func_43(12, 5)){
...
break;
case 22:
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_41953[22 /*31*/].f_2, 1) <=100f){
switch (func_44()){
case 0:
if(func_43(12, 5)){
...
}}elseif(INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(480.4354f, -1317.91f, 29.5957f, "v_chopshop")){
func_50(24, PLAYER::PLAYER_PED_ID());
}
}
elseif(!func_51(24, PLAYER::PLAYER_PED_ID())){
func_50(24, PLAYER::PLAYER_PED_ID());
}}
break;
case 25:
...
switch (func_44()){
case 0:
if(SYSTEM::VDIST2(Global_41953[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) < 10000f){
...
elseif(SYSTEM::VDIST2(Global_41953[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) < 10000f){
func_50(4, PLAYER::PLAYER_PED_ID());
}}
break;
case 2:
...
if((MISC::IS_BIT_SET(Global_38626[(iParam0 / 32)], (iParam0 % 32)) && Global_39089[iParam0] !=2) && !MISC::IS_BIT_SET(Global_38862[(iParam0 / 32)], (iParam0 % 32))){
...
iVar0=ENTITY::GET_ENTITY_MODEL(func_59(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1)));
switch (iVar0){
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_69(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_41590[iParam1], 0);
Global_40993[iParam1]=0;
}}elseif(iParam2==1 || iParam2==2){
if(!Global_40993[iParam1]){
Global_41590[iParam1]=PED::ADD_SCENARIO_BLOCKING_AREA(uParam0->f_79, uParam0->f_82, 0, 1, 1, 1);
...
Global_40394[iParam1]=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uParam0->f_68, uParam0->f_71, uParam0->f_74, 0, 7);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_67, 1) > 250f){
...
void func_85(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4){
if(iParam0 !=198){
if(Global_78558){
...
bool func_88(int iParam0, bool bParam1, int iParam2, bool bParam3){
bool bVar0;
int iVar1;
int iVar2;
struct<5> Var3;
...
void func_90(){
if(!iLocal_66 && MISC::IS_BIT_SET(Global_113648.f_9087.f_2[27 /*3*/], 2)){
iLocal_66=1;
bLocal_65=true;
}
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_41590[iVar0], 0);
...
iVar0=0;
while (iVar0 < 27){
OBJECT::ADD_DOOR_TO_SYSTEM(Global_41953[iVar0 /*31*/], Global_41953[iVar0 /*31*/].f_5, Global_41953[iVar0 /*31*/].f_2, 1, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_41953[iVar0 /*31*/], 1, 1, 0);
...
Global_41953[iVar0 /*31*/].f_9={
-851.8159f, 170.8743f, 61.30219f 
};
Global_41953[iVar0 /*31*/].f_12={
-851.57f, 148.1459f, 71.34533f 
};
Global_41953[iVar0 /*31*/].f_15=15f;
Global_41953[iVar0 /*31*/].f_16={
-836.6597f, 175.3366f, 65.05977f 
};
Global_41953[iVar0 /*31*/].f_19={
-836.6878f, 152.789f, 73.66382f 
};
Global_41953[iVar0 /*31*/].f_23=0.25f;
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), 3);
...
Global_41953[iVar0 /*31*/].f_9={
15.18826f, -2531.203f, 5.05037f 
};
Global_41953[iVar0 /*31*/].f_12={
30.92092f, -2542.128f, 7.5043f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), 3);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), 7);
iVar0=1;
...
Global_41953[iVar0 /*31*/].f_9={
-190.6964f, -2515.288f, 4.678052f 
};
Global_41953[iVar0 /*31*/].f_12={
-190.7913f, -2536.692f, 9.000118f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_8=12f;
Global_41953[iVar0 /*31*/].f_9={
-200.208f, -2515.379f, 5.047561f 
};
Global_41953[iVar0 /*31*/].f_12={
-200.3241f, -2495.309f, 7.891297f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
484.581f, -3115.548f, 4.652226f 
};
Global_41953[iVar0 /*31*/].f_12={
473.6379f, -3116.051f, 11.0701f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_8=40f;
Global_41953[iVar0 /*31*/].f_9={
484.0876f, -3115.801f, 4.652227f 
};
Global_41953[iVar0 /*31*/].f_12={
494.8903f, -3115.787f, 11.06866f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_8=40f;
Global_41953[iVar0 /*31*/].f_9={
-1599.609f, 2805.895f, 15.67009f 
};
Global_41953[iVar0 /*31*/].f_12={
-1593.815f, 2811.392f, 22.02457f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_8=40f;
Global_41953[iVar0 /*31*/].f_9={
-1050.437f, 4909.196f, 200f 
};
Global_41953[iVar0 /*31*/].f_12={
-1027.922f, 4921.748f, 215f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
520.2437f, 164.8932f, 98.04417f 
};
Global_41953[iVar0 /*31*/].f_12={
523.08f, 172.6999f, 102.7824f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
19.32684f, 550.176f, 174.0001f 
};
Global_41953[iVar0 /*31*/].f_12={
15.76926f, 543.8351f, 178.023f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
405.3651f, -1612.886f, 27.52282f 
};
Global_41953[iVar0 /*31*/].f_12={
396.684f, -1605.761f, 32.76698f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
-2551.36f, 1909.907f, 166.4336f 
};
Global_41953[iVar0 /*31*/].f_12={
-2572.051f, 1924.18f, 171.3947f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
-958.5402f, -2798.281f, 12.71478f 
};
Global_41953[iVar0 /*31*/].f_12={
-964.4572f, -2808.593f, 17.71479f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
-970.272f, -2800.353f, 12.71479f 
};
Global_41953[iVar0 /*31*/].f_12={
-965.0052f, -2791.101f, 17.71479f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
433.7827f, -1001.49f, 23.79724f 
};
Global_41953[iVar0 /*31*/].f_12={
433.8862f, -1017.222f, 29.59358f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
-1585.349f, 2796.765f, 15.33345f 
};
Global_41953[iVar0 /*31*/].f_12={
-1573.874f, 2783.339f, 20.00324f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_8=6.75f;
Global_41953[iVar0 /*31*/].f_9={
-1592.552f, 2791.04f, 15.32601f 
};
Global_41953[iVar0 /*31*/].f_12={
-1604.54f, 2805.558f, 20.1746f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
-979.2388f, -2341.411f, 11.92474f 
};
Global_41953[iVar0 /*31*/].f_12={
-993.5251f, -2333.147f, 20.42473f 
};
Global_41953[iVar0 /*31*/].f_15=15.25f;
Global_41953[iVar0 /*31*/].f_16={
-984.4644f, -2357.32f, 11.92474f 
};
Global_41953[iVar0 /*31*/].f_19={
-1002.451f, -2346.988f, 20.44472f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_8=6.5f;
Global_41953[iVar0 /*31*/].f_9={
486.4057f, -1311.665f, 27.75163f 
};
Global_41953[iVar0 /*31*/].f_12={
488.9124f, -1316.529f, 31.65202f 
};
Global_41953[iVar0 /*31*/].f_15=8.5f;
Global_41953[iVar0 /*31*/].f_16={
482.3187f, -1319.807f, 26.91848f 
};
Global_41953[iVar0 /*31*/].f_19={
478.041f, -1311.511f, 31.95297f 
};
Global_41953[iVar0 /*31*/].f_23=0.55f;
MISC::SET_BIT(&(Global_41953[iVar0 /*31*/].f_1), false);
MISC::CLEAR_BIT(&(Global_41953[iVar0 /*31*/].f_1), true);
...
Global_41953[iVar0 /*31*/].f_9={
444.0669f, -1993.736f, 21.10992f 
};
Global_41953[iVar0 /*31*/].f_12={
459.423f, -2010.026f, 26.19515f 
};
Global_41953[iVar0 /*31*/].f_15=10f;
Global_41953[iVar0 /*31*/].f_16={
452.2514f, -1987.255f, 21.18945f 
};
Global_41953[iVar0 /*31*/].f_19={
466.8117f, -2002.878f, 25.8988f 
};
...
func_106("MP_APARTMENT_DOOR_01", joaat("prop_sm1_11_doorr"), -1605.014f, -431.9617f, 40.6384f, bParam0);
...
void func_106(char* sParam0, int iParam1, struct<3> Param2, bool bParam5){
var uVar0;
...
}elseif(OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iVar0)){
...
void func_108(){
if(func_77()){
if(((!Global_113648.f_7263.f_426 || MISC::IS_BIT_SET(iLocal_46, 0)) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) || Global_38615){
if(!Global_2696069){
if(MISC::IS_BIT_SET(iLocal_46, 0) || Global_38615){
iLocal_162=1;
}
iLocal_64=0;
}}}elseif(((!Global_42791.f_426 || MISC::IS_BIT_SET(iLocal_46, 1)) || ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_98()) && !func_109())) || Global_38615){
if(func_3()==2){
