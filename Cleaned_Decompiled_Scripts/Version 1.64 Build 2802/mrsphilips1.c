...
func_225();
if(!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(joaat("DOORHASH_T_TRAILER_CS"))) OBJECT::ADD_DOOR_TO_SYSTEM(joaat("DOORHASH_T_TRAILER_CS"), joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, true, true, false);
...
if(CUTSCENE::WAS_CUTSCENE_SKIPPED()) iLocal_143=1;
}else{
if(iLocal_143==1){
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
if(!func_217()) Global_20383.f_1=3;
Global_21725=5;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_214(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_211() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_214(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_213(-1, false)==8;
...
if(func_215())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(iParam5==1) func_224(500, false);
}
return;
}
...
num=0;
if(!func_232(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE)) TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
if(iParam0==1)if(!func_227()) return false;
...
if(!func_247(0, uParam0)) Global_78815=MISC::GET_GAME_TIMER() - 9000;
...
text={
func_238(Global_78814, Global_78816, iParam10) 
};
y==-0.014f;
...
if(!func_250(0) || Global_78828 || Global_78817==1 || !CAM::IS_SCREEN_FADED_IN()) return false;
switch (Global_78813){
case 0:
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_258(&uParam0->[i]);
else func_257(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_262(&uParam0->[i]);
else func_261(&uParam0->[i]);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_267(&uParam0->[i]);
else func_266(&uParam0->[i], false, 1, 0);
}
return;
}
...
if(Global_100681 !=12)if(func_271(sParam0, 6, iParam1)) Global_100681.f_1=iParam1;
return;
}
...
if(func_277()){
if(func_276()){
if(Global_100718 >=func_273())if(!IS_BIT_SET(Global_91469[iParam2 /*34*/].f_15, 16))if(Global_113648.f_9087.f_330[iParam2 /*6*/].f_1 >=2) Global_94857=1;
...
if(Global_100681.f_11==5)if(func_272(&(Global_100681.f_3)) > -1) return true;
return false;
}
...
if(func_288()) return;
if(Global_20584)if(func_287()) func_286(true, true);
else func_286(false, false);
if(Global_20383.f_1==10 || Global_20383.f_1==9) MISC::SET_BIT(&Global_8254, 16);
if(AUDIO::IS_MOBILE_PHONE_CALL_ONGOING()) AUDIO::STOP_SCRIPTED_CONVERSATION(false);
Global_21725=5;
