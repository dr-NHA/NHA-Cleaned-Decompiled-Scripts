...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_85.f_28[0], 1);
}
iLocal_84=1;
break;
case 1:
...
float fVar6;
Var0={
func_243(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
float fVar6;
Var0={
func_243(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
uLocal_332=PED::CREATE_SYNCHRONIZED_SCENE(Local_333, Local_336, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_85.f_28[0], 0, 0);
}
...
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_158, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_148, Local_333, 0, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_148, Local_336, 2, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_148, uLocal_332, "leadout_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
...
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_156, 0)){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_149[0], uLocal_332, "leadout_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 1, 1148846080);
...
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_157, 0)){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_149[1], uLocal_332, "leadout_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 1, 1148846080);
...
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_159, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_147, -261.1132f, 294.1956f, 90.68612f, 0, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_147, -0.604164f, -2.332095f, 89.8831f, 2, 0);
...
if(!func_287(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
void func_295(){
if(func_265()){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_85.f_28[0], 0f, 0f, 0f, 1, -1, 1500, 2000, 0);
}}
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iLocal_148, 1), ENTITY::GET_ENTITY_ROTATION(iLocal_148, 2), 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_330, sLocal_161, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_148)){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_148, uLocal_330, "leadin_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_149[0])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_149[0], uLocal_330, "leadin_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_149[1])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_149[1], uLocal_330, "leadin_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
}
func_256(1, 1, 1, 1);
iLocal_84=1;
}
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.99f){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_331)){
uLocal_331=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iLocal_148, 1), ENTITY::GET_ENTITY_ROTATION(iLocal_148, 2), 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_331, sLocal_161, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_85.f_28[0], 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_148)){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_148, uLocal_331, "idle_01_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_148);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_149[0])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_149[0], uLocal_331, "idle_01_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_149[0]);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_149[1])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_149[1], uLocal_331, "idle_01_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_149[1]);
}
}}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.3f){
if(!bLocal_328){
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.05f){
func_295();
}}else{
func_295();
iLocal_84=2;
...
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_rcpap1_camera", PED::GET_PED_BONE_COORDS(Local_85.f_28[0], 28422, Local_340), ENTITY::GET_ENTITY_ROTATION(Local_85.f_41[3], 2), 1065353216, 0, 0, 0);
if(!AUDIO::HAS_SOUND_FINISHED(uLocal_339)){
AUDIO::STOP_SOUND(uLocal_339);
}
if(AUDIO::REQUEST_SCRIPT_AUDIO_BANK(sLocal_343, 0, -1)){
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_339, "CAMERA", PED::GET_PED_BONE_COORDS(Local_85.f_28[0], 28422, Local_340), sLocal_344, 0, 0, 0);
iLocal_345=1;
}}}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_287(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
bLocal_328=false;
if(func_232(PLAYER::PLAYER_PED_ID())){
uLocal_146=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_232(Local_85.f_28[0])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_85.f_28[0], uLocal_146);
PED::SET_PED_CONFIG_FLAG(Local_85.f_28[0], 132, 1);
PED::SET_PED_KEEP_TASK(Local_85.f_28[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_85.f_28[0], 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
iLocal_147=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-261.19f, 292.22f, 90.79f, 10f, iLocal_155, 1, 0, 1);
ENTITY::SET_CAN_CLIMB_ON_ENTITY(iLocal_147, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_148)){
...
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_332, 0.02f);
}
bLocal_329=false;
}
...
if(ENTITY::IS_ENTITY_DEAD(Local_85.f_28[0], 0)){
func_318("P3BEVDEAD");
return 1;
...
return 1;
}elseif(func_365(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_274(iParam0, 0, 0)) || func_274(iParam0, 1, 0)) || func_274(iParam0, 2, 0)) || func_399(iParam0) !=145) || func_398(iParam0)) || func_397(iParam0)) || func_348(iParam0)) || func_396(iParam0)) || !func_386(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_397(iParam0)){
}
if(func_397(iParam0)){
}
...
}elseif(func_408(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
}elseif((!func_424(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_426(iParam0, uVar1[iVar6], 1) && func_425(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_420(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_435(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_434()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
var func__432(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
uLocal_82=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uParam0->f_41[0], 1), ENTITY::GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], uLocal_82, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_82, 1);
if(func_233(uParam0->f_28[0])){
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_82, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
}
if(func_233(uParam0->f_41[1])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], uLocal_82, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
}
if(func_233(uParam0->f_41[2])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], uLocal_82, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
}}
iVar31=0;
while (iVar31 <=(iVar0 - 1)){
...
AUDIO::RELEASE_SOUND_ID(uLocal_339);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_149[0])){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_149[0], 1);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_149[1])){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_149[1], 1);
}
