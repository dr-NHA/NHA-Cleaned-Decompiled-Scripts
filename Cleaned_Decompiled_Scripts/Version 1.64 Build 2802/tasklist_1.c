...
fLocal_14=0.001f;
iLocal_17=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(2)) func_11();
while (true){
SYSTEM::WAIT(250);
switch (iLocal_27){
case 0:
...
for (iLocal_22=0;
iLocal_22 < Global_22844[1 /*42*/].f_32[1];
...
if(func_10()) return 0;
if(func_5(iParam0, iParam1, bParam2, iParam3)==1) return 1;
return 0;
}
...
while (i < 2){
if(Global_23013[i /*9*/].f_8==0 || Global_23013[i /*9*/].f_8==1)if(!func_9(Global_23013[i /*9*/].f_2, Global_23013[Global_22843 /*9*/].f_2)) Global_22843=i;
i=i + 1;
}
