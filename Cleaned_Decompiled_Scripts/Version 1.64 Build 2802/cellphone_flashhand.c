...
if(ENTITY::GET_ENTITY_MODEL(uLocal_114)==joaat("submersible") || ENTITY::GET_ENTITY_MODEL(iLocal_114)==joaat("submersible2")){
iLocal_117=1;
}else{
iLocal_117=0;
}
if(((((ENTITY::GET_ENTITY_MODEL(iLocal_114)==joaat("rhino") || ENTITY::GET_ENTITY_MODEL(iLocal_114)==joaat("cutter")) || ENTITY::GET_ENTITY_MODEL(iLocal_114)==joaat("chernobog")) || ENTITY::GET_ENTITY_MODEL(iLocal_114)==joaat("khanjali")) || iLocal_117) || VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_114, 0)==0){
MISC::SET_BIT(&Global_8254, 4);
}
...
void func_20(){
if(MISC::IS_BIT_SET(Global_8254, 10) || iLocal_122==1){
...
func_81(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300", &Var0, "CELL_195", 0);
}else{
func_112(Global_20364, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
func_81(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), &Var0, &(Global_2028[Global_7568 /*29*/].f_3), 0);
}}
func_112(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
}
func_55();
...
void func_79(){
MOBILE::GET_MOBILE_PHONE_RENDER_I(&iLocal_86);
if(iLocal_86==-1){}}
...
func_81(Global_20364, "SET_TITLEBAR_TIME", SYSTEM::TO_FLOAT(iLocal_91), SYSTEM::TO_FLOAT(iLocal_92), -1f, -1f, -1f, &cLocal_94, 0, 0, 0, 0);
if(Global_20326==0){
func_92();
}
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
Global_2800023=0;
Global_2800023.f_2=0;
}elseif(func_117(Global_2800023.f_20)){
