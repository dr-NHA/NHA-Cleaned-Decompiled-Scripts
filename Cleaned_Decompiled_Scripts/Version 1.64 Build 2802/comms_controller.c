...
if(MISC::IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 3)){
if(func_140()){
iLocal_58=2;
}}else{
iLocal_58=2;
...
Global_113648.f_7690.f_867[iVar1 /*14*/]={
Global_113648.f_7690.f_867[iVar1 + 1 /*14*/] 
};
iVar1++;
}
...
bVar0=false;
while (bVar0 < 3){
if(MISC::IS_BIT_SET(uParam0->f_2, bVar0)){
...
void func_76(){
int iVar0;
if(MISC::IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 1)){
if(!func_54(26)){
if(func_84()){
...
uParam0->f_1=(func_78(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
int func_84(){
if(MISC::IS_BIT_SET(Global_8254, 23)){
if(Global_21778==1){
return 1;
}else{
return 0;
...
return 0;
}}elseif(iVar3 < iVar1 && iVar3 >=iVar2){
return 0;
}
...
var func__105(){
return MISC::IS_BIT_SET(Global_113648.f_18576[26 /*6*/], 3);
}
...
fVar0=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_108(212, 0));
if(fVar0 > 22500f){
Global_95683=-1;
return 1;
}}
...
Vector3 func__108(int iParam0, int iParam1){
int iVar0;
iVar0=iParam0;
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(SYSTEM::VDIST2(func_108(181, 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 40000f){
return 1;
}}
if(Global_95683==-1){
Global_95683=MISC::GET_GAME_TIMER();
...
int iVar0;
if(Global_43804 !=-1){
if(MISC::IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 1) && !Global_113648.f_7690.f_913){
func_150(iParam0, 0);
}else{
...
if(MISC::IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 15)){
switch (func_66()){
case 0:
iVar0=0;
break;
...
func_60(125, 0);
}elseif(Global_113648.f_7690[Global_43804 /*15*/].f_6==14){
func_60(126, 0);
}elseif(Global_113648.f_7690[Global_43804 /*15*/].f_6==15){
func_60(127, 0);
}}}
if(Global_43805 !=-1){
func_79();
...
if(MISC::IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 10) || iParam1){
...
if(MISC::IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 8)){
func_154(&(Global_113648.f_7690[Global_43804 /*15*/]));
}}elseif(MISC::IS_BIT_SET(Global_113648.f_7690[Global_43804 /*15*/].f_1, 11)){
...
if(AUDIO::CAN_VEHICLE_RECEIVE_CB_RADIO(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
switch (iLocal_53){
case -1:
...
AUDIO::PLAY_SOUND_FRONTEND(iLocal_57, "Background_Loop", "CB_RADIO_SFX", 1);
return 1;
}}else{
...
var func__168(int iParam0, int iParam1){
...
if((*iParam0 >=Global_43808 || MISC::IS_BIT_SET(Global_113648.f_7690.f_765[iVar0 /*10*/].f_1, 21)) || iVar1){
...
iVar2=iVar20;
Var3={
func_198(Global_44465[iVar20 /*12*/].f_1) 
};
...
Var3={
func_198(Global_44465[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(bVar1){
func_195(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_196(iParam1)), 0));
}else{
func_195(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_196(iParam1)), 0));
}
switch (Global_20383){
case 0:
...
if(MISC::IS_BIT_SET(uParam0, func_202()) && !MISC::IS_BIT_SET(uParam4, 19)){
return 0;
}}}
if(Global_78556){
return 0;
...
if(MISC::IS_BIT_SET(uParam4, 18)){
if(!MISC::IS_BIT_SET(uParam0, func_202())){
return 0;
}}
iVar0=1;
...
bVar1=func_66();
if(func_9(bVar1)){
if(MISC::IS_BIT_SET(Global_113648.f_7690.f_199[iVar0 /*15*/].f_2, bVar1)){
...
if(iVar3 < 9){
Global_113648.f_7690[iVar3 /*15*/]={
Global_113648.f_7690.f_199[iVar0 /*15*/] 
};
Global_113648.f_7690.f_136++;
bVar4=false;
while (bVar4 < 3){
if(MISC::IS_BIT_SET(Global_113648.f_7690[iVar3 /*15*/].f_2, bVar4)){
func_8(bVar4);
}
bVar4++;
}}else{
...
Global_113648.f_7690[iVar1 /*15*/]={
Global_113648.f_7690.f_137[iVar0 /*15*/] 
};
Global_113648.f_7690.f_136++;
bVar2=false;
while (bVar2 < 3){
if(MISC::IS_BIT_SET(Global_113648.f_7690.f_137[iVar0 /*15*/].f_2, bVar2)){
func_8(bVar2);
}
bVar2++;
}}
...
if((*iParam0 >=Global_43808 || MISC::IS_BIT_SET(Global_113648.f_7690.f_651[iVar0 /*14*/].f_1, 21)) || iVar1){
...
return 0;
}}elseif(!MISC::IS_BIT_SET(uParam0->f_1, 18)){
if(uParam0->f_12 >=2 || MISC::IS_BIT_SET(uParam0->f_1, 19)){
bVar18=false;
bVar17=false;
while (bVar17 < 3){
if(MISC::IS_BIT_SET(uParam0->f_2, bVar17)){
switch (bVar17){
case 0:
iVar19=0;
break;
...
if(MISC::IS_BIT_SET(Global_113648.f_7690[iVar0 /*15*/].f_1, 0)){
iVar1=0;
if(Global_113648.f_7690[iVar0 /*15*/].f_3 >=5){
iVar1=1;
}
if((*iParam0 >=Global_43808 || MISC::IS_BIT_SET(Global_113648.f_7690[iVar0 /*15*/].f_1, 21)) || iVar1){
if(Global_113648.f_7690[iVar0 /*15*/].f_3==Global_113648.f_7690.f_919[func_66()] || !MISC::IS_BIT_SET(Global_113648.f_7690[iVar0 /*15*/].f_2, func_202())){
...
func_129();
return 0;
}}elseif(func_289(&Global_43639, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar14, &cVar18, 0, 0, 1)){
if(uParam0->f_3==5 || MISC::IS_BIT_SET(uParam0->f_1, 12)){
func_144(1);
}
return 1;
...
func_129();
return 0;
}}elseif(MISC::IS_BIT_SET(uParam0->f_1, 0)){
...
func_129();
return 0;
}}elseif(func_288(&Global_43639, uParam0->f_6, &Var22, &(Var22.f_4), iVar0, 0, 0, 1)){
if(MISC::IS_BIT_SET(uParam0->f_1, 12)){
func_144(1);
}
if(MISC::IS_BIT_SET(uParam0->f_1, 13)){
...
if((*iParam0 >=Global_43808 || iVar1) || MISC::IS_BIT_SET(Global_113648.f_7690[iVar0 /*15*/].f_1, 21)){
if(Global_113648.f_7690[iVar0 /*15*/].f_3==Global_113648.f_7690.f_919[func_66()] || !MISC::IS_BIT_SET(Global_113648.f_7690[iVar0 /*15*/].f_2, func_202())){
