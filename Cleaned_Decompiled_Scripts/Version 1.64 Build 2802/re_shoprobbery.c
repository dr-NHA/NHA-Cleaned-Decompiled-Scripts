...
iLocal_42=64;
Local_128={
-824.1719f, -187.654f, 36.5707f 
};
Local_131={
-1202.94f, -779.74f, 17.33f 
};
Local_50={
...
func_149();
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_114[0], joaat("weapon_unarmed"), 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_167, iLocal_114[0], PED::GET_PED_BONE_INDEX(iLocal_114[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1, 0);
}}
}
if(MISC::IS_PROJECTILE_IN_AREA(Local_194 - Vector(20f, 20f, 20f), Local_194 + Vector(20f, 20f, 20f), 0)){
if(!PED::IS_PED_INJURED(iLocal_117[1])){
TASK::TASK_SMART_FLEE_COORD(iLocal_117[1], Local_103, 150f, -1, 0, 0);
...
TASK::TASK_SMART_FLEE_COORD(iLocal_117[2], Local_103, 150f, -1, 0, 0);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_152);
if(iLocal_49==1){
...
TASK::TASK_SMART_FLEE_COORD(0, Local_103, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_121[iVar2], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_117[0], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_184, iLocal_175, PLAYER::PLAYER_PED_ID(), 8, 16f, 786469, -1f, -1f, 1);
...
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_175, Local_55[0 /*3*/], 20f, 20f, 10f, 0, 1, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_184, iLocal_175, PLAYER::PLAYER_PED_ID(), 8, 19f, 786469, -1f, -1f, 1);
iLocal_224=1;
}}}
if(func_110()){
if(!PED::IS_PED_INJURED(iLocal_184)){
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_184, 6, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_184, 1, 1);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_184, iLocal_175, PLAYER::PLAYER_PED_ID(), 8, 17f, 786469, -1f, -1f, 1);
iLocal_163=1;
}
...
TASK::TASK_DRIVE_BY(iLocal_114[iVar3], PLAYER::PLAYER_PED_ID(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
iLocal_141[iVar3]=1;
}
elseif(!HUD::DOES_BLIP_EXIST(uLocal_192)){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_114[iVar3], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
PED::SET_PED_KEEP_TASK(iLocal_114[iVar3], 1);
if(!PED::IS_PED_INJURED(iLocal_184)){
...
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_184, uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
PED::SET_PED_KEEP_TASK(iLocal_184, 1);
}
...
func_105();
iLocal_47=9;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_114[0], PLAYER::PLAYER_PED_ID(), 1)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_167)){
if(ENTITY::IS_ENTITY_ATTACHED(iLocal_167)){
ENTITY::DETACH_ENTITY(iLocal_167, 1, 1);
}
...
STREAMING::REQUEST_ANIM_DICT("random@robbery");
}elseif(!PED::IS_PED_INJURED(iLocal_117[0])){
...
TASK::TASK_PLAY_ANIM(iLocal_117[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
if(!PED::IS_PED_INJURED(iLocal_117[1])){
TASK::TASK_SMART_FLEE_COORD(iLocal_117[1], Local_103, 150f, -1, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[1], 0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_117[1]));
...
TASK::TASK_SMART_FLEE_COORD(0, Local_103, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_121[iVar4], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
...
TASK::TASK_SMART_FLEE_COORD(iLocal_121[iVar5], Local_103, 150f, -1, 0, 0);
...
if((func_168() && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())){
SYSTEM::SETTIMERA(0);
iLocal_47=11;
}
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_248()) > (fLocal_197 + 150f)){
iLocal_47=12;
}
...
elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117[0], PLAYER::PLAYER_PED_ID(), 1)){
func_73(2);
func_53();
}
break;
...
HUD::CLEAR_HELP(1);
MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_117[0], 1), 20f, 0);
HUD::DISPLAY_HUD(0);
HUD::DISPLAY_RADAR(0);
if(iLocal_49==1){
bLocal_181=true;
...
Local_198={
ENTITY::GET_ENTITY_COORDS(iLocal_117[0], 0) 
};
if(iLocal_49==1){
Local_198={
-820.77f, -186.514f, 36.569f 
};
Local_204={
0f, 0f, -60f 
};
...
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_216, sLocal_211, sLocal_212, 1000f, -2f, 5, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_117[0]);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, sLocal_211, sLocal_213, 1000f, -2f, 4, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_117[0], 0, 0);
iLocal_167=OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1, 1, 0);
...
}}elseif(func_11(iParam0, iVar0, 0)){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_18() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_18() /*5568*/].f_681.f_10, iParam0);
}
...
func_103(&uLocal_229);
fLocal_197=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_248());
SYSTEM::SETTIMERA(0);
iLocal_47=10;
}
...
MISC::SET_BIT(&uLocal_106, 1);
if(!bLocal_161){
if(ENTITY::IS_ENTITY_DEAD(iLocal_114[0], 0)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_114[0])){
Local_107={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_114[0], 1067030938, 1069547520) 
};
}}else{
Local_107={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_114[0], 1), 1067030938, 1069547520) 
};
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_175)){
Local_107={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_175, 0), 1067030938, 1069547520) 
};
}
Local_107={
Local_107.f_0, Local_107.f_1, (Local_107.f_2 + 0.25f) 
};
uLocal_110=OBJECT::CREATE_PICKUP(joaat("pickup_money_med_bag"), Local_107, uLocal_106, iLocal_189, 1, joaat("prop_cs_duffel_01"));
...
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_114[iVar0], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
PED::SET_PED_KEEP_TASK(iLocal_114[iVar0], 1);
}
iVar0++;
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_114[0])){
iLocal_149=1;
}elseif(PED::IS_PED_INJURED(iLocal_114[0])){
iLocal_149=1;
}
if(!bLocal_161){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_114[1])){
iLocal_150=1;
}elseif(PED::IS_PED_INJURED(iLocal_114[1])){
iLocal_150=1;
}}else{
iLocal_150=1;
}
...
iLocal_151=1;
}elseif(PED::IS_PED_INJURED(iLocal_184) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_184, 0)){
iLocal_151=1;
}
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[iVar0], 1, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_114[iVar0], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_114[iVar0], 1);
SYSTEM::WAIT(0);
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_184, 1, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_184, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_184, 1);
SYSTEM::WAIT(0);
...
if(((iVar0 < iParam0 && iVar0 > -iParam0) && iVar1 < iParam0) && iVar1 > -iParam0){}else{
return 1;
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_144(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
TASK::TASK_SMART_FLEE_PED(iLocal_114[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
iLocal_165=1;
}}
if(!iLocal_166){
...
TASK::TASK_SMART_FLEE_PED(iLocal_114[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
iLocal_166=1;
}}}}
...
struct<3> Var3;
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_167, 1) 
};
Var3={
ENTITY::GET_ENTITY_ROTATION(iLocal_167, 2) 
};
OBJECT::DELETE_OBJECT(&iLocal_167);
iLocal_167=OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), Var0, 1, 1, 0);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_114[0], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
}
if(!PED::IS_PED_INJURED(iLocal_114[1])){
PED::FORCE_PED_MOTION_STATE(iLocal_114[1], joaat("MotionState_Run"), 1, 0, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_152);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_ENTER_VEHICLE(0, iLocal_175, -1, 1, 2f, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_114[1], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
}
iLocal_47=2;
iLocal_138=1;
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_216, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
...
if(!PED::IS_PED_INJURED(iLocal_117[0])){
TASK::CLEAR_PED_TASKS(iLocal_117[0]);
TASK::TASK_PLAY_ANIM(iLocal_117[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0f, 0, 0, 0);
}
STREAMING::NEW_LOAD_SCENE_START_SPHERE(-1195.062f, -773.2098f, 16.324f, 20f, 4);
uLocal_216=PED::CREATE_SYNCHRONIZED_SCENE(Local_201, Local_207, 2);
if(((!PED::IS_PED_INJURED(iLocal_114[0]) && !PED::IS_PED_INJURED(iLocal_114[1])) && !PED::IS_PED_INJURED(iLocal_117[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_167)){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_168[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_168[1])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_168[0], iLocal_117[0], PED::GET_PED_BONE_INDEX(iLocal_117[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_168[1], iLocal_117[0], PED::GET_PED_BONE_INDEX(iLocal_117[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
}}
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_216, 0.05f);
Local_201={
-1199.369f, -776.1991f, 16.3235f 
};
Local_207={
0f, 0f, -60f 
};
uLocal_216=PED::CREATE_SYNCHRONIZED_SCENE(Local_201, Local_207, 2);
if(!PED::IS_PED_INJURED(iLocal_114[1])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
}
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_216, 0.06f);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
iLocal_136=1;
...
iLocal_184=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_175, 26, joaat("g_m_y_korean_01"), -1, 1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_184, joaat("weapon_pistol"), -1, 1, 1);
...
var func__169(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_168()){
return 1;
}
...
if(!PED::IS_PED_INJURED(iLocal_114[0]) && !PED::IS_PED_INJURED(iLocal_114[1])){
if(((PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_114[1], 1) - Vector(12f, 12f, 12f), ENTITY::GET_ENTITY_COORDS(iLocal_114[1], 1) + Vector(12f, 12f, 12f), 0, 1) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_114[0], 1), 3f, 1)) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_114[1], 1), 3f, 1)){
return 1;
}}
iVar0=0;
while (iVar0 < iLocal_117){
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_175(iParam3), 0);
}
...
iVar0=0;
while (iVar0 <=(iLocal_111 - 1)){
iLocal_114[iVar0]=PED::CREATE_PED(26, iLocal_222, Local_55[iVar0 /*3*/], fLocal_62[iVar0], 1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_114[iVar0], joaat("weapon_pistol"), -1, 1, 1);
...
uLocal_168[0]=OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), Local_97, 1, 1, 0);
uLocal_168[1]=OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), Local_97 - Vector(0.1f, 0f, 0f), 1, 1, 0);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
...
iLocal_117[iVar0]=PED::CREATE_PED(26, iLocal_219, Local_65[iVar0 /*3*/], fLocal_75[iVar0], 1, 1);
...
iLocal_121[0]=PED::CREATE_PED(26, iLocal_220, Local_79[0 /*3*/], fLocal_92[0], 1, 1);
...
iVar0=1;
while (iVar0 <=2){
iLocal_121[iVar0]=PED::CREATE_PED(26, iLocal_221, Local_79[iVar0 /*3*/], fLocal_92[iVar0], 1, 1);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_121[0], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_121[1], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_121[2], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
PED::SET_PED_KEEP_TASK(iLocal_121[2], 1);
TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_114[0], iLocal_117[0], -1, 0);
...
iLocal_117[0]=PED::CREATE_PED(26, iLocal_219, Local_65[0 /*3*/], fLocal_75[0], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_117[0], "pedWorker[0]");
...
iLocal_117[1]=PED::CREATE_PED(26, iLocal_218, Local_65[1 /*3*/], fLocal_75[1], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_117[1], "pedWorker[1]");
iVar0=0;
while (iVar0 <=(iLocal_112 - 1)){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_117[iVar0], 17, 1);
...
iLocal_121[0]=PED::CREATE_PED(26, iLocal_220, Local_79[0 /*3*/], fLocal_92[0], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_121[0], "pedShopper[0]");
iLocal_121[1]=PED::CREATE_PED(26, iLocal_221, Local_79[1 /*3*/], fLocal_92[1], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_121[1], "pedShopper[1]");
iVar0=0;
...
TASK::TASK_PLAY_ANIM(iLocal_117[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0f, 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_117[0], 1);
TASK::TASK_PLAY_ANIM(iLocal_117[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0f, 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_117[1], 1);
TASK::TASK_COWER(iLocal_121[0], -1);
PED::SET_PED_KEEP_TASK(iLocal_121[0], 1);
TASK::TASK_PLAY_ANIM(iLocal_121[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0f, 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_121[1], 1);
Local_201={
-1192.01f, -768.929f, 16.358f 
};
Local_207={
0f, 0f, -59.5f 
};
uLocal_216=PED::CREATE_SYNCHRONIZED_SCENE(Local_201, Local_207, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_216, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(iLocal_114[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0f, 0, 0, 0);
func_180(14, 1);
func_179(14);
SYSTEM::WAIT(500);
func_177(14, 0, 0);
...
iLocal_113=3;
Local_55[0 /*3*/]={
-821.4461f, -184.8474f, 37.5668f 
};
fLocal_62[0]=252.381f;
Local_55[1 /*3*/]={
-819.4664f, -186.8146f, 36.5671f 
};
fLocal_62[1]=-153.9562f;
Local_65[0 /*3*/]={
-821.941f, -183.3325f, 36.5689f 
};
fLocal_75[0]=203.3684f;
Local_65[1 /*3*/]={
-813.6672f, -185.5652f, 36.5689f 
};
fLocal_75[1]=90.1761f;
Local_65[2 /*3*/]={
-816.1049f, -183.9966f, 36.5689f 
};
fLocal_75[2]=192.7338f;
Local_79[0 /*3*/]={
-813.008f, -184.931f, 37.869f 
};
fLocal_92[0]=337.68f;
Local_79[1 /*3*/]={
-817.5606f, -190.8273f, 37.3114f 
};
fLocal_92[1]=25.8399f;
Local_79[2 /*3*/]={
-816.1862f, -182.897f, 37.6304f 
};
fLocal_92[2]=30f;
Local_97={
-822.2148f, -184.0822f, 37.7027f 
};
Local_100={
-1.8236f, 0.6172f, 75.8024f 
};
Local_103={
-808.5918f, -180.0378f, 36.5689f 
};
iLocal_188=joaat("prop_cs_duffel_01");
iLocal_189=2000;
Local_194={
-822.8538f, -187.7645f, 36.5792f 
};
}elseif(iLocal_49==2){
...
iLocal_113=2;
Local_55[0 /*3*/]={
-1193.045f, -769.304f, 16.321f 
};
fLocal_62[0]=-85.5f;
Local_55[1 /*3*/]={
-1199.045f, -778.8358f, 16.3277f 
};
fLocal_62[1]=329.1899f;
Local_65[0 /*3*/]={
-1193.802f, -766.8922f, 16.331f 
};
fLocal_75[0]=221.3152f;
Local_65[1 /*3*/]={
-1193.85f, -771.4392f, 16.3227f 
};
fLocal_75[1]=247.1149f;
Local_79[0 /*3*/]={
-1184.359f, -767.0463f, 16.3468f 
};
fLocal_92[0]=103.3015f;
Local_79[1 /*3*/]={
-1185.932f, -770.624f, 16.344f 
};
fLocal_92[1]=43.215f;
Local_97={
-1192.968f, -767.0651f, 17.2968f 
};
Local_100={
0f, 0f, -128.52f 
};
Local_103={
-1180.457f, -763.9163f, 16.3267f 
};
iLocal_188=joaat("prop_cs_duffel_01");
iLocal_189=2000;
Local_194={
-1201.006f, -777.4955f, 16.3235f 
};
}
bLocal_54=true;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_222()) || func_221()) || func_220()) || func_219()) || Global_113648.f_7690.f_919[bVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_224()) || Global_32166) || func_223()) || func_129(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[bVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_224()) || Global_32166) || func_223()) || func_129(8, -1)) || func_221()) || func_220()) || func_219()) || Global_113648.f_7690.f_919[bVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_224()) || func_221()) || Global_112695) || Global_32166) || func_223()) || Global_44446) || func_129(8, -1)) || func_220()) || func_218()) || func_219()) || Global_113648.f_7690.f_919[bVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_224()) || Global_112695) || Global_32166) || func_223()) || func_129(8, -1)) || func_220()) || func_218()) || func_222()) || func_221()) || func_219()){
return 0;
}
break;
}}else{
...
TASK::TASK_SMART_FLEE_COORD(iLocal_114[iVar0], Local_103, 150f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_114[iVar0], 1);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_114[iVar0]));
}
...
TASK::TASK_SMART_FLEE_COORD(0, Local_103, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_121[iVar0], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
PED::SET_PED_KEEP_TASK(iLocal_121[iVar0], 1);
}}
iVar0++;
...
TASK::TASK_SMART_FLEE_COORD(iLocal_117[iVar0], Local_103, 150f, -1, 0, 0);
}
else{
...
TASK::TASK_SMART_FLEE_COORD(0, Local_103, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_152);
TASK::TASK_PERFORM_SEQUENCE(iLocal_117[iVar0], uLocal_152);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_152);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[iVar0], 0);
...
float fVar0;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_128, 1);
iLocal_127=1;
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_131, 1) < fVar0){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_131, 1);
iLocal_127=2;
}
if(iLocal_127==1){
bLocal_134=true;
