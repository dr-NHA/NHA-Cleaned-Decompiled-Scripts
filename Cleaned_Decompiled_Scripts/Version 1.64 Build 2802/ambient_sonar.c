...
void func_7(){
if(HUD::DOES_BLIP_EXIST(uLocal_387)){
HUD::REMOVE_BLIP(&uLocal_387);
}}
...
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_108, func_86(func_87(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
