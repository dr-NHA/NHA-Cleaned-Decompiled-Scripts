...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_97, joaat("player"));
...
iLocal_71[iVar0]=0;
iLocal_67[iVar0]=1;
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_71[iVar0]){
...
iLocal_67[iVar0]=0;
iLocal_71[iVar0]=1;
}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(uLocal_85[iVar0], 0)){
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_85[iVar0], joaat("script_task_vehicle_chase")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_85[iVar0], joaat("script_task_vehicle_chase")) !=0){
...
iLocal_79[iVar0]=0;
iLocal_75[iVar0]=1;
}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_79[iVar0]){
...
}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_85[iVar0])){
iLocal_65=1;
iLocal_64=1;
}
iVar0++;
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_97, joaat("player"));
iVar4=0;
while (iVar4 < 3){
