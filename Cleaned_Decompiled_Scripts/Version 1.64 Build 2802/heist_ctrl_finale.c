...
iLocal_49=-1;
iLocal_180=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_421();
func_420(2);
...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("finale_heist2a")) > 0 || SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("finale_heist2b")) > 0) func_3();
if(func_404(34))if(!_IS_MISSION_REPEAT_ACTIVE(false))if(!IS_BIT_SET(Global_113648.f_1.f_120[4], 9)) func_406(4, 9, true);
elseif(IS_BIT_SET(Global_113648.f_1.f_120[4], 9)) func_406(4, 9, false);
elseif(IS_BIT_SET(Global_113648.f_1.f_120[4], 9)) func_406(4, 9, false);
SYSTEM::WAIT(0);
}
func_1(2);
...
int num;
if(Global_78819) return;
if(!PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX())) return;
...
num2=num;
if(num2 !=uParam0->f_464 && !(num2==2 && uParam0->f_464==4) && !(*uParam0==1 && num2==3 && uParam0->f_464==4))if(IS_BIT_SET(uParam0->f_449, 2)) func_6(uParam0, num2, 0);
else uParam0->f_464=num2;
return;
}
...
if(!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_20[0 /*4*/]) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_20[1 /*4*/]) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_108[0 /*4*/]) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_108[1 /*4*/])) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(0);
}else{
...
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_20[0 /*4*/], "")) func_22(&uParam0->f_1.f_20[0 /*4*/], 3, 0, -1, 10000, 7, 0, 0, 0);
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_20[1 /*4*/], "")) func_22(&uParam0->f_1.f_20[1 /*4*/], 3, 1000, -1, 10000, 7, 0, 0, 0);
...
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_108[0 /*4*/], "")) func_22(&uParam0->f_1.f_108[0 /*4*/], 3, 0, -1, 10000, 7, 0, 0, 0);
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_108[1 /*4*/], "")) func_22(&uParam0->f_1.f_108[1 /*4*/], 3, 1000, -1, 10000, 7, 0, 0, 0);
Global_113648.f_1.f_6[*uParam0]=true;
}elseif(func_21() && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
if(Global_113648.f_20412.f_145 > 0) return false;
return true;
}
...
if(fParam4 !=-1f) uParam0->f_7=fParam4;
return;
}


Vector3 func__28(var uParam0, var uParam1) // Position - 0x1462{
float num;
float num2;
float num3;
float num4;
...
unk2={
unk2 +{
num6, num5 * SYSTEM::COS(90f - unk), num5 * SYSTEM::SIN(90f - unk) 
}};
num7=num5;
...
if(*uParam1 < 0 || *uParam1 > value) return;
if(uParam1->f_1 < 0 || uParam1->f_1 > value2) return;
...
if(*uParam0 !=1) func_9("H_LBL_CRW" /*CREW*/);
func_9("H_LBL_TODO" /*TODO*/);
if(*uParam0 !=2) func_9("H_LBL_APP" /*APPROACH*/);
switch (*uParam0){
case 0:
...
int num2;
int num3;
if(iParam1 < 0 || iParam1 >=uParam0->f_1.f_96) return;
func_24(uParam0, 2, 1);
num=func_66(func_31(*uParam0));
...
i < uParam0->f_417;
i=i + 1){
if(Global_113648.f_1.f_12[num /*6*/][i]==iParam1) return true;
}
return false;
}
...
i < 10;
i=i + 1){
if(MISC::ARE_STRINGS_EQUAL(&Global_96710[iParam1 /*19*/].f_7[iParam2 /*2*/], &Global_96710[i /*19*/].f_7[iParam2 /*2*/])) MISC::SET_BIT(&(Global_96710[i /*19*/].f_18), iParam2);
}}}
return;
}
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_69(uParam0);
return;
}
...
dx={
uParam0->f_401 - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
...
num2=uParam0->f_404;
if(num2 > 180f) num2=num2 - 360f;
elseif(num2 < -180f) num2=num2 + 360f;
if(num2 - headingFromVector2d < num) num=MISC::ABSF(num2 - headingFromVector2d);
if(num <=70f){
flag=true;
}else{
if(headingFromVector2d > 180f) headingFromVector2d=headingFromVector2d - 360f;
elseif(headingFromVector2d < -180f) headingFromVector2d=headingFromVector2d + 360f;
if(uParam0->f_404 - headingFromVector2d < num) num=MISC::ABSF(uParam0->f_404 - headingFromVector2d);
if(num <=70f){
flag=true;
}else{
if(num2 - headingFromVector2d < num) num=MISC::ABSF(num2 - headingFromVector2d);
if(num <=70f) flag=true;
}}
}}}}}
if(flag){
if(uParam0->f_451==-1){
_CONTEXT_ADD_HELP_TEXT(&(uParam0->f_451), 3, "PB_H_ENT" /*Press ~INPUT_CONTEXT~ to view the plans.*/, 0, 0, 0, 0);
}elseif(func_138(uParam0->f_451, true)){
...
vector={
vector +{
0f, 1f * SYSTEM::COS(180f - uParam0->f_404), 1f * SYSTEM::SIN(180f - uParam0->f_404) 
}};
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, SPC_AMBIENT_SCRIPT | 4 | 128);
...
if(interiorAtCoords !=0) INTERIOR::UNPIN_INTERIOR(interiorAtCoords);
...
if(func_78()) return;
if(Global_20584)if(func_77()) func_76(true, true);
else func_76(false, false);
if(Global_20383.f_1==10 || Global_20383.f_1==9) MISC::SET_BIT(&Global_8254, 16);
...
if(!MISC::ARE_STRINGS_EQUAL(controlGroupInstructionalButtonsString, uParam0->f_466)) func_8(uParam0);
uParam0->f_466=controlGroupInstructionalButtonsString;
func_120();
func_110(uParam0);
func_88(uParam0);
if(uParam0->f_464==1) func_85(uParam0);
if(func_21()) func_19(uParam0);
...
if(IS_BIT_SET(uParam0->f_449, 7))if(!CUTSCENE::IS_CUTSCENE_PLAYING() && CAM::IS_SCREEN_FADED_IN() && !HUD::IS_PAUSE_MENU_ACTIVE())if(uParam0->f_464 !=1)if(uParam0->f_464==0 || !IS_BIT_SET(uParam0->f_449, 11) && !IS_BIT_SET(uParam0->f_449, 10) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && uParam0->f_483==0)if(!IS_BIT_SET(uParam0->f_449, 18) || uParam0->f_464==2) GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uParam0->f_414, 255, 255, 255, 0, 0);
...
if(!CUTSCENE::IS_CUTSCENE_PLAYING()) PAD::SET_INPUT_EXCLUSIVE(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT);
...
vector={
vector +{
0.5f, 2.9f * SYSTEM::COS(180f - uParam0->f_404), 2.9f * SYSTEM::SIN(180f - uParam0->f_404) 
}};
MISC::GET_GROUND_Z_FOR_3D_COORD(vector, &(vector.f_2), false, false);
...
if(bParam3) uParam0->f_17=func_82(uParam0->f_17, uParam0->f_7 - uParam0->f_19, uParam0->f_7);
else uParam0->f_17=func_82(uParam0->f_17, uParam0->f_7 - uParam0->f_19, uParam0->f_7 + uParam0->f_19);
}elseif(bParam8){
...
if(uParam0->f_452==-1){
if(IS_BIT_SET(uParam0->f_449, 19)) uParam0->f_452=MISC::GET_GAME_TIMER() + 500;
else uParam0->f_452=MISC::GET_GAME_TIMER();
...
func_87(uParam0, i);
if(IS_BIT_SET(uParam0->f_1.f_370, i)) MISC::SET_BIT(&(uParam0->f_449), 19);
else MISC::CLEAR_BIT(&(uParam0->f_449), 19);
flag=true;
}}}
if(!flag) func_86(3, *uParam0, true);
}}}
return;
}
...
uParam0->f_455=0;
if(uParam0->f_467[0 /*5*/].f_4) MISC::CLEAR_BIT(&(uParam0->f_449), 11);
else MISC::SET_BIT(&(uParam0->f_449), 11);
for (i=0;
i < 2;
i=i + 1){
uParam0->f_467[i /*5*/]={
...
uParam0->f_467[i /*5*/].f_2={
uParam0->f_467[i + 1 /*5*/].f_2 
};
...
uParam0->f_467[j /*5*/].f_2={
uParam0->f_467[j + 1 /*5*/].f_2 
};
...
if(IS_BIT_SET(uParam0->f_449, 11)) MISC::CLEAR_BIT(&(uParam0->f_449), 11);
if(IS_BIT_SET(uParam0->f_449, 13)) MISC::CLEAR_BIT(&(uParam0->f_449), 13);
...
if(func_93(PLAYER::PLAYER_ID())) return false;
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_102(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_102(character)) return func_105(character);
...
if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL)) func_8(uParam0);
...
if(PAD::IS_LOOK_INVERTED()) uParam0->f_458[3]=-uParam0->f_458[3];
if(uParam0->f_454 > MISC::GET_GAME_TIMER()){
uParam0->f_458[2]=0;
uParam0->f_458[3]=0;
}
if(uParam0->f_464==0 || uParam0->f_464==4)if(uParam0->f_453 > 15) MISC::SET_BIT(&(uParam0->f_449), 4);
else MISC::CLEAR_BIT(&(uParam0->f_449), 4);
if(!IS_BIT_SET(uParam0->f_449, 10)){
if(!IS_BIT_SET(uParam0->f_449, 11)){
...
}elseif(uParam0->f_458[1] > 85 || uParam0->f_458[0] > 85 || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 187) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 190) || PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_CURSOR_SCROLL_DOWN)){
NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(uParam0->f_413, "SET_INPUT_EVENT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(9);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(uParam0->f_413, "GET_CURRENT_SELECTION");
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(8);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
if(uParam0->f_416 !=0) AUDIO::PLAY_SOUND_FRONTEND(-1, "MARKER_ERASE", "HEIST_BULLETIN_BOARD_SOUNDSET", true);
uParam0->f_416=0;
if(IS_BIT_SET(uParam0->f_449, 9)){
...
uParam0->f_456=MISC::GET_GAME_TIMER();
uParam0->f_457=uParam0->f_456;
}elseif(uParam0->f_458[1] > 85 || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 187) || PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SNIPER_ZOOM_OUT_ONLY)){
NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(uParam0->f_413, "SET_INPUT_EVENT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(9);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
if(uParam0->f_416 !=1) AUDIO::PLAY_SOUND_FRONTEND(-1, "MARKER_ERASE", "HEIST_BULLETIN_BOARD_SOUNDSET", true);
uParam0->f_416=1;
if(IS_BIT_SET(uParam0->f_449, 9)){
MISC::CLEAR_BIT(&(uParam0->f_449), 9);
func_8(uParam0);
...
if(!_IS_MISSION_REPEAT_ACTIVE(false)) func_116(*uParam0);
}else{
...
num3=j;
if(num3 !=0){
if(Global_96556[num3 /*5*/] !=Global_96710[num2 /*19*/].f_1[i]) flag=false;
if(!IS_BIT_SET(Global_113648.f_1.f_116, num3)) flag=false;
if(IS_BIT_SET(Global_113648.f_1.f_118, num3)) flag=false;
if(num3==11 && *uParam0==3) flag=false;
if(func_38(uParam0, num3)) flag=false;
}else{
flag=false;
}}
}
...
k < 2;
k=k + 1){
if(uParam0->f_1.f_30[k] !=13) func_406(*uParam0, uParam0->f_1.f_30[k], false);
}
uParam0->f_427=0;
func_12(uParam0, true);
uParam0->f_456=MISC::GET_GAME_TIMER();
...
l < 2;
l=l + 1){
if(uParam0->f_1.f_30[l] !=13) func_406(*uParam0, uParam0->f_1.f_30[l], false);
}
func_114(8, 0);
func_86(5, 1, false);
uParam0->f_427=0;
...
if(!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_108[0 /*4*/]) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_108[1 /*4*/]) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_20[0 /*4*/]) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_20[1 /*4*/])) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
}
if(uParam0->f_680 !=0){
...
num=func_31(*uParam0);
func_114(num, num2);
if(!_IS_MISSION_REPEAT_ACTIVE(false)) func_113(*uParam0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "SELECT" /*Filter List*/, "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
func_63(uParam0, num2, 0);
if(uParam0->f_1.f_30[scaleformMovieMethodReturnValueInt] !=13) func_406(*uParam0, uParam0->f_1.f_30[scaleformMovieMethodReturnValueInt], true);
for (m=0;
m < uParam0->f_1.f_96;
m=m + 1){
func_62(uParam0, m);
...
uParam0->f_457=uParam0->f_456;
MISC::SET_BIT(&(uParam0->f_449), 10);
if(!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_108[0 /*4*/]) && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(&uParam0->f_1.f_108[1 /*4*/])) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(0);
uParam0->f_681=0;
}}
if(uParam0->f_682 !=0){
...
if(unk !=uParam0->f_427) AUDIO::PLAY_SOUND_FRONTEND(-1, "PERSON_SCROLL", "HEIST_BULLETIN_BOARD_SOUNDSET", true);
uParam0->f_427=unk;
}
uParam0->f_682=0;
}}
if(uParam0->f_427 !=0) func_111(uParam0, uParam0->f_427);
return;
}
...
switch (iParam1){
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 0)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 1)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
}
break;
case 3:
switch (iParam1){
case 12:
if(IS_BIT_SET(Global_113648.f_1.f_117, 3)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
break;
case 9:
if(IS_BIT_SET(Global_113648.f_1.f_117, 6)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
break;
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 0))if(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 1))if(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
break;
case 6:
if(IS_BIT_SET(Global_113648.f_1.f_117, 4)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 7:
if(IS_BIT_SET(Global_113648.f_1.f_117, 2)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 8:
if(IS_BIT_SET(Global_113648.f_1.f_117, 5)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
}
break;
case 4:
switch (iParam1){
case 12:
if(IS_BIT_SET(Global_113648.f_1.f_117, 15))if(IS_BIT_SET(Global_113648.f_1.f_117, 3)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[25 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
break;
case 7:
if(IS_BIT_SET(Global_113648.f_1.f_117, 2))if(IS_BIT_SET(Global_113648.f_1.f_117, 14)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[30 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[28 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 14)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[29 /*2*/], 1);
break;
case 9:
if(IS_BIT_SET(Global_113648.f_1.f_117, 18))if(IS_BIT_SET(Global_113648.f_1.f_117, 6)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[27 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
break;
case 4:
if(IS_BIT_SET(Global_113648.f_1.f_117, 17)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
break;
case 5:
if(IS_BIT_SET(Global_113648.f_1.f_117, 12)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
break;
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 10))if(IS_BIT_SET(Global_113648.f_1.f_117, 0))if(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 11))if(IS_BIT_SET(Global_113648.f_1.f_117, 1))if(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 3:
if(IS_BIT_SET(Global_113648.f_1.f_117, 13)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 6:
if(IS_BIT_SET(Global_113648.f_1.f_117, 19))if(IS_BIT_SET(Global_113648.f_1.f_117, 4)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 8:
if(IS_BIT_SET(Global_113648.f_1.f_117, 16))if(IS_BIT_SET(Global_113648.f_1.f_117, 5)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 13:
if(IS_BIT_SET(Global_113648.f_1.f_117, 20)) func_25(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
}
break;
}}
...
if(num==1) STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_JEWEL_STEALTH"), true, true);
else STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_JEWEL_STEALTH"), false, true);
break;
case 1:
num=Global_113648.f_9087.f_99.f_205[8];
if(num==3) STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_DOCKS_SINK_SHIP"), true, true);
else STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_DOCKS_SINK_SHIP"), false, true);
break;
case 3:
num=Global_113648.f_9087.f_99.f_205[10];
if(num==6) STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_BUREAU_FIRECREW"), true, true);
else STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_BUREAU_FIRECREW"), false, true);
break;
case 4:
num=Global_113648.f_9087.f_99.f_205[11];
if(num==8) STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_BIGS_TRAFFIC"), true, true);
else STATS::STAT_SET_BOOL(joaat("SP_HEIST_CHOSE_BIGS_TRAFFIC"), false, true);
break;
}
return;
}
...
if(!CUTSCENE::IS_CUTSCENE_PLAYING()){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(Global_44446==true) func_127(PLAYER::PLAYER_PED_ID());
vector={
uParam0->f_401 
};
vector={
...
interiorAtCoords=INTERIOR::GET_INTERIOR_AT_COORDS(uParam0->f_401);
if(interiorAtCoords !=0) INTERIOR::PIN_INTERIOR_IN_MEMORY(interiorAtCoords);
INTERIOR::SET_ROOM_FOR_GAME_VIEWPORT_BY_NAME(&(Global_96627[uParam0->f_1.f_1 /*15*/].f_7));
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) INTERIOR::SET_ROOM_FOR_GAME_VIEWPORT_BY_KEY(INTERIOR::GET_KEY_FOR_ENTITY_IN_ROOM(PLAYER::PLAYER_PED_ID()));
func_124(false);
func_123();
...
if(iParam14 > 0f) CAM::SET_CAM_NEAR_CLIP(*uParam0, iParam14);
...
if(iParam1==-1) return;
if(iParam2==6) return;
if(func_133(iParam0, iParam1, iParam2)) return;
num=func_132();
if(num==-1) return;
...
if(func_134(iParam0, iParam1, iParam2)==-1) return false;
return true;
}
...
if(!func_102(character)) return false;
switch (iParam0){
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_148() || Global_112695 || Global_32166 || func_147() || func_107(8, -1) || func_146() || func_145() || func_144() || func_143() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_148() || Global_32166 || func_147() || func_107(8, -1) || func_144() || func_146() || func_145() || func_143() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_148() || Global_112695 || Global_32166 || func_147() || func_107(8, -1) || func_144() || func_146() || func_145() || func_143() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_148() || Global_112695 || Global_32166 || func_147() || func_107(8, -1) || func_146() || func_145() || func_143() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_148() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_107(8, -1) || func_143() || func_142() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_107(8, -1) || func_146() || func_145() || func_142() || func_141()) return false;
...
break;
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_148() || Global_32166 || func_147() || func_107(8, -1) || func_145() || func_144() || func_143() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 7:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_148() || func_145() || Global_112695 || Global_32166 || func_147() || Global_44446 || func_107(8, -1) || func_144() || func_142() || func_143() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 8:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || unk_0x279D0BCF8F708D74(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_148() || Global_112695 || Global_32166 || func_147() || func_107(8, -1) || func_144() || func_142() || func_146() || func_145() || func_143()) return false;
break;
}}else{
return false;
}}else{
...
if(iLocal_49 !=-1) CUTSCENE::REQUEST_CUTSCENE(sLocal_42, 8);
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()) CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION("LESTER", 1, 0, 0, 0);
}
if(func_404(26)){
if(func_404(25)){
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED(sLocal_42)){
if(!_IS_MISSION_REPEAT_ACTIVE(false))if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_130, "Michael", 0, joaat("Player_Zero"), 0);
elseif(!ENTITY::IS_ENTITY_DEAD(pedLocal_130, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_130, "Michael", 0, joaat("Player_Zero"), 0);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_133, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_133, "Lester", 0, joaat("IG_LesterCrest"), 0);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_131, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_131, "Franklin", 0, joaat("Player_One"), 0);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_132, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_132, "Trevor", 0, joaat("Player_Two"), 0);
func_73(true);
func_124(true);
...
i < func_212(4);
i=i + 1){
if(func_210(4, i)==12) func_196(-837794877);
}
if(bLocal_47) flags=0;
else flags=256;
CUTSCENE::START_CUTSCENE(flags);
if(_IS_MISSION_REPEAT_ACTIVE(false)) CUTSCENE::SET_CUTSCENE_FADE_VALUES(false, false, false, false);
func_115(25, 0);
iLocal_44=MISC::GET_GAME_TIMER();
}}elseif(CUTSCENE::IS_CUTSCENE_PLAYING()){
iLocal_44=iLocal_44;
func_120();
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("LESTER", 0))if(ENTITY::DOES_ENTITY_EXIST(pedLocal_133)) PED::DELETE_PED(&pedLocal_133);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 2000, 0, true, false);
}
func_195(0);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("FRANKLIN", 0))if(ENTITY::DOES_ENTITY_EXIST(pedLocal_131)) PED::DELETE_PED(&pedLocal_131);
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("TREVOR", 0))if(ENTITY::DOES_ENTITY_EXIST(pedLocal_132)) PED::DELETE_PED(&pedLocal_132);
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(true)){
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
}}elseif(iLocal_45==-1 && !_IS_MISSION_REPEAT_ACTIVE(false)){
iLocal_45=MISC::GET_GAME_TIMER() + 3500;
}elseif(MISC::GET_GAME_TIMER() > iLocal_45 || _IS_MISSION_REPEAT_ACTIVE(false)){
...
if(iLocal_180 !=-1)if(PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_180)) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_180);
...
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED(sLocal_42)) CUTSCENE::REMOVE_CUTSCENE();
}
return;
}
...
break;
case 11:
if(func_156(91)) func_157(0, true);
break;
case 5:
if(func_156(91)) func_157(2, true);
break;
case 3:
if(func_156(67)) func_157(5, true);
break;
case 2:
if(func_156(77)) func_157(7, true);
break;
}}}}
if(!func_40(10) && IS_BIT_SET(Global_113648.f_24997.f_8[4], 0)) func_157(9, true);
if(!func_40(13) && IS_BIT_SET(Global_113648.f_24997.f_8[16], 0)) func_157(12, true);
if(!func_40(12))if(iParam0==4) func_157(11, true);
if(!bParam1){
if(!func_155(69)) func_22("DI_HLP_HST" /*Heist characters become available in Rockstar Editor's 'Director Mode' after being up for selection on a GTAV heist.*/, 2, 0, 20000, 10000, 7, 0, 209, 0);
...
if(!bParam1) func_154(func_158(iParam0));
}}
return;
}
...
if(iParam0 !=-1 && iParam0 !=13) return IS_BIT_SET(Global_113648.f_26436.f_1, iParam0);
return false;
}
...
if(num==11) return 0;
if(num==8 || num==9 || num==10) return 0;
}
Global_113648.f_18535[echParam1]=iParam2;
uParam0->f_2296[echParam1]=func_180();
if(!func_179(iParam2, &uParam0->f_2300[echParam1 /*3*/], &uParam0->f_2310[echParam1])) return 0;
if(!func_178(uParam0->f_2300[echParam1 /*3*/], 0f, 0f, 0f, false)){
if(!func_178(Global_99120[iParam2 /*3*/], 0f, 0f, 0f, false)){
unk.f_11=12;
unk.f_31=49;
unk.f_81=2;
if(func_163(echParam1, iParam2, &unk, &unk99, &unk102, &unk103, &unk106)) Global_100085[echParam1 /*98*/]={
unk 
};
}}
uParam0->f_2314[echParam1]=0;
uParam0->f_2318[echParam1 /*3*/]={
0f, 0f, 0f 
};
...
*uParam3={
Global_100388[echParam0 /*3*/] - Global_113648.f_2365.f_539.f_2300[echParam0 /*3*/] 
};
...
*uParam4=Global_100398[echParam0] - Global_113648.f_2365.f_539.f_2310[echParam0];
if(SYSTEM::VMAG2(*uParam3) < 0.5f * 0.5f) *uParam3={
*uParam3 *{
1.5f, 1.5f, 1.5f 
}};
}else{
...
*uParam3={
{
28.826f, -1277.56f, -90.961f 
}
-{
28.3203f, -1324.1947f, -90.0089f 
}};
...
*uParam3={
{
28.764f, -1431.464f, 66.028f 
}
-{
28.2954f, -1351.5203f, 37.5988f 
}};
...
*uParam3={
{
29.17f, -1417.047f, 54.081f 
}
-{
28.2915f, -1464.6798f, 72.2278f 
}};
...
*uParam3={
{
28.701f, -1090.07f, 306.036f 
}
-{
28.3684f, -1120.7855f, 257.9167f 
}};
*uParam4=-1f - 97.2736f;
return true;
case 40:
...
*uParam3={
{
5.4446f, -2912.043f, 659.5297f 
}
-{
5.0589f, -2916.4788f, 709.0244f 
}};
...
*uParam3={
{
5.1176f, -2936.8425f, 656.9753f 
}
-{
5.1337f, -2917.325f, 643.5248f 
}};
...
*uParam3={
{
5.681f, -2769.795f, 593.033f 
}
-{
5.0558f, -2819.0852f, 594.4415f 
}};
...
*uParam3={
{
28.1755f, -550.2679f, -1170.7203f 
}
-{
30.2361f, -526.9999f, -1257.5f 
}};
...
*uParam3={
{
43.517f, -33.7052f, -531.6035f 
}
-{
45.6141f, -21.87f, -511.73f 
}};
...
*uParam5={
{
183.8081f, 578.5989f, 174.7651f 
}
-{
176.086f, 551.7596f, 10.9694f 
}};
*uParam6=10f;
return true;
case 196:
...
*uParam3={
{
29.4846f, -1457.9152f, -17.4132f 
}
-{
31.1932f, -1441.1821f, -14.8689f 
}};
*uParam4=89.0026f - -1.5f;
*uParam5={
{
33.6125f, -1563.4609f, -147.0307f 
}
-{
31.1932f, -1441.1821f, -14.8689f 
}};
...
*uParam3={
{
43.5168f, -33.5909f, -531.4f 
}
-{
45.2617f, -28.54f, -521.13f 
}};
...
*uParam3={
{
28.225f, -1015.1096f, -70.4456f 
}
-{
27.5447f, -1019.2347f, -78.4023f 
}};
...
*uParam3={
{
3.403f, -1531.113f, -1190.0171f 
}
-{
4.7514f, -1573.632f, -1174.458f 
}};
...
*uParam3={
{
28.4055f, -1607.5681f, 44.4802f 
}
-{
(28.2858f - 0.5f) + 1.5f, -1607.2864f, 2.8895f 
}};
...
*uParam3={
{
28.1773f, -1592.7875f, 3.6009f 
}
-{
29.2903f, -1607.2864f, 2.8895f 
}};
...
return true;
case 282:
if(func_163(echParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
case 283:
if(func_163(echParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
...
*uParam3={
{
-0.6187f, -1440.4209f, 2779.759f 
}
-{
0.3109f, -1453.731f, 2789.845f 
}};
...
*uParam3={
{
33.8797f, 3597.0466f, 1399.6621f 
}
-{
37.9419f, 3602.284f, 1394.2081f 
}};
...
*uParam3={
{
7.1164f, -1094.2047f, -1243.6498f 
}
-{
7.1f, -1105.15f, -1242.68f 
}};
...
*uParam3={
{
6.8143f, -930.5448f, -1672.5349f 
}
-{
6.479f, -974.7168f, -1667.148f 
}};
...
*uParam3={
{
30.3025f, 6276.1196f, -267.5488f 
}
-{
30.5054f, 6250.9f, -301.4778f 
}};
...
*uParam3={
{
32.5629f, -387.5143f, -147.166f 
}
- Global_99120[iParam1 /*3*/] 
};
...
*uParam3={
{
139.5782f, 2030.4458f, -1883.836f 
}
- Global_99120[iParam1 /*3*/] 
};
...
if(hParam0==joaat("blimp"))if(!func_175() && !func_174() && !func_173() && !func_172() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_171() || MISC::IS_PC_VERSION() || func_170()){
}elseif(!func_173()){
return false;
}}
if(bParam1)if(!func_169(hParam0, iParam2)) return false;
if(!func_167(hParam0)) return false;
return true;
}
...
if(Global_100085[echParam0 /*98*/]==joaat("blimp") || Global_100085[echParam0 /*98*/]==joaat("blimp2")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("submersible") || Global_100085[echParam0 /*98*/]==joaat("submersible2")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("freight")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("packer")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("asea2")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("burrito2") || Global_100085[echParam0 /*98*/]==joaat("fbi2")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("entityxf") && !Global_113648.f_9087.f_330[8 /*6*/]) return true;
if(Global_100085[echParam0 /*98*/]==joaat("cheetah") && !Global_113648.f_9087.f_330[8 /*6*/]) return true;
if(Global_100085[echParam0 /*98*/]==joaat("policeb") && !Global_113648.f_9087.f_330[8 /*6*/]) return true;
if(Global_100085[echParam0 /*98*/]==joaat("ztype") && !Global_113648.f_9087.f_330[9 /*6*/]) return true;
if(Global_100085[echParam0 /*98*/]==joaat("polmav") && !Global_113648.f_9087.f_330[9 /*6*/]) return true;
if(Global_100085[echParam0 /*98*/]==joaat("jb700") && !Global_113648.f_9087.f_330[10 /*6*/]) return true;
if(Global_100085[echParam0 /*98*/]==joaat("monroe") && !Global_113648.f_9087.f_330[11 /*6*/]) return true;
if(Global_100085[echParam0 /*98*/]==joaat("firetruk")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("handler")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("monroe")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("phantom")) return true;
if(Global_100085[echParam0 /*98*/]==joaat("gauntlet") && !Global_113648.f_9087.f_330[80 /*6*/] && !Global_113648.f_9087.f_330[81 /*6*/] && !Global_113648.f_9087.f_330[82 /*6*/]) return true;
return false;
}
...
if(iParam1 < 1 || iParam1 > func_184(num, num2)) return;
...
var func__186(BOOL bParam0, var uParam1, var uParam2) // Position - 0x100DD{
...
if(echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF) return;
Global_2028[iParam0 /*29*/].f_24[echParam1]=iParam2;
if(iParam0 < 162) Global_113648.f_28052[iParam0 /*29*/].f_24[echParam1]=iParam2;
return;
}
...
if(iParam0 < 162) Global_113648.f_28052[iParam0 /*29*/].f_12[echParam1]=iParam2;
return;
}
...
if(iParam0 < 162) Global_113648.f_28052[iParam0 /*29*/].f_19[echParam1]=iParam2;
return;
}
...
i < CHAR_MULTIPLAYER;
i=i + 1){
if(IS_BIT_SET(num, i)) func_199(i);
}
return;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_218(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_214() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_218(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_216(-1, false)==8;
...
if(func_219())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
iLocal_180=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uLocal_182.f_1.f_394, uLocal_182.f_1.f_397 *{
1.5f, 1.5f, 1.5f 
}
, 0f, false, 7);
...
if(ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(pedLocal_134)) ENTITY::DETACH_ENTITY(pedLocal_134, true, true);
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) bLocal_47=true;
else bLocal_47=false;
...
if(!ENTITY::IS_ENTITY_DEAD(veLocal_128, false))if(func_376(veLocal_128, CHAR_MICHAEL, 0)) iLocal_181=2;
elseif(ENTITY::DOES_ENTITY_EXIST(veLocal_128)) VEHICLE::DELETE_VEHICLE(&veLocal_128);
if(iLocal_181 !=2){
...
if(iLocal_181==1) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("tailgater"));
ENTITY::REMOVE_MODEL_HIDE(95.19f, -1293.4994f, 28.2672f, 1.5f, joaat("v_club_officechair"), false);
func_115(24, 0);
}}}}}elseif(!IS_BIT_SET(iLocal_43, 3)){
if(_CAN_ENTER_FREEROAM_STATE(0))if(func_385(&iLocal_46, 0, 0, false, 0)==1) MISC::SET_BIT(&iLocal_43, 3);
}else{
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_182.f_484), 0, 0, "MICHAEL", 1, 1);
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_182.f_484), 1, 0, "FRANKLIN", 1, 1);
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_182.f_484), 2, 0, "TREVOR", 1, 1);
...
func_225();
func_115(24, 0);
}}elseif(func_156(77) || _IS_MISSION_REPEAT_ACTIVE(false)){
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("BS_2A_2B_INT")) CUTSCENE::REMOVE_CUTSCENE();
if(iLocal_48 !=-1) func_223(&iLocal_48);
}
return;
}
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_224(*uParam0, false);
...
if(!uParam0->f_39)if(uParam0->f_7==4) return 1;
...
if(!bParam2){
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) && !FILES::GET_DLC_VEHICLE_FLAGS(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
else TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
if(PED::IS_PED_RAGDOLL(uParam0->[uParam0->f_7]) && !FILES::GET_DLC_VEHICLE_FLAGS(uParam0->[uParam0->f_7]) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(uParam0->[uParam0->f_7])) TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->[uParam0->f_7]);
else TASK::CLEAR_PED_TASKS(uParam0->[uParam0->f_7]);
}
ped=PLAYER::PLAYER_PED_ID();
character=_GET_CURRENT_PLAYER_CHARACTER();
if(!uParam0->f_23) func_274(ped, false);
...
case CHAR_MICHAEL:
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING("BulletTime")) GRAPHICS::ANIMPOSTFX_STOP("BulletTime");
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING("BulletTimeOut")) GRAPHICS::ANIMPOSTFX_STOP("BulletTimeOut");
break;
case CHAR_FRANKLIN:
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING("DrivingFocus")) GRAPHICS::ANIMPOSTFX_STOP("DrivingFocus");
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING("DrivingFocusOut")) GRAPHICS::ANIMPOSTFX_STOP("DrivingFocusOut");
break;
case CHAR_TREVOR:
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING("REDMIST")) GRAPHICS::ANIMPOSTFX_STOP("REDMIST");
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING("REDMISTOut")) GRAPHICS::ANIMPOSTFX_STOP("REDMISTOut");
break;
}
if(func_102(_GET_CURRENT_PLAYER_CHARACTER()))if(PLAYER::IS_SPECIAL_ABILITY_ACTIVE(PLAYER::PLAYER_ID(), 0)) PLAYER::SPECIAL_ABILITY_DEACTIVATE_FAST(PLAYER::PLAYER_ID(), 0);
...
if(iParam3 & 1 !=0) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 210, false);
...
if(uParam0->f_5==4) uParam0->f_5=3;
...
if(num < 25f && !PED::IS_PED_SWIMMING_UNDER_WATER(PLAYER::PLAYER_PED_ID())) ENTITY::SET_ENTITY_HEALTH(PLAYER::PLAYER_PED_ID(), SYSTEM::ROUND(((25f / 100f) * (SYSTEM::TO_FLOAT(PED::GET_PED_MAX_HEALTH(PLAYER::PLAYER_PED_ID())) - 100f)) + 100f), 0);
if(bParam1){
...
}}elseif(ENTITY::DOES_ENTITY_EXIST(ped)){
entityScript=ENTITY::GET_ENTITY_SCRIPT(ped, &script);
if(!MISC::IS_STRING_NULL(entityScript)){
if(!MISC::ARE_STRINGS_EQUAL(entityScript, SCRIPT::GET_THIS_SCRIPT_NAME())) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(ped, false, true);
PED::DELETE_PED(&ped);
}}
Global_97963=1;
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SET_AUTO_GIVE_PARACHUTE_WHEN_ENTER_PLANE(PLAYER::PLAYER_ID(), func_404(67));
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SET_AUTO_GIVE_SCUBA_GEAR_WHEN_EXIT_VEHICLE(PLAYER::PLAYER_ID(), func_404(68));
...
break;
case CHAR_FRANKLIN:
if(Global_113648.f_9087.f_330[2 /*6*/]) func_231(4, *uParam1);
func_231(7, *uParam1);
func_231(8, *uParam1);
func_231(11, *uParam1);
if(Global_113648.f_9087.f_99.f_58[126]) func_231(12, *uParam1);
break;
case CHAR_TREVOR:
if(Global_113648.f_9087.f_330[20 /*6*/]) func_231(4, *uParam1);
func_231(7, *uParam1);
func_231(8, *uParam1);
func_231(11, *uParam1);
break;
...
if(func_232(iParam0, pedParam1)) return;
...
i=i + 1){
if(eParam1==Global_41953[iParam0 /*31*/].f_25[i]) return true;
}
return false;
}
...
func_236(iParam0);
if(IS_BIT_SET(Global_38617[iParam0 / 32], iParam0 % 32)) func_235(iParam0);
}}
return;
}
...
if(IS_BIT_SET(vector.f_4, 2)) func_241(iParam0, &vector);
...
if(Global_113648.f_9087) num=func_238(iParam0);
else num=0;
if(func_403(14)) num=0;
...
if(func_102(character))if(IS_BIT_SET(Global_95708[0], character))if(iParam0 !=40) return 0;
else return 1;
break;
case 47:
case 48:
...
if(func_102(character))if(IS_BIT_SET(Global_95708[6], character)) return 0;
break;
case 51:
case 52:
if(character==CHAR_TREVOR){
if(IS_BIT_SET(Global_113648.f_7231[2], 0)) return 0;
if(func_102(character))if(IS_BIT_SET(Global_95708[2], character)) return 0;
}elseif(character==CHAR_MICHAEL){
if(IS_BIT_SET(Global_113648.f_7231[1], 0)) return 0;
if(func_102(character))if(IS_BIT_SET(Global_95708[1], character)) return 0;
}
break;
case 53:
if(character==CHAR_TREVOR)if(IS_BIT_SET(Global_113648.f_7231[3], 0)) return 0;
if(func_102(character))if(IS_BIT_SET(Global_95708[3], character)) return 0;
break;
default:
return 0;
}
...
if(func_247()==-1 || func_247()==999 && !func_246()==0) return true;
return false;
}
...
var unk;
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !func_102(_GET_CURRENT_PLAYER_CHARACTER()) || !func_261()) return;
unk=12;
unk.f_13=12;
unk.f_26=12;
unk.f_39=9;
...
if(bParam2==-1) bParam2=func_217();
if(echParam1 < false) echParam1=255;
...
if(func_258(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && pedParam0==PLAYER::PLAYER_PED_ID())if(func_258(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
else uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO, iParam3, 0);
}
return;
}
...
if(func_263() && func_262(0)) return true;
return false;
}


var func__262(int iParam0) // Position - 0x1738C{
return Global_1574538[iParam0];
}


var func__263() // Position - 0x1739C{
...
if(func_403(14)) character=_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID());
if(character==CHAR_MICHAEL) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(mainPlayerBlipId, "BLIP_MICHAEL" /*Michael*/);
elseif(character==CHAR_FRANKLIN) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(mainPlayerBlipId, "BLIP_FRANKLIN" /*Franklin*/);
elseif(character==CHAR_TREVOR) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(mainPlayerBlipId, "BLIP_TREV" /*Trevor*/);
else HUD::SET_BLIP_NAME_FROM_TEXT_FILE(mainPlayerBlipId, "BLIP_PLAYER" /*Player*/);
}
return;
}
...
if(pedWeapontypeInSlot !=0 && pedWeapontypeInSlot !=joaat("WEAPON_UNARMED") && pedWeapontypeInSlot !=joaat("OBJECT"))if(WEAPON::GET_AMMO_IN_PED_WEAPON(pedParam0, pedWeapontypeInSlot)==-1)if(WEAPON::GET_MAX_AMMO(pedParam0, pedWeapontypeInSlot, &ammo)) WEAPON::SET_PED_INFINITE_AMMO(pedParam0, false, pedWeapontypeInSlot);
}}
...
if(WEAPON::GET_AMMO_IN_PED_WEAPON(pedParam0, pedWeapontypeInSlot)==-1)if(WEAPON::GET_MAX_AMMO(pedParam0, pedWeapontypeInSlot, &ammo)) WEAPON::SET_PED_INFINITE_AMMO(pedParam0, false, pedWeapontypeInSlot);
}}
return;
}
...
if(pedParam0==PLAYER::PLAYER_PED_ID() && PED::GET_PED_MAX_HEALTH(pedParam0)==200) PED::SET_PED_MAX_HEALTH(pedParam0, SYSTEM::ROUND((float)PED::GET_PED_MAX_HEALTH(pedParam0) * Global_262145.f_107));
if(Global_113648.f_2365.f_539.f_290[character] <=0f) Global_113648.f_2365.f_539.f_290[character]=100f;
elseif(Global_113648.f_2365.f_539.f_290[character] <=10f) Global_113648.f_2365.f_539.f_290[character]=10f;
...
if(iParam0==0) return CHAR_MICHAEL;
elseif(iParam0==2) return CHAR_TREVOR;
elseif(iParam0==1) return CHAR_FRANKLIN;
return _CHAR_NULL;
}
...
func_273(8, *uParam1, false);
func_273(11, *uParam1, false);
if(Global_113648.f_9087.f_99.f_58[126]) func_273(12, *uParam1, false);
break;
case CHAR_TREVOR:
func_273(4, *uParam1, false);
func_273(7, *uParam1, false);
...
int i;
BOOL flag;
if(!bParam2)if(!ENTITY::DOES_ENTITY_EXIST(eParam1)) return;
if(Global_41953[iParam0 /*31*/].f_24==0) return;
flag=false;
for (i=0;
i < Global_41953[iParam0 /*31*/].f_24;
i=i + 1){
...
}elseif(eParam1==Global_41953[iParam0 /*31*/].f_25[i]){
Global_41953[iParam0 /*31*/].f_25[i]=0;
flag=true;
}}
if(flag) Global_41953[iParam0 /*31*/].f_24=Global_41953[iParam0 /*31*/].f_24 - 1;
return;
}
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_102(character) && !PED::IS_PED_INJURED(pedParam0))if(pedParam0==PLAYER::PLAYER_PED_ID()) Global_113648.f_2365.f_539.f_2328[character]=PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
return;
}
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_102(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_2318[character /*3*/]={
...
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_102(character) && !PED::IS_PED_INJURED(pedParam0)){
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && STREAMING::GET_PLAYER_SWITCH_TYPE() !=3)if(STREAMING::GET_PLAYER_SWITCH_STATE()==8) return;
Global_113648.f_2365.f_539.f_2300[character /*3*/]={
...
if(Global_113648.f_2365.f_539.f_2300[character /*3*/] >=8000f) Global_113648.f_2365.f_539.f_2300[character /*3*/]=7500f;
elseif(Global_113648.f_2365.f_539.f_2300[character /*3*/] <=-8000f) Global_113648.f_2365.f_539.f_2300[character /*3*/]=-7500f;
if(Global_113648.f_2365.f_539.f_2300[character /*3*/].f_1 >=8000f) Global_113648.f_2365.f_539.f_2300[character /*3*/].f_1=7500f;
elseif(Global_113648.f_2365.f_539.f_2300[character /*3*/].f_1 <=-8000f) Global_113648.f_2365.f_539.f_2300[character /*3*/].f_1=-7500f;
if(Global_113648.f_2365.f_539.f_2300[character /*3*/].f_2 >=2500f) Global_113648.f_2365.f_539.f_2300[character /*3*/].f_2=2000f;
}
return;
}
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_102(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_294[character]=PED::GET_PED_ARMOUR(pedParam0);
return;
}
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_102(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_290[character]=((SYSTEM::TO_FLOAT(ENTITY::GET_ENTITY_HEALTH(pedParam0)) - 100f) / (SYSTEM::TO_FLOAT(PED::GET_PED_MAX_HEALTH(pedParam0)) - 100f)) * 100f;
return;
}
...
j=0;
for (k=func_284(pedWeapontypeInSlot, j);
k !=0;
k=func_284(pedWeapontypeInSlot, j)){
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_102(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_2296[character]=func_180();
return;
}
...
if(iParam1 !=0 && iParam1 !=2 && iParam1 !=1){}else{
flag=uParam0->f_34[iParam1]==2;
if(func_269(_GET_CURRENT_PLAYER_CHARACTER()) !=iParam1 || flag){
flag2=false;
if(flag || uParam0->f_24[iParam1] !=0 || func_291(iParam1) && func_288(iParam1) && !uParam0->f_18[iParam1])if(!uParam0->f_23)if(!PED::IS_PED_INJURED(uParam0->[iParam1]) || flag)if(uParam0->f_34[iParam1] !=1 && uParam0->f_34[iParam1] !=3) flag2=true;
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0 && !IS_BIT_SET(Global_98159.f_47, iParam1)) flag2=true;
elseif(!(IS_BIT_SET(Global_113648.f_9087.f_2[27 /*3*/], 1) && !Global_3 && !_IS_MISSION_REPEAT_ACTIVE(false)))if(uParam0->f_23) flag2=true;
if(flag2){
uParam0->f_7=iParam1;
return 1;
}}}
...
if(Global_113648.f_9087 || Global_3)if(!Global_78558 || Global_78558 && iParam0 !=func_269(func_290()))if(!func_289(func_271(iParam0))) return 0;
return 1;
}
BOOL func_289(eCharacter echParam0) // Position - 0x19358{
if(func_102(echParam0))if(Global_113648.f_9087 || Global_3 || _IS_MISSION_REPEAT_ACTIVE(false)) return Global_113648.f_2365.f_539.f_2348[echParam0];
else return true;
return false;
}
...
if(Global_113648.f_9087 || Global_3 || _IS_MISSION_REPEAT_ACTIVE(false))if(!Global_78558 || Global_78558 && iParam0 !=func_269(func_290()))if(iParam0==0 && !func_404(115) || iParam0==1 && !func_404(116) || iParam0==2 && !func_404(117)) return 0;
return 1;
}
...
Vehicle vehicle;
if(iParam0==-1) return;
if(!func_304(&Global_77348.f_555[0 /*21*/], iParam0)) return;
...
if(iParam0==24) Global_113648.f_32751.f_4801=func_180();
if(veParam1 !=Global_77348.f_139[iParam0]){
if(iParam0==24){
vehicle=func_303(iParam0);
if(ENTITY::DOES_ENTITY_EXIST(vehicle) && VEHICLE::IS_VEHICLE_DRIVEABLE(vehicle, false) && veParam1 !=vehicle) func_294(vehicle, _CHAR_NULL);
}
...
if(hParam0==0) return false;
if(!func_166(hParam0, false, -1)) return false;
...
if(!func_166(entityModel, false, -1)) return true;
return false;
}
...
i < 9;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(Global_98012[i]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_98012[i], false))if(Global_98012[i]==veParam0 && ENTITY::GET_ENTITY_MODEL(Global_98012[i])==ENTITY::GET_ENTITY_MODEL(veParam0)) return 1;
}}
return 0;
}
...
for (i=0;
func_302(echParam1, i, &garageName, &num);
i=i + 1){
...
if(!func_178(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false)) *uParam0={
...
if(IS_BIT_SET(Global_77348.f_555[0 /*21*/].f_9, 13)) func_307(iParam0, false);
}
return;
}
...
if(uParam1->f_65==-1 && !func_316(uParam1->f_66)) uParam1->f_65=0;
...
i <=11;
i=i + 1){
if(VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1)) MISC::SET_BIT(&(uParam1->f_77), func_314(i + 1));
}
...
if(echParam1==CHAR_TREVOR)if(ENTITY::GET_ENTITY_MODEL(*uParam0)==joaat("bodhi2")) func_358(uParam0);
...
if(ENTITY::GET_ENTITY_MODEL(*uParam0)==joaat("bodhi2")) func_358(uParam0);
...
if(flag) func_357(*uParam0, echParam1);
return 1;
}}}
return 0;
}
...
entityModel=ENTITY::GET_ENTITY_MODEL(veParam0);
if(!func_355(entityModel, bParam1, uParam2) && !func_354(PLAYER::PLAYER_ID()) && !func_335(veParam0)) return false;
if(func_354(PLAYER::PLAYER_ID()))if(func_333(entityModel)) return true;
else return false;
flag=false;
if(func_332(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(entityModel) || VEHICLE::IS_THIS_MODEL_A_PLANE(entityModel)) flag=true;
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_326(Global_2657589[plParam0 /*466*/].f_321.f_7)==11;
return false;
}
...
case joaat("monster4"):
case joaat("monster5"):
if(func_331(PLAYER::PLAYER_ID())) return true;
break;
case joaat("minitank"):
case joaat("burrito2"):
return true;
case -1576586413:
if(func_330(PLAYER::PLAYER_ID())) return true;
break;
case -1627077503:
return true;
}
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_326(Global_2657589[plParam0 /*466*/].f_321.f_7)==26;
return false;
}
BOOL func_331(Player plParam0) // Position - 0x1F78F{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_326(Global_2657589[plParam0 /*466*/].f_321.f_7)==13;
return false;
}
BOOL func_332(Player plParam0) // Position - 0x1F7D6{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_326(Global_2657589[plParam0 /*466*/].f_321.f_7)==7;
return false;
}
BOOL func_333(Hash hParam0) // Position - 0x1F81C{
if(hParam0==joaat("oppressor2")) return false;
if(!func_334(PLAYER::PLAYER_ID()) && hParam0 !=joaat("thruster") && hParam0 !=joaat("avenger")) return false;
return true;
}
...
if(func_353(PLAYER::PLAYER_ID()) || func_352(PLAYER::PLAYER_ID()))if(func_336(veParam0)) return true;
return false;
}
...
if(func_340(veParam0, false)) return true;
if(func_339(PLAYER::PLAYER_ID()) && !func_333(ENTITY::GET_ENTITY_MODEL(veParam0)) || VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("thruster"))) return false;
if(DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))if(DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle")==NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))if(!func_337(veParam0)) return true;
return false;
}
...
if(ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false)){
entityModel=ENTITY::GET_ENTITY_MODEL(veParam0);
if(VEHICLE::IS_BIG_VEHICLE(veParam0) && !func_329(veParam0) || func_338(entityModel)) return true;
switch (entityModel){
...
if(func_354(plParam0) && Global_2657589[plParam0 /*466*/].f_321.f_10==plParam0) return true;
return false;
}
...
if(func_342(ENTITY::GET_ENTITY_MODEL(veParam0), 0))if(Global_2793044.f_304==veParam0) return true;
elseif(func_341(veParam0) !=-1 && !bParam1) return true;
break;
}
return false;
}
...
if(iParam1==0)if(func_351(hParam0, 0)) return true;
switch (hParam0){
case joaat("faction"):
...
return func_350();
case joaat("sabregt"):
if(Global_262145.f_14734) return func_349();
break;
case joaat("tornado"):
case joaat("tornado2"):
case joaat("tornado3"):
if(Global_262145.f_14735) return func_349();
break;
case joaat("virgo3"):
if(Global_262145.f_14733) return func_349();
break;
case joaat("minivan"):
if(Global_262145.f_14736) return func_349();
break;
case joaat("slamvan"):
if(Global_262145.f_14738) return func_349();
break;
case joaat("sultan"):
case joaat("banshee"):
return func_348();
case joaat("comet2"):
if(Global_262145.f_19141) return func_347();
break;
case joaat("diablous"):
if(Global_262145.f_19143) return func_347();
break;
case joaat("fcr"):
if(Global_262145.f_19147) return func_347();
break;
case joaat("elegy2"):
if(Global_262145.f_19144) return func_347();
break;
case joaat("nero"):
if(Global_262145.f_19151) return func_347();
break;
case joaat("italigtb"):
if(Global_262145.f_19149) return func_347();
break;
case joaat("specter"):
if(Global_262145.f_19154) return func_347();
break;
case joaat("technical"):
if(Global_262145.f_21100) return func_346();
break;
case joaat("insurgent"):
if(Global_262145.f_21101) return func_346();
break;
case joaat("ratloader"):
case joaat("ratloader2"):
return func_345();
case joaat("glendale"):
if(func_345() || func_344()) return true;
break;
case joaat("impaler"):
return func_345();
case joaat("issi3"):
...
return func_345();
case joaat("youga2"):
if(Global_262145.f_29332) return func_344();
break;
case joaat("gauntlet3"):
if(Global_262145.f_29682) return func_344();
break;
case joaat("manana"):
if(Global_262145.f_29331) return func_344();
break;
case joaat("peyote"):
if(Global_262145.f_29681) return func_344();
break;
case joaat("yosemite"):
if(Global_262145.f_29680) return func_344();
break;
}
switch (hParam0){
case joaat("tenf"):
if(*Global_262145.f_33139) return func_343();
break;
case joaat("weevil"):
if(*Global_262145.f_33138) return func_343();
break;
case joaat("brioso2"):
if(*Global_262145.f_33131) return func_343();
break;
case joaat("sentinel3"):
if(*Global_262145.f_33140) return func_343();
break;
}
return false;
}
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1 && Global_2657589[plParam0 /*466*/].f_321.f_10 !=_INVALID_PLAYER_INDEX()) return func_326(Global_2657589[plParam0 /*466*/].f_321.f_7)==5;
return false;
}
BOOL func_353(Player plParam0) // Position - 0x2043E{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1 && Global_2657589[plParam0 /*466*/].f_321.f_10 !=_INVALID_PLAYER_INDEX()) return func_326(Global_2657589[plParam0 /*466*/].f_321.f_7)==8;
return false;
}
BOOL func_354(Player plParam0) // Position - 0x2049E{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_326(Global_2657589[plParam0 /*466*/].f_321.f_7)==9;
return false;
}
...
flag=false;
if(func_332(PLAYER::PLAYER_ID()) && VEHICLE::IS_THIS_MODEL_A_HELI(hParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(hParam0)) flag=true;
...
if(!func_359(*uParam0)) VEHICLE::SET_VEHICLE_EXTRA(*uParam0, 5, !Global_113648.f_9087.f_99.f_58[119]);
return;
}
...
}elseif(func_365(*uParam0, modType, uParam1->[i] - 1)){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, modType, uParam1->[i] - 1, false);
}}}}
if(func_351(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_363(*uParam0, uParam1->[38] - 1)) VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_363(*uParam0, uParam1->[38] - 1), false);
func_362(uParam0);
if(func_361(*uParam0)){
...
i >=0 && func_365(veParam0, iParam1, i);
i=i - 1){}
return i;
}
BOOL func_365(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x20E6E{
if(!func_366() && PED::APPLY_PED_BLOOD_SPECIFIC(veParam0, iParam1, iParam2)) return true;
return false;
}
...
if(bParam18) func_374(playersLastVehicle);
...
if(entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)if(func_371(playersLastVehicle, vParam0, vParam3, fParam6)) flag=true;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
...
if(bParam16)if(func_301(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true)) flag=false;
if(flag){
...
Vector3 func__373(float fParam0, var uParam1, var uParam2) // Position - 0x216D0{
float num;
float num2;
...
Vector3 func__375() // Position - 0x21774{
...
i < 9;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(Global_98012[i]))if(Global_98012[i]==veParam0)if(echParam1==_CHAR_NULL || echParam1==Global_98022[i])if(iParam2==0 || ENTITY::GET_ENTITY_MODEL(veParam0)==func_305(echParam1, iParam2)) return true;
}
return false;
}
...
entityCoords2={
ENTITY::GET_ENTITY_COORDS(Global_100384[character], true) 
};
...
if(VEHICLE::GET_VEHICLE_TRAILER_VEHICLE(veParam1, &trailer)) hParam2->f_1=ENTITY::GET_ENTITY_MODEL(trailer);
...
if(VEHICLE::GET_VEHICLE_NEON_ENABLED(veParam1, 2)) MISC::SET_BIT(&(hParam2->f_92), 28);
else MISC::CLEAR_BIT(&(hParam2->f_92), 28);
if(VEHICLE::GET_VEHICLE_NEON_ENABLED(veParam1, 3)) MISC::SET_BIT(&(hParam2->f_92), 29);
else MISC::CLEAR_BIT(&(hParam2->f_92), 29);
if(VEHICLE::GET_VEHICLE_NEON_ENABLED(veParam1, 0)) MISC::SET_BIT(&(hParam2->f_92), 30);
else MISC::CLEAR_BIT(&(hParam2->f_92), 30);
if(VEHICLE::GET_VEHICLE_NEON_ENABLED(veParam1, 1)) MISC::SET_BIT(&(hParam2->f_92), 31);
else MISC::CLEAR_BIT(&(hParam2->f_92), 31);
...
if(convertibleRoofState==0 || convertibleRoofState==5) hParam2->f_24=1;
else hParam2->f_24=0;
}else{
hParam2->f_24=0;
}
if(pedParam0==PLAYER::PLAYER_PED_ID()) hParam2->f_25=AUDIO::GET_PLAYER_RADIO_STATION_INDEX();
...
switch (character){
case CHAR_MICHAEL:
if(Global_113648.f_32751.f_69[0 /*78*/].f_66==ENTITY::GET_ENTITY_MODEL(veParam1)) *uParam6=12;
break;
case CHAR_FRANKLIN:
if(Global_113648.f_32751.f_69[1 /*78*/].f_66==ENTITY::GET_ENTITY_MODEL(veParam1)) *uParam6=13;
break;
case CHAR_TREVOR:
if(Global_113648.f_32751.f_69[2 /*78*/].f_66==ENTITY::GET_ENTITY_MODEL(veParam1)) *uParam6=14;
break;
}}else{
*iParam5=0;
*uParam3={
...
if(iParam4 !=0) func_386(uParam0, iParam4);
}
return 2;
}
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_400(uParam0);
elseif(num < fParam1 * fParam1 || IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(uParam0->f_449, 0))if(func_399(uParam0))if(IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(Global_96692, *uParam0)) func_394(uParam0);
else func_394(uParam0);
else func_393(uParam0);
if(num > fParam2 * fParam2 && !IS_BIT_SET(Global_96690, *uParam0)){
if(IS_BIT_SET(uParam0->f_449, 0)){
if(IS_BIT_SET(uParam0->f_449, 1)) func_391(uParam0);
func_390(uParam0);
}}}
return;
}
...
if(uParam0->f_413 !=0) GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&(uParam0->f_413));
if(uParam0->f_414 !=0) GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&(uParam0->f_414));
...
if(IS_BIT_SET(uParam0->f_449, 1)){
if(!CUTSCENE::IS_CUTSCENE_PLAYING())if(IS_BIT_SET(uParam0->f_449, 2)) func_70(uParam0, false);
func_392(uParam0);
...
i < uParam0->f_1.f_33;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_428[i])) OBJECT::DELETE_OBJECT(&uParam0->f_428[i]);
}
return;
}
...
if(!AUDIO::HAS_LOADED_SP_DATA_SET()) return;
...
vector={
func_396(uParam0, &uParam0->f_1.f_34[i /*2*/]) 
};
...
Vector3 func__396(var uParam0, var uParam1) // Position - 0x22637{
float num;
float num2;
float num3;
float num4;
...
value2=0;
if(func_33(num, uParam0->f_1.f_258[i])) value2=1;
NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(uParam0->f_413, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(value);
...
if(!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam0->f_413)) return false;
if(!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam0->f_414)) return false;
if(!HUD::HAS_ADDITIONAL_TEXT_LOADED(5)) return false;
if(AUDIO::HAS_LOADED_SP_DATA_SET())if(!AUDIO::REQUEST_SCRIPT_AUDIO_BANK("HEIST_BULLETIN_BOARD", false, -1)) return false;
else return false;
if(*uParam0 !=1)if(!STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_planning_pin_01")) || !STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_planning_pin_02")) || !STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_planning_pin_03"))) return false;
...
GRAPHICS::DRAW_SCALEFORM_MOVIE_3D(uParam0->f_413, uParam0->f_401 +{
num2, num * SYSTEM::COS(90f - uParam0->f_404), num * SYSTEM::SIN(90f - uParam0->f_404) 
}
, 180f, 0f, uParam0->f_404, 1f, 1f, 1f, uParam0->f_1.f_6, uParam0->f_1.f_7, 1f, 2);
}
return;
}
...
ENTITY::SET_ENTITY_HAS_GRAVITY(uParam0->f_428[i], false);
ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_428[i], true);
}}elseif(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_428[i])){
...
if(bParam0) Global_112670=0;
else Global_112670=1;
return;
}


void func_406(int iParam0, int iParam1, BOOL bParam2) // Position - 0x22CAF{
if(bParam2) MISC::SET_BIT(&Global_113648.f_1.f_120[iParam0], iParam1);
else MISC::CLEAR_BIT(&Global_113648.f_1.f_120[iParam0], iParam1);
...
*uParam0=iParam1;
unk={
Global_96627[uParam0->f_1.f_1 /*15*/].f_3 
};
...
uParam0->f_405={
unk +{
0f, -uParam0->f_1.f_8 * SYSTEM::COS(360f - unk4), -uParam0->f_1.f_8 * SYSTEM::SIN(360f - unk4) 
}};
uParam0->f_408={
-0.85f, 0f, unk4 
};
...
if(bParam5) MISC::SET_BIT(&(uParam0->f_370), uParam0->f_369);
...
TEXT_LABEL_COPY(&uParam0->f_211[uParam0->f_209 /*4*/],{
unk 
}
, 4);
...
var unk;
TEXT_LABEL_ASSIGN_STRING(&unk, sParam2, 8);
if(MISC::ARE_STRINGS_EQUAL(sParam2, "")) return;
...
var func__419(var uParam0, var uParam1) // Position - 0x2368C{
if(uParam0 > uParam1) return uParam0;
return uParam1;
}
...
if(iLocal_48 !=-1) func_223(&iLocal_48);
CUTSCENE::REMOVE_CUTSCENE();
if(iLocal_46 !=-1) func_160(&iLocal_46);
SCRIPT::TERMINATE_THIS_THREAD();
return;
}
BOOL func_422(var uParam0) // Position - 0x237A7{
if(IS_BIT_SET(uParam0->f_449, 1)) func_391(uParam0);
if(IS_BIT_SET(uParam0->f_449, 0)) func_390(uParam0);
return true;
}