...
Var3={
ENTITY::GET_ENTITY_COORDS(uLocal_82, 1) 
};
...
char* func_21(){
if(MISC::IS_BIT_SET(Global_113648.f_24988, 3)){
return "BB4_loiter";
}elseif(MISC::IS_BIT_SET(Global_113648.f_24988, 2)){
return "BB3_loiter";
}elseif(MISC::IS_BIT_SET(Global_113648.f_24988, 1)){
return "BB2_loiter";
}elseif(MISC::IS_BIT_SET(Global_113648.f_24988, 0)){
return "BB1_loiter";
}
return "MAUDE_loiter";
}
...
float fVar6;
Var0={
func_31(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
float fVar6;
Var0={
func_31(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
iLocal_80=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, joaat("prop_table_03b"), 1, 0, 1);
if(func_8(iLocal_80)){
...
iLocal_81=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, joaat("prop_laptop_01a"), 0, 0, 1);
if(func_8(iLocal_81)){
...
iLocal_79=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, joaat("prop_table_03_chr"), 0, 0, 1);
if(func_8(iLocal_79)){
