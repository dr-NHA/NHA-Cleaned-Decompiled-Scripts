...
flag=false;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_153(true);
pedLocal_85=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
iLocal_95=0;
func_151(&Global_112299, 0);
func_145();
MISC::SET_THIS_IS_A_TRIGGER_SCRIPT(true);
if(func_144(iLocal_94, 1)) iLocal_100=10;
else iLocal_100=9;
while (!Global_38596){
SYSTEM::WAIT(0);
}
if(!func_144(iLocal_94, 8))if(!_CAN_ENTER_FREEROAM_STATE(iLocal_100))if(func_141(0, iLocal_99)) func_153(false);
else func_153(true);
if(iLocal_99 !=-1)if(!func_141(0, iLocal_99)) bLocal_118=false;
if(func_144(iLocal_94, 8388608)) func_153(true);
if(func_144(iLocal_94, 524288) && func_140() && !func_139()) func_153(true);
...
pedLocal_85=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
if(func_144(iLocal_94, 1048576))if(ENTITY::IS_ENTITY_DEAD(pedLocal_85, false)) func_153(true);
...
if(func_144(iLocal_94, 524288) && func_140() && !func_139()) func_153(true);
if(func_114()) func_153(true);
if(!func_106(6) || Global_112695 || func_105()) flag3=false;
if(!bLocal_118){
...
if(func_101(true)) flag3=false;
if(Global_78558) flag3=false;
if(func_100()) flag3=false;
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) flag3=false;
if(func_99() || func_98(8, -1)) flag3=false;
...
if(func_97(0) || func_96()) flag3=false;
if(flag3){
...
}}}elseif(clockHours < iLocal_119 || clockHours >=iLocal_120){
func_103(&iLocal_94, 128);
flag3=false;
if(fLocal_93 < (fLocal_117 * fLocal_117) + 4f){
if(!func_144(iLocal_94, 134217728)){
...
elseif(!func_144(iLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
if(func_144(iLocal_94, 2097152))if(!func_116(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_52)) func_137(10);
...
func_5();
func_151(&Global_112299, 0);
if(func_144(iLocal_94, 16777216)) func_153(true);
if(iLocal_99 !=-1)if(Global_113648.f_9087)if(!func_141(0, iLocal_99)) func_153(true);
}
func_4();
break;
case 8:
...
case 7:
func_2();
if(iLocal_105 !=263) func_138(iLocal_105, false, false);
if(iLocal_96 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_96);
...
func_145();
if(iLocal_105 !=263) func_138(iLocal_105, true, false);
func_137(0);
}}}elseif(iLocal_106==0){
if(fLocal_110 > fLocal_102 * fLocal_102){
if(iLocal_105 !=263){
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(scenarioGroup))if(TASK::DOES_SCENARIO_GROUP_EXIST(scenarioGroup))if(TASK::IS_SCENARIO_GROUP_ENABLED(scenarioGroup)) TASK::SET_SCENARIO_GROUP_ENABLED(scenarioGroup, false);
return;
}
...
}elseif(MISC::IS_PS3_VERSION() || func_22()){
...
if(func_28(piParam0))if(func_27(piParam0)) return piParam0->f_2;
else return func_26(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;
return piParam0->f_1;
}
...
if(!func_28(piParam0)) func_37(piParam0);
else func_35(piParam0);
return;
}
...
if(!func_28(piParam0)) func_35(piParam0);
return;
}
...
i < func_55();
i=i + 1){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_329[i /*14*/]) || !ENTITY::DOES_ENTITY_EXIST(iLocal_329[i /*14*/].f_1)) return false;
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_329.f_83) || !ENTITY::DOES_ENTITY_EXIST(iLocal_329.f_83.f_1)) return false;
return true;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_157) && !ENTITY::IS_ENTITY_DEAD(pedLocal_157, false))if(AUDIO::IS_AMBIENT_SPEECH_PLAYING(pedLocal_157)) return;
if(func_25(&uLocal_147) >=8f){
num=(MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 3) + 1;
if(num > 0 && num <=3){
if(ENTITY::IS_ENTITY_DEAD(iLocal_329[num - 1 /*14*/], false)) return;
switch (num){
case 1:
str="ORR_GUY1";
break;
...
if(func_61(PLAYER::PLAYER_ID())) return false;
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_71(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_71(character)) return func_74(character);
...
if(!bLocal_162) func_80(pedLocal_157, "PRERACE_CHAT", "A_M_Y_RACER_01_WHITE_MINI_01", 11);
else func_80(pedLocal_157, "PRERACE_TAUNT", "A_M_Y_RACER_01_WHITE_MINI_01", 11);
iLocal_328=3;
}
break;
case 3:
...
bLocal_161=true;
iLocal_328=1;
}elseif(func_25(&uLocal_144) >=10f && !bLocal_162){
bLocal_162=true;
iLocal_328=1;
}}
break;
...
TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
if(!PED::IS_PED_INJURED(iLocal_329[i /*14*/])) TASK::TASK_PERFORM_SEQUENCE(iLocal_329[i /*14*/], taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
}
...
if(!iLocal_329[i /*14*/].f_10 && PED::IS_PED_RAGDOLL(iLocal_329[i /*14*/]) || TASK::IS_PED_GETTING_UP(iLocal_329[i /*14*/])) iLocal_329.f_101=iLocal_329.f_101 + 1;
iLocal_329[i /*14*/].f_10=1;
}elseif(iLocal_329[i /*14*/].f_10){
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_329.f_83.f_1, false)) veLocal_86=iLocal_329.f_83.f_1;
...
TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
if(!PED::IS_PED_INJURED(iLocal_329.f_83)) TASK::TASK_PERFORM_SEQUENCE(iLocal_329.f_83, taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
}
func_35(&uLocal_141);
...
if(!iLocal_329.f_83.f_10) iLocal_329.f_101=iLocal_329.f_101 + 1;
iLocal_329.f_83.f_10=1;
}elseif(iLocal_329.f_83.f_10){
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000);
TASK::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_83(), 1090519040, -1056964608, -1, 0, 0, false, false, false);
TASK::TASK_ACHIEVE_HEADING(0, iLocal_329.f_83.f_9, 1000);
...
if(iLocal_329.f_101 >=3) return true;
if(ENTITY::DOES_ENTITY_EXIST(pedParam0)){
if(!PED::IS_PED_INJURED(pedParam0)){
entityCoords={
ENTITY::GET_ENTITY_COORDS(pedParam0, true) 
};
if(bParam1)if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), true)) return true;
if(bParam2)if(PED::IS_PED_IN_COMBAT(pedParam0, target)) return true;
if(bParam4)if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(target, pedParam0)) return true;
if(bParam3)if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))if(func_88(pedParam0, true) < 20f) return true;
...
if(PED::IS_PED_FLEEING(pedParam0)) return true;
...
if(PED::IS_PED_BEING_JACKED(pedParam0))if(PED::GET_PEDS_JACKER(pedParam0)==target) return true;
...
if(ENTITY::DOES_ENTITY_EXIST(veParam0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veParam0, false)) return false;
else return true;
return true;
}
...
if(!func_71(character)) return false;
switch (iParam0){
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_113() || Global_112695 || Global_32166 || func_112() || func_98(8, -1) || func_111() || func_110() || func_109() || func_100() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_113() || Global_32166 || func_112() || func_98(8, -1) || func_109() || func_111() || func_110() || func_100() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_113() || Global_112695 || Global_32166 || func_112() || func_98(8, -1) || func_109() || func_111() || func_110() || func_100() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_113() || Global_112695 || Global_32166 || func_112() || func_98(8, -1) || func_111() || func_110() || func_100() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_113() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_98(8, -1) || func_100() || func_108() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_98(8, -1) || func_111() || func_110() || func_108() || func_107()) return false;
...
return true;
case 1:
if(func_118(6) || func_118(7)) return true;
else return func_116(3);
break;
case 2:
return true;
case 3:
if(_CAN_ENTER_FREEROAM_STATE(5))if(func_106(4)) return true;
break;
}
return false;
}
...
char* scenarioGroup;
clockHours=CLOCK::GET_CLOCK_HOURS();
if(clockHours <=iLocal_119 && clockHours >=iLocal_120 || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return;
if(bLocal_158){
func_129();
func_128();
switch (iLocal_124){
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(scenarioGroup))if(TASK::DOES_SCENARIO_GROUP_EXIST(scenarioGroup))if(!TASK::IS_SCENARIO_GROUP_ENABLED(scenarioGroup)) TASK::SET_SCENARIO_GROUP_ENABLED(scenarioGroup, true);
}
func_120();
return;
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_329.f_83, taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
}}elseif(fLocal_110 < 225f){}
pedLocal_157=iLocal_329.f_83;
if(!ENTITY::IS_ENTITY_DEAD(iLocal_329[0 /*14*/], false)) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_163, 1, iLocal_329[0 /*14*/], "MALE1", 0, 1);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_329[1 /*14*/], false)) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_163, 2, iLocal_329[1 /*14*/], "MALE2", 0, 1);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_329[2 /*14*/], false)) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_163, 3, iLocal_329[3 /*14*/], "MALE3", 0, 1);
if(!func_28(&uLocal_147)) func_37(&uLocal_147);
else func_35(&uLocal_147);
return;
}
...
i < iLocal_329.f_71;
i=i + 1){
if(STREAMING::IS_MODEL_A_VEHICLE(iLocal_329.f_71[i])) randomIntInRange=randomIntInRange + 1;
}
if(iLocal_124==1)if(!bParam0) randomIntInRange=randomIntInRange - 1;
...
if(iLocal_105 !=263)if(func_146(iLocal_105, true)) iLocal_105=263;
func_84(iLocal_105);
}
if(iLocal_124==2){
iLocal_119=20;
...
if(iLocal_124==1 || iLocal_124==5) sLocal_101="PLAY_OFFROAD_V" /*Press ~INPUT_CONTEXT~ to enter an offroad truck race.*/;
else sLocal_101="PLAY_OFFROAD_M" /*Press ~INPUT_CONTEXT~ to enter an offroad motorcycle / ATV race.*/;
return;
}
...
num=iParam0;
if(num < 0 || num >=263 || iParam0==263) return false;
if(bParam1) return IS_BIT_SET(Global_32543[num /*23*/].f_11, 15);
...
Vector3 func__150(int iParam0) // Position - 0x60BD{
if(iParam0 >=7 || iParam0 <=-1) return 0f, 0f, 0f;
switch (iParam0){
case 0:
...
if(bParam0)if(iLocal_105 !=263) func_138(iLocal_105, 0, false);
_CONTEXT_REMOVE_HELP_TEXT(&iLocal_96);
