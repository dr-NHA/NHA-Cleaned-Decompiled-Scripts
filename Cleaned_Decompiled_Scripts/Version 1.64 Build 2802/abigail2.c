...
Local_163={
-1573.733f, 5164.508f, 18.5576f 
};
fLocal_166=175.9451f;
Local_347={
-1014.054f, -2474.013f, 19.1091f 
};
Local_100={
ScriptParam_0 
};
...
func_237(3);
}}elseif(func_235(PLAYER::PLAYER_PED_ID(), iLocal_169) > 250f){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX())==0){
iLocal_168=2;
}else{
func_237(3);
...
TASK::TASK_SMART_FLEE_PED(iLocal_169, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
}
if(iLocal_338==0){
...
iLocal_338=1;
}}elseif(((((iLocal_346 < 15 && !func_232()) && (MISC::GET_GAME_TIMER() - iLocal_343) > 10000) && func_231(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_169)) && func_214(&uLocal_173, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0)){
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_249(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=0;
}}elseif(func_262(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_263(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
HUD::SET_BLIP_AS_FRIENDLY(iLocal_170, 0);
...
switch (iLocal_168){
case 0:
uLocal_353=PED::ADD_SCENARIO_BLOCKING_AREA(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
func_300();
if(func_472(iLocal_169)){
func_298();
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_344);
...
TASK::TASK_VEHICLE_PARK(0, iLocal_162, Local_347, 49.567f, 3, 1092616192, 0);
TASK::TASK_LEAVE_VEHICLE(0, iLocal_162, 256);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_344);
TASK::TASK_PERFORM_SEQUENCE(iLocal_169, uLocal_344);
}else{
TASK::TASK_WANDER_STANDARD(iLocal_169, 1193033728, 0);
}}
...
func_275();
func_237(4);
}elseif(ENTITY::IS_ENTITY_AT_COORD(iLocal_169, Local_347, 5f, 5f, 5f, 0, 1, 0)){
func_237(3);
}else{
func_273(&iLocal_170, "", "", &iLocal_171, iLocal_172, 0);
if(iLocal_339==0){
if(((func_472(iLocal_162) && PED::IS_PED_IN_VEHICLE(iLocal_169, iLocal_162, 1)) && func_231(iLocal_169, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_214(&uLocal_173, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0)){
iLocal_339=1;
}
...
if(func_472(iLocal_162)){
if(PED::IS_PED_IN_VEHICLE(iLocal_169, iLocal_162, 0) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_162, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
if(((VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_162, 0, 0) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_162, 1, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_162, 4, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_162, 5, 0)){
return 1;
}}}
return 0;
}
...
if(bParam4){
return 0;
}elseif(func_279(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__283(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_287(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_287(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
float fVar6;
Var0={
func_287(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_169, 0);
TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_169, 0);
}}
...
void func_300(){
if(!func_472(iLocal_162)){
iLocal_162=VEHICLE::CREATE_VEHICLE(iLocal_161, Local_163, fLocal_166, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_162, 1);
}}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_169, 0, 0);
}
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_308() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_308() /*5568*/].f_681.f_10, iParam0);
}


var func__311(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_19();
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_336(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_358(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
Var4={
func_371(Global_78814, Global_78816, iParam10) 
};
if(fVar7==-0.014f){
}
...
if(!func_390()){
func_388(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
}
func_387(0, -1, 1);
func_386(1, 1, 1);
}
...
iLocal_162=VEHICLE::CREATE_VEHICLE(iLocal_161, Param12, fParam15, 1, 1, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_161, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_161);
func_300();
if(func_347(Param8)){
...
var uVar5;
var uVar6;
if((func_161(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0)){
...
return 1;
}elseif(func_419(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_348(iParam0, 0, 0)) || func_348(iParam0, 1, 0)) || func_348(iParam0, 2, 0)) || func_453(iParam0) !=145) || func_452(iParam0)) || func_451(iParam0)) || func_403(iParam0)) || func_450(iParam0)) || !func_440(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_451(iParam0)){
}
if(func_451(iParam0)){
}
...
}elseif(func_462(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_353, 0);
if(iParam0==1){
