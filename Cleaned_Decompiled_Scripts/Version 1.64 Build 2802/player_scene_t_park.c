...
fLocal_141=-1f;
fLocal_142=-1f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_66();
SYSTEM::WAIT(0);
func_54();
func_53();
func_49();
...
switch (iLocal_69){
case 0:
if(func_37()) iLocal_69=1;
break;
case 1:
if(func_2()) iLocal_69=2;
break;
case 2:
func_1();
break;
...
if(MISC::ARE_STRINGS_EQUAL(&uLocal_106, "scr_meth_pipe_smoke")) func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0, -1);
iLocal_223=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_223, &uLocal_207, PLAYER::PLAYER_PED_ID(), &uLocal_191, false, 0);
iLocal_224=iLocal_224 + 1;
}
}
elseif(GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&uLocal_106, obLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, false, false, false)){
if(MISC::ARE_STRINGS_EQUAL(&uLocal_106, "scr_meth_pipe_smoke")) func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0, -1);
iLocal_223=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_223, &uLocal_207, PLAYER::PLAYER_PED_ID(), &uLocal_191, false, 0);
iLocal_224=iLocal_224 + 1;
...
break;
case 2:
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_122))if(GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(&uLocal_122, uLocal_83 + uLocal_138, 0f, 0f, 0f, 1f, false, false, false)) iLocal_224=iLocal_224 + 1;
else iLocal_224=iLocal_224 + 1;
break;
case 3:
break;
}
if(ENTITY::DOES_ENTITY_EXIST(obLocal_72))if(ENTITY::IS_ENTITY_ATTACHED(obLocal_72))if(iLocal_82 !=-1)if(synchronizedScenePhase > fLocal_81) func_3(&obLocal_72, iLocal_82);
}else{
if(iLocal_88 !=0){
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_72))if(ENTITY::IS_ENTITY_ATTACHED(obLocal_72))if(iLocal_82 !=-1) func_3(&obLocal_72, iLocal_82);
return true;
}}else{
func_66();
return false;
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(*pobParam0, true) 
};
entityRotation={
ENTITY::GET_ENTITY_ROTATION(*pobParam0, 2) 
};
ENTITY::SET_ENTITY_COORDS(*pobParam0, entityCoords +{
0.1f, 0f, 0f 
}
, true, false, false, true);
ENTITY::SET_ENTITY_ROTATION(*pobParam0, entityRotation, entityRotation.f_1, entityRotation.f_2, 2, true);
}
if(ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("p_defilied_ragdoll_01_s")) ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(pobParam0);
return 1;
case 1:
...
case 3:
if(ENTITY::IS_ENTITY_ATTACHED(*pobParam0)) ENTITY::DETACH_ENTITY(*pobParam0, true, true);
if(ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("prop_chateau_table_01") && ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("v_res_tt_flusher") && ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("v_ilev_fh_lampa_on") && ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("prop_cs_remote_01")) ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*pobParam0, -8f, true);
if(ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("v_ilev_fh_dineeamesa") && ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("v_res_tt_flusher") && ENTITY::GET_ENTITY_MODEL(*pobParam0) !=joaat("v_ilev_fh_lampa_on")) ENTITY::FREEZE_ENTITY_POSITION(*pobParam0, false);
ENTITY::SET_ENTITY_DYNAMIC(*pobParam0, true);
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(pobParam0);
return 1;
case 4:
...
if(Global_20383.f_1 !=1) func_7(true);
SYSTEM::WAIT(0);
}
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_GAME_STREAM);
...
if(!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PISTOL"), false)) WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PISTOL"), 30, false, true);
...
if(func_6(num, &animName, &unk36, &any))if(func_4(num, &animDict, &unk67, &unk83, &unk99, &unk100))if(!ENTITY::IS_ENTITY_PLAYING_ANIM(*pobParam0, &animDict, &animName, 2)) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*pobParam0, Global_98011, &animName, &animDict, 1000f, -8f, any, 1148846080);
...
if(func_12()) return;
if(Global_20584)if(func_11()) func_10(true, true);
else func_10(false, false);
if(Global_20383.f_1==10 || Global_20383.f_1==9) MISC::SET_BIT(&Global_8254, 16);
...
if(func_16()) return Global_98791;
return 318;
}
...
if(func_36(pedParam0) + iParam2 > 10) iParam2=10 - func_36(pedParam0);
num=20000;
...
if(iParam1==-1) return;
if(iParam2==6) return;
if(func_21(iParam0, iParam1, iParam2)) return;
num=func_20();
if(num==-1) return;
...
if(func_22(iParam0, iParam1, iParam2)==-1) return false;
return true;
}
...
if(func_35(pedParam0)==-1) return false;
return true;
}
...
ENTITY::SET_ENTITY_ROTATION(obLocal_72,{
fLocal_86, 0f, 0f 
}
+ uLocal_77, 2, true);
...
if(!func_38()){
if(ENTITY::DOES_ENTITY_EXIST(obLocal_72))if(iLocal_80 !=-1)if(!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(obLocal_72, PLAYER::PLAYER_PED_ID())) ENTITY::ATTACH_ENTITY_TO_ENTITY(obLocal_72, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_80), uLocal_74, uLocal_77, false, false, false, false, 2, true, 0);
return true;
}
return false;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_52();
return;
}
...
while (!flag && num < 400){
flag=true;
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && STREAMING::GET_PLAYER_SWITCH_STATE() !=8 || STREAMING::GET_PLAYER_SWITCH_STATE()==1) flag=false;
STREAMING::REQUEST_PTFX_ASSET();
if(!STREAMING::HAS_PTFX_ASSET_LOADED()) flag=false;
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_175))if(!AUDIO::REQUEST_AMBIENT_AUDIO_BANK(&uLocal_175, false, -1)) flag=false;
if(!hLocal_73==0){
if(!ENTITY::DOES_ENTITY_EXIST(obLocal_72)){
STREAMING::REQUEST_MODEL(hLocal_73);
if(!STREAMING::HAS_MODEL_LOADED(hLocal_73)){
...
if(iLocal_70==273) uLocal_138={
{
34.97325f + 0.25f, -441.7662f, -118.32176f 
}
- uLocal_83 
};
elseif(iLocal_70==274) uLocal_138={
0.125f, -1.1486f, 0.0588f + 0.1f 
};
else uLocal_138={
-0.125f, 1.1486f, -0.0588f 
};
break;
case 245:
case 40:
...
uParam109->f_109=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
uParam109->f_110=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
func_56(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"),{
2.6407f, 8.164f, -14.1564f 
}
+{
-1f, 0.03f, -2.16f 
}
, -66f + -56f);
if(uParam0.f_2==80) func_57(uParam109);
uParam109->f_118=1;
return 1;
case 124:
*uParam109={
...
func_57(uParam109);
uParam109->f_118=1;
if(uParam0.f_2==92) uParam109->f_118=1;
if(uParam0.f_2==104) uParam109->f_118=0;
if(uParam0.f_2==81){
func_57(uParam109);
uParam109->f_118=1;
}
...
uParam109->f_109=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
uParam109->f_110=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
if(uParam0.f_2==94) func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -1.71f, 1.05f, 0f, -138f);
uParam109->f_118=1;
return 1;
case 95:
*uParam109={
...
uParam109->f_118=1;
func_57(uParam109);
if(uParam0.f_2==265) uParam109->f_118=1;
if(uParam0.f_2==268) uParam109->f_118=0;
if(uParam0.f_2==267) func_56(uParam109, 144, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -2.4166f, -0.15f, 0f, -148.7555f);
if(uParam0.f_2==266) func_56(uParam109, 144, joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -5.7915f, -11.0439f, 0.67f, -72.589f);
return 1;
case 246:
*uParam109={
uParam0 
...
if(func_60(entityCoords, 0f, 0f, 0f, false)) entityCoords={
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_72))if(iLocal_82 !=-1) func_3(&obLocal_72, iLocal_82);
if(iLocal_88 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_88, false);
iLocal_88=0;
AUDIO::STOP_SOUND(iLocal_223);
