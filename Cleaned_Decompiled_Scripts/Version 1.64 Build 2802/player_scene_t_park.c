...
Var0={
Vector(32.856f, 3819.65f, 1971.62f) - Local_83 
};
uLocal_87=GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_90, Local_83 + Var0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
}}
...
uLocal_223=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_223, &cLocal_207, PLAYER::PLAYER_PED_ID(), &cLocal_191, 0, 0);
iLocal_224++;
}
}
elseif(GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&cLocal_106, iLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0)){
if(MISC::ARE_STRINGS_EQUAL(&cLocal_106, "scr_meth_pipe_smoke")){
func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0, -1);
}
uLocal_223=AUDIO::GET_SOUND_ID();
...
if(iLocal_88 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_88, 0);
iLocal_88=0;
...
ENTITY::SET_ENTITY_ROTATION(*iParam0, Var4.f_0, Var4.f_1, Var4.f_2, 2, 1);
}
...
break;
case 5:
FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(*iParam0, 1), 0, 1056964608, 1, 0, 1065353216, 0);
OBJECT::DELETE_OBJECT(iParam0);
return 1;
break;
case 6:
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_98011, &sVar35, &sVar68, 1000f, -8f, uVar67, 1148846080);
}}}
...
iLocal_72=OBJECT::CREATE_OBJECT(iLocal_73, Local_83, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_80), Local_74, Local_77, 0, 0, 0, 0, 2, 1, 0);
}else{
iLocal_72=OBJECT::CREATE_OBJECT(iLocal_73, Local_83 + Local_74, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_72, Local_83 + Local_74, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_72, Vector(uLocal_86, 0f, 0f) + Local_77, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_72, 1);
}}}
if(!func_38()){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_72)){
if(iLocal_80 !=-1){
...
if(iLocal_70==273){
Local_138={
Vector((34.97325f + 0.25f), -441.7662f, -118.3218f) - Local_83 
};
}elseif(iLocal_70==274){
Local_138={
