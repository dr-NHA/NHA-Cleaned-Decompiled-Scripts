...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_156, 1, 1);
}
func_439();
if(func_450()){
iVar0=func_438();
...
Global_78341[1 /*14*/]={
func_92(iVar0, iParam1, iParam2, -1) 
};
...
Global_78341[1 /*14*/]={
func_92(iVar0, iParam1, uVar31[iParam1], -1) 
};
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_92(iVar10, iParam1, iParam2, -1) 
};
if(!func_82(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_92(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar28=9;
...
uVar28={
func_85(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_92(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_92(iVar10, iVar0, func_49(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_85(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_92(iVar10, 14, uVar69[iVar1], -1) 
};
func_59(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_75(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_92(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_70(iParam0, iParam2, iParam3, -1)){
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_84(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_84(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_84(iParam0));
if(iVar57 > iVar56){
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_84(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_84(iParam1))){
return 1;
}
return 0;
}
...
var func__233(int iParam0, int iParam1){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_156, uLocal_160);
...
func_298(4);
}elseif(func_296(PLAYER::PLAYER_PED_ID(), iLocal_156) > 250f){
...
}}}}}}elseif((bParam6 && !iLocal_548==0) && !func_245()){
if(*iParam1 < (iParam2 - 1)){
*iParam1++;
}else{
*iParam0=1;
...
func_246();
iLocal_548=2;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_156, PLAYER::PLAYER_PED_ID(), iParam0) && iLocal_519 < 4){
func_246();
iLocal_548=1;
}}
if(iLocal_548==1){
...
float fVar6;
Var0={
func_259(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_259(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__259(struct<3> Param0){
float fVar0;
float fVar1;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_277(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=0;
}elseif(!func_293(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
switch (iLocal_155){
case 0:
PATHFIND::SET_ROADS_IN_AREA(Local_147, Local_147.f_3, 1, 1);
MISC::SET_INSTANCE_PRIORITY_HINT(2);
if(func_440(Local_86.f_35[0])){
iVar0=0;
while (iVar0 < 3){
Local_526[iVar0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1) 
};
iVar0++;
}}
...
if(func_440(Local_86.f_35[0])){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_86.f_35[0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
...
if(((!iLocal_332 && !iLocal_333) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_156)) && !ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, 0, 1, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_156, Local_86.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786469, 100f, 1f, 1);
iLocal_333=1;
}}
func_253(0);
func_266(&uLocal_549, iLocal_156, 0, 0, 1, 1, 1);
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_156, Local_86.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 100f, 1f, 1);
iLocal_332=1;
}
if(!func_307()){
func_302();
...
iLocal_332=1;
func_298(3);
}elseif(PED::IS_PED_BEING_JACKED(iLocal_156) || !func_3(Local_86.f_35[0])){
iLocal_332=1;
func_298(3);
}}else{
iLocal_332=1;
...
int func_303(){
if(func_440(Local_86.f_35[0])){
if(PED::IS_PED_IN_VEHICLE(iLocal_156, Local_86.f_35[0], 0)){
...
if(func_440(Local_86.f_35[0])){
iVar0=0;
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_86.f_35[0], 0, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_86.f_35[0], 1, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_86.f_35[0], 4, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_86.f_35[0], 5, 0)){
iVar0++;
}
if(iVar0 > 1){
...
int iVar0;
iVar0=VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1), 20f, iParam0, 6);
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_86.f_35[0], 1, 1, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_86.f_35[0], 0, 0, 0);
}
if(func_440(iLocal_156)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_156, uLocal_159);
uLocal_330=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1), 100f, 10f, 0);
}else{
TASK::TASK_SMART_FLEE_PED(iLocal_156, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}}
...
iLocal_161=VEHICLE::CREATE_VEHICLE(iLocal_162, -1482.366f, 529.0344f, 117.2725f, 201.5764f, 1, 1, 0);
...
if(!ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], Local_82, 20f, 20f, 100f, 0, 1, 0)){
sLocal_423="DREY1_CGONE";
iLocal_332=1;
func_298(3);
return 1;
}elseif(!ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], Local_82, 5f, 5f, 100f, 0, 1, 0)){
...
float fVar6;
Var0={
func_259(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_156, 0f, 0f, -0.5f, 1, -1, 3000, 2000, 0);
...
iLocal_565=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1459.57f, 485.16f, 115.2f, 10f, joaat("prop_yoga_mat_02"), 1, 0, 1);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_565)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_565, 1);
}
iLocal_155=1;
iLocal_564=0;
break;
...
MISC::CLEAR_AREA_OF_VEHICLES(-1473.376f, 517.8441f, 116.8854f, 30f, 0, 0, 0, 0, 0, 0, 0);
func_314(500, 0);
iLocal_562++;
}
break;
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_156, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
}}
break;
}
break;
...
if(iParam4==1){
if(func_376(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_351(iParam0, 0, 0)) || func_351(iParam0, 1, 0)) || func_351(iParam0, 2, 0)) || func_370(iParam0) !=145) || func_350(iParam0)) || func_349(iParam0)) || func_348(iParam0)) || func_347(iParam0)) || !func_337(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_349(iParam0)){
}
if(func_349(iParam0)){
}
...
if(!func_394(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_394(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
func_427();
if(!func_433()){
func_425(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 12, 5000, 0, 0);
}
func_424(0, -1, 1);
if(iParam0==1){
if(func_440(iLocal_156)){
...
Local_86.f_35[0]=VEHICLE::CREATE_VEHICLE(iLocal_163, Local_82, fLocal_85, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_163);
}
if(func_440(Local_86.f_35[0])){
VEHICLE::SET_VEHICLE_INFLUENCES_WANTED_LEVEL(Local_86.f_35[0], 0);
...
PED::SET_PED_CONFIG_FLAG(iLocal_156, 177, 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_156, 1);
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_156, 1, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_156, 1, 1);
TASK::SET_PED_PATH_MAY_ENTER_WATER(iLocal_156, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_156, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_156, 281, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_156, 42, 1);
}}
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-1457.251f, 475.8258f, 114.2015f 
};
uParam0->f_17[1 /*3*/]={
-1460.402f, 490.4705f, 118.601f 
};
uParam0->f_24=35f;
uParam0->f_27=0;
...
MISC::CLEAR_AREA_OF_VEHICLES(-1471.166f, 510.6191f, 115.8419f, 4f, 0, 0, 0, 0, 0, 0, 0);
func_441(0);
return 1;
break;
}
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_561, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_81, 0);
func_193(99, 0, 1, 1, 0);
func_404(&iLocal_565, 0);
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_156, 0, 1);
}
func_461(&iLocal_156, 1, 0, 1);
func_458(&iLocal_161);
func_463();
PATHFIND::SET_ROADS_IN_AREA(Local_147, Local_147.f_3, 1, 1);
VEHICLE::REMOVE_ROAD_NODE_SPEED_ZONE(uLocal_330);
}
