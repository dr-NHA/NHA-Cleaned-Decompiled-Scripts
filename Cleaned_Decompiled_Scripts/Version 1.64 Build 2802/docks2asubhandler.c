...
float num;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19)) func_1();
...
if(num > 90000f) MISC::SET_BIT(&iLocal_2, 1);
elseif(num > 40000f && !ENTITY::IS_ENTITY_ON_SCREEN(veLocal_0)) MISC::SET_BIT(&iLocal_2, 1);
}else{
