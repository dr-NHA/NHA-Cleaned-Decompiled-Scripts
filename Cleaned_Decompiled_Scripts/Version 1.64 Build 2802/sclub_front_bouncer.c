...
func_118(ENTITY::IS_ENTITY_DEAD(iLocal_69, 0));
if(ENTITY::IS_ENTITY_DEAD(iLocal_69, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_342)){
HUD::REMOVE_BLIP(&uLocal_342);
}}
...
if(((func_20() && PED::IS_PED_IN_COMBAT(iLocal_69, PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar0 !=joaat("weapon_pistol")){
func_18(16);
func_21();
}
...
func_7();
}elseif(!PED::IS_PED_IN_COMBAT(iLocal_69, 0)){
func_21();
}}}elseif(!PED::IS_PED_IN_COMBAT(iLocal_69, PLAYER::PLAYER_PED_ID())){
func_21();
}}
...
if(Global_1574582.f_6 || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
return 0;
}
...
if(func_15(16, -1)){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_69, joaat("weapon_pistol"), -1, 0, 1);
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_69, joaat("weapon_pistol"), 1);
TASK::TASK_COMBAT_PED(iLocal_69, PLAYER::PLAYER_PED_ID(), 0, 16);
}elseif(func_15(8, -1)){
WEAPON::REMOVE_ALL_PED_WEAPONS(iLocal_69, 1);
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_69, joaat("weapon_unarmed"), 1);
PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_69, 0);
TASK::TASK_COMBAT_PED(iLocal_69, PLAYER::PLAYER_PED_ID(), 0, 16);
}elseif(!(func_20() && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))){
WEAPON::REMOVE_ALL_PED_WEAPONS(iLocal_69, 1);
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_69, joaat("weapon_unarmed"), 1);
PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_69, 0);
TASK::TASK_COMBAT_PED(iLocal_69, PLAYER::PLAYER_PED_ID(), 0, 16);
...
func_18(32);
if(!HUD::DOES_BLIP_EXIST(uLocal_342)){
uLocal_342=HUD::ADD_BLIP_FOR_ENTITY(iLocal_69);
HUD::SET_BLIP_COLOUR(uLocal_342, 1);
HUD::SET_BLIP_SCALE(uLocal_342, 0.7f);
}
return 1;
}
...
bVar0=true;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_69, PLAYER::PLAYER_PED_ID(), 1)){
bVar1=true;
}
...
bVar0=true;
return 1;
}elseif(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_69, PLAYER::PLAYER_PED_ID(), 17)){
bVar0=true;
return 1;
}}}
Var2={
...
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_69, joaat("weapon_unarmed"), 0);
WEAPON::REMOVE_ALL_PED_WEAPONS(iLocal_69, 1);
}
if(!func_15(4, -1)){
...
}}}elseif(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_69, 1)) < (10f * 10f)){
...
fVar4=func_42();
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_69, 1), Var1) > 2f && TASK::GET_SCRIPT_TASK_STATUS(iLocal_69, joaat("script_task_follow_nav_mesh_to_coord")) !=1){
func_41(0);
}
switch (func_40()){
case 0:
...
TASK::TASK_PLAY_ANIM(iLocal_69, func_39(0), func_38(0), 8f, -8f, -1, 2, 0, 0, 0, 0);
func_41(3);
}
break;
case 3:
...
TASK::TASK_PLAY_ANIM(iLocal_69, func_39(iVar0), func_38(iVar0), 8f, -8f, -1, 2, 0, 0, 0, 0);
func_41(4);
}}else{
TASK::TASK_PLAY_ANIM(iLocal_69, func_39(0), func_38(0), 8f, -8f, -1, 2, 0, 0, 0, 0);
}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, uParam1, func_57(iParam2), 1);
}
...
var func__74(int iParam0, int iParam1){
...
iLocal_69=PED::CREATE_PED(26, joaat("s_m_m_bouncer_01"), func_34() - Vector(1f, 0f, 0f), func_42(), 1, 1);
func_95(1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_69, joaat("weapon_pistol"), -1, 0, 1);
...
Local_242[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_69, 1));
}else{
