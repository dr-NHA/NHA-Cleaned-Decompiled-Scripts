...
func_2(0);
}elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&Global_112704))==0){
func_2(0);
}}}
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_270, "FP_HAIL_TAXI", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FP_HAIL_TAXI", &cLocal_270, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_270, "FUCK_U", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FUCK_U", &cLocal_270, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_270, "FORGET_IT", 3)){
...
HUD::SET_BLIP_ROUTE(uLocal_93, 0);
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_270, "Aknowledge_L", 3)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_56.f_0, 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(Local_56.f_1, Local_56.f_0)){
TASK::OPEN_SEQUENCE_TASK(&uVar0);
if((!VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_0, 1, 0) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_0, 2, 0)) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_0, 0, 0)){
TASK::TASK_PAUSE(0, 2000);
}
else{
TASK::TASK_PAUSE(0, 500);
...
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(Local_56.f_1, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}
else{
...
if(ENTITY::DOES_ENTITY_EXIST(Local_56.f_0)){
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Local_56.f_0, 0)){
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112679, 0)){
...
func_33();
if(HUD::DOES_BLIP_EXIST(uLocal_93)){
HUD::SET_BLIP_FLASH_TIMER(uLocal_93, 10000);
}}else{
func_5();
}}else{
func_5();
...
}elseif(func_41(Global_112716, 30000)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_112679, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_112680, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}else{
return 1;
}
...
TASK::TASK_VEHICLE_MISSION(0, Global_112679, Global_112679, 22, 12f, 262275, 3f, 3f, 1);
TASK::TASK_VEHICLE_MISSION(0, Global_112679, Global_112679, 5, 12f, 262275, 3f, 3f, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(Global_112680, uVar2);
...
if(func_39(Global_112679)){
if(!HUD::DOES_BLIP_EXIST(uLocal_93)){
uLocal_93=HUD::ADD_BLIP_FOR_ENTITY(Global_112679);
HUD::SET_BLIP_SPRITE(uLocal_93, 198);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_93, "TXM_BLIP");
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 1f, 0f, 0f) 
};
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
Var6={
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
if(!CAM::IS_GAMEPLAY_HINT_ACTIVE()){
CAM::SET_GAMEPLAY_VEHICLE_HINT(Global_112679, 0f, 0f, 0f, 1, 4000, 2000, 2000);
iLocal_88=1;
}
}
Global_113648.f_10051.f_120=1;
...
Global_112716=0;
if(func_39(Global_112679)){
VEHICLE::START_VEHICLE_HORN(Global_112679, 2500, MISC::GET_HASH_KEY("NORMAL"), 0);
}
if(ENTITY::DOES_ENTITY_EXIST(Global_112680)){
if(!PED::IS_PED_INJURED(Global_112680)){
...
struct<3> Var0;
Var0={
ENTITY::GET_ENTITY_COORDS(Local_56.f_0, 0) 
};
if(!Local_56.f_2){
if(!Local_56.f_3){
...
if(Local_56.f_4){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_56.f_1, Local_56.f_0, Local_56.f_17, 10f, 0, ENTITY::GET_ENTITY_MODEL(Local_56.f_0), Local_56.f_29, 5f, MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_56.f_17, 1));
Local_56.f_4=0;
}else{
TASK::TASK_VEHICLE_PARK(Local_56.f_1, Local_56.f_0, Local_56.f_17, Local_56.f_6, 3, 90f, 1);
}}
Local_56.f_2=1;
}}else{
PED::SET_DRIVER_ABILITY(Local_56.f_1, 0.5f);
...
Local_56.f_2=1;
}}elseif(!func_19(Local_56.f_1, joaat("script_task_vehicle_park"))){
...
return 1;
}elseif(PATHFIND::GET_POSITION_BY_SIDE_OF_ROAD(Var0, -1, &Var3)){
*uParam7={
Var3 
};
*uParam8=uParam6;
...
Var1={
*uParam0, uParam0->f_1, uVar0 
};
if(func_71(Var1, Param1)){
Var4={
Param1 - Var1 / Vector(5f, 5f, 5f) 
};
iVar7=1;
while (iVar7 <=5){
Var1={
...
Var0={
ENTITY::GET_ENTITY_COORDS(Local_56.f_0, 1) 
};
if(func_38(Var0, Local_56.f_14, Local_56.f_7)){
return 1;
}elseif(func_38(Var0, Local_274, 5f)){
Local_56.f_14={
Local_274 
};
return 1;
}elseif(!func_19(Local_56.f_1, joaat("script_task_vehicle_drive_to_coord"))){
Local_56.f_2=0;
Local_56.f_8=0;
}}
return 0;
...
*uParam4=163.87f;
return 1;
}elseif(func_95(Param0, -3800f, 5400f, -100f, -1900f, 8500f, 100f)){
*uParam3={
-1577.16f, 5166.51f, 19.1864f 
};
*uParam4=0f;
return 1;
}elseif(func_95(Param0, -874.9833f, 125.7645f, -100f, -768.6254f, 193.0297f, 100f)){
*uParam3={
-856.6151f, 163.7361f, 65.093f 
};
*uParam4=355.3355f;
return 1;
}elseif(func_95(Param0, -39.2005f, -1473.55f, -100f, 10.6133f, -1430.099f, 100f)){
*uParam3={
-15.5181f, -1456.4f, 29.4244f 
};
*uParam4=94.6893f;
return 1;
}elseif(func_95(Param0, 1964.742f, 3792.59f, -100f, 1992.636f, 3840.253f, 100f)){
*uParam3={
...
if(func_73(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0))){
if(Local_56.f_10 < 2){
iVar4=0;
}
elseif(Local_56.f_10 < 5){
iVar4=9;
}
else{
iVar4=1;
...
Local_56.f_5=func_77(ENTITY::GET_ENTITY_COORDS(Local_56.f_0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
Local_56.f_2=0;
Local_56.f_8=0;
iLocal_53=2;
}}elseif(Local_56.f_8 >=5){
Local_56.f_10++;
if(Local_56.f_10 > 10){
func_13();
}
...
*uParam0=VEHICLE::CREATE_VEHICLE(func_146(), Param2, uParam5, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, 0)){
...
*uParam1=PED::CREATE_PED_INSIDE_VEHICLE(*uParam0, 25, func_147(), -1, 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(*uParam1)){
if(!PED::IS_PED_INJURED(*uParam1)){
...
return 1;
}}elseif(PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(Var26, *uParam2, &Var0, &fVar9, &uVar10, iParam3, fVar14, fVar15)){
...
bVar12=true;
Var16={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var3, fVar9, 0f, 1f, 0f) 
};
Var19={
Var16 - Var3 
};
...
if(iVar4==0){
Var0={
-1587.096f, -928.5875f, 14.3046f 
};
fVar3=139.9023f;
}elseif(iVar4==1){
Var0={
-1532.458f, -863.667f, 21.6188f 
};
fVar3=139.9028f;
}elseif(iVar4==2){
Var0={
-1472.888f, -733.0396f, 24.0746f 
};
fVar3=236.3756f;
}elseif(iVar4==3){
Var0={
-1397.303f, -781.1235f, 19.3347f 
};
fVar3=48.1876f;
}elseif(iVar4==4){
Var0={
-1605.409f, -1012.578f, 12.0175f 
};
fVar3=51.1191f;
}elseif(iVar4==5){
Var0={
-1572.457f, -1007.106f, 12.0184f 
};
fVar3=141.2024f;
}
if(func_102(Param0, Var0, 1133903872, 1101004800)){
...
if(iVar4==0){
Var0={
-1126.552f, -1530.591f, 3.294f 
};
fVar3=214.5477f;
}elseif(iVar4==1){
Var0={
-1043.019f, -1644.172f, 3.4894f 
};
fVar3=35.3163f;
}elseif(iVar4==2){
Var0={
-1039.345f, -1532.581f, 4.1467f 
};
fVar3=32.1734f;
}elseif(iVar4==3){
Var0={
-1067.577f, -1501.944f, 4.0327f 
};
fVar3=216.1659f;
}
if(func_102(Param0, Var0, 1133903872, 1101004800)){
...
Var0={
-1095.382f, 2686.487f, 18.5919f 
};
fVar3=130.0954f;
}elseif(iVar4==3){
Var0={
-1373.514f, 2429.944f, 26.7492f 
};
fVar3=298.9626f;
}
if(func_102(Param0, Var0, 1133903872, 1101004800)){
...
if(iVar4==0){
Var0={
1299.198f, 1164.342f, 105.3728f 
};
fVar3=3.1765f;
}elseif(iVar4==1){
Var0={
1304.831f, 1084.598f, 104.6453f 
};
fVar3=8.2195f;
}elseif(iVar4==2){
Var0={
1290.873f, 1237.684f, 107.4217f 
};
fVar3=186.5802f;
}elseif(iVar4==3){
Var0={
1310.975f, 1001.138f, 104.9354f 
};
fVar3=359.3654f;
}elseif(iVar4==4){
Var0={
1284.936f, 1355.748f, 103.4301f 
};
fVar3=182.4582f;
}
if(func_102(Param0, Var0, 1133903872, 1101004800)){
...
if(iVar4==0){
Var0={
-1208.617f, -1410.733f, 3.1853f 
};
fVar3=215.8772f;
}elseif(iVar4==1){
Var0={
-1172.9f, -1412.38f, 3.6078f 
};
fVar3=126.9322f;
}elseif(iVar4==2){
Var0={
-1112.842f, -1437.895f, 4.031f 
};
fVar3=211.4814f;
}elseif(iVar4==3){
Var0={
-1079.885f, -1472.878f, 4.0784f 
};
fVar3=32.9476f;
}elseif(iVar4==4){
Var0={
-1086.768f, -1540.707f, 3.5549f 
};
fVar3=128.3527f;
}
if(func_102(Param0, Var0, 1133903872, 1101004800)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_0, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
...
Var9={
ENTITY::GET_ENTITY_COORDS(uVar19[iVar4], 0) 
};
...
iLocal_277=0;
}elseif(iLocal_277 !=uVar19[iVar2]){
func_109(&iLocal_277, 0);
...
iLocal_91=0;
iLocal_52=2;
}}elseif(func_118(&uLocal_101, 131, "TAXISAU", sLocal_267, sLocal_267, "TX_2A", "TX_2A", 2, 1, 0, 0, 0)){
iLocal_52=1;
}}}}elseif(iLocal_52==1){
if(func_117()){
iLocal_52=0;
...
if(MISC::IS_BIT_SET(Global_113648.f_7690[iVar4 /*15*/].f_2, bVar0)){
...
if(MISC::IS_BIT_SET(Global_113648.f_7690.f_651[iVar4 /*14*/].f_2, bVar0)){
...
if(MISC::IS_BIT_SET(Global_113648.f_7690.f_765[iVar4 /*10*/].f_2, bVar0)){
...
return 1;
}elseif(Global_43258[iParam3 /*5*/].f_4 !=-1){
