...
switch (iLocal_51){
case 0:
if(func_144()) iLocal_51=1;
else SYSTEM::WAIT(500);
break;
case 1:
if(func_144()){
uLocal_274={
...
if(!func_3())if(MISC::ARE_STRINGS_EQUAL("NULL", &Global_112704)) func_2(false);
elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&Global_112704))==0) func_2(false);
return;
}
...
if(!Global_112697) return false;
if(Global_112698) return false;
return true;
}
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "HAIL_TAXI", 3)) ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "HAIL_TAXI", &uLocal_270, -2f);
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FP_HAIL_TAXI", 3)) ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FP_HAIL_TAXI", &uLocal_270, -2f);
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FUCK_U", 3)) ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FUCK_U", &uLocal_270, -2f);
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FORGET_IT", 3)) ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FORGET_IT", &uLocal_270, -2f);
if(iLocal_95 !=-1) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 113, false);
if(iLocal_92==1){
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(PLAYER::PLAYER_PED_ID(), true);
iLocal_92=0;
}}
STREAMING::REMOVE_ANIM_DICT(&uLocal_270);
if(iLocal_95 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_95);
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TXM_H01" /*Press ~INPUT_CONTEXT~ to hail a taxi.*/)){
iLocal_94=iLocal_94 + 1;
if(iLocal_94==3) Global_113648.f_10051.f_120=1;
...
if(bLocal_88)if(CAM::IS_GAMEPLAY_HINT_ACTIVE()) CAM::STOP_GAMEPLAY_HINT(false);
if(ENTITY::DOES_ENTITY_EXIST(Global_112680))if(!PED::IS_PED_INJURED(Global_112680))if(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &uLocal_270, "Aknowledge_R", 3)) ENTITY::STOP_ENTITY_ANIM(Global_112680, "Aknowledge_R", &uLocal_270, -4f);
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &uLocal_270, "Aknowledge_L", 3)) ENTITY::STOP_ENTITY_ANIM(Global_112680, "Aknowledge_L", &uLocal_270, -4f);
if(iLocal_54==0) func_6();
veLocal_278=0;
bLocal_87=false;
bLocal_88=false;
iLocal_97=0;
...
if(SCRIPT::HAS_SCRIPT_LOADED("taxiService")) SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("taxiService");
PLAYER::SET_PLAYER_CAN_DO_DRIVE_BY(PLAYER::PLAYER_ID(), true);
func_11();
}
func_6();
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TX_H02" /*Press ~INPUT_ENTER~ to enter a taxi as a passenger. Hold ~INPUT_ENTER~ to jack a taxi.*/)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
iLocal_96=0;
iLocal_54=0;
return;
}
...
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(veLocal_56, 1, false) || !VEHICLE::IS_VEHICLE_SEAT_FREE(veLocal_56, 2, false) || !VEHICLE::IS_VEHICLE_SEAT_FREE(veLocal_56, 0, false)) TASK::TASK_PAUSE(0, 2000);
else TASK::TASK_PAUSE(0, 500);
...
if(ENTITY::DOES_ENTITY_EXIST(veLocal_56))if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(veLocal_56, false))if(veLocal_56 !=Global_112679) ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&veLocal_56);
if(iLocal_53==1){
...
if(iLocal_54==0) func_27();
elseif(iLocal_54==1) func_23();
elseif(iLocal_54==2) func_16();
elseif(iLocal_54==3)if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) iLocal_54=0;
return;
}
...
func_21();
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112679, 1, false)==PLAYER::PLAYER_PED_ID()) iLocal_279=1;
else iLocal_279=2;
func_20(&Global_112679, iLocal_279);
if(!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, false))if(PED::IS_PED_SITTING_IN_VEHICLE(Global_112680, Global_112679))if(!func_19(Global_112680, SCRIPT_TASK_VEHICLE_TEMP_ACTION)) TASK::TASK_VEHICLE_TEMP_ACTION(Global_112680, Global_112679, 1, 1000000);
func_13();
func_5();
if(bLocal_89){
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TX_H02" /*Press ~INPUT_ENTER~ to enter a taxi as a passenger. Hold ~INPUT_ENTER~ to jack a taxi.*/)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
...
if(!PED::IS_PED_INJURED(randomPedAtCoord))if(PED::IS_PED_ON_FOOT(randomPedAtCoord)) TASK::TASK_SMART_FLEE_PED(randomPedAtCoord, PLAYER::PLAYER_PED_ID(), 150f, -1, false, false);
}
return;
}
...
if(func_19(pedAsGroupMember, SCRIPT_TASK_ENTER_VEHICLE)) flag=false;
...
if(func_22(&Global_112679, hLocal_100, hLocal_99)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112679, false)){
if(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112679)) iLocal_54=2;
func_21();
}else{
func_24();
}}else{
...
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), *veParam0, 5f, 5f, 2f, false, true, 0)) return false;
if(ENTITY::GET_ENTITY_SPEED(*veParam0) > 0.5f) return false;
if(INTERIOR::GET_INTERIOR_FROM_ENTITY(*veParam0) !=INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())) return false;
if(!func_26(*veParam0)) return false;
return true;
}
BOOL func_26(Vehicle veParam0) // Position - 0xFCC{
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(ENTITY::IS_ENTITY_UPRIGHT(veParam0, 1119092736)) return true;
return false;
}
...
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(veLocal_277, 1, false))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_277, 1, false)==PLAYER::PLAYER_PED_ID()) iLocal_279=1;
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(veLocal_277, 2, false))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_277, 2, false)==PLAYER::PLAYER_PED_ID()) iLocal_279=2;
if(iLocal_55==4 || iLocal_55==2)if(veLocal_277 !=Global_112679) func_5();
func_21();
...
if(!*uParam0==Global_112679 && !Global_112679==0) func_6();
...
if(!PED::IS_PED_INJURED(Global_112680) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, false))if(PED::IS_PED_SITTING_IN_VEHICLE(Global_112680, Global_112679))if(!func_19(Global_112680, SCRIPT_TASK_VEHICLE_TEMP_ACTION)) TASK::TASK_VEHICLE_TEMP_ACTION(Global_112680, Global_112679, 1, 10000);
bLocal_89=false;
iLocal_54=1;
}}}}elseif(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TX_H02" /*Press ~INPUT_ENTER~ to enter a taxi as a passenger. Hold ~INPUT_ENTER~ to jack a taxi.*/)){
HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
}
return;
}
...
if(iLocal_55==0)if(ENTITY::DOES_ENTITY_EXIST(veLocal_278)) iLocal_55=1;
elseif(iLocal_55==1) func_58();
elseif(iLocal_55==2) func_49();
elseif(iLocal_55==3) func_43();
elseif(iLocal_55==4) func_32();
return;
}
...
if(!func_36()){
if(!func_19(Global_112680, SCRIPT_TASK_VEHICLE_TEMP_ACTION)) TASK::TASK_VEHICLE_TEMP_ACTION(Global_112680, Global_112679, 1, 1000000);
PED::SET_PED_CONFIG_FLAG(Global_112680, 251, true);
func_33();
if(HUD::DOES_BLIP_EXIST(blLocal_93)) HUD::SET_BLIP_FLASH_TIMER(blLocal_93, 10000);
}else{
func_5();
}}else{
func_5();
...
if(CAM::IS_GAMEPLAY_HINT_ACTIVE())if(bLocal_88)if(func_34()) CAM::STOP_GAMEPLAY_HINT(false);
return;
}
...
if(num > 64 || num < -64 || num2 > 64 || num2 < -64) return true;
return false;
}
...
float num2;
float num3;
if(iLocal_55==4)if(Global_112716==-1 || Global_112716==0) Global_112716=MISC::GET_GAME_TIMER();
elseif(func_41(Global_112716, 30000))if(iLocal_54==0 || iLocal_54==3)if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112679, true)) return true;
if(func_39(Global_112679)){
entityCoords={
ENTITY::GET_ENTITY_COORDS(Global_112679, false) 
};
if(iLocal_55==4)if(!func_38(uLocal_274, entityCoords, 75f)) return true;
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_112679, PLAYER::PLAYER_PED_ID(), true)) return true;
...
if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Global_112679) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Global_112679)) return true;
if(PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) return true;
}}else{
return true;
}
if(func_37(Global_112680))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_112680, PLAYER::PLAYER_PED_ID(), true)) return true;
else return true;
return false;
}
...
if(ENTITY::DOES_ENTITY_EXIST(*veParam0))if(VEHICLE::IS_VEHICLE_DRIVEABLE(*veParam0, false))if(ENTITY::DOES_ENTITY_EXIST(*pedParam1))if(!PED::IS_PED_INJURED(*pedParam1))if(!PED::IS_PED_FLEEING(*pedParam1))if(!PED::IS_PED_IN_COMBAT(*pedParam1, 0))if(PED::IS_PED_SITTING_IN_VEHICLE(*pedParam1, *veParam0))if(ENTITY::GET_ENTITY_MODEL(*veParam0)==hParam2)if(PED::IS_PED_MODEL(*pedParam1, hParam3)) return true;
return false;
}
...
if(MISC::GET_RANDOM_INT_IN_RANGE(0, 3) < 2) TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FORGET_IT", 4f, -2f, -1, 48, 0, false, false, false);
else TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FUCK_U", 4f, -2f, -1, 48, 0, false, false, false);
}
if(MISC::GET_RANDOM_INT_IN_RANGE(0, 5)==1)if(!Global_44445) bLocal_87=true;
...
if(!Global_44445 && PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) return false;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) return false;
if(func_48(0)) return false;
if(func_47()) return false;
if(func_46()) return false;
if(func_45()) return false;
...
if(func_42(&Global_112679, &Global_112680, hLocal_100, hLocal_99)){
flag=false;
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 23)) flag=true;
...
if(func_51(Global_112679)) TASK::TASK_PLAY_ANIM(0, &uLocal_270, "Aknowledge_R", 8f, -4f, -1, 16785456, 0, false, false, false);
else TASK::TASK_PLAY_ANIM(0, &uLocal_270, "Aknowledge_L", 8f, -4f, -1, 16785456, 0, false, false, false);
...
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, 1f, 0f, 0f) 
};
...
if(MISC::GET_ANGLE_BETWEEN_2D_VECTORS(x1, x1.f_1, x2, x2.f_1) < 90f) return true;
}
return false;
}
...
if(STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_270)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FP_HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FUCK_U", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FORGET_IT", 3)){
if(!func_63(&veLocal_278))if(!VEHICLE::IS_TAXI_LIGHT_ON(veLocal_278)) VEHICLE::SET_TAXI_LIGHTS(veLocal_278, true);
if(iLocal_95==-1) _CONTEXT_ADD_HELP_TEXT(&iLocal_95, 0, "TXM_H01" /*Press ~INPUT_CONTEXT~ to hail a taxi.*/, 1, 0, 0, 0);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_278, false)) VEHICLE::SET_TAXI_LIGHTS(veLocal_278, false);
bLocal_88=false;
iLocal_55=3;
}else{
...
if(weaponHash !=joaat("WEAPON_PETROLCAN") || !MISC::ARE_STRINGS_EQUAL(priorityLowData.f_2, "FP_HAIL_TAXI")) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 113, true);
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
...
if(VEHICLE::IS_TAXI_LIGHT_ON(*uParam0)) VEHICLE::SET_TAXI_LIGHTS(*uParam0, false);
return true;
}}}
...
if(iLocal_53 !=0)if(func_107()) func_13();
if(iLocal_53==0){}elseif(iLocal_53==1){
func_99();
}elseif(iLocal_53==2){
func_74();
}elseif(iLocal_53==3){
...
Global_112716=0;
if(func_39(Global_112679)) VEHICLE::START_VEHICLE_HORN(Global_112679, 2500, MISC::GET_HASH_KEY("NORMAL"), false);
if(ENTITY::DOES_ENTITY_EXIST(Global_112680)){
if(!PED::IS_PED_INJURED(Global_112680)){
...
Vector3 entityCoords;
entityCoords={
ENTITY::GET_ENTITY_COORDS(veLocal_56, false) 
};
if(!veLocal_56.f_2){
if(!veLocal_56.f_3){
...
veLocal_56.f_2=1;
}}elseif(!func_19(veLocal_56.f_1, SCRIPT_TASK_VEHICLE_PARK)){
...
float num;
nodeFlags=1;
if(!func_73(vParam3)) nodeFlags=9;
...
*uParam8=uParam6;
if(func_70(uParam7, outPosition)) veLocal_56.f_4=1;
}else{
*uParam7={
outPosition3 
};
...
if(uParam0.f_2 - uParam3.f_2 > 0.45f || uParam0.f_2 - uParam3.f_2 < -0.45f) return true;
return false;
}
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(veLocal_56, true) 
};
if(func_38(entityCoords, veLocal_56.f_14, veLocal_56.f_7)){
return true;
}elseif(func_38(entityCoords, uLocal_274, 5f)){
veLocal_56.f_14={
uLocal_274 
};
return true;
}elseif(!func_19(veLocal_56.f_1, SCRIPT_TASK_VEHICLE_DRIVE_TO_COORD)){
veLocal_56.f_2=0;
veLocal_56.f_8=0;
}}
return false;
...
flag=false;
nodeFlags=1;
if(!func_73(vParam0)) nodeFlags=9;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_56, false)) vehicle=veLocal_56;
if(!MISC::IS_POINT_OBSCURED_BY_A_MISSION_ENTITY(*pvParam3, 3f, 3f, 3f, vehicle)) flag=true;
}}}
*uParam5=*uParam5 + 1;
if(*uParam5 >=num5) flag=true;
}}else{
flag=true;
}
if(flag){
...
*pfParam4=163.87f;
return true;
}elseif(func_95(vParam0, -3800f, 5400f, -100f, -1900f, 8500f, 100f)){
*pvParam3={
-1577.1599f, 5166.5103f, 19.1864f 
};
*pfParam4=0f;
return true;
}elseif(func_95(vParam0, -874.9833f, 125.7645f, -100f, -768.62537f, 193.02971f, 100f)){
*pvParam3={
-856.6151f, 163.7361f, 65.093f 
};
*pfParam4=355.3355f;
return true;
}elseif(func_95(vParam0, -39.2005f, -1473.5498f, -100f, 10.6133f, -1430.0988f, 100f)){
*pvParam3={
-15.5181f, -1456.3999f, 29.4244f 
};
*pfParam4=94.6893f;
return true;
}elseif(func_95(vParam0, 1964.7421f, 3792.59f, -100f, 1992.6361f, 3840.2532f, 100f)){
*pvParam3={
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_86(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_86(character)) return func_89(character);
...
Vector3 func__94(int iParam0) // Position - 0x63D1{
switch (iParam0){
case 1:
...
if(!bParam7)if(MISC::ABSF(fParam0 - uParam3) <=iParam6)if(MISC::ABSF(fParam0.f_1 - uParam3.f_1) <=iParam6)if(MISC::ABSF(fParam0.f_2 - uParam3.f_2) <=iParam6) return true;
elseif(MISC::ABSF(fParam0 - uParam3) <=iParam6)if(MISC::ABSF(fParam0.f_1 - uParam3.f_1) <=iParam6) return true;
return false;
}
...
if(func_73(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))if(veLocal_56.f_10 < 2) num2=0;
elseif(veLocal_56.f_10 < 5) num2=9;
else num2=1;
elseif(veLocal_56.f_10 < 5) num2=0;
else num2=9;
...
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam1)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*uParam1, true, false);
...
if(num5 !=6){
if(func_105(entityCoords, num5, uParam0, uParam1)) return true;
}elseif(PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(entityCoords, *uParam2, &outPosition, &outHeading, &outNumLanes, iParam3, num3, num4)){
while (!flag && num2 < 5){
...
if(num >=iParam6 * iParam6) return false;
...
if(func_103(vParam3, false)) return false;
return true;
}
...
if(func_91(vParam0, 1, 0, false)) return true;
...
if(func_92(2, vParam0))if(func_91(vParam0, 2, 0, false)) return true;
if(func_92(3, vParam0))if(func_91(vParam0, 3, 0, false)) return true;
if(func_92(4, vParam0))if(func_91(vParam0, 4, 0, false)) return true;
if(func_92(5, vParam0))if(func_91(vParam0, 5, 0, false)) return true;
if(func_92(6, vParam0))if(func_91(vParam0, 6, 0, false)) return true;
if(!func_81())if(func_92(7, vParam0))if(func_91(vParam0, 7, 0, false)) return true;
if(func_92(8, vParam0))if(func_91(vParam0, 8, 0, false)) return true;
...
if(i==0){
unk={
-883.8992f, 76.3237f, 50.9372f 
};
num=271.8234f;
}elseif(i==1){
unk={
-838.2045f, 88.1067f, 51.3396f 
};
num=102.3721f;
}elseif(i==2){
unk={
-884.0715f, 217.2857f, 71.7633f 
};
num=254.5437f;
}elseif(i==3){
unk={
-834.0018f, 217.2782f, 73.154f 
};
num=80.7037f;
}elseif(i==4){
unk={
-830.9222f, 135.3548f, 58.1352f 
};
num=92.957f;
}
...
if(i==0){
unk={
-1587.0962f, -928.5875f, 14.3046f 
};
num=139.9023f;
}elseif(i==1){
unk={
-1532.4579f, -863.667f, 21.6188f 
};
num=139.9028f;
}elseif(i==2){
unk={
-1472.8877f, -733.0396f, 24.0746f 
};
num=236.3756f;
}elseif(i==3){
unk={
-1397.3027f, -781.1235f, 19.3347f 
};
num=48.1876f;
}elseif(i==4){
unk={
-1605.4087f, -1012.5778f, 12.0175f 
};
num=51.1191f;
}elseif(i==5){
unk={
-1572.4573f, -1007.1061f, 12.0184f 
};
num=141.2024f;
}
if(func_102(uParam0, unk, 1133903872, 1101004800)){
...
if(i==0){
unk={
-1126.5519f, -1530.5911f, 3.294f 
};
num=214.5477f;
}elseif(i==1){
unk={
-1043.0194f, -1644.1719f, 3.4894f 
};
num=35.3163f;
}elseif(i==2){
unk={
-1039.3455f, -1532.5812f, 4.1467f 
};
num=32.1734f;
}elseif(i==3){
unk={
-1067.5765f, -1501.944f, 4.0327f 
};
num=216.1659f;
}
if(func_102(uParam0, unk, 1133903872, 1101004800)){
...
if(i==0){
unk={
-1247.2906f, 2549.53f, 16.4214f 
};
num=137.1185f;
}elseif(i==1){
unk={
-1314.11f, 2470.677f, 23.3185f 
};
num=309.2187f;
}elseif(i==2){
unk={
-1095.3818f, 2686.4868f, 18.5919f 
};
num=130.0954f;
}elseif(i==3){
unk={
-1373.5143f, 2429.944f, 26.7492f 
};
num=298.9626f;
}
if(func_102(uParam0, unk, 1133903872, 1101004800)){
...
if(i==0){
unk={
1299.198f, 1164.3418f, 105.3728f 
};
num=3.1765f;
}elseif(i==1){
unk={
1304.8314f, 1084.5979f, 104.6453f 
};
num=8.2195f;
}elseif(i==2){
unk={
1290.8727f, 1237.6844f, 107.4217f 
};
num=186.5802f;
}elseif(i==3){
unk={
1310.9749f, 1001.1377f, 104.9354f 
};
num=359.3654f;
}elseif(i==4){
unk={
1284.9357f, 1355.7482f, 103.4301f 
};
num=182.4582f;
}
if(func_102(uParam0, unk, 1133903872, 1101004800)){
...
if(i==0){
unk={
-1208.6174f, -1410.7325f, 3.1853f 
};
num=215.8772f;
}elseif(i==1){
unk={
-1172.9f, -1412.3802f, 3.6078f 
};
num=126.9322f;
}elseif(i==2){
unk={
-1112.8418f, -1437.8954f, 4.031f 
};
num=211.4814f;
}elseif(i==3){
unk={
-1079.8854f, -1472.8779f, 4.0784f 
};
num=32.9476f;
}elseif(i==4){
unk={
-1086.7677f, -1540.7067f, 3.5549f 
};
num=128.3527f;
}
if(func_102(uParam0, unk, 1133903872, 1101004800)){
...
if(func_95(vParam0, -874.9833f, 125.7645f, -100f, -768.62537f, 193.02971f, 100f)) return 0;
if(func_90(vParam0, -1693.3018f, -1109.1305f, 17.89778f, 240f)){
if(OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, -1538.9806f, -941.1323f, 10.566226f, -1715.5703f, -1139.7659f, 52.203613f, 110f, false, true)) return 1;
if(OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, -1739.989f, -1115.973f, 10.087262f, -1800.5149f, -1187.1798f, 52.0172f, 25f, false, true)) return 1;
if(OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, -1801.7664f, -1180.2517f, 4.017236f, -1857.7177f, -1244.6284f, 38.49653f, 85f, false, true)) return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, -1140.8896f, -1573.1349f, -6.566939f, -1067.0844f, -1675.9756f, 23.531528f, 52f, false, true)) return 2;
if(func_92(3, vParam0))if(func_91(vParam0, 3, 0, false)) return 3;
if(OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, 1324.1715f, 1110.7479f, 99.65493f, 1523.0968f, 1110.4734f, 132.88586f, 170f, false, true)) return 4;
if(OBJECT::IS_POINT_IN_ANGLED_AREA(vParam0, -1171.7086f, -1524.6598f, 23.379686f, -1139.7214f, -1573.589f, -1.585432f, 55f, false, true)) return 5;
return 6;
}
...
float num2;
float num3;
if(!func_38(uLocal_274, veLocal_56.f_20, 100f)) return true;
if(_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID()) !=veLocal_56.f_30) return true;
if(iLocal_55==4) return true;
if(iLocal_53==2 || iLocal_53==3){
if(!func_37(veLocal_56.f_1)) return true;
if(!func_39(veLocal_56)) return true;
if(!PED::IS_PED_SITTING_IN_VEHICLE(veLocal_56.f_1, veLocal_56)) return true;
if(PED::IS_PED_FLEEING(veLocal_56.f_1)) return true;
if(PED::IS_PED_IN_COMBAT(veLocal_56.f_1, 0)) return true;
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(veLocal_56, PLAYER::PLAYER_PED_ID(), true)) return true;
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(veLocal_56.f_1, PLAYER::PLAYER_PED_ID(), true)) return true;
entityCoords={
ENTITY::GET_ENTITY_COORDS(veLocal_56, false) 
};
if(MISC::IS_BULLET_IN_AREA(entityCoords, 7f, false)) return true;
...
if(MISC::IS_PROJECTILE_IN_AREA(num2, num3, true)) return true;
if(func_38(uLocal_274, entityCoords, 20f)){
if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), veLocal_56) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), veLocal_56)) return true;
if(PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) return true;
}}
return false;
}
...
num4=0;
num6=-99999f;
if(iLocal_55 !=0 && iLocal_55 !=1) bLocal_90=false;
if(bLocal_90){
num=3;
num7=35f;
}else{
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], false) 
};
...
if(num8 < 0f) num8=num8 * -1f;
if(num8 < 4f){
entityForwardVector={
ENTITY::GET_ENTITY_FORWARD_VECTOR(PLAYER::PLAYER_PED_ID()) 
};
vector={
entityCoords - uLocal_274 
};
if(((entityForwardVector * vector) + (entityForwardVector.f_1 * vector.f_1)) / SYSTEM::VDIST(vector, 0f, 0f, 0f) > SYSTEM::COS(120f)){
if(CAM::IS_SPHERE_VISIBLE(entityCoords, 2f)) num5=num5 * 0.5f;
if(func_63(&sizeAndVehs[i])) num5=num5 * 0.2f;
if(!ENTITY::IS_ENTITY_UPRIGHT(sizeAndVehs[i], 1119092736) || ENTITY::IS_ENTITY_IN_WATER(sizeAndVehs[i])) num5=0f;
if(num5 > num6){
num6=num5;
num2=i;
}
...
veLocal_277=0;
}elseif(veLocal_277 !=sizeAndVehs[num3]){
func_109(&veLocal_277, false);
veLocal_277=sizeAndVehs[num3];
func_109(&veLocal_277, true);
}
if(bLocal_90){
if(num2==-1) veLocal_278=0;
else veLocal_278=sizeAndVehs[num2];
bLocal_90=false;
}else{
bLocal_90=true;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, false)){
pedInVehicleSeat=VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam0, -1, false);
if(ENTITY::DOES_ENTITY_EXIST(pedInVehicleSeat))if(PED::IS_PED_MODEL(pedInVehicleSeat, func_147()))if(!PED::IS_PED_INJURED(pedInVehicleSeat)) PED::SET_PED_CONFIG_FLAG(pedInVehicleSeat, 251, bParam1);
}}
return;
}
...
if(iLocal_55==2 || iLocal_55==3)if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "HAIL_TAXI", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_270, "FP_HAIL_TAXI", 3)) func_59();
return;
}
BOOL func_111() // Position - 0x7DA3{
if(!func_3()) return false;
if(!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) return false;
...
bLocal_91=false;
iLocal_52=2;
}}elseif(func_118(&uLocal_101, 131, "TAXISAU", sLocal_267, sLocal_267, "TX_2A", "TX_2A", 2, 1, 0, 0, false)){
iLocal_52=1;
}}}}elseif(iLocal_52==1){
if(func_117()) iLocal_52=0;
}elseif(iLocal_52==2){
if(func_117()){
if(func_116())if(!bLocal_91) iLocal_52=0;
elseif(func_115())if(!bLocal_91) iLocal_52=0;
if(iLocal_52 !=0){
if(!func_114(19)) func_113(19);
func_13();
...
if(AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE()==1) bLocal_91=true;
}}
return;
}
...
float xSize;
int nodeFlags;
if(iLocal_53 !=0) return false;
if(iLocal_55==4 || iLocal_55==2) return false;
if(iLocal_54 !=0) return false;
if(SCRIPT::IS_THREAD_ACTIVE(iLocal_269)) return false;
if(!func_111()) return false;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(ENTITY::IS_ENTITY_IN_AIR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) return false;
func_134();
xSize=50f;
nodeFlags=1;
if(!func_73(uLocal_274)) nodeFlags=9;
if(!PATHFIND::GET_CLOSEST_VEHICLE_NODE(uLocal_274, &outPosition, nodeFlags, 100f, 2.5f)) return false;
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), outPosition, xSize, xSize, 20f, false, true, 0)) return false;
if(func_103(uLocal_274, true)) return false;
return true;
}
...
i=i + 1){
if(IS_BIT_SET(Global_113648.f_7690[i /*15*/].f_2, character))if(func_137(entityCoords, func_138(i))) return 1;
}
for (i=0;
i < Global_113648.f_7690.f_764;
i=i + 1){
if(IS_BIT_SET(Global_113648.f_7690.f_651[i /*14*/].f_2, character))if(func_137(entityCoords, func_136(i))) return 1;
}
for (i=0;
i < Global_113648.f_7690.f_866;
i=i + 1){
if(IS_BIT_SET(Global_113648.f_7690.f_765[i /*10*/].f_2, character))if(func_137(entityCoords, func_135(i))) return 1;
}}}
return 0;
}
...
elseif(Global_43258[iParam3 /*5*/].f_4 !=-1) return func_137(vParam0, Global_43258[iParam3 /*5*/].f_4);
}
return false;
}
...
if(echParam0==CHAR_MICHAEL || echParam0==CHAR_FRANKLIN || echParam0==CHAR_TREVOR)if(func_142(131, echParam0)==1) return true;
elseif(echParam0==func_14())if(func_142(131, CHAR_MICHAEL)==1 || func_142(131, CHAR_FRANKLIN)==1 || func_142(131, CHAR_TREVOR)==1) return true;
return false;
}
