...
func_37(1, 0);
func_35();
}}elseif(OBJECT::DOES_PICKUP_EXIST(Local_49[iLocal_41 /*11*/].f_1)){
...
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_108, func_8(func_9(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
...
iVar2=iVar20;
Var3={
func_25(Global_44465[iVar20 /*12*/].f_1) 
};
...
Var3={
func_25(Global_44465[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(bVar1){
func_16(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_17(iParam1)), 0));
}else{
func_16(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_17(iParam1)), 0));
}
switch (Global_20383){
case 0:
