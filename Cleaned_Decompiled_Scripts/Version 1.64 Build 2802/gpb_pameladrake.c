...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_240)) && fVar43 < 25f) && func_88(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")) && func_85(uLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
if(!func_89()){
func_91();
TASK::TASK_PLAY_ANIM(uLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_250=24;
...
func_52(Global_113593[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_240, &Local_372, &Local_356));
}}
break;
case 9:
...
if(bLocal_437){
iVar35=1;
}elseif(func_33(&uLocal_37, &cLocal_304, &cVar9, 3, 0, 0, 0)){
iVar35=1;
}
if(iVar35==1){
iLocal_250=11;
...
if((ENTITY::DOES_ENTITY_EXIST(uLocal_448) && !ENTITY::IS_ENTITY_DEAD(uLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_240, 0)){
if(!iLocal_449){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 15f){
...
TASK::TASK_FOLLOW_POINT_ROUTE(uLocal_448, 1f, 0);
iLocal_449=1;
}}else{
PED::SET_IK_TARGET(uLocal_448, 1, uLocal_240, 0, 0f, 0f, 0f, 0, -1, -1);
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_448, 1), 377.4565f, 154.6708f, 102.0838f, 1) > 25f){
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_448);
iLocal_450=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_448, 1), ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1) < 3f && iLocal_451==0){
iLocal_451=1;
}}}}
...
void func_9(){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_240, 0)){
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(uLocal_240, 0);
}}
...
uLocal_448=PED::CREATE_PED(4, joaat("a_m_m_business_01"), 396.8498f, 143.3195f, 101.4659f, 360f, 1, 1);
if((ENTITY::DOES_ENTITY_EXIST(uLocal_448) && !ENTITY::IS_ENTITY_DEAD(uLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_240, 0)){
PED::SET_IK_TARGET(uLocal_448, 1, uLocal_240, 0, 0f, 0f, 0f, 0, -1, -1);
}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_240, 0)){
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(uLocal_240, "MAG_2_PAM_PED_GROUP", 0);
}}
