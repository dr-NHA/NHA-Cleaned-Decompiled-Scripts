...
if(bLocal_508){
if(bLocal_509) GRAPHICS::DRAW_DEBUG_TEXT_2D("controlledByAnim", 0.02f, 0.5f, 0f, 0, 0, 255, 255);
...
if(bLocal_508)if(flag3) GRAPHICS::DRAW_DEBUG_TEXT_2D("conversationAlreadyOngoing", 0.8f, 0.1f, 0f, 0, 0, 255, 255);
...
if(bLocal_507) Global_113593[iLocal_251]=iLocal_506;
...
if(bLocal_508) GRAPHICS::DRAW_DEBUG_TEXT_2D("WAITING TO CLEAN UP", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_240)){
...
bLocal_450=true;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(pedLocal_448, true), ENTITY::GET_ENTITY_COORDS(pedLocal_240, true), true) < 3f && iLocal_451==0){
iLocal_451=1;
}}}
return;
}
...
if(character==CHAR_TREVOR) return 3;
elseif(character==CHAR_MICHAEL) return 22;
return 4;
}
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR) TEXT_LABEL_ASSIGN_STRING(sParam0, "pamela_convo_trevor_im_trying_to_get_noticed", 64);
elseif(character==CHAR_MICHAEL) TEXT_LABEL_ASSIGN_STRING(sParam0, "pamela_ig_2_imterribledarling", 64);
elseif(character==CHAR_FRANKLIN) TEXT_LABEL_ASSIGN_STRING(sParam0, "pamela_ig_5_inthebackdoor", 64);
return;
}
...
var func__83(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2ED5{
...
Vector3 func__87(float fParam0, var uParam1, var uParam2) // Position - 0x2FFC{
float num;
float num2;
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_448) && !ENTITY::IS_ENTITY_DEAD(pedLocal_448, false) && !ENTITY::IS_ENTITY_DEAD(pedLocal_240, false)) PED::SET_IK_TARGET(pedLocal_448, 1, pedLocal_240, 0, 0f, 0f, 0f, 0, -1, -1);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_240, false)) AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(pedLocal_240, "MAG_2_PAM_PED_GROUP", 0);
return;
}
...
, 4);
if(MISC::ARE_STRINGS_EQUAL(&string1, &uLocal_502)) func_13();
...
if(!Global_3) return;
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_448)) ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_448);
return;
}
