...
ENTITY::DETACH_ENTITY(Local_1352[iVar0 /*2*/], 1, 1);
}
...
ENTITY::DETACH_ENTITY(iLocal_1359, 1, 1);
}
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_1359);
}}
if(iLocal_1360 !=0){
PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1360, 0);
}
...
}elseif(HUD::GET_BLIP_FROM_ENTITY(Local_1348.f_0) !=0){
...
switch (iLocal_94){
case 1:
if((((((iLocal_1333==0 && ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)) && ENTITY::DOES_ENTITY_EXIST(Local_1336.f_0)) && !PED::IS_PED_INJURED(Local_1336.f_0)) && PED::IS_PED_IN_VEHICLE(Local_1336.f_0, Local_1348.f_0, 0)) && func_134(&(Local_1114[0 /*8*/]))){
...
iLocal_94=2;
}elseif((ENTITY::DOES_ENTITY_EXIST(iLocal_1350) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1350, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1350, Local_1348.f_0)){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1348.f_0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 0, 1, 0)){
VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_1350, 5f, -1, 0);
iLocal_94=101;
}}elseif(iLocal_1333==1){
func_103(&uLocal_1131, 1, 0);
...
func_199("JHP2A_TAKEBZ", 7500, 1);
iLocal_1375=1;
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1348.f_0, 0);
}}elseif(iLocal_1333==0){
if(HUD::DOES_BLIP_EXIST(Local_1348.f_1)){
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(5f, 5f, 4);
MISC::SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
HUD::REMOVE_BLIP(&(Local_1348.f_1));
...
if(func_98(&uLocal_1131, Var0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 1, Local_1348.f_0, "JHP2A_RTNVAN", "", "", PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1348.f_0, 0), 0, 1, -1)){
iLocal_94=101;
}
if(HUD::DOES_BLIP_EXIST(uLocal_1131) && HUD::DOES_BLIP_HAVE_GPS_ROUTE(uLocal_1131)){
HUD::SET_BLIP_ROUTE(uLocal_1131, 0);
}}
break;
case 101:
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1348.f_0, 0)){
iVar8=Local_1348.f_0;
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_1350) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1350, Local_1348.f_0)){
iVar8=iLocal_1350;
}
...
HUD::CLEAR_PRINTS();
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1348.f_0, 0);
VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1348.f_0, 1);
...
if((bVar9 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, 0f, -3f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, 0f, -4.5f, 1f), 1.68f, 0, 1, 1)) || (!bVar9 && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_1352[iVar6 /*2*/], 1), 0.75f, 0.75f, 4f, 0, 0, 1))){
...
if(bVar11 || ((iVar12 && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && bLocal_1382)){
...
bLocal_1382=PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1);
}
break;
case 1000:
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
...
var func__61(struct<3> Param0, int iParam3){
var uVar0;
...
struct<3> Var0;
if(ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0)){
return 0;
}
Var0={
MISC::GET_CLOSEST_POINT_ON_LINE(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, Local_87), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, Local_90), 0) 
};
...
if(((ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0) || (ENTITY::DOES_ENTITY_EXIST(Local_1352[0 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1352[0 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1352[1 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1352[1 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1352[2 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1352[2 /*2*/]))){
iLocal_1333=2;
}}
if(iLocal_1333==2){
if((((!ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)) || (ENTITY::DOES_ENTITY_EXIST(Local_1352[0 /*2*/]) && !func_94(Local_1352[0 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1352[1 /*2*/]) && !func_94(Local_1352[1 /*2*/]))) || (ENTITY::DOES_ENTITY_EXIST(Local_1352[2 /*2*/]) && !func_94(Local_1352[2 /*2*/]))){
iLocal_1333=3;
}}
if(iLocal_1333==0){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
if(iLocal_1333==0){
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)){
iLocal_1333=1;
}}
if(iLocal_1333==1 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1348.f_0, 1)){
func_9(6, 1);
}else{
func_9(6, 0);
}}
...
if(iParam4==1){
if(func_189(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
if(!iLocal_1379){
if(PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1348.f_0, 1)){
...
func_324(1);
}}elseif(Local_1114[0 /*8*/].f_1==4){
if(func_204(PLAYER::PLAYER_PED_ID(), Local_1348.f_0, 1) > 250f){
func_324(1);
}}elseif(func_204(PLAYER::PLAYER_PED_ID(), Local_1348.f_0, 1) > 250f){
func_324(2);
}}elseif(func_204(PLAYER::PLAYER_PED_ID(), Local_1348.f_0, 1) > 250f){
func_324(2);
}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0)){
if((ENTITY::IS_ENTITY_IN_WATER(Local_1348.f_0) && !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)) && !WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_briefcase"), 0)){
func_324(4);
}}}
...
void func_207(){
if(ENTITY::DOES_ENTITY_EXIST(Local_1336.f_0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_1336.f_0, 0)){
func_208(Local_1336.f_0, &(Local_1336.f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
}}
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0)){
if(((!func_201(Local_1348.f_0) && ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0)) && iLocal_1376) && func_204(Local_1348.f_0, PLAYER::PLAYER_PED_ID(), 1) > 200f){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_1348);
}}}
...
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1346, 1084227584);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1346, 1, 1, 0);
if(func_298()){
...
case 1:
if(!func_7(87)){
Local_1348.f_0=VEHICLE::CREATE_VEHICLE(joaat("boxville3"), 693.725f, -1006.302f, 21.8355f, 359.884f, 1, 1, 0);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1348.f_0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1348.f_0, 1084227584);
}
if(func_298()){
func_210(0, -1, 1);
}else{
...
*iParam0=VEHICLE::CREATE_VEHICLE(Var0.f_66, Param1, fParam4, 1, 1, 0);
...
Local_1348.f_0=VEHICLE::CREATE_VEHICLE(iLocal_84, Var1, 119.4988f, 1, 1, 0);
Local_1336.f_0=PED::CREATE_PED_INSIDE_VEHICLE(Local_1348.f_0, 26, iLocal_83, -1, 1, 1);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1348.f_0, 1084227584);
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1336.f_0, Local_1348.f_0, &Global_97543, 786475, 23, 16, -1, 12f, 0, 1073741824);
}else{
TASK::WAYPOINT_RECORDING_GET_COORD(&Global_97543, 29, &Var1);
MISC::CLEAR_AREA_OF_VEHICLES(Var1, 20f, 0, 0, 0, 0, 0, 0, 0);
Local_1348.f_0=VEHICLE::CREATE_VEHICLE(iLocal_84, Var1, 134.0011f, 1, 1, 0);
Local_1336.f_0=PED::CREATE_PED_INSIDE_VEHICLE(Local_1348.f_0, 26, iLocal_83, -1, 1, 1);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1348.f_0, 1084227584);
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1336.f_0, Local_1348.f_0, &Global_97543, 786475, 29, 16, -1, 12f, 0, 1073741824);
}}}
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0)){
func_290(Local_1348.f_0, 0);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)){
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_1348.f_0, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1348.f_0, 1, 1);
VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_1348.f_0, 1);
VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1348.f_0, 1);
}}
if(ENTITY::DOES_ENTITY_EXIST(Local_1336.f_0)){
if(!PED::IS_PED_INJURED(Local_1336.f_0)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1336.f_0, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_1336.f_0, iLocal_1335);
PED::SET_PED_ACCURACY(Local_1336.f_0, 5);
PED::SET_PED_CAN_BE_TARGETTED(Local_1336.f_0, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1336.f_0, 1, 0);
WEAPON::GIVE_WEAPON_TO_PED(Local_1336.f_0, joaat("weapon_pistol"), 15, 0, 1);
...
struct<3> Var0;
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0)){
if(!ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0) && !ENTITY::DOES_ENTITY_EXIST(iLocal_1359)){
iLocal_1359=OBJECT::CREATE_OBJECT(iLocal_86, ENTITY::GET_ENTITY_COORDS(Local_1348.f_0, 1), 1, 1, 0);
OBJECT::SET_OBJECT_PHYSICS_PARAMS(iLocal_1359, 0.1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
ENTITY::ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(iLocal_1359, Local_1348.f_0, -1, -1, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_1348.f_0, ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(Local_1348.f_0, 5)) + Vector(0f, 0f, 0.02f), 0f, 0f, 0f, 0f, 0f, 0f, -1f, 1, 1, 0, 1, 2);
ENTITY::SET_ENTITY_VISIBLE(iLocal_1359, 0, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_1352[0 /*2*/])){
if(ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0)){
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, MISC::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &(Var0.f_2), 0, 0);
Local_1352[0 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_85, Var0, 1, 1, 0);
}else{
Local_1352[0 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_85, ENTITY::GET_ENTITY_COORDS(Local_1348.f_0, 1), 1, 1, 0);
OBJECT::SET_OBJECT_PHYSICS_PARAMS(Local_1352[0 /*2*/], 3.5f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1352[0 /*2*/], Local_1348.f_0, -1, -0.2f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_1352[0 /*2*/], 1);
}}
if(!ENTITY::DOES_ENTITY_EXIST(Local_1352[1 /*2*/])){
if(ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0)){
Var0={
...
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &(Var0.f_2), 0, 0);
Local_1352[1 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_85, Var0, 1, 1, 0);
}else{
Local_1352[1 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_85, ENTITY::GET_ENTITY_COORDS(Local_1348.f_0, 1), 1, 1, 0);
OBJECT::SET_OBJECT_PHYSICS_PARAMS(Local_1352[1 /*2*/], 3.5f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1352[1 /*2*/], Local_1348.f_0, -1, 0f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_1352[1 /*2*/], 1);
}}
if(!ENTITY::DOES_ENTITY_EXIST(Local_1352[2 /*2*/])){
if(ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0)){
Var0={
...
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &(Var0.f_2), 0, 0);
Local_1352[2 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_85, Var0, 1, 1, 0);
}else{
Local_1352[2 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_85, ENTITY::GET_ENTITY_COORDS(Local_1348.f_0, 1), 1, 1, 0);
OBJECT::SET_OBJECT_PHYSICS_PARAMS(Local_1352[2 /*2*/], 3.5f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1352[2 /*2*/], Local_1348.f_0, -1, 0.2f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_1352[2 /*2*/], 1);
}}}}
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1335, -183807561);
...
iLocal_1360=PED::ADD_SCENARIO_BLOCKING_AREA(713.7754f, -996.4443f, 22.3085f, 715.7624f, -991.7067f, 25.6214f, 0, 1, 1, 1);
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1359, PLAYER::PLAYER_PED_ID(), 0)){
...
iLocal_1365++;
if(iLocal_1365 >=3){
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Lock_Destroyed", iLocal_1359, "JWL_PREP_2A_SOUNDS", 0, 0);
}
else{
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Lock_Damage", iLocal_1359, "JWL_PREP_2A_SOUNDS", 0, 0);
}}}
}
else{
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_1359);
}}
if(((((iLocal_1365 >=3 || ENTITY::IS_ENTITY_DEAD(iLocal_1359, 0)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1348.f_0, 2)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1348.f_0, 3)) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1348.f_0, 2) > 0f) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1348.f_0, 3) > 0f){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1359)){
OBJECT::DELETE_OBJECT(&iLocal_1359);
}
if(!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1348.f_0, 2)){
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1348.f_0, 2, 0, 0);
}
if(!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1348.f_0, 3)){
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1348.f_0, 3, 0, 0);
}
iLocal_1377=0;
iLocal_1378=0;
...
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1348.f_0, 2, 1, 0);
VEHICLE::SET_VEHICLE_DOOR_LATCHED(Local_1348.f_0, 2, 0, 0, 1);
iLocal_1377=1;
}
}
else{
...
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_1348.f_0, 3, 1, 0);
VEHICLE::SET_VEHICLE_DOOR_LATCHED(Local_1348.f_0, 3, 0, 0, 1);
iLocal_1378=1;
}
}
else{
...
if(bParam1){
Var0={
func_317(ENTITY::GET_ENTITY_COORDS(iParam0, 1) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-MISC::GET_RANDOM_INT_IN_RANGE(3, 6)), MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) 
};
...
ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(iParam0, Local_1348.f_0, 1);
}}}
...
float fVar8;
if(!func_135(uParam0)){
if(((!ENTITY::DOES_ENTITY_EXIST(Local_1336.f_0) || PED::IS_PED_INJURED(Local_1336.f_0)) || (ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) && func_204(Local_1348.f_0, Local_1336.f_0, 1) > 200f)) || (!PED::IS_PED_IN_ANY_VEHICLE(Local_1336.f_0, 0) && func_204(Local_1348.f_0, Local_1336.f_0, 1) > 200f)){
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)){
VEHICLE::SET_VEHICLE_DISABLE_TOWING(Local_1348.f_0, 0);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&Local_1336);
func_315(uParam0);
}else{
if((uParam0->f_1 !=5 && uParam0->f_1 !=3) && ((!ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)) || !PED::IS_PED_IN_VEHICLE(Local_1336.f_0, Local_1348.f_0, 0))){
iLocal_1367=0;
iLocal_1368=0;
...
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1348.f_0, 0)){
if((ENTITY::IS_ENTITY_STATIC(PLAYER::PLAYER_PED_ID()) || fLocal_1363 > 0.5f) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, 0f, 2f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1348.f_0, 0f, 10f, 2f), 4.5f, 0, 1, 0)){
if(!AUDIO::IS_HORN_ACTIVE(Local_1348.f_0)){
if(iLocal_1380==-1){
iLocal_1380=MISC::GET_GAME_TIMER();
}
elseif((MISC::GET_GAME_TIMER() - iLocal_1380) > 5000){
VEHICLE::START_VEHICLE_HORN(Local_1348.f_0, 2000, joaat("normal"), 0);
}}else{
iLocal_1380=-1;
}}
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1348.f_0, -990.6312f, -2413.214f, 12.69471f, -996.0194f, -2422.608f, 16.05846f, 8.75f, 0, 1, 0)){
...
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1336.f_0, Local_1348.f_0, &Global_97543, 786475, -1, 24, -1, 12f, 0, 1073741824);
}
}}
break;
case 2:
...
StringCopy(&cLocal_1369, "", 24);
func_313(uParam0, 5, 0);
}elseif(!func_321(Local_1336.f_0, joaat("script_task_vehicle_follow_waypoint_recording"), 1)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1348.f_0, -1096.139f, -2467.117f, 12.69561f, -1101.641f, -2476.775f, 15.6304f, 7.8125f, 0, 1, 0)){
iLocal_1367=0;
iLocal_1368=0;
StringCopy(&cLocal_1369, "", 24);
func_313(uParam0, 3, 0);
...
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1336.f_0, Local_1348.f_0, "jhp2a_airport", 786475, -1, 24, -1, 12f, 0, 1073741824);
}}
break;
case 3:
...
StringCopy(&cLocal_1369, "", 24);
func_313(uParam0, 5, 0);
}elseif(PED::IS_PED_IN_VEHICLE(Local_1336.f_0, Local_1348.f_0, 1)){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_1334);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_1334);
TASK::TASK_PERFORM_SEQUENCE(Local_1336.f_0, uLocal_1334);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1334);
}}
break;
case 4:
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1348.f_0, 0, 1)){
iVar7++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1348.f_0, 1, 1)){
iVar7++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1348.f_0, 4, 1)){
iVar7++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_1348.f_0, 5, 1)){
iVar7++;
}
...
StringCopy(&cLocal_1369, "", 24);
func_313(uParam0, 5, 0);
}elseif(!func_321(Local_1336.f_0, joaat("script_task_vehicle_mission"), 1)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_1336.f_0, Local_1348.f_0, PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 400f, 10f, 0);
}
break;
case 5:
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) && !ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0)){
if(PED::IS_PED_IN_VEHICLE(Local_1336.f_0, Local_1348.f_0, 0)){
...
}}elseif(!func_321(Local_1336.f_0, joaat("script_task_leave_vehicle"), 1)){
TASK::TASK_LEAVE_VEHICLE(Local_1336.f_0, Local_1348.f_0, 256);
}
}
elseif(!func_321(Local_1336.f_0, joaat("script_task_combat"), 1)){
PED::SET_PED_CAN_BE_TARGETTED(Local_1336.f_0, 1);
TASK::TASK_COMBAT_PED(Local_1336.f_0, PLAYER::PLAYER_PED_ID(), 0, 16);
}}
if(ENTITY::DOES_ENTITY_EXIST(Local_1348.f_0) && !ENTITY::IS_ENTITY_DEAD(Local_1348.f_0, 0)){
VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_1348.f_0, 2, 1);
VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_1348.f_0, 3, 1);
}
break;
}}
...
break;
case 1:
if(!PED::IS_PED_IN_VEHICLE(Local_1336.f_0, Local_1348.f_0, 0) || iLocal_1333==3){
if(!PED::IS_PED_IN_VEHICLE(Local_1336.f_0, Local_1348.f_0, 0)){
iLocal_1367=4;
}else{
iLocal_1367++;
}}elseif(func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_1336.f_0)){
...
fVar8=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_1336.f_0, 1));
...
if(func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_1336.f_0)){
if(MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_1369)){
if((MISC::GET_GAME_TIMER() - iLocal_1368) > 5000 && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_1336.f_0, 1)) < 400f){
if(MISC::GET_RANDOM_INT_IN_RANGE(0, 2)==0){
...
elseif(func_320(&uLocal_1156, &cLocal_79, &cLocal_1369, 8, 0, 0, 0)){
iLocal_1367++;
}}}
break;
case 1:
