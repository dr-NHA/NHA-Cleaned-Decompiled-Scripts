...
fLocal_47=-1f;
Local_107={
154.92f, 6841.12f, 19.14f 
};
iLocal_125=200;
Local_139={
-1161.199f, 934.5912f, 196.7591f 
};
Local_142={
...
}elseif(!PED::IS_PED_INJURED(iLocal_54[1])){
...
iLocal_59=VEHICLE::CREATE_VEHICLE(joaat("granger"), -1155.043f, 942.9685f, 197.4921f, 161.1247f, 1, 1, 0);
ENTITY::SET_ENTITY_LOD_DIST(iLocal_59, 200);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_59, 1.5f);
iLocal_57=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_59, 26, joaat("s_m_m_highsec_01"), -1, 1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_57, joaat("weapon_pistol"), -1, 1, 1);
...
if(VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[0], iLocal_58, -1, 0, 0) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[0], iLocal_58, 0, 0, 0)){
if(!iLocal_164){
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_58, -0.5f, 0.5f, 0f), PLAYER::PLAYER_PED_ID(), 3f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
...
iLocal_164=1;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[0], joaat("script_task_perform_sequence"))==1){
...
if(VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[1], iLocal_58, -1, 0, 0) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_54[1], iLocal_58, 0, 0, 0)){
if(!iLocal_164){
...
VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_58, 1);
iLocal_164=1;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[1], joaat("script_task_perform_sequence"))==1){
...
elseif(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iLocal_53)){
PED::SET_ENABLE_HANDCUFFS(iLocal_53, 1);
PED::SET_ENABLE_BOUND_ANKLES(iLocal_53, 1);
ENTITY::SET_ENTITY_HEALTH(iLocal_53, 0, 0);
}}
...
}}}elseif(((!PED::IS_PED_IN_GROUP(iLocal_53) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_53, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, joaat("script_task_perform_sequence")) !=1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, joaat("script_task_perform_sequence")) !=0){
...
}}}elseif(!HUD::DOES_BLIP_EXIST(uLocal_114)){
uLocal_114=func_68(iLocal_53, 0, 145);
}
if(!PED::IS_PED_IN_GROUP(iLocal_53)){
...
var func__66(struct<3> Param0, int iParam3){
var uVar0;
...
var func__68(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
iLocal_149=0;
}}}elseif((!iLocal_149 && func_12()) && !func_53()){
Local_156={
func_55() 
};
Local_150={
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_78, 4.5f, 0, 0, 0, 0, 0, 0, 0);
...
elseif(!PED::IS_PED_IN_GROUP(iLocal_53)){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_53, func_60());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_53, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_53, 0);
}}elseif(!PED::IS_PED_IN_GROUP(iLocal_53)){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_103(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_109(iParam2), 1);
}
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_60, iLocal_54[0], PED::GET_PED_BONE_INDEX(iLocal_54[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
TASK::CLEAR_PED_TASKS(iLocal_54[0]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, 3.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_65);
PED::SET_PED_KEEP_TASK(iLocal_54[0], 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_54[0], 0, 0);
iLocal_145=1;
}}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
TASK::TASK_CLEAR_LOOK_AT(0);
...
iLocal_64=0;
while (iLocal_64 <=1){
iLocal_54[iLocal_64]=PED::CREATE_PED(26, iLocal_103, Local_81[iLocal_64 /*3*/], fLocal_98[iLocal_64], 1, 1);
...
iLocal_60=OBJECT::CREATE_OBJECT(joaat("prop_ld_shovel"), Local_107, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_shovel"));
uLocal_61[0]=OBJECT::CREATE_OBJECT(joaat("p_arm_bind_cut_s"), Local_107, 1, 1, 0);
uLocal_61[1]=OBJECT::CREATE_OBJECT(joaat("p_arm_bind_cut_s"), Local_107 + Vector(1f, 1f, 1f), 1, 1, 0);
...
Local_78={
163.4486f, 6839.993f, 18.86f 
};
fLocal_97=0f;
Local_81[0 /*3*/]={
162.8193f, 6837.257f, 18.9614f 
};
fLocal_98[0]=297.0056f;
Local_81[1 /*3*/]={
162.5046f, 6841.68f, 18.8426f 
};
fLocal_98[1]=193.3866f;
Local_88={
169.3462f, 6837.805f, 19.1421f 
};
fLocal_101=265.6862f;
Local_91={
164.0896f, 6836.923f, 19.03899f 
};
Local_94={
168.9638f, 6834.302f, 24.99057f 
};
iLocal_66=1;
}
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_53, 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_53, 1);
}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
PED::SET_ENABLE_HANDCUFFS(iLocal_53, 1);
PED::SET_ENABLE_BOUND_ANKLES(iLocal_53, 1);
}}
iVar0=0;
