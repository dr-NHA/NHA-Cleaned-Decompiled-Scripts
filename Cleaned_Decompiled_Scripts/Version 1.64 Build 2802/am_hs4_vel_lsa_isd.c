...
uParam0->f_22=PED::CREATE_PED(4, func_68(), uParam0->f_9, 0f, 0, 0);
...
var func__77(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12){
...
SCRIPT::SEND_TU_SCRIPT_EVEN(1, &Var0, 5, func_82(1, 1));
}


var func__82(int iParam0, bool bParam1){
var uVar0;
bool bVar1;
int iVar2;
bVar1=false;
...
iVar1=iParam0;
return MISC::IS_BIT_SET(uVar0, func_114(iVar1));
}
...
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(iVar2))){
}else{
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_151(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_148(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_147()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(iVar7 + 1))){
...
var func__136(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(func_143(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
Vector3 func__157(struct<3> Param0){
...
if(iVar0==PLAYER::PLAYER_ID()){
uParam0->f_23=PED::CLONE_PED_ALT(func_270(), 0, 0, 1, 1);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23)){
return 0;
}}else{
uParam0->f_23=PED::CLONE_PED_ALT(func_270(), 0, 0, 0, 0);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23)){
return 0;
}
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_179(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_179(iParam2));
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78341[1 /*14*/]={
func_206(iVar0, iParam1, iParam2, -1) 
};
...
}}elseif(func_191(iVar0, 4, iParam2, &uVar68)){
return func_190(iParam0, 4, uVar68);
}}
...
return 1;
}elseif(func_195(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_179(iParam0));
if(iVar57 > iVar56){
...
var func__232(var uParam0, int iParam1){
var uVar0;
...
var func__259(bool bParam0){
if(bParam0){
return (MISC::IS_BIT_SET(Global_4718592.f_160050, 12) && func_260());
}
...
elseif(func_110(PLAYER::PLAYER_ID(), 1) && Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10.f_76.f_21 !=0){
return 1;
}}
break;
default:
...
if(func_267(1)){
uVar0=PLAYER::GET_PLAYER_PED(func_266());
}
return uVar0;
}
...
func_288(&uLocal_95, 3178.632f, -4960.667f, 99.0647f, -3.4084f, -0.004f, -78.1044f, "HS4_VEL_LSA_ISD", 1, 1, 5, 0);
}
