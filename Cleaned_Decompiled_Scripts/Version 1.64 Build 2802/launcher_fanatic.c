...
return 0;
}}elseif(func_203(iParam0->f_28[0])){
if(func_179(iParam0)){
if(func_183(2)){
if(func_181(iParam0->f_27)){
func_180(iParam0->f_27, *iParam0);
...
if(*iParam0==6){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_203(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
...
var func__189(int iParam0, int iParam1){
switch (iParam0){
case 5:
if(iParam1 > -1){
...
void func_193(var uParam0, char* sParam1, char* sParam2, int iParam3){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_194(iParam3), 0);
}
...
uParam1->f_3=5;
}elseif((func_215(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
float fVar6;
Var0={
func_232(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_232(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__232(struct<3> Param0){
float fVar0;
float fVar1;
...
if(func_203(PLAYER::PLAYER_PED_ID()) && func_203(uParam0)){
...
float fVar6;
Var0={
func_232(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
int func_254(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_36(iParam1)){
...
void func_263(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6){
func_264(uParam0);
