...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_279(&num, true);
func_211(num);
...
if(num==21) func_200(&num, vector, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
elseif(num==22) func_195(&num, vector, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
elseif(num==23)if(iLocal_96==0)if(func_200(&num, vector, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50)) iLocal_96=1;
else func_192(&num);
if(func_177(&num, 0)){
if(func_176(num)) func_173(num, &blLocal_98);
if(!func_2(&num)) func_279(&num, true);
if(func_1(&num)) func_279(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xC3C{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6A53{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x71A3{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x752F{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x766E{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x83F1{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BF3{
...
var func__175(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC057{
if(bParam0) return uParam1;
return uParam2;
}
...
func_295("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_181(uParam0->f_27)){
func_180(uParam0->f_27, *uParam0);
func_295("RC5_IN_ACTIVATION_RANGE:
...
if(func_181(true)){
func_180(1, *uParam0);
func_295("RC_IN_ACTIVATION_RANGE:
...
func_295("RC_STOP_PLAYER_VEHICLE_CHECK:
...
uParam0->f_60=MISC::GET_GAME_TIMER();
return true;
}}elseif(func_201(sParam5)){
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))if(func_199(PLAYER::PLAYER_PED_ID(), uParam1, true) >=20f) func_148();
}}
return false;
}
...
if(Global_43257==17){
if(*uParam0 !=-1) func_209(uParam0);
}elseif(func_208()){
if(*uParam0 !=-1) func_209(uParam0);
}elseif(*uParam0==-1){
if(func_199(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_207(uParam0, 1);
}else{
...
if(func_199(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_209(uParam0);
}}}
return;
}
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_205(*uParam0, false);
...
var unk;
if(Global_78558){
func_295("IS_RC_FINE_AND_IN_RANGE():
The game is running Multiplayer [TERMINATING]");
return false;
}
func_115(*panParam0, &unk);
if(func_249(*panParam0) || func_247(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_295("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_242(panParam0->f_28[0]);
func_295("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_222(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_222(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_219(panParam0);
else func_217(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(func_216(&(panParam0->f_48)) && bParam1) func_213(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
if(func_215(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_215(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_214(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(num !=-1) func_233(&iLocal_37[num /*4*/]);
return false;
}
...
Vector3 func__228(Ped pedParam0, int iParam1) // Position - 0xEC88{
...
float num;
unk={
func_232(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_232(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__232(float fParam0, var uParam1, var uParam2) // Position - 0xEE49{
float num;
float num2;
...
float num;
unk={
func_232(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_246() && !func_245()) return true;
if(!func_244(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_248() && Global_100681.f_11==6 && iParam0==func_171(&(Global_100681.f_3), 0)) return true;
return false;
}
...
switch (*uParam0){
case 21:
if(!func_265(uParam0)) return false;
break;
case 22:
if(!func_259(uParam0)) return false;
break;
case 23:
if(!func_252(uParam0)) return false;
break;
}
if(*uParam0==22){
iLocal_93=func_251();
...
break;
case 1:
if(!func_257(&num) || !func_256(&(uParam0->f_48))) return false;
iLocal_91=2;
break;
case 2:
flag=true;
...
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_253(&uParam0->f_28[0], CHAR_MARY_ANN, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1)) flag=false;
...
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) func_261(&uParam0->f_35[0], num[2], 808.35f, 1277.2f, 360.15f, 216.5f);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1])) func_261(&uParam0->f_35[1], num[2], 807.89f, 1275.73f, 360.18f, 208.2f);
if(flag) iLocal_91=3;
break;
case 3:
for (i=0;
...
if(func_246() && !func_245()) return false;
if(func_274(iParam0)) return false;
if(iParam0==-1) iParam0=func_170();
if(iParam0==-1) return false;
if(!func_249(iParam0)){
if(!func_273(iParam0)) return false;
if(!func_272(iParam0)) return false;
if(func_271(iParam0)) return false;
}
if(iParam0==58)if(func_269(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
if(func_244(iParam0)) return false;
...
int i;
if(*uParam0==1){
if(func_277(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
char* str;
if(bParam1) func_284(uParam0, 0, false, false);
if(HUD::DOES_BLIP_EXIST(blLocal_98)) HUD::REMOVE_BLIP(&blLocal_98);
func_283(&(uParam0->f_48));
if(*uParam0==22) PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_93, false);
if(iLocal_94 !=-1){
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))if(func_201(sParam0)) func_281();
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_218(&uParam0->[i]);
else func_287(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_264(&uParam0->[i]);
else func_293(&uParam0->[i], false, 1, 0);
}
return;
}
