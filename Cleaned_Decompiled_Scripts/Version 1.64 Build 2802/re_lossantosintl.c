...
break;
case 3:
uLocal_49[0]=VEHICLE::CREATE_VEHICLE(joaat("jet"), Local_61[0 /*3*/], 0, 1, 1, 0);
ENTITY::SET_ENTITY_HEADING(uLocal_49[0], 240.3179f);
VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_49[0], 0);
uLocal_49[1]=VEHICLE::CREATE_VEHICLE(joaat("jet"), Local_61[1 /*3*/], 0, 1, 1, 0);
VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_49[1], 0);
uLocal_49[2]=VEHICLE::CREATE_VEHICLE(joaat("jet"), Local_61[2 /*3*/], 0, 1, 1, 0);
VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_49[2], 0);
uLocal_49[3]=VEHICLE::CREATE_VEHICLE(joaat("jet"), Local_61[3 /*3*/], 0, 1, 1, 0);
VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_49[3], 0);
iVar0=0;
while (iVar0 < 4){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_49[iVar0])){
...
if(bLocal_78){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_49[0], 0)){
if(ENTITY::IS_ENTITY_OCCLUDED(uLocal_49[0]) && !CAM::IS_SPHERE_VISIBLE(Local_61[0 /*3*/], 50f)){
if(VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(101, "AirportJetTakeOff")){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE_WITH_FLAGS(uLocal_49[0], 101, "AirportJetTakeOff", 2, 5, 786603);
iLocal_77=1;
}
...
VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_54, 0);
...
}elseif(!ENTITY::IS_ENTITY_DEAD(uLocal_89, 0) && !PED::IS_PED_INJURED(uLocal_90)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_89);
PED::SET_PED_KEEP_TASK(uLocal_90, 1);
Var0={
ENTITY::GET_ENTITY_COORDS(uLocal_89, 1) 
};
...
Var6={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var0, uVar9, Var3) 
};
