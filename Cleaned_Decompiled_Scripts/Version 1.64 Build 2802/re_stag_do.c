...
if(iLocal_49==3){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_87, 1) < 100f){
...
if(func_66(1, 0, 1)){
func_31();
}}elseif(!PED::IS_PED_INJURED(iLocal_57)){
...
func_27();
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), 1)){
func_27();
return 1;
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_59, 0)){
...
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
if(!PED::IS_PED_INJURED(iLocal_57)){
...
var func__29(struct<3> Param0, int iParam3){
var uVar0;
uVar0=HUD::ADD_BLIP_FOR_COORD(Param0);
HUD::SET_BLIP_SCALE(uVar0, func_30(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_62(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
HUD::SET_BLIP_AS_FRIENDLY(uLocal_319, 1);
}
iLocal_117=0;
iLocal_119=1;
}}}
...
HUD::SET_BLIP_SCALE(uVar0, func_30(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
...
var func__70(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
if(!HUD::DOES_BLIP_EXIST(uLocal_320)){
uLocal_320=func_29(Local_67, 1);
}}}elseif(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_321)){
HUD::REMOVE_BLIP(&uLocal_321);
if(!HUD::DOES_BLIP_EXIST(uLocal_320)){
uLocal_320=func_29(Local_67, 1);
}}}elseif(HUD::DOES_BLIP_EXIST(uLocal_320)){
HUD::REMOVE_BLIP(&uLocal_320);
if(!HUD::DOES_BLIP_EXIST(uLocal_321)){
...
TASK::TASK_GO_TO_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
}
...
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_55, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_55, 0);
}}}}elseif(((!PED::IS_PED_IN_GROUP(iLocal_55) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("script_task_perform_sequence")) !=1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("script_task_perform_sequence")) !=0){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_55, func_73());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_55, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_55, 0);
}}}
...
if(!PED::IS_PED_INJURED(iLocal_55)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_113);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_USE_MOBILE_PHONE_TIMED(0, 30600);
TASK::CLOSE_SEQUENCE_TASK(uLocal_113);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_113);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_113);
}}}
...
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_99, 10f, 0, 0, 0, 0, 0, 0, 0);
...
if(!HUD::DOES_BLIP_EXIST(uLocal_319)){
uLocal_319=func_68(iLocal_59, 0, 0);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_319, true);
}
}
iLocal_117=0;
}}
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_87, 5f, 0, 0, 0, 0, 0, 0, 0);
}}
if(!bLocal_123){
...
iLocal_57=PED::CREATE_PED(4, joaat("ig_bestmen"), -2202.747f, 4299.008f, 47.4293f, 73.0028f, 1, 1);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_113);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57, uLocal_113);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_113);
bLocal_123=true;
}}}
if(!bLocal_124){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_99, 3f, 20000, 1048576000, 0, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
TASK::CLOSE_SEQUENCE_TASK(uLocal_113);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_113);
...
TASK::TASK_GO_TO_ENTITY(iLocal_57, iLocal_55, -1, 8f, 1073741824, 1073741824, 0);
}
if(!HUD::DOES_BLIP_EXIST(uLocal_322)){
...
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_113);
TASK::TASK_PERFORM_SEQUENCE(iLocal_56, uLocal_113);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_113);
iLocal_58=PED::CREATE_PED(4, joaat("ig_bestmen"), -333.3692f, 6157.644f, 30.489f, 83.2763f, 1, 1);
...
break;
}}}elseif(ENTITY::IS_ENTITY_DEAD(iLocal_55, 0)){
func_183();
}}}
...
}}}elseif(PED::IS_PED_IN_VEHICLE(iLocal_55, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) && ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
if(!func_71()){
func_4(&uLocal_136, "stagdau", "stagd_bump1", 4, 0, 0, 0);
}}}}}
...
if(!HUD::DOES_BLIP_EXIST(uLocal_321)){
uLocal_321=func_70(iLocal_55, 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_321, 0);
TASK::TASK_LOOK_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
}
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 10f, 10f, 10f, 0, 1, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_321)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_321, 1);
}
SYSTEM::SETTIMERB(0);
func_98();
while (func_71()){
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iLocal_55)){
if((!func_149() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1131.777f, 2636.418f, 15.589f, -1040.995f, 2717.077f, 31.715f, 60.75f, 0, 1, 0)) && HUD::DOES_BLIP_EXIST(uLocal_321)){
if(!func_71()){
...
HUD::DISPLAY_RADAR(0);
if(!PED::IS_PED_INJURED(iLocal_55)){
MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), 5f, 1, 0, 0, 0);
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_55);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_55, uLocal_318, "re@stag_do@", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_55, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_318, "re@stag_do@", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_113);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_113);
}elseif(!PED::IS_PED_IN_GROUP(iLocal_55)){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_55, func_73());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_55, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_55, 0);
}}elseif(!PED::IS_PED_IN_GROUP(iLocal_55)){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_66, iLocal_55, PED::GET_PED_BONE_INDEX(iLocal_55, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
...
Local_80={
-355.2565f, 6164.931f, 30.2944f 
};
Local_83={
-330.5575f, 6139.852f, 34.4886f 
};
fLocal_86=25.375f;
Local_87={
...
Local_90={
-1991.126f, 457.991f, 101.1808f 
};
Local_93={
-2002.69f, 460.539f, 99.828f 
};
Local_96={
-1997.605f, 445.6651f, 105.0519f 
};
Local_99={
...
fLocal_102=24.6875f;
Local_103={
-2205.351f, 4298.79f, 47.265f 
};
Local_106={
-2207.525f, 4301.697f, 47.1803f 
};
Local_109={
-2195.637f, 4295.407f, 51.1889f 
};
fLocal_112=12.5625f;
Local_67={
Local_90 
...
MISC::CLEAR_AREA_OF_PEDS(ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), 10f, 0);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_113);
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_174()) || Global_112695) || Global_32166) || func_173()) || func_24(8, -1)) || func_172()) || func_171()) || func_170()) || func_169()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_174()) || Global_32166) || func_173()) || func_24(8, -1)) || func_170()) || func_172()) || func_171()) || func_169()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_174()) || Global_112695) || Global_32166) || func_173()) || func_24(8, -1)) || func_172()) || func_171()) || func_169()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_174()) || Global_32166) || func_173()) || func_24(8, -1)) || func_171()) || func_170()) || func_169()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_174()) || func_171()) || Global_112695) || Global_32166) || func_173()) || Global_44446) || func_24(8, -1)) || func_170()) || func_168()) || func_169()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_174()) || Global_112695) || Global_32166) || func_173()) || func_24(8, -1)) || func_170()) || func_168()) || func_172()) || func_171()) || func_169()){
return 0;
}
break;
}}else{
...
PED::REMOVE_PED_FROM_GROUP(iLocal_55);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_55, 0);
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_66)){
ENTITY::DETACH_ENTITY(iLocal_66, 1, 1);
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_219(iParam0, 0, 0)) || func_219(iParam0, 1, 0)) || func_219(iParam0, 2, 0)) || func_218(iParam0) !=145) || func_217(iParam0)) || func_216(iParam0)) || func_215(iParam0)) || func_214(iParam0)) || !func_203(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_216(iParam0)){
}
if(func_216(iParam0)){
}
