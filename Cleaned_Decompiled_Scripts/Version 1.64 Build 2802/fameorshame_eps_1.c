...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_13(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_9() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_13(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_11(-1, false)==8;
...
if(func_14())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(uParam0->f_154 >=*uParam0) return;
...
int num;
num=MISC::GET_GAME_TIMER() + 7500;
if(*uParam1==0) *uParam1=GRAPHICS::REQUEST_SCALEFORM_MOVIE(sParam0);
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam1)) return 1;
if(iParam2==0) return 1;
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam1)){
SYSTEM::WAIT(0);
if(MISC::GET_GAME_TIMER() > num && !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam1)) return 0;
}
return 1;
}
...
if(func_7(PLAYER::PLAYER_PED_ID()) && iParam1==1) MISC::CLEAR_AREA_OF_PEDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 500f, 0);
return;
}
...
if(func_39()) return;
if(Global_20584)if(func_38()) func_37(true, true);
else func_37(false, false);
if(Global_20383.f_1==10 || Global_20383.f_1==9) MISC::SET_BIT(&Global_8254, 16);
if(AUDIO::IS_MOBILE_PHONE_CALL_ONGOING()) AUDIO::STOP_SCRIPTED_CONVERSATION(false);
Global_21725=5;
...
if(CUTSCENE::IS_CUTSCENE_PLAYING()) CUTSCENE::STOP_CUTSCENE_IMMEDIATELY();
...
if(hParam0 !=0) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hParam0);
return;
}
...
i < uParam0->f_17;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_17[i]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_17[i], false)) ENTITY::STOP_ENTITY_ANIM(uParam0->f_17[i], animation, animGroup, -1000f);
