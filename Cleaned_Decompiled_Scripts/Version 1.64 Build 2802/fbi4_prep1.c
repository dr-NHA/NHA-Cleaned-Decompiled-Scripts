...
iLocal_684=2;
}elseif(!func_106("PRA_LEVAREA", 0, 0)){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_48(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_868.f_0, 0)){
...
return 1;
}elseif(((func_149(2, Local_868.f_1, Local_868.f_4) && func_149(3, Local_840.f_1, Local_840.f_4)) && func_149(4, Local_854.f_1, Local_854.f_4)) && func_141(0)){
func_142();
func_147(33);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_111[0 /*11*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
...
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_109, 1) 
};
iVar4=0;
while (iVar4 <=(iLocal_81 - 1)){
fVar28=MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Local_134[iVar4 /*25*/], 1);
...
Vector3 func__137(bool bParam0){
struct<3> Var0;
var uVar3;
if(!bParam0){
...
Var0={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_109, uVar3) 
};
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_109, Var0) 
};
if(!bParam0){
Var0={
Var0 + Vector(0.5f, 0f, 1f) 
};
}else{
Var0={
Var0 + Vector(0.5f, 0f, -1f) 
...
return 1;
}elseif(STREAMING::HAS_ANIM_DICT_LOADED("missfbi4prepp1") && STREAMING::HAS_ANIM_SET_LOADED("missfbi4prepp1_garbageman")){
return 1;
}
return 0;
}
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_868.f_0, 1);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_868.f_0, 1);
return 1;
}}elseif(func_153(&Local_868, Local_868.f_5, Local_868.f_1, Local_868.f_4, 1)){
func_36(Local_868.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_868.f_0, 1);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_868.f_0, 1);
return 1;
...
if(!PED::IS_PED_DEAD_OR_DYING(Global_97178.f_9[0], 1)){
...
PED::SET_PED_CONFIG_FLAG(Local_840.f_0, 170, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_840.f_0, 65536, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_840.f_0, 50, 1);
return 1;
}}else{
return 1;
}}elseif(func_150(&Local_840, Local_840.f_5, Local_840.f_1, Local_840.f_4, 1, 0, 1, 1)){
if(func_37(Local_868.f_0)){
...
if(!PED::IS_PED_DEAD_OR_DYING(Global_97178.f_9[1], 1)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97178.f_9[1], 1, 1);
Local_854.f_0=Global_97178.f_9[1];
if(func_343(Local_854.f_0)){
PED::SET_PED_CONFIG_FLAG(Local_854.f_0, 170, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_854.f_0, 65536, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_854.f_0, 50, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_854.f_0, true);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_854.f_0, 1, 1);
return 1;
}}else{
return 1;
}}elseif(func_150(&Local_854, Local_854.f_5, Local_854.f_1, Local_854.f_4, 1, 0, 1, 1)){
if(func_37(Local_868.f_0)){
...
func_7(&(uParam0->f_4));
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!func_157(PLAYER::PLAYER_PED_ID(), *uParam0, 150f, 1) && !bLocal_665){
...
if(func_177(*uParam0, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7)){
func_176(uParam0, 1);
return;
}}
if((MISC::GET_GAME_TIMER() - uParam0->f_1) > uParam0->f_3){
...
uParam0->f_6=12;
uParam0->f_1=MISC::GET_GAME_TIMER();
}elseif(!func_184(*uParam0, joaat("script_task_cower"))){
if(func_184(*uParam0, joaat("script_task_combat"))){
TASK::CLEAR_PED_TASKS(*uParam0);
}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_111[func_171(uParam0->f_10) /*11*/])){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_667, 1f, -1, 2f, 0, 1193033728);
}}
uParam0->f_1=MISC::GET_GAME_TIMER();
uParam0->f_6=23;
uParam0->f_5=1;
...
if(func_170(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 1.5f){
...
if(!func_157(*uParam0, PLAYER::PLAYER_PED_ID(), 15f, 1)){
func_7(&(uParam0->f_4));
uParam0->f_6=7;
uParam0->f_1=MISC::GET_GAME_TIMER();
}}
...
if(!func_157(*uParam0, PLAYER::PLAYER_PED_ID(), 120f, 1)){
func_5(uParam0, 1, 0, 1);
}}else{
func_168(uParam0);
}
...
if((MISC::GET_GAME_TIMER() - uParam0->f_1) > uParam0->f_2 || !func_184(*uParam0, joaat("script_task_drive_by"))){
func_163(uParam0);
}
break;
case 12:
...
func_163(uParam0);
uParam0->f_1=MISC::GET_GAME_TIMER();
}elseif(func_177(Local_111[func_171(uParam0->f_10) /*11*/], *uParam0, 1126825984, 1, 250, 7)){
func_176(uParam0, 0);
}else{
func_162(uParam0);
uParam0->f_1=MISC::GET_GAME_TIMER();
...
uParam0->f_5=1;
uParam0->f_6=16;
}}elseif((MISC::GET_GAME_TIMER() - iLocal_670) >=5000 && (MISC::GET_GAME_TIMER() - iLocal_670) <=5500){
if(PED::IS_PED_IN_ANY_VEHICLE(*uParam0, 0)){
...
float fVar6;
Var0={
func_160(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_160(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__160(struct<3> Param0){
float fVar0;
float fVar1;
...
iVar0=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(func_37(iVar0)){
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(*uParam0, iVar0, -1, 0, 0)){
uParam0->f_6=18;
uParam0->f_1=MISC::GET_GAME_TIMER();
}}}}
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_80, joaat("player"));
switch (uParam0->f_8){
case 4:
break;
case 10:
...
if(!PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0)){
if(uParam0->f_10==0){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(0)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}}}
break;
case 2:
...
if(uParam0->f_9==1){
func_164(uParam0);
}elseif(uParam0->f_10==0){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(0)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}}elseif(!PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0)){
if(uParam0->f_10==0){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}else{
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_134[iLocal_661 /*25*/].f_19, 1f, 20000, -1f, 0, func_165(Local_134[iLocal_661 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*uParam0, 1), 1));
}
if(func_37(iLocal_109)){
...
if(func_37(iLocal_109) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_109, 0) && !PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0))){
...
var func__173(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
if(!func_157(PLAYER::PLAYER_PED_ID(), *uParam0, 10f, 1)){
...
Vector3 func__179(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_160(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
uParam0->f_7=3;
}}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_109, 1)){
func_176(uParam0, 0);
return;
}
break;
...
TASK::OPEN_SEQUENCE_TASK(&uVar0);
if(func_170(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_134[iLocal_661 /*25*/].f_19) > 1.5f){
...
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
uParam0->f_9=2;
}elseif(func_191(Local_134[iLocal_661 /*25*/].f_19, *uParam0, 1f, 1f, 8f)){
func_190(uParam0);
return;
}
...
if(func_10(Local_134[iLocal_661 /*25*/].f_17) && !ENTITY::IS_ENTITY_ATTACHED(Local_134[iLocal_661 /*25*/].f_17)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_134[iLocal_661 /*25*/].f_17, *uParam0, PED::GET_PED_BONE_INDEX(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
}}}
if(func_191(Local_134[iLocal_661 /*25*/].f_19, *uParam0, 1f, 1f, 8f)){
func_190(uParam0);
return;
}}elseif(!func_184(*uParam0, joaat("script_task_follow_nav_mesh_to_coord"))){
if(func_37(iLocal_109)){
...
if(!func_184(*uParam0, joaat("script_task_follow_nav_mesh_to_coord"))){
TASK::OPEN_SEQUENCE_TASK(&uVar1);
if(func_170(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), ENTITY::GET_ENTITY_COORDS(iLocal_109, 1)) > 3f){
...
var uVar0;
var uVar1;
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_80, joaat("player"));
func_169(uParam0);
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(*uParam0, 0)){
TASK::TASK_PUT_PED_DIRECTLY_INTO_MELEE(*uParam0, PLAYER::PLAYER_PED_ID(), 8f, -1f, 10f, 0);
...
return 1;
}}}}elseif(ENTITY::IS_ENTITY_A_PED(Local_82.f_18)){
if(func_10(Local_82.f_18)){
...
TASK::TASK_VEHICLE_PARK(0, iLocal_109, Local_134[iLocal_661 /*25*/].f_3, Local_134[iLocal_661 /*25*/].f_8, Local_134[iLocal_661 /*25*/].f_10, 5f, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(*uParam0, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
uParam0->f_7=6;
...
func_197(uParam0);
}elseif(!func_184(*uParam0, joaat("script_task_go_to_entity")) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0)){
TASK::CLEAR_PED_TASKS(*uParam0);
TASK::TASK_GO_TO_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 4f, 1f, 1073741824, 0);
}}elseif(func_107(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_137(bParam1)), 5f, 1)){
iVar0=-1;
if(!bParam1){
iVar0=0;
}
...
if(uParam0->f_5 !=1){
if(func_37(iLocal_109) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(!func_184(*uParam0, joaat("script_task_drive_by")) && PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0)){
if(func_157(PLAYER::PLAYER_PED_ID(), iLocal_109, 10f, 1)){
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_109, PLAYER::PLAYER_PED_ID())){
TASK::TASK_DRIVE_BY(*uParam0, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 10f, 100, 1, joaat("FIRING_PATTERN_FULL_AUTO"));
uParam0->f_1=MISC::GET_GAME_TIMER();
uParam0->f_6=9;
}}}}}}
...
}}elseif(Local_134[iVar0 /*25*/].f_23 !=0){
...
Local_667={
ENTITY::GET_ENTITY_COORDS(Local_111[func_171(iParam1) /*11*/], 1) 
};
uParam0->f_1=MISC::GET_GAME_TIMER();
uParam0->f_8=uParam0->f_7;
uParam0->f_5=1;
...
func_176(uParam0, 0);
}}}elseif(Local_111[func_171(iParam1) /*11*/].f_6==22){
if(func_181(*uParam0, Local_111[func_171(iParam1) /*11*/], 140f, 0) && func_157(Local_111[func_171(iParam1) /*11*/], PLAYER::PLAYER_PED_ID(), 15f, 1)){
uParam0->f_5=1;
uParam0->f_6=21;
}}elseif(Local_111[func_171(iParam1) /*11*/].f_6==5 || Local_111[func_171(iParam1) /*11*/].f_6==7){
...
if(iParam1==0){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(*uParam0, iLocal_109, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
uParam0->f_6=7;
...
TASK::TASK_COWER(*uParam0, -1);
uParam0->f_6=12;
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_111[func_171(iParam1) /*11*/], iLocal_109, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
...
uParam0->f_5=1;
}elseif(PED::IS_PED_BEING_JACKED(*uParam0)){
func_169(uParam0);
TASK::TASK_SMART_FLEE_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 1);
uParam0->f_6=2;
uParam0->f_5=1;
...
if(bParam4){
return 0;
}elseif(func_205(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
if(func_157(uParam0, PLAYER::PLAYER_PED_ID(), 6f, 1)){
if(!PED::IS_PED_IN_ANY_VEHICLE(uParam0, 0)){
...
iLocal_837=1;
}}elseif(!func_157(PLAYER::PLAYER_PED_ID(), Local_868.f_0, 120f, 1) && iLocal_837){
...
*iParam2=2;
}}elseif(func_220(*iParam0) || func_219(*iParam0)){
func_7(iParam3);
if(func_106(func_114(func_77()), 0, 0)){
HUD::CLEAR_THIS_PRINT(func_114(func_77()));
}
...
int iVar0;
int iVar1;
if((func_343(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_37(iParam0)){
...
}}}}elseif(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, 1)){
if(func_231(iVar2)){
...
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), Local_827, 20f, 0, 0, 34340901, 2f, 10f);
}
else{
PATHFIND::REQUEST_PATH_NODES_IN_AREA_THIS_FRAME(623.3781f, -172.26f, 1700.732f, -2115.843f);
}}}elseif(func_229(iVar2)){
if(func_37(Local_868.f_0)){
if(!func_157(iVar2, Local_868.f_0, 17f, 1)){
if(TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("script_task_vehicle_mission")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("script_task_vehicle_mission")) !=0){
TASK::TASK_VEHICLE_MISSION(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), Local_868.f_0, 3, 20f, 786468, 2f, 0.5f, 1);
}
}}}else{
func_223(iVar2);
}}}
...
if(!func_230()){
if((ENTITY::DOES_ENTITY_EXIST(Local_868.f_0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_868.f_0, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_868.f_0, Local_827, 2f, 2f, 2f, 0, 1, 0)){
if((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_868.f_0, 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(PED::IS_PED_IN_VEHICLE(iParam0, Local_868.f_0, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_868.f_0, -1, 0)==iParam0){
return 1;
}}}}
return 0;
}
...
}}elseif(func_107(PLAYER::PLAYER_PED_ID(), Local_827, 240f, 1)){
if(iLocal_877){
func_6(&uLocal_876);
iLocal_877=0;
}}}
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_253(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
func_285(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
}}}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_305(iParam0, 0, 0)) || func_305(iParam0, 1, 0)) || func_305(iParam0, 2, 0)) || func_328(iParam0) !=145) || func_304(iParam0)) || func_303(iParam0)) || func_302(iParam0)) || func_301(iParam0)) || !func_289(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_303(iParam0)){
}
if(func_303(iParam0)){
}
...
if(!func_157(PLAYER::PLAYER_PED_ID(), uLocal_875, fVar0, 1)){
iVar1++;
}}else{
iVar1++;
}
...
if(func_352()==0){
return MISC::IS_BIT_SET(func_350(func_351(iParam0), -1, 0), iParam1);
}}else{
...
iLocal_1048[2]=0;
Local_688[0 /*8*/]={
func_362("FP1_WANTM", "FP1_LOSTM", "FP1_THEREM", "FP1_CHATFM", "", "FP1_CHATTM") 
};
Local_688[1 /*8*/]={
func_362("FP1_WANTT", "FP1_LOSTT", "FP1_THERET", "FP1_CHATFM", "FP1_CHATFT", "") 
};
Local_688[2 /*8*/]={
func_362("FP1_WANTF", "FP1_LOSTF", "FP1_THEREF", "", "FP1_CHATFT", "FP1_CHATTM") 
};
}
...
struct<3> Var0[6];
Var0[0 /*3*/]={
1251.308f, -400.6231f, 68.0926f 
};
Var0[1 /*3*/]={
1183.993f, -403.3443f, 66.8734f 
};
Var0[2 /*3*/]={
1161.54f, -372.6073f, 66.6034f 
};
Var0[3 /*3*/]={
1167.644f, -273.7987f, 67.9705f 
};
Var0[4 /*3*/]={
1252.362f, -247.353f, 77.5631f 
};
Var0[5 /*3*/]={
1330.062f, -341.0342f, 100.3476f 
};
func_367(&Var0, 6);
}
...
void func_373(){
Local_840={
func_374(1200.61f, -344.2721f, 68.0424f, 269.2015f, joaat("s_m_y_garbage")) 
};
Local_854={
func_374(1202.42f, -341.6034f, 67.9378f, 273.1125f, joaat("s_m_y_garbage")) 
};
}
...
void func_375(){
Local_868={
func_376(1203.146f, -337.3543f, 67.9314f, 189.7047f, joaat("trash")) 
};
}
