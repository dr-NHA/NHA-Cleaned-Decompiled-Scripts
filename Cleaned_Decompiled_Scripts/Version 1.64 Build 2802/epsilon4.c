...
Local_144={
1813.294f, 4698.785f, 38.9553f 
};
Local_147={
1827.178f, 4698.114f, 38.1653f 
};
fLocal_150=187.4554f;
Local_151={
1811.96f, 4697.071f, 39.1076f 
};
fLocal_154=330.5137f;
Local_155={
1814.02f, 4697.051f, 38.9678f 
};
fLocal_158=24.0044f;
iLocal_159=joaat("weapon_digiscanner");
uLocal_160=WEAPON::GET_WEAPONTYPE_MODEL(iLocal_159);
sLocal_161="empty";
iLocal_339=1;
iLocal_764=-1;
iLocal_765=-1;
...
uLocal_360=GRAPHICS::SET_GRASS_CULL_SPHERE(1751.65f, 4676.77f, 43.03f, 1.5f);
func_402();
func_385();
func_384();
Local_772.f_0=0;
...
}elseif(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster") >=0.5f){
...
Var10={
func_20(iParam0, iParam1, iParam2, bParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9) 
};
iVar20=0;
func_19(&iVar20);
...
Local_772.f_9=1;
Local_772.f_1=3;
}elseif(ENTITY::IS_ENTITY_DEAD(Local_606[0 /*8*/], 0)){
func_242(6);
Local_772.f_9=2;
Local_772.f_1=3;
}elseif(ENTITY::IS_ENTITY_DEAD(Local_606[1 /*8*/], 0)){
func_242(6);
Local_772.f_9=3;
Local_772.f_1=3;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_606[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_606[0 /*8*/], 0, 2)){
func_242(6);
Local_772.f_9=4;
Local_772.f_1=3;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_606[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_606[1 /*8*/], 0, 2)){
func_242(6);
Local_772.f_9=5;
Local_772.f_1=3;
}elseif(func_235(&(Local_606[0 /*8*/]))){
func_242(6);
Local_772.f_9=6;
Local_772.f_1=3;
}elseif(func_235(&(Local_606[1 /*8*/]))){
func_242(6);
Local_772.f_9=7;
Local_772.f_1=3;
}elseif(func_234(Local_606[0 /*8*/])){
...
float fVar6;
Var0={
func_241(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_241(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__241(struct<3> Param0){
float fVar0;
float fVar1;
...
iLocal_362=VEHICLE::CREATE_VEHICLE(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1, 0);
...
if(Local_772.f_1==1){
if(func_259()){
}elseif(Local_772.f_6){
Local_772.f_1=3;
}elseif(Local_772.f_4){
...
void func_245(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_249(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
void func_253(){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_165, "SET_COLOUR");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_165, "SET_DISTANCE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
HUD::SET_TEXT_RENDER_ID(uLocal_166);
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_782);
TASK::TASK_WARP_PED_INTO_VEHICLE(0, iLocal_362, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_782);
TASK::TASK_PERFORM_SEQUENCE(Local_83.f_28[1], uLocal_782);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_782);
func_405("Did Jimmy pass exit");
}}else{
TASK::TASK_GO_STRAIGHT_TO_COORD(Local_83.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
func_405("Did Jimmy regular exit");
}
PED::FORCE_PED_MOTION_STATE(Local_606[1 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
}}}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_782);
TASK::TASK_PERFORM_SEQUENCE(Local_83.f_28[0], uLocal_782);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_782);
func_405("Did Marnie pass exit");
}}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_83.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_83.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 1193033728);
func_405("Did Marnie regular exit");
}
PED::FORCE_PED_MOTION_STATE(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
}}}
...
Vector3 func__258(float fParam0){
...
uVar9=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_278(iVar2, iVar8));
}}}
iVar8++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_278(iVar2, iVar10));
func_275(uVar1, func_278(iVar2, iVar10));
}}
iVar10++;
}
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
}elseif(fLocal_640 > 50f){
Local_625.f_14="detector_level2_prop";
}else{
Local_625.f_14="detector_level1_prop";
}
ENTITY::PLAY_ENTITY_ANIM(Local_625.f_0, Local_625.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
}}}elseif(func_294()){
...
Var67={
func_101(iVar81, 2, uParam1->f_59, -1) 
};
...
Var67={
func_101(iVar81, 1, uParam1->f_62, -1) 
};
...
if(iLocal_353==0){
if(!func_338()){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_147, 1, 0, 0, 1);
...
Var2={
ENTITY::GET_ENTITY_COORDS(Local_606[1 /*8*/], 1) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(1829.75f, 4693.5f, 38.51f, &fVar1, 0, 0);
ENTITY::SET_ENTITY_COORDS(Local_606[1 /*8*/], Var2.f_0, Var2.f_1, fVar1, 1, 0, 0, 1);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_606[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
}
...
Local_772.f_9=7;
Local_772.f_1=3;
}elseif(!func_331(&uLocal_694, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
func_242(6);
Local_772.f_9=8;
Local_772.f_1=3;
}elseif(Local_772.f_6){
...
}}elseif(func_233(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_1, 1) > 120f){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
...
func_405("Player moved away - unloading midtro");
CUTSCENE::REMOVE_CUTSCENE();
}}}elseif(func_233(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_1, 1) < 100f){
if(!CUTSCENE::HAS_CUTSCENE_LOADED()){
...
if(iLocal_339==1){
func_325(&uLocal_164);
if(!func_331(&uLocal_642, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
iLocal_339=0;
AUDIO::STOP_SCRIPTED_CONVERSATION(0);
HUD::CLEAR_PRINTS();
}elseif(iLocal_347==0 && iLocal_338){
if(!func_285()){
iLocal_358=MISC::GET_GAME_TIMER();
iLocal_347=1;
}}elseif(iLocal_340==0){
...
if((MISC::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_37, sLocal_161) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_361, 30f, 30f, 30f, 0, 1, 0)) || func_311(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_37, 7, 0, 0, 0)){
...
iLocal_357=0;
}}elseif(iLocal_338==0 && !func_309(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 9f, 1)){
...
iLocal_356=MISC::GET_GAME_TIMER();
iLocal_751++;
}}}elseif(bLocal_336 !=Local_625.f_1){
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1)){
if(iLocal_359==-1){
...
iLocal_337=1;
iLocal_338=1;
}}elseif(!func_309(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, (9f + 2f), 1)){
iLocal_337=0;
}}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_164)){
uLocal_164=func_307(Local_144, 5, 0);
}
bLocal_336=Local_625.f_1;
if(func_331(&uLocal_642, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
iLocal_339=1;
...
}}elseif(!func_285() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
if(MISC::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_311(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0)){
iLocal_344=1;
}}}elseif(iLocal_345==0){
if(iLocal_353 < 2){
...
}}elseif((!func_285() && (MISC::GET_GAME_TIMER() - iLocal_358) >=7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
if(MISC::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_311(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0)){
iLocal_345=1;
}}}}}}
if(Local_772.f_1==3){
...
int func_307(struct<3> Param0, int iParam3, int iParam4){
int iVar0;
iVar0=0;
...
bool func_308(int iParam0, int iParam1, float fParam2, int iParam3){
return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, iParam3), ENTITY::GET_ENTITY_COORDS(iParam1, iParam3)) <=(fParam2 * fParam2);
}


bool func_309(int iParam0, struct<3> Param1, float fParam4, int iParam5){
...
var func__316(int iParam0, int iParam1){
...
Var8={
uParam0->f_2 - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
Var11={
...
AUDIO::STOP_SOUND(Local_625.f_3);
AUDIO::PLAY_SOUND_FROM_ENTITY(Local_625.f_4, "CONTINUAL_BEEP", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", 0, 0);
Local_625.f_6=1;
}else{
...
AUDIO::PLAY_SOUND_FROM_ENTITY(Local_625.f_3, "IDLE_BEEP", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", 0, 0);
if(bVar16){
PAD::SET_CONTROL_SHAKE(0, 200, 150);
}else{
...
if(CAM::IS_AIM_CAM_ACTIVE()){
if(Local_625.f_7==0){
AUDIO::PLAY_SOUND_FROM_ENTITY(Local_625.f_5, "SCAN", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", 0, 0);
Local_625.f_7=1;
}elseif(bVar16){
...
fLocal_640=94.9f;
}elseif(fLocal_640 <=-95f && fLocal_640 >=-99.8f){
fLocal_640=-94.9f;
}
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1)){
fLocal_640=100f;
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_538[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
uParam0->f_2=1;
...
uParam0->f_1=2;
uParam0->f_2=0;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, joaat("script_task_go_straight_to_coord"))==7){
...
", uParam0->f_3);
TASK::OPEN_SEQUENCE_TASK(&uLocal_167);
...
}}elseif(Local_538[uParam0->f_3 /*6*/].f_4==2){
TASK::TASK_ACHIEVE_HEADING(0, Local_538[uParam0->f_3 /*6*/].f_3, 0);
TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
}elseif(Local_538[uParam0->f_3 /*6*/].f_4==3){
TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
}elseif(Local_538[uParam0->f_3 /*6*/].f_4==1){
TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_167);
TASK::TASK_PERFORM_SEQUENCE(*uParam0, uLocal_167);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_167);
uParam0->f_2=1;
}elseif(uParam0->f_2==1){
...
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_353 > 0){
if(!PED::IS_PED_IN_GROUP(*uParam0)){
TASK::CLEAR_PED_TASKS(*uParam0);
...
elseif(func_311(&uLocal_168, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0)){
iLocal_757=MISC::GET_GAME_TIMER();
}}}
...
elseif(func_311(&uLocal_168, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0)){
iLocal_759=MISC::GET_GAME_TIMER();
iLocal_758++;
}}}}
break;
...
iLocal_623=0;
iLocal_624=0;
}}elseif(func_311(&uLocal_168, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0)){
iLocal_623=0;
iLocal_624=0;
}}}}}}
...
STREAMING::REQUEST_MODEL(uLocal_160);
...
ENTITY::SET_ENTITY_COORDS(Local_606[1 /*8*/], 1829.8f, 4693.48f, uVar0, 1, 0, 0, 1);
}}}
...
TASK::TASK_GO_STRAIGHT_TO_COORD(Local_606[0 /*8*/], Local_538[Local_606[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
PED::FORCE_PED_MOTION_STATE(Local_606[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 1);
Local_606[0 /*8*/].f_7=1;
func_405("Done Marnie intro exit state");
}}}

int func_346(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_234(iParam0)){
...
if(!func_416(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0)){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_167);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_167);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_167);
...
TASK::TASK_PLAY_ANIM(Local_83.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
CUTSCENE::REMOVE_CUTSCENE();
CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("EP_4_RCM_CONCAT", 2, 8);
func_405("Done Marnie leadin anim - request concat cutscene");
iLocal_334=1;
}}elseif(func_350(Local_83.f_28[0])){
...
Local_625.f_13=0;
Local_625.f_14="NO_RECENT_ANIM";
uLocal_165=GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_165)){
SYSTEM::WAIT(0);
}
...
if(HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner")){
uLocal_166=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
}}
...
iVar0=(iLocal_536 - 1);
if(iVar0 < 0){}
Local_363[iVar0 /*43*/].f_8={
Param0 
};
Local_363[iVar0 /*43*/].f_11={
Param3 
};
...
Local_363[iVar0 /*43*/].f_2={
Param1 
};
Local_363[iVar0 /*43*/].f_5={
Param4 
};
...
var func__406(struct<3> Param0, float fParam3){
struct<3> Var0;
Var0={
...
int func_409(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7){
if(func_410(uParam0, iParam1, Param2, fParam5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(*uParam0, 1);
...
int func_410(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6){
int iVar0;
if(!func_170(iParam1)){
...
GRAPHICS::REMOVE_GRASS_CULL_SPHERE(uLocal_360);
...
}elseif(PED::IS_PED_IN_GROUP(Local_606[1 /*8*/])){
...
void func_419(var uParam0, int iParam1, int iParam2, int iParam3){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!PED::IS_PED_INJURED(*uParam0)){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(*uParam0, 0, 1);
if(iParam3==0){
