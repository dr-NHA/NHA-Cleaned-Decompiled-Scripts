...
if(!ENTITY::IS_ENTITY_DEAD(ScriptParam_0.f_0, 0) && !ENTITY::IS_ENTITY_DEAD(ScriptParam_0.f_1, 0)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(ScriptParam_0.f_0, 1, 1);
...
TASK::TASK_SMART_FLEE_PED(Local_2996[0 /*20*/], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
iLocal_3084=18;
}
...
if(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0)){
TASK::TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/].f_1, uLocal_421);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_421);
iLocal_3084=18;
}
...
TASK::CLEAR_PED_TASKS(Local_2996[0 /*20*/].f_1);
PED::SET_PED_KEEP_TASK(Local_2996[0 /*20*/].f_1, 1);
TASK::TASK_SMART_FLEE_PED(Local_2996[0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
iLocal_3084=18;
}
}}elseif(bLocal_2964){
}
...
func_147(&uLocal_399, ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1), 0, 0, 1, 1, 1);
}}}else{
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_3109, 1) 
};
}
...
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_3109);
}elseif(VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_3109)){
iLocal_3084=4;
return 1;
}
return 0;
...
elseif(func_171(&Local_2348, "TOWAUD", "TOW_HAN_EXP2", 9, 0, 0, 0)){
iLocal_3115=4;
}
break;
case 1:
...
Local_2632={
(Local_2625[0 /*3*/] + 15f), (Local_2625[0 /*3*/].f_1 + 15f), (Local_2625[0 /*3*/].f_2 + 15f) 
};
Local_2635={
(Local_2625[0 /*3*/] - 15f), (Local_2625[0 /*3*/].f_1 - 15f), (Local_2625[0 /*3*/].f_2 - 15f) 
};
...
HUD::SET_BLIP_ROUTE(Local_2996[0 /*20*/].f_8, 1);
}}
break;
case 5:
func_122();
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_421);
TASK::TASK_PERFORM_SEQUENCE(Local_2996[iLocal_3037 /*20*/], uLocal_421);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_421);
...
}elseif(Global_113648.f_19975.f_3==1){
func_171(&Local_2348, "TOWAUD", "TOW_TUT_ENDB", 9, 0, 0, 0);
}elseif(Global_113648.f_19975.f_3==4){
...
iLocal_468=0;
func_146(&uLocal_399, 0, 0);
HUD::SET_BLIP_ROUTE(Local_2996[iLocal_3037 /*20*/].f_8, 0);
HUD::REMOVE_BLIP(&(Local_2996[iLocal_3037 /*20*/].f_8));
...
HUD::SET_BLIP_ROUTE(Local_2996[iVar1 /*20*/].f_8, 0);
iLocal_2967=0;
...
HUD::SET_BLIP_ROUTE(Local_2996[iVar1 /*20*/].f_8, 1);
...
StringCopy(&cLocal_3068, sParam0, 64);
MISC::CLEAR_AREA_OF_VEHICLES(Local_2625[0 /*3*/], 6f, 0, 0, 0, 0, 0, 0, 0);
iLocal_3037=iVar1;
return 1;
}}}}
iVar1++;
...
void func_111(){
int iVar0;
if(((!ENTITY::IS_ENTITY_DEAD(iLocal_3109, 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6)) || (Global_113648.f_19975.f_3==0 || Global_113648.f_19975.f_3 > 2)){
return;
}
switch (iLocal_3050){
case 0:
...
if(bLocal_2936){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_3109, ENTITY::GET_ENTITY_COORDS(Local_2996[iParam1 /*20*/], 1), 25f, 25f, 25f, 0, 1, 0)){
...
elseif(ENTITY::IS_ENTITY_AT_COORD(iLocal_3109, ENTITY::GET_ENTITY_COORDS(Local_2996[iParam1 /*20*/], 1), 50f, 50f, 50f, 0, 1, 0)){
if(!iLocal_2977){
if(Global_113648.f_19975.f_7==0 || Global_113648.f_19975.f_7==1){
func_257(&Local_2348, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
func_257(&Local_2348, 5, Local_2996[iParam1 /*20*/], "TOWBREAKM", 0, 1);
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_2995, joaat("player"));
...
return func_117(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, iParam1);
}
...
int iVar0;
if(!bLocal_2940){
iVar0=SYSTEM::ROUND(((300f - func_126(&uLocal_3100)) * 1000f));
if(iLocal_420==3){
if((iVar0 / 1000) < 60){
...
VEHICLE::SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, 0.7f, 0f, 0f, 1600f, 1600f, 1);
}elseif(Local_650[iLocal_2604 /*23*/]==4){
fLocal_3066=-1f;
iLocal_2950=1;
iLocal_3110=VEHICLE::CREATE_VEHICLE(joaat("ambulance"), Local_1870[func_256() /*28*/].f_23, Local_1870[func_256() /*28*/].f_26, 1, 1, 0);
...
iLocal_3111=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_3110, 4, joaat("s_m_m_paramedic_01"), -1, 1, 1);
}
...
var func__132(struct<3> Param0, struct<3> Param3){
...
Local_2996[*iParam4 /*20*/].f_6=VEHICLE::CREATE_VEHICLE(iLocal_2987[iLocal_3039], Param0, uParam3, 1, 1, 0);
...
Local_2996[*iParam4 /*20*/].f_17=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(Local_650[iLocal_2604 /*23*/].f_10, fVar0, 0f, 0);
}else{
Local_2996[*iParam4 /*20*/].f_17=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(Param0, fVar0, 0f, 0);
}
Local_2996[*iParam4 /*20*/].f_18=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(Param0, fVar1, 2.5f, 0);
Local_2996[*iParam4 /*20*/].f_19=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(Param0, fVar2, 4f, 0);
if(bParam5){
...
VEHICLE::SET_DISABLE_VEHICLE_ENGINE_FIRES(Local_2996[*iParam4 /*20*/].f_6, 1);
}else{
VEHICLE::SET_DISABLE_VEHICLE_PETROL_TANK_FIRES(Local_2996[*iParam4 /*20*/].f_6, 1);
VEHICLE::SET_VEHICLE_ENGINE_HEALTH(Local_2996[*iParam4 /*20*/].f_6, 1f);
VEHICLE::SET_DISABLE_VEHICLE_ENGINE_FIRES(Local_2996[*iParam4 /*20*/].f_6, 1);
...
iLocal_2950=1;
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_2996[*uParam4 /*20*/].f_6, 1.5f, 0f, 0f) 
};
Var12={
ENTITY::GET_ENTITY_COORDS(Local_2996[*uParam4 /*20*/].f_6, 1) 
};
uVar15=ENTITY::GET_ENTITY_HEADING(Local_2996[*uParam4 /*20*/].f_6);
uLocal_3048=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var12, uVar15, -1.5f, -30f, 0f), 10f, 0f, 0);
uLocal_3049=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var12, uVar15, -1.5f, 30f, 0f), 10f, 0f, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Var0, 30f, 0, 0, 0, 0, 0, 0, 0);
Local_1870[func_256() /*28*/][0 /*3*/]={
...
if(ENTITY::IS_ENTITY_DEAD(Local_280[iVar0 /*3*/], 0)){
HUD::REMOVE_BLIP(&(Local_280[iVar0 /*3*/].f_1));
}elseif(Local_280[iVar0 /*3*/].f_2 && func_116(Local_280[iVar0 /*3*/], 1) > 200f){
HUD::REMOVE_BLIP(&(Local_280[iVar0 /*3*/].f_1));
}}
iVar0++;
}}
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_155(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_2984) && !ENTITY::IS_ENTITY_DEAD(iLocal_2984, 0)){
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_2984, 1) 
};
}
...
iVar0=0;
while (iVar0 < 1){
Local_2556[iVar0 /*18*/].f_2={
*(uParam0[iVar0 /*3*/]) 
};
Local_2556[iVar0 /*18*/].f_5={
0f, 0f, -1f 
};
if(iVar0==0){
Local_2556[iVar0 /*18*/].f_8={
func_188(MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0f) 
};
}else{
Local_2556[iVar0 /*18*/].f_8={
func_188(0.5f, 1f, 0f) 
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_421);
TASK::TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_421);
...
iLocal_3120=2;
}}}elseif(func_10(Local_2996[0 /*20*/].f_7, Local_650[iLocal_2604 /*23*/].f_1, 1) < IntToFloat(iLocal_3041 + 10)){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_421);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_GO_TO_COORD_ANY_MEANS(0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_650[iLocal_2604 /*23*/].f_1, Local_650[iLocal_2604 /*23*/].f_4, 0f, 15f, 0f), 3f, 0, 0, 786603, -1082130432);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_421);
...
VEHICLE::REMOVE_ROAD_NODE_SPEED_ZONE(uLocal_3049);
...
VEHICLE::SET_VEHICLE_STAYS_FROZEN_WHEN_CLEANED_UP(Local_2996[0 /*20*/].f_7, 1);
...
func_120(&iLocal_2598);
}}elseif(!PED::IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0)){
func_120(&iLocal_2598);
}}
switch (iLocal_3119){
case 0:
...
iLocal_2983=PED::CREATE_PED_INSIDE_VEHICLE(Local_2996[0 /*20*/].f_7, 4, joaat("s_m_m_lsmetro_01"), -1, 1, 1);
...
Var0={
ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_7, 1) 
};
...
iLocal_3119=6;
}elseif(func_10(Local_2996[0 /*20*/].f_6, Var0, 1) < 10f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_2996[0 /*20*/].f_6, Local_650[iLocal_2604 /*23*/].f_13, Local_650[iLocal_2604 /*23*/].f_16, Local_650[iLocal_2604 /*23*/].f_19, 0, 1, 0)){
iLocal_2934=1;
if(!ENTITY::IS_ENTITY_DEAD(iLocal_3109, 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)){
if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6)){
VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6);
...
TASK::TASK_PLAY_ANIM(Local_2996[0 /*20*/], "oddjobs@towing", "m_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(Local_2996[0 /*20*/].f_1, "oddjobs@towing", "f_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_2996[0 /*20*/].f_6, 10);
}
bLocal_442=true;
...
TASK::TASK_PLAY_ANIM(Local_2996[0 /*20*/], "RANDOM@CAR_SLEEPING", "Sleeping_Idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
bLocal_442=true;
}}elseif(func_209()){
bLocal_2964=true;
}else{
...
TASK::TASK_SMART_FLEE_PED(0, Local_2996[0 /*20*/], 1000f, -1, 0, 0);
TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_421);
if(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0)){
TASK::TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/].f_1, uLocal_421);
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_421);
if(ENTITY::DOES_ENTITY_EXIST(Local_2996[0 /*20*/])){
uLocal_2986=HUD::ADD_BLIP_FOR_ENTITY(Local_2996[0 /*20*/]);
...
if(SYSTEM::VDIST2(Var1, ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/], 1)) < 400f){
if((Global_113648.f_19975.f_4 % 2)==0){
...
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_3109, 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)){
if(func_204() || (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6) && !bLocal_2979)){
func_172();
iLocal_3118=5;
}
elseif(!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6) && bLocal_2979){
if(bLocal_2973){
if(!func_47()){
iLocal_3118=5;
}}
...
}elseif(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_421);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
...
if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6)){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
}else{
if(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_2996[0 /*20*/].f_6, 1);
}
...
TASK::TASK_ENTER_VEHICLE(0, Local_2996[0 /*20*/].f_6, 20000, -1, 1073741824, 1, 0);
TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_2996[0 /*20*/].f_6, 5f, 786597);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0)){
TASK::TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
bLocal_3137=true;
}}
...
if(!bLocal_3137){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_2996[0 /*20*/].f_6, 1);
TASK::TASK_ENTER_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 20000, -1, 1073741824, 1, 0);
}
iLocal_3118=7;
}
}
...
TASK::TASK_ENTER_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 20000, -1, 1073741824, 1, 0);
iLocal_3118=7;
}}elseif(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)){
...
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_3109, 0)){
...
TASK::TASK_ENTER_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, -1, -1, 1073741824, 1, 0);
}
}
}
elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], joaat("script_task_follow_to_offset_of_entity")) !=1){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
}}}
}}}}
break;
...
if(ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0)){
iLocal_3118=8;
}elseif(((fVar1 > 35f || (func_4(&uLocal_3097) > 30f && fVar1 > 5f)) || iVar0) || (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))){
if(bLocal_2964){
func_257(&Local_2348, 5, Local_2996[0 /*20*/], "TOWABDHANDMAN2", 0, 1);
sVar2="TOW_PED_ANCU";
}elseif(bLocal_2965){
...
iVar0=0;
if(PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::GET_PLAYER_INDEX()) && func_116(uParam1, 1) < 40f){
iVar0=1;
}
...
if(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)){
Var3={
ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1) 
};
}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
Var0={
...
if(((SYSTEM::TIMERA() > 12000 || func_117(uParam0, uParam1, 1) < 15f) && func_117(uParam0, uParam1, 1) < 30f) && !func_47()){
...
if((SYSTEM::TIMERA() > 12000 || func_117(uParam0, uParam1, 1) < 7.5f) || (iLocal_468 && func_117(uParam0, uParam1, 1) < 30f)){
iLocal_443=1;
...
*uParam0=1;
}}elseif(func_171(&Local_2348, "TOWAUD", "TOW_DISP_DMT", 8, 0, 0, 0)){
*uParam0=1;
}
if(bParam4){
...
if(func_171(&Local_2348, "TOWAUD", "TOW_DISP_DMA", 8, 0, 0, 0)){
*uParam0=2;
}}elseif(func_171(&Local_2348, "TOWAUD", "TOW_DISP_DT2", 8, 0, 0, 0)){
*uParam0=2;
}
if(bParam4){
fLocal_428=(fLocal_428 + 25f);
...
return;
}elseif(!HUD::DOES_BLIP_EXIST(*uParam1) && bLocal_467){
...
var func__245(var uParam0, int iParam1, int iParam2){
int iVar0;
int iVar1;
iVar0=0;
...
iVar3[iVar57]=iVar58;
iVar57++;
}elseif(Local_650[iVar58 /*23*/]==iParam1){
iVar3[iVar57]=iVar58;
iVar57++;
}}}
iVar58++;
