...
Local_63={
1492.31f, 2136.53f, 89.15f 
};
Local_66={
1408.24f, 2522.803f, 41.0419f 
};
Local_114={
...
elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 20f, 20f, 8f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), 17)){
...
elseif(func_70(PLAYER::PLAYER_PED_ID(), iLocal_72) < 10f){
if(ENTITY::GET_ENTITY_SPEED(uLocal_75) < 1f){
func_69();
}
}}}
...
elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_75, 0)){
if(bLocal_110){
TASK::TASK_COMBAT_PED(iLocal_72, PLAYER::PLAYER_PED_ID(), 0, 16);
func_52();
iLocal_101=1;
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, joaat("script_task_enter_vehicle")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, joaat("script_task_enter_vehicle")) !=0){
...
func_92();
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, joaat("script_task_perform_sequence")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, joaat("script_task_perform_sequence")) !=0){
iLocal_55=11;
}elseif(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 200f, 200f, 200f, 0, 1, 0)){
func_16();
}
}
else{
...
var func__6(struct<3> Param0, int iParam3){
var uVar0;
...
if(!HUD::DOES_BLIP_EXIST(uLocal_70)){
uLocal_70=func_6(Local_86, 1);
}}}}elseif(HUD::DOES_BLIP_EXIST(uLocal_70)){
...
var func__11(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
if(!bLocal_100){
Var0[0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(0f, 9f, 0f) 
};
...
Var0[2 /*3*/]={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(0f, 0f, 9f) 
};
...
uLocal_85=VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[0 /*3*/], func_58(Var0[0 /*3*/], func_59(PLAYER::PLAYER_ID())), 1, 1, 0);
...
bLocal_100=true;
}elseif(!CAM::IS_SPHERE_VISIBLE(Var0[1 /*3*/], 3f)){
uLocal_85=VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[1 /*3*/], func_58(Var0[1 /*3*/], func_59(PLAYER::PLAYER_ID())), 1, 1, 0);
uLocal_82[0]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_85, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
uLocal_82[1]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_85, 6, joaat("s_m_y_ranger_01"), 0, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_82[0], joaat("weapon_pistol"), -1, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_82[1], joaat("weapon_pistol"), -1, 0, 1);
...
PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
bLocal_100=true;
}elseif(!CAM::IS_SPHERE_VISIBLE(Var0[2 /*3*/], 3f)){
uLocal_85=VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[2 /*3*/], func_58(Var0[2 /*3*/], func_59(PLAYER::PLAYER_ID())), 1, 1, 0);
uLocal_82[0]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_85, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
uLocal_82[1]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_85, 6, joaat("s_m_y_ranger_01"), 0, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_82[0], joaat("weapon_pistol"), -1, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_82[1], joaat("weapon_pistol"), -1, 0, 1);
...
PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
bLocal_100=true;
}elseif(!CAM::IS_SPHERE_VISIBLE(Var0[3 /*3*/], 3f)){
uLocal_85=VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[3 /*3*/], func_58(Var0[3 /*3*/], func_59(PLAYER::PLAYER_ID())), 1, 1, 0);
uLocal_82[0]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_85, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
uLocal_82[1]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_85, 6, joaat("s_m_y_ranger_01"), 0, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_82[0], joaat("weapon_pistol"), -1, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_82[1], joaat("weapon_pistol"), -1, 0, 1);
...
iLocal_55=10;
}}elseif(VEHICLE::IS_COP_VEHICLE_IN_AREA_3D((Var0.f_0 - 50f), (Var0.f_1 - 50f), (Var0.f_2 - 50f), (Var0.f_0 + 50f), (Var0.f_1 + 50f), (Var0.f_2 + 50f))){
if(!PED::IS_PED_INJURED(iLocal_72)){
TASK::CLEAR_PED_TASKS(iLocal_72);
if(PED::IS_PED_IN_GROUP(iLocal_72)){
PED::REMOVE_PED_FROM_GROUP(iLocal_72);
...
iLocal_55=10;
}}}elseif(VEHICLE::IS_COP_VEHICLE_IN_AREA_3D((Var0.f_0 - 10f), (Var0.f_1 - 10f), (Var0.f_2 - 10f), (Var0.f_0 + 10f), (Var0.f_1 + 10f), (Var0.f_2 + 10f))){
if(!PED::IS_PED_INJURED(iLocal_72)){
TASK::CLEAR_PED_TASKS(iLocal_72);
if(PED::IS_PED_IN_GROUP(iLocal_72)){
PED::REMOVE_PED_FROM_GROUP(iLocal_72);
...
var func__58(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5){
...
if((MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_72, 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_72, 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_72, 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_72, 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_72, 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_72, 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)){
return 1;
}
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, fLocal_109, 1f, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}elseif(iLocal_56==1){
...
iLocal_79=VEHICLE::CREATE_VEHICLE(joaat("sheriff"), 1524.332f, 2173.347f, 79.0619f, 201.6806f, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_INFLUENCES_WANTED_LEVEL(iLocal_79, 0);
...
uVar0=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_79, 26, joaat("s_m_y_ranger_01"), -1, 1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_72, joaat("weapon_pistol"), -1, 0, 1);
}
if(func_50()==0){
...
Local_76={
1538.09f, 2172.344f, 77.826f 
};
fLocal_89=142.0201f;
Local_91={
984.3975f, -106.9935f, 73.3531f 
};
Local_86={
960.1481f, -139.4141f, 73.476f 
};
}
if(iLocal_62==2){
iLocal_90=joaat("s_m_y_prisoner_01");
Local_76={
1401.692f, 2528.085f, 40.3762f 
};
fLocal_89=301.2458f;
Local_91={
938.5384f, -2167.42f, 29.5153f 
};
Local_86={
928.9882f, -2173.248f, 29.2873f 
};
}
iLocal_58=1;
}
...
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_168()) || Global_32166) || func_167()) || func_86(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_112695) || Global_32166) || func_167()) || func_86(8, -1)) || func_166()) || func_165()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_32166) || func_167()) || func_86(8, -1)) || func_165()) || func_164()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_168()) || func_165()) || Global_112695) || Global_32166) || func_167()) || Global_44446) || func_86(8, -1)) || func_164()) || func_162()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_74);
PED::SET_PED_KEEP_TASK(iLocal_72, 1);
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_75, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_74);
