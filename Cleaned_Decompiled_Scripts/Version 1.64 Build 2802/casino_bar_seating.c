...
MISC::SET_BIT(&(Global_1950108.f_3), 16);
if(uParam0->f_6==-1){
if(MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)if(func_41(uParam0->f_9) && !Global_262145.f_27071) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPTV_WALKOFF" /*Press ~INPUT_CONTEXT~ to sit down, watch TV or play "Don't Cross The Line".*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPJAC_SIT" /*Press ~INPUT_CONTEXT~ to sit down.*/, 0, 0, 0, 0);
...
if(STREAMING::HAS_ANIM_DICT_LOADED(&animDict)) func_59(uParam0, 4);
break;
case 4:
func_35(uParam0, &animDict);
...
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&animDict, &animName, func_31(uParam0), func_30(uParam0), 0, 2) 
};
animInitialOffsetRotation={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&animDict, &animName, func_31(uParam0), func_30(uParam0), 0, 2) 
};
targetHeading=animInitialOffsetRotation.f_2;
distanceToSlide=0.05f;
if(uParam0->f_1.f_1==1) distanceToSlide=0.15f;
...
if(func_33(&(uParam0->f_7), 13)) PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_NEXT_CAMERA, true);
...
if(bParam1){
num=func_3(uParam0);
if(num !=uParam0->f_1.f_2)if(num==0) randomIntInRange=11 + uParam0->f_1.f_2;
else randomIntInRange=6 + num;
else randomIntInRange=uParam0->f_1.f_3;
num=uParam0->f_1.f_2;
}elseif(uParam0->f_1.f_3==5){
num=uParam0->f_1.f_2;
endRange=3;
randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(0, endRange);
if(randomIntInRange==uParam0->f_1.f_4) randomIntInRange=(randomIntInRange + 1) % endRange;
}else{
...
if(uParam0->f_1.f_1==2 || uParam0->f_1.f_1==3) return uParam0->f_1.f_2;
if(func_4())if(uParam0->f_1.f_1==1)if(num==0 || num==4) num=1;
elseif(uParam0->f_1.f_1==1)if(num==1 || num==2) num=3;
return num;
}
...
var func__7(BOOL bParam0, var uParam1, var uParam2) // Position - 0x915{
...
if(uParam0->f_13==6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BLOCK_INTERRUPT")) && !func_33(&(uParam0->f_7), 12))if(num >=0.35f && !Global_2766478 && !Global_2766481) func_13(uParam0);
if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL)) func_42(uParam0);
...
if(uParam0->f_6==-1)if(uParam0->f_1.f_1==1 || uParam0->f_1.f_1==0)if(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL)) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPOF_AC_PC_EXIT" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPOF_AC_EXIT" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL)) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPOFSEAT_PCEXIT" /*Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPOFSEAT_EXIT" /*Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
if(uParam0->f_13==6){
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL)) action=INPUT_SCRIPT_RRIGHT;
else action=INPUT_FRONTEND_RIGHT;
if(PAD::IS_DISABLED_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, action)) func_14(uParam0);
}}}}
func_60(&(uParam0->f_7), 9);
return;
}
BOOL func_9(BOOL bParam0) // Position - 0xB40{
if(PAD::GET_ALLOW_MOVEMENT_WHILE_ZOOMED())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(func_10(PLAYER::PLAYER_PED_ID()))if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 25) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 68)) return false;
...
if(bParam0)if(func_20()) Global_2683862.f_41=1;
...
Vector3 func__30(var uParam0) // Position - 0x113A{
var unk;
unk={
uParam0->f_16[uParam0->f_9 /*14*/].f_3 
};
if(func_4() && uParam0->f_1.f_1==0) unk.f_2=unk.f_2 - 4f;
return unk;
}


Vector3 func__31(var uParam0) // Position - 0x1176{
...
if(uParam0->f_1.f_1==3)if(uParam0->f_1.f_3==5) TEXT_LABEL_ASSIGN_STRING(sParam1, "BASE_A", 16);
elseif(uParam0->f_1.f_3==0) TEXT_LABEL_ASSIGN_STRING(sParam1, "IDLE_B", 16);
return;
}
...
if(func_4()) TEXT_LABEL_APPEND_STRING(sParam1, "@FEMALE", 64);
...
if(uParam0->f_1.f_1==1)if(func_4())if(randomIntInRange==0 || randomIntInRange==4) randomIntInRange=1;
elseif(randomIntInRange==1 || randomIntInRange==2) randomIntInRange=3;
if(uParam0->f_1.f_1==3)if(uParam0->f_9 >=118 && uParam0->f_9 <=122) randomIntInRange=2;
...
case 6:
case 7:
if(Global_100733.f_386==joaat("Apart_Cin_Room")) return true;
break;
}
return false;
}
...
i < 10;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(sizeAndPeds[i]) && !PED::IS_PED_INJURED(sizeAndPeds[i]) && ENTITY::IS_ENTITY_VISIBLE(sizeAndPeds[i]) && func_57(sizeAndPeds[i], &uParam0->f_16[uParam0->f_9 /*14*/])) return true;
}
return false;
}
...
if(playerIndex !=PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))if(func_57(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->f_16[uParam0->f_9 /*14*/]) || func_52(playerIndex)==uParam0->f_9) return 1;
}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(iParam4==3 || iParam4==4)if(func_16(ENTITY::GET_ENTITY_HEADING(pedParam0), uParam1.f_2 - 180f, 45f)) return 1;
elseif(func_16(ENTITY::GET_ENTITY_HEADING(pedParam0), uParam1.f_2, 45f)) return 1;
return 0;
}
...
i < 5;
i=i + 1){
if(func_57(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9 /*14*/]) && func_56(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13)) return true;
else uParam0->f_9=(uParam0->f_9 + 1) % 31;
}
return false;
}
...
if(uParam0->f_13==6){}elseif(uParam0->f_13 > 4){
...
}elseif(MISC::GET_FRAME_COUNT() - uParam0->f_12 < 5){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_62());
}
return;
}
...
if(!func_80(PLAYER::PLAYER_ID())) return true;
if(func_77(PLAYER::PLAYER_ID()) && CAM::IS_SCREEN_FADED_OUT()) return true;
if(_SHOULD_NETWORK_SCRIPT_TERMINATE()) return true;
if(!func_67()) return true;
return false;
}
BOOL func_67() // Position - 0x1F39{
if(func_68()==0) return true;
return false;
}
...
if(func_76()) return true;
if(Global_2696915) return true;
if(func_75()) return true;
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_73()) return true;
...
if(plParam0 !=_INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(func_79(plParam0) && !func_78(plParam0)) return true;
return false;
}
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_81(Global_2657589[plParam0 /*466*/].f_321.f_7)==14;
return false;
}
...
func_29(-1);
localSceneFromNetworkId=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_8);
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(localSceneFromNetworkId)) NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
...
elseif(flag14 || !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_93()) ENTITY::SET_ENTITY_VISIBLE(playerPed, !flag14, false);
if(!flag14){
...
if(!func_89(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))if(!flag20) ENTITY::SET_ENTITY_COLLISION(playerPed, true, false);
...
if(func_86(*Global_4718592.f_166301)) ENTITY::FREEZE_ENTITY_POSITION(playerPed, true);
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_95(-1, false)==8;
...
uParam1->f_16[iParam2 /*14*/]={
unk 
};
uParam1->f_16[iParam2 /*14*/].f_3={
0f, 0f, num 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_1={
func_102(func_104(), func_103(iParam3, num)) + unk 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_102(func_101(), func_103(iParam3, num)) + unk 
};
...
Vector3 func__101() // Position - 0x3014{
return 0.5f, -0.5f, 2f;
}


Vector3 func__102(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3027{
float num;
float num2;
float num3;
...
Vector3 func__104() // Position - 0x30A4{
return -0.5f, -0.5f, 0f;
}
...
case 0:
*uParam1={
1120.862f, 212.423f, -50.4401f 
};
*uParam2=-124.25f;
break;
case 1:
*uParam1={
1120.2f, 211.123f, -50.4401f 
};
*uParam2=-115.25f;
break;
case 2:
*uParam1={
1119.816f, 209.848f, -50.4401f 
};
*uParam2=-106.5f;
break;
case 3:
*uParam1={
1119.618f, 208.511f, -50.4401f 
};
*uParam2=-96.25f;
break;
case 4:
*uParam1={
1119.54f, 207.185f, -50.4401f 
};
*uParam2=-99.5f;
break;
case 5:
*uParam1={
1118.818f, 204.723f, -50.4401f 
};
*uParam2=-117.25f;
break;
case 6:
*uParam1={
1118.193f, 203.635f, -50.4401f 
};
*uParam2=-127.75f;
break;
case 7:
*uParam1={
1117.355f, 202.623f, -50.4401f 
};
*uParam2=-137.25f;
break;
case 8:
*uParam1={
1116.384f, 201.823f, -50.4401f 
};
*uParam2=-147.5f;
break;
case 9:
*uParam1={
1115.254f, 201.136f, -50.4401f 
};
*uParam2=-157.75f;
break;
case 10:
*uParam1={
1114.046f, 200.698f, -50.4401f 
};
*uParam2=-167.75f;
break;
case 11:
*uParam1={
1112.791f, 200.235f, -50.4401f 
};
*uParam2=-158f;
break;
case 12:
*uParam1={
1111.561f, 199.51f, -50.4401f 
};
*uParam2=-148f;
break;
case 13:
*uParam1={
1130.482f, 239.144f, -51.0408f 
};
*uParam2=152.93f;
break;
case 14:
*uParam1={
1129.412f, 239.844f, -51.0408f 
};
*uParam2=130.68f;
break;
case 15:
*uParam1={
1128.693f, 240.931f, -51.0408f 
};
*uParam2=109.18f;
break;
case 16:
*uParam1={
1128.732f, 243.531f, -51.0408f 
};
*uParam2=66.43f;
break;
case 17:
*uParam1={
1129.494f, 244.656f, -51.0408f 
};
*uParam2=44.43f;
break;
case 18:
*uParam1={
1130.592f, 245.344f, -51.0408f 
};
*uParam2=20.43f;
break;
case 19:
*uParam1={
1133.189f, 245.344f, -51.0408f 
};
*uParam2=-25.32f;
break;
case 20:
*uParam1={
1134.295f, 244.606f, -51.0408f 
};
*uParam2=-48.07f;
break;
case 21:
*uParam1={
1135.011f, 243.469f, -51.0408f 
};
*uParam2=-68.32f;
break;
case 22:
*uParam1={
1125.608f, 252.885f, -51.0408f 
};
*uParam2=-27.82f;
break;
case 23:
*uParam1={
1126.656f, 252.185f, -51.0408f 
};
*uParam2=-48.32f;
break;
case 24:
*uParam1={
1127.391f, 251.06f, -51.0408f 
};
*uParam2=-69.57f;
break;
case 25:
*uParam1={
1127.354f, 248.448f, -51.0408f 
};
*uParam2=-116.07f;
break;
case 26:
*uParam1={
1126.609f, 247.36f, -51.0408f 
};
*uParam2=-136.82f;
break;
case 27:
*uParam1={
1125.499f, 246.623f, -51.0408f 
};
*uParam2=-159.32f;
break;
case 28:
*uParam1={
1122.905f, 246.673f, -51.0408f 
};
*uParam2=153.5f;
break;
case 29:
*uParam1={
1121.809f, 247.398f, -51.0408f 
};
*uParam2=131.75f;
break;
case 30:
*uParam1={
1121.087f, 248.548f, -51.0408f 
};
*uParam2=111.75f;
break;
}}else{
...
if(i==3 || i==4 || i==5 || i==6)if(!bNoTerminate) func_83();
else return 0;
if(!func_108(false)){
if(iParam0==0){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_83();
else return 0;
if(func_76())if(!bNoTerminate) func_83();
else return 0;
if(_DOES_EVENT_OF_TYPE_EXIST(157))if(!bNoTerminate) func_83();
else return 0;
}elseif(!NETWORK::NETWORK_IS_IN_SESSION()){
if(!bNoTerminate) func_83();
else return 0;
}}
SYSTEM::WAIT(0);
}
if(iParam1 > -1) Global_1574666=i;
if(iParam0==0)if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_83();
else return 0;
elseif(!NETWORK::NETWORK_IS_IN_SESSION())if(!bNoTerminate) func_83();
else return 0;
return 1;
}
