...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_39[bLocal_31 /*3*/]) < fLocal_250){
...
if(func_15()){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_251, Local_254, fLocal_263, 0, 1, 0)){
bLocal_33=true;
iLocal_27=1;
}
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_257, Local_260, fLocal_263, 0, 1, 0)){
bLocal_34=true;
iLocal_27=1;
}
}
...
func_14();
}elseif(!ENTITY::IS_ENTITY_IN_AIR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
func_14();
}
if(bLocal_33){
if(iLocal_37){
if(iLocal_36){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_251, Local_254, fLocal_263, 0, 1, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_257, Local_260, fLocal_263, 0, 1, 0)){
func_14();
func_1();
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 1073741824, 3);
}
}
elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_251, Local_254, fLocal_263, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_257, Local_260, fLocal_263, 0, 1, 0)){
iLocal_36=1;
}
elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_251, Local_254, fLocal_263, 0, 1, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_257, Local_260, fLocal_263, 0, 1, 0)){
func_14();
...
bool bVar0;
if(bLocal_31 < 32){
bVar0=MISC::IS_BIT_SET(Global_113648.f_10051.f_96, bLocal_31);
}elseif(bLocal_31 < 64){
bVar0=MISC::IS_BIT_SET(Global_113648.f_10051.f_97, (bLocal_31 - 32));
}else{
bVar0=MISC::IS_BIT_SET(Global_113648.f_10051.f_98, (bLocal_31 - 64));
}
if(bVar0){}else{
if(!bLocal_267){
if(bLocal_38){
...
if(bLocal_31==29){
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_96, bLocal_31)){
bLocal_267=true;
}}
...
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_97, (bLocal_31 - 32))){
bLocal_267=true;
}}elseif(MISC::IS_BIT_SET(Global_113648.f_10051.f_98, (bLocal_31 - 64))){
bLocal_267=true;
}
if(bLocal_267){}else{
func_27(bLocal_31);
...
case 29:
Local_251={
-655.1467f, -2138.094f, -0.339008f 
};
Local_254={
-146.0279f, -2493.724f, 54.67567f 
};
fLocal_263=47.75f;
Local_257={
-672.2213f, -2162.675f, -0.082912f 
};
Local_260={
-163.5556f, -2519.058f, 54.72249f 
};
break;
case 30:
Local_251={
...
case 40:
Local_251={
-686.3775f, -1548.553f, 12.33747f 
};
Local_254={
-669.329f, -1507.063f, -0.788618f 
};
fLocal_263=25f;
Local_257={
...
case 46:
Local_251={
-3064.973f, 780.1677f, 18.70642f 
};
Local_254={
-3093.958f, 757.2886f, 29.19696f 
};
fLocal_263=5f;
Local_257={
-3063.054f, 778.0165f, 18.67167f 
};
Local_260={
-3092.175f, 754.9156f, 29.1458f 
};
break;
case 47:
Local_251={
-1471.517f, 2406.815f, 2.485338f 
};
Local_254={
-1489.422f, 2404.39f, 21.76938f 
};
fLocal_263=15f;
Local_257={
-1468.889f, 2400.668f, 2.60396f 
};
Local_260={
-1487.055f, 2398.087f, 21.83768f 
};
break;
case 48:
Local_251={
...
case 67:
Local_251={
1001.145f, -987.1138f, 42.62456f 
};
Local_254={
1078.645f, -963.7435f, 28.93338f 
};
fLocal_263=14f;
Local_257={
1002.864f, -992.8986f, 42.62456f 
};
Local_260={
1080.484f, -969.9034f, 28.88377f 
};
break;
case 68:
Local_251={
952.5042f, -847.6615f, 43.01844f 
};
Local_254={
1021.093f, -844.5063f, 29.71967f 
};
fLocal_263=20f;
Local_257={
945.5494f, -835.9777f, 43.15658f 
};
Local_260={
1016.364f, -835.3861f, 29.7297f 
};
break;
case 69:
Local_251={
1212.477f, -1183.013f, 46.4739f 
};
Local_254={
1267.189f, -1161.997f, 32.48297f 
};
fLocal_263=40f;
Local_257={
1206.01f, -1157.063f, 47.93699f 
};
Local_260={
1258.374f, -1140.68f, 32.42903f 
};
break;
}}
...
bVar1=false;
while (bVar1 < 32){
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_96, bVar1)){
if(func_50(bVar1)){
iVar0++;
}}
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_97, bVar1)){
if(func_50(bVar1 + 32)){
iVar0++;
}}
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_98, bVar1)){
if(func_50(bVar1 + 64)){
iVar0++;
}}
bVar1++;
