...
fLocal_32=-0.0375f;
fLocal_33=0.17f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(98)) func_15();
func_14();
num=0;
while (true){
SYSTEM::WAIT(500);
...
if(SCRIPT::IS_THREAD_ACTIVE(Global_32504[num /*7*/].f_5)) PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(Global_32504[num /*7*/].f_5, 1);
Global_32504[num /*7*/].f_5=0;
}}}elseif(!func_10(Global_32504[num /*7*/], 4)){
if(func_5(&Global_32504[num /*7*/], entityCoords)) func_1(num);
}
num2=num2 + 1;
num=num + 1;
if(num==5) num=0;
...
if(Global_32504[iParam0 /*7*/].f_5 !=0) func_2(&Global_32504[iParam0 /*7*/], 2);
}}
return;
}
...
if(!func_10(*iParam0, 1))if(func_9() && !func_6(6)) return false;
if(SYSTEM::VDIST2(vParam1, iParam0->f_2) > iParam0->f_1) return false;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2080.115f, 3292.193f, -11.667f, -2112.049f, 3224.331f, 11.667f, 115f, true, false, 0)) return false;
return true;
}
...
vParam1.f_2=0f;
if(!SCRIPT::IS_THREAD_ACTIVE(Global_32504[iParam0 /*7*/].f_5)) return true;
if(func_10(Global_32504[iParam0 /*7*/], 4)) return true;
if(func_9() && !func_6(6))if(!func_10(Global_32504[iParam0 /*7*/], 1))if(iParam0==1 || iParam0==2)if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("golf"))==0) return true;
else return true;
if(SYSTEM::VDIST2(Global_32504[iParam0 /*7*/].f_2, vParam1) > Global_32504[iParam0 /*7*/].f_1 + 400f) return true;
return false;
}
