...
if(Global_20371) func_7(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
else func_7(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
bLocal_60=true;
}
return;
}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam7)) func_10(sParam7);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam8)) func_10(sParam8);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam9)) func_10(sParam9);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam10)) func_10(sParam10);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam11)) func_10(sParam11);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
return;
}
...
func_9(Global_20364, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(0), -1082130432, -1082130432, -1082130432);
if(Global_20371){
if(bLocal_60) func_7(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
else func_7(Global_20364, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
func_7(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
}else{
if(bLocal_60) func_7(Global_20364, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
else func_7(Global_20364, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
func_7(Global_20364, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, 0, 0, 0, 0, 0);
}
func_7(Global_20364, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
MISC::CLEAR_BIT(&Global_8253, 17);
...
if(!HUD::DOES_TEXT_LABEL_EXIST(&uLocal_20)) TEXT_LABEL_ASSIGN_STRING(&uLocal_20, "CELL_195" /*Unknown*/, 64);
