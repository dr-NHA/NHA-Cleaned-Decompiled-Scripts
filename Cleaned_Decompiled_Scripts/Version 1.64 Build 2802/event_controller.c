...
uVar19=NETWORK::NETWORK_GET_PRESENCE_INVITE_INDEX_BY_ID(uParam22);
...
iVar81=(iVar80 - 1);
while (iVar81 >=0){
Global_2623469[iVar80 /*99*/]={
Global_2623469[iVar81 /*99*/] 
};
iVar80=(iVar80 - 1);
iVar81=(iVar81 - 1);
}
...
Global_2623469[iVar82 /*99*/].f_57={
Var36 
};
Global_2623469[iVar82 /*99*/].f_73={
Var52 
};
...
}elseif(func_131(Global_2800023.f_20)){
