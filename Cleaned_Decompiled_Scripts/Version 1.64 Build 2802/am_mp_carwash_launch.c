...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_mp_carwash_launch")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
...
num=0;
while (num==0){
if(func_9(PLAYER::PLAYER_ID(), true, false) || func_8() || !func_7(PLAYER::PLAYER_ID()) || func_6() || func_5(PLAYER::PLAYER_ID()) || func_4(PLAYER::PLAYER_ID()) || func_2(PLAYER::PLAYER_ID())) num=0;
else num=1;
SYSTEM::WAIT(0);
}
if(SYSTEM::VDIST2(vector, func_1(157)) < SYSTEM::VDIST2(vector, func_1(156))) scriptName="carwash2";
...
SCRIPT::REQUEST_SCRIPT(scriptName);
SYSTEM::WAIT(0);
if(MISC::GET_GAME_TIMER() > gameTimer + 20000) SCRIPT::TERMINATE_THIS_THREAD();
}
...
Vector3 func__1(int iParam0) // Position - 0x1FF{
int num;
num=iParam0;
...
int num;
num=Global_2672505;
if(IS_BIT_SET(Global_1890444[num /*129*/].f_14, 0) && Global_1890444[num /*129*/].f_23==2) return 1;
return 0;
}

int func_9(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2F6{
if(bParam1)if(func_10(plParam0)) return 1;
!bParam2;
