...
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_280, &cLocal_312, 2)){
TASK::CLEAR_PED_TASKS(*uParam0);
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -16f, 1);
PED::SET_PED_MOVE_ANIMS_BLEND_OUT(*uParam0);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_272 + Local_276, 1f, -1, (fLocal_279 * 0.1f), 0, 1193033728);
PED::FORCE_PED_MOTION_STATE(*uParam0, joaat("MotionState_Walk"), 0, 0, 0);
...
if(fLocal_348 >=0f){
if(fVar0 >=fLocal_348){
func_133(*uParam0, "DISMISS_MICHAEL", "AMANDA_NORMAL", 24);
fLocal_348=-1f;
}}
if(fVar0 >=fVar1){
TASK::CLEAR_PED_TASKS(*uParam0);
...
TASK::TASK_START_SCENARIO_AT_POSITION(*uParam0, &cLocal_328, Local_272 + Local_344, (fLocal_275 + fLocal_347), 0, 0, 1);
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 5f, 0f, 0f) 
};
Local_276={
Var3 - Local_272 * Vector(4f, 4f, 4f) 
};
}
TASK::CLEAR_PED_TASKS(*uParam0);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_272 + Local_276, 1f, -1, (fLocal_279 * 0.1f), 0, 1193033728);
...
func_7(*uParam0);
if(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, joaat("script_task_follow_nav_mesh_to_coord")) !=1){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_272 + Local_276) < (fLocal_279 * fLocal_279)){
if(fLocal_279==0f){
fLocal_279=(SYSTEM::VMAG(Local_276) * 0.75f);
}
TASK::TASK_WANDER_IN_AREA(*uParam0, Local_272 + Local_276, fLocal_279, 1077936128, 1086324736);
func_134(4, 0);
return 1;
}}
break;
...
func_7(*uParam0);
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_272 + Local_276) < (fLocal_279 * fLocal_279)){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_272 + Local_276, fLocal_279, 1)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, Local_272 + Local_276, fLocal_279, 0);
...
Var6={
func_4(Local_272 + Local_276, (fLocal_279 * 0.9f), 0f) 
};
...
Var12={
ENTITY::GET_ENTITY_COORDS(*uParam0, 1) - Vector(2f, 2f, 2f) 
};
Var15={
ENTITY::GET_ENTITY_COORDS(*uParam0, 1) + Vector(2f, 2f, 2f) 
};
uLocal_349=PED::ADD_SCENARIO_BLOCKING_AREA(Var12, Var15, 0, 0, 1, 1);
...
func_7(*uParam0);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_280, &cLocal_296, 2)){
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_280, &cLocal_312, 2)){
}
break;
case 8:
if(func_130(uParam0)){
...
Vector3 func__4(struct<3> Param0, float fParam3, float fParam4){
struct<3> Var0;
float fVar3;
float fVar4;
int iVar5;
...
Vector3 func__5(struct<3> Param0, float fParam3, float fParam4){
struct<3> Var0;
float fVar3;
Var0={
...
fVar3=(fParam4 / 2f);
Var0={
func_6(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) 
};
...
Vector3 func__6(struct<3> Param0, float fParam3){
float fVar0;
if(fParam3==0f){
return 0f, 0f, 0f;
}
...
float fVar4;
if(PED::IS_PED_INJURED(uParam0)){
if(!iLocal_352 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER::PLAYER_PED_ID(), 1)){
bVar0=func_129(uParam0);
...
func_113(75, ENTITY::GET_ENTITY_COORDS(uParam0, 0), 250f, -1);
if(func_46(Global_96415, bVar0, 2, 0, iVar3, iVar2, 75)){
iLocal_352=1;
}}}}}
return;
}
func_10(uParam0, 138, &uLocal_72, "FMMAUD", &uLocal_237, &uLocal_258, 3);
fVar4=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
if(fVar4 > (8f * 8f)){
iLocal_350=-1;
}elseif(AUDIO::IS_ANY_SPEECH_PLAYING(uParam0)){
iLocal_350=-1;
}else{
if(iLocal_350 <=0){
...
iLocal_350=-1;
iLocal_351++;
}}elseif(iLocal_350 + 10000 < MISC::GET_GAME_TIMER()){
...
return 0;
}}elseif(!ENTITY::IS_ENTITY_ON_SCREEN(uParam0) || !ENTITY::IS_ENTITY_VISIBLE(uParam0)){
return 0;
}
bVar12=false;
switch (iParam1){
...
var func__21(int iParam0, int iParam1){
...
return 1;
}elseif(!func_34() && !AUDIO::IS_MOBILE_PHONE_CALL_ONGOING()){
...
return 0;
}}}elseif(func_102(iVar1, iParam2, -1, &sVar8)){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_54() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_54() /*5568*/].f_681.f_10, iParam0);
}
...
var func__62(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_57();
}
...
void func_90(int iParam0, char* sParam1, bool bParam2, var uParam3){
if(!func_19()){
return;
}
...
void func_93(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11){
...
iParam2=1;
}elseif(func_103(&(Var4[1 /*4*/]), iVar13)){
iParam2=0;
}else{
...
if(MISC::ARE_STRINGS_EQUAL(&(Global_113648.f_14143[iVar0 /*104*/]), uParam0)){
...
iParam2=1;
}elseif(func_103(&(Var0[1 /*4*/]), iVar9)){
iParam2=0;
}else{
iParam2=MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
}}else{
...
if(PED::HAS_PED_RECEIVED_EVENT(uParam0, 124)){
return 1;
}}
return 0;
}
...
uLocal_264=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_272 + Local_266, 1f, iLocal_265, 1, 0, 1);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_264)){
ENTITY::SET_ENTITY_COORDS(uLocal_264, Local_272 + Local_266, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_264, Vector(fLocal_275, 0f, 0f) + Local_269, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_264, 1);
}}}
return 0;
}
...
return 0;
}}elseif(!CAM::IS_SPHERE_VISIBLE(Var0, 1.5f)){
return 0;
}}}elseif(iParam1==func_139(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_100402, 1, 1);
func_147(&Global_100402, Global_95684);
PED::SET_PED_CONFIG_FLAG(Global_100402, 132, 1);
PED::SET_PED_CONFIG_FLAG(Global_100402, 317, 1);
}
...
case 99:
Local_276={
Vector(24.3224f, -700.7733f, -1306.836f) - Local_272 
};
fLocal_279=40f;
iLocal_262=2;
break;
case 100:
Local_276={
Vector((82.0206f + 1f), 272.6104f, -566.2225f) - Local_272 
};
fLocal_279=30f;
iLocal_262=2;
break;
case 101:
Local_276={
Vector((53.6418f + 1f), -217.321f, 77.2686f) - Local_272 
};
fLocal_279=25f;
iLocal_262=2;
break;
case 102:
Local_276={
Vector((102.0191f + 1f), 313.2252f, 412.1519f) - Local_272 
};
fLocal_279=15f;
iLocal_262=2;
break;
case 170:
Local_276={
Vector((37.8417f + 1f), -275.1926f, -616.7041f) - Local_272 
};
fLocal_279=30f;
break;
case 171:
Local_276={
Vector((56.8469f + 1f), -125.1416f, -106.3491f) - Local_272 
};
fLocal_279=25f;
break;
case 172:
...
case 94:
Local_276={
Vector((112.1615f + 1f), 328.301f, -16.8925f) - Local_272 
};
fLocal_279=25f;
break;
case 152:
...
Local_344={
1.358f, 2.385f, -0.608f 
};
fLocal_347=160f;
iLocal_265=joaat("prop_patio_lounger1");
Local_266={
Vector(63.082f, 357.697f, -1352.644f) - Vector(64.08f, 355.1845f, -1353.791f) 
};
Local_269={
0f, 0f, (54.35f - 72f) 
};
...
default:
Local_276={
MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), 0f 
};
fLocal_279=(SYSTEM::VMAG(Local_276) * 0.75f);
break;
}
...
iVar5=0;
while (iVar5 < 5){
if(MISC::IS_BIT_SET(Global_113648.f_7231.f_11[iVar5], 0)){
Var6={
Global_95884[iVar5 /*9*/].f_3 
};
