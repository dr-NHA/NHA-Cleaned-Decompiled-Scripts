...
if(!func_19() && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE()) _SET_PLAYER_CONTROL_EX(PLAYER::PLAYER_ID(), true, 0, false);
}
...
elseif(flag14 || !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_12()) ENTITY::SET_ENTITY_VISIBLE(playerPed, !flag14, false);
if(!flag14){
...
if(!func_8(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))if(!flag20) ENTITY::SET_ENTITY_COLLISION(playerPed, true, false);
...
if(func_5(*Global_4718592.f_166301)) ENTITY::FREEZE_ENTITY_POSITION(playerPed, true);
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_14(-1, false)==8;
...
MISC::SET_BIT(&(Global_1950108.f_3), 16);
if(uParam0->f_6==-1){
if(MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)if(func_63(uParam0->f_9) && !Global_262145.f_27071) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_6), 4, "MPTV_WALKOFF" /*Press ~INPUT_CONTEXT~ to sit down, watch TV or play "Don't Cross The Line".*/, 0, 0, 0, 0);
...
if(STREAMING::HAS_ANIM_DICT_LOADED(&animDict)) func_80(uParam0, 4);
break;
case 4:
func_57(uParam0, &animDict);
...
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&animDict, &animName, func_53(uParam0), func_52(uParam0), 0, 2) 
};
animInitialOffsetRotation={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&animDict, &animName, func_53(uParam0), func_52(uParam0), 0, 2) 
};
...
if(func_75() && uParam0->f_9==8) func_37(uParam0);
func_40(uParam0);
func_31(uParam0);
localSceneFromNetworkId=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_8);
if(func_55(&(uParam0->f_7), 13)) PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_NEXT_CAMERA, true);
...
if(func_27())if(uParam0->f_1.f_1==1)if(num==0 || num==4) num=1;
...
var func__30(BOOL bParam0, var uParam1, var uParam2) // Position - 0x123D{
...
if(uParam0->f_13==6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BLOCK_INTERRUPT")) && !func_55(&(uParam0->f_7), 12))if(num >=0.35f && !Global_2766478 && !Global_2766481) func_36(uParam0);
if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL)) func_21(uParam0);
...
if(PAD::IS_DISABLED_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, action)) func_37(uParam0);
}}}}
func_81(&(uParam0->f_7), 9);
return;
}
BOOL func_32(BOOL bParam0) // Position - 0x1468{
if(PAD::GET_ALLOW_MOVEMENT_WHILE_ZOOMED())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(func_33(PLAYER::PLAYER_PED_ID()))if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 25) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 68)) return false;
...
if(bParam0)if(func_43()) Global_2683862.f_41=1;
...
if(func_51()) return;
if(Global_20584)if(func_49()) func_48(true, true);
else func_48(false, false);
...
Vector3 func__52(var uParam0) // Position - 0x1A44{
var unk;
unk={
uParam0->f_16[uParam0->f_9 /*14*/].f_3 
};
if(func_27() && uParam0->f_1.f_1==0) unk.f_2=unk.f_2 - 4f;
return unk;
}


Vector3 func__53(var uParam0) // Position - 0x1A80{
...
if(func_27()) TEXT_LABEL_APPEND_STRING(sParam1, "@FEMALE", 64);
...
if(uParam0->f_1.f_1==1)if(func_27())if(randomIntInRange==0 || randomIntInRange==4) randomIntInRange=1;
...
i < 10;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(sizeAndPeds[i]) && !PED::IS_PED_INJURED(sizeAndPeds[i]) && ENTITY::IS_ENTITY_VISIBLE(sizeAndPeds[i]) && func_78(sizeAndPeds[i], &uParam0->f_16[uParam0->f_9 /*14*/])) return true;
}
return false;
}
...
if(playerIndex !=PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))if(func_78(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->f_16[uParam0->f_9 /*14*/]) || func_71(playerIndex)==uParam0->f_9) return 1;
}}
return 0;
}
...
if(Global_1981407==0 && func_76()) return true;
return false;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(iParam4==3 || iParam4==4)if(func_39(ENTITY::GET_ENTITY_HEADING(pedParam0), uParam1.f_2 - 180f, 45f)) return 1;
elseif(func_39(ENTITY::GET_ENTITY_HEADING(pedParam0), uParam1.f_2, 45f)) return 1;
return 0;
}
...
i < 5;
i=i + 1){
if(func_78(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9 /*14*/]) && func_77(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13)) return true;
...
if(!func_99(PLAYER::PLAYER_ID())) return true;
if(func_96(PLAYER::PLAYER_ID()) && CAM::IS_SCREEN_FADED_OUT()) return true;
if(_SHOULD_NETWORK_SCRIPT_TERMINATE()) return true;
if(!func_16()) return true;
return false;
}
...
if(func_95()) return true;
if(Global_2696915) return true;
if(func_94()) return true;
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_92()) return true;
...
if(plParam0 !=_INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(func_98(plParam0) && !func_97(plParam0)) return true;
return false;
}
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_100(Global_2657589[plParam0 /*466*/].f_321.f_7)==21;
return false;
}
...
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("music_studio_seating", func_112(), true, 0)) return false;
...
func_105(func_107(), func_106(iParam3, num)) + unk 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_105(func_104(), func_106(iParam3, num)) + unk 
};
...
Vector3 func__104() // Position - 0x2FFE{
return 0.5f, -0.5f, 2f;
}


Vector3 func__105(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3011{
float num;
float num2;
float num3;
...
Vector3 func__107() // Position - 0x308E{
return -0.5f, -0.5f, 0f;
}
...
case 0:
*uParam1={
-1017.25f, -90.296f, -100.388f 
};
*uParam2=-90f;
break;
case 1:
*uParam1={
-1017.25f, -91.034f, -100.388f 
};
*uParam2=-90f;
break;
case 2:
*uParam1={
-1018.919f, -88.779f, -100.416f 
};
*uParam2=5.76f;
break;
case 3:
*uParam1={
-1006.604f, -75.716f, -100.001f 
};
*uParam2=0f;
break;
case 4:
*uParam1={
-1002.706f, -75.829f, -100.001f 
};
*uParam2=-45f;
break;
case 5:
*uParam1={
-1003.631f, -65.468f, -100.001f 
};
*uParam2=65.88f;
break;
case 6:
*uParam1={
-1003.241f, -64.703f, -100.001f 
};
*uParam2=54.72f;
break;
case 7:
*uParam1={
-1002.81f, -64.054f, -100.001f 
};
*uParam2=65.16f;
break;
case 8:
*uParam1={
-1002.294f, -63.104f, -100.001f 
};
*uParam2=60.84f;
break;
case 9:
*uParam1={
-998.893f, -80.68f, -100.001f 
};
*uParam2=141.12f;
break;
case 10:
*uParam1={
-999.73f, -80.017f, -100.001f 
};
*uParam2=147.96f;
break;
case 11:
*uParam1={
-997.339f, -61.701f, -100.001f 
};
*uParam2=-36.72f;
break;
case 12:
*uParam1={
-984.732f, -65.988f, -100.001f 
};
*uParam2=-25.65f;
break;
case 13:
*uParam1={
-983.832f, -66.376f, -100.001f 
};
*uParam2=-26f;
break;
case 14:
*uParam1={
-979.469f, -73.513f, -100.001f 
};
*uParam2=-122.76f;
break;
case 15:
*uParam1={
-990.732f, -77.676f, -100.001f 
};
*uParam2=166.68f;
break;
case 16:
*uParam1={
-985.745f, -71.501f, -99.426f 
};
*uParam2=44.28f;
break;
case 17:
*uParam1={
-1002.362f, -78.16f, -99.98f 
};
*uParam2=-89.64f;
break;
}}else{
...
if(func_95())if(!bNoTerminate) func_2();
else return 0;
