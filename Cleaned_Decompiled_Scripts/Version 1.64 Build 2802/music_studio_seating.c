...
}elseif(bVar14 || (!func_13(PLAYER::PLAYER_ID(), 0) && !func_12())){
...
if(!func_8(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
if((((((((((((func_74(uParam0) || func_70(uParam0)) || func_69(uParam0)) || !func_68(uParam0)) || func_66(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1950108.f_4, 2)) || func_65(uParam0->f_16[uParam0->f_9 /*14*/].f_13)){
...
Var20={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_53(uParam0), func_52(uParam0), 0, 2) 
};
Var23={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_53(uParam0), func_52(uParam0), 0, 2) 
};
uVar26=Var23.f_2;
fVar27=0.05f;
...
PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
uParam0->f_8=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_53(uParam0), func_52(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
...
return 1;
}}elseif(func_39(ENTITY::GET_ENTITY_HEADING(iParam0), Param1.f_2, 45f)){
return 1;
}}
return 0;
}
...
var func__78(var uParam0, var uParam1){
...
func_85(&(uParam0->f_7), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
func_85(&(uParam0->f_7), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
int func_101(){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("music_studio_seating", func_112(), 1, 0)){
return 0;
}
NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, func_112());
func_110(0, -1, 0);
...
func_105(func_107(), func_106(iParam3, fVar3)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_105(func_104(), func_106(iParam3, fVar3)) + Var0 
};
...
Vector3 func__105(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
