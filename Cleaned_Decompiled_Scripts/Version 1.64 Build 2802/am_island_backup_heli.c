...
func_60(5);
}}elseif(func_11(Local_79.f_1.f_3[0 /*2*/])){
if(func_11(Local_79.f_1.f_3[1 /*2*/])){
func_60(5);
}}elseif(func_11(Local_79.f_1.f_3[1 /*2*/])){
func_60(3);
}else{
...
if(func_12(Local_79.f_1)){
iLocal_66++;
}elseif(ENTITY::DOES_ENTITY_EXIST(NETWORK::NET_TO_VEH(Local_79.f_1))){
...
uVar1=NETWORK::NET_TO_VEH(Local_79.f_1);
...
uVar2=NETWORK::NET_TO_PED(Local_79.f_1.f_3[0 /*2*/]);
...
Var0={
func_57(func_58(PLAYER::PLAYER_ID()), 0f, (-200f * SYSTEM::SIN((SYSTEM::TO_FLOAT(Local_79.f_1.f_13) * 30f))), (200f * SYSTEM::COS((SYSTEM::TO_FLOAT(Local_79.f_1.f_13) * 30f))), 0f) 
};
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_58(iVar1), Param0, 1) < fParam3){
return 1;
}}
}}}}}
iVar0++;
...
Vector3 func__57(struct<3> Param0, float fParam3, struct<2> Param4, float fParam6){
struct<3> Var0;
float fVar3;
float fVar4;
float fVar5;
...
void func_64(){
var uVar0;
uVar0=NETWORK::NET_TO_VEH(Local_79.f_1);
...
uVar0=NETWORK::NET_TO_PED(Local_79.f_1.f_3[0 /*2*/]);
...
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_HELI_MISSION(uVar0, uVar1, 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, iLocal_74, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_71[0]), 10, -1082130432, 0);
}
}}}
}}}
if(NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_79.f_1.f_3[1 /*2*/])){
uVar0=NETWORK::NET_TO_PED(Local_79.f_1.f_3[1 /*2*/]);
if(!PED::IS_PED_INJURED(uVar0)){
...
uVar1=PLAYER::GET_PLAYER_PED(iLocal_77);
if(!func_6(&uLocal_75)){
...
iVar2=0;
while (iVar2 < iVar3){
uVar5=NETWORK::NET_TO_PED(Local_79.f_1.f_3[iVar2 /*2*/]);
...
uVar3=NETWORK::NET_TO_PED(Local_79.f_1.f_3[0 /*2*/]);
uVar4=NETWORK::NET_TO_VEH(Local_79.f_1);
...
TASK::TASK_HELI_MISSION(uVar3, uVar4, 0, uVar2, 0f, 0f, 0f, iLocal_74, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_71[0]), 10, -1082130432, 0);
iLocal_77=iVar0;
}}
