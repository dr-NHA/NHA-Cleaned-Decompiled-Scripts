...
case 0:
func_217(&iLocal_144);
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0)){
...
iLocal_438=0;
if(ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, 1, 1, 0)){
func_217(&iLocal_144);
iLocal_143=0;
iLocal_142=6;
}
...
iLocal_144=func_216(Local_161, 5, 1);
}}}elseif(iLocal_436 && !func_215()){
func_213(3);
iLocal_436=0;
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0)){
HUD::CLEAR_PRINTS();
iLocal_437=0;
iLocal_436=1;
func_217(&iLocal_144);
...
iLocal_436=1;
func_217(&iLocal_144);
}elseif(ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, 1, 1, 0)){
func_217(&iLocal_144);
iLocal_143=0;
iLocal_142=6;
}
...
uVar0=Global_2805027[iParam0 /*3*/][func_69(iParam1)];
...
bool func_210(int iParam0, struct<3> Param1, float fParam4, int iParam5){
...
int func_216(struct<3> Param0, int iParam3, int iParam4){
int iVar0;
iVar0=0;
...
switch (iLocal_143){
case 0:
if(ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 10f, 10f, 2f, 0, 1, 0)){
func_217(&iLocal_144);
...
iLocal_143=2;
}elseif((iLocal_433 && func_212(5)) && (MISC::GET_PROFILE_SETTING(203)==0 || !func_215())){
func_213(5);
}}}else{
HUD::CLEAR_PRINTS();
iLocal_142=8;
...
iLocal_143=1;
iLocal_433=1;
}}elseif(func_221(&uLocal_251, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0)){
iLocal_143=1;
iLocal_433=1;
}}}}
...
var func__226(int iParam0, int iParam1){
...
int func_243(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
if(!func_215() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 0)){
if(!iLocal_425){
iLocal_425=1;
...
iLocal_425=0;
iLocal_426++;
}}elseif(func_249(&uLocal_251, "BAR3AAU", Local_416[iLocal_426 /*2*/], 7, 0, 0, 0)){
iLocal_425=0;
iLocal_426++;
}}}}}}
...
func_217(&iLocal_144);
iLocal_144=func_211(Local_145.f_4, 1, 5);
HUD::SET_BLIP_ROUTE(iLocal_144, 1);
...
if(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4) && ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, 1, 1, 0)){
iLocal_439=0;
iLocal_143=2;
}
if(!iLocal_432){
...
var uVar0;
var uVar1;
uVar0=Global_2848280[iParam0 /*3*/][func_69(iParam1)];
...
if(func_152(iVar0) && !PED::IS_PED_INJURED(uParam0)){
...
if(func_322()){
*uParam0=func_303(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_7()==0){
return MISC::IS_BIT_SET(func_70(func_301(iParam0), -1, 0), iParam1);
}}else{
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_304(iVar0, 0), 1);
...
Vector3 func__304(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_309(2, 2);
}elseif(func_308(Global_1853747)){
...
Var18={
func_311(Var18, -Var0.f_3.f_2) 
};
Var18={
func_311(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__311(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
if(iParam4==1){
if(func_365(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
void func_342(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
func_361(iParam5, &Var0, Param1, uParam4, func_270(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_279(iParam0, 0, 0)) || func_279(iParam0, 1, 0)) || func_279(iParam0, 2, 0)) || func_270(iParam0) !=145) || func_359(iParam0)) || func_358(iParam0)) || func_357(iParam0)) || func_356(iParam0)) || !func_346(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_358(iParam0)){
}
if(func_358(iParam0)){
}
...
void func_361(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_360(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
Local_186[iParam0 /*29*/].f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0 /*29*/], 6, iLocal_247, -1, 1, 1);
Local_186[iParam0 /*29*/].f_2=PED::CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0 /*29*/], 6, iLocal_247, 0, 1, 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_246)){
Local_186[iParam0 /*29*/]=VEHICLE::CREATE_VEHICLE(iLocal_246, Local_186[iParam0 /*29*/].f_3, Local_186[iParam0 /*29*/].f_6, 1, 1, 0);
}}elseif(!ENTITY::IS_ENTITY_DEAD(Local_186[iParam0 /*29*/].f_1, 0)){
PED::SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_1, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0 /*29*/].f_1, joaat("weapon_pistol"), 100, 1);
PED::SET_PED_ACCURACY(Local_186[iParam0 /*29*/].f_1, 10);
if(func_207(Local_186[iParam0 /*29*/].f_2)){
PED::SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_2, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_2, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0 /*29*/].f_2, joaat("weapon_pistol"), 100, 1);
...
}elseif((func_391(Local_186[iParam0 /*29*/]) || func_378(Local_186[iParam0 /*29*/].f_1)) || func_378(Local_186[iParam0 /*29*/].f_2)){
func_376(iParam0, 0);
}elseif(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
func_376(iParam0, 0);
}}else{
...
func_376(iParam0, 1);
}elseif((func_378(Local_186[iParam0 /*29*/].f_1) || func_378(Local_186[iParam0 /*29*/].f_2)) || func_391(Local_186[iParam0 /*29*/])){
func_376(iParam0, 0);
}
break;
case 3:
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_1, 0);
PED::SET_PED_HIGHLY_PERCEPTIVE(Local_186[iParam0 /*29*/].f_1, 1);
func_374(&(Local_186[iParam0 /*29*/].f_1), 1, 0, 1);
}
if(func_207(Local_186[iParam0 /*29*/].f_2)){
PED::SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_2, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_2, 0);
PED::SET_PED_HIGHLY_PERCEPTIVE(Local_186[iParam0 /*29*/].f_2, 1);
func_374(&(Local_186[iParam0 /*29*/].f_2), 1, 0, 1);
}
if(iParam1 && func_207(Local_186[iParam0 /*29*/])){
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_186[iParam0 /*29*/], 1, 1, 0);
...
return 1;
}elseif(MISC::IS_PROJECTILE_IN_AREA(Var0 - Vector(3f, 3f, 3f), Var0 + Vector(3f, 3f, 3f), 1)){
return 1;
}elseif(func_379(iParam0, 1126825984)){
return 1;
}}
return 0;
}
...
Vector3 func__383(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_387(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_387(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__387(struct<3> Param0){
float fVar0;
float fVar1;
...
return 1;
}elseif(MISC::IS_PROJECTILE_IN_AREA(Var0 - Vector(5f, 5f, 5f), Var0 + Vector(5f, 5f, 5f), 1)){
return 1;
}}
return 0;
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, 1, 0)){
return 1;
}elseif(Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7 !=0f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, 1, 0)){
return 1;
}
return 0;
}
...
void func_426(){
if(func_207(Local_145.f_4)){
VEHICLE::SET_VEHICLE_STRONG(Local_145.f_4, 1);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_145.f_4, 1);
VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_145.f_4, 0);
VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_145.f_4, 0);
if(!bLocal_152){
...
void func_435(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_439(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
int func_441(int iParam0, var uParam1, var uParam2, int iParam3){
int iVar0;
iVar0=0;
if(MISC::IS_PC_VERSION()){
...
func_209(&uLocal_155);
func_206(&(Local_145.f_4));
Local_145.f_4=VEHICLE::CREATE_VEHICLE(Local_145.f_5, Param0, fParam3, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_145.f_4, 1);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_145.f_4);
VEHICLE::SET_VEHICLE_EXTRA(Local_145.f_4, 1, 1);
VEHICLE::SET_VEHICLE_EXTRA(Local_145.f_4, 2, 1);
VEHICLE::SET_VEHICLE_EXTRA(Local_145.f_4, 3, 1);
uLocal_155=OBJECT::CREATE_OBJECT(iLocal_159, Param0, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_155, Local_145.f_4, 0, Local_156, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1, 0);
ENTITY::SET_ENTITY_COLLISION(uLocal_155, 1, 0);
bLocal_152=true;
func_427(Local_145.f_4, 0);
...
sLocal_449="DEFAULT";
func_458(49, 1, 0);
uLocal_164[0]=PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
uLocal_164[1]=PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
Local_186[0 /*29*/].f_7[0 /*8*/][0 /*3*/]={
1216.144f, -1287.004f, 33.97642f 
};
Local_186[0 /*29*/].f_7[0 /*8*/][1 /*3*/]={
1202.456f, -1306.054f, 39.47411f 
};
Local_186[0 /*29*/].f_7[0 /*8*/].f_7=16.5f;
Local_186[0 /*29*/].f_7[1 /*8*/][0 /*3*/]={
1204.858f, -1296.131f, 33.97642f 
};
Local_186[0 /*29*/].f_7[1 /*8*/][1 /*3*/]={
1198.832f, -1365.926f, 39.47705f 
};
...
Local_186[1 /*29*/].f_7[0 /*8*/][0 /*3*/]={
1164.457f, -1363.839f, 33.51062f 
};
Local_186[1 /*29*/].f_7[0 /*8*/][1 /*3*/]={
1180.637f, -1359.837f, 39.11396f 
};
Local_186[1 /*29*/].f_7[0 /*8*/].f_7=15.5f;
Local_186[1 /*29*/].f_7[1 /*8*/][0 /*3*/]={
0f, 0f, 0f 
};
Local_186[1 /*29*/].f_7[1 /*8*/][1 /*3*/]={
0f, 0f, 0f 
};
...
Vector3 func__467(char* sParam0, int iParam1){
struct<3> Var0;
Var0.f_2=sParam0;
Var0.f_0=iParam1;
Var0.f_1=0;
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_164[0], 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_164[1], 0);
MISC::SET_INSTANCE_PRIORITY_HINT(0);
