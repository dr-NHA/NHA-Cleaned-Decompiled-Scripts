...
if(Global_9058[Global_20383 /*2811*/][0 /*281*/].f_259==2) func_9(Global_20364, "SET_SLEEP_MODE", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
else func_9(Global_20364, "SET_SLEEP_MODE", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
if(func_4(0)) func_3();
}}
return;
}
...
if(func_17()) MOBILE::CELL_SET_INPUT(5);
return;
}
...
uLocal_18[i]=num2;
unk[num2]=1;
if(Global_9058[Global_20383 /*2811*/][iLocal_38 /*281*/].f_124[i]==1) iLocal_34=iLocal_34 + 1;
}
...
if(func_17())if(Global_20589==0) MOBILE::CELL_SET_INPUT(2);
...
if(func_17())if(Global_20589==0) MOBILE::CELL_SET_INPUT(1);
...
unk[num2]=1;
if(Global_9058[Global_20383 /*2811*/][value /*281*/].f_280==1) iLocal_34=iLocal_34 + 1;
value=value + 1;
}
func_9(Global_20364, "DISPLAY_VIEW", 13f, -1082130432, -1082130432, -1082130432, -1082130432);
