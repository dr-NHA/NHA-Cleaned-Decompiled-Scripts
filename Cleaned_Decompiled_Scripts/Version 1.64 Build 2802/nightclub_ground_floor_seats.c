...
iVar11=0;
while (iVar11 < 10){
if(((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar11]) && !PED::IS_PED_INJURED(uVar0[iVar11])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar11])) && (func_63(uVar0[iVar11], uParam0[uParam0->f_141.f_2 /*14*/]) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uVar0[iVar11], 0), (uParam0[uParam0->f_141.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_141.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f)){
return 1;
}
iVar11++;
}
...
int func_83(){
if(Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10 !=func_19()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10, 1, 0)){
return 0;
}
