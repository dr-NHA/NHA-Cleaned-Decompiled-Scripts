...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(localSceneFromNetworkId)) NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
}
return;
}
...
if(MISC::GET_GAME_TIMER() - uParam0->f_141.f_6 > 150) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "MPJAC_SIT" /*Press ~INPUT_CONTEXT~ to sit down.*/, 0, 0, 0, 0);
...
if(uParam0->f_141.f_8==1) distanceToSlide=0.15f;
...
}}elseif(!func_32(&(uParam0->f_141), 8)){
func_65(uParam0, 8);
}
break;
case 7:
...
if(bParam1){
num=func_11(uParam0);
if(num !=uParam0->f_141.f_8.f_1)if(num==0) randomIntInRange=11 + uParam0->f_141.f_8.f_1;
else randomIntInRange=6 + num;
else randomIntInRange=uParam0->f_141.f_8.f_2;
num=uParam0->f_141.f_8.f_1;
}elseif(uParam0->f_141.f_8.f_2==5){
num=uParam0->f_141.f_8.f_1;
endRange=3;
randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(0, endRange);
if(randomIntInRange==uParam0->f_141.f_8.f_3) randomIntInRange=(randomIntInRange + 1) % endRange;
}else{
...
int num;
if(uParam0->f_141.f_8==2) return uParam0->f_141.f_8.f_1;
num=(uParam0->f_141.f_8.f_1 + 1) % func_14(uParam0->f_141.f_8);
if(func_12())if(uParam0->f_141.f_8==1)if(num==0 || num==4) num=1;
elseif(uParam0->f_141.f_8==1)if(num==1 || num==2) num=3;
return num;
}
...
if(uParam0->f_141.f_4==6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("block_interrupt")) && !func_32(&(uParam0->f_141), 12))if(num >=0.35f && !Global_2766478 && !Global_2766481) func_29(uParam0);
...
if(uParam0->f_141.f_5==-1)if(uParam0->f_141.f_8==1 || uParam0->f_141.f_8==0)if(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))if(flag)if(func_17(PLAYER::PLAYER_ID())==3) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_SEAT_PC_BM" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(func_17(PLAYER::PLAYER_ID())==2) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_SEAT_PC_TOU" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_SEAT_PC" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "MPOF_AC_PC_EXIT" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(flag)if(func_17(PLAYER::PLAYER_ID())==3) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_SEAT_BM" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(func_17(PLAYER::PLAYER_ID())==2) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_SEAT_TOU" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_SEAT" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "MPOF_AC_EXIT" /*Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(uParam0->f_141.f_8==2)if(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))if(flag)if(func_17(PLAYER::PLAYER_ID())==3) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_PC_BM" /*Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(func_17(PLAYER::PLAYER_ID())==2) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_PC_TOU" /*Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_PC" /*Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "MPOFSEAT_PCEXIT" /*Press ~INPUT_SCRIPT_RRIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(flag)if(func_17(PLAYER::PLAYER_ID())==3) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_BM" /*Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
elseif(func_17(PLAYER::PLAYER_ID())==2) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_PSEAT_TOU" /*Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "DJ_PSEAT" /*Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
else _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_141.f_5), 4, "MPOFSEAT_EXIT" /*Press ~INPUT_FRONTEND_RIGHT~ to stand up.*/, 0, 0, 0, 0);
if(uParam0->f_141.f_4==6){
...
var unk;
unk={
uParam0->[uParam0->f_141.f_2 /*14*/].f_8.f_3 
};
if(func_12() && uParam0->f_141.f_8==0) unk.f_2=unk.f_2 - 4f;
return unk;
}
...
if(uParam0->f_141.f_8==1)if(func_12())if(randomIntInRange==0 || randomIntInRange==4) randomIntInRange=1;
...
if(playerIndex !=PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))if(func_63(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_141.f_2 /*14*/]) || func_58(playerIndex)==uParam0->f_141.f_2) return 1;
}}
...
i < 10;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(sizeAndPeds[i]) && !PED::IS_PED_INJURED(sizeAndPeds[i]) && ENTITY::IS_ENTITY_VISIBLE(sizeAndPeds[i]) && func_63(sizeAndPeds[i], &uParam0->[uParam0->f_141.f_2 /*14*/]) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(sizeAndPeds[i], false), (uParam0->[uParam0->f_141.f_2 /*14*/].f_1 + uParam0->[uParam0->f_141.f_2 /*14*/].f_1.f_3) /{
2f, 2f, 2f 
}
) < 1f) return true;
}
...
i < 1;
i=i + 1){
if(func_63(PLAYER::PLAYER_PED_ID(), &uParam0->[uParam0->f_141.f_2 /*14*/]) && func_62(PLAYER::PLAYER_PED_ID(), uParam0->[uParam0->f_141.f_2 /*14*/].f_8.f_3, uParam0->[uParam0->f_141.f_2 /*14*/])) return true;
else uParam0->f_141.f_2=(uParam0->f_141.f_2 + 1) % 10;
}
return false;
}
...
if(uParam0->f_141.f_4==6){}elseif(uParam0->f_141.f_4 > 4){
...
}elseif(MISC::GET_FRAME_COUNT() - uParam0->f_141.f_7 < 5){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_68());
}
return;
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1607.0521f, -3011.8904f, -80.00597f, -1574.7677f, -3011.67f, -77.99634f, 9.5f, false, true, 0)) return true;
return false;
}
...
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10, true, 0)) return false;
...
Vector3 func__86() // Position - 0x252E{
return 0.5f, -0.5f, 2f;
}


Vector3 func__87(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2541{
float num;
float num2;
float num3;
...
Vector3 func__88() // Position - 0x2585{
return -0.5f, -0.5f, 0f;
}
...
case 0:
*uParam1={
-1582.646f, -3009.84f, -79.98f 
};
*uParam2=0f;
break;
case 1:
*uParam1={
-1583.785f, -3009.78f, -80f 
};
*uParam2=0f;
break;
case 2:
*uParam1={
-1584.526f, -3009.84f, -79.98f 
};
*uParam2=0f;
break;
case 3:
*uParam1={
-1585.535f, -3009.78f, -80f 
};
*uParam2=0f;
break;
case 4:
*uParam1={
-1590.568f, -3007.62f, -79.98f 
};
*uParam2=0f;
break;
case 5:
...
case 6:
*uParam1={
-1593.153f, -3007.62f, -79.98f 
};
*uParam2=0f;
break;
case 7:
*uParam1={
-1594.067f, -3007.6f, -80f 
};
*uParam2=0f;
break;
case 8:
*uParam1={
-1598.14f, -3007.62f, -79.98f 
};
*uParam2=0f;
break;
case 9:
*uParam1={
-1599.09f, -3007.6f, -80f 
};
*uParam2=0f;
break;
}}else{
...
case 0:
*uParam1={
-1582.646f, -3009.9f, -80.033f 
};
*uParam2=0f;
break;
case 1:
*uParam1={
-1583.635f, -3009.83f, -80.033f 
};
*uParam2=0f;
break;
case 2:
*uParam1={
-1584.526f, -3009.9f, -80.033f 
};
*uParam2=0f;
break;
case 3:
*uParam1={
-1585.417f, -3009.83f, -80.033f 
};
*uParam2=0f;
break;
case 4:
*uParam1={
-1590.568f, -3007.63f, -80.033f 
};
*uParam2=0f;
break;
case 5:
*uParam1={
-1591.6f, -3007.57f, -80.033f 
};
*uParam2=0f;
break;
case 6:
*uParam1={
-1593.153f, -3007.63f, -80.033f 
};
*uParam2=0f;
break;
case 7:
*uParam1={
-1594.067f, -3007.57f, -80.033f 
};
*uParam2=0f;
break;
case 8:
*uParam1={
-1598.14f, -3007.63f, -80.033f 
};
*uParam2=0f;
break;
case 9:
*uParam1={
-1599.09f, -3007.57f, -80.033f 
};
*uParam2=0f;
break;
}}
