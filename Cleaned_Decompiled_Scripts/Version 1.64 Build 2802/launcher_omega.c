...
if(num==44) func_247();
elseif(num==45) func_246();
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_272(&num, true);
func_207(num);
...
if(func_174(&num, 0)){
if(!func_2(&num)) func_272(&num, true);
if(func_1(&num)) func_272(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xBC1{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x69D7{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x7127{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x74B3{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x75F2{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x8373{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B75{
...
func_289("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_178(uParam0->f_27)){
func_177(uParam0->f_27, *uParam0);
func_289("RC5_IN_ACTIVATION_RANGE:
...
if(func_178(true)){
func_177(1, *uParam0);
func_289("RC_IN_ACTIVATION_RANGE:
...
func_289("RC_STOP_PLAYER_VEHICLE_CHECK:
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true) 
};
entityCoords2={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
...
if(heading < 0f) heading=heading + 360f;
...
if(Global_43257==17){
if(*uParam0 !=-1) func_205(uParam0);
}elseif(func_204()){
if(*uParam0 !=-1) func_205(uParam0);
}elseif(*uParam0==-1){
if(func_199(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_203(uParam0, 1);
}else{
...
if(func_199(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_205(uParam0);
}}}
return;
}
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_201(*uParam0, false);
...
var unk;
if(Global_78558){
func_289("IS_RC_FINE_AND_IN_RANGE():
The game is running Multiplayer [TERMINATING]");
return false;
}
func_115(*panParam0, &unk);
if(func_245(*panParam0) || func_243(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_289("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_238(panParam0->f_28[0]);
func_289("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_218(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_218(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_215(panParam0);
else func_213(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(func_212(&(panParam0->f_48)) && bParam1) func_209(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
if(func_211(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_211(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_210(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(iParam2==0) func_213(uParam0);
else func_215(uParam0);
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_149();
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_221(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_229(&iLocal_37[num /*4*/]);
return false;
}
if(!func_226(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_225();
if(num==-1) return false;
...
Vector3 func__224(Ped pedParam0, int iParam1) // Position - 0xE64C{
...
float num;
unk={
func_228(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_228(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__228(float fParam0, var uParam1, var uParam2) // Position - 0xE80D{
float num;
float num2;
...
if(!bParam2){
if(func_236(pedParam0, bParam1, radius, num)) return true;
if(func_233(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_234(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_234(pedParam0, fParam1)) return true;
...
float num;
unk={
func_228(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_245(iParam0)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(4)){
if(func_243(iParam0)){
}else{
return true;
}}
if(func_242() && !func_241()) return true;
if(!func_240(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_244() && Global_100681.f_11==6 && iParam0==func_172(&(Global_100681.f_3), 0)) return true;
return false;
}
...
if(HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner")) iLocal_97=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
...
switch (*uParam0){
case 44:
if(!func_258(uParam0)) return false;
break;
case 45:
...
break;
case 1:
if(!func_256(&num) || !func_255(&(uParam0->f_48))) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_252(&uParam0->f_28[0], CHAR_OMEGA, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1)) flag=false;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) func_250(&uParam0->f_35[0], num[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
if(flag) iLocal_91=3;
break;
case 3:
...
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_252(&uParam0->f_28[0], CHAR_OMEGA, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1)) flag=false;
...
if(func_242() && !func_241()) return false;
if(func_267(iParam0)) return false;
if(iParam0==-1) iParam0=func_171();
if(iParam0==-1) return false;
if(!func_245(iParam0)){
if(!func_266(iParam0)) return false;
if(!func_265(iParam0)) return false;
if(func_264(iParam0)) return false;
}
if(iParam0==58)if(func_262(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
int i;
if(*uParam0==1){
if(func_270(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
char* str;
if(*uParam0==45) VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314.546f, 2576.3296f, 44.7f, 2326.4463f, 2579.6082f, 47.6645f, true, true);
if(bParam1){
func_289("SCRIPT TERMINATING:
Cleaning up entities in Launcher");
if(*uParam0==44 && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1])) ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uParam0->f_41[1]);
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))if(func_194(sParam0)) func_274();
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_214(&uParam0->[i]);
else func_280(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_251(&uParam0->[i]);
else func_283(&uParam0->[i]);
}
return;
}
...
else func_286(&uParam0->[i], false, 1, 0);
}
return;
}
