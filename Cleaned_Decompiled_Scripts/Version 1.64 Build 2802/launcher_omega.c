...
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], 1) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
...
float fVar2;
float fVar3;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_96, "SET_COLOUR");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_96, "SET_DISTANCE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
HUD::SET_TEXT_RENDER_ID(uLocal_97);
fVar0=0.1f;
fVar1=0.24f;
fVar2=0.21f;
fVar3=0.51f;
...
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
if((MISC::GET_GAME_TIMER() - iLocal_98) > 1250){
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
iLocal_98=MISC::GET_GAME_TIMER();
}}

int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8){
var uVar0;
if(!*uParam8==3){
if(func_180(2)){
if(!func_151()){
...
uParam1->f_3=5;
}elseif((func_211(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
Vector3 func__224(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_228(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_228(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__228(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_228(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
void func_247(){
uLocal_96=GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_96)){
SYSTEM::WAIT(0);
}
...
if(HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner")){
uLocal_97=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
}
uLocal_99=AUDIO::GET_SOUND_ID();
iLocal_98=MISC::GET_GAME_TIMER();
}
...
if(!func_252(&(uParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1)){
bVar4=false;
}}
