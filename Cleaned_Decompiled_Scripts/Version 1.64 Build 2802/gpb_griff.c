...
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_448);
}}
...
void func_104(){
PED::SET_PED_COMPONENT_VARIATION(uLocal_240, 1, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_240, 11, 0, 0, 0);
PED::SET_PED_PROP_INDEX(uLocal_240, 1, 0, 0, 0, 1);
PED::SET_PED_PROP_INDEX(uLocal_240, 0, 0, 0, 0, 1);
uLocal_448=OBJECT::CREATE_OBJECT(joaat("prop_cs_protest_sign_01"), ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1, 1, 0);
