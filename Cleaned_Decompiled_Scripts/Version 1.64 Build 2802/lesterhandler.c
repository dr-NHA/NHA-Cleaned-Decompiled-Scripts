...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_46, 0, 0);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_46, 1);
func_28(&uLocal_51, 3, uLocal_46, "LESTER", 0, 1);
uLocal_47=OBJECT::CREATE_OBJECT(joaat("prop_cs_walking_stick"), 706.9874f, -967.0945f, 30.4f, 0, 0, 0);
...
uLocal_48=OBJECT::CREATE_OBJECT(joaat("prop_laptop_lester2"), 707.3041f, -967.6456f, 30.376f, 1, 1, 0);
...
if(Global_78823==86){
if(!Global_113643==1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, 0, 1, 0)){
func_3(7, 1);
Global_113639=0;
Global_113643=1;
...
int func_2(){
uLocal_219=GRAPHICS::REQUEST_SCALEFORM_MOVIE("JHPB_02_Laptop");
