...
iLocal_41=49;
iLocal_42=64;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83)) func_30();
if(_IS_MISSION_REPEAT_ACTIVE(false)) func_30();
...
if(!HUD::IS_NAMED_RENDERTARGET_LINKED(joaat("prop_laptop_lester2"))) HUD::LINK_NAMED_RENDERTARGET(joaat("prop_laptop_lester2"));
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL)if(num < 4f)if(MISC::GET_GAME_TIMER() > iLocal_217)if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(_CONVERSATION_ADD_LINE(&uLocal_51, "JHFAUD", "JHF_LEAVE", 3, 0, 0, 0)) iLocal_217=MISC::GET_GAME_TIMER() + 25000;
if(Global_78823==86){
...
func_1();
if(num > 2500f) MISC::SET_BIT(&iLocal_216, 1);
}}
SYSTEM::WAIT(0);
}
func_30();
...
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_219)) return true;
return false;
}
