...
void func_194(int iParam0, char* sParam1, struct<3> Param2){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
uParam1->f_3=5;
}elseif((func_205(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
int func_212(var uParam0, bool bParam1, int iParam2){
int iVar0;
int iVar1;
if(bParam1){
...
float fVar6;
Var0={
func_222(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_222(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__222(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_222(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
func_242(&(uParam0->f_35[0]), -685.2281f, 5833.982f, 16.331f, 313.2204f, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_100)){
iLocal_100=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, Local_97, 0, 1065353216, 0, 0, 1);
...
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_97, 1f, iLocal_94, 0)){
...
void func_242(var uParam0, struct<3> Param1, float fParam4, int iParam5){
func_243(uParam0, iLocal_93, Param1, fParam4);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_243(var uParam0, int iParam1, struct<3> Param2, var uParam5){
func_244(uParam0);
...
int func_245(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7){
if(func_246(uParam0, iParam1, Param2, fParam5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_246(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_36(iParam1)){
...
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
func_242(&(uParam0->f_35[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
...
void func_266(var uParam0, int iParam1, bool bParam2, bool bParam3){
