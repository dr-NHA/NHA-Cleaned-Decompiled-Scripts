...
ENTITY::FREEZE_ENTITY_POSITION(iLocal_156, 0);
}
if(iLocal_144==1){
...
if(func_14(iLocal_158, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f, 1)){
AUDIO::STOP_PED_SPEAKING(iLocal_158, 0);
...
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_158, 2, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_158, 64, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_158, 128, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_158, 8, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_158, 1, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_158, 32, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_158, 5, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_158, 17, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_158, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_158, 1);
}}
}}}}
break;
}}
...
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_150, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_150, 0);
if(func_2(iLocal_158, joaat("script_task_synchronized_scene"))){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_158, -1000f, 1);
}
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_158, iLocal_150, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_158, 0, 0);
if(func_11(iLocal_154)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_154, "special_ped@maude@base", "base_chair", 3)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_154, -16f, 0);
}
iVar0=0;
iVar0 +=16;
iVar0 +=64;
iVar0 +=512;
iVar0 +=4096;
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_154, iLocal_150, "Female_Flee_Table_Left_Maude_Chair", "special_ped@maude@exit_flee", 16f, -4f, iVar0, 1148846080);
}
return 1;
}}else{
return 1;
...
bool func_14(int iParam0, struct<3> Param1, float fParam4, int iParam5){
...
iLocal_156=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2727.4f, 4145.56f, 43.68f, 10f, joaat("prop_table_03b"), 1, 0, 1);
if(func_11(iLocal_156)){
ENTITY::SET_ENTITY_COORDS(iLocal_156, 2727.4f, 4145.56f, 43.68f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_156, -92.17f);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_156, 1);
}}}
if(func_17(iLocal_158)){
...
if(func_17(iLocal_158)){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_158, 0) 
};
if(!func_246(0)){
...
iLocal_142=2;
iLocal_143=0;
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_158)){
iLocal_144=0;
iLocal_142=2;
iLocal_143=0;
}
...
Global_78341[1 /*14*/]={
func_110(iVar0, iParam1, iParam2, -1) 
};
...
Global_78341[1 /*14*/]={
func_110(iVar0, iParam1, uVar31[iParam1], -1) 
};
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_110(iVar10, iParam1, iParam2, -1) 
};
if(!func_100(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_110(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar28=9;
...
uVar28={
func_103(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_110(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_110(iVar10, iVar0, func_67(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_103(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_110(iVar10, 14, uVar69[iVar1], -1) 
};
func_77(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_93(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_110(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_88(iParam0, iParam2, iParam3, -1)){
...
func_95(iVar2, uVar3, iVar0, 1, 0);
}}


void func_95(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4){
int iVar0;
if(bParam4){}
...
func_188(&uVar32, Var0.f_3, Global_100718, iParam1, iParam2);
}}


void func_188(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4){
...
bool func_241(char* sParam0, int iParam1, int iParam2){
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_158, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0)){
return 1;
}}
...
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_158, 1), 15f)){
return 1;
}
...
Vector3 func__258(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_147, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_158, iLocal_147, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1148846080, 0);
iVar0=0;
iVar0=16;
iVar0=64;
iVar0=512;
iVar0=4096;
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_154, iLocal_147, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar0, 1148846080);
PED::SET_PED_KEEP_TASK(iLocal_158, 1);
}}}}
...
case 31:
if(bParam1){
uLocal_80=PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, 0, 1, 1, 1);
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_80, 0);
...
if(iParam4==1){
if(func_325(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
void func_281(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6){
struct<60> Var0;
...
func_315(iParam5, &Var0, Param1, uParam4, func_318(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_299(iParam0, 0, 0)) || func_299(iParam0, 1, 0)) || func_299(iParam0, 2, 0)) || func_318(iParam0) !=145) || func_298(iParam0)) || func_297(iParam0)) || func_296(iParam0)) || func_295(iParam0)) || !func_285(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_297(iParam0)){
}
if(func_297(iParam0)){
}
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_307(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_315(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_312(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
iLocal_157=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, iVar3, 1, 0, 1);
}}}}
...
if(!func_350(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_81.f_28[0], 0f, 0f, 0f, 1, -1, 2000, 2000, 0);
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 0f, 1.2f, 0f, 1f, -1, 1036831949, 1);
}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_350(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
2729.092f, 4143.17f, 41.36332f 
};
uParam0->f_17[1 /*3*/]={
2714.735f, 4145.382f, 45.30732f 
};
uParam0->f_24=12.8f;
uParam0->f_27=0;
uParam0->f_25=1;
...
int func_367(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7){
if(func_368(uParam0, iParam1, Param2, fParam5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_370(var uParam0, var uParam1, struct<3> Param2, float fParam5){
func_4(uParam0);
...
var uVar5;
var uVar6;
if((func_179(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0)){
...
return 1;
}elseif(func_402(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_426(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
}elseif((!func_437(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_439(iParam0, uVar1[iVar6], 1) && func_438(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_319(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_321(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_321(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_321(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_321(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_321(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_321(iVar6))){
}else{
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_321(iVar7 + 1))){
