...
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_372, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 6f){
func_87();
}}else{
func_87();
}}}
...
MISC::CLEAR_AREA_OF_VEHICLES(func_28(), 5f, 0, 0, 0, 0, 0, 0, 0);
...
func_42("TV_HLP3");
iLocal_308=5;
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_331) > 0.8f){
uLocal_331=PED::CREATE_SYNCHRONIZED_SCENE(func_28(), func_27(), 2);
...
}}elseif(ENTITY::FIND_ANIM_EVENT_PHASE(func_5(), "cigar_idle_b_michael", func_4(), &fVar4, &fVar5)){
if(fVar3 >=fVar4 && fVar3 <=fVar5){
iLocal_313=1;
}}}else{
uLocal_331=PED::CREATE_SYNCHRONIZED_SCENE(func_28(), func_27(), 2);
...
STATS::STAT_SET_INT(joaat("num_sh_sofa_smoked"), iLocal_334 + 1, 1);
}
if(Global_32224[4 /*11*/].f_2){
iLocal_309=0;
}else{
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_35(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
