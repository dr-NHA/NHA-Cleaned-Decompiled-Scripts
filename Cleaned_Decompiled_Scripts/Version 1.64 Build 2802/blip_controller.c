...
iVar2=0;
while (iVar2 < 263){
bVar7=MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 18);
if(!bVar7){
if(func_34(iVar2)){
iVar5++;
bVar7=true;
...
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 13)){
if(func_33()){
iVar8++;
}
iVar9++;
}
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 1)){
if(!bLocal_50){
iVar8++;
}
iVar9++;
}
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 2)){
if(bLocal_50){
iVar8++;
}
iVar9++;
}
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 7)){
if(!func_32(15)){
iVar8++;
}
iVar9++;
}
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 16)){
if(!func_30(Global_32543[iVar2 /*23*/].f_22)){
iVar8++;
}
iVar9++;
}
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 14)){
if(func_32(5)){
iVar8++;
}
iVar9++;
}
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 8)){
...
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 19)){
switch (iLocal_64){
case 1:
case 0:
case 2:
...
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 27)){
if(bLocal_45){
iVar8++;
}
iVar9++;
...
elseif(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 15)){
MISC::SET_BIT(&(Global_32543[iVar2 /*23*/].f_11), 0);
}}elseif(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 15)){
MISC::SET_BIT(&(Global_32543[iVar2 /*23*/].f_11), 0);
}
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 0) && MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 3)){
bVar10=false;
...
case 0:
case 2:
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 28)){
...
HUD::SHOW_HEIGHT_ON_BLIP(Global_32543[iVar2 /*23*/].f_19, 0);
}
else{
...
break;
}}elseif(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 28)){
Global_32543[iVar2 /*23*/].f_19=HUD::ADD_BLIP_FOR_RADIUS(Global_32543[iVar2 /*23*/][0 /*3*/], Global_32543[iVar2 /*23*/].f_10);
HUD::SET_BLIP_ALPHA(Global_32543[iVar2 /*23*/].f_19, 128);
HUD::SHOW_HEIGHT_ON_BLIP(Global_32543[iVar2 /*23*/].f_19, 0);
}else{
...
if(MISC::IS_BIT_SET(Global_32543[iVar2 /*23*/].f_11, 9)){
if(iLocal_47){
HUD::SET_BLIP_FLASHES(Global_32543[iVar2 /*23*/].f_19, 1);
iLocal_47=0;
}else{
HUD::SET_BLIP_FLASHES_ALTERNATE(Global_32543[iVar2 /*23*/].f_19, 1);
iLocal_47=1;
}
HUD::SET_BLIP_FLASH_TIMER(Global_32543[iVar2 /*23*/].f_19, 10000);
MISC::CLEAR_BIT(&(Global_32543[iVar2 /*23*/].f_11), 9);
}else{
HUD::SET_BLIP_FLASHES(Global_32543[iVar2 /*23*/].f_19, 0);
}
}
...
Var0={
func_17(PLAYER::GET_PLAYER_INDEX()) 
};
iVar3=-1;
fVar4=1000000f;
iVar5=0;
...
fVar6=MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, HUD::GET_BLIP_COORDS(Global_32543[iLocal_55[iVar5] /*23*/].f_19), 1);
if(fVar6 < fVar4){
fVar4=fVar6;
iVar3=iVar5;
}}}
...
}}elseif(HUD::DOES_BLIP_EXIST(Global_32543[iLocal_55[iVar5] /*23*/].f_19)){
...
if(!MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 28)){
...
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uParam0, &(Global_32543[iParam1 /*23*/].f_20));
}}
bVar1=MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 4);
bVar2=MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 5);
iVar3=MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 6);
bVar4=false;
if(func_21(0)){
bVar4=MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 11);
}
if(iVar3 && !bVar4){
...
if(MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 8)){
if(!func_29(iParam1)){
if(MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 28)){
...
HUD::SET_BLIP_AS_SHORT_RANGE(uParam0, MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 5));
HUD::SET_BLIP_PRIORITY(uParam0, 3);
HUD::SET_BLIP_AS_SHORT_RANGE(uParam0, 1);
...
if(MISC::IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 19)){
switch (iVar0){
case 1:
case 0:
case 2:
...
uVar1=MISC::GET_BITS_IN_RANGE(Global_32543[iVar0 /*23*/].f_11, 21, 26);
return uVar1;
}
...
if(!MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 8)){
return 0;
}
if(Global_32543[iVar0 /*23*/].f_17==func_1()){
return 1;
}
if(!MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 10)){
return 0;
}
...
if(iLocal_68 && MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 13)){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(iLocal_69 && ((MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 7) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 11)) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 16))){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(iLocal_70 && MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 14)){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(iLocal_65 && ((MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 10) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 8)) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 19))){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(bLocal_66){
...
if(iLocal_72 && MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 27)){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if((iLocal_73 && (MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 1) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 2))) || Global_32543[iParam0 /*23*/].f_16==1){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
return 0;
...
if(bParam1==MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 2)){
return;
}
if(bParam1){
