...
bLocal_50=true;
iLocal_53=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(2)) func_52();
for (i=0;
i <=59;
i=i + 1){
if(func_51(i)){
...
if(func_33()) num5=num5 + 1;
num6=num6 + 1;
}
if(IS_BIT_SET(Global_32543[j /*23*/].f_11, 1)){
if(!bLocal_50) num5=num5 + 1;
num6=num6 + 1;
}
...
if(bLocal_45) num5=num5 + 1;
num6=num6 + 1;
}
if(Global_32543[j /*23*/].f_16==1) func_23();
}
if(num6 > 0)if(num5 > 0) MISC::CLEAR_BIT(&(Global_32543[j /*23*/].f_11), 0);
elseif(IS_BIT_SET(Global_32543[j /*23*/].f_11, 15)) MISC::SET_BIT(&(Global_32543[j /*23*/].f_11), 0);
elseif(IS_BIT_SET(Global_32543[j /*23*/].f_11, 15)) MISC::SET_BIT(&(Global_32543[j /*23*/].f_11), 0);
...
break;
}}elseif(IS_BIT_SET(Global_32543[j /*23*/].f_11, 28)){
Global_32543[j /*23*/].f_19=HUD::ADD_BLIP_FOR_RADIUS(Global_32543[j /*23*/][0 /*3*/], Global_32543[j /*23*/].f_10);
HUD::SET_BLIP_ALPHA(Global_32543[j /*23*/].f_19, 128);
HUD::SHOW_HEIGHT_ON_BLIP(Global_32543[j /*23*/].f_19, false);
}else{
...
if(Global_32543[j /*23*/].f_16==1) flag3=true;
}
else{
if(IS_BIT_SET(Global_32543[j /*23*/].f_11, 19)){
switch (echLocal_64){
...
num3=num3 + 1;
if(Global_32543[j /*23*/].f_16==1) func_18(j);
}
Global_32543[j /*23*/].f_19=0;
}}
MISC::CLEAR_BIT(&(Global_32543[j /*23*/].f_11), 18);
num7=30;
if(CAM::IS_SCREEN_FADED_OUT()) num7=250;
if(num3 > num7){
SYSTEM::WAIT(0);
num3=0;
}
...
if(func_3(character)) return func_6(character);
...
if(func_10(126)){
if(func_9(138)) func_8(138, false, false);
if(!func_9(139))if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("chop"))==0)if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 19.3f, 528.24f, 169.63f, true) > 50f) func_8(139, true, false);
}else{
if(func_9(139)) func_8(139, false, false);
if(!func_9(138))if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("chop"))==0)if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -11.15f, -1425.56f, 29.67f, true) > 50f) func_8(138, true, false);
}}}}
return;
}
...
if(Global_32540==true) Global_32541=1;
Global_32540=true;
}
if(bParam1){
...
if(PLAYER::IS_PLAYER_DEAD(PLAYER::GET_PLAYER_INDEX())) return;
vector={
...
if(iLocal_53==num) return;
iLocal_53=num;
if(num==-1) return;
for (i=0;
i < 7;
i=i + 1){
if(uLocal_55[i] !=-1)if(i==num)if(HUD::DOES_BLIP_EXIST(Global_32543[uLocal_55[i] /*23*/].f_19)) func_16(uLocal_55[i]);
elseif(HUD::DOES_BLIP_EXIST(Global_32543[uLocal_55[i] /*23*/].f_19)) func_12(uLocal_55[i]);
}
return;
}
...
uLocal_55[i]=-1;
if(iParam0==iLocal_53) iLocal_53=-1;
return;
}}
return;
}
...
int i;
int num;
if(iLocal_54==7) return;
i=0;
num=-1;
for (i=0;
i < iLocal_54;
i=i + 1){
if(uLocal_55[i]==iParam0) return;
}
for (i=0;
i < 7;
i=i + 1){
...
if(!IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 28)) HUD::SET_BLIP_SCALE(blParam0, 1f);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_32543[iParam1 /*23*/].f_20)))if(HUD::DOES_TEXT_LABEL_EXIST(&(Global_32543[iParam1 /*23*/].f_20))) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blParam0, &(Global_32543[iParam1 /*23*/].f_20));
...
flag4=false;
if(func_21(0)) flag4=IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 11);
if(flag3 && !flag4) HUD::SET_BLIP_AS_SHORT_RANGE(blParam0, false);
else HUD::SET_BLIP_AS_SHORT_RANGE(blParam0, true);
if(flag2 && flag){
HUD::SET_BLIP_DISPLAY(blParam0, 4);
}else{
if(flag2) HUD::SET_BLIP_DISPLAY(blParam0, 5);
if(flag) HUD::SET_BLIP_DISPLAY(blParam0, 3);
}
...
case 8:
HUD::SET_BLIP_HIGH_DETAIL(blParam0, true);
if(Global_32543[iParam1 /*23*/].f_16==4) HUD::SET_BLIP_PRIORITY(blParam0, 7);
else HUD::SET_BLIP_PRIORITY(blParam0, 5);
if(IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 8)){
if(!func_29(iParam1)){
if(IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 28)){
HUD::SET_BLIP_ALPHA(blParam0, 0);
}else{
if(Global_32543[iParam1 /*23*/].f_17==CHAR_MICHAEL) HUD::SET_BLIP_COLOUR(blParam0, 42);
if(Global_32543[iParam1 /*23*/].f_17==CHAR_FRANKLIN) HUD::SET_BLIP_COLOUR(blParam0, 43);
if(Global_32543[iParam1 /*23*/].f_17==CHAR_TREVOR) HUD::SET_BLIP_COLOUR(blParam0, 44);
...
if(IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 28)) HUD::SET_BLIP_ALPHA(blParam0, 128);
if(Global_32543[iParam1 /*23*/].f_16==8) HUD::SET_BLIP_HIDDEN_ON_LEGEND(blParam0, false);
}}
break;
default:
...
if(IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 17)) HUD::SET_BLIP_AS_MISSION_CREATOR_BLIP(blParam0, true);
else HUD::SET_BLIP_AS_MISSION_CREATOR_BLIP(blParam0, false);
if(IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 20)) HUD::SHOW_TICK_ON_BLIP(blParam0, true);
else HUD::SHOW_TICK_ON_BLIP(blParam0, false);
if(IS_BIT_SET(Global_32543[iParam1 /*23*/].f_11, 29)) HUD::SET_BLIP_COLOUR(blParam0, 39);
return;
}
...
int bitsInRange;
num=iParam0;
if(num < 0 || num >=263 || iParam0==263) return 0;
...
elseif(!func_26(iParam0)) flag=true;
if(iParam0==5)if(func_25(6)) flag=false;
if(func_21(14)) flag=false;
...
num=iParam0;
if(num < 0 || num >=263 || iParam0==263) return false;
if(!IS_BIT_SET(Global_32543[num /*23*/].f_11, 8)) return false;
if(Global_32543[num /*23*/].f_17==_GET_CURRENT_PLAYER_CHARACTER()) return true;
if(!IS_BIT_SET(Global_32543[num /*23*/].f_11, 10)) return false;
if(Global_32543[num /*23*/].f_18==_GET_CURRENT_PLAYER_CHARACTER()) return true;
return false;
}
...
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) !=0) return true;
return false;
}
...
bLocal_46=bLocal_45;
if(func_10(130)) bLocal_45=true;
if(func_10(131)) bLocal_45=false;
...
if(ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), false)) return false;
...
if(interiorFromEntity==0 || func_37(interiorFromEntity)) bLocal_50=true;
else bLocal_50=false;
return true;
}
return false;
}
...
i <=60;
i=i + 1){
if(Global_30[i]==inParam0) return true;
}
return false;
}
...
num=iParam0;
if(num < 0 || num >=263 || iParam0==263) return;
if(bParam1==IS_BIT_SET(Global_32543[num /*23*/].f_11, 2)) return;
if(bParam1) MISC::SET_BIT(&(Global_32543[num /*23*/].f_11), 2);
else MISC::CLEAR_BIT(&(Global_32543[num /*23*/].f_11), 2);
if(Global_32540==true) Global_32541=1;
Global_32540=true;
MISC::SET_BIT(&(Global_32543[num /*23*/].f_11), 18);
return;
