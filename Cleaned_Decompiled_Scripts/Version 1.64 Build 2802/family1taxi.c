...
if(func_6("AM_H_TAXI1" /*Use ~INPUT_CONTEXT~ to flag down passing taxis.*/)) func_11("AM_H_TAXI1" /*Use ~INPUT_CONTEXT~ to flag down passing taxis.*/, 1);
if(func_6("AM_H_TAXI2" /*Taxi pick ups can be requested through the phone.*/)) func_11("AM_H_TAXI2" /*Taxi pick ups can be requested through the phone.*/, 1);
