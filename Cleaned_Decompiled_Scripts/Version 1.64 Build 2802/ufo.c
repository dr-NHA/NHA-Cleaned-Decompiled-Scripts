...
fLocal_14=0.001f;
iLocal_17=-1;
if(Global_113648.f_10196.f_3854==0) func_10();
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(18)) func_10();
while (true){
SYSTEM::WAIT(0);
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_10();
switch (iLocal_18){
case 0:
if(CLOCK::GET_CLOCK_HOURS()==3 && func_9()) iLocal_18=1;
break;
case 1:
func_1(152, 1, false, true, 0);
iLocal_18=2;
if(!AUDIO::IS_AMBIENT_ZONE_ENABLED("AZ_SPECIAL_UFO_03")) AUDIO::SET_AMBIENT_ZONE_STATE("AZ_SPECIAL_UFO_03", true, true);
break;
case 2:
if(CLOCK::GET_CLOCK_HOURS() !=3 || !func_9()) func_10();
break;
}}
return;
}
...
if(func_5()) num=Global_113648.f_7263.f_227[iParam0];
...
if(func_7()==-1 || func_7()==999 && !func_6()==0) return true;
return false;
}
...
if(AUDIO::IS_AMBIENT_ZONE_ENABLED("AZ_SPECIAL_UFO_03")) AUDIO::SET_AMBIENT_ZONE_STATE("AZ_SPECIAL_UFO_03", false, true);
