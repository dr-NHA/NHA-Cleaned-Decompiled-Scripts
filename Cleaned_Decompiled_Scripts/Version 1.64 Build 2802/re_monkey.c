...
iLocal_43=64;
uLocal_51={
-336.61462f, -93.668076f, 46.0005f 
};
fLocal_54=256.1257f;
fLocal_58=0f;
uLocal_69={
-334.8087f, -85.713f, 47.4504f 
};
...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)) func_150();
...
func_51();
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID())) func_49(PLAYER::PLAYER_PED_ID(), -347.4067f, -93.5801f, 44.6639f, 306.0178f);
...
if(func_13(iParam0, iParam1) !=322) func_7(func_13(iParam0, iParam1), uLocal_44, uLocal_44.f_1);
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID())) func_49(PLAYER::PLAYER_PED_ID(), -366.6139f, -79.7531f, 44.6616f, 230.7299f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
CAM::DO_SCREEN_FADE_IN(250);
return true;
}elseif(iLocal_48==2){
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_50))if(PED::IS_PED_DEAD_OR_DYING(pedLocal_50, true)) func_150();
elseif(iLocal_49 > 0)if(bLocal_56) return true;
else func_150();
switch (iLocal_49){
case 0:
if(func_57()){
...
if(func_14(Global_113637)) func_59(0);
...
if(iParam4 !=0) func_64(uParam0, iParam4);
}
return 2;
}
...
var func__70(BOOL bParam0, var uParam1, var uParam2) // Position - 0x288A{
...
func_72();
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && iLocal_55 < 3) func_150();
return;
}
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(pedLocal_50, false) 
};
radius=7.5f;
unk5={
...
if(iLocal_55 < 3)if(MISC::IS_BULLET_IN_AREA(entityCoords, radius, false) || MISC::IS_PROJECTILE_IN_AREA(entityCoords - unk5, entityCoords + unk5, false)) iLocal_55=3;
switch (iLocal_55){
case 0:
...
break;
case 1:
if(func_83(SCRIPT_TASK_PLAY_ANIM)) iLocal_55=5;
...
break;
case 2:
if(func_83(SCRIPT_TASK_PERFORM_SEQUENCE)) iLocal_55=5;
if(isPedInAnyHeli) num=30f;
elseif(isPedInAnyVehicle) num=17.5f;
else num=5f;
if(flag && flag2 && func_82(PLAYER::PLAYER_PED_ID(), pedLocal_50, num)) iLocal_55=3;
if(bLocal_56) iLocal_55=3;
if(func_81()) iLocal_55=3;
if(flag2 && func_80(entityCoords2, entityCoords)) iLocal_55=3;
func_78();
break;
case 3:
if(func_73()) iLocal_55=iLocal_55 + 1;
break;
case 4:
...
if(shapeTestResult==2)if(hit==1) iLocal_55=iLocal_55 + 1;
else iLocal_55=iLocal_55 - 1;
elseif(shapeTestResult==0) iLocal_55=iLocal_55 + 1;
break;
case 7:
PED::DELETE_PED(&pedLocal_50);
break;
}}elseif(ENTITY::DOES_ENTITY_EXIST(pedLocal_50)){
...
iLocal_60=1;
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(pedLocal_50, sLocal_74, sLocal_76, 3)){
...
func_76(&blLocal_57);
func_75();
if(ENTITY::DOES_ENTITY_EXIST(uLocal_64[0])) ENTITY::DETACH_ENTITY(uLocal_64[0], true, true);
...
Vector3 func__74(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x2DF7{
return ({
...
if(entityAnimCurrentTime < 0.383793f) func_75();
elseif(entityAnimCurrentTime < 0.612112f) func_79();
elseif(entityAnimCurrentTime < 1f) func_75();
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(pedLocal_50, sLocal_74, sLocal_77, 3)){
entityAnimCurrentTime=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(pedLocal_50, sLocal_74, sLocal_77);
if(entityAnimCurrentTime < 0.1124f) func_75();
elseif(entityAnimCurrentTime < 0.5566f) func_79();
elseif(entityAnimCurrentTime < 0.7546f) func_75();
elseif(entityAnimCurrentTime < 0.9f) func_79();
elseif(entityAnimCurrentTime < 1f) func_75();
}
return;
}
...
if(func_95(uParam0, 33, 0, false, false))if(func_94(58))if(func_91())if(_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return true;
return false;
}
...
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_149()) return false;
}
...
if(func_22(_GET_CURRENT_PLAYER_CHARACTER()))if(func_137(100f, true) !=-1) return false;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !bParam6)if(entityCoords.f_2 - uLocal_44.f_2 > 50f) return false;
if(!func_136(iParam3)) return false;
if(func_22(_GET_CURRENT_PLAYER_CHARACTER()))if(func_135(_GET_CURRENT_PLAYER_CHARACTER())==4 || func_135(_GET_CURRENT_PLAYER_CHARACTER())==5) return false;
if(func_22(_GET_CURRENT_PLAYER_CHARACTER()))if(!func_134(iParam3, iParam4, 145)) return false;
if(!func_133(Global_113648.f_24997.f_43[iParam3])) return false;
if(MISC::GET_GAME_TIMER() - Global_113639 < 150000)if(iParam3 !=30) return false;
if(func_131()) return false;
if(MISC::GET_MISSION_FLAG()) return false;
if(MISC::GET_RANDOM_EVENT_FLAG()) return false;
if(!func_121(4)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(5)) return false;
if(func_120(iParam3, iParam4) && !bParam5) return false;
...
if(iParam3==9 && iParam4==2 || iParam4==5 && !func_120(0, 0)) return false;
if(Global_32310) return false;
if(func_136(30) && !func_120(30, 0))if(iParam3 !=30)if(SYSTEM::VDIST2(entityCoords, -61.2745f, -1100.4675f, 25.3752f) < 176400f) return false;
...
if(func_119(num))if(func_97(i))if(!func_96(vector, 0f, 0f, 0f, false))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector) < 210f * 210f)if(_GET_CURRENT_PLAYER_CHARACTER() !=i) return false;
}}}
return true;
}
...
var func__109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3AC7{
if(bParam0) return uParam1;
return uParam2;
}
...
int num;
int num2;
if(!func_119(iParam1) || !func_119(iParam0)) return 1;
...
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_130() || Global_112695 || Global_32166 || func_129() || func_128(8, -1) || func_127() || func_126() || func_125() || func_124() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_130() || Global_32166 || func_129() || func_128(8, -1) || func_125() || func_127() || func_126() || func_124() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_130() || Global_112695 || Global_32166 || func_129() || func_128(8, -1) || func_125() || func_127() || func_126() || func_124() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_130() || Global_112695 || Global_32166 || func_129() || func_128(8, -1) || func_127() || func_126() || func_124() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_130() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_128(8, -1) || func_124() || func_123() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_128(8, -1) || func_127() || func_126() || func_123() || func_122()) return false;
...
if(func_148() && !func_149()) return true;
if(func_147() && func_146()) return true;
return false;
}
