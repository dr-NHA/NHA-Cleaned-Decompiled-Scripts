...
MISC::CLEAR_AREA_OF_VEHICLES(ScriptParam_0.f_1[0 /*3*/], 8f, 0, 0, 0, 0, 0, 0, 0);
...
if(bVar3){
if(iLocal_86==iVar4){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_85, ScriptParam_0.f_1[0 /*3*/], 4f, 4f, 2f, 0, 1, 0)){
func_93(&uLocal_94, 128);
bVar3=false;
}
}
...
elseif(!func_111(uLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_67(&iLocal_96);
...
if(func_111(uLocal_94, 2097152)){
if(!func_88(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52)){
func_104(10);
}}
...
fLocal_102=209f;
iLocal_105=95;
MISC::CLEAR_AREA_OF_VEHICLES(Local_114, 10f, 0, 0, 0, 0, 0, 0, 0);
iLocal_99=10;
