...
fLocal_32=180f;
iLocal_35=3;
uLocal_92=func_576(64);
uLocal_93=func_576(63);
...
bLocal_369=true;
Local_390={
-1304.754f, -38.3551f, 47.0814f 
};
Local_393={
-1340.555f, 17.6527f, 51.7458f 
};
Local_396={
-1388.436f, 138.2263f, 55.0734f 
};
iLocal_780=-1;
...
Global_78804=1;
iLocal_91=0;
while (!func_538(&Local_108, &uLocal_831)){
SYSTEM::WAIT(0);
}
func_537(&Local_108, 0, 1);
Global_78804=0;
...
if(func_517(Local_481[iVar0 /*13*/])){
...
iVar1=0;
func_515(PLAYER::PLAYER_PED_ID(), -1291.596f, -12.9214f, 48.5137f, 294.7073f, 0, 1);
}else{
iVar1=func_514();
}
...
SYSTEM::WAIT(0);
func_488(Local_108.f_9, 0, 0, 0, 0, 0);
if(func_517(Local_455.f_0)){
if((MISC::GET_GAME_TIMER() - iLocal_372) > 2000){
if(!iLocal_371){
func_487(Local_455.f_0, 0);
...
if(!PED::IS_PED_IN_VEHICLE(Local_455.f_0, Local_749.f_0, 0)){
...
ENTITY::SET_ENTITY_COORDS(Local_749.f_0, -1246.956f, -89.9753f, 42.904f, 1, 0, 0, 1);
...
if(!func_32()){
if(func_517(PLAYER::PLAYER_PED_ID())){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_777, 1) + Vector(0f, 1.5f, 0f), 1, 0, 0, 1);
}}
iLocal_362=1;
iLocal_171=2;
break;
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_25(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
int iVar0;
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(func_238(Global_113648.f_2365.f_539.f_4321) !=ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID())){
...
func_192(&uVar32, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
var func__247(int iParam0, int iParam1){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, Local_455.f_0, PED::GET_PED_BONE_INDEX(Local_455.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
if(func_5(Local_749.f_0)){
if(func_6(Local_455.f_0)){
if(!PED::IS_PED_IN_VEHICLE(Local_455.f_0, Local_749.f_0, 0)){
TASK::TASK_ENTER_VEHICLE(Local_455.f_0, Local_749.f_0, -1, -1, 1073741824, 1, 0);
}}
}
func_536("GS_WAIT_FOR_PLAYER, player threatened Glen;
attacking...");
...
func_12();
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0)){
...
func_536("GS_WAIT_FOR_PLAYER, player got too close to Glen (alert_dis);
attacking...");
func_267();
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, Local_455.f_0, PED::GET_PED_BONE_INDEX(Local_455.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
iLocal_170=3;
...
func_536("GS_PLAYER_IN_OUTFIT, player threatened Glen or returned a second time;
attacking...");
func_267();
}else{
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, Local_455.f_0, PED::GET_PED_BONE_INDEX(Local_455.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_776);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_776, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_776);
TASK::TASK_PERFORM_SEQUENCE(Local_455.f_0, uLocal_776);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_776);
if(func_517(Local_468.f_0)){
...
if((func_5(Local_749.f_0) && func_5(Local_694[5 /*6*/])) && func_517(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749.f_0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_694[5 /*6*/], 0)){
if(func_14()){
func_15();
}
...
case 2:
if(func_275(Local_455.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0)){
func_536("GS_ANGRY_AT_PLAYER, player threatened Glen;
attacking...");
func_267();
}
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0)){
...
break;
case 3:
if(((func_5(Local_749.f_0) && func_265(Local_455.f_0, Local_749.f_0, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749.f_0, 0)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_749.f_0)){
...
if(func_6(Local_455.f_0)){
if(!func_263()){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455.f_0, Local_749.f_0, "NIGEL1DGOLF", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
}else{
iLocal_363=1;
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455.f_0, Local_749.f_0, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
}
}
iLocal_170=4;
}}else{
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749.f_0, 1)){
iLocal_170=7;
}}
break;
case 5:
...
func_259();
if(func_5(Local_749.f_0)){
if(!PED::IS_PED_IN_VEHICLE(Local_455.f_0, Local_749.f_0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749.f_0, 1)){
iLocal_170=7;
}}
break;
case 7:
...
if(!MISC::IS_BIT_SET(Global_113648.f_18576.f_382, 4)){
MISC::SET_BIT(&(Global_113648.f_18576.f_382), 4);
}}}

int func_258(){
if(ENTITY::GET_ENTITY_SPEED(Local_749.f_0) < 0.15f && PED::IS_PED_IN_VEHICLE(Local_455.f_0, Local_749.f_0, 0)){
iLocal_378++;
if(iLocal_378 > 30){
TASK::VEHICLE_WAYPOINT_PLAYBACK_PAUSE(Local_749.f_0);
if(func_5(Local_749.f_0) && func_517(Local_455.f_0)){
VEHICLE::BRING_VEHICLE_TO_HALT(Local_749.f_0, 2f, 3, 0);
if(PED::IS_PED_IN_VEHICLE(Local_455.f_0, Local_749.f_0, 0)){
...
void func_259(){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_455.f_0, 1), 20f, 1)){
...
iVar0=0;
while (iVar0 <=2){
if(func_517(Local_521[iVar0 /*13*/])){
iLocal_681[iVar0]=1;
}
iVar0++;
}}
...
int func_263(){
if(func_517(PLAYER::PLAYER_PED_ID())){
if(func_264(&uLocal_935, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
return 1;
}}
return 0;
}
...
TASK::TASK_PERFORM_SEQUENCE(Local_481[iVar0 /*13*/], uLocal_775);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_775);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_481[iVar0 /*13*/], 25, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_481[iVar0 /*13*/], 1, 1);
PED::SET_PED_KEEP_TASK(Local_481[iVar0 /*13*/], 1);
TASK::SET_PED_PATH_PREFER_TO_AVOID_WATER(Local_481[iVar0 /*13*/], 1);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_774, joaat("player"));
iLocal_667[iVar0]=4;
...
if(func_5(Local_749.f_0)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749.f_0, 0)){
if(func_6(Local_455.f_0)){
if(!PED::IS_PED_IN_VEHICLE(Local_455.f_0, Local_749.f_0, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_775);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 500);
TASK::TASK_PAUSE(0, MISC::GET_RANDOM_INT_IN_RANGE(250, 500));
TASK::TASK_ENTER_VEHICLE(0, Local_749.f_0, -1, -1, 1073741824, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_775);
TASK::TASK_PERFORM_SEQUENCE(Local_455.f_0, uLocal_775);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_775);
...
if(func_517(Local_468.f_0)){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_468.f_0, 1, 1);
}
func_299(Local_468.f_0, 1);
func_269();
if(iLocal_169 <=3 && func_517(Local_455.f_0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, Local_455.f_0, PED::GET_PED_BONE_INDEX(Local_455.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
if(func_517(Local_468.f_0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_825.f_0, Local_468.f_0, PED::GET_PED_BONE_INDEX(Local_468.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}elseif(ENTITY::IS_ENTITY_ATTACHED(Local_782.f_1)){
...
iVar0=0;
while (iVar0 <=5){
if(func_517(Local_561[iVar0 /*13*/])){
func_270(iVar0);
iLocal_671[iVar0]=3;
}
iVar0++;
...
struct<3> Var0;
if(func_517(PLAYER::PLAYER_PED_ID()) && func_517(iParam0)){
...
if(bParam4){
return 0;
}elseif(func_276(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__280(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_284(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_284(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__284(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_284(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
switch (iLocal_693){
case 0:
if(func_6(Local_455.f_0) && func_517(PLAYER::PLAYER_PED_ID())){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_776);
TASK::TASK_PERFORM_SEQUENCE(iParam0, uLocal_776);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_776);
PED::SET_PED_KEEP_TASK(iParam0, 1);
}}}
...
void func_301(){
if(iLocal_368){
if(!func_517(Local_455.f_0) && func_303()){
...
iVar0=0;
while (iVar0 <=1){
if(func_517(Local_640[iVar0 /*13*/])){
func_305(iVar0);
}
iVar0++;
}}}
...
if(func_517(Local_455.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_455.f_0, Local_749.f_0, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(Local_455.f_0, Local_640[iParam0 /*13*/], 62f, 62f, 62f, 0, 1, 0)){
if(func_6(Local_640[iParam0 /*13*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_640[iParam0 /*13*/], Local_455.f_0, -1);
iLocal_678[iParam0]=1;
}
}
elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_640[iParam0 /*13*/], 1), 15f, 1)){
...
}}elseif(func_275(Local_640[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || ENTITY::IS_ENTITY_AT_ENTITY(Local_455.f_0, Local_640[iParam0 /*13*/], 30f, 30f, 30f, 0, 1, 0)){
func_299(Local_640[iParam0 /*13*/], 0);
iLocal_678[iParam0]=3;
}}}
break;
case 1:
if(ENTITY::IS_ENTITY_AT_ENTITY(Local_455.f_0, Local_640[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0)){
if(func_6(Local_640[iParam0 /*13*/])){
func_296(&uLocal_174, 8, Local_640[iParam0 /*13*/], "NIGEL1DAMBIENTGOLFER1", 0, 1);
if(func_265(PLAYER::PLAYER_PED_ID(), Local_640[iParam0 /*13*/], 1) < 45f){
...
TASK::TASK_GO_STRAIGHT_TO_COORD(Local_640[iParam0 /*13*/], Local_640[iParam0 /*13*/].f_4, 3f, -1, 1193033728, 1056964608);
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_307(iParam2), 1);
}
...
if(func_321()){
func_536("Monitor_Security, player has 'mucked about' with the celeb scene;
attacking...");
...
int iVar0;
int iVar1;
if(func_517(PLAYER::PLAYER_PED_ID()) && func_517(Local_481[iParam0 /*13*/])){
...
func_536("SS_GUARD_AREA, player threatened Celeb security;
attacking...");
func_267();
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0);
func_536("SS_GUARD_AREA, player tried sniping Celeb security but was spotted;
attacking...");
func_267();
}}elseif(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_481[iParam0 /*13*/])){
if(func_273()){
...
func_536("SS_GUARD_AREA, player aimed Sniper Rifle when security could see them;
attacking...");
func_267();
}}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0)){
if(!func_181(PLAYER::PLAYER_PED_ID(), 12, 4)){
if(!func_317()){
if(func_277(Local_481[iParam0 /*13*/], 1126825984) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0)){
if(func_14()){
func_12();
}
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_5", 7, 0, 0)){
func_536("SS_GUARD_AREA, player armed, not wearing outfit, guard has LOS or player within 18m;
attacking...");
func_267();
}}
}
elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0)){
if(iLocal_349==0){
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_775);
TASK::TASK_PERFORM_SEQUENCE(Local_481[iParam0 /*13*/], uLocal_775);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_775);
iLocal_387=MISC::GET_GAME_TIMER();
iLocal_349=1;
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0)){
if(func_14()){
func_12();
}
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0)){
func_536("SS_GUARD_AREA, non-outfit, player came back to area after being warned;
attacking");
func_267();
}}}
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0)){
...
func_536("SS_GUARD_AREA, outfit, player came back to area after being warned;
attacking");
func_267();
}}
}}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 50f, 50f, 50f, 0, 1, 0)){
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0)){
func_536("SS_GUARD_AREA, player 50m away from group in non-buggy vehicle;
attacking");
func_267();
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0)){
...
if(PED::HAS_PED_RECEIVED_EVENT(Local_481[iParam0 /*13*/], 61) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 6f, 6f, 6f, 0, 1, 0)){
if(func_277(Local_481[iParam0 /*13*/], 1126825984)){
if(func_14()){
func_12();
}
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0)){
func_536("SS_GUARD_AREA, player went too fast too close to security;
attacking");
func_267();
}}
}}elseif(func_277(Local_481[iParam0 /*13*/], 1126825984)){
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(iLocal_356==0){
...
func_536("SS_GO_TO_PLAYER, player armed, guard has LOS;
attacking...");
func_267();
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) && iLocal_351==1){
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0)){
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
if(func_277(Local_481[iParam0 /*13*/], 1126825984)){
if(func_265(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 1) < 80f){
func_536("SS_WARN_PLAYER, player armed, guard has LOS;
attacking...");
func_267();
}}}elseif(!func_181(PLAYER::PLAYER_PED_ID(), 12, 4)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 4f, 4f, 4f, 0, 1, 0) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 8f, 8f, 8f, 0, 1, 0) && iLocal_351==1)){
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0)){
if(func_6(Local_481[iParam0 /*13*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0)){
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
func_536("SS_WARN_PLAYER, player in vehicle going too fast within 9m of guard;
attacking...");
func_267();
}
}}
...
elseif(func_265(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 1) > 20f){
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0)){
func_536("SS_WARN_PLAYER, outfit worn, player came back to area after being warned;
attacking");
func_267();
}}}}
break;
...
func_536("SS_AIM_AT_PLAYER, player armed, guard has LOS;
attacking...");
if(iLocal_357==0){
func_267();
}
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_481[iParam0 /*13*/], 1, 1);
PED::SET_PED_KEEP_TASK(Local_481[iParam0 /*13*/], 1);
TASK::SET_PED_PATH_PREFER_TO_AVOID_WATER(Local_481[iParam0 /*13*/], 1);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_774, joaat("player"));
...
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_481[iParam0 /*13*/], 1), 20f, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0)){
if(func_14()){
func_12();
}
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 7f, 7f, 5f, 0, 1, 0) || (func_315(PLAYER::PLAYER_PED_ID(), -1097.28f, 68.05f, 52.99f, 10f, 1) && iLocal_351==1)){
if(func_14()){
func_12();
}
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
func_536("SS_AIM_AT_PLAYER, player in vehicle above acceptable speed, within 20m;
attacking...");
func_267();
}
}}
...
if(func_517(Local_455.f_0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 11f, 11f, 11f, 0, 1, 0)){
if(func_6(Local_481[iParam0 /*13*/])){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_481[iParam0 /*13*/]);
TASK::TASK_GO_STRAIGHT_TO_COORD(Local_481[iParam0 /*13*/], Local_481[iParam0 /*13*/].f_1, 3f, -1, Local_481[iParam0 /*13*/].f_7, 1056964608);
}
iLocal_351=1;
iLocal_667[iParam0]=0;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) || (MISC::GET_GAME_TIMER() - iLocal_387) >=12000){
if(func_14()){
func_12();
}
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
break;
case 4:
if(func_265(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (PED::IS_PED_IN_ANY_VEHICLE(Local_455.f_0, 0) || func_517(Local_455.f_0))){
if(HUD::DOES_BLIP_EXIST(Local_481[iParam0 /*13*/].f_11)){
HUD::REMOVE_BLIP(&(Local_481[iParam0 /*13*/].f_11));
func_299(Local_481[iParam0 /*13*/], 1);
iLocal_667[iParam0]=6;
}}elseif(!func_314(Local_481[iParam0 /*13*/], joaat("script_task_perform_sequence"))){
TASK::OPEN_SEQUENCE_TASK(&uLocal_775);
TASK::TASK_PAUSE(0, MISC::GET_RANDOM_INT_IN_RANGE(5, 200));
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_775);
...
iLocal_351=0;
if(func_275(Local_481[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::HAS_PED_RECEIVED_EVENT(Local_481[iParam0 /*13*/], 61)){
func_536("SS_STANDDOWN, player threatened Glen OR guard thought he'd get run over;
attacking...");
func_267();
}elseif(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_481[iParam0 /*13*/])){
if(func_273()){
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 0, 0);
func_536("SS_STANDDOWN, player aiming Sniper Rifle, guard has LOS;
attacking...");
func_267();
}}}
break;
...
bool func_315(int iParam0, struct<3> Param1, float fParam4, int iParam5){
...
TASK::TASK_GO_TO_ENTITY(Local_481[iVar0 /*13*/], Local_455.f_0, 20000, 6f, 1073741824, 1073741824, 0);
}}else{
...
if(func_517(Local_455.f_0)){
if(!func_314(Local_455.f_0, joaat("script_task_cower"))){
TASK::CLEAR_PED_TASKS(Local_455.f_0);
...
ENTITY::DETACH_ENTITY(Local_825.f_0, 1, 1);
}
TASK::TASK_SMART_FLEE_PED(Local_468.f_0, PLAYER::PLAYER_PED_ID(), 300f, -1, 1, 0);
...
iVar0=0;
while (iVar0 <=2){
if((!func_517(Local_481[iVar0 /*13*/]) || func_322(PLAYER::PLAYER_PED_ID(), Local_481[iVar0 /*13*/], 1)) || PED::IS_PED_RAGDOLL(Local_481[iVar0 /*13*/])){
func_536("HAS_PLAYER_MUCKED_ABOUT():
Player bumped celeb security with vehicle OR celeb security dead");
return 1;
}
iVar0++;
}
if((!func_517(Local_455.f_0) || func_322(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 1)) || PED::IS_PED_RAGDOLL(Local_455.f_0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
return 1;
}
if((!func_517(Local_468.f_0) || func_322(PLAYER::PLAYER_PED_ID(), Local_468.f_0, 1)) || PED::IS_PED_RAGDOLL(Local_468.f_0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
return 1;
}
if(func_5(Local_749.f_0) && func_517(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749.f_0, 0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
...
if(func_5(Local_694[4 /*6*/]) && func_517(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_694[4 /*6*/], 0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
...
if(func_5(Local_694[5 /*6*/]) && func_517(PLAYER::PLAYER_PED_ID())){
...
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_389, "COLLECT_IN_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
}else{
func_536("Golf club NOT attached to bag - correct?");
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_389, "COLLECT_OUT_BAG", Local_782.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
}
...
if(func_264(&uLocal_831, ENTITY::GET_ENTITY_COORDS(iParam0, 1))){
return 1;
}
return 0;
}
...
void func_329(){
if(iLocal_364==0){
if(func_517(Local_782.f_1) && iLocal_169==6){
...
if(func_517(Local_782.f_1)){
if(iLocal_364==1){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_782.f_1, 65f, 65f, 65f, 0, 1, 0)){
...
if(iLocal_169 < 6){
if(func_517(Local_455.f_0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 140f, 140f, 140f, 0, 1, 0) && !func_278(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 1126825984, 1, 250, 7)){
func_34(1);
}}}}}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_455.f_0) && func_517(Local_782.f_1)){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_777, Local_749.f_0, 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}
if(func_517(Local_782.f_1) && func_517(Local_455.f_0)){
if(!ENTITY::IS_ENTITY_ATTACHED(Local_782.f_1)){
func_536("Reattaching club to bag!?");
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, iLocal_777, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1, 0);
}elseif(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_782.f_1, Local_455.f_0)){
...
func_301();
if(bLocal_369){
if(func_517(Local_782.f_1) && func_517(iLocal_777)){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
if((func_258() || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_749.f_0, 0, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_749.f_0, 1, 0)){
...
void func_335(){
if(func_517(Local_455.f_0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 20f, 20f, 20f, 0, 1, 0)){
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_347(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(!func_362(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(!func_363(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_360(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_360(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_361(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
if(func_517(iLocal_777) && func_5(Local_749.f_0)){
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_777)){
func_536("Reattaching bag to buggy!?");
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_777, Local_749.f_0, 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}
if((func_517(Local_782.f_1) && func_517(Local_455.f_0)) && func_5(Local_749.f_0)){
if(!ENTITY::IS_ENTITY_ATTACHED(Local_782.f_1)){
func_536("Reattaching club to bag!?");
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, iLocal_777, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1, 0);
}elseif(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_782.f_1, Local_455.f_0)){
...
if(func_369() || !func_517(Local_455.f_0)){
func_33("N1D_COLLECT", 7500, 5);
func_35(6);
}else{
if(bLocal_369){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_749.f_0, PLAYER::PLAYER_PED_ID(), 1) && !WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_749.f_0, 0, 2)){
func_370();
func_513("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_749.f_0));
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_749.f_0);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_749.f_0, PLAYER::PLAYER_PED_ID(), 1)){
func_513("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_749.f_0));
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_749.f_0);
}}else{
func_536("Celeb dead - returning true");
...
if(iLocal_363==0){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_749.f_0)){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455.f_0, Local_749.f_0, "NIGEL1DGOLF", 786468, 0, 8, -1, -1082130432, 0, 1073741824);
}}elseif(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_749.f_0)){
iLocal_363=0;
}}}}}}
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[iVar0 /*6*/], Local_561[iVar0 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[iVar0 /*13*/], 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
iVar0++;
}
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[0 /*6*/], Local_561[0 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[0 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[1 /*6*/], Local_561[1 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[1 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[2 /*6*/], Local_561[2 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[2 /*13*/], 28422), 0f, 0f, 0.05f, 0f, -10f, -90f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_788[3 /*6*/], Local_561[3 /*13*/], PED::GET_PED_BONE_INDEX(Local_561[3 /*13*/], 28422), -0.01f, 0f, 0f, 10f, 0f, -90f, 0, 0, 0, 0, 2, 1, 0);
iVar0=0;
while (iVar0 <=1){
if(func_6(Local_561[iVar0 /*13*/])){
TASK::TASK_PLAY_ANIM(Local_561[iVar0 /*13*/], "rcmnigel1d", Local_561[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
}
iVar0++;
}
iVar0=2;
while (iVar0 <=3){
if(func_6(Local_561[iVar0 /*13*/])){
TASK::TASK_PLAY_ANIM(Local_561[iVar0 /*13*/], "mini@golf", Local_561[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
}
iVar0++;
}
iLocal_347=1;
...
case 0:
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_561[iParam0 /*13*/], 1), 50f, 0)){
func_270(iParam0);
if(!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_306(Local_561[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
}
func_536("AS_PLAYGOLF, bullet in area of ambient golfer (no vehicle);
alerted...");
func_318();
iLocal_671[iParam0]=1;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_561[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0)){
...
func_270(iParam0);
func_536("AS_PLAYGOLF, player threatened ambient golfer;
attacking...");
func_318();
iLocal_671[iParam0]=1;
}
...
Local_399={
ENTITY::GET_ENTITY_COORDS(Local_561[iParam0 /*13*/], 1) 
};
...
iLocal_671[iParam0]=1;
}}elseif(func_277(Local_561[iParam0 /*13*/], 1126825984)){
if(!func_317()){
if(!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_306(Local_561[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
}
func_270(iParam0);
func_536("AS_PLAYGOLF, player armed and ambient golfer has LOS;
attacking...");
func_318();
iLocal_671[iParam0]=1;
}}}}elseif(ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) >=10f){
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_561[iParam0 /*13*/], 11f, 11f, 11f, 0, 1, 0) && PED::HAS_PED_RECEIVED_EVENT(Local_561[iParam0 /*13*/], 61)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_561[iParam0 /*13*/])){
if(!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_306(Local_561[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
}
...
func_374();
iLocal_671[iParam0]=1;
}}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_561[iParam0 /*13*/], 1), 50f, 1)){
func_299(Local_561[iParam0 /*13*/], 1);
func_375(iParam0);
if(!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_306(Local_561[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
}
func_536("AS_PLAYGOLF, bullet in area of ambient golfer (in vehicle);
attacking...");
func_318();
iLocal_671[iParam0]=1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_561[iParam0 /*13*/]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_561[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1)){
...
func_536("AS_ALERTED, player threatened ambient golfer and was armed;
attacking...");
func_318();
func_270(iParam0);
iLocal_671[iParam0]=3;
...
break;
case 3:
if(!func_314(Local_561[iParam0 /*13*/], joaat("script_task_smart_flee_ped"))){
func_270(iParam0);
}
...
if(ENTITY::IS_ENTITY_AT_COORD(Local_561[iVar0 /*13*/], Local_399, 20f, 20f, 20f, 0, 1, 0)){
PED::SET_PED_CAN_BE_TARGETTED(Local_561[iVar0 /*13*/], 1);
...
case 2:
HUD::CLEAR_PRINTS();
if(func_517(Local_455.f_0) && !bLocal_366){
func_35(4);
}else{
iLocal_361=0;
func_35(6);
...
break;
case 1:
if(!CAM::DOES_CAM_EXIST(uLocal_343)){
uLocal_343=func_386();
}
if(!CAM::DOES_CAM_EXIST(uLocal_341)){
uLocal_341=CAM::CREATE_CAMERA_WITH_PARAMS(180543640, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 50f, 0, 2);
CAM::SET_CAM_SPLINE_DURATION(uLocal_341, 4500);
CAM::ADD_CAM_SPLINE_NODE_USING_CAMERA_FRAME(uLocal_341, uLocal_343, 1500, 3);
CAM::ADD_CAM_SPLINE_NODE(uLocal_341, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_341, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 1500, 3, 2);
}
...
break;
case 2:
if(!CAM::IS_CAM_ACTIVE(uLocal_343)){
if(!CAM::IS_CAM_ACTIVE(uLocal_341)){
CAM::SET_CAM_ACTIVE(uLocal_343, 1);
CAM::RENDER_SCRIPT_CAMS(1, 1, 3000, 1, 0, 0);
}}elseif(!CAM::IS_CAM_ACTIVE(uLocal_341)){
...
uLocal_342=CAM::CREATE_CAMERA_WITH_PARAMS(180543640, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 50f, 0, 2);
CAM::SET_CAM_SPLINE_DURATION(uLocal_342, 4500);
CAM::ADD_CAM_SPLINE_NODE_USING_CAMERA_FRAME(uLocal_342, uLocal_341, 1500, 3);
CAM::ADD_CAM_SPLINE_NODE(uLocal_342, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_342, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 1500, 3, 2);
}
...
if(CAM::IS_CAM_ACTIVE(uLocal_343)){
CAM::SET_CAM_ACTIVE(uLocal_343, 0);
}
if(CAM::IS_CAM_ACTIVE(uLocal_341)){
...
iVar0=0;
while (iVar0 <=3){
if(func_517(Local_402[iVar0 /*13*/])){
func_389(iVar0);
}
iVar0++;
}}
...
}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_402[iParam0 /*13*/], 1), 30f, 1)){
if(!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203)==0){
if(!func_14()){
if(iParam0==0){
func_296(&uLocal_174, 7, Local_402[iParam0 /*13*/], "CONCIERGE", 0, 1);
...
HUD::SET_BLIP_FLASHES(iLocal_339, 1);
}}elseif(!HUD::DOES_BLIP_EXIST(iLocal_339)){
func_536("Recreated mission blip");
iLocal_339=func_271(Local_455.f_0, 1, 0, 5);
}else{
HUD::SET_BLIP_FLASHES(iLocal_339, 0);
}}}

int func_392(int iParam0){
if(func_264(&uLocal_883, ENTITY::GET_ENTITY_COORDS(iParam0, 0))){
return 1;
}
return 0;
}
...
func_257();
func_384();
if(func_517(Local_455.f_0) && func_517(PLAYER::PLAYER_PED_ID())){
...
iVar1=func_469(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
if(iVar1 !=-1 && iVar1 !=94){
...
iVar10=func_466(&(Global_100681.f_3));
if(iVar10 > -1){
...
iVar9=0;
while (iVar9 < iVar10){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_422(Var11.f_1)) && iVar72 < 51){
...
if(func_454()){
*uParam0=func_435(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_42()==0){
return MISC::IS_BIT_SET(func_103(func_433(iParam0), -1, 0), iParam1);
}}else{
...
iVar0=0;
while (iVar0 <=59){
if(iParam3==6 || iParam3==func_453(iVar0)){
if(!bParam5 || func_452(iVar0)){
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_436(iVar0, 0), 1);
...
Vector3 func__436(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_441(2, 2);
}elseif(func_440(Global_1853747)){
...
Vector3 func__441(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_443(Var18, -Var0.f_3.f_2) 
};
Var18={
func_443(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__443(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
var func__455(){
var uVar0;
func_465(&uVar0, CLOCK::GET_CLOCK_SECONDS());
func_464(&uVar0, CLOCK::GET_CLOCK_MINUTES());
func_463(&uVar0, CLOCK::GET_CLOCK_HOURS());
func_458(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
func_457(&uVar0, CLOCK::GET_CLOCK_MONTH());
func_456(&uVar0, CLOCK::GET_CLOCK_YEAR());
return uVar0;
}
...
var func__460(int iParam0){
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_461(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
if(!HUD::DOES_BLIP_EXIST(uLocal_340)){
iLocal_340=func_474(-1377.18f, 55.39f, 53.7f, 0);
HUD::SET_BLIP_SPRITE(iLocal_340, 109);
}
iLocal_690=0;
}}

int func_474(struct<3> Param0, int iParam3){
int iVar0;
iVar0=HUD::ADD_BLIP_FOR_COORD(Param0);
HUD::SET_BLIP_SCALE(iVar0, func_475(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
PED::SET_PED_PROP_INDEX(Local_455.f_0, 0, 0, 0, false, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_455.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_455.f_0, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_455.f_0, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_455.f_0, 1, 1);
func_487(Local_455.f_0, 0);
func_309(&Local_468, 0);
func_378(&Local_825, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_825.f_0, Local_468.f_0, PED::GET_PED_BONE_INDEX(Local_468.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
TASK::TASK_PLAY_ANIM(Local_468.f_0, "rcmnigel1d", "idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_468.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_468.f_0, 0);
if(func_517(Local_455.f_0)){
Local_782.f_3={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(Local_455.f_0, 1), 1067030938, 1069547520) 
};
}
...
if(func_5(Local_749.f_0)){
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_749.f_0, "NIGEL_1D_GOLF_CART_A", 0);
}}
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_749.f_0, 1, 1, 0);
...
func_3(&Local_749);
func_483(&(Local_782.f_1));
func_483(&iLocal_777);
func_483(&Local_825);
iVar0=0;
while (iVar0 <=5){
func_483(&(Local_788[iVar0 /*6*/]));
iVar0++;
}
...
if(((!func_501(0) || Global_78828) || Global_78817==1) || !CAM::IS_SCREEN_FADED_IN()){
return 0;
}
switch (Global_78813){
case 0:
...
break;
case 5:
if((CUTSCENE::IS_CUTSCENE_PLAYING() || func_354(0)) || func_500(1)){
}else{
return 1;
}
break;
...
void func_508(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
int func_515(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_517(uParam0)){
...
uLocal_778=PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
PED::SET_PED_NON_CREATION_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
uLocal_779=PED::ADD_SCENARIO_BLOCKING_AREA(-1379.33f, 45.13f, 50.68f, -1368.01f, 69.83f, 55.9f, 0, 1, 1, 1);
if(iLocal_780==-1){
...
func_522(&uLocal_831);
func_521(&uLocal_831, -1313.714f, -27.2202f, 48.0314f);
func_521(&uLocal_831, -1294.066f, -27.0136f, 47.5724f);
func_521(&uLocal_831, -1069.844f, -143.769f, 39.7493f);
func_521(&uLocal_831, -925.2529f, -89.9079f, 38.3457f);
func_521(&uLocal_831, -1010.948f, 40.0643f, 49.9277f);
func_521(&uLocal_831, -1122.838f, 233.7037f, 64.7587f);
func_521(&uLocal_831, -1282.578f, 188.8798f, 59.2769f);
func_521(&uLocal_831, -1328.153f, 192.0178f, 57.8136f);
...
func_522(&uLocal_935);
func_521(&uLocal_935, -1100.2f, 77.1233f, 53.2703f);
func_521(&uLocal_935, -1040.69f, 97.3963f, 51.9067f);
func_521(&uLocal_935, -977.9333f, -5.5166f, 45.6548f);
func_521(&uLocal_935, -1039.687f, -35.872f, 45.4867f);
func_521(&uLocal_935, -1062.19f, -2.8635f, 49.6013f);
func_520(&uLocal_935);
iLocal_173=1;
}
...
Local_755[0 /*6*/].f_1={
-1100.818f, -103.591f, 40.874f 
};
Local_755[0 /*6*/].f_4=99f;
Local_755[0 /*6*/].f_5=joaat("caddy");
Local_755[1 /*6*/].f_1={
-1114.088f, -97.6378f, 41.0175f 
};
...
break;
case 1:
if((!func_543(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8)){
return 0;
}
iLocal_91=2;
break;
...
struct<3> Var9;
Var0={
-1212.164f, 634.8231f, 100.5055f 
};
Var3={
-1010.083f, 830.9487f, 250.4705f 
};
Var6={
Var0 
};
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_779, 0);
if(iLocal_780 > -1){
...
if(bParam0){
func_191(iVar0, 1, 0);
func_557(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
}else{
...
iVar33=func_466(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar33 > -1){
