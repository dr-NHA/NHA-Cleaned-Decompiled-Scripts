...
bLocal_317=true;
}elseif(SYSTEM::VDIST2(Local_96, 769.3f, -151.66f, 73.79f) < 16f){
bLocal_317=2;
}elseif(SYSTEM::VDIST2(Local_96, -1923.93f, 254.48f, 85.7f) < 16f){
bLocal_317=3;
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) !=0){
SCRIPT::TERMINATE_THIS_THREAD();
}elseif(func_225(PLAYER::PLAYER_PED_ID(), Local_96, 1) < 100f){
SCRIPT::TERMINATE_THIS_THREAD();
}}
if(bLocal_317 !=3){
...
SCRIPT::TERMINATE_THIS_THREAD();
}}elseif(func_185(Local_96, 8, 0, 0, 0)){
func_182(8);
}else{
SCRIPT::TERMINATE_THIS_THREAD();
}
iLocal_316=func_180();
uLocal_325=PED::ADD_SCENARIO_BLOCKING_AREA(Local_96 - Vector(20f, 20f, 20f), Local_96 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
while (true){
SYSTEM::WAIT(0);
func_179();
...
func_62(8);
func_26();
}elseif((MISC::GET_GAME_TIMER() - iLocal_129) > 10000){
func_62(8);
func_26();
}elseif((iLocal_329==0 && !func_25()) && func_2(&uLocal_134, "REBTHAU", sLocal_301, 4, 0, 0, 0)){
iLocal_329=1;
}}}
...
Var10={
func_37(iParam0, iParam1, iParam2, bParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9) 
};
iVar20=0;
func_36(&iVar20);
...
func_72(&uLocal_342);
func_71(&uLocal_132);
if(iLocal_130==0 && !HUD::DOES_BLIP_EXIST(uLocal_131)){
...
var func__67(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
iLocal_311=1;
}}}}elseif(((!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_93, iLocal_92, 35f, 35f, 35f, 0, 1, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_93, 0)) && !func_80()) && func_2(&uLocal_134, "REBTHAU", "REBTH_PLASTE", 4, 0, 0, 0)){
func_78(0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_92, 0);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_122, joaat("player"));
...
iLocal_89=4;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_93, iLocal_92, 20f, 20f, 20f, 0, 1, 0)){
if(func_77()){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_92, uLocal_95);
...
}}elseif(PED::IS_PED_IN_GROUP(iLocal_92)){
...
float fVar6;
Var0={
func_87(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_87(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
if(((iLocal_326==0 && HUD::DOES_BLIP_EXIST(uLocal_131)) && func_64(PLAYER::PLAYER_PED_ID())) && func_64(iLocal_91)){
if(func_63(PLAYER::PLAYER_PED_ID(), iLocal_91, 1) < 30f || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_91, 1), 10f, 1)){
iLocal_326=1;
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_131, iLocal_326);
}}
if(((bLocal_317==2 && func_64(iLocal_91)) && func_73(iLocal_93)) && PED::IS_PED_IN_VEHICLE(iLocal_91, iLocal_93, 0)){
if(iLocal_312==0){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE_USING_AI(iLocal_93, 1, "RE_BikeThief2", 30f, 786468);
iLocal_312=1;
Local_313={
VEHICLE::GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(VEHICLE::GET_VEHICLE_RECORDING_ID(1, "RE_BikeThief2"), VEHICLE::GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(1, "RE_BikeThief2")) 
};
}elseif(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_93) || func_225(iLocal_93, Local_313, 1) < 5f){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_93)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_93);
}
...
if(!func_64(iLocal_91)){
return 1;
}elseif(func_64(iLocal_93)){
if(iLocal_344==0){
if(PED::IS_PED_IN_VEHICLE(iLocal_91, iLocal_93, 0)){
iLocal_344=1;
}}elseif(!PED::IS_PED_IN_VEHICLE(iLocal_91, iLocal_93, 0)){
return 1;
}
...
iLocal_119=0;
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_91, 40f, 40f, 40f, 0, 1, 0)){
...
TASK::TASK_GO_STRAIGHT_TO_COORD(0, Local_105, 2f, 20000, 1193033728, 1056964608);
...
iLocal_327=1;
}}elseif(func_64(PLAYER::PLAYER_PED_ID())){
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_92, PLAYER::PLAYER_PED_ID(), Var1, 0, 1, 0)){
iVar0=0;
}else{
iVar0=1;
}}
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_123(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=1;
uParam0->f_7=1;
}}elseif(func_138(bParam1, bParam2, bParam3)){
uParam0->f_4=MISC::GET_GAME_TIMER();
uParam0->f_5=1;
uParam0->f_7=1;
...
uParam0->f_5=0;
}elseif(!func_139(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_136(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_137(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_95);
TASK::TASK_PERFORM_SEQUENCE(iLocal_91, uLocal_95);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
PED::SET_PED_KEEP_TASK(iLocal_91, 1);
}}
func_71(&uLocal_133);
...
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_92, 31086, 0f, 0f, 0f) 
};
Var3={
Var3 + PED::GET_PED_BONE_COORDS(iLocal_92, 31086, 0f, 0f, 0f) 
};
...
case 1:
Local_102={
433.57f, -1916.68f, 24.04f 
};
fLocal_112=248.5f;
Local_105={
439.054f, -1920.145f, 23.5581f 
};
Local_108={
434.31f, -1908.87f, 25.92f 
};
fLocal_113=-163.17f;
Local_99={
435.18f, -1915.18f, 24.68f 
};
fLocal_111=226.13f;
fLocal_115=10f;
fLocal_116=20f;
...
case 2:
Local_102={
774.06f, -155.63f, 73.44f 
};
fLocal_112=144.3932f;
Local_105={
769.8723f, -156.9548f, 73.5144f 
};
Local_108={
773.632f, -150.3134f, 74.6217f 
};
fLocal_113=151.6004f;
Local_99={
771.41f, -154.29f, 74.09f 
};
fLocal_111=150.54f;
fLocal_115=10f;
fLocal_116=20f;
...
case 3:
Local_102={
-1927.94f, 254.7125f, 84.4018f 
};
fLocal_112=285.0046f;
Local_105={
-1934.785f, 253.2105f, 83.8164f 
};
Local_108={
-1931.04f, 252.19f, 84.99f 
};
fLocal_113=42.33f;
Local_99={
-1932.27f, 254.5f, 84.4f 
};
fLocal_111=96.81f;
fLocal_115=10f;
fLocal_116=35f;
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_102 - Vector(20f, 20f, 20f), Local_102 + Vector(20f, 20f, 20f), 0, 1);
VEHICLE::REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(Local_102 - Vector(20f, 20f, 20f), Local_102 + Vector(20f, 20f, 20f), 0);
MISC::CLEAR_AREA(Local_102, 20f, 1, 0, 0, 0);
iLocal_118=1;
}
...
iLocal_93=VEHICLE::CREATE_VEHICLE(iLocal_90, Local_99, fLocal_111, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_INFLUENCES_WANTED_LEVEL(iLocal_93, 0);
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_123, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_122, joaat("player"));
iLocal_91=PED::CREATE_PED(19, joaat("g_m_y_strpunk_01"), Local_108, fLocal_113, 1, 1);
...
iLocal_92=PED::CREATE_PED(19, joaat("a_m_y_beachvesp_01"), Local_102, fLocal_112, 1, 1);
...
if(PED::IS_PED_INJURED(iLocal_92)){
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_92, PLAYER::PLAYER_PED_ID(), 1)){
func_164();
func_163(&uLocal_134, "REBTHAU", "REBTH_ATTACK", 4, 0, 0);
return 1;
}elseif(func_160(iLocal_92, 170f)){
func_164();
func_163(&uLocal_134, "REBTHAU", "REBTH_ATTACK", 4, 0, 0);
return 1;
}}
...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_86) < (75f * 75f)){
return 1;
}
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_173()){
return 0;
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_22(8, -1)) || func_215()) || func_214()) || func_213()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_217()) || Global_32166) || func_216()) || func_22(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_22(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_22(8, -1)) || func_215()) || func_214()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_217()) || Global_32166) || func_216()) || func_22(8, -1)) || func_214()) || func_213()) || func_212()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
...
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_217()) || Global_112695) || Global_32166) || func_216()) || func_22(8, -1)) || func_213()) || func_211()) || func_215()) || func_214()) || func_212()){
return 0;
}
break;
}}else{
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_102 - Vector(20f, 20f, 20f), Local_102 + Vector(20f, 20f, 20f), 1, 1);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_93, 0)){
