...
if((!bParam4 || func_112(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_43[0], 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_43[0], joaat("weapon_pistol"), 100, 0, 0);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_43[0], "S_M_M_GENERICSECURITY_01_LATINO_MINI_01");
}else{
iLocal_43[0]=PED::CREATE_PED(26, joaat("s_m_m_security_01"), 863.1551f, -1564.572f, 29.3231f, 130.7946f, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_43[0], iLocal_303);
func_122(iLocal_43[0], 40f, 1084227584, 1123024896, -1028390912, 1119092736);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_43[0], 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_43[0], joaat("weapon_pistol"), 100, 0, 0);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_43[1], 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_43[1], joaat("weapon_pistol"), 100, 0, 0);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_43[1], "S_M_M_GENERICSECURITY_01_LATINO_MINI_02");
}else{
iLocal_43[1]=PED::CREATE_PED(26, joaat("s_m_m_security_01"), 940.2881f, -1573.877f, 29.3866f, 269.1856f, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_43[1], iLocal_303);
func_122(iLocal_43[1], 40f, 1084227584, 1123024896, -1028390912, 1119092736);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_43[1], 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_43[1], joaat("weapon_pistol"), 100, 0, 0);
...
uLocal_59=func_133(Local_116, 1);
}}}
if(func_135()){
iLocal_62=4;
}}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_116, 4f, 4f, 2f, 1, 1, 2)){
...
var func__133(struct<3> Param0, int iParam3){
var uVar0;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_32, 0)){
if(!HUD::DOES_BLIP_EXIST(uLocal_61)){
uLocal_61=func_153(iLocal_32, 0, 0);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_61, 1);
if(HUD::IS_MESSAGE_BEING_DISPLAYED()){
HUD::CLEAR_PRINTS();
}
if(iLocal_395==0){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_33, 0)){
if(!HUD::DOES_BLIP_EXIST(uLocal_58)){
uLocal_58=func_153(iLocal_33, 0, 0);
...
if(!HUD::DOES_BLIP_EXIST(uLocal_58)){
uLocal_58=func_153(iLocal_33, 0, 0);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_58, true);
}}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_119, Local_132, 1) < 100f){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(iLocal_316==1){
if(MISC::GET_GAME_TIMER() < iLocal_110 + 7500){
HUD::CLEAR_PRINTS();
...
if(!HUD::DOES_BLIP_EXIST(uLocal_61)){
uLocal_61=func_153(iLocal_32, 0, 0);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_61, true);
if(HUD::IS_MESSAGE_BEING_DISPLAYED()){
HUD::CLEAR_PRINTS();
}
if(iLocal_395==0){
...
if(iParam4==1){
if(func_178(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
void func_162(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
func_175(iParam5, &Var0, Param1, uParam4, func_63(iParam0));
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_170(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_175(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_73(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
iLocal_456=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_113 + 5000){
...
OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_114, joaat("prop_sec_barrier_ld_01a"), 61f, -633f, 32f, 1, 1, 0);
OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_115, joaat("prop_sec_barrier_ld_01a"), 66f, -618f, 32f, 1, 1, 0);
iLocal_457=1;
}
if(iLocal_457==1){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
...
}}elseif(MISC::GET_GAME_TIMER() > iLocal_108 + 8000){
if(func_192() && func_191()){
if(func_188(&uLocal_137, "SOL1AUD", "SOL1_SEE6", 7, 0, 0, 0)){
iLocal_108=MISC::GET_GAME_TIMER();
}
...
}}elseif(MISC::GET_GAME_TIMER() > iLocal_105[0] + 2000){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_43[0], 1), 863.1551f, -1564.572f, 29.3231f, 1) > 3f){
if(iLocal_459[0]==0){
...
}}elseif(MISC::GET_GAME_TIMER() > iLocal_105[1] + 2000){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_43[1], 1), 940.2881f, -1573.877f, 29.3866f, 1) > 3f){
if(iLocal_459[1]==0){
...
elseif(MISC::GET_GAME_TIMER() > iLocal_82 + 15000){
...
iLocal_410=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_88 + 15000){
...
iLocal_411=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_89 + 15000){
func_197(iLocal_43[0], "PROVOKE_GENERIC", "S_M_M_GENERICSECURITY_01_LATINO_MINI_01", 9);
iLocal_89=MISC::GET_GAME_TIMER();
}
}
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_43[0], 50, 1);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_43[0], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3f, -1, 1048576000, 0, 1193033728);
func_199(iLocal_43[0]);
iLocal_448[0]=1;
}
if(iLocal_445[0]==1){
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_43[1], 50, 1);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_43[1], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3f, -1, 1048576000, 0, 1193033728);
func_199(iLocal_43[1]);
iLocal_448[1]=1;
}
if(iLocal_445[1]==1){
...
elseif(MISC::GET_GAME_TIMER() > iLocal_87 + 7000){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 1) < 20f){
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_43[0])){
...
iLocal_402=1;
}}}elseif(MISC::GET_GAME_TIMER() > iLocal_86 + 7000){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 1) < 20f){
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_43[0])){
...
}elseif(MISC::GET_GAME_TIMER() > iLocal_96[0] + 500){
if(iLocal_439[0]==0){
if(ENTITY::IS_ENTITY_ON_SCREEN(iLocal_43[0])){
TASK::CLEAR_PED_TASKS(iLocal_43[0]);
}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_43[0], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f, -1, 1048576000, 0, 1193033728);
func_199(iLocal_43[0]);
iLocal_439[0]=1;
}}}elseif(iLocal_484[0]==0){
if(ENTITY::IS_ENTITY_ON_SCREEN(iLocal_43[0])){
TASK::CLEAR_PED_TASKS(iLocal_43[0]);
}else{
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_43[0]);
...
elseif(MISC::GET_GAME_TIMER() > iLocal_83 + 7000){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 1) < 10f){
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_43[0])){
...
}}}elseif(MISC::GET_GAME_TIMER() > iLocal_84 + 7000){
...
}elseif(MISC::GET_GAME_TIMER() > iLocal_96[1] + 500){
if(iLocal_439[1]==0){
if(ENTITY::IS_ENTITY_ON_SCREEN(iLocal_43[1])){
TASK::CLEAR_PED_TASKS(iLocal_43[1]);
}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_43[1], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f, -1, 1048576000, 0, 1193033728);
func_199(iLocal_43[1]);
iLocal_439[1]=1;
}}}elseif(iLocal_484[1]==0){
if(ENTITY::IS_ENTITY_ON_SCREEN(iLocal_43[1])){
TASK::CLEAR_PED_TASKS(iLocal_43[1]);
}else{
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_43[1]);
...
}}}elseif(MISC::GET_GAME_TIMER() > iLocal_85 + 7000){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[1], 1) < 10f){
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_43[1])){
...
if(!PED::IS_PED_INJURED(iLocal_43[0])){
Local_125[0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(iLocal_43[0], 1) 
};
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_43[1])){
if(!PED::IS_PED_INJURED(iLocal_43[1])){
Local_125[1 /*3*/]={
ENTITY::GET_ENTITY_COORDS(iLocal_43[1], 1) 
};
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_43[0])){
if(!PED::IS_PED_INJURED(iLocal_43[0])){
...
elseif(Local_119.f_0 < Local_125[0 /*3*/]){
iLocal_31=0;
iLocal_459[0]=0;
iLocal_462[0]=0;
iLocal_459[1]=0;
...
iLocal_105[0]=MISC::GET_GAME_TIMER();
iLocal_105[1]=MISC::GET_GAME_TIMER();
}}elseif(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[1], 1) < 15f){
if((Local_119.f_0 > Local_125[1 /*3*/] && !PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_43[1], 90f)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 936.7849f, -1569.337f, 31.49661f, 936.3553f, -1581.973f, 27.77812f, 8.25f, 0, 1, 0)){
iLocal_31=0;
iLocal_459[0]=0;
iLocal_462[0]=0;
iLocal_459[1]=0;
...
iLocal_105[0]=MISC::GET_GAME_TIMER();
iLocal_105[1]=MISC::GET_GAME_TIMER();
}}elseif(Local_119.f_0 > Local_125[1 /*3*/]){
iLocal_31=0;
iLocal_459[0]=0;
iLocal_462[0]=0;
iLocal_459[1]=0;
...
iLocal_105[0]=MISC::GET_GAME_TIMER();
iLocal_105[1]=MISC::GET_GAME_TIMER();
}}elseif(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 1) < func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[1], 1)){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 1) < 15f){
if((Local_119.f_0 < Local_125[0 /*3*/] && !PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 90f)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 868.5617f, -1579.476f, 33.30448f, 866.5635f, -1560.984f, 28.90482f, 8.25f, 0, 1, 0)){
iLocal_31=0;
iLocal_459[0]=0;
iLocal_462[0]=0;
iLocal_459[1]=0;
...
if(iLocal_31==2){
if(iLocal_398==0){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 936.7849f, -1569.337f, 31.49661f, 936.3553f, -1581.973f, 27.77812f, 8.25f, 0, 1, 0) || Local_119.f_0 > 942f){
if(!PED::IS_PED_INJURED(iLocal_43[1])){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 868.5617f, -1579.476f, 33.30448f, 866.5635f, -1560.984f, 28.90482f, 8.25f, 0, 1, 0) || Local_119.f_0 < 860f){
if(!PED::IS_PED_INJURED(iLocal_43[0])){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_119, Local_132, 1) < 36f){
if(iLocal_404[0]==1){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_43[0], PLAYER::PLAYER_PED_ID())){
iLocal_31=2;
}
...
if(iLocal_404[1]==1){
if(Local_119.f_2 < 36f || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_43[1], PLAYER::PLAYER_PED_ID())){
iLocal_31=2;
}
...
if(iLocal_404[0]==1){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[0], 1) < 20f){
if(Local_119.f_0 > Local_125[0 /*3*/] && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 868.5617f, -1579.476f, 33.30448f, 866.5635f, -1560.984f, 28.90482f, 8.25f, 0, 1, 0)){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_43[0], PLAYER::PLAYER_PED_ID()) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_43[0])){
iLocal_31=2;
}}}}
if(iLocal_404[1]==1){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_43[1], 1) < 20f){
if(Local_119.f_0 < Local_125[1 /*3*/] && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 936.7849f, -1569.337f, 31.49661f, 936.3553f, -1581.973f, 27.77812f, 8.25f, 0, 1, 0)){
...
iLocal_413=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_90 + 3000){
if(func_189(PLAYER::PLAYER_PED_ID(), iLocal_35[iLocal_63], 1) < 20f && PED::CAN_PED_SEE_HATED_PED(iLocal_35[iLocal_63], PLAYER::PLAYER_PED_ID())){
if(iLocal_29 !=3 && iLocal_29 !=4){
func_207(3);
if(iLocal_416==1){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 926.455f, -1582.384f, 29.32759f, 909.6322f, -1581.374f, 31.58907f, 9.5f, 0, 1, 0) || Local_119.f_1 > -1573f){
if(iLocal_416==0){
...
}}elseif(iParam0==iLocal_35[iLocal_65]){
if(func_189(PLAYER::PLAYER_PED_ID(), iParam0, 1) < 20f){
if(iLocal_347[iLocal_65]==0){
if(PED::CAN_PED_SEE_HATED_PED(iParam0, PLAYER::PLAYER_PED_ID()) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iParam0)){
if(!ENTITY::IS_ENTITY_ON_SCREEN(iParam0)){
...
elseif(MISC::GET_GAME_TIMER() > iLocal_91 + 300){
iLocal_371[iLocal_65]=0;
}}elseif(iLocal_371[iLocal_65]==0){
if(!ENTITY::IS_ENTITY_ON_SCREEN(iLocal_35[iLocal_65])){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_35[iLocal_65]);
}
if(ENTITY::IS_ENTITY_ON_SCREEN(iLocal_35[iLocal_65])){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_473=1;
}elseif(PED::IS_PED_IN_ANY_VEHICLE(iLocal_46, 0)){
...
if(iLocal_470==1){
if((func_211(iLocal_46) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_46, 1)) && iLocal_473==0){
Local_122={
ENTITY::GET_ENTITY_COORDS(iLocal_46, 1) 
};
...
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_46, PED::GET_VEHICLE_PED_IS_IN(iLocal_46, 0), Local_116, 4, 30f, 786468, 3f, 15f, 0);
iLocal_479=0;
iLocal_476=1;
}}
}
elseif(ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_CLOSEST_VEHICLE(Local_122, 200f, joaat("police3"), 32768))){
if(iLocal_479==0){
TASK::TASK_VEHICLE_MISSION(iLocal_46, PED::GET_VEHICLE_PED_IS_IN(iLocal_46, 0), VEHICLE::GET_CLOSEST_VEHICLE(Local_122, 200f, joaat("police3"), 32768), 8, 40f, 262144, 300f, 1f, 1);
iLocal_476=0;
iLocal_479=1;
}
}
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_475=1;
}elseif(PED::IS_PED_IN_ANY_VEHICLE(iLocal_48, 0)){
...
if(iLocal_471==1){
if((func_211(iLocal_48) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_48, 1)) && iLocal_475==0){
Local_122={
ENTITY::GET_ENTITY_COORDS(iLocal_48, 1) 
};
PATHFIND::REQUEST_PATH_NODES_IN_AREA_THIS_FRAME(Local_122.f_0, Local_122.f_1, Local_116.f_0, Local_116.f_1);
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(iLocal_477==0){
if(PATHFIND::ARE_NODES_LOADED_FOR_AREA(Local_122.f_0, Local_122.f_1, Local_116.f_0, Local_116.f_1)){
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_48, PED::GET_VEHICLE_PED_IS_IN(iLocal_48, 0), Local_116, 4, 30f, 786468, 3f, 15f, 0);
iLocal_480=0;
iLocal_477=1;
}}
}
elseif(ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_CLOSEST_VEHICLE(Local_122, 200f, joaat("police3"), 32768))){
if(iLocal_480==0){
TASK::TASK_VEHICLE_MISSION(iLocal_48, PED::GET_VEHICLE_PED_IS_IN(iLocal_48, 0), VEHICLE::GET_CLOSEST_VEHICLE(Local_122, 200f, joaat("police3"), 32768), 8, 40f, 262144, 300f, 1f, 1);
iLocal_477=0;
iLocal_480=1;
}
}
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_474=1;
}elseif(PED::IS_PED_IN_ANY_VEHICLE(iLocal_47, 0)){
...
if(iLocal_472==1){
if((func_211(iLocal_47) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_47, 1)) && iLocal_474==0){
Local_122={
ENTITY::GET_ENTITY_COORDS(iLocal_47, 1) 
};
PATHFIND::REQUEST_PATH_NODES_IN_AREA_THIS_FRAME(Local_122.f_0, Local_122.f_1, Local_116.f_0, Local_116.f_1);
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(iLocal_478==0){
if(PATHFIND::ARE_NODES_LOADED_FOR_AREA(Local_122.f_0, Local_122.f_1, Local_116.f_0, Local_116.f_1)){
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_47, PED::GET_VEHICLE_PED_IS_IN(iLocal_47, 0), Local_116, 4, 30f, 786468, 3f, 15f, 0);
iLocal_481=0;
iLocal_478=1;
}}
}
elseif(ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_CLOSEST_VEHICLE(Local_122, 200f, joaat("police3"), 32768))){
if(iLocal_481==0){
TASK::TASK_VEHICLE_MISSION(iLocal_47, PED::GET_VEHICLE_PED_IS_IN(iLocal_47, 0), VEHICLE::GET_CLOSEST_VEHICLE(Local_122, 200f, joaat("police3"), 32768), 8, 40f, 262144, 300f, 1f, 1);
iLocal_478=0;
iLocal_481=1;
}
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_33)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_33, 0)){
if((PED::IS_PED_IN_VEHICLE(iParam0, iLocal_33, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_33, -1, 0)==iParam0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_33, Local_116, 3f, 3f, 3f, 0, 1, 0)){
