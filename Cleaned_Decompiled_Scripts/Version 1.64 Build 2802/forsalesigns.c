...
bool bVar0;
if(iLocal_42){
if(func_50(uLocal_44)){
if((((!func_49() && !PED::IS_PED_FLEEING(uLocal_44)) && !PED::IS_PED_RAGDOLL(uLocal_44)) && !PED::IS_PED_PRONE(uLocal_44)) && !PED::IS_PED_INJURED(uLocal_44)){
if(func_48(uLocal_44, PLAYER::PLAYER_PED_ID(), 1) <=3f){
if((MISC::GET_GAME_TIMER() - iLocal_43) > 8000){
if(func_25(&uLocal_45, "JOSH1AU", "JOSH1_AMB2", 7, 0, 0, 0)){
iLocal_43=MISC::GET_GAME_TIMER();
}}}}
if(func_48(uLocal_44, PLAYER::PLAYER_PED_ID(), 1) > 150f){
func_24(&uLocal_44);
}}else{
...
}}elseif(!MISC::IS_BIT_SET(Global_113648.f_10051.f_108, bVar0)){
...
if(!MISC::IS_BIT_SET(Global_113648.f_10051.f_108, func_3(func_4(iParam0), iVar0))){
return 0;
}
iVar0++;
}}
...
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_108, func_3(func_4(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
...
uLocal_41=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_41)){
...
break;
case 1:
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_41, "SHOW_SHARD_MIDSIZED_MESSAGE");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_41, "SHARD_ANIM_OUT");
...
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_41)){
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_41, 100, 100, 100, 255, 0);
}}
break;
case 3:
...
case 4:
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_41)){
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_41);
}
bLocal_376=false;
bLocal_39=false;
iLocal_40=0;
...
bool func_13(var uParam0, struct<3> Param1, float fParam4, int iParam5){
...
struct<3> Var0;
Var0={
ENTITY::GET_ENTITY_ROTATION(uParam0, 0) 
};
...
float func_48(var uParam0, var uParam1, int iParam2){
struct<3> Var0;
struct<3> Var3;
if(!ENTITY::IS_ENTITY_DEAD(uParam0, 0)){
Var0={
...
if(!func_2(2)){
Local_210[0 /*11*/].f_3={
-1569.525f, 444.04f, 108.135f 
};
Local_210[0 /*11*/].f_9=80f;
Local_210[1 /*11*/].f_3={
-1352.88f, 613.77f, 134.34f 
};
...
Local_210[3 /*11*/].f_3={
-1632.833f, -413.8573f, 39.9441f 
};
Local_210[3 /*11*/].f_9=321.5f;
Local_210[4 /*11*/].f_3={
-1765.678f, -423.9763f, 41.5f 
};
Local_210[4 /*11*/].f_9=256.25f;
Local_210[5 /*11*/].f_3={
-380.75f, 427.79f, 110.97f 
};
Local_210[5 /*11*/].f_9=286.5f;
Local_210[6 /*11*/].f_3={
-163.2826f, 989.2324f, 234.0641f 
};
Local_210[6 /*11*/].f_9=0f;
Local_210[7 /*11*/].f_3={
-493.083f, 588.6333f, 122.485f 
};
Local_210[7 /*11*/].f_9=177.2061f;
Local_210[8 /*11*/].f_3={
-818.84f, 434.74f, 88.15f 
};
Local_210[8 /*11*/].f_9=91.5f;
Local_210[9 /*11*/].f_3={
-913.24f, 785.4f, 184.66f 
};
Local_210[9 /*11*/].f_9=96.26f;
Local_210[10 /*11*/].f_3={
-825.92f, -26.67f, 38.68f 
};
Local_210[10 /*11*/].f_9=15f;
Local_210[11 /*11*/].f_3={
-1103.5f, 587.29f, 103.25f 
};
Local_210[11 /*11*/].f_9=305.5f;
Local_210[12 /*11*/].f_3={
-1253.439f, 491.05f, 94.3706f 
};
Local_210[12 /*11*/].f_9=0f;
Local_210[13 /*11*/].f_3={
160.29f, 486.71f, 142.96f 
};
Local_210[13 /*11*/].f_9=95f;
Local_210[14 /*11*/].f_3={
-1163.859f, 319.19f, 67.96f 
};
...
uLocal_44=uVar2[iVar1];
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(uLocal_44)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_44, 1, 0);
}
PED::SET_PED_MONEY(uLocal_44, 0);
PED::SET_PED_CAN_BE_TARGETTED(uLocal_44, 0);
PED::SET_PED_NAME_DEBUG(uLocal_44, "POSTJOSH");
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_44, joaat("player"));
func_53(&uLocal_45, 5, uLocal_44, "JOSH", 1, 1);
return 1;
}}
iVar1++;
}
