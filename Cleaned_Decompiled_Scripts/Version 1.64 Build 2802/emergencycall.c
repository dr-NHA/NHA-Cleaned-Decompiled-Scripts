...
iLocal_43=5;
}}elseif(MISC::CREATE_INCIDENT(7, Local_45, 2, 3f, &uLocal_49, 0, 0)){
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}
break;
...
elseif(MISC::CREATE_INCIDENT_WITH_ENTITY(5, PLAYER::PLAYER_PED_ID(), 2, 3f, &uLocal_49, 0, 0)){
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}}elseif(MISC::CREATE_INCIDENT(5, Local_45, 2, 3f, &uLocal_49, 0, 0)){
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}
break;
...
iLocal_48=MISC::GET_GAME_TIMER();
iLocal_43=5;
}}elseif(MISC::CREATE_INCIDENT(3, Local_45, 4, 3f, &uLocal_49, 0, 0)){
...
if(SYSTEM::VDIST(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(*uParam1, *uParam2, fVar17, 0f, 0f), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > SYSTEM::VDIST(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(*uParam1, *uParam2, -fVar17, 0f, 0f), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
fVar17=-fVar17;
}
*uParam1={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(*uParam1, *uParam2, fVar17, 0f, 0f) 
};
