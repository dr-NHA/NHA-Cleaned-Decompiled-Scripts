...
func_53(uParam0);
if(func_52(uParam0)){
if(((func_51(uParam0) && !func_50(uParam0)) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1)) && !func_49()){
func_48(uParam0, 1, 0);
func_47(uParam0);
}elseif(func_9(&(uParam0->f_6), 6) && func_50(uParam0)){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1) && !func_49()){
func_48(uParam0, 0, 0);
...
var uVar0;
if(((((((!func_9(&(uParam0->f_6), 0) && !func_9(&(uParam0->f_6), 2)) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_33(uParam0)) && !func_32(0)) && !func_31()) && func_29()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, -1, 0))){
func_25(uParam0, 1);
...
bool func_29(){
return (!MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 4) && !func_30());
}
...
var uVar0;
if(((((((!func_9(&(uParam0->f_6), 0) && !func_9(&(uParam0->f_6), 1)) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_9(&(uParam0->f_6), 3)) && !func_32(0)) && !func_31()) && func_29()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, -1, 0))){
uVar0=func_23(uParam0->f_6.f_2, 3333, 10000);
uParam0->f_6.f_2=0;
if(func_52(uParam0)){
...
case joaat("akula"):
case joaat("annihilator2"):
VEHICLE::SET_DEPLOY_FOLDING_WINGS(uParam0->f_1, !bParam1, iParam2);
break;
}}


bool func_49(){
return MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 3);
}
...
return ((func_38(uParam0) && uParam0->f_3==PLAYER::PLAYER_PED_ID()) || VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, -1, 0)==PLAYER::PLAYER_PED_ID());
}
...
bool func_56(){
return MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 2);
}
...
if(func_38(uParam0)){
uParam0->f_4=func_77(PLAYER::PLAYER_PED_ID(), 0);
}
if(func_52(uParam0)){
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_3) && func_69(NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(uParam0->f_3))){
func_24(uParam0, 0);
}else{
func_5(uParam0, 0);
}}
...
return (iParam0 !=-1 && MISC::IS_BIT_SET(Global_1853910[iParam0 /*862*/].f_837, 1));
}
...
var func__75(){
return MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_837, 1);
}
