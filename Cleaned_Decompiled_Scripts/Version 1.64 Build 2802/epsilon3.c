...
iLocal_325++;
}}elseif(func_2(&uLocal_148, "EPS3AUD", "EP3_FOLLOW", 8, 0, 0, 0)){
iLocal_322=MISC::GET_GAME_TIMER();
iLocal_325++;
}}}elseif((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_240()) && (MISC::GET_GAME_TIMER() - iLocal_322) > iLocal_324){
...
elseif(func_2(&uLocal_148, "EPS3AUD", "EP3_AMB", 8, 0, 0, 0)){
iLocal_322=MISC::GET_GAME_TIMER();
iLocal_324=1000;
}}}}
if(func_239(Local_83.f_28[0])){
...
}}}elseif(PED::IS_PED_HEADTRACKING_PED(Local_83.f_28[0], PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(Local_83.f_28[0]);
}
if(func_241(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >=100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 1), 3f)){
iLocal_146=3;
}
if((((((GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 5f) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_grenadelauncher"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_rpg"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_grenade"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_molotov"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_flare"), 5f, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(Local_83.f_28[0], uLocal_318);
iLocal_313=3;
func_317(2);
}
...
uVar0=Global_2805027[iParam0 /*3*/][func_96(iParam1)];
...
func_182(&uVar32, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
MemCopy(&Var3,{
func_234(Global_44465[iVar7 /*12*/].f_1)
}
, 4);
}else{
Var3={
...
void func_230(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13){
int iVar0;
bool bVar1;
char cVar2[64];
...
if(bVar1){
func_231(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_232(iParam1)), 0));
}else{
func_231(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_232(iParam1)), 0));
}
switch (Global_20383){
case 0:
...
iVar2=iVar20;
Var3={
func_234(Global_44465[iVar20 /*12*/].f_1) 
};
...
Var3={
func_234(Global_44465[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(func_239(Local_83.f_28[0])){
TASK::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "base_loop", 1000f, -8f, -1, 262145, 0.01f, 0, 0, 0);
func_257(Local_83.f_28[0], 1843.82f, 4705.74f, 40.8f, 143.14f, 1, 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_83.f_28[0], 1, 0);
}}
if(!iLocal_315){
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
if(func_239(Local_83.f_28[0])){
TASK::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "base_loop", 1000f, -8f, -1, 262145, 0, 0, 0, 0);
func_257(Local_83.f_28[0], 1843.82f, 4705.74f, 40.8f, 143.14f, 1, 1);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MICHAEL", 0)){
if(func_239(PLAYER::PLAYER_PED_ID())){
...
void func_250(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_254(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
int func_257(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_239(iParam0)){
...
Vector3 func__268(struct<3> Param0){
float fVar0;
float fVar1;
...
if(!func_277(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_277(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_277(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
if(func_249(PLAYER::PLAYER_PED_ID())){
uLocal_320=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_249(Local_83.f_28[0])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_83.f_28[0], uLocal_320);
PED::SET_PED_CONFIG_FLAG(Local_83.f_28[0], 132, 1);
}
if(func_239(Local_83.f_28[0])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_83.f_28[0], 1);
PED::SET_PED_KEEP_TASK(Local_83.f_28[0], 1);
}
bLocal_314=false;
...
if(func_239(Local_83.f_28[0])){
if(func_291()){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_83.f_28[0], 0f, 0f, -0.5f, 1, 30000, 2000, 2000, 0);
}
else{
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_83.f_28[0], -0.75f, 0f, -0.5f, 1, 30000, 2000, 2000, 0);
}
...
TASK::TASK_PLAY_ANIM(Local_83.f_28[0], sLocal_144, "leadin", 8f, -8f, -1, 786434, 0, 0, 0, 0);
}}elseif(!func_240()){
SYSTEM::WAIT(500);
iLocal_146=3;
}
...
if(func_320(&(uParam0->f_28[0]), 60, Var3, uVar6, "EPSILON LAUNCHER RC - MARNIE", 1)){
...
int func_320(var uParam0, int iParam1, struct<3> Param2, var uParam5, char* sParam6, int iParam7){
if(func_321(uParam0, iParam1, Param2, uParam5, 1)){
...
int func_321(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_16(iParam1)){
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_319, 0);
if(func_344()){}
