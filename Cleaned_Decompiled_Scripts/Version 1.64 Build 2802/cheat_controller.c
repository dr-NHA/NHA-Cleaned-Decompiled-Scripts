...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_68, 1) 
};
...
Var0[1 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Param1, fParam4, -Var34.f_0, -Var34.f_1, -Var34.f_2) 
};
Var0[2 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Param1, fParam4, Var34.f_0, -Var34.f_1, -Var34.f_2) 
};
...
uVar50=SHAPETEST::START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(func_19(PLAYER::PLAYER_ID()) + Vector(1f, 0f, 0f), Param1, 87, PLAYER::PLAYER_PED_ID(), 0);
...
if(MISC::IS_BIT_SET(Global_32412, bParam0)){
return 1;
}
return 0;
}
...
if(bParam1){
MISC::SET_BIT(&Global_32413, bParam0);
func_5(bParam0);
}else{
MISC::CLEAR_BIT(&Global_32413, bParam0);
}}
...
fVar4=(fVar4 + 500f);
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Var0.f_0, Var0.f_1, fVar4, 1, 0, 0, 1);
...
if(MISC::IS_BIT_SET(Global_32413, bParam0)){
return 1;
}
return 0;
}
...
if(MISC::IS_BIT_SET(Global_32415, bParam0)){
if(iParam1 !=0){
