...
if(func_65(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1)){
iVar1=0;
...
iVar1=1;
}}elseif(ENTITY::IS_ENTITY_A_VEHICLE(uParam1)){
...
iVar1=1;
}}elseif(ENTITY::IS_ENTITY_AN_OBJECT(uParam1)){
...
if(((VEHICLE::IS_TURRET_SEAT(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0)==joaat("apc") && iVar1 !=-1)) || (ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("akula") && iVar1 !=-1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("riot2") && iVar1==0) && func_49(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) !=-1)){
return 0;
}}}
if(Global_1962010){
return 0;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_48(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=0;
}elseif(!func_64(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_61(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_62(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
if(!ENTITY::IS_ENTITY_DEAD(uVar0, 0) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iVar0)){
fLocal_534[iParam0]=1f;
}else{
bVar1=false;
if(!PED::GET_PED_TYPE(uLocal_451[iParam0])==6){
func_70(uLocal_462[iParam0], PLAYER::PLAYER_PED_ID(), &(fLocal_534[iParam0]), 17.5f, 7.5f, 30f, 0.7f, 1.2f, 1f, bVar1);
}else{
fLocal_534[iParam0]=1f;
...
if(!PED::GET_PED_TYPE(uLocal_451[iParam0])==6){
if(MISC::IS_AREA_OCCUPIED(ENTITY::GET_ENTITY_COORDS(uLocal_462[iParam0], 1) - Vector(1f, 1f, 1f), ENTITY::GET_ENTITY_COORDS(uLocal_462[iParam0], 1) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, 0, 0)){
...
func_77(iParam0, iParam1);
if(PED::IS_PED_SITTING_IN_VEHICLE(uLocal_451[iParam0], uLocal_462[iParam0])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_451[iParam0], joaat("script_task_vehicle_drive_wander")) !=1){
TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_451[iParam0], uLocal_462[iParam0], fLocal_269, iLocal_270);
}else{
...
case -2:
if(!PED::IS_PED_INJURED(uLocal_451[iParam0])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_451[iParam0], joaat("script_task_smart_flee_ped")) !=1){
PED::SET_PED_CONFIG_FLAG(uLocal_451[iParam0], 29, 1);
TASK::TASK_SMART_FLEE_PED(uLocal_451[iParam0], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
}}else{
iLocal_529[iParam0]=-1;
return 0;
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(iParam1, 0)){
uVar9=PED::GET_VEHICLE_PED_IS_IN(iParam1, 0);
...
if(PED::IS_PED_IN_ANY_VEHICLE(iParam1, 0)){
uVar13=PED::GET_VEHICLE_PED_IS_IN(iParam1, 0);
Var9.f_0=ENTITY::GET_ENTITY_FORWARD_X(uVar13);
...
TASK::TASK_VEHICLE_MISSION(uLocal_451[iVar1], uLocal_462[iVar1], 0, 15, 20f, iLocal_270, 0.5f, 2f, 1);
...
return 0;
}}}elseif(iParam1==func_82(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_491, joaat("player"));
iVar0=0;
while (iVar0 < 4){
if(iLocal_467[iVar0] !=0){
MISC::CLEAR_AREA(Local_492 + Local_472[iVar0 /*3*/], 20f, 1, 0, 0, 0);
uLocal_462[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_467[iVar0], Local_492 + Local_472[iVar0 /*3*/], (fLocal_495 + fLocal_485[iVar0]), 1, 1, 0);
...
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(uLocal_462[iVar0], 1);
}
if(iLocal_456[iVar0] !=0){
...
Local_472[0 /*3*/]={
Vector(0f, SYSTEM::COS(fVar12), SYSTEM::SIN(fVar12)) * FtoV(MISC::GET_RANDOM_FLOAT_IN_RANGE(15f, 25f)) 
};
fLocal_485[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
iLocal_490=0;
iLocal_456[0]=joaat("a_m_y_genstreet_01");
