...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0, &sLocal_349, &(Local_430[iParam1 /*16*/]), 2)){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_253[iParam1], 0)){
...
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iParam1], -8f, 1);
Var38={
...
Var38.f_0=-824.333f;
fVar41=140.49f;
ENTITY::SET_ENTITY_COORDS(iLocal_253[iParam1], Var38, 1, 0, 0, 1);
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_480)){
uLocal_480=PED::CREATE_SYNCHRONIZED_SCENE(Var0 + Var76, 0f, 0f, (fVar3 + fVar79), 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_480, 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_480, 0);
}
TASK::TASK_SYNCHRONIZED_SCENE(uParam0, uLocal_480, &sVar42, &cVar58, 1000f, -8f, 0, 0, 1000f, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_480, 1);
iLocal_243[iParam1]=1;
}
break;
case 1:
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(iLocal_237[iVar0], iLocal_253[iVar0])){
ENTITY::SET_ENTITY_COORDS(iLocal_237[iVar0], ENTITY::GET_ENTITY_COORDS(iLocal_237[iVar0], 1), 1, 0, 0, 1);
}}
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_98011, &sLocal_349, &(Local_430[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
iLocal_243[iVar0]=0;
}else{
iLocal_243[iVar0]=-1;
}
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_98011, &(Local_302[iVar0 /*16*/]), &sLocal_349, 8f, 1090519040, 0, 1148846080);
}
iVar0++;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_463) && iLocal_468){
...
while (iVar0 < iLocal_237){
if(!PED::IS_PED_INJURED(iLocal_237[iVar0])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_98010, &sLocal_349, &(Local_397[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], 0)){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_269[iVar0 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_98010, &(Local_269[iVar0 /*16*/]), &sLocal_349, 8f, 1090519040, 0, 1148846080);
}else{
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_253[iVar0])){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_253[iVar0], iLocal_474[iVar0], &Local_470, 1);
}
...
VEHICLE::SET_PLAYBACK_SPEED(iLocal_253[iVar0], uLocal_479);
}}
iVar0++;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_463)){
...
return 0;
}}}elseif(iParam1==func_39(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(iLocal_256[iVar0] !=0){
iLocal_253[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_256[iVar0], Local_335 + Local_259[iVar0 /*3*/], (fLocal_338 + fLocal_266[iVar0]), 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_253[iVar0], 1084227584);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_269[iVar0 /*16*/]))){
ENTITY::PLAY_ENTITY_ANIM(iLocal_253[iVar0], &(Local_269[iVar0 /*16*/]), &sLocal_349, 8f, 1, 0, 0, 0, 0);
}else{
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_253[iVar0], iLocal_474[iVar0], &Local_470, 1);
}}
iVar0++;
}
PED::ADD_RELATIONSHIP_GROUP("KIDSS", &uLocal_252);
iVar0=0;
while (iVar0 < iLocal_237){
if(iLocal_240[iVar0] !=145){
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_237[iVar0], uLocal_252);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_397[iVar0 /*16*/]))){
TASK::TASK_PLAY_ANIM(iLocal_237[iVar0], &sLocal_349, &(Local_397[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
iLocal_243[iVar0]=0;
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_253[iVar0], 0)){
...
PED::SET_PED_PROP_INDEX(iParam0, 0, 0, 1, 0, 1);
return 1;
break;
case 10:
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iParam0);
PED::SET_PED_PROP_INDEX(iParam0, 0, 0, 0, 0, 1);
PED::SET_PED_PROP_INDEX(iParam0, 1, 0, 0, 0, 1);
if(iParam2 !=101){
unk_0x7E4E6DFA37692889(iParam0, 2, 1);
}else{
PED::SET_PED_PROP_INDEX(iParam0, 2, 0, 0, 0, 1);
}
return 1;
break;
case 8:
...
iVar0=12;
iVar1=32;
if(MISC::IS_BIT_SET(Global_113648.f_2365.f_539.f_3816[0 /*166*/][iVar0 /*11*/][(iVar1 / 32)], (iVar1 % 32))){
...
Global_78341[1 /*14*/]={
func_70(iVar0, iParam1, iParam2, -1) 
};
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_50(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(uParam0, func_50(iParam1))){
return 1;
}
return 0;
}
...
return 1;
}elseif(func_58(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_54(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_50(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_50(iParam0));
if(iVar57 > iVar56){
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_70(iVar10, iParam1, iParam2, -1) 
};
if(!func_165(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_70(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar28=9;
...
uVar28={
func_61(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_70(iVar10, 14, uVar28[iVar1], -1) 
};
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_50(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_50(iVar0)));
}
else{
...
Global_78341[1 /*14*/]={
func_70(iVar10, iVar0, func_146(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_61(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_70(iVar10, 14, uVar69[iVar1], -1) 
};
...
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_252);
