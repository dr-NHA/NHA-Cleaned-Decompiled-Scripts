...
ENTITY::SET_CAN_CLIMB_ON_ENTITY(Local_55[0 /*2*/], 0);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 400f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_55[0 /*2*/])){
func_93(9);
}}
...
}}elseif(func_92(PLAYER::PLAYER_PED_ID(), Local_52, 1) < 200f){
...
HUD::SET_BLIP_EXTENDED_HEIGHT_THRESHOLD(Local_188.f_5, 1);
}
...
iLocal_392=0;
iLocal_2134++;
}}elseif(!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], PLAYER::GET_PLAYERS_LAST_VEHICLE())){
func_41(&Local_188);
if(!HUD::DOES_BLIP_EXIST(uLocal_378)){
...
TASK::TASK_PERFORM_SEQUENCE(Local_64[3 /*10*/], uLocal_379);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
iLocal_2134++;
}}elseif((!iLocal_387 && func_36()) && (MISC::GET_GAME_TIMER() - iLocal_452) > 3000){
...
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_55[3 /*2*/], -189.8985f, -2622.707f, 5.0001f, 14, 30f, 786468, 5f, 1f, 1);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_55[3 /*2*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 1000f, 10f, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_379);
TASK::TASK_PERFORM_SEQUENCE(Local_64[3 /*10*/], uLocal_379);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
}else{
TASK::CLEAR_PED_TASKS(Local_64[3 /*10*/]);
TASK::TASK_SMART_FLEE_COORD(Local_64[3 /*10*/], Local_52, 300f, -1, 0, 0);
}
iLocal_452=MISC::GET_GAME_TIMER();
iLocal_2134++;
}
...
}elseif(func_146(*uParam0, "v_hospital", 307.3065f, -589.9595f, 43.302f)){
*uParam0={
...
if(func_173()){
*uParam0=func_154(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_155(iVar0, 0), 1);
...
return func_160(2, 2);
}elseif(func_159(Global_1853747)){
...
Vector3 func__160(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_162(Var18, -Var0.f_3.f_2) 
};
Var18={
func_162(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__162(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
if(func_228(&Local_188, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_55[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((HUD::DOES_BLIP_EXIST(Local_188.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_55[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, 0, 1, 0)) && func_220(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/]))){
...
iLocal_452=MISC::GET_GAME_TIMER();
iLocal_2134++;
}}elseif(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0 && HUD::DOES_BLIP_EXIST(Local_188.f_5)){
...
ENTITY::SET_ENTITY_COORDS(Local_55[0 /*2*/], Local_411, 1, 0, 0, 1);
...
VEHICLE::SET_VEHICLE_USE_CUTSCENE_WHEEL_COMPRESSION(Local_55[2 /*2*/], 1, 0, 0);
VEHICLE::SET_VEHICLE_DOORS_SHUT(Local_55[2 /*2*/], 1);
iLocal_448=1;
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("DockHeist_trailer", 0)){
VEHICLE::SET_VEHICLE_USE_CUTSCENE_WHEEL_COMPRESSION(Local_55[1 /*2*/], 1, 0, 0);
iLocal_451=1;
}
...
iLocal_450=1;
}elseif(!ENTITY::DOES_ENTITY_EXIST(Local_169[4 /*2*/])){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_169[4 /*2*/], Local_55[1 /*2*/], -1, Local_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
Local_169[5 /*2*/]=OBJECT::CREATE_OBJECT(joaat("prop_tarp_strap"), -332.8449f, -2622.157f, 8.7838f, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_169[5 /*2*/], Local_55[1 /*2*/], -1, Local_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
...
if(HUD::DOES_BLIP_EXIST(Local_188.f_5)){
HUD::SET_BLIP_ROUTE(Local_188.f_5, 0);
}
if(func_107(PLAYER::PLAYER_PED_ID()) && func_107(Local_55[0 /*2*/])){
...
case 1:
Local_430={
ENTITY::GET_ENTITY_COORDS(Local_169[8 /*2*/], 1) 
};
if(Local_430.f_2 <=1f){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_55[0 /*2*/], Local_169[8 /*2*/], -1, 2.47f, 0f, -1.96f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1, 0);
iLocal_410++;
}else{
func_208(1, 2f);
}
...
fLocal_443=CAM::GET_CAM_NEAR_CLIP(uLocal_444);
...
CAM::SET_CAM_NEAR_CLIP(uLocal_444, fLocal_443);
fLocal_424=80f;
ENTITY::DETACH_ENTITY(Local_169[7 /*2*/], 1, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_169[7 /*2*/], Local_169[6 /*2*/], -1, Local_421, 0f, 0f, fLocal_424, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_169[8 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], Local_426), 0, 0, 1);
...
Local_169[6 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_415, Local_416, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(Local_169[6 /*2*/], Local_416, 1, 0, 0, 1);
...
Local_169[7 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_420, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[6 /*2*/], Local_421), 1, 1, 0);
}
if(!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_169[7 /*2*/], Local_169[6 /*2*/])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_169[7 /*2*/], Local_169[6 /*2*/], -1, Local_421, 0f, 0f, fLocal_424, 0, 0, 0, 0, 2, 1, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_169[8 /*2*/])){
Local_169[8 /*2*/]=OBJECT::CREATE_OBJECT(iLocal_425, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], Local_426), 1, 1, 0);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_169[8 /*2*/], 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_169[8 /*2*/], Local_169[7 /*2*/], -1, Local_426, 0f, 0f, fLocal_429, 0, 0, 0, 0, 2, 1, 0);
...
iLocal_439=PHYSICS::ADD_ROPE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], Local_433), 0f, 0f, 0f, 70f, 0, -1f, 4f, 1.4f, 0, 0, 1, 1f, 0, 0);
PHYSICS::ROPE_SET_SMOOTH_REELIN(iLocal_439, 1);
PHYSICS::ROPE_SET_UPDATE_ORDER(iLocal_439, 2);
PHYSICS::ROPE_DRAW_SHADOW_ENABLED(&iLocal_439, 0);
PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_439, Local_169[7 /*2*/], Local_169[8 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], Local_433), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[8 /*2*/], Local_436), 70f, 0, 0, 0, 0);
iLocal_384=1;
return 1;
}
...
Local_166={
PHYSICS::GET_CGOFFSET(Local_55[0 /*2*/]) 
};
}
if(ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]) && !HUD::DOES_BLIP_EXIST(uLocal_378)){
uLocal_378=func_281(Local_169[2 /*2*/]);
}
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_378, "SUBBTN_LABEL");
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_64[4 /*10*/], 0);
}
...
func_274();
if((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && !func_214(0)){
...
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_381, cLocal_51, "ig_1_stealth_button", 1000f, -1.5f, 4, 0, 1000f, 2);
}
else{
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_381, cLocal_51, "ig_1_button", 1000f, -1.5f, 4, 0, 1000f, 2);
}
...
iLocal_445=1;
iLocal_2134++;
}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_381) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_381) >=0.7f){
...
func_268(12);
iLocal_2134++;
}elseif(func_269(func_270(0), 0) && !func_269(func_270(1), 0)){
...
case 5:
Var1={
ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1) 
};
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_379);
TASK::TASK_PERFORM_SEQUENCE(Local_64[6 /*10*/], uLocal_379);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_379);
TASK::TASK_PERFORM_SEQUENCE(Local_64[7 /*10*/], uLocal_379);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
func_89(&uLocal_460, joaat("s_m_m_security_01"));
}else{
Local_64[5 /*10*/]=PED::CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1228.929f, -3015.008f, 8.31909f, 0f, 1, 1);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_379);
TASK::TASK_PERFORM_SEQUENCE(Local_64[5 /*10*/], uLocal_379);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
func_89(&uLocal_460, joaat("s_m_m_security_01"));
}
if(func_107(Local_64[4 /*10*/])){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_379);
TASK::TASK_PERFORM_SEQUENCE(Local_64[4 /*10*/], uLocal_379);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_379);
...
func_198(1);
iLocal_2134=0;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) < 5f && !iLocal_388){
...
Local_145[0 /*5*/]=PHYSICS::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[0 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[0 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], 1.8f, 1.02f, 1.11f), fLocal_2139, 0, 0, 0, 0);
Local_145[1 /*5*/]=PHYSICS::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[1 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[0 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], -1.8f, 1.02f, 1.11f), fLocal_2139, 0, 0, 0, 0);
Local_145[2 /*5*/]=PHYSICS::ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[2 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[1 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], 1.8f, -3.07f, 1.11f), fLocal_2139, 0, 0, 0, 0);
Local_145[3 /*5*/]=PHYSICS::ADD_ROPE(1260.752f, -3004.994f, 22.68315f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
PHYSICS::ATTACH_ENTITIES_TO_ROPE(Local_145[3 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[1 /*2*/], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], -1.8f, -3.07f, 1.11f), fLocal_2139, 0, 0, 0, 0);
iLocal_383=1;
iLocal_385=0;
PHYSICS::ACTIVATE_PHYSICS(Local_55[0 /*2*/]);
ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(Local_55[0 /*2*/], 1, 0f, 0f, 0.01f, 0, 0, 1, 0);
}}elseif(func_107(Local_55[0 /*2*/])){
if(!iLocal_385){
PHYSICS::ACTIVATE_PHYSICS(Local_55[0 /*2*/]);
iLocal_385=1;
}
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_169[3 /*2*/], Local_64[4 /*10*/], PED::GET_PED_BONE_INDEX(Local_64[4 /*10*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
iLocal_386=1;
}}}
...
TASK::STOP_ANIM_TASK(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", -1056964608);
}
...
if(iParam4==1){
if(func_261(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_127(iParam0, 0, 0)) || func_127(iParam0, 1, 0)) || func_127(iParam0, 2, 0)) || func_117(iParam0) !=145) || func_252(iParam0)) || func_251(iParam0)) || func_250(iParam0)) || func_249(iParam0)) || !func_237(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_251(iParam0)){
}
if(func_251(iParam0)){
}
...
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_2143[iLocal_2146], "DOCKS_HEIST_PREP_1_SUB_SWING", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
iLocal_2146++;
}}elseif(iVar0 <=2){
...
}elseif(HUD::DOES_BLIP_EXIST(Local_64[iLocal_382 /*10*/].f_2)){
...
}elseif(iLocal_2133==2 && Local_64[iLocal_382 /*10*/]==Local_64[3 /*10*/]){
...
func_93(1);
}elseif(Local_55[iLocal_382 /*2*/]==Local_55[2 /*2*/] || Local_55[iLocal_382 /*2*/]==Local_55[1 /*2*/]){
func_93(2);
}elseif(iLocal_382==3){
func_93(8);
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 750f){
func_93(10);
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 700f){
...
if(func_107(Local_64[4 /*10*/])){
if(iLocal_404){
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
...
case 1:
if(!iLocal_404){
if((MISC::GET_GAME_TIMER() - iLocal_403) > 2000 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 10f){
iLocal_404=1;
iLocal_399=0;
}}
...
iLocal_399=2;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 8.5f){
AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
if(!func_287(Local_64[4 /*10*/], joaat("script_task_turn_ped_to_face_coord"), 1)){
TASK::TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0, 0, 0, 0);
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 12f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(!func_287(Local_64[4 /*10*/], joaat("script_task_turn_ped_to_face_coord"), 1)){
TASK::TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0, 0, 0, 0);
}}elseif(((WEAPON::IS_FLASH_LIGHT_ON(PLAYER::PLAYER_PED_ID()) && (CLOCK::GET_CLOCK_HOURS() >=19 || CLOCK::GET_CLOCK_HOURS() < 6)) && func_10(PLAYER::PLAYER_PED_ID(), Local_64[4 /*10*/], 1) < 25f) && (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_64[4 /*10*/]) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_64[4 /*10*/]))){
if(!func_287(Local_64[4 /*10*/], joaat("script_task_turn_ped_to_face_coord"), 1)){
TASK::TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0, 0, 0, 0);
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 12f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_64[4 /*10*/], 1252.558f, -3004.846f, 8.31909f, 2f, -1, 0.25f, 0, -122.93f);
iLocal_403=MISC::GET_GAME_TIMER();
iLocal_404=0;
}}}}
if(func_107(Local_64[4 /*10*/])){
...
TASK::WAYPOINT_PLAYBACK_PAUSE(Local_64[4 /*10*/], 0, 0);
}elseif(ENTITY::IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1228.849f, -2986.284f, 8.31909f, 2f, 2f, 2f, 0, 1, 0)){
TASK::WAYPOINT_PLAYBACK_PAUSE(Local_64[4 /*10*/], 0, 0);
}
}
else{
iLocal_407=MISC::GET_GAME_TIMER();
TASK::WAYPOINT_PLAYBACK_RESUME(Local_64[4 /*10*/], 1, -1, 3000);
}}
...
iLocal_399=3;
iLocal_401=1;
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
TASK::TASK_HANDS_UP(Local_64[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 1);
}elseif(PED::HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 23)){
AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
func_226(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
iLocal_399=3;
iLocal_401=2;
...
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID(), 1)){
AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
func_226(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
iLocal_399=3;
...
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || !func_107(Local_64[4 /*10*/])){
iLocal_399=0;
}
...
TASK::TASK_HANDS_UP(Local_64[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 1);
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
}elseif(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_64[4 /*10*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_64[4 /*10*/])){
...
TASK::TASK_SMART_FLEE_PED(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_64[4 /*10*/], joaat("script_task_wander_in_area")) !=1){
TASK::TASK_WANDER_IN_AREA(Local_64[4 /*10*/], 1183.287f, -2947.87f, 4.8986f, 100f, 1077936128, 1086324736);
}
}}
if(!iLocal_405){
WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iLocal_406, 1);
...
iLocal_402=MISC::GET_GAME_TIMER();
iLocal_405=1;
}}elseif((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_64[4 /*10*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_64[4 /*10*/])) && PED::IS_PED_FACING_PED(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID(), 160f)){
if(WEAPON::GET_WEAPONTYPE_GROUP(iLocal_406) !=joaat("GROUP_MELEE") && iLocal_406 !=joaat("weapon_unarmed")){
...
case 0:
if(func_107(Local_55[0 /*2*/])){
if((!HUD::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
func_293();
iLocal_456=MISC::GET_GAME_TIMER();
iLocal_458=1;
}}
break;
case 1:
if((MISC::GET_GAME_TIMER() - iLocal_456) > 6000 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0)){
func_226(&uLocal_213, 1, 0, "FLOYD", 0, 1);
...
switch (iLocal_458){
case 0:
if((!HUD::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_55[0 /*2*/], 0)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 324.7653f, -2974.495f, -1f, 1) < 110f){
func_293();
iLocal_458=1;
}
break;
...
switch (iLocal_458){
case 0:
if(((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_VEHICLE(Local_64[3 /*10*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_293();
iLocal_456=MISC::GET_GAME_TIMER();
iLocal_458=1;
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 60f){
func_291();
iLocal_458=3;
}}
break;
...
iLocal_458=2;
}}elseif(func_289(&uLocal_213, "DHP1AUD", "DHP1_WHSE", "DHP1_WHSE_2", 7, 0, 0)){
iLocal_458=2;
}
break;
case 2:
...
switch (iLocal_458){
case 0:
if((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_VEHICLE(Local_64[3 /*10*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 40f){
func_293();
iLocal_458=1;
}
break;
...
iLocal_458=2;
}}elseif(func_289(&uLocal_213, "DHP1AUD", "DHP1_PARK", "DHP1_PARK_2", 7, 0, 0)){
iLocal_458=2;
}
break;
case 2:
...
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_55[0 /*2*/], 0);
AUDIO::SET_VEHICLE_RADIO_ENABLED(Local_55[0 /*2*/], 1);
}
