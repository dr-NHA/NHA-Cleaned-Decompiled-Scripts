...
fLocal_150=20f;
sLocal_316="Omega";
uLocal_317=WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_digiscanner"));
...
elseif(!bLocal_148 && func_229(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0]) > 50f){
...
Global_78341[1 /*14*/]={
func_88(iVar0, iParam1, iParam2, -1) 
};
...
Global_78341[1 /*14*/]={
func_88(iVar0, iParam1, uVar31[iParam1], -1) 
};
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_88(iVar10, iParam1, iParam2, -1) 
};
if(!func_78(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_88(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar28=9;
...
uVar28={
func_81(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_88(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_88(iVar10, iVar0, func_45(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_88(iVar10, 14, uVar69[iVar1], -1) 
};
func_55(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_71(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_88(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_66(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_65(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_80(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_80(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_80(iParam0));
if(iVar57 > iVar56){
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_80(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_80(iParam1))){
return 1;
}
return 0;
}
...
func_166(&uVar32, Var0.f_3, Global_100718, iParam1, iParam2);
}}


void func_166(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4){
...
var func__215(int iParam0, int iParam1){
...
func_254(5);
return 0;
}elseif(PED::IS_PED_INJURED(Local_81.f_28[0])){
iLocal_144=2;
func_254(5);
return 0;
}elseif(func_235(Local_81.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
TASK::TASK_SMART_FLEE_PED(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
iLocal_144=3;
func_254(5);
return 0;
}elseif(func_233(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1)){
TASK::TASK_SMART_FLEE_PED(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
iLocal_144=3;
func_254(5);
return 0;
}elseif(PED::IS_PED_RAGDOLL(Local_81.f_28[0])){
iLocal_144=3;
func_254(5);
return 0;
}}
...
if(func_234(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(func_234(iParam1)){
...
if(bParam4){
return 0;
}elseif(func_236(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
float fVar6;
Var0={
func_244(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_244(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__244(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_244(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
case 0:
if(func_231(Local_81.f_28[0])){
TASK::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], uLocal_326);
}
...
func_319(&Local_81, 0, 1);
if(!ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0])){
Local_81.f_41[0]=OBJECT::CREATE_OBJECT(uLocal_317, 2468.51f, 3437.39f, 55f, 1, 1, 0);
}
iLocal_319=OBJECT::CREATE_OBJECT(iLocal_318, 2472.3f, 3437.3f, 49.3f, 1, 1, 0);
if(func_231(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_81.f_41[0], Local_81.f_28[0], PED::GET_PED_BONE_INDEX(Local_81.f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, 0, 0, 0, 0, 2, 1, 0);
}
if(func_231(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_319)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_319, Local_81.f_28[0], PED::GET_PED_BONE_INDEX(Local_81.f_28[0], 64729), Local_320, Local_323, 0, 0, 0, 0, 2, 1, 0);
}
...
iVar0=0;
while (iVar0 < 16){
if(func_231(uVar1[iVar0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar1[iVar0], Local_331[0 /*3*/], Local_331[1 /*3*/], fLocal_338, 0, 1, 0)){
...
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_81.f_28[0], 0f, 0f, 0f, 1, -1, 2500, 2000, 0);
...
bool func_291(int iParam0, int iParam1, float fParam2, int iParam3){
...
PED::SET_PED_KEEP_TASK(Local_81.f_28[0], 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_81.f_28[0], 0);
PED::SET_PED_CONFIG_FLAG(Local_81.f_28[0], 185, 1);
}
if(func_234(PLAYER::PLAYER_PED_ID()) && func_234(Local_81.f_28[0])){
uLocal_329=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_81.f_28[0], uLocal_329);
PED::SET_PED_CONFIG_FLAG(Local_81.f_28[0], 132, 1);
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
2463.225f, 3444.113f, 48.59399f 
};
uParam0->f_17[1 /*3*/]={
2475.22f, 3428.098f, 50.99095f 
};
uParam0->f_24=17f;
uParam0->f_27=0;
...
int func_321(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7){
if(func_322(uParam0, iParam1, Param2, fParam5, 1)){
...
int func_322(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_157(iParam1)){
...
bVar13=false;
if(func_231(iParam0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, Local_331[0 /*3*/], Local_331[1 /*3*/], fLocal_338, 0, 1, 0)){
...
Var0[0 /*3*/]={
(Var0[2 /*3*/] - Var0[1 /*3*/]), (Var0[2 /*3*/].f_1 - Var0[1 /*3*/].f_1), (Var0[2 /*3*/].f_2 - Var0[1 /*3*/].f_2) 
};
Var10={
func_329() 
};
...
Var10={
Var10 * Vector(1.1f, 1.1f, 1.1f) 
};
}elseif(iVar14==joaat("t20") || iVar14==joaat("virgo")){
Var10={
Var10 * Vector(1.2f, 1.2f, 1.2f) 
};
}
if(Var0[0 /*3*/] > Var10.f_0){
bVar13=true;
}elseif(Var0[0 /*3*/].f_1 > Var10.f_1){
bVar13=true;
}elseif(Var0[0 /*3*/].f_2 > Var10.f_2){
bVar13=true;
}
if(bVar13){
...
var uVar5;
var uVar6;
if((func_157(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0)){
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_273(iParam0, 0, 0)) || func_273(iParam0, 1, 0)) || func_273(iParam0, 2, 0)) || func_390(iParam0) !=145) || func_389(iParam0)) || func_388(iParam0)) || func_339(iParam0)) || func_387(iParam0)) || !func_377(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_388(iParam0)){
}
if(func_388(iParam0)){
}
...
}elseif(func_399(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
}elseif((!func_415(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_417(iParam0, uVar1[iVar6], 1) && func_416(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_411(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_426(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_425()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
var func__423(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
void func_446(){
Local_331[0 /*3*/]={
2453.513f, 3424.646f, 48.44232f 
};
Local_331[1 /*3*/]={
2490.06f, 3434.195f, 58.26103f 
};
fLocal_338=32.75f;
}
