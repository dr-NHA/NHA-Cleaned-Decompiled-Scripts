...
func_120();
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19)) func_115(0);
if(func_112(func_114(SCRIPT::GET_THIS_SCRIPT_NAME()))) func_115(0);
if(!func_110()) func_115(0);
if(!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) func_115(0);
if(func_109()) func_115(0);
if(func_108()) func_115(0);
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_107()) func_115(0);
if(MISC::GET_GAME_TIMER() < Global_32428 + 10000 && !func_107()) func_115(0);
...
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_115(1);
...
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_240)){
if(!bLocal_441) func_97(func_114(SCRIPT::GET_THIS_SCRIPT_NAME()));
func_115(0);
}
...
if(ENTITY::IS_ENTITY_OCCLUDED(pedLocal_240) && func_84(pedLocal_240, PLAYER::PLAYER_PED_ID(), true) > 50f && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_115(1);
SYSTEM::WAIT(0);
}
return;
}
...
if(character==CHAR_TREVOR) return 9;
elseif(character==CHAR_MICHAEL) return 6;
return -1;
}
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_TREVOR_WHAT_ARE_YOU_ON", 64);
elseif(character==CHAR_MICHAEL) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_MICHAEL_LET_ME_ASK_YOU_SOMTHING", 64);
return;
}
...
var func__83(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2D18{
...
Vector3 func__87(float fParam0, var uParam1, var uParam2) // Position - 0x2E3F{
float num;
float num2;
...
bLocal_436=true;
iLocal_252=6;
if(func_106()) sLocal_303="";
else sLocal_303="PBTS_INTERACT" /*Press ~INPUT_CONTEXT~ to talk to Tonya.*/;
...
if(IS_BIT_SET(Global_113648.f_18576[58 /*6*/], 0) && !IS_BIT_SET(Global_113648.f_18576[58 /*6*/], 3)) return true;
return false;
}
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN || !func_111()) return false;
return true;
}
BOOL func_111() // Position - 0x3248{
if(IS_BIT_SET(Global_113648.f_18576[60 /*6*/], 0) && !IS_BIT_SET(Global_113648.f_18576[60 /*6*/], 3)) return false;
if(IS_BIT_SET(Global_113648.f_18576[61 /*6*/], 0) && !IS_BIT_SET(Global_113648.f_18576[61 /*6*/], 3)) return false;
if(IS_BIT_SET(Global_113648.f_18576[62 /*6*/], 3)) return false;
if(IS_BIT_SET(Global_113648.f_18576[58 /*6*/], 2) || IS_BIT_SET(Global_113648.f_18576[59 /*6*/], 2) || IS_BIT_SET(Global_113648.f_18576[62 /*6*/], 2)) return true;
return false;
}
...
if(iLocal_298 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_298);
if(HUD::DOES_BLIP_EXIST(blLocal_248)) func_116(&blLocal_248);
func_90();
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) AUDIO::DISABLE_PED_PAIN_AUDIO(PLAYER::PLAYER_PED_ID(), false);
