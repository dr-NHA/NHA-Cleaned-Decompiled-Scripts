...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_278(&num, true);
if(num==32){
func_214();
...
if(num==32) func_197(&num, vector, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_99);
elseif(num==34) func_192(&num, vector, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
if(func_178(&num, 0)){
if(func_177(num)) func_174(num, &blLocal_98);
if(!func_2(&num)) func_278(&num, true);
if(func_1(&num)) func_278(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xCDC{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6AF1{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x7241{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x75CD{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x770C{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x8490{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C92{
...
case 12:
case 13:
if(iParam0==11) *uParam1=func_175(1835.53f, 4705.86f, 38.1f, false);
elseif(iParam0==12) *uParam1=func_175(1826.13f, 4698.88f, 38.92f, false);
else *uParam1=func_175(637.02f, 119.7093f, 89.5f, false);
HUD::SET_BLIP_SPRITE(*uParam1, BLIP_EPSILON);
HUD::SET_BLIP_COLOUR(*uParam1, 42);
break;
case 18:
case 19:
if(iParam0==18) *uParam1=func_175(-954.19f, -2760.05f, 14.64f, false);
else *uParam1=func_175(-63.8f, -809.5f, 321.8f, false);
HUD::SET_BLIP_SPRITE(*uParam1, BLIP_DOM);
HUD::SET_BLIP_COLOUR(*uParam1, 43);
break;
case 21:
case 23:
if(iParam0==21) *uParam1=func_175(-1877.82f, -440.649f, 45.05f, false);
else *uParam1=func_175(-915.6f, 6139.2f, 5.5f, false);
...
case 47:
case 48:
if(iParam0==47) *uParam1=func_175(-70.71f, 301.43f, 106.79f, false);
else *uParam1=func_175(-257.22f, 292.85f, 90.63f, false);
...
var func__176(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC116{
if(bParam0) return uParam1;
return uParam2;
}
...
if(func_213(playersLastVehicle))if(PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))if(!ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(playersLastVehicle) && !ENTITY::IS_ENTITY_IN_AIR(playersLastVehicle) && ENTITY::GET_ENTITY_SPEED(playersLastVehicle) < 1f) return true;
...
*uParam10=3;
return 1;
}}}elseif(func_199(sParam5) && !*uParam10==1 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && func_196(PLAYER::PLAYER_PED_ID(), uParam1, true) >=20f){
...
if(Global_43257==17){
if(*uParam0 !=-1) func_206(uParam0);
}elseif(func_205()){
if(*uParam0 !=-1) func_206(uParam0);
}elseif(*uParam0==-1){
if(func_196(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_204(uParam0, 1);
}else{
...
if(func_196(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_206(uParam0);
}}}
return;
}
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_202(*uParam0, false);
...
if(*panParam0==19) func_210(panParam0->f_28[0]);
func_295("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_223(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_223(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_220(panParam0);
...
if(func_219(&(panParam0->f_48)) && bParam1) func_216(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
if(func_218(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_218(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_217(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_226(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_234(&iLocal_37[num /*4*/]);
return false;
}
if(!func_231(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_230();
if(num==-1) return false;
...
Vector3 func__229(Ped pedParam0, int iParam1) // Position - 0xEC67{
...
float num;
unk={
func_233(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_233(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__233(float fParam0, var uParam1, var uParam2) // Position - 0xEE28{
float num;
float num2;
...
if(!bParam2){
if(func_241(pedParam0, bParam1, radius, num)) return true;
if(func_238(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_239(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_239(pedParam0, fParam1)) return true;
...
float num;
unk={
func_233(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_248() && Global_100681.f_11==6 && iParam0==func_172(&(Global_100681.f_3), 0)) return true;
return false;
}
...
return false;
case 1:
if(!func_260(&num) || !func_259(&(uParam0->f_48))) return false;
iLocal_91=2;
return false;
case 2:
flag=true;
...
if(func_131(PLAYER::PLAYER_PED_ID())) TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, SLF_FAST_TURN_RATE | 2048, 4);
}else{
flag=false;
}}
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
...
case 1:
MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, true, false, false, false);
if(!func_260(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1")) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(func_255(&uParam0->f_28[0], CHAR_JOE, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1)) PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
else flag=false;
...
if(iParam0==58)if(func_268(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
int i;
if(*uParam0==1){
if(func_276(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
if(*uParam0==32) VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA({
35f, 3409f, 322f 
}
-{
20f, 20f, 20f 
...
, true, true);
elseif(*uParam0==34) PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_97, false);
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))if(func_199(sParam0)) func_280();
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_211(&uParam0->[i]);
else func_286(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_293(&uParam0->[i]);
else func_292(&uParam0->[i], false, 1, 0);
}
return;
}
