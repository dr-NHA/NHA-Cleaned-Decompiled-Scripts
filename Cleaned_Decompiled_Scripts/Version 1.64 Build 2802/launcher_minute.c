...
if(!func_212(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], 1), 1056964608)){
...
*uParam10=3;
return 1;
}}}elseif(((func_199(sParam5) && !*uParam10==1) && func_132(PLAYER::PLAYER_PED_ID())) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) >=20f){
...
uParam1->f_3=5;
}elseif((func_218(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
Vector3 func__229(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_233(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_233(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__233(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_233(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
void func_253(var uParam0, var uParam1, struct<3> Param2, float fParam5){
func_254(uParam0);
...
int func_256(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_36(iParam1)){
