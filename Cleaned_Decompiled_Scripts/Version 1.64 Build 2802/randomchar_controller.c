...
HUD::SET_BLIP_FLASHES(Global_32543[iVar34 /*23*/].f_19, 1);
...
void func_46(){
if(!func_45(39)){
if(MISC::IS_BIT_SET(Global_113648.f_18576[27 /*6*/], 3)){
if(func_47("FS_HELP1")==2){
func_6("FS_HELP1", 1, 0, 2000, 10000, 7, 0, 0, 0);
}elseif(func_47("FS_HELP1")==1){
func_5(39);
}}}}
...
float func_51(var uParam0, struct<3> Param1, int iParam4){
struct<3> Var0;
...
if(func_75()){
if(!func_43(114)){
if(MISC::IS_BIT_SET(Global_113648.f_18576[46 /*6*/], 3)){
func_72(552744224, 6, 2, 50, 60000, 10000, -1, 181, -1, 0, 1);
func_71(114, 1);
}}elseif(!func_43(83)){
if(MISC::IS_BIT_SET(Global_113648.f_18576[51 /*6*/], 3)){
...
if(!MISC::IS_BIT_SET(Global_113648.f_18576.f_390[iLocal_52], bLocal_51)){
func_18(iVar0, &Var1);
if(iVar0==58){
MISC::SET_BIT(&(Global_113648.f_18576.f_390[iLocal_52]), bLocal_51);
}elseif(HUD::GET_MINIMAP_FOW_COORDINATE_IS_REVEALED(Var1.f_6)){
MISC::SET_BIT(&(Global_113648.f_18576.f_390[iLocal_52]), bLocal_51);
}elseif(Global_112735[iVar0 /*10*/].f_8 !=-1){
if(iLocal_53[Global_112735[iVar0 /*10*/].f_8]){
if(MISC::IS_BIT_SET(Global_32543[iLocal_74[Global_112735[iVar0 /*10*/].f_8] /*23*/].f_11, 6)){
...
if(!MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 1)){
if(!Var0.f_23){
MISC::SET_BIT(&(Global_113648.f_18576[iParam0 /*6*/]), true);
}}
if(MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 3)){
...
if(MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 2) && !MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 3)){
bVar59=true;
if(func_128(iParam0)){
bVar59=false;
}
...
if(!func_120() && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Var0.f_6, 0) > fVar61){
Global_112735[iParam0 /*10*/].f_3=0;
}else{
...
iVar62=0;
if((((iVar60 && !MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 3)) && MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 0)) && MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 1)) && MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 2)){
...
if(!MISC::IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 4)){
...
elseif(MISC::IS_BIT_SET(Var0.f_26, 0)){
sVar64="TRIG_RC_M";
}
else{
sVar64="TRIG_RC_T";
...
if(iParam0==2){
if(MISC::IS_BIT_SET(Global_113648.f_18576[3 /*6*/], 3) && Global_112735[3 /*10*/].f_3==1){
return 1;
}}elseif(iParam0==3){
if(MISC::IS_BIT_SET(Global_113648.f_18576[2 /*6*/], 3) && Global_112735[2 /*10*/].f_3==1){
return 1;
}}
return 0;
}
...
if(MISC::IS_BIT_SET(Global_113648.f_18576[2 /*6*/], 0) && MISC::IS_BIT_SET(Global_113648.f_18576[3 /*6*/], 0)){
...
if(bParam1 !=MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 8)){
MISC::SET_BIT(&(Global_32543[iVar0 /*23*/].f_11), 18);
}
MISC::SET_BIT(&(Global_32543[iVar0 /*23*/].f_11), 8);
}else{
Global_32543[iVar0 /*23*/].f_18=iParam2;
if(bParam1 !=MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 10)){
MISC::SET_BIT(&(Global_32543[iVar0 /*23*/].f_11), 18);
}
...
if(MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 8) || MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 10)){
MISC::SET_BIT(&(Global_32543[iVar0 /*23*/].f_11), 18);
}
...
if((MISC::IS_BIT_SET(Global_113648.f_18576[2 /*6*/], 3) || MISC::IS_BIT_SET(Global_113648.f_18576[3 /*6*/], 3)) || MISC::IS_BIT_SET(Global_113648.f_18576[4 /*6*/], 3)){
...
return 0;
}}elseif(iVar0 < iParam0 && iVar0 > iParam1){
return 0;
}
return 1;
}
