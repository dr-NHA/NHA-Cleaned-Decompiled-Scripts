...
iLocal_96=-15;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(34)) func_137();
func_136();
func_134();
while (true){
SYSTEM::WAIT(0);
if(func_131(4) || Global_97601) func_137();
if(func_130()){
bLocal_95=false;
...
i < 63;
i=i + 1){
if(i % 60==iLocal_49 || Global_112735[i /*10*/].f_2) func_83(i);
}
func_76();
func_54();
func_49();
...
if(*iParam0 > -1 && *iParam0 < 20) uLocal_53[*iParam0]=0;
*iParam0=-1;
return;
}
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_12(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_12(character)) return func_15(character);
...
Vector3 func__17(int iParam0, int iParam1) // Position - 0x934{
int num;
num=iParam0;
...
int num;
int num2;
if(!func_32(iParam1) || !func_32(iParam0)) return 1;
num=func_30(iParam0);
...
var func__31(BOOL bParam0, var uParam1, var uParam2) // Position - 0x24FA{
...
if(num6 < 1 || num6 > func_33(num5, num4)) return false;
return true;
}
...
if(iParam1 < 1 || iParam1 > func_33(num, num2)) return;
...
if(!func_45(39))if(IS_BIT_SET(Global_113648.f_18576[27 /*6*/], 3))if(func_47("FS_HELP1" /*Find and destroy all of Lenny Avery's "For Sale" signs that are located around the northern area of the city.*/)==2) func_6("FS_HELP1" /*Find and destroy all of Lenny Avery's "For Sale" signs that are located around the northern area of the city.*/, 1, 0, 2000, 10000, 7, 0, 0, 0);
elseif(func_47("FS_HELP1" /*Find and destroy all of Lenny Avery's "For Sale" signs that are located around the northern area of the city.*/)==1) func_5(39);
return;
}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))if(!func_45(55))if(func_53(5) && func_51(PLAYER::PLAYER_PED_ID(), func_52(5), true) < func_50(5) || func_53(6) && func_51(PLAYER::PLAYER_PED_ID(), func_52(6), true) < func_50(6))if(func_47("BARSTASH2" /*Areas where you can find vehicles with a hidden stash are marked on the map. Search them to find vehicles for Barry.*/)==2) func_6("BARSTASH2" /*Areas where you can find vehicles with a hidden stash are marked on the map. Search them to find vehicles for Barry.*/, 1, 0, 2000, 10000, 2, 0, 0, 0);
elseif(func_47("BARSTASH2" /*Areas where you can find vehicles with a hidden stash are marked on the map. Search them to find vehicles for Barry.*/)==1) func_5(55);
return;
}


float func_50(int iParam0) // Position - 0x2C33{
if(iParam0==5 || iParam0==6) return 250f;
elseif(iParam0==38) return 35f;
elseif(iParam0==39) return 37.5f;
elseif(iParam0==40) return 45f;
elseif(iParam0==41) return 150f;
elseif(iParam0==49 || iParam0==50) return 90f;
return 250f;
}
...
Vector3 func__52(int iParam0) // Position - 0x2CF9{
if(iParam0==5) return 1161.31f, -1326.52f, 34.23f;
elseif(iParam0==6) return -533.15f, -1691.25f, 18.21f;
elseif(iParam0==38) return -565.8f, 293.14f, 90.8f;
elseif(iParam0==39) return -1036.65f, 363.59f, 79.82f;
elseif(iParam0==40) return -620.37f, -264.39f, 37.81f;
elseif(iParam0==41) return -1115.96f, 31.42f, 53.8f;
elseif(iParam0==49) return 305.52f, 157.19f, 102.94f;
elseif(iParam0==50) return 1040.96f, -534.42f, 60.17f;
return 0f, 0f, 0f;
}
...
func_18(num, &unk);
if(num==58) MISC::SET_BIT(&Global_113648.f_18576.f_390[iLocal_52], iLocal_51);
elseif(HUD::GET_MINIMAP_FOW_COORDINATE_IS_REVEALED(unk.f_6)) MISC::SET_BIT(&Global_113648.f_18576.f_390[iLocal_52], iLocal_51);
elseif(Global_112735[num /*10*/].f_8 !=-1)if(uLocal_53[Global_112735[num /*10*/].f_8])if(IS_BIT_SET(Global_32543[uLocal_74[Global_112735[num /*10*/].f_8] /*23*/].f_11, 6)) func_81(uLocal_74[Global_112735[num /*10*/].f_8]);
}elseif(Global_112735[num /*10*/].f_8 !=-1){
if(uLocal_53[Global_112735[num /*10*/].f_8])if(!IS_BIT_SET(Global_32543[uLocal_74[Global_112735[num /*10*/].f_8] /*23*/].f_11, 6)) func_77(uLocal_74[Global_112735[num /*10*/].f_8]);
}}
return;
}
...
if(!IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 1))if(!unk.f_23) MISC::SET_BIT(&Global_113648.f_18576[iParam0 /*6*/], 1);
...
flag=true;
if(unk.f_14 !=-1)if(!func_43(unk.f_14)) flag=false;
if(func_128(iParam0)) flag=false;
if(func_126(iParam0)) flag=false;
if(func_125(unk.f_30)) flag=false;
if(unk.f_15 > 0 && flag){
...
if(!func_121(unk.f_27, unk.f_28)) flag=false;
if(flag){
...
flag2=true;
if(func_128(iParam0)) flag2=false;
if(func_126(iParam0)) flag2=false;
if(func_125(unk.f_30)) flag2=false;
if(flag2)if(!func_121(unk.f_27, unk.f_28)) flag2=false;
if(!flag2) MISC::CLEAR_BIT(&Global_113648.f_18576[iParam0 /*6*/], 2);
}
flag3=true;
...
Global_112735[iParam0 /*10*/].f_3=1;
}elseif(Global_112735[iParam0 /*10*/].f_3){
if(unk.f_4==0 || unk.f_4==2 || unk.f_4==3 || unk.f_4==11 || unk.f_4==16 || unk.f_4==17) num4=100f;
else num4=209f;
if(!func_120() && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), unk.f_6, false) > num4){
Global_112735[iParam0 /*10*/].f_3=0;
}else{
if(iParam0==10 && Global_113648.f_7263[109] !=1) func_107(109, 1);
flag3=false;
}}
num5=0;
...
func_95(num6);
if(func_94(unk.f_26, 1)) func_93(num6, true, 1, false);
if(func_94(unk.f_26, 0)) func_93(num6, true, 0, false);
if(func_94(unk.f_26, CHAR_TREVOR)) func_93(num6, true, 2, false);
if(func_82(iParam0) && iParam0 !=52) func_81(num6);
if(func_82(iParam0))if(func_91(iParam0)) func_104(num6, true);
if(iParam0==58) func_90(num6, 4);
else func_90(num6, 8);
...
elseif(iParam0==5 || iParam0==38 || iParam0==49){
...
str="";
if(IS_BIT_SET(unk.f_26, 1)) str="TRIG_RC_F" /*Return as Franklin to start this Strangers and Freaks mission.*/;
elseif(IS_BIT_SET(unk.f_26, 0)) str="TRIG_RC_M" /*Return as Michael to start this Strangers and Freaks mission.*/;
else str="TRIG_RC_T" /*Return as Trevor to start this Strangers and Freaks mission.*/;
...
if(iParam0==2)if(IS_BIT_SET(Global_113648.f_18576[3 /*6*/], 3) && Global_112735[3 /*10*/].f_3==true) return true;
elseif(iParam0==3)if(IS_BIT_SET(Global_113648.f_18576[2 /*6*/], 3) && Global_112735[2 /*10*/].f_3==true) return true;
return false;
}
BOOL func_86(int iParam0) // Position - 0x457E{
if(iParam0==2 || iParam0==3)if(IS_BIT_SET(Global_113648.f_18576[2 /*6*/], 0) && IS_BIT_SET(Global_113648.f_18576[3 /*6*/], 0))if(!IS_BIT_SET(Global_113648.f_18576[2 /*6*/], 3) && !IS_BIT_SET(Global_113648.f_18576[3 /*6*/], 3)) return true;
return false;
}
...
int num;
int num2;
if(!func_82(iParam0)) return false;
num=194;
num2=iParam0 - 52;
if(func_43(108)==true) return true;
if(Global_113648.f_2354[num2 /*2*/] >=1) return true;
if(IS_BIT_SET(Global_113648.f_18576[iParam0 /*6*/], 3)) return true;
...
}elseif(iParam1==2 || iParam1==3 || iParam1==4 || iParam1==7){
...
func_99(iParam0, 66);
}}elseif(iParam1==5 || iParam1==6){
func_97(iParam0, "B_STA" /*Weed Stash*/);
}elseif(iParam1==8){
func_97(iParam0, "B_DRE" /*Killer*/);
}elseif(iParam1==10 || iParam1==11 || iParam1==12 || iParam1==13 || iParam1==14 || iParam1==15 || iParam1==16){
func_97(iParam0, "B_EPS" /*Epsilon*/);
}elseif(iParam1==18 || iParam1==19 || iParam1==20){
func_97(iParam0, "B_EXT" /*Dom*/);
}elseif(iParam1==21 || iParam1==22 || iParam1==23){
...
}elseif(iParam1==28 || iParam1==29 || iParam1==30){
func_97(iParam0, "B_JOS" /*Josh*/);
}elseif(iParam1==33 || iParam1==34){
func_97(iParam0, "B_MIN" /*Minute Men*/);
}elseif(iParam1==38 || iParam1==39 || iParam1==40 || iParam1==41){
func_97(iParam0, "B_CEL" /*Celebrity Item*/);
}elseif(iParam1==42 || iParam1==43){
func_97(iParam0, "B_NIG" /*Nigel*/);
}elseif(iParam1==45){
func_97(iParam0, "B_OME" /*Omega*/);
}elseif(iParam1==47 || iParam1==48 || iParam1==51){
func_97(iParam0, "B_PAP" /*Beverly*/);
}elseif(iParam1==49 || iParam1==50){
func_97(iParam0, "B_PHO" /*Photo Opportunity*/);
}elseif(iParam1==52){
func_97(iParam0, "BLIP_66" /*Strangers and Freaks*/);
}elseif(iParam1==53 || iParam1==54 || iParam1==55 || iParam1==56){
func_97(iParam0, "BLIP_84" /*Rampage*/);
}elseif(iParam1==59 || iParam1==60 || iParam1==61 || iParam1==62){
...
if(HUD::DOES_BLIP_EXIST(Global_32543[num /*23*/].f_19)) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Global_32543[num /*23*/].f_19, sParam1);
return;
}
...
num=iParam0;
if(num < 0 || num >=263 || iParam0==263) return;
if(Global_32543[num /*23*/].f_12[0]==iParam1) return;
...
num=iParam0;
if(num < 0 || num >=263 || iParam0==263) return;
if(fParam1==Global_32543[num /*23*/][0 /*3*/] && fParam1.f_1==Global_32543[num /*23*/][0 /*3*/].f_1 && fParam1.f_2==Global_32543[num /*23*/][0 /*3*/].f_2) return;
Global_32540=1;
MISC::SET_BIT(&(Global_32543[num /*23*/].f_11), 18);
Global_32543[num /*23*/][0 /*3*/]={
fParam1 
};
Global_38593=1;
return;
...
num=iParam0;
if(num < 0 || num >=263 || iParam0==263) return;
if(bParam1) MISC::SET_BIT(&(Global_32543[num /*23*/].f_11), 28);
else MISC::CLEAR_BIT(&(Global_32543[num /*23*/].f_11), 28);
if(Global_32540==1) Global_32541=1;
Global_32540=1;
MISC::SET_BIT(&(Global_32543[num /*23*/].f_11), 18);
return;
...
if(iParam0==5 || iParam0==6 || iParam0==38 || iParam0==39 || iParam0==40 || iParam0==41 || iParam0==49 || iParam0==50) return true;
return false;
}
...
func_109(iParam0);
if(IS_BIT_SET(Global_38617[iParam0 / 32], iParam0 % 32)) func_108(iParam0);
}}
return;
}
...
if(IS_BIT_SET(vector.f_4, 2)) func_114(iParam0, &vector);
...
if(Global_113648.f_9087) num=func_111(iParam0);
else num=0;
if(func_11(14)) num=0;
...
if(func_12(character))if(IS_BIT_SET(Global_95708[0], character))if(iParam0 !=40) return 0;
else return 1;
break;
case 47:
case 48:
...
if(func_12(character))if(IS_BIT_SET(Global_95708[6], character)) return 0;
break;
case 51:
case 52:
if(character==CHAR_TREVOR){
if(IS_BIT_SET(Global_113648.f_7231[2], 0)) return 0;
if(func_12(character))if(IS_BIT_SET(Global_95708[2], character)) return 0;
}elseif(character==CHAR_MICHAEL){
if(IS_BIT_SET(Global_113648.f_7231[1], 0)) return 0;
if(func_12(character))if(IS_BIT_SET(Global_95708[1], character)) return 0;
}
break;
case 53:
if(character==CHAR_TREVOR)if(IS_BIT_SET(Global_113648.f_7231[3], 0)) return 0;
if(func_12(character))if(IS_BIT_SET(Global_95708[3], character)) return 0;
break;
default:
return 0;
}
...
if(func_119()==-1 || func_119()==999 && !func_118()==0) return true;
return false;
}
...
if(iParam1 > iParam0)if(num < iParam0 || num > iParam1) return false;
elseif(num < iParam0 && num > iParam1) return false;
return true;
}
...
if(bParam0)if(func_43(130) && !func_43(131)) return true;
return false;
}
BOOL func_126(int iParam0) // Position - 0x92B5{
if(func_127(iParam0)) return false;
...
if(iParam0==58 || iParam0==59 || iParam0==62)if(func_129(40) || func_129(41) || func_129(43) || func_129(47)) return true;
if(iParam0==24)if(func_129(41)) return true;
return false;
}
