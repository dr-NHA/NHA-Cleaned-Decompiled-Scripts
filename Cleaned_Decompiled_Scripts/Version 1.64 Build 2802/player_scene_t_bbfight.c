...
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_299) > 100f){
return 1;
}
return 0;
}
...
TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98010, &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
(*iParam1)[iVar0]=101;
...
case 101:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011)){
TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98011, &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
...
TASK::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, 0);
...
case 200:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98010)){
TASK::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
(*iParam1)[iVar0]=201;
}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011)){
(*iParam1)[iVar0]=201;
}
...
case 201:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011)){
TASK::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
...
if(iLocal_113==108){
Local_303[iVar0 /*3*/]={
Vector(224.5948f, 1213.466f, 199.6328f) - Local_299 
};
}elseif(iLocal_113==109){
Local_303[iVar0 /*3*/]={
Vector(5.9049f, -717.1404f, -1908.287f) - Local_299 
};
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_299 + Local_303[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
PED::FORCE_PED_MOTION_STATE((*iParam0)[iVar0], joaat("MotionState_Walk"), 0, 0, 0);
...
case 0:
Var8={
ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1) 
};
Var11={
Local_299 + Local_303[iVar0 /*3*/] + Vector(1f, 0f, 0f) 
};
...
break;
case 11:
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_299) > 50f && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1)) > 50f){
...
TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_299 + Local_303[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
(*iParam1)[iVar0]=1;
}
...
case 5:
if(func_32((*iParam0)[iVar0])){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_290[iVar0])){
OBJECT::DELETE_OBJECT(&(uLocal_290[iVar0]));
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_290[iVar0]));
}
TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
...
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_299 + Local_303[iVar0 /*3*/], 20f, 1)){
...
TASK::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, iVar26);
iLocal_486[iVar0]=MISC::GET_GAME_TIMER();
}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_290[iVar0])){
...
default:
break;
}}elseif(ENTITY::DOES_ENTITY_EXIST((*iParam0)[iVar0])){
if((*iParam1)[iVar0] !=-1){
iVar27=0;
...
if(MISC::IS_BIT_SET(Global_32543[iVar0 /*23*/].f_11, 19)){
iVar5=3;
iVar4=0;
while (iVar4 < iVar5){
Var6={
...
Vector3 func__31(int iParam0, int iParam1){
int iVar0;
iVar0=iParam0;
...
int func_33(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, int iParam8, int iParam9, int iParam10){
struct<3> Var0;
struct<3> Var3;
...
if(func_42(PLAYER::PLAYER_PED_ID()) && func_42(uParam0)){
...
float fVar6;
Var0={
func_40(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
Var3={
func_40(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__40(struct<3> Param0){
float fVar0;
float fVar1;
...
return 0;
}}}elseif(iParam1==func_49(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
while (iVar0 < iLocal_280){
if(iLocal_286[iVar0] !=0){
iLocal_280[iVar0]=PED::CREATE_PED(26, iLocal_286[iVar0], Local_299 + Local_303[iVar0 /*3*/], 0, 1, 1);
...
}}elseif(PED::GET_PED_DRAWABLE_VARIATION(iLocal_280[iVar0], 10)==1){
...
if(iLocal_293[iVar0] !=0){
uLocal_290[iVar0]=OBJECT::CREATE_OBJECT(iLocal_293[iVar0], Local_299 + Local_303[iVar0 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_HEADING(uLocal_290[iVar0], (fLocal_302 + fLocal_310[iVar0]));
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_290[iVar0], iLocal_280[iVar0], PED::GET_PED_BONE_INDEX(iLocal_280[iVar0], iLocal_296[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
iVar0++;
}
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_289, joaat("player"));
...
case 166:
Local_303[0 /*3*/]={
Vector(36.037f, -476.663f, -1050.724f) - Local_299 
};
...
case 246:
Local_303[0 /*3*/]={
Vector(4.6f, -1570.924f, -1194.77f) - Local_299 + Vector(-1f, 0f, 0f) 
};
...
case 257:
Local_303[0 /*3*/]={
Vector(7.1578f, -978.6192f, -1666.374f) - Local_299 
};
...
case 239:
Local_303[0 /*3*/]={
Vector(113.05f, 354.39f, -52.2f) - Local_299 + Vector(-1f, 0f, 0f) 
};
Local_303[1 /*3*/]={
Vector(113.05f, 354.08f, -53.18f) - Local_299 + Vector(-1f, 0f, 0f) 
};
fLocal_310[0]=-100f;
fLocal_310[1]=-100f;
iLocal_286[0]=joaat("a_m_m_business_01");
