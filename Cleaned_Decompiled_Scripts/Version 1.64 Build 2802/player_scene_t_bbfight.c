...
fLocal_501=0f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_68();
SYSTEM::WAIT(0);
func_57();
func_56();
func_52();
...
if(func_46()) func_68();
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())if(iLocal_113==258 && func_45(13)==2) func_68();
SYSTEM::WAIT(0);
switch (iLocal_112){
case 0:
if(func_43()) iLocal_112=1;
break;
case 1:
if(func_2()) iLocal_112=2;
break;
case 2:
func_1();
break;
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_489)) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_114, _GET_CURRENT_PLAYER_CHARACTER(), PLAYER::PLAYER_PED_ID(), &uLocal_489, 0, 1);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_493)) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_114, CHAR_ALL_PLAYERS_CONF, iLocal_280[0], &uLocal_493, 0, 1);
if(_CONVERSATION_ADD_LINE(&uLocal_114, "PRSAUD", &uLocal_497, 3, 0, 0, 0)) bLocal_502=true;
}}}}}
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_299) > 100f) return true;
return false;
}
...
if(!Global_78558){
if(!PED::IS_PED_INJURED(pedParam2))if(uParam0->[echParam1 /*10*/].f_8==0) PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(pedParam2, false);
else PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(pedParam2, true);
if(!PED::IS_PED_INJURED(pedParam2))if(uParam0->[echParam1 /*10*/].f_9==0) TASK::OPEN_PATROL_ROUTE(pedParam2, 0);
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_26(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_26(character)) return func_25(character);
...
if(iLocal_113==108) uLocal_303[i /*3*/]={
{
224.5948f, 1213.4664f, 199.6328f 
}
- uLocal_299 
};
elseif(iLocal_113==109) uLocal_303[i /*3*/]={
{
5.9049f, -717.1404f, -1908.2874f 
}
- uLocal_299 
};
...
elseif(heading > 360f) heading=heading - 360f;
num6=MISC::ABSF(entityHeading - heading);
if(num6 > 45f){
if(!TASK::GET_SCRIPT_TASK_STATUS(uParam0->[i], SCRIPT_TASK_ACHIEVE_HEADING)==1) TASK::TASK_ACHIEVE_HEADING(uParam0->[i], heading, 0);
break;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_453[i /*16*/])){
uLocal_486[i]=-1;
...
j < *uParam0;
j=j + 1){
if(i !=j)if(uParam1->[j] < 10) uParam1->[j]=10;
}
...
playEnterAnim=true;
if(iLocal_113==165) playEnterAnim=false;
TASK::TASK_START_SCENARIO_IN_PLACE(uParam0->[i], &uLocal_453[i /*16*/], 0, playEnterAnim);
uLocal_486[i]=MISC::GET_GAME_TIMER();
}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_290[i])){
if(uLocal_486[i] > 0){
...
default:
break;
}}elseif(ENTITY::DOES_ENTITY_EXIST(uParam0->[i])){
if(uParam1->[i] !=-1){
for (k=0;
k < *uParam0;
k=k + 1){
if(i !=k)if(uParam1->[k] !=-1 && uParam1->[k] < 10) uParam1->[k]=10;
}
uParam1->[i]=-1;
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_290[i])){
...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(eParam0, true), vector) < fParam1 * fParam1) return true;
...
if(!_IS_NULL_VECTOR(vector2))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(eParam0, true), vector2) < fParam1 * fParam1) return true;
}}}}}
return false;
}
...
Vector3 func__31(int iParam0, int iParam1) // Position - 0x171D{
int num;
num=iParam0;
...
if(PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedParam0)) return true;
if(PED::IS_PED_IN_COMBAT(pedParam0, PLAYER::PLAYER_PED_ID())) return true;
if(func_35(pedParam0, true, false, false, false)) return true;
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(pedParam0, true), 15f)) return true;
if(PED::HAS_PED_RECEIVED_EVENT(pedParam0, 73)) return true;
for (i=0;
i < iLocal_280;
i=i + 1){
if(pedParam0 !=iLocal_280[i])if(uLocal_283[i] < 0) return true;
}
for (j=0;
j < 1;
j=j + 1){
...
angle=50f;
if(PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), angle)) return true;
}}}
return false;
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, num, num2, uParam4.f_1 * 2f, bParam8, bParam9, iParam10)) return true;
return false;
}
...
if(!bParam2){
if(func_41(pedParam0, bParam1, radius, num)) return true;
if(func_36(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_37(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_37(pedParam0, fParam1)) return true;
...
float num;
unk={
func_40(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_40(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__40(float fParam0, var uParam1, var uParam2) // Position - 0x1C97{
float num;
float num2;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false))if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(vehiclePedIsIn)) return false;
}}}
if(func_15(0) || func_15(3) || func_15(2))if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !func_47()) return true;
if(func_17(8, -1)) return true;
if(Global_2672505.f_60) return true;
if(Global_98159.f_44==1)if(Global_98159.f_46==0) return true;
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())if(STREAMING::GET_PLAYER_SWITCH_TYPE() !=3)if(STREAMING::GET_PLAYER_SWITCH_STATE() <=2 && STREAMING::GET_PLAYER_SWITCH_STATE() !=1) return true;
return false;
}
...
if(func_15(14)) return 0;
if(MISC::GET_IS_PLAYER_IN_ANIMAL_FORM()) return 0;
if(!func_50(iParam0, func_51())) return 0;
...
}elseif(eParam1==func_49(Global_100402) && eParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_55();
return;
}
...
if(iLocal_286[i]==joaat("S_M_Y_BayWatch_01"))if(PED::GET_PED_DRAWABLE_VARIATION(iLocal_280[i], PV_COMP_UPPR)==0)if(PED::GET_PED_DRAWABLE_VARIATION(iLocal_280[i], PV_COMP_DECL) !=1) PED::SET_PED_COMPONENT_VARIATION(iLocal_280[i], PV_COMP_DECL, 1, 0, 0);
elseif(PED::GET_PED_DRAWABLE_VARIATION(iLocal_280[i], PV_COMP_DECL)==1)if(PED::GET_PED_DRAWABLE_VARIATION(iLocal_280[i], PV_COMP_DECL) !=0) PED::SET_PED_COMPONENT_VARIATION(iLocal_280[i], PV_COMP_DECL, 0, 0, 0);
...
case 261:
uLocal_303[0 /*3*/]={
3.2998f, -1.8338f, 0.1366f 
};
uLocal_303[1 /*3*/]={
2.0737f, -3.6041f, 0.1348f 
};
...
if(func_34(entityCoords, 0f, 0f, 0f, false)) entityCoords={
...
i < iLocal_286;
i=i + 1){
if(iLocal_286[i] !=0) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_286[i]);
}
