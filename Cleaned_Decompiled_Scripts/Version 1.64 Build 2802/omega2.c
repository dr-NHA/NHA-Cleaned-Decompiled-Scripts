...
if(func_29(iLocal_171) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_171, 1)){
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_153[2], sLocal_149[2], 1, 0, 0);
}
if(func_29(uLocal_153[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_153[0], sLocal_149[0], 0, 0, 0);
}
if(func_29(uLocal_153[1])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_153[1], sLocal_149[1], 0, 0, 0);
}
if(func_29(PLAYER::PLAYER_PED_ID())){
...
ENTITY::FREEZE_ENTITY_POSITION(uLocal_153[0], 1);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_149[1], 0)){
ENTITY::FREEZE_ENTITY_POSITION(uLocal_153[1], 1);
}
...
}}elseif(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_157, 0)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_158, 1);
}
...
iLocal_159=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_166, Local_160, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_159, Local_163, 2, 0);
}
func_48(18, 0);
func_218(23, 0);
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_117(iVar10, 14, uVar28[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_117(iVar10, 14, uVar69[iVar1], -1) 
};
func_85(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_108(14);
if(Global_78339==1){
...
uVar0=Global_2805027[iParam0 /*3*/][func_111(iParam1)];
...
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_81.f_28[0], 0f, 0f, 0f, 1, 2000, 2500, 2000, 0);
...
func_47(4);
return 0;
}elseif(PED::IS_PED_INJURED(Local_81.f_28[0]) || PED::IS_PED_RAGDOLL(Local_81.f_28[0])){
iLocal_144=2;
func_47(4);
return 0;
...
uLocal_170=INTERIOR::GET_INTERIOR_AT_COORDS(ENTITY::GET_ENTITY_COORDS(Local_81.f_35[0], 1));
if(INTERIOR::IS_VALID_INTERIOR(uLocal_170)){
INTERIOR::PIN_INTERIOR_IN_MEMORY(uLocal_170);
iLocal_167=1;
}}}elseif(!iLocal_168){
if(INTERIOR::IS_INTERIOR_READY(uLocal_170)){
iLocal_168=1;
}}elseif(!iLocal_169){
if(func_29(Local_81.f_35[0])){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_81.f_35[0], 1) 
};
uVar3=ENTITY::GET_ENTITY_HEADING(Local_81.f_35[0]);
func_38(&(Local_81.f_35[0]));
Local_81.f_35[0]=VEHICLE::CREATE_VEHICLE(joaat("dune2"), Var0, uVar3, 1, 1, 0);
INTERIOR::UNPIN_INTERIOR(uLocal_170);
iLocal_169=1;
}}}
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_81.f_28[0], uLocal_145);
}
...
void func_251(){
uLocal_153[0]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2333.23f, 2574.97f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_l"), 1, 0, 1);
uLocal_153[1]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2329.65f, 2576.64f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_r"), 1, 0, 1);
...
Global_78341[1 /*14*/]={
func_117(iVar0, iParam1, uVar31[iParam1], -1) 
};
