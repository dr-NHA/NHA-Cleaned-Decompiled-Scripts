...
PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_109[0 /*3*/], Local_109[1 /*3*/], 8.25f, 0, 0, 1);
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_43.f_14, 8.5f, 0, 0, 0, 0, 0, 0, 0);
...
bVar0=false;
while (bVar0 < 5){
if(MISC::IS_BIT_SET(iLocal_99, bVar0)){
iVar1++;
}
bVar0++;
}
...
Vector3 func__50(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7){
if(bParam7){
...
if(iLocal_104==0){
if(func_65(iVar0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_43.f_6[0 /*3*/], Local_43.f_6[1 /*3*/], Local_43.f_6.f_7, 0, 1, 0)){
...
elseif((MISC::GET_GAME_TIMER() - iLocal_106) > 500){
if(iLocal_103==0){
HUD::CLEAR_PRINTS();
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_43.f_6[0 /*3*/], Local_43.f_6[1 /*3*/], Local_43.f_6.f_7, 0, 1, 0) && func_48(&Local_43)){
