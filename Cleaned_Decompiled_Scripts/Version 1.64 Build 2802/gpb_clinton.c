...
if(func_26(character)) return func_29(character);
...
var func__84(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2DD9{
...
Vector3 func__88(float fParam0, var uParam1, var uParam2) // Position - 0x2F00{
float num;
float num2;
