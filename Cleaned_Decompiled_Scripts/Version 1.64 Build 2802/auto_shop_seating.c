...
var func__76(var uParam0, var uParam1){
...
func_83(&(uParam0->f_7), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
func_83(&(uParam0->f_7), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("auto_shop_seating", Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10, 1, 0)){
return 0;
}
...
uParam1->f_16[iParam2 /*14*/].f_6.f_1={
func_105(func_103(), func_106(iParam3, fVar3)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_105(func_102(), func_106(iParam3, fVar3)) + Var0 
};
}
...
case 0:
*uParam1={
-1356.109f, 137.168f, -96.12f 
};
*uParam2=180f;
break;
case 1:
*uParam1={
-1353.853f, 138.379f, -96.12f 
};
*uParam2=-92.52f;
break;
case 2:
*uParam1={
-1354.324f, 147.343f, -100.194f 
};
*uParam2=90f;
break;
case 3:
*uParam1={
-1354.025f, 146.018f, -100.194f 
};
*uParam2=125f;
break;
case 4:
*uParam1={
-1353.006f, 145.343f, -100.194f 
};
*uParam2=173.36f;
break;
}}else{
