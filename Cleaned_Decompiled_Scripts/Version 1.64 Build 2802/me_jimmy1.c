...
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_394[iVar0])){
if(PED::IS_PED_INJURED(uLocal_394[iVar0])){
func_2(5);
}}
iVar0++;
}}
...
func_2(2);
}elseif(func_42(iLocal_392) && func_42(PLAYER::PLAYER_PED_ID())){
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_392, 1), 2f) && !FIRE::IS_EXPLOSION_IN_SPHERE(13, ENTITY::GET_ENTITY_COORDS(iLocal_392, 1), 2f)){
PED::SET_PED_CAN_RAGDOLL(iLocal_392, 1);
PED::SET_PED_TO_RAGDOLL(iLocal_392, 500, 1000, 0, 0, 0, 0);
ENTITY::SET_ENTITY_HEALTH(iLocal_392, 99, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_392, 1, 0);
func_2(2);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_392, PLAYER::PLAYER_PED_ID(), 1)){
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_392, joaat("script_task_hands_up"))==1){
...
}elseif(func_42(iLocal_392) && ENTITY::IS_ENTITY_AT_COORD(iLocal_392, Local_380, 50f, 50f, 50f, 0, 1, 0)){
func_50(iLocal_392);
}else{
func_53(&iLocal_392, 1, 0, 1);
}}
...
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_403, 0);
}
if(bParam0){
func_48(&iLocal_403);
}else{
...
PED::SET_PED_RESET_FLAG(iLocal_392, 60, 1);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_392, uVar1);
...
iLocal_457=-1;
bLocal_300=false;
if((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) || (PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 1) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_392))) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(iLocal_392)){
func_86(500, 1);
SYSTEM::WAIT(1000);
...
if(func_42(iLocal_392)){
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_392, -1375.82f, 362.3f, 64.17f, 0, 0, 1);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_392, uVar2);
...
if(!func_27()){
if(((func_49(iLocal_403) && func_42(iLocal_392)) && PED::IS_PED_IN_VEHICLE(iLocal_392, iLocal_403, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, 0, 0)){
if(func_45(&uLocal_107, "MEJ1AUD", "MEJ1_HOME2", 7, 0, 0, 0) || func_44(&iLocal_457, 5000)){
iLocal_389=2;
}}elseif(func_45(&uLocal_107, "MEJ1AUD", "MEJ1_HOME", 7, 0, 0, 0) || func_44(&iLocal_457, 5000)){
iLocal_389=2;
}}
if(func_83(1000)){
bLocal_300=true;
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_392, uVar3);
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_78(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_142(iVar10, iParam1, iParam2, -1) 
};
if(!func_141(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_142(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_121(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_142(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_142(iVar10, iVar0, func_100(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_121(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_142(iVar10, 14, uVar69[iVar1], -1) 
};
func_111(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_134(14);
if(Global_78339==1){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78341[1 /*14*/]={
func_142(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
return 0;
}
...
if(func_42(iLocal_392)){
TASK::CLEAR_PED_TASKS(iLocal_392);
ENTITY::SET_ENTITY_COORDS(iLocal_392, Local_293, 1, 0, 0, 1);
...
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_392, 1);
PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_392, 0);
}
iLocal_389=1;
break;
case 1:
...
func_223();
if(func_42(iLocal_392)){
PED::SET_PED_RESET_FLAG(iLocal_392, 124, 1);
}}
...
break;
case 2:
uLocal_273=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_273, 0f);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_273, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_322=0;
iLocal_323=-1;
iLocal_274=12;
break;
case 3:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273)){
if(iLocal_277 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7)){
iLocal_274=14;
}else{
switch (func_225()){
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=5;
break;
case 5:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >=0.9f){
uLocal_273=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_273, 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=6;
}}
break;
case 6:
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "exit_left", 8f, -8f, 4, iLocal_276, 1148846080, 0);
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=9;
break;
case 9:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273)){
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=10;
}}
break;
case 10:
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "exit_right", 8f, -8f, 4, iLocal_276, 1148846080, 0);
if(iLocal_277 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_403, 7)){
iLocal_274=13;
}else{
iLocal_274=12;
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "back", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=3;
}}
break;
case 13:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >=0.7f){
iLocal_274=14;
}}
break;
case 14:
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "exit_back", 4f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=15;
break;
case 15:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >=0.95f){
uLocal_273=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_273, 0f);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_273, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 1);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "enter_backseat", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=16;
}}else{
uLocal_273=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_273, 0);
...
case 16:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_273)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_273) >=0.85f){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_392, -4f, 1);
...
break;
case 17:
if(PED::IS_PED_IN_VEHICLE(iLocal_392, iLocal_403, 0) && iLocal_277){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_403, 0)){
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_403, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) 
};
if(Var0.f_1 < -1f){
return 1;
}elseif(Var0.f_0 < -1f){
...
if(func_42(iLocal_392)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 0)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(iLocal_392, 0);
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
...
int func_231(){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 0)){
return 0;
}
return 1;
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(func_49(iVar0) && PED::IS_PED_IN_VEHICLE(iLocal_392, iVar0, 0)){
return 1;
}}
return 0;
}
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_383 - Vector(10f, 10f, 10f), Local_383 + Vector(10f, 10f, 10f), 0, 1);
MISC::CLEAR_AREA_OF_VEHICLES(Local_383, 10f, 0, 0, 0, 0, 0, 0, 0);
}else{
...
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_392, 1);
PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_392, 0);
ENTITY::SET_ENTITY_PROOFS(iLocal_392, 1, 0, 0, 0, 1, 0, 0, 0);
PED::SET_PED_CAN_RAGDOLL(iLocal_392, 1);
}
...
void func_250(){
if((iLocal_372 < 12 && MISC::GET_GAME_TIMER() > iLocal_358) && func_42(uLocal_394[0])){
if(func_226(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 30f){
if(!func_27() && func_230()){
...
void func_253(){
if(((((iLocal_375 && ENTITY::DOES_ENTITY_EXIST(uLocal_394[0])) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[1])) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[2])) && func_42(iLocal_392)) && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
...
if(func_314()){
*uParam0=func_296(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_294()==0){
return MISC::IS_BIT_SET(func_138(func_293(iParam0), -1, 0), iParam1);
}}else{
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_297(iVar0, 0), 1);
...
Vector3 func__297(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_301(2, 2);
}elseif(func_300(Global_1853747)){
...
Vector3 func__301(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_303(Var18, -Var0.f_3.f_2) 
};
Var18={
func_303(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__303(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_321(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
ENTITY::SET_ENTITY_VISIBLE(iLocal_403, 1, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_403, 1);
iVar0=0;
iVar0=0;
while (iVar0 < 3){
ENTITY::SET_ENTITY_VISIBLE(uLocal_394[iVar0], 1, 0);
iVar0++;
}
ENTITY::SET_ENTITY_VISIBLE(iLocal_392, 1, 0);
PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_392, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_403, 12f);
TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_394[0], iLocal_403, 12f, 786468);
...
if(func_49(iLocal_403) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[0])){
if(iLocal_322 && MISC::GET_GAME_TIMER() > iLocal_323){
VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(iLocal_403, 1);
iLocal_322=0;
}
func_356(&uLocal_40, iLocal_403, 0, 0, 1, 1, 1);
if((((((((((ENTITY::GET_ENTITY_HEALTH(iLocal_403) < 850 || func_355()) || func_353()) || func_352(iLocal_403, &uLocal_454, &uLocal_456, &uLocal_453, &fLocal_455, 6, 1082130432)) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_403) < 50f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_403) < 50f) || (func_42(uLocal_394[0]) && !PED::IS_PED_IN_VEHICLE(uLocal_394[0], iLocal_403, 0))) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 2, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_403, 1, 5000)){
if(AUDIO::IS_MOBILE_PHONE_CALL_ONGOING()){
func_208();
}
if(func_42(uLocal_394[0])){
TASK::TASK_VEHICLE_TEMP_ACTION(uLocal_394[0], iLocal_403, 20, 1000);
}
VEHICLE::BRING_VEHICLE_TO_HALT(iLocal_403, 20f, 1, 0);
...
ENTITY::SET_ENTITY_HEALTH(iLocal_392, 99, 0);
func_2(2);
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_403)){
STREAMING::REMOVE_ANIM_DICT("missfam3");
if(FIRE::IS_ENTITY_ON_FIRE(iLocal_403)){
PED::SET_PED_CAN_RAGDOLL(iLocal_392, 1);
PED::SET_PED_TO_RAGDOLL(iLocal_392, 500, 1000, 0, 0, 0, 0);
...
if(PED::IS_PED_IN_VEHICLE(uLocal_394[iVar2], iLocal_403, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 257);
}
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar3);
TASK::TASK_PERFORM_SEQUENCE(uLocal_394[iVar2], uVar3);
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
if(iVar2==0 && !func_353()){
func_28();
func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_1", 7, 1, 0);
}elseif(((iVar2==1 && !func_42(uLocal_394[0])) || ((iVar2==2 && !func_42(uLocal_394[0])) && !func_42(uLocal_394[1]))) && !func_353()){
func_351(&uLocal_107, 6, uLocal_394[iVar2], "MEJimmyKidnapper2", 1, 1);
func_28();
func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_2", 7, 0, 0);
}elseif((iVar2==1 && func_42(uLocal_394[0])) || (iVar2==2 && (func_42(uLocal_394[0]) || func_42(uLocal_394[1])))){
...
func_67(&iLocal_391);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_403, 0);
...
func_344();
}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_403, 0)){
iLocal_277=1;
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS")){
AUDIO::STOP_AUDIO_SCENE("M_E_JIMMY_STOP_KIDNAPPERS");
}
...
func_344();
}}elseif(func_227(PLAYER::PLAYER_PED_ID(), iLocal_403, 1) < (5f - 1f)){
iLocal_277=1;
func_344();
}}
break;
...
if(func_42(iLocal_392)){
PED::SET_PED_RESET_FLAG(iLocal_392, 249, 1);
PED::SET_PED_RESET_FLAG(iLocal_392, 248, 1);
PED::SET_PED_RESET_FLAG(iLocal_392, 124, 1);
}
func_223();
func_244();
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_350(iParam3), 0);
}
...
int iVar0;
int iVar1;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_49(iLocal_403)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(func_49(iVar0)){
...
iVar0=0;
if(VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_403, 0, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_403, 1, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_403, 4, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_403, 5, 0)){
iVar0++;
}
if(iVar0 > 2){
iLocal_440=1;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_365(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(!func_379(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_377(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_378(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
iLocal_315=0;
}}elseif(func_45(&uLocal_107, "MEJ1AUD", "MEJ1_CALL", 7, 0, 0, 0)){
iLocal_312=MISC::GET_GAME_TIMER() + 10000;
}}}}}
...
void func_386(){
bool bVar0;
if((func_42(PLAYER::PLAYER_PED_ID()) && func_42(uLocal_394[0])) && func_49(iLocal_403)){
if(iLocal_310==-1 && iLocal_311==-1){
if(!bLocal_313){
bLocal_313=ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_403, PLAYER::PLAYER_PED_ID());
}
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_403, PLAYER::PLAYER_PED_ID(), 1) || bLocal_313){
func_208();
func_28();
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_394[0], iLocal_403, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 0f, 3);
iLocal_274=2;
fLocal_386=200f;
fLocal_387=500f;
}}elseif(func_226(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_403)){
...
iLocal_316=0;
}}}elseif(((iLocal_310 < 8 && func_226(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 50f) && !func_27()) && !func_385("MEJ1_02", 0, 0)){
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_403, 0f, -20f, 0f) 
};
if(func_391(PLAYER::PLAYER_PED_ID(), Var0, 20f, 1)){
iVar3=MISC::GET_RANDOM_INT_IN_RANGE(1, uLocal_394);
...
HUD::SET_BLIP_ROUTE(iLocal_391, 1);
...
break;
case 1:
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_377, 1) < 1400f){
iLocal_389=2;
}
break;
case 2:
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_409, Local_412, fLocal_433, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_415, Local_418, fLocal_434, 0, 1, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_403, Local_405, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_421, Local_424, fLocal_433, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_427, Local_430, fLocal_434, 0, 1, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_403, Local_405, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
return 1;
}}
...
iLocal_394[iVar0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_403, 4, iLocal_402, iLocal_398[iVar0], 1, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_394[iVar0], 1);
ENTITY::SET_ENTITY_VISIBLE(iLocal_394[iVar0], 0, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_394[iVar0], 2, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_394[iVar0], 128, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_394[iVar0], 65536, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_394[iVar0], 17, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_394[iVar0], 1);
if(iVar0==0){
...
ENTITY::SET_ENTITY_VISIBLE(iLocal_392, 0, 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_392, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_392, 29, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_392, 116, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_392, 104, 1);
TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_392, 1);
TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_392, 1);
PED::SET_PED_HELMET(iLocal_392, 0);
ENTITY::SET_ENTITY_PROOFS(iLocal_392, 1, 0, 0, 1, 1, 0, 0, 0);
PED::SET_PED_CAN_RAGDOLL(iLocal_392, 0);
PED::SET_PED_RESET_FLAG(iLocal_392, 249, 1);
PED::SET_PED_RESET_FLAG(iLocal_392, 248, 1);
PED::SET_PED_RESET_FLAG(iLocal_392, 124, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_392, 1);
PED::SET_PED_DIES_IN_WATER(iLocal_392, 1);
PED::SET_PED_DIES_IN_SINKING_VEHICLE(iLocal_392, 1);
func_351(&uLocal_107, 3, iLocal_392, "JIMMY", 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID(), uLocal_393);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_392, uLocal_393);
ENTITY::SET_ENTITY_COLLISION(iLocal_392, 0, 0);
uLocal_273=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_273, 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_273, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_273, iLocal_403, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_403, sLocal_275));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_392, uLocal_273, sLocal_272, "base", 8f, -8f, 4, iLocal_276, 1148846080, 0);
iLocal_274=0;
}}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_404)){
iLocal_403=VEHICLE::CREATE_VEHICLE(iLocal_404, Local_405, fLocal_408, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOURS(iLocal_403, 22, 22);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_403, 0, 8);
ENTITY::SET_ENTITY_VISIBLE(iLocal_403, 0, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_403, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_404, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_404);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_403, 1, 1);
VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(iLocal_403, 0);
iLocal_322=0;
iLocal_323=-1;
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_403, "M_E_JIMMY_ENEMY_VEHICLE_GROUP", 0);
}}
...
if(func_42(PLAYER::PLAYER_PED_ID())){
uLocal_393=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
func_534(1);
...
break;
case 3:
func_404(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
ENTITY::SET_ENTITY_COLLISION(iLocal_392, 1, 0);
if(bParam0){
if((func_49(iLocal_403) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, -1, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_403, 0, 0)){
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_403, -1);
PED::SET_PED_INTO_VEHICLE(iLocal_392, iLocal_403, 0);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_403, 1, 1, 0);
}}else{
Var2={
func_414() 
};
...
if((func_49(iVar1) && VEHICLE::IS_VEHICLE_SEAT_FREE(iVar1, 0, 0)) && func_42(iLocal_392)){
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_216(iParam0, 0, 0)) || func_216(iParam0, 1, 0)) || func_216(iParam0, 2, 0)) || func_263(iParam0) !=145) || func_485(iParam0)) || func_484(iParam0)) || func_448(iParam0)) || func_483(iParam0)) || !func_482(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_484(iParam0)){
}
if(func_484(iParam0)){
}
...
}elseif(func_494(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, iVar1, ((*uParam1)[iVar0] - 1), false);
}}}
iVar0++;
}
if(func_474(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_492(*uParam0, ((*uParam1)[38] - 1))){
VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_492(*uParam0, ((*uParam1)[38] - 1)), false);
}
func_491(uParam0);
if(func_490(*uParam0)){
...
}elseif((!func_510(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_511(iParam0, uVar1[iVar6], 1) && func_427(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_289(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_268(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_268(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_268(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_268(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_268(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_268(iVar6))){
}else{
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_268(iVar7 + 1))){
...
CAM::SET_WIDESCREEN_BORDERS(0, 0);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_383 - Vector(10f, 10f, 10f), Local_383 + Vector(10f, 10f, 10f), 1, 1);
func_534(0);
