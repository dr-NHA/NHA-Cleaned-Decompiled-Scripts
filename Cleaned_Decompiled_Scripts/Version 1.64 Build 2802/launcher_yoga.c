...
elseif(!func_86(uLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_42(&iLocal_96);
...
void func_75(){
if(!ENTITY::DOES_ENTITY_EXIST(Local_120.f_0)){
Local_120.f_0=OBJECT::CREATE_OBJECT(Local_120.f_1, Local_120.f_2, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_120.f_0, Local_120.f_2, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(Local_120.f_0, Local_120.f_5, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(Local_120.f_0, 1);
}}
