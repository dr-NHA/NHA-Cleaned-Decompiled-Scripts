...
if(character==CHAR_TREVOR) return 10;
elseif(character==CHAR_MICHAEL) return 3;
return 5;
}
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_Trevor_WhaHellHolaAmigo", 64);
elseif(character==CHAR_MICHAEL) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_Michael_HeyBroKeepFighting", 64);
elseif(character==CHAR_FRANKLIN) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_Franklin_HeyWhatsCrackinMan", 64);
return;
}
...
var func__83(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2D48{
...
Vector3 func__87(float fParam0, var uParam1, var uParam2) // Position - 0x2E6F{
float num;
float num2;
