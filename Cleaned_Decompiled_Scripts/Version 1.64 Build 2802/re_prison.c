...
func_88();
Local_312={
ENTITY::GET_ENTITY_COORDS(iLocal_311, 1) 
};
switch (iLocal_310){
case 0:
func_86();
...
return 1;
}}}}}}elseif(SYSTEM::VDIST2(Param0, Param3) > 62500f){
return 1;
}
return 0;
}
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_570, 0f, 4f, -2f) 
};
...
if(bLocal_572){
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_569, 1) 
};
if(SYSTEM::VDIST2(Local_312, Var3) < 90000f){
if(!iLocal_573){
iLocal_573=1;
}}}}elseif(HUD::DOES_BLIP_EXIST(uLocal_571)){
HUD::REMOVE_BLIP(&uLocal_571);
}}}
...
}}}elseif(HUD::DOES_BLIP_EXIST(Local_629.f_36[iVar0])){
...
if(!Local_629.f_22[0]){
if(!PED::IS_PED_INJURED(Local_629.f_31[0])){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[0], Local_629.f_27[1], -2f, 0f, 0f, 1f, -1, 1036831949, 1);
}}
if(!Local_629.f_22[1]){
if(!PED::IS_PED_INJURED(Local_629.f_31[1])){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[1], Local_629.f_27[1], -1f, 0f, 0f, 1f, -1, 1036831949, 1);
}}}}
if(!PED::IS_PED_INJURED(Local_629.f_27[2])){
if(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_629.f_27[2])){
if(!Local_629.f_22[2]){
if(!PED::IS_PED_INJURED(Local_629.f_31[2])){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[2], Local_629.f_27[2], 1f, 0f, 0f, 1f, -1, 1036831949, 1);
}}
if(!Local_629.f_22[3]){
if(!PED::IS_PED_INJURED(Local_629.f_31[3])){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_629.f_31[3], Local_629.f_27[2], -1f, 0f, 0f, 1f, -1, 1036831949, 1);
}}}}}
...
if((((func_16(Local_318.f_64[iVar0], 0, &Local_128, &uLocal_135, 0, 1, 0, 1, 1) || MISC::IS_BULLET_IN_AREA(Local_318[iVar0 /*3*/], 20f, 1)) || MISC::IS_SNIPER_BULLET_IN_AREA(Local_318[iVar0 /*3*/] - Vector(20f, 20f, 20f), Local_318[iVar0 /*3*/] + Vector(20f, 20f, 20f))) || iLocal_418) || func_32(&(Local_318.f_64[iVar0]))){
if(!func_2(5)){
...
}}}elseif(HUD::DOES_BLIP_EXIST(Local_318.f_75[iVar0])){
...
Var1={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_408[iVar0], 0f, 3.5f, -2f) 
};
TASK::TASK_VEHICLE_AIM_AT_COORD(uLocal_408[iVar0], Var1);
...
iVar0=0;
while (iVar0 < 12){
uLocal_52[iVar0]=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_65[iVar0 /*3*/], 10f, 10f, 10f, 0f, 0, 7);
iVar0++;
}
iLocal_102=1;
}}
...
PED::SET_PED_IS_AVOIDED_BY_OTHERS(Local_629.f_27[iVar0], 0);
...
Var1={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_629[1 /*3*/], Local_629.f_10[1], -2f, 0f, 0f) 
};
Var4={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_629[1 /*3*/], Local_629.f_10[1], -1f, 0f, 0f) 
};
Var7={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_629[2 /*3*/], Local_629.f_10[2], 1f, 0f, 0f) 
};
Var10={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_629[2 /*3*/], Local_629.f_10[2], -1f, 0f, 0f) 
};
Local_629.f_31[0]=PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), Var1, Local_629.f_10[1], 1, 1);
Local_629.f_31[1]=PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), Var4, Local_629.f_10[1], 1, 1);
Local_629.f_31[2]=PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), Var7, Local_629.f_10[2], 1, 1);
Local_629.f_31[3]=PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), Var10, Local_629.f_10[2], 1, 1);
iVar0=0;
while (iVar0 < 4){
if(ENTITY::DOES_ENTITY_EXIST(Local_629.f_31[iVar0])){
...
void func_69(){
if(bLocal_574){
iLocal_569=VEHICLE::CREATE_VEHICLE(joaat("polmav"), 10f, 10f, -30f, 0f, 1, 1, 0);
...
if(iVar0==0){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_01", 1, 0, 1);
}elseif(iVar0==1){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_02", 1, 0, 1);
}elseif(iVar0==2){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_03", 1, 0, 1);
}elseif(iVar0==3){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_04", 1, 0, 1);
}elseif(iVar0==4){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_05", 1, 0, 1);
}elseif(iVar0==5){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_06", 1, 0, 1);
}elseif(iVar0==6){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_07", 1, 0, 1);
}elseif(iVar0==7){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_08", 1, 0, 1);
}elseif(iVar0==9){
TASK::TASK_PATROL(Local_318.f_64[iVar0], "miss_Tower_10", 1, 0, 1);
}else{
TASK::TASK_FOLLOW_WAYPOINT_RECORDING(Local_318.f_64[iVar0], Local_318.f_42[iVar0], 0, 0, -1);
}}}
iVar0++;
...
void func_92(){
if(HUD::DOES_BLIP_EXIST(uLocal_621)){
HUD::REMOVE_BLIP(&uLocal_621);
}
...
void func_95(){
if(HUD::DOES_BLIP_EXIST(uLocal_571)){
HUD::REMOVE_BLIP(&uLocal_571);
}
