...
fLocal_14=0.001f;
iLocal_17=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(2)) func_18();
num=Global_43218;
num2=15;
unk=8;
while (true){
if(Global_43257 !=15)if(Global_43220 !=0)if(Global_43219 !=-1)if(!SCRIPT::IS_THREAD_ACTIVE(Global_43220)) func_17(&Global_43219);
if(Global_43218 > 0){
Global_43223=1;
if(Global_43218==num){
num3=0;
...
i < Global_43218;
i=i + 1){
if(_CAN_ENTER_FREEROAM_STATE(Global_43224[i /*4*/].f_2)) unk[i]=0;
else unk[i]=1;
if(Global_43224[i /*4*/].f_1==7) unk[i]=1;
}
num4=0;
i=0;
for (i=0;
i < Global_43218 - 1;
i=i + 1){
if(!unk[i + 1])if(Global_43224[i + 1 /*4*/].f_1 < Global_43224[num4 /*4*/].f_1) num4=i + 1;
}
num3=num4;
if(Global_43224[num3 /*4*/].f_2==15) num3=-1;
if(num3 !=-1)if(!_CAN_ENTER_FREEROAM_STATE(Global_43224[num3 /*4*/].f_2)) num3=-1;
}
if(num3 > -1){
...
if(num2==15) func_14(false);
if(Global_43257==15) func_14(true);
Global_43223=0;
Global_38595=1;
if(Global_43257 !=5 && Global_43257 !=15) PLAYER::FORCE_CLEANUP(8);
if(Global_43257==15 || Global_43257==6) func_13(false);
else func_13(true);
...
num=func_8(*uParam0);
num2=func_6(*uParam0);
if(iParam1 < 1 || iParam1 > func_5(num, num2)) return;
...
var func__7(BOOL bParam0, var uParam1, var uParam2) // Position - 0x458{
