...
Local_70={
-3092.82f, 749.8f, 21.48f 
};
Local_73={
181.8977f, 4415.152f, 73.463f 
};
Local_76={
2743.461f, 4385.51f, 47.7521f 
};
Local_79={
-382.1346f, 2817.971f, 44.0671f 
};
Local_97={
...
func_59();
}elseif(!PED::IS_PED_RAGDOLL(iLocal_85)){
...
iLocal_159=5;
}}elseif(!PED::IS_PED_INJURED(iLocal_86)){
...
iLocal_159=2;
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_85, 0)){
...
var func__69(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
bVar0=false;
}}elseif(!func_88(func_89(iParam0), 4)){
bVar0=false;
}}
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_81() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_81() /*5568*/].f_681.f_10, iParam0);
}
...
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_85, joaat("script_task_go_to_entity"))==1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_85, joaat("script_task_go_to_entity"))==0){
TASK::CLEAR_PED_TASKS(iLocal_85);
}}}elseif(!PED::IS_PED_IN_GROUP(iLocal_85)){
...
iLocal_127=0;
}}}elseif((!iLocal_127 && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && !func_124()){
Local_134={
func_123() 
};
Local_128={
...
if(HUD::DOES_BLIP_EXIST(uLocal_121)){
HUD::REMOVE_BLIP(&uLocal_121);
}}}elseif(!HUD::DOES_BLIP_EXIST(uLocal_121)){
uLocal_121=func_69(iLocal_85, 0, 145);
}
...
if(!HUD::DOES_BLIP_EXIST(uLocal_83)){
uLocal_83=func_131(Local_93, 1);
}}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_93, 50f, 50f, 50f, 0, 1, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_83)){
HUD::REMOVE_BLIP(&uLocal_83);
}}}}


var func__131(struct<3> Param0, int iParam3){
var uVar0;
...
func_56(0);
iLocal_125=0;
}}elseif(!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_85)){
...
func_145(iLocal_171, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_185, &uLocal_188, &Local_190, &uLocal_189, &uLocal_193, 0f, 0f, 0f, 1500, 0f);
...
*uParam3=func_149(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(iParam1, 1));
func_148(iParam1, uParam4, uParam5);
}
if(!ENTITY::IS_ENTITY_OCCLUDED(iParam0)){
*uParam6=MISC::GET_GAME_TIMER();
}elseif((MISC::GET_GAME_TIMER() - *uParam6) > iParam10){
if(func_147(iParam0, iParam1, 1) > fParam11 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f){
if(!func_146(*uParam2)){
...
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_190, uLocal_189, Param7) 
};
if(!func_146(Var0)){
...
var func__149(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5){
...
if(iVar0==1){
*uParam3=func_131(ENTITY::GET_ENTITY_COORDS(*iParam2, 1), 0);
...
}elseif(ENTITY::DOES_ENTITY_EXIST(*iParam2)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam2, 0)){
if(PED::IS_PED_IN_VEHICLE(*iParam0, *iParam2, 0)){
iVar1=1;
}}}}}
...
iLocal_171=VEHICLE::CREATE_VEHICLE(iLocal_102, Local_66, func_155(Local_66, func_156(PLAYER::PLAYER_ID()), 1), 1, 1, 0);
...
}}elseif((iLocal_174 >=24 && iLocal_155 < 150000) || (iLocal_174 >=24 && iLocal_155 < 150000)){
...
bLocal_175=true;
}}elseif(iLocal_174==func_164(func_166()) && iLocal_173==func_165(func_166())){
bLocal_175=true;
}
if(bLocal_175){
func_54();
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_89);
iLocal_140++;
}}elseif(func_182(iLocal_85, PLAYER::PLAYER_PED_ID()) < 12f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_182(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f)){
fLocal_184=func_147(iLocal_85, PLAYER::PLAYER_PED_ID(), 1);
...
case 4:
if(!PED::IS_PED_INJURED(iLocal_85)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_182(iLocal_85, PLAYER::PLAYER_PED_ID()) < 25f){
if(func_127()){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_89);
iLocal_140++;
}}elseif(func_182(iLocal_85, PLAYER::PLAYER_PED_ID()) < 8f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_182(PLAYER::PLAYER_PED_ID(), iLocal_85) < 30f)){
fLocal_184=func_147(iLocal_85, PLAYER::PLAYER_PED_ID(), 1);
fLocal_184=(fLocal_184 - 0.25f);
TASK::OPEN_SEQUENCE_TASK(&uLocal_89);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
...
case 4:
if(!PED::IS_PED_INJURED(iLocal_85)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_182(iLocal_85, PLAYER::PLAYER_PED_ID()) < 15f){
if(func_127()){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
if(VEHICLE::IS_VEHICLE_SEAT_FREE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0)){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_85, func_121());
...
if((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -3024.265f, 660.8264f, 1.1982f, -3140.823f, 803.707f, 35.131f, 93f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_85)) || func_182(PLAYER::PLAYER_PED_ID(), iLocal_85) < 12f){
func_189();
iLocal_59=2;
}}}}elseif(iLocal_60==2){
if(!iLocal_167){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_85)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_85, 0)){
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_85, 95f, 95f, 50f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_85)) || func_182(PLAYER::PLAYER_PED_ID(), iLocal_85) < 12f){
func_189();
iLocal_59=2;
}}}}}
...
return 1;
}}elseif(PED::IS_PED_INJURED(iLocal_86) && ENTITY::DOES_ENTITY_EXIST(iLocal_86)){
...
if(iLocal_60==1){
Local_90={
-3086.052f, 735.5091f, 20.4883f 
};
fLocal_96=17.9234f;
Local_93={
-1053.344f, -2539.327f, 19.0394f 
};
...
Local_90={
196.7701f, 4427.757f, 72.2673f 
};
fLocal_96=75.9173f;
Local_93={
3328.828f, 5154.456f, 17.2894f 
};
...
Local_90={
2745.026f, 4386.827f, 47.8636f 
};
fLocal_96=19.4143f;
Local_93={
814.455f, 1274.797f, 359.5112f 
};
Local_104={
804.2382f, 1269.589f, 359.3557f 
};
...
Local_90={
-324.0379f, 2818.034f, 58.4498f 
};
fLocal_96=56.5422f;
Local_93={
-344.0339f, 634.4108f, 171.2902f 
};
...
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_247()) || Global_32166) || func_246()) || func_21(8, -1)) || func_243()) || func_245()) || func_244()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_247()) || Global_112695) || Global_32166) || func_246()) || func_21(8, -1)) || func_245()) || func_244()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_247()) || func_244()) || Global_112695) || Global_32166) || func_246()) || Global_44446) || func_21(8, -1)) || func_243()) || func_241()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_271(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
