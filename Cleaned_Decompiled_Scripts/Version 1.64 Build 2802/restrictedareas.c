...
if(func_35(bLocal_37, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0))){
...
if(!bLocal_56){
if(func_38(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), bLocal_37, 0, 0)){
