...
int iVar8;
Var0={
-1085.279f, -2970.573f, 12.9457f 
};
iLocal_329=0;
if(ENTITY::DOES_ENTITY_EXIST(iLocal_241)){
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_241, 0)){
func_143();
}elseif(iLocal_47==2){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_241, 0)){
if(!HUD::DOES_BLIP_EXIST(uLocal_50)){
func_142("BK_PLANE", 7500, 1);
uLocal_50=func_141(iLocal_241, 0, 0);
}
if(func_140(PLAYER::PLAYER_PED_ID(), iLocal_241, 1) > 300f){
func_143();
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_50)){
HUD::CLEAR_PRINTS();
HUD::REMOVE_BLIP(&uLocal_50);
}}}
if((((ENTITY::DOES_ENTITY_EXIST(iLocal_241) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_241, 0)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_241)) && iLocal_325) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", 0, -1)){
if(!bLocal_326){
if(PAD::IS_CONTROL_JUST_PRESSED(0, 114)){
if(iLocal_324==-1 || (MISC::GET_GAME_TIMER() - iLocal_324) > 2000){
if(!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_332)){
uLocal_332=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", iLocal_241, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
fLocal_330=0f;
}
if(func_139("LEAFLET")){
HUD::CLEAR_HELP(1);
}
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "PROPERTIES_PLANE_PROMO_MASTER", iLocal_241, 0, 0, 0);
iLocal_324=MISC::GET_GAME_TIMER();
bLocal_326=true;
}}}elseif((MISC::GET_GAME_TIMER() - iLocal_324) > 3000){
bLocal_326=false;
}}elseif(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_332)){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(uLocal_332, 0);
fLocal_330=0f;
}
if(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_332)){
if(bLocal_326){
...
GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(uLocal_332, "spawn", fLocal_330, 0);
}
switch (iLocal_47){
case 0:
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_241)){
iLocal_241=VEHICLE::CREATE_VEHICLE(joaat("stunt"), Var0, 121.2244f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_241, 1084227584);
}else{
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_241, 1, 1);
}
...
func_135(&uLocal_51, 1, 0);
iLocal_47++;
}
break;
case 1:
if(ENTITY::DOES_ENTITY_EXIST(iLocal_241) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_241, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_241, 0)){
HUD::CLEAR_PRINTS();
...
break;
case 3:
if(func_30(&uLocal_51, Local_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_241)){
func_135(&uLocal_51, 1, 0);
iLocal_47++;
}
break;
...
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_241, 0);
func_27();
break;
}
switch (iLocal_48){
...
if((10 - iLocal_323) <=0){
iLocal_48++;
}elseif((func_26() && (MISC::GET_GAME_TIMER() - iLocal_49) > 5000) && iLocal_329){
...
int func_28(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
int func_30(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, float fParam10, int iParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19){
return func_31(uParam0, Param1, func_75(), Param4, Param7, iParam11, 5, 0, 0, 0, iParam12, sParam13, func_74(), func_74(), func_74(), func_74(), sParam14, 0, bParam16, sParam15, 1, iParam17, bParam18, iParam19, func_74(), func_74(), func_74(), 1, fParam10);
}

int func_31(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, var uParam32, var uParam33, var uParam34, bool bParam35, var uParam36){
int iVar0;
bool bVar1;
int iVar2;
struct<3> Var3;
...
func_72(uParam0);
func_71();
if(func_54(uParam0, uParam0->f_17[0], uParam0->f_17[1], uParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, uParam0->f_8, bParam25, iParam18, 0, 0, uParam32, uParam33, uParam34, iParam14, bParam26)){
func_53(sParam20);
func_53(sParam21);
func_53(sParam22);
func_53(sParam23);
...
if((!func_48(uParam0, 1) && !func_47(uParam0)) && !MISC::IS_BIT_SET(uParam0->f_13, 0)){
if(bParam30){
func_46(uParam0, "LOSE_WANTED", 0);
...
uParam0->f_5=func_43(Var3, 0);
if(!iParam31==-1){
HUD::SET_BLIP_SPRITE(uParam0->f_5, iParam31);
}
if(bParam35){
func_42(uParam0->f_5, uParam0);
}}elseif(!func_41(Var3, HUD::GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0)){
...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_40()) || !func_38(uParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
func_44(uParam0->f_17[iVar9], "NEED_A_BIGGER_VEHICLE", 3);
}
...
if(func_36(1, 0, 1) || MISC::IS_BIT_SET(uParam0->f_13, 7)){
return 1;
}}}elseif(func_36(1, 0, 1) || MISC::IS_BIT_SET(uParam0->f_13, 7)){
return 1;
}
return 0;
}
...
var func__43(struct<3> Param0, int iParam3){
var uVar0;
...
void func_44(var uParam0, char* sParam1, int iParam2){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_45(iParam2), 1);
}
...
void func_46(var uParam0, char* sParam1, bool bParam2){
if(!bParam2){
...
int func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, var uParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17){
int iVar0;
int iVar1;
int iVar2;
int iVar3;
...
if(!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_40())){
if(func_68(uParam0, uParam0->f_17[iVar0], uParam8, 1)){
...
if(func_68(uParam0, uParam0->f_17[iVar0], uParam8, bParam11)){
if(!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_40())){
...
void func_56(var uParam0, char* sParam1, var uParam2, bool bParam3){
if(!bParam3){
if(!MISC::IS_STRING_NULL(sParam1)){
if(!MISC::ARE_STRINGS_EQUAL(sParam1, "")){
func_57(sParam1, uParam2, 7500, 1);
}}}
uParam0->f_10=MISC::GET_GAME_TIMER();
}


void func_57(char* sParam0, var uParam1, int iParam2, int iParam3){
iParam3=iParam3;
...
AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", 0, -1);
iLocal_327=1;
}}
if(!iLocal_328){
if(fVar0 < 300f){
...
}elseif((MISC::GET_GAME_TIMER() - uParam0->f_7) > 1000){
uParam0->f_6=1;
...
var func__77(struct<3> Param0, var uParam3, bool bParam4){
var uVar0;
...
var func__79(int iParam0, struct<3> Param1, int iParam4){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
if(iParam4==1){
if(func_131(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
void func_81(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6){
struct<60> Var0;
...
func_117(iParam5, &Var0, Param1, uParam4, func_123(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_101(iParam0, 0, 0)) || func_101(iParam0, 1, 0)) || func_101(iParam0, 2, 0)) || func_123(iParam0) !=145) || func_100(iParam0)) || func_99(iParam0)) || func_98(iParam0)) || func_97(iParam0)) || !func_85(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_99(iParam0)){
}
if(func_99(iParam0)){
}
...
void func_117(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_114(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
if(bParam1){
if(PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_40()) && uParam0->f_17[iVar0] !=PLAYER::PLAYER_PED_ID()){
PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
}}
...
float func_140(int iParam0, int iParam1, int iParam2){
struct<3> Var0;
struct<3> Var3;
...
int func_141(var uParam0, bool bParam1, bool bParam2){
...
Local_242[0 /*8*/]={
-1039.556f, -1071.264f, 150f 
};
Local_242[0 /*8*/].f_3=200f;
Local_242[1 /*8*/]={
-1014.976f, 450.128f, 150f 
};
Local_242[1 /*8*/].f_3=200f;
Local_242[2 /*8*/]={
-598.1714f, -310.67f, 150f 
};
Local_242[2 /*8*/].f_3=200f;
Local_242[3 /*8*/]={
-392.5704f, 514.8138f, 150f 
};
Local_242[3 /*8*/].f_3=200f;
Local_242[4 /*8*/]={
127.7632f, -135.7758f, 150f 
};
Local_242[4 /*8*/].f_3=200f;
Local_242[5 /*8*/]={
1033.469f, -570.8278f, 150f 
};
Local_242[5 /*8*/].f_3=200f;
Local_242[6 /*8*/]={
246.5894f, -890.811f, 150f 
};
Local_242[6 /*8*/].f_3=200f;
Local_242[7 /*8*/]={
1231.393f, -1694.348f, 150f 
};
Local_242[7 /*8*/].f_3=200f;
Local_242[8 /*8*/]={
424.9531f, -1904.325f, 150f 
};
Local_242[8 /*8*/].f_3=200f;
Local_242[9 /*8*/]={
-22.4342f, -1414.275f, 160f 
};
...
fVar1=0f;
MISC::GET_GROUND_Z_FOR_3D_COORD(Local_242[iVar0 /*8*/], &fVar1, 0, 0);
