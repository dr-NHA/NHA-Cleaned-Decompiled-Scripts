...
func_119();
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19)) func_114(0);
if(func_111(func_113(SCRIPT::GET_THIS_SCRIPT_NAME()))) func_114(0);
if(!func_110()) func_114(0);
if(!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) func_114(0);
if(func_109()) func_114(0);
if(func_108()) func_114(0);
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_107()) func_114(0);
if(MISC::GET_GAME_TIMER() < Global_32428 + 10000 && !func_107()) func_114(0);
...
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_114(1);
num6=func_97(PLAYER::PLAYER_PED_ID(), pedLocal_240);
if(num6 < 10f && func_96()) PED::SET_IK_TARGET(pedLocal_240, 1, PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
...
if(bLocal_506){
if(bLocal_507) GRAPHICS::DRAW_DEBUG_TEXT_2D("controlledByAnim", 0.02f, 0.5f, 0f, 0, 0, 255, 255);
...
if(func_85(pedLocal_240, PLAYER::PLAYER_PED_ID(), true) < 25f)if(!HUD::DOES_BLIP_EXIST(blLocal_248)) func_81(&blLocal_248, &pedLocal_240, false);
elseif(HUD::DOES_BLIP_EXIST(blLocal_248)) func_80(&blLocal_248);
if(!bLocal_439){
...
if(func_78(num7))if(!func_77(num7)) func_68(hashKey, false);
}}}
switch (iLocal_250){
case 0:
...
if(bLocal_506)if(flag3) GRAPHICS::DRAW_DEBUG_TEXT_2D("conversationAlreadyOngoing", 0.8f, 0.1f, 0f, 0, 0, 255, 255);
else GRAPHICS::DRAW_DEBUG_TEXT_2D("NOT conversationAlreadyOngoing", 0.8f, 0.1f, 0f, 0, 0, 255, 255);
if(func_61() && !flag3 && !func_60()) iLocal_250=3;
if(!func_63()) func_102(0, true);
break;
case 5:
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(pedLocal_240, &uLocal_372, &uLocal_356, 3)) func_53(Global_113593[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(pedLocal_240, &uLocal_372, &uLocal_356));
}
break;
case 9:
...
if(bLocal_505) Global_113593[iLocal_251]=iLocal_504;
...
if(num6 > 10f && _CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_14();
iLocal_250=16;
}else{
if(!bLocal_438){
func_28(&uLocal_404);
...
if(func_78(num8))if(!func_77(num8)) func_68(MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()), false);
...
if(HUD::DOES_BLIP_EXIST(blLocal_248)) func_80(&blLocal_248);
flag7=false;
while (true){
GRAPHICS::DRAW_DEBUG_TEXT_2D("do_monologue=FALSE", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
if(bLocal_506) GRAPHICS::DRAW_DEBUG_TEXT_2D("WAITING TO CLEAN UP", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_240)){
if(!bLocal_441) func_98(func_113(SCRIPT::GET_THIS_SCRIPT_NAME()));
func_114(0);
}
...
if(ENTITY::IS_ENTITY_OCCLUDED(pedLocal_240) && func_85(pedLocal_240, PLAYER::PLAYER_PED_ID(), true) > 50f && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_114(1);
SYSTEM::WAIT(0);
}
return;
}
...
if(Global_113593[iLocal_251]==3 && iLocal_297 >=4 && iLocal_297 <=12) return 1;
return 0;
}
...
if(character==CHAR_TREVOR) return 19;
elseif(character==CHAR_MICHAEL) return 8;
return 7;
}
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_TREVOR_MYBROTHER", 64);
elseif(character==CHAR_MICHAEL) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_MICHAEL_OHHOWYOUDOING", 64);
elseif(character==CHAR_FRANKLIN) TEXT_LABEL_ASSIGN_STRING(sParam0, "CONVO_FRANKLIN_HEYWASSUP", 64);
return;
}
...
if(func_38(PLAYER::PLAYER_ID())) return false;
...
int num;
num=func_79(hParam0);
if(func_78(num)) func_69(num, bParam1);
return;
}
...
if(!func_73(70)) func_70("DI_HLP_SPCL" /*Unique characters become available in Rockstar Editor's 'Director Mode' as you meet them around Los Santos.*/, 2, 0, 20000, 10000, 7, 0, 210, 0);
}}}}
return;
}
...
if(func_78(iParam0)) return IS_BIT_SET(Global_113648.f_26436.f_2, iParam0);
return false;
}
...
var func__84(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2E31{
...
float num;
unk={
func_88(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_88(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__88(float fParam0, var uParam1, var uParam2) // Position - 0x2F58{
float num;
float num2;
...
if(Global_113593[iLocal_251]==3) return false;
return true;
}
...
num=func_99(iParam0);
if(func_78(num)) func_69(func_99(iParam0), false);
return;
}
...
i=i + 1){
num=i;
if(func_100(num, true)==iParam0) return num;
}
return -1;
}
...
, 4);
if(MISC::ARE_STRINGS_EQUAL(&string1, &uLocal_500)) func_14();
...
if(iLocal_298 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_298);
if(HUD::DOES_BLIP_EXIST(blLocal_248)) func_115(&blLocal_248);
func_91();
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) AUDIO::DISABLE_PED_PAIN_AUDIO(PLAYER::PLAYER_PED_ID(), false);
