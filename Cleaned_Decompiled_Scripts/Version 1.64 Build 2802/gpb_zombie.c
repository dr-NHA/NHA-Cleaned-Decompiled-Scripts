...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_240)) && fVar43 < 25f) && func_89(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")) && func_86(uLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
if(!func_90()){
func_92();
TASK::TASK_PLAY_ANIM(uLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_250=24;
...
func_53(Global_113593[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_240, &Local_372, &Local_356));
}}
break;
case 9:
...
if(bLocal_437){
iVar35=1;
}elseif(func_34(&uLocal_37, &cLocal_304, &cVar9, 3, 0, 0, 0)){
iVar35=1;
}
if(iVar35==1){
iLocal_250=11;
...
uLocal_448=OBJECT::CREATE_OBJECT(joaat("prop_npc_phone"), ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1, 1, 0);
...
void func_105(){
PED::SET_PED_CAN_EVASIVE_DIVE(uLocal_240, 0);
PED::SET_PED_CONFIG_FLAG(uLocal_240, 185, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_240, 318, 1);
}
