...
Var0=2;
Var8={
func_20(Param0[1 /*3*/] - Param0[0 /*3*/]) * Vector(fParam8, fParam8, fParam8) 
};
Var0[0 /*3*/]={
Param0[0 /*3*/] - Var8 
};
...
Vector3 func__56(struct<3> Param0, struct<3> Param3){
...
iLocal_117[iParam0]=SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(Local_107[iParam0 /*3*/], Local_107[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 4);
}}else{
iVar0=SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_117[iParam0], &iVar8, &uVar2, &uVar5, &uVar1);
if(iVar0==2){
Local_40[iParam0 /*24*/].f_8=0;
if(iVar8 > 0){
