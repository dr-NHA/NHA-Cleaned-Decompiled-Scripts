...
iLocal_42=64;
uLocal_51={
2194.1345f, 5593.2783f, 53.703827f 
};
uLocal_73={
2203.2703f, 5549.918f, 93.09485f 
};
uLocal_76={
2199.6294f, 5640.293f, 52.23926f 
};
fLocal_79=81.5f;
uLocal_48={
uScriptParam_0.f_1[0 /*3*/] 
};
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)) func_142();
if(func_115(uLocal_48, -1, 0, false, false)) func_112(-1);
...
if(!func_111())if(func_110()) func_142();
...
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) func_23(0);
for (iLocal_125=0;
iLocal_125 < 6;
iLocal_125=iLocal_125 + 1){
if(!PED::IS_PED_INJURED(iLocal_103[iLocal_125])){
if(HUD::DOES_BLIP_EXIST(uLocal_116[iLocal_125])) HUD::REMOVE_BLIP(&uLocal_116[iLocal_125]);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_103[iLocal_125]);
}}
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
MISC::ENABLE_DISPATCH_SERVICE(DT_FireDepartment, true);
if(bLocal_89) func_3(18, 7, 0);
else func_3(18, 1, 0);
bLocal_87=true;
}
if(SYSTEM::VDIST(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), uLocal_48) > 150f) func_142();
return;
}
...
var func__6(BOOL bParam0, var uParam1, var uParam2) // Position - 0x36C{
...
num=func_7(*uParam0);
num2=func_5(*uParam0);
if(iParam1 < 1 || iParam1 > func_21(num, num2)) return;
...
break;
case 1:
if(PED::IS_PED_INJURED(iLocal_103[0]) && PED::IS_PED_INJURED(iLocal_103[1]) && PED::IS_PED_INJURED(iLocal_103[2]) && PED::IS_PED_INJURED(iLocal_103[3]) && PED::IS_PED_INJURED(iLocal_103[4])) func_25();
elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_48, 100f, 100f, 100f, false, true, 0)) func_25();
break;
}
for (iLocal_125=0;
iLocal_125 < 6;
iLocal_125=iLocal_125 + 1){
if(PED::IS_PED_INJURED(iLocal_103[iLocal_125]))if(HUD::DOES_BLIP_EXIST(uLocal_116[iLocal_125])) HUD::REMOVE_BLIP(&uLocal_116[iLocal_125]);
}
return;
}
...
_DISPLAY_HELP_TEXT("DRUG_BLIP_END" /*Try coming back in a week or so to seeifthey have made more takings.*/, -1);
...
if(func_38(iParam0)) Global_113648.f_24997.f_2=3;
if(func_37(iParam0, iParam1) !=322) func_31(func_37(iParam0, iParam1), uLocal_43, uLocal_43.f_1);
Global_113636=iParam1;
if(Global_113634==0)if(Global_113637==1 || Global_113637==5 || Global_113637==11 || Global_113637==25) func_30(2);
elseif(Global_113637==26 || Global_113637==8 || Global_113637==17) func_30(7);
else func_30(1);
}
return;
}
...
if(func_38(Global_113637)) func_59(0);
HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
if(bParam0 && func_38(Global_113637)) HUD::FLASH_MINIMAP_DISPLAY();
return 1;
}
return 0;
}
...
if(iParam4 !=0) func_63(uParam0, iParam4);
}
return 2;
}
...
if(OBJECT::DOES_PICKUP_EXIST(pkLocal_113))if(!HUD::DOES_BLIP_EXIST(blLocal_115)) blLocal_115=func_68(pkLocal_113);
}
return;
}
...
var func__69(BOOL bParam0, var uParam1, var uParam2) // Position - 0x235A{
if(bParam0) return uParam1;
return uParam2;
}
...
if(HUD::DOES_BLIP_EXIST(blLocal_114)) HUD::REMOVE_BLIP(&blLocal_114);
SYSTEM::SETTIMERA(0);
bLocal_100=true;
iLocal_127=2;
iLocal_47=1;
...
if(iLocal_128==0) iLocal_128=MISC::GET_GAME_TIMER();
else iLocal_129=MISC::GET_GAME_TIMER();
}else{
iLocal_129=0;
iLocal_128=0;
}
...
PED::SET_PED_KEEP_TASK(iLocal_103[iLocal_125], true);
if(!HUD::DOES_BLIP_EXIST(uLocal_116[iLocal_125])) uLocal_116[iLocal_125]=func_72(iLocal_103[iLocal_125], true, 145);
}
}
if(!bLocal_99){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
...
i < iLocal_110;
i=i + 1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_110[i], false))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_110[i], PLAYER::PLAYER_PED_ID(), true)) return true;
}
for (i=0;
i < iLocal_103;
i=i + 1){
if(!PED::IS_PED_INJURED(iLocal_103[i])){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_103[i], PLAYER::PLAYER_PED_ID()))if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_103[i]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_103[i])) return true;
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true), 5f, true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_103[i], PLAYER::PLAYER_PED_ID(), true) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_103[i]) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) -{
15f, 15f, 15f 
}
, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) +{
15f, 15f, 15f 
}
, joaat("WEAPON_SMOKEGRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) -{
15f, 15f, 15f 
}
, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) +{
15f, 15f, 15f 
}
, joaat("WEAPON_GRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) -{
15f, 15f, 15f 
}
, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) +{
15f, 15f, 15f 
}
, joaat("WEAPON_GRENADELAUNCHER"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) -{
15f, 15f, 15f 
}
, ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) +{
15f, 15f, 15f 
}
, joaat("WEAPON_STICKYBOMB"), true)) return true;
}}
if(FIRE::IS_EXPLOSION_IN_ANGLED_AREA(-1, uLocal_73, uLocal_76, fLocal_79)) return true;
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_73, uLocal_76, fLocal_79, false, true, 0))if(PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) return true;
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2202.4976f, 5603.4243f, 52.7476f, 20f, 20f, 20f, false, true, 0))if(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 15f) return true;
return false;
}
...
PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_48 -{
20f, 50f, 50f 
}
, uLocal_48 +{
20f, 50f, 50f 
...
uLocal_54[1 /*3*/]={
2210.5842f, 5580.6836f, 52.8132f 
};
uLocal_80[1]=300.5012f;
uLocal_54[2 /*3*/]={
2201.3025f, 5589.2793f, 52.9354f 
};
uLocal_80[2]=53.1602f;
uLocal_54[3 /*3*/]={
2202.5352f, 5613.3667f, 52.6781f 
};
uLocal_80[3]=70f;
uLocal_54[4 /*3*/]={
...
if(iLocal_126==0) WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], joaat("WEAPON_SAWNOFFSHOTGUN"), -1, true, true);
elseif(iLocal_126==1) WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], joaat("WEAPON_MICROSMG"), -1, true, true);
else WEAPON::GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], joaat("WEAPON_ASSAULTRIFLE"), -1, true, true);
...
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_109()) return false;
}
if(func_105()) return true;
if(func_99(100f, true) !=-1) return true;
return false;
}
...
if(func_108() && !func_109()) return true;
if(func_107() && func_106()) return true;
return false;
}
...
if(func_105()) return true;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_109()) return false;
if(func_99(100f, true) !=-1) return true;
return false;
}
BOOL func_111() // Position - 0x5AFF{
if(Global_113637==func_53() && MISC::GET_RANDOM_EVENT_FLAG() && Global_113638) return true;
return false;
}
...
if(func_105()) return false;
if(func_140()) return false;
if(Global_113637 !=-1) return false;
if(func_46(_GET_CURRENT_PLAYER_CHARACTER()))if(func_99(100f, true) !=-1) return false;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !bParam6)if(entityCoords.f_2 - uLocal_43.f_2 > 50f) return false;
if(!func_139(iParam3)) return false;
if(func_46(_GET_CURRENT_PLAYER_CHARACTER()))if(func_138(_GET_CURRENT_PLAYER_CHARACTER())==4 || func_138(_GET_CURRENT_PLAYER_CHARACTER())==5) return false;
if(func_46(_GET_CURRENT_PLAYER_CHARACTER()))if(!func_137(iParam3, iParam4, 145)) return false;
if(!func_136(Global_113648.f_24997.f_43[iParam3])) return false;
if(MISC::GET_GAME_TIMER() - Global_113639 < 150000)if(iParam3 !=30) return false;
if(func_135()) return false;
if(MISC::GET_MISSION_FLAG()) return false;
if(MISC::GET_RANDOM_EVENT_FLAG()) return false;
if(!func_126(4)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(5)) return false;
if(func_125(iParam3, iParam4) && !bParam5) return false;
...
if(iParam3==9 && iParam4==2 || iParam4==5 && !func_125(0, 0)) return false;
if(Global_32310) return false;
if(func_139(30) && !func_125(30, 0))if(iParam3 !=30)if(SYSTEM::VDIST2(entityCoords, -61.2745f, -1100.4675f, 25.3752f) < 176400f) return false;
if(func_46(_GET_CURRENT_PLAYER_CHARACTER())){
for (i=CHAR_MICHAEL;
i < CHAR_MULTIPLAYER;
i=i + 1){
...
if(func_124(num))if(func_117(i))if(!func_116(vector, 0f, 0f, 0f, false))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector) < 210f * 210f)if(_GET_CURRENT_PLAYER_CHARACTER() !=i) return false;
}}}
return true;
}
...
int num;
int num2;
if(!func_124(iParam1) || !func_124(iParam0)) return 1;
num=func_5(iParam0);
num2=func_5(iParam1);
...
num6=func_8(iParam0);
if(num6 < 1 || num6 > func_21(num5, num4)) return false;
return true;
}
...
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_112695 || Global_32166 || func_133() || func_88(8, -1) || func_132() || func_131() || func_130() || func_129() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_134() || Global_32166 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_112695 || Global_32166 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_112695 || Global_32166 || func_133() || func_88(8, -1) || func_132() || func_131() || func_129() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_134() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_88(8, -1) || func_129() || func_128() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_88(8, -1) || func_132() || func_131() || func_128() || func_127()) return false;
...
break;
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_134() || Global_32166 || func_133() || func_88(8, -1) || func_131() || func_130() || func_129() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 7:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_134() || func_131() || Global_112695 || Global_32166 || func_133() || Global_44446 || func_88(8, -1) || func_130() || func_128() || func_129() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 8:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || unk_0x279D0BCF8F708D74(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_134() || Global_112695 || Global_32166 || func_133() || func_88(8, -1) || func_130() || func_128() || func_132() || func_131() || func_129()) return false;
break;
}}else{
return false;
}}else{
