...
while (true){
SYSTEM::WAIT(0);
if((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_100) || (func_111() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_48, 500f, 500f, 500f, 0, 1, 0))){
if(!func_111()){
if(func_110()){
func_142();
}}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_73, Local_76, fLocal_79, 0, 1, 0)){
func_67();
if(!bLocal_101){
...
func_25();
}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_48, 100f, 100f, 100f, 0, 1, 0)){
func_25();
}
break;
}
...
if((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_103[iLocal_125], PLAYER::PLAYER_PED_ID(), 15f, 15f, 40f, 0, 1, 0) && PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_103[iLocal_125])) || PED::CAN_PED_SEE_HATED_PED(iLocal_103[iLocal_125], PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_73, Local_76, fLocal_79, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, 0, 1, 0)){
if(!func_56()){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_103[iVar0], uLocal_124);
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_124);
TASK::TASK_PERFORM_SEQUENCE(iLocal_103[iVar1], uLocal_124);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_124);
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_73, Local_76, fLocal_79, 0, 1, 0) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_103[iLocal_125], PLAYER::PLAYER_PED_ID(), 15f, 15f, 5f, 0, 1, 0)){
func_93();
SYSTEM::WAIT(0);
if(func_92()){
func_91(&uLocal_131, 4, iLocal_103[iLocal_125], "DRUGFARMGOON", 0, 1);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_124);
TASK::TASK_PERFORM_SEQUENCE(iLocal_103[0], uLocal_124);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_124);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_124, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_124);
TASK::TASK_PERFORM_SEQUENCE(iLocal_103[1], uLocal_124);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_124);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_124, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_124);
TASK::TASK_PERFORM_SEQUENCE(iLocal_103[2], uLocal_124);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_124);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_124);
TASK::TASK_PERFORM_SEQUENCE(iLocal_103[3], uLocal_124);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_124);
...
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_124);
TASK::TASK_PERFORM_SEQUENCE(iLocal_103[4], uLocal_124);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_124);
PED::SET_PED_USING_ACTION_MODE(iLocal_103[4], 0, -1, 0);
}
if(!PED::IS_PED_INJURED(iLocal_103[5])){
TASK::TASK_GUARD_CURRENT_POSITION(iLocal_103[5], 0f, 3f, 1);
...
if((((((MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1), 5f, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_103[iVar0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_103[iVar0])) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1)){
return 1;
}}
iVar0++;
}
...
PED::ADD_SCENARIO_BLOCKING_AREA(Local_48 - Vector(20f, 50f, 50f), Local_48 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
...
uLocal_113=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), Local_51, -1.368082f, 0.230633f, 176.8749f, iVar0, MISC::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
Local_54[0 /*3*/]={
...
iLocal_125=0;
while (iLocal_125 < 6){
iLocal_103[iLocal_125]=PED::CREATE_PED(26, joaat("g_m_y_salvagoon_01"), Local_54[iLocal_125 /*3*/], fLocal_80[iLocal_125], 1, 1);
...
HUD::SET_BLIP_SPRITE(uLocal_114, 140);
func_57("DRUG_BLIP_START", -1);
iLocal_46=1;
}}


var func__97(struct<3> Param0, int iParam3){
var uVar0;
