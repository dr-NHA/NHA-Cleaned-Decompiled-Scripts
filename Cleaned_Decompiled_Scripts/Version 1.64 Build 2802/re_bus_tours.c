...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_306, 2.5f, 1.5f, 0f), 1, 0, 0, 1);
...
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
if(PED::IS_PED_INJURED(iLocal_285) || PED::IS_PED_INJURED(uLocal_286)){
func_229();
}
else{
iLocal_312=1;
...
GRAPHICS::SET_EXPOSURETWEAK(1);
}else{
iLocal_319=1;
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
GRAPHICS::SET_EXPOSURETWEAK(0);
}}}
...
}}elseif(CAM::DOES_CAM_EXIST(uLocal_328)){
CAM::DESTROY_CAM(uLocal_328, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 0, 1, 0, 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
}}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
if(!CAM::DOES_CAM_EXIST(uLocal_328) && !CAM::IS_GAMEPLAY_HINT_ACTIVE()){
...
func_31(PLAYER::PLAYER_PED_ID(), &uLocal_328, fLocal_342, 0f, fLocal_341);
CAM::SET_CAM_FOV(uLocal_328, fVar1);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_328, PLAYER::PLAYER_PED_ID(), Var7.f_0, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
}else{
uLocal_328=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_328, PLAYER::PLAYER_PED_ID(), Var7.f_0, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
CAM::SET_CAM_NEAR_CLIP(uLocal_328, 0.01f);
fLocal_341=-70f;
fLocal_342=3f;
func_31(PLAYER::PLAYER_PED_ID(), &uLocal_328, fLocal_342, 0f, fLocal_341);
CAM::SET_CAM_FOV(uLocal_328, fVar1);
...
CAM::SET_CAM_ROT(*uParam1, Var1.f_0, Var1.f_1, Var1.f_2, 2);
}}}
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_287[2], MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), 0.5f) 
};
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
MISC::CLEAR_AREA_OF_VEHICLES(Param0.f_0, Param0.f_1, Param0.f_2, 5f, 0, 0, 0, 0, 0, 0, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_306, Param0.f_0, Param0.f_1, Param0.f_2, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_306, fParam3);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_306, 0f);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_285, iLocal_306, ENTITY::GET_ENTITY_COORDS(iLocal_306, 1), 0f, 0, joaat("tourbus"), iLocal_511, 5f, 15f);
...
}}elseif(!PED::IS_PED_INJURED(iLocal_285)){
...
if(iVar0==13){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_52[iVar0 /*15*/].f_1, 30f, 30f, 15f, 0, 1, 0)){
...
elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_52[iVar0 /*15*/].f_1, 40f, 40f, 12f, 0, 1, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_306, 0)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
if(iVar1 <=13){
func_85(ENTITY::GET_ENTITY_COORDS(iLocal_306, 1), Local_52[iVar1 /*15*/].f_1, &Local_320, &Local_323, 500);
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_285, uVar2);
...
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
GRAPHICS::SET_EXPOSURETWEAK(1);
uLocal_329=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 93.8459f, 251.8829f, 110.4535f, 23.0883f, 0.101f, -61.7699f, 40f, 1, 2);
uLocal_330=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 97.0995f, 249.7653f, 109.0195f, -3f, 0f, -91.5944f, 50f, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_329, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_330, uLocal_329, 17000, 1, 1);
...
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
Var6[0 /*3*/]={
105.1253f, 247.7461f, 107.1111f 
};
Var6[1 /*3*/]={
109.2535f, 247.9478f, 107.0121f 
};
Var6[2 /*3*/]={
110.3568f, 249.2771f, 107.0133f 
};
Var6[3 /*3*/]={
104.8579f, 251.0388f, 107.1858f 
};
Var6[4 /*3*/]={
105.4064f, 248.0866f, 107.1104f 
};
fVar0[0]=269.6692f;
fVar0[1]=283.6581f;
fVar0[2]=278.7632f;
...
ENTITY::SET_ENTITY_COORDS(uLocal_287[iLocal_335], Var6[iLocal_335 /*3*/], 1, 0, 0, 1);
...
*uParam6={
*uParam6 - Vector(IntToFloat(iParam8), IntToFloat(iParam8), IntToFloat(iParam8)) 
};
*uParam7={
*uParam7 + Vector(IntToFloat(iParam8), IntToFloat(iParam8), IntToFloat(iParam8)) 
};
iLocal_318=1;
}}
...
if(AUDIO::DOES_CONTEXT_EXIST_FOR_THIS_PED(uParam0, "TOUR_ABOUT_TO_START", 0)){
return 1;
}}
return 0;
}
...
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_306, "RE_BUS_TOUR_BUS_VEHICLE", 0);
...
MISC::SET_MINIGAME_IN_PROGRESS(1);
HUD::DISPLAY_RADAR(0);
uLocal_329=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 94.5693f, 246.0525f, 108.9809f, -11.5369f, 0f, -74.512f, 40f, 1, 2);
uLocal_330=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 95.7144f, 243.8854f, 111.291f, -26.2154f, 0f, -59.2407f, 50f, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_329, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_330, uLocal_329, 6500, 1, 1);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
func_85(ENTITY::GET_ENTITY_COORDS(iLocal_306, 1), Local_52[0 /*15*/].f_1, &Local_320, &Local_323, 500);
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_99() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_99() /*5568*/].f_681.f_10, iParam0);
}
...
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_306, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_124("TX_H02")){
if(func_155()){
if(!iLocal_513){
...
uLocal_310=HUD::ADD_BLIP_FOR_ENTITY(iLocal_306);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_310, 1);
HUD::SET_BLIP_SCALE(uLocal_310, Global_32210);
if(!PED::IS_PED_INJURED(iLocal_286)){
...
char* sVar0;
*uParam0=0;
if(PED::GET_CLOSEST_PED(Local_279, 100f, 1, 0, uParam0, 0, 0, 28)){
if(!PED::IS_PED_INJURED(*uParam0)){
if(func_129(*uParam0)){
...
case 0:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_306, 3);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_306, 7);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 2:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_306, 6);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 3:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_306, 8);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 4:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_306, 1);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
}
sVar0=func_128(PED::IS_PED_MALE(*uParam0));
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_165()) || Global_112695) || Global_32166) || func_164()) || func_23(8, -1)) || func_163()) || func_162()) || func_161()) || func_160()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_165()) || Global_32166) || func_164()) || func_23(8, -1)) || func_161()) || func_163()) || func_162()) || func_160()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_165()) || Global_112695) || Global_32166) || func_164()) || func_23(8, -1)) || func_161()) || func_163()) || func_162()) || func_160()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_165()) || Global_112695) || Global_32166) || func_164()) || func_23(8, -1)) || func_163()) || func_162()) || func_160()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_165()) || Global_32166) || func_164()) || func_23(8, -1)) || func_162()) || func_161()) || func_160()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_165()) || func_162()) || Global_112695) || Global_32166) || func_164()) || Global_44446) || func_23(8, -1)) || func_161()) || func_159()) || func_160()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_165()) || Global_112695) || Global_32166) || func_164()) || func_23(8, -1)) || func_161()) || func_159()) || func_163()) || func_162()) || func_160()){
return 0;
}
break;
}}else{
...
if(!PED::IS_PED_INJURED(iLocal_285)){
if(((func_171(iLocal_285) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_285, 0)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_285)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_285)){
func_167(iLocal_286);
return 1;
}}else{
func_167(iLocal_286);
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_170(iParam2), 1);
}
...
if(func_172(uParam0, &uLocal_337, &uLocal_334, uLocal_332, bLocal_338, 1077936128, 0) || PED::IS_PED_RAGDOLL(uParam0)){
func_167(uParam0);
return 1;
}
return 0;
...
void func_180(){
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(0, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(1, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(2, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(3, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(4, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(5, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(6, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(7, 1);
MISC::SUPRESS_RANDOM_EVENT_THIS_FRAME(8, 1);
}
...
PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(Local_279, &uLocal_282, &uLocal_307, 1, 1077936128, 0);
iLocal_306=VEHICLE::CREATE_VEHICLE(joaat("tourbus"), Local_263.f_1, Local_263.f_13, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_306, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_306, 3);
ENTITY::SET_CAN_CLIMB_ON_ENTITY(iLocal_306, 0);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_327);
TASK::TASK_PLAY_ANIM(0, sLocal_509, "IDLE_A", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_509, "IDLE_B", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_509, "IDLE_C", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_327, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_327);
TASK::TASK_PERFORM_SEQUENCE(iLocal_286, uLocal_327);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_327);
func_186(&uLocal_343, 3, iLocal_286, "TOURGUIDE", 0, 1);
if(!HUD::DOES_BLIP_EXIST(uLocal_311)){
uLocal_311=HUD::ADD_BLIP_FOR_ENTITY(iLocal_306);
HUD::SET_BLIP_SPRITE(uLocal_311, 85);
}
func_185();
iLocal_48=1;
}}}
...
PED::ADD_RELATIONSHIP_GROUP("re_bus_tours1", &uLocal_309);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_285, uLocal_309);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_286, uLocal_309);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_309, joaat("player"));
}
...
struct<15> Var180;
Var0.f_1={
-24.85f, 263.6119f, 106.5301f 
};
Var0.f_4={
-62.9588f, 335.2273f, 136.055f 
};
Var0.f_7=10000;
Var0.f_8=(8f - 1f);
Var0.f_10={
-0.9281f, 266.8539f, 108.0699f 
};
Var0.f_13=82f;
Var0.f_0="BUSTO_P1";
Var15.f_1={
...
Var15.f_4={
-253.7246f, 247.9038f, 95.2063f 
};
Var15.f_7=9000;
Var15.f_8=(8f - 1f);
Var15.f_10={
-188.67f, 265.43f, 92.15f 
};
Var15.f_13=81.79f;
Var15.f_0="BUSTO_P5";
Var30.f_1={
-522.1094f, 260.8653f, 82.063f 
};
Var30.f_4={
-549.5739f, 272.7824f, 82.9753f 
};
Var30.f_7=9000;
Var30.f_8=8f;
Var30.f_10={
-435.0476f, 249.8727f, 82.0866f 
};
Var30.f_13=85f;
Var30.f_0="BUSTO_P6";
Var45.f_1={
-575.5643f, 512.5427f, 105.0293f 
};
Var45.f_4={
-586.4406f, 529.1188f, 108.8539f 
};
Var45.f_7=9000;
Var45.f_8=(8f + 2f);
Var45.f_10={
-552.3732f, 481.7021f, 102.1826f 
};
Var45.f_13=25f;
Var45.f_0="BUSTO_P7";
Var60.f_1={
-732.2224f, 474.0897f, 105.0424f 
};
Var60.f_4={
-728.4921f, 448.0321f, 107.9036f 
};
Var60.f_7=9000;
Var60.f_8=(8f + 3f);
Var60.f_10={
-688.5469f, 490.5489f, 108.784f 
};
Var60.f_13=105f;
Var60.f_0="BUSTO_P8";
Var75.f_1={
-1037.97f, 468.9468f, 76.7167f 
};
Var75.f_4={
-1065.762f, 469.4401f, 80.3204f 
};
Var75.f_7=9000;
Var75.f_8=(8f + 2f);
Var75.f_10={
-973.6752f, 499.3758f, 78.8246f 
};
Var75.f_13=47f;
Var75.f_0="BUSTO_P9";
Var90.f_1={
-1231.581f, 239.014f, 64.8339f 
};
Var90.f_4={
-1309.778f, 261.4181f, 65.87f 
};
Var90.f_7=9000;
Var90.f_8=(8f + 4f);
Var90.f_10={
-1168.448f, 257.0845f, 66.3477f 
};
Var90.f_13=105f;
Var90.f_0="BUSTO_P10";
Var105.f_1={
-1406.729f, -160.0764f, 46.5244f 
};
Var105.f_4={
-1421.479f, -193.5715f, 50f 
};
Var105.f_7=9000;
Var105.f_8=(8f + 4f);
Var105.f_10={
-1398.391f, -114.7998f, 50.028f 
};
Var105.f_13=178f;
Var105.f_0="BUSTO_P11";
Var120.f_1={
-1316.205f, -487.0228f, 32.3407f 
};
Var120.f_4={
-1271.75f, -500.2502f, 44.4638f 
};
Var120.f_7=9000;
Var120.f_8=(15f + 4f);
Var120.f_10={
-1356.912f, -437.5389f, 34.0665f 
};
Var120.f_13=215f;
Var120.f_0="BUSTO_P3";
Var135.f_1={
-723.1427f, -239.0515f, 36.0196f 
};
Var135.f_4={
-696.7581f, -239.2147f, 40.8147f 
};
Var135.f_7=9000;
Var135.f_8=(15f + 6f);
Var135.f_10={
-777.5432f, -262.5703f, 36.0082f 
};
Var135.f_13=290f;
Var135.f_0="BUSTO_P2";
Var150.f_1={
-690.7699f, -25.762f, 36.9897f 
};
Var150.f_4={
-695f, 22f, 53f 
};
...
Var150.f_8=(15f + 5f);
Var150.f_10={
-696.695f, -40.7958f, 36.8186f 
};
Var150.f_13=27.9347f;
Var150.f_0="BUSTO_P14";
Var165.f_1={
179.6443f, -340.3767f, 43.0448f 
};
Var165.f_4={
235.139f, -393.0182f, 50.0242f 
};
Var165.f_7=6000;
Var165.f_8=(15f + 5f);
Var165.f_10={
113.5266f, -317.9667f, 44.6514f 
};
Var165.f_13=250f;
Var165.f_0="BUSTO_P13";
Var180.f_1={
288.2845f, 166.6872f, 103.309f 
};
Var180.f_4={
299.9585f, 198.3281f, 113.3522f 
};
Var180.f_7=6000;
Var180.f_8=(15f + 3f);
Var180.f_10={
344.1458f, 148.4554f, 102.159f 
};
Var180.f_13=70f;
Var180.f_0="BUSTO_P4";
Local_263.f_1={
99.4291f, 246.9366f, 107.2005f 
};
Local_263.f_4={
102.6186f, 254.6904f, 114.0255f 
};
Local_263.f_7=-1;
Local_263.f_8=8f;
Local_263.f_10={
177.5471f, 209.657f, 105.0543f 
};
Local_263.f_13=70f;
