...
fLocal_514=0.94f;
iLocal_515=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_158();
SYSTEM::WAIT(0);
func_147();
func_145();
func_141();
...
switch (iLocal_70){
case 0:
if(func_136()) iLocal_70=1;
break;
case 1:
if(func_135()) iLocal_70=2;
break;
case 2:
if(func_133()){
...
if(func_41(Global_96415, character, 2, 0, num3, num2, 75)) bLocal_517=true;
}}}}
return;
}
...
if(num4 > 8f * 8f){
iLocal_515=-1;
}elseif(AUDIO::IS_ANY_SPEECH_PLAYING(pedParam0)){
iLocal_515=-1;
}else{
if(iLocal_515 <=0) iLocal_515=MISC::GET_GAME_TIMER();
if(iLocal_515 > 0){
if(iLocal_516==0){
...
}}elseif(iLocal_515 + 10000 < MISC::GET_GAME_TIMER()){
...
switch (num){
case 0:
if(Global_95687[0]==18) return 0;
TEXT_LABEL_ASSIGN_STRING(&unk5, "FMM_0", 16);
break;
case 1:
if(Global_95687[1]==42) return 0;
TEXT_LABEL_ASSIGN_STRING(&unk5, "FMM_1", 16);
break;
case 2:
if(Global_95687[2]==65 || Global_95687[2]==66) return 0;
TEXT_LABEL_ASSIGN_STRING(&unk5, "FMM_2", 16);
break;
case 3:
if(character==CHAR_FRANKLIN || character==CHAR_TREVOR) return 0;
...
break;
case 5:
if(character==CHAR_MICHAEL || character==CHAR_TREVOR) return 0;
TEXT_LABEL_ASSIGN_STRING(&unk5, "FMF_0", 16);
break;
case 6:
if(character==CHAR_MICHAEL) return 0;
TEXT_LABEL_ASSIGN_STRING(&unk5, "FMF_1", 16);
break;
case 10:
if(character==CHAR_FRANKLIN) return 0;
TEXT_LABEL_ASSIGN_STRING(&unk5, "FMT_0", 16);
break;
case 11:
if(character==CHAR_FRANKLIN || character==CHAR_MICHAEL) return 0;
...
switch (character){
case CHAR_MICHAEL:
if(num==0 || num==1 || num==3 || num==4) TEXT_LABEL_APPEND_STRING(&unk5, "_M0", 16);
elseif(!func_32(131)) TEXT_LABEL_APPEND_STRING(&unk5, "_M0", 16);
else TEXT_LABEL_APPEND_STRING(&unk5, "_M1", 16);
break;
case CHAR_FRANKLIN:
TEXT_LABEL_APPEND_STRING(&unk5, "_F", 16);
break;
case CHAR_TREVOR:
if(num==11) TEXT_LABEL_APPEND_STRING(&unk5, "_T0", 16);
elseif(!func_32(130)) TEXT_LABEL_APPEND_STRING(&unk5, "_T0", 16);
else TEXT_LABEL_APPEND_STRING(&unk5, "_T1", 16);
break;
}
if(SYSTEM::VDIST2(entityCoords, entityCoords2) > 100f) return 0;
if(iParam1==6 || iParam1==31)if(MISC::ABSF(entityCoords2.f_2 - entityCoords.f_2) > 2f) return 0;
elseif(!ENTITY::IS_ENTITY_ON_SCREEN(pedParam0) || !ENTITY::IS_ENTITY_VISIBLE(pedParam0)) return 0;
flag=false;
switch (iParam1){
case 10:
case 8:
...
if(!PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_TALK) && !PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_TALK)) return 0;
if(!flag){
roomKeyFromEntity=INTERIOR::GET_ROOM_KEY_FROM_ENTITY(pedParam0);
if(Global_100733.f_386 !=roomKeyFromEntity) return 0;
}
gxt={
unk5 
};
TEXT_LABEL_APPEND_STRING(&gxt, "_01", 16);
if(HUD::DOES_TEXT_LABEL_EXIST(&gxt)) num2=1;
else num2=0;
if(num2 || func_31(sParam3, &unk5, uParam4)){
if(num==5)if(character==CHAR_MICHAEL) _CONVERSATION_INITIALIZE_ACTOR(uParam2, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
elseif(character==CHAR_FRANKLIN) _CONVERSATION_INITIALIZE_ACTOR(uParam2, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
elseif(character==CHAR_TREVOR) _CONVERSATION_INITIALIZE_ACTOR(uParam2, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
int i;
int j;
if(MISC::IS_STRING_NULL_OR_EMPTY(sParam1)) return false;
...
if(func_16(PLAYER::PLAYER_ID())) return false;
...
if(HUD::HAS_THIS_ADDITIONAL_TEXT_LOADED(sParam0, iParam1)) return true;
elseif(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())if(!HUD::IS_STREAMING_ADDITIONAL_TEXT(iParam1)) HUD::REQUEST_ADDITIONAL_TEXT(sParam0, iParam1);
return false;
}
...
k <=num2 - 1;
k=k + 1){
if(k + 1 < num2) num2[k /*4*/]={
num2[k + 1 /*4*/] 
};
else TEXT_LABEL_ASSIGN_STRING(&num2[k /*4*/], "", 16);
}
num3=num3 - 1;
}}}}}
randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(0, num3 + 1);
*sParam1={
num2[randomIntInRange /*4*/] 
};
if(MISC::IS_STRING_NULL_OR_EMPTY(sParam1)) return 0;
return 1;
}
...
if(entityModel==func_37(CHAR_JIMMY)) return 0;
if(entityModel==func_37(CHAR_TRACEY)) return 1;
if(entityModel==func_37(CHAR_AMANDA)) return 2;
...
if(entityModel==func_37(CHAR_LAMAR)) return 6;
if(entityModel==func_37(CHAR_STRETCH)) return 7;
if(entityModel==_GET_CHARACTER_MODEL(CHAR_MICHAEL)) return 8;
if(entityModel==_GET_CHARACTER_MODEL(CHAR_TREVOR)) return 9;
if(entityModel==func_37(CHAR_RON)) return 10;
if(entityModel==func_37(CHAR_PATRICIA)) return 11;
if(entityModel==joaat("S_F_M_Maid_01")) return 12;
if(entityModel==func_37(CHAR_FLOYD)) return 13;
if(entityModel==func_37(CHAR_WADE)) return 14;
return 16;
}
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1A1B{
if(func_36(character)) return func_35(character);
...
if(!func_36(echParam0)) return func_35(echParam0);
...
if(iParam5==-1) return false;
num7=0;
if(iParam5==2091854273 || iParam5==328868333 || iParam5==-1813399915 || iParam5==465306446 || iParam5==-816460512 || iParam5==-702667427) num7=262144;
num8=-1;
if(iParam5==2091854273) num8=24;
elseif(iParam5==328868333) num8=25;
elseif(iParam5==-1813399915) num8=26;
elseif(iParam5==465306446) num8=27;
elseif(iParam5==-816460512) num8=28;
elseif(iParam5==-702667427) num8=29;
if(func_101(iParam5, num5, num6, num, num3, echParam1, num4, 10000, iParam6, iParam4, num8, num7, 1)) return true;
else return false;
}}elseif(func_97(num2, iParam2, -1, &unk)){
...
if(num > 10000) func_43(character, 129, 5000);
elseif(num >=10) func_43(character, 129, num / 10);
return;
}

int func_43(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x1DC0{
if(func_76(echParam0)==3) return 0;
if(func_76(echParam0)==4) return 0;
...
func_46(iParam0);
if(Global_43257==15) func_45(false);
return 1;
}
...
}}elseif(IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_49() /*5568*/].f_681.f_10, iParam0)){
flag=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
int cloudTimeAsInt6;
int num6;
if(iParam0==8) return func_57(129, -1);
if(iParam0==9) return func_57(135, -1);
if(iParam0==10) return func_57(136, -1);
if(iParam0==11) return func_57(137, -1);
if(iParam0==12){
...
if(func_24(14) && !func_71(iParam0)) return 0;
...
if(func_68(&Global_4542597, iParam0)) return 0;
if(func_61(&Global_4542597, iParam0)) return 1;
}else{
...
if(func_24(14) && !func_71(iParam1)) return false;
if(func_68(uParam0, iParam1)) return false;
if(func_67(uParam0) < 0f) func_66(uParam0, 0);
func_64(&unk);
i=0;
for (i=0;
i < *uParam0 - 1;
...
if(func_24(14) && !func_71(iParam1)) return 0;
if(func_68(uParam0, iParam1)) return 0;
if(func_67(uParam0) < 0f) func_66(uParam0, 0);
for (i=0;
i < *uParam0;
i=i + 1){
...
character=_GET_CURRENT_PLAYER_CHARACTER();
num=_GET_PLAYER_CASH(character);
if(num > 10000) func_43(character, 128, 5000);
elseif(num >=10) func_43(character, 128, num / 10);
return;
}
...
character=_GET_CURRENT_PLAYER_CHARACTER();
num=_GET_PLAYER_CASH(character);
if(num > 10000) func_43(character, 127, 5000);
elseif(num >=10) func_43(character, 127, num / 10);
return;
}
...
character=_GET_CURRENT_PLAYER_CHARACTER();
num=_GET_PLAYER_CASH(character);
if(num > 10000) func_43(character, 126, 5000);
elseif(num >=10) func_43(character, 126, num / 10);
return;
}
...
character=_GET_CURRENT_PLAYER_CHARACTER();
num=_GET_PLAYER_CASH(character);
if(num > 10000) func_43(character, 125, 5000);
elseif(num >=10) func_43(character, 125, num / 10);
return;
}
...
if(!Global_9058[Global_20383 /*2811*/][0 /*281*/].f_259==1)if(!func_91()) AUDIO::PLAY_SOUND_FRONTEND(-1, "Text_Arrive_Tone", &Global_20372, true);
}
if(!Global_20585){
...
if(Global_2694519)if(num==14) func_88(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num /*15*/], 0, 0, 0, 0);
Global_8822[i]=1;
}}}
num=num + 1;
}}else{
...
j < 35;
j=j + 1){
if(Global_113648.f_14143[j /*104*/].f_24 !=0)if(Global_113648.f_14143[j /*104*/].f_28==0)if(Global_113648.f_14143[j /*104*/].f_99[Global_20383]==true) Global_22793=Global_22793 + 1;
}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam7)) func_89(sParam7);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam8)) func_89(sParam8);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam9)) func_89(sParam9);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam10)) func_89(sParam10);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam11)) func_89(sParam11);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
return;
}
...
while (num3 < num2){
if(!func_95(Global_113648.f_14143[num3 /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18)) Global_22792=num3;
num3=num3 + 1;
}
...
Global_113648.f_14143[Global_22792 /*104*/].f_18.f_5=99999;
while (i < num2){
if(Global_113648.f_14143[i /*104*/].f_24==0 || Global_113648.f_14143[i /*104*/].f_24==1)if(!func_95(Global_113648.f_14143[i /*104*/].f_18, Global_113648.f_14143[Global_22792 /*104*/].f_18)) Global_22792=i;
...
int num;
if(iParam1 >=5){}else{
if(iParam2 >=2 || iParam2 < -1) iParam2=-1;
...
if(iParam2==-1){
num=func_99(iParam0);
if(func_98(&unk5[0 /*4*/], num)) iParam2=1;
elseif(func_98(&unk5[1 /*4*/], num)) iParam2=0;
else iParam2=MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
}
*uParam3={
unk5[iParam2 /*4*/] 
};
...
num=0;
num2=0;
if(iParam1 > 3) return false;
while (num < 35){
if(!MISC::IS_STRING_NULL(&Global_113648.f_14143[num /*104*/]))if(MISC::ARE_STRINGS_EQUAL(&Global_113648.f_14143[num /*104*/], sParam0))if(Global_113648.f_14143[num /*104*/].f_99[iParam1]) num2=1;
num=num + 1;
}
...
if(iParam6 < 0) return false;
if(iParam7 < 0) return false;
if(iParam8==76) return false;
if(iParam9==235) return false;
if(echParam5 < CHAR_MULTIPLAYER)if(IS_BIT_SET(iParam4, echParam5)) return false;
if(iParam4 < 1 || iParam4 > 7) return false;
if(iParam1==-1) return false;
if(iParam1==83 || iParam2==83) return false;
...
num=func_99(iParam0);
if(func_98(&unk[0 /*4*/], num)) iParam2=1;
elseif(func_98(&unk[1 /*4*/], num)) iParam2=0;
else iParam2=MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
}else{
...
switch (iParam0){
case 0:
if(iParam1==0) return 67;
else return 68;
break;
case 1:
if(iParam1==0) return 69;
else return 70;
break;
case 2:
if(iParam1==0) return 71;
else return 72;
break;
case 3:
if(iParam1==0) return 73;
else return 74;
break;
case 4:
if(iParam1==0) return 75;
else return 76;
break;
}}
return 75;
...
if(iParam0==iParam5) return;
if(iParam0==76) return;
if(iParam5==76) return;
Global_43258[iParam0 /*5*/]={
uParam1 
};
...
i < Global_113648.f_7690.f_136;
i=i + 1){
if(Global_113648.f_7690[i /*15*/]==iParam0) return func_115(iParam0, gameTimer);
}
for (i=0;
i < Global_113648.f_7690.f_764;
i=i + 1){
if(Global_113648.f_7690.f_651[i /*14*/]==iParam0) return func_113(iParam0, gameTimer);
}
for (i=0;
i < Global_113648.f_7690.f_866;
i=i + 1){
if(Global_113648.f_7690.f_765[i /*10*/]==iParam0) return func_110(iParam0, gameTimer);
}
return 6;
}
...
if(num !=iParam0) return 6;
if(!func_36(_GET_CURRENT_PLAYER_CHARACTER())) return 6;
flag=false;
if(IS_BIT_SET(num.f_2, _GET_CURRENT_PLAYER_CHARACTER_0())) flag=true;
if(num.f_4 > iParam1) return 4;
if(flag)if(num.f_3 < Global_113648.f_7690.f_919[_GET_CURRENT_PLAYER_CHARACTER_0()]) return 5;
if(num.f_6 !=144)if(Global_43809[num.f_6] > iParam1) return 3;
if(Global_43808 > iParam1) return 2;
return 1;
}
...
i < Global_113648.f_7690.f_866;
i=i + 1){
if(Global_113648.f_7690.f_765[i /*10*/]==iParam0) return Global_113648.f_7690.f_765[i /*10*/];
}
return unk;
}
...
if(num.f_4 > iParam1) return 4;
if(flag)if(num.f_3 < Global_113648.f_7690.f_919[_GET_CURRENT_PLAYER_CHARACTER_0()]) return 5;
if(Global_43809[num.f_6] > iParam1) return 3;
if(Global_43808 > iParam1) return 2;
return 1;
}
...
i < Global_113648.f_7690.f_764;
i=i + 1){
if(Global_113648.f_7690.f_651[i /*14*/]==iParam0) return Global_113648.f_7690.f_651[i /*14*/];
}
return unk;
}
...
if(num !=iParam0) return 6;
if(!func_36(_GET_CURRENT_PLAYER_CHARACTER())) return 1;
if(Global_43804 !=-1)if(Global_113648.f_7690[Global_43804 /*15*/]==iParam0) return 0;
flag=false;
if(IS_BIT_SET(num.f_2, _GET_CURRENT_PLAYER_CHARACTER_0())) flag=true;
if(num.f_4 > iParam1) return 4;
if(flag)if(num.f_3 < Global_113648.f_7690.f_919[_GET_CURRENT_PLAYER_CHARACTER_0()]) return 5;
...
i < Global_113648.f_7690.f_136;
i=i + 1){
if(Global_113648.f_7690[i /*15*/]==iParam0) return Global_113648.f_7690[i /*15*/];
}
return unk;
}
...
if(iParam0==0) return 2091854273;
elseif(iParam0==1) return 328868333;
elseif(iParam0==2) return -1813399915;
elseif(iParam0==3) return 465306446;
elseif(iParam0==4) return -816460512;
elseif(iParam0==5) return -702667427;
return -1;
}

int func_121(eCharacter echParam0) // Position - 0x5031{
if(echParam0==_CHAR_NULL) return 7;
if(echParam0 < func_123()) return func_122(echParam0);
if(echParam0==_CHAR_VIRTUAL_MP) return 7;
if(echParam0==func_123()) return 6;
...
i <=character;
i=i + 1){
if(func_37(i)==entityModel) return i;
}}
return _CHAR_NULL;
}
...
num2=-1f;
num3=-1f;
if(ENTITY::FIND_ANIM_EVENT_PHASE(&uLocal_361, &uLocal_442[iParam1 /*16*/], "WalkInterruptible", &num2, &num3)) num=num2;
else num=fLocal_514;
...
uLocal_291[iParam1 /*3*/]={
(entityCoords - uLocal_277) *{
4f, 4f, 4f 
}};
...
TASK::TASK_GO_STRAIGHT_TO_COORD(*pedParam0, uLocal_277 + (uLocal_291[iParam1 /*3*/] *{
0.1f, 0.1f, 0.1f 
}
), 1f, -1, 1193033728, 1056964608);
...
num4=SYSTEM::VMAG(uLocal_291[iParam1 /*3*/] *{
0.05f, 0.05f, 0.05f 
}
);
...
break;
case 2:
if(PED::IS_PED_RAGDOLL(*pedParam0) || TASK::IS_PED_GETTING_UP(*pedParam0)) return 0;
if(PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), *pedParam0) || PED::IS_PED_IN_COMBAT(*pedParam0, 0)){
uLocal_270[iParam1]=10;
return 1;
}
if(TASK::GET_SCRIPT_TASK_STATUS(*pedParam0, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) !=1){
if(uLocal_308[iParam1]==0f) uLocal_308[iParam1]=SYSTEM::VMAG(uLocal_291[iParam1 /*3*/]) * 0.75f;
...
if(PED::IS_PED_RAGDOLL(*pedParam0) || TASK::IS_PED_GETTING_UP(*pedParam0)) return 0;
if(TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_513)) TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_513, false);
...
if(PED::IS_PED_RAGDOLL(*pedParam0) || TASK::IS_PED_GETTING_UP(*pedParam0)) return 0;
vector={
func_126(uLocal_277 + uLocal_291[iParam1 /*3*/], func_129(uLocal_308[iParam1] * 0.9f, 10f, 100f), 0f) 
};
if(TASK::GET_SCRIPT_TASK_STATUS(*pedParam0, SCRIPT_TASK_USE_NEAREST_SCENARIO_TO_POS)==1){
}elseif(PATHFIND::GET_SAFE_COORD_FOR_PED(vector, false, &outPosition, 14)){
...
i < 3;
i=i + 1){
if(i !=iParam1)if(uLocal_270[i]==2 || uLocal_270[i]==3) uLocal_270[i]=10;
}
...
Vector3 func__126(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x56FC{
float num;
float num2;
float endRange;
int i;
...
i=i + 1){
num={
MISC::GET_RANDOM_FLOAT_IN_RANGE(-fParam3, fParam3), MISC::GET_RANDOM_FLOAT_IN_RANGE(-fParam3, fParam3), 0f 
};
...
Vector3 func__127(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x5775{
var unk;
float endRange;
unk={
...
endRange=fParam4 / 2f;
unk={
func_128(unk, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) 
};
...
Vector3 func__128(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x57BD{
float num;
...
}elseif(_CONVERSATION_ADD_LINE(&uLocal_72, "PRSAUD", &uLocal_507, 3, 0, 0, 0)){
bLocal_512=true;
}}}else{
return true;
}}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || STREAMING::GET_PLAYER_SWITCH_TYPE()==3) return false;
if(STREAMING::GET_PLAYER_SWITCH_STATE() > 8){
if(STREAMING::GET_PLAYER_SWITCH_STATE() !=11) return false;
if(STREAMING::GET_PLAYER_SWITCH_STATE()==11)if(STREAMING::GET_PLAYER_SWITCH_INTERP_OUT_DURATION() > 0)if(STREAMING::GET_PLAYER_SWITCH_INTERP_OUT_CURRENT_TIME() > 100) return false;
}
return true;
}
...
i < iLocal_262;
i=i + 1){
if(!PED::IS_PED_INJURED(iLocal_262[i])) TASK::TASK_SYNCHRONIZED_SCENE(iLocal_262[i], Global_98010, &uLocal_361, &uLocal_377[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
if(!PED::IS_PED_INJURED(Global_100402)) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 4, Global_100402, "LAMAR", 0, 1);
if(!PED::IS_PED_INJURED(iLocal_262[0])) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 5, iLocal_262[0], "GangMember1", 0, 1);
if(!PED::IS_PED_INJURED(iLocal_262[1])) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_72, 6, iLocal_262[1], "GangMember2", 0, 1);
return true;
}
return false;
}
...
Vector3 entityCoords;
float num;
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())if(STREAMING::GET_PLAYER_SWITCH_TYPE() !=3)if(STREAMING::GET_PLAYER_SWITCH_STATE() <=2 && STREAMING::GET_PLAYER_SWITCH_STATE() !=1) return 1;
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(func_24(14)) return 0;
if(MISC::GET_IS_PLAYER_IN_ANIMAL_FORM()) return 0;
if(!func_139(iParam0, func_140())) return 0;
...
if(num > 250f)if(!ENTITY::IS_ENTITY_DEAD(pedParam1, false))if(!ENTITY::IS_ENTITY_ON_SCREEN(pedParam1)) return 0;
elseif(!CAM::IS_SPHERE_VISIBLE(entityCoords, 1.5f)) return 0;
}elseif(pedParam1==func_138(Global_100402) && pedParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_144();
return;
}
...
while (!flag && num < 400){
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(Global_100402)) flag=false;
for (i=0;
i < iLocal_262;
i=i + 1){
if(iLocal_266[i] !=0){
...
if(func_37(CHAR_LAMAR)==ENTITY::GET_ENTITY_MODEL(Global_100402)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_100402, true, true);
...
if(eptLocal_276==PED_TYPE_COP) WEAPON::GIVE_WEAPON_TO_PED(iLocal_262[i], joaat("WEAPON_STUNGUN"), 1000, false, true);
}}
return;
}
...
if(hParam1 !=joaat("NO_RELATIONSHIP")) PED::SET_PED_RELATIONSHIP_GROUP_HASH(*pedParam0, hParam1);
return;
}
...
case 219:
uLocal_281[0 /*3*/]={
-0.2331f, 0.0497f, 0.0041f 
};
uLocal_281[1 /*3*/]={
0.6908f, -0.4534f, 0.0042f 
};
uLocal_291[0 /*3*/]={
-0.6f, -144.3f, 0f 
};
...
case 5:
*uParam1={
Global_113648.f_2365.f_539.f_2300[0 /*3*/] +{
-1f, 0f, 0f 
}};
...
case 6:
*uParam1={
Global_113648.f_2365.f_539.f_2300[1 /*3*/] +{
-1f, 0f, 0f 
}};
...
case 7:
*uParam1={
Global_113648.f_2365.f_539.f_2300[2 /*3*/] +{
-1f, 0f, 0f 
}};
...
entityCoords={
Global_113648.f_2365.f_539.f_2300[num /*3*/] 
};
if(func_131(entityCoords, 0f, 0f, 0f, false)) entityCoords={
...
*uParam2={
{
71.8356f, 180.5483f, -796.9911f 
}
-{
71.1531f, 179.5117f, -812.0607f 
}};
...
+{
0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-0.5f, 0.5f) 
}};
...
*uParam2={
*uParam2 +{
0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f) 
}};
...
*uParam2={
{
30.7131f, -1454.6757f, -42.2059f 
}
-{
30.116f, -1435.9974f, -14.3064f 
}};
...
*uParam2={
{
9.6327f, -1521.394f, -1158.133f 
}
-{
9.6346f, -1517.601f, -1152.5707f 
}};
...
*uParam2={
{
9.6327f + 1f, -1518.7363f, -1148.4664f 
}
-{
9.6346f, -1517.601f, -1152.5707f 
}};
...
i < iLocal_266;
i=i + 1){
if(iLocal_266[i] !=0) ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_262[i]);
}
for (i=0;
i < iLocal_266;
i=i + 1){
if(iLocal_266[i] !=0) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_266[i]);
}
PED::REMOVE_RELATIONSHIP_GROUP(hLocal_275);
if(!TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_513)) TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_513, true);
