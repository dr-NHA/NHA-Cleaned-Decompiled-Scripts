...
if(!iLocal_517 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER::PLAYER_PED_ID(), 1)){
...
func_108(75, ENTITY::GET_ENTITY_COORDS(uParam0, 0), 250f, -1);
if(func_41(Global_96415, bVar0, 2, 0, iVar3, iVar2, 75)){
iLocal_517=1;
}}}}}
return;
}
func_6(uParam0, 138, &uLocal_72, "FMFAUD", &uLocal_237, &uLocal_258, 3);
...
return 1;
}elseif(!func_30() && !AUDIO::IS_MOBILE_PHONE_CALL_ONGOING()){
...
return 0;
}}}elseif(func_97(iVar1, iParam2, -1, &sVar8)){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_49() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_49() /*5568*/].f_681.f_10, iParam0);
}
...
var func__57(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_52();
}
...
iParam2=1;
}elseif(func_98(&(Var4[1 /*4*/]), iVar13)){
iParam2=0;
}else{
...
case 0:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_361, &(Local_442[iParam1 /*16*/]), 2)){
fVar1=fLocal_514;
fVar2=-1f;
fVar3=-1f;
...
Local_291[iParam1 /*3*/]={
Var4 - Local_277 * Vector(4f, 4f, 4f) 
};
...
TASK::TASK_GO_STRAIGHT_TO_COORD(*uParam0, Local_277 + Local_291[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
PED::FORCE_PED_MOTION_STATE(*uParam0, joaat("MotionState_Walk"), 0, 1, 0);
...
break;
case 1:
if(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, joaat("script_task_go_straight_to_coord")) !=1){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_277 + Local_291[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
iLocal_270[iParam1]=2;
return 1;
}
fVar7=SYSTEM::VMAG(Local_291[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_277) >=fVar7){
if(!func_130() && !ENTITY::IS_ENTITY_ON_SCREEN(*uParam0)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_277 + Local_291[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
iLocal_270[iParam1]=2;
return 1;
}}
...
TASK::TASK_WANDER_IN_AREA(*uParam0, Local_277 + Local_291[iParam1 /*3*/], fLocal_308[iParam1], 1077936128, 1086324736);
...
TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_513, 0);
}
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_277 + Local_291[iParam1 /*3*/]) < (fLocal_308[iParam1] * fLocal_308[iParam1])){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_277 + Local_291[iParam1 /*3*/], fLocal_308[iParam1], 1)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, Local_277 + Local_291[iParam1 /*3*/], fLocal_308[iParam1], 0);
...
Var8={
func_126(Local_277 + Local_291[iParam1 /*3*/], func_129((fLocal_308[iParam1] * 0.9f), 10f, 100f), 0f) 
};
if(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, joaat("script_task_use_nearest_scenario_to_pos"))==1){
}elseif(PATHFIND::GET_SAFE_COORD_FOR_PED(Var8, 0, &Var11, 14)){
...
Vector3 func__126(struct<3> Param0, float fParam3, float fParam4){
struct<3> Var0;
float fVar3;
float fVar4;
int iVar5;
...
Vector3 func__127(struct<3> Param0, float fParam3, float fParam4){
struct<3> Var0;
float fVar3;
Var0={
...
fVar3=(fParam4 / 2f);
Var0={
func_128(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) 
};
...
Vector3 func__128(struct<3> Param0, float fParam3){
float fVar0;
if(fParam3==0f){
return 0f, 0f, 0f;
}
...
if(!iLocal_512){
if(fVar0 < fLocal_511){
}elseif(func_12(&uLocal_72, "PRSAUD", &Local_507, 3, 0, 0, 0)){
iLocal_512=1;
}}}else{
return 1;
}}
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_262[iVar0], Global_98011, &cLocal_361, &(Local_442[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
iLocal_270[iVar0]=0;
}else{
iLocal_270[iVar0]=-1;
}
...
while (iVar0 < iLocal_262){
if(!PED::IS_PED_INJURED(iLocal_262[iVar0])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_262[iVar0], Global_98010, &cLocal_361, &(Local_377[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
}
iVar0++;
}
...
return 0;
}}}elseif(iParam1==func_138(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
while (iVar0 < iLocal_262){
if(iLocal_266[iVar0] !=0){
iLocal_262[iVar0]=PED::CREATE_PED(iLocal_276, iLocal_266[iVar0], Local_277 + Local_281[iVar0 /*3*/], 0, 1, 1);
...
TASK::TASK_PLAY_ANIM(iLocal_262[iVar0], &cLocal_361, &(Local_377[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_262[iVar0], 317, 1);
if(iLocal_276==6){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_262[iVar0], joaat("weapon_stungun"), 1000, 0, 1);
}}
iVar0++;
}}
...
Local_291[0 /*3*/]={
Vector(21.5656f, -1890.595f, 59.4395f) - Local_277 
};
Local_291[1 /*3*/]={
Local_291[0 /*3*/] 
};
Local_291[iLocal_262 /*3*/]={
Vector(-4.6336f, -54.7307f, 67.5391f) * Vector(-1f, -1f, -1f) 
};
...
Local_291[0 /*3*/]={
Vector(27.9565f, -1650.517f, 278.2831f) - Local_277 
};
Local_291[1 /*3*/]={
Local_291[0 /*3*/] 
};
Local_291[iLocal_262 /*3*/]={
-Vector(0f, 62.7f, 54.673f) 
};
...
if(!TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_513)){
TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_513, 1);
}
