...
fLocal_31=140f;
fLocal_32=180f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_20();
...
if(MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_NAME_OF_SCRIPT_WITH_THIS_ID(nextThreadId), "heist_ctrl_finale")) flag=true;
}
...
if(bParam18) func_16(playersLastVehicle);
...
if(entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)if(func_13(playersLastVehicle, vParam0, vParam3, fParam6)) flag=true;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
...
if(bParam16)if(func_4(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true)) flag=false;
if(flag){
...
for (i=0;
func_5(echParam1, i, &garageName, &num);
i=i + 1){
...
Vector3 func__15(float fParam0, var uParam1, var uParam2) // Position - 0xBBB{
float num;
float num2;
