...
if(Global_78828 || Global_78828.f_1) bLocal_29=0;
flag=false;
flag2=false;
if(func_40(131)) flag=true;
if(!func_40(130)) flag=true;
if(flag){
Global_43222=0;
func_39(18);
func_38();
}
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) flag2=true;
Global_43222=bLocal_29;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()))if(ENTITY::IS_ENTITY_IN_AIR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) bLocal_29=0;
if(bLocal_30 !=bLocal_29){
if(!bLocal_29) func_20();
if(bLocal_29 && !flag2){
flag3=false;
flag4=true;
while (flag4){
...
SYSTEM::WAIT(5000);
PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID());
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())) interiorFromEntity=INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
}}
if(_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID())==CHAR_MICHAEL)if(!IS_BIT_SET(Global_113648.f_7690.f_923, 0)) func_10(1628462442, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
elseif(!IS_BIT_SET(Global_113648.f_7690.f_923, 1)) func_10(1791324372, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
elseif(!IS_BIT_SET(Global_113648.f_7690.f_923, 2)) func_10(-240877892, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
elseif(_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID())==CHAR_TREVOR)if(!IS_BIT_SET(Global_113648.f_7690.f_923, 3)) func_10(1806999335, 7, 4, 31, 3, 10000, 20000, -1, -1, 151, -1, 1024);
elseif(!IS_BIT_SET(Global_113648.f_7690.f_923, 4)) func_10(2054503592, 7, 4, 31, 3, 10000, 20000, -1, -1, 151, -1, 1024);
elseif(!IS_BIT_SET(Global_113648.f_7690.f_923, 4)) func_10(-2009081795, 7, 4, 31, 3, 10000, 20000, -1, -1, 151, -1, 1024);
if(num==0 && !flag2){
if(!func_9(0) && !func_9(4) && !func_9(3)){
if(unk_0xE777A59AAA1C96A0(11) < 256)if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) MISC::CREATE_INCIDENT_WITH_ENTITY(DT_Gangs, PLAYER::PLAYER_PED_ID(), numUnits, 0f, &iLocal_33, 0, 0);
if(CAM::IS_SCREEN_FADED_IN()){
if(bLocal_32) _DISPLAY_HELP_TEXT("CITDENAL" /*Michael and Trevor have been exiled from the city. If they enter the city, Martin's henchmen will track them down.*/, -1);
else _DISPLAY_HELP_TEXT("CITDENAL_R" /*Michael and Trevor have been exiled by Martin. Approaching his ranch will cause his henchmen to attack.*/, -1);
num=120000;
}
}}}else{
bLocal_29=false;
...
if(bLocal_29)if(!MISC::IS_INCIDENT_VALID(iLocal_33))if(unk_0xE777A59AAA1C96A0(11) < 256)if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) MISC::CREATE_INCIDENT_WITH_ENTITY(DT_Gangs, PLAYER::PLAYER_PED_ID(), numUnits, 0f, &iLocal_33, 0, 0);
if(bLocal_29 && SYSTEM::TIMERB() > 60000){
SYSTEM::SETTIMERB(0);
numUnits=numUnits + MISC::GET_RANDOM_INT_IN_RANGE(1, 2);
if(numUnits < 8)if(MISC::IS_INCIDENT_VALID(iLocal_33)) MISC::SET_INCIDENT_REQUESTED_UNITS(iLocal_33, DT_Gangs, numUnits);
elseif(unk_0xE777A59AAA1C96A0(11) < 256)if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) MISC::CREATE_INCIDENT_WITH_ENTITY(DT_Gangs, PLAYER::PLAYER_PED_ID(), numUnits, 0f, &iLocal_33, 0, 0);
else numUnits=8;
}
bLocal_30=bLocal_29;
if(flag2){
...
if(bLocal_29) SYSTEM::WAIT(0);
else SYSTEM::WAIT(10000);
...
if(iParam0==7) return;
if(bParam1) MISC::SET_BIT(&Global_113648.f_7231.f_17[iParam0], 0);
else MISC::CLEAR_BIT(&Global_113648.f_7231.f_17[iParam0], 0);
...
if(iParam0==5) return;
if(bParam1) MISC::SET_BIT(&Global_113648.f_7231.f_11[iParam0], 0);
else MISC::CLEAR_BIT(&Global_113648.f_7231.f_11[iParam0], 0);
...
i < 3;
i=i + 1){
if(IS_BIT_SET(iParam2, i)) func_11(i);
}
return 1;
}
return 0;
...
if(func_12(character)) return func_17(character);
...
if(iParam4 !=0) func_19(uParam0, iParam4);
}
return 2;
}
...
if(iLocal_28 !=-1) func_21(&iLocal_28);
func_25(1628462442);
func_25(1791324372);
func_25(-240877892);
func_25(1806999335);
...
if(!(CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN())) return 0;
if(fParam0.f_1 < 400f){
if(fParam0 < 1400f){
if(fParam0 > -1900f){
