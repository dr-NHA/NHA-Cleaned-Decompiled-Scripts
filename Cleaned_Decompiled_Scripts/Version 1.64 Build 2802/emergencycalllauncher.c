...
if(!flag)if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(34)) SCRIPT::TERMINATE_THIS_THREAD();
else MISC::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
_CONVERSATION_INITIALIZE_ACTOR(&uLocal_45, 1, 0, "EMSDispatch", 0, 1);
func_38();
while (true){
SYSTEM::WAIT(0);
if(flag)if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) SCRIPT::TERMINATE_THIS_THREAD();
func_36();
...
if(bParam0) Global_32398=true;
else Global_32398=false;
return;
}
...
if(func_6()){
TEXT_LABEL_COPY(&uLocal_210,{
func_5() 
}
, 6);
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&uLocal_210))==0) func_4();
else Global_32222=true;
}else{
Global_32222=false;
}
return;
...
iLocal_44=1;
}}elseif(func_8(&uLocal_45, 130, "LOCAUD", "LOC_CALLQ", iLocal_217, "CELL_601" /*Which Service?*/, "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, false)){
if(!func_6()){
SCRIPT::REQUEST_SCRIPT("emergencycall");
while (!SCRIPT::HAS_SCRIPT_LOADED("emergencycall")){
SYSTEM::WAIT(0);
...
break;
case 1:
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("emergencycall"))==0)if(!func_35(130)) iLocal_43=1;
break;
}
return;
}
...
if(Global_2883694)if(func_26(0))if(Global_3407872 || _IS_MISSION_REPEAT_ACTIVE(false)) return true;
if(Global_2883693)if(func_26(0))if(Global_3932160 || _IS_MISSION_REPEAT_ACTIVE(false)) return true;
return false;
}
...
if(func_34(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_33;
return -1;
}
