...
bool func_8(){
return MISC::IS_BIT_SET(Global_2684799.f_1.f_2810, 3);
}
...
struct<53> Var3;
int iVar61;
if(!MISC::IS_BIT_SET(Global_1950108.f_3, 27)){
...
if(MISC::IS_BIT_SET(Global_1950108, 15)){
MISC::CLEAR_BIT(&Global_1950108, 15);
}
if(MISC::IS_BIT_SET(Global_1950108.f_2, 6)){
...
MISC::CLEAR_AREA_OF_VEHICLES(uParam1->f_5 + uParam1->f_19, (SYSTEM::VMAG(uParam1->f_22) + 25f), 0, 0, 0, 0, 0, 0, 0);
...
if(iVar0==0){
if(iParam0==1){
if(!MISC::IS_BIT_SET(Global_100681.f_20, 2)){
MISC::SET_GAME_PAUSED(1);
MISC::SET_BIT(&(Global_100681.f_20), 2);
}}elseif(MISC::IS_BIT_SET(Global_100681.f_20, 2)){
MISC::SET_GAME_PAUSED(0);
...
Var0={
ENTITY::GET_ENTITY_COORDS(Local_43.f_1, 1) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(Local_43.f_4, 1) 
};
...
if((Global_44232[iLocal_64 /*5*/].f_3 >=10 || Global_44232[iLocal_64 /*5*/].f_4 >=15) || MISC::IS_BIT_SET(Global_44449, 9)){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_43.f_1, joaat("script_task_synchronized_scene"))==1 && !MISC::IS_BIT_SET(Global_1950108.f_3, 27)){
return;
}
...
func_157(iVar1);
func_156(iVar1);
}elseif(Global_44313[iVar1 /*6*/].f_1==2){
if(!iLocal_49==-1){
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_181(iParam2), 1);
}
