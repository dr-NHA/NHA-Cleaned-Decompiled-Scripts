...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1331, 1);
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1332, 1);
...
if(func_465()){
func_464();
}}elseif(!PED::IS_PED_INJURED(iLocal_1049)){
func_457();
if(iLocal_1035 < 10){
Local_360.f_6=1;
}else{
...
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_1061, 0)){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1061, iLocal_1318, iLocal_1318, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1316) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1061, iLocal_1316, iLocal_1316, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}
func_34(func_31(25f), 6, "OJAvaGUARD2");
func_33(&uLocal_1368, "OJASAUD", "OJASva_CAR3", "OJASva_CAR3_1", 9, 0, 0);
}else{
TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_1061, PLAYER::PLAYER_PED_ID(), -1, 0);
func_2(iLocal_1061);
}}
}
iLocal_1174=1;
...
void func_1(){
int iVar0;
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_1049, 0)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(iLocal_1049, 0);
...
iVar0=0;
while (iVar0 <=2){
if(!PED::IS_PED_INJURED(uLocal_1054[iVar0])){
...
iVar0=0;
while (iVar0 <=1){
if(!PED::IS_PED_INJURED(uLocal_1058[iVar0])){
...
while (iVar0 <=2){
if(!PED::IS_PED_INJURED(uLocal_1054[iVar0])){
if(bParam1 || (!bParam1 && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_1054[iVar0], 0))){
...
while (iVar0 <=1){
if(!PED::IS_PED_INJURED(uLocal_1058[iVar0])){
if(bParam1 || (!bParam1 && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_1058[iVar0], 0))){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_1050, iLocal_1316, 0)){
bVar1=true;
}}}
if(bLocal_1168){
fVar0=100f;
...
}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_1050)){
*iParam0=6;
return 1;
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_1124)){
if(func_30(iLocal_1049, iLocal_1050, 1) >=(fVar0 * 0.5f)){
if(!HUD::IS_BLIP_FLASHING(uLocal_1124)){
HUD::SET_BLIP_FLASHES(uLocal_1124, 1);
}}elseif(HUD::IS_BLIP_FLASHING(uLocal_1124)){
HUD::SET_BLIP_FLASHES(uLocal_1124, 0);
}}}}}
return 0;
}
...
case 0:
if(!func_28()){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1054[0], 0)){
TASK::TASK_CLEAR_LOOK_AT(uLocal_1054[0]);
}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1054[1], 0)){
...
iLocal_1177=1;
}}}elseif(!bLocal_1168 && PED::IS_PED_INJURED(iLocal_1050)){
if(!iLocal_1177){
func_34(iVar0, 3, "OJAvaGUARD");
...
iLocal_1175=1;
}}elseif(!bLocal_1185 && PED::IS_PED_INJURED(iLocal_1050)){
iVar0=func_101();
func_100(iVar0);
}}}elseif(bLocal_1161){
if(!iLocal_1177){
...
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1054[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1054[iVar0], 0)){
PED::SET_PED_RESET_FLAG(uLocal_1054[iVar0], 85, 1);
if(PED::CAN_PED_SEE_HATED_PED(uLocal_1054[iVar0], PLAYER::PLAYER_PED_ID())){
return 1;
}}
iVar0++;
}
iVar0=0;
while (iVar0 < 2){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1058[iVar0], 0)){
PED::SET_PED_RESET_FLAG(uLocal_1058[iVar0], 85, 1);
if(PED::CAN_PED_SEE_HATED_PED(uLocal_1058[iVar0], PLAYER::PLAYER_PED_ID())){
return 1;
}}
iVar0++;
}
iVar0=0;
while (iVar0 < 2){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1051[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_1051[iVar0], 0)){
PED::SET_PED_RESET_FLAG(iLocal_1051[iVar0], 85, 1);
...
iVar1=0;
while (iVar1 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1054[iVar1]) && !PED::IS_PED_INJURED(uLocal_1054[iVar1])){
...
iVar1=0;
while (iVar1 < 2){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[iVar1]) && !PED::IS_PED_INJURED(uLocal_1058[iVar1])){
...
WEAPON::GET_CURRENT_PED_WEAPON(iLocal_1049, &iVar2, 1);
...
if((func_107(iLocal_1316) || func_106(iLocal_1316)) || (ENTITY::DOES_ENTITY_EXIST(iLocal_1316) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1316, iLocal_1049, 1))){
return 1;
}
if(func_107(iLocal_1317) || (ENTITY::DOES_ENTITY_EXIST(iLocal_1317) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1317, iLocal_1049, 1))){
return 1;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1316) && !ENTITY::IS_ENTITY_DEAD(iLocal_1316, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_1049, iLocal_1316, 0)){
VEHICLE::SET_VEHICLE_ALARM(iLocal_1316, 1);
...
return 1;
}}elseif(FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_1312, fLocal_1315)){
if(func_104()){
iLocal_1192=1;
}else{
return 1;
...
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1054[iVar0])){
...
iVar0=0;
while (iVar0 < 2){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[iVar0])){
if(iLocal_1138 && !bLocal_1171){
...
PED::SET_PED_RESET_FLAG(iLocal_1051[iVar0], 128, 1);
}}}
iVar0++;
}
if(iLocal_1208==0){
...
if(iLocal_1138){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1050, 0)){
PED::SET_PED_RESET_FLAG(iLocal_1050, 120, 1);
}}}
...
break;
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1317, 0)){
if(func_134()){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1317)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1317, -1, 0)==uLocal_1058[iParam0]){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_1058[iParam0], iLocal_1317, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
}}
...
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1317)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_1317, 1) 
};
uVar4=ENTITY::GET_ENTITY_HEADING(iLocal_1317);
iLocal_1151=0;
...
case 3:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1317, 0)){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1058[iParam0], 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_1058[iParam0], iLocal_1317, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
if(!iLocal_1138){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1317, -1, 0)==uLocal_1058[iParam0]){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], joaat("script_task_vehicle_mission")) !=1){
TASK::TASK_VEHICLE_ESCORT(uLocal_1058[iParam0], iLocal_1317, iLocal_1316, -1, 45f, 786981, 10f, -1, 10f);
}}
}
elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1317, -1, 0)==uLocal_1058[iParam0]){
if(!iLocal_1152){
if(ENTITY::IS_ENTITY_DEAD(iLocal_1050, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
elseif(!bLocal_1168){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], joaat("script_task_combat")) !=1){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], joaat("script_task_combat")) !=1){
TASK::TASK_COMBAT_PED(iVar0, PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(!iLocal_1162){
iLocal_1041[iParam0]=8;
}}}
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_1049, iVar0, 5f, 5f, 3f, 0, 1, 0)){
...
case 6:
if(bLocal_1163){
TASK::OPEN_SEQUENCE_TASK(&uLocal_1328);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
if(!PED::IS_PED_INJURED(uLocal_1058[iParam0])){
TASK::TASK_PERFORM_SEQUENCE(uLocal_1058[iParam0], uLocal_1328);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_1328);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
...
case 7:
if(!PED::IS_PED_INJURED(uLocal_1058[iParam0])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], joaat("script_task_any")) !=1){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_1058[iParam0], iLocal_1049, iLocal_1049, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}}
break;
case 8:
...
}}elseif(func_118(iVar0, iLocal_1317, &Local_360, &iLocal_371, 0, 0, 0, 1, 1) || func_117(iLocal_1317)){
iVar5=func_36(1116471296, 1);
if(iVar5 !=0){
func_116(ENTITY::GET_ENTITY_COORDS(iVar5, 1), 1097859072, 1116471296);
}
if(!func_115()){
iLocal_1138=1;
}}elseif(!bLocal_1141){
...
if(PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1317, 0)){
if(((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1317, 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)) || iLocal_1150) || !bLocal_1141){
if(iLocal_1041[iParam0] < 8){
iLocal_1041[iParam0]=8;
}}}elseif(iLocal_1041[iParam0] < 8){
iLocal_1041[iParam0]=8;
}}
...
if(!PED::IS_PED_INJURED(iParam0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_1049, iParam0, 5f, 5f, 1f, 0, 1, 0)){
if(PED::IS_PED_FACING_PED(iParam0, iLocal_1049, 120f)){
if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_1049, 17)){
return 1;
}}}}}}
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_1316, 0) || iLocal_1192){
bLocal_1161=true;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1050)){
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_1049, -1, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1049, 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_1049, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 3, 1);
}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
TASK::TASK_PERFORM_SEQUENCE(iParam0, uLocal_1328);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
...
if(!iLocal_1138){
if(!PED::IS_PED_INJURED(iParam0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_1049, iParam0, Param1, 0, 1, 0)){
if(PED::IS_PED_FACING_PED(iParam0, iLocal_1049, 160f)){
if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_1049, 17)){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_1049, iLocal_1049, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
iLocal_1048=5;
iLocal_1138=1;
}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
...
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_GO_TO_ENTITY(0, iLocal_1049, 20000, 2f, 1f, 1073741824, 0);
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_1316, 1) 
};
}
...
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1058[iParam0], 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1317, 0)){
if(!PED::IS_PED_IN_VEHICLE(uLocal_1058[iParam0], iLocal_1317, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], joaat("script_task_enter_vehicle")) !=1){
TASK::TASK_ENTER_VEHICLE(uLocal_1058[iParam0], iLocal_1317, 20000, iVar0, 2f, 1, 0);
}}}}}

int func_134(){
if(!PED::IS_PED_INJURED(uLocal_1058[0]) && !PED::IS_PED_INJURED(uLocal_1058[1])){
if(PED::IS_PED_IN_VEHICLE(uLocal_1058[0], iLocal_1317, 0) && PED::IS_PED_IN_VEHICLE(uLocal_1058[1], iLocal_1317, 0)){
return 1;
}}
return 0;
}
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
TASK::OPEN_SEQUENCE_TASK(&uLocal_1328);
TASK::TASK_GO_TO_COORD_ANY_MEANS(0, Local_1272[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
TASK::TASK_ACHIEVE_HEADING(0, fLocal_1225[iParam0], 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
TASK::TASK_PERFORM_SEQUENCE(iVar0, uLocal_1328);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
...
if(ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_1272[iParam0 /*3*/], 3f, 3f, 3f, 0, 1, 0)){
...
break;
}elseif(func_52(&uLocal_1337) >=27f && iLocal_1142){
func_129(iVar0, 15f, 15f, 3f);
}elseif(func_52(&uLocal_1337) >=15f){
func_142(iVar0);
}}else{
iLocal_1166=0;
bLocal_1139=true;
...
if(!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1316, 0)){
...
if(iParam0==0){
TASK::TASK_LOOK_AT_ENTITY(uLocal_1054[iParam0], uLocal_1054[1], -1, 2048, 4);
}elseif(iParam0==1){
TASK::TASK_LOOK_AT_ENTITY(uLocal_1054[iParam0], uLocal_1054[0], -1, 2048, 4);
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
if(!func_140()){
if(iLocal_1138){
...
if(!iLocal_1138){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1316, -1, 0)==iVar0){
if(!PED::IS_PED_INJURED(iVar0)){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1316, 1, 1, 0);
if(func_138()){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1316, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
}else{
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1316, "OJASva_101", 181, 0, 0, -1, -1f, 0, 1073741824);
}
}}
...
case 7:
if(iLocal_1138){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1316, -1, 0)==iVar0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1316, 1, 0)==iLocal_1050){
if(!PED::IS_PED_INJURED(iVar0)){
...
TASK::TASK_VEHICLE_MISSION(iVar0, iLocal_1316, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 8, 35f, 786469, -1f, -1f, 1);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iVar0, joaat("script_task_vehicle_mission")) !=1){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iVar0, iLocal_1316, PLAYER::PLAYER_PED_ID(), 8, 35f, 786469, -1f, -1f, 1);
}}
}}}elseif(!PED::IS_PED_INJURED(iVar0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iVar0, joaat("script_task_combat")) !=1){
TASK::TASK_COMBAT_PED(iVar0, iLocal_1049, 0, 16);
}}}elseif(bLocal_1153 || (iLocal_1167 && !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1316))){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1316, -1, 0)==iVar0){
if(!ENTITY::IS_ENTITY_DEAD(iVar0, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iVar0, joaat("script_task_vehicle_mission")) !=1){
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar0, iLocal_1316, Local_1294, 8, 25f, 786603, -1f, -1f, 1);
}
}}}}
break;
case 8:
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1054[iParam0], 0)){
TASK::TASK_PERFORM_SEQUENCE(uLocal_1054[iParam0], uLocal_1328);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_1328);
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1054[iParam0], joaat("script_task_any")) !=1){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_1054[iParam0], iLocal_1049, iLocal_1049, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}}
break;
case 10:
if(iLocal_1048==4 || iLocal_1048==5){
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1050)){
iLocal_1048=5;
}}}}}}elseif((iLocal_1037[iParam0] !=10 && iLocal_1037[iParam0] !=11) && iLocal_1037[iParam0] !=7){
iLocal_1037[iParam0]=10;
}
...
int iVar0;
int iVar1[10];
uLocal_1216=PED::GET_PED_NEARBY_VEHICLES(PLAYER::PLAYER_PED_ID(), &iVar1);
...
if(!PED::IS_PED_INJURED(iLocal_1050)){
if(!iLocal_1138){
if(PED::IS_PED_IN_VEHICLE(iLocal_1050, iLocal_1316, 0) && func_141()){
return 1;
}}elseif(PED::IS_PED_IN_VEHICLE(iLocal_1050, iLocal_1316, 0)){
return 1;
}}}
return 0;
}
...
while (iVar0 <=1){
if(!PED::IS_PED_INJURED(iLocal_1051[iVar0])){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_1051[iVar0], 0)){
iVar1=0;
}}
iVar0++;
}
...
TASK::TASK_AIM_GUN_AT_ENTITY(iParam0, iLocal_1049, -1, 0);
...
case 0:
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1050, 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_1050, 0)){
if(!PED::IS_PED_INJURED(iLocal_1051[iParam0])){
if(iParam0==0){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_1051[iParam0], iLocal_1050, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
}
elseif(iParam0==1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1317, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_1051[iParam0], uVar2);
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1051[iParam0], 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1051[iParam0], 0)){
if(!PED::IS_PED_IN_VEHICLE(iLocal_1051[iParam0], iVar0, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_1050, 0)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1051[iParam0], 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_1051[iParam0], iVar0, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
if(iLocal_1138){
if(!bLocal_1168){
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_1051[iParam0], joaat("script_task_combat")) !=1){
TASK::TASK_COMBAT_PED(iLocal_1051[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
}
}}elseif(!iLocal_1162){
iLocal_1045[iParam0]=5;
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
TASK::TASK_PERFORM_SEQUENCE(iLocal_1051[iParam0], uLocal_1328);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
}elseif(!PED::IS_PED_INJURED(iLocal_1051[iParam0])){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_1051[iParam0], Local_1309, 15f, 0, 0);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_1051[iParam0], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1051[iParam0], 0, 1);
PED::SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_1051[iParam0], 2f);
if(!iLocal_1135 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_1051[iParam0], 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_1328);
if(PED::IS_PED_INJURED(iLocal_1050)){
...
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_1050, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
iLocal_1135=1;
}else{
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1316) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
Var4={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_1316, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_1316, "wheel_lr")) 
};
Var7={
ENTITY::GET_ENTITY_COORDS(iLocal_1316, 1) 
};
...
PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_1051[iParam0], iLocal_1316, Var7, 1.5f, 0);
}
TASK::OPEN_SEQUENCE_TASK(&uLocal_1328);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1050, 0)){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_1050, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
}}
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1051[iParam0], 0)){
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1051[iParam0], iLocal_1050, PLAYER::PLAYER_PED_ID(), 3f, 1, 0.005f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}}
...
}}elseif(func_137(iLocal_1051[iParam0])){
iLocal_1138=1;
}}elseif(iLocal_1045[iParam0] < 5){
if(!PED::IS_PED_INJURED(iLocal_1051[iParam0])){
if(PED::IS_PED_USING_ANY_SCENARIO(iLocal_1051[iParam0])){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_1051[iParam0]);
}
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1051[iParam0], 13, 1);
}
iLocal_1045[iParam0]=5;
}}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1050)){
Local_1309={
ENTITY::GET_ENTITY_COORDS(iLocal_1050, 0) 
};
}
switch (iLocal_1044){
case 0:
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1050, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0) && !ENTITY::IS_ENTITY_DEAD(uLocal_1054[0], 0)){
if(!PED::IS_PED_IN_VEHICLE(iLocal_1050, iLocal_1316, 0)){
...
TASK::TASK_SMART_FLEE_PED(0, iLocal_1049, 200f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1050, 0)){
TASK::TASK_PERFORM_SEQUENCE(iLocal_1050, uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
bLocal_1168=true;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_1050, joaat("script_task_any")) !=1){
TASK::TASK_SMART_FLEE_PED(iLocal_1050, iLocal_1049, 200f, -1, 0, 0);
}
if(!iLocal_1183){
...
if(!iLocal_1138){
if(iLocal_1162){
}elseif(func_137(iLocal_1050) || iLocal_1192){
...
int iVar0;
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1316, -1, 0);
if(iVar0==0 || (iVar0 !=0 && PED::IS_PED_INJURED(iVar0))){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1316, 0, 0);
if(iVar0==0 || (iVar0 !=0 && PED::IS_PED_INJURED(iVar0))){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1316, 2, 0);
if(iVar0==0 || (iVar0 !=0 && PED::IS_PED_INJURED(iVar0))){
return 1;
}}}}
return 0;
...
func_230();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_233((2f - 0.5f)) - 0.001388889f)), fVar6, func_227(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
}else{
return;
}
...
fVar12=func_211((fVar11 / (0.6f * func_233(25f))), 0f, 1f);
func_230();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_233((2f * 0.5f))), fVar6, func_227(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
fVar1=(fVar1 + func_233((2f * 0.3f)));
if(uParam0->f_56 > 0){
fVar1=(fVar1 + func_233((25f * 0.2f)));
}}}}
...
TASK::CLEAR_PED_TASKS(uLocal_1054[iVar0]);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_1054[iVar0]));
}}
iVar0++;
}
iVar0=0;
...
TASK::CLEAR_PED_TASKS(uLocal_1058[iVar0]);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_1058[iVar0]));
}}
iVar0++;
}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1317, 0)){
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1058[0], 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1317, 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_1058[0], iLocal_1317, 0)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_1058[0]);
}}}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[1]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1058[1], 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1317, 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_1058[1], iLocal_1317, 0)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_1058[1]);
}}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_1317, 0)){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1323) && !ENTITY::IS_ENTITY_DEAD(iLocal_1323, 0)){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_1323) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_1323, 1)){
...
int iVar0;
if(bParam0){
if(HUD::DOES_BLIP_EXIST(uLocal_1124)){
HUD::REMOVE_BLIP(&uLocal_1124);
}}
iVar0=0;
while (iVar0 < 3){
...
void func_263(){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_1297, Local_1300, fLocal_1247, 1, 0, 0)){
bLocal_1156=true;
}else{
bLocal_1156=false;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_1054[0], iLocal_1316, 0)){
bLocal_1149=true;
func_264();
iLocal_1035=13;
}
...
float fVar10;
int iVar11;
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1050) && !ENTITY::IS_ENTITY_DEAD(iLocal_1050, 0)){
Var7={
ENTITY::GET_ENTITY_COORDS(iLocal_1050, 1) 
};
fVar10=ENTITY::GET_ENTITY_HEADING(iLocal_1050);
}
Var0[0 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var7, fVar10, 1f, -1f, 0f) 
};
Var0[1 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var7, fVar10, -1f, -1f, 0f) 
};
...
while (iVar11 < 2){
if(iVar11==0){
iLocal_1051[iVar11]=PED::CREATE_PED(26, iLocal_1331, Var0[0 /*3*/], Var0[0 /*3*/].f_1, 38.3253f, uLocal_1243[iLocal_1206], 1, 1);
}else{
iLocal_1051[iVar11]=PED::CREATE_PED(26, iLocal_1332, Var0[1 /*3*/], Var0[1 /*3*/].f_1, 38.3253f, uLocal_1243[iLocal_1206], 1, 1);
}
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1051[iVar11], 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_1051[iVar11]);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1051[iVar11], 3, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1051[iVar11], 23, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1051[iVar11], 30, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1051[iVar11], 13, 1);
PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_1051[iVar11], 2);
PED::SET_PED_KEEP_TASK(iLocal_1051[iVar11], 1);
func_277(iLocal_1051[iVar11], 1);
PED::SET_PED_TO_LOAD_COVER(iLocal_1051[iVar11], 1);
iVar11++;
}}
...
iLocal_1050=PED::CREATE_PED(26, iLocal_1329, Local_1262[iLocal_1206 /*3*/], uLocal_1243[iLocal_1206], 1, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1050, 1, 1);
...
HUD::SET_BLIP_SCALE(uLocal_1124, 1f);
}
...
return func_32(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), Param0, iParam3);
}
...
if(PED::IS_PED_IN_VEHICLE(uLocal_1054[0], iLocal_1316, 0) && PED::IS_PED_IN_VEHICLE(uLocal_1054[1], iLocal_1316, 0)){
return 1;
}}
return 0;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1316, 0, 1, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1323) && !ENTITY::IS_ENTITY_DEAD(iLocal_1323, 0)){
...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_1323, 1) 
};
return 1;
}}}
return 0;
...
iVar1=0;
while (iVar1 < 3){
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1054[iVar1])){
if(iVar1==2){
iVar0=iLocal_1332;
}else{
iVar0=iLocal_1331;
}
uLocal_1054[iVar1]=PED::CREATE_PED(26, iVar0, Local_1272[iVar1 /*3*/], fLocal_1225[iVar1], 1, 1);
if(iVar1==0){
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 3, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 11, 0, 0, 0);
}elseif(iVar1==1){
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 11, 0, 2, 0);
}elseif(iVar1==2){
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 3, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iVar1], 11, 1, 1, 0);
}}
if(!PED::IS_PED_INJURED(uLocal_1054[iVar1])){
PED::SET_PED_CAN_BE_TARGETTED(uLocal_1054[iVar1], 0);
PED::SET_PED_KEEP_TASK(uLocal_1054[iVar1], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1054[iVar1], 23, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1054[iVar1], 30, 0);
PED::SET_PED_TARGET_LOSS_RESPONSE(uLocal_1054[iVar1], 2);
PED::SET_PED_CONFIG_FLAG(uLocal_1054[iVar1], 104, 1);
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1058[iVar0])){
if(iVar0==0){
uLocal_1058[iVar0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1317, 26, iLocal_1331, -1, 1, 1);
}elseif(iVar0==1){
uLocal_1058[iVar0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1317, 26, iLocal_1332, 0, 1, 1);
}
func_277(uLocal_1058[iVar0], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1058[iVar0], 3, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1058[iVar0], 23, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1058[iVar0], 30, 0);
PED::SET_PED_TARGET_LOSS_RESPONSE(uLocal_1058[iVar0], 2);
PED::SET_PED_KEEP_TASK(uLocal_1058[iVar0], 1);
}
iVar0++;
}}
...
void func_296(){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1317)){
iLocal_1317=VEHICLE::CREATE_VEHICLE(iLocal_1333, Local_1288, fLocal_1237, 1, 1, 0);
...
Var18={
func_349(Var18, -Var0.f_3.f_2) 
};
Var18={
func_349(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__349(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
switch (iLocal_1197){
case 0:
if(func_414(1084227584, 1) || (bLocal_1155 && STREAMING::STREAMVOL_HAS_LOADED(uLocal_1134))){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1316, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1316, 0)){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_1316, 107, "ASSOJva", 1);
...
iLocal_1197++;
}elseif(STREAMING::STREAMVOL_HAS_LOADED(uLocal_1134)){
}
break;
case 1:
if(func_385()){
...
func_410(0, 0, 1);
func_409();
CAM::SHAKE_CAM(uLocal_1334, "HAND_SHAKE", 0.2f);
CAM::SHAKE_CAM(uLocal_1335, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1335, uLocal_1334, 6000, 0, 0);
...
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_1316, 102, "ASSOJva", 1);
VEHICLE::SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(iLocal_1316, 4500f);
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(iLocal_1316, 1);
func_259("ASS_VA_SNIPE2", 7500, 1);
CAM::SET_CAM_PARAMS(uLocal_1334, -1218.861f, -191.0496f, 38.83616f, 3.519839f, -0.000706f, 42.27108f, 38f, 0, 1, 1, 2);
CAM::SET_CAM_NEAR_DOF(uLocal_1334, 0.5f);
CAM::SET_CAM_FAR_DOF(uLocal_1334, 7f);
CAM::SHAKE_CAM(uLocal_1334, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_PARAMS(uLocal_1335, -1218.91f, -190.8791f, 38.84585f, 3.519839f, -0.000706f, 43.33815f, 38f, 0, 1, 1, 2);
CAM::SET_CAM_NEAR_DOF(uLocal_1335, 0.7f);
CAM::SET_CAM_FAR_DOF(uLocal_1335, 10f);
CAM::SHAKE_CAM(uLocal_1335, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1335, uLocal_1334, 2000, 3, 3);
iLocal_1198++;
}}}
break;
case 2:
...
iLocal_1196=0;
while (iLocal_1196 < 3){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1054[iLocal_1196], 0)){
if(iLocal_1196==0){
iVar0=1250;
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1054[iLocal_1196], joaat("script_task_perform_sequence")) !=1){
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
TASK::OPEN_SEQUENCE_TASK(&uLocal_1328);
TASK::TASK_LEAVE_ANY_VEHICLE(0, iVar0, 0);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_1252[iLocal_1196 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_1328);
TASK::TASK_PERFORM_SEQUENCE(uLocal_1054[iLocal_1196], uLocal_1328);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1328);
}}
iLocal_1196++;
}
...
CAM::SET_CAM_PARAMS(uLocal_1334, -1265.549f, -213.4919f, 43.0913f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1334, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_PARAMS(uLocal_1335, -1266.063f, -213.922f, 43.0918f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1335, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1335, uLocal_1334, 4000, 3, 3);
iLocal_1221=4000;
}else{
CAM::SET_CAM_PARAMS(uLocal_1334, -1266.193f, -215.217f, 43.2442f, -3.1088f, 0.0498f, -48.5594f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1334, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_PARAMS(uLocal_1335, -1267.53f, -215.7824f, 43.1067f, -9.2365f, 0.0498f, -48.3561f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1335, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1335, uLocal_1334, 4000, 3, 3);
iLocal_1221=4000;
}
...
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1316, 1, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1316, 0, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1316, 2, 1);
HUD::CLEAR_HELP(1);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4){
...
VEHICLE::REMOVE_VEHICLE_RECORDING(102, "ASSOJva");
VEHICLE::REMOVE_VEHICLE_RECORDING(107, "ASSOJva");
ENTITY::SET_ENTITY_COORDS(iLocal_1316, Local_1294, 1, 0, 0, 1);
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_1306, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 299.4985f);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1319)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1319, 0)){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1319, 0, 1, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_1319, -1251.873f, -256.7999f, 38.2695f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_1319, 296.7603f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1319, 1084227584);
}}}
...
if(iLocal_1196==0){
uLocal_1054[iLocal_1196]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1316, 26, iLocal_1331, -1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 3, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 11, 0, 0, 0);
}elseif(iLocal_1196==1){
uLocal_1054[iLocal_1196]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1316, 26, iLocal_1331, 0, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 11, 0, 2, 0);
}elseif(iLocal_1196==2){
uLocal_1054[iLocal_1196]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1316, 26, iLocal_1332, 1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 3, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_1054[iLocal_1196], 11, 1, 1, 0);
}}
iLocal_1196++;
}}}}
...
void func_412(){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1316)){
iLocal_1316=VEHICLE::CREATE_VEHICLE(iLocal_1330, Local_1291, fLocal_1223, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1330);
VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_1316, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1316, 1, 1);
VEHICLE::SET_VEHICLE_PROVIDES_COVER(iLocal_1316, 1);
}}
...
iLocal_1323=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1323) && !ENTITY::IS_ENTITY_DEAD(iLocal_1323, 0)){
func_297(iLocal_1323);
}
}}}}
if(!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
if(!func_427()){
if(!HUD::DOES_BLIP_EXIST(uLocal_1123)){
uLocal_1123=func_426(Local_1306, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_1123, "ASS_VA_DESTBLIP");
...
HUD::CLEAR_PRINTS();
}}}elseif(STREAMING::STREAMVOL_HAS_LOADED(uLocal_1134) && func_423()){
func_422();
func_264();
iLocal_1035=8;
}}elseif(!func_427()){
...
func_420();
uLocal_1134=STREAMING::STREAMVOL_CREATE_FRUSTUM(-1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 80f, 12, 127);
iLocal_1136=1;
}}elseif(func_282(Local_1306, 1) > 120f){
if(STREAMING::STREAMVOL_IS_VALID(uLocal_1134)){
STREAMING::STREAMVOL_DELETE(uLocal_1134);
func_272();
iLocal_1136=0;
}}elseif(!STREAMING::STREAMVOL_IS_VALID(uLocal_1134)){
if(!func_419()){
iLocal_1136=0;
}}}
...
var func__426(struct<3> Param0, int iParam3){
var uVar0;
...
if(func_428()){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_1049, Local_1306, 25f, 25f, 90f, 1, 1, 0)){
iVar1=1;
}}
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if((fVar0 < 2f || ENTITY::IS_ENTITY_AT_COORD(iLocal_1049, Local_1306, 2f, 2f, 2f, 1, 1, 0)) || iVar1){
...
iLocal_1319=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
break;
case 1:
Local_1695[0]=PED::CREATE_PED(4, joaat("a_f_m_bevhills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, 1, 1);
Local_1695[1]=PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1695[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1695[1], 1);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
...
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(Local_1695[0], 0)){
TASK::TASK_PERFORM_SEQUENCE(Local_1695[0], uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
...
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(Local_1695[1], 0)){
TASK::TASK_PERFORM_SEQUENCE(Local_1695[1], uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
Local_1695.f_4=VEHICLE::CREATE_VEHICLE(joaat("taxi"), -1221.73f, -199.0665f, 38.1751f, 152.5038f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1695.f_4, 1084227584);
Local_1695.f_3=PED::CREATE_PED_INSIDE_VEHICLE(Local_1695.f_4, 4, joaat("a_m_y_hipster_01"), -1, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1695.f_3, 1);
TASK::TASK_LOOK_AT_ENTITY(Local_1695.f_3, Local_1695[0], -1, 0, 2);
Local_1695.f_8[0]=PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, 1, 1);
Local_1695.f_8[1]=PED::CREATE_PED(4, joaat("a_m_y_hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1695.f_8[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1695.f_8[1], 1);
TASK::TASK_PLAY_ANIM(Local_1695.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(Local_1695.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0, 0, 0, 0);
Local_1695.f_5[0]=PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, 1, 1);
Local_1695.f_5[1]=PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1695.f_5[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1695.f_5[1], 1);
TASK::TASK_PLAY_ANIM(Local_1695.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(Local_1695.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
Local_1695.f_11=1;
...
if(iLocal_1190){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
fLocal_1249=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_1306);
iLocal_1190=0;
...
func_37(7);
}elseif(SYSTEM::VDIST(Var0, Local_1306) > (fLocal_1249 + 200f)){
if(!iLocal_1186){
...
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(iLocal_1062, 0);
PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_1062, 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_1062, 0);
PED::SET_RAGDOLL_BLOCKING_FLAGS(iLocal_1062, 16);
PED::SET_PED_CONFIG_FLAG(iLocal_1062, 208, 1);
if(fVar1 < 5f){
...
case 0:
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || (ENTITY::DOES_ENTITY_EXIST(iLocal_1062) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1062, PLAYER::PLAYER_PED_ID(), 1))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1694, PLAYER::PLAYER_PED_ID(), 1)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1694, PLAYER::PLAYER_PED_ID(), 1)){
}
PED::SET_PED_MOVEMENT_CLIPSET(iLocal_1062, "move_lester_CaneUp", 1048576000);
TASK::TASK_PLAY_ANIM(iLocal_1062, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
iLocal_1195=1;
}}
break;
case 1:
...
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_1062, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
PED::FORCE_PED_MOTION_STATE(iLocal_1062, joaat("MotionState_Walk"), 0, 0, 0);
iLocal_1195=2;
}}
break;
case 2:
...
void func_437(){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1062)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1062, PLAYER::PLAYER_PED_ID(), 1)){
func_37(9);
}}}
...
void func_444(){
uLocal_1320[0]=VEHICLE::CREATE_VEHICLE(iLocal_1333, -1270.045f, -251.4953f, 41.4459f, 214.63f, 1, 1, 0);
uLocal_1320[1]=VEHICLE::CREATE_VEHICLE(iLocal_1333, -1265.199f, -218.4823f, 45.9981f, 127.85f, 1, 1, 0);
}


void func_445(){
uLocal_1334=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
uLocal_1335=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1243.588f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
}
...
uLocal_1132=PED::ADD_SCENARIO_BLOCKING_AREA(Var0 - Vector(15f, 15f, 15f), Var0 + Vector(15f, 15f, 15f), 0, 1, 1, 1);
uLocal_1133=PED::ADD_SCENARIO_BLOCKING_AREA(Var3 - Vector(45f, 35f, 35f), Var3 + Vector(45f, 35f, 35f), 0, 1, 1, 1);
}


void func_450(){
StringCopy(&Local_969, "ASS_VA_PASSED", 24);
MemCopy(&(Local_969.f_6),{
Global_63377
}
, 6);
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_1673, 1, 0, 0, 1);
...
if(!CAM::DOES_CAM_EXIST(uLocal_1677)){
uLocal_1677=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Local_1679, Local_1682, 42.2032f, 1, 2);
CAM::SHAKE_CAM(uLocal_1677, "HAND_SHAKE", 0.3f);
}
if(!CAM::DOES_CAM_EXIST(uLocal_1678)){
uLocal_1678=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Local_1685, Local_1688, 42.2032f, 0, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1678, uLocal_1677, 5000, 1, 1);
CAM::SHAKE_CAM(uLocal_1677, "HAND_SHAKE", 0.3f);
}
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
if(func_46(0)){
...
ENTITY::SET_ENTITY_COORDS(iLocal_1062, -1509.458f, -948.195f, 7.75f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_1062, -11f);
TASK::TASK_PLAY_ANIM(iLocal_1062, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_1062, 0, 0);
}}}
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0))){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("WalkingStick_Lester", 0)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1062) && !PED::IS_PED_INJURED(iLocal_1062)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_1063, iLocal_1062, PED::GET_PED_BONE_INDEX(iLocal_1062, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}}
if(CUTSCENE::HAS_CUTSCENE_FINISHED() && !CUTSCENE::IS_CUTSCENE_PLAYING()){
func_392(0, 1, 1, 0, 0, 0, 0);
if(!PED::IS_PED_INJURED(iLocal_1062)){
ENTITY::SET_ENTITY_PROOFS(iLocal_1062, 0, 0, 0, 0, 0, 0, 0, 0);
PED::SET_PED_CAN_RAGDOLL(iLocal_1062, 1);
}
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
if(CAM::IS_SCREEN_FADED_OUT()){
...
iLocal_1694=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1510.103f, -947.7194f, 8.2332f, 5f, joaat("prop_bench_08"), 1, 0, 1);
}}
...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_1324[iLocal_1220 + 1], 1, 0);
VEHICLE::SET_VEHICLE_HAS_BEEN_DRIVEN_FLAG(iLocal_1324[iLocal_1220 + 1], 0);
iLocal_1220++;
}}}}}}}
...
if(!ENTITY::IS_ENTITY_DEAD(Local_1695[0], 0) && !ENTITY::IS_ENTITY_DEAD(Local_1695[1], 0)){
TASK::TASK_LOOK_AT_ENTITY(Local_1695[0], Local_1695[1], -1, 0, 2);
TASK::TASK_LOOK_AT_ENTITY(Local_1695[1], Local_1695[0], -1, 0, 2);
}
if(((ENTITY::DOES_ENTITY_EXIST(Local_1695[1]) && ENTITY::DOES_ENTITY_EXIST(Local_1695.f_4)) && !PED::IS_PED_INJURED(Local_1695[1])) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1695.f_4, 0)){
...
if(((ENTITY::DOES_ENTITY_EXIST(Local_1695[0]) && ENTITY::DOES_ENTITY_EXIST(Local_1695.f_4)) && !PED::IS_PED_INJURED(Local_1695[0])) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1695.f_4, 0)){
...
if(PED::IS_PED_IN_VEHICLE(Local_1695[0], Local_1695.f_4, 0) && PED::IS_PED_IN_VEHICLE(Local_1695[1], Local_1695.f_4, 0)){
if(!ENTITY::IS_ENTITY_DEAD(Local_1695.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_1695.f_4, 0)){
...
if(func_58(&uLocal_1352)){
if(func_52(&uLocal_1352) > 3f){
if(!PED::IS_PED_INJURED(Local_1695.f_3) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1695.f_4, 0)){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1695.f_3, Local_1695.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
iLocal_1210++;
}}}
break;
case 3:
...
void func_462(){
if((ENTITY::DOES_ENTITY_EXIST(Local_1695.f_3) && !ENTITY::IS_ENTITY_DEAD(Local_1695.f_3, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1695.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1695[0]) && !ENTITY::IS_ENTITY_DEAD(Local_1695[0], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1695[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_1695[0], 2, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1695[1]) && !ENTITY::IS_ENTITY_DEAD(Local_1695[1], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1695[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_1695[1], 2, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1695.f_8[0]) && !ENTITY::IS_ENTITY_DEAD(Local_1695.f_8[0], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1695.f_8[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1695.f_8[1]) && !ENTITY::IS_ENTITY_DEAD(Local_1695.f_8[1], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1695.f_8[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1695.f_5[0]) && !ENTITY::IS_ENTITY_DEAD(Local_1695.f_5[0], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1695.f_5[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1695.f_5[1]) && !ENTITY::IS_ENTITY_DEAD(Local_1695.f_5[1], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1695.f_5[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}}

int func_463(){
if(!ENTITY::IS_ENTITY_DEAD(Local_1695.f_3, 0)){
if(PED::IS_PED_BEING_JACKED(Local_1695.f_3)){
if(PED::GET_PEDS_JACKER(Local_1695.f_3)==PLAYER::PLAYER_PED_ID()){
return 1;
}}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(Local_1695.f_4, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1695.f_4, 0)){
return 1;
}}
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_498(iParam0, uVar1[iVar6], 1) && func_497(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_50(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_1132, 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_1133, 0);
func_533();
func_92(&uLocal_1533, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1331, 0);
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1332, 0);
func_542();
