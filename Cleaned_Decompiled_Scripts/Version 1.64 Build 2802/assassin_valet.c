...
uLocal_1303={
-1236.6611f, -197.316f, 39.6313f 
};
uLocal_1306={
-1266.0273f, -218.98291f, 41.44594f 
};
uLocal_1312={
-1237.7314f, -189.54518f, 40.63728f 
};
fLocal_1315=40f;
...
uLocal_1669={
-1263.6769f, -222.2767f, 41.446f 
};
fLocal_1672=304.201f;
uLocal_1673={
-1507.2521f, -934.3307f, 8.6562f 
};
fLocal_1676=137.9228f;
uLocal_1679={
-1510.7333f, -935.95996f, 10.902136f 
};
uLocal_1682={
15.074911f, -0.024198f, -71.861885f 
};
uLocal_1685={
-1510.8776f, -936.1155f, 9.798549f 
};
uLocal_1688={
...
if(func_539()) bLocal_1157=true;
bLocal_1146=true;
}else{
bLocal_1146=false;
}
func_538();
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 32, false);
func_537();
iLocal_269=0;
uLocal_57={
func_535(iLocal_269) 
...
if(Global_94858)if(iLocal_1213 <=1) iLocal_1213=iLocal_1213 + 1;
func_533();
if(iLocal_1213==0){
if(bLocal_1157){
func_531();
...
if(!VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(vehicle)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(vehicle)) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(vehicle)) && !VEHICLE::IS_BIG_VEHICLE(vehicle)) VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vehicle, 1084227584);
else VEHICLE::DELETE_VEHICLE(&vehicle);
}
func_466(-1510.181f, -946.9595f, 8.2738f, 10f, 1, 0);
}elseif(iLocal_1213==1){
if(bLocal_1157){
func_531();
while (!func_530()){
SYSTEM::WAIT(0);
...
if(!VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(vehicle2)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(vehicle2)) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(vehicle2)) && !VEHICLE::IS_BIG_VEHICLE(vehicle2)) VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vehicle2, 1084227584);
else VEHICLE::DELETE_VEHICLE(&vehicle2);
}
func_466(-1266.1729f, -214.0011f, 41.4459f, 310.0126f, 1, 0);
}elseif(iLocal_1213==2){
if(bLocal_1157){
func_531();
while (!func_530()){
SYSTEM::WAIT(0);
...
if(!VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(vehicle3)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(vehicle3)) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(vehicle3)) && !VEHICLE::IS_BIG_VEHICLE(vehicle3)) VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(vehicle3, 1084227584);
else VEHICLE::DELETE_VEHICLE(&vehicle3);
}
...
}elseif(!PED::IS_PED_INJURED(pedLocal_1049)){
func_457();
if(iLocal_1035 < 10) uLocal_360.f_6=1;
else uLocal_360.f_6=5;
func_154();
func_102();
if(bLocal_1162) func_97();
if(!bLocal_1145)if(iLocal_1035 >=9 && iLocal_1035 < 11) func_93(&uLocal_1207, &fLocal_1222, &bLocal_1144, &bLocal_1145);
func_61();
func_59();
if(bLocal_1138 || bLocal_1143 && iLocal_1035 < 11 || bLocal_1173 && iLocal_1035 < 11){
if(!func_58(&uLocal_1358) && iLocal_1035 > 8){
func_55(&uLocal_1358);
}elseif(iLocal_1035 < 8 || func_52(&uLocal_1358) > 5f){
if(iLocal_1048==1) func_37(1);
elseif(iLocal_1048==5) func_37(5);
else func_37(2);
}elseif(func_52(&uLocal_1358) > 2.5f){
if(!bLocal_1174){
if(!bLocal_1193) pedLocal_1061=func_36(70f, false);
else pedLocal_1061=func_36(70f, true);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
if(!PED::IS_PED_INJURED(pedLocal_1061)){
TASK::CLEAR_PED_TASKS(pedLocal_1061);
if(iLocal_1048==1){
if(ENTITY::DOES_ENTITY_EXIST(eLocal_1318))if(!PED::IS_PED_IN_ANY_VEHICLE(pedLocal_1061, false)) TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(pedLocal_1061, eLocal_1318, eLocal_1318, 2f, false, 1056964608, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
...
}}elseif(iLocal_1048==8){
if(ENTITY::DOES_ENTITY_EXIST(veLocal_1316) && VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false)) TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(pedLocal_1061, veLocal_1316, veLocal_1316, 2f, false, 1056964608, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
...
if(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)==joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn)==joaat("towtruck2")) bLocal_1148=true;
}else{
bLocal_1148=false;
}
if(bLocal_1148)if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(vehiclePedIsIn, veLocal_1316)) VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(vehiclePedIsIn, veLocal_1316);
return;
}
...
if(!MISC::ARE_STRINGS_EQUAL(&string1, "OJAS_FEED")) func_3();
}}}
return;
}
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_20(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_20(character)) return func_23(character);
...
i <=2;
i=i + 1){
if(!PED::IS_PED_INJURED(uLocal_1054[i]))if(func_32(uLocal_1054[i], uLocal_1294, true) < fParam0) return uLocal_1054[i];
}
for (i=0;
i <=1;
i=i + 1){
if(!PED::IS_PED_INJURED(uLocal_1058[i]))if(func_32(uLocal_1058[i], uLocal_1294, true) < fParam0) return uLocal_1058[i];
}
return 0;
}
...
if(ENTITY::IS_ENTITY_DEAD(pedParam0, false)) return -1f;
...
if(!PED::IS_PED_INJURED(pedParam0)) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_1368, iParam1, pedParam0, sParam2, 0, 1);
return;
}
...
HUD::CLEAR_PRINTS();
AUDIO::TRIGGER_MUSIC_EVENT("ASS1_FAIL");
if(func_51()) func_49(-1698.51f, -1067.7682f, 12.1417f, 316.3502f);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) Global_100681.f_12[0]=1;
else Global_100681.f_12[0]=0;
switch (iLocal_1048){
case 0:
str="ASS_VA_FAILED";
break;
...
func_548(&(Global_113648.f_19965.f_1), 1024);
if(!MISC::IS_STRING_NULL(sParam0)) func_48(sParam0);
return;
}
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID())) return true;
return false;
}


float func_52(int* piParam0) // Position - 0x252D{
if(func_58(piParam0))if(func_54(piParam0)) return piParam0->f_2;
else return func_53(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;
return piParam0->f_1;
}
...
if(!func_58(piParam0)) func_56(piParam0);
return;
}
...
if(func_60(&iLocal_1048)) func_37(6);
return;
}
...
BOOL flag;
if(iLocal_1035 > 11){
if(!PED::IS_PED_INJURED(pedLocal_1050))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false))if(PED::IS_PED_IN_VEHICLE(pedLocal_1050, veLocal_1316, false)) flag=true;
if(bLocal_1168) num=100f;
else num=200f;
...
}}elseif(ENTITY::IS_ENTITY_OCCLUDED(pedLocal_1050)){
*uParam0=6;
return true;
}}elseif(HUD::DOES_BLIP_EXIST(blLocal_1124)){
if(func_30(pedLocal_1049, pedLocal_1050, true) >=num * 0.5f)if(!HUD::IS_BLIP_FLASHING(blLocal_1124)) HUD::SET_BLIP_FLASHES(blLocal_1124, true);
elseif(HUD::IS_BLIP_FLASHING(blLocal_1124)) HUD::SET_BLIP_FLASHES(blLocal_1124, false);
}}}}
return false;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_1050))if(!PED::IS_PED_INJURED(pedLocal_1050)) func_62(&uLocal_1533, pedLocal_1050, 0, 0, true, true, true);
return;
}
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) func_92(uParam0, 0, false);
uParam0->f_6=2;
...
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(string2)) func_90();
...
if(func_84(uParam0, bParam7, bParam9, false)) func_81(uParam0, pedParam1, uParam2, iParam6);
if(*uParam0){
*uParam0=0;
...
uParam0->f_3=string2;
if(MISC::ARE_STRINGS_EQUAL("CMN_HINT" /*~s~Press ~INPUT_VEH_CIN_CAM~ to toggle focus on the target.*/, string2)) func_68(true);
}
}}}}elseif(func_70(string2)){
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))if(PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID()))if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_BOAT)==CINEMATIC || CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_BOAT)==FIRST_PERSON) func_92(uParam0, string2, true);
elseif(PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()))if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_HELI)==CINEMATIC || CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_HELI)==FIRST_PERSON) func_92(uParam0, string2, true);
elseif(PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_AIRCRAFT)==CINEMATIC || CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_AIRCRAFT)==FIRST_PERSON) func_92(uParam0, string2, true);
elseif(PED::IS_PED_IN_ANY_SUB(PLAYER::PLAYER_PED_ID()))if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_SUBMARINE)==CINEMATIC || CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(IN_SUBMARINE)==FIRST_PERSON) func_92(uParam0, string2, true);
elseif(PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(ON_BIKE)==CINEMATIC || CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(ON_BIKE)==FIRST_PERSON) func_92(uParam0, string2, true);
elseif(CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE()==CINEMATIC || CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE()==FIRST_PERSON) func_92(uParam0, string2, true);
if(!func_84(uParam0, bParam7, bParam9, false))if(!*uParam0 && !uParam0->f_1 && !func_67(uParam0)) func_66(uParam0);
}}else{
...
if(func_89(PLAYER::PLAYER_PED_ID())) TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
if(CAM::IS_GAMEPLAY_HINT_ACTIVE()){
...
case 0:
case 3:
if(func_68(false) < 3) return true;
break;
case 4:
if(func_68(false) < 1) return true;
break;
case 5:
case 15:
if(func_68(false) < 1) return true;
...
if(func_80(0)) return false;
if(func_79()) return false;
...
if(ENTITY::IS_ENTITY_DEAD(pedParam1, false)) func_92(uParam0, 0, false);
if(func_50(vParam2, 0f, 0f, 0f, false)){
if(ENTITY::IS_ENTITY_A_PED(pedParam1)){
pedIndexFromEntityIndex=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam1);
if(!PED::IS_PED_IN_ANY_VEHICLE(pedIndexFromEntityIndex, false))if(PED::IS_PED_A_PLAYER(pedIndexFromEntityIndex))if(!func_82()) vParam2={
0f, 0f, 1f 
};
...
break;
case 2:
if(uParam0->f_6==0)if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))if(!func_88(bParam1, bParam2, bParam3)) uParam0->f_5=0;
elseif(!func_87(bParam1, bParam2, bParam3)) uParam0->f_5=0;
elseif(uParam0->f_6==1)if(!func_87(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) uParam0->f_5=0;
...
elseif(!func_88(bParam1, bParam2, bParam3)) uParam0->f_5=0;
break;
case 3:
if(MISC::GET_GAME_TIMER() - uParam0->f_4 > 500)if(uParam0->f_6==0)if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))if(func_86(bParam1, bParam2, bParam3)) uParam0->f_5=0;
elseif(func_85(bParam1, bParam2, bParam3)) uParam0->f_5=0;
elseif(uParam0->f_6==1)if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || func_85(bParam1, bParam2, bParam3)) uParam0->f_5=0;
elseif(uParam0->f_6==2)if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)) uParam0->f_5=0;
elseif(func_86(bParam1, bParam2, bParam3)) uParam0->f_5=0;
break;
case 4:
if(!func_67(uParam0)) uParam0->f_5=0;
break;
}
...
if(!func_71(bParam0, bParam1, bParam2)) return false;
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
...
if(!func_58(&uLocal_1355)) func_55(&uLocal_1355);
*uParam2=1;
}
if(func_58(&uLocal_1355)){
num=func_52(&uLocal_1355);
if(num >=*uParam1) *uParam3=1;
}
iLocal_1217=SYSTEM::ROUND(*uParam1 - num);
iLocal_1217=iLocal_1217 * 1000;
if(iLocal_1217 < 63000) bLocal_1151=true;
if(iLocal_1217 < 65000) bLocal_1158=true;
if(iLocal_1217 < iLocal_1214) bLocal_1181=true;
if(!AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\\ASSASSINATION_MULTI", false, -1)) bLocal_1367=false;
else bLocal_1367=true;
...
i <=9;
i=i + 1){
if(num==-1)if(func_96(7, i)==false) num=i;
}
if(num > -1){
...
case 0:
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1054[0], false)) TASK::TASK_CLEAR_LOOK_AT(uLocal_1054[0]);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1054[1], false)) TASK::TASK_CLEAR_LOOK_AT(uLocal_1054[1]);
ped=func_101();
if(bLocal_1161){
if(!bLocal_1177){
func_34(ped, 3, "OJAvaGUARD");
if(_CONVERSATION_ADD_LINE(&uLocal_1368, "OJASAUD", "OJASva_EXPLO", 9, 0, 0, 0)) bLocal_1177=true;
}}elseif(!bLocal_1168 && PED::IS_PED_INJURED(pedLocal_1050)){
if(!bLocal_1177){
func_34(ped, 3, "OJAvaGUARD");
if(_CONVERSATION_ADD_LINE(&uLocal_1368, "OJASAUD", "OJASva_SNIPE", 9, 0, 0, 0)) bLocal_1177=true;
}}
if(!func_58(&uLocal_1343)) func_55(&uLocal_1343);
else func_56(&uLocal_1343);
iLocal_1211=1;
}
break;
case 1:
...
ped=func_101();
func_34(ped, 3, "OJAvaGUARD");
if(_CONVERSATION_ADD_LINE(&uLocal_1368, "OJASAUD", "OJASva_LOOK", 9, 0, 0, 0)) bLocal_1175=true;
}elseif(!bLocal_1185 && PED::IS_PED_INJURED(pedLocal_1050)){
ped=func_101();
func_100(ped);
}}}elseif(bLocal_1161){
if(!bLocal_1177){
...
if(func_99(pedLocal_1049)) fLocal_1248=2.5f;
else fLocal_1248=5f;
...
if(PED::CAN_PED_SEE_HATED_PED(uLocal_1054[i], PLAYER::PLAYER_PED_ID())) return true;
}}
for (i=0;
i < 2;
i=i + 1){
...
if(PED::CAN_PED_SEE_HATED_PED(uLocal_1058[i], PLAYER::PLAYER_PED_ID())) return true;
}}
for (i=0;
i < 2;
i=i + 1){
...
if(PED::CAN_PED_SEE_HATED_PED(uLocal_1051[i], PLAYER::PLAYER_PED_ID())) return true;
}}
return false;
}
BOOL func_99(Ped pedParam0) // Position - 0x3F4E{
if(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, -1252.3015f, -213.90327f, 35.112217f, -1205.8076f, -183.06808f, 45.325413f, 51f, false, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, -1250.8093f, -192.52184f, 35.33125f, -1231.8663f, -161.36552f, 45.025352f, 12.8f, false, true, 0)) return true;
return false;
}
...
i < 3;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1054[i]) && !PED::IS_PED_INJURED(uLocal_1054[i])) num=uLocal_1054[i];
}
if(num==0){
for (i=0;
i < 2;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[i]) && !PED::IS_PED_INJURED(uLocal_1058[i])) num=uLocal_1058[i];
}}
if(num==0){
for (i=0;
i < 2;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1051[i]) && !PED::IS_PED_INJURED(uLocal_1051[i])) num=uLocal_1051[i];
}}
return num;
}
...
func_109();
if(!bLocal_1162)if(!bLocal_1138)if(func_103(&iLocal_1048)) bLocal_1138=true;
return;
}
...
if(func_107(veLocal_1316) || func_106(veLocal_1316) || ENTITY::DOES_ENTITY_EXIST(veLocal_1316) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(veLocal_1316, pedLocal_1049, true)) return true;
if(func_107(veLocal_1317) || ENTITY::DOES_ENTITY_EXIST(veLocal_1317) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(veLocal_1317, pedLocal_1049, true)) return true;
...
if(iLocal_1035==12)if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false))if(func_30(pedLocal_1049, veLocal_1316, true) <=15f) return true;
if(uLocal_1037[0]==2 || uLocal_1037[1]==2 || uLocal_1037[2]==2)if(func_105()) return true;
if(iLocal_1035 < 11)if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, uLocal_1312, fLocal_1315)) return true;
elseif(FIRE::IS_EXPLOSION_IN_SPHERE(-1, uLocal_1312, fLocal_1315))if(func_104()) bLocal_1192=true;
else return true;
}
return false;
}
BOOL func_104() // Position - 0x438C{
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1272.181f, -241.25453f, 62.904064f, -1300.2035f, -201.39682f, 40.404076f, 44.5f, false, false, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1270.1255f, -253.93211f, 62.90407f, -1311.4138f, -193.65883f, 38.232914f, 44.5f, false, false, 0)) return true;
return false;
}
BOOL func_105() // Position - 0x43FE{
int weaponHash;
if(WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true))if(weaponHash==joaat("WEAPON_STICKYBOMB"))if(PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()))if(PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 24) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 69)) return true;
return false;
}
BOOL func_106(Vehicle veParam0) // Position - 0x4460{
if(ENTITY::DOES_ENTITY_EXIST(veParam0))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(VEHICLE::GET_VEHICLE_DOOR_LOCK_STATUS(veParam0)==3 && PED::GET_VEHICLE_PED_IS_ENTERING(pedLocal_1049)==veParam0) return 1;
return 0;
}
BOOL func_107(Vehicle veParam0) // Position - 0x449A{
int weaponHash;
Entity entity;
if(ENTITY::DOES_ENTITY_EXIST(veParam0))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veParam0, -1, false) !=0)if(WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true))if(weaponHash==joaat("WEAPON_STICKYBOMB"))if(func_30(PLAYER::PLAYER_PED_ID(), veParam0, true) < 40f)if(PLAYER::GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(PLAYER::PLAYER_ID(), &entity))if(ENTITY::IS_ENTITY_A_VEHICLE(entity) && ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(entity)==veParam0 || ENTITY::IS_ENTITY_A_PED(entity) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(entity)==VEHICLE::GET_PED_IN_VEHICLE_SEAT(veParam0, -1, false))if(PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 24) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 69)) return true;
return false;
}
...
i < 3;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1054[i]))if(bLocal_1138 && !bLocal_1171) func_149(uLocal_1054[i], &uLocal_1064[i /*8*/], -1, 0, false, false, 150f, 0, -1, -1, true, false, false);
}
for (i=0;
i < 2;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[i]))if(bLocal_1138 && !bLocal_1171) func_149(uLocal_1058[i], &uLocal_1089[i /*8*/], -1, 0, false, false, 150f, 0, -1, -1, true, false, false);
}
for (i=0;
i < 2;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1051[i])){
if(bLocal_1138 && !bLocal_1171) func_149(uLocal_1051[i], &uLocal_1106[i /*8*/], -1, 0, false, false, 150f, 0, -1, -1, true, false, false);
if(!PED::IS_PED_INJURED(uLocal_1051[i]))if(uLocal_1045[i]==4) PED::SET_PED_RESET_FLAG(uLocal_1051[i], 128, true);
}}
if(iLocal_1208==0){
func_147(0);
}elseif(iLocal_1208==1){
func_147(1);
}elseif(iLocal_1208==2){
if(iLocal_1035 >=9) func_136(0);
}elseif(iLocal_1208==3){
if(iLocal_1035 >=9) func_136(1);
}elseif(iLocal_1208==4){
if(iLocal_1035 >=9){
func_136(2);
func_135(-1222.5576f, -173.74709f, 38.325413f, -1220.1012f, -169.05315f, 42.075413f, 4f);
}}elseif(iLocal_1208==5){
func_110(0);
func_135(-1213.4323f, -191.32614f, 38.325413f, -1208.5529f, -193.86182f, 42.075344f, 4f);
}elseif(iLocal_1208==6){
func_110(1);
func_135(-1219.1403f, -202.31242f, 38.325344f, -1214.2693f, -204.9035f, 42.075344f, 4f);
}
iLocal_1208=iLocal_1208 + 1;
if(iLocal_1208 > 6) iLocal_1208=0;
if(bLocal_1138)if(!ENTITY::IS_ENTITY_DEAD(pedLocal_1050, false)) PED::SET_PED_RESET_FLAG(pedLocal_1050, 120, true);
return;
}
...
case 0:
if(bLocal_1151) uLocal_1041[iParam0]=1;
elseif(bLocal_1149) uLocal_1041[iParam0]=3;
break;
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1317, false)){
if(func_134()){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(veLocal_1317))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_1317, -1, false)==uLocal_1058[iParam0]) TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_1058[iParam0], veLocal_1317, "OJASva_104", 948, 0, 16, 18, 6f, false, 1073741824);
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(veLocal_1317, true) 
};
...
if(!bLocal_1138){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_1317, -1, false)==uLocal_1058[iParam0])if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], SCRIPT_TASK_VEHICLE_MISSION) !=1) TASK::TASK_VEHICLE_ESCORT(uLocal_1058[iParam0], veLocal_1317, veLocal_1316, -1, 45f, 786981, 10f, -1, 10f);
}
elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_1317, -1, false)==uLocal_1058[iParam0]){
if(!bLocal_1152){
if(ENTITY::IS_ENTITY_DEAD(pedLocal_1050, false)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) TASK::TASK_COMBAT_PED(entity2, PLAYER::PLAYER_PED_ID(), 0, 16);
else uLocal_1041[iParam0]=8;
}else{
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(ENTITY::GET_ENTITY_SPEED(veLocal_1317) < 5f) uLocal_1041[iParam0]=8;
TASK::TASK_COMBAT_PED(entity2, PLAYER::PLAYER_PED_ID(), 0, 16);
}
}
elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], SCRIPT_TASK_COMBAT) !=1){
TASK::TASK_COMBAT_PED(entity2, PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(!bLocal_1162){
...
break;
case 4:
if(!func_58(&uLocal_1337)) func_56(&uLocal_1337);
func_130(&uLocal_1058[iParam0]);
uLocal_1041[iParam0]=5;
break;
case 5:
if(!func_99(pedLocal_1049))if(func_52(&uLocal_1337) >=27f || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))if(!PED::IS_PED_INJURED(entity2))if(ENTITY::IS_ENTITY_AT_ENTITY(pedLocal_1049, entity2, 5f, 5f, 3f, false, true, 0)) func_129(entity2, 5f, 5f, 3f);
else func_133(iParam0);
else uLocal_1041[iParam0]=0;
break;
case 6:
if(bLocal_1163){
...
if(!PED::IS_PED_INJURED(uLocal_1058[iParam0])) TASK::TASK_PERFORM_SEQUENCE(uLocal_1058[iParam0], iLocal_1328);
...
break;
case 7:
if(!PED::IS_PED_INJURED(uLocal_1058[iParam0]))if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], SCRIPT_TASK_ANY) !=1) TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_1058[iParam0], pedLocal_1049, pedLocal_1049, 1f, false, -1f, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
break;
case 8:
if(iLocal_1048 !=4 && iLocal_1048 !=5) func_127(entity2);
else func_126(entity2);
uLocal_1041[iParam0]=9;
break;
case 9:
if(iParam0==0)if(iLocal_1048 !=4) func_125(veLocal_1317, entity2, 1112014848, 1112014848, 1092616192);
func_2(entity2);
func_100(entity2);
break;
}
if(!bLocal_1138){
if(bLocal_1162){
if(uLocal_1041[iParam0] !=6 && uLocal_1041[iParam0] !=7) uLocal_1041[iParam0]=6;
}elseif(func_118(entity2, veLocal_1317, &uLocal_360, &iLocal_371, false, false, false, true, true) || func_117(veLocal_1317)){
ped=func_36(1116471296, true);
if(ped !=0) func_116(ENTITY::GET_ENTITY_COORDS(ped, true), 1097859072, 1116471296);
if(!func_115()) bLocal_1138=true;
}elseif(!bLocal_1141){
...
}elseif(!func_99(pedLocal_1049)){
bLocal_1138=true;
if(!ENTITY::DOES_ENTITY_EXIST(pedLocal_1050)) iLocal_1048=5;
uLocal_1041[iParam0]=8;
}}}}}elseif(!PED::IS_PED_INJURED(entity2)){
if(PED::IS_PED_IN_VEHICLE(entity2, veLocal_1317, false))if(!VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1317, false) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false) || bLocal_1150 || !bLocal_1141)if(uLocal_1041[iParam0] < 8) uLocal_1041[iParam0]=8;
elseif(uLocal_1041[iParam0] < 8) uLocal_1041[iParam0]=8;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(PED::IS_PED_INJURED(pedParam0))if(HUD::DOES_BLIP_EXIST(blParam1)) HUD::REMOVE_BLIP(&blParam1);
return;
}
...
if(!bLocal_1138)if(!func_99(pedLocal_1049))if(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(!PED::IS_PED_INJURED(pedParam0))if(func_29(pedParam0, false) <=fParam1)if(PED::IS_PED_FACING_PED(pedParam0, pedLocal_1049, 120f))if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedLocal_1049, 17))if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1251.791f, -147.043f, 42.679f, -1197.245f, -212.232f, 50.679f, 35f, true, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1259.282f, -204.172f, -60.654f, -1304.335f, -235.719f, 60.654f, 85f, true, true, 0)) return true;
elseif(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(!PED::IS_PED_INJURED(pedParam0))if(ENTITY::IS_ENTITY_AT_ENTITY(pedLocal_1049, pedParam0, 5f, 5f, 1f, false, true, 0))if(PED::IS_PED_FACING_PED(pedParam0, pedLocal_1049, 120f))if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, pedLocal_1049, 17)) return true;
return false;
}
BOOL func_115() // Position - 0x5054{
if(bLocal_1162 || bLocal_1163) return true;
return false;
}
...
BOOL flag;
float num;
if(!ENTITY::DOES_ENTITY_EXIST(pedLocal_1050)) return;
if(!ENTITY::DOES_ENTITY_EXIST(veLocal_1316)) return;
if(ENTITY::IS_ENTITY_DEAD(veLocal_1316, false) || bLocal_1192) bLocal_1161=1;
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_1050)){
...
if(num > iParam3){
bLocal_1162=true;
if(num > iParam4) bLocal_1163=true;
}}}
return;
}
...
if(entitySpeed > 7f)if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(vehiclePedIsIn, veParam0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vehiclePedIsIn, veParam0, true)) return true;
}}}}}
return false;
}
...
if(!ENTITY::IS_ENTITY_DEAD(playersLastVehicle, false))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, playersLastVehicle, true))if((float)iLocal_359 > 100f) return true;
if(bLocal_356)if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), true))if((float)iLocal_359 > 100f) return true;
...
if(func_120(PLAYER::PLAYER_PED_ID(), pedParam0)) return true;
if(bParam2){
if(PED::IS_PED_RAGDOLL(pedParam0) && func_29(pedParam0, true) < 1.5f) return true;
...
if(PED::IS_PED_PLANTING_BOMB(pedParam0) || func_107(vehiclePedIsIn))if(ENTITY::IS_ENTITY_AT_COORD(pedParam1, ENTITY::GET_ENTITY_COORDS(pedParam0, true), (float)uParam2->f_6 * 3, (float)uParam2->f_6 * 3, (float)uParam2->f_6 * 3, false, true, 0))if(PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam1), pedParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam1, pedParam0, 17)) return true;
}}
...
if(TASK::GET_SCRIPT_TASK_STATUS(pedParam1, SCRIPT_TASK_ENTER_VEHICLE) !=1) TASK::TASK_ENTER_VEHICLE(pedParam1, veParam0, 20000, -1, 1073741824, 1, 0);
}elseif(TASK::GET_SCRIPT_TASK_STATUS(pedParam1, SCRIPT_TASK_VEHICLE_MISSION) !=1){
...
}}elseif(!PED::IS_PED_IN_VEHICLE(pedParam1, veParam0, false)){
if(TASK::GET_SCRIPT_TASK_STATUS(pedParam1, SCRIPT_TASK_COMBAT) !=1) TASK::TASK_COMBAT_PED(pedParam1, PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(PED::IS_PED_IN_VEHICLE(pedParam1, veParam0, false)){
...
TASK::ADD_VEHICLE_SUBTASK_ATTACK_PED(pedParam1, PLAYER::PLAYER_PED_ID());
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(pedParam1, SCRIPT_TASK_COMBAT) !=1){
...
if(!ENTITY::IS_ENTITY_DEAD(pedParam0, false)) PED::SET_PED_COMBAT_ATTRIBUTES(pedParam0, BF_CanLeaveVehicle, true);
...
TASK::CLOSE_SEQUENCE_TASK(iLocal_1328);
if(!ENTITY::IS_ENTITY_DEAD(pedParam0, false)) TASK::TASK_PERFORM_SEQUENCE(pedParam0, iLocal_1328);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_1328);
}elseif(!PED::IS_PED_INJURED(pedParam0)){
...
Vector3 func__128() // Position - 0x5A16{
var unk;
int num;
...
iLocal_1048=5;
bLocal_1138=true;
}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(pedParam0, false)){
if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY) !=1) TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(pedParam0, pedLocal_1049, pedLocal_1049, 1f, false, -1f, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
}}}
return;
}
...
int taskSequenceId;
var entityCoords;
if(pedLocal_1061==0) pedLocal_1061=func_36(70f, false);
...
}elseif(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, SCRIPT_TASK_GO_TO_ENTITY) !=1){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(*uParam0, pedLocal_1049, -1);
}}elseif(*uParam0 !=pedLocal_1061){
if(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, SCRIPT_TASK_GO_TO_ENTITY) !=1) TASK::TASK_TURN_PED_TO_FACE_ENTITY(*uParam0, pedLocal_1049, -1);
}}
...
if(!ENTITY::IS_ENTITY_DEAD(veLocal_1316, false)) entityCoords2={
ENTITY::GET_ENTITY_COORDS(veLocal_1316, true) 
};
num=SYSTEM::VDIST2(entityCoords, entityCoords2);
if(num <=25f) return true;
}
return false;
}
...
bLocal_1139=true;
if(iParam0==0) seat=-1;
elseif(iParam0==1) seat=0;
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1058[iParam0], false))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1317, false))if(!PED::IS_PED_IN_VEHICLE(uLocal_1058[iParam0], veLocal_1317, false))if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1058[iParam0], SCRIPT_TASK_ENTER_VEHICLE) !=1) TASK::TASK_ENTER_VEHICLE(uLocal_1058[iParam0], veLocal_1317, 20000, seat, 1073741824, 1, 0);
return;
}
BOOL func_134() // Position - 0x5D5C{
if(!PED::IS_PED_INJURED(uLocal_1058[0]) && !PED::IS_PED_INJURED(uLocal_1058[1]))if(PED::IS_PED_IN_VEHICLE(uLocal_1058[0], veLocal_1317, false) && PED::IS_PED_IN_VEHICLE(uLocal_1058[1], veLocal_1317, false)) return true;
return false;
}
...
if(!bLocal_1138)if(MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(fParam0, fParam3, fParam6, joaat("WEAPON_STICKYBOMB"), false)) bLocal_1138=true;
return;
}
...
break;
case 1:
if(ENTITY::DOES_ENTITY_EXIST(driver))if(!ENTITY::IS_ENTITY_DEAD(driver, false))if(!bLocal_1173)if(TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_PLAY_ANIM) !=1 && TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_PERFORM_SEQUENCE) !=1)if(ENTITY::IS_ENTITY_AT_COORD(driver, uLocal_1272[iParam0 /*3*/], 3f, 3f, 3f, false, true, 0)) func_144(driver, &uLocal_1200[iParam0], true);
else uLocal_1037[iParam0]=0;
break;
case 3:
...
}elseif(func_52(&uLocal_1337) > uLocal_1231[iParam0] || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
func_130(&driver);
uLocal_1037[iParam0]=2;
}
break;
...
if(func_52(&uLocal_1337) >=27f && bLocal_1142) func_129(driver, 15f, 15f, 3f);
elseif(func_52(&uLocal_1337) >=15f) func_142(driver);
}else{
bLocal_1166=false;
bLocal_1139=true;
if(!bLocal_1159) uLocal_1037[iParam0]=0;
else uLocal_1037[iParam0]=4;
}
break;
case 4:
if(!PED::IS_PED_INJURED(driver)){
...
if(!PED::IS_PED_IN_VEHICLE(driver, veLocal_1316, false)) TASK::TASK_ENTER_VEHICLE(driver, veLocal_1316, 30000, -1, 1f, 1, 0);
}elseif(iParam0==1){
TASK::TASK_LOOK_AT_ENTITY(uLocal_1054[1], uLocal_1054[0], -1, 0, 2);
if(!PED::IS_PED_IN_VEHICLE(driver, veLocal_1316, false)) TASK::TASK_ENTER_VEHICLE(driver, veLocal_1316, 30000, 0, 1f, 1, 0);
}elseif(iParam0==2){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1317, false))if(!PED::IS_PED_IN_VEHICLE(driver, veLocal_1317, false)) TASK::TASK_ENTER_VEHICLE(driver, veLocal_1317, 30000, 1, 1f, 1, 0);
}}
...
break;
case 5:
if(!PED::IS_PED_INJURED(driver)) PED::SET_PED_RESET_FLAG(driver, 60, true);
if(!ENTITY::IS_ENTITY_DEAD(driver, false))if(TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_LOOK_AT_ENTITY) !=1)if(iParam0==0) TASK::TASK_LOOK_AT_ENTITY(uLocal_1054[iParam0], uLocal_1054[1], -1, SLF_WHILE_NOT_IN_FOV, 4);
elseif(iParam0==1) TASK::TASK_LOOK_AT_ENTITY(uLocal_1054[iParam0], uLocal_1054[0], -1, SLF_WHILE_NOT_IN_FOV, 4);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false)){
if(!func_140()){
if(bLocal_1138){
if(!PED::IS_PED_INJURED(driver)){
if(TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_COMBAT) !=1){
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_1054[0])) TASK::TASK_CLEAR_LOOK_AT(uLocal_1054[0]);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_1054[1])) TASK::TASK_CLEAR_LOOK_AT(uLocal_1054[1]);
...
if(bLocal_1154)if(uLocal_1037[iParam0] !=10 && uLocal_1037[iParam0] !=11) uLocal_1037[iParam0]=10;
break;
case 6:
if(!bLocal_1138){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false)){
...
if(func_138()) TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(driver, veLocal_1316, "OJASva_101a", 181, 0, 16, -1, 10f, false, 1073741824);
else TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(driver, veLocal_1316, "OJASva_101", 181, 0, 0, -1, -1082130432, false, 1073741824);
}}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_VEHICLE_MISSION) !=1) TASK::TASK_VEHICLE_MISSION(driver, veLocal_1316, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 8, 35f, 786469, -1f, -1f, true);
elseif(TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_VEHICLE_MISSION) !=1) TASK::TASK_VEHICLE_MISSION_PED_TARGET(driver, veLocal_1316, PLAYER::PLAYER_PED_ID(), 8, 35f, 786469, -1f, -1f, true);
}}}elseif(!PED::IS_PED_INJURED(driver)){
if(TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_COMBAT) !=1) TASK::TASK_COMBAT_PED(driver, pedLocal_1049, 0, 16);
}}elseif(bLocal_1153 || bLocal_1167 && !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(veLocal_1316)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_1316, -1, false)==driver)if(!ENTITY::IS_ENTITY_DEAD(driver, false))if(TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_VEHICLE_MISSION) !=1) TASK::TASK_VEHICLE_MISSION_COORS_TARGET(driver, veLocal_1316, uLocal_1294, 8, 25f, 786603, -1f, -1f, true);
}
break;
case 8:
if(bLocal_1163){
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_128(), 1f, false, 1056964608, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::CLOSE_SEQUENCE_TASK(iLocal_1328);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1054[iParam0], false)) TASK::TASK_PERFORM_SEQUENCE(uLocal_1054[iParam0], iLocal_1328);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_1328);
}else{
TASK::OPEN_SEQUENCE_TASK(&iLocal_1328);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
...
break;
case 9:
if(!PED::IS_PED_INJURED(uLocal_1054[iParam0]))if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1054[iParam0], SCRIPT_TASK_ANY) !=1) TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_1054[iParam0], pedLocal_1049, pedLocal_1049, 1f, false, -1f, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
break;
case 10:
...
break;
case 11:
if(iParam0==0) func_125(veLocal_1316, driver, 1112014848, 1112014848, 1092616192);
func_2(driver);
func_100(driver);
break;
}
if(iLocal_1035 < 10) num=5f;
else num=fLocal_1238;
if(!bLocal_1138){
if(bLocal_1162){
if(uLocal_1037[iParam0] !=8 && uLocal_1037[iParam0] !=9) uLocal_1037[iParam0]=8;
}elseif(func_137(driver)){
ped=func_36(1116471296, true);
if(ped !=0) func_116(ENTITY::GET_ENTITY_COORDS(ped, true), 1097859072, 1116471296);
if(!func_115()) bLocal_1138=true;
}elseif(!bLocal_1141){
...
bLocal_1138=true;
if(!ENTITY::DOES_ENTITY_EXIST(pedLocal_1050)) iLocal_1048=5;
}}}}}elseif(uLocal_1037[iParam0] !=10 && uLocal_1037[iParam0] !=11 && uLocal_1037[iParam0] !=7){
uLocal_1037[iParam0]=10;
}
...
if(!bLocal_1138){
if(ENTITY::DOES_ENTITY_EXIST(pedParam0)){
if(!PED::IS_PED_INJURED(pedParam0))if(PED::IS_PED_IN_ANY_VEHICLE(pedParam0, false)) vehiclePedIsIn=PED::GET_VEHICLE_PED_IS_IN(pedParam0, false);
else vehiclePedIsIn=0;
if(func_118(pedParam0, vehiclePedIsIn, &uLocal_360, &iLocal_371, false, false, false, true, true) || PED::IS_PED_RAGDOLL(pedParam0) && func_29(pedParam0, true) < 1.5f) return true;
}}
return false;
}
...
i < sizeAndVehs;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(sizeAndVehs[i]) && !ENTITY::IS_ENTITY_DEAD(sizeAndVehs[i], false))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(sizeAndVehs[i], -1218.8435f, -278.623f, 36.819595f, -1248.4033f, -225.84673f, 43.15606f, 8.5f, false, true, 0)) iLocal_1215=iLocal_1215 + 1;
}
if(iLocal_1215 >=1){
bLocal_1167=true;
return true;
...
if(ENTITY::DOES_ENTITY_EXIST(eParam0))if(!ENTITY::IS_ENTITY_DEAD(eParam0, false)) return true;
return false;
}
BOOL func_140() // Position - 0x684B{
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false))if(!PED::IS_PED_INJURED(pedLocal_1050))if(!bLocal_1138)if(PED::IS_PED_IN_VEHICLE(pedLocal_1050, veLocal_1316, false) && func_141()) return true;
elseif(PED::IS_PED_IN_VEHICLE(pedLocal_1050, veLocal_1316, false)) return true;
return false;
}
...
i <=1;
i=i + 1){
if(!PED::IS_PED_INJURED(uLocal_1051[i]))if(!PED::IS_PED_IN_ANY_VEHICLE(uLocal_1051[i], false)) num=0;
}
return num;
}
...
if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_AIM_GUN_AT_ENTITY) !=1) TASK::TASK_AIM_GUN_AT_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), -1, false);
func_34(pedParam0, 3, "OJAvaGUARD");
...
if(!PED::IS_PED_INJURED(pedParam0))if(func_29(pedParam0, true) < 5f)if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY) !=1 && TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_AIM_GUN_AT_ENTITY) !=1) TASK::TASK_AIM_GUN_AT_ENTITY(pedParam0, pedLocal_1049, -1, false);
elseif(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY) !=1)if(pedParam0==pedLocal_1061) TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(pedParam0, pedLocal_1049, pedLocal_1049, 1f, false, -1f, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
elseif(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_AIM_GUN_AT_ENTITY) !=1) TASK::TASK_AIM_GUN_AT_ENTITY(pedParam0, pedLocal_1049, -1, false);
return;
}


void func_144(Ped pedParam0, var uParam1, BOOL bParam2) // Position - 0x69F3{
if(!PED::IS_PED_INJURED(pedParam0))if(bParam2) func_145(pedParam0, uParam1);
return;
}
...
if(num==0) TASK::TASK_PLAY_ANIM(pedParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_a", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), true, false, false);
elseif(num==1) TASK::TASK_PLAY_ANIM(pedParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_b", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), true, false, false);
elseif(num==2) TASK::TASK_PLAY_ANIM(pedParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_fold_arms", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), true, false, false);
elseif(num==3) TASK::TASK_PLAY_ANIM(pedParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_look", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), true, false, false);
*uParam1=num;
return;
}
...
int num;
num=0;
if(iParam0==iParam1) return 0;
for (i=MISC::GET_RANDOM_INT_IN_RANGE(iParam0, iParam1);
i==iParam2 || num < 50;
i=MISC::GET_RANDOM_INT_IN_RANGE(iParam0, iParam1)){
num=num + 1;
}
return i;
}
...
Vector3 entityCoords;
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1051[iParam0])) return;
...
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1051[iParam0], false))if(VEHICLE::IS_VEHICLE_DRIVEABLE(vehicle, false))if(!ENTITY::IS_ENTITY_DEAD(uLocal_1051[iParam0], false))if(!PED::IS_PED_IN_VEHICLE(uLocal_1051[iParam0], vehicle, false))if(PED::IS_PED_IN_ANY_VEHICLE(pedLocal_1050, false))if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1051[iParam0], SCRIPT_TASK_ENTER_VEHICLE) !=1) TASK::TASK_ENTER_VEHICLE(uLocal_1051[iParam0], vehicle, 30000, seat, 1f, 1, 0);
else uLocal_1045[iParam0]=2;
break;
case 2:
if(iParam0==0) vehicle=veLocal_1316;
elseif(iParam0==1) vehicle=veLocal_1317;
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(ENTITY::GET_ENTITY_SPEED(vehicle) < 5f) uLocal_1045[iParam0]=5;
TASK::TASK_COMBAT_PED(uLocal_1051[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1051[iParam0], SCRIPT_TASK_COMBAT) !=1){
TASK::TASK_COMBAT_PED(uLocal_1051[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
}
}}elseif(!bLocal_1162){
...
break;
case 3:
if(!PED::IS_PED_INJURED(uLocal_1051[iParam0]))if(PED::IS_PED_USING_ANY_SCENARIO(uLocal_1051[iParam0])) PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(uLocal_1051[iParam0]);
if(bLocal_1163){
TASK::OPEN_SEQUENCE_TASK(&iLocal_1328);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_LOOK_AT_COORD(0, func_128(), MISC::GET_RANDOM_INT_IN_RANGE(2000, 2500), SLF_WHILE_NOT_IN_FOV, 4);
...
TASK::CLEAR_SEQUENCE_TASK(&iLocal_1328);
}elseif(!PED::IS_PED_INJURED(uLocal_1051[iParam0])){
...
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(veLocal_1316, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veLocal_1316, "wheel_lr")) 
};
entityCoords={
ENTITY::GET_ENTITY_COORDS(veLocal_1316, true) 
};
entityCoords={
worldPositionOfEntityBone - entityCoords 
};
...
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_1050, false)) TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, pedLocal_1050, 0f, -1.5f, 0f, 2f, -1, 1036831949, true);
}
TASK::CLOSE_SEQUENCE_TASK(iLocal_1328);
}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1051[iParam0], false)) TASK::TASK_PERFORM_SEQUENCE(uLocal_1051[iParam0], iLocal_1328);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_1328);
}
...
if(entityAnimCurrentTime < 0.5f) ENTITY::SET_ENTITY_ANIM_SPEED(uLocal_1051[iParam0], "oddjobs@assassinate@hotel@", "enter", 3.5f);
else ENTITY::SET_ENTITY_ANIM_SPEED(uLocal_1051[iParam0], "oddjobs@assassinate@hotel@", "enter", 1f);
}}
break;
case 5:
if(iParam0==0) vehicle=veLocal_1316;
elseif(iParam0==1) vehicle=veLocal_1317;
if(!PED::IS_PED_INJURED(pedLocal_1050)){
if(!PED::IS_PED_INJURED(uLocal_1051[iParam0]))if(PED::IS_PED_IN_ANY_VEHICLE(pedLocal_1050, false)) TASK::TASK_COMBAT_PED(uLocal_1051[iParam0], pedLocal_1049, 0, 16);
else TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_1051[iParam0], pedLocal_1050, PLAYER::PLAYER_PED_ID(), 3f, true, 0.005f, 1082130432, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
uLocal_1045[iParam0]=6;
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(vehicle, false)){
...
if(!bLocal_1138){
if(bLocal_1162)if(uLocal_1045[iParam0] !=3 && uLocal_1045[iParam0] !=4) uLocal_1045[iParam0]=3;
elseif(func_137(uLocal_1051[iParam0])) bLocal_1138=true;
}elseif(uLocal_1045[iParam0] < 5){
if(!PED::IS_PED_INJURED(uLocal_1051[iParam0])){
if(PED::IS_PED_USING_ANY_SCENARIO(uLocal_1051[iParam0])) PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(uLocal_1051[iParam0]);
...
Vector3 func__148() // Position - 0x72B5{
var unk;
return unk;
}
...
int taskSequenceId;
Ped ped;
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_1050)) uLocal_1309={
ENTITY::GET_ENTITY_COORDS(pedLocal_1050, false) 
};
switch (iLocal_1044){
case 0:
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_1050, false)){
...
if(!bLocal_1138 && !bLocal_1162) TASK::TASK_ENTER_VEHICLE(pedLocal_1050, veLocal_1316, 30000, 1, 1f, 1, 0);
else TASK::TASK_ENTER_VEHICLE(pedLocal_1050, veLocal_1316, 30000, 1, 2f, 1, 0);
if(!func_58(&uLocal_1346)) func_55(&uLocal_1346);
else func_56(&uLocal_1346);
}
if(!bLocal_1164){
...
if(_CONVERSATION_ADD_LINE(&uLocal_1368, "OJASAUD", "OJASva_TARG", 8, 0, 0, 0)) bLocal_1164=true;
}}}
}
...
if(!bLocal_1183)if(func_152())if(func_30(pedLocal_1050, PLAYER::PLAYER_PED_ID(), true) <=5f && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(func_36(25f, true)==0)if(func_151()) bLocal_1183=true;
break;
case 4:
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_1050, false)){
if(PED::IS_PED_IN_VEHICLE(pedLocal_1050, veLocal_1316, false)){
if(TASK::GET_SCRIPT_TASK_STATUS(pedLocal_1050, SCRIPT_TASK_LEAVE_ANY_VEHICLE) !=1) TASK::TASK_LEAVE_ANY_VEHICLE(pedLocal_1050, 0, 256);
}elseif(!bLocal_1168){
...
TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_1050, false)) TASK::TASK_PERFORM_SEQUENCE(pedLocal_1050, taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
bLocal_1168=true;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(pedLocal_1050, SCRIPT_TASK_ANY) !=1){
...
if(!bLocal_1138){
if(bLocal_1162){
}elseif(func_137(pedLocal_1050) || bLocal_1192){
ped=func_36(1116471296, true);
if(ped !=0) func_116(ENTITY::GET_ENTITY_COORDS(ped, true), 1097859072, 1116471296);
if(!func_115()) bLocal_1138=true;
}}
...
if(pedInVehicleSeat==0 || pedInVehicleSeat !=0 && PED::IS_PED_INJURED(pedInVehicleSeat)) return true;
}}}
return false;
}
...
break;
case 5:
if(func_446()) iLocal_1035=6;
break;
case 6:
func_445();
func_444();
if(bLocal_1146){
if(Global_113648.f_19965.f_5 !=0f) func_57(&uLocal_1340, Global_113648.f_19965.f_5);
iLocal_1213=func_534();
if(Global_94858)if(iLocal_1213 <=2) iLocal_1213=iLocal_1213 + 1;
if(iLocal_1213==0) func_443();
elseif(iLocal_1213==1) func_442();
elseif(iLocal_1213==2) func_438();
}else{
...
break;
case 2:
if(func_209(&uLocal_388, false, 1065353216, false, false, false)) bLocal_1189=true;
if(!bLocal_1189) func_201(&uLocal_1545, 1128792064, 1, false, true, 1065353216);
...
if(func_124(Global_113648.f_19965.f_1, 4194304)) value=value + uParam0.f_24;
...
int outValue;
Hash statHash;
if(func_195(echParam0)==3) return;
if(func_195(echParam0)==4) return;
...
func_165(iParam0);
if(Global_43257==15) func_164(false);
return 1;
}
...
}}elseif(IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_168() /*5568*/].f_681.f_10, iParam0)){
flag=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
int cloudTimeAsInt6;
int num6;
if(iParam0==8) return func_176(129, -1);
if(iParam0==9) return func_176(135, -1);
if(iParam0==10) return func_176(136, -1);
if(iParam0==11) return func_176(137, -1);
if(iParam0==12){
...
if(func_24(14) && !func_190(iParam0)) return 0;
...
if(func_187(&Global_4542597, iParam0)) return 0;
if(func_180(&Global_4542597, iParam0)) return 1;
}else{
...
if(func_24(14) && !func_190(iParam1)) return false;
if(func_187(uParam0, iParam1)) return false;
if(func_186(uParam0) < 0f) func_185(uParam0, 0);
func_183(&unk);
i=0;
for (i=0;
i < *uParam0 - 1;
...
if(func_24(14) && !func_190(iParam1)) return 0;
if(func_187(uParam0, iParam1)) return 0;
if(func_186(uParam0) < 0f) func_185(uParam0, 0);
for (i=0;
i < *uParam0;
i=i + 1){
...
float num;
num=0f;
if(func_124(Global_113648.f_19965.f_1, 8192)) num=num + 0.2f;
if(func_124(Global_113648.f_19965.f_1, 16384)) num=num + 0.2f;
if(func_124(Global_113648.f_19965.f_1, 32768)) num=num + 0.2f;
if(func_124(Global_113648.f_19965.f_1, 65536)) num=num + 0.1f;
if(func_124(Global_113648.f_19965.f_1, 131072)) num=num + 0.1f;
if(func_124(Global_113648.f_19965.f_1, 262144)) num=num + 0.1f;
if(func_124(Global_113648.f_19965.f_1, 524288)) num=num + 0.333f;
if(func_124(Global_113648.f_19965.f_1, 1048576)) num=num + 0.333f;
if(func_124(Global_113648.f_19965.f_1, 2097152)) num=num + 0.333f;
return num;
}
...
if(!Global_78827)if(!PLAYER::IS_PLAYER_DEAD(PLAYER::GET_PLAYER_INDEX()))if(!Global_78828)if(CAM::IS_SCREEN_FADED_OUT() && !_IS_MISSION_REPEAT_ACTIVE(false)) CAM::DO_SCREEN_FADE_IN(800);
func_199(0);
return;
}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(controlInstructionalButtonsString)) func_206(controlInstructionalButtonsString);
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_2[i /*15*/])) func_205(uParam0->f_2[i /*15*/]);
if(MISC::IS_PC_VERSION()){
...
value2=bParam4 ? func_207(uParam0->f_1, 32) ? 1f :
0f :
-1f;
...
var func__204(BOOL bParam0, var uParam1, var uParam2) // Position - 0x983C{
...
BOOL flag;
if(MISC::GET_FRAME_COUNT()==uParam0->f_578) return uParam0->f_579;
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(PLAYER::IS_SPECIAL_ABILITY_ACTIVE(PLAYER::PLAYER_ID(), 0)) PLAYER::SPECIAL_ABILITY_DEACTIVATE(PLAYER::PLAYER_ID(), 0);
...
func_234(0);
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))if(PLAYER::GET_ARE_CAMERA_CONTROLS_DISABLED() || CAM::IS_SCREEN_FADED_OUT() && !CAM::IS_SCREEN_FADING_IN()) HUD::SET_MOUSE_CURSOR_THIS_FRAME();
Global_43807=1;
if(!uParam0->f_567){
...
if(uParam0->f_562==0) uParam0->f_562=uParam0->f_576 + SYSTEM::FLOOR(15000f * iParam2);
if(bParam4 && uParam0->f_576 >=uParam0->f_562 - 1500) uParam0->f_562=uParam0->f_576 + 3000;
if(uParam0->f_564==0f){
uParam0->f_564=uParam0->f_564 + func_233(30f);
uParam0->f_564=uParam0->f_564 + ((float)uParam0->f_56 * func_233(25f));
if(uParam0->f_56 > 0) uParam0->f_564=uParam0->f_564 + func_233(25f * 0.5f);
if(uParam0->f_549) uParam0->f_564=uParam0->f_564 + (func_233(30f) - func_233(2f));
}
flag=true;
while (flag){
func_199(1);
...
if((float)uParam0->f_576 > (float)uParam0->f_562 + 666 - (15000f * iParam2))if(uParam0->f_30 < 1f) uParam0->f_30=uParam0->f_30 + 0f + ((1f / 0.225f) * SYSTEM::TIMESTEP());
...
if(uParam0->f_576 > uParam0->f_562 - 333)if(!uParam0->f_565)if(uParam0->f_548 < 1f) uParam0->f_548=uParam0->f_548 + 0f + ((1f / 0.3f) * SYSTEM::TIMESTEP());
uParam0->f_548=func_211(uParam0->f_548, 0f, 1f);
if(uParam0->f_566)if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL))if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam0->f_4))if(!uParam0->f_571) func_210(uParam0, !uParam0->f_569 && uParam0->f_56 > 0);
...
uParam0->f_569=1;
uParam0->f_577=0.75f;
if(uParam0->f_576 > uParam0->f_562 - 5000) uParam0->f_562=uParam0->f_576 + 5000;
}elseif(bParam5){
NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(uParam0->f_1, "ROLL_UP_BACKGROUND");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
uParam0->f_569=0;
...
if(uParam0->f_576 > uParam0->f_562)if(uParam0->f_565)if(!uParam0->f_571)if(PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ENDSCREEN_ACCEPT)) uParam0->f_565=0;
elseif(uParam0->f_576 - uParam0->f_546 > 1000 && uParam0->f_545) flag=false;
uParam0->f_579=!flag;
if(bParam1){
SYSTEM::WAIT(0);
}else{
...
if(uParam0->f_560==4) func_231(&(uParam0->f_13));
else func_205(&(uParam0->f_13));
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(150);
else GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(100);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
if(uParam0->f_560==4) GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_56 - 1);
else GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_56);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bParam2);
if(uParam0->f_560==4 || uParam0->f_560==3) GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
else GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(69);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
uParam0->f_2=1;
}
...
num5=0f;
if(uParam0->f_30 >=0.975f)if(num2 < num5) num2=num5;
}
num=0.3f * func_232();
if(uParam0->f_12) num=0.5f;
width=*uParam0 * 2f;
if(uParam0->f_560 !=4){
num6=func_229(&(uParam0->f_13));
if(width < num6) width=num6 + (3f * 0.006f);
if(GRAPHICS::GET_ASPECT_RATIO(false) < 1.4f) width=width * 1.3f;
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_554))) num6=func_228(&(uParam0->f_550), &(uParam0->f_554));
else num6=func_229(&(uParam0->f_550));
num7=(0.119f + 0.05f) / func_232() / 2.5f;
if(uParam0->f_560==1 || uParam0->f_560==0 && uParam0->f_561 !=0)if(width < num6 + (2.6f * num7)) width=num6 + (2.6f * num7);
elseif(uParam0->f_560==5)if(width < num6 + (2.6f * num7)) width=num6 + (2.6f * num7);
elseif(width < num6 + (1.9f * num7)) width=num6 + (2f * num7);
}
...
if(uParam0->f_572 > 1f) uParam0->f_572=1f;
}}
if(CAM::IS_SCREEN_FADED_OUT()) HUD::HIDE_LOADING_ON_FADE_THIS_FRAME();
...
if(uParam0->f_56 > 0) num=num + func_233(25f * 0.2f);
i=0;
for (i=0;
i < uParam0->f_56;
i=i + 1){
...
HUD::SET_TEXT_SCALE(1f, 0.4f);
if(MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_554))) func_215(&(uParam0->f_550), start2, num + func_233(2f * 2f), false, false, 0);
else func_214(&(uParam0->f_550), &(uParam0->f_554), start2, num + func_233(2f * 2f), false, 0);
HUD::SET_TEXT_WRAP(start2, end2);
...
if(uParam0->f_560==-1) screenX=screenX - (0.006f * 6f);
width2=width2 * 0.65f;
height=height * 0.65f;
...
if(NETWORK::NETWORK_CLAN_GET_EMBLEM_TXD_NAME(&netHandle, &txdName)) return func_221(&txdName);
}else{
...
if(uParam0->f_57[iParam1]==16 || uParam0->f_57[iParam1]==17) HUD::ADD_TEXT_COMPONENT_INTEGER(uParam0->f_489[iParam1]);
}
...
if(uParam0->f_57[iParam1]==0) return;
if(uParam0->f_57[iParam1]==15) HUD::SET_TEXT_JUSTIFICATION(1);
else HUD::SET_TEXT_JUSTIFICATION(2);
HUD::SET_TEXT_SCALE(1f, func_226(14f));
if(uParam0->f_57[iParam1]==5 || uParam0->f_57[iParam1]==4) HUD::SET_TEXT_WRAP(fParam3, num - (0.00078125f * 3f));
else HUD::SET_TEXT_WRAP(fParam3, num + (0.00078125f * 2f));
HUD::SET_TEXT_COLOUR(r, g, b, iParam5);
...
if(CAM::IS_SCREEN_FADING_OUT() || CAM::IS_SCREEN_FADED_OUT()) GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(7);
...
if(func_238()) return;
if(Global_20584)if(func_237()) func_236(true, true);
else func_236(false, false);
...
uParam0->f_1=0;
uParam0->f_123=0;
if(bParam1) func_203(&(uParam0->f_1), 32);
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0)){
func_203(&(uParam0->f_1), 1);
if(bParam2) GRAPHICS::SET_SCALEFORM_MOVIE_TO_USE_SYSTEM_TIME(*uParam0, true);
}
if(MISC::IS_PC_VERSION())if(bParam3) func_203(&(uParam0->f_1), 4096);
if(bParam4) func_203(&(uParam0->f_1), 8192);
return;
}
...
func_244(uParam0);
func_243(uParam0);
if(MISC::ARE_STRINGS_EQUAL(&(uParam0->f_550), "SPR_RESULT") || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_550), "") && uParam0->f_56 > 0) uParam0->f_570=1;
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) GRAPHICS::REQUEST_STREAMED_TEXTURE_DICT("MPHud", false);
if(uParam0->f_1==0){
...
if(!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam0->f_1) || !GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("CommonMenu") || !GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPLeaderboard") || !GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPHud")) return false;
if(uParam0->f_566)if(!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam0->f_4)) return false;
}
if(uParam0->f_566)if(uParam0->f_571) func_242(uParam0);
elseif(uParam0->f_56 !=0) func_210(uParam0, true);
else func_210(uParam0, false);
Global_78820=1;
return true;
}
...
if(screenWidthOfDisplayText > (0.1125f * 2f) - (0.006f * 2f)) *uParam0=(screenWidthOfDisplayText / 2f) + (0.006f * 2f);
return;
}
...
if(bLocal_376) func_250(&uLocal_388, 6, &(uLocal_969.f_12), "MTPHPERRET" /*Checkpoint*/, SYSTEM::FLOOR(fLocal_372), 0, 3, 0);
else func_250(&uLocal_388, 9, &(uLocal_969.f_12), "", SYSTEM::FLOOR(fLocal_372), 0, 0, 0);
...
i < Global_75457;
i=i + 1){
if(Global_75458[i /*9*/] >=0 && !Global_63587[Global_75458[i /*9*/] /*13*/].f_7)if(Global_75458[i /*9*/].f_3==2) num=1;
}}
if(num==1){
iLocal_383=50;
iLocal_384=1;
...
if(bLocal_375) func_247(39, 1, true);
else func_247(39, 0, true);
if(bLocal_375) func_247(40, SYSTEM::ROUND(fLocal_374 + fLocal_373), true);
else func_247(40, SYSTEM::ROUND(fLocal_373), true);
...
if(bLocal_375) func_247(53, 1, true);
else func_247(53, 0, true);
if(bLocal_375) func_247(56, SYSTEM::ROUND(fLocal_374 + fLocal_373), true);
else func_247(56, SYSTEM::ROUND(fLocal_373), true);
...
if(bLocal_375) func_247(67, 1, true);
else func_247(67, 0, true);
if(bLocal_375) func_247(68, SYSTEM::ROUND(fLocal_374 + fLocal_373), true);
else func_247(68, SYSTEM::ROUND(fLocal_373), true);
...
if(bLocal_375) func_247(82, 1, true);
else func_247(82, 0, true);
if(bLocal_375) func_247(83, SYSTEM::ROUND(fLocal_374 + fLocal_373), true);
else func_247(83, SYSTEM::ROUND(fLocal_373), true);
...
if(bLocal_375) func_247(98, 1, true);
else func_247(98, 0, true);
if(bLocal_375) func_247(99, SYSTEM::ROUND(fLocal_374 + fLocal_373), true);
else func_247(99, SYSTEM::ROUND(fLocal_373), true);
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
vehiclePedIsIn=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
if(ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn, false))if(VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(vehiclePedIsIn))if(AUDIO::PREPARE_MUSIC_EVENT("ASS1_LOST")) bLocal_1179=true;
}}}
return;
}
...
break;
case 3:
if(!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) iLocal_1197=2;
break;
}
return;
}
...
iLocal_1197=iLocal_1197 + 1;
bLocal_1187=true;
}}}}elseif(func_36(1116471296, true) !=0){
if(!bLocal_1176){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
if(!HUD::IS_MESSAGE_BEING_DISPLAYED()){
_SHOW_SUBTITLE_CLEAR_EXISTING("ASS_VA_GO", 7500, -1);
iLocal_1197=iLocal_1197 + 1;
bLocal_1176=true;
}}}}elseif(!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && func_36(125f, true)==0){
iLocal_1197=iLocal_1197 + 1;
}
break;
case 1:
...
if(ENTITY::DOES_ENTITY_EXIST(veLocal_1316)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false)) VEHICLE::SET_VEHICLE_DOORS_LOCKED(veLocal_1316, 1);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1058[0], false))if(!ENTITY::IS_ENTITY_DEAD(veLocal_1317, false))if(PED::IS_PED_IN_VEHICLE(uLocal_1058[0], veLocal_1317, false)) TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_1058[0]);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1058[1]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1058[1], false))if(!ENTITY::IS_ENTITY_DEAD(veLocal_1317, false))if(PED::IS_PED_IN_VEHICLE(uLocal_1058[1], veLocal_1317, false)) TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_1058[1]);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_1317, false)) TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&veLocal_1317);
}}}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1320[0])) ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_1320[0]);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1320[1])) ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_1320[1]);
if(ENTITY::DOES_ENTITY_EXIST(veLocal_1323) && !ENTITY::IS_ENTITY_DEAD(veLocal_1323, false))if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(veLocal_1323) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(veLocal_1323, true)) ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&veLocal_1323);
return;
}
...
int i;
if(bParam0)if(HUD::DOES_BLIP_EXIST(blLocal_1124)) HUD::REMOVE_BLIP(&blLocal_1124);
for (i=0;
i < 3;
i=i + 1){
if(HUD::DOES_BLIP_EXIST(uLocal_1125[i])) HUD::REMOVE_BLIP(&uLocal_1125[i]);
}
for (i=0;
i < 2;
i=i + 1){
if(HUD::DOES_BLIP_EXIST(uLocal_1129[i])) HUD::REMOVE_BLIP(&uLocal_1129[i]);
}
for (i=0;
i < 2;
i=i + 1){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_1297, uLocal_1300, fLocal_1247, true, false, 0)) bLocal_1156=true;
else bLocal_1156=false;
if(HUD::DOES_BLIP_EXIST(blLocal_1124)) HUD::REMOVE_BLIP(&blLocal_1124);
...
if(func_267(veLocal_1316, 5f)) bLocal_1153=true;
}}}
if(!bLocal_1150)if(func_266(veLocal_1316, 10000)) bLocal_1150=true;
return;
}
BOOL func_266(Vehicle veParam0, int iParam1) // Position - 0xD116{
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veParam0, 0, iParam1) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veParam0, 2, iParam1) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veParam0, 3, iParam1) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veParam0, 1, iParam1)) return true;
return false;
}
BOOL func_267(Vehicle veParam0, float fParam1) // Position - 0xD166{
if(ENTITY::DOES_ENTITY_EXIST(veParam0))if(func_268(veParam0, -1217.4419f, -281.5099f, 36.7495f, true) <=fParam1) return true;
return false;
}
...
if(ENTITY::DOES_ENTITY_EXIST(*ppedParam0))if(ENTITY::IS_ENTITY_OCCLUDED(*ppedParam0)) PED::DELETE_PED(ppedParam0);
...
if(ENTITY::DOES_ENTITY_EXIST(*pveParam0))if(ENTITY::IS_ENTITY_OCCLUDED(*pveParam0)) ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(pveParam0);
return;
}
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(pedLocal_1050, true) 
};
entityHeading=ENTITY::GET_ENTITY_HEADING(pedLocal_1050);
}
unk[0 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(entityCoords, entityHeading, 1f, -1f, 0f) 
};
unk[1 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(entityCoords, entityHeading, -1f, -1f, 0f) 
};
...
i < 2;
i=i + 1){
if(i==0) uLocal_1051[i]=PED::CREATE_PED(PED_TYPE_MISSION, hLocal_1331, unk[0 /*3*/], unk[0 /*3*/].f_1, 38.3253f, uLocal_1243[iLocal_1206], true, true);
else uLocal_1051[i]=PED::CREATE_PED(PED_TYPE_MISSION, hLocal_1332, unk[1 /*3*/], unk[1 /*3*/].f_1, 38.3253f, uLocal_1243[iLocal_1206], true, true);
...
if(pedParam0 !=pedLocal_1050) WEAPON::GIVE_WEAPON_TO_PED(pedParam0, joaat("WEAPON_PISTOL"), -1, false, true);
if(!bParam1){
...
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hLocal_1329);
if(!HUD::DOES_BLIP_EXIST(blLocal_1124)) blLocal_1124=func_279(pedLocal_1050, false, false);
...
if(func_32(PLAYER::PLAYER_PED_ID(), -1237.566f, -156.88245f, 39.41317f, true) < 13f) return true;
return false;
}
BOOL func_284(int iParam0, float fParam1) // Position - 0xD867{
if(VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(uLocal_1252[iParam0 /*3*/], fParam1)) return true;
return false;
}
...
if(STREAMING::HAS_MODEL_LOADED(hLocal_1329)) num=1;
else num=0;
return num;
}
BOOL func_287() // Position - 0xD916{
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1054[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_1054[1]) && !PED::IS_PED_INJURED(uLocal_1054[0]) && !PED::IS_PED_INJURED(uLocal_1054[1]))if(PED::IS_PED_IN_VEHICLE(uLocal_1054[0], veLocal_1316, false) && PED::IS_PED_IN_VEHICLE(uLocal_1054[1], veLocal_1316, false)) return true;
return false;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false)) VEHICLE::SET_VEHICLE_ENGINE_ON(veLocal_1316, false, true, false);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(ENTITY::DOES_ENTITY_EXIST(veLocal_1323) && !ENTITY::IS_ENTITY_DEAD(veLocal_1323, false)) func_297(veLocal_1323);
func_294();
func_293();
...
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)) return false;
if(!ENTITY::DOES_ENTITY_EXIST(veLocal_1317)) return false;
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(veLocal_1323, true) 
};
return true;
}}}
return false;
...
i=i + 1){
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1054[i])){
if(i==2) modelHash=hLocal_1332;
else modelHash=hLocal_1331;
...
i=i + 1){
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1058[i])){
if(i==0) uLocal_1058[i]=PED::CREATE_PED_INSIDE_VEHICLE(veLocal_1317, PED_TYPE_MISSION, hLocal_1331, -1, true, true);
elseif(i==1) uLocal_1058[i]=PED::CREATE_PED_INSIDE_VEHICLE(veLocal_1317, PED_TYPE_MISSION, hLocal_1332, 0, true, true);
...
if(func_299(veParam2)) uParam1->f_3=1;
else uParam1->f_3=0;
return 1;
}
return 0;
...
if(!uParam0->f_7)if(!uParam0->f_10) uParam0->f_10=func_301(veParam1);
if(iParam2==1){
*uParam0={
...
i < 9;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(Global_98012[i]))if(Global_98012[i]==veParam0)if(echParam1==_CHAR_NULL || echParam1==Global_98022[i])if(iParam2==0 || ENTITY::GET_ENTITY_MODEL(veParam0)==func_304(echParam1, iParam2)) return 1;
}
return 0;
}
...
if(uParam1->f_65==-1 && !func_309(uParam1->f_66)) uParam1->f_65=0;
...
i <=11;
i=i + 1){
if(VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1)) MISC::SET_BIT(&(uParam1->f_77), func_307(i + 1));
}
...
uParam0->f_5=145;
if(iParam4==1) func_315(&(uParam0->f_2890), uParam0, pedParam5, 1, 1, 0);
...
if(func_316(pedParam2, &vehicle, iParam3, iParam5)) func_298(uParam0, uParam1, vehicle, iParam4);
elseif(ENTITY::DOES_ENTITY_EXIST(vehicle))if(!ENTITY::IS_ENTITY_DEAD(vehicle, false))if(VEHICLE::IS_VEHICLE_MODEL(vehicle, joaat("skylift")) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), vehicle, false)) func_298(uParam0, uParam1, vehicle, iParam4);
return;
}
...
for (i=0;
func_318(echParam1, i, &garageName, &num);
i=i + 1){
...
if(func_320(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && pedParam0==PLAYER::PLAYER_PED_ID())if(func_320(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
else uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO, iParam3, 0);
}
return;
}
...
j=0;
for (k=func_328(pedWeapontypeInSlot, j);
k !=0;
k=func_328(pedWeapontypeInSlot, j)){
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_20(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_294[character]=PED::GET_PED_ARMOUR(pedParam0);
return;
}
...
if(func_340(*uParam0) && !func_336(*uParam0)) return true;
}}
return false;
}
...
elseif(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(func_339()==0) return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_338(iParam0), -1, 0), iParam1);
...
Vector3 func__342(int iParam0, BOOL bParam1) // Position - 0x12E13{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
case 46:
if(Global_1853747 !=_INVALID_PLAYER_INDEX())if(func_354(Global_1853747)) return func_347(2, 2);
elseif(func_346(Global_1853747)) return func_347(45, 3);
...
Vector3 func__343() // Position - 0x13563{
...
Vector3 func__347(int iParam0, int iParam1) // Position - 0x138EF{
var unk;
var unk7;
unk7={
1000000f, 1000000f, 1000000f 
};
if(Global_1853747 !=_INVALID_PLAYER_INDEX())if(iParam1==3)if(func_348(iParam0, 1, &unk, 0, false)) unk7={
unk 
};
elseif(iParam1==2)if(IS_BIT_SET(Global_1853910[Global_1853747 /*862*/].f_267.f_288, 4))if(func_348(iParam0, 1, &unk, 0, false)) unk7={
unk 
};
elseif(IS_BIT_SET(Global_1853910[Global_1853747 /*862*/].f_267.f_288, 5))if(func_348(iParam0, 2, &unk, 0, false)) unk7={
unk 
};
return unk7;
}
...
var unk12;
Vector3 vector2;
if(!func_353(iParam3, &unk)) return false;
if(!func_353(iParam1, &vector)) return false;
if(!bParam4) unk12={
func_351(iParam0) 
};
else unk12={
...
vector2={
func_349(vector2, -unk.f_3.f_2) 
};
vector2={
func_349(vector2, vector.f_3.f_2) 
};
*uParam2={
...
Vector3 func__349(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x13A2E{
float num;
float num2;
float num3;
...
Vector3 func__355(int iParam0) // Position - 0x147A6{
switch (iParam0){
case 1:
...
case 17:
if(func_356()==0) return 205f, 5180f, -90f;
...
var func__361() // Position - 0x14D94{
var unk;
...
if(iParam1 < 1 || iParam1 > func_365(num, num2)) return;
...
var func__367(BOOL bParam0, var uParam1, var uParam2) // Position - 0x14FA8{
if(bParam0) return uParam1;
return uParam2;
}
...
if(ENTITY::GET_ENTITY_SPEED(vehiclePedIsIn) <=0.5f)if(!func_58(&uLocal_1349)) func_55(&uLocal_1349);
elseif(func_58(&uLocal_1349)) func_56(&uLocal_1349);
if(func_58(&uLocal_1349))if(func_52(&uLocal_1349) > 10f) func_37(2);
}elseif(func_58(&uLocal_1349)){
func_56(&uLocal_1349);
}}}
return;
}
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) AUDIO::SET_VEH_RADIO_STATION(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), "OFF");
iLocal_1197=iLocal_1197 + 1;
}elseif(STREAMING::STREAMVOL_HAS_LOADED(iLocal_1134)){
}
break;
case 1:
if(func_385()){
...
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(veLocal_1316)) VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(veLocal_1316);
...
if(iLocal_1196==0) delayTime=1250;
elseif(iLocal_1196==1) delayTime=400;
else delayTime=0;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false))if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(veLocal_1316)) VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(veLocal_1316);
...
HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==FIRST_PERSON) CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
else CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(true, 0f, 1, 0);
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_396(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_393() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_396(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_395(-1, false)==8;
...
if(func_397())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(bParam18) func_406(playersLastVehicle);
...
if(entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)if(func_403(playersLastVehicle, vParam0, vParam3, fParam6)) flag=true;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
...
if(bParam16)if(func_317(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true)) flag=false;
if(flag){
...
Vector3 func__405(float fParam0, var uParam1, var uParam2) // Position - 0x18033{
float num;
float num2;
...
Vector3 func__407() // Position - 0x180D7{
...
playersLastVehicle=PLAYER::GET_PLAYERS_LAST_VEHICLE();
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)) VEHICLE::SET_VEHICLE_FORWARD_SPEED(playersLastVehicle, 0f);
}
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
}elseif(func_52(&uLocal_367) > 1f || iParam1==0){
return true;
}}
return false;
}
...
if(PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) _SHOW_SUBTITLE_CLEAR_EXISTING("ASS_VA_LOSECOPS", 7500, 1);
MISC::CLEAR_AREA_OF_VEHICLES(-1220.57f, -185.96f, 38.4f, 50f, false, false, false, false, false, false, 0);
iLocal_1197=iLocal_1197 + 1;
break;
case 1:
...
if(ENTITY::DOES_ENTITY_EXIST(veLocal_1323) && !ENTITY::IS_ENTITY_DEAD(veLocal_1323, false)) func_297(veLocal_1323);
}}}}
if(!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
if(!func_427()){
...
HUD::CLEAR_PRINTS();
}}}elseif(STREAMING::STREAMVOL_HAS_LOADED(iLocal_1134) && func_423()){
func_422();
func_264();
iLocal_1035=8;
}}elseif(!func_427()){
...
bLocal_1136=true;
}}elseif(func_282(uLocal_1306, true) > 120f){
if(STREAMING::STREAMVOL_IS_VALID(iLocal_1134)){
STREAMING::STREAMVOL_DELETE(iLocal_1134);
func_272();
bLocal_1136=false;
}}elseif(!STREAMING::STREAMVOL_IS_VALID(iLocal_1134)){
if(!func_419()) bLocal_1136=false;
}
return;
}
BOOL func_419() // Position - 0x188A3{
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), joaat("taxi")))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), -1, false) !=PLAYER::PLAYER_PED_ID()) return true;
return false;
}
...
if(HUD::DOES_BLIP_EXIST(blLocal_1123)) HUD::REMOVE_BLIP(&blLocal_1123);
return;
}
BOOL func_423() // Position - 0x18947{
BOOL num;
func_420();
if(STREAMING::HAS_MODEL_LOADED(hLocal_1331) && STREAMING::HAS_MODEL_LOADED(hLocal_1332)) num=1;
else num=0;
return num;
}
...
if(num < 200f) func_429();
if(func_428())if(ENTITY::IS_ENTITY_AT_COORD(pedLocal_1049, uLocal_1306, 25f, 25f, 90f, true, true, 0)) flag=true;
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0)if(num < 2f || ENTITY::IS_ENTITY_AT_COORD(pedLocal_1049, uLocal_1306, 2f, 2f, 2f, true, true, 0) || flag)if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1141.085f, -192.66f, 75.756f, -1246.085f, -192.66f, 100.756f, 115f, false, true, 0))if(func_428() && flag) return true;
elseif(!ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) return true;
return false;
}
...
if(STREAMING::HAS_MODEL_LOADED(joaat("A_M_M_BevHills_01")) && STREAMING::HAS_MODEL_LOADED(joaat("A_F_M_BevHills_01")) && STREAMING::HAS_MODEL_LOADED(joaat("A_F_M_BevHills_02")) && STREAMING::HAS_MODEL_LOADED(joaat("taxi")) && STREAMING::HAS_MODEL_LOADED(joaat("A_M_Y_Hipster_01")) && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@assassinate@hotel@") && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("OJAS_HotelTaxi01")) iLocal_1209=iLocal_1209 + 1;
break;
case 1:
...
TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1695[0], false)) TASK::TASK_PERFORM_SEQUENCE(uLocal_1695[0], taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
...
TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1695[1], false)) TASK::TASK_PERFORM_SEQUENCE(uLocal_1695[1], taskSequenceId);
TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
...
func_37(7);
}elseif(SYSTEM::VDIST(entityCoords, uLocal_1306) > fLocal_1249 + 200f){
if(!bLocal_1186){
...
if(ENTITY::IS_ENTITY_OCCLUDED(pedLocal_1062) || !ENTITY::IS_ENTITY_ON_SCREEN(pedLocal_1062)) func_433();
}
switch (iLocal_1195){
case 0:
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_1062)) PED::DELETE_PED(&pedLocal_1062);
return;
}
...
if(func_58(piParam0))if(func_52(piParam0) > fParam1) return true;
return false;
}


void func_437() // Position - 0x192BB{
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_1062))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_1062, PLAYER::PLAYER_PED_ID(), true)) func_37(9);
return;
}
...
if(!IS_BIT_SET(Global_100681.f_20, 13)) func_533();
func_439(0, -1, 1);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
iLocal_1035=18;
...
iLocal_1132=PED::ADD_SCENARIO_BLOCKING_AREA(unk -{
15f, 15f, 15f 
}
, unk +{
15f, 15f, 15f 
...
iLocal_1133=PED::ADD_SCENARIO_BLOCKING_AREA(unk4 -{
45f, 35f, 35f 
}
, unk4 +{
45f, 35f, 35f 
...
TEXT_LABEL_COPY(&(uLocal_969.f_6),{
Global_63377 
}
, 6);
...
uLocal_1288={
-1343.4927f, -153.199f, 47.1825f 
};
fLocal_1237=260.3612f;
uLocal_1291={
-1242.2126f, -241.5975f, 38.71f 
};
fLocal_1223=96.8755f;
uLocal_1294={
-1221.6313f, -186.88194f, 38.799603f 
};
fLocal_1224=201.0763f;
fLocal_1238=40f;
uLocal_360.f_2=40f;
uLocal_1252[0 /*3*/]={
-1221.1538f, -170.9907f, 38.3253f 
};
uLocal_1252[1 /*3*/]={
-1210.5562f, -192.882f, 38.3253f 
};
uLocal_1252[2 /*3*/]={
-1216.3691f, -203.6806f, 38.3253f 
};
uLocal_1239[0]=157.3177f;
uLocal_1239[1]=58.3594f;
uLocal_1239[2]=65.6443f;
uLocal_1272[0 /*3*/]={
-1220.3773f, -169.407f, 38.3253f 
};
uLocal_1272[1 /*3*/]={
-1208.963f, -193.8791f, 38.3253f 
};
uLocal_1272[2 /*3*/]={
-1214.9547f, -205.0824f, 38.3253f 
};
uLocal_1272[3 /*3*/]={
-1217.5182f, -197.13f, 38.3254f 
};
uLocal_1272[4 /*3*/]={
-1231.8916f, -194.382f, 38.1753f 
};
...
PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, false);
PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
if(STREAMING::HAS_MODEL_LOADED(joaat("IG_LesterCrest")) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cs_walking_stick")) && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@assassinate@hotel@leadin") && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@assassinate@hotel@leaning@") && STREAMING::HAS_CLIP_SET_LOADED("move_lester_CaneUp")) iLocal_1197=iLocal_1197 + 1;
break;
case 1:
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
...
CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
if(_IS_MISSION_REPEAT_ACTIVE(false)) CAM::DO_SCREEN_FADE_IN(800);
iLocal_1197=iLocal_1197 + 1;
}
break;
case 2:
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 3))if(!func_58(&uLocal_1691)) func_55(&uLocal_1691);
if(func_58(&uLocal_1691))if(func_52(&uLocal_1691) > 6f) iLocal_1197=iLocal_1197 + 1;
}
break;
case 3:
if(func_453()) iLocal_1197=iLocal_1197 + 1;
break;
case 4:
func_392(true, true, true, false, false, false, false);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Franklin", 0, 0, 0);
...
if(!ENTITY::DOES_ENTITY_EXIST(pedLocal_1062))if(CUTSCENE::DOES_CUTSCENE_ENTITY_EXIST("Lester", 0))if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0))) pedLocal_1062=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0));
if(!ENTITY::DOES_ENTITY_EXIST(eLocal_1063))if(CUTSCENE::DOES_CUTSCENE_ENTITY_EXIST("WalkingStick_Lester", 0))if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("WalkingStick_Lester", 0))) eLocal_1063=CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("WalkingStick_Lester", 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
...
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0)))if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("WalkingStick_Lester", 0))if(ENTITY::DOES_ENTITY_EXIST(pedLocal_1062) && !PED::IS_PED_INJURED(pedLocal_1062)) ENTITY::ATTACH_ENTITY_TO_ENTITY(eLocal_1063, pedLocal_1062, PED::GET_PED_BONE_INDEX(pedLocal_1062, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
...
if(!ENTITY::DOES_ENTITY_EXIST(obLocal_1694)) obLocal_1694=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1510.1029f, -947.7194f, 8.2332f, 5f, joaat("prop_bench_08"), true, false, true);
return;
}
...
if(iLocal_1220 >=2) iLocal_1220=-1;
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(ped, true) 
};
entityCoords={
entityCoords 
};
...
if(!PED::IS_PED_INJURED(pedParam0))if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_PERFORM_SEQUENCE) !=1)if(func_29(pedParam0, false) < 1f || bParam1) func_460(pedParam0, true);
return;
}
...
if(!func_58(&uLocal_1352)) func_55(&uLocal_1352);
...
case 4:
if(bLocal_1181){
if(!PED::IS_PED_INJURED(uLocal_1058[0])) ped=uLocal_1058[0];
else ped=func_31(25f);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1695.f_3) && !ENTITY::IS_ENTITY_DEAD(uLocal_1695.f_3, false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) TASK::TASK_SMART_FLEE_PED(uLocal_1695.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1695.f_8[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1695.f_8[0], false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) TASK::TASK_SMART_FLEE_PED(uLocal_1695.f_8[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1695.f_8[1]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1695.f_8[1], false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) TASK::TASK_SMART_FLEE_PED(uLocal_1695.f_8[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1695.f_5[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1695.f_5[0], false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) TASK::TASK_SMART_FLEE_PED(uLocal_1695.f_5[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1695.f_5[1]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1695.f_5[1], false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) TASK::TASK_SMART_FLEE_PED(uLocal_1695.f_5[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
return;
}
BOOL func_463() // Position - 0x1A8DB{
if(!ENTITY::IS_ENTITY_DEAD(uLocal_1695.f_3, false))if(PED::IS_PED_BEING_JACKED(uLocal_1695.f_3))if(PED::GET_PEDS_JACKER(uLocal_1695.f_3)==PLAYER::PLAYER_PED_ID()) return true;
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(uLocal_1695.f_4, false))if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_1695.f_4, false)) return true;
if(func_118(uLocal_1695[0], 0, &uLocal_360, &iLocal_371, false, false, false, true, false)) return true;
if(func_118(uLocal_1695[1], 0, &uLocal_360, &iLocal_371, false, false, false, true, false)) return true;
if(func_118(uLocal_1695.f_8[0], 0, &uLocal_360, &iLocal_371, false, false, false, true, false)) return true;
if(func_118(uLocal_1695.f_8[1], 0, &uLocal_360, &iLocal_371, false, false, false, true, false)) return true;
if(func_118(uLocal_1695.f_5[0], 0, &uLocal_360, &iLocal_371, false, false, false, true, false)) return true;
if(func_118(uLocal_1695.f_5[1], 0, &uLocal_360, &iLocal_371, false, false, false, true, false)) return true;
if(func_117(uLocal_1695.f_4)) return true;
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, -1231.326f, -201.7195f, 38.2114f, 20f)) return true;
return false;
}
...
}elseif(!func_496(vehicle, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(uParam0->f_9==1) func_469(vehicle, uParam0->f_11);
...
if(!func_472(hParam0, false, -1)) return false;
...
if(hParam0==joaat("blimp"))if(!func_481() && !func_480() && !func_479() && !func_478() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_477() || MISC::IS_PC_VERSION() || func_476()){
}elseif(!func_479()){
return false;
}}
if(bParam1)if(!func_475(hParam0, iParam2)) return false;
if(!func_473(hParam0)) return false;
return true;
}
...
if(!func_472(entityModel, false, -1)) return true;
return false;
}
...
if(iParam0 < 0 || iParam0 >=func_493(&Global_113648.f_32751.f_5038[num /*157*/])) return false;
...
if(!func_50(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false)) *uParam0={
...
if(uParam1->f_69 > -1 && uParam1->f_69 < 255)if(!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(uParam1->f_69==6) func_515(veParam0, uParam1->f_69);
else func_515(veParam0, uParam1->f_69);
...
if(bParam3) func_507(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
if(!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66)){
for (n=0;
n <=11;
n=n + 1){
if(IS_BIT_SET(uParam1->f_77, func_307(n + 1)))if(!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, n + 1)) VEHICLE::SET_VEHICLE_EXTRA(veParam0, n + 1, false);
...
if(func_502() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")))if(!IS_BIT_SET(uParam1->f_77, 23))if(IS_BIT_SET(uParam1->f_77, 22)) VEHICLE::CONTROL_LANDING_GEAR(veParam0, 2);
...
if(func_505(7))if(func_504(Global_2672505.f_4.f_16) || func_503(Global_2672505.f_4.f_16)) return false;
return true;
}
...
int num;
num=iParam0;
if(num !=-1) return func_11(iParam0, 9);
return false;
}
...
}elseif(func_513(*uParam0, modType, uParam1->[i] - 1)){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, modType, uParam1->[i] - 1, false);
}}}}
if(func_512(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_510(*uParam0, uParam1->[38] - 1)) VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_510(*uParam0, uParam1->[38] - 1), false);
func_509(uParam0);
if(func_508(*uParam0)){
...
i >=0 && func_513(veParam0, iParam1, i);
i=i - 1){}
return i;
}
...
if(!func_514() && PED::APPLY_PED_BLOOD_SPECIFIC(veParam0, iParam1, iParam2)) return true;
return false;
}
...
if(!func_514() && func_519(uParam0)) return 1;
return 0;
}
...
if(func_522(PLAYER::PLAYER_ID())==3)if(ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(func_521(veParam0) !=-1) return true;
return false;
}
...
if(func_525(plParam0)==233) return func_523(plParam0);
return -1;
}

int func_523(Player plParam0) // Position - 0x21F7D{
if(func_524(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_182;
return -1;
}
...
if(func_524(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_33;
return -1;
}
...
i < 68;
i=i + 1){
if(func_494(&Global_77348.f_555[0 /*21*/], i))if(MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_77348.f_555[0 /*21*/], bParam4) <=fParam3) func_490(i);
}
return;
}
...
if(!func_472(uParam0->f_12.f_66, false, -1)) return 0;
if(uParam0->f_12.f_66==joaat("stunt") && func_497(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false)) return 0;
return 1;
}
...
if(func_529(uParam0)) STREAMING::REQUEST_MODEL(uParam0->f_12.f_66);
return;
}


void func_533() // Position - 0x22174{
if(STREAMING::STREAMVOL_IS_VALID(iLocal_1134)) STREAMING::STREAMVOL_DELETE(iLocal_1134);
return;
}
...
num.f_32=-1;
num.f_25={
-1700.0151f, -1066.335f, 12.144f 
};
num.f_28={
-1691.5642f, -1066.5138f, 12.076f 
};
num.f_31=35.4714f;
num.f_10={
...
num.f_33={
-1700.0983f, -1067.9395f, 12.1547f 
};
num.f_36=162.4559f;
num.f_37=1;
}elseif(iParam0==1){
...
num.f_32=1;
num.f_25={
804.9559f, -1070.4604f, 27.3361f 
};
num.f_28={
799.8408f, -1079.1416f, 27.321f 
};
num.f_31=69.6524f;
num.f_10={
801.8048f, -1068.0675f, 30.3496f 
};
num.f_13={
-20.8953f, 0f, -132.9451f 
};
num.f_16={
805.8168f, -1074.4961f, 28.9803f 
};
num.f_19={
-1.5585f, 0f, 6.9143f 
};
num.f_33={
804.8776f, -1070.5231f, 27.3416f 
};
num.f_36=287.8741f;
num.f_37=0;
}
...
Vector3 func__536(int iParam0) // Position - 0x2266F{
switch (iParam0){
case 0:
...
if(flag) func_548(&(Global_113648.f_19965.f_1), 4096);
return;
}
...
if(func_58(&uLocal_1340)) Global_113648.f_19965.f_5=func_52(&uLocal_1340);
if(!bLocal_1180) AUDIO::TRIGGER_MUSIC_EVENT("ASS1_LOST");
...
int weaponHash;
weaponHash=0;
if(ENTITY::DOES_ENTITY_EXIST(pedParam0))if(WEAPON::GET_CURRENT_PED_WEAPON(pedParam0, &weaponHash, false))if(weaponHash !=0 && weaponHash !=joaat("WEAPON_UNARMED"))if(!func_544(iParam1, weaponHash)) weaponHash=0;
