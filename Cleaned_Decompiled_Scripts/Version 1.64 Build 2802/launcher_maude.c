...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_258(&num, true);
func_197(num);
func_189(&iLocal_93, &(num.f_9), vector);
if(func_174(&num, 0)){
if(!func_2(&num)) func_258(&num, true);
if(func_1(&num)) func_258(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xB4C{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x695F{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x70AF{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x743B{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x757A{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x82FF{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B01{
...
func_275("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_178(uParam0->f_27)){
func_177(uParam0->f_27, *uParam0);
func_275("RC5_IN_ACTIVATION_RANGE:
...
if(func_178(true)){
func_177(1, *uParam0);
func_275("RC_IN_ACTIVATION_RANGE:
...
func_275("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if(Global_43257==17){
if(*uParam0 !=-1) func_195(uParam0);
}elseif(func_194()){
if(*uParam0 !=-1) func_195(uParam0);
}elseif(*uParam0==-1){
if(func_193(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_192(uParam0, 1);
}else{
...
if(func_193(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_195(uParam0);
}}}
return;
}
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_190(*uParam0, false);
...
var unk;
if(Global_78558){
func_275("IS_RC_FINE_AND_IN_RANGE():
The game is running Multiplayer [TERMINATING]");
return false;
}
func_115(*panParam0, &unk);
if(func_235(*panParam0) || func_233(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_275("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_228(panParam0->f_28[0]);
func_275("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_208(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_208(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_205(panParam0);
else func_203(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(func_202(&(panParam0->f_48)) && bParam1) func_199(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
if(func_201(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_201(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_200(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(iParam2==0) func_203(uParam0);
else func_205(uParam0);
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_149();
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_211(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_219(&iLocal_37[num /*4*/]);
return false;
}
if(!func_216(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_215();
if(num==-1) return false;
...
Vector3 func__214(Ped pedParam0, int iParam1) // Position - 0xE13E{
...
float num;
unk={
func_218(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_218(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__218(float fParam0, var uParam1, var uParam2) // Position - 0xE2FF{
float num;
float num2;
...
if(!bParam2){
if(func_226(pedParam0, bParam1, radius, num)) return true;
if(func_223(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_224(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_224(pedParam0, fParam1)) return true;
...
float num;
unk={
func_218(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_232() && !func_231()) return true;
if(!func_230(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_234() && Global_100681.f_11==6 && iParam0==func_172(&(Global_100681.f_3), 0)) return true;
return false;
}
...
if(!func_237(uParam0)) return false;
...
break;
case 1:
if(!func_242(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base")) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) func_241(&uParam0->f_41[0], num[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1])) func_241(&uParam0->f_41[1], num[2], 2727.686f, 4145.715f, 44.08f, 71f);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_238(&uParam0->f_28[0], CHAR_MAUDE, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1)) flag=false;
if(flag) iLocal_91=3;
break;
case 3:
...
if(func_232() && !func_231()) return false;
if(func_253(iParam0)) return false;
if(iParam0==-1) iParam0=func_171();
if(iParam0==-1) return false;
if(!func_235(iParam0)){
if(!func_252(iParam0)) return false;
if(!func_251(iParam0)) return false;
if(func_250(iParam0)) return false;
}
if(iParam0==58)if(func_248(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
if(func_230(iParam0)) return false;
...
int i;
if(*uParam0==1){
if(func_256(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_267(&uParam0->[i]);
else func_266(&uParam0->[i]);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_271(&uParam0->[i]);
else func_270(&uParam0->[i], false, 1, 0);
}
return;
}
...
if(func_273(uParam0->f_28[0], SCRIPT_TASK_SYNCHRONIZED_SCENE)) TASK::CLEAR_PED_TASKS(uParam0->f_28[0]);
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_28[0], -1000f, true);
}
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0])) ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], -1000f, true);
}
return;
}
