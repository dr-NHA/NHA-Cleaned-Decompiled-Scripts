...
func_321();
if(!_IS_MISSION_REPLAY_IN_PROGRESS())if(func_320(uLocal_82.f_28[0]) && func_320(PLAYER::PLAYER_PED_ID()) && !func_319(PLAYER::PLAYER_PED_ID(), uLocal_82.f_28[0], 4f, true)) bLocal_383=true;
while (true){
SYSTEM::WAIT(0);
RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_UR", 0);
func_302(uLocal_82.f_9, 0, 0, 0, 0, 0);
if(iLocal_148 !=4 && iLocal_148 !=0) func_301();
if(iLocal_148 < 3 && bLocal_383)if(func_320(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.8821f, -19.652481f, 172.67476f, 1653.8553f, 8.008027f, 175.02478f, 7f, false, true, 0))if(func_320(pedLocal_155))if(func_319(PLAYER::PLAYER_PED_ID(), pedLocal_155, 10f, true)) func_300();
switch (iLocal_148){
case 0:
func_283();
break;
...
if(MISC::IS_STRING_NULL_OR_EMPTY(sLocal_168)) func_354(true);
else func_5(sLocal_168, true);
iLocal_147=1;
break;
case 1:
if(func_4()){
...
if(iLocal_375==0)if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1624.015f, -5.45107f, 102.06766f, 1639.0066f, -52.987503f, 181.3352f, 58.75f, false, true, 0) && PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID())==2) iLocal_375=1;
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_155))if(SYSTEM::TIMERA() > 5000)if(MISC::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.7285f, -26.278694f, 172.58151f, 1672.6519f, -24.58394f, 177.25467f, 4f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.5189f, 5.134407f, 172.67433f, 1656.5706f, 9.669823f, 176.77434f, 15.25f, false, true, 0)) iLocal_149=2;
elseif(MISC::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.7285f, -26.278694f, 172.58151f, 1672.6519f, -24.58394f, 177.25467f, 4f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.5189f, 5.134407f, 172.67433f, 1656.5706f, 9.669823f, 176.77434f, 15.25f, false, true, 0)) iLocal_149=2;
}
if(MISC::GET_GAME_TIMER() < iLocal_370 + 5000)if(RECORDING::IS_REPLAY_RECORDING()) RECORDING::REPLAY_DISABLE_CAMERA_MOVEMENT_THIS_FRAME();
break;
case 2:
if(!PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_PARACHUTE_FREE_FALL(PLAYER::PLAYER_PED_ID()) && ENTITY::GET_ENTITY_HEIGHT_ABOVE_GROUND(PLAYER::PLAYER_PED_ID()) < 2f && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))if(_CONVERSATION_ADD_LINE(&uLocal_182, "EXT4AUD", "EXT4_WIL2", 8, 0, 0, 0)) func_9();
break;
}
return;
}
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_372))if(func_245(400)) bLocal_381=true;
if(bLocal_381)if(!CAM::IS_SCREEN_FADING_OUT()) CAM::DO_SCREEN_FADE_OUT(500);
SYSTEM::WAIT(0);
if(!bLocal_379){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_372) >=0.2f)if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_373)) AUDIO::PREPARE_SYNCHRONIZED_AUDIO_EVENT("RCM_Extreme4_Fall_and_impact", 0);
...
bLocal_380=true;
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_373) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_373) >=0.323f){
if(!bLocal_376){
...
if(MISC::GET_GAME_TIMER() > iLocal_374 + 600 && timeScale==1f)if(!bLocal_377) bLocal_377=true;
num2=1f / 30f;
num3=MISC::GET_FRAME_TIME() / num2;
if(MISC::GET_GAME_TIMER() > iLocal_374 + 630){
timeScale=timeScale + (0.035f * num3);
if(timeScale > 1f) timeScale=1f;
MISC::SET_TIME_SCALE(timeScale);
}else{
...
if(MISC::GET_GAME_TIMER() > iLocal_374 + 3500)if(num==4) num=5;
...
if(bLocal_381){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_373)) AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_373);
...
entityCoords={
ENTITY::GET_ENTITY_COORDS(pedLocal_155, true) 
};
if(entityCoords.f_2 > 155f) zPos=155f;
else zPos=entityCoords.f_2;
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_373)) PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_373, 1f);
...
if(func_320(PLAYER::PLAYER_PED_ID())) PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), false, 0);
return;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_239(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_236() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_239(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_238(-1, false)==8;
...
if(func_240())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(iLocal_149 < 2) AUDIO::PREPARE_MUSIC_EVENT("EXT4_JUMPED_OS");
switch (iLocal_149){
case 0:
iLocal_151=0;
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1655.1393f, 5.342447f, 172.67477f, 1662.0853f, -6.198325f, 175.02477f, 8.25f, false, true, 0)) CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
else CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 5, 8);
AUDIO::STOP_SOUND(iLocal_367);
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()) CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION("Dom", 8, 2, 0, 0);
...
if(func_320(pedLocal_155)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_155, "Dom", 0, joaat("CS_Dom"), 0);
SYSTEM::WAIT(0);
bLocal_383=false;
CAM::STOP_GAMEPLAY_HINT(false);
AUDIO::START_AUDIO_SCENE("EXTREME_04_CUSTOM_QUIET_SCENE");
if(func_320(pedLocal_155)) ENTITY::FREEZE_ENTITY_POSITION(pedLocal_155, false);
if(ENTITY::DOES_ENTITY_EXIST(obLocal_179) && !ENTITY::IS_ENTITY_DEAD(obLocal_179, false)) ENTITY::SET_ENTITY_VISIBLE(obLocal_179, false, false);
...
uLocal_348={
1649.793f, 11.7826f, 172.7745f 
};
fLocal_351=220.9923f;
}else{
uLocal_348={
1662.016f, 53.0925f, 171.2482f 
};
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371)){
if(func_320(pedLocal_155)){
if(!CAM::DOES_CAM_EXIST(caLocal_363)) caLocal_363=unk_0xDEE46CEB08617ECA("DEFAULT_ANIMATED_CAMERA", 1);
...
if(func_320(pedLocal_155))if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dom", 0)) iLocal_149=2;
}else{
iLocal_149=2;
}
break;
case 2:
RECORDING::REPLAY_STOP_EVENT();
if(ENTITY::DOES_ENTITY_EXIST(obLocal_179) && !ENTITY::IS_ENTITY_DEAD(obLocal_179, false)) ENTITY::SET_ENTITY_VISIBLE(obLocal_179, true, false);
if(iLocal_151==0){
...
if(iParam5==1) func_247(500, false);
}
return;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
if(bParam18) func_262(playersLastVehicle);
...
if(entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)if(func_259(playersLastVehicle, vParam0, vParam3, fParam6)) flag=true;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
...
if(bParam16)if(func_257(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true)) flag=false;
if(flag){
...
for (i=0;
func_258(echParam1, i, &garageName, &num);
i=i + 1){
...
Vector3 func__261(float fParam0, var uParam1, var uParam2) // Position - 0x291B3{
float num;
float num2;
...
num=0;
if(!func_266(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE)) TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
if(ENTITY::IS_ENTITY_IN_AIR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) num=0;
}}
func_265();
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) num=0;
if(num==0) return false;
if(iParam0==1)if(!func_264()) return false;
return true;
}
...
if(func_320(pedParam0))if(TASK::GET_SCRIPT_TASK_STATUS(pedParam0, esthParam1)==1 || TASK::GET_SCRIPT_TASK_STATUS(pedParam0, esthParam1)==0) return true;
return false;
}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD)==1)if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 30) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 31) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 23) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 21) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 22) || func_282() && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 1) || func_282() && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 2) || func_282() && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 32)) TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
switch (iLocal_149){
case 0:
if(func_320(uLocal_82.f_28[0])) PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_82.f_28[0], BF_AlwaysFlee, true);
iLocal_368=0;
bLocal_383=true;
...
if(PED::IS_PED_RAGDOLL(pedLocal_155)) ENTITY::SET_ENTITY_HEALTH(pedLocal_155, 0, 0);
...
if(!bLocal_378)if(func_319(PLAYER::PLAYER_PED_ID(), pedLocal_155, 30f, true) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(_CONVERSATION_ADD_LINE(&uLocal_182, "EXT4AUD", "EXT4_COMM", 7, 0, 0, 0)) bLocal_378=true;
func_272();
if(!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), pedLocal_155)) TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_155, -1, 0, 2);
}}
...
veLocal_172=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
hLocal_181=ENTITY::GET_ENTITY_MODEL(veLocal_172);
if(VEHICLE::IS_THIS_MODEL_A_CAR(hLocal_181)==true || VEHICLE::IS_THIS_MODEL_A_BIKE(hLocal_181)==true) iLocal_149=2;
}}else{
func_271();
}}}
break;
...
if(func_320(pedLocal_155))if(TASK::GET_SCRIPT_TASK_STATUS(pedLocal_155, SCRIPT_TASK_PERFORM_SEQUENCE) !=1) TASK::TASK_PERFORM_SEQUENCE(pedLocal_155, iLocal_171);
return;
}
...
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))if(AUDIO::HAS_SOUND_FINISHED(iLocal_367)) AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_367, "DOM", pedLocal_155, "EXTREME_04_SOUNDSET", false, 0);
return;
}
...
if(!bParam2){
if(func_279(pedParam0, bParam1, radius, num)) return true;
if(func_275(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_276(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_276(pedParam0, fParam1)) return true;
...
float num;
unk={
func_261(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_261(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(CAM::GET_CAM_ACTIVE_VIEW_MODE_CONTEXT())==FIRST_PERSON) return 1;
return 0;
}
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_82.f_28[0])) func_288(uLocal_82.f_28[0], 1737.4534f, 101.7498f, 170.0243f, 288.5211f, false, true);
else func_285(&uLocal_82.f_28[0], 1737.4534f, 101.7498f, 170.0243f, 288.5211f);
...
if(!ENTITY::DOES_ENTITY_EXIST(veLocal_173)) veLocal_173=VEHICLE::CREATE_VEHICLE(joaat("sanchez"), 1662.8799f, -14.255f, 172.7742f, 205.3516f, true, true, false);
if(!ENTITY::DOES_ENTITY_EXIST(veLocal_174)) veLocal_174=VEHICLE::CREATE_VEHICLE(joaat("bmx"), 1633.7656f, -23.6768f, 127.0535f, 55.7565f, true, true, false);
...
if(!ENTITY::DOES_ENTITY_EXIST(obLocal_179)) obLocal_179=OBJECT::CREATE_AMBIENT_PICKUP(joaat("PICKUP_PARACHUTE"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), true, true);
...
if(iParam1==1) func_247(500, false);
return;
}
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_82.f_28[0])) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_82.f_28[0], "Hudson", 0, joaat("A_C_Retriever"), 0);
SYSTEM::WAIT(0);
CAM::STOP_GAMEPLAY_HINT(false);
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Franklin", 0)) iLocal_150=2;
break;
case 2:
...
if(func_319(PLAYER::PLAYER_PED_ID(), uLocal_82.f_28[0], 4f, true)) iLocal_384=iLocal_384 - 10000;
...
if(iLocal_153==0){
if(distanceBetweenCoords > 160f) iLocal_153=1;
}elseif(distanceBetweenCoords > 200f){
sLocal_168="EXT4_F2";
iLocal_148=4;
}
if(distanceBetweenCoords > 150f)if(HUD::DOES_BLIP_EXIST(blLocal_170)) HUD::SET_BLIP_FLASHES(blLocal_170, true);
elseif(HUD::DOES_BLIP_EXIST(blLocal_170)) HUD::SET_BLIP_FLASHES(blLocal_170, false);
}
...
if(!func_316(0) || Global_78828 || Global_78817==1 || !CAM::IS_SCREEN_FADED_IN()) return false;
switch (Global_78813){
case 0:
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID())) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_182, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
iLocal_375=0;
bLocal_376=false;
bLocal_377=false;
bLocal_378=false;
...
if(func_330(echParam0, echParam1)==1 && func_329(echParam0, echParam1)==1) bParam2=false;
num=echParam1;
...
break;
case 1:
if(!func_336(&num) || !func_334(&(uParam0->f_48))) return 0;
iLocal_79=2;
break;
case 2:
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_346(&uParam0->[i]);
else func_345(&uParam0->[i]);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_287(&uParam0->[i]);
else func_350(&uParam0->[i], false, 1, 0);
}
return;
}
...
if(Global_100681 !=12)if(func_356(sParam0, 6, iParam1)) Global_100681.f_1=iParam1;
return;
}
...
if(func_362()){
if(func_361()){
if(Global_100718 >=func_358())if(!IS_BIT_SET(Global_91469[iParam2 /*34*/].f_15, 16))if(Global_113648.f_9087.f_330[iParam2 /*6*/].f_1 >=2) Global_94857=1;
...
if(Global_100681.f_11==5)if(func_357(&(Global_100681.f_3)) > -1) return true;
return false;
}
...
if(func_373()) return;
if(Global_20584)if(func_372()) func_371(true, true);
else func_371(false, false);
if(Global_20383.f_1==10 || Global_20383.f_1==9) MISC::SET_BIT(&Global_8254, 16);
if(AUDIO::IS_MOBILE_PHONE_CALL_ONGOING()) AUDIO::STOP_SCRIPTED_CONVERSATION(false);
Global_21725=5;
