...
if(func_320(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0)){
...
if((MISC::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0)){
iLocal_149=2;
}}}elseif((MISC::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0)){
iLocal_149=2;
}}
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_371) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_372)){
if(func_245(400)){
bLocal_381=true;
}}
if(bLocal_381){
...
SYSTEM::WAIT(0);
if(!iLocal_379){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_371)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_371)==1f){
if(func_320(Local_155.f_0)){
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_155.f_0, uLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_372, 0);
CAM::SET_CAM_ACTIVE(uLocal_364, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_364, uLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, 0, 0);
CAM::DESTROY_CAM(uLocal_363, 0);
iLocal_379=1;
}}}}elseif(!iLocal_380){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_372) >=0.2f){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_373)){
AUDIO::PREPARE_SYNCHRONIZED_AUDIO_EVENT("RCM_Extreme4_Fall_and_impact", 0);
}}
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_372)==1f){
if(func_320(Local_155.f_0)){
uLocal_373=PED::CREATE_SYNCHRONIZED_SCENE(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
uLocal_365=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
TASK::TASK_SYNCHRONIZED_SCENE(Local_155.f_0, uLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_373, 1);
CAM::SET_CAM_ACTIVE(uLocal_365, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_365, uLocal_373, "Fall_and_impact_CAM", "rcmextreme4");
AUDIO::PLAY_SYNCHRONIZED_AUDIO_EVENT(uLocal_373);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, 0, 0);
CAM::DESTROY_CAM(uLocal_364, 0);
iLocal_380=1;
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_373) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_373) >=0.323f){
if(!iLocal_376){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_373) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_373) >=0.44f){
uLocal_180=GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_ALPHA(uLocal_180, 1f);
iLocal_382=1;
}}}
...
if(iVar0 !=7){
CAM::DESTROY_CAM(uLocal_365, 0);
uLocal_362=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
CAM::SET_CAM_PARAMS(uLocal_362, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
...
if(bLocal_381){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_373)){
AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(uLocal_373);
}
...
Var4={
ENTITY::GET_ENTITY_COORDS(Local_155.f_0, 1) 
};
if(Var4.f_2 > 155f){
fVar7=155f;
}else{
...
ENTITY::SET_ENTITY_COORDS(Local_155.f_0, 1657.046f, -17.4571f, fVar7, 1, 0, 0, 1);
}}
...
if(func_231(Local_155.f_0)){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_373)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_373, 1f);
}
TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_155.f_0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, 0, 0);
ENTITY::SET_ENTITY_COORDS(Local_155.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_239(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
int func_241(int iParam0, var uParam1, var uParam2, int iParam3){
int iVar0;
iVar0=0;
...
AUDIO::STOP_SOUND(uLocal_367);
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()){
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION("Dom", 8, 2, 0, 0);
}
if(!func_269()){
if(func_263(1, 20f, 1)){
if((!iLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0)){
...
if(func_320(Local_155.f_0)){
ENTITY::FREEZE_ENTITY_POSITION(Local_155.f_0, 0);
}
...
uLocal_366=PED::ADD_SCENARIO_BLOCKING_AREA(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
iLocal_149=1;
}}}
break;
case 1:
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_371)){
if(func_320(Local_155.f_0)){
if(!CAM::DOES_CAM_EXIST(uLocal_363)){
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_155.f_0, uLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_371, 1);
CAM::SET_CAM_ACTIVE(uLocal_363, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_363, uLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, 0, 0);
iLocal_154=1;
}
...
Vector3 func__261(struct<3> Param0){
float fVar0;
float fVar1;
...
if(!func_267(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_267(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
uLocal_170=func_280(Local_155.f_0, 1, 1, 5);
SYSTEM::SETTIMERA(0);
iLocal_149=1;
break;
case 1:
...
TASK::TASK_PERFORM_SEQUENCE(Local_155.f_0, uLocal_171);
}}}
...
if(AUDIO::HAS_SOUND_FINISHED(uLocal_367)){
...
if(AUDIO::HAS_SOUND_FINISHED(uLocal_367)){
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_367, "DOM", Local_155.f_0, "EXTREME_04_SOUNDSET", 0, 0);
}}}}
...
float fVar6;
Var0={
func_261(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_261(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_155.f_1, 20f, 0, 0, 0, 0, 0, 0, 0);
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_173)){
iLocal_173=VEHICLE::CREATE_VEHICLE(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_174)){
iLocal_174=VEHICLE::CREATE_VEHICLE(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_176)){
iLocal_176=OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_177)){
iLocal_177=OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_171, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_171);
TASK::TASK_PERFORM_SEQUENCE(Local_155.f_0, uLocal_171);
}}
if(func_320(Local_155.f_0)){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_155.f_0, 0);
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_179)){
iLocal_179=OBJECT::CREATE_AMBIENT_PICKUP(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
}
...
void func_285(var uParam0, struct<3> Param1, float fParam4){
func_286(uParam0, iLocal_81, Param1, fParam4, 26);
...
void func_286(var uParam0, int iParam1, struct<3> Param2, var uParam5, int iParam6){
func_287(uParam0);
...
int func_288(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_231(iParam0)){
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID())){
if(!func_267(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
if(!func_266(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle"))){
...
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
...
CAM::SET_GAMEPLAY_HINT_CAMERA_BLEND_TO_FOLLOW_PED_MEDIUM_VIEW_MODE(1);
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_155.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
CAM::SET_GAMEPLAY_HINT_FOV(fVar0);
CAM::SET_GAMEPLAY_HINT_FOLLOW_DISTANCE_SCALAR(fVar1);
CAM::SET_GAMEPLAY_HINT_BASE_ORBIT_PITCH_OFFSET(fVar2);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(fVar3);
...
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_155.f_0, 1), 1);
if(iLocal_153==0){
if(fVar0 > 160f){
iLocal_153=1;
}}elseif(fVar0 > 200f){
...
if(fVar0 > 150f){
if(HUD::DOES_BLIP_EXIST(uLocal_170)){
HUD::SET_BLIP_FLASHES(uLocal_170, 1);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_170)){
HUD::SET_BLIP_FLASHES(uLocal_170, 0);
}}
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_175)){
iLocal_175=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
...
ENTITY::FREEZE_ENTITY_POSITION(Local_155.f_0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_155.f_0, 1);
WEAPON::REMOVE_ALL_PED_WEAPONS(Local_155.f_0, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_155.f_0, 8, 2, 0, 0);
AUDIO::DISABLE_PED_PAIN_AUDIO(Local_155.f_0, 1);
PED::SET_PED_CONFIG_FLAG(Local_155.f_0, 137, 1);
PED::SET_PED_CONFIG_FLAG(Local_155.f_0, 118, 0);
PED::SET_PED_CONFIG_FLAG(Local_155.f_0, 208, 1);
...
int func_322(var uParam0, int iParam1, struct<3> Param2, var uParam5, char* sParam6, int iParam7){
if(func_323(uParam0, iParam1, Param2, uParam5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_323(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_160(iParam1)){
