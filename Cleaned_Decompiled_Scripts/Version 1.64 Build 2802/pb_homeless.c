...
}elseif(!ENTITY::IS_ENTITY_DEAD(uLocal_55, 0)){
...
Var1={
(fParam5 + 0.2f), (fParam5 + 0.2f), fVar0 
};
...
iLocal_54=PED::CREATE_PED(19, joaat("a_m_o_tramp_01"), Local_47.f_0, Local_47.f_1, Local_50.f_2, 0f, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_54, uLocal_53);
if(iLocal_44==1){
Local_50={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0.8f, 0.8f, -1f) 
};
iLocal_55=PED::CREATE_PED(5, joaat("g_m_y_strpunk_01"), Local_50, 0f, 1, 1);
PED::ADD_RELATIONSHIP_GROUP("homeless", &uLocal_53);
