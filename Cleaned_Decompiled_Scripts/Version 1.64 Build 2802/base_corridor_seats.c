...
int func_70(){
if(Global_1853753 !=func_60()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1853753, 1, 0)){
return 0;
}
...
func_75(func_76(iVar4), fVar3) + Var0 
};
(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3={
0f, 0f, (fVar3 + 174f) 
};
(uParam1[(*iParam2)[iVar4] /*14*/])->f_1={
func_75(func_74(iVar4), fVar3) + Var0 
};
(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3={
func_75(func_73(iVar4), fVar3) + Var0 
};
