...
var uVar0;
uVar0=iParam0;
MISC::CLEAR_BIT(&(Global_2646729.f_388), uVar0);
MISC::CLEAR_BIT(&(Global_2646729.f_389), bVar0);
MISC::CLEAR_BIT(&(Global_2646729.f_390), bVar0);
MISC::CLEAR_BIT(&(Global_2646729.f_392), bVar0);
MISC::CLEAR_BIT(&(Global_2646729.f_396), bVar0);
MISC::CLEAR_BIT(&(Global_2646729.f_391), bVar0);
}
...
elseif(func_20(Global_2672505, iParam0, 1)){
return func_66(6);
}
else{
return func_66(5);
...
if(((func_63(PLAYER::PLAYER_ID()) || (func_62() && func_61())) && !MISC::IS_BIT_SET(Global_2793044.f_4690, 31)) && !bParam4){
uVar1=func_60();
...
return func_40(iParam0, NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), iParam1, bParam2, bParam3);
}
}
else{
return func_40(iParam0, NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), iParam1, bParam2, bParam3);
...
if(bParam1){
if(iParam2 > -1){
if(func_29(iVar0, iParam2, 0, -1) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)){
if(iVar0==iParam2){
return func_22(1);
}else{
return func_22(0);
...
while (iVar5 <=31){
iVar1=iVar5;
if(((!func_5(iVar1, 1, 1) || func_32(iVar1, 0)) || MISC::IS_BIT_SET(Global_2657589[iVar1 /*466*/].f_199, 2)) || func_31(iVar1)){
...
if((func_65(iParam1, iParam0, iVar0, 0) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)) || ((func_29(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(iParam0), 0, -1) && MISC::IS_BIT_SET(Global_4718592.f_15, 23)) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18))){
return func_22(1);
...
if(MISC::IS_BIT_SET(Global_4718592.f_15, 26) && !func_29(iParam0, PLAYER::GET_PLAYER_TEAM(iParam1), 0, -1)){
iVar0=func_41(1);
}}else{
iVar0=1;
}
