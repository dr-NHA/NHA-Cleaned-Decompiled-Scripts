...
}elseif(!func_8(PLAYER::PLAYER_ID(), 0)){
...
}elseif(bVar14 || (!func_8(PLAYER::PLAYER_ID(), 0) && !func_24())){
...
}}elseif(AUDIO::IS_AUDIO_SCENE_ACTIVE("MUTES_RADIO_SCENE")){
...
func_56(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}
func_1();
}}
...
Var0.f_2=uVar3;
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, Var0 + Vector(1f, 0f, 0f), 0, 0, 1);
return 1;
}
return 0;
}
...
if(CUTSCENE::DOES_CUTSCENE_HANDLE_EXIST(uVar0) !=2){
return;
}
uParam0->f_24=ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY(uVar0, uParam0->f_20));
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_24)){
return;
}
...
ENTITY::SET_ENTITY_COLLISION(uParam0->f_22, true, 0);
...
uParam0->f_22=PED::CREATE_PED(4, func_70(), uParam0->f_9, 0f, 0, 0);
ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_22, 1);
ENTITY::SET_ENTITY_VISIBLE(uParam0->f_22, false, 0);
ENTITY::SET_ENTITY_COLLISION(uParam0->f_22, false, 0);
...
var func__79(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12){
...
SCRIPT::SEND_TU_SCRIPT_EVEN(1, &Var0, 5, func_84(1, 1));
}


var func__84(int iParam0, bool bParam1){
var uVar0;
bool bVar1;
int iVar2;
bVar1=false;
...
if(func_91()==0){
return MISC::IS_BIT_SET(func_88(func_90(iParam0), -1, 0), iParam1);
}}else{
...
return GRAPHICS::ADD_VEHICLE_CREW_EMBLEM(*uParam0, PLAYER::GET_PLAYER_PED(uParam1), uParam2, Param3, Param6, Param9, uParam12, iParam13, uParam14);
}
...
iVar1=iParam0;
return MISC::IS_BIT_SET(uVar0, func_116(iVar1));
}
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar5))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_150(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_149()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar7 + 1))){
...
var func__136(int iParam0, int iParam1){
...
var func__138(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(func_145(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(iVar0==PLAYER::PLAYER_ID()){
uParam0->f_23=PED::CLONE_PED_ALT(func_271(), 0, 0, 1, 1);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23)){
return 0;
}}else{
uParam0->f_23=PED::CLONE_PED_ALT(func_271(), 0, 0, 0, 0);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23)){
return 0;
}
...
ENTITY::SET_ENTITY_COLLISION(uParam0->f_23, false, 0);
...
}elseif(MISC::IS_BIT_SET((*uParam1)[(iVar35 / 32)], (iVar35 % 32))){
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_180(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_180(iParam2));
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78341[1 /*14*/]={
func_207(iVar0, iParam1, iParam2, -1) 
};
...
}}elseif(func_192(iVar0, 4, iParam2, &uVar68)){
return func_191(iParam0, 4, uVar68);
}}
...
return 1;
}elseif(func_197(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_196(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_180(iParam0));
if(iVar57 > iVar56){
...
var func__233(var uParam0, int iParam1){
var uVar0;
...
var func__260(bool bParam0){
if(bParam0){
return (MISC::IS_BIT_SET(Global_4718592.f_160050, 12) && func_261());
}
...
elseif(func_112(PLAYER::PLAYER_ID(), 1) && Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10.f_76.f_21 !=0){
return 1;
}}
break;
default:
...
if(func_268(1)){
uVar0=PLAYER::GET_PLAYER_PED(func_267());
}
return uVar0;
}
