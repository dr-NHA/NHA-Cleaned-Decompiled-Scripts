...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID())) func_56(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
func_1();
}
return;
}
...
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(pedParam0, entityCoords +{
1f, 0f, 0f 
}
, false, false, true);
return 1;
...
func_68(uParam0);
flag=uParam0->f_7;
if(flag)if(func_67()) func_66(uParam0, 4);
if(!CUTSCENE::IS_CUTSCENE_PLAYING() || CUTSCENE::GET_CUTSCENE_TIME() > CUTSCENE::GET_CUTSCENE_END_TIME() - 800){
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_24))if(!func_63(uParam0->f_24, 0, false, false, false, false, true, false, true)) func_62(uParam0->f_24);
func_66(uParam0, 4);
}
return;
}
...
if(!STREAMING::HAS_MODEL_LOADED(func_70())) return false;
...
var func__71(BOOL bParam0, var uParam1, var uParam2) // Position - 0x197C{
...
if(func_131(ENTITY::GET_ENTITY_MODEL(veParam0)))if(uParam1->f_9[44]==2) VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(veParam0, false, true);
...
if(func_130(uParam1->f_66, &num) && uParam1->f_80 !=num) uParam1->f_80=num;
...
if(func_129(veParam0)) func_123(veParam0, func_126(uParam1->f_74, uParam1->f_75, uParam1->f_76));
if(VEHICLE::GET_VEHICLE_LIVERY2_COUNT(veParam0) > 1 && uParam1->f_98 >=0) VEHICLE::SET_VEHICLE_LIVERY2(veParam0, uParam1->f_98);
if(IS_BIT_SET(uParam1->f_95, 0)) func_94(veParam0, &(uParam1->f_81));
if(!func_85(4) && !bParam4 && !NETWORK::NETWORK_IS_ACTIVITY_SESSION()) func_82(veParam0);
...
i < 60;
i=i + 1){
if(func_92(i)==iParam0)if(func_86(i)) return true;
}}
return false;
}
...
elseif(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(func_91()==0) return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_90(iParam0), -1, 0), iParam1);
...
if(!func_104(veParam0, panParam1)) return 1;
...
if(ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(veParam0, 0) || func_103(veParam0)) return true;
return false;
}
...
if(func_110(plParam0)==233) return func_108(plParam0);
return -1;
}

int func_108(Player plParam0) // Position - 0x8A62{
if(func_109(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_182;
return -1;
}
...
if(func_109(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_33;
return -1;
}
...
if(!bParam1)if(func_114(plParam0, iParam2)) return 0;
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(func_121(plParam0) && Global_2657589[plParam0 /*466*/].f_321.f_10==plParam0) return true;
return false;
}
BOOL func_121(Player plParam0) // Position - 0x8CA3{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_122(Global_2657589[plParam0 /*466*/].f_321.f_7)==22;
return false;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_127() && Global_1576216)if(iParam0==Global_1576217 && iParam1==Global_1576218 && iParam2==Global_1576219) return 13;
return 0;
}
...
if(uParam1->f_69 > -1 && uParam1->f_69 < 255)if(!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(uParam1->f_69==6) func_147(veParam0, uParam1->f_69);
else func_147(veParam0, uParam1->f_69);
...
if(bParam3) func_139(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
if(!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66)){
for (n=0;
n <=11;
n=n + 1){
if(IS_BIT_SET(uParam1->f_77, func_153(n + 1)))if(!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, n + 1)) VEHICLE::SET_VEHICLE_EXTRA(veParam0, n + 1, false);
...
if(func_133() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")))if(!IS_BIT_SET(uParam1->f_77, 23))if(IS_BIT_SET(uParam1->f_77, 22)) VEHICLE::CONTROL_LANDING_GEAR(veParam0, 2);
...
if(func_137(7))if(func_135(Global_2672505.f_4.f_16) || func_134(Global_2672505.f_4.f_16)) return false;
return true;
}
...
int num;
num=iParam0;
if(num !=-1) return func_136(iParam0, 9);
return false;
}
...
}elseif(func_145(*uParam0, modType, uParam1->[i] - 1)){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, modType, uParam1->[i] - 1, false);
}}}}
if(func_144(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_142(*uParam0, uParam1->[38] - 1)) VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_142(*uParam0, uParam1->[38] - 1), false);
func_141(uParam0);
if(func_140(*uParam0)){
...
i >=0 && func_145(veParam0, iParam1, i);
i=i - 1){}
return i;
}
...
if(!func_146() && PED::APPLY_PED_BLOOD_SPECIFIC(veParam0, iParam1, iParam2)) return true;
return false;
}
...
if(!func_146() && func_152(uParam0)) return 1;
return 0;
}
...
if(func_107(PLAYER::PLAYER_ID())==3)if(ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(func_106(veParam0) !=-1) return true;
return false;
}
...
if(func_272(PLAYER::PLAYER_ID(), false, false)) return;
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
if(!func_159(uParam0)) return;
if(!func_69(uParam0)) return;
if(!uParam0->f_15)if(!STREAMING::NEW_LOAD_SCENE_START(uParam0->f_9, func_158(uParam0->f_12), 4000f, 0)) return;
else uParam0->f_15=1;
...
Vector3 func__158(float fParam0, var uParam1, var uParam2) // Position - 0xAF27{
...
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(func_271())) return false;
player=func_266();
...
i < 127;
i=i + 1){
if(IS_BIT_SET(uParam1->[i / 32], i % 32))if(func_169(&unk, i, characterType, pedParam0, -1))if(func_162(pedParam0, &unk, i, unk.f_4, unk.f_8, flag, flag2, bParam2, flag3)) STATS::GET_PACKED_TU_INT_STAT_KEY(pedParam0, unk.f_4, unk.f_5);
}
...
if(func_163(13, -1)){
return false;
}elseif(func_163(14, -1)){
return false;
}elseif(func_163(15, -1)){
return false;
}elseif(func_163(16, -1)){
return false;
}elseif(func_163(71, -1)){
return false;
}elseif(func_163(72, -1)){
}
...
break;
case joaat("crewLogo"):
if(bParam8)if(entityModel==joaat("MP_M_Freemode_01"))if(Global_4540628==-1)if(!Global_100733.f_1570)if(func_163(15, -1)) return false;
...
if(stat==14192)if(func_91()==2 && func_165()==2) return 0;
else return 0;
...
if(func_91()==2 && func_165()==2) return 14192;
return 14192;
}
...
num=400;
if(_IS_EXCLUSIVE_CONTENT_UNLOCKED() && func_172() || func_171()) num=0;
...
if(iParam2==3 || iParam2==4 && iParam1 >=129) func_170(sParam0, iParam2, iParam1, 129);
...
if(pedPropIndex==-1) return func_190(epctParam1);
...
if(iParam1==-1) return func_190(epctParam3);
entityModel=ENTITY::GET_ENTITY_MODEL(pedParam0);
hashNameForProp=FILES::GET_HASH_NAME_FOR_PROP(pedParam0, epctParam3, iParam1, iParam2);
if(hashNameForProp !=-1 && hashNameForProp !=0)if(entityModel==joaat("MP_M_Freemode_01")) return func_188(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 3);
elseif(entityModel==joaat("MP_F_Freemode_01")) return func_188(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 4);
...
if(unk.f_1==hParam1) return func_189(hParam0) + i;
}}elseif(iParam2==13){}elseif(iParam2==14){
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, true, -1, -1);
shopPedQueryPropIndex=FILES::GET_SHOP_PED_QUERY_PROP_INDEX(hParam1);
if(shopPedQueryPropIndex !=-1) return func_181(hParam0) + shopPedQueryPropIndex;
}else{
...
if(shopPedQueryComponentIndex !=-1) return func_179(hParam0, func_180(iParam2)) + shopPedQueryComponentIndex;
}
return -99;
}
...
entityModel=ENTITY::GET_ENTITY_MODEL(pedParam0);
Global_78341[1 /*14*/]={
func_207(entityModel, iParam1, iParam2, -1) 
};
hash=Global_2883588;
...
Global_78341[2 /*14*/]={
func_207(entityModel, num2, num, -1) 
};
...
if(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_180(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_180(iParam1))) return true;
if(iParam1==4){
Global_78340=Global_78340 + 1;
if(Global_78340==1)if(func_194(entityModel, 11, func_183(pedParam0, 11), -1))if(func_193(entityModel, 4, iParam2, &num3)) return func_191(pedParam0, 4, num3);
elseif(func_192(entityModel, 4, iParam2, &num3)) return func_191(pedParam0, 4, num3);
Global_78340=Global_78340 - 1;
}}
return false;
}
...
case 11:
if(iParam2 >=256){
if(hParam3==-1) hParam3=func_178(hParam0, iParam2, 11, 4);
...
if(func_199(hParam0, iParam2, iParam3)) return true;
...
return true;
}elseif(func_197(hParam0, iParam2, iParam3, -1)){
...
if(hParam3==-1) hParam3=func_178(hParam0, iParam2, 14, 3);
...
case 1:
if(iParam2 >=26){
if(hParam3==-1) hParam3=func_178(hParam0, iParam2, 1, 3);
...
if(hParam3==-1) hParam3=func_178(hParam0, iParam2, 14, 4);
...
case 1:
if(iParam2 >=26){
if(hParam3==-1) hParam3=func_178(hParam0, iParam2, 1, 4);
...
i < itemHash.f_3;
i=i + 1){
if(FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_1, i, &outPropVariant) && outPropVariant.f_2 !=-1)if(outPropVariant !=0 && outPropVariant !=-1 && outPropVariant !=joaat("0")) uParam0->[outPropVariant.f_2]=func_188(hParam1, outPropVariant, 14, num);
...
switch (iParam1){
case 0:
if(Global_113648.f_9087.f_99.f_58[120]) func_206(&unk, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
else func_206(&unk, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
break;
case 1:
...
func_253();
if(hParam0==joaat("MP_M_Freemode_01")) func_237(iParam1, iParam2, hParam3);
elseif(hParam0==joaat("MP_F_Freemode_01")) func_208(iParam1, iParam2, hParam3);
...
if(iParam1==12){
if(!func_215(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_215(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
}elseif(iParam1==13){
}elseif(iParam1==14){
if(!func_215(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_215(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
...
if(func_214(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 1);
if(func_214(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 2);
if(!func_214(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 4);
}else{
MISC::SET_BIT(&(iParam0->f_6), 0);
...
int num;
int num2;
if(func_234(iParam0)==14192) return false;
...
if(num !=-1 && num < 4)if(func_255(num) !=-1 && func_255(num) !=0) return 1;
}
...
if(func_256(true)) return Global_1665818;
if(iParam0 <=-1 || iParam0 >=4) return -1;
return Global_2684799.f_6316[iParam0];
}
BOOL func_256(BOOL bParam0) // Position - 0x322C2{
if(func_260(bParam0) || func_258() || func_257(*Global_4718592.f_166301)) return true;
return false;
}
...
if(bParam0) return IS_BIT_SET(*Global_4718592.f_160050, 12) && func_261();
...
elseif(func_112(PLAYER::PLAYER_ID(), true) && Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10.f_76.f_21 !=0){
return 1;
}}
break;
default:
...
if(func_232(89, -1)) return 89;
}elseif(iParam2==17){
return 88;
}elseif(iParam2==28){
if(func_232(87, -1)) return 87;
}elseif(iParam2==41){
return 86;
}elseif(iParam2 >=237){
...
if(componentType==10)if(nameHash !=0 && nameHash !=joaat("0")) return func_264(nameHash, 3);
...
if(componentType2==10)if(nameHash2 !=0 && nameHash2 !=joaat("0")) return func_264(nameHash2, 3);
...
if(componentType3==10)if(nameHash3 !=0 && nameHash3 !=joaat("0")) return func_264(nameHash3, 4);
...
if(componentType4==10)if(nameHash4 !=0 && nameHash4 !=joaat("0")) return func_264(nameHash4, 4);
...
if(func_268(true)) player=_GET_BOSS_OF_LOCAL_PLAYER();
return player;
}
...
if(func_268(true)) playerPed=PLAYER::GET_PLAYER_PED(_GET_BOSS_OF_LOCAL_PLAYER());
return playerPed;
}
...
if(func_286()) return true;
if(Global_2696915) return true;
if(func_285()) return true;
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_283()) return true;
