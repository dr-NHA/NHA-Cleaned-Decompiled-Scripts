...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(!ENTITY::DOES_ENTITY_EXIST(obLocal_4)) obLocal_4=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(1090f, -1996f, 39f, 100f, joaat("v_ilev_found_cranebucket"), true, false, true);
if(!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_3)){
if(ENTITY::DOES_ENTITY_EXIST(obLocal_4)){
interiorFromEntity=INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
if(INTERIOR::IS_VALID_INTERIOR(interiorFromEntity))if(INTERIOR::IS_INTERIOR_READY(interiorFromEntity))if(INTERIOR::IS_INTERIOR_SCENE()) iLocal_3=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_obfoundry_cauldron_steam", obLocal_4, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
}}}
}
break;
case 2:
...
if(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_3)) GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_3, false);
if(ENTITY::DOES_ENTITY_EXIST(obLocal_4)) ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&obLocal_4);
