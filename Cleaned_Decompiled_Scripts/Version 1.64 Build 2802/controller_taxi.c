...
}}elseif(!func_84(Global_113648.f_19099, 16)){
if(!iLocal_116){
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(func_22(), 1);
}
...
iVar1=11;
iVar2=0;
}elseif(func_84(Global_113648.f_19099, 1024)){
...
}elseif(MISC::IS_PS3_VERSION() || func_3()){
...
return (func_62(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
if(VEHICLE::IS_VEHICLE_MODEL(uVar0, func_22())){
return 1;
}}}}}
return 0;
}
...
uParam0->f_1=(func_62(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
