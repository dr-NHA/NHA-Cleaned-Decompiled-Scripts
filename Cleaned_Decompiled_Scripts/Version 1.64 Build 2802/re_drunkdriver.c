...
iLocal_165=-1;
uLocal_339={
-1017.3451f, -1354.1962f, 4.4568f 
};
uLocal_342={
2003.4564f, 3071.1018f, 46.0499f 
};
uLocal_57={
uScriptParam_0.f_1[0 /*3*/] 
};
func_280();
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)) func_240();
if(func_198(uLocal_57, 27, iLocal_345, false, false)) func_195(-1);
...
if(!func_194())if(func_193()) func_240();
...
if(func_181()) func_240();
if(!bLocal_60) func_180();
if(bLocal_60) func_179();
}
break;
case 1:
func_172();
...
if(PED::IS_PED_IN_GROUP(uLocal_91[0])) PED::REMOVE_PED_FROM_GROUP(uLocal_91[0]);
...
if(PED::IS_PED_IN_GROUP(uLocal_91[1])) PED::REMOVE_PED_FROM_GROUP(uLocal_91[1]);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[0]))if(!PED::IS_PED_INJURED(uLocal_91[0])) PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_91[0], 1f);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[1]))if(!PED::IS_PED_INJURED(uLocal_91[1])) PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_91[1], 1f);
}
...
if(func_61()){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[0])) PED::DELETE_PED(&uLocal_91[0]);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[1])) PED::DELETE_PED(&uLocal_91[1]);
func_36();
}
if(func_35() || func_34() || func_3()) func_66();
break;
}}else{
func_240();
}
...
iLocal_159=MISC::GET_GAME_TIMER();
if(func_2())if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)) uLocal_160={
ENTITY::GET_ENTITY_SPEED_VECTOR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) 
};
}
return;
}
...
if(iLocal_54==1)if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[0]))if(!PED::IS_PED_INJURED(uLocal_91[0]))if(PED::IS_PED_IN_VEHICLE(uLocal_91[0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)) return true;
if(iLocal_54==2)if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_91[1]))if(!PED::IS_PED_INJURED(uLocal_91[0]) && !PED::IS_PED_INJURED(uLocal_91[1]))if(PED::IS_PED_IN_VEHICLE(uLocal_91[0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) && PED::IS_PED_IN_VEHICLE(uLocal_91[1], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)) return true;
}}
return false;
}
...
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), veLocal_94, 200f, 200f, 200f, false, true, 0)) return true;
if(!func_33("REDR2_DC") && !func_33("REDR2_AKA") && !func_33("REDR2_OFFR") && !func_33("REDR2_CULT")) func_5(true);
...
if(bParam0){
if(bLocal_136)if(func_10(&uLocal_173, "REDR2AU", &uLocal_143, &uLocal_137, 8, 0, 0)) bLocal_136=false;
}elseif(!bLocal_136 && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && !func_33("REDR1_SWV")){
uLocal_143={
func_9() 
};
uLocal_137={
...
if(func_14(PLAYER::PLAYER_ID())) return false;
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_24(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_24(character)) return func_27(character);
...
if(iLocal_54==1)if(PED::IS_PED_INJURED(uLocal_91[0])) return 1;
if(iLocal_54==2)if(PED::IS_PED_INJURED(uLocal_91[0]) && PED::IS_PED_INJURED(uLocal_91[1])) return 1;
return 0;
}

int func_35() // Position - 0x1323{
if(iLocal_54==1)if(!ENTITY::DOES_ENTITY_EXIST(uLocal_91[0])) return 1;
if(iLocal_54==2)if(!ENTITY::DOES_ENTITY_EXIST(uLocal_91[0]) && !ENTITY::DOES_ENTITY_EXIST(uLocal_91[1])) return 1;
return 0;
}
...
if(func_49(iParam0)) Global_113648.f_24997.f_2=3;
if(func_48(iParam0, iParam1) !=322) func_42(func_48(iParam0, iParam1), uLocal_44, uLocal_44.f_1);
Global_113636=iParam1;
if(Global_113634==0)if(Global_113637==1 || Global_113637==5 || Global_113637==11 || Global_113637==25) func_41(2);
elseif(Global_113637==26 || Global_113637==8 || Global_113637==17) func_41(7);
else func_41(1);
}
return;
}
...
if(Global_113648.f_24997.f_5==1000) return true;
return false;
}
...
i < 5;
i=i + 1){
if(Global_44206[i /*5*/].f_1==eParam0) return i;
}
return -1;
}
...
if(PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) return true;
if(MISC::IS_BULLET_IN_AREA(uLocal_152, 40f, true) || MISC::IS_BULLET_IN_AREA(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), 10f, false) || MISC::IS_PROJECTILE_IN_AREA(uLocal_152 -{
40f, 40f, 40f 
}
, uLocal_152 +{
40f, 40f, 40f 
...
, false)) return true;
if(!PED::IS_PED_INJURED(uLocal_91[0])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[0], PLAYER::PLAYER_PED_ID(), true) || ENTITY::IS_ENTITY_IN_WATER(uLocal_91[0])) return true;
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), true)) return true;
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))if(PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_91[0]) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_91[0]))if(PED::CAN_PED_SEE_HATED_PED(uLocal_91[0], PLAYER::PLAYER_PED_ID())) return true;
}else{
return true;
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[1])){
if(!PED::IS_PED_INJURED(uLocal_91[1])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[1], PLAYER::PLAYER_PED_ID(), true)) return true;
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[1], PLAYER::GET_PLAYERS_LAST_VEHICLE(), true)) return true;
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))if(PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_91[1]) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_91[1]))if(PED::CAN_PED_SEE_HATED_PED(uLocal_91[1], PLAYER::PLAYER_PED_ID())) return true;
}else{
return true;
}}
return false;
...
if(HUD::DOES_BLIP_EXIST(blLocal_151)) HUD::REMOVE_BLIP(&blLocal_151);
if(!PED::IS_PED_INJURED(uLocal_91[0])){
...
if(!func_194()){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false)) veLocal_95=PLAYER::GET_PLAYERS_LAST_VEHICLE();
...
if(HUD::DOES_BLIP_EXIST(uLocal_155[0])) HUD::SHOW_HEIGHT_ON_BLIP(uLocal_155[0], true);
iLocal_55=1;
}}}}
if(iLocal_54==2){
...
if(HUD::DOES_BLIP_EXIST(uLocal_155[0])) HUD::SHOW_HEIGHT_ON_BLIP(uLocal_155[0], true);
if(HUD::DOES_BLIP_EXIST(uLocal_155[1])) HUD::SHOW_HEIGHT_ON_BLIP(uLocal_155[1], true);
...
SYSTEM::SETTIMERA(0);
iLocal_55=4;
}}elseif(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_91[0], 30f, 30f, 30f, false, true, 0)){
...
if(!PED::IS_PED_INJURED(uLocal_91[1])) TASK::TASK_LOOK_AT_ENTITY(uLocal_91[1], PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_YAW_LIMIT | 8 | 2048, 4);
SYSTEM::SETTIMERA(0);
iLocal_55=4;
}
}}}
...
if(HUD::DOES_BLIP_EXIST(uLocal_155[iLocal_63])) HUD::REMOVE_BLIP(&uLocal_155[iLocal_63]);
}
if(!HUD::DOES_BLIP_EXIST(blLocal_158)) blLocal_158=func_150(veLocal_94, false, false);
if(!PED::IS_PED_INJURED(uLocal_91[0])) TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_91[0]);
iLocal_55=4;
}}}
if(iLocal_123 < MISC::GET_GAME_TIMER()){
if(func_152()) func_62(0);
...
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) iLocal_170=iLocal_170 + 1;
}
}
break;
case 2:
if(func_149()) iLocal_170=6;
else iLocal_170=iLocal_170 + 1;
break;
case 3:
if(!bLocal_104){
...
func_147(uLocal_91[0], &uLocal_65[0]);
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_LFT", 4, 0, 0, 0)) iLocal_170=iLocal_170 + 1;
break;
case 4:
if(!func_149()){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
...
if(HUD::DOES_BLIP_EXIST(uLocal_155[0])) HUD::REMOVE_BLIP(&uLocal_155[0]);
if(HUD::DOES_BLIP_EXIST(uLocal_155[1])) HUD::REMOVE_BLIP(&uLocal_155[1]);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_94, false)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(veLocal_94, 1);
if(!PED::IS_PED_INJURED(uLocal_91[0])) TASK::TASK_ENTER_VEHICLE(uLocal_91[0], veLocal_94, -1, 0, 1f, 1, 0);
}
iLocal_170=iLocal_170 + 1;
}}
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false) !=veLocal_94)if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_TKM", 4, 0, 0, 0)) iLocal_55=7;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_TKF", 4, 0, 0, 0)) iLocal_55=7;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_TKT", 4, 0, 0, 0)) iLocal_55=7;
else iLocal_55=7;
}
break;
case 6:
func_147(uLocal_91[0], &uLocal_65[0]);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(func_149())if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_AKB", 4, 0, 0, 0)) iLocal_170=10;
else iLocal_170=4;
else iLocal_170=4;
break;
case 7:
...
func_6();
SYSTEM::WAIT(0);
if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_AKA", 4, 0, 0, 0)) iLocal_170=iLocal_170 + 1;
}else{
func_147(uLocal_91[0], &uLocal_65[0]);
}}
}
...
case 2:
func_147(uLocal_91[0], &uLocal_65[0]);
if(!PED::IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(PLAYER::PLAYER_PED_ID()))if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_94, false)) VEHICLE::SET_VEHICLE_DOORS_LOCKED(veLocal_94, 1);
...
if(randomIntInRange < 60)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_PLS", 4, 0, 0, 0)) SYSTEM::SETTIMERA(0);
elseif(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_CAR", 4, 0, 0, 0)) SYSTEM::SETTIMERA(0);
}}
}
if(!ENTITY::IS_ENTITY_DEAD(veLocal_94, false))if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_94, true)) iLocal_55=7;
break;
}}
if(iLocal_54==1){
if(!PED::IS_PED_INJURED(uLocal_91[0]) && !ENTITY::IS_ENTITY_DEAD(veLocal_94, false)){
...
elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_94, -1, false)==uLocal_91[0]){
iLocal_55=2;
}
elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(veLocal_94, -1, false)==PLAYER::PLAYER_PED_ID()){
iLocal_55=7;
}
else{
func_70(uLocal_91[0], 120000, false);
...
SYSTEM::WAIT(0);
func_66();
}}}elseif(!PED::IS_PED_INJURED(uLocal_91[0])){
func_70(uLocal_91[0], 120000, false);
TASK::TASK_WANDER_STANDARD(uLocal_91[0], 1193033728, 0);
PED::SET_PED_KEEP_TASK(uLocal_91[0], true);
SYSTEM::WAIT(0);
...
break;
case 6:
if(!PED::IS_PED_INJURED(uLocal_91[0]))if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_91[0], SCRIPT_TASK_PERFORM_SEQUENCE)==1)if(TASK::GET_SEQUENCE_PROGRESS(uLocal_91[0])==5) func_66();
break;
case 7:
if(iLocal_54==1){
if(!PED::IS_PED_INJURED(uLocal_91[1]))if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_91[1], 50f, 50f, 50f, false, true, 0)) ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_91[1]);
switch (iLocal_64){
case 0:
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
if(!HUD::DOES_BLIP_EXIST(uLocal_155[0])) uLocal_155[0]=func_167(uLocal_91[0], false, 145);
...
if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_LFC", 4, 0, 0, 0)) bLocal_119=true;
}}
}
break;
case 2:
func_144();
if(!PED::IS_PED_INJURED(uLocal_91[0]))if(func_149())if(!bLocal_118)if(func_145(PLAYER::PLAYER_PED_ID(), uLocal_91[0], true) > fLocal_164 + 5f)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_LEA", 4, 0, 0, 0)) bLocal_118=true;
elseif(!bLocal_119)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_LFC", 4, 0, 0, 0)) bLocal_119=true;
if(func_2()){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_94, false)) VEHICLE::SET_VEHICLE_DOORS_LOCKED(veLocal_94, 1);
if(HUD::DOES_BLIP_EXIST(uLocal_155[0])) HUD::REMOVE_BLIP(&uLocal_155[0]);
...
if(!PED::IS_PED_INJURED(uLocal_91[0]))if(func_145(PLAYER::PLAYER_PED_ID(), uLocal_91[0], true) > 50f) func_66();
break;
case 3:
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
SYSTEM::WAIT(1500);
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_WHA", 4, 0, 0, 0)) iLocal_64=iLocal_64 + 1;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_WHB", 4, 0, 0, 0)) iLocal_64=iLocal_64 + 1;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_WHC", 4, 0, 0, 0)) iLocal_64=iLocal_64 + 1;
}
break;
case 4:
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
...
if(HUD::DOES_BLIP_EXIST(blLocal_103)) HUD::REMOVE_BLIP(&blLocal_103);
iLocal_55=8;
}
}
break;
...
if(!HUD::DOES_BLIP_EXIST(uLocal_155[0])) uLocal_155[0]=func_167(uLocal_91[0], false, 145);
if(!HUD::DOES_BLIP_EXIST(uLocal_155[1])) uLocal_155[1]=func_167(uLocal_91[1], false, 145);
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
SYSTEM::SETTIMERA(0);
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_JIA", 4, 0, 0, 0)) iLocal_64=iLocal_64 + 1;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_JIB", 4, 0, 0, 0)) iLocal_64=iLocal_64 + 1;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_JIC", 4, 0, 0, 0)) iLocal_64=iLocal_64 + 1;
}}
}
break;
case 1:
...
func_139();
func_138();
if(!bLocal_117)if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_BCK", 4, 0, 0, 0)) bLocal_117=true;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)){
...
func_146();
for (iLocal_63=0;
iLocal_63 <=iLocal_90 - 1;
iLocal_63=iLocal_63 + 1){
if(HUD::DOES_BLIP_EXIST(uLocal_155[iLocal_63])) HUD::REMOVE_BLIP(&uLocal_155[iLocal_63]);
}
if(HUD::DOES_BLIP_EXIST(blLocal_158)) HUD::REMOVE_BLIP(&blLocal_158);
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR && !func_64()){
if(!HUD::DOES_BLIP_EXIST(blLocal_103)){
blLocal_103=func_142(uLocal_87, false);
HUD::SET_BLIP_SPRITE(blLocal_103, BLIP_ALTRUIST);
...
case 5:
func_139();
if(iLocal_346==0 || iLocal_346==9) func_138();
if(MISC::GET_GAME_TIMER() - iLocal_171 > 9000) func_125();
if(iLocal_346==9 && MISC::GET_GAME_TIMER() - iLocal_347 > 6000 && MISC::GET_GAME_TIMER() - iLocal_347 < 6500) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_CHAT", 4, 0, 0, 0);
if(func_132(uLocal_81)){
func_5(false);
func_68();
SYSTEM::WAIT(0);
...
if(!ENTITY::IS_ENTITY_DEAD(veLocal_94, false))if(!PED::IS_PED_INJURED(uLocal_91[0]) && !PED::IS_PED_INJURED(uLocal_91[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_94, false))if(ENTITY::IS_ENTITY_AT_COORD(uLocal_91[0], uLocal_81, Global_22, true, true, 0) && ENTITY::IS_ENTITY_AT_COORD(uLocal_91[1], uLocal_81, Global_22, false, true, 0)) iLocal_64=iLocal_64 + 1;
break;
case 6:
if(HUD::DOES_BLIP_EXIST(blLocal_102)) HUD::REMOVE_BLIP(&blLocal_102);
if(HUD::DOES_BLIP_EXIST(blLocal_103)) HUD::REMOVE_BLIP(&blLocal_103);
...
iLocal_63 <=iLocal_90 - 1;
iLocal_63=iLocal_63 + 1){
if(!PED::IS_PED_INJURED(uLocal_91[iLocal_63])) PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_91[iLocal_63], false);
}
if(iLocal_54==1){
if(func_124(true, false, true) && iLocal_124==-1){
func_6();
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) VEHICLE::BRING_VEHICLE_TO_HALT(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 10.5f - 5f, 2, false);
if(func_2())if(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)==veLocal_94) iLocal_124=0;
else iLocal_124=1;
else iLocal_124=2;
}
if(iLocal_124==0) func_123();
if(iLocal_124==1) func_122();
if(iLocal_124==2) func_121();
if(bLocal_130){
...
if(iLocal_124==0) func_110();
elseif(iLocal_124==1) func_109();
elseif(iLocal_124==2) func_77();
if(bLocal_130){
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
func_36();
}}
...
break;
case 4:
if(iLocal_125 < MISC::GET_GAME_TIMER()) iLocal_126=iLocal_126 + 1;
break;
case 5:
...
int outValue;
Hash statHash;
if(func_108(echParam0)==3) return;
if(func_108(echParam0)==4) return;
...
func_81(iParam0);
if(Global_43257==15) func_80(false);
return 1;
}
...
}}elseif(IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_84() /*5568*/].f_681.f_10, iParam0)){
flag=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
int cloudTimeAsInt6;
int num6;
if(iParam0==8) return func_90(129, -1);
if(iParam0==9) return func_90(135, -1);
if(iParam0==10) return func_90(136, -1);
if(iParam0==11) return func_90(137, -1);
if(iParam0==12){
...
if(func_28(14) && !func_104(iParam0)) return 0;
...
if(func_101(&Global_4542597, iParam0)) return 0;
if(func_94(&Global_4542597, iParam0)) return 1;
}else{
...
if(func_28(14) && !func_104(iParam1)) return false;
if(func_101(uParam0, iParam1)) return false;
if(func_100(uParam0) < 0f) func_99(uParam0, 0);
func_97(&unk);
i=0;
for (i=0;
i < *uParam0 - 1;
...
if(func_28(14) && !func_104(iParam1)) return 0;
if(func_101(uParam0, iParam1)) return 0;
if(func_100(uParam0) < 0f) func_99(uParam0, 0);
for (i=0;
i < *uParam0;
i=i + 1){
...
iLocal_125=MISC::GET_GAME_TIMER() + 1500;
iLocal_126=7;
}}elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL){
...
break;
case 7:
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) iLocal_126=iLocal_126 + 1;
break;
case 8:
func_78(_GET_CURRENT_PLAYER_CHARACTER(), 1, 80, false, true);
bLocal_130=true;
...
TASK::OPEN_SEQUENCE_TASK(&iLocal_99);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, uLocal_84 -{
0f, 0f, 1f 
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_TKT", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_TKF", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_TKM", 4, 0, 0, 0);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_94, false)) VEHICLE::SET_VEHICLE_DOORS_LOCKED(veLocal_94, 7);
if(bLocal_131){
if(!ENTITY::IS_ENTITY_DEAD(veLocal_94, false)){
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_117(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_114() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_117(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_116(-1, false)==8;
...
if(func_118())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(bLocal_108) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_TK", 4, 0, 0, 0);
else _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_TK1", 4, 0, 0, 0);
iLocal_126=iLocal_126 + 1;
}
break;
case 1:
...
break;
case 2:
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_GBM", 4, 0, 0, 0)) iLocal_126=iLocal_126 + 1;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_GBF", 4, 0, 0, 0)) iLocal_126=iLocal_126 + 1;
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_GBT", 4, 0, 0, 0)) iLocal_126=iLocal_126 + 1;
break;
case 3:
if(!PED::IS_PED_INJURED(uLocal_91[0])){
TASK::OPEN_SEQUENCE_TASK(&iLocal_99);
...
iLocal_347=MISC::GET_GAME_TIMER();
iLocal_346=iLocal_346 + 1;
}}}elseif(!PED::IS_PED_INJURED(uLocal_91[0]) && !PED::IS_PED_INJURED(uLocal_91[1])){
TASK::CLEAR_PED_TASKS(uLocal_91[0]);
TASK::CLEAR_PED_TASKS(uLocal_91[1]);
iLocal_346=3;
}
...
if(camViewModeForContext2==FIRST_PERSON) flag2=true;
}
if(!flag2){
TASK::OPEN_SEQUENCE_TASK(&iLocal_99);
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_idle_m", 3)) TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_exit_m", 2f, -2f, -1, 0, 0, false, false, false);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false))if(!PED::IS_PED_INJURED(uLocal_91[0]))if(PED::IS_PED_IN_VEHICLE(uLocal_91[0], vehiclePedIsIn, false))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(vehiclePedIsIn, 2, false)==uLocal_91[0] && VEHICLE::GET_PED_IN_VEHICLE_SEAT(vehiclePedIsIn, 1, false)==uLocal_91[1]) return true;
}}
return false;
}
...
if(num < iParam0 && num > -iParam0 && num2 < iParam0 && num2 > -iParam0){}else{
return 1;
}
return 0;
}
...
if(fLocal_47==-1f) fLocal_47=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0);
...
if(!bLocal_108){
if(!func_33("REDR1_SWV") && !func_33("REDR1_COM") && !func_33("REDR1_BANT1") && !func_33("REDR1_SIK") && !func_33("REDR2_DC") && !func_33("REDR1_OFFR") && !func_33("REDR2_OFFR") && !func_33("REDR1_CULT") && !func_33("REDR2_CULT")) func_5(true);
if(bLocal_110 && !bLocal_134 && MISC::GET_GAME_TIMER() - iLocal_171 > 9000)if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_BANT1", 4, 0, 0, 0)) bLocal_134=true;
}
if(bLocal_134 && !bLocal_135){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_RESPM", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_RESPF", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_RESPT", 4, 0, 0, 0);
...
bLocal_135=false;
bLocal_133=true;
}}}}elseif(bLocal_108 && !bLocal_132 && iLocal_149 < MISC::GET_GAME_TIMER()){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
...
if(iLocal_163 > 17) bLocal_109=true;
return;
}
...
float num;
if(func_2())if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)) entitySpeedVector={
ENTITY::GET_ENTITY_SPEED_VECTOR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) 
};
num={
entitySpeedVector - uParam0 
};
num={
func_136(num, iParam3) 
};
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
...
}elseif(iLocal_165 < MISC::GET_GAME_TIMER()){
...
Vector3 func__136(float fParam0, var uParam1, var uParam2, int iParam3) // Position - 0x8039{
float num;
...
if(!ENTITY::IS_ENTITY_DEAD(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)) VEHICLE::REMOVE_VEHICLE_WINDOW(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1);
SYSTEM::SETTIMERB(0);
...
bLocal_105=true;
}}elseif(entityAnimCurrentTime > 0.295f && entityAnimCurrentTime < 0.37f){
if(!bLocal_106){
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE("scr_puke_in_car", uLocal_91[0], 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1065353216, false, false, false);
bLocal_106=true;
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_SIKM", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_SIKF", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) _CONVERSATION_ADD_LINE(&uLocal_173, "REDR1AU", "REDR1_SIKT", 4, 0, 0, 0);
}}elseif(entityAnimCurrentTime > 0.49f && entityAnimCurrentTime < 0.55f){
if(!bLocal_107){
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE("scr_puke_in_car", uLocal_91[0], 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1065353216, false, false, false);
bLocal_107=true;
}}
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_1", sLocal_114) > 0.8f) iLocal_111=iLocal_111 + 1;
}
break;
case 3:
...
if(iLocal_54==1){
if(!PED::IS_PED_INJURED(uLocal_91[0])){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_91[0], 150f, 150f, 150f, false, true, 0)) func_66();
if(func_149() || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())){
if(!PED::IS_PED_IN_GROUP(uLocal_91[0])){
PED::SET_PED_AS_GROUP_MEMBER(uLocal_91[0], func_63());
PED::SET_PED_NEVER_LEAVES_GROUP(uLocal_91[0], true);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_91[0], 0);
}}elseif(PED::IS_PED_IN_GROUP(uLocal_91[0])){
PED::REMOVE_PED_FROM_GROUP(uLocal_91[0]);
}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
if(PED::IS_PED_IN_VEHICLE(uLocal_91[0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_114, 3) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(uLocal_91[0])) TASK::TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 2f, -4f, -1, 1, 0, false, false, false);
if(func_152()){
func_62(0);
bLocal_120=false;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 3)){
TASK::STOP_ANIM_PLAYBACK(uLocal_91[0], 0, false);
}}else{
if(PED::IS_PED_IN_ANY_VEHICLE(uLocal_91[0], false))if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 3)) TASK::STOP_ANIM_PLAYBACK(uLocal_91[0], 0, false);
...
if(HUD::DOES_BLIP_EXIST(uLocal_155[0])) HUD::REMOVE_BLIP(&uLocal_155[0]);
if(!HUD::DOES_BLIP_EXIST(blLocal_102)) blLocal_102=func_142(uLocal_81, true);
}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_155[0])) uLocal_155[0]=func_167(uLocal_91[0], false, 145);
if(HUD::DOES_BLIP_EXIST(blLocal_102)) HUD::REMOVE_BLIP(&blLocal_102);
}}}
...
var func__143(BOOL bParam0, var uParam1, var uParam2) // Position - 0x889E{
...
if(!func_149()){
if(PED::IS_PED_IN_GROUP(uLocal_91[0])) PED::REMOVE_PED_FROM_GROUP(uLocal_91[0]);
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_91[0], SCRIPT_TASK_GO_TO_ENTITY) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_91[0], SCRIPT_TASK_GO_TO_ENTITY) !=0) TASK::TASK_GO_TO_ENTITY(uLocal_91[0], PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
if(PED::IS_PED_IN_ANY_VEHICLE(uLocal_91[0], false)) TASK::TASK_LEAVE_ANY_VEHICLE(uLocal_91[0], 0, 0);
if(!bLocal_122){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
...
bLocal_122=false;
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_91[0], SCRIPT_TASK_GO_TO_ENTITY)==1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_91[0], SCRIPT_TASK_GO_TO_ENTITY)==0) TASK::CLEAR_PED_TASKS(uLocal_91[0]);
}}elseif(!PED::IS_PED_IN_GROUP(uLocal_91[0])){
PED::SET_PED_AS_GROUP_MEMBER(uLocal_91[0], func_63());
PED::SET_PED_NEVER_LEAVES_GROUP(uLocal_91[0], true);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_91[0], 0);
...
if(!func_64())if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) Global_32402=1;
return;
}
...
break;
case 1:
if(!PED::IS_PED_INJURED(pedParam0))if(PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 45f)) *uParam1=*uParam1 + 1;
break;
case 2:
if(!PED::IS_PED_INJURED(pedParam0))if(!PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 45f)) *uParam1=0;
break;
}
return;
}
...
int num;
if(iLocal_54==1) num=1;
if(iLocal_54==2) num=2;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))if(!PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_SUB(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_TRAIN(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("rhino")))if(VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) >=num) return true;
elseif(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID()), false))if(!VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID()))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID()))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID()))) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID()))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID()))) && ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID())) !=joaat("rhino")) return true;
return false;
}
...
if(!PED::IS_PED_INJURED(uLocal_91[0])){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_91[0], 30f, 30f, 30f, false, true, 0)){
if(!bLocal_115)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_DCB", 4, 0, 0, 0)) bLocal_115=true;
if(!bLocal_116)if(_CONVERSATION_ADD_LINE(&uLocal_173, "REDR2AU", "REDR2_DCC", 4, 0, 0, 0)) bLocal_116=true;
}}
return;
}
...
if(func_49(Global_113637)) func_158(0);
HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
if(bParam0 && func_49(Global_113637)) HUD::FLASH_MINIMAP_DISPLAY();
return 1;
}
return 0;
}
...
if(iParam4 !=0) func_162(uParam0, iParam4);
}
return 2;
}
...
PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_68 -{
8f, 8f, 8f 
}
, uLocal_68 +{
8f, 8f, 8f 
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_76 -{
10f, 15f, 15f 
}
, uLocal_76 +{
10f, 15f, 15f 
...
, false, true);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_81 -{
10f, 15f, 15f 
}
, uLocal_81 +{
10f, 15f, 15f 
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_173, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_173, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
if(iLocal_54==2){
PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_81 -{
10f, 50f, 30f 
}
, uLocal_81 +{
10f, 50f, 30f 
...
if(bParam1)if(!func_178(iParam0, 2, true)) func_177(iParam0, 2, true);
elseif(func_178(iParam0, 2, true)) func_175(iParam0, 2, true);
return;
}
...
elseif(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(func_44()==0) return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_176(iParam0), -1, 0), iParam1);
...
if(iLocal_54==1)if(STREAMING::HAS_PTFX_ASSET_LOADED() && STREAMING::HAS_ANIM_DICT_LOADED("random@drunk_driver_1") && STREAMING::HAS_ANIM_SET_LOADED("MOVE_M@DRUNK@VERYDRUNK") && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, -1)) bLocal_56=true;
elseif(iLocal_54==2)if(STREAMING::HAS_ANIM_DICT_LOADED("random@drunk_driver_2") && STREAMING::HAS_ANIM_DICT_LOADED("MOVE_M@DRUNK@SLIGHTLYDRUNK") && STREAMING::HAS_ANIM_DICT_LOADED("MOVE_M@DRUNK@MODERATEDRUNK_HEAD_UP")) bLocal_56=true;
}else{
STREAMING::REQUEST_MODEL(hLocal_96);
STREAMING::REQUEST_MODEL(hLocal_98);
STREAMING::REQUEST_MODEL(hLocal_97);
...
if(iLocal_54==1){
uLocal_152={
-1018.2382f, -1350.1014f, 4.475f 
};
iLocal_90=2;
hLocal_96=joaat("A_M_Y_BeachVesp_01");
hLocal_97=joaat("A_M_Y_BeachVesp_02");
uLocal_68={
-1016.7623f, -1356.459f, 4.5531f 
};
fLocal_71=247.8087f;
uLocal_72={
-1015.572f, -1357.081f, 4.552f 
};
fLocal_75=66.3861f;
uLocal_76={
-1027.7618f, -1341.6439f, 4.4614f 
};
fLocal_79=76.9418f;
hLocal_98=joaat("baller2");
uLocal_81={
160.8892f, -111.4167f, 61.2999f 
};
uLocal_84={
159.2191f, -117.0664f, 61.2999f 
};
bLocal_60=true;
}
if(iLocal_54==2){
uLocal_152={
1893.8561f, 3714.3457f, 31.7771f 
};
iLocal_90=2;
...
fLocal_71=252.0142f;
uLocal_72={
1894.7627f, 3714.1604f, 31.7605f 
};
fLocal_75=86.1102f;
uLocal_76={
1888.2565f, 3717.1892f, 31.8394f 
};
fLocal_79=299.4672f;
hLocal_98=joaat("emperor");
uLocal_81={
1120.5507f, 2647.3071f, 36.9963f 
};
uLocal_84={
1121.8657f, 2641.7068f, 37.1487f 
};
bLocal_60=true;
}
return;
...
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_192()) return false;
}
if(func_188()) return true;
if(func_182(100f, true) !=-1) return true;
return false;
}
...
if(func_191() && !func_192()) return true;
if(func_190() && func_189()) return true;
return false;
}
...
if(func_188()) return true;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_192()) return false;
if(func_182(100f, true) !=-1) return true;
return false;
}
BOOL func_194() // Position - 0xC041{
if(Global_113637==func_58() && MISC::GET_RANDOM_EVENT_FLAG() && Global_113638) return true;
return false;
}
...
if(func_188()) return false;
if(func_238()) return false;
if(Global_113637 !=-1) return false;
if(func_24(_GET_CURRENT_PLAYER_CHARACTER()))if(func_182(100f, true) !=-1) return false;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !bParam6)if(entityCoords.f_2 - uLocal_44.f_2 > 50f) return false;
if(!func_237(iParam3)) return false;
if(func_24(_GET_CURRENT_PLAYER_CHARACTER()))if(func_236(_GET_CURRENT_PLAYER_CHARACTER())==4 || func_236(_GET_CURRENT_PLAYER_CHARACTER())==5) return false;
if(func_24(_GET_CURRENT_PLAYER_CHARACTER()))if(!func_235(iParam3, iParam4, 145)) return false;
if(!func_234(Global_113648.f_24997.f_43[iParam3])) return false;
if(MISC::GET_GAME_TIMER() - Global_113639 < 150000)if(iParam3 !=30) return false;
if(func_233()) return false;
if(MISC::GET_MISSION_FLAG()) return false;
if(MISC::GET_RANDOM_EVENT_FLAG()) return false;
if(!func_224(4)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(5)) return false;
if(func_223(iParam3, iParam4) && !bParam5) return false;
...
if(iParam3==9 && iParam4==2 || iParam4==5 && !func_223(0, 0)) return false;
if(Global_32310) return false;
if(func_237(30) && !func_223(30, 0))if(iParam3 !=30)if(SYSTEM::VDIST2(entityCoords, -61.2745f, -1100.4675f, 25.3752f) < 176400f) return false;
if(func_24(_GET_CURRENT_PLAYER_CHARACTER())){
for (i=CHAR_MICHAEL;
i < CHAR_MULTIPLAYER;
i=i + 1){
...
if(func_222(num))if(func_200(i))if(!func_199(vector, 0f, 0f, 0f, false))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector) < 210f * 210f)if(_GET_CURRENT_PLAYER_CHARACTER() !=i) return false;
}}}
return true;
}
...
var func__212(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC8C1{
if(bParam0) return uParam1;
return uParam2;
}
...
int num;
int num2;
if(!func_222(iParam1) || !func_222(iParam0)) return 1;
...
if(iParam1 < 1 || iParam1 > func_206(num, num2)) return;
...
if(num6 < 1 || num6 > func_206(num5, num4)) return false;
return true;
}
...
if(!func_24(character)) return false;
switch (iParam0){
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112695 || Global_32166 || func_231() || func_30(8, -1) || func_230() || func_229() || func_228() || func_227() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_232() || Global_32166 || func_231() || func_30(8, -1) || func_228() || func_230() || func_229() || func_227() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112695 || Global_32166 || func_231() || func_30(8, -1) || func_228() || func_230() || func_229() || func_227() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112695 || Global_32166 || func_231() || func_30(8, -1) || func_230() || func_229() || func_227() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_232() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_30(8, -1) || func_227() || func_226() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_30(8, -1) || func_230() || func_229() || func_226() || func_225()) return false;
...
break;
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_232() || Global_32166 || func_231() || func_30(8, -1) || func_229() || func_228() || func_227() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 7:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_232() || func_229() || Global_112695 || Global_32166 || func_231() || Global_44446 || func_30(8, -1) || func_228() || func_226() || func_227() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 8:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || unk_0x279D0BCF8F708D74(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_232() || Global_112695 || Global_32166 || func_231() || func_30(8, -1) || func_228() || func_226() || func_230() || func_229() || func_227()) return false;
break;
}}else{
return false;
}}else{
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_enter_m", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_idle_m", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_exit_m", 3)) TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
if(bLocal_172){
func_279(false);
if(Global_32406) AUDIO::TRIGGER_MUSIC_EVENT("AC_STOP");
func_278();
func_6();
AUDIO::SET_NO_DUCKING_FOR_CONVERSATION(false);
...
, true, true);
func_156(false);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE())) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), true, false);
if(!ENTITY::IS_ENTITY_DEAD(veLocal_95, false))if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_95, false) && func_145(PLAYER::PLAYER_PED_ID(), veLocal_95, true) > 50f) func_252(veLocal_95, 0, _CHAR_NULL);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_91[0])){
if(!PED::IS_PED_INJURED(uLocal_91[0])){
PED::SET_PED_CONFIG_FLAG(uLocal_91[0], 317, true);
if(!PED::IS_PED_IN_ANY_VEHICLE(uLocal_91[0], false)) PED::RESET_PED_LAST_VEHICLE(uLocal_91[0]);
if(PED::IS_PED_IN_GROUP(uLocal_91[0])) PED::REMOVE_PED_FROM_GROUP(uLocal_91[0]);
}}
for (iLocal_63=0;
iLocal_63 <=iLocal_90 - 1;
...
if(!PED::IS_PED_IN_ANY_VEHICLE(uLocal_91[iLocal_63], false)) PED::RESET_PED_LAST_VEHICLE(uLocal_91[iLocal_63]);
...
if(iLocal_54==1) PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(42.7808f, -1324.4054f, -10f, 98.245f, -1277.174f, 10f, 1);
if(CAM::DOES_CAM_EXIST(caLocal_127))if(CAM::IS_CAM_ACTIVE(caLocal_127)) CAM::SET_CAM_ACTIVE(caLocal_127, false);
}
func_241(-1);
...
if(ENTITY::DOES_ENTITY_EXIST(pedInVehicleSeat) && !PED::IS_PED_INJURED(pedInVehicleSeat))if(ENTITY::GET_ENTITY_MODEL(pedInVehicleSeat)==joaat("Player_Zero")) iParam1=CHAR_MICHAEL;
elseif(ENTITY::GET_ENTITY_MODEL(pedInVehicleSeat)==joaat("Player_One")) iParam1=CHAR_FRANKLIN;
elseif(ENTITY::GET_ENTITY_MODEL(pedInVehicleSeat)==joaat("Player_Two")) iParam1=CHAR_TREVOR;
if(iParam1 !=CHAR_MICHAEL && iParam1 !=CHAR_FRANKLIN && iParam1 !=CHAR_TREVOR) iParam1=Global_113648.f_2365.f_539.f_4321;
}
for (i=0;
i < 3;
i=i + 1){
...
if(uParam1->f_65==-1 && !func_257(uParam1->f_66)) uParam1->f_65=0;
...
i <=11;
i=i + 1){
if(VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1)) MISC::SET_BIT(&(uParam1->f_77), func_255(i + 1));
}
...
if(!func_261(hParam0, false, -1)) return false;
...
if(hParam0==joaat("blimp"))if(!func_270() && !func_269() && !func_268() && !func_267() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_266() || MISC::IS_PC_VERSION() || func_265()){
}elseif(!func_268()){
return false;
}}
if(bParam1)if(!func_264(hParam0, iParam2)) return false;
if(!func_262(hParam0)) return false;
return true;
}
...
if(!func_261(entityModel, false, -1)) return true;
return false;
}
...
for (i=0;
func_277(iParam1, i, &garageName, &num);
i=i + 1){
...
Vector3 func__280() // Position - 0x12977{
float distanceBetweenCoords;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
