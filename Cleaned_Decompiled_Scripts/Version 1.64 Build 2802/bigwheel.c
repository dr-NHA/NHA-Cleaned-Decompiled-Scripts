...
uParam0->f_14=(uParam0->f_14 + func_2(((((Var10.f_0 - uParam0->f_14) * 0.05f) * fVar9) * fParam7), -3f, 3f));
uParam0->f_14.f_1=(uParam0->f_14.f_1 + func_2(((((Var10.f_1 - uParam0->f_14.f_1) * 0.05f) * fVar9) * fParam7), -3f, 3f));
uParam0->f_14.f_2=(uParam0->f_14.f_2 + func_2(((((Var10.f_2 - uParam0->f_14.f_2) * 0.05f) * fVar9) * fParam7), -3f, 3f));
}
if(uParam0->f_26){
...
}elseif(func_30(uParam0->f_8) && func_30(uParam0->f_9)){
...
CAM::ATTACH_CAM_TO_PED_BONE(Local_294.f_0, PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f, 1);
}else{
...
uVar0=func_21(iLocal_286);
if(!MISC::IS_STRING_NULL_OR_EMPTY(uVar0)){
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, sLocal_160, uVar0, 1000f, -8f, 0, 0, 1148846080, 0);
...
PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 118, 0);
PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 208, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_3, 0, func_20(fParam1), 0f, 0f, fParam1, 0, 0, 0, 0, 2, 1, 0);
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_160, func_21(iLocal_286), 1000f, -8f, -1, 1, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}


Vector3 func__20(float fParam0){
struct<3> Var0;
...
ENTITY::SET_ENTITY_COORDS(iLocal_161, Local_278, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_161, (-fLocal_276 - (360f / 16f)), 0f, 0f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_161, 1);
}
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("FAIRGROUND_RIDES_FERRIS_WHALE")){
if(func_30(PLAYER::PLAYER_PED_ID())){
Var1={
...
if(!CAM::DOES_CAM_EXIST(uLocal_293)){
uLocal_293=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_293, -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 0, 1, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_293, 1);
CAM::SET_CAM_PARAMS(uLocal_293, -1659.11f, -1120.752f, 12.9489f, -5.5053f, 0f, 56.0716f, 50.1098f, 7000, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
...
}elseif(func_67(PLAYER::GET_PLAYERS_LAST_VEHICLE(), joaat("sandking"))){
...
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_287, "GENERATOR", iLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
iLocal_289=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_289, "SLOW_SQUEAK", iLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
iLocal_290=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_290, "SLOW_SQUEAK", Local_162[1 /*7*/].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
iLocal_288=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_288, "CARRIAGE", Local_162[1 /*7*/].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
}
...
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_4[iVar0], uParam0->f_1, sLocal_160, uVar3, 1000f, -8f, 0, 0, 1148846080, 0);
...
Vector3 func__51(int iParam0, struct<3> Param1){
var uVar0;
...
Vector3 func__65(struct<3> Param0){
float fVar0;
float fVar1;
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_123(iVar10, iParam1, iParam2, -1) 
};
if(!func_122(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_123(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_101(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_123(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_123(iVar10, iVar0, func_80(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_123(iVar10, 14, uVar69[iVar1], -1) 
};
func_91(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_114(14);
if(Global_78339==1){
...
if(!func_187(uParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_64, Global_113648.f_2365.f_539[iVar0 /*65*/].f_63)){
...
Global_78341[1 /*14*/]={
func_123(iParam0, iParam1, iParam2, -1) 
};
...
if(!func_187(uParam0, Global_113648.f_2365.f_539[iVar0 /*65*/].f_61, Global_113648.f_2365.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_81(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_81(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_81(iParam0));
if(iVar57 > iVar56){
...
Global_78341[1 /*14*/]={
func_123(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_81(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_81(iParam1))){
return 1;
}
return 0;
}
...
void func_189(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_193(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
int func_201(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4){
if(MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1)){
return 1;
}
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_227() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_227() /*5568*/].f_681.f_10, iParam0);
}
