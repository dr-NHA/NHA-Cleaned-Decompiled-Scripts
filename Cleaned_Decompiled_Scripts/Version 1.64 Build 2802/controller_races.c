...
fLocal_25=-0.0375f;
fLocal_26=0.17f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_31();
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("controller_races")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
while (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("initial")) > 0){
SYSTEM::WAIT(0);
}
func_30();
while (true){
if(func_27(9) || Global_97601) func_31();
...
MISC::CLEAR_BIT(&(Global_113648.f_24981.f_3), i);
}elseif(MISC::GET_GAME_TIMER() - Global_113628[i] > 60000){
Global_113622[i]=false;
Global_113628[i]=MISC::GET_GAME_TIMER();
func_3(num);
func_2(num, true, true);
MISC::CLEAR_BIT(&(Global_113648.f_24981.f_3), i);
}
...
Vector3 func__8(int iParam0, int iParam1) // Position - 0x55C{
int num;
num=iParam0;
...
func_3(num);
func_2(num, true, true);
MISC::CLEAR_BIT(&(Global_113648.f_24978.f_2), i);
}
elseif(MISC::GET_GAME_TIMER() - Global_113617[i] > 60000){
Global_113612[i]=false;
Global_113617[i]=MISC::GET_GAME_TIMER();
func_3(num);
func_2(num, true, true);
MISC::CLEAR_BIT(&(Global_113648.f_24978.f_2), i);
}}}elseif(func_7(num)){
...
break;
case 1:
if(CLOCK::GET_CLOCK_HOURS() >=20 || CLOCK::GET_CLOCK_HOURS() < 5) iLocal_28=2;
break;
case 2:
if(CLOCK::GET_CLOCK_HOURS() < 20 && CLOCK::GET_CLOCK_HOURS() >=5){
func_24();
