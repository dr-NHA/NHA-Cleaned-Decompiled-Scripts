...
while (bVar0 <=(5 - 1)){
iVar1=func_10(bVar0);
if(MISC::IS_BIT_SET(Global_113648.f_24981.f_1, bVar0)){
if(MISC::IS_BIT_SET(Global_113648.f_24981.f_3, bVar0)){
...
}elseif((MISC::GET_GAME_TIMER() - Global_113628[bVar0]) > 60000){
...
while (bVar0 <=(4 - 1)){
iVar1=func_22(bVar0);
if(MISC::IS_BIT_SET(Global_113648.f_24978.f_2, bVar0)){
fVar2=SYSTEM::VDIST2(func_9(PLAYER::PLAYER_ID()), func_8(iVar1, 0));
if(fVar2 > 43681f){
if(!func_7(iVar1)){
...
elseif((MISC::GET_GAME_TIMER() - Global_113617[bVar0]) > 60000){
