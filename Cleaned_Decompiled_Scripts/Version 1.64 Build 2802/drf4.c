...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_19() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_19() /*5568*/].f_681.f_10, iParam0);
}
...
uParam0->f_1=(func_66(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
iVar2[iParam0]=0;
}elseif((iParam1 > 0 && iParam1 < 13) && !func_99(&(Global_113648.f_19963), iParam1)){
iVar2[iParam1]=0;
}elseif((iParam2 > 0 && iParam2 < 13) && !func_99(&(Global_113648.f_19963), iParam2)){
iVar2[iParam2]=0;
}elseif((iParam3 > 0 && iParam3 < 13) && !func_99(&(Global_113648.f_19963), iParam3)){
iVar2[iParam3]=0;
}elseif((iParam4 > 0 && iParam4 < 13) && !func_99(&(Global_113648.f_19963), iParam4)){
iVar2[iParam4]=0;
}
...
int iVar7;
bool bVar8;
if((((!func_109(&(Global_113648.f_19963), 8) && iParam1) && iParam0 !=4) && func_107(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f){
bVar4=8;
*uParam3=4;
}else{
...
iVar0=1;
}elseif(MISC::ARE_STRINGS_EQUAL(uParam0, "DRF_EXILE")){
iVar0=2;
}elseif(MISC::ARE_STRINGS_EQUAL(uParam0, "DRF_SOL2")){
iVar0=1;
}elseif(MISC::ARE_STRINGS_EQUAL(uParam0, "DRF_MIC2")){
iVar0=1;
}
return iVar0;
}
