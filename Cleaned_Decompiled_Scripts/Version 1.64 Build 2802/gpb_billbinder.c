...
if(character==CHAR_TREVOR)if(uLocal_299[2]==1) return 14;
else return 5;
elseif(character==CHAR_MICHAEL) return 4;
return 5;
}
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR)if(uLocal_299[2]==1) TEXT_LABEL_ASSIGN_STRING(sParam0, "Bill_ig_4_03_convo_TheEliteAreOutToCrush", 64);
else TEXT_LABEL_ASSIGN_STRING(sParam0, "BILL_IG_5_02_CONVO_GoodToSeeYouAgain", 64);
elseif(character==CHAR_MICHAEL) TEXT_LABEL_ASSIGN_STRING(sParam0, "Bill_ig_2_CONVO_michael_YouSeemMellow", 64);
elseif(character==CHAR_FRANKLIN) TEXT_LABEL_ASSIGN_STRING(sParam0, "bill_ig_3_convo_franklin_nothingisupman", 64);
return;
}
...
var func__83(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2D6E{
...
Vector3 func__87(float fParam0, var uParam1, var uParam2) // Position - 0x2E95{
float num;
float num2;
...
uLocal_255[6]=6;
uLocal_255[7]=6;
if(func_106(113)) uLocal_299[2]=2;
return;
}
