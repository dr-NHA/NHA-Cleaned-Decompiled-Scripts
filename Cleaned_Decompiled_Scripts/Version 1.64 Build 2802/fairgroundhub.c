...
num=4;
_IS_NULL_VECTOR(unk);
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(195)) func_75();
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fairgroundhub")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
if(Global_2883694){
...
func_67();
SYSTEM::WAIT(3000);
if(!ENTITY::DOES_ENTITY_EXIST(num[0])) num[0]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1643.5242f, -1124.6805f, 17.4326f, 0.3f, joaat("prop_roller_car_01"), true, false, true);
if(!ENTITY::DOES_ENTITY_EXIST(num[1])) num[1]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.1455f, -1126.6127f, 17.4326f, 0.3f, joaat("prop_roller_car_02"), true, false, true);
if(!ENTITY::DOES_ENTITY_EXIST(num[2])) num[2]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.7676f, -1128.5453f, 17.4326f, 0.3f, joaat("prop_roller_car_02"), true, false, true);
if(!ENTITY::DOES_ENTITY_EXIST(num[3])) num[3]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.3896f, -1130.4784f, 17.4326f, 0.3f, joaat("prop_roller_car_02"), true, false, true);
i=0;
for (i=0;
i < num;
i=i + 1){
...
if(func_65(PLAYER::PLAYER_PED_ID(), unk, false) > 100f + 20f) func_75();
if(!func_64(14)){
if(func_63()){
func_75();
}elseif(uLocal_74[0 /*24*/].f_9==0){
uLocal_74[0 /*24*/].f_9=15;
uLocal_99[0 /*24*/].f_9=8;
sLocal_40.f_9=0;
sLocal_57.f_9=0;
}}
if(func_62(64) !=0) func_54(64, 0, 0, true, 0);
if(func_1(&uLocal_74, &sLocal_40, false, false, true, FRIEND)) func_75();
if(func_1(&uLocal_99, &sLocal_57, false, false, true, FRIEND)) func_75();
SYSTEM::WAIT(0);
}
return;
}
...
uParam1->f_12=i;
if(uParam0->[i /*24*/].f_7 || MISC::GET_MISSION_FLAG() && uParam1->f_16==0) func_39(uParam1, 6);
elseif(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) func_39(uParam1, 8);
elseif(bParam2) func_39(uParam1, 3);
elseif(uParam0->[i /*24*/].f_8) func_39(uParam1, 2);
elseif(func_28() < uParam0->[uParam1->f_12 /*24*/].f_9) func_39(uParam1, 1);
elseif(func_23()) func_39(uParam1, 7);
else func_39(uParam1, 4);
}}}else{
func_22(uParam1);
}
break;
case 2:
if(!uParam1->f_9) func_20(uParam1, uParam1->f_6);
...
break;
case 1:
if(!uParam1->f_9) func_11(uParam1, uParam1->f_2, uParam0->[uParam1->f_12 /*24*/].f_9);
...
break;
case 6:
if(!uParam1->f_9) func_20(uParam1, uParam1->f_1);
...
break;
case 3:
if(!uParam1->f_9) func_20(uParam1, uParam1->f_3);
...
break;
case 7:
if(!uParam1->f_9) func_20(uParam1, uParam1->f_5);
if(func_16(&uParam0->[uParam1->f_12 /*24*/]) || !func_43(uParam1->f_16)){
func_39(uParam1, 0);
return false;
}
break;
case 8:
if(!uParam1->f_9) func_20(uParam1, uParam1->f_4);
...
break;
case 9:
if(!uParam1->f_9)if(func_10()) func_20(uParam1, uParam1->f_7);
else func_20(uParam1, uParam1->f_8);
...
if(!uParam1->f_9) func_11(uParam1, *uParam1, uParam0->[uParam1->f_12 /*24*/].f_9);
...
if(PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT) && uParam1->f_9==1)if(!func_8(&uParam0->[uParam1->f_12 /*24*/])) func_39(uParam1, 9);
else func_39(uParam1, 5);
break;
case 5:
func_22(uParam1);
...
if(bParam0)if(func_6()) return true;
if(func_64(14)) return true;
return false;
}
BOOL func_6() // Position - 0xC51{
if(Global_112593) return true;
if(!func_64(14) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("director_mode")) > 0) return true;
return false;
}
...
if(func_9(uParam0->f_12, entityRotation) > SYSTEM::COS(uParam0->f_15)) return 1;
return 0;
}
...
if(MISC::ARE_STRINGS_EQUAL(*uParam0, uParam0->f_14) || MISC::ARE_STRINGS_EQUAL(uParam0->f_2, uParam0->f_14)) return func_15(uParam0->f_14, uParam0->f_15);
...
if(uParam0->f_11==0) return !func_19(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10 + 2f, true);
unk={
func_17(uParam0->f_16, 2f) 
};
...
unk=2;
unk9={
func_18(uParam0[1 /*3*/] - uParam0[0 /*3*/]) *{
...
Vector3 func__18(float fParam0, var uParam1, var uParam2) // Position - 0xF7F{
float num;
float num2;
...
if(func_13(uParam0)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
uParam0->f_14=0;
uParam0->f_15=0;
...
if(func_27(vehiclePedIsIn)) return true;
if(func_24(vehiclePedIsIn, 3)) return true;
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) return func_36(PLAYER::PLAYER_ID());
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_32(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_32(character)) return func_35(character);
...
elseif(func_38(plParam0)) return Global_1853910[plParam0 /*862*/].f_205.f_3;
else return 0;
return 0;
}
...
if(iParam0==0)if(func_63()) return false;
...
if(uParam0->f_11==1) func_51(&(uParam0->f_16), 255, 100, 0, 100);
else func_50(uParam0->f_1, uParam0->f_10, 0, 0, 255, 255, 32);
return;
}
...
unk={
func_18(uParam3 - uParam0) 
};
unk4={
func_53(unk, 0f, 0f, 1f) 
};
num=fParam6 / 2f;
unk13=8;
unk7={
...
Vector3 func__53(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x19B7{
...
if(func_58()) num=Global_113648.f_7263.f_227[iParam0];
...
if(func_60()==-1 || func_60()==999 && !func_59()==0) return true;
return false;
}
...
uParam0->f_1={
func_69(uParam0->f_16) 
};
return;
}


Vector3 func__69(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5F64{
return func_70(uParam0[0 /*3*/], uParam0[1 /*3*/], 0.5f, true);
}


Vector3 func__70(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x5F84{
if(bParam7) fParam6=func_71(fParam6, 0f, 1f);
return uParam0 + ({
...
Vector3 func__74(int iParam0) // Position - 0x606D{
int num;
num=iParam0;
