...
fLocal_47=-1f;
Local_56={
-1511.194f, 436.5252f, 109.7818f 
};
Local_59={
968.0051f, -127.6078f, 73.3543f 
};
Local_65={
...
}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_140, sLocal_386, "IG_1_ALT1_GIRL_IN_VAN_LOOP", 3)){
PED::SET_PED_SUFFERS_CRITICAL_HITS(iLocal_140, 1);
TASK::TASK_SMART_FLEE_COORD(iLocal_140, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 150f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_140, 1);
}}
func_255();
}
...
func_255();
}}elseif(!PED::IS_PED_INJURED(iLocal_140)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_142, uLocal_159);
...
if(HUD::DOES_BLIP_EXIST(uLocal_123)){
if(HUD::GET_BLIP_COLOUR(uLocal_123) !=1){
HUD::SET_BLIP_AS_FRIENDLY(uLocal_123, 0);
HUD::SET_BLIP_COLOUR(uLocal_123, 1);
}}
func_154();
func_115(&uLocal_341, 0, 0);
iLocal_50=2;
}
elseif(iLocal_366 || iLocal_81){
if(HUD::DOES_BLIP_EXIST(uLocal_123)){
if(HUD::GET_BLIP_COLOUR(uLocal_123) !=1){
HUD::SET_BLIP_AS_FRIENDLY(uLocal_123, 0);
HUD::SET_BLIP_COLOUR(uLocal_123, 1);
...
elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_155, 0)){
...
Local_392.f_3={
-22.8598f, 0f, (ENTITY::GET_ENTITY_HEADING(iLocal_155) - 60f) 
};
}
Local_392.f_6={
-1.4334f, -4.6656f, 1.3733f 
};
Local_392.f_9={
-22.8598f, 0f, -106.3162f 
};
Local_392.f_12=55f;
Local_392.f_13=3000;
Local_392.f_18=0;
...
TASK::TASK_LOOK_AT_ENTITY(iLocal_140, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_140, uLocal_108, sLocal_386, "IG_1_ALT1_EXIT_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_108, 0);
PED::SET_PED_KEEP_TASK(iLocal_140, 1);
...
Local_110={
ENTITY::GET_ENTITY_COORDS(iLocal_155, 0) 
};
Local_113.f_2=ENTITY::GET_ENTITY_HEADING(iLocal_155);
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_155, 0f, -4.7f, 0f) 
};
...
Local_171={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_386, "IG_1_ALT1_EXIT_VAN", Local_110, Local_113, 1f, 2) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Local_171, &(Local_171.f_2), 0, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_140, Local_171, 1, 0, 0, 1);
Local_171={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_386, "IG_1_ALT1_EXIT_VAN", Local_110, Local_113, 1f, 2) 
};
ENTITY::SET_ENTITY_HEADING(iLocal_140, Local_171.f_2);
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_108)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_108, 1f);
}
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_140, 0, 0);
...
elseif(HUD::DOES_BLIP_EXIST(uLocal_120)){
...
elseif((MISC::GET_GAME_TIMER() - iLocal_119) > 2000 && !func_90()){
if(!iLocal_99){
...
if(HUD::DOES_BLIP_EXIST(uLocal_125[iVar5])){
HUD::REMOVE_BLIP(&(uLocal_125[iVar5]));
}
iVar6=1;
}
if(!HUD::DOES_BLIP_EXIST(uLocal_125[iVar5]) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_144[iVar5], 0)){
uLocal_125[iVar5]=func_54(iLocal_144[iVar5], 1, 145);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_125[iVar5])){
HUD::REMOVE_BLIP(&(uLocal_125[iVar5]));
}
...
if(HUD::DOES_BLIP_EXIST(uLocal_128[iVar5])){
HUD::REMOVE_BLIP(&(uLocal_128[iVar5]));
}
iVar6=1;
}
if(!HUD::DOES_BLIP_EXIST(uLocal_128[iVar5]) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_147[iVar5], 0)){
uLocal_128[iVar5]=func_54(iLocal_147[iVar5], 1, 145);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_128[iVar5])){
HUD::REMOVE_BLIP(&(uLocal_128[iVar5]));
}
...
if(HUD::DOES_BLIP_EXIST(uLocal_120)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_120, iLocal_83);
}
if(HUD::DOES_BLIP_EXIST(uLocal_121)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_121, iLocal_83);
}
if(HUD::DOES_BLIP_EXIST(uLocal_122)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_122, iLocal_83);
}
if(HUD::DOES_BLIP_EXIST(uLocal_123)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_123, iLocal_83);
}
if(HUD::DOES_BLIP_EXIST(uLocal_124)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_124, iLocal_83);
}}else{
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_155, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_140, uVar0);
...
Var0={
HUD::GET_BLIP_COORDS(uLocal_131[iParam0]) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_156[iParam0], 0) 
};
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_131[iParam0])){
HUD::REMOVE_BLIP(&(uLocal_131[iParam0]));
}}


var func__8(struct<3> Param0, int iParam3){
var uVar0;
uVar0=HUD::ADD_BLIP_FOR_COORD(Param0);
HUD::SET_BLIP_SCALE(uVar0, func_9(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
}elseif(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(iLocal_144[iVar0], 0)) < fVar1){
fVar1=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(iLocal_144[iVar0], 0));
}}
iVar0++;
}
...
}elseif(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(iLocal_147[iVar0], 0)) < fVar1){
fVar1=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(iLocal_147[iVar0], 0));
}}
iVar0++;
}
...
if(!iLocal_367){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_140, 0) + Var0 
};
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_140, 0) + Var3 
};
if(func_164(&uLocal_176, cLocal_387, "RESNA_MOR", 4, func_205(), 0, 0)){
...
iLocal_415=OBJECT::CREATE_OBJECT(joaat("prop_ld_test_01"), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) + Vector(2f, 0f, 0f), 1, 1, 0);
...
Var2={
ENTITY::GET_ENTITY_COORDS(iLocal_156[iVar1], 0) 
};
Var5={
...
Local_416[iVar1 /*7*/].f_3={
ENTITY::GET_ENTITY_ROTATION(iVar0, 2) 
};
...
}elseif(((MISC::GET_GAME_TIMER() - iLocal_434[iVar1]) > 1000 && (MISC::GET_GAME_TIMER() - iLocal_431[0]) > 2000) && (MISC::GET_GAME_TIMER() - iLocal_431[1]) > 2000){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_416[iVar1 /*7*/], 3f, 0, 0, 0, 0, 0, 0, 0);
...
iLocal_156[iVar11]=VEHICLE::CREATE_VEHICLE(iLocal_370, Var2, Var8.f_2, 1, 1, 0);
...
struct<3> Var3;
Var0={
Param0 - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) 
};
Var3={
...
var func__54(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
HUD::SET_BLIP_SCALE(uVar0, func_9(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
...
var func__57(struct<3> Param0, int iParam3){
...
HUD::SET_BLIP_SPRITE(uLocal_139, 269);
func_59();
}}}
...
if(!iLocal_90[0]){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(iLocal_140, 0)) < 400f && (MISC::GET_GAME_TIMER() - iLocal_104) > 30000){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_140, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
...
iLocal_388++;
}}elseif(func_164(&uLocal_176, cLocal_387, "RESNA_ADD2", 4, 0, 0, 0)){
iLocal_388++;
}
}
break;
...
}}elseif(PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_140)){
...
iLocal_388++;
}}elseif(func_66("RESNA_B3DF", func_11())){
iLocal_388++;
}
}
break;
...
}}elseif((MISC::GET_GAME_TIMER() - iLocal_384) > 500){
iLocal_384=-1;
iLocal_376=0;
iLocal_377=0;
return 1;
}}}elseif(iLocal_376 && !iLocal_377){
Local_378={
func_64() 
};
func_45();
...
var uVar7;
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_155, 0f, -6f, 0f) 
};
...
Var11[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar1, (-Var8.f_0 / 2f), (Var8.f_1 / 2f), 0f) 
};
Var11[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar1, (Var8.f_0 / 2f), (Var8.f_1 / 2f), 0f) 
};
...
Var24[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_155, -1f, -2.5f, 0f) 
};
Var24[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_155, 1f, -2.5f, 0f) 
};
Var24[2 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_155, 0.75f, -5f, 0f) 
};
Var24[3 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_155, -0.75f, -5f, 0f) 
};
...
Var0={
func_99(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam1, uParam0->f_3), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam1, *uParam0)) 
};
Var3={
func_97(Var0) 
};
...
Vector3 func__97(struct<3> Param0){
struct<3> Var0;
...
Vector3 func__99(struct<3> Param0, struct<3> Param3){
struct<3> Var0;
struct<3> Var3;
float fVar6;
Var0={
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_104(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
struct<3> Var1[4];
Var1[0 /*3*/]={
986.8661f, -113.7463f, 72.9153f 
};
Var1[1 /*3*/]={
964.0147f, -144.0337f, 73.4875f 
};
Var1[2 /*3*/]={
954.2817f, -137.429f, 73.4781f 
};
Var1[3 /*3*/]={
976.5977f, -149.0529f, 73.2404f 
};
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_59, 10f, 10f, 10f, 0, 1, 0)){
iVar0=0;
while (iVar0 < 4){
uLocal_150[iVar0]=PED::CREATE_PED(22, iLocal_371, Var1[iVar0 /*3*/], 0f, 1, 1);
...
TASK::TASK_COMBAT_PED(uLocal_150[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
...
if(HUD::DOES_BLIP_EXIST(uLocal_134[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_134[iVar0]));
}
iVar1++;
}
iVar0++;
...
if(PED::IS_PED_INJURED(iLocal_142)){
return 1;
}elseif(PED::IS_PED_ON_FOOT(iLocal_142)){
return 1;
}
if(PED::IS_PED_INJURED(iLocal_141)){
return 1;
...
}elseif(!PED::IS_PED_INJURED(iLocal_142)){
...
if(!WEAPON::HAS_PED_GOT_WEAPON(iLocal_142, joaat("weapon_microsmg"), 0) || (WEAPON::HAS_PED_GOT_WEAPON(iLocal_142, joaat("weapon_microsmg"), 0) && WEAPON::GET_PED_AMMO_BY_TYPE(iLocal_142, joaat("AMMO_SHOTGUN"))==0)){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_142, joaat("weapon_microsmg"), 68, 1, 1);
}else{
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_142, joaat("weapon_microsmg"), 1);
}
TASK::TASK_DRIVE_BY(iLocal_142, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 100, 1, -753768974);
}}}
if((MISC::GET_GAME_TIMER() - iLocal_438) > 250){
if(!PED::IS_PED_INJURED(iLocal_141)){
if((PED::IS_PED_IN_ANY_VEHICLE(iLocal_141, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_141, joaat("script_task_drive_by")) !=1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_141, joaat("script_task_drive_by")) !=0){
...
if(!PED::IS_PED_INJURED(iLocal_143)){
if((PED::IS_PED_IN_ANY_VEHICLE(iLocal_143, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_143, joaat("script_task_drive_by")) !=1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_143, joaat("script_task_drive_by")) !=0){
TASK::CLEAR_PED_TASKS(iLocal_143);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_143, joaat("weapon_pistol"), 68, 1, 1);
...
if(((VEHICLE::IS_TURRET_SEAT(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0)==joaat("apc") && iVar1 !=-1)) || (ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("akula") && iVar1 !=-1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("riot2") && iVar1==0) && func_135(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) !=-1)){
return 0;
}}}
if(Global_1962010){
return 0;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_134(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=1;
uParam0->f_7=1;
}}elseif(func_149(bParam1, bParam2, bParam3)){
uParam0->f_4=MISC::GET_GAME_TIMER();
uParam0->f_5=1;
uParam0->f_7=1;
...
uParam0->f_5=0;
}elseif(!func_150(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_147(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_148(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
if(!PED::IS_PED_INJURED(iLocal_141)){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_141, joaat("weapon_smg"), 68, 1, 1);
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_141, joaat("weapon_smg"), 1);
...
if(!PED::IS_PED_INJURED(iLocal_143)){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_143, joaat("weapon_pistol"), 68, 1, 1);
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_143, joaat("weapon_pistol"), 1);
...
if(PED::IS_PED_INJURED(iLocal_141)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_141, PLAYER::PLAYER_PED_ID(), 1)){
bVar0=true;
}
if(PED::IS_PED_INJURED(iLocal_142)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_142, PLAYER::PLAYER_PED_ID(), 1)){
bVar0=true;
}
if(PED::IS_PED_INJURED(iLocal_143)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_143, PLAYER::PLAYER_PED_ID(), 1)){
bVar0=true;
}
if(PED::IS_PED_INJURED(iLocal_140)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_140, PLAYER::PLAYER_PED_ID(), 1)){
bVar0=true;
}
if(bVar0){
func_162();
...
func_161();
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_107) > 0.4f){
func_160();
}}elseif(!PED::IS_PED_INJURED(iLocal_140)){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_140, iLocal_155, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_155, sLocal_175), 0.421191f, -1.99042f, 0.20134f, -5.08056E-06f, -6.5249E-06f, 174.612f, 1, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_140, ENTITY::GET_ENTITY_COORDS(iLocal_155, 0), 1, 0, 0, 1);
...
var func__175(int iParam0, bool bParam1, int iParam2){
iParam2=iParam2;
...
func_192();
func_191();
EVENT::ADD_SHOCKING_EVENT_AT_POSITION(111, Local_52, -1082130432);
...
Local_165={
-3057.362f, 441.8271f, 6.151212f 
};
Local_168={
-0.34992f, -0.199749f, -98.79861f 
};
fLocal_359=116f;
Local_56={
-3053.721f, 440.9221f, 5.3566f 
};
uLocal_164=OBJECT::CREATE_OBJECT(joaat("prop_ld_test_01"), ENTITY::GET_ENTITY_COORDS(iLocal_155, 0), 1, 1, 0);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_143, joaat("weapon_pistol"), 68, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_142, joaat("weapon_sawnoffshotgun"), 68, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_141, joaat("weapon_microsmg"), 68, 0, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_142, joaat("weapon_sawnoffshotgun"), 68, 1, 1);
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_142, joaat("weapon_sawnoffshotgun"), 1);
...
uVar0=Global_2805027[iParam0 /*3*/][func_198(iParam1)];
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_140, uLocal_117, sLocal_386, "IG_1_GIRL_ON_PHONE_LOOP", 1000f, -1000f, 4, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_141, uLocal_117, sLocal_386, "IG_1_GUY1_IN_VAN_LOOP", 1000f, -1000f, 4, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_143, uLocal_117, sLocal_386, "IG_1_GUY2_IN_VAN_LOOP", 1000f, -1000f, 4, 0, 1148846080, 0);
PED::SET_PED_CAN_RAGDOLL(iLocal_140, 1);
}
else{
func_156();
...
Local_113={
ENTITY::GET_ENTITY_ROTATION(iLocal_155, 2) 
};
uLocal_118=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iLocal_155, 0), Local_113.f_0, Local_113.f_1, ENTITY::GET_ENTITY_HEADING(iLocal_155), 2);
if(iLocal_82){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_155, 0);
iLocal_82=0;
}
PED::SET_SYNCHRONIZED_SCENE_RATE(uLocal_118, fVar0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_140, uLocal_118, sLocal_386, "IG_1_GIRL_DRAG_INTO_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_141, uLocal_118, sLocal_386, "IG_1_GUY1_DRAG_INTO_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_143, uLocal_118, sLocal_386, "IG_1_GUY2_DRAG_INTO_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
...
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_140, 31086, 0f, 0f, 0f) 
};
Var3={
Var3 + PED::GET_PED_BONE_COORDS(iLocal_140, 31086, 0f, 0f, 0f) 
};
...
MISC::CLEAR_AREA(Local_171, 15f, 1, 0, 0, 0);
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_247()) || Global_112695) || Global_32166) || func_246()) || func_80(8, -1)) || func_245()) || func_244()) || func_243()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_247()) || Global_32166) || func_246()) || func_80(8, -1)) || func_243()) || func_245()) || func_244()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_247()) || Global_112695) || Global_32166) || func_246()) || func_80(8, -1)) || func_245()) || func_244()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_247()) || Global_32166) || func_246()) || func_80(8, -1)) || func_244()) || func_243()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_247()) || func_244()) || Global_112695) || Global_32166) || func_246()) || Global_44446) || func_80(8, -1)) || func_243()) || func_241()) || func_242()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_247()) || Global_112695) || Global_32166) || func_246()) || func_80(8, -1)) || func_243()) || func_241()) || func_245()) || func_244()) || func_242()){
return 0;
}
break;
}}else{
