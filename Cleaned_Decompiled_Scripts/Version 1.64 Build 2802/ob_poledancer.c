...
Local_2={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uScriptParam_0, 0f, 0f, 0f) 
};
...
void func_3(){
if(!PED::IS_PED_INJURED(uLocal_1)){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_1, joaat("script_task_play_anim"))==7){
TASK::TASK_PLAY_ANIM(uLocal_1, sLocal_8, sLocal_6, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
}elseif(ENTITY::HAS_ENTITY_ANIM_FINISHED(uLocal_1, sLocal_8, sLocal_6, 3)){
TASK::TASK_PLAY_ANIM(uLocal_1, sLocal_8, sLocal_6, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
}elseif(!iLocal_9){
...
void func_4(){
if(ENTITY::IS_ENTITY_DEAD(uLocal_1, 0)){
uLocal_1=PED::CREATE_PED(5, iLocal_7, Local_2.f_0, Local_2.f_1, Local_2.f_2, uLocal_5, 1, 1);
