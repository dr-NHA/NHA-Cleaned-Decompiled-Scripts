...
Vector3 func__28(int iParam0, bool bParam1){
switch (iParam0){
case 0:
if(bParam1==1){
...
uLocal_86[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), func_32(iParam0, 0), Param1, iVar0, -1, 2, 1, 0);
...
Vector3 func__32(int iParam0, bool bParam1){
switch (iParam0){
case 0:
...
uLocal_66[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_petrolcan"), func_35(iParam0), Param1, iVar0, -1, 2, 1, 0);
OBJECT::SET_PICKUP_REGENERATION_TIME(uLocal_66[iParam0], 600000);
}


Vector3 func__35(int iParam0){
switch (iParam0){
case 0:
...
Vector3 func__39(int iParam0, bool bParam1){
switch (iParam0){
case 0:
