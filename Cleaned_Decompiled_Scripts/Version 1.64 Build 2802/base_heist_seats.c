...
void func_11(){
func_19(&Local_47);
if(Global_1853753==PLAYER::PLAYER_ID() && !MISC::IS_BIT_SET(Global_1890444[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*129*/].f_38.f_27, 5)){
if(func_18(&Local_47, 1, 1)){
func_17(&Local_47);
}
if(func_18(&Local_47, 0, 0)){
MISC::SET_BIT(&Global_1836154, 1);
if((((((iLocal_484==0 && !MISC::IS_BIT_SET(Global_1890444[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*129*/].f_38.f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225)){
func_12(&Local_47);
}}else{
MISC::CLEAR_BIT(&Global_1836154, 1);
}}else{
...
if(Var20.f_0 !=3){
Var34={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_45(iParam0), func_44(iParam0), 0, 2) 
};
Var37={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_45(iParam0), func_44(iParam0), 0, 2) 
};
uVar40=Var37.f_2;
TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Var34, 1f, 500, uVar40, 0.15f);
}
func_58(iParam0, 5);
break;
case 5:
...
iParam0->f_421.f_1=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_45(iParam0), func_44(iParam0), 2, 1, 0, 1065353216, 0, 1065353216);
...
func_33(iParam0);
func_26(iParam0);
uVar42=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iParam0->f_421.f_1);
...
break;
case 8:
uVar43=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iParam0->f_421.f_1);
...
}elseif(uParam0->f_421.f_8.f_2==5){
iVar1=uParam0->f_421.f_8.f_1;
iVar2=3;
...
uParam0->f_421.f_1=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_45(uParam0), func_44(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
...
Vector3 func__44(var uParam0){
struct<3> Var0;
Var0={
(uParam0[uParam0->f_421.f_2 /*14*/])->f_8.f_3 
};
...
if(uParam0->f_421.f_4==6){}elseif(uParam0->f_421.f_4 > 4){
...
}elseif(uParam0->f_421.f_4 > 1){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_61(uParam0));
uParam0->f_421.f_7=MISC::GET_FRAME_COUNT();
}elseif((MISC::GET_FRAME_COUNT() - uParam0->f_421.f_7) < 5){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_61(uParam0));
}}
...
int func_75(){
if(Global_1853753 !=func_65()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_heist_seats", Global_1853753, 1, 0)){
return 0;
}
...
if(func_81(PLAYER::PLAYER_ID()) || MISC::IS_BIT_SET(iLocal_484, 0)){
return 0;
}
Var0={
uParam0->f_1 
...
if(MISC::IS_BIT_SET(Global_1890444[iParam0 /*129*/].f_38.f_27, 3)){
return 1;
}}}
return 0;
}
...
Local_47[iParam0 /*14*/].f_1={
Param1 + func_83(Param5, (fParam4 - 180f)) 
};
Local_47[iParam0 /*14*/].f_1.f_3={
Param1 + func_83(Param8, (fParam4 - 180f)) 
};
Local_47[iParam0 /*14*/].f_1.f_6=1f;
Local_47[iParam0 /*14*/].f_8={
Param1 
};
Local_47[iParam0 /*14*/].f_8.f_3={
0f, 0f, fParam4 
};
}
