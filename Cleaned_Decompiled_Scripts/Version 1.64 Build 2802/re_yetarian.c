...
uLocal_126={
-35.607f, -1110.0458f, 26.4364f 
};
uLocal_129={
-126.1154f, -1129.3466f, 23.4329f 
};
iLocal_143=-1;
iLocal_144=-1;
iLocal_145=-1;
...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(27)) func_172();
if(func_145(uScriptParam_0.f_1[0 /*3*/], 30, 0, false, false)) func_143(30);
else SCRIPT::TERMINATE_THIS_THREAD();
func_130();
while (true){
if(!func_129())if(func_128()) func_100();
if(TASK::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))if(TASK::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP")) TASK::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", false);
num=CAM::REPLAY_GET_MAX_DISTANCE_ALLOWED_FROM_PLAYER() + 20f;
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), uLocal_99) < num * num) RECORDING::REPLAY_DISABLE_CAMERA_MOVEMENT_THIS_FRAME();
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), uLocal_103) < num * num) RECORDING::REPLAY_DISABLE_CAMERA_MOVEMENT_THIS_FRAME();
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_90))if(func_1(pedLocal_90, PLAYER::PLAYER_PED_ID(), true) > 120f) func_100();
}else{
func_100();
}
SYSTEM::WAIT(0);
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_94)) OBJECT::DELETE_OBJECT(&obLocal_94);
if(!bLocal_110){
if(!bLocal_111){
...
TASK::OPEN_SEQUENCE_TASK(&iLocal_147);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
if(func_1(pedLocal_90, PLAYER::PLAYER_PED_ID(), true) <=4f) TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1500);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(pedLocal_90, false), true) >=100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(pedLocal_90, false), 3f)) PED::DELETE_PED(&pedLocal_90);
if(uLocal_47[0 /*20*/].f_18 >=5 && uLocal_47[1 /*20*/].f_18 >=5) func_4();
}}else{
func_36();
PED::SET_PED_MAX_MOVE_BLEND_RATIO(pedLocal_90, 2f);
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(pedLocal_90, false), true) >=100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(pedLocal_90, false), 3f)) PED::DELETE_PED(&pedLocal_90);
if(uLocal_47[0 /*20*/].f_18 >=5 && uLocal_47[1 /*20*/].f_18 >=5)if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -69.623955f, -1087.3695f, 24.598333f, -11.278607f, -1108.2798f, 34.17205f, 47.5f, false, true, 0)) func_4();
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_90)) PED::SET_PED_RESET_FLAG(pedLocal_90, 60, true);
}}else{
if(HUD::DOES_BLIP_EXIST(blLocal_93)) HUD::REMOVE_BLIP(&blLocal_93);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_90))if(ENTITY::IS_ENTITY_DEAD(pedLocal_90, false))if(!bLocal_121) bLocal_121=true;
bLocal_113=true;
if(uLocal_47[0 /*20*/].f_18 >=5 && uLocal_47[1 /*20*/].f_18 >=5)if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -69.623955f, -1087.3695f, 24.598333f, -11.278607f, -1108.2798f, 34.17205f, 47.5f, false, true, 0)) func_4();
}
break;
...
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) unk_0x34954CC75CC067A4("SCRIPTED_SCANNER_REPORT_SIMEON_01", 0f);
func_8(-1, 0);
func_5();
func_100();
return;
...
if(func_17(iParam0)) Global_113648.f_24997.f_2=3;
if(func_16(iParam0, iParam1) !=322) func_10(func_16(iParam0, iParam1), uLocal_43, uLocal_43.f_1);
Global_113636=iParam1;
if(Global_113634==0)if(Global_113637==1 || Global_113637==5 || Global_113637==11 || Global_113637==25) func_9(2);
elseif(Global_113637==26 || Global_113637==8 || Global_113637==17) func_9(7);
else func_9(1);
}
return;
}
...
}elseif(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1 /*20*/].f_1)){
_CONVERSATION_INITIALIZE_ACTOR(&uLocal_152, 5, uLocal_47[1 /*20*/].f_1, "YETARIAN_GOON", 0, 1);
}else{
iLocal_114=1;
iLocal_115=1;
}
if(iLocal_114==0)if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL)if(_CONVERSATION_ADD_LINE(&uLocal_152, sLocal_151, "RE_YETA_MIKE", 7, 0, 0, 0)) iLocal_114=1;
elseif(_CONVERSATION_ADD_LINE(&uLocal_152, sLocal_151, "RE_YETA_FRAN", 7, 0, 0, 0)) iLocal_114=1;
}}elseif(iLocal_115==0){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0 /*20*/].f_1)){
...
if(func_43(PLAYER::PLAYER_ID())) return false;
...
return true;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(pedLocal_90, false), true) <=4.5f || TASK::GET_SCRIPT_TASK_STATUS(pedLocal_90, SCRIPT_TASK_PERFORM_SEQUENCE)==7){
if(!bLocal_112){
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_90))if(ENTITY::IS_ENTITY_PLAYING_ANIM(pedLocal_90, "cellphone@", "cellphone_call_out", 3))if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(pedLocal_90, "cellphone@", "cellphone_call_out") >=0.24f)if(ENTITY::DOES_ENTITY_EXIST(obLocal_94)) OBJECT::DELETE_OBJECT(&obLocal_94);
return;
}
...
if(INTERIOR::IS_INTERIOR_READY(interiorAtCoords)) return true;
}
return false;
}
...
}elseif(OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(-1831288286) < 1f){
...
if(iLocal_97==-1) iLocal_97=MISC::GET_GAME_TIMER();
if(iLocal_98==-1) iLocal_98=4000;
}
else{
if(iLocal_97==-1) iLocal_97=MISC::GET_GAME_TIMER();
if(iLocal_98==-1) iLocal_98=1000;
}
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_152, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
else _CONVERSATION_INITIALIZE_ACTOR(&uLocal_152, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
_CONVERSATION_INITIALIZE_ACTOR(&uLocal_152, 4, pedLocal_90, "SIMEON", 0, 1);
if(bLocal_111) _CONVERSATION_ADD_LINE(&uLocal_152, sLocal_151, "RE_YETA_SNIP", 7, 0, 0, 0);
elseif(bLocal_109) _CONVERSATION_ADD_LINE(&uLocal_152, sLocal_151, "RE_YETA_EXT", 7, 1, 0, 0);
elseif(func_63())if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) _CONVERSATION_ADD_LINE(&uLocal_152, sLocal_151, "RE_YETAM", 7, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_ADD_LINE(&uLocal_152, sLocal_151, "RE_YETAF", 7, 0, 0, 0);
else _CONVERSATION_ADD_LINE(&uLocal_152, sLocal_151, "RE_YETA_SNIP", 7, 0, 0, 0);
return;
}
BOOL func_63() // Position - 0x297D{
if(func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_UNARMED") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("OBJECT") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_KNIFE") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_NIGHTSTICK") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_HAMMER") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_BAT") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_CROWBAR") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_GOLFCLUB") && func_64(PLAYER::PLAYER_PED_ID()) !=joaat("WEAPON_BOTTLE"))if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) return false;
...
return true;
}}elseif(PED::IS_COP_PED_IN_AREA_3D(uLocal_126, uLocal_129) || MISC::IS_POSITION_OCCUPIED(-61.013214f, -1093.393f, 25.752972f, 2f, false, true, false, false, false, 0, false) && MISC::IS_POSITION_OCCUPIED(-38.596832f, -1109.284f, 25.687418f, 2f, false, true, false, false, false, 0, false)){
if(INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==MISC::GET_HASH_KEY("rm_showroom")){
...
if(func_17(Global_113637)) func_68(0);
HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
if(bParam0 && func_17(Global_113637)) HUD::FLASH_MINIMAP_DISPLAY();
return 1;
}
return 0;
}
...
if(iParam4 !=0) func_73(uParam0, iParam4);
}
return 2;
}
...
func_66(&pedLocal_91);
func_78(&obLocal_95);
}}elseif(_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_91)){
...
switch (iLocal_89){
case 0:
if(func_96()) iLocal_89=1;
elseif(func_84()) func_100();
...
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_95()) return false;
}
if(func_91()) return true;
if(func_85(100f, true) !=-1) return true;
return false;
}
...
if(func_94() && !func_95()) return true;
if(func_93() && func_92()) return true;
return false;
}
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) WEAPON::GIVE_WEAPON_TO_PED(uLocal_47[iParam0 /*20*/].f_1, uLocal_47[iParam0 /*20*/].f_17, -1, true, true);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(uLocal_47[iParam0 /*20*/].f_1, false), true) >=250f) uLocal_47[iParam0 /*20*/].f_18=5;
}else{
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_47[iParam0 /*20*/].f_1, SCRIPT_TASK_COMBAT)==7) TASK::TASK_COMBAT_PED(uLocal_47[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(uLocal_47[iParam0 /*20*/].f_1, false), true) >=75f) uLocal_47[iParam0 /*20*/].f_18=5;
}
break;
case 5:
func_98(&(uLocal_47[iParam0 /*20*/].f_2));
if(ENTITY::DOES_ENTITY_EXIST(uLocal_47[iParam0 /*20*/].f_1)) ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_47[iParam0 /*20*/].f_1));
...
if(iLocal_143 !=-1) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_143);
if(iLocal_144 !=-1) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_144);
if(iLocal_145 !=-1) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_145);
if(iLocal_146 !=-1) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_146);
if(TASK::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))if(!TASK::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP")) TASK::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", true);
...
var func__109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5FEB{
...
if(iParam1 < 1 || iParam1 > func_124(num, num2)) return;
...
if(func_91()) return true;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_95()) return false;
if(func_85(100f, true) !=-1) return true;
return false;
}
BOOL func_129() // Position - 0x6711{
if(Global_113637==func_32() && MISC::GET_RANDOM_EVENT_FLAG() && Global_113638) return true;
return false;
}
...
if(iLocal_146==-1) iLocal_146=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-29.3f, -1086.35f, 25.57f, 5.5f, 3f, 2f, -10f, false, 7);
func_131(196, 0);
func_131(197, 0);
func_131(194, 0);
func_131(195, 0);
...
func_133(iParam0);
if(IS_BIT_SET(Global_38617[iParam0 / 32], iParam0 % 32)) func_132(iParam0);
}}
return;
}
...
if(IS_BIT_SET(vector.f_4, 2)) func_138(iParam0, &vector);
...
if(Global_113648.f_9087) num=func_135(iParam0);
else num=0;
if(func_24(14)) num=0;
...
if(func_25(character))if(IS_BIT_SET(Global_95708[0], character))if(iParam0 !=40) return 0;
else return 1;
break;
case 47:
case 48:
...
if(func_25(character))if(IS_BIT_SET(Global_95708[6], character)) return 0;
break;
case 51:
case 52:
if(character==CHAR_TREVOR){
if(IS_BIT_SET(Global_113648.f_7231[2], 0)) return 0;
if(func_25(character))if(IS_BIT_SET(Global_95708[2], character)) return 0;
}elseif(character==CHAR_MICHAEL){
if(IS_BIT_SET(Global_113648.f_7231[1], 0)) return 0;
if(func_25(character))if(IS_BIT_SET(Global_95708[1], character)) return 0;
}
break;
case 53:
if(character==CHAR_TREVOR)if(IS_BIT_SET(Global_113648.f_7231[3], 0)) return 0;
if(func_25(character))if(IS_BIT_SET(Global_95708[3], character)) return 0;
break;
default:
return 0;
}
...
if(func_12()==-1 || func_12()==999 && !func_142()==0) return true;
return false;
}
...
if(func_170()) return false;
if(Global_113637 !=-1) return false;
if(func_25(_GET_CURRENT_PLAYER_CHARACTER()))if(func_85(100f, true) !=-1) return false;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !bParam6)if(entityCoords.f_2 - uLocal_43.f_2 > 50f) return false;
if(!func_169(iParam3)) return false;
if(func_25(_GET_CURRENT_PLAYER_CHARACTER()))if(func_168(_GET_CURRENT_PLAYER_CHARACTER())==4 || func_168(_GET_CURRENT_PLAYER_CHARACTER())==5) return false;
if(func_25(_GET_CURRENT_PLAYER_CHARACTER()))if(!func_167(iParam3, iParam4, 145)) return false;
if(!func_166(Global_113648.f_24997.f_43[iParam3])) return false;
if(MISC::GET_GAME_TIMER() - Global_113639 < 150000)if(iParam3 !=30) return false;
if(func_165()) return false;
if(MISC::GET_MISSION_FLAG()) return false;
if(MISC::GET_RANDOM_EVENT_FLAG()) return false;
if(!func_156(4)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(5)) return false;
if(func_155(iParam3, iParam4) && !bParam5) return false;
...
if(iParam3==9 && iParam4==2 || iParam4==5 && !func_155(0, 0)) return false;
if(Global_32310) return false;
if(func_169(30) && !func_155(30, 0))if(iParam3 !=30)if(SYSTEM::VDIST2(entityCoords, -61.2745f, -1100.4675f, 25.3752f) < 176400f) return false;
if(func_25(_GET_CURRENT_PLAYER_CHARACTER())){
for (i=CHAR_MICHAEL;
i < CHAR_MULTIPLAYER;
i=i + 1){
...
if(func_154(num))if(func_147(i))if(!func_146(vector, 0f, 0f, 0f, false))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector) < 210f * 210f)if(_GET_CURRENT_PLAYER_CHARACTER() !=i) return false;
}}}
return true;
}
...
int num;
int num2;
if(!func_154(iParam1) || !func_154(iParam0)) return 1;
...
if(num6 < 1 || num6 > func_124(num5, num4)) return false;
return true;
}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
character=_GET_CURRENT_PLAYER_CHARACTER();
if(!func_25(character)) return false;
switch (iParam0){
case 9:
case 0:
...
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || Global_32166 || func_163() || func_52(8, -1) || func_160() || func_162() || func_161() || func_159() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_112695 || Global_32166 || func_163() || func_52(8, -1) || func_160() || func_162() || func_161() || func_159() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_112695 || Global_32166 || func_163() || func_52(8, -1) || func_162() || func_161() || func_159() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_164() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_52(8, -1) || func_159() || func_158() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_52(8, -1) || func_162() || func_161() || func_158() || func_157()) return false;
