...
Local_126={
-35.607f, -1110.046f, 26.4364f 
};
Local_129={
-126.1154f, -1129.347f, 23.4329f 
};
iLocal_143=-1;
iLocal_144=-1;
iLocal_145=-1;
...
fVar0=(CAM::REPLAY_GET_MAX_DISTANCE_ALLOWED_FROM_PLAYE() + 20f);
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_99) < (fVar0 * fVar0)){
RECORDING::REPLAY_DISABLE_CAMERA_MOVEMENT_THIS_FRAME();
}
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_103) < (fVar0 * fVar0)){
RECORDING::REPLAY_DISABLE_CAMERA_MOVEMENT_THIS_FRAME();
}
...
if(func_2(uLocal_90)){
if(func_1(uLocal_90, PLAYER::PLAYER_PED_ID(), 1) > 120f){
func_100();
}}}else{
func_100();
}
...
iLocal_113=1;
iLocal_108=1;
TASK::CLEAR_PED_TASKS(uLocal_90);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_94)){
OBJECT::DELETE_OBJECT(&uLocal_94);
}
if(!bLocal_110){
if(!bLocal_111){
TASK::OPEN_SEQUENCE_TASK(&uLocal_147);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_147);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_147);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_90, uLocal_147);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_147);
iLocal_112=1;
}
else{
if(!bLocal_111){
TASK::OPEN_SEQUENCE_TASK(&uLocal_147);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
if(func_1(uLocal_90, PLAYER::PLAYER_PED_ID(), 1) <=4f){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1500);
}
...
func_36();
PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_90, 2f);
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) >=100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 3f)){
...
if(func_2(uLocal_90)){
PED::SET_PED_RESET_FLAG(uLocal_90, 60, 1);
}}}else{
...
}elseif(func_2(Local_47[1 /*20*/].f_1)){
...
iLocal_114=1;
}}elseif(func_39(&uLocal_152, cLocal_151, "RE_YETA_FRAN", 7, 0, 0, 0)){
iLocal_114=1;
}}}}elseif(iLocal_115==0){
if(!func_57()){
if(func_2(Local_47[0 /*20*/].f_1)){
...
var func__44(int iParam0, int iParam1){
...
if(func_2(uLocal_90)){
if(!bLocal_110){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <=7f || TASK::GET_SCRIPT_TASK_STATUS(uLocal_90, joaat("script_task_perform_sequence"))==7){
if(!iLocal_112){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <=7f){
}
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_90, joaat("script_task_perform_sequence"))==7){
}}
return 1;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <=4.5f || TASK::GET_SCRIPT_TASK_STATUS(uLocal_90, joaat("script_task_perform_sequence"))==7){
if(!iLocal_112){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_90, 0), 1) <=4.5f){
}
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_90, joaat("script_task_perform_sequence"))==7){
}}
return 1;
...
void func_59(){
if(func_2(uLocal_90)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_90, "cellphone@", "cellphone_call_out", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_90, "cellphone@", "cellphone_call_out") >=0.24f){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_94)){
OBJECT::DELETE_OBJECT(&uLocal_94);
}}}}}
...
func_56(&uLocal_152, 4, uLocal_90, "SIMEON", 0, 1);
if(bLocal_111){
...
int func_65(){
if(!PED::IS_COP_PED_IN_AREA_3D(Local_126, Local_129) && !(MISC::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && MISC::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0))){
...
return 1;
}}elseif(PED::IS_COP_PED_IN_AREA_3D(Local_126, Local_129) || (MISC::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && MISC::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0))){
if(INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==MISC::GET_HASH_KEY("rm_showroom")){
...
if(bParam0){
if(func_2(uLocal_92)){
ENTITY::SET_ENTITY_VISIBLE(uLocal_92, 1, 0);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_92, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uLocal_92, 1);
uLocal_90=uLocal_92;
uLocal_94=uLocal_96;
func_66(&uLocal_91);
func_78(&uLocal_95);
}}elseif(func_2(uLocal_91)){
ENTITY::SET_ENTITY_VISIBLE(uLocal_91, 1, 0);
...
MISC::CLEAR_ANGLED_AREA_OF_VEHICLES(-53.57574f, -1095.356f, 24.17232f, -46.52551f, -1094.587f, 27.42232f, 3.75f, 0, 0, 0, 0, 0, 0, 0);
break;
case 1:
if(!func_2(uLocal_91) || !func_2(uLocal_92)){
func_81(&uLocal_91, 18, Local_99, fLocal_102, 1);
if(func_2(uLocal_91)){
ENTITY::SET_ENTITY_VISIBLE(uLocal_91, 0, 0);
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_91, iLocal_150);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_91, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_91, joaat("weapon_pistol"), 999, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_91, 0, iLocal_148);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_148, joaat("player"));
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_91, 1, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_91, 104, 1);
uLocal_95=OBJECT::CREATE_OBJECT(iLocal_122, ENTITY::GET_ENTITY_COORDS(uLocal_91, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_95, uLocal_91, PED::GET_PED_BONE_INDEX(uLocal_91, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_147);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_147, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_147);
TASK::TASK_PERFORM_SEQUENCE(uLocal_91, uLocal_147);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_147);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_91, 1);
}
func_81(&uLocal_92, 18, Local_103, fLocal_106, 1);
if(func_2(uLocal_92)){
ENTITY::SET_ENTITY_VISIBLE(uLocal_92, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uLocal_92, 0);
PED::SET_PED_CAN_BE_TARGETTED(uLocal_92, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_92, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_92, iLocal_150);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_92, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_92, joaat("weapon_pistol"), 999, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_92, 0, iLocal_148);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_148, joaat("player"));
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_92, 1, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_92, 104, 1);
uLocal_96=OBJECT::CREATE_OBJECT(iLocal_122, ENTITY::GET_ENTITY_COORDS(uLocal_92, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_96, uLocal_92, PED::GET_PED_BONE_INDEX(uLocal_92, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_147);
TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_147, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_147);
TASK::TASK_PERFORM_SEQUENCE(uLocal_92, uLocal_147);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_147);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_91, 1);
}}else{
func_80();
uLocal_123=VEHICLE::CREATE_VEHICLE(joaat("baller2"), -46.2722f, -1097.466f, 25.42f, 112.5363f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_123, 7);
VEHICLE::SET_VEHICLE_WINDOW_TINT(uLocal_123, 3);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_123, 2);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_123, 0);
uLocal_124=VEHICLE::CREATE_VEHICLE(joaat("tailgater"), -41.07354f, -1099.567f, 25.42f, 138.4292f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_124, 12);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_124, 2);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_124, 0);
uLocal_125=VEHICLE::CREATE_VEHICLE(joaat("bjxl"), -36.74456f, -1101.583f, 25.42f, 155.1573f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_125, 4);
VEHICLE::SET_VEHICLE_WINDOW_TINT(uLocal_125, 3);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_125, 2);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_125, 0);
iLocal_89=2;
}
break;
case 2:
...
int func_81(var uParam0, bool bParam1, struct<3> Param2, float fParam5, bool bParam6){
int iVar0;
if(!func_25(bParam1)){
...
Local_47[iParam0 /*20*/].f_1=PED::CREATE_PED(22, Local_47[iParam0 /*20*/], Local_47[iParam0 /*20*/].f_10, Local_47[iParam0 /*20*/].f_13, 1, 1);
if(func_2(Local_47[iParam0 /*20*/].f_1)){
if(iParam0==0){
TASK::TASK_START_SCENARIO_AT_POSITION(Local_47[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", Local_132[iParam0 /*3*/], fLocal_139[iParam0], 0, 0, 1);
PED::SET_PED_SHOULD_PLAY_NORMAL_SCENARIO_EXIT(Local_47[iParam0 /*20*/].f_1);
PED::SET_PED_SHOULD_IGNORE_SCENARIO_EXIT_COLLISION_CHECKS(Local_47[iParam0 /*20*/].f_1, 1);
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_47[iParam0 /*20*/].f_1, -37.34785f, -1102.022f, 25.42232f, 3f, 0, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 37, 1);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0 /*20*/].f_1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_47[iParam0 /*20*/].f_1, iLocal_148);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(Local_47[iParam0 /*20*/].f_1, 0, iLocal_148);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 23, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 1, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 28, 1);
WEAPON::SET_PED_CHANCE_OF_FIRING_BLANKS(Local_47[iParam0 /*20*/].f_1, 0.7f, 0.3f);
iLocal_116[iParam0]=0;
if(func_55()==0){
WEAPON::GIVE_WEAPON_TO_PED(Local_47[iParam0 /*20*/].f_1, Local_47[iParam0 /*20*/].f_17, -1, 1, 1);
}
...
PED::SET_PED_USING_ACTION_MODE(Local_47[iParam0 /*20*/].f_1, 1, -1, "DEFAULT_ACTION");
TASK::OPEN_SEQUENCE_TASK(&uLocal_147);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 12, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_47[iParam0 /*20*/].f_14, 1f, -1, 3f, 0, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_147);
TASK::TASK_PERFORM_SEQUENCE(Local_47[iParam0 /*20*/].f_1, uLocal_147);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_147);
Local_47[iParam0 /*20*/].f_18=3;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) >=250f){
...
if(func_2(Local_47[iParam0 /*20*/].f_1)){
func_99(Local_47[iParam0 /*20*/].f_1, &(Local_47[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
if(TASK::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*20*/].f_1, joaat("script_task_perform_sequence"))==7 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) <=5f){
...
PED::SET_PED_KEEP_TASK(Local_47[iParam0 /*20*/].f_1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(Local_47[iParam0 /*20*/].f_1, Local_47[iParam0 /*20*/].f_17, -1, 0, 1);
iLocal_116[iParam0]=1;
}}
if(TASK::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*20*/].f_1, joaat("script_task_combat"))==7){
TASK::TASK_COMBAT_PED(Local_47[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) >=75f){
Local_47[iParam0 /*20*/].f_18=5;
}}
break;
case 5:
...
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_149);
...
uLocal_142=PED::ADD_SCENARIO_BLOCKING_AREA(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, 0, 1, 1, 1);
TASK::ADD_COVER_BLOCKING_AREA(-34.2476f, -1107.283f, 24.9621f, -24.7924f, -1102.557f, 29.8287f, 1, 1, 1, 0);
if(iLocal_146==-1){
iLocal_146=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-29.3f, -1086.35f, 25.57f, 5.5f, 3f, 2f, -10f, 0, 7);
}
func_131(196, 0);
func_131(197, 0);
func_131(194, 0);
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112695) || Global_32166) || func_163()) || func_52(8, -1)) || func_162()) || func_161()) || func_160()) || func_159()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_164()) || Global_32166) || func_163()) || func_52(8, -1)) || func_160()) || func_162()) || func_161()) || func_159()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112695) || Global_32166) || func_163()) || func_52(8, -1)) || func_160()) || func_162()) || func_161()) || func_159()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112695) || Global_32166) || func_163()) || func_52(8, -1)) || func_162()) || func_161()) || func_159()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_164()) || func_161()) || Global_112695) || Global_32166) || func_163()) || Global_44446) || func_52(8, -1)) || func_160()) || func_158()) || func_159()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
