...
Local_235={
-1783.295f, 3179.115f, 31.8283f 
};
Local_238={
-1780.851f, 3183.688f, 31.8261f 
};
Local_255={
-1591.913f, 2799.37f, 15.9362f 
};
fLocal_258=218.6321f;
Local_259={
-2303.674f, 3384.374f, 30.0307f 
};
fLocal_262=101.3716f;
fLocal_280=0f;
Local_421={
-1894.567f, 3092.903f, 31.8103f 
};
Local_424={
-1963.457f, 3133.104f, 31.8103f 
};
Local_427={
-1960.055f, 3130.99f, 31.8103f 
};
iLocal_538=1000;
...
Local_446[0 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_421, 57.3018f, Local_430[0 /*3*/]) 
};
Local_446[1 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_421, 57.3018f, Local_430[1 /*3*/]) 
};
Local_446[2 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_421, 57.3018f, Local_430[2 /*3*/]) 
};
Local_446[3 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_421, 57.3018f, Local_430[3 /*3*/]) 
};
Local_446[4 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_421, 57.3018f, Local_430[4 /*3*/]) 
};
MISC::CLEAR_AREA_OF_VEHICLES(Local_421, 10f, 0, 0, 0, 0, 0, 0, 0);
iLocal_467=1;
break;
case 1:
...
case 0:
MISC::CLEAR_AREA_OF_VEHICLES(Local_421, 10f, 0, 0, 0, 0, 0, 0, 0);
iLocal_413=PED::CREATE_PED(6, joaat("s_m_y_marine_01"), Local_421, 57.3018f, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_413, joaat("army"));
WEAPON::GIVE_WEAPON_TO_PED(iLocal_413, joaat("weapon_assaultrifle"), -1, 1, 1);
...
iVar0=0;
while (iVar0 < 5){
uLocal_414[iVar0]=PED::CREATE_PED(6, joaat("s_m_y_marine_01"), Local_446[iVar0 /*3*/], 57.3018f, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_414[iVar0], joaat("army"));
WEAPON::GIVE_WEAPON_TO_PED(uLocal_414[iVar0], joaat("weapon_assaultrifle"), -1, 1, 1);
...
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_414[iVar0], iLocal_413, Local_430[iVar0 /*3*/], 1f, -1, 1036831949, 1);
}
}
iVar0++;
}
...
if(iLocal_464){
Var2={
ENTITY::GET_ENTITY_COORDS(iLocal_413, 1) 
};
...
while (iVar0 < 5){
if(((ENTITY::DOES_ENTITY_EXIST(iLocal_413) && ENTITY::DOES_ENTITY_EXIST(uLocal_414[iVar0])) && !PED::IS_PED_INJURED(iLocal_413)) && !PED::IS_PED_INJURED(uLocal_414[iVar0])){
ENTITY::SET_ENTITY_COORDS(uLocal_414[iVar0], Local_446[iVar0 /*3*/], 1, 0, 0, 1);
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_414[iVar0], iLocal_413, Local_430[iVar0 /*3*/], 1f, -1, 1036831949, 1);
}
iVar0++;
}}
...
Local_248[0 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_232, 140.0094f, 1f, 0f, 0f) 
};
Local_248[1 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_232, 140.0094f, -1f, 0f, 0f) 
};
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_228[0], joaat("script_task_perform_sequence")) !=1){
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_228[1], joaat("script_task_perform_sequence")) !=1){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1588.977f, 2793.941f, 14.98289f, -1575.664f, 2779.558f, 26.11536f, 29.75f, 0, 1, 0)){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_228[0], 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_228[0], joaat("script_task_go_to_entity")) !=1){
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_228[0], joaat("script_task_shoot_at_entity")) !=1){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2306.916f, 3390.545f, 29.17826f, -2322.245f, 3401.719f, 35.63131f, 36f, 0, 1, 0)){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_228[1], 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_228[1], joaat("script_task_go_to_entity")) !=1){
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_228[1], joaat("script_task_shoot_at_entity")) !=1){
...
if(iLocal_265){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_224, 1) 
};
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
Var4={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_232, 10f, 0, 0, 0, 0, 0, 0, 0);
...
ENTITY::SET_ENTITY_COORDS(uLocal_225[iVar0], Local_248[iVar0 /*3*/], 1, 0, 0, 1);
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_225[iVar0], iLocal_224, Local_241[iVar0 /*3*/], 1f, -1, 1036831949, 1);
}
iVar0++;
}}
...
switch (iLocal_274){
case 0:
iLocal_224=PED::CREATE_PED(6, joaat("s_m_y_marine_01"), Local_232, 140.0094f, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_224, joaat("weapon_assaultrifle"), -1, 1, 1);
...
iVar0=0;
while (iVar0 < 2){
uLocal_225[iVar0]=PED::CREATE_PED(6, joaat("s_m_y_marine_01"), Local_248[iVar0 /*3*/], 140.0094f, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_225[iVar0], joaat("weapon_assaultrifle"), -1, 1, 1);
ENTITY::SET_ENTITY_LOD_DIST(uLocal_225[iVar0], 1000);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_225[iVar0], joaat("army"));
...
if(ENTITY::IS_ENTITY_IN_AIR(iLocal_286) || (Var0.f_2 > 50f && func_49(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3, 350, 0))){
bLocal_341=true;
}}}}
if(bLocal_341){
switch (iLocal_301){
case 0:
uLocal_292=PED::CREATE_PED(5, joaat("s_m_y_marine_01"), -2127.982f, 2824.686f, 50.437f, 34.9781f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_292, 1);
uLocal_293[0]=PED::CREATE_PED(5, joaat("s_m_y_marine_01"), -1993.875f, 3145.167f, 54.4011f, 147.2257f, 1, 1);
uLocal_293[1]=PED::CREATE_PED(5, joaat("s_m_y_marine_01"), -2176.656f, 3250.501f, 54.3807f, 140.5236f, 1, 1);
uLocal_293[2]=PED::CREATE_PED(5, joaat("s_m_y_marine_01"), -2002.671f, 2960.148f, 31.8103f, 28.6649f, 1, 1);
func_48();
...
Var3={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Var0, uVar6, 0f, -150f, 0f) 
};
uVar7=ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID());
uVar7=uVar7;
if(!func_39(Var3)){
if(!CAM::IS_SPHERE_VISIBLE(Var3, 10f)){
iLocal_285=VEHICLE::CREATE_VEHICLE(joaat("lazer"), Var3, ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), 1, 1, 0);
...
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_285, 0);
uLocal_291=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_285, 5, joaat("s_m_y_marine_01"), -1, 1, 1);
...
WEAPON::SET_CURRENT_PED_VEHICLE_WEAPON(uLocal_291, joaat("vehicle_weapon_space_rocket"));
}
...
iVar4=0;
while (iVar4 < 3){
uLocal_287[iVar4]=VEHICLE::CREATE_VEHICLE(joaat("crusader"), Local_317[iVar4 /*3*/], fLocal_337[iVar4], 1, 1, 0);
uLocal_297[iVar4]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_287[iVar4], 5, joaat("s_m_y_marine_01"), -1, 1, 1);
...
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_287[iVar4], Local_327[iVar4 /*3*/], 25f, 0, joaat("crusader"), 786469, 5f, -1f);
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_297[iVar4], joaat("script_task_vehicle_drive_to_coord")) !=1){
...
void func_45(){
Local_317[0 /*3*/]={
-2158f, 3254.864f, 31.8106f 
};
Local_317[1 /*3*/]={
-2138.572f, 3253.477f, 31.8106f 
};
Local_317[2 /*3*/]={
-2133.471f, 3243.626f, 31.8106f 
};
Local_327[0 /*3*/]={
-2226.64f, 3172.212f, 31.8103f 
};
Local_327[1 /*3*/]={
-2156.083f, 3197.557f, 31.8106f 
};
Local_327[2 /*3*/]={
-1899.385f, 3054.546f, 31.8102f 
};
...
WEAPON::GIVE_WEAPON_TO_PED(uLocal_293[iVar0], joaat("weapon_stinger"), 20, 1, 1);
PED::SET_PED_ACCURACY(uLocal_293[iVar0], 100);
TASK::TASK_COMBAT_PED(uLocal_293[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_293[iVar0], joaat("army"));
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_228[0])){
uLocal_228[0]=PED::CREATE_PED(6, joaat("s_m_y_marine_01"), Local_255, fLocal_258, 1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(uLocal_228[0], joaat("weapon_assaultrifle"), -1, 1, 1);
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_228[1])){
uLocal_228[1]=PED::CREATE_PED(6, joaat("s_m_y_marine_01"), Local_259, fLocal_262, 1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(uLocal_228[1], joaat("weapon_assaultrifle"), -1, 1, 1);
...
}elseif(!ENTITY::IS_ENTITY_DEAD(uLocal_228[iVar0], 0)){
