...
while (true){
SYSTEM::WAIT(0);
if(iLocal_22==1)if(_SHOULD_NETWORK_SCRIPT_TERMINATE()) func_25();
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) func_2(pickupHash, OBJECT::GET_SAFE_PICKUP_COORDS(uLocal_19, 1067030938, 1069547520), address, randomIntInRange, model, false, false);
else OBJECT::CREATE_PICKUP(pickupHash, OBJECT::GET_SAFE_PICKUP_COORDS(uLocal_19, 1067030938, 1069547520), address, randomIntInRange, false, model);
return;
}
...
var unk;
unk=123;
if(func_12() && func_11(hParam0)) unk={
func_3(hParam0, vParam1, iParam4, iParam5, hParam6, bParam7) 
};
else unk.f_4=OBJECT::CREATE_AMBIENT_PICKUP(hParam0, vParam1, iParam4, iParam5, hParam6, bParam7, bParam8);
return unk;
}
...
Global_1914091[num2 /*297*/].f_98.f_21[num /*14*/]={
hash 
};
Global_1914091[num2 /*297*/].f_98.f_21[num /*14*/].f_5={
vParam1 
};
...
int i;
if(!func_7(uParam0)) return -1;
for (i=0;
i < 10;
i=i + 1){
if(func_5(uParam0, &Global_2652258.f_2452[i /*16*/])) return i;
}
return -1;
}
BOOL func_5(var uParam0, var uParam1) // Position - 0x3DC{
if(*uParam0==*uParam1 && func_6(uParam0->f_1, uParam1->f_1, false) && uParam0->f_4==uParam1->f_4) return true;
return false;
}
...
if(*uParam0==123 || _IS_NULL_VECTOR(uParam0->f_1) || uParam0->f_4==0) return false;
return true;
}
...
int num;
int i;
if(iParam0==-1) iParam0=PLAYER::NETWORK_PLAYER_ID_TO_INT();
num=-1;
for (i=0;
i < 10;
i=i + 1){
...
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_18()) return true;
...
if(i==3 || i==4 || i==5 || i==6)if(!bNoTerminate) func_24();
else return 0;
if(!func_23(false)){
if(iParam0==0){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_24();
else return 0;
if(func_21())if(!bNoTerminate) func_24();
else return 0;
if(_DOES_EVENT_OF_TYPE_EXIST(157))if(!bNoTerminate) func_24();
else return 0;
}elseif(!NETWORK::NETWORK_IS_IN_SESSION()){
if(!bNoTerminate) func_24();
else return 0;
}}
SYSTEM::WAIT(0);
}
if(iParam1 > -1) Global_1574666=i;
if(iParam0==0)if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_24();
else return 0;
elseif(!NETWORK::NETWORK_IS_IN_SESSION())if(!bNoTerminate) func_24();
else return 0;
return 1;
}
