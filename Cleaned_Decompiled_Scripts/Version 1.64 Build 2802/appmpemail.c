...
uLocal_45=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_45) && iLocal_40==0){
SYSTEM::WAIT(0);
...
iLocal_41=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_45);
}
if(iLocal_41 < 0){
iLocal_41=0;
}
...
Global_20311={
func_47(Param0, Param3, fVar4) 
};
Global_20314={
func_47(Param6, Param9, fVar4) 
};
}else{
Global_20311={
Param3 
...
Vector3 func__47(struct<3> Param0, struct<3> Param3, float fParam6){
