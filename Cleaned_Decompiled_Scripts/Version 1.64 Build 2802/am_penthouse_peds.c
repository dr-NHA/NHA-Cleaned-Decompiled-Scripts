...
while (true){
func_37();
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1579668==0 || func_28()) func_25();
func_3();
func_1();
}
return;
...
int num;
float num2;
if(iLocal_38==0)if(AUDIO::LOAD_STREAM("Party_Walla_Stream", "DLC_Vinewood_Casino_Penthouse_Party_Sounds")) iLocal_38=iLocal_38 + 1;
if(iLocal_38==1){
num=func_2();
if(num > -1){
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_42[i /*47*/])) func_12(&uLocal_42[i /*47*/]);
elseif(ENTITY::IS_ENTITY_DEAD(uLocal_42[i /*47*/], false)) func_11(&uLocal_42[i /*47*/]);
...
if(ENTITY::DOES_ENTITY_EXIST(*uParam0) && !ENTITY::IS_ENTITY_DEAD(*uParam0, false)) func_5(uParam0);
return;
}
...
if(!func_7(uParam0)){
if(func_6(uParam0)) TASK::TASK_PLAY_ANIM_ADVANCED(0, animDict, animName, uParam0->f_40, 0f, 0f, uParam0->f_43, 1090519040, -1056964608, -1, 790529, randomFloatInRange, 2, 3);
else TASK::TASK_PLAY_ANIM(0, animDict, animName, 1090519040, -1056964608, -1, 1, randomFloatInRange, false, false, false);
}else{
unk=4;
unk[0]=0;
unk[1]=1;
...
if(ENTITY::DOES_ENTITY_EXIST(ppedParam0->f_1)) OBJECT::DELETE_OBJECT(&(ppedParam0->f_1));
return;
}
...
i < PV_COMP_UPPR;
i=i + 1){
if(uParam0->f_28[i]) PED::SET_PED_PROP_INDEX(*uParam0, uParam0->f_32[i], 0, uParam0->f_36[i], false, 1);
}
func_18(uParam0);
if(func_17(uParam0)){
...
if(func_7(uParam0)) PED::SET_PED_ALTERNATE_MOVEMENT_ANIM(*uParam0, 0, func_13(uParam0), "BASE", 1090519040, true);
...
Vector3 func__14(var uParam0) // Position - 0xE8C{
switch (uParam0->f_44){
case 1:
case 2:
return 0f, 0f, 0.01f;
...
if(func_7(uParam0))if(!STREAMING::HAS_ANIM_DICT_LOADED(func_13(uParam0))) return false;
if(func_17(uParam0))if(STREAMING::HAS_MODEL_LOADED(func_16(uParam0))) return true;
else return false;
else return true;
}else{
return false;
...
if(func_7(uParam0)) STREAMING::REQUEST_ANIM_DICT(func_13(uParam0));
if(func_17(uParam0)) STREAMING::REQUEST_MODEL(func_16(uParam0));
}
return;
}
BOOL func_22(var uParam0) // Position - 0x131E{
if(_IS_NULL_VECTOR(uParam0->f_40)) return false;
if(uParam0->f_46 <=func_23()) return true;
return false;
}


var func__23() // Position - 0x1347{
var unk;
unk=iLocal_39.f_1;
return unk;
}
...
if(AUDIO::IS_STREAM_PLAYING()) AUDIO::STOP_STREAM();
func_27();
func_26();
return;
}
...
if(func_35()) return true;
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_33()) return true;
...
if(Global_1579664) return 1;
return 0;
}

int func_46(var uParam0) // Position - 0x83DE{
if(uParam0 >=Global_262145.f_27054) return 5;
elseif(uParam0 >=Global_262145.f_27053) return 4;
elseif(uParam0 >=Global_262145.f_27052) return 3;
elseif(uParam0 >=Global_262145.f_27051) return 2;
return 1;
}
...
if(i==3 || i==4 || i==5 || i==6)if(!bNoTerminate) func_26();
else return 0;
if(!func_49(false)){
if(iParam0==0){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_26();
else return 0;
if(func_36())if(!bNoTerminate) func_26();
else return 0;
if(_DOES_EVENT_OF_TYPE_EXIST(157))if(!bNoTerminate) func_26();
else return 0;
}elseif(!NETWORK::NETWORK_IS_IN_SESSION()){
if(!bNoTerminate) func_26();
else return 0;
}}
SYSTEM::WAIT(0);
}
if(iParam1 > -1) Global_1574666=i;
if(iParam0==0)if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_26();
else return 0;
elseif(!NETWORK::NETWORK_IS_IN_SESSION())if(!bNoTerminate) func_26();
else return 0;
return 1;
}
