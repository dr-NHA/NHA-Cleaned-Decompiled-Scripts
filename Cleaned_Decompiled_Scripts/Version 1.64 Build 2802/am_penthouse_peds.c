...
iVar0=func_2();
if(iVar0 > -1){
if(ENTITY::DOES_ENTITY_EXIST(Local_42[iVar0 /*47*/]) && !ENTITY::IS_ENTITY_DEAD(Local_42[iVar0 /*47*/], 0)){
...
}elseif(ENTITY::IS_ENTITY_DEAD(Local_42[iVar0 /*47*/], 0)){
...
if(!func_7(uParam0)){
if(func_6(uParam0)){
TASK::TASK_PLAY_ANIM_ADVANCED(0, uVar0, uVar1, uParam0->f_40, 0f, 0f, uParam0->f_43, 1090519040, -1056964608, -1, 790529, uVar2, 2, 3);
}else{
...
func_21(uParam0);
if(func_20(uParam0)){
*uParam0=PED::CREATE_PED(26, func_19(uParam0), uParam0->f_40, uParam0->f_43, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
iVar0=0;
while (iVar0 < 12){
...
PED::SET_PED_PROP_INDEX(*uParam0, uParam0->f_32[iVar0], 0, uParam0->f_36[iVar0], 0, 1);
}
iVar0++;
}
func_18(uParam0);
if(func_17(uParam0)){
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1)){
uParam0->f_1=OBJECT::CREATE_OBJECT(func_16(uParam0), PED::GET_PED_BONE_COORDS(*uParam0, func_15(uParam0), 0f, 0f, 0f), 0, 0, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_1, *uParam0, PED::GET_PED_BONE_INDEX(*uParam0, func_15(uParam0)), func_14(uParam0), 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
}}
if(func_7(uParam0)){
PED::SET_PED_ALTERNATE_MOVEMENT_ANIM(*uParam0, 0, func_13(uParam0), "BASE", 1090519040, 1);
}
iLocal_37++;
}}}}
...
return 5;
}elseif(iParam0 >=Global_262145.f_27053){
return 4;
}elseif(iParam0 >=Global_262145.f_27052){
return 3;
}elseif(iParam0 >=Global_262145.f_27051){
return 2;
}
return 1;
}
...
void func_47(){
while (!NETWORK::NETWORK_TRY_TO_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, Global_1579683)){
SYSTEM::WAIT(0);
}
Global_1579683++;
func_48(0, -1, 0);
