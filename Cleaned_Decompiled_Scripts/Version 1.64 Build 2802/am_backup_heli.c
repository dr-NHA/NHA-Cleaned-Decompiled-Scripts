...
func_58(5);
}}elseif(func_11(Local_230.f_1.f_3[0 /*2*/])){
if(func_11(Local_230.f_1.f_3[1 /*2*/]) && func_11(Local_230.f_1.f_3[2 /*2*/])){
func_58(5);
}}elseif(func_11(Local_230.f_1.f_3[1 /*2*/]) && func_11(Local_230.f_1.f_3[2 /*2*/])){
func_58(3);
}else{
...
if(func_12(Local_230.f_1)){
iLocal_56++;
}elseif(ENTITY::DOES_ENTITY_EXIST(NETWORK::NET_TO_VEH(Local_230.f_1))){
...
Var0={
func_55(func_56(PLAYER::PLAYER_ID()), 0f, (-200f * SYSTEM::SIN((SYSTEM::TO_FLOAT(Local_230.f_1.f_15) * 30f))), (200f * SYSTEM::COS((SYSTEM::TO_FLOAT(Local_230.f_1.f_15) * 30f))), 0f) 
};
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_45(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam3)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_45(iVar1), Param0, 1) <=(fVar2 + fParam3)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_56(iVar1), Param0, 1) < fParam3){
return 1;
}}
}}}}}
iVar0++;
...
Vector3 func__55(struct<3> Param0, float fParam3, struct<2> Param4, float fParam6){
struct<3> Var0;
float fVar3;
float fVar4;
float fVar5;
...
uLocal_47=HUD::ADD_BLIP_FOR_ENTITY(uVar1);
HUD::SET_BLIP_SPRITE(uLocal_47, 422);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_47, 0);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_47, "MPCT_MERRY3");
func_86(&uLocal_47, 1);
}
...
uVar0=NETWORK::NET_TO_PED(Local_230.f_1.f_3[0 /*2*/]);
...
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_HELI_MISSION(uVar0, uVar1, 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 23, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_61[0]), 10, -1082130432, 0);
}
}}}
}
if(!iLocal_50){
...
uVar0=NETWORK::NET_TO_PED(Local_230.f_1.f_3[1 /*2*/]);
if(!PED::IS_PED_INJURED(uVar0)){
...
uVar0=NETWORK::NET_TO_PED(Local_230.f_1.f_3[2 /*2*/]);
if(!PED::IS_PED_INJURED(uVar0)){
...
if(fLocal_58==-1f){
bVar0=true;
}elseif(!func_6(&uLocal_59)){
func_5(&uLocal_59, 0, 0);
}elseif(func_4(&uLocal_59, 5000, 0)){
bVar0=true;
}
if(bVar0){
Var1={
