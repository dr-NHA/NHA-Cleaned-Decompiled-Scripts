...
if(!func_8(iParam0, func_9())) return 0;
...
}elseif(eParam1==func_7(Global_100402) && eParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_19();
return;
}
...
ENTITY::SET_ENTITY_ROTATION(iLocal_72[i],{
fLocal_85, 0f, 0f 
}
+ uLocal_99[i /*3*/], 2, true);
...
TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_72[i], &uLocal_117, &uLocal_125[i /*8*/], uLocal_82 + uLocal_86[i /*3*/],{
fLocal_85, 0f, 0f 
}
+ uLocal_99[i /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
...
Vector3 func__21(float fParam0, float fParam1, float fParam2) // Position - 0x8D7{
float num;
float num2;
...
uLocal_86[0 /*3*/]={
14.613f, 8.4563f, 0.9751f 
};
uLocal_86[1 /*3*/]={
10.6489f, 8.6708f, 0.7701f 
};
uLocal_86[2 /*3*/]={
6.3982f, 1.4604f, 1.1f 
};
uLocal_86[3 /*3*/]={
4.2327f, 5.864f, 0.9f - 0.15f 
};
uLocal_99[0 /*3*/]={
0f, 0f, 23.047f 
};
...
uLocal_173[0 /*3*/]={
({
0.37364f, -1445.5344f, 2803.7603f 
}
- uLocal_82) +{
0.1f, 0f, 0f 
}};
...
uLocal_173[3 /*3*/]={
({
0.28483f, -1448.0331f, 2794.3005f 
}
- uLocal_82) +{
0.1f, 0f, 0f 
}};
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_117)) STREAMING::REMOVE_ANIM_DICT(&uLocal_117);
for (i=0;
i < iLocal_159;
i=i + 1){
