...
fVar0=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_82);
if(fVar0 > (100f * 100f)){
return 1;
}
return 0;
...
iVar0=1;
}elseif(ENTITY::DOES_ENTITY_EXIST((*iParam0)[iVar1])){
}
iVar1++;
}
return iVar0;
...
return 0;
}}}elseif(iParam1==func_7(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(iLocal_77[iVar0] !=0){
iLocal_72[iVar0]=PED::CREATE_PED(26, iLocal_77[iVar0], Local_82 + Local_86[iVar0 /*3*/], 0, 1, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_72[iVar0], Vector(uLocal_85, 0f, 0f) + Local_99[iVar0 /*3*/], 2, 1);
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_72[iVar0], 13, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_72[iVar0], 17, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_72[iVar0], 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_72[iVar0], 0);
TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0 /*8*/]), Local_82 + Local_86[iVar0 /*3*/], Vector(uLocal_85, 0f, 0f) + Local_99[iVar0 /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_72[iVar0], 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_72[iVar0], 1);
PED::SET_PED_RESET_FLAG(iLocal_72[iVar0], 55, 1);
...
fVar14=1f;
fVar15=-1f;
iLocal_159[iVar0]=GRAPHICS::ADD_DECAL(iLocal_166[iVar0], Local_82 + Local_173[iVar0 /*3*/], Var3, Var6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
SYSTEM::WAIT(0);
}
iVar0++;
}}
...
Vector3 func__21(struct<3> Param0){
float fVar0;
float fVar1;
...
iLocal_166[3]=1110;
Local_173[0 /*3*/]={
Vector(0.37364f, -1445.534f, 2803.76f) - Local_82 + Vector(0.1f, 0f, 0f) 
};
Local_173[1 /*3*/]={
Vector(0.28778f, -1444.863f, 2800.022f) - Local_82 + Vector(0.1f, 0f, 0f) 
};
Local_173[2 /*3*/]={
Vector(0.6045f, -1452.404f, 2795.934f) - Local_82 + Vector(0.1f, 0f, 0f) 
};
Local_173[3 /*3*/]={
Vector(0.28483f, -1448.033f, 2794.301f) - Local_82 + Vector(0.1f, 0f, 0f) 
};
iLocal_166[4]=1015;
iLocal_166[5]=1015;
Local_173[4 /*3*/]={
Local_173[0 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) 
};
Local_173[5 /*3*/]={
Local_173[1 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) 
};
break;
default:
