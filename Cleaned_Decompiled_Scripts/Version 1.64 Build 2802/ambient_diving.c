...
func_59();
VEHICLE::SET_BOAT_ANCHOR(uLocal_409, 0);
iLocal_411=1;
if(iLocal_386==2){
func_2(3);
}}}elseif(func_48(uLocal_409) && func_48(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_IN_WATER(PLAYER::PLAYER_PED_ID())){
fVar0=500f;
}else{
fVar0=250f;
}
if(func_58(PLAYER::PLAYER_PED_ID(), uLocal_409, 0) > fVar0){
func_57();
if(iLocal_386==2){
func_2(3);
}}}else{
...
if(!func_60()){
if(func_48(uLocal_409)){
if(!HUD::DOES_BLIP_EXIST(uLocal_410)){
uLocal_410=func_54(uLocal_409, 0, 0);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_409, 0, 1, 0);
if(VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(uLocal_409))){
if(!ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(uLocal_409)){
VEHICLE::SET_BOAT_ANCHOR(uLocal_409, 1);
}}
iLocal_411=0;
}}
break;
...
ENTITY::SET_ENTITY_RECORDS_COLLISIONS(uLocal_409, 0);
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(uLocal_409)){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_409);
}}}
...
void func_59(){
if(HUD::DOES_BLIP_EXIST(uLocal_410)){
HUD::REMOVE_BLIP(&uLocal_410);
}}

int func_60(){
if(func_48(PLAYER::PLAYER_PED_ID())){
if(func_48(uLocal_409)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_409, 0)){
return 1;
}}elseif(func_61()){
uLocal_409=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_409)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_409, 1, 1);
ENTITY::SET_ENTITY_RECORDS_COLLISIONS(uLocal_409, 1);
return 1;
}}}
return 0;
}
...
HUD::REMOVE_BLIP(&uLocal_390);
}}
if(!HUD::DOES_BLIP_EXIST(uLocal_390)){
uLocal_390=HUD::ADD_BLIP_FOR_RADIUS(Var3, 200f);
HUD::SET_BLIP_ALPHA(uLocal_390, 128);
HUD::SET_BLIP_COLOUR(uLocal_390, 2);
HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_390, 0);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_390, "B_WRE");
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_390, 0);
iLocal_391=iLocal_388;
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_390)){
HUD::REMOVE_BLIP(&uLocal_390);
}}else{
if(func_61()){
if(!func_25(42)){
...
iLocal_406=0;
if(func_61()){
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_408, "SINGLE_BLIP_FROM_BOAT", Var3, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
}else{
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_408, "SCRIPT_TRIGGERED_FROM_PROP", Var0, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
}}else{
fLocal_403=(fLocal_403 + fLocal_405);
fLocal_403=func_63(fLocal_403, 0f, fLocal_404);
if(!HUD::DOES_BLIP_EXIST(uLocal_392)){
uLocal_392=HUD::ADD_BLIP_FOR_RADIUS(Var3, fLocal_403);
HUD::SET_BLIP_ALPHA(uLocal_392, 255);
HUD::SET_BLIP_COLOUR(uLocal_392, 4);
HUD::SET_BLIP_AS_SHORT_RANGE(uLocal_392, 1);
HUD::SET_RADIUS_BLIP_EDGE(uLocal_392, 1);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_392, 0);
}else{
HUD::SET_BLIP_SCALE(uLocal_392, fLocal_403);
}
iVar7=0;
if(func_61()){
iVar7=0;
while (iVar7 <=3){
if(!HUD::DOES_BLIP_EXIST(uLocal_393[iVar7])){
uLocal_393[iVar7]=HUD::ADD_BLIP_FOR_RADIUS(Var3, (fLocal_403 + fLocal_398[iVar7]));
HUD::SET_BLIP_ALPHA(uLocal_393[iVar7], 255);
HUD::SET_BLIP_COLOUR(uLocal_393[iVar7], 4);
HUD::SET_BLIP_AS_SHORT_RANGE(uLocal_393[iVar7], 1);
HUD::SET_RADIUS_BLIP_EDGE(uLocal_393[iVar7], 1);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_393[iVar7], 0);
}else{
HUD::SET_BLIP_SCALE(uLocal_393[iVar7], (fLocal_403 + fLocal_398[iVar7]));
}
iVar7++;
}}else{
iVar7=0;
while (iVar7 <=3){
if(HUD::DOES_BLIP_EXIST(uLocal_393[iVar7])){
HUD::SET_BLIP_SCALE(uLocal_393[iVar7], fLocal_403);
}
iVar7++;
}}
...
int iVar0;
if(HUD::DOES_BLIP_EXIST(uLocal_392)){
HUD::REMOVE_BLIP(&uLocal_392);
}
iVar0=0;
while (iVar0 <=3){
if(HUD::DOES_BLIP_EXIST(uLocal_393[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_393[iVar0]));
}
iVar0++;
}}
...
func_64();
if(!AUDIO::HAS_SOUND_FINISHED(uLocal_408)){
AUDIO::STOP_SOUND(uLocal_408);
}
func_57();
iVar0=0;
