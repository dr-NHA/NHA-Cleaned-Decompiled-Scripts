...
fLocal_31=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_32);
}
func_176(&iVar1);
func_31(&iVar2);
if(iLocal_47 > 3){
...
func_172("MG_TRAF_AVAIL", 0, 0, -1, 10000, 7, 0, 0, 0);
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_55, 4f, 0, 0, 0, 0, 0, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_54)){
VEHICLE::DELETE_VEHICLE(&iLocal_54);
}
iLocal_54=VEHICLE::CREATE_VEHICLE(func_167(), Local_55, fLocal_58, 1, 1, 0);
AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_54, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_167());
if(ENTITY::DOES_ENTITY_EXIST(iLocal_54)){
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_54, 1)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_54, 1, 1);
}
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_54, 2)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_54, 2, 0);
}
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_54, 3)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_54, 3, 0);
}
...
if(*iParam0){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_54, 0)){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_54, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iVar2=PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID());
if(iVar2==iLocal_54){
if(SYSTEM::VDIST2(Local_55, ENTITY::GET_ENTITY_COORDS(iLocal_28, 1)) < 100f){
...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_54, 1, 0);
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_54);
...
var uVar0;
var uVar1;
uVar0=Global_2848280[iParam0 /*3*/][func_91(iParam1)];
...
if(func_135()){
*uParam0=func_115(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_113()==0){
return MISC::IS_BIT_SET(func_90(func_112(iParam0), -1, 0), iParam1);
}}else{
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_116(iVar0, 0), 1);
...
Vector3 func__116(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_121(2, 2);
}elseif(func_120(Global_1853747)){
...
Vector3 func__121(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_123(Var18, -Var0.f_3.f_2) 
};
Var18={
func_123(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__123(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) !=145) || func_155(iParam0)) || func_154(iParam0)) || func_153(iParam0)) || func_152(iParam0)) || !func_142(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_154(iParam0)){
}
if(func_154(iParam0)){
}
...
void func_158(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_157(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_32) < 2500f){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_50, 8f, 0, 0, 0, 0, 0, 0, 0);
iLocal_48=VEHICLE::CREATE_VEHICLE(joaat("cuban800"), Local_50, 25.29f, 1, 1, 0);
...
case 4:
if(ENTITY::DOES_ENTITY_EXIST(iLocal_48)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_48, 0) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_47=9;
return;
}}
if(func_28(9)){
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_48, 0)){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_29) && !ENTITY::IS_ENTITY_DEAD(iLocal_29, 0)){
if(ENTITY::GET_ENTITY_MODEL(iLocal_29) !=joaat("dune") && ENTITY::GET_ENTITY_MODEL(iLocal_29) !=joaat("cuban800")){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_29, 2137.12f, 4799.97f, 39.67854f, 2116.64f, 4790.417f, 45.45295f, 25f, 0, 1, 0)){
func_138(iLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
}}elseif(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
VEHICLE::SET_PLAYERS_LAST_VEHICLE(iLocal_29);
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_187()) || Global_112695) || Global_32166) || func_181()) || func_180(8, -1)) || func_135()) || func_186()) || func_179()) || func_185()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_187()) || Global_32166) || func_181()) || func_180(8, -1)) || func_179()) || func_135()) || func_186()) || func_185()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_187()) || Global_112695) || Global_32166) || func_181()) || func_180(8, -1)) || func_135()) || func_186()) || func_185()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_187()) || Global_32166) || func_181()) || func_180(8, -1)) || func_186()) || func_179()) || func_185()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_187()) || func_186()) || Global_112695) || Global_32166) || func_181()) || Global_44446) || func_180(8, -1)) || func_179()) || func_184()) || func_185()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_187()) || Global_112695) || Global_32166) || func_181()) || func_180(8, -1)) || func_179()) || func_184()) || func_135()) || func_186()) || func_185()){
return 0;
}
break;
}}else{
...
void func_192(){
if(!iLocal_80){
iLocal_79=PED::ADD_SCENARIO_BLOCKING_AREA(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), 0, 1, 1, 1);
iLocal_80=1;
}}
