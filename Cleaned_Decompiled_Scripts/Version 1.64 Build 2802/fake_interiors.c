...
uLocal_33=PLAYER::PLAYER_PED_ID();
}
...
Var0={
ENTITY::GET_ENTITY_COORDS(uLocal_33, 0) 
};
Var3={
func_19(iLocal_29) 
};
...
if(!bVar6){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_33, func_16(iLocal_29, iVar7), func_15(iLocal_29, iVar7), func_14(iLocal_29, iVar7), 0, 1, 0)){
bVar6=true;
}}
iVar7++;
}
...
}}elseif(MISC::IS_BIT_SET(uLocal_34, 0)){
HUD::SET_MINIMAP_COMPONENT(15, 0, -1);
MISC::CLEAR_BIT(&uLocal_34, 0);
}}elseif(!MISC::IS_BIT_SET(uLocal_34, 1)){
HUD::SET_MINIMAP_COMPONENT(15, 0, -1);
MISC::CLEAR_BIT(&uLocal_34, 0);
...
Vector3 func__15(int iParam0, int iParam1){
switch (iParam0){
case 0:
switch (iParam1){
case 0:
