...
}elseif(func_2(&(Local_130.f_1)) > 20f){
...
Local_130.f_4=PED::ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
}
...
case 2:
if(Global_1836156 || func_23(3)){
PED::REMOVE_SCENARIO_BLOCKING_AREA(Local_130.f_4, 0);
}
return 1;
break;
}
...
void func_48(var uParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_43();
}
