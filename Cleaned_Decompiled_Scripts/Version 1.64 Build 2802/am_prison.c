...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) func_44(uScriptParam_0);
else func_42();
while (true){
func_41();
if(_SHOULD_NETWORK_SCRIPT_TERMINATE() || NETWORK::NETWORK_IS_IN_TUTORIAL_SESSION()) func_42();
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(func_28()) func_42();
if(!func_27() || func_24(PLAYER::PLAYER_ID(), 0))if(!Global_1836156 && !func_23(3) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && !func_18(PLAYER::PLAYER_ID()) && !func_16(func_17(PLAYER::PLAYER_ID())) && !func_14(PLAYER::PLAYER_ID(), 146) && !func_10(PLAYER::PLAYER_ID()))if(func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 4, 100, false))if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()))if(!func_8(&(iLocal_130.f_1))) func_5(&(iLocal_130.f_1));
elseif(func_2(&(iLocal_130.f_1)) > 20f)if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 4) PLAYER::REPORT_CRIME(PLAYER::PLAYER_ID(), 36, PLAYER::GET_WANTED_LEVEL_THRESHOLD(4) - PLAYER::GET_WANTED_LEVEL_THRESHOLD(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())));
else PLAYER::REPORT_POLICE_SPOTTED_PLAYER(PLAYER::PLAYER_ID());
elseif(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 4) PLAYER::REPORT_CRIME(PLAYER::PLAYER_ID(), 36, PLAYER::GET_WANTED_LEVEL_THRESHOLD(4) - PLAYER::GET_WANTED_LEVEL_THRESHOLD(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())));
else PLAYER::REPORT_POLICE_SPOTTED_PLAYER(PLAYER::PLAYER_ID());
elseif(func_8(&(iLocal_130.f_1))) func_1(&(iLocal_130.f_1));
}else{
func_42();
}}
return;
...
if(func_8(piParam0))if(func_4(piParam0)) return piParam0->f_2;
...
if(!func_8(piParam0)) func_6(piParam0);
return;
}
...
if(func_13(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_33;
return -1;
}
...
if(Global_1894573[plParam0 /*608*/]==iParam1) return func_15(plParam0);
return false;
}
...
return true;
case 141:
if(func_15(PLAYER::PLAYER_ID())) return true;
break;
}
return false;
}
...
if(func_19())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_21(-1, false)==8;
...
Player player;
if(func_26() !=0) return false;
if(!func_25(plParam0)) return false;
player=plParam0;
if(Global_1853910[player /*862*/]==iParam1) return true;
return false;
}
...
if(Global_1853910[PLAYER::PLAYER_ID() /*862*/]==-1) return false;
return true;
}
BOOL func_28() // Position - 0x1375{
BOOL num;
num=0;
if(NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())if(func_32()) num=1;
if(func_29()) num=1;
return num;
}
...
switch (iLocal_130){
case 0:
if(Global_1836156 || func_23(3)) iLocal_130.f_4=PED::ADD_SCENARIO_BLOCKING_AREA(1413.7028f, 2341.5168f, -232.3945f, 2016.2095f, 2998.893f, 161.0299f, false, true, true, true);
func_30(&uLocal_97[NETWORK::PARTICIPANT_ID_TO_INT()], 1);
iLocal_130=1;
break;
case 1:
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 1693.1636f, 2559.6162f, 44.5649f) >=1030225f) iLocal_130=2;
break;
case 2:
if(Global_1836156 || func_23(3)) PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_130.f_4, false);
return true;
}
return false;
}
...
if(NETWORK::NETWORK_GET_NUM_PARTICIPANTS() > 1) return false;
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 1693.1636f, 2559.6162f, 44.5649f) >=1030225f) return true;
return false;
}
...
if(func_39()) return true;
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_37()) return true;
...
if(!_NETWORK_WAIT_FOR_HOST_BROADCAST_DATA()) func_42();
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_42();
return;
}
...
if(i==3 || i==4 || i==5 || i==6)if(!bNoTerminate) func_43();
else return 0;
if(!func_47(false)){
if(iParam0==0){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_43();
else return 0;
if(func_40())if(!bNoTerminate) func_43();
else return 0;
if(_DOES_EVENT_OF_TYPE_EXIST(157))if(!bNoTerminate) func_43();
else return 0;
}elseif(!NETWORK::NETWORK_IS_IN_SESSION()){
if(!bNoTerminate) func_43();
else return 0;
}}
SYSTEM::WAIT(0);
}
if(iParam1 > -1) Global_1574666=i;
if(iParam0==0)if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!bNoTerminate) func_43();
else return 0;
elseif(!NETWORK::NETWORK_IS_IN_SESSION())if(!bNoTerminate) func_43();
else return 0;
return 1;
}
