...
fLocal_296=1f;
fLocal_297=1f;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_54();
SYSTEM::WAIT(0);
func_40();
func_37();
func_33();
...
switch (iLocal_70){
case 0:
if(func_27()) iLocal_70=1;
break;
case 1:
if(func_26()) iLocal_70=2;
break;
case 2:
if(func_2()) iLocal_70=3;
break;
case 3:
func_1();
break;
...
if(!bLocal_238)if(_CONVERSATION_ADD_LINE(&uLocal_72, "PRSAUD", "FRAS_IG_7x", 3, 0, 0, 0)) bLocal_238=true;
if(synchronizedScenePhase < 0.2812f){
if(iLocal_294 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_294, false);
iLocal_294=0;
}}elseif(synchronizedScenePhase < 0.4778f){
if(iLocal_294==0){
...
}}elseif(synchronizedScenePhase < 0.5745f){
if(iLocal_294 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_294, false);
iLocal_294=0;
}}elseif(synchronizedScenePhase < 0.7712f){
if(iLocal_294==0){
iLocal_294=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", obLocal_239, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_294, fLocal_295, fLocal_296, fLocal_297, false);
}}elseif(iLocal_294 !=0){
...
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_294, false);
iLocal_294=0;
}}elseif(synchronizedScenePhase < 0.6712f){
if(iLocal_294==0){
iLocal_294=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", obLocal_239, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_294, fLocal_295, fLocal_296, fLocal_297, false);
}}elseif(synchronizedScenePhase < 1f){
if(iLocal_294 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_294, false);
iLocal_294=0;
}}else{
...
if(!func_31(iParam0, func_32())) return 0;
...
}elseif(pedParam1==func_30(Global_100402) && pedParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_36();
return;
}
...
if(!PED::IS_PED_INJURED(Global_100402)) TASK::TASK_STAND_STILL(Global_100402, -1);
...
case 206:
case 207:
if(func_41(205, sParam1, sParam2, sParam3, uParam4, uParam5)) return true;
break;
case 204:
if(func_41(205, sParam1, sParam2, sParam3, uParam4, uParam5)) return true;
break;
...
uParam109->f_109=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
uParam109->f_110=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
func_44(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"),{
...
, -66f + -56f);
if(uParam0.f_2==80) func_45(uParam109);
uParam109->f_118=1;
return 1;
case 124:
*uParam109={
...
uParam109->f_109=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
uParam109->f_110=joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
if(uParam0.f_2==94) func_44(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -1.71f, 1.05f, 0f, -138f);
uParam109->f_118=1;
return 1;
case 95:
*uParam109={
...
if(uParam0.f_2==267) func_44(uParam109, 144, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -2.4166f, -0.15f, 0f, -148.7555f);
if(uParam0.f_2==266) func_44(uParam109, 144, joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -5.7915f, -11.0439f, 0.67f, -72.589f);
return 1;
case 246:
*uParam109={
uParam0 
...
if(func_48(entityCoords, 0f, 0f, 0f, false)) entityCoords={
