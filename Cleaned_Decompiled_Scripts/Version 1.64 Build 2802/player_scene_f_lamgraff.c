...
if(fVar0 < 0.2812f){
if(iLocal_294 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_294, 0);
iLocal_294=0;
}}elseif(fVar0 < 0.4778f){
if(iLocal_294==0){
iLocal_294=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", uLocal_239, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_294, fLocal_295, fLocal_296, fLocal_297, 0);
}}elseif(fVar0 < 0.5745f){
if(iLocal_294 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_294, 0);
iLocal_294=0;
}}elseif(fVar0 < 0.7712f){
if(iLocal_294==0){
iLocal_294=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", uLocal_239, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_294, fLocal_295, fLocal_296, fLocal_297, 0);
}}elseif(iLocal_294 !=0){
...
iLocal_293=PED::CREATE_SYNCHRONIZED_SCENE(Local_241, 0f, 0f, uLocal_244, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_293, 1);
}
...
return 0;
}}}elseif(iParam1==func_30(Global_100402) && iParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
uLocal_239=OBJECT::CREATE_OBJECT(iLocal_240, ENTITY::GET_ENTITY_COORDS(Global_100402, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_239, Global_100402, PED::GET_PED_BONE_INDEX(Global_100402, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
