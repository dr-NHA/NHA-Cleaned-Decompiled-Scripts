...
if(!iLocal_155 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0)){
...
Var10={
func_42(iParam0, iParam1, iParam2, bParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9) 
};
iVar20=0;
func_41(&iVar20);
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_54(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
Global_78341[1 /*14*/]={
func_113(iVar10, iVar0, func_71(iParam0, iVar0, -1), -1) 
};
...
return 1;
}elseif(func_100(iParam0, iParam2, iParam3, -1)){
...
switch (iParam2){
case 2:
iVar1=func_103(uParam0, 1);
iVar0=func_81(iParam1, iParam3, iVar1);
break;
case 1:
iVar2=func_103(uParam0, 2);
...
if(iParam2==11){
iVar5=iParam3;
iVar4=func_103(uParam0, 3);
}elseif(iParam2==3){
iVar4=iParam3;
iVar5=func_103(uParam0, 11);
iVar5=func_76(iParam1, iVar4, iVar5, 0);
}
iVar3=func_103(uParam0, 8);
...
iVar7=func_103(uParam0, 8);
iVar8=func_103(uParam0, 11);
...
if(func_83(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3))){
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_72(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_72(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_72(iParam0));
if(iVar57 > iVar56){
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_72(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_72(iParam1))){
return 1;
}
return 0;
}
...
void func_180(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18){
var uVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
Vector3 func__186(struct<3> Param0){
float fVar0;
float fVar1;
...
if(!func_218(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_218(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
Global_78341[1 /*14*/]={
func_113(iVar0, iParam1, uVar31[iParam1], -1) 
};
...
func_288(&uVar32, Var0.f_3, Global_100718, iParam1, iParam2);
}}
