...
int func_82(){
if(Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10 !=func_19()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_321.f_10, 1, 0)){
return 0;
}
...
func_86(func_87(), fVar3) + Var0 
};
(uParam1[iParam2 /*14*/])->f_1.f_3={
func_86(func_85(), fVar3) + Var0 
};
