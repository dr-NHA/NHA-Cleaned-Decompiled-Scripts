...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(210)) func_73();
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("letterscraps")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
func_72(12);
if(func_71(106)==1){
func_70(12);
func_67(287, 0, 0);
...
bLocal_619=true;
}elseif(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 189)){
...
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 190) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 189) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 202)) return true;
return false;
}
...
int num;
num=iParam0;
if(!MISC::ARE_STRINGS_EQUAL(&Global_112300[iParam0 /*28*/], "") && !MISC::IS_STRING_NULL(&Global_112300[iParam0 /*28*/]))if(IS_BIT_SET(Global_112300[iParam0 /*28*/].f_27, 1))if(IS_BIT_SET(Global_112300[iParam0 /*28*/].f_27, 2)) return func_19(num, &Global_112300[iParam0 /*28*/], &(Global_112300[iParam0 /*28*/].f_4), Global_112300[iParam0 /*28*/].f_20);
else return func_18(num, &Global_112300[iParam0 /*28*/], &(Global_112300[iParam0 /*28*/].f_4));
elseif(IS_BIT_SET(Global_112300[iParam0 /*28*/].f_27, 2)) return func_17(num, &Global_112300[iParam0 /*28*/], Global_112300[iParam0 /*28*/].f_20);
else return func_16(num, &Global_112300[iParam0 /*28*/]);
return false;
}
...
if(func_23(&uLocal_44, &iLocal_57) || bLocal_620) iLocal_43=2;
...
}elseif(uParam0->f_10==iLocal_608){
func_55(&uParam1->[uParam0->f_10 /*11*/], uParam0->f_7, joaat("PICKUP_CUSTOM_SCRIPT"), false, true, 2);
if(OBJECT::DOES_PICKUP_EXIST(uParam1->[uParam0->f_10 /*11*/].f_1)) INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(uParam1->[uParam0->f_10 /*11*/].f_1, sLocal_609);
}else{
...
if(uParam0->f_11)if(!Global_78819) func_24(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 1, &iLocal_610, &uLocal_611, "LETTERS_TITLE" /*Scrap Collected~s~*/, "LETTERS_COLLECT" /*~1~/50 letter scraps collected.*/);
...
i < func_31(iParam0);
i=i + 1){
if(IS_BIT_SET(Global_113648.f_10051.f_108, func_30(func_31(iParam0), i))) outValue=outValue + 1;
}}elseif(iParam0==6){
...
if(func_27(num, -1)) outValue=outValue + 1;
}}
return outValue;
}
...
if(*uParam0==1 || *uParam0==0) func_50(*uParam0, iParam2, true);
PAD::SET_CONTROL_SHAKE(PLAYER_CONTROL, 200, 250);
STATS::STAT_INCREMENT(uParam0->f_6, 1f);
if(bLocal_41) func_49(&(uParam0->f_1), iParam2);
else func_47(&(uParam0->f_1));
func_44();
...
num=num + outValue;
if(outValue > 0) func_45(18, outValue);
STATS::STAT_GET_INT(func_46(1), &outValue, -1);
num=num + outValue;
if(outValue > 0) func_45(19, outValue);
STATS::STAT_GET_INT(func_46(3), &outValue, -1);
num=num + outValue;
if(outValue > 0) func_45(20, outValue);
...
uParam0->f_4=num;
bLocal_40;
if(num==uParam0->f_3 && uParam0->f_2==705) func_65(168, 0);
return;
}
...
bLocal_40;
if(uParam0->f_4==uParam0->f_3 && uParam0->f_2==705) func_65(168, 0);
return;
}
...
if(bParam3) func_56(uParam0->f_3);
...
Vector3 func__63(int iParam0, int iParam1) // Position - 0x1D65{
switch (iParam0){
case 0:
if(iParam1==1) return 1034.2743f, -3026.2754f, 4.90197f;
else return 1026.7053f, -3026.0515f, 13.3323f;
break;
case 1:
if(iParam1==1) return -1040.9789f, -2743.5093f, 12.94983f;
else return -1048.6035f, -2734.218f, 12.8895f;
break;
case 2:
if(iParam1==1) return -93.9012f, -2711.3145f, 5.01752f;
else return -81.1199f, -2726.5112f, 7.74f;
break;
case 3:
return -917.6909f, -2527.3843f, 22.3218f;
case 4:
if(iParam1==1) return 746.45f, -2310.32f, 26.03f;
else return 748.922f, -2298.114f, 19.624f;
break;
case 5:
if(iParam1==1) return 1509.7421f, -2126.0376f, 75.21973f;
else return 1509.0994f, -2120.551f, 75.61f;
break;
case 6:
return 76.0032f, -1970.4752f, 20.1302f;
case 7:
if(iParam1==1) return -1.82327f, -1732.6144f, 28.29367f;
else return 0.067f, -1734.027f, 30.606f;
break;
case 8:
if(iParam1==1) return -1377.7656f, -1409.837f, 4.63205f;
else return -1380.4912f, -1404.3735f, 1.7273f;
break;
case 9:
...
case 14:
if(iParam1==1) return -1243.1036f, -507.8057f, 30.10775f;
else return -1238.7655f, -506.7138f, 37.6019f;
break;
case 15:
if(iParam1==1) return 83.79993f, -431.9302f, 36.55315f;
else return 86.4f, -433.9f, 36f;
break;
case 16:
...
case 19:
if(iParam1==1) return -3020.4749f, 36.55431f, 9.11777f;
else return -3021.4f, 38f, 10.2945f;
break;
case 20:
if(iParam1==1) return -347.52768f, 53.37161f, 52.97814f;
else return -347.3f, 54.865f, 53.921f;
break;
case 21:
...
case 24:
if(iParam1==1) return 688.1073f, 1204.6713f, 323.3438f;
else return 682.4505f, 1204.9277f, 344.3322f;
break;
case 25:
return -1548.7627f, 1380.1727f, 125.3728f;
case 26:
if(iParam1==1) return -432.14f, 1598.46f, 355.73f;
else return -432.0034f, 1597.1292f, 356.613f;
break;
case 27:
...
case 29:
if(iParam1==1) return 3069.213f, 2160.9883f, 1.1327f;
else return 3063.5828f, 2212.63f, 2.5863f;
break;
case 30:
return 180.21f, 2263.83f, 91.87f;
case 31:
if(iParam1==1) return 926.96f, 2445.36f, 49.09f;
else return 929.6946f, 2444.1155f, 48.43f;
break;
case 32:
if(iParam1==1) return -2380.2124f, 2655.1758f, 0.832f;
else return -2379.9482f, 2656.9534f, 1.4906f;
break;
case 33:
...
case 35:
if(iParam1==1) return 288.84085f, 2871.9116f, 42.6422f;
else return 265.7415f, 2866.416f, 73.19f;
break;
case 36:
if(iParam1==1) return 1297.378f, 2988.7102f, 40.11787f;
else return 1294.2f, 3001.9f, 57.7f;
break;
case 37:
...
case 39:
if(iParam1==1) return -3.51812f, 4332.4507f, 31.21602f;
else return -1.9585f, 4334.787f, 32.3702f;
break;
case 40:
return 1336.7367f, 4307.1997f, 37.1325f;
case 41:
if(iParam1==1) return -1007.10284f, 4836.936f, 268.5488f;
else return -1001.48f, 4851.322f, 273.6112f;
break;
case 42:
return 1877.09f, 5078.98f, 50.49f;
case 43:
if(iParam1==1) return 3366.0986f, 5182.4614f, 0.68317f;
else return 3436.4526f, 5176.911f, 6.386f;
break;
case 44:
if(iParam1==1) return -576.12f, 5472.24f, 59.28f;
else return -578.8057f, 5470.164f, 59.0295f;
break;
case 45:
...
case 48:
if(iParam1==1) return 1466.109f, 6552.2656f, 12.95773f;
else return 1469.6321f, 6552.1743f, 13.6854f;
break;
case 49:
if(iParam1==1) return 66.19278f, 6668.8877f, 30.80633f;
else return 66.7136f, 6663.1978f, 30.7821f;
break;
}
return 0f, 0f, 0f;
}
...
if(iParam0==146 || iParam0==-1) return 0;
...
if(bLocal_621) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(uLocal_44.f_7);
