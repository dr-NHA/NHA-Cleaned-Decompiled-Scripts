...
AUDIO::STOP_PED_SPEAKING(Local_443.f_28[1], 1);
}
if(func_457(Local_443.f_28[2])){
AUDIO::STOP_PED_SPEAKING(Local_443.f_28[2], 1);
}
...
ENTITY::SET_ENTITY_PROOFS(iLocal_508, 0, 0, 0, 0, 0, 0, 0, 0);
}
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_507, 0)){
func_206(777);
}}
iLocal_88=2;
}
...
if(MISC::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_508, 0)){
func_505("Back gate blocked");
Local_110={
-1130.35f, 307.92f, 65.19f 
};
TASK::OPEN_SEQUENCE_TASK(&uLocal_506);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_110, 2f, 20000, 1f, 1, 1193033728);
...
PED::SET_PED_KEEP_TASK(Local_443.f_28[0], 1);
TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[0], uLocal_506);
}
else{
func_505("Back gate clear");
TASK::OPEN_SEQUENCE_TASK(&uLocal_506);
if(func_207(iLocal_508)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
}else{
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_506);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_110, 2f, 20000, 1f, 1, 1193033728);
if(func_207(iLocal_508)){
TASK::TASK_ENTER_VEHICLE(0, iLocal_508, 20000, -1, 1073741824, 1, 0);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
}
else{
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
...
PED::SET_PED_FLEE_ATTRIBUTES(Local_443.f_28[0], 2, 1);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_506);
}
iLocal_532=MISC::GET_GAME_TIMER();
PED::SET_PED_CAN_BE_DRAGGED_OUT(Local_443.f_28[0], 1);
PED::SET_PED_CONFIG_FLAG(Local_443.f_28[0], 177, 1);
iLocal_102=1;
}
break;
case 1:
...
if(func_207(iLocal_508)){
if(PED::IS_PED_IN_VEHICLE(Local_443.f_28[0], iLocal_508, 1)){
if(VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_508) < 20f){
TASK::CLEAR_PED_TASKS(Local_443.f_28[0]);
TASK::TASK_LEAVE_ANY_VEHICLE(Local_443.f_28[0], 0, 4416);
TASK::TASK_SMART_FLEE_PED(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
func_237(&iLocal_508);
}}
if(func_457(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_508, 1)){
TASK::CLEAR_PED_TASKS(Local_443.f_28[0]);
TASK::TASK_SMART_FLEE_PED(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
func_237(&iLocal_508);
}}
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 1)){
...
iLocal_510=0;
while (iLocal_510 <=4){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_534[iLocal_510 /*7*/], Local_534[iLocal_510 /*7*/].f_3, Local_534[iLocal_510 /*7*/].f_6, 0, 1, 2)){
func_241("Player detected inside flee direction trigger:
", iLocal_510);
STREAMING::REQUEST_MODEL(iLocal_85);
STREAMING::REQUEST_MODEL(iLocal_84);
Local_89={
Local_570[iLocal_510 /*3*/] 
};
...
Local_89.f_7=VEHICLE::CREATE_VEHICLE(iLocal_85, Local_89, 0f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_89.f_7, 1084227584);
ENTITY::SET_ENTITY_QUATERNION(Local_89.f_7, Local_89.f_3, Local_89.f_4, Local_89.f_5, Local_89.f_6);
Local_89.f_8=PED::CREATE_PED_INSIDE_VEHICLE(Local_89.f_7, 6, iLocal_84, -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(Local_89.f_8, joaat("weapon_pistol"), -1, 0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_89.f_8, 1);
...
if(PED::IS_PED_IN_ANY_VEHICLE(Local_89.f_8, 0)){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_89.f_7, Local_89.f_9, Local_89.f_10, 1);
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(Local_89.f_7, 1);
...
if(func_207(Local_89.f_7)){
if(func_457(Local_89.f_8)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_89.f_8, 0);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[1], 0);
...
iLocal_101=3;
iLocal_511=MISC::GET_GAME_TIMER();
}elseif(func_243(Local_443.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[iVar0], 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_506);
TASK::TASK_SHOOT_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, joaat("FIRING_PATTERN_BURST_FIRE"));
TASK::CLOSE_SEQUENCE_TASK(uLocal_506);
TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[iVar0], uLocal_506);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_506);
}
iVar0++;
}
...
if(bParam4){
return 0;
}elseif(func_244(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__248(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_252(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_252(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__252(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_252(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
fVar4=132.53f;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0)){
Var1={
-1101.694f, 280.5019f, 63.38352f 
};
fVar4=85.45f;
}else{
Var1={
-1095.231f, 279.3389f, 62.7919f 
};
fVar4=84.67f;
}
}
...
if(func_207(iLocal_507)){
ENTITY::SET_ENTITY_COORDS(iLocal_507, -1107.5f, 280.33f, 64.01f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_507, 97.97f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_507, 1084227584);
}
iLocal_527++;
}
break;
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_272(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[0], uLocal_506);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_506);
PED::FORCE_PED_MOTION_STATE(Local_443.f_28[0], joaat("MotionState_DoNothing"), 0, 1, 0);
}}
...
if(func_457(Local_443.f_28[1])){
PED::FORCE_PED_MOTION_STATE(Local_443.f_28[1], joaat("MotionState_Aiming"), 0, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_506);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_506);
TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[1], uLocal_506);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_506);
func_505("*** Idle cop anim");
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0)){
if(func_457(Local_443.f_28[2])){
PED::FORCE_PED_MOTION_STATE(Local_443.f_28[2], joaat("MotionState_Aiming"), 0, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_506);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_506);
TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[2], uLocal_506);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_506);
...
if(func_457(Local_443.f_28[1])){
iLocal_504=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[1], 1), 1, 1065353216, 0, 0, 1);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
func_505("*** Registered Cop standing");
}
if(func_457(Local_443.f_28[2])){
iLocal_505=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[2], 1), 1, 1065353216, 0, 0, 1);
...
if(func_457(Local_443.f_28[0])){
if(iParam0==1){
ENTITY::SET_ENTITY_COORDS(Local_443.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_443.f_28[0], 193.1737f);
TASK::TASK_PLAY_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
}
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_443.f_28[0], 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_443.f_28[0], 1);
}
if(iParam0==1){
if(func_457(Local_443.f_28[2])){
WEAPON::GIVE_WEAPON_TO_PED(Local_443.f_28[2], joaat("weapon_pistol"), -1, 1, 1);
ENTITY::SET_ENTITY_COORDS(Local_443.f_28[2], -1106.08f, 288.55f, 63.31f, 1, 0, 0, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_506);
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_506);
TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[2], uLocal_506);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_506);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[2], 1);
}}
if(iParam0==1){
if(func_457(Local_443.f_28[1])){
WEAPON::GIVE_WEAPON_TO_PED(Local_443.f_28[1], joaat("weapon_pistol"), -1, 1, 1);
ENTITY::SET_ENTITY_COORDS(Local_443.f_28[1], -1102.41f, 289.73f, 63.18f, 1, 0, 0, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_506);
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_506);
TASK::TASK_PERFORM_SEQUENCE(Local_443.f_28[1], uLocal_506);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_506);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[1], 1);
}}
if(func_457(Local_443.f_28[1])){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_443.f_28[1], 23, 1);
}
if(func_457(Local_443.f_28[2])){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_443.f_28[2], 23, 1);
}
...
TASK::TASK_PLAY_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
func_505("Done Josh leadin anim");
if(func_267(Local_443.f_28[2])){
TASK::TASK_PLAY_ANIM(Local_443.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
func_505("Done Notepad cop leadin anim");
}
if(func_267(Local_443.f_28[1])){
TASK::TASK_PLAY_ANIM(Local_443.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
...
void func_328(){
if(func_457(Local_443.f_28[1])){
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_443.f_28[1], -1102.48f, 290.2f, 64.22f, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_443.f_28[1], 177.74f);
}else{
Local_443.f_28[1]=PED::CREATE_PED(6, iLocal_84, -1102.92f, 290.12f, -200f, 40.46f, 0, 0);
}
if(func_457(Local_443.f_28[2])){
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_443.f_28[2], -1103.94f, 290.21f, 64.28f, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_443.f_28[2], -167.67f);
}else{
Local_443.f_28[2]=PED::CREATE_PED(6, iLocal_84, -1102.73f, 290.91f, -200f, 92.06f, 0, 0);
}
if(!func_334()){
...
var uVar5;
var uVar6;
if((func_153(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0)){
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_286(iParam0, 0, 0)) || func_286(iParam0, 1, 0)) || func_286(iParam0, 2, 0)) || func_394(iParam0) !=145) || func_393(iParam0)) || func_392(iParam0)) || func_343(iParam0)) || func_391(iParam0)) || !func_381(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_392(iParam0)){
}
if(func_392(iParam0)){
}
...
}elseif(func_403(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, iVar1, ((*uParam1)[iVar0] - 1), false);
}}}
iVar0++;
}
if(func_370(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_401(*uParam0, ((*uParam1)[38] - 1))){
VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_401(*uParam0, ((*uParam1)[38] - 1)), false);
}
func_400(uParam0);
if(func_399(*uParam0)){
...
}elseif((!func_419(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_421(iParam0, uVar1[iVar6], 1) && func_420(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_415(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_378(iVar2))){
}else{
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_378(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_378(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_378(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_378(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_378(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_378(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_430(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_429()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_378(iVar7 + 1))){
...
var func__427(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
Local_89.f_11=0;
Local_534[0 /*7*/]={
-1152.526f, 278.2318f, 65.69334f 
};
Local_534[0 /*7*/].f_3={
-1136.277f, 239.0551f, 69.44059f 
};
Local_534[0 /*7*/].f_6=3.25f;
Local_534[1 /*7*/]={
-1151.918f, 287.2276f, 66.04018f 
};
Local_534[1 /*7*/].f_3={
-1137.051f, 290.5453f, 70.0429f 
};
Local_534[1 /*7*/].f_6=3.25f;
Local_534[2 /*7*/]={
-1093.003f, 295.5289f, 63.11537f 
};
Local_534[2 /*7*/].f_3={
-1069.194f, 293.5286f, 67.53568f 
};
Local_534[2 /*7*/].f_6=3.25f;
Local_534[3 /*7*/]={
-1050.776f, 284.3935f, 63.15669f 
};
Local_534[3 /*7*/].f_3={
-1050.369f, 244.0945f, 67.86394f 
};
Local_534[3 /*7*/].f_6=3.25f;
Local_534[4 /*7*/]={
-1065.411f, 229.6216f, 61.88657f 
};
Local_534[4 /*7*/].f_3={
-1104.021f, 232.1321f, 68.14975f 
};
Local_534[4 /*7*/].f_6=3.25f;
Local_570[0 /*3*/]={
-1357.57f, 200.1279f, 58.075f 
};
