...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1) || func_261(num)) func_273(&num, true);
if(func_260(43)){
...
func_189(&num);
if(func_174(&num, 0)){
if(!func_2(&num)) func_273(&num, true);
if(func_1(&num)) func_273(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xC25{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6A39{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x7189{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x7515{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7654{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x83D6{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BD8{
...
if(!func_196(&uLocal_265)) func_195(&uLocal_265);
else func_193(&uLocal_265);
iLocal_99=1;
iLocal_268=0;
}
break;
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0], false)) TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 4);
func_193(&uLocal_265);
iLocal_99=2;
}}
break;
...
if(func_196(piParam0))if(func_192(piParam0)) return piParam0->f_2;
else return func_191(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;
return piParam0->f_1;
}
...
if(!func_196(piParam0)) func_193(piParam0);
return;
}
...
if(func_201(PLAYER::PLAYER_ID())) return false;
...
if(Global_43257==17){
if(*uParam0 !=-1) func_217(uParam0);
}elseif(func_216()){
if(*uParam0 !=-1) func_217(uParam0);
}elseif(*uParam0==-1){
if(func_215(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_214(uParam0, 1);
}else{
...
if(func_215(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_217(uParam0);
}}}
return;
}
...
if(func_257(*panParam0) || func_255(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_289("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_250(panParam0->f_28[0]);
func_289("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_230(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_230(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_227(panParam0);
else func_225(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(func_224(&(panParam0->f_48)) && bParam1) func_221(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
if(func_223(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_223(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_222(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(iParam2==0) func_225(uParam0);
else func_227(uParam0);
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_149();
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_233(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_241(&iLocal_37[num /*4*/]);
return false;
}
if(!func_238(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_237();
if(num==-1) return false;
...
Vector3 func__236(Ped pedParam0, int iParam1) // Position - 0xF842{
...
float num;
unk={
func_240(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_240(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__240(float fParam0, var uParam1, var uParam2) // Position - 0xFA03{
float num;
float num2;
...
if(!bParam2){
if(func_248(pedParam0, bParam1, radius, num)) return true;
if(func_245(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_246(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_246(pedParam0, fParam1)) return true;
...
float num;
unk={
func_240(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_254() && !func_253()) return true;
if(!func_252(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_256() && Global_100681.f_11==6 && iParam0==func_172(&(Global_100681.f_3), 0)) return true;
return false;
}
...
iLocal_95=PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_92 -{
10f, 10f, 10f 
}
, uLocal_92 +{
10f, 10f, 10f 
...
uParam0->f_15=11f;
uParam0->f_27=0;
if(*uParam0==58) TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "tonya_mcs_1", 24);
elseif(*uParam0==59) TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "tonya_mcs_2", 24);
elseif(*uParam0==62) TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "tonya_mcs_3", 24);
...
break;
case 1:
if(!STREAMING::HAS_MODEL_LOADED(joaat("IG_Tonya")) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@tonya@intro") || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@tonya@base") || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@tonya@franklin_5@franklin_5a") || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@tonya@franklin_5@franklin_5b") || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@tonya@franklin_5@franklin_5c")) return false;
iLocal_91=2;
break;
case 2:
flag=true;
...
if(func_254() && !func_253()) return false;
...
if(func_252(iParam0)) return false;
...
int i;
if(*uParam0==1){
if(func_271(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
if(bLocal_97) PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_95, false);
func_289("SCRIPT TERMINATED");
SCRIPT::TERMINATE_THIS_THREAD();
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_281(&uParam0->[i]);
else func_280(&uParam0->[i]);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_285(&uParam0->[i]);
else func_284(&uParam0->[i], false, 1, 0);
}
return;
}
