...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
fVar0=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_92);
...
TASK::TASK_PERFORM_SEQUENCE(uParam0->f_28[0], uLocal_96);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_96);
}
}
elseif(*uParam0==59){
...
int func_197(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6){
...
int func_198(char* sParam0, int iParam1, bool bParam2){
Global_21726=0;
...
uParam1->f_3=5;
}elseif((func_223(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
Vector3 func__236(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_240(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_240(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__240(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_240(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
uLocal_95=PED::ADD_SCENARIO_BLOCKING_AREA(Local_92 - Vector(10f, 10f, 10f), Local_92 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
iLocal_97=1;
