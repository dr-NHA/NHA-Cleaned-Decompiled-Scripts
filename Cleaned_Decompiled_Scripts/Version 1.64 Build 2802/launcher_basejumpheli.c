...
elseif(!func_161(uLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_116(&iLocal_96);
...
if(func_161(uLocal_94, 2097152)){
if(!func_139(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52)){
func_154(10);
}}
...
void func_17(){
func_18(&uLocal_461, Local_287.f_0);
}
...
if(CAM::IS_CAM_ACTIVE(uLocal_461)){
CAM::SET_CAM_ACTIVE(uLocal_461, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_461, 0);
}
func_2();
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287.f_0, 0)){
...
uVar11=func_112(func_113(iLocal_121)==joaat("maverick"), 0.45f, 0.3f);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287.f_0, 0) && PED::IS_PED_IN_VEHICLE(Local_287.f_3, Local_287.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(Local_287.f_3, Local_287.f_0, ENTITY::GET_ENTITY_COORDS(Local_287.f_0, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287.f_0) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_287.f_0), 262144, 50f, 50f, 1);
}else{
TASK::TASK_SMART_FLEE_PED(Local_287.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
...
fVar10=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_108(iLocal_121));
if(fVar10 < 11664f){
if(!iLocal_460){
STREAMING::REQUEST_MODEL(func_107(iLocal_121));
iLocal_460=1;
}}elseif(fVar10 > 13924f){
if(iLocal_460){
...
if((STREAMING::HAS_MODEL_LOADED(func_107(iLocal_121)) && ENTITY::DOES_ENTITY_EXIST(Local_287.f_0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287.f_0, 0)){
Local_287.f_3=PED::CREATE_PED_INSIDE_VEHICLE(Local_287.f_0, 4, func_107(iLocal_121), -1, 1, 1);
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_287.f_0, 1, 1, 0);
VEHICLE::SET_HELI_BLADES_SPEED(Local_287.f_0, uVar11);
}}else{
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_287.f_3, 1, 0);
if(!CAM::DOES_CAM_EXIST(uLocal_461) || !CAM::IS_CAM_RENDERING(uLocal_461)){
VEHICLE::SET_HELI_BLADES_SPEED(Local_287.f_0, uVar11);
}
if(!MISC::IS_BIT_SET(Local_287.f_169, 0)){
if(CAM::IS_SCREEN_FADED_IN()){
if(!PED::IS_PED_INJURED(Local_287.f_3) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_287.f_3, 1)) < 400f){
...
func_18(&uLocal_461, Local_287.f_0);
if((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_287.f_0, 1) && !PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) && func_78(Local_287.f_3, Local_287.f_0)){
Var7={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_287.f_0, PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f)) 
};
...
if(!CAM::DOES_CAM_EXIST(uLocal_461)){
func_67(0, 0, 1);
func_60(1);
uLocal_461=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_59(iLocal_121), func_58(iLocal_121), func_57(iLocal_121), 0, 2);
CAM::SET_CAM_ACTIVE(uLocal_461, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SHAKE_CAM(uLocal_461, "HAND_SHAKE", 0.07f);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287.f_0, 0)){
...
func_24(&uLocal_462);
while (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_287.f_0, 0) && func_55(&uLocal_462) < 2f){
SYSTEM::WAIT(0);
}
func_11(&uLocal_462);
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_287.f_0, 0)){
bVar12=false;
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
if(CAM::DOES_CAM_EXIST(uLocal_461)){
CAM::DESTROY_CAM(uLocal_461, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(Local_287.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_287.f_0, 0)){
TASK::OPEN_SEQUENCE_TASK(&uVar6);
TASK::TASK_STAND_STILL(0, 500);
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_287.f_0, ENTITY::GET_ENTITY_COORDS(Local_287.f_0, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287.f_0) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_287.f_0), 262144, 50f, 50f, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar6);
TASK::TASK_PERFORM_SEQUENCE(Local_287.f_3, uVar6);
...
func_25(&uVar1);
while (func_12(&uVar1) < 2f){
SYSTEM::WAIT(0);
func_18(&uLocal_461, Local_287.f_0);
}}}}}
if(!bVar12){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287.f_0, 0) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_287.f_0, 1)) < 225f) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
...
void func_69(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
if(((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !ENTITY::DOES_ENTITY_EXIST(uParam1)) || ENTITY::IS_ENTITY_DEAD(iParam0, 0)) || ENTITY::IS_ENTITY_DEAD(iParam1, 0)){
return 0;
}
if(PED::IS_PED_IN_VEHICLE(iParam0, iParam1, 0) && func_79(iParam0, iParam1)==-1){
return 1;
}
return 0;
}
...
if(((!ENTITY::DOES_ENTITY_EXIST(uParam1) || ENTITY::IS_ENTITY_DEAD(iParam1, 0)) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0)) || FIRE::IS_ENTITY_ON_FIRE(iParam1)){
return 1;
}
if(ENTITY::DOES_ENTITY_EXIST(iParam0)){
...
if(MISC::IS_PROJECTILE_IN_AREA((Var1.f_0 - 5f), (Var1.f_1 - 5f), (Var1.f_2 - 5f), (Var1.f_0 + 5f), (Var1.f_1 + 5f), (Var1.f_2 + 5f), 0)){
return 1;
}
...
return func_111(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), uParam0, iParam1);
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_136()) || Global_112695) || Global_32166) || func_135()) || func_121(8, -1)) || func_134()) || func_133()) || func_132()) || func_123()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_136()) || Global_32166) || func_135()) || func_121(8, -1)) || func_132()) || func_134()) || func_133()) || func_123()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_136()) || Global_112695) || Global_32166) || func_135()) || func_121(8, -1)) || func_132()) || func_134()) || func_133()) || func_123()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_136()) || Global_112695) || Global_32166) || func_135()) || func_121(8, -1)) || func_134()) || func_133()) || func_123()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_136()) || Global_32166) || func_135()) || func_121(8, -1)) || func_133()) || func_132()) || func_123()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_136()) || func_133()) || Global_112695) || Global_32166) || func_135()) || Global_44446) || func_121(8, -1)) || func_132()) || func_131()) || func_123()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_136()) || Global_112695) || Global_32166) || func_135()) || func_121(8, -1)) || func_132()) || func_131()) || func_134()) || func_133()) || func_123()){
return 0;
}
break;
}}else{
...
var uVar0;
bool bVar1;
fLocal_93=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0);
...
if(iLocal_121==3){
Local_287.f_0=VEHICLE::CREATE_VEHICLE(joaat("frogger"), Param0, fParam3, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_287.f_0, 5);
}else{
Local_287.f_0=VEHICLE::CREATE_VEHICLE(joaat("maverick"), Param0, fParam3, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_287.f_0, 6);
}
iLocal_86=Local_287.f_0;
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_86, 1);
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Param0, &uVar0, 0, 0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_287.f_0, 1084227584);
}
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_287.f_0, 1);
iLocal_458=1;
}else{
iLocal_458=0;
}}
