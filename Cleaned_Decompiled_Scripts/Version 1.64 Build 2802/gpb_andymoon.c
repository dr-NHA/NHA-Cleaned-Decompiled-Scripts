...
if(character==CHAR_TREVOR)if(uLocal_299[2]==1) return 10;
elseif(uLocal_299[2]==2) return 6;
else return 14;
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR)if(uLocal_299[2]==1) TEXT_LABEL_ASSIGN_STRING(sParam0, "andy_ig_4_imspeakingthetruth", 64);
elseif(uLocal_299[2]==2) TEXT_LABEL_ASSIGN_STRING(sParam0, "andy_ig_5_didyouseethem", 64);
else TEXT_LABEL_ASSIGN_STRING(sParam0, "andy_ig_3_gotothehills", 64);
elseif(character==CHAR_MICHAEL) TEXT_LABEL_ASSIGN_STRING(sParam0, "andy_ig_2_whenwillistrike", 64);
elseif(character==CHAR_FRANKLIN) TEXT_LABEL_ASSIGN_STRING(sParam0, "andy_ig_2_b_theenergyisupbrother", 64);
return;
}
...
var func__83(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2E0C{
...
Vector3 func__87(float fParam0, var uParam1, var uParam2) // Position - 0x2F33{
float num;
float num2;
