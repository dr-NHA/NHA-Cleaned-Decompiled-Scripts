...
iLocal_93=2;
}elseif(!func_94("PRB_LEVAREA", 0, 0)){
...
var func__76(int iParam0, int iParam1){
...
bool func_95(int iParam0, struct<3> Param1, float fParam4, int iParam5){
return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, iParam5), Param1) <=(fParam4 * fParam4);
}


void func_96(){
func_131(&iLocal_268, &uLocal_269, &iLocal_95, &iLocal_219, &iLocal_218, Local_224, Local_282.f_0, 0, 11f);
switch (iLocal_93){
case 0:
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_282.f_0, 0)){
...
int func_97(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_5(iParam0)){
...
void func_105(int iParam0, struct<3> Param1, int iParam4){
if(!HUD::DOES_BLIP_EXIST(*iParam0)){
*iParam0=func_106(Param1, 5, iParam4);
}}

int func_106(struct<3> Param0, int iParam3, int iParam4){
int iVar0;
iVar0=0;
...
iLocal_92=2;
return 1;
}elseif((((func_124(2, Local_282.f_1, Local_282.f_4) && func_124(5, Local_270.f_1, Local_270.f_4)) && func_124(6, Local_276.f_1, Local_276.f_4)) && func_124(3, Local_252.f_1, Local_252.f_4)) && func_124(4, Local_221, 0)){
...
TASK::TASK_PLAY_ANIM_ADVANCED(Local_252.f_0, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_270.f_0, Local_249), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_270.f_0), 1000f, -1.5f, -1, 1, 0, 2, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_252.f_0, 0, 0);
}
func_120();
func_118();
PED::SET_PED_CONFIG_FLAG(Local_252.f_0, 154, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_252.f_0, uLocal_288);
}
...
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Tow_truck_damage", Local_270.f_0, "FBI_04_HEAT_SOUNDS", 0, 0);
return 1;
}}else{
return 1;
}}
...
MISC::CLEAR_AREA(Local_252.f_1, 100f, 1, 0, 0, 0);
func_115();
if(func_449(Local_252.f_0)){
...
if(!HUD::DOES_BLIP_EXIST(*iParam0)){
*iParam0=func_117(iParam1, iParam2, 5);
}}

int func_117(var uParam0, var uParam1, int iParam2){
int iVar0;
iVar0=0;
if(func_5(uParam0)){
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_282.f_0, 1);
return 1;
}}elseif(func_128(&Local_282, Local_282.f_5, Local_282.f_1, Local_282.f_4, 1)){
func_129(Local_282.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_282.f_0, 1);
return 1;
}
...
PED::SET_PED_CAPSULE(Local_252.f_0, 0.1f);
AUDIO::STOP_PED_SPEAKING(Local_252.f_0, 1);
TASK::SET_PED_PATH_MAY_ENTER_WATER(Local_252.f_0, 0);
return 1;
}}else{
return 1;
}}elseif(func_125(&Local_252, Local_252.f_5, Local_252.f_1, Local_252.f_4, 1, 0, 1, 1)){
PED::SET_PED_CAPSULE(Local_252.f_0, 0.1f);
AUDIO::STOP_PED_SPEAKING(Local_252.f_0, 1);
...
return 1;
}}elseif(func_128(&Local_270, Local_270.f_5, Local_270.f_1, Local_270.f_4, 1)){
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_270.f_0, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_270.f_0, 4, 0, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_270.f_0, 0, 1, 0);
...
return 1;
}}elseif(func_128(&Local_276, Local_276.f_5, Local_276.f_1, Local_276.f_4, 1)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_276.f_0, 3);
return 1;
}
break;
...
int func_125(var uParam0, var uParam1, struct<3> Param2, var uParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
...
int func_127(var uParam0, char* sParam1, int iParam2){
...
int func_128(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6){
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_131(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, struct<3> Param5, int iParam8, bool bParam9, int iParam10){
if(func_6(*iParam0)){
switch (*iParam2){
case 0:
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0)){
...
*iParam2=2;
}}elseif(func_137(*iParam0) || func_136(*iParam0)){
func_27(iParam3);
if(func_94(func_102(func_66()), 0, 0)){
HUD::CLEAR_THIS_PRINT(func_102(func_66()));
}
...
int iVar0;
int iVar1;
if((func_449(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_6(iParam0)){
...
if(!func_142()){
if(func_449(Local_252.f_0)){
if(func_137(PED::GET_VEHICLE_PED_IS_IN(Local_252.f_0, 0))){
...
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), Local_224, 4, 20f, 786469, 2f, 10f, 1);
iLocal_97[iParam0]=5;
}
break;
case 5:
...
case 0:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_252.f_0, Var3) 
};
if(!MISC::IS_POSITION_OCCUPIED(Var0, 1.5f, 0, 0, 1, 0, 0, Local_252.f_0, 0)){
if(!bLocal_248){
if(iParam0==0){
sVar6="FP2_MTAKEDOW";
}
...
case 4:
break;
}}elseif(!func_121(iParam1, joaat("script_task_stealth_kill"))){
return 1;
}
return 0;
}
...
if(!func_151()){
if((ENTITY::DOES_ENTITY_EXIST(iLocal_268) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_268, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_268, Local_224, 2f, 2f, 2f, 0, 1, 0)){
...
if(!func_151()){
if(func_449(Local_252.f_0)){
if(((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam1, -408.0286f, -2175.476f, 5.31836f, -394.644f, -2175.297f, 15.31835f, 21.52f, 0, 1, 0) && !func_153(iParam0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_252.f_0)) && !PED::IS_PED_IN_ANY_VEHICLE(iParam1, 0)){
...
break;
case 9:
if(func_209(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 20f, 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_210(10);
return;
}
if(func_208()){
...
if(!func_209(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 10f, 1)){
func_210(14);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 1)){
func_210(14);
}else{
func_210(13);
}}elseif(func_202(Local_252.f_0, 1, 0, 0, 0)){
func_210(14);
}
break;
case 15:
...
case 16:
if(func_6(Local_282.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_252.f_0, Local_282.f_0, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(Local_252.f_0, uVar0);
...
int func_158(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12){
bool bVar0;
if(iParam3==0){
...
Var1={
func_192(ENTITY::GET_ENTITY_COORDS(iVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
Var4={
...
}}elseif(!func_121(Local_252.f_0, joaat("script_task_achieve_heading"))){
...
func_210(13);
}}elseif(((((iLocal_96 !=15 && iLocal_96 !=9) && iLocal_96 !=10) && iLocal_96 !=6) && iLocal_96 !=8) && iLocal_96 !=7){
func_210(15);
}}
...
Vector3 func__197(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
}elseif((MISC::GET_GAME_TIMER() - iLocal_235) > 6000){
return 1;
}}}elseif(func_209(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 10f, 1)){
if(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 10f){
if(iLocal_235==-1){
iLocal_235=MISC::GET_GAME_TIMER();
}elseif((MISC::GET_GAME_TIMER() - iLocal_235) > 5500){
return 1;
}}}else{
iLocal_235=-1;
}
...
if(!func_121(Local_252.f_0, joaat("script_task_play_anim"))){
if(func_6(Local_270.f_0)){
TASK::TASK_PLAY_ANIM(Local_252.f_0, "mini@repair", "fixing_a_ped", 1.5f, -1.5f, -1, 1, 0, 0, 0, 0);
}}
break;
case 3:
...
if(!func_121(Local_252.f_0, joaat("script_task_enter_vehicle"))){
if(func_6(Local_270.f_0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_252.f_0, 0)){
...
TASK::TASK_VEHICLE_MISSION(Local_252.f_0, Local_276.f_0, Local_270.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}else{
func_213();
iParam0=10;
}
...
elseif(iLocal_95==1){
if(!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_276.f_0)){
TASK::TASK_VEHICLE_MISSION(Local_252.f_0, Local_276.f_0, Local_282.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}else{
func_213();
iParam0=10;
}
}}}elseif(func_6(Local_270.f_0) && func_6(Local_282.f_0)){
if(bLocal_227){
if(!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_282.f_0)){
TASK::TASK_VEHICLE_MISSION(Local_252.f_0, Local_282.f_0, Local_270.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}
else{
func_213();
iParam0=10;
...
TASK::TASK_VEHICLE_MISSION(Local_252.f_0, Local_270.f_0, Local_282.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}
else{
func_213();
iParam0=10;
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_288, joaat("player"));
...
TASK::TASK_SMART_FLEE_PED(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
}
break;
case 15:
if(!func_121(Local_252.f_0, joaat("script_task_combat"))){
...
TASK::TASK_PERFORM_SEQUENCE(Local_252.f_0, uVar1);
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_252.f_0, sParam0, "S_M_M_TRUCKER_01_BLACK_FULL_02", "SPEECH_PARAMS_FORCE", 0);
}
...
if(!func_235() || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
void func_229(){
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_252.f_0, 1)){
func_194();
}else{
if(func_6(Local_282.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_252.f_0, Local_282.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_252.f_0, Local_282.f_0, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
iLocal_96=14;
return;
}}
if(func_6(Local_270.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_252.f_0, Local_270.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_252.f_0, Local_270.f_0, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
iLocal_96=14;
return;
}}
if(func_6(Local_276.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_252.f_0, Local_276.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_252.f_0, Local_276.f_0, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
iLocal_96=14;
}}}
...
if(bParam4){
return 0;
}elseif(func_231(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
int func_235(){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_252.f_0, 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}
return 0;
}
...
func_210(15);
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_282.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
}}elseif(PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_270.f_0)){
func_210(15);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_270.f_0, PLAYER::PLAYER_PED_ID(), 1)){
if(!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 4)){
func_210(15);
}}}}}
if(func_239()){
if(func_95(Local_270.f_0, Local_270.f_1, 2f, 1)){
func_210(5);
}}}elseif((((((func_241() && iLocal_96 !=7) && iLocal_96 !=6) && iLocal_96 !=8) && iLocal_96 !=11) && iLocal_96 !=16) && iLocal_96 !=7){
func_210(16);
}}
...
if(func_209(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 2f, 1) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
}}elseif(func_95(PLAYER::PLAYER_PED_ID(), Local_224, 240f, 1)){
if(iLocal_290){
func_133(&iLocal_289);
iLocal_290=0;
}}}
...
return;
}}elseif(!func_209(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 200f, 1)){
if(ENTITY::IS_ENTITY_ON_SCREEN(Local_252.f_0)){
func_207(&Local_252, 0, 1, 1);
func_133(&Local_270);
}else{
...
void func_251(){
func_252();
func_131(&iLocal_268, &uLocal_269, &iLocal_95, &iLocal_219, &iLocal_218, Local_224, Local_282.f_0, 0, 1090519040);
func_156();
func_145();
switch (iLocal_93){
case 0:
...
if(func_6(Local_270.f_0)){
if(!bLocal_227){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_270.f_0, 0)){
bLocal_227=true;
}}elseif(!PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_270.f_0)){
bLocal_227=false;
}}}
...
void func_254(struct<3> Param0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7){
var uVar0;
int iVar1;
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_323(iVar10, iParam1, iParam2, -1) 
};
if(!func_322(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_323(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_302(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_323(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_323(iVar10, iVar0, func_281(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_323(iVar10, 14, uVar69[iVar1], -1) 
};
func_292(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_315(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_323(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_310(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_309(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_282(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_282(iParam2));
...
func_317(iVar2, uVar3, iVar0, 1, 0);
}}


void func_317(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4){
int iVar0;
if(bParam4){}
...
uVar0=Global_2805027[iParam0 /*3*/][func_318(iParam1)];
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_282(iParam0));
if(iVar57 > iVar56){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78341[1 /*14*/]={
func_323(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_282(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_282(iParam1))){
return 1;
}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
func_392(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
}}}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_412(iParam0, 0, 0)) || func_412(iParam0, 1, 0)) || func_412(iParam0, 2, 0)) || func_435(iParam0) !=145) || func_411(iParam0)) || func_410(iParam0)) || func_409(iParam0)) || func_408(iParam0)) || !func_396(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_410(iParam0)){
}
if(func_410(iParam0)){
}
...
iVar0=0;
if(!func_6(iLocal_268)){
if(!func_6(uLocal_269) && !func_6(Local_282.f_0)){
func_448(1);
return;
}
if(func_6(Local_282.f_0)){
...
if(!func_209(PLAYER::PLAYER_PED_ID(), uLocal_269, 500f, 1)){
iVar0++;
}}else{
iVar0++;
}
...
if(func_455()==0){
uVar0=func_319(func_454(iParam0), -1, 0);
MISC::CLEAR_BIT(&uVar0, bParam1);
func_317(func_454(iParam0), uVar0, -1, 1, 0);
}}else{
...
if(func_455()==0){
return MISC::IS_BIT_SET(func_319(func_454(iParam0), -1, 0), iParam1);
}}else{
...
struct<3> Var0[5];
Var0[0 /*3*/]={
-1138.69f, -1893.385f, 2.453f 
};
Var0[1 /*3*/]={
-1067.893f, -1941.208f, 12.1445f 
};
Var0[2 /*3*/]={
-1062.374f, -2034.396f, 12.1273f 
};
Var0[3 /*3*/]={
-1178.806f, -2101.68f, 12.3805f 
};
Var0[4 /*3*/]={
-1250.224f, -2047.043f, 8.9687f 
};
func_466(&Var0, 5);
}
...
void func_472(){
Local_252={
func_473(-409.7205f, -2175.858f, 9.31836f, 121.7754f, joaat("s_m_m_trucker_01")) 
};
}
...
void func_474(){
Local_282={
func_475(-413.2349f, -2182.086f, 9.3184f, 83.9445f, joaat("towtruck")) 
};
Local_270={
func_475(-412.3477f, -2176.262f, 9.3184f, 281.0786f, joaat("peyote")) 
};
Local_276={
func_475(-386.5059f, -2168.738f, 9.3184f, 87.2085f, joaat("ruiner")) 
};
}
