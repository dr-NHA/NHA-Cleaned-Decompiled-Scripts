...
iLocal_70=318;
iLocal_71=1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)) func_56();
SYSTEM::WAIT(0);
func_37();
func_33();
func_29();
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_237, true) > 100f) return true;
return false;
}
...
if(func_9(uParam0))if(func_6(uParam0) < fParam1) return true;
return false;
}


float func_6(var uParam0) // Position - 0x257{
if(func_9(uParam0))if(func_7(uParam0)) return uParam0->f_2;
else return uParam0->f_1 - func_4(IS_BIT_SET(*uParam0, 4));
return uParam0->f_1;
}
...
if(!func_9(&uLocal_241)) func_12(&uLocal_241, MISC::GET_RANDOM_FLOAT_IN_RANGE(1.75f, 2.25f) * 2f);
return false;
}


void func_12(int* piParam0, float fParam1) // Position - 0x38C{
if(!func_9(piParam0)) func_3(piParam0, fParam1);
return;
}
...
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam1, vector) 
};
...
if(func_19(0) || func_19(3) || func_19(2))if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !func_18()) return true;
...
if(func_19(14)) return 0;
if(MISC::GET_IS_PLAYER_IN_ANIMAL_FORM()) return 0;
if(!func_22(iParam0, func_23())) return 0;
...
}elseif(eParam1==func_21(Global_100402) && eParam1 !=0){
Global_100402=0;
}}
return 1;
}
...
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(CAM::IS_SCREEN_FADED_OUT()) func_32();
return;
}
...
if(!VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_153[2]) > 0) VEHICLE::ATTACH_VEHICLE_TO_TRAILER(iLocal_153[0], iLocal_153[2], 1065353216);
if(!VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_153[3]) > 0) VEHICLE::ATTACH_VEHICLE_TO_TRAILER(iLocal_153[1], iLocal_153[3], 1065353216);
for (i=0;
i < 4;
i=i + 1){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_181[i], false)){
...
if(ENTITY::GET_ENTITY_MODEL(pedParam0)==joaat("A_M_M_Salton_01"))if(PED::GET_PED_DRAWABLE_VARIATION(pedParam0, PV_COMP_UPPR)==1)if(_GET_RANDOM_BOOL()) PED::SET_PED_COMPONENT_VARIATION(pedParam0, PV_COMP_UPPR, 0, PED::GET_PED_TEXTURE_VARIATION(pedParam0, PV_COMP_UPPR), 0);
else PED::SET_PED_COMPONENT_VARIATION(pedParam0, PV_COMP_UPPR, 2, PED::GET_PED_TEXTURE_VARIATION(pedParam0, PV_COMP_UPPR), 0);
return;
}
...
if(STREAMING::HAS_MODEL_LOADED(iLocal_72[randomIntInRange])) return randomIntInRange;
unk=4;
endRange=0;
for (i=0;
i < iLocal_72;
...
i < iLocal_72;
i=i + 1){
if(unk[randomIntInRange]==iLocal_72[i]) return i;
}
...
Vector3 func__45(int iParam0, int iParam1) // Position - 0x2209{
...
uParam1->[1]=-18.0565f;
uParam0->[2 /*3*/]={
-23.7805f, 13.1962f, 0f 
};
uParam1->[2]=-18.3452f;
uParam0->[3 /*3*/]={
-29.6605f, 16.1762f, 0f 
};
uParam1->[3]=-21.835f;
uParam0->[4 /*3*/]={
-14.3505f, 6.5462f, 0f 
...
uParam0->[i /*3*/]={
uParam0->[i /*3*/] + (unk *{
1f + (SYSTEM::TO_FLOAT(i) / SYSTEM::TO_FLOAT((*uParam0 + 1) - 2)), 1f + (SYSTEM::TO_FLOAT(i) / SYSTEM::TO_FLOAT((*uParam0 + 1) - 2)), 1f + (SYSTEM::TO_FLOAT(i) / SYSTEM::TO_FLOAT((*uParam0 + 1) - 2)) 
}
) 
};
uParam0->[i /*3*/]={
uParam0->[i /*3*/] + func_45(-1090519040, 1056964608) 
};
uParam1->[i]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-22f, -15f);
}
uParam2->[0 /*3*/]={
-19.4623f, -36.7339f, 0f 
};
uParam2->[1 /*3*/]={
-11.7179f, -35.5764f, 0f 
};
uParam2->[2 /*3*/]={
uParam2->[0 /*3*/] + unk 
};
...
if(func_51(entityCoords, 0f, 0f, 0f, false)) entityCoords={
