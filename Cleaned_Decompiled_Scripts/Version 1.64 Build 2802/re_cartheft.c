...
Local_317={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_77, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_77, "wheel_lr")) 
};
Local_320={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_77, Local_317) 
};
...
Local_323={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_77, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_77, "wheel_rr")) 
};
Local_326={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_77, Local_323) 
};
...
elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_77, PLAYER::PLAYER_PED_ID(), 1)){
if(!PED::IS_PED_INJURED(iLocal_76)){
...
if(bLocal_301==1){
Local_93={
-2258.759f, 4274.059f, 45.9166f 
};
}elseif(bLocal_61){
Local_93={
-483.4162f, -2160.874f, 8.359f 
};
}else{
Local_93={
-485.9905f, -2153.542f, 8.1999f 
};
}
...
elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_77, iLocal_75, 20f, 20f, 7f, 0, 1, 0)){
func_63();
if(func_62()){
if(VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_75, iLocal_77, -1, 0, 0)){
if(!bLocal_296){
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_63)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_77, 0)){
...
if(func_45(ENTITY::GET_ENTITY_HEADING(iLocal_77), 336f, 90f)){
Local_90={
-2254.3f, 4273.361f, 44.9697f 
};
fLocal_105=336.6557f;
Local_87={
-2252.683f, 4274.16f, 45.0612f 
};
Local_93={
-2257.825f, 4269.189f, 44.6334f 
};
fLocal_106=272.8688f;
Local_113={
-2254.588f, 4277.307f, 45.6133f 
};
Local_116={
6.6248f, 0.0369f, 179.5595f 
};
}
else{
Local_90={
-2254.223f, 4272.33f, 44.9193f 
};
fLocal_105=148.0287f;
Local_93={
-2255.733f, 4271.32f, 44.8166f 
};
fLocal_106=179.4774f;
Local_87={
-2257.088f, 4268.938f, 44.6456f 
};
Local_113={
-2255.775f, 4274.144f, 46.0666f 
};
Local_116={
2.8781f, 0.3464f, -146.6097f 
};
}}
Var4={
-2269.34f, 4279.89f, 45.47f 
};
fVar7=53.23f;
fLocal_112=50f;
...
Local_113={
-478.7095f, -2163.598f, 10.3091f 
};
Local_116={
-7.4391f, 0.0006f, 35.6865f 
};
Local_90={
-484.9581f, -2155.266f, 8.248f 
};
fLocal_105=243.308f;
fLocal_112=22f;
}else{
Local_113={
-488.0143f, -2149.419f, 9.9817f 
};
Local_116={
-11.7475f, 0.0006f, -145.0045f 
};
Local_90={
-484.3195f, -2154.188f, 8.2182f 
};
fLocal_105=64.6764f;
fLocal_112=36.9289f;
}
Var4={
-486.92f, -2169.01f, 8.89f 
};
fVar7=63.1f;
ENTITY::SET_ENTITY_COORDS(iLocal_77, Local_90, 1, 0, 0, 1);
WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), 1);
...
Local_313={
ENTITY::GET_ENTITY_ROTATION(iLocal_77, 2) 
};
if(func_168(iLocal_80)){
...
iLocal_51=4;
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_302) && !bLocal_342){
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_75, 1, 0);
}else{
PED::SET_PED_RESET_FLAG(iLocal_75, 310, 1);
}}
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_302)){
if(iLocal_316==0){
...
if(bLocal_342){
Var0={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_306, sLocal_309, Local_310, Local_313, 1f, 2) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &(Var0.f_2), 0, 0);
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Var0, 1, 0, 0, 1);
Var0={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_306, sLocal_309, Local_310, Local_313, 1f, 2) 
};
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_39(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
var func__52(int iParam0, int iParam1){
...
var func__66(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_88(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=1;
uParam0->f_7=1;
}}elseif(func_102(bParam1, bParam2, bParam3)){
uParam0->f_4=MISC::GET_GAME_TIMER();
uParam0->f_5=1;
uParam0->f_7=1;
...
uParam0->f_5=0;
}elseif(!func_103(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_100(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_101(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
return 1;
}elseif(!ENTITY::IS_ENTITY_OCCLUDED(iLocal_77)){
return 1;
}}
return 0;
}
...
if(func_118()){
iLocal_50=1;
}}elseif(!PED::IS_PED_RAGDOLL(iLocal_75) && !TASK::IS_PED_GETTING_UP(iLocal_75)){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_78);
iLocal_50=2;
}}elseif(PED::IS_PED_FACING_PED(iLocal_75, PLAYER::PLAYER_PED_ID(), 60f)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_75, joaat("script_task_perform_sequence")) !=1){
TASK::OPEN_SEQUENCE_TASK(&uLocal_78);
TASK::TASK_PLAY_ANIM(0, sLocal_84, "arms_waving", 2f, -8f, -1, 0, 0, 0, 0, 0);
if(bLocal_61==0){
...
elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_75, sLocal_83, "waiting", 3)){
...
elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_75, "RANDOM@CAR_THIEF@WAITING_IG_4", "idle_a", 3)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_75, joaat("script_task_perform_sequence"))==7){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_75, uLocal_78);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_78);
}elseif((MISC::GET_GAME_TIMER() - iLocal_304) > 6000){
iLocal_59=1;
}}
}
elseif(!PED::IS_PED_FACING_PED(iLocal_75, PLAYER::PLAYER_PED_ID(), 70f)){
...
}}elseif(!PED::IS_PED_FACING_PED(iLocal_75, PLAYER::PLAYER_PED_ID(), 50f)){
...
Var10={
func_150(iParam0, iParam1, iParam2, bParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9) 
};
iVar20=0;
func_149(&iVar20);
...
Var1={
Var1 + PED::GET_PED_BONE_COORDS(iLocal_75, 31086, 0f, 0f, 0f) 
};
Var4={
Var4 + PED::GET_PED_BONE_COORDS(iLocal_75, 31086, 0f, 0f, 0f) 
};
...
case 1:
Local_96={
-2257.482f, 4266.638f, 44.5095f 
};
fLocal_110=293.9091f;
Local_99={
-2253.763f, 4273.17f, 44.977f 
};
...
case 2:
Local_99={
-538.6718f, -2183.442f, 5.2336f 
};
Local_96={
-365.7f, -2179.26f, 9.3184f 
};
...
VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(iLocal_77, 0, 0);
...
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Local_52 
};
uLocal_55=MISC::GET_HEADING_FROM_VECTOR_2D(Var0.f_0, Var0.f_1);
}
...
fLocal_106=272.8688f;
Local_113={
-2258.04f, 4272.244f, 45.75466f 
};
Local_116={
1.729481f, 0f, -114.9352f 
};
}else{
Local_90={
-2253.634f, 4269.119f, 44.7686f 
};
fLocal_105=336.143f;
Local_93={
-2255.733f, 4271.32f, 44.8166f 
...
Local_113={
-2254.886f, 4273.539f, 46.2282f 
};
Local_116={
-7.492095f, 0f, -168.1909f 
};
}}else{
if(bLocal_61){
...
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -583.0884f, -2234.249f, 4.523423f, -685.1817f, -2350.904f, 17.07073f, 178f, 0, 1, 0)){
...
Local_90={
-501.9105f, -2148.019f, 8.0392f 
};
fLocal_105=294.4744f;
Local_87={
-501.0442f, -2150.799f, 8.139f 
};
Local_93={
-493.8062f, -2156.036f, 8.1978f 
};
Local_113={
-504.365f, -2144.534f, 9.8585f 
};
Local_116={
-6.6935f, 0f, -127.8147f 
};
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_112695) || Global_32166) || func_226()) || func_59(8, -1)) || func_225()) || func_224()) || func_223()) || func_222()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_227()) || Global_32166) || func_226()) || func_59(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_112695) || Global_32166) || func_226()) || func_59(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_112695) || Global_32166) || func_226()) || func_59(8, -1)) || func_225()) || func_224()) || func_222()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_32166) || func_226()) || func_59(8, -1)) || func_224()) || func_223()) || func_222()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_227()) || func_224()) || Global_112695) || Global_32166) || func_226()) || Global_44446) || func_59(8, -1)) || func_223()) || func_221()) || func_222()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_112695) || Global_32166) || func_226()) || func_59(8, -1)) || func_223()) || func_221()) || func_225()) || func_224()) || func_222()){
return 0;
}
break;
}}else{
...
bLocal_301=true;
}elseif(SYSTEM::VDIST(Local_52, -500.924f, -2165.36f, 7.6988f) < 5f){
bLocal_301=2;
}}
