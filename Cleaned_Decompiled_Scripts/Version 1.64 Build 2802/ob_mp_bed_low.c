...
Local_337={
262.9207f, -1002.98f, -100.0086f 
};
Local_340={
261.0173f, -1002.98f, -98.0086f 
};
fLocal_346=230.5943f;
Local_347={
262.74f, -1004.344f, -99.575f 
};
Local_350={
0f, 0f, -162.36f 
};
...
Local_343={
261.8297f, -1002.928f, -99.0062f 
};
while (true){
SYSTEM::WAIT(0);
if((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || func_73()==5)) && !func_65()){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_343, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) < 3f){
switch (iLocal_325){
case 0:
if(func_64()){
iLocal_325=1;
...
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_343, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > (3f + 2f)){
func_82();
}}else{
func_82();
}}}
...
Local_343={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_333, sLocal_334, Local_347, Local_350, 0, 2) 
};
Var3={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_333, sLocal_334, Local_347, Local_350, 0, 2) 
};
fLocal_346=Var3.f_2;
...
func_11(1);
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
uLocal_331=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uLocal_330);
...
var func__15(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_21(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
}elseif(bVar14 || (!func_18(PLAYER::PLAYER_ID(), 0) && !func_22())){
...
return MISC::IS_BIT_SET(Global_1653913.f_241.f_136[func_47(9) /*33*/][iParam0], func_46(9));
}
...
if((((((MISC::IS_BIT_SET(Global_1835487, iParam0) || Global_1835488 !=-1) || func_63()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_62()) || func_59(iParam0)){
return 0;
}
