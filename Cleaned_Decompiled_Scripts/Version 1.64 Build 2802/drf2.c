...
uLocal_419={
-1907.785f, -574.8f, 18.616f 
};
uLocal_422={
-1895.5337f, -564.2134f, 11.3497f 
};
fLocal_425=179f;
fLocal_426=314.381f;
fLocal_427=54.08f;
...
iLocal_432=_GET_RANDOM_BOOL() ? 0 :
1;
iLocal_433=_GET_RANDOM_BOOL() ? 0 :
1;
iLocal_434=_GET_RANDOM_BOOL() ? 0 :
1;
...
if(!PLAYER::IS_PLAYER_DEAD(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
while (true){
SYSTEM::WAIT(0);
if(iLocal_60 !=15 && iLocal_60 !=17) PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
switch (iLocal_60){
case 0:
if(func_250()) WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), -1, false, true);
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) func_137(&uLocal_407, PLAYER::PLAYER_PED_ID(), 0, 2);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_399, false)) func_137(&uLocal_413, pedLocal_399, 0, 2);
flag6=true;
}}}
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&uLocal_407, 0)) func_132(pedLocal_399, true, false);
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&uLocal_413, 0)) func_132(pedLocal_399, false, true);
...
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
iLocal_60=3;
if(CAM::IS_SCREEN_FADED_OUT()) flag8=true;
}
break;
case 3:
func_120();
if(CAM::IS_SCREEN_FADED_OUT() || flag8){
if(flag8) CAM::DO_SCREEN_FADE_OUT(0);
func_119(&uLocal_251);
...
uLocal_61.f_20=1;
if(bLocal_435) CUTSCENE::REMOVE_CUTSCENE();
func_107(&(uLocal_61.f_12), &uLocal_61, func_252());
flag6=false;
func_119(&uLocal_251);
}
...
flag3=true;
}elseif(func_135(&uLocal_251) >=14f){
uLocal_61.f_20=2;
flag3=true;
HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
}elseif(!flag4 && func_135(&uLocal_251) >=7f){
TEXT_LABEL_ASSIGN_STRING(&unk11, "DRF_PROMPT", 16);
_CONVERSATION_ADD_LINE(&uLocal_83, &unk7, &unk11, 9, 0, 0, 0);
flag4=true;
}}elseif(func_135(&uLocal_251) > 5f && func_134() || CUTSCENE::HAS_CUTSCENE_LOADED() && uLocal_61.f_20 !=1 || func_135(&uLocal_251) > num || func_93(iLocal_82, pedLocal_399, &caLocal_404)){
func_90();
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &uLocal_407, 0, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(pedLocal_399, false)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_399, &uLocal_413, 0, 0, 0);
...
if(func_89() && CUTSCENE::IS_CUTSCENE_PLAYING() && !CAM::IS_SCREEN_FADING_OUT() && !CAM::IS_SCREEN_FADED_OUT()) CUTSCENE::STOP_CUTSCENE(false);
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false)){
if(iLocal_82==4){
AUDIO::STOP_STREAM();
...
if(!bLocal_436){
STREAMING::NEW_LOAD_SCENE_START(-1903.8698f, -562.9188f, 12.8354f, func_76({
12.8015f, -560.0015f, -1901.3314f 
}
-{
12.8354f, -562.9188f, -1903.8698f 
}
), 100f, 0);
bLocal_436=true;
SYSTEM::WAIT(0);
}
if(!bLocal_437) bLocal_437=true;
...
if(iLocal_82==4) STREAMING::NEW_LOAD_SCENE_START(-1905.4998f, -557.8768f, 12.4125f, func_76({
11.9712f, -560.4745f, -1903.8552f 
}
-{
12.4125f, -557.8768f, -1905.4998f 
}
), 100f, 0);
else STREAMING::NEW_LOAD_SCENE_START(-1903.8698f, -562.9188f, 12.8354f, func_76({
12.8015f, -560.0015f, -1901.3314f 
}
-{
12.8354f, -562.9188f, -1903.8698f 
...
if(!func_75(&unk4)){
func_243(&unk4);
}elseif(func_135(&unk4) > func_74(func_252())){
if(func_252()==4){
...
break;
case 15:
if(CAM::IS_SCREEN_FADED_OUT() && !CAM::IS_SCREEN_FADING_IN()) CAM::DO_SCREEN_FADE_IN(500);
if(ENTITY::IS_ENTITY_DEAD(pedLocal_400, false)){
func_270(80, 1);
STATS::STAT_SET_BOOL(joaat("SP_KILLED_DR_FRIEDLANDER"), true, true);
_CONVERSATION_ADD_LINE(&uLocal_83, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
if(HUD::DOES_BLIP_EXIST(blLocal_403)) HUD::SET_BLIP_COLOUR(blLocal_403, 1);
iLocal_60=17;
}elseif(!ENTITY::DOES_ENTITY_EXIST(pedLocal_400) || func_72(pedLocal_400, PLAYER::PLAYER_PED_ID(), true) > 300f){
_CONVERSATION_ADD_LINE(&uLocal_83, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
if(HUD::DOES_BLIP_EXIST(blLocal_403)) HUD::SET_BLIP_COLOUR(blLocal_403, 3);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_400)) MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(pedLocal_400, true), 10f, 0);
iLocal_60=17;
}else{
func_55();
...
vector={
-1908.7588f, -558.642f, 13.4942f 
};
vector2={
-12.0007f, 0f, -115.8697f 
};
break;
case FIRST_PERSON:
vector={
-1904.6583f, -560.0228f, 12.4975f 
};
vector2={
-10.0948f, 0.0099f, -128.3421f 
};
break;
default:
vector={
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
}}elseif(CAM::DOES_CAM_EXIST(caLocal_405)){
if(func_135(&uLocal_263) >=2.66f){
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==THIRD_PERSON_FAR ? -16f :
0f);
...
func_119(&uLocal_257);
}}elseif(HUD::GET_BLIP_COLOUR(blLocal_403) !=3){
...
if(PED::IS_PED_IN_ANY_VEHICLE(pedLocal_400, false)) flag=true;
if(!PED::IS_PED_FLEEING(pedLocal_400))if(!VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_401, false) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_401, true) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veLocal_401, 0, 2000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veLocal_401, 1, 2000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veLocal_401, 2, 2000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veLocal_401, 3, 2000) || flag && !PED::IS_PED_IN_ANY_VEHICLE(pedLocal_400, false) || func_48(veLocal_401) || func_44(veLocal_401)) TASK::TASK_SMART_FLEE_PED(pedLocal_400, PLAYER::PLAYER_PED_ID(), 3000f, -1, false, false);
}
elseif(!PED::IS_PED_FLEEING(pedLocal_400)){
...
break;
case 17:
if(!func_75(&uLocal_254)) func_243(&uLocal_254);
if(func_135(&uLocal_254) > 4f || CAM::IS_SCREEN_FADED_OUT()){
HUD::REMOVE_BLIP(&blLocal_403);
if(CAM::DOES_CAM_EXIST(caLocal_404)) CAM::DESTROY_CAM(caLocal_404, false);
func_271();
func_268(false, false);
if(!func_1(80)){
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_400))if(ENTITY::DOES_ENTITY_EXIST(veLocal_401) && PED::IS_PED_IN_VEHICLE(pedLocal_400, veLocal_401, false)) VEHICLE::DELETE_VEHICLE(&veLocal_401);
...
if(func_36(echParam0)==3) return 0;
if(func_36(echParam0)==4) return 0;
...
func_5(iParam0);
if(Global_43257==15) func_4(false);
return 1;
}
...
}}elseif(IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_8() /*5568*/].f_681.f_10, iParam0)){
flag=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
int cloudTimeAsInt6;
int num6;
if(iParam0==8) return func_16(129, -1);
if(iParam0==9) return func_16(135, -1);
if(iParam0==10) return func_16(136, -1);
if(iParam0==11) return func_16(137, -1);
if(iParam0==12){
...
if(func_31(14) && !func_30(iParam0)) return 0;
...
if(func_27(&Global_4542597, iParam0)) return 0;
if(func_20(&Global_4542597, iParam0)) return 1;
}else{
...
if(func_31(14) && !func_30(iParam1)) return false;
if(func_27(uParam0, iParam1)) return false;
if(func_26(uParam0) < 0f) func_25(uParam0, 0);
func_23(&unk);
i=0;
for (i=0;
i < *uParam0 - 1;
...
if(func_31(14) && !func_30(iParam1)) return 0;
if(func_27(uParam0, iParam1)) return 0;
if(func_26(uParam0) < 0f) func_25(uParam0, 0);
for (i=0;
i < *uParam0;
i=i + 1){
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_40(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_40(character)) return func_43(character);
...
if(entityModel==joaat("cargobob") || entityModel==joaat("cargobob2") || entityModel==joaat("cargobob3"))if(VEHICLE::DOES_CARGOBOB_HAVE_PICK_UP_ROPE(playersLastVehicle))if(VEHICLE::IS_VEHICLE_ATTACHED_TO_CARGOBOB(playersLastVehicle, veParam0)) return true;
}}
return false;
}
...
if(func_75(piParam0))if(func_135(piParam0) > fParam1) return true;
return false;
}


var func__54(BOOL bParam0, var uParam1, var uParam2) // Position - 0x28A6{
...
int i;
float num;
if(!ENTITY::DOES_ENTITY_EXIST(pedLocal_400) || ENTITY::IS_ENTITY_DEAD(pedLocal_400, false) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) return;
if(!func_75(&uLocal_269)) func_243(&uLocal_269);
if(!func_75(&uLocal_272)) func_243(&uLocal_272);
...
iLocal_429=1;
func_119(&uLocal_269);
}}elseif(func_135(&uLocal_269) > 12f){
...
iLocal_431=1;
func_119(&uLocal_272);
}}elseif(func_135(&uLocal_272) > 10.3f){
...
if(!bLocal_438 && iLocal_429 >=1 && iLocal_431 >=1 && !HUD::IS_MESSAGE_BEING_DISPLAYED()) bLocal_438=true;
return;
}
...
if(func_60(PLAYER::PLAYER_ID())) return false;
...
Vector3 func__76(float fParam0, var uParam1, var uParam2) // Position - 0x3419{
float num;
float num2;
...
Vector3 func__77(Vehicle veParam0) // Position - 0x3458{
var forwardVector;
var rightVector;
var upVector;
var position;
var minimum;
float maximum;
if(ENTITY::IS_ENTITY_DEAD(veParam0, false)) return 0f, 0f, 0f;
...
maximum.f_1, maximum.f_1, maximum.f_1 
}
*{
0f, -0.6293f, 0.7771f 
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_82(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_79() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_81(-1, false)==8;
...
Vector3 func__86(Ped pedParam0, float fParam1, float fParam2, float fParam3) // Position - 0x3753{
var groundZ;
fParam1.f_2=fParam1.f_2 + 0.15f;
if(MISC::GET_GROUND_Z_FOR_3D_COORD(fParam1, &groundZ, false, false)) fParam1.f_2=groundZ;
if(func_87(pedParam0)) ENTITY::SET_ENTITY_COORDS(pedParam0, fParam1, true, false, false, true);
return fParam1;
}
...
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_399)) PED::DELETE_PED(&pedLocal_399);
...
if(CAM::IS_SCREEN_FADED_OUT()){
if(!bLocal_436){
STREAMING::NEW_LOAD_SCENE_START(-1905.4998f, -557.8768f, 12.4125f, func_76({
12.4748f, -560.2881f, -1904.7095f 
}
-{
12.4125f, -557.8768f, -1905.4998f 
}
...
if(CAM::DOES_CAM_EXIST(*uParam2)) CAM::DESTROY_CAM(*uParam2, false);
if(!CAM::DOES_CAM_EXIST(*uParam2)) *uParam2=CAM::CREATE_CAMERA(joaat("DEFAULT_SCRIPTED_CAMERA"), false);
...
CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
}elseif(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), &animDict, &animName) >=0.99f){
return true;
}}}
return false;
}
...
if(isControlJustPressed) *uParam2=1;
else *uParam2=0;
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SHRINK_ACCEPT")) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
func_105(piParam1);
return true;
}}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(controlInstructionalButtonsString)) func_102(controlInstructionalButtonsString);
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(piParam0->f_2[i /*15*/])) func_101(piParam0->f_2[i /*15*/]);
if(MISC::IS_PC_VERSION()){
...
value2=bParam4 ? func_103(piParam0->f_1, 32) ? 1f :
0f :
-1f;
...
var string1;
string1={
func_109(uParam0, &unk, iParam1, true) 
};
if(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX01")) return 8;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX02")) return 16;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX03")) return 32;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX04")) return 64;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX05")) return 128;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX06")) return 256;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX07")) return 512;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX08")) return 1024;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX09")) return 2048;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX10")) return 4096;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX11")) return 8192;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTSX12")) return 16384;
return 8;
}
...
var unk;
int num;
if(func_117() <=0)if(!func_116()) num=func_113(1, 2, 3, 4, 12);
elseif(func_112() >=1) num=func_113(5, 6, 7, 0, 0);
else num=func_113(5, 7, 0, 0, 0);
elseif(func_117() >=2) num=func_113(10, 11, 0, 0, 0);
elseif(!func_116())if(iParam2 !=4) num=func_113(8, 9, 0, 0, 0);
else num=9;
elseif(iParam2 !=4) num=func_113(8, 9, 10, 0, 0);
else num=func_113(9, 10, 0, 0, 0);
func_111(uParam0, num);
if(bParam3) func_110(&(Global_113648.f_19963), num, true);
TEXT_LABEL_ASSIGN_STRING(&unk, "OBTSX", 16);
if(num < 10) TEXT_LABEL_APPEND_STRING(&unk, "0", 16);
...
iParam1=iParam1 + 11;
if(bParam2) MISC::SET_BIT(&(uParam0->f_1), iParam1);
else MISC::CLEAR_BIT(&(uParam0->f_1), iParam1);
return;
}
...
if(iParam0 > 0 && iParam0 < 13 && !func_115(&(Global_113648.f_19963), iParam0)) unk[iParam0]=0;
elseif(iParam1 > 0 && iParam1 < 13 && !func_115(&(Global_113648.f_19963), iParam1)) unk[iParam1]=0;
elseif(iParam2 > 0 && iParam2 < 13 && !func_115(&(Global_113648.f_19963), iParam2)) unk[iParam2]=0;
elseif(iParam3 > 0 && iParam3 < 13 && !func_115(&(Global_113648.f_19963), iParam3)) unk[iParam3]=0;
elseif(iParam4 > 0 && iParam4 < 13 && !func_115(&(Global_113648.f_19963), iParam4)) unk[iParam4]=0;
randomIntInRange=func_114(&unk, 13, 1, 13);
if(randomIntInRange > 0) return randomIntInRange;
if(iParam2 <=0 || iParam2 >=13) randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(1, 3);
elseif(iParam3 <=0 || iParam3 >=13) randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
elseif(iParam4 <=0 || iParam4 >=13) randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(1, 5);
else randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(1, 6);
...
if(iParam1 < 0 || iParam1 > 12) return false;
iParam1=iParam1 + 11;
...
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL)) PAD::DISABLE_CONTROL_ACTION(FRONTEND_CONTROL, INPUT_FRONTEND_PAUSE_ALTERNATE, false);
return;
}
...
if(func_125(0)) func_122(iParam0);
...
if(func_126()) return;
if(Global_20584)if(func_124()) func_123(true, true);
else func_123(false, false);
...
uParam0->f_1=0;
uParam0->f_123=0;
if(bParam1) func_100(&(uParam0->f_1), 32);
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0)){
func_100(&(uParam0->f_1), 1);
if(bParam2) GRAPHICS::SET_SCALEFORM_MOVIE_TO_USE_SYSTEM_TIME(*uParam0, true);
}
if(MISC::IS_PC_VERSION())if(bParam3) func_100(&(uParam0->f_1), 4096);
if(bParam4) func_100(&(uParam0->f_1), 8192);
return;
}
...
if(pedInVehicleSeat !=0 && pedInVehicleSeat !=PLAYER::PLAYER_PED_ID()) *uParam2=0;
}}}
...
if(ENTITY::DOES_ENTITY_EXIST(*uParam2))if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam2)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*uParam2, true, false);
...
if(CAM::DOES_CAM_EXIST(*uParam3)) CAM::DESTROY_CAM(*uParam3, false);
if(!CAM::DOES_CAM_EXIST(*uParam3)) *uParam3=CAM::CREATE_CAMERA(joaat("DEFAULT_SCRIPTED_CAMERA"), false);
...
if(func_75(piParam0))if(func_136(piParam0)) return piParam0->f_2;
else return func_50(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;
return piParam0->f_1;
}
...
unk67={
func_150(entityModel, 2, uParam1->f_59, -1) 
};
...
unk67={
func_150(entityModel, 1, uParam1->f_62, -1) 
};
...
if(iParam1==-1) return func_147(iParam3);
entityModel=ENTITY::GET_ENTITY_MODEL(pedParam0);
...
if(unk.f_1==hParam1) return func_146(hParam0) + i;
...
if(shopPedQueryComponentIndex !=-1) return func_143(hParam0, func_144(iParam2)) + shopPedQueryComponentIndex;
}
return -99;
}
...
func_215();
if(hParam0==joaat("Player_Zero")) func_197(iParam1, iParam2);
elseif(hParam0==joaat("Player_One")) func_178(iParam1, iParam2);
...
if(iParam1==12){
if(!func_158(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_158(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
}elseif(iParam1==13){
}elseif(iParam1==14){
if(!func_158(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_158(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
...
if(func_157(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 1);
if(func_157(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 2);
if(!func_157(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 4);
}else{
MISC::SET_BIT(&(iParam0->f_6), 0);
...
if(iParam0 < 136) func_175(iParam0);
else func_174(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_161(3, iParam0, 242, -1);
return;
}
...
if(iParam0 < 107) func_194(iParam0);
elseif(iParam0 < 227) func_193(iParam0);
else func_192(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_161(3, iParam0, 318, -1);
return;
}
...
if(iParam0 < 60) func_212(iParam0);
else func_211(iParam0);
if(Global_78341[0 /*14*/].f_2==-1) func_161(3, iParam0, 181, -1);
return;
}
...
if(func_220(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && pedParam0==PLAYER::PLAYER_PED_ID())if(func_220(161, iParam3)) uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO_SA, iParam3, 0);
else uParam1->f_59=_MPCHAR_STAT_GET_INT(MP_STAT_CHAR_FM_STORED_HAIRDO, iParam3, 0);
}
return;
}
...
BOOL playbackFlags;
bitShift=0;
if(iParam1==1 || iParam1==4) bitShift=1;
playbackFlags=15;
...
var string1;
string1={
func_225(iParam0, true, true, &unk) 
};
if(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW01")) return 128;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW02")) return 256;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW03")) return 512;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW04")) return 1024;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW05")) return 2048;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW06")) return 4096;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW07")) return 8192;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW08")) return 16384;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW09")) return 32768;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW10")) return 65536;
elseif(MISC::ARE_STRINGS_EQUAL(&string1, "OBTOW11")) return 131072;
return 128;
}
...
if(num2 <=0){
if(iParam0 !=4) num=func_227(7, 9, 10, 11, 0);
else num=func_227(7, 9, 10, 0, 0);
}else{
...
if(bParam2) func_226(&(Global_113648.f_19963), num, true);
...
if(!flag){
if(iParam0 > 0 && iParam0 < 12) unk[iParam0]=0;
if(iParam1 > 0 && iParam1 < 12) unk[iParam1]=0;
if(iParam2 > 0 && iParam2 < 12) unk[iParam2]=0;
if(iParam3 > 0 && iParam3 < 12) unk[iParam3]=0;
if(iParam4 > 0 && iParam4 < 12) unk[iParam4]=0;
}
...
i < iParam1;
i=i + 1){
if(uParam0->[i] > 0) num=num + 1;
}
return num;
}
BOOL func_230(var uParam0, int iParam1) // Position - 0x1E33D{
if(iParam1 < 0 || iParam1 > 11) return false;
return IS_BIT_SET(uParam0->f_1, iParam1);
}
BOOL func_231(int iParam0, BOOL bParam1) // Position - 0x1E362{
switch (iParam0){
case 0:
if(func_232(19) && !func_232(20))if(func_232(44)) return 32;
else return 16;
break;
case 1:
if(func_232(20) && !func_232(59))if(!func_232(21) || func_232(72) || func_232(73))if(func_232(21)) return 64;
elseif(func_232(29)) return 32;
else return 16;
break;
case 4:
if(func_232(48) && func_232(61) && func_232(22))if(func_232(27)) return 64;
elseif(func_232(24)) return 32;
elseif(!func_232(84) && !func_232(85)) return 16;
break;
}
if(bParam1) return 16;
return 1;
}
...
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0) || ENTITY::IS_ENTITY_DEAD(*uParam0, false)) *uParam0=PED::CREATE_PED(PED_TYPE_MISSION, hParam1, vParam2, fParam5, true, true);
...
if(!INTERIOR::IS_INTERIOR_DISABLED(interior)) return;
if(func_235(iParam0)) func_237(iParam0, false);
}
...
if(!AUDIO::LOAD_STREAM("Office_Background_Stream", "SHRINK_SOUNDS")) return false;
if(func_242(uParam0))if(HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) return true;
return false;
}
...
if(!func_75(piParam0)) func_119(piParam0);
return;
}
...
if(iParam6==4) func_248(uParam0, hParam4);
func_247(uParam0);
...
WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true);
if(weaponHash==0 || weaponHash==joaat("WEAPON_UNARMED") || weaponHash==joaat("WEAPON_ELECTRIC_FENCE") || weaponHash==joaat("GADGET_PARACHUTE") || weaponHash==joaat("OBJECT")) return false;
return true;
}
...
HUD::DISPLAY_RADAR(true);
func_257();
if(ENTITY::DOES_ENTITY_EXIST(*pveParam1)) ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(pveParam1);
...
if(iParam3 >=15){
func_234(1, true);
if(CAM::DOES_CAM_EXIST(caParam2)) CAM::DESTROY_CAM(caParam2, false);
}
if(CAM::IS_SCREEN_FADING_OUT() || CAM::IS_SCREEN_FADED_OUT()) CAM::DO_SCREEN_FADE_IN(500);
SCRIPT::TERMINATE_THIS_THREAD();
return;
}
...
var func__272(BOOL bParam0, var uParam1, var uParam2) // Position - 0x230C1{
if(bParam0) return uParam1;
return uParam2;
}
