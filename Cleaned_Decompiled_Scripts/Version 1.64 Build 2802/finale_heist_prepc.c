...
Local_154={
-1154.086f, -2006.297f, 12.1803f 
};
Local_160={
-442.5602f, -2184.605f, 14.55648f 
};
Local_163={
-442.668f, -2172.496f, 9.39933f 
};
fLocal_166=13.47f;
...
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Local_96.f_0, 0f, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_96.f_0, 1, 1, 1);
}
if(OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_119.f_0)){
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Local_119.f_0, 0f, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_119.f_0, 1, 1, 1);
}
func_2();
func_479();
}
...
int iVar0;
int iVar1;
func_220(&iLocal_176, &uLocal_177, &iLocal_95, &uLocal_147, &uLocal_146, Local_157, 0, 0, 1090519040);
func_213();
switch (iLocal_93){
case 0:
...
iLocal_93=1;
if(!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_96.f_0)){
OBJECT::ADD_DOOR_TO_SYSTEM(Local_96.f_0, joaat("prop_com_gar_door_01"), -440.0606f, -2171.827f, 11.3672f, 1, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_96.f_0, 1, 1, 1);
}
if(!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_119.f_0)){
OBJECT::ADD_DOOR_TO_SYSTEM(Local_119.f_0, joaat("prop_com_gar_door_01"), -445.3054f, -2171.827f, 11.3672f, 1, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_119.f_0, 1, 1, 1);
}
...
iVar0=-1;
iVar1=0;
func_62(&uLocal_146, Local_157, &iLocal_94, iLocal_95, &iLocal_145, &iLocal_174);
if(func_51(iLocal_176, Local_157, &uLocal_146, iLocal_95, iLocal_94, &iLocal_172, &iLocal_175, &iVar0, &iVar1, &iLocal_145, 7f)){
VEHICLE::SET_VEHICLE_HAS_BEEN_DRIVEN_FLAG(iLocal_176, 0);
...
HUD::CLEAR_PRINTS();
func_44();
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_96.f_0, 2, 1, 1);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_119.f_0, 2, 1, 1);
func_42(1, func_43());
if(func_4(iLocal_176)){
...
int func_50(){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_160, Local_163, fLocal_166, 0, 1, 0)){
return 1;
}
return 0;
}

int func_51(int iParam0, struct<3> Param1, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12){
float fVar0;
...
bool func_56(int iParam0, struct<3> Param1, float fParam4, int iParam5){
return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, iParam5), Param1) <=(fParam4 * fParam4);
}


void func_57(var uParam0, struct<3> Param1, int iParam4){
if(!HUD::DOES_BLIP_EXIST(*uParam0)){
*uParam0=func_58(Param1, 5, iParam4);
}}

int func_58(struct<3> Param0, int iParam3, int iParam4){
int iVar0;
iVar0=0;
...
void func_62(var uParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7){
switch (*iParam4){
case 0:
...
bLocal_28=false;
func_21(1, 1, 1);
}elseif(func_209(1, Local_151, 0)){
if(!func_473()){
if(func_207()){
func_206(func_41());
return 1;
}elseif(func_209(2, Local_151, 0)){
func_206(func_41());
return 1;
}}else{
return 1;
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_178.f_0, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("gauntlet"), true);
if(!func_473()){
...
return 1;
}elseif(func_105(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_143(iParam0, 0, 0)) || func_143(iParam0, 1, 0)) || func_143(iParam0, 2, 0)) || func_142(iParam0) !=145) || func_141(iParam0)) || func_140(iParam0)) || func_87(iParam0)) || func_139(iParam0)) || !func_127(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_140(iParam0)){
}
if(func_140(iParam0)){
}
...
}elseif(func_153(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_154() && unk_0x96AF6537AE293DDE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_160(struct<3> Param0, float fParam3, int iParam4){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
}elseif((!func_173(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_175(iParam0, uVar1[iVar6], 1) && func_174(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_169(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_123(iVar2))){
}else{
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_123(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_123(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_123(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_123(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_123(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_123(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_185(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_184()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_123(iVar7 + 1))){
...
var func__180(int iParam0, int iParam1){
...
var func__182(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_97178[func_208()], 0)){
...
case 2:
if(func_4(Global_97178[func_208()])){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97178[func_208()], 1, 1);
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("gauntlet"), true);
return 1;
}}elseif(Global_100681.f_12[0] !=1 || func_469(0)){
...
*iParam0=VEHICLE::CREATE_VEHICLE(iParam1, Param2, uParam5, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(*iParam0)){
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(*iParam0, 1, 0);
}
...
if(!iLocal_167){
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_96.f_0, 1);
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_119.f_0, 1);
AUDIO::START_AUDIO_SCENE("BIG_SCORE_PREP_C_GARAGE_DOOR");
iLocal_167=1;
}}elseif(!func_56(PLAYER::PLAYER_PED_ID(), Local_157, 70f, 1)){
if(iLocal_167){
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_96.f_0, 0);
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_119.f_0, 0);
...
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(*uParam0, uParam0->f_1, 1, 1);
uParam0->f_22=0;
}}elseif(iLocal_92==4 && !func_56(PLAYER::PLAYER_PED_ID(), Local_157, 100f, 1)){
...
if(func_4(iLocal_176)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_176, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_176, Local_160, Local_163, fLocal_166, 0, 1, 0)){
...
void func_220(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4, struct<3> Param5, int iParam8, bool bParam9, int iParam10){
if(func_4(*iParam0)){
switch (*iParam2){
case 0:
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0)){
...
*iParam2=2;
}}elseif(func_228(*iParam0) || func_227(*iParam0)){
func_19(uParam3);
if(func_59(func_53(func_41()), 0, 0)){
HUD::CLEAR_THIS_PRINT(func_53(func_41()));
}
...
func_223(iParam0, uParam1);
}}
break;
case 2:
case 1:
if((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0) && !func_228(*iParam0)) && !func_227(*iParam0)){
func_19(uParam4);
if(!ENTITY::IS_ENTITY_AT_COORD(*iParam0, Param5, iParam10, iParam10, 2f, 0, 1, 2)){
func_221(uParam3, *iParam0, 1);
}
*iParam2=0;
}
break;
...
if(!HUD::DOES_BLIP_EXIST(*uParam0)){
*uParam0=func_222(iParam1, iParam2, 5);
}}

int func_222(int iParam0, var uParam1, int iParam2){
int iVar0;
iVar0=0;
if(func_5(iParam0)){
...
int iVar0;
int iVar1;
if((func_435(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_4(iParam0)){
...
void func_229(){
func_220(&iLocal_176, &uLocal_177, &iLocal_95, &uLocal_147, &uLocal_146, Local_157, 0, 1, 1090519040);
func_213();
func_257();
switch (iLocal_93){
case 0:
if(func_65(iLocal_92, bLocal_28)){
func_57(&uLocal_146, Local_157, 1);
...
if(func_240(iLocal_176, Local_157, &uLocal_146, iLocal_94, iLocal_95, &iLocal_145, &iLocal_175, 0, 0, 1086324736) && func_50()){
iLocal_93=2;
}
break;
case 2:
...
int func_240(int iParam0, struct<3> Param1, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11){
...
}}}}elseif(func_245(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1)){
...
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, 0), Local_154, 4, 20f, 786469, 2f, 10f, 1);
}}else{
func_233(iVar1);
}}
iVar0++;
...
if(!func_246()){
if((ENTITY::DOES_ENTITY_EXIST(iLocal_176) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_176, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_176, Local_154, 2f, 2f, 2f, 0, 1, 0)){
if((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_176, 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(PED::IS_PED_IN_VEHICLE(iParam0, iLocal_176, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_176, -1, 0)==iParam0){
return 1;
}}}}
return 0;
}
...
if(func_255()==0){
return MISC::IS_BIT_SET(func_252(func_254(iParam0), -1, 0), iParam1);
}}else{
...
func_258(1, 81);
func_258(2, 82);
}elseif(func_56(PLAYER::PLAYER_PED_ID(), Local_157, 120f, 1)){
func_3(0);
func_3(1);
func_3(2);
}}
...
void func_260(){
func_220(&iLocal_176, &uLocal_177, &iLocal_95, &uLocal_147, &uLocal_146, Local_154, 0, 0, 1090519040);
switch (iLocal_93){
case 0:
if(func_65(iLocal_92, bLocal_28)){
...
func_57(&uLocal_146, Local_154, 1);
}
break;
case 2:
...
func_62(&uLocal_146, Local_154, &iLocal_94, iLocal_95, &iLocal_145, &iLocal_174);
func_243();
if(func_242(iLocal_176)){
func_19(&uLocal_146);
func_19(&uLocal_147);
...
if(func_240(iLocal_176, Local_154, &uLocal_146, iLocal_94, iLocal_95, &iLocal_145, &iLocal_175, 0, 1, 1086324736) || func_249()){
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_328(iVar10, iParam1, iParam2, -1) 
};
if(!func_327(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_328(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_309(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_328(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_328(iVar10, iVar0, func_288(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_309(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_328(iVar10, 14, uVar69[iVar1], -1) 
};
func_299(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_322(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_328(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_317(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_316(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_289(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_289(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_289(iParam0));
if(iVar57 > iVar56){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78341[1 /*14*/]={
func_328(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_289(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_289(iParam1))){
return 1;
}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
func_398(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
}}}
...
func_412(iParam5, &Var0, Param1, uParam4, func_142(iParam0));
...
void func_412(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_168(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
if(VEHICLE::GET_DOES_VEHICLE_HAVE_DAMAGE_DECALS(uParam0)){
iVar8 +=50;
}
if(VEHICLE::IS_VEHICLE_BUMPER_BROKEN_OFF(uParam0, 1)){
iVar8 +=50;
}elseif(VEHICLE::IS_VEHICLE_BUMPER_BOUNCING(uParam0, 1)){
iVar8 +=25;
}
if(VEHICLE::IS_VEHICLE_BUMPER_BROKEN_OFF(uParam0, 0)){
iVar8 +=50;
}elseif(VEHICLE::IS_VEHICLE_BUMPER_BOUNCING(uParam0, 0)){
iVar8 +=25;
}
...
int iVar0;
if(!func_4(iLocal_176)){
if(!func_4(uLocal_177) && !func_4(Local_178.f_0)){
func_426(1);
return;
}
...
if(!func_432(PLAYER::PLAYER_PED_ID(), uLocal_177, 500f, 1)){
iVar0++;
}}else{
iVar0++;
}
...
bool func_432(int iParam0, int iParam1, float fParam2, int iParam3){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_443() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_443() /*5568*/].f_681.f_10, iParam0);
}
...
void func_475(){
Local_96={
func_476(1616809629, -440.0352f, -2172.502f, 9.39933f, -440.1235f, -2166.841f, 12.3181f, -440.1479f, -2166.364f, 9.3181f, -439.9046f, -2174.041f, 12.39933f, -442.2598f, -2169.643f, 9.31843f, -438.0615f, -2173.349f, 13.31699f) 
};
Local_119={
func_476(-1380475172, -445.3699f, -2172.47f, 9.39933f, -445.3286f, -2166.688f, 12.31802f, -445.492f, -2166.232f, 9.31686f, -445.2189f, -2174.173f, 12.39933f, -447.3654f, -2169.836f, 9.30682f, -443.38f, -2173.165f, 12.31856f) 
};
}
...
case 82:
Local_178={
func_478(307.123f, -1084.801f, 28.3597f, 299.7018f, joaat("gauntlet"), 0) 
};
Local_157={
-442.189f, -2183.603f, 9.31981f 
};
...
Local_193[1 /*3*/]={
-442.1008f, -2181.29f, 9.3195f 
};
Local_193[2 /*3*/]={
-445.3427f, -2181.132f, 9.3183f 
};
...
Global_32208=1;
bVar0=true;
}elseif(Global_32175[iVar1]==iParam0){
Global_32175[iVar1]=iParam0;
Global_32186[iVar1]=bParam1;
Global_32197[iVar1]=(MISC::GET_GAME_TIMER() + iParam3);
Global_32208=1;
