...
}}elseif(!func_86(1, 1, -1.3389f, 544.1759f, 172.7673f, -1f)){
func_8(&iLocal_30, 1, -1.3389f, 544.1759f, 172.7673f, 124.3018f, 1, 1);
}}
if(!iLocal_28){
...
var uVar5;
var uVar6;
if((func_85(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0)){
...
return 1;
}elseif(func_33(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_71(iParam0, 0, 0)) || func_71(iParam0, 1, 0)) || func_71(iParam0, 2, 0)) || func_70(iParam0) !=145) || func_69(iParam0)) || func_68(iParam0)) || func_15(iParam0)) || func_67(iParam0)) || !func_55(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_68(iParam0)){
}
if(func_68(iParam0)){
}
...
}elseif(func_81(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
Vector3 func__98(struct<3> Param0){
float fVar0;
float fVar1;
...
Var67={
func_130(iVar81, 2, uParam1->f_59, -1) 
};
...
Var67={
func_130(iVar81, 1, uParam1->f_62, -1) 
};
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_124(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_124(iParam0));
if(iVar57 > iVar56){
