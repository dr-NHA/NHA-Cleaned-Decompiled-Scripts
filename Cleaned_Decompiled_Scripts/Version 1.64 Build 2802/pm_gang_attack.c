...
}elseif(func_6(uLocal_284[iVar4], func_7(func_8()), 1) > 100f && func_5(PLAYER::PLAYER_PED_ID(), uLocal_284[iVar4], 1) > 300f){
func_4();
}elseif(iLocal_280 && func_6(uLocal_284[iVar4], func_7(func_8()), 1) > 50f){
if(func_2()){
if(!iLocal_279){
...
TASK::TASK_SMART_FLEE_PED(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 1, 0);
}
break;
}}
iVar0++;
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_35(iParam2), 1);
}
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("script_task_shoot_at_coord")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("script_task_shoot_at_coord")) !=0){
TASK::TASK_SHOOT_AT_COORD(iParam0, Param1, -1, joaat("FIRING_PATTERN_BURST_FIRE"));
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("script_task_stand_still")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("script_task_stand_still")) !=0){
TASK::TASK_STAND_STILL(iParam0, -1);
}}


Vector3 func__40(struct<3> Param0, float fParam3){
struct<3> Var0;
Var0={
...
Vector3 func__41(struct<3> Param0, float fParam3){
float fVar0;
if(fParam3==0f){
return 0f, 0f, 0f;
}
...
if(!func_38(uLocal_284[iVar0], joaat("script_task_combat"), 1)){
TASK::TASK_COMBAT_PED(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(uLocal_281[Local_37[iVar0 /*10*/].f_8]==0 || Local_37[iVar0 /*10*/].f_9==-2){
}elseif(!PED::IS_PED_IN_VEHICLE(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], 0)){
if(func_5(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], 1) > 4f){
if(!func_38(uLocal_284[iVar0], joaat("script_task_combat"), 1)){
PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], 0f, 0f, 0f, 4f, 0);
TASK::TASK_COMBAT_PED(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
}
}
elseif(!func_38(uLocal_284[iVar0], joaat("script_task_enter_vehicle"), 1)){
TASK::TASK_ENTER_VEHICLE(uLocal_284[iVar0], uLocal_281[Local_37[iVar0 /*10*/].f_8], -1, Local_37[iVar0 /*10*/].f_9, 2f, 1, 0);
}
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_281[Local_37[iVar0 /*10*/].f_8], 0)){
if(!func_38(uLocal_284[iVar0], joaat("script_task_combat"), 1)){
TASK::TASK_COMBAT_PED(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
}
}}elseif(!func_38(uLocal_284[iVar0], joaat("script_task_vehicle_shoot_at_entity"), 1)){
TASK::TASK_VEHICLE_SHOOT_AT_PED(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 1101004800);
}
break;
case 2:
if(PED::IS_PED_IN_ANY_VEHICLE(uLocal_284[iVar0], 0)){
...
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_284[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iVar0], 0), 0);
}}elseif(!func_38(uLocal_284[iVar0], joaat("script_task_vehicle_mission"), 1) || iLocal_276 !=iLocal_277){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_284[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iVar0], 0), PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 1000f, 0f, 1);
}elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_284[iVar0], joaat("script_task_vehicle_mission"))==1){
if(!TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_284[iVar0])){
TASK::TASK_DRIVE_BY(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
}}
}
elseif(func_46(uLocal_284[iVar0], 0)==-1){
if(!func_38(uLocal_284[iVar0], joaat("script_task_vehicle_mission"), 1) || iLocal_276 !=iLocal_277){
TASK::TASK_VEHICLE_ESCORT(uLocal_284[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iVar0], 0), PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iLocal_276], 0), -1, 40f, 786468, -1082130432, 20, 1101004800);
}elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_284[iVar0], joaat("script_task_vehicle_mission"))==1){
if(!TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_284[iVar0])){
TASK::TASK_DRIVE_BY(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
}}
...
if(!func_38(uLocal_284[iVar0], joaat("script_task_shuffle_to_next_vehicle_seat"), 1)){
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_284[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_284[iVar0], 0), 0);
}}elseif(!func_38(uLocal_284[iVar0], joaat("script_task_drive_by"), 1) || iLocal_276 !=iLocal_277){
TASK::TASK_DRIVE_BY(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
}
}}
break;
...
var func__49(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
case 3:
*uParam0={
-323.9344f, 6259.659f, 30.3539f 
};
uParam0->f_3=292.4941f;
uParam0->f_4={
-313.3472f, 6263.395f, 42.7414f 
};
uParam0->f_7=joaat("weapon_molotov");
uParam0->f_8=1;
uParam0->f_9=0;
...
case 2:
*uParam0={
-2200.848f, 4268.19f, 47.3093f 
};
uParam0->f_3=331.1949f;
uParam0->f_4={
-2196.575f, 4275.129f, 49.0669f 
};
uParam0->f_7=joaat("weapon_assaultrifle");
uParam0->f_8=-1;
uParam0->f_9=-2;
...
case 3:
*uParam0={
-2202.818f, 4294.149f, 47.4518f 
};
uParam0->f_3=263.7257f;
uParam0->f_4={
-2192.783f, 4289.572f, 50.3251f 
};
uParam0->f_7=joaat("weapon_molotov");
uParam0->f_8=0;
uParam0->f_9=0;
...
case 4:
*uParam0={
-2196.271f, 4265.064f, 47.3446f 
};
uParam0->f_3=325.4524f;
uParam0->f_4={
-2191.183f, 4271.747f, 49.867f 
};
uParam0->f_7=joaat("weapon_pumpshotgun");
uParam0->f_8=1;
uParam0->f_9=-1;
...
case 5:
*uParam0={
-2204.492f, 4290.059f, 47.3773f 
};
uParam0->f_3=269.5739f;
uParam0->f_4={
-2193.017f, 4292.669f, 54.873f 
};
uParam0->f_7=joaat("weapon_microsmg");
uParam0->f_8=0;
uParam0->f_9=-1;
...
TASK::TASK_SMART_FLEE_PED(uLocal_284[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 1);
}
