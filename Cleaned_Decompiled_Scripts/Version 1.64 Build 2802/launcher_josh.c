...
func_312("Josh 4:
Trying to set Cop 1 component variation");
...
func_312("Josh 4:
Trying to set Cop 2 component variation");
...
if(func_176(num)) func_173(num, &blLocal_264);
if(!func_2(&num)) func_294(&num, true);
if(func_1(&num)) func_294(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xD19{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6B2F{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x727F{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x760B{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x774A{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x84CB{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CCD{
...
var func__175(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC12F{
if(bParam0) return uParam1;
return uParam2;
}
...
return true;
}}elseif(func_178(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], true) <=10f){
...
return true;
}elseif(!func_180(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_153(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, false, true, false)){
...
return 1;
}elseif(!func_180(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_153(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, false, true, false)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}
return 0;
}
...
func_312("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_186(uParam0->f_27)){
func_185(uParam0->f_27, *uParam0);
func_312("RC5_IN_ACTIVATION_RANGE:
...
if(func_186(true)){
func_185(1, *uParam0);
func_312("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_312("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if(func_187(playersLastVehicle))if(PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))if(!ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(playersLastVehicle) && !ENTITY::IS_ENTITY_IN_AIR(playersLastVehicle) && ENTITY::GET_ENTITY_SPEED(playersLastVehicle) < 1f) return true;
...
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || Global_32166 || func_195() || func_194(8, -1) || func_192() || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_196() || Global_112695 || Global_32166 || func_195() || func_194(8, -1) || func_192() || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_196() || Global_112695 || Global_32166 || func_195() || func_194(8, -1) || func_96() || func_193() || func_191() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_196() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_194(8, -1) || func_191() || func_190() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_194(8, -1) || func_96() || func_193() || func_190() || func_189()) return false;
...
break;
case 7:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || func_193() || Global_112695 || Global_32166 || func_195() || Global_44446 || func_194(8, -1) || func_192() || func_190() || func_191() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 8:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || unk_0x279D0BCF8F708D74(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_196() || Global_112695 || Global_32166 || func_195() || func_194(8, -1) || func_192() || func_190() || func_96() || func_193() || func_191()) return false;
break;
}}else{
return false;
}}else{
...
switch (iLocal_96){
case 0:
if(MISC::GET_GAME_TIMER() - iLocal_262 > 100 && bLocal_263==false) iLocal_96=1;
break;
case 1:
if(func_222(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) <=20f)if(_CONVERSATION_ADD_LINE(&uLocal_97, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0)) iLocal_96=2;
break;
case 2:
...
}elseif(func_222(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) >=25f){
func_148();
bLocal_263=true;
iLocal_96=0;
}
...
if(func_202(PLAYER::PLAYER_ID())) return false;
...
if(func_222(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_216(uParam0, 1);
}else{
...
if(func_222(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_218(uParam0);
}}}
return;
}
...
var unk;
if(Global_78558){
func_312("IS_RC_FINE_AND_IN_RANGE():
The game is running Multiplayer [TERMINATING]");
return false;
}
func_115(*panParam0, &unk);
if(func_259(*panParam0) || func_257(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_312("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_252(panParam0->f_28[0]);
func_312("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_232(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_232(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_221(panParam0);
else func_228(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(func_227(&(panParam0->f_48)) && bParam1) func_224(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
if(func_226(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_226(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_225(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(iParam2==0) func_228(uParam0);
else func_221(uParam0);
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_148();
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_235(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_243(&iLocal_37[num /*4*/]);
return false;
}
if(!func_240(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_239();
if(num==-1) return false;
...
Vector3 func__238(Ped pedParam0, int iParam1) // Position - 0xF29F{
...
float num;
unk={
func_242(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_242(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__242(float fParam0, var uParam1, var uParam2) // Position - 0xF460{
float num;
float num2;
...
if(!bParam2){
if(func_250(pedParam0, bParam1, radius, num)) return true;
if(func_247(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_248(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_248(pedParam0, fParam1)) return true;
...
float num;
unk={
func_242(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_256() && !func_255()) return true;
if(!func_254(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_258() && Global_100681.f_11==6 && iParam0==func_171(&(Global_100681.f_3), 0)) return true;
return false;
}
...
switch (*uParam0){
case 27:
if(!func_279(uParam0)) return false;
break;
case 28:
if(!func_278(uParam0)) return false;
break;
case 29:
if(!func_276(uParam0)) return false;
break;
case 30:
if(!func_262(uParam0)) return false;
break;
}
...
break;
case 1:
if(!func_274(&num) || !func_273(&(uParam0->f_48))) return false;
...
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(func_268(&uParam0->f_28[0], CHAR_JOSH, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1)) PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_28[0], BF_AlwaysFlee, true);
else flag=false;
...
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) func_264(&uParam0->f_35[0], num[3], -1107.5f, 280.33f, 64.01f, 97.97f);
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
567.5142f, -1760.011f, 27.16929f 
};
uParam0->f_17[1 /*3*/]={
565.34454f, -1775.9313f, 31.351496f 
};
uParam0->f_24=7f;
uParam0->f_27=0;
uParam0->f_26=1;
...
break;
case 1:
if(!func_274(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh3")) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_268(&uParam0->f_28[0], CHAR_JOSH, 566.1639f, -1773.8171f, 29f, 14.4f, "JOSH LAUNCHER RC", 1)) flag=false;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) func_277(&uParam0->f_35[0]);
if(flag) iLocal_91=3;
break;
case 3:
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0])){
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
574.05206f, -1770.5944f, 27.669289f 
};
uParam0->f_17[1 /*3*/]={
559.16315f, -1768.6635f, 31.41929f 
};
uParam0->f_24=17.25f;
uParam0->f_27=0;
uParam0->f_26=1;
...
break;
case 1:
if(!func_274(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh2")) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_268(&uParam0->f_28[0], CHAR_JOSH, 565.3901f, -1772.8378f, 29.80087f, 62.501556f, "JOSH LAUNCHER RC", 1)) flag=false;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
...
PED::SET_PED_CONFIG_FLAG(uParam0->f_28[0], 118, false);
PED::SET_PED_CONFIG_FLAG(uParam0->f_28[0], 208, true);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID())) TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_268(&uParam0->f_28[0], CHAR_JOSH, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1)) flag=false;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) func_263(&uParam0->f_35[0], true);
if(!func_280(true, true)) flag=false;
if(flag) iLocal_91=3;
break;
case 3:
...
if(func_256() && !func_255()) return false;
if(func_289(iParam0)) return false;
if(iParam0==-1) iParam0=func_170();
if(iParam0==-1) return false;
if(!func_259(iParam0)){
if(!func_288(iParam0)) return false;
if(!func_287(iParam0)) return false;
if(func_286(iParam0)) return false;
}
if(iParam0==58)if(func_284(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
int i;
if(*uParam0==1){
if(func_292(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
char* str;
if(bParam1){
func_312("SCRIPT TERMINATING:
Cleaning up entities in Launcher");
func_301(uParam0, 0, false, false);
}
if(HUD::DOES_BLIP_EXIST(blLocal_264)) HUD::REMOVE_BLIP(&blLocal_264);
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))if(func_298(sParam0)) func_296();
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_229(&uParam0->[i]);
else func_304(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_265(&uParam0->[i]);
else func_307(&uParam0->[i]);
}
return;
}
...
else func_310(&uParam0->[i], false, 1, 0);
}
return;
}
