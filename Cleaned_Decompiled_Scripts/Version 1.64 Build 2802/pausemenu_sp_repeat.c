...
break;
case 133:
if(iScriptParam_0.f_2==76) func_81();
else func_82(7, 1, 0);
break;
case 76:
...
break;
case 52:
if(iScriptParam_0.f_2==52) HUD::SET_SAVEGAME_LIST_UNIQUE_ID(iScriptParam_0.f_3);
break;
case 154:
if(iScriptParam_0.f_2==154) HUD::SET_SAVEGAME_LIST_UNIQUE_ID(iScriptParam_0.f_3);
break;
default:
func_31(1);
...
func_29(false, 1);
func_28(2, false);
if(!iScriptParam_0.f_1==52 && !iScriptParam_0.f_1==154) func_28(1, false);
Global_78808=0;
func_27(-1);
}
break;
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)) Global_78810={
ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) 
};
...
if(iParam1==7)if(iParam0 >=0 && iParam0 < 63) Global_112735[iParam0 /*10*/].f_3=1;
...
if(!HUD::HAS_ADDITIONAL_TEXT_LOADED(8)) return false;
iParam0=iParam0 + 1;
return true;
}
...
if(Global_113648.f_18576.f_380 > 0) return 1;
return 0;
}
BOOL func_7() // Position - 0x41E{
if(Global_2883694){
if(Global_3407872.f_931.f_21 > 0) return 1;
return 0;
}elseif(Global_2883693){
if(Global_3932160.f_931.f_21 > 0) return 1;
return 0;
}elseif(Global_113648.f_10018.f_21 > 0){
return 1;
}
return 0;
}
...
if(func_26()){
if(func_25(14)) return 5;
return 0;
}
if(Global_78819==1) return 0;
if(Global_2883694)if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(-1516147206) > 0) return 0;
elseif(Global_2883693)if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(2006115718) > 0) return 0;
elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0) return 0;
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("creator")) > 0) return 1;
if(_IS_MISSION_REPEAT_ACTIVE(false)) return 0;
if(func_23(Global_112673, 256)) return 2;
if(func_22()) return 2;
if(func_21()) return 3;
if(func_20()) return 3;
if(func_19()) return 3;
if(func_10()) return 3;
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || func_9()) return 2;
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 207.43358f, -1019.7954f, -100.47276f, 189.93378f, -1019.6235f, -95.56883f, 17.1875f, false, true, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) return 3;
if(Global_78556) return 2;
if(Global_77348.f_577) return 4;
return -1;
}
...
elseif(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(func_17()==0) return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_16(iParam0), -1, 0), iParam1);
...
if(bParam1==true) func_29(false, 1);
...
if(iParam0==1) HUD::PAUSE_MENU_DEACTIVATE_CONTEXT(joaat("HIDE_ACCEPTBUTTON"));
else HUD::PAUSE_MENU_ACTIVATE_CONTEXT(joaat("HIDE_ACCEPTBUTTON"));
...
i <=94 - 1;
i=i + 1){
if(uLocal_30[i /*2*/]==iParam0) return i;
}
return -1;
}
...
if(func_39(i, iParam2)==true) *uParam1=*uParam1 + 1;
}}}}else{
num3=0;
for (j=0;
j <=num - 1;
...
if(func_39(num4, iParam2)) *uParam1=*uParam1 + 1;
}else{
j=num + 1;
}}}
return;
...
switch (iParam1){
case 1:
if(func_44(iParam0)) return func_43();
else return Global_113648.f_9087.f_330[iParam0 /*6*/];
break;
case 7:
...
if(Global_113648.f_9087.f_330[24 /*6*/]==1 || Global_113648.f_9087.f_330[25 /*6*/]==1 || Global_113648.f_9087.f_330[26 /*6*/]==1 || Global_113648.f_9087.f_330[27 /*6*/]==1) return 1;
return 0;
}
BOOL func_44(int iParam0) // Position - 0x15EC{
int num;
num=iParam0;
if(num==24 || num==25 || num==26 || num==27) return true;
return false;
}
...
num4=0;
for (i=0;
i < func_75(iParam0, Global_78808);
i=i + 1){
...
flag=false;
num=func_72(num5);
if(num >=2147483647) num=50;
break;
}
if(!Global_63587[num5 /*13*/].f_7 && flag){
if(func_53(num5, num3, 0)) num4=num4 + 1;
num3=num3 + 1;
}}
...
if(iParam3 > -1) value=SYSTEM::TO_FLOAT(iParam3);
if(num==0){
...
int num3;
char* str;
if(plParam2 !=0)if(!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(plParam2)) return false;
if(Global_63587[iParam0 /*13*/].f_7) return true;
num={
Global_63587[iParam0 /*13*/] 
};
...
value=iParam0;
if(value > iParam1) value=iParam1;
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam2);
...
if(func_64(iParam0, func_71(Global_63587[iParam0 /*13*/].f_4))) return 1;
return 0;
}
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_67(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_67(character)) return func_70(character);
...
TEXT_LABEL_APPEND_STRING(&unk, &(Global_91469[iParam0 /*34*/].f_8), 8);
if(iParam0==90) TEXT_LABEL_APPEND_STRING(&unk, "A", 8);
}
break;
case 7:
unk={
...
int num;
num=0;
if(Global_78808 !=iParam0 || iParam2==1) num=1;
Global_78808=iParam0;
func_4(2);
if(func_8() !=-1 || !func_5(iParam0)){
if(iParam1==1) func_31(0);
func_3(false);
...
num=uLocal_30[i /*2*/];
uLocal_28={
func_78(num, Global_78808) 
};
for (j=0;
j < func_75(num, Global_78808);
j=j + 1){
num4=func_73(num, Global_78808, j);
if(!Global_63587[num4 /*13*/].f_7){
if(func_63(num4)==1) num3=num3 + 1;
switch (num4){
case 42:
case 55:
case 85:
