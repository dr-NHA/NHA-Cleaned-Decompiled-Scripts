...
iLocal_44=-1;
iLocal_94=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_347();
func_346(0);
...
func_291();
func_156();
}elseif(IS_BIT_SET(uLocal_95.f_449, 0)){
func_152(&uLocal_95);
}
...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("agency_heist3a")) > 0 || SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("agency_heist3b")) > 0) func_4();
if(func_332(12))if(!_IS_MISSION_REPEAT_ACTIVE(false))if(!IS_BIT_SET(Global_113648.f_1.f_120[3], 8)) func_2(3, 8, true);
elseif(IS_BIT_SET(Global_113648.f_1.f_120[3], 8)) func_2(3, 8, false);
elseif(IS_BIT_SET(Global_113648.f_1.f_120[3], 8)) func_2(3, 8, false);
SYSTEM::WAIT(0);
}
func_1(0);
...
num2=num;
if(num2 !=uParam0->f_464 && !(num2==2 && uParam0->f_464==4) && !(*uParam0==1 && num2==3 && uParam0->f_464==4))if(IS_BIT_SET(uParam0->f_449, 2)) func_7(uParam0, num2, 0);
...
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_20[0 /*4*/], "")) func_23(&uParam0->f_1.f_20[0 /*4*/], 3, 0, -1, 10000, 7, 0, 0, 0);
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_20[1 /*4*/], "")) func_23(&uParam0->f_1.f_20[1 /*4*/], 3, 1000, -1, 10000, 7, 0, 0, 0);
...
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_108[0 /*4*/], "")) func_23(&uParam0->f_1.f_108[0 /*4*/], 3, 0, -1, 10000, 7, 0, 0, 0);
if(!MISC::ARE_STRINGS_EQUAL(&uParam0->f_1.f_108[1 /*4*/], "")) func_23(&uParam0->f_1.f_108[1 /*4*/], 3, 1000, -1, 10000, 7, 0, 0, 0);
Global_113648.f_1.f_6[*uParam0]=true;
}elseif(func_22() && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
Vector3 func__29(var uParam0, var uParam1) // Position - 0x15B5{
float num;
float num2;
float num3;
float num4;
...
if(*uParam0 !=1) func_10("H_LBL_CRW" /*CREW*/);
func_10("H_LBL_TODO" /*TODO*/);
if(*uParam0 !=2) func_10("H_LBL_APP" /*APPROACH*/);
switch (*uParam0){
case 0:
...
if(!MISC::ARE_STRINGS_EQUAL(controlGroupInstructionalButtonsString, uParam0->f_466)) func_9(uParam0);
uParam0->f_466=controlGroupInstructionalButtonsString;
func_120();
func_110(uParam0);
func_88(uParam0);
if(uParam0->f_464==1) func_85(uParam0);
if(func_22()) func_20(uParam0);
...
if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL)) func_9(uParam0);
...
k < 2;
k=k + 1){
if(uParam0->f_1.f_30[k] !=13) func_2(*uParam0, uParam0->f_1.f_30[k], false);
}
uParam0->f_427=0;
func_13(uParam0, true);
uParam0->f_456=MISC::GET_GAME_TIMER();
...
l < 2;
l=l + 1){
if(uParam0->f_1.f_30[l] !=13) func_2(*uParam0, uParam0->f_1.f_30[l], false);
}
func_114(8, 0);
func_86(5, 1, false);
uParam0->f_427=0;
...
if(uParam0->f_1.f_30[scaleformMovieMethodReturnValueInt] !=13) func_2(*uParam0, uParam0->f_1.f_30[scaleformMovieMethodReturnValueInt], true);
for (m=0;
m < uParam0->f_1.f_96;
m=m + 1){
func_62(uParam0, m);
...
switch (iParam1){
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 0)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 1)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
}
break;
case 3:
switch (iParam1){
case 12:
if(IS_BIT_SET(Global_113648.f_1.f_117, 3)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
break;
case 9:
if(IS_BIT_SET(Global_113648.f_1.f_117, 6)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
break;
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 0))if(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 1))if(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[21 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[19 /*2*/], 1);
break;
case 6:
if(IS_BIT_SET(Global_113648.f_1.f_117, 4)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 7:
if(IS_BIT_SET(Global_113648.f_1.f_117, 2)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
case 8:
if(IS_BIT_SET(Global_113648.f_1.f_117, 5)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[18 /*2*/], 1);
break;
}
break;
case 4:
switch (iParam1){
case 12:
if(IS_BIT_SET(Global_113648.f_1.f_117, 15))if(IS_BIT_SET(Global_113648.f_1.f_117, 3)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[25 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[24 /*2*/], 1);
break;
case 7:
if(IS_BIT_SET(Global_113648.f_1.f_117, 2))if(IS_BIT_SET(Global_113648.f_1.f_117, 14)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[30 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[28 /*2*/], 1);
elseif(IS_BIT_SET(Global_113648.f_1.f_117, 14)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[29 /*2*/], 1);
break;
case 9:
if(IS_BIT_SET(Global_113648.f_1.f_117, 18))if(IS_BIT_SET(Global_113648.f_1.f_117, 6)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[27 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[26 /*2*/], 1);
break;
case 4:
if(IS_BIT_SET(Global_113648.f_1.f_117, 17)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
break;
case 5:
if(IS_BIT_SET(Global_113648.f_1.f_117, 12)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[31 /*2*/], 1);
break;
case 1:
if(IS_BIT_SET(Global_113648.f_1.f_117, 10))if(IS_BIT_SET(Global_113648.f_1.f_117, 0))if(IS_BIT_SET(Global_113648.f_1.f_117, 7)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 10:
if(IS_BIT_SET(Global_113648.f_1.f_117, 11))if(IS_BIT_SET(Global_113648.f_1.f_117, 1))if(IS_BIT_SET(Global_113648.f_1.f_117, 8)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[23 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 3:
if(IS_BIT_SET(Global_113648.f_1.f_117, 13)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 6:
if(IS_BIT_SET(Global_113648.f_1.f_117, 19))if(IS_BIT_SET(Global_113648.f_1.f_117, 4)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 8:
if(IS_BIT_SET(Global_113648.f_1.f_117, 16))if(IS_BIT_SET(Global_113648.f_1.f_117, 5)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[22 /*2*/], 1);
else func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
case 13:
if(IS_BIT_SET(Global_113648.f_1.f_117, 20)) func_26(uParam0, uParam0->f_1.f_276, uParam0->f_1.f_304[20 /*2*/], 1);
break;
}
break;
}}
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_154(uParam0);
if(IS_BIT_SET(uParam0->f_449, 0)) func_153(uParam0);
return true;
}
...
if(_IS_MISSION_REPEAT_ACTIVE(false))if(ENTITY::DOES_ENTITY_EXIST(pedLocal_45)) CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_45, "FRANKLIN", 1, joaat("Player_One"), 0);
...
i < func_281(3);
i=i + 1){
if(func_279(3, i)==12) func_265(406771743);
}
...
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("MICHAEL", joaat("Player_Zero")))) ENTITY::SET_ENTITY_VISIBLE(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("MICHAEL", joaat("Player_Zero")), true, false);
...
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(ON_FOOT)==FIRST_PERSON) PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 2000, 0, true, false);
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false)) func_290(true);
}else{
if(_IS_MISSION_REPEAT_ACTIVE(false)){
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_45)) PED::DELETE_PED(&pedLocal_45);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_46)) PED::DELETE_PED(&pedLocal_46);
...
if(iLocal_94 !=-1)if(PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_94)) PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_94);
...
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("AH_2_EXT_P4")) CUTSCENE::REMOVE_CUTSCENE();
}
if(iLocal_43 !=-1){
...
break;
case 11:
if(func_328(91)) func_160(0, true);
break;
case 5:
if(func_328(91)) func_160(2, true);
break;
case 3:
if(func_328(67)) func_160(5, true);
break;
case 2:
if(func_328(77)) func_160(7, true);
break;
}}}}
if(!func_40(10) && IS_BIT_SET(Global_113648.f_24997.f_8[4], 0)) func_160(9, true);
if(!func_40(13) && IS_BIT_SET(Global_113648.f_24997.f_8[16], 0)) func_160(12, true);
if(!func_40(12))if(iParam0==4) func_160(11, true);
if(!bParam1){
if(!func_159(69)) func_23("DI_HLP_HST" /*Heist characters become available in Rockstar Editor's 'Director Mode' after being up for selection on a GTAV heist.*/, 2, 0, 20000, 10000, 7, 0, 209, 0);
...
if(!bParam1) func_158(func_161(iParam0));
}}
return;
}
...
if(!func_182(iParam2, &uParam0->f_2300[iParam1 /*3*/], &uParam0->f_2310[iParam1])) return 0;
if(!func_181(uParam0->f_2300[iParam1 /*3*/], 0f, 0f, 0f, false)){
if(!func_181(Global_99120[iParam2 /*3*/], 0f, 0f, 0f, false)){
unk.f_11=12;
unk.f_31=49;
unk.f_81=2;
if(func_166(iParam1, iParam2, &unk, &unk99, &unk102, &unk103, &unk106)) Global_100085[iParam1 /*98*/]={
unk 
};
}}
...
return true;
case 282:
if(func_166(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
case 283:
if(func_166(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6)) return true;
break;
...
if(hParam0==joaat("blimp"))if(!func_178() && !func_177() && !func_176() && !func_175() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_174() || MISC::IS_PC_VERSION() || func_173()){
}elseif(!func_176()){
return false;
}}
if(bParam1)if(!func_172(hParam0, iParam2)) return false;
if(!func_170(hParam0)) return false;
return true;
}
...
if(iParam1 < 1 || iParam1 > func_187(num, num2)) return;
...
var func__189(BOOL bParam0, var uParam1, var uParam2) // Position - 0x10148{
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SET_AUTO_GIVE_PARACHUTE_WHEN_ENTER_PLANE(PLAYER::PLAYER_ID(), func_332(67));
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) PLAYER::SET_AUTO_GIVE_SCUBA_GEAR_WHEN_EXIT_VEHICLE(PLAYER::PLAYER_ID(), func_332(68));
...
var unk;
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !func_102(_GET_CURRENT_PLAYER_CHARACTER()) || !func_234()) return;
unk=12;
unk.f_13=12;
unk.f_26=12;
unk.f_39=9;
...
var func__235(int iParam0) // Position - 0x15DE6{
return Global_1574538[iParam0];
}


var func__236() // Position - 0x15DF6{
...
if(func_327(14)) character=_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID());
...
eCharacter character;
character=_GET_PLAYER_CHARACTER_FROM_PED(pedParam0);
if(func_102(character) && !PED::IS_PED_INJURED(pedParam0)) Global_113648.f_2365.f_539.f_2296[character]=func_183();
return;
}
...
if(Global_113648.f_9087 || Global_3 || _IS_MISSION_REPEAT_ACTIVE(false))if(!Global_78558 || Global_78558 && iParam0 !=func_242(func_263()))if(iParam0==0 && !func_332(115) || iParam0==1 && !func_332(116) || iParam0==2 && !func_332(117)) return 0;
return 1;
}
...
i < CHAR_MULTIPLAYER;
i=i + 1){
if(IS_BIT_SET(num, i)) func_268(i);
}
return;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_286(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_283() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_286(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_285(-1, false)==8;
...
if(func_287())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(!bParam0){
if(ENTITY::DOES_ENTITY_EXIST(obLocal_48)) OBJECT::DELETE_OBJECT(&obLocal_48);
...
iLocal_94=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uLocal_95.f_1.f_394, uLocal_95.f_1.f_397 *{
1.5f, 1.5f, 1.5f 
}
, 0f, false, 7);
...
if(PED::GET_PED_PROP_INDEX(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD, 1)==7) PED::CLEAR_PED_PROP(PLAYER::PLAYER_PED_ID(), 0, 1);
if(!IS_BIT_SET(iLocal_41, 13)){
if(!CAM::IS_SCREEN_FADED_IN() && !CAM::IS_SCREEN_FADING_IN()) CAM::DO_SCREEN_FADE_IN(800);
MISC::SET_BIT(&iLocal_41, 13);
}
if(CUTSCENE::WAS_CUTSCENE_SKIPPED()) MISC::SET_BIT(&iLocal_41, 14);
...
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("FRANKLIN", 0)))if(!ENTITY::IS_ENTITY_DEAD(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("FRANKLIN", 0), false)) ENTITY::SET_ENTITY_VISIBLE(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("FRANKLIN", 0), false, false);
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("LESTER", 0)))if(!ENTITY::IS_ENTITY_DEAD(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("LESTER", 0), false)) ENTITY::SET_ENTITY_VISIBLE(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("LESTER", 0), false, false);
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("WALKINGSTICK_LESTER", 0)))if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("WALKINGSTICK_LESTER", 0))) ENTITY::SET_ENTITY_VISIBLE(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("WALKINGSTICK_LESTER", 0), false, false);
MISC::SET_BIT(&iLocal_41, 4);
}
}
if(!IS_BIT_SET(iLocal_41, 5)){
if(MISC::GET_GAME_TIMER() - iLocal_44 > 73900){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_49[0])) ENTITY::SET_ENTITY_VISIBLE(uLocal_49[0], false, false);
...
if(_CAN_ENTER_FREEROAM_STATE(0))if(func_312(&iLocal_42, 0, 0, false, 0)==1) MISC::SET_BIT(&iLocal_41, 2);
if(IS_BIT_SET(iLocal_41, 2)){
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_95.f_484), 0, 0, "MICHAEL", 1, 1);
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_95.f_484), 1, 0, "FRANKLIN", 1, 1);
_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_95.f_484), 3, 0, "LESTER", 1, 1);
...
if(CUTSCENE::HAS_THIS_CUTSCENE_LOADED("AH_2_EXT_ALT")) CUTSCENE::REMOVE_CUTSCENE();
if(IS_BIT_SET(iLocal_41, 6)) MISC::CLEAR_BIT(&iLocal_41, 6);
}
return;
}
...
if(uParam1->f_65==-1 && !func_298(uParam1->f_66)) uParam1->f_65=0;
...
i <=11;
i=i + 1){
if(VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1)) MISC::SET_BIT(&(uParam1->f_77), func_296(i + 1));
}
...
if(hParam0==0) return false;
if(!func_169(hParam0, false, -1)) return false;
...
if(!func_169(entityModel, false, -1)) return true;
return false;
}
...
for (i=0;
func_308(iParam1, i, &garageName, &num);
i=i + 1){
...
if(iParam4 !=0) func_313(uParam0, iParam4);
}
return 2;
}
...
if(IS_BIT_SET(uParam0->f_449, 1)) func_324(uParam0);
elseif(num < fParam1 * fParam1 || IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(uParam0->f_449, 0))if(func_323(uParam0))if(IS_BIT_SET(Global_96690, *uParam0))if(IS_BIT_SET(Global_96692, *uParam0)) func_318(uParam0);
else func_318(uParam0);
else func_317(uParam0);
...
vector={
func_320(uParam0, &uParam0->f_1.f_34[i /*2*/]) 
};
...
Vector3 func__320(var uParam0, var uParam1) // Position - 0x1A626{
float num;
float num2;
float num3;
float num4;
...
value2=0;
if(func_329(num, uParam0->f_1.f_258[i])) value2=1;
NETWORK::NETWORK_LEAVE_PED_BEHIND_BEFORE_CUTSCENE(uParam0->f_413, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(value);
...
if(Global_94666[iParam0 /*2*/]) return 1;
for (i=0;
i < Global_91433;
i=i + 1){
if(Global_91433[i /*5*/] !=-1)if(Global_78828.f_109[Global_91433[i /*5*/] /*4*/]==iParam0) return 1;
}
return 0;
}
...
var func__345(var uParam0, var uParam1) // Position - 0x1B663{
...
if(iLocal_42 !=-1) func_163(&iLocal_42);
