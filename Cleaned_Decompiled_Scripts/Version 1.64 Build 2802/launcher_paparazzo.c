...
if(num==47) iLocal_96=func_244();
if(num !=49 && num !=50) MISC::CLEAR_AREA(vector, num.f_15, true, false, false, false);
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_275(&num, true);
if(num==47) func_202(&num, vector, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
elseif(num==51) func_202(&num, vector, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
func_201(num);
func_193(&iLocal_95, &(num.f_9), vector);
if(func_178(&num, 0)){
if(func_177(num)) func_174(num, &blLocal_97);
if(!func_2(&num)) func_275(&num, true);
if(func_1(&num)) func_275(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xBFD{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6A12{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x7162{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x74EE{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x762D{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x83B0{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8BB2{
...
var func__176(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC036{
if(bParam0) return uParam1;
return uParam2;
}
...
func_288("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_182(uParam0->f_27)){
func_181(uParam0->f_27, *uParam0);
func_288("RC5_IN_ACTIVATION_RANGE:
...
if(func_182(true)){
func_181(1, *uParam0);
func_288("RC_IN_ACTIVATION_RANGE:
...
func_288("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if(func_197(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_196(uParam0, 1);
}else{
...
if(func_197(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_199(uParam0);
}}}
return;
}
...
var unk;
if(Global_78558){
func_288("IS_RC_FINE_AND_IN_RANGE():
The game is running Multiplayer [TERMINATING]");
return false;
}
func_115(*panParam0, &unk);
if(func_243(*panParam0) || func_241(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_288("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_236(panParam0->f_28[0]);
func_288("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_216(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_216(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_213(panParam0);
else func_211(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(iParam2==0) func_211(uParam0);
else func_213(uParam0);
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_149();
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), veParam0, xSize, xSize, xSize, false, true, 0))if(func_219(veParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_227(&iLocal_37[num /*4*/]);
return false;
}
if(!func_224(veParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_223();
if(num==-1) return false;
...
Vector3 func__222(Ped pedParam0, int iParam1) // Position - 0xE8E2{
...
float num;
unk={
func_226(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(veParam0, true)) 
};
...
func_226(PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__226(float fParam0, var uParam1, var uParam2) // Position - 0xEAA3{
float num;
float num2;
...
if(!bParam2){
if(func_234(veParam0, bParam1, radius, num)) return true;
if(func_231(veParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_232(veParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_232(veParam0, fParam1)) return true;
...
float num;
unk={
func_226(uParam1 - ENTITY::GET_ENTITY_COORDS(veParam0, true)) 
};
...
if(func_243(iParam0)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(4)){
if(func_241(iParam0)){
}else{
return true;
}}
if(func_240() && !func_239()) return true;
if(!func_238(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_242() && Global_100681.f_11==6 && iParam0==func_172(&(Global_100681.f_3), 0)) return true;
return false;
}
...
break;
case 49:
if(!func_257(uParam0)) return false;
break;
case 50:
if(!func_256(uParam0)) return false;
break;
case 51:
if(!func_246(uParam0)) return false;
break;
}
...
break;
case 1:
if(!func_255(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict)) return false;
iLocal_91=2;
break;
case 2:
flag=true;
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0])) TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, animDict, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[1])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", animDict, 8f, -8f, 0, 1148846080);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[2])) ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", animDict, 8f, -8f, 0, 1148846080);
}
for (i=0;
i <=num - 1;
i=i + 1){
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-82.641426f, 302.73065f, 104.63494f 
};
uParam0->f_17[1 /*3*/]={
-68.78405f, 296.6317f, 107.89578f 
};
uParam0->f_24=11f;
uParam0->f_27=0;
uParam0->f_26=1;
...
break;
case 1:
if(!func_255(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2")) return false;
iLocal_91=2;
break;
case 2:
flag=true;
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-154.98163f, 287.04315f, 96.63823f 
};
uParam0->f_17[1 /*3*/]={
-155.49458f, 274.40674f, 90.82359f 
};
uParam0->f_24=15f;
uParam0->f_27=0;
uParam0->f_25=1;
...
if(func_183(uParam0->f_35[0])) VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 62, 62);
else flag=false;
}
if(flag) iLocal_91=3;
break;
...
i <=num - 1;
i=i + 1){
if(i !=1) STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(num[i]);
}
return true;
}
return false;
...
if(func_240() && !func_239()) return false;
...
if(iParam0==58)if(func_265(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
if(func_238(iParam0)) return false;
...
int i;
if(*uParam0==1){
if(func_273(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
if(HUD::DOES_BLIP_EXIST(blLocal_97)) HUD::REMOVE_BLIP(&blLocal_97);
if(iLocal_95 !=-1){
func_288("SCRIPT TERMINATING:
...
if(*uParam0==48){
func_288("SCRIPT TERMINATING:
Holding on to launcher until Paparazzo 3 cleans up...");
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_251(&uParam0->[i]);
