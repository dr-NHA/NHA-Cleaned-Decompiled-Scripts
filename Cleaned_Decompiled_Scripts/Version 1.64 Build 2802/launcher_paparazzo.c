...
var func__175(struct<3> Param0, int iParam3){
var uVar0;
uVar0=HUD::ADD_BLIP_FOR_COORD(Param0);
HUD::SET_BLIP_SCALE(uVar0, func_176(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
float fVar6;
Var0={
func_226(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_226(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__226(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_226(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
void func_247(var uParam0, var uParam1, struct<3> Param2, float fParam5){
func_212(uParam0);
...
void func_250(var uParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6){
func_251(uParam0);
...
int func_253(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6){
int iVar0;
if(!func_36(iParam1)){
...
case 3:
if(func_132(uParam0->f_41[0])){
uLocal_94=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uParam0->f_41[0], 1), ENTITY::GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], uLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_94, 1);
if(func_132(uParam0->f_28[0])){
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
}
if(func_132(uParam0->f_41[1])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], uLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
}
if(func_132(uParam0->f_41[2])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], uLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
}}
iVar31=0;
while (iVar31 <=(iVar0 - 1)){
...
uLocal_94=PED::CREATE_SYNCHRONIZED_SCENE(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_94, 1);
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-154.9816f, 287.0432f, 96.63823f 
};
uParam0->f_17[1 /*3*/]={
-155.4946f, 274.4067f, 90.82359f 
};
uParam0->f_24=15f;
uParam0->f_27=0;
uParam0->f_25=1;
