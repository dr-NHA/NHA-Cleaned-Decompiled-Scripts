...
uLocal_930=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_930, -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
...
if(CAM::DOES_CAM_EXIST(uLocal_930)){
CAM::SET_CAM_PARAMS(uLocal_930, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
...
}elseif(func_49(PLAYER::GET_PLAYERS_LAST_VEHICLE(), joaat("sandking"))){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), Local_868.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
CAM::ATTACH_CAM_TO_ENTITY(Local_893.f_0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, 1);
}
SYSTEM::WAIT(0);
if(func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_880.f_9)){
func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_880.f_9, 1), &fVar10, &fVar11, 1);
...
Var4={
func_4(func_5(iVar0 + 1) - func_5(iVar0)) 
};
Var7={
func_4(func_5(iVar0 + 4) - func_5(iVar0)) 
};
...
Vector3 func__4(struct<3> Param0){
float fVar0;
float fVar1;
...
PAD::SET_CONTROL_SHAKE(0, iLocal_933, iLocal_934);
}}
*uParam0={
func_18(&(Local_159[uParam0->f_4[0] /*3*/]), &(Local_159[uParam0->f_4[1] /*3*/]), &(Local_159[uParam0->f_4[2] /*3*/]), &(Local_159[uParam0->f_4[3] /*3*/]), uParam0->f_3) 
};
*uParam0={
*uParam0 + Local_862 
};
...
Vector3 func__18(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4){
struct<3> Var0;
float fVar3;
float fVar4;
...
uParam0->f_9=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_40, *uParam0, 1, 1, 0);
if(func_56(uParam0->f_9)){
ENTITY::SET_ENTITY_COLLISION(uParam0->f_9, 0, 0);
ENTITY::SET_ENTITY_VISIBLE(uParam0->f_9, 0, 0);
...
void func_29(){
int iVar0;
iLocal_925[0]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), 1, 0, 1);
iLocal_925[1]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
iLocal_925[2]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
iLocal_925[3]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
iVar0=0;
while (iVar0 < iLocal_925){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_925[iVar0])){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_925[iVar0], 1, 0);
ENTITY::SET_ENTITY_VISIBLE(iLocal_925[iVar0], 0, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_925[iVar0], 0, 0);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_925[iVar0], 1);
}
iVar0++;
}}
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_113(iVar10, iParam1, iParam2, -1) 
};
if(!func_112(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_113(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_113(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_113(iVar10, iVar0, func_70(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_113(iVar10, 14, uVar69[iVar1], -1) 
};
func_81(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_104(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_113(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_99(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_98(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
if(func_82(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3))){
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_71(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_71(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_71(iParam0));
if(iVar57 > iVar56){
...
Global_78341[1 /*14*/]={
func_113(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_71(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_71(iParam1))){
return 1;
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_183(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_196() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_196() /*5568*/].f_681.f_10, iParam0);
}


var func__200(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_108();
}
...
Vector3 func__222(int iParam0, struct<3> Param1){
var uVar0;
...
iLocal_925[0]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, 1, 1, 0);
}
if(!func_56(iLocal_925[1])){
iLocal_925[1]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, 1, 1, 0);
}
if(!func_56(iLocal_925[2])){
iLocal_925[2]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, 1, 1, 0);
}
if(!func_56(iLocal_925[3])){
iLocal_925[3]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, 1, 1, 0);
}
iVar0=0;
while (iVar0 < iLocal_925){
if(func_56(iLocal_925[iVar0])){
ENTITY::SET_ENTITY_HEADING(iLocal_925[iVar0], 140f);
ENTITY::SET_ENTITY_VISIBLE(iLocal_925[iVar0], 1, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_925[iVar0], 1, 0);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_925[iVar0], 1);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_925[iVar0], 1);
