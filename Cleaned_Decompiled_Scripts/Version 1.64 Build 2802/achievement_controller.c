...
if(MISC::IS_BIT_SET(Global_2793044.f_2320.f_18, 1)){
func_137(41, 1);
}}
...
if(Var45.f_4==joaat("WAPClip")){
iVar43=Var45.f_6;
}elseif(Var45.f_4==joaat("WAPScop")){
iVar42=Var45.f_6;
}}elseif((((Var45.f_4==joaat("WAPClip") || Var45.f_4==joaat("WAPScop")) || Var45.f_4==joaat("WAPRail")) || Var45.f_4==joaat("gun_root")) || Var45.f_4==-31573710){
}else{
return 0;
}
iVar44++;
...
var func__39(struct<7> Param0, int iParam7){
var uVar0;
var uVar1;
var uVar2;
if(func_48(Param0)==0){
...
var func__49(struct<6> Param0, var uParam6){
var uVar0;
if(Param0.f_0 > 0){
...
}elseif(iParam5==func_65()){
StringCopy(sParam0, "VE_KOSATKA_t0_v0", 64);
}elseif(iParam5==func_64()){
if(iParam7==40){
...
case joaat("component_specialcarbine_clip_03"):
return 0;
default:}}elseif(func_74(iParam0)){
...
return MISC::IS_BIT_SET(uVar0, func_83(iVar1));
}
...
var func__86(int iParam0, int iParam1, int iParam2){
var uVar0;
...
var func__93(int iParam0, int iParam1, int iParam2){
var uVar0;
...
return (func_103(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
return 1;
}elseif(Global_113648.f_1990[1 /*121*/][iVar0 /*10*/].f_8==3){
return 1;
}elseif(Global_113648.f_1990[2 /*121*/][iVar0 /*10*/].f_8==3){
return 1;
}
iVar0++;
}
...
return 1;
}elseif(Global_113648.f_19149[1 /*271*/].f_3[iVar0 /*12*/].f_3==3){
return 1;
}elseif(Global_113648.f_19149[2 /*271*/].f_3[iVar0 /*12*/].f_3==3){
return 1;
}
iVar0++;
}
...
bVar0=false;
while (bVar0 < 4){
if(MISC::IS_BIT_SET(Global_113648.f_24978.f_1, bVar0)){
return 1;
}
bVar0++;
}
...
bVar0=false;
while (bVar0 < 5){
if(MISC::IS_BIT_SET(Global_113648.f_24981.f_2, bVar0)){
return 1;
}
bVar0++;
}
...
switch (iParam1){
case 1:
return !MISC::IS_BIT_SET(Global_91469[iParam0 /*34*/].f_15, 5);
break;
case 7:
...
if(func_105(uParam0)){
if(!func_104(uParam0)){
uParam0->f_2=(func_103(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
...
iVar0=0;
iVar1=func_168(2);
if(func_167(iVar1, 0) || MISC::IS_BIT_SET(Global_96532, 2)){
iVar0++;
}
iVar1=func_168(1);
if(func_167(iVar1, 0) || MISC::IS_BIT_SET(Global_96532, 1)){
iVar0++;
}
iVar1=func_168(0);
if(func_167(iVar1, 0) || MISC::IS_BIT_SET(Global_96532, 0)){
iVar0++;
}
return iVar0;
}
...
uParam0->f_1=(func_103(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
