...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_260(&num, true);
func_203(num);
...
if(func_174(&num, 0)){
if(!func_2(&num)) func_260(&num, true);
if(func_1(&num)) func_260(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xB8F{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x69A4{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x70F4{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x7480{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x75BF{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x8342{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B44{
...
return 1;
}}elseif(func_190(sParam5)){
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))if(func_195(PLAYER::PLAYER_PED_ID(), uParam1, true) >=20f) func_149();
}}
return 0;
}
...
if(func_202()){
if(*uParam0 !=-1) func_200(uParam0);
}elseif(*uParam0==-1){
if(func_195(PLAYER::PLAYER_PED_ID(), uParam3, true) <=100f) func_199(uParam0, 1);
}else{
...
if(func_195(PLAYER::PLAYER_PED_ID(), uParam3, true) > 120f) func_200(uParam0);
}}}
return;
}
...
Vector3 func__220(Ped pedParam0, int iParam1) // Position - 0xE3DF{
...
Vector3 func__224(float fParam0, var uParam1, var uParam2) // Position - 0xE5A0{
float num;
float num2;
...
if(!func_243(uParam0)) return false;
...
break;
case 1:
if(!func_246(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1") || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_PUMPSHOTGUN")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_SNIPERRIFLE"))) return false;
iLocal_91=2;
break;
case 2:
flag=true;
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[0], 0);
else flag=false;
}
if(flag) iLocal_91=3;
break;
...
if(func_255(iParam0)) return false;
if(iParam0==-1) iParam0=func_171();
if(iParam0==-1) return false;
if(!func_241(iParam0)){
...
if(iParam0==58)if(func_250(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
int i;
if(*uParam0==1){
if(func_258(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_272(&uParam0->[i]);
else func_271(&uParam0->[i], false, 1, 0);
}
return;
}
