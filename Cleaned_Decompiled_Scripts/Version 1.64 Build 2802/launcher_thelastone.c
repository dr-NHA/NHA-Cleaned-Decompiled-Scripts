...
void func_196(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9){
float fVar0;
float fVar1;
float fVar2;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
case 2:
bVar5=true;
uParam0->f_28[0]=PED::CREATE_PED(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
