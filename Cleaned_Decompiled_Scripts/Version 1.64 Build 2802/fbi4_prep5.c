...
int func_39(var uParam0, struct<3> Param1, var uParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_27(uParam0)){
...
case 0:
if(func_95(iLocal_84, bLocal_28)){
func_108(&uLocal_200, Local_205, 1, 1, "PRE_BLIP");
if(HUD::DOES_BLIP_EXIST(uLocal_200)){
HUD::SET_BLIP_COLOUR(uLocal_200, 2);
HUD::SET_BLIP_ROUTE_COLOUR(uLocal_200, 2);
}
...
func_108(&uLocal_200, Local_205, 1, 1, "PRE_SHOP");
}elseif(func_105(PLAYER::PLAYER_PED_ID(), Local_205, 12f, 1)){
if(iLocal_198){
func_22(&uLocal_200);
iLocal_198=0;
}
...
bool func_105(int iParam0, struct<3> Param1, float fParam4, int iParam5){
...
void func_108(var uParam0, struct<3> Param1, int iParam4, bool bParam5, char* sParam6){
if(!HUD::DOES_BLIP_EXIST(*uParam0)){
*uParam0=func_109(Param1, 5, iParam4);
if(bParam5){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, sParam6);
}}}

int func_109(struct<3> Param0, int iParam3, int iParam4){
int iVar0;
iVar0=0;
...
Var1={
29.0849f, -1111.087f, 28.3095f 
};
fVar4=81.7758f;
}else{
Var1={
42.7098f, -1105.501f, 28.1318f 
};
fVar4=147.8968f;
}
...
return 1;
}elseif(func_141(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_179(iParam0, 0, 0)) || func_179(iParam0, 1, 0)) || func_179(iParam0, 2, 0)) || func_178(iParam0) !=145) || func_177(iParam0)) || func_176(iParam0)) || func_124(iParam0)) || func_175(iParam0)) || !func_163(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_176(iParam0)){
}
if(func_176(iParam0)){
}
...
}elseif(func_189(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
}elseif((!func_208(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_209(iParam0, uVar1[iVar6], 1) && func_97(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_204(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_218(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_217()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
var func__215(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
func_247(2);
}elseif(!func_105(PLAYER::PLAYER_PED_ID(), Local_205, 75f, 1)){
if(!bLocal_208){
HUD::CLEAR_PRINTS();
...
}elseif(Global_113648.f_2365.f_539.f_2403[1]==-99){
func_250(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
}elseif(Global_113648.f_2365.f_539.f_2403[2]==-99){
...
func_250(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
}elseif(Global_113648.f_2365.f_539.f_2403[0]==-99){
func_250(sLocal_80[0], sLocal_80[1], sLocal_80[2]);
}elseif(Global_113648.f_2365.f_539.f_2403[2]==-99){
func_250(sLocal_80[2], sLocal_80[1], sLocal_80[0]);
}
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_261() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
void func_262(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4){
int iVar0;
if(bParam4){}
...
return MISC::IS_BIT_SET(Global_2359296[func_261() /*5568*/].f_681.f_10, iParam0);
}
...
if(func_92()==0){
uVar0=func_89(func_91(iParam0), -1, 0);
MISC::SET_BIT(&uVar0, bParam1);
func_262(func_91(iParam0), uVar0, -1, 1, 0);
}}else{
...
Global_78341[1 /*14*/]={
func_299(iParam0, iParam1, iParam2, -1) 
};
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 10, -1, 0, -1, func_310(iParam0));
if(iVar57 > iVar56){
