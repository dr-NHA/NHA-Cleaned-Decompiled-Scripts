...
func_77();
Global_4543155=0;
MISC::SET_BIT(&Global_4543155, false);
MISC::SET_BIT(&Global_4543155, true);
iVar1=0;
while (iVar1 < 131){
...
while ((!MISC::IS_BIT_SET(Global_4543155, 0) || !MISC::IS_BIT_SET(Global_4543155, 1)) || !MISC::IS_BIT_SET(Global_4543155, 2)){
if(!MISC::IS_BIT_SET(Global_4543155, 0)){
}
if(!MISC::IS_BIT_SET(Global_4543155, 1)){
}
if(!MISC::IS_BIT_SET(Global_4543155, 2)){
}
SYSTEM::WAIT(0);
}
MISC::START_SAVE_DATA(&Global_113648, 1, 1);
...
MISC::START_SAVE_DATA(&Global_2359296, 5569, 0);
...
char cVar36[16];
char cVar40[16];
MISC::START_SAVE_STRUCT_WITH_SIZE(uParam0, 4469, cParam1);
...
int iVar0;
char cVar1[16];
MISC::START_SAVE_STRUCT_WITH_SIZE(uParam0, 586, cParam1);
...
int iVar0;
char cVar1[16];
MISC::START_SAVE_STRUCT_WITH_SIZE(uParam0, 7, cParam1);
...
iVar1=171;
while (iVar1 <=198){
if(MISC::IS_BIT_SET(Global_113648.f_25184[iVar1], bVar0)){
...
void func_33(){
REPLAY::REGISTER_EFFECT_FOR_REPLAY_EDITOR("No_Filter", 1);
...
*uParam18={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Param12, 0f, Var0) 
};
...
uVar18=MISC::GET_HASH_KEY(&sVar2);
if(NETSHOPPING::NET_GAMESERVER_CATALOG_ITEM_KEY_IS_VALID(uVar18)){
uVar19=NETSHOPPING::NET_GAMESERVER_GET_PRICE(uVar18, 426439576, 1);
Var20={
func_66(iParam0) 
};
return uVar19;
