...
if(ENTITY::DOES_ENTITY_EXIST(Global_112358.f_222[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112358.f_222[0], 0)){
...
Var8={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_245, 1067030938, 1069547520) 
};
uLocal_247=OBJECT::CREATE_PICKUP(joaat("pickup_money_med_bag"), Var8, Local_37.f_28, -1, 1, Local_37.f_10);
...
Var8={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_246, 1067030938, 1069547520) 
};
uLocal_248=OBJECT::CREATE_PICKUP(joaat("pickup_money_med_bag"), Var8, Local_37.f_29, -1, 1, Local_37.f_11);
...
func_45();
}elseif(HUD::DOES_BLIP_EXIST(uLocal_249)){
...
func_45();
}elseif(HUD::DOES_BLIP_EXIST(uLocal_250)){
...
HUD::CLEAR_PRINTS();
func_37();
}}elseif((OBJECT::DOES_PICKUP_EXIST(uLocal_247) && func_36(PLAYER::PLAYER_PED_ID(), OBJECT::GET_PICKUP_COORDS(uLocal_247), 1) > 500f) || (OBJECT::DOES_PICKUP_EXIST(uLocal_248) && func_36(PLAYER::PLAYER_PED_ID(), OBJECT::GET_PICKUP_COORDS(uLocal_248), 1) > 500f)){
func_45();
}elseif(iLocal_242 && func_34()){
HUD::CLEAR_PRINTS();
...
}}elseif(PED::IS_PED_IN_VEHICLE(iLocal_245, iLocal_244, 1) && (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_244, 0, 3000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_244, 1, 3000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_244, 2, 8000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_244, 3, 8000))){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_246, 0) && !func_33(iLocal_246, joaat("script_task_smart_flee_ped"), 1)){
...
if(func_86()){
func_79();
}}elseif(func_39(PLAYER::PLAYER_PED_ID(), iLocal_245, 1) < 15f){
switch (iLocal_238){
case 0:
if(func_31()){
MemCopy(&cVar0,{
...
}}elseif((MISC::GET_GAME_TIMER() - iLocal_253) > 2000){
...
if(((VEHICLE::IS_TURRET_SEAT(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0)==joaat("apc") && iVar1 !=-1)) || (ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("akula") && iVar1 !=-1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0)==joaat("riot2") && iVar1==0) && func_55(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) !=-1)){
return 0;
}}}
if(Global_1962010){
return 0;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_54(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=1;
uParam0->f_7=1;
}}elseif(func_69(bParam1, bParam2, bParam3)){
uParam0->f_4=MISC::GET_GAME_TIMER();
uParam0->f_5=1;
uParam0->f_7=1;
...
uParam0->f_5=0;
}elseif(!func_70(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_67(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_68(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
case 5:
*uParam0={
178.0117f, 202.3507f, 102.9037f 
};
uParam0->f_3={
514.5839f, 78.78811f, 111.1864f 
};
uParam0->f_6=131.0625f;
break;
case 6:
*uParam0={
418.5796f, -636.2899f, 25.43758f 
};
uParam0->f_3={
400.2468f, -826.1611f, 44.10468f 
};
uParam0->f_6=95.375f;
break;
case 7:
*uParam0={
-1368.458f, -238.4543f, 40.36241f 
};
uParam0->f_3={
-1475.669f, -127.621f, 65.65466f 
};
uParam0->f_6=158.25f;
break;
case 11:
...
*uParam0={
-602.3785f, 258.2744f, 79.0293f 
};
uParam0->f_3={
-469.064f, 244.8735f, 97.88577f 
};
uParam0->f_6=70.125f;
}else{
*uParam0={
-621.5889f, 262.0915f, 78.67405f 
};
uParam0->f_3={
-494.7666f, 248.2196f, 97.88564f 
};
uParam0->f_6=70.125f;
}
break;
...
if(func_89(func_92(), Var0)){
*uParam0={
137.2073f, 392.7482f, 110.9443f 
};
uParam0->f_3={
297.2104f, 336.0269f, 120.3525f 
};
uParam0->f_6=95.375f;
}else{
*uParam0={
191.3225f, 364.9949f, 104.5153f 
};
uParam0->f_3={
320.3688f, 325.2877f, 120.2689f 
};
uParam0->f_6=70.125f;
}
break;
...
if(func_89(func_92(), Var0)){
*uParam0={
-221.6586f, 6310.131f, 28.40555f 
};
uParam0->f_3={
-319.8287f, 6211.665f, 46.19521f 
};
uParam0->f_6=95.375f;
}else{
*uParam0={
-260.2809f, 6273.981f, 28.42822f 
};
uParam0->f_3={
-371.5657f, 6164.586f, 46.1894f 
};
uParam0->f_6=95.375f;
}
break;
case 14:
*uParam0={
-2313.765f, 4159.022f, 29.59011f 
};
uParam0->f_3={
-2140.887f, 4437.057f, 72.619f 
};
uParam0->f_6=113.5f;
break;
}}
...
Vector3 func__91(struct<3> Param0){
float fVar0;
float fVar1;
