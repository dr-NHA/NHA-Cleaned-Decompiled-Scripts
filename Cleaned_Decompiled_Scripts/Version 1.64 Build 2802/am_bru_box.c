...
if(func_227(PLAYER::PLAYER_ID()) !=1 && !MISC::IS_BIT_SET(Global_2793044.f_912.f_7, 0)){
func_228();
}}}
...
if((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60.f_3, 500f, 500f, 500f, 0, 1, 0) && func_227(PLAYER::PLAYER_ID()) !=1) && !MISC::IS_BIT_SET(Global_2793044.f_912.f_7, 0)){
...
Var6={
Global_4718592.f_1265[iVar12 /*23466*/].f_2787[0 /*36*/].f_16 
};
Var9={
Global_4718592.f_1265[iVar12 /*23466*/].f_2787[0 /*36*/].f_19 
};
fVar5=Global_4718592.f_1265[iVar12 /*23466*/].f_2787[0 /*36*/].f_23;
iVar4=1;
}elseif(Global_4718592.f_1265[iVar12 /*23466*/].f_2787[0 /*36*/].f_22 > 0f){
Var6={
Global_4718592.f_1265[iVar12 /*23466*/].f_2787[0 /*36*/].f_13 
};
...
Var13.f_10=1;
if(iVar4==0){
if(MISC::IS_BIT_SET(Local_60.f_1, 8) || func_186(Var6, fVar5, &Var0, &uVar3, &Var13)){
if(Local_60.f_7 >=32 || func_227(PLAYER::PLAYER_ID())==1){
...
}}elseif(MISC::IS_BIT_SET(Local_60.f_1, 8) || func_8(Var6, Var9, fVar5, &Var0, &uVar3, Var13)){
if(Local_60.f_7 >=32 || func_227(PLAYER::PLAYER_ID())==1){
Local_60.f_2=NETWORK::OBJ_TO_NET(OBJECT::CREATE_PORTABLE_PICKUP(joaat("pickup_portable_package"), Var0, 1, joaat("prop_drug_package_02")));
}else{
Local_60.f_2=NETWORK::OBJ_TO_NET(OBJECT::CREATE_NON_NETWORKED_PORTABLE_PICKUP(joaat("pickup_portable_package"), Var0, 1, joaat("prop_drug_package_02")));
...
if(uParam4->f_5){}elseif(func_102(Param0, 1, 0, uParam4->f_15, 1060320051, 1086324736, 1065353216, 1088421888)){
iVar8=0;
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_119(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam3)){
if(CAM::IS_SPHERE_VISIBLE(Param0, fParam3)){
return 1;
}}}}}
iVar0=0;
...
if(!bParam7){
if((iParam5 || (iParam5==0 && PLAYER::GET_PLAYER_TEAM(iVar1) !=PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()))) || PLAYER::GET_PLAYER_TEAM(iVar1)==-1){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_119(iVar1), Param0, 1) <=(fVar2 + fParam3)){
if(NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, Param0, fParam3)){
return 1;
}}}
}
...
Global_2635559.f_3=(Global_2635559.f_3 + Global_2635559.f_2);
}}elseif(func_177(Param0, 6f, 5f, 5f, 5f, 0, bParam6, iParam7, fParam8, bParam15, -1, 1, 0, 0, fParam13, bParam14, 0)){
Global_2635559.f_3=(Global_2635559.f_3 + Global_2635559.f_2);
if(!func_128(Param0, fParam12)){
Global_2635559.f_3++;
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_79(iVar1), Param0, 1) < fParam3){
return 1;
}}
}}}}}
iVar0++;
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_79(iVar1), Param0, 1) <=(fVar2 + fParam3)){
if(NETWORK::IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, Param0, fParam3)){
return 1;
}
}}}}
...
if(!func_168(Var1)){
Var1={
func_164(Var1, &fVar4, iVar9, uParam2->f_9, *uParam2, iVar10, uParam2->f_11, uParam2->f_34, &bVar11, bVar12, 1, uParam2->f_51, uParam2->f_60) 
};
...
elseif(func_177(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_156(Var1, fVar4, uParam2->f_34, 1, 1, 0, 0, 0, 0)){
iVar23=1;
}
}
...
*uParam5={
func_164(*uParam5, fParam6, iParam9, uParam7->f_9, *uParam7, iParam8, uParam7->f_11, uParam7->f_34, &bParam13, 0, 0, uParam7->f_51, uParam7->f_60) 
};
if(!func_168(*uParam5)){
iVar0=999;
return;
...
Vector3 func__164(struct<3> Param0, var uParam3, int iParam4, bool bParam5, struct<3> Param6, int iParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16){
struct<3> Var0;
var uVar3;
var uVar4;
var uVar5;
...
bVar12=true;
}}elseif(func_177(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_156(Var3, fVar6, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0)){
bVar12=true;
}
}
if(bVar12){
...
HUD::REMOVE_BLIP(&uLocal_170);
}}


void func_194(){
if(!MISC::IS_BIT_SET(Global_2672505.f_3689, 0)){
...
if(!HUD::DOES_BLIP_EXIST(uLocal_170)){
if(NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_2)){
uLocal_170=HUD::ADD_BLIP_FOR_ENTITY(NETWORK::NET_TO_OBJ(Local_60.f_2));
if(func_214()){
HUD::SET_BLIP_SCALE(uLocal_170, 0.85f);
}else{
HUD::SET_BLIP_SCALE(uLocal_170, 1.2f);
}
HUD::SET_BLIP_SPRITE(uLocal_170, 403);
HUD::SET_BLIP_COLOUR(uLocal_170, 2);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_170, "ABB_BLIPN");
}}}
