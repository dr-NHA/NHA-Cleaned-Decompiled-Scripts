...
if(character==CHAR_TREVOR) return 11;
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR) TEXT_LABEL_ASSIGN_STRING(sParam0, "dadwhatthefuck", 64);
elseif(character==CHAR_MICHAEL) TEXT_LABEL_ASSIGN_STRING(sParam0, "jessie_ig_2_yeahyeahyeah", 64);
elseif(character==CHAR_FRANKLIN) TEXT_LABEL_ASSIGN_STRING(sParam0, "its_all_good_my_dads_really_happy_with_me", 64);
return;
}
...
var func__83(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2DC0{
...
Vector3 func__87(float fParam0, var uParam1, var uParam2) // Position - 0x2EE7{
float num;
float num2;
