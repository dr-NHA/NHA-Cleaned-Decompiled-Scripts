...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)) func_163();
if(Global_40195[0]==1) SCRIPT::TERMINATE_THIS_THREAD();
if(func_121(uLocal_48, -1, 0, false, false)) func_118(-1);
...
break;
case 1:
if(shLocal_64==0) shLocal_64=unk_0x29CDE2F9C4D4CAF2(101, -104.982f, 6408.7373f, 30.4905f, 180000f);
func_110();
if(!PED::IS_PED_INJURED(pedLocal_53)){
func_109();
}elseif(!PED::IS_PED_INJURED(pedLocal_54)){
func_105();
func_104();
}else{
func_163();
}
if(bLocal_76) func_102();
...
if(HUD::DOES_BLIP_EXIST(blLocal_57)) HUD::REMOVE_BLIP(&blLocal_57);
...
if(!bLocal_86)if(MISC::CREATE_INCIDENT(DT_PoliceVehicleRequest, uLocal_48, 2, 0f, &uLocal_88, 0, 0)) bLocal_86=true;
break;
case 3:
if(bLocal_84){
...
if(func_53())if(!bLocal_77)if(bLocal_87)if(_CONVERSATION_ADD_LINE(&uLocal_101, "RERHOAU", "RERHO_THANK", 4, iLocal_266, 0, 0)) bLocal_77=true;
elseif(_CONVERSATION_ADD_LINE(&uLocal_101, "RERHOAU", "RERHO_NOGUN", 4, iLocal_266, 0, 0)) bLocal_77=true;
func_3();
if(!PED::IS_PED_INJURED(pedLocal_53)){
...
if(bLocal_77)if(!bLocal_85)if(!PED::IS_PED_INJURED(pedLocal_54))if(_CONVERSATION_ADD_LINE(&uLocal_101, "RERHOAU", "RERHO_CONS", 4, iLocal_266, 0, 0)) bLocal_85=true;
...
if(!bLocal_86 && bLocal_85)if(MISC::CREATE_INCIDENT(DT_AmbulanceDepartment, uLocal_48, 2, 0f, &uLocal_89, 0, 0)) bLocal_86=true;
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_48) > 5625f && !CAM::IS_SPHERE_VISIBLE(uLocal_48, 10f)) func_28();
}
break;
}}elseif(iLocal_47==3){
func_28();
...
if(PED::IS_PED_RAGDOLL(pedLocal_53)) ENTITY::SET_ENTITY_HEALTH(pedLocal_53, 0, 0);
}elseif(PED::IS_PED_RAGDOLL(pedLocal_53)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_53, false);
TASK::TASK_SMART_FLEE_COORD(pedLocal_53, uLocal_48, 50f, -1, false, false);
PED::SET_PED_KEEP_TASK(pedLocal_53, true);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_53);
...
if(PED::IS_PED_RAGDOLL(pedLocal_54)) ENTITY::SET_ENTITY_HEALTH(pedLocal_54, 0, 0);
}elseif(PED::IS_PED_RAGDOLL(pedLocal_54)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_54, false);
TASK::TASK_SMART_FLEE_COORD(pedLocal_54, uLocal_48, 50f, -1, false, false);
PED::SET_PED_KEEP_TASK(pedLocal_54, true);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_54);
...
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_53);
func_54();
}}}elseif(!PED::IS_PED_INJURED(pedLocal_53)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_53, false);
TASK::TASK_SMART_FLEE_COORD(pedLocal_53, uLocal_48, 50f, -1, false, false);
PED::SET_PED_KEEP_TASK(pedLocal_53, true);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_53);
...
if(!PED::IS_PED_INJURED(pedLocal_53)){
if(MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(pedLocal_53, 31086, 0f, 0f, 0f), 15f, true)) flag=true;
vector={
vector + PED::GET_PED_BONE_COORDS(pedLocal_53, 31086, 0f, 0f, 0f) 
};
vector2={
vector2 + PED::GET_PED_BONE_COORDS(pedLocal_53, 31086, 0f, 0f, 0f) 
};
...
if(!PED::IS_PED_INJURED(pedLocal_54))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_54, PLAYER::PLAYER_PED_ID(), true)) flag=true;
else flag=true;
flag;
return flag;
}
...
if(func_41(iParam0)) Global_113648.f_24997.f_2=3;
if(func_40(iParam0, iParam1) !=322) func_34(func_40(iParam0, iParam1), uLocal_44, uLocal_44.f_1);
Global_113636=iParam1;
if(Global_113634==0)if(Global_113637==1 || Global_113637==5 || Global_113637==11 || Global_113637==25) func_33(2);
elseif(Global_113637==26 || Global_113637==8 || Global_113637==17) func_33(7);
else func_33(1);
}
return;
}
...
if(value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_113648.f_10196.f_3853)) func_37(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
...
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -91.307045f, 6391.8535f, 30.640295f, -102.55954f, 6403.1025f, 32.454437f, 8.5f, false, true, 0)) TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_54, iLocal_68, sLocal_267, "bystander_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
else PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_54, false);
}
TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_53, iLocal_68, sLocal_267, "girl_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_68)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_68) > 0.1f) func_3();
if(!bLocal_78)if(bLocal_87)if(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_68) > 0.5f)if(_CONVERSATION_ADD_LINE(&uLocal_101, "RERHOAU", "RERHO_SAINT", 4, iLocal_266, 0, 0)) bLocal_78=true;
elseif(_CONVERSATION_ADD_LINE(&uLocal_101, "RERHOAU", "RERHO_THANK", 4, iLocal_266, 0, 0)) bLocal_78=true;
...
if(!PED::IS_PED_INJURED(pedLocal_54)) PED::SET_PED_DIES_WHEN_INJURED(pedLocal_54, true);
bLocal_76=true;
}else{
ENTITY::SET_ENTITY_HEALTH(pedLocal_52, 50, 0);
}}}elseif(SYSTEM::TIMERA() > 6000){
...
if(HUD::DOES_BLIP_EXIST(blLocal_57)) HUD::SHOW_HEIGHT_ON_BLIP(blLocal_57, true);
if(!bLocal_80){
...
if(_CONVERSATION_ADD_LINE(&uLocal_101, "RERHOAU", sLocal_91, 4, 0, 0, 0)) iLocal_63=24000;
SYSTEM::SETTIMERA(0);
bLocal_80=true;
}}}elseif(MISC::ARE_STRINGS_EQUAL(sLocal_92, "NULL")){
...
break;
}}elseif(_CONVERSATION_ADD_LINE(&uLocal_101, "RERHOAU", sLocal_92, 4, iLocal_266, 0, 0)){
SYSTEM::SETTIMERA(0);
}}else{
sLocal_92="NULL";
}
...
WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true);
if(WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(PLAYER::PLAYER_PED_ID(), weaponHash, joaat("COMPONENT_AT_AR_FLSH")))if(WEAPON::IS_PED_WEAPON_COMPONENT_ACTIVE(PLAYER::PLAYER_PED_ID(), weaponHash, joaat("COMPONENT_AT_AR_FLSH"))) flag=true;
elseif(WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(PLAYER::PLAYER_PED_ID(), weaponHash, joaat("COMPONENT_AT_PI_FLSH")))if(WEAPON::IS_PED_WEAPON_COMPONENT_ACTIVE(PLAYER::PLAYER_PED_ID(), weaponHash, joaat("COMPONENT_AT_PI_FLSH"))) flag=true;
if(flag)if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(pedParam0, true), _GET_PLAYER_COORDS(PLAYER::PLAYER_ID())) < 8f) return true;
return false;
}
...
bLocal_100=true;
return true;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_99 + 120000){
bLocal_100=true;
return true;
}
return false;
...
if(!PED::IS_PED_INJURED(randomPedAtCoord))if(ENTITY::GET_ENTITY_MODEL(randomPedAtCoord)==joaat("S_F_Y_Cop_01") || ENTITY::GET_ENTITY_MODEL(randomPedAtCoord)==joaat("S_M_Y_Cop_01")) return true;
...
i < pedNearbyVehicles;
i=i + 1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(sizeAndVehs[i], false))if(ENTITY::GET_ENTITY_MODEL(sizeAndVehs[i])==joaat("police") || ENTITY::GET_ENTITY_MODEL(sizeAndVehs[i])==joaat("pranger") || ENTITY::GET_ENTITY_MODEL(sizeAndVehs[i])==joaat("sheriff") || ENTITY::GET_ENTITY_MODEL(sizeAndVehs[i])==joaat("sheriff2")) return true;
}}
return false;
}
BOOL func_62() // Position - 0x2C74{
if(ENTITY::IS_ENTITY_AT_ENTITY(pedLocal_52, PLAYER::PLAYER_PED_ID(), 2f, 2f, 1.5f, false, true, 0))if(PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), pedLocal_52)) return true;
return false;
}
...
if(!PED::IS_PED_INJURED(pedLocal_54))if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), pedLocal_54)) flag=true;
if(!PED::IS_PED_INJURED(pedLocal_53))if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), pedLocal_53)) flag=true;
if(!PED::IS_PED_INJURED(pedLocal_52))if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), pedLocal_52)) flag=true;
}}
flag;
return flag;
}
...
if(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 15f)if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_52, num + 17f, num + 17f, 6f, false, true, 0)) flag2=true;
elseif(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 10f)if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_52, num + 12f, num + 12f, 6f, false, true, 0)) flag2=true;
elseif(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 5f)if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_52, num + 8f, num + 8f, 6f, false, true, 0)) flag2=true;
}
if(flag2){
dx={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - uLocal_48 
};
headingFromVector2d=MISC::GET_HEADING_FROM_VECTOR_2D(dx, dx.f_1);
if(func_65(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), headingFromVector2d, 15f)) flag=true;
dx={
...
if(ENTITY::DOES_ENTITY_EXIST(playersLastVehicle))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(playersLastVehicle, -91.56341f, 6391.747f, 30.639702f, -101.2611f, 6401.6997f, 32.454494f, 7.5f, false, true, 0)) flag=true;
flag;
return flag;
}
...
if(num > num2)if(entityHeading < num && entityHeading > num2) return true;
elseif(entityHeading < num || entityHeading > num2) return true;
}
return false;
}
...
if(HUD::DOES_BLIP_EXIST(blLocal_57)) HUD::SHOW_HEIGHT_ON_BLIP(blLocal_57, false);
func_75(true);
iLocal_99=MISC::GET_GAME_TIMER();
...
if(func_41(Global_113637)) func_76(0);
HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
if(bParam0 && func_41(Global_113637)) HUD::FLASH_MINIMAP_DISPLAY();
return 1;
}
return 0;
}
...
if(iParam4 !=0) func_81(uParam0, iParam4);
}
return 2;
}
...
var func__88(BOOL bParam0, var uParam1, var uParam2) // Position - 0x39C2{
if(bParam0) return uParam1;
return uParam2;
}
BOOL func_89() // Position - 0x39D9{
if(!_CAN_ENTER_FREEROAM_STATE(5)) return true;
if(func_97()) return true;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_96()) return false;
if(func_90(100f, true) !=-1) return true;
return false;
}
...
if(func_100() && !func_96()) return true;
if(func_99() && func_98()) return true;
return false;
}
...
if(Global_113637==func_50() && MISC::GET_RANDOM_EVENT_FLAG() && Global_113638) return true;
return false;
}
...
if(!bLocal_82){
if(!PED::IS_PED_INJURED(pedLocal_53)) PED::SET_PED_SHOOTS_AT_COORD(pedLocal_52, PED::GET_PED_BONE_COORDS(pedLocal_53, 31086, 0f, 0f, -0.1f), false);
bLocal_82=true;
bLocal_80=true;
func_103();
}}}elseif(!PED::IS_PED_INJURED(pedLocal_53)){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_67)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_67) > 0.6f) func_103();
}elseif(!PED::IS_PED_INJURED(pedLocal_53)){
PED::SET_PED_DIES_WHEN_INJURED(pedLocal_53, true);
ENTITY::SET_ENTITY_HEALTH(pedLocal_53, 0, 0);
}
...
if(uLocal_101[2 /*10*/].f_7) func_56(&uLocal_101, 2);
func_108();
...
if(!bLocal_100) iLocal_47=2;
elseif(func_107(&uLocal_101, "RERHOAU", "RERHO_BLAME", "RERHO_BLAME_3", 4, iLocal_266, 0)) iLocal_47=2;
}else{
if(!PED::IS_PED_INJURED(pedLocal_54)){
if(!PED::IS_PED_INJURED(pedLocal_52)) TASK::TASK_SMART_FLEE_PED(pedLocal_54, pedLocal_52, 100f, -1, false, false);
else TASK::TASK_SMART_FLEE_PED(pedLocal_54, PLAYER::PLAYER_PED_ID(), 100f, -1, false, false);
PED::SET_PED_KEEP_TASK(pedLocal_54, true);
if(!bLocal_100){
...
bLocal_80=true;
func_103();
}elseif(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(pedLocal_53)){
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_48, 50f, 50f, 25f, false, true, 0)) iLocal_266=0;
else iLocal_266=1;
return;
}
...
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_96()) return false;
}
if(func_97()) return true;
if(func_90(100f, true) !=-1) return true;
return false;
...
31.640238f, 6405.0576f, -98.41389f 
}
-{
5f, 5f, 5f 
}
...
iLocal_65=PED::ADD_SCENARIO_BLOCKING_AREA({
31.640238f, 6405.0576f, -98.41389f 
}
-{
40f, 40f, 40f 
...
if(func_97()) return false;
if(func_161()) return false;
if(Global_113637 !=-1) return false;
if(func_19(_GET_CURRENT_PLAYER_CHARACTER()))if(func_90(100f, true) !=-1) return false;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !bParam6)if(entityCoords.f_2 - uLocal_44.f_2 > 50f) return false;
if(!func_160(iParam3)) return false;
if(func_19(_GET_CURRENT_PLAYER_CHARACTER()))if(func_159(_GET_CURRENT_PLAYER_CHARACTER())==4 || func_159(_GET_CURRENT_PLAYER_CHARACTER())==5) return false;
if(func_19(_GET_CURRENT_PLAYER_CHARACTER()))if(!func_158(iParam3, iParam4, 145)) return false;
if(!func_157(Global_113648.f_24997.f_43[iParam3])) return false;
if(MISC::GET_GAME_TIMER() - Global_113639 < 150000)if(iParam3 !=30) return false;
if(func_156()) return false;
if(MISC::GET_MISSION_FLAG()) return false;
if(MISC::GET_RANDOM_EVENT_FLAG()) return false;
if(!func_147(4)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(5)) return false;
if(func_146(iParam3, iParam4) && !bParam5) return false;
...
if(iParam3==9 && iParam4==2 || iParam4==5 && !func_146(0, 0)) return false;
if(Global_32310) return false;
if(func_160(30) && !func_146(30, 0))if(iParam3 !=30)if(SYSTEM::VDIST2(entityCoords, -61.2745f, -1100.4675f, 25.3752f) < 176400f) return false;
if(func_19(_GET_CURRENT_PLAYER_CHARACTER())){
for (i=CHAR_MICHAEL;
i < CHAR_MULTIPLAYER;
i=i + 1){
...
if(func_145(num))if(func_123(i))if(!func_122(vector, 0f, 0f, 0f, false))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector) < 210f * 210f)if(_GET_CURRENT_PLAYER_CHARACTER() !=i) return false;
}}}
return true;
}
...
var func__135(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6942{
if(bParam0) return uParam1;
return uParam2;
}
...
int num;
int num2;
if(!func_145(iParam1) || !func_145(iParam0)) return 1;
...
if(iParam1 < 1 || iParam1 > func_129(num, num2)) return;
...
if(num6 < 1 || num6 > func_129(num5, num4)) return false;
return true;
}
...
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_155() || Global_112695 || Global_32166 || func_154() || func_25(8, -1) || func_153() || func_152() || func_151() || func_150() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_155() || Global_32166 || func_154() || func_25(8, -1) || func_151() || func_153() || func_152() || func_150() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
...
break;
case 4:
if(func_155() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_25(8, -1) || func_150() || func_149() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_25(8, -1) || func_153() || func_152() || func_149() || func_148()) return false;
