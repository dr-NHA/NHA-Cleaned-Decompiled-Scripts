...
bLocal_47=true;
}elseif(SYSTEM::VDIST(Local_87, -588.4711f, -866.9462f, 25.3292f) < 5f){
bLocal_47=2;
}elseif(SYSTEM::VDIST(Local_87, -389f, 6061f, 31f) < 5f){
bLocal_47=3;
}elseif(SYSTEM::VDIST(Local_87, -600f, -1094f, 22.76f) < 5f){
bLocal_47=4;
}elseif(SYSTEM::VDIST(Local_87, -1025f, -1086f, 2f) < 5f){
bLocal_47=5;
}elseif(SYSTEM::VDIST(Local_87, -595.5618f, -667.7235f, 31.0544f) < 5f){
bLocal_47=6;
}elseif(SYSTEM::VDIST(Local_87, 3018.384f, 3634.017f, 70.4076f) < 5f){
bLocal_47=7;
}elseif(SYSTEM::VDIST(Local_87, -2815.661f, 2208.171f, 27.8382f) < 5f){
bLocal_47=8;
}elseif(SYSTEM::VDIST(Local_87, 856.7742f, -2067.845f, 29.0704f) < 5f){
bLocal_47=9;
}elseif(SYSTEM::VDIST(Local_87, 805.1932f, -703.1327f, 28.1632f) < 5f){
bLocal_47=10;
}else{
...
TASK::TASK_ENTER_VEHICLE(iLocal_51[iVar0], iLocal_54, -1, func_248(iLocal_54), 1073741824, 1, 0);
}}else{
...
func_187();
uLocal_65=PED::ADD_SCENARIO_BLOCKING_AREA(Local_77 + Vector(30f, 30f, 30f), Local_77 - Vector(30f, 30f, 30f), 0, 1, 1, 1);
while (true){
SYSTEM::WAIT(0);
func_184(&uLocal_317);
if(!func_183()){
...
MISC::CLEAR_AREA(Local_77, 4f, 1, 0, 0, 0);
}
iLocal_48=4;
bLocal_109=true;
}else{
...
if(iLocal_46==3){
func_148();
if(!ENTITY::IS_ENTITY_OCCLUDED(iLocal_54) && (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 100f || func_158())){
func_139(1);
}
}
elseif(((!ENTITY::IS_ENTITY_OCCLUDED(iLocal_54) && iLocal_48==4) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_96, Local_99, fLocal_102, 0, 1, 0)) || func_158()){
func_139(1);
}
...
if(iLocal_511 !=0){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_56, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < SYSTEM::POW(50f, 2f)){
iLocal_511=0;
func_135(&uLocal_305, 0, 0);
}}}elseif(((bLocal_109 && !OBJECT::DOES_PICKUP_EXIST(uLocal_137)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0)) && !bLocal_121){
if(iLocal_511 !=1){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < SYSTEM::POW(50f, 2f)){
iLocal_511=1;
func_135(&uLocal_305, 0, 0);
}}}elseif(OBJECT::DOES_PICKUP_EXIST(uLocal_137)){
if(iLocal_511 !=2){
...
func_105(&uLocal_305, OBJECT::GET_PICKUP_COORDS(uLocal_137), 0, 0, 1, 1, 1);
if(SYSTEM::VDIST2(OBJECT::GET_PICKUP_COORDS(uLocal_137), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > SYSTEM::POW(50f, 2f)){
iLocal_511=-1;
func_135(&uLocal_305, 0, 0);
}}}
if(((!ENTITY::IS_ENTITY_DEAD(iLocal_54, 0) && bLocal_109) && !bLocal_111) && (!func_138(0) || (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_stickybomb"), 0) && !func_138(1)))){
switch (iLocal_134){
case 0:
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 225f){
...
TASK::TASK_PLAY_ANIM(iLocal_51[iLocal_130], "random@security_van", "sec_hand_override", 1000f, -4f, -1, 49, 0, 0, 0, 0);
}}
if(!iLocal_116){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_54)){
...
ENTITY::DETACH_ENTITY(iLocal_56, 1, 1);
...
if(bLocal_109){
Param0={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -3.3f, 0f), 1067030938, 1069547520) 
};
}else{
Param0={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_51[iLocal_130], 0), 1067030938, 1069547520) 
};
}}
MISC::SET_BIT(&uLocal_138, 3);
MISC::SET_BIT(&uLocal_138, 4);
MISC::SET_BIT(&uLocal_138, true);
if(bParam3){
uLocal_137=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_security_case"), Param0, ENTITY::GET_ENTITY_ROTATION(iLocal_56, 2), 0, uLocal_128, 2, 1, 0);
}else{
uLocal_137=OBJECT::CREATE_PICKUP(joaat("pickup_money_security_case"), Param0, uLocal_138, uLocal_128, 1, 0);
}
...
HUD::SET_BLIP_SCALE(uVar0, func_33(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
return uVar0;
}
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iLocal_54, 0, Local_81, Local_84, 0, 0, 0, 0, 2, 1, 0);
iLocal_49=2;
}}
break;
case 2:
...
ENTITY::DETACH_ENTITY(iLocal_56, 1, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_56, 1, 0);
PHYSICS::ACTIVATE_PHYSICS(iLocal_56);
OBJECT::SET_ACTIVATE_OBJECT_PHYSICS_AS_SOON_AS_IT_IS_UNFROZEN(iLocal_56, 1);
Local_477={
ENTITY::GET_ENTITY_COORDS(iLocal_56, 1) - ENTITY::GET_ENTITY_COORDS(iLocal_54, 1) * Vector(1.5f, 1.5f, 1.5f) 
};
...
}elseif(MISC::GET_RATIO_OF_CLOSEST_POINT_ON_LINE(ENTITY::GET_ENTITY_COORDS(iLocal_56, 1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, Local_470), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, Local_473), 0) >=1f){
iLocal_49=3;
iLocal_123[0]=0;
iLocal_123[1]=0;
...
}}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_54)){
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_54, 2, 0, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_54, 3, 0, 0);
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_56) && !OBJECT::DOES_PICKUP_EXIST(uLocal_137)){
if(ENTITY::GET_ENTITY_SPEED(iLocal_56)==0f && (MISC::GET_GAME_TIMER() - iLocal_476) > 1000){
func_30(ENTITY::GET_ENTITY_COORDS(iLocal_56, 1), 1);
OBJECT::DELETE_OBJECT(&iLocal_56);
}elseif((MISC::GET_GAME_TIMER() - iLocal_476) > 5000){
func_30(0f, 0f, 0f, 0);
}}
...
Vector3 func__35(struct<3> Param0){
float fVar0;
float fVar1;
...
if(!iLocal_466){
if(MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), joaat("weapon_stickybomb"), 0.25f, 0) || OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), 0.3f, WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_stickybomb")), 0)){
iLocal_466=1;
}}
iVar0=0;
GRAPHICS::DRAW_DEBUG_SPHERE(ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), 0.1f, 255, 0, 0, 255);
if(func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), 1f, 1) || (FIRE::IS_EXPLOSION_IN_SPHERE(2, ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), 0.3f) && iLocal_466)){
iLocal_117=1;
iVar0=1;
}
...
iVar0=1;
}}elseif((((((((((((((((((((((FIRE::IS_EXPLOSION_IN_SPHERE(5, Param6, iParam9) || (FIRE::IS_EXPLOSION_IN_SPHERE(2, Param6, iParam9) && !bParam10)) || (FIRE::IS_EXPLOSION_IN_SPHERE(20, Param6, iParam9) && !bParam10)) || FIRE::IS_EXPLOSION_IN_SPHERE(4, Param6, iParam9)) || (FIRE::IS_EXPLOSION_IN_SPHERE(28, Param6, iParam9) && !bParam10)) || FIRE::IS_EXPLOSION_IN_SPHERE(32, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(25, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(9, Param6, iParam9)) || (FIRE::IS_EXPLOSION_IN_SPHERE(3, Param6, iParam9) && !bParam10)) || (FIRE::IS_EXPLOSION_IN_SPHERE(6, Param6, iParam9) && !bParam10)) || FIRE::IS_EXPLOSION_IN_SPHERE(0, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(1, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(23, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(34, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(14, Param6, iParam9)) || (FIRE::IS_EXPLOSION_IN_SPHERE(30, Param6, iParam9) && !bParam10)) || (FIRE::IS_EXPLOSION_IN_SPHERE(12, Param6, iParam9) && !bParam10)) || FIRE::IS_EXPLOSION_IN_SPHERE(7, Param6, iParam9)) || (FIRE::IS_EXPLOSION_IN_SPHERE(21, Param6, iParam9) && !bParam10)) || (FIRE::IS_EXPLOSION_IN_SPHERE(18, Param6, iParam9) && !bParam10)) || FIRE::IS_EXPLOSION_IN_SPHERE(15, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(10, Param6, iParam9)) || FIRE::IS_EXPLOSION_IN_SPHERE(27, Param6, iParam9)){
iVar0=1;
}
return iVar0;
}
...
if(HUD::DOES_BLIP_EXIST(uLocal_59) && HUD::GET_BLIP_HUD_COLOUR(uLocal_59) !=119){
HUD::REMOVE_BLIP(&uLocal_59);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0)){
iVar0=0;
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_59)){
HUD::REMOVE_BLIP(&uLocal_59);
}
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && HUD::DOES_BLIP_EXIST(uLocal_59)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_54, 0)){
if(HUD::GET_BLIP_ALPHA(uLocal_59) !=0){
HUD::SET_BLIP_ALPHA(uLocal_59, 0);
}}elseif(HUD::GET_BLIP_ALPHA(uLocal_59) !=255){
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_60[iVar0])){
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_64)){
HUD::REMOVE_BLIP(&uLocal_64);
}}}elseif((ENTITY::DOES_ENTITY_EXIST(iLocal_54) && ENTITY::DOES_ENTITY_EXIST(iLocal_51[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_51[1])){
...
if(HUD::DOES_BLIP_EXIST(uLocal_60[1])){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_60[1], iLocal_122);
}
if(HUD::DOES_BLIP_EXIST(uLocal_59)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_59, iLocal_122);
}
if(HUD::DOES_BLIP_EXIST(uLocal_64)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_64, iLocal_122);
}
if(!iLocal_122){
...
var func__42(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
return 1;
}elseif(!ENTITY::IS_ENTITY_OCCLUDED(iParam0) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1)) < 300f){
return 1;
}}
return 0;
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[iVar0], uLocal_58);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_58);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[iLocal_130], uLocal_58);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_58);
}
iLocal_50++;
}
...
PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_51[iVar0], iLocal_54, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -4f, 0f), 5f, 0);
iLocal_123[iVar0]=1;
}
if(((OBJECT::DOES_PICKUP_EXIST(uLocal_137) && !iLocal_123[iVar0]) && iLocal_49==3) && !bLocal_121){
PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_51[iVar0], iLocal_54, OBJECT::GET_PICKUP_COORDS(uLocal_137), 5f, 0);
iLocal_123[iVar0]=1;
}
if(bLocal_121){
if(iLocal_123[iVar0]){
...
TASK::TASK_PLAY_ANIM(iLocal_51[iParam0], "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
}}}}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
Var0={
func_35(ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) 
};
...
Var5[0 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), fVar3, 0f, 4.5f, 0f) 
};
Var5[1 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), fVar4, 0f, 4.5f, 0f) 
};
func_78(&fVar3);
func_78(&fVar4);
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_501) > 2f){
bVar13=true;
}
iVar12=0;
while (iVar12 < iLocal_51){
if(!PED::IS_PED_INJURED(iLocal_51[iVar12])){
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar12], 1), Var5[iVar12 /*3*/]) > 2f){
bVar13=true;
}}
iVar12++;
}
...
iVar12=0;
while (iVar12 < iLocal_51){
if((((((!PED::IS_PED_INJURED(iLocal_51[iVar12]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar12], 1), Var5[iVar12 /*3*/]) > 2f) && (MISC::GET_GAME_TIMER() - iLocal_504[iVar12]) > 1000) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_51[iVar12], 0)) && !iLocal_481[iVar12]) && (iParam0==-1 || iParam0==iVar12)){
if(bParam1){
if(func_72()){
Local_501={
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var5[iVar12 /*3*/], PLAYER::PLAYER_PED_ID(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
}
else{
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, Var5[iVar12 /*3*/], Local_501, 2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::TASK_AIM_GUN_AT_COORD(0, Local_501, -1, 1, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uVar14);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[iVar12], uVar14);
...
Local_485={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_54, 0) 
};
Local_488={
ENTITY::GET_ENTITY_ROTATION(iLocal_54, 2) 
};
Local_491={
PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_panic", Local_485, Local_488, 0, 2) 
};
...
if(OBJECT::DOES_PICKUP_EXIST(uLocal_137)){
if(bLocal_110){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(uLocal_137), 2f, -1, 0.25f, 0, 1193033728);
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(uLocal_137), 1f, -1, 0.25f, 0, 1193033728);
}
iLocal_50++;
}
else{
...
break;
case 1:
if(!PED::IS_PED_INJURED(iParam0) && OBJECT::DOES_PICKUP_EXIST(uLocal_137)){
if((MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), OBJECT::GET_PICKUP_COORDS(uLocal_137), 1) < 2f && !PED::IS_PED_RAGDOLL(iParam0)) && (MISC::GET_GAME_TIMER() - iLocal_136) > 3000){
...
if(SYSTEM::VDIST(Local_491, ENTITY::GET_ENTITY_COORDS(iParam0, 1)) < 0.3f){
...
elseif(ENTITY::IS_ENTITY_OCCLUDED(iParam0) && !CAM::IS_SPHERE_VISIBLE(Local_485, 2f)){
ENTITY::SET_ENTITY_COORDS(iParam0, Local_485, 1, 0, 0, 1);
}}}
break;
case 4:
...
ENTITY::DETACH_ENTITY(iLocal_56, 1, 1);
ENTITY::SET_ENTITY_COLLISION(iLocal_56, 0, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iLocal_54, 0, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(iLocal_56, 1)), 90f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
bLocal_109=true;
...
Var7[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1.f_0, Var4.f_1, 0f) 
};
Var7[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var4.f_0, Var4.f_1, 0f) 
};
Var7[2 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var4.f_0, Var1.f_1, 0f) 
};
Var7[3 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var1.f_0, Var1.f_1, 0f) 
};
fVar72=-3.7f;
fVar73=1.35f;
Var20[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 - 0.25f), fVar72, 0f) 
};
Var20[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (fVar73 + 0.25f), fVar72, 0f) 
};
Var20[2 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (fVar73 - 0.25f), (fVar72 - 1.55f), 0f) 
};
Var20[3 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 + 0.25f), (fVar72 - 1.55f), 0f) 
};
Var33[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, -fVar73, 0.5f, 0f) 
};
Var33[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 - 0.75f), 0.5f, 0f) 
};
Var33[2 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, (-fVar73 - 0.75f), 1.5f, 0f) 
};
Var33[3 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, -fVar73, 1.5f, 0f) 
};
Var46[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, fVar73, 0.5f, 0f) 
};
...
if(!PED::IS_PED_INJURED(iParam0)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_56)){
iLocal_56=OBJECT::CREATE_OBJECT(iLocal_105, Local_77, 1, 1, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_56, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_56)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iParam0, PED::GET_PED_BONE_INDEX(iParam0, 28422), Local_90, Local_93, 1, 0, 0, 0, 2, 1, 0);
}}}
...
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_54, -1, 0) !=func_89() && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_54, -1, 0)){
...
TASK::TASK_ENTER_VEHICLE(iLocal_51[1], iLocal_54, -1, 0, 1073741824, 1, 0);
}}
iLocal_50++;
}else{
func_68(8);
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(func_89(), iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 50f, 786484, 100f, 5f, 1);
iLocal_50++;
}}
break;
case 2:
if(func_87()){
if(ENTITY::DOES_ENTITY_EXIST(func_89())){
TASK::TASK_VEHICLE_MISSION(func_89(), iLocal_54, 0, 5, 0f, 786484, 100f, 100f, 1);
iLocal_50++;
}}
break;
case 3:
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_54, PLAYER::PLAYER_PED_ID(), 8, 50f, 786484, 100f, 5f, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[iVar1], uVar2);
TASK::CLEAR_SEQUENCE_TASK(&uVar2);
}}else{
func_68(8);
}}
if(((((((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) || OBJECT::DOES_PICKUP_EXIST(uLocal_137)) || iLocal_49==3) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 0, 7000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 3, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 2, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 1, 40000)) || (iLocal_50 > 1 && !func_88())){
if(!func_88()){
}
func_68(8);
}}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[iVar0], uVar1);
...
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), ENTITY::GET_ENTITY_COORDS(iLocal_54, 1)) > 10f){
func_68(7);
}}
if((ENTITY::IS_ENTITY_DEAD(iLocal_55, 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0)) || (!ENTITY::IS_ENTITY_UPRIGHT(iLocal_55, 1119092736) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_55, 1))){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_58);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[iParam0], uLocal_58);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_58);
if(iLocal_131==0){
iLocal_131=EVENT::ADD_SHOCKING_EVENT_AT_POSITION(118, ENTITY::GET_ENTITY_COORDS(iLocal_51[iParam0], 1), -1082130432);
}}}
...
}elseif(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 4)){
...
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_72()){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), 1)){
func_68(8);
}}
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0)){
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_92(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=0;
}elseif(!func_126(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_123(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_124(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
MISC::SET_BIT(&(Global_113648.f_24997.f_6), bParam0);
}
...
return MISC::IS_BIT_SET(Global_113648.f_24997.f_6, iParam0);
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[0], uVar0);
...
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_54, 10f, 786603);
TASK::CLOSE_SEQUENCE_TASK(uVar1);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[0], uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
iLocal_50++;
}
elseif(bLocal_47==7){
...
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_54, 10f, 786603);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51[0], uVar2);
TASK::CLEAR_SEQUENCE_TASK(&uVar2);
iLocal_50++;
}
else{
...
if(!PED::IS_PED_IN_VEHICLE(iLocal_51[0], iLocal_54, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_51[0], joaat("script_task_enter_vehicle")) !=1){
TASK::TASK_ENTER_VEHICLE(iLocal_51[0], iLocal_54, -1, -1, 1f, 8388608, 0);
}
if(!PED::IS_PED_IN_VEHICLE(iLocal_51[1], iLocal_54, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_51[1], joaat("script_task_enter_vehicle")) !=1){
...
if(((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), 25f, 0)) || (!PED::IS_PED_INJURED(iLocal_51[0]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_51[0], 1), 20f, 0))) || (!PED::IS_PED_INJURED(iLocal_51[1]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_51[1], 1), 20f, 0))){
func_68(6);
}
if(iLocal_48 !=4){
if(!PED::IS_PED_INJURED(iLocal_51[0])){
...
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(iLocal_54, 1) 
};
Var3={
ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_54) 
};
Var6={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) 
};
...
iVar0=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
}}elseif(ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE())){
...
Local_491={
PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_calm", Local_485, Local_488, 0, 2) 
};
bLocal_496=false;
iLocal_497=0;
...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_77) < 22500f && ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(iLocal_54)){
...
if(MISC::ABSF((fVar0 - Local_488.f_2)) < 15f && SYSTEM::VDIST(Local_491, ENTITY::GET_ENTITY_COORDS(iLocal_51[1], 1)) < 0.2f){
...
TASK::CLEAR_PED_TASKS(iLocal_51[0]);
TASK::TASK_PLAY_ANIM(iLocal_51[0], "random@security_van", "driver_exit_panic", 1000f, -8f, -1, 0, 0, 0, 0, 0);
}}}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_77, 25f, 25f, 20f, 0, 1, 0)){
return 1;
}}
if(((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), 25f, 0)) || (!PED::IS_PED_INJURED(iLocal_51[0]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_51[0], 1), 20f, 0))) || (!PED::IS_PED_INJURED(iLocal_51[1]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_51[1], 1), 20f, 0))){
return 1;
...
if((MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], 1), 5f, 1) || func_37(ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], 1) + Vector(5f, 10f, 10f), ENTITY::GET_ENTITY_COORDS(iLocal_51[iVar0], 1) - Vector(5f, 5f, 5f), 0f, 0f, 0f, 0, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_51[iVar0], PLAYER::PLAYER_PED_ID(), 1)){
bLocal_110=true;
return 1;
}}else{
bLocal_110=true;
...
void func_159(){
int iVar0;
iLocal_54=VEHICLE::CREATE_VEHICLE(iLocal_104, Local_77, fLocal_80, 1, 1, 0);
iLocal_57=OBJECT::CREATE_OBJECT(joaat("prop_security_case_01"), Local_77, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_57, iLocal_54, 0, 0f, -2.4589f, 1.2195f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_VISIBLE(iLocal_57, 0, 0);
ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(iLocal_57, iLocal_54, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_54, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_54, 3);
ENTITY::SET_ENTITY_PROOFS(iLocal_57, 0, 1, 1, 1, 1, 1, 0, 0);
...
VEHICLE::SET_VEHICLE_DROPS_MONEY_WHEN_BLOWN_UP(iLocal_54, 0);
...
iLocal_51[1]=PED::CREATE_PED(26, iLocal_103, Local_67[1 /*3*/], fLocal_74[1], 1, 1);
iLocal_51[0]=PED::CREATE_PED(26, iLocal_103, Local_67[0 /*3*/], fLocal_74[0], 1, 1);
...
if(iLocal_46==1){
PED::SET_PED_PROP_INDEX(iLocal_51[0], 0, 1, 0, 0, 1);
PED::SET_PED_SUFFERS_CRITICAL_HITS(iLocal_51[0], 0);
PED::SET_PED_PROP_INDEX(iLocal_51[1], 0, 1, 0, 0, 1);
...
uLocal_128=MISC::GET_RANDOM_INT_IN_RANGE(3000, 8000);
switch (bLocal_47){
case 1:
Local_96={
-315.889f, -1550.554f, 7.233013f 
};
Local_99={
-315.2352f, -1366.581f, 45.29617f 
};
fLocal_102=180f;
Local_77={
...
fLocal_80=-64.3539f;
Local_67[0 /*3*/]={
-335.564f, -1462.237f, 29.5452f 
};
fLocal_74[0]=158.3857f;
Local_67[1 /*3*/]={
-342.7024f, -1475.043f, 29.6004f 
};
...
case 3:
Local_96={
-468.6309f, 6101.907f, 14.8912f 
};
Local_99={
-359.9734f, 5994.152f, 50.36843f 
};
fLocal_102=152.25f;
Local_77={
...
fLocal_80=188.9862f;
Local_67[0 /*3*/]={
-398.4612f, 6051.296f, 30.5003f 
};
fLocal_74[0]=251.7138f;
Local_67[1 /*3*/]={
-378.408f, 6035.689f, 30.498f 
};
...
case 4:
Local_96={
-631.3408f, -1105.581f, 7.220509f 
};
Local_99={
-462.1721f, -1103.597f, 62.53583f 
};
fLocal_102=177.25f;
Local_77={
-595.7766f, -1094.089f, 21.1785f 
};
fLocal_80=263.4662f;
Local_67[0 /*3*/]={
-600.8182f, -1103.778f, 21.3292f 
};
fLocal_74[0]=338.8304f;
Local_67[1 /*3*/]={
-595.3461f, -1096.054f, 21.1785f 
};
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_1()) || Global_112695) || Global_32166) || func_223()) || func_24(8, -1)) || func_222()) || func_221()) || func_220()) || func_219()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_1()) || Global_32166) || func_223()) || func_24(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_1()) || Global_112695) || Global_32166) || func_223()) || func_24(8, -1)) || func_220()) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_1()) || Global_112695) || Global_32166) || func_223()) || func_24(8, -1)) || func_222()) || func_221()) || func_219()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_1()) || Global_32166) || func_223()) || func_24(8, -1)) || func_221()) || func_220()) || func_219()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_1()) || func_221()) || Global_112695) || Global_32166) || func_223()) || Global_44446) || func_24(8, -1)) || func_220()) || func_218()) || func_219()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_1()) || Global_112695) || Global_32166) || func_223()) || func_24(8, -1)) || func_220()) || func_218()) || func_222()) || func_221()) || func_219()){
return 0;
}
break;
}}else{
