...
Global_78341[1 /*14*/]={
func_83(iVar0, iParam1, iParam2, -1) 
};
...
Global_78341[1 /*14*/]={
func_83(iVar0, iParam1, uVar31[iParam1], -1) 
};
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_83(iVar10, iParam1, iParam2, -1) 
};
if(!func_73(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_83(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar28=9;
...
uVar28={
func_76(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_83(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_83(iVar10, iVar0, func_40(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_83(iVar10, 14, uVar69[iVar1], -1) 
};
func_50(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_66(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_83(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_60(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_75(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_75(iParam0));
if(iVar57 > iVar56){
...
if(!bLocal_159){
func_221(1);
TASK::TASK_PERFORM_SEQUENCE(iLocal_147, uLocal_146);
...
if(func_353(uLocal_149[0]) && func_353(uLocal_149[1])){
if((func_220(uLocal_149[0], Local_360, 30f, 1) || func_217(uLocal_149[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || func_217(uLocal_149[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
...
float fVar6;
Var0={
func_219(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_219(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__219(struct<3> Param0){
float fVar0;
float fVar1;
...
bool func_220(int iParam0, struct<3> Param1, float fParam4, int iParam5){
...
TASK::TASK_PLAY_ANIM(0, sLocal_145, "barry_get_up", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_148, 0), 200f, -1, 0, 0);
...
var func__227(int iParam0, int iParam1){
...
bool func_237(int iParam0, int iParam1, float fParam2, int iParam3){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_81.f_41[0], iLocal_147, PED::GET_PED_BONE_INDEX(iLocal_147, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}elseif(ENTITY::IS_ENTITY_ATTACHED(Local_81.f_41[0])){
ENTITY::DETACH_ENTITY(Local_81.f_41[0], 1, 1);
ENTITY::SET_ENTITY_HAS_GRAVITY(Local_81.f_41[0], 1);
}}}
...
iLocal_148=VEHICLE::CREATE_VEHICLE(iLocal_153, Var0, fVar3, 1, 1, 0);
uLocal_149[0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_148, 6, iLocal_154, -1, 1, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_149[0], joaat("weapon_pistol"), -1, 1);
WEAPON::SET_PED_INFINITE_AMMO(uLocal_149[0], 1, joaat("weapon_pistol"));
uLocal_149[1]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_148, 6, iLocal_154, 0, 1, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_149[1], joaat("weapon_pistol"), -1, 1);
WEAPON::SET_PED_INFINITE_AMMO(uLocal_149[1], 1, joaat("weapon_pistol"));
VEHICLE::SET_VEHICLE_SIREN(iLocal_148, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_148, 20f);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_149[0], iLocal_148, Local_360, 20f, 1, iLocal_153, 786603, 5f, 5f);
return 1;
}
return 0;
}
...
MISC::CLEAR_AREA_OF_COPS(ENTITY::GET_ENTITY_COORDS(iLocal_147, 1), 1000f, 0);
uLocal_368=PED::CREATE_SYNCHRONIZED_SCENE(Local_372, Local_375, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_368, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_147, uLocal_368, sLocal_145, "barry_3_sit_loop", 1000f, -8f, 1, 16, 1148846080, 0);
}
...
func_243();
}}}elseif(func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 15f, 1)){
if(!bLocal_169){
...
iLocal_157=1;
iLocal_144=2;
}elseif(!func_237(PLAYER::PLAYER_PED_ID(), iLocal_147, 100f, 1)){
iLocal_144=2;
}}
break;
case 2:
...
}}elseif(AUDIO::IS_PED_IN_CURRENT_CONVERSATION(iLocal_147)){
if(!PED::IS_PED_HEADTRACKING_PED(iLocal_147, PLAYER::PLAYER_PED_ID())){
TASK::TASK_LOOK_AT_ENTITY(iLocal_147, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(iLocal_147, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(iLocal_147);
}
if(func_237(iLocal_147, PLAYER::PLAYER_PED_ID(), 6f, 1)){
if(!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_147)){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_147, -1, 0, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_147)){
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
}}
...
if(func_237(iLocal_147, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 15f, 1)){
bLocal_159=true;
AUDIO::STOP_SCRIPTED_CONVERSATION(0);
func_221(0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_147, uLocal_146);
...
switch (iLocal_144){
case 0:
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_367)){
if(func_353(iLocal_147)){
uLocal_367=PED::CREATE_SYNCHRONIZED_SCENE(417.533f, -765.23f, 28.41f, 0f, 0f, 12.96f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_147, uLocal_367, sLocal_145, "lead_out", 1000f, -8f, 1, 16, 1148846080, 0);
}}
func_239(1);
iLocal_172=0;
iLocal_144=1;
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_367) > 0.99f){
iLocal_144=2;
}}else{
iLocal_144=2;
}
...
iLocal_152=OBJECT::CREATE_OBJECT(iLocal_155, 416.3885f, -764.8415f, 28.3848f, 1, 1, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_152)){
ENTITY::SET_ENTITY_ROTATION(iLocal_152, 0f, 0f, 20f, 2, 1);
}}
...
void func_269(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
if(!func_282(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_282(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
Var67={
func_83(iVar81, 2, uParam1->f_59, -1) 
};
...
Var67={
func_83(iVar81, 1, uParam1->f_62, -1) 
};
...
var uVar0;
var uVar1;
uVar0=Global_2848280[iParam0 /*3*/][func_69(uParam1)];
...
if(!func_478()){
if(func_353(iLocal_147)){
TASK::TASK_PLAY_ANIM(iLocal_147, sLocal_145, "lead_in", 8f, -8f, -1, 2, 0, 0, 0, 0);
iLocal_144=1;
}}else{
func_252(1);
}}elseif(iLocal_144==1){
if(func_255(iLocal_147)){
if(!bLocal_161 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, 0, 1, 0) || func_291())){
bLocal_161=true;
...
if(!bLocal_171){
if(func_291()){
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_147, 0f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
}else{
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_147, 0.5f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_282(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
iLocal_344[1]=20000;
iLocal_344[2]=7000;
uLocal_371=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_147, uLocal_371);
PED::SET_PED_CONFIG_FLAG(iLocal_147, 132, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_147, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_147, 185, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_147, 0);
...
uLocal_368=PED::CREATE_SYNCHRONIZED_SCENE(Local_372, Local_375, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_368, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_147, uLocal_368, sLocal_145, "barry_3_sit_loop", 1000f, -8f, 0, 0, 1148846080, 0);
}
func_264();
...
int func_306(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_353(iParam0)){
...
if(!func_353(PLAYER::PLAYER_PED_ID())){
return 1;
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_147, 0)){
func_239(0);
func_328("B3BARRYDEAD");
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_147, PLAYER::PLAYER_PED_ID(), 1) || func_327(PLAYER::PLAYER_PED_ID(), iLocal_147, 1)){
TASK::TASK_SMART_FLEE_PED(iLocal_147, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
func_239(0);
func_328("B3BARRYHURT");
return 1;
}elseif(func_311(iLocal_147, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_327(PLAYER::PLAYER_PED_ID(), iLocal_147, 1)){
if(!iLocal_157){
if((iLocal_143==-2 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_367)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_367) < 0.82f){
}else{
func_221(0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_147, uLocal_146);
}
...
if(bParam4){
return 0;
}elseif(func_312(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__316(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_219(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
if(func_255(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(func_255(iParam1)){
...
if(func_332()){
func_479();
}elseif(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_142)){
if(func_255(iLocal_147)){
...
return 1;
}elseif(func_379(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_271(iParam0, 0, 0)) || func_271(iParam0, 1, 0)) || func_271(iParam0, 2, 0)) || func_413(iParam0) !=145) || func_412(iParam0)) || func_411(iParam0)) || func_362(iParam0)) || func_410(iParam0)) || !func_400(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_411(iParam0)){
}
if(func_411(iParam0)){
}
...
}elseif(func_422(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
bool func_434(struct<3> Param0, struct<3> Param3, bool bParam6){
if(bParam6){
...
int func_435(struct<3> Param0, float fParam3){
return func_436(&(Global_107196.f_2890), Param0, fParam3, 0);
}

int func_436(var uParam0, struct<3> Param1, float fParam4, bool bParam5){
int iVar0;
struct<3> Var1;
bool bVar4;
var uVar5;
...
}elseif((!func_438(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
int func_438(int iParam0, struct<3> Param1, bool bParam4){
int iVar0;
var uVar1[3];
int iVar5;
int iVar6;
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_440(iParam0, uVar1[iVar6], 1) && func_439(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_434(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
...
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_397(iVar2))){
}else{
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_397(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_397(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_397(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_397(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_397(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_397(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_449(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_448()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_397(iVar7 + 1))){
...
uParam0->f_27=0;
uParam0->f_17[0 /*3*/]={
415.4587f, -773.3615f, 27.8549f 
};
uParam0->f_17[1 /*3*/]={
415.5205f, -758.5715f, 31.34455f 
};
uParam0->f_24=14.5f;
...
if(func_471(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER:
BARRY 3", 1)){
...
int func_471(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7){
if(func_472(uParam0, iParam1, Param2, fParam5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_472(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_152(iParam1)){
...
void func_477(var uParam0, char* sParam1, char* sParam2, char* sParam3){
*uParam0=sParam1;
uParam0->f_1=sParam2;
uParam0->f_2=sParam3;
STREAMING::REQUEST_ANIM_DICT(*uParam0);
...
int func_496(char* sParam0, int iParam1, int iParam2){
var uVar0;
struct<32> Var1;
int iVar33;
func_16();
...
int func_499(char* sParam0, bool bParam1){
int iVar0;
int iVar1;
