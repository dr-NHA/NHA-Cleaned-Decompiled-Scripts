...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_336, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) < 3f){
if(iLocal_51){
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "enter", 1000f, -4f, 0, 0, 1148846080, 0);
if(func_74(iLocal_327)){
...
if(!Global_32224[0 /*11*/].f_2){
func_68();
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "base", 4f, -8f, 64, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "base_remote", sLocal_335, 4f, -8f, 64, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_330, 1);
}else{
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "tv_enter", 4f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "tv_enter_remote", sLocal_335, 4f, -8f, 0, 1148846080);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}}
Global_32209=1;
...
STATS::STAT_SET_INT(joaat("num_sh_tv_watched"), iLocal_333 + 1, 1);
iLocal_324=1;
}}
if(!AUDIO::IS_AUDIO_SCENE_ACTIVE("TV_FRANKLINS_HOUSE_SOCEN")){
AUDIO::START_AUDIO_SCENE("TV_FRANKLINS_HOUSE_SOCEN");
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "tv_enter", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "tv_enter_remote", sLocal_335, 8f, -8f, 0, 1148846080);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}
iLocal_308=6;
}elseif(PAD::IS_CONTROL_JUST_PRESSED(2, 222)){
func_64();
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "exit", 8f, -8f, 0, 0, 1148846080, 0);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}
iLocal_308=12;
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "tv_base", 4f, -8f, 64, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "tv_base_remote", sLocal_335, 4f, -8f, 0, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_330, 1);
if(func_74(iLocal_327)){
CAM::SET_CAM_PARAMS(iLocal_327, Local_358, Local_361, fLocal_364, 0, 1, 1, 2);
CAM::SHAKE_CAM(iLocal_327, "HAND_SHAKE", (0.2f / 3f));
...
if(PAD::IS_CONTROL_JUST_PRESSED(2, 51)){
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "tv_exit", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "tv_exit_remote", sLocal_335, 8f, -8f, 0, 1148846080);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}
iLocal_318=1;
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "tv_idle_a", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "tv_idle_a_remote", sLocal_335, 8f, -8f, 0, 1148846080);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}
iLocal_319=1;
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "tv_base", 8f, -8f, 64, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "tv_base_remote", sLocal_335, 8f, -8f, 64, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_330, 1);
iLocal_308=7;
}
break;
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "base", 8f, -8f, 64, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_67(), uLocal_330, "base_remote", sLocal_335, 8f, -8f, 64, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_330, 1);
if(func_74(iLocal_327)){
CAM::SET_CAM_PARAMS(iLocal_327, Local_351, Local_354, fLocal_357, 0, 1, 1, 2);
}
...
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "blunt_enter", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_55(), uLocal_330, "blunt_enter_joint", sLocal_335, 1000f, -1000f, 0, 1148846080);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_53(), uLocal_330, "blunt_enter_lighter", sLocal_335, 8f, -8f, 0, 1148846080);
if(!Global_32224[0 /*11*/].f_2){
if(func_74(iLocal_327)){
...
bLocal_320=func_49();
if(bLocal_320){
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "blunt_idle_a", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_55(), uLocal_330, "blunt_idle_a_joint", sLocal_335, 1000f, -1000f, 0, 1148846080);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_53(), uLocal_330, "blunt_idle_a_lighter", sLocal_335, 8f, -8f, 0, 1148846080);
}
else{
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "blunt_idle_b", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_55(), uLocal_330, "blunt_idle_b_joint", sLocal_335, 1000f, -1000f, 0, 1148846080);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_53(), uLocal_330, "blunt_idle_b_lighter", sLocal_335, 8f, -8f, 0, 1148846080);
}
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}
...
}}elseif(ENTITY::FIND_ANIM_EVENT_PHASE(func_45(), "blunt_idle_b", func_44(), &fVar4, &fVar5)){
if(fVar3 >=fVar4 && fVar3 <=fVar5){
iLocal_316=1;
}}}else{
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "blunt_interrupt", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_55(), uLocal_330, "blunt_interrupt_joint", sLocal_335, 1000f, -1000f, 0, 1148846080);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_53(), uLocal_330, "blunt_interrupt_lighter", sLocal_335, 8f, -8f, 0, 1148846080);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}
if(!iLocal_323){
...
func_48();
uLocal_330=PED::CREATE_SYNCHRONIZED_SCENE(func_73(), func_72(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_330, sLocal_335, "blunt_exit", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_55(), uLocal_330, "blunt_exit_joint", sLocal_335, 1000f, -1000f, 0, 1148846080);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(func_53(), uLocal_330, "blunt_exit_lighter", sLocal_335, 8f, -8f, 0, 1148846080);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_330, 0);
}
if(!iLocal_323){
...
STATS::STAT_SET_INT(joaat("num_sh_sofa_used"), iLocal_334 + 1, 1);
}
...
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_sh_lighter_sparks", func_53(), 0f, 0f, 0.05f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
iLocal_311=1;
}
if(!iLocal_310 && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.255f){
uLocal_329=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_sh_lighter_flame", func_53(), 0f, 0f, 0.05f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
iLocal_310=1;
}
...
uLocal_328=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_sh_cig_smoke", func_55(), -0.09f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
iLocal_325=1;
}
...
case joaat("prop_bong_01"):
case joaat("prop_cigar_03"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_cs_lighter_01"), 0, 0, 1);
break;
case joaat("p_cs_joint_01"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 2f, joaat("p_cs_lighter_01"), 0, 0, 1);
break;
case joaat("p_tumbler_02_s1"):
case joaat("p_tumbler_cs2_s"):
case joaat("p_tumbler_cs2_s_trev"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_whiskey_bottle_s"), 0, 0, 1);
break;
case joaat("p_wine_glass_s"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("prop_wine_bot_01"), 0, 0, 1);
break;
case joaat("prop_radio_01"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("prop_bottle_cap_01"), 0, 0, 1);
break;
}
return uVar0;
}
...
case joaat("prop_rolled_sock_02"):
Var0={
1972.142f, 3813.243f, 32.4271f 
};
break;
case joaat("prop_mr_raspberry_01"):
Var0={
-1145.91f, -1514.944f, 9.6327f 
};
break;
case joaat("prop_radio_01"):
Var0={
1976.94f, 3821.242f, 33.3266f 
};
break;
case joaat("p_w_grass_gls_s"):
Var0={
...
switch (iLocal_55){
case joaat("prop_cigar_03"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("prop_cigar_03"), 0, 0, 1);
break;
case joaat("prop_cs_beer_bot_01"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 2.5f, joaat("prop_cs_beer_bot_01"), 0, 0, 1);
break;
case joaat("p_tumbler_02_s1"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_tumbler_02_s1"), 0, 0, 1);
break;
case joaat("p_tumbler_cs2_s"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_tumbler_cs2_s"), 0, 0, 1);
break;
case joaat("p_tumbler_cs2_s_trev"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_tumbler_cs2_s_trev"), 0, 0, 1);
break;
case joaat("p_cs_joint_01"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_cs_joint_01"), 0, 0, 1);
break;
case joaat("prop_radio_01"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 3f, joaat("prop_cs_beer_bot_01"), 0, 0, 1);
break;
case joaat("p_w_grass_gls_s"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_w_grass_gls_s"), 0, 0, 1);
break;
case joaat("p_wine_glass_s"):
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 5f, joaat("p_wine_glass_s"), 0, 0, 1);
break;
}
return uVar0;
}
...
if(func_62(iParam0)){
GRAPHICS::SET_TV_CHANNEL(-1);
GRAPHICS::SET_TV_CHANNEL_PLAYLIST(iParam1, func_61(iParam2), iParam4);
...
STATS::STAT_SET_INT(joaat("num_sh_sofa_smoked"), iLocal_332 + 1, 1);
}
iLocal_308=10;
}}
...
var func__67(){
var uVar0;
uVar0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(func_54(), 10f, joaat("prop_cs_remote_01"), 0, 0, 1);
return uVar0;
}


void func_68(){
GRAPHICS::SET_TV_CHANNEL_PLAYLIST(0, func_61(1), 0);
if(func_69(22)){
GRAPHICS::SET_TV_CHANNEL_PLAYLIST(1, func_61(12), 0);
}else{
GRAPHICS::SET_TV_CHANNEL_PLAYLIST(1, func_61(2), 0);
}}
...
Var6={
Var0 + Var3 - Var0 * Vector(0.25f, 0.25f, 0.25f) 
};
...
return 1;
}}}elseif(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-800.68f, 184.18f, 72.57f, 0.5f, joaat("p_tumbler_02_s1"), 0)){
...
ENTITY::FREEZE_ENTITY_POSITION(OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1153.82f, -1523.31f, 10.51f, 0.5f, joaat("p_whiskey_bottle_s"), 0, 0, 1), 1);
return 1;
}}}elseif(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-800.68f, 184.18f, 72.55f, 0.5f, joaat("p_tumbler_cs2_s"), 0)){
...
if(func_91(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0, fParam3, 0)){
return 1;
}}}}}
return 0;
}
...
int func_97(){
if(AUDIO::REQUEST_AMBIENT_AUDIO_BANK(func_98(), 0, -1)){
return 1;
}
return 0;
}
