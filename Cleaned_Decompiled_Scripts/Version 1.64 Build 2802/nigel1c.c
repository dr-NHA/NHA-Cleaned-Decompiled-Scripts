...
iLocal_897=103;
Local_899={
-603.9266f, -293.9479f, 34.77906f 
};
Local_902={
-636.4999f, -242.5444f, 39.1609f 
};
fLocal_905=20f;
...
Local_920={
-606.6835f, -293.8564f, 34.77928f 
};
Local_923={
-642.6559f, -236.1222f, 38.88903f 
};
fLocal_926=20f;
Local_927={
-608.4832f, -286.607f, 39.75064f 
};
Local_930={
-634.5681f, -246.6082f, 36.347f 
};
fLocal_933=20f;
Local_934={
-620.5983f, -263.0439f, 38.76393f 
};
Local_937={
-665.5768f, -220.7088f, 35.37474f 
};
fLocal_940=30f;
Local_941={
-641.8198f, -235.5721f, 37.88144f 
};
fLocal_944=65.31715f;
Local_945={
-665.364f, -232.7904f, 36.64935f 
};
...
SYSTEM::WAIT(0);
func_281(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
iLocal_889=1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_604, PLAYER::PLAYER_PED_ID(), 1)){
if(PED::IS_PED_USING_ANY_SCENARIO(iLocal_604)){
PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_604, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}
TASK::CLEAR_PED_TASKS(iLocal_604);
TASK::TASK_SMART_FLEE_PED(iLocal_604, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
}
if(!PED::IS_PED_FLEEING(iLocal_604)){
if((func_36(iLocal_604, 1126825984) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_604, PLAYER::PLAYER_PED_ID(), 1)) && !func_28(iLocal_604, 1, 0, 0, 0)){
if(PED::IS_PED_USING_ANY_SCENARIO(iLocal_604)){
PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_604, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}
TASK::CLEAR_PED_TASKS(iLocal_604);
...
float fVar6;
Var0={
func_33(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
Var3={
func_33(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__33(struct<3> Param0){
float fVar0;
float fVar1;
...
Vector3 func__40(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_33(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
iLocal_522=0;
iLocal_521=10;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_605, PLAYER::PLAYER_PED_ID(), 1) || func_47()){
PED::SET_PED_TO_RAGDOLL(iLocal_605, 500, 1000, 0, 1, 1, 0);
iLocal_516=4;
iLocal_522=0;
iLocal_521=10;
}elseif(FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(ENTITY::GET_ENTITY_COORDS(iLocal_605, 1), 2f) > 0){
PED::SET_PED_TO_RAGDOLL(iLocal_605, 500, 1000, 0, 1, 1, 0);
iLocal_516=3;
iLocal_522=0;
iLocal_521=10;
...
iLocal_522=0;
iLocal_521=10;
}elseif(func_34(iLocal_604, 1, 8f, 15f) || func_29(iLocal_604, 5f, 0, 0)){
...
TASK::TASK_SMART_FLEE_PED(iLocal_605, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}
iLocal_516=2;
iLocal_522=0;
iLocal_521=10;
...
int func_47(){
if((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_605, PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID())){
return 1;
}
return 0;
}
...
HUD::CLEAR_PRINTS();
HUD::CLEAR_HELP(1);
if(HUD::DOES_BLIP_EXIST(uLocal_700)){
HUD::REMOVE_BLIP(&uLocal_700);
}
AUDIO::TRIGGER_MUSIC_EVENT("NIGEL1C_FAIL");
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_605, 0.5f, 1f, 0f), 2.5f, 20000, 0.25f, 0, 40000f);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(iLocal_605, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
}
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_1C_SCENE")){
...
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_604, iLocal_605, 0f, 0f, 0f, 2f, -1, 3f, 1);
}}
iLocal_950=-1;
iLocal_522=1;
break;
...
func_220();
func_68(&uLocal_701, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_934, Local_937, fLocal_940, 0, 1, 0)){
func_219(500, 1);
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_616, 0);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_616, sLocal_910, "take_collar_trevor", 8f, -4f, 1, 16, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_605, uLocal_616, sLocal_910, "take_collar_dog", 8f, -4f, 1, 16, 1148846080, 0);
...
break;
case 1:
if(((iLocal_884==0 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_616)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_616) >=0.75f) && func_284(iLocal_605)){
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COLLAR", iLocal_605, "NIGEL_1C_SOUNDSET", 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_605, 3, 1, 0, 0);
iLocal_884=1;
}elseif(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_616) && !func_26()){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_82(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0, 0);
...
PED::ADD_SCENARIO_BLOCKING_AREA(Local_914, Local_917, 0, 1, 1, 1);
...
Vector3 func__89(int iParam0, struct<3> Param1){
var uVar0;
...
uVar28={
func_123(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_144(iVar10, 14, uVar28[iVar1], -1) 
};
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_103(iVar0)));
}
else{
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iVar0), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
}
func_136(iVar0);
if(Global_78339==1){
iVar2=0;
...
Global_78341[1 /*14*/]={
func_144(iVar10, iVar0, func_102(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_123(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_144(iVar10, 14, uVar69[iVar1], -1) 
};
func_113(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_136(14);
if(Global_78339==1){
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_103(iParam1)));
}else{
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, iParam4);
}
if(Global_78339==1){
iVar2=0;
while (iVar2 < 15){
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_103(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_103(iParam2));
...
func_147(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 !=0);
return;
}}}else{
...
func_147(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 !=0);
return;
}
iVar56=(iParam1 - iParam2);
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_103(iParam0));
if(iVar57 > iVar56){
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_103(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_103(iParam1))){
return 1;
}
return 0;
}
...
if(func_222(Param0)){
if(PED::IS_PED_IN_VEHICLE(Param0.f_1, Param0.f_0, 0)){
...
TASK::TASK_PLAY_ANIM(0, sLocal_908, "chop_growl", 8f, -8f, -1, 9, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(iLocal_605, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_605, 1, 0);
}
func_87(1);
...
PED::SET_PED_TO_RAGDOLL(iLocal_605, 500, 1000, 0, 0, 0, 0);
...
if((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_605, Local_927, Local_930, fLocal_933, 0, 1, 0) && func_226(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_605, 0f, 1f, 0f), 1.5f)) && !ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_605)){
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_605, 1)) 
};
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[0 /*16*/].f_9, 1f, 20000, 0.25f, 0, 40000f);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_523[0 /*16*/], uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
iLocal_881=1;
...
iLocal_883=0;
}}elseif(func_88(&uLocal_701, "NIG1CAU", "NIG1C_DOG", "NIG1C_DOG_3", 7, 1, 0)){
iLocal_883=0;
}}}
...
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[1 /*16*/].f_9, 1f, 20000, 0.25f, 0, 40000f);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_523[1 /*16*/], uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
...
int func_228(){
var uVar0;
TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_612, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &uVar0);
return uVar0;
}
...
VEHICLE::START_VEHICLE_HORN(Local_659.f_0, 4000, 0, 0);
iLocal_877=1;
}}}elseif(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_605)){
if(func_233()==19){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_659.f_0, 2, "NIG1C_COMET2", 1);
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_659.f_0, 1);
}}}}}

int func_233(){
var uVar0;
TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_612, ENTITY::GET_ENTITY_COORDS(iLocal_605, 1), &uVar0);
return uVar0;
}
...
VEHICLE::START_VEHICLE_HORN(Local_643.f_0, 3000, 0, 0);
iLocal_876=1;
}}}elseif(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_605)){
if(func_233() > 25){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_643.f_0, 1, "NIG1C_COMET", 1);
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_643.f_0, 1);
}}}
...
if(iLocal_875==0){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_605, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, 1, 0)){
VEHICLE::START_VEHICLE_HORN(Local_627.f_0, 1500, 0, 0);
...
PED::SET_PED_PANIC_EXIT_SCENARIO(Local_523[2 /*16*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}
TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
TASK::TASK_PAUSE(0, 500);
TASK::TASK_PLAY_ANIM(0, sLocal_907, "reaction_backward_big_intro_c", 8f, -8f, -1, 8192, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_907, "react_big_variations_a", 8f, -8f, -1, 8192, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_907, "exit_to_generic", 8f, -8f, -1, 8192, 0, 0, 0, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_523[2 /*16*/], uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
}
iLocal_875=1;
}}
...
break;
case 1:
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_627.f_0, iLocal_894, sLocal_893, 1);
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_635.f_0, iLocal_896, sLocal_895, 1);
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_667.f_0, iLocal_897, sLocal_895, 1);
...
TASK::TASK_VEHICLE_MISSION(Local_667.f_1, Local_667.f_0, Local_635.f_0, 2, 20f, 262144, 0.5f, 2f, 1);
TASK::TASK_VEHICLE_MISSION(Local_635.f_1, Local_635.f_0, Local_667.f_0, 2, 20f, 262144, 0.5f, 2f, 1);
VEHICLE::START_VEHICLE_HORN(Local_635.f_0, 800, 0, 0);
iLocal_514=4;
break;
case 4:
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_667.f_1, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_635.f_1, -1f, 1f, 0f), 1.3f, 20000, 0.25f, 0, 40000f);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_635.f_1, -1f, 1f, 0f), 1.2f, 20000, 1f, 0, 40000f);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_635.f_1, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_907, "react_big_variations_a", 8f, -8f, -1, 8192, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_907, "exit_to_generic", 8f, -8f, -1, 8192, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_627.f_1, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
...
case 6:
break;
}}elseif(func_222(Local_691)){
if(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_605)){
if(func_233() > 19){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_691.f_1, Local_691.f_0, -567.85f, -288.8f, 34.08f, 12f, 0, iLocal_623, 24, 5f, 5f);
iLocal_514=6;
}}}}elseif((func_56(Local_635.f_0) && func_56(Local_627.f_0)) && func_56(Local_667.f_0)){
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_635.f_0, 1);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_627.f_0, 1);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_667.f_0, 1);
func_236();
}}
...
switch (iLocal_519){
case 0:
if((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_635.f_0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_627.f_0, 0)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_667.f_0, 0)){
...
break;
case 1:
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_667.f_0, 0)){
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_667.f_1, 17, 1);
TASK::CLEAR_PED_TASKS(Local_667.f_1);
TASK::TASK_SMART_FLEE_PED(Local_667.f_1, PLAYER::PLAYER_PED_ID(), 60f, -1, 0, 0);
iLocal_519=4;
}
break;
case 2:
...
if(bParam4){
return 0;
}elseif(func_36(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
break;
case 1:
ENTITY::SET_ENTITY_COORDS(Local_651.f_0, -616.56f, -176.6f, 37.26f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_651.f_0, 117.29f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_651.f_0, 1084227584);
if(func_56(Local_635.f_0)){
TASK::TASK_VEHICLE_MISSION(Local_651.f_1, Local_651.f_0, Local_635.f_0, 12, 15f, 262144, 20f, 5f, 1);
}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_651.f_1, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
VEHICLE::START_VEHICLE_HORN(Local_651.f_0, 1000, 0, 0);
iLocal_515=4;
break;
case 4:
if((TASK::GET_SCRIPT_TASK_STATUS(Local_651.f_1, joaat("script_task_perform_sequence")) !=1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_651.f_0, -1, 0)) && !PED::IS_PED_FLEEING(Local_651.f_1)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_651.f_0, -2f, 2f, 0f), 2f, 20000, 0.25f, 0, 40000f);
if(func_284(Local_627.f_1)){
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_651.f_0, 0) && !PED::IS_PED_FLEEING(Local_651.f_1)){
TASK::CLEAR_PED_TASKS(Local_651.f_1);
iLocal_515=6;
}
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_651.f_0, 1);
break;
case 5:
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_651.f_0, 0) && !PED::IS_PED_FLEEING(Local_651.f_1)){
TASK::CLEAR_PED_TASKS(Local_651.f_1);
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_651.f_0, PLAYER::PLAYER_PED_ID(), 8, 20f, 20, 100f, 5f, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_651.f_1, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
iLocal_515=7;
...
iLocal_885=0;
iLocal_887=0;
MISC::CLEAR_AREA_OF_VEHICLES(-628.8963f, -183.1741f, 36.76265f, 50f, 1, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-679.2649f, -250.0605f, 35.60568f, 21.75f, 1, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-655.583f, -298.5198f, 34.45316f, 39.75f, 1, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-670.7004f, -99.16148f, 36.77983f, 60f, 1, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-561.3182f, -153.0898f, 36.6348f, 50f, 1, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(-590.6263f, -247.0923f, 34.69418f, 35f, 1, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0, 0);
if(!func_249()){
return;
}
...
TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[0 /*16*/], "WORLD_HUMAN_WINDOW_SHOP_BROWSE", 0, 1);
}
if(func_284(Local_523[2 /*16*/])){
TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[2 /*16*/], "WORLD_HUMAN_WINDOW_SHOP_BROWSE", 0, 1);
}
if(func_284(Local_523[4 /*16*/])){
TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[4 /*16*/], "WORLD_HUMAN_STAND_MOBILE", 0, 0);
}
if(func_284(Local_523[1 /*16*/])){
TASK::TASK_START_SCENARIO_IN_PLACE(Local_523[1 /*16*/], "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_683.f_1, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
}
if(func_222(Local_675)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_675.f_1, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
}
...
ENTITY::SET_ENTITY_COORDS(Local_683.f_0, -678.85f, -95.08f, 36.86f, 1, 0, 0, 1);
...
func_234();
func_232();
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_605, Local_869, 3f, 3f, 2f, 0, 1, 0)){
iLocal_522=0;
iLocal_521=6;
}
if(func_225(0)){
...
if(ENTITY::IS_ENTITY_AT_ENTITY(Local_523[4 /*16*/], iLocal_605, 2.5f, 2.5f, 2f, 0, 1, 0)){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_523[4 /*16*/], uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[iParam0 /*16*/].f_6, 1f, 20000, 0.25f, 0, 40000f);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_523[iParam0 /*16*/], uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
Local_523[iParam0 /*16*/].f_13=1;
}}}elseif(func_27(Local_523[iParam0 /*16*/], iLocal_605, 3f, 1)){
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_523[iParam0 /*16*/], ENTITY::GET_ENTITY_COORDS(iLocal_605, 1)) 
};
TASK::CLEAR_PED_TASKS(Local_523[iParam0 /*16*/]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_866);
TASK::TASK_LOOK_AT_ENTITY(0, iLocal_605, -1, 0, 2);
if(Var0.f_1 > 0.7f){
TASK::TASK_PLAY_ANIM(0, sLocal_907, Local_523[iParam0 /*16*/].f_15, 8f, -4f, -1, 0, 0, 0, 0, 0);
}else{
TASK::TASK_PLAY_ANIM(0, sLocal_907, "avoid_rb", 8f, -4f, -1, 0, 0, 0, 0, 0);
}
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_605, 0);
TASK::TASK_PAUSE(0, 1000);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_523[iParam0 /*16*/].f_9, 1f, 20000, 0.25f, 0, 40000f);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(Local_523[iParam0 /*16*/], uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
...
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_605, -1, 0, 2);
}}elseif(MISC::GET_GAME_TIMER() > iLocal_614 && !func_26()){
...
Var0={
Local_523[iParam0 /*16*/].f_2 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &fVar3, 0, 0);
ENTITY::SET_ENTITY_COORDS(Local_523[iParam0 /*16*/], Var0.f_0, Var0.f_1, fVar3, 1, 0, 0, 1);
...
Local_627.f_0=VEHICLE::CREATE_VEHICLE(Local_627.f_2, Local_627.f_4, Local_627.f_7, 1, 1, 0);
Local_627.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_627.f_0, 4, Local_627.f_3, -1, 1, 1);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_627.f_0, 1);
...
Local_635.f_0=VEHICLE::CREATE_VEHICLE(iLocal_623, -591.7191f, -166.3491f, 37.8459f, 35f, 1, 1, 0);
Local_635.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_635.f_0, 5, iLocal_618, -1, 1, 1);
...
Local_643.f_0=VEHICLE::CREATE_VEHICLE(iLocal_621, -651.4f, -153.68f, 36.95f, 217.44f, 1, 1, 0);
Local_643.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_643.f_0, 4, iLocal_620, -1, 1, 1);
iLocal_615=PED::CREATE_PED_INSIDE_VEHICLE(Local_643.f_0, 4, iLocal_618, 2, 1, 1);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_643.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_643.f_0, 3);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_643.f_1, 17, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_615, 17, 1);
...
Local_659.f_0=VEHICLE::CREATE_VEHICLE(iLocal_622, -525.33f, -137.35f, 38.04f, 111.2f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_659.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_659.f_0, 3);
if(!func_284(Local_659.f_1)){
Local_659.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_659.f_0, 4, iLocal_618, -1, 1, 1);
...
if(STREAMING::HAS_MODEL_LOADED(iLocal_621) && STREAMING::HAS_MODEL_LOADED(iLocal_620)){
Local_667.f_0=VEHICLE::CREATE_VEHICLE(iLocal_621, Local_667.f_4, Local_667.f_7, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_667.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_667.f_0, 3);
if(!func_284(Local_667.f_1)){
Local_667.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_667.f_0, 4, iLocal_620, -1, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_667.f_1, 17, 1);
...
Local_651.f_0=VEHICLE::CREATE_VEHICLE(iLocal_624, -584.32f, -156.66f, 36.95f, 117.29f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_651.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_651.f_0, 3);
Local_651.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_651.f_0, 4, iLocal_618, -1, 1, 1);
...
Local_675.f_0=VEHICLE::CREATE_VEHICLE(iLocal_626, -683.3f, -238.03f, 36.63f, 29.79f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_675.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_675.f_0, 3);
if(!func_284(Local_675.f_1)){
Local_675.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_675.f_0, 4, iLocal_620, -1, 1, 1);
...
Local_683.f_0=VEHICLE::CREATE_VEHICLE(Local_683.f_2, Local_683.f_4, Local_683.f_7, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_683.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_683.f_0, 3);
if(!func_284(Local_683.f_1)){
Local_683.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_683.f_0, 4, Local_683.f_3, -1, 1, 1);
...
Local_691.f_0=VEHICLE::CREATE_VEHICLE(iLocal_623, Local_691.f_4, Local_691.f_7, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_691.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_691.f_0, 3);
if(!func_284(Local_691.f_1)){
Local_691.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_691.f_0, 4, iLocal_620, -1, 1, 1);
...
iLocal_699=VEHICLE::CREATE_VEHICLE(joaat("firetruk"), -637.88f, -112.82f, 38.1f, 83.08f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_699, 1084227584);
}
return 0;
}
return 1;
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_609, 2.2f, 20000, 0.25f, 0, 40000f);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_PLAY_ANIM(0, sLocal_907, "IDLE_D", 2f, -8f, -1, 8193, 0, 0, 0, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(iLocal_604, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
}
iLocal_613=1;
iLocal_614=0;
...
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_605, 0f, 0f, 0f, 1, 2000, 2000, 2000, 0);
}
...
TASK::TASK_PLAY_ANIM(0, sLocal_909, "gesture_easy_now", 8f, -8f, -1, 8, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_866);
TASK::TASK_PERFORM_SEQUENCE(iLocal_604, uLocal_866);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_866);
iLocal_892=1;
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_605, -628.1631f, -261.5749f, 37.6045f, 1.5f, 20000, 0.25f, 0, -15.13f);
iLocal_517=4;
}
break;
case 4:
...
break;
case 1:
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_927, Local_930, fLocal_933, 0, 1, 0)){
iLocal_522=0;
iLocal_521=3;
}
if(PED::IS_PED_FLEEING(iLocal_604)){
...
bool bVar0;
if(func_284(iLocal_604)){
if(MISC::GET_GAME_TIMER() > iLocal_898 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_899, Local_902, fLocal_905, 0, 1, 0)){
bVar0=false;
if(HUD::IS_MESSAGE_BEING_DISPLAYED()){
...
func_252("N1C_INIT", 7500, 1);
AUDIO::TRIGGER_MUSIC_EVENT("NIGEL1C_FORA");
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_920, Local_923, fLocal_926, 0, 1, 0)){
iLocal_522=0;
iLocal_521=2;
}else{
iLocal_522=1;
...
if(((!func_278(0) || Global_78828) || Global_78817==1) || !CAM::IS_SCREEN_FADED_IN()){
return 0;
}
switch (Global_78813){
case 0:
...
func_292(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
}
...
Global_78341[1 /*14*/]={
func_144(iVar0, iParam1, uVar31[iParam1], -1) 
};
if(PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_103(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_103(iParam1), Global_78341[1 /*14*/].f_3) > 0){
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_103(iParam1), Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4, 0);
}}
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
if((!func_407(iVar0, bParam1, uParam2) && !func_406(PLAYER::PLAYER_ID())) && !func_387(iParam0)){
return 0;
}
...
bVar1=false;
if(func_384(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0))){
bVar1=true;
}
...
if((!func_386(PLAYER::PLAYER_ID()) && iParam0 !=joaat("thruster")) && iParam0 !=joaat("avenger")){
return 0;
}
return 1;
}
...
if(func_405(PLAYER::PLAYER_ID()) || func_404(PLAYER::PLAYER_ID())){
if(func_388(iParam0)){
return 1;
}}
return 0;
...
if(func_391(PLAYER::PLAYER_ID()) && (!func_385(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("thruster")))){
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
if((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_381(iParam0)) || func_390(iVar0)){
return 1;
}
switch (iVar0){
...
return 1;
}elseif(func_393(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
bVar0=false;
if(func_384(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0))){
bVar0=true;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_213(iParam0, 0, 0)) || func_213(iParam0, 1, 0)) || func_213(iParam0, 2, 0)) || func_427(iParam0) !=145) || func_426(iParam0)) || func_425(iParam0)) || func_376(iParam0)) || func_424(iParam0)) || !func_414(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_425(iParam0)){
}
if(func_425(iParam0)){
}
...
}elseif(func_436(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, iVar1, ((*uParam1)[iVar0] - 1), false);
}}}
iVar0++;
}
if(func_403(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_434(*uParam0, ((*uParam1)[38] - 1))){
VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_434(*uParam0, ((*uParam1)[38] - 1)), false);
}
func_433(uParam0);
if(func_432(*uParam0)){
...
if(iParam1==0 || ENTITY::GET_ENTITY_MODEL(Global_98012[iVar0])==func_441(iParam0, iParam1)){
...
}elseif((!func_452(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=(iVar5 - 1)){
if(func_454(iParam0, uVar1[iVar6], 1) && func_453(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam4 || func_448(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
iVar0=1;
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar0 + 1))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_411(iVar0 + 1));
}}elseif(uParam1->f_66==joaat("sandking") || uParam1->f_66==joaat("sandking2")){
iVar1=1;
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar1 + 1))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_411(iVar1 + 1));
}}elseif(uParam1->f_66==joaat("formula") || uParam1->f_66==joaat("formula2")){
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar2))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_411(iVar2));
}
iVar2++;
}}elseif(uParam1->f_66==joaat("openwheel1")){
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar3))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_411(iVar3));
}
iVar3++;
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_411(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==-1035489563){
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_411(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar6))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_411(iVar6));
}
iVar6++;
}}
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_463(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_462()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_411(iVar7 + 1))){
...
if(((func_456() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))){
...
var func__460(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
func_57(Local_651);
func_55(&iLocal_699);
MISC::CLEAR_AREA_OF_VEHICLES(-669.0843f, -209.1426f, 36.27277f, 25.25f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0, 0);
...
iLocal_604=PED::CREATE_PED(5, iLocal_617, Local_606, 27.58f, 1, 1);
...
iLocal_605=PED::CREATE_PED(26, iLocal_619, -633.89f, -250.1f, 37.38f, 50f, 1, 1);
...
iLocal_605=PED::CREATE_PED(26, iLocal_619, -636.42f, -95.84f, 37.48f, -95.46f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_605, 3, 0, 3, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_605, 4, 0, 1, 0);
...
MISC::CLEAR_AREA_OF_VEHICLES(-633.4493f, -248.2691f, 35.87451f, 50f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_911, 50f, 0, 0, 0, 0, 0, 0, 0);
func_489();
func_250();
iLocal_604=Local_453.f_28[0];
...
iLocal_605=Local_453.f_28[1];
if(func_284(iLocal_605)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_605, 1);
}
func_68(&uLocal_701, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
func_68(&uLocal_701, 3, iLocal_604, "KERRY", 0, 1);
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-650.5558f, -217.0627f, 35.55435f 
};
uParam0->f_17[1 /*3*/]={
-601.4099f, -300.3887f, 64.24574f 
};
uParam0->f_24=35f;
uParam0->f_27=1;
iVar3=0;
...
break;
case 1:
if(!func_506(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4)){
return 0;
}
iLocal_82=2;
break;
...
if(bParam0){
func_319(iVar0, 1, 0);
func_525(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
}else{
...
iVar33=func_527(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar33 > -1){
