...
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_96.f_35[0], 1084227584);
...
PED::SET_PED_KEEP_TASK(Local_96.f_28[0], 1);
}
if(func_312(Local_96.f_28[1])){
...
PED::SET_PED_KEEP_TASK(Local_96.f_28[1], 1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_96.f_35[0], 1, 1, 0);
...
int func_235(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_312(iParam0)){
...
int func_236(var uParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6){
...
func_237(uParam0, iLocal_83, Param1, fParam4);
if(func_312(*uParam0)){
...
void func_237(var uParam0, int iParam1, struct<3> Param2, float fParam5){
func_238(uParam0);
...
if(iParam4==1){
if(func_299(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
void func_255(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6){
struct<60> Var0;
...
func_289(iParam5, &Var0, Param1, uParam4, func_292(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_273(iParam0, 0, 0)) || func_273(iParam0, 1, 0)) || func_273(iParam0, 2, 0)) || func_292(iParam0) !=145) || func_272(iParam0)) || func_271(iParam0)) || func_270(iParam0)) || func_269(iParam0)) || !func_259(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_271(iParam0)){
}
if(func_271(iParam0)){
}
...
var func__280(int iParam0){
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_281(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_289(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_286(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
Vector3 func__308(struct<3> Param0){
float fVar0;
float fVar1;
...
if(!func_318(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_318(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
case 2:
bVar6=true;
if(!func_344(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC:
NIGEL", 1)){
bVar6=false;
}
if(!func_344(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC:
MRS THORNHILL", 1)){
bVar6=false;
}
...
case 38:
if(bParam1){
uLocal_95=PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
...
case 39:
if(bParam1){
uLocal_95=PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
...
case 41:
if(bParam1){
uLocal_95=PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
...
case 42:
if(bParam1){
uLocal_95=PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
int func_344(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7){
if(func_345(uParam0, iParam1, Param2, fParam5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_345(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6){
int iVar0;
if(!func_153(iParam1)){
