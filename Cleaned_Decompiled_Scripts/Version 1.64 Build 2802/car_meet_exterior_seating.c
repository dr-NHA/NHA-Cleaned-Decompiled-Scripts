...
int func_55(var uParam0, struct<3> Param1, int iParam4){
...
var func__56(var uParam0, var uParam1){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_73(PLAYER::PLAYER_ID()), Global_1950108.f_1029[154 /*3*/], 1) >=150f){
return 1;
}
if(func_65()){
return 1;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_53(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
func_84(func_86(), func_85(iParam3, fVar3)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_84(func_83(), func_85(iParam3, fVar3)) + Var0 
};
