...
func_2();
if(MISC::IS_BIT_SET(uLocal_325, 0)){
func_1();
}
}
break;
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_338, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 6f){
func_83();
}}else{
func_83();
}}}
...
void func_1(){
uLocal_332=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uLocal_331);
switch (iLocal_327){
case 0:
break;
case 1:
...
if(func_44(1, 0, 1)){
if((((((func_50(Local_338, Var0) && Local_354.f_2 < (Local_338.f_2 + 1f)) && func_54(9)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS(Local_338)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_342, Local_345, 2f, 0, 1, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID())){
...
Local_338={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_334, sLocal_335, Local_348, Local_351, 0, 2) 
};
Var3={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_334, sLocal_335, Local_348, Local_351, 0, 2) 
};
fLocal_341=Var3.f_2;
...
var func__16(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_22(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
}elseif(bVar14 || (!func_19(PLAYER::PLAYER_ID(), 0) && !func_23())){
...
return MISC::IS_BIT_SET(Global_1653913.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
...
if((((((MISC::IS_BIT_SET(Global_1835487, iParam0) || Global_1835488 !=-1) || func_64()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_63()) || func_60(iParam0)){
return 0;
}
