...
fLocal_341=43.8287f;
uLocal_342={
349f, -997.3587f, -100.5f 
};
uLocal_345={
351.74f, -997.3587f, -97f 
};
uLocal_348={
349.66f, -996.183f, -99.764f 
};
uLocal_351={
0f, 0f, -3.96f 
};
...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(18) || func_84() || Global_2793044.f_1947) func_83();
if(func_80(9) || func_79() && !func_78()) func_83();
...
switch (iLocal_326){
case 0:
if(func_65()) iLocal_326=1;
break;
case 1:
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
func_2();
if(IS_BIT_SET(iLocal_325, 0)) func_1();
}
break;
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_338, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > 6f){
func_83();
}}else{
func_83();
}}
...
break;
case 3:
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_332)) func_83();
break;
case 4:
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_332)) func_83();
break;
...
switch (iLocal_327){
case 0:
if(Global_1835488==9) Global_1835488=-1;
if(func_74()==5){
MISC::CLEAR_BIT(&iLocal_325, 0);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==FIRST_PERSON) iLocal_330=1;
...
if(iLocal_333==-1) _CONTEXT_ADD_HELP_TEXT(&iLocal_333, 3, "SA_BED_IN" /*Press ~INPUT_CONTEXT~ to get into bed.~n~*/, 0, 0, 0, 0);
iLocal_327=1;
}}
break;
case 1:
...
func_39();
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_BED_IN" /*Press ~INPUT_CONTEXT~ to get into bed.~n~*/)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
func_37();
...
uLocal_338={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_334, sLocal_335, uLocal_348, uLocal_351, 0, 2) 
};
animInitialOffsetRotation={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_334, sLocal_335, uLocal_348, uLocal_351, 0, 2) 
};
...
func_12(true);
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
if(iLocal_330==1) CAM::DISABLE_ON_FOOT_FIRST_PERSON_VIEW_THIS_UPDATE();
iLocal_332=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_331);
...
if(!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_BED_OUT" /*Press ~INPUT_SCRIPT_RUP~ to get out of bed.~n~*/)) func_11("SA_BED_OUT" /*Press ~INPUT_SCRIPT_RUP~ to get out of bed.~n~*/);
iLocal_327=6;
}
break;
case 6:
...
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
if(iLocal_330==1) CAM::DISABLE_ON_FOOT_FIRST_PERSON_VIEW_THIS_UPDATE();
if(!func_10(true))if(!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_BED_OUT" /*Press ~INPUT_SCRIPT_RUP~ to get out of bed.~n~*/)) func_11("SA_BED_OUT" /*Press ~INPUT_SCRIPT_RUP~ to get out of bed.~n~*/);
elseif(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_BED_OUT" /*Press ~INPUT_SCRIPT_RUP~ to get out of bed.~n~*/)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
if(!func_46(PLAYER::PLAYER_ID()) && PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_SCRIPT_RUP)){
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_BED_OUT" /*Press ~INPUT_SCRIPT_RUP~ to get out of bed.~n~*/)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
func_9();
MISC::CLEAR_BIT(&iLocal_325, 0);
iLocal_331=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_348, uLocal_351, 2, false, false, 1065353216, 0, 1065353216);
...
break;
case 7:
if(!func_8() && INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(uLocal_338)) && iLocal_330==1) CAM::DISABLE_ON_FOOT_FIRST_PERSON_VIEW_THIS_UPDATE();
...
if(!Global_2639783==iParam0) Global_2639783.f_1=0;
Global_2639783=iParam0;
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) Global_2639783.f_3=NETWORK::GET_NETWORK_TIME();
return;
}
...
if(iParam0==func_74()) Global_2639783.f_19=1;
return;
}
BOOL func_6() // Position - 0xA79{
if(func_7()==1 || func_7()==4) return true;
return false;
}
...
if(func_7()==3 || func_7()==2) return true;
return false;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_22(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_18() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_22(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_20(-1, false)==8;
...
if(func_23())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
elseif(flag14 || !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_23()) ENTITY::SET_ENTITY_VISIBLE(playerPed, !flag14, false);
if(!flag14){
...
if(!func_31(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))if(!flag20) ENTITY::SET_ENTITY_COLLISION(playerPed, true, false);
...
if(func_28(*Global_4718592.f_166301)) ENTITY::FREEZE_ENTITY_POSITION(playerPed, true);
}
...
i <=7;
i=i + 1){
if(!PED::IS_PED_INJURED(sizeAndPeds[i]))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(sizeAndPeds[i], uLocal_342, uLocal_345, 2f, false, true, 0)) return false;
}}
return true;
}
...
if(Global_97609 && Global_97610 || func_52()) return false;
if(func_51(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam3, false)) return true;
}}}}
return false;
}
...
if(IS_BIT_SET(Global_1835487, iParam0) || Global_1835488 !=-1 || func_64() || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID()) || func_63() || func_60(iParam0)) return false;
if(func_59(PLAYER::PLAYER_ID())==4) return false;
if(func_55(PLAYER::PLAYER_ID())==1) return false;
return true;
}

int func_55(Player plParam0) // Position - 0x1CBA{
if(func_58(plParam0)==299) return func_56(plParam0);
return -1;
}

int func_56(Player plParam0) // Position - 0x1CD8{
if(func_57(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_182;
return -1;
}
...
if(func_57(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_33;
return -1;
}

int func_59(Player plParam0) // Position - 0x1D59{
if(func_58(plParam0)==271) return func_56(plParam0);
return -1;
}
BOOL func_60(int iParam0) // Position - 0x1D77{
if(func_61()) return true;
return false;
}
BOOL func_61() // Position - 0x1D8B{
if(func_62() !=-1) return true;
else return false;
return false;
}
...
if(!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_334)) return false;
bLocal_328=true;
return true;
}
...
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_70()) return true;
...
if(func_73())if(!bNoTerminate) func_77();
else return 0;
...
if(iLocal_333 > -1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_333);
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_BED_IN" /*Press ~INPUT_CONTEXT~ to get into bed.~n~*/) || _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_BED_OUT" /*Press ~INPUT_SCRIPT_RUP~ to get out of bed.~n~*/)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
func_9();
AUDIO::RELEASE_AMBIENT_AUDIO_BANK();
if(bLocal_328) STREAMING::REMOVE_ANIM_DICT(sLocal_334);
func_4();
if(!func_22(PLAYER::PLAYER_ID()) && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_35()) _SET_PLAYER_CONTROL_EX(PLAYER::PLAYER_ID(), true, 0, false);
func_77();
return;
}
BOOL func_84() // Position - 0x2340{
if(func_85()) return false;
return true;
}
