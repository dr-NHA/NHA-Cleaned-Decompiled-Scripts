...
if((SYSTEM::VDIST2(Var0, Var3) > 10000f || ENTITY::IS_ENTITY_DEAD(uLocal_38, 0)) || func_4()){
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_38, uVar6);
TASK::CLEAR_SEQUENCE_TASK(&uVar6);
iLocal_40=1;
}}
break;
...
fVar7=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
if(fVar7 >=0.157f){
...
iLocal_40=2;
}}elseif(func_5(&uLocal_63, "TOWAUD", "TONYA_CALL2", 8, 0, 0, 0)){
iLocal_40=2;
}}}
break;
case 2:
