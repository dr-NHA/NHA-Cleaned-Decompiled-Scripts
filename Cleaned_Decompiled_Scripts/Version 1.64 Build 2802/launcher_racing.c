...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_24() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
var func__32(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_27();
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_74(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
GRAPHICS::DRAW_SPRITE(func_109(Global_23270.f_4824[iVar22]), func_106(Global_23270.f_4824[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_88(Global_23270.f_4824[iVar22])), (fVar37 * func_88(Global_23270.f_4824[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
}
}}
bVar41=true;
...
var func__120(int iParam0, int iParam1){
switch (iParam0){
case 5:
if(iParam1 > -1){
...
TASK::STOP_ANIM_TASK(uLocal_103[iVar0], cLocal_184, sLocal_185[iVar0], -1056964608);
}
func_135(iVar0);
}}
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_103[iParam0], uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
iLocal_195=2;
break;
case 2:
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_103[iParam0], joaat("script_task_perform_sequence")) !=1 || PED::IS_PED_FACING_PED(uLocal_103[iParam0], PLAYER::PLAYER_PED_ID(), 20f)){
...
func_140(&uLocal_198);
TASK::TASK_PLAY_ANIM(uLocal_103[iParam0], "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
iLocal_195=4;
}
break;
case 4:
...
iLocal_196=1;
iLocal_195=1;
}elseif(func_136(&uLocal_198) >=10f && !iLocal_197){
iLocal_197=1;
iLocal_195=1;
}
break;
...
return (func_137(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_143(iParam3), 0);
}
...
iLocal_95=MISC::GET_GAME_TIMER() + 1000;
return 0;
}elseif((ENTITY::GET_ENTITY_HEALTH(iLocal_0) <=200 || FIRE::IS_ENTITY_ON_FIRE(iLocal_0)) || func_151()){
...
iLocal_92=1;
iLocal_95=MISC::GET_GAME_TIMER() + 1000;
}}elseif(Local_83.f_1==1){
if(!func_149("STREET_NA_BIKE")){
func_148("STREET_NA_BIKE");
iLocal_92=1;
iLocal_95=MISC::GET_GAME_TIMER() + 1000;
}}elseif(!func_149("STREET_NA_CAR")){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_89, 1) < IntToFloat(iVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==0){
return 1;
}}
return 0;
}
...
iLocal_111=VEHICLE::CREATE_VEHICLE(iLocal_182, Local_113, fLocal_116, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_NOT_STEALABLE_AMBIENTLY(iLocal_111, 0);
...
iLocal_117=VEHICLE::CREATE_VEHICLE(iLocal_183, Local_118, fLocal_121, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_NOT_STEALABLE_AMBIENTLY(iLocal_117, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(uLocal_103[iVar0], 0) && !func_165(uLocal_103[iVar0], joaat("script_task_play_anim"))){
TASK::TASK_PLAY_ANIM(uLocal_103[iVar0], cLocal_184, sLocal_185[iVar0], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
PED::SET_PED_KEEP_TASK(uLocal_103[iVar0], 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_174[iVar0])){
uLocal_103[iVar0]=PED::CREATE_PED(25, iLocal_174[iVar0], Local_136[iVar0 /*3*/], fLocal_158[iVar0], 1, 1);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_103[iVar0], Local_136[iVar0 /*3*/], 0, 0, 1);
...
if(!ENTITY::IS_ENTITY_DEAD(uLocal_103[iVar1], 0) && !func_165(uLocal_103[iVar1], joaat("script_task_play_anim"))){
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_103[iVar1], Local_136[iVar1 /*3*/], 0, 0, 1);
if(iVar1 !=2 && iVar1 !=3){
TASK::TASK_PLAY_ANIM(uLocal_103[iVar1], cLocal_184, sLocal_185[iVar1], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
}
else{
TASK::TASK_PLAY_ANIM(uLocal_103[iVar1], cLocal_184, sLocal_185[iVar1], 1000f, -1000f, -1, 1, 0.5f, 0, 0, 0);
}
PED::SET_PED_KEEP_TASK(uLocal_103[iVar1], 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_174[iVar1])){
uLocal_103[iVar1]=PED::CREATE_PED(25, iLocal_174[iVar1], Local_136[iVar1 /*3*/], fLocal_158[iVar1], 1, 1);
...
TASK::TASK_LOOK_AT_ENTITY(uLocal_103[4], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
iVar1=0;
...
VEHICLE::SET_BOAT_REMAINS_ANCHORED_WHILE_PLAYER_IS_DRIVER(iLocal_111, 0);
VEHICLE::SET_FORCE_LOW_LOD_ANCHOR_MODE(iLocal_111, 0);
...
if(VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_166[iVar2], -1, 0)){
PED::SET_PED_INTO_VEHICLE(iLocal_170[iVar2], iLocal_166[iVar2], -1);
}}
}
elseif(func_16(iLocal_166[iVar2]) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_jetski_01"))){
iLocal_170[iVar2]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_166[iVar2], 25, joaat("a_m_y_jetski_01"), -1, 1, 1);
PED::SET_PED_DIES_IN_WATER(iLocal_170[iVar2], 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_170[iVar2], 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_182)){
iLocal_166[iVar2]=VEHICLE::CREATE_VEHICLE(iLocal_182, Local_122[iVar2 /*3*/], fLocal_132[iVar2], 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_166[iVar2], 1084227584);
VEHICLE::SET_BOAT_LOW_LOD_ANCHOR_DISTANCE(iLocal_166[iVar2], 0f);
VEHICLE::SET_BOAT_REMAINS_ANCHORED_WHILE_PLAYER_IS_DRIVER(iLocal_166[iVar2], 1);
VEHICLE::SET_FORCE_LOW_LOD_ANCHOR_MODE(iLocal_166[iVar2], 1);
if(unk_0x74D15F81528C1714(iLocal_166[iVar2])){
VEHICLE::SET_BOAT_ANCHOR(iLocal_166[iVar2], 1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_166[iVar2], 0, 1, 0);
}
iVar2++;
}
...
if(Local_83.f_1==3){
return 1;
}elseif(Local_83.f_1==1 || Local_83.f_1==2){
...
PATHFIND::SET_PED_PATHS_IN_AREA(Local_201, Local_204, 0, 0);
PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_207, Local_210, fLocal_213, 0, 0, 1);
iLocal_94=1;
}elseif(Local_83.f_1==3){
switch (Local_83.f_0){
case 5:
...
if(((func_16(uVar0) && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0)) && !func_204(PLAYER::PLAYER_PED_ID(), uVar0, -1)) && ENTITY::GET_ENTITY_MODEL(uVar0) !=joaat("taxi")){
return 0;
}}
switch (Local_83.f_0){
case 0:
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_103[iVar1], uVar2);
}
iVar1++;
}
iVar1=0;
...
if(func_16(iLocal_166[iVar1]) && PED::IS_PED_IN_VEHICLE(iLocal_170[iVar1], iLocal_166[iVar1], 0)){
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_166[iVar1], 30f, 786597);
}else{
TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_170[iVar1], uVar2);
}
iVar1++;
}
if(func_65(iLocal_112)){
if(func_16(iLocal_111) && PED::IS_PED_IN_VEHICLE(iLocal_112, iLocal_111, 0)){
TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_112, iLocal_111, 30f, 786597);
}else{
TASK::TASK_WANDER_STANDARD(iLocal_112, 1193033728, 0);
}}
return 0;
}
if(func_184()){
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_103[iVar4], uVar3);
}
iVar4++;
}
iVar4=0;
...
VEHICLE::SET_BOAT_ANCHOR(iLocal_166[iVar4], 0);
}
if(func_65(iLocal_170[iVar4])){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_PAUSE(0, iVar4 * 60);
if(func_16(iLocal_166[iVar4]) && PED::IS_PED_IN_VEHICLE(iLocal_170[iVar4], iLocal_166[iVar4], 0)){
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_166[iVar4], 50f, 786468);
}else{
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uVar3);
TASK::TASK_PERFORM_SEQUENCE(iLocal_170[iVar4], uVar3);
if((iVar4 % 2)==0){
...
TASK::TASK_SMART_FLEE_PED(iLocal_112, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}}
switch (Local_83.f_0){
case 0:
Global_113622[0]=1;
...
return 1;
}elseif(func_185(iLocal_170[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::IS_PED_BEING_JACKED(iLocal_170[iVar0])){
return 1;
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_166[iVar0])){
if(ENTITY::IS_ENTITY_DEAD(iLocal_166[iVar0], 0)){
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_166[iVar0], PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(iLocal_166[iVar0]) < 900){
return 1;
}}
iVar0++;
}
...
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_111, PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(iLocal_111) < 900){
return 1;
}}
return 0;
}
...
return 1;
}elseif(func_185(iLocal_112, 1, 1116471296, 1126825984, 0, 0, 0, 0)){
return 1;
}elseif(PED::IS_PED_BEING_JACKED(iLocal_112)){
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_111, 0)){
return 1;
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_111, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_111, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_117)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_117, 0)){
return 1;
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_117, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
iVar0=0;
while (iVar0 <=(iLocal_174 - 1)){
...
return 1;
}elseif(func_185(uLocal_103[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
return 1;
}}
iVar0++;
}
...
if(bParam4){
return 0;
}elseif(func_186(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__190(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_194(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
switch (Local_83.f_0){
case 5:
return MISC::IS_BIT_SET(Global_113648.f_24978.f_2, 0);
break;
case 6:
return MISC::IS_BIT_SET(Global_113648.f_24978.f_2, 1);
break;
case 7:
return MISC::IS_BIT_SET(Global_113648.f_24978.f_2, 2);
break;
case 8:
return MISC::IS_BIT_SET(Global_113648.f_24978.f_2, 3);
break;
case 0:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_3, 0);
break;
case 1:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_3, 1);
break;
case 2:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_3, 2);
break;
case 3:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_3, 3);
break;
case 4:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_3, 4);
break;
}
return 0;
}
...
var func__207(struct<3> Param0, float fParam3){
struct<3> Var0;
Var0={
...
switch (iParam0){
case 0:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_1, 0);
break;
case 1:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_1, 1);
break;
case 2:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_1, 2);
break;
case 3:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_1, 3);
break;
case 4:
return MISC::IS_BIT_SET(Global_113648.f_24981.f_1, 4);
break;
}
return 0;
}
...
Local_83.f_3=100;
Local_83.f_4=20;
}elseif(func_215(func_216(87, 0), Local_89, 1f, 0)){
Local_83.f_0=1;
Local_83.f_1=2;
Local_83.f_3=500;
Local_83.f_4=18;
}elseif(func_215(func_216(88, 0), Local_89, 1f, 0)){
Local_83.f_0=2;
Local_83.f_1=2;
Local_83.f_3=1000;
Local_83.f_4=2;
}elseif(func_215(func_216(89, 0), Local_89, 1f, 0)){
Local_83.f_0=3;
Local_83.f_1=2;
Local_83.f_3=1250;
Local_83.f_4=4;
}elseif(func_215(func_216(90, 0), Local_89, 1f, 0)){
Local_83.f_0=4;
Local_83.f_1=1;
Local_83.f_3=1500;
Local_83.f_4=5;
}elseif(func_215(func_216(82, 0), Local_89, 1f, 0)){
Local_83.f_0=5;
Local_83.f_1=3;
Local_83.f_3=0;
Local_83.f_4=16;
}elseif(func_215(func_216(83, 0), Local_89, 1f, 0)){
Local_83.f_0=6;
Local_83.f_1=3;
Local_83.f_3=0;
Local_83.f_4=13;
}elseif(func_215(func_216(84, 0), Local_89, 1f, 0)){
Local_83.f_0=7;
Local_83.f_1=3;
Local_83.f_3=0;
Local_83.f_4=15;
Local_83.f_5=1;
}elseif(func_215(func_216(85, 0), Local_89, 1f, 0)){
Local_83.f_0=8;
Local_83.f_1=3;
Local_83.f_4=24;
Local_83.f_3=0;
...
Vector3 func__216(int iParam0, int iParam1){
int iVar0;
iVar0=iParam0;
...
TASK::CLEAR_PED_TASKS(uLocal_103[iVar0]);
TASK::TASK_WANDER_STANDARD(uLocal_103[iVar0], 1193033728, 0);
...
VEHICLE::SET_BOAT_ANCHOR(iLocal_166[iVar0], 0);
}
