...
uLocal_236=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_236)){
SYSTEM::WAIT(0);
}
iVar2=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_236);
switch (iVar2){
case 0:
Global_21344={
Global_21855 
...
func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300", &Var0, "CELL_195", 0);
}else{
func_51(Global_20364, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), &Var0, &(Global_2028[Global_7568 /*29*/].f_3), 0);
}}
func_51(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
}
func_23();
...
}elseif(func_73(Global_2800023.f_20)){
...
AUDIO::ADD_LINE_TO_CONVERSATION(iVar3, &cLocal_50, &(Global_20593[iVar2 /*6*/]), iVar4, uVar5, 0, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
}}
iVar1=(iVar1 + iVar0);
...
uVar10=func_76(0);
uVar11=func_75(0);
AUDIO::ADD_LINE_TO_CONVERSATION(iVar3, &cLocal_50, &(Global_21344.f_6[iLocal_92 /*6*/]), iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
...
if(Global_21731==0){
AUDIO::SET_CONVERSATION_AUDIO_CONTROLLED_BY_ANIM(uLocal_83);
AUDIO::SET_CONVERSATION_AUDIO_PLACEHOLDER(uLocal_84);
AUDIO::START_SCRIPT_CONVERSATION(Global_21344.f_368, Global_21344.f_369, Global_21344.f_370, uLocal_82);
Global_21725=4;
}}

int func_75(int iParam0){
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_85), iParam0 * 7 + 6, iParam0 * 7 + 7);
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_85), iParam0 * 7 + 5, iParam0 * 7 + 6);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_85), iParam0 * 7 + 4, iParam0 * 7 + 5);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_85), iParam0 * 7 + 3, iParam0 * 7 + 4);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 1;
}
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_85), iParam0 * 7 + 2, iParam0 * 7 + 3);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_85), iParam0 * 7 + 1, iParam0 * 7 + 2);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_85), iParam0 * 7, iParam0 * 7 + 1);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
int func_82(){
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_73), 2, 3);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
int func_83(){
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_73), 1, 2);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
int func_84(){
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_73), 0, 1);
if(MISC::ARE_STRINGS_EQUAL(uVar0, "0")){
return 0;
}
return 1;
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_66), iParam0 * 3 + 2, iParam0 * 3 + 3);
...
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_66), iParam0 * 3 + 1, iParam0 * 3 + 2);
return func_86(uVar0);
}

int func_88(int iParam0){
var uVar0;
uVar0=HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME(HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&cLocal_66), iParam0 * 3, iParam0 * 3 + 1);
return func_86(uVar0);
}
...
AUDIO::SET_CONVERSATION_AUDIO_PLACEHOLDER(uLocal_84);
if(Global_22717){
AUDIO::PRELOAD_SCRIPT_CONVERSATION(Global_21344.f_368, Global_21344.f_369, Global_21344.f_370, uLocal_82);
...
uVar10=func_76(iVar2);
uVar11=func_75(iVar2);
AUDIO::ADD_LINE_TO_CONVERSATION(iVar3, &cLocal_50, &Global_21344, iVar4, uVar5, 1, uVar6, uVar7, uVar8, uVar12, uVar9, uVar10, uVar11);
}
iLocal_29=1;
}
iVar2++;
