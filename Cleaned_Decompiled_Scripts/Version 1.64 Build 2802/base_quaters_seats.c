...
if(bParam1) _CONTEXT_REMOVE_HELP_TEXT(&(uParam0->f_29.f_5));
return;
}
...
if(func_8(&(uParam0->f_29), 7)) uParam0->f_29.f_14(&uParam0->[iParam1 /*14*/], iParam1, sParam2);
...
func_4(uParam0, true);
func_52(uParam0, 1);
}elseif(uParam0->f_29.f_5==-1){
if(MISC::GET_GAME_TIMER() - uParam0->f_29.f_6 > 150) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_29.f_5), 4, "MPJAC_SIT" /*Press ~INPUT_CONTEXT~ to sit down.*/, 0, 0, 0, 0);
...
if(bParam1){
num=func_13(uParam0);
if(num !=uParam0->f_29.f_8.f_1)if(num==0) randomIntInRange=11 + uParam0->f_29.f_8.f_1;
else randomIntInRange=6 + num;
else randomIntInRange=uParam0->f_29.f_8.f_2;
num=uParam0->f_29.f_8.f_1;
}elseif(uParam0->f_29.f_8.f_2==5){
num=uParam0->f_29.f_8.f_1;
endRange=3;
randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(0, endRange);
if(randomIntInRange==uParam0->f_29.f_8.f_3) randomIntInRange=(randomIntInRange + 1) % endRange;
}else{
...
if(uParam0->f_29.f_8==2) return uParam0->f_29.f_8.f_1;
...
if(uParam0->f_29.f_4==6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("block_interrupt")) && !func_8(&(uParam0->f_29), 12))if(num >=0.35f) func_23(uParam0);
...
if(uParam0->f_29.f_5==-1) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_29.f_5), 4, "MPJAC_EXIT" /*Press ~INPUT_CONTEXT~ to stand up.*/, 0, 0, 0, 0);
if(uParam0->f_29.f_4==6)if(PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_CONTEXT)) func_24(uParam0);
}}}
...
var unk;
unk={
uParam0->[uParam0->f_29.f_2 /*14*/].f_8.f_3 
};
if(func_16() && uParam0->f_29.f_8==0) unk.f_2=unk.f_2 - 4f;
return unk;
}
...
if(playerIndex !=PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true) && func_50(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_29.f_2 /*14*/])) return 1;
}}
return 0;
}
...
i < 1;
i=i + 1){
if(func_50(PLAYER::PLAYER_PED_ID(), &uParam0->[uParam0->f_29.f_2 /*14*/])) return true;
else uParam0->f_29.f_2=(uParam0->f_29.f_2 + 1) % 2;
}
return false;
}
...
if(uParam0->f_29.f_4==6){}elseif(uParam0->f_29.f_4 > 4){
...
}elseif(uParam0->f_29.f_4 > 1){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_55(uParam0));
uParam0->f_29.f_7=MISC::GET_FRAME_COUNT();
}elseif(MISC::GET_FRAME_COUNT() - uParam0->f_29.f_7 < 5){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_55(uParam0));
}
return;
}
...
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1853753, true, 0)) return false;
...
func_89();
if(func_88(Global_1853753)) func_81();
else func_71();
return true;
}
return false;
...
Vector3 func__75() // Position - 0x192A{
return -0.67f, -1.66f, 0.7f;
}


Vector3 func__76() // Position - 0x1941{
return -0.67f, 0f, -1.3f;
}


Vector3 func__77(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x1954{
float num;
float num2;
float num3;
...
Vector3 func__78() // Position - 0x1998{
return func_77({
-60f, 4841.945f, 362.58f 
}
- func_79(), 180f - -66.83f);
}


Vector3 func__79() // Position - 0x19C3{
...
case 0:
*uParam1={
361.89f, 4842.36f, -59.25f 
};
*uParam2=180f + -66.83f;
break;
case 1:
*uParam1={
366.28f, 4839.91f, -59.25f 
};
*uParam2=180f + 28.31f;
break;
case 2:
*uParam1={
367.33f, 4827.37f, -59.25f 
};
*uParam2=180f - 163.69f;
break;
case 3:
*uParam1={
370.58f, 4827.01f, -59.25f 
};
...
uParam1->[iParam2 /*14*/].f_8={
func_77(func_85(), num) + unk 
};
uParam1->[iParam2 /*14*/].f_8.f_3={
0f, 0f, num + 3f 
};
uParam1->[iParam2 /*14*/].f_1={
func_77(func_84(), num) + unk 
};
uParam1->[iParam2 /*14*/].f_1.f_3={
func_77(func_83(), num) + unk 
};
uParam1->[iParam2 /*14*/].f_1.f_6=0.73f;
return;
}
...
Vector3 func__83() // Position - 0x1B30{
return 0f, -1.74f, 2f;
}


Vector3 func__84() // Position - 0x1B3F{
return 0f, 0f, 0f;
}


Vector3 func__85() // Position - 0x1B4A{
return func_77({
-60f, 4845.8f, 364.74f 
}
- func_86(), -4f);
...
Vector3 func__86() // Position - 0x1B6F{
...
case 1:
*uParam1={
367.39f, 4845.325f, -60f 
};
*uParam2=-46f;
break;
case 2:
*uParam1={
369.965f, 4827.239f, -60f 
};
*uParam2=-16f;
break;
case 3:
