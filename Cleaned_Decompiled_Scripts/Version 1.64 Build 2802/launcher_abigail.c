...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_280(&num, true);
func_218(num);
...
if(func_178(&num, 0)){
if(func_177(num)) func_174(num, &blLocal_101);
if(!LAUNCH_RC_MISSION(&num)) func_280(&num, true);
if(func_1(&num)) func_280(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xBFE{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6A14{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x7164{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x74F0{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x762F{
float num;
float num2;
float num3;
...
func_298("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_182(uParam0->f_27)){
func_181(uParam0->f_27, *uParam0);
func_298("RC5_IN_ACTIVATION_RANGE:
...
if(func_182(true)){
func_181(1, *uParam0);
func_298("RC_IN_ACTIVATION_RANGE:
...
func_298("RC_STOP_PLAYER_VEHICLE_CHECK:
...
*uParam0=3;
}elseif(func_210(PLAYER::PLAYER_PED_ID(), *uParam1, true) < 15f){
*uParam0=4;
}}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, sLocal_99, "outro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, sLocal_99, "outro") > 0.99f) TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "base", 8f, -8f, -1, 1, 0, false, false, false);
break;
case 3:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, sLocal_99, "intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, sLocal_99, "intro") > 0.99f) *uParam0=4;
break;
case 4:
if(_CONVERSATION_ADD_LINE(&(uParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_92, uLocal_95, 8f, false, true, 0)) TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, false, false, false);
*uParam0=5;
}
break;
case 5:
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_92, uLocal_95, 8f, false, true, 0)){
if(MISC::GET_GAME_TIMER() > uParam0->f_166) *uParam0=4;
}else{
TASK::TASK_PLAY_ANIM(*uParam1, sLocal_99, "outro", 8f, -8f, -1, 2, 0, false, false, false);
*uParam0=1;
}}
...
if(func_203(PLAYER::PLAYER_ID())) return false;
...
if(func_197(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_214(uParam0, 1);
}else{
...
if(func_197(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_216(uParam0);
}}}
return;
}
...
var unk;
if(Global_78558){
func_298("IS_RC_FINE_AND_IN_RANGE():
...
Vector3 func__235(Ped pedParam0, int iParam1) // Position - 0xF26E{
...
Vector3 func__239(float fParam0, var uParam1, var uParam2) // Position - 0xF42F{
float num;
float num2;
...
if(func_255() && Global_100681.f_11==6 && iParam0==func_172(&(Global_100681.f_3), 0)) return true;
return false;
}
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-1588.6636f, 5210.4404f, 2.488135f 
};
uParam0->f_17[1 /*3*/]={
-1596.9752f, 5228.6836f, 5.966843f 
};
uParam0->f_24=8f;
uParam0->f_27=0;
uParam0->f_25=1;
...
break;
case 1:
if(!func_264(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_99)) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_261(&uParam0->f_28[0], CHAR_ABIGAIL, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1)) flag=false;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-1598.5696f, 5231.605f, 1.969029f 
};
uParam0->f_17[1 /*3*/]={
-1610.4132f, 5257.687f, 5.965584f 
};
uParam0->f_24=8f;
uParam0->f_27=0;
uParam0->f_25=1;
...
break;
case 1:
if(!STREAMING::HAS_MODEL_LOADED(model) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_99)) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(!func_261(&uParam0->f_28[0], CHAR_ABIGAIL, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1)) flag=false;
if(flag) iLocal_91=3;
break;
case 3:
...
if(func_275(iParam0)) return false;
if(iParam0==-1) iParam0=func_171();
if(iParam0==-1) return false;
if(!func_256(iParam0)){
...
if(iParam0==58)if(func_270(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
int i;
if(*uParam0==1){
if(func_278(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
if(HUD::DOES_BLIP_EXIST(blLocal_101)) HUD::REMOVE_BLIP(&blLocal_101);
if(iLocal_100 !=-1){
func_298("SCRIPT TERMINATING:
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))if(func_284(sParam0)) func_282();
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_260(&uParam0->[i]);
else func_292(&uParam0->[i]);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_296(&uParam0->[i]);
else func_295(&uParam0->[i], false, 1, 0);
}
return;
}
