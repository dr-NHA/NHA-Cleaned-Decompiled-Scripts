...
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
*iParam0=1;
break;
case 1:
if(MISC::GET_GAME_TIMER() > iParam0->f_166){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, 0, 1, 0)){
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
*iParam0=3;
}elseif(func_210(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f){
*iParam0=4;
}}
...
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
}
break;
case 3:
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, 0, 1, 0)){
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
}
*iParam0=5;
}
break;
...
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, 0, 1, 0)){
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
*iParam0=1;
}else{
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
*iParam0=2;
}
}}else{
iParam0->f_166=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 10000));
...
var func__204(int iParam0, int iParam1){
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-1588.664f, 5210.44f, 2.488135f 
};
uParam0->f_17[1 /*3*/]={
-1596.975f, 5228.684f, 5.966843f 
};
uParam0->f_24=8f;
uParam0->f_27=0;
uParam0->f_25=1;
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-1598.57f, 5231.605f, 1.969029f 
};
uParam0->f_17[1 /*3*/]={
-1610.413f, 5257.687f, 5.965584f 
};
uParam0->f_24=8f;
uParam0->f_27=0;
uParam0->f_25=1;
