...
if(unk_0xA903968D412A99A2("Heist4CameraFlash3")==1f) Global_1962983=true;
return;
}
entityIndexOfCutsceneEntity=CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("MP_1", 0);
if(!ENTITY::DOES_ENTITY_EXIST(entityIndexOfCutsceneEntity) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(entityIndexOfCutsceneEntity)) return;
if(ENTITY::HAS_ANIM_EVENT_FIRED(entityIndexOfCutsceneEntity, 746734512)) func_57("Heist4CameraFlash");
...
if(!GRAPHICS::ANIMPOSTFX_IS_RUNNING(sParam0)) GRAPHICS::ANIMPOSTFX_PLAY(sParam0, 0, false);
return;
}
...
func_70(uParam0);
flag=uParam0->f_7;
if(flag)if(func_69()) func_68(uParam0, 4);
if(!CUTSCENE::IS_CUTSCENE_PLAYING() || CUTSCENE::GET_CUTSCENE_TIME() > CUTSCENE::GET_CUTSCENE_END_TIME() - 800){
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_24))if(!func_65(uParam0->f_24, 0, false, false, false, false, true, false, true)) func_64(uParam0->f_24);
func_68(uParam0, 4);
}
return;
}
...
if(!STREAMING::HAS_MODEL_LOADED(func_72())) return false;
...
var func__73(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1A5B{
...
if(func_133(ENTITY::GET_ENTITY_MODEL(veParam0)))if(uParam1->f_9[44]==2) VEHICLE::SET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(veParam0, false, true);
...
if(func_132(uParam1->f_66, &num) && uParam1->f_80 !=num) uParam1->f_80=num;
...
if(func_131(veParam0)) func_125(veParam0, func_128(uParam1->f_74, uParam1->f_75, uParam1->f_76));
if(VEHICLE::GET_VEHICLE_LIVERY2_COUNT(veParam0) > 1 && uParam1->f_98 >=0) VEHICLE::SET_VEHICLE_LIVERY2(veParam0, uParam1->f_98);
if(IS_BIT_SET(uParam1->f_95, 0)) func_96(veParam0, &(uParam1->f_81));
if(!func_87(4) && !bParam4 && !NETWORK::NETWORK_IS_ACTIVITY_SESSION()) func_84(veParam0);
...
i < 60;
i=i + 1){
if(func_94(i)==iParam0)if(func_88(i)) return true;
}}
return false;
}
...
elseif(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(func_93()==0) return IS_BIT_SET(_MPCHAR_STAT_GET_INT(func_92(iParam0), -1, 0), iParam1);
...
if(!func_106(veParam0, panParam1)) return 1;
...
if(ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(GRAPHICS::DOES_VEHICLE_HAVE_CREW_EMBLEM(veParam0, 0) || func_105(veParam0)) return true;
return false;
}
...
if(func_112(plParam0)==233) return func_110(plParam0);
return -1;
}

int func_110(Player plParam0) // Position - 0x8B44{
if(func_111(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_182;
return -1;
}
...
if(func_111(plParam0, false)) return Global_1894573[plParam0 /*608*/].f_10.f_33;
return -1;
}
...
if(!bParam1)if(func_116(plParam0, iParam2)) return 0;
...
if(plParam0 !=_INVALID_PLAYER_INDEX())if(func_123(plParam0) && Global_2657589[plParam0 /*466*/].f_321.f_10==plParam0) return true;
return false;
}
BOOL func_123(Player plParam0) // Position - 0x8D85{
if(plParam0 !=_INVALID_PLAYER_INDEX())if(_NETWORK_IS_PLAYER_VALID(plParam0, true, true))if(Global_2657589[plParam0 /*466*/].f_321.f_7 !=-1) return func_124(Global_2657589[plParam0 /*466*/].f_321.f_7)==22;
return false;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_129() && Global_1576216)if(iParam0==Global_1576217 && iParam1==Global_1576218 && iParam2==Global_1576219) return 13;
return 0;
}
...
if(uParam1->f_69 > -1 && uParam1->f_69 < 255)if(!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))if(uParam1->f_69==6) func_149(veParam0, uParam1->f_69);
else func_149(veParam0, uParam1->f_69);
...
if(bParam3) func_141(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
if(!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66)){
for (n=0;
n <=11;
n=n + 1){
if(IS_BIT_SET(uParam1->f_77, func_155(n + 1)))if(!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, n + 1)) VEHICLE::SET_VEHICLE_EXTRA(veParam0, n + 1, false);
...
if(func_135() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")))if(!IS_BIT_SET(uParam1->f_77, 23))if(IS_BIT_SET(uParam1->f_77, 22)) VEHICLE::CONTROL_LANDING_GEAR(veParam0, 2);
...
if(func_139(7))if(func_137(Global_2672505.f_4.f_16) || func_136(Global_2672505.f_4.f_16)) return false;
return true;
}
...
int num;
num=iParam0;
if(num !=-1) return func_138(iParam0, 9);
return false;
}
...
}elseif(func_147(*uParam0, modType, uParam1->[i] - 1)){
}else{
VEHICLE::SET_VEHICLE_MOD(*uParam0, modType, uParam1->[i] - 1, false);
}}}}
if(func_146(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) !=func_144(*uParam0, uParam1->[38] - 1)) VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_144(*uParam0, uParam1->[38] - 1), false);
func_143(uParam0);
if(func_142(*uParam0)){
...
i >=0 && func_147(veParam0, iParam1, i);
i=i - 1){}
return i;
}
...
if(!func_148() && PED::APPLY_PED_BLOOD_SPECIFIC(veParam0, iParam1, iParam2)) return true;
return false;
}
...
if(!func_148() && func_154(uParam0)) return 1;
return 0;
}
...
if(func_109(PLAYER::PLAYER_ID())==3)if(ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))if(func_108(veParam0) !=-1) return true;
return false;
}
...
if(func_274(PLAYER::PLAYER_ID(), false, false)) return;
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
if(!func_161(uParam0)) return;
if(!func_71(uParam0)) return;
if(!uParam0->f_15)if(!STREAMING::NEW_LOAD_SCENE_START(uParam0->f_9, func_160(uParam0->f_12), 4000f, 0)) return;
else uParam0->f_15=1;
...
Vector3 func__160(float fParam0, var uParam1, var uParam2) // Position - 0xB009{
...
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(func_273())) return false;
player=func_268();
...
i < 127;
i=i + 1){
if(IS_BIT_SET(uParam1->[i / 32], i % 32))if(func_171(&unk, i, characterType, pedParam0, -1))if(func_164(pedParam0, &unk, i, unk.f_4, unk.f_8, flag, flag2, bParam2, flag3)) STATS::GET_PACKED_TU_INT_STAT_KEY(pedParam0, unk.f_4, unk.f_5);
}
...
if(func_165(13, -1)){
return false;
}elseif(func_165(14, -1)){
return false;
}elseif(func_165(15, -1)){
return false;
}elseif(func_165(16, -1)){
return false;
}elseif(func_165(71, -1)){
return false;
}elseif(func_165(72, -1)){
}
...
break;
case joaat("crewLogo"):
if(bParam8)if(entityModel==joaat("MP_M_Freemode_01"))if(Global_4540628==-1)if(!Global_100733.f_1570)if(func_165(15, -1)) return false;
...
if(stat==14192)if(func_93()==2 && func_167()==2) return 0;
else return 0;
...
if(func_93()==2 && func_167()==2) return 14192;
return 14192;
}
...
num=400;
if(_IS_EXCLUSIVE_CONTENT_UNLOCKED() && func_174() || func_173()) num=0;
...
if(iParam2==3 || iParam2==4 && iParam1 >=129) func_172(sParam0, iParam2, iParam1, 129);
...
i <=53;
i=i + 1){
if(func_193(pedParam0, iParam1, i)) return i;
}}elseif(iParam1==13){
for (j=0;
j <=19;
j=j + 1){
if(func_193(pedParam0, iParam1, j)) return j;
}
return 31;
}elseif(iParam1==14){
...
if(pedPropIndex==-1) return func_192(epctParam1);
...
if(iParam1==-1) return func_192(epctParam3);
entityModel=ENTITY::GET_ENTITY_MODEL(pedParam0);
hashNameForProp=FILES::GET_HASH_NAME_FOR_PROP(pedParam0, epctParam3, iParam1, iParam2);
if(hashNameForProp !=-1 && hashNameForProp !=0)if(entityModel==joaat("MP_M_Freemode_01")) return func_190(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 3);
elseif(entityModel==joaat("MP_F_Freemode_01")) return func_190(ENTITY::GET_ENTITY_MODEL(pedParam0), hashNameForProp, 14, 4);
...
if(unk.f_1==hParam1) return func_191(hParam0) + i;
}}elseif(iParam2==13){}elseif(iParam2==14){
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, true, -1, -1);
shopPedQueryPropIndex=FILES::GET_SHOP_PED_QUERY_PROP_INDEX(hParam1);
if(shopPedQueryPropIndex !=-1) return func_183(hParam0) + shopPedQueryPropIndex;
}else{
...
if(shopPedQueryComponentIndex !=-1) return func_181(hParam0, func_182(iParam2)) + shopPedQueryComponentIndex;
}
return -99;
}
...
entityModel=ENTITY::GET_ENTITY_MODEL(pedParam0);
Global_78341[1 /*14*/]={
func_209(entityModel, iParam1, iParam2, -1) 
};
hash=Global_2883588;
...
Global_78341[2 /*14*/]={
func_209(entityModel, num2, num, -1) 
};
...
l <=8;
l=l + 1){
if(!func_193(pedParam0, 14, unk28[l])) return false;
}
return true;
}elseif(iParam1==14){
...
if(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_182(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_182(iParam1))) return true;
if(iParam1==4){
Global_78340=Global_78340 + 1;
if(Global_78340==1)if(func_196(entityModel, 11, func_185(pedParam0, 11), -1))if(func_195(entityModel, 4, iParam2, &num3)) return func_193(pedParam0, 4, num3);
elseif(func_194(entityModel, 4, iParam2, &num3)) return func_193(pedParam0, 4, num3);
Global_78340=Global_78340 - 1;
}}
return false;
}
...
case 11:
if(iParam2 >=256){
if(hParam3==-1) hParam3=func_180(hParam0, iParam2, 11, 4);
...
if(func_201(hParam0, iParam2, iParam3)) return true;
...
return true;
}elseif(func_199(hParam0, iParam2, iParam3, -1)){
...
return true;
}elseif(func_198(hParam0, iParam2, iParam3, -1)){
if(iParam1==1 || iParam1==2 || iParam1==4 || iParam1==5 || iParam1==10 || iParam1==11 || iParam1==12 || iParam1==14 || iParam1==18 || iParam1==50) return false;
return true;
...
if(hParam3==-1) hParam3=func_180(hParam0, iParam2, 14, 3);
...
case 1:
if(iParam2 >=26){
if(hParam3==-1) hParam3=func_180(hParam0, iParam2, 1, 3);
...
if(hParam3==-1) hParam3=func_180(hParam0, iParam2, 14, 4);
...
case 1:
if(iParam2 >=26){
if(hParam3==-1) hParam3=func_180(hParam0, iParam2, 1, 4);
...
i < itemHash.f_3;
i=i + 1){
if(FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_1, i, &outPropVariant) && outPropVariant.f_2 !=-1)if(outPropVariant !=0 && outPropVariant !=-1 && outPropVariant !=joaat("0")) uParam0->[outPropVariant.f_2]=func_190(hParam1, outPropVariant, 14, num);
...
switch (iParam1){
case 0:
if(Global_113648.f_9087.f_99.f_58[120]) func_208(&unk, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
else func_208(&unk, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
break;
case 1:
...
func_255();
if(hParam0==joaat("MP_M_Freemode_01")) func_239(iParam1, iParam2, hParam3);
elseif(hParam0==joaat("MP_F_Freemode_01")) func_210(iParam1, iParam2, hParam3);
...
if(iParam1==12){
if(!func_217(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_217(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
}elseif(iParam1==13){
}elseif(iParam1==14){
if(!func_217(Global_2883588, 1, true, true, -1)) MISC::CLEAR_BIT(&(iParam0->f_6), 2);
if(!func_217(Global_2883588, 2, true, true, -1)) MISC::SET_BIT(&(iParam0->f_6), 4);
...
if(func_216(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 1);
if(func_216(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 2);
if(!func_216(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0)) MISC::SET_BIT(&(iParam0->f_6), 4);
}else{
MISC::SET_BIT(&(iParam0->f_6), 0);
...
int num;
int num2;
if(func_236(iParam0)==14192) return false;
...
if(num !=-1 && num < 4)if(func_257(num) !=-1 && func_257(num) !=0) return 1;
}
...
if(func_258(true)) return Global_1665818;
if(iParam0 <=-1 || iParam0 >=4) return -1;
return Global_2684799.f_6316[iParam0];
}
BOOL func_258(BOOL bParam0) // Position - 0x322C2{
if(func_262(bParam0) || func_260() || func_259(*Global_4718592.f_166301)) return true;
return false;
}
...
if(bParam0) return IS_BIT_SET(*Global_4718592.f_160050, 12) && func_263();
...
elseif(func_114(PLAYER::PLAYER_ID(), true) && Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10.f_76.f_21 !=0){
return 1;
}}
break;
default:
...
if(func_234(89, -1)) return 89;
}elseif(iParam2==17){
return 88;
}elseif(iParam2==28){
if(func_234(87, -1)) return 87;
}elseif(iParam2==41){
return 86;
}elseif(iParam2 >=237){
...
if(componentType==10)if(nameHash !=0 && nameHash !=joaat("0")) return func_266(nameHash, 3);
...
if(componentType2==10)if(nameHash2 !=0 && nameHash2 !=joaat("0")) return func_266(nameHash2, 3);
...
if(componentType3==10)if(nameHash3 !=0 && nameHash3 !=joaat("0")) return func_266(nameHash3, 4);
...
if(componentType4==10)if(nameHash4 !=0 && nameHash4 !=joaat("0")) return func_266(nameHash4, 4);
...
if(func_270(true)) player=_GET_BOSS_OF_LOCAL_PLAYER();
return player;
}
...
if(func_270(true)) playerPed=PLAYER::GET_PLAYER_PED(_GET_BOSS_OF_LOCAL_PLAYER());
return playerPed;
}
...
if(func_288()) return true;
if(Global_2696915) return true;
if(func_287()) return true;
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_285()) return true;
...
func_291();
if(PED::GET_PED_PROP_INDEX(PLAYER::PLAYER_PED_ID(), PV_COMP_HEAD, 1)==19) PED::CLEAR_PED_PROP(PLAYER::PLAYER_PED_ID(), 0, 1);
}
return;
}
...
switch (ENTITY::GET_ENTITY_MODEL(pedParam0)){
case joaat("MP_M_Freemode_01"):
if(pedDrawableVariation >=1 && pedDrawableVariation <=19 || pedDrawableVariation >=21 && pedDrawableVariation <=29) return 1;
...
if(FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hashNameForComponent, joaat("PARACHUTE"), 0)) return 1;
break;
case joaat("MP_F_Freemode_01"):
if(pedDrawableVariation >=1 && pedDrawableVariation <=19 || pedDrawableVariation >=21 && pedDrawableVariation <=29) return 1;
hashNameForComponent=FILES::GET_HASH_NAME_FOR_COMPONENT(pedParam0, 5, pedDrawableVariation, PED::GET_PED_TEXTURE_VARIATION(pedParam0, PV_COMP_HAND));
