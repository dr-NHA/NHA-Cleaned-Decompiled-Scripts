...
func_121();
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19)) func_116(0);
if(func_113(func_115(SCRIPT::GET_THIS_SCRIPT_NAME()))) func_116(0);
if(!func_112()) func_116(0);
if(!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) func_116(0);
if(func_111()) func_116(0);
if(func_110()) func_116(0);
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_109()) func_116(0);
if(MISC::GET_GAME_TIMER() < Global_32428 + 10000 && !func_109()) func_116(0);
...
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_116(1);
num6=func_99(PLAYER::PLAYER_PED_ID(), pedLocal_240);
if(num6 < 10f && func_98()) PED::SET_IK_TARGET(pedLocal_240, 1, PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
...
if(func_87(pedLocal_240, PLAYER::PLAYER_PED_ID(), true) < 25f)if(!HUD::DOES_BLIP_EXIST(blLocal_248)) func_83(&blLocal_248, &pedLocal_240, false);
elseif(HUD::DOES_BLIP_EXIST(blLocal_248)) func_82(&blLocal_248);
if(!bLocal_439){
...
if(func_80(num7))if(!func_79(num7)) func_71(hashKey, false);
}}}
switch (iLocal_250){
case 0:
...
if(func_64() && !flag3 && !func_63()) iLocal_250=3;
if(!func_66()) func_104(0, true);
break;
case 5:
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(pedLocal_240, &uLocal_372, &uLocal_356, 3)) func_56(Global_113593[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(pedLocal_240, &uLocal_372, &uLocal_356));
}
break;
case 9:
...
if(num6 > 10f && _CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_17();
iLocal_250=16;
}else{
if(!bLocal_438){
func_31(&uLocal_404);
...
if(func_80(num8))if(!func_79(num8)) func_71(MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()), false);
...
if(HUD::DOES_BLIP_EXIST(blLocal_248)) func_82(&blLocal_248);
flag7=false;
while (true){
...
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_240)){
if(!bLocal_441) func_100(func_115(SCRIPT::GET_THIS_SCRIPT_NAME()));
func_116(0);
}
...
if(ENTITY::IS_ENTITY_OCCLUDED(pedLocal_240) && func_87(pedLocal_240, PLAYER::PLAYER_PED_ID(), true) > 50f && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_116(1);
SYSTEM::WAIT(0);
}
return;
}
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_448)) ENTITY::DETACH_ENTITY(obLocal_448, true, true);
return;
}
...
eCharacter character;
character=_GET_CURRENT_PLAYER_CHARACTER();
if(character==CHAR_TREVOR) TEXT_LABEL_ASSIGN_STRING(sParam0, "How_You_Doin", 64);
elseif(character==CHAR_MICHAEL)if(uLocal_299[0]==2) TEXT_LABEL_ASSIGN_STRING(sParam0, "Hey_How_You_Doing2", 64);
else TEXT_LABEL_ASSIGN_STRING(sParam0, "Hey_How_You_Doing", 64);
elseif(character==CHAR_FRANKLIN) TEXT_LABEL_ASSIGN_STRING(sParam0, "Sup_Homie_Hows_Everything", 64);
return;
}
...
int num;
num=func_81(hParam0);
if(func_80(num)) func_72(num, bParam1);
return;
}
...
if(!func_14(70)) func_73("DI_HLP_SPCL" /*Unique characters become available in Rockstar Editor's 'Director Mode' as you meet them around Los Santos.*/, 2, 0, 20000, 10000, 7, 0, 210, 0);
}}}}
return;
}
...
if(func_80(iParam0)) return IS_BIT_SET(Global_113648.f_26436.f_2, iParam0);
return false;
}
...
var func__86(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2E29{
...
float num;
unk={
func_90(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_90(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__90(float fParam0, var uParam1, var uParam2) // Position - 0x2F50{
float num;
float num2;
...
if(func_80(num)) func_72(func_101(iParam0), false);
return;
}
...
i=i + 1){
num=i;
if(func_102(num, true)==iParam0) return num;
}
return -1;
}
...
, 4);
if(MISC::ARE_STRINGS_EQUAL(&string1, &uLocal_499)) func_17();
...
if(iLocal_298 !=-1) _CONTEXT_REMOVE_HELP_TEXT(&iLocal_298);
if(HUD::DOES_BLIP_EXIST(blLocal_248)) func_117(&blLocal_248);
func_93();
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) AUDIO::DISABLE_PED_PAIN_AUDIO(PLAYER::PLAYER_PED_ID(), false);
