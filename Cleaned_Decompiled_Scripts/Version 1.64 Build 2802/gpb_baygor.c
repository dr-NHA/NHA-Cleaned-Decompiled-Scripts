...
iLocal_241=1;
if(ENTITY::DOES_ENTITY_EXIST(uLocal_240) && func_105(uLocal_240)){
...
fVar43=func_99(PLAYER::PLAYER_PED_ID(), uLocal_240);
...
Var76={
ENTITY::GET_ENTITY_COORDS(uLocal_240, 1) 
};
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uLocal_240, "GENERIC_CURSE_MED", "SPEECH_PARAMS_FORCE", 1);
}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_240)) && fVar43 < 25f) && func_91(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")) && func_88(uLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
if(!func_92()){
func_94();
TASK::TASK_PLAY_ANIM(uLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_250=24;
...
if(func_87(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 25f){
if(!HUD::DOES_BLIP_EXIST(uLocal_248)){
func_83(&uLocal_248, &uLocal_240, 0);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_248)){
func_82(&uLocal_248);
}
if(!bLocal_439){
...
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_240, joaat("script_task_follow_nav_mesh_to_coord")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_240, joaat("script_task_follow_nav_mesh_to_coord")) !=0){
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_240, 0, 0);
func_121();
iLocal_250=0;
}
break;
...
if(func_87(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < fVar40){
if(func_62()==1){
iLocal_250=8;
iLocal_440=0;
}}
...
func_56(Global_113593[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_240, &Local_372, &Local_356));
}}
break;
case 9:
...
func_53(&uLocal_37, 3, uLocal_240, &Local_236, 0, 1);
func_52(&cVar5);
...
if(bLocal_437){
iVar35=1;
}elseif(func_37(&uLocal_37, &cLocal_304, &cVar9, 3, 0, 0, 0)){
iVar35=1;
}
if(iVar35==1){
iLocal_250=11;
...
if(((((((((((((iLocal_250==0 || iLocal_250==1) || iLocal_250==3) || iLocal_250==8) || iLocal_250==9) || iLocal_250==7) && func_87(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436==1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30==0) && bLocal_439==1) && !Global_3) && func_7()) && bVar81){
if(iLocal_298==-1){
...
if((ENTITY::IS_ENTITY_OCCLUDED(uLocal_240) && func_87(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_116(1);
}
SYSTEM::WAIT(0);
}}
...
void func_8(){
func_9();
if(func_105(uLocal_240) && func_105(PLAYER::PLAYER_PED_ID())){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_240, 0);
...
void func_9(){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_448)){
ENTITY::DETACH_ENTITY(uLocal_448, 1, 1);
}}
...
int func_66(){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_240, joaat("script_task_play_anim")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_240, joaat("script_task_play_anim")) !=0){
return 0;
}
return 1;
}
...
var func__84(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
float fVar6;
Var0={
func_90(ENTITY::GET_ENTITY_COORDS(uParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
Var3={
func_90(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__90(struct<3> Param0){
float fVar0;
float fVar1;
...
void func_107(){
uLocal_448=OBJECT::CREATE_OBJECT(joaat("prop_cs_pamphlet_01"), ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_448, uLocal_240, PED::GET_PED_BONE_INDEX(uLocal_240, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
PED::SET_PED_PROP_INDEX(uLocal_240, 1, 0, 0, 0, 1);
}
...
void func_120(){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_448)){
OBJECT::DELETE_OBJECT(&uLocal_448);
}}
