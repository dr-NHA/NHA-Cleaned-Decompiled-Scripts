...
if(num==17){
iLocal_97=PED::ADD_SCENARIO_BLOCKING_AREA(vector -{
40f, 40f, 40f 
}
, vector +{
40f, 40f, 40f 
...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_277(&num, true);
func_209(num);
...
func_201(&num);
if(AUDIO::HAS_SOUND_FINISHED(iLocal_96)) func_196(&num, vector, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && _DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]) && !AUDIO::IS_ANY_SPEECH_PLAYING(num.f_28[0]) && AUDIO::HAS_SOUND_FINISHED(iLocal_96) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1)) AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_96, "DOM_BREATHING", num.f_28[0], "EXTREME_03_SOUNDSET", false, 0);
...
if(func_175(num)) func_172(num, &blLocal_98);
if(!func_2(&num)) func_277(&num, true);
elseif(num==19) AUDIO::STOP_SOUND(iLocal_96);
if(func_1(&num)) func_277(&num, false);
}}
return;
}
...
if(func_161(*panParam0)) func_150();
...
var func__15(Hash hParam0) // Position - 0xD4D{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6B62{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x72B2{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x763E{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x777D{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x84FE{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D00{
...
if(func_159(0)) func_156(iParam0);
...
if(iParam4 !=0) func_165(iParam0, iParam4);
}
return 2;
}
...
case 12:
case 13:
if(iParam0==11) *uParam1=func_173(1835.53f, 4705.86f, 38.1f, false);
elseif(iParam0==12) *uParam1=func_173(1826.13f, 4698.88f, 38.92f, false);
else *uParam1=func_173(637.02f, 119.7093f, 89.5f, false);
HUD::SET_BLIP_SPRITE(*uParam1, BLIP_EPSILON);
HUD::SET_BLIP_COLOUR(*uParam1, 42);
break;
case 18:
case 19:
if(iParam0==18) *uParam1=func_173(-954.19f, -2760.05f, 14.64f, false);
else *uParam1=func_173(-63.8f, -809.5f, 321.8f, false);
HUD::SET_BLIP_SPRITE(*uParam1, BLIP_DOM);
HUD::SET_BLIP_COLOUR(*uParam1, 43);
break;
case 21:
case 23:
if(iParam0==21) *uParam1=func_173(-1877.82f, -440.649f, 45.05f, false);
else *uParam1=func_173(-915.6f, 6139.2f, 5.5f, false);
...
case 47:
case 48:
if(iParam0==47) *uParam1=func_173(-70.71f, 301.43f, 106.79f, false);
else *uParam1=func_173(-257.22f, 292.85f, 90.63f, false);
...
var func__174(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC141{
if(bParam0) return uParam1;
return uParam2;
}
...
return 1;
}elseif(!func_177(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_152(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, false, true, false)){
...
func_290("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_182(uParam0->f_27)){
func_181(uParam0->f_27, *uParam0);
func_290("RC5_IN_ACTIVATION_RANGE:
...
if(func_182(true)){
func_181(1, *uParam0);
func_290("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_290("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0])) CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Dom", uParam0->f_28[0], 0);
return;
}
...
if(Global_43257==17){
if(*uParam0 !=-1) func_207(uParam0);
}elseif(func_206()){
if(*uParam0 !=-1) func_207(uParam0);
}elseif(*uParam0==-1){
if(func_200(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_205(uParam0, 1);
}else{
...
if(func_200(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_207(uParam0);
}}}
return;
}
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_203(*uParam0, false);
...
var unk;
if(Global_78558){
func_290("IS_RC_FINE_AND_IN_RANGE():
The game is running Multiplayer [TERMINATING]");
return false;
}
func_115(*panParam0, &unk);
if(func_247(*panParam0) || func_245(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_290("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_240(panParam0->f_28[0]);
func_290("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_220(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_220(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_217(panParam0);
else func_215(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(func_214(&(panParam0->f_48)) && bParam1) func_211(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
if(func_213(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_213(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_212(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(iParam2==0) func_215(uParam0);
else func_217(uParam0);
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_148();
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_223(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_231(&iLocal_37[num /*4*/]);
return false;
}
if(!func_228(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_227();
if(num==-1) return false;
...
Vector3 func__226(Ped pedParam0, int iParam1) // Position - 0xEB4E{
...
float num;
unk={
func_230(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_230(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__230(float fParam0, var uParam1, var uParam2) // Position - 0xED0F{
float num;
float num2;
...
if(!bParam2){
if(func_238(pedParam0, bParam1, radius, num)) return true;
if(func_235(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_236(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_236(pedParam0, fParam1)) return true;
...
float num;
unk={
func_230(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_247(iParam0)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(4)){
if(func_245(iParam0)){
}else{
return true;
}}
if(func_244() && !func_243()) return true;
if(!func_242(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_246() && Global_100681.f_11==6 && iParam0==func_170(&(Global_100681.f_3), 0)) return true;
return false;
}
...
switch (*uParam0){
case 17:
if(!func_263(uParam0)) return false;
break;
case 18:
if(!func_260(uParam0)) return false;
break;
case 19:
...
break;
case 1:
if(!func_254(&num) || !func_253(&(uParam0->f_48))) return false;
iLocal_91=2;
break;
case 2:
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-63.191788f, -808.91675f, 320.24774f 
};
uParam0->f_17[1 /*3*/]={
-68.8908f, -813.6761f, 324.29004f 
};
uParam0->f_24=10f;
uParam0->f_27=0;
uParam0->f_25=1;
...
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())) TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, SLF_WIDEST_YAW_LIMIT | 32, 2);
}else{
flag=false;
}}
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
...
if(func_244() && !func_243()) return false;
if(func_272(iParam0)) return false;
if(iParam0==-1) iParam0=func_169();
if(iParam0==-1) return false;
if(!func_247(iParam0)){
if(!func_271(iParam0)) return false;
if(!func_270(iParam0)) return false;
if(func_269(iParam0)) return false;
}
if(iParam0==58)if(func_267(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
if(func_242(iParam0)) return false;
...
int i;
if(*uParam0==1){
if(func_275(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
if(*uParam0==18){
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0])) VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_35[0], 1);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[1])) VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_35[1], 1);
}
if(bParam1){
func_290("SCRIPT TERMINATING:
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_216(&uParam0->[i]);
else func_282(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_252(&uParam0->[i]);
else func_288(&uParam0->[i], false, 1, 0);
}
return;
}
