...
if(Var0.f_0==17){
uLocal_97=PED::ADD_SCENARIO_BLOCKING_AREA(Var61 - Vector(40f, 40f, 40f), Var61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
}elseif(Var0.f_0==18){
uLocal_97=PED::ADD_SCENARIO_BLOCKING_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
}
...
func_201(&Var0);
if(AUDIO::HAS_SOUND_FINISHED(uLocal_96)){
func_196(&Var0, Var61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
}
if((((((!func_195() && func_194(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_96)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1)){
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
}
if((iLocal_95==0 && func_194(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0)){
Var69={
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_152(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
var func__173(struct<3> Param0, int iParam3){
var uVar0;
...
return 1;
}elseif((!func_177(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle")) && func_194(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && func_152(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 3f, 1, 1056964608, 0, 1, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}
return 0;
}
...
return 0;
}}elseif(func_194(uParam0->f_28[0])){
if(func_180(uParam0)){
if(func_184(2)){
if(func_182(uParam0->f_27)){
func_181(uParam0->f_27, *uParam0);
...
if(*uParam0==6){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_194(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
...
uParam1->f_3=5;
}elseif((func_213(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
Vector3 func__226(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_230(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var3={
func_230(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__230(struct<3> Param0){
float fVar0;
float fVar1;
...
if(func_194(PLAYER::PLAYER_PED_ID()) && func_194(uParam0)){
...
float fVar6;
Var0={
func_230(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-63.19179f, -808.9167f, 320.2477f 
};
uParam0->f_17[1 /*3*/]={
-68.8908f, -813.6761f, 324.29f 
};
uParam0->f_24=10f;
uParam0->f_27=0;
uParam0->f_25=1;
...
if(*iParam0==17){
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_97, 0);
