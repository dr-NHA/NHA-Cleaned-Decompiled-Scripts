...
Local_229[1 /*3*/]={
1286.655f, -1627f, 53.225f 
};
fLocal_239[1]=22.3073f;
Local_229[2 /*3*/]={
1286.452f, -1624.782f, 53.225f 
};
fLocal_239[2]=49.6773f;
Var14={
1298.391f, -1580.895f, 50.7937f 
};
fVar17=332.006f;
Local_243={
1277.725f, -1617.897f, 53.2254f 
};
if(func_164()){
...
case 4:
iVar23=0;
PED::ADD_SCENARIO_BLOCKING_AREA(Local_243 - Vector(10f, 30f, 30f), Local_243 + Vector(10f, 30f, 30f), 0, 1, 1, 1);
PED::SET_PED_NON_CREATION_AREA(Local_243 - Vector(50f, 50f, 50f), Local_243 + Vector(100f, 100f, 100f));
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_243 - Vector(15f, 15f, 15f), Local_243 + Vector(15f, 15f, 15f), 0, 1);
MISC::SET_BIT(&uVar8, 4);
MISC::SET_BIT(&uVar8, 1);
MISC::SET_BIT(&uVar8, 5);
PED::ADD_RELATIONSHIP_GROUP("GangOne", &uLocal_49);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_49, joaat("player"));
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iVar22, uLocal_49);
...
iVar18[iVar24]=PED::CREATE_PED(12, Var1[iVar24], Local_229[iVar24 /*3*/], fLocal_239[iVar24], 1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(iVar18[iVar24], func_86(), -1, 1, 1);
...
TASK::TASK_SYNCHRONIZED_SCENE(iVar18[0], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED(iVar18[1])){
TASK::TASK_SYNCHRONIZED_SCENE(iVar18[1], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED(iVar18[2])){
TASK::TASK_SYNCHRONIZED_SCENE(iVar18[2], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
}
...
if((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_257, 9f, 9f, 9f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, 0, 1, 0)) || TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())){
*iParam0=6;
}}}
switch (*iParam0){
case 0:
...
*iParam0=9;
}}elseif(PED::IS_PED_RAGDOLL(iParam7)){
...
break;
case 2:
GRAPHICS::DRAW_DEBUG_LINE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_243, 0, 0, 255, 255);
TASK::TASK_PAUSE(PLAYER::PLAYER_PED_ID(), 1000);
Local_257={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
if(!PED::IS_PED_INJURED((*iParam8)[1])){
if(!HUD::DOES_BLIP_EXIST(uLocal_220[1])){
}
...
TASK::TASK_SYNCHRONIZED_SCENE((*iParam8)[0], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED((*iParam8)[1])){
TASK::TASK_SYNCHRONIZED_SCENE((*iParam8)[1], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED((*iParam8)[2])){
TASK::TASK_SYNCHRONIZED_SCENE((*iParam8)[2], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
}
*iParam0=3;
}
break;
...
TASK::OPEN_SEQUENCE_TASK(&iLocal_50);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(0f, 0f, 1f), PLAYER::PLAYER_PED_ID(), 2f, 0, 3.5f, 5f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
...
}elseif(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
*iParam0=6;
}
break;
case 6:
...
if(TASK::GET_SCRIPT_TASK_STATUS(iParam6, joaat("script_task_perform_sequence"))==7 || ENTITY::IS_ENTITY_AT_ENTITY(iParam6, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0)){
if(!func_75()){
...
TASK::TASK_PLAY_ANIM_ADVANCED(0, Param0.f_5, "sit_down_idle_01", Local_229[0 /*3*/], 0f, 0f, fLocal_239[0], 1000f, -4f, -1, 1, 0, 2, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_50);
...
iVar0=0;
while (iVar0 <=(*uParam0 - 1)){
if(!HUD::DOES_BLIP_EXIST(uLocal_220[iVar0])){
if(!PED::IS_PED_INJURED((*uParam0)[iVar0])){
...
var func__38(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_225, 0);
}
...
TASK::CLEAR_SEQUENCE_TASK(&iLocal_50);
if(HUD::DOES_BLIP_EXIST(uLocal_225)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_225, 1);
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1273.098f, -1604.172f, 53.1535f, 1276.568f, -1615.127f, 56.7879f, 10f, 0, 1, 0) && !func_63()){
iLocal_255=3;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1298.546f, -1617.742f, 53.2254f, 1262.868f, -1629.36f, 64.2894f, 30.4375f, 0, 1, 0)){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_243, 13f, 0, 0, 0, 0, 0, 0, 0);
TASK::CLEAR_PED_SECONDARY_TASK(iParam0);
if(!PED::IS_PED_INJURED(iParam0)){
TASK::OPEN_SEQUENCE_TASK(&iLocal_50);
...
if(SYSTEM::TIMERA() > 8000 && ENTITY::IS_ENTITY_AT_COORD(iParam0, Local_243, 3f, 3f, 3f, 0, 1, 0)){
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_112695) || Global_32166) || func_99()) || func_58(8, -1)) || func_98()) || func_97()) || func_96()) || func_95()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_100()) || Global_32166) || func_99()) || func_58(8, -1)) || func_96()) || func_98()) || func_97()) || func_95()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_112695) || Global_32166) || func_99()) || func_58(8, -1)) || func_98()) || func_97()) || func_95()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_100()) || Global_32166) || func_99()) || func_58(8, -1)) || func_97()) || func_96()) || func_95()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_100()) || func_97()) || Global_112695) || Global_32166) || func_99()) || Global_44446) || func_58(8, -1)) || func_96()) || func_94()) || func_95()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_100()) || Global_112695) || Global_32166) || func_99()) || func_58(8, -1)) || func_96()) || func_94()) || func_98()) || func_97()) || func_95()){
return 0;
}
break;
}}else{
...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_46) < (75f * 75f)){
return 1;
}
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_243 - Vector(10f, 10f, 10f), Local_243 + Vector(10f, 10f, 10f), 1, 1);
