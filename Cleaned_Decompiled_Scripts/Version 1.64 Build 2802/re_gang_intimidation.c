...
uLocal_229[0 /*3*/]={
1283.85f, -1622.501f, 53.2255f 
};
uLocal_239[0]=198.9926f;
uLocal_229[1 /*3*/]={
1286.6545f, -1627f, 53.225f 
};
uLocal_239[1]=22.3073f;
uLocal_229[2 /*3*/]={
1286.4518f, -1624.7819f, 53.225f 
};
uLocal_239[2]=49.6773f;
vector={
1298.3907f, -1580.895f, 50.7937f 
};
heading=332.006f;
uLocal_243={
1277.7249f, -1617.8971f, 53.2254f 
};
num4=3;
if(_GET_RANDOM_BOOL()){
...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)) func_152(unk, num3, &num4, ped);
if(func_119(uLocal_226, -1, 0, false, false)) func_116(-1);
...
case 4:
num5=0;
PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_243 -{
10f, 30f, 30f 
}
, uLocal_243 +{
10f, 30f, 30f 
...
PED::SET_PED_NON_CREATION_AREA(uLocal_243 -{
50f, 50f, 50f 
}
, uLocal_243 +{
100f, 100f, 100f 
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_243 -{
15f, 15f, 15f 
}
, uLocal_243 +{
15f, 15f, 15f 
...
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_55, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_55, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) _CONVERSATION_INITIALIZE_ACTOR(&uLocal_55, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
if(!PED::IS_PED_INJURED(num4[0])) TASK::TASK_SYNCHRONIZED_SCENE(num4[0], iLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
if(!PED::IS_PED_INJURED(num4[1])) TASK::TASK_SYNCHRONIZED_SCENE(num4[1], iLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
if(!PED::IS_PED_INJURED(num4[2])) TASK::TASK_SYNCHRONIZED_SCENE(num4[2], iLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
...
if(num2 < 3){
if(func_79(&num4, &unk9, &unk8, &unk7, address, flag, 1075838976, 0) || func_78(num4[0], 0) || func_78(num4[1], 0) || func_78(num4[2], 0) || MISC::IS_BULLET_IN_AREA(uLocal_229[0 /*3*/], 40f, true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(uLocal_229[0 /*3*/] -{
25f, 25f, 25f 
}
, uLocal_229[0 /*3*/] +{
25f, 25f, 25f 
}
, joaat("WEAPON_SMOKEGRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(uLocal_229[0 /*3*/] -{
25f, 25f, 25f 
}
, uLocal_229[0 /*3*/] +{
25f, 25f, 25f 
}
, joaat("WEAPON_GRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(uLocal_229[0 /*3*/] -{
25f, 25f, 25f 
}
, uLocal_229[0 /*3*/] +{
25f, 25f, 25f 
}
, joaat("WEAPON_GRENADELAUNCHER"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(uLocal_229[0 /*3*/] -{
25f, 25f, 25f 
}
, uLocal_229[0 /*3*/] +{
25f, 25f, 25f 
}
, joaat("WEAPON_STICKYBOMB"), true)){
for (j=0;
j < num4;
j=j + 1){
...
if(bLocal_247) num=6;
if(bLocal_54)if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) num2=6;
...
int i;
if(*uParam0 >=3)if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_53))if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_257, 9f, 9f, 9f, false, true, 0) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, false, true, 0) || TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) *uParam0=6;
switch (*uParam0){
case 0:
if(func_60(pedParam7, uParam8)){
if(bLocal_256) *uParam0=2;
...
if(PED::IS_PED_INJURED(uParam8->[0]) || PED::IS_PED_INJURED(uParam8->[1]) || PED::IS_PED_INJURED(uParam8->[2])) func_42(uParam8, pedParam7);
if(PED::IS_PED_INJURED(pedParam7))if(iLocal_255 > 2) func_42(uParam8, pedParam7);
else *uParam0=9;
elseif(PED::IS_PED_RAGDOLL(pedParam7))if(ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 3)) TASK::STOP_ANIM_TASK(pedParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", -1056964608);
}else{
*uParam0=9;
}
break;
...
if(!PED::IS_PED_INJURED(uParam8->[0])) TASK::TASK_SYNCHRONIZED_SCENE(uParam8->[0], iLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
if(!PED::IS_PED_INJURED(uParam8->[1])) TASK::TASK_SYNCHRONIZED_SCENE(uParam8->[1], iLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
if(!PED::IS_PED_INJURED(uParam8->[2])) TASK::TASK_SYNCHRONIZED_SCENE(uParam8->[2], iLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
*uParam0=3;
}
break;
case 3:
...
TASK::OPEN_SEQUENCE_TASK(&iLocal_50);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) -{
0f, 0f, 1f 
}
, PLAYER::PLAYER_PED_ID(), 2f, false, 3.5f, 5f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
...
break;
case 4:
if(func_35(uParam1, uParam8->[2], uParam8)) func_41(uLocal_220[2]);
elseif(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) *uParam0=6;
break;
case 6:
if(!bLocal_250){
func_76();
...
if(func_32(uParam8)){
*uParam10=1;
if(!PED::IS_PED_INJURED(pedParam7))if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam7, 8f, 8f, 8f, false, true, 0)) _CONVERSATION_ADD_LINE(&uLocal_55, "REGIAU", "REGIN_SORRY", 4, 0, 0, 0);
...
if(func_14(iParam0)) Global_113648.f_24997.f_2=3;
if(func_13(iParam0, iParam1) !=322) func_7(func_13(iParam0, iParam1), uLocal_46, uLocal_46.f_1);
Global_113636=iParam1;
if(Global_113634==0)if(Global_113637==1 || Global_113637==5 || Global_113637==11 || Global_113637==25) func_6(2);
elseif(Global_113637==26 || Global_113637==8 || Global_113637==17) func_6(7);
else func_6(1);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uParam0->[i]))if(!PED::IS_PED_INJURED(uParam0->[i])) return false;
}
return true;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(PED::IS_PED_INJURED(uParam0->[i])) func_41(uLocal_220[i]);
}
return;
}
...
case 3:
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) _CONVERSATION_ADD_LINE(&uLocal_55, "REGIAU", "REGIN_REALM", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) _CONVERSATION_ADD_LINE(&uLocal_55, "REGIAU", "REGIN_REALF", 4, 0, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) _CONVERSATION_ADD_LINE(&uLocal_55, "REGIAU", "REGIN_REALT", 4, 0, 0, 0);
iLocal_252=4;
}
break;
case 4:
...
var func__40(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2927{
...
if(func_49(PLAYER::PLAYER_ID())) return false;
...
if(!func_114()) func_64(true);
if(HUD::DOES_BLIP_EXIST(blLocal_224)) func_41(blLocal_224);
...
TASK::CLEAR_SEQUENCE_TASK(&iLocal_50);
if(HUD::DOES_BLIP_EXIST(blLocal_225)) HUD::SHOW_HEIGHT_ON_BLIP(blLocal_225, true);
...
if(!PED::IS_PED_INJURED(uParam1->[2]))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1273.098f, -1604.1722f, 53.1535f, 1276.5682f, -1615.1274f, 56.7879f, 10f, false, true, 0) && !func_63()) iLocal_255=3;
elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1298.5461f, -1617.742f, 53.2254f, 1262.868f, -1629.3601f, 64.2894f, 30.4375f, false, true, 0)) func_62(pedParam0, uParam1);
break;
case 1:
if(!PED::IS_PED_INJURED(uParam1->[2]))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1273.098f, -1604.1722f, 53.1535f, 1276.5682f, -1615.1274f, 56.7879f, 10f, false, true, 0) && !func_63()) iLocal_255=3;
elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1298.5461f, -1617.742f, 53.2254f, 1262.868f, -1629.3601f, 64.2894f, 30.4375f, false, true, 0)) func_62(pedParam0, uParam1);
...
func_61(pedParam0);
iLocal_255=4;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1298.5461f, -1617.742f, 53.2254f, 1262.868f, -1629.3601f, 64.2894f, 30.4375f, false, true, 0)){
...
if(_GET_RANDOM_BOOL()) TASK::TASK_PLAY_ANIM(pedParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_a", 2f, -2f, -1, 48, 0, false, false, false);
else TASK::TASK_PLAY_ANIM(pedParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 0, 0, false, false, false);
_CONVERSATION_ADD_LINE(&uLocal_55, "REGIAU", "REGIN_HERE", 4, 0, 0, 0);
SYSTEM::SETTIMERA(0);
}}
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::CAN_PED_SEE_HATED_PED(pedParam0, PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0)) func_62(pedParam0, uParam1);
}
break;
case 4:
if(!PED::IS_PED_INJURED(pedParam0)){
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))if(PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("rhino"))) return true;
if(PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) return true;
return false;
}
...
if(func_14(Global_113637)) func_65(0);
HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
if(bParam0 && func_14(Global_113637)) HUD::FLASH_MINIMAP_DISPLAY();
return 1;
}
return 0;
}
...
if(iParam4 !=0) func_70(uParam0, iParam4);
}
return 2;
}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0) > (float)iParam3) return true;
return false;
}
...
if(!flag) iLocal_45=MISC::GET_GAME_TIMER();
return false;
}
...
if(randomIntInRange==0) return joaat("WEAPON_COMBATPISTOL");
elseif(randomIntInRange==1) return joaat("WEAPON_COMBATPISTOL");
elseif(randomIntInRange==2) return joaat("WEAPON_PISTOL");
elseif(randomIntInRange==3) return joaat("WEAPON_PISTOL");
else return joaat("WEAPON_PISTOL");
...
if(BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())if(func_91(iParam0)) return true;
return false;
}
...
return true;
case 1:
if(func_21(6) || func_21(7)) return true;
else return func_91(3);
break;
case 2:
return true;
case 3:
if(_CAN_ENTER_FREEROAM_STATE(5))if(func_92(4)) return true;
break;
}
return false;
}
...
if(!func_22(character)) return false;
switch (iParam0){
case 9:
case 0:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_100() || Global_112695 || Global_32166 || func_99() || func_58(8, -1) || func_98() || func_97() || func_96() || func_95() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_100() || Global_32166 || func_99() || func_58(8, -1) || func_96() || func_98() || func_97() || func_95() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
if(!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_100() || Global_112695 || Global_32166 || func_99() || func_58(8, -1) || func_96() || func_98() || func_97() || func_95() || Global_113648.f_7690.f_919[character]==5 || Global_43804 !=-1) return false;
break;
case 3:
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_100() || Global_112695 || Global_32166 || func_99() || func_58(8, -1) || func_98() || func_97() || func_95() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 4:
if(func_100() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_58(8, -1) || func_95() || func_94() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_58(8, -1) || func_98() || func_97() || func_94() || func_93()) return false;
...
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_46) < 75f * 75f) return true;
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_112()) return false;
}
if(func_108()) return true;
if(func_102(100f, true) !=-1) return true;
return false;
}
...
if(func_111() && !func_112()) return true;
if(func_110() && func_109()) return true;
return false;
}
...
if(func_108()) return true;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_112()) return false;
if(func_102(100f, true) !=-1) return true;
return false;
}
BOOL func_114() // Position - 0x6A22{
if(Global_113637==func_29() && MISC::GET_RANDOM_EVENT_FLAG() && Global_113638) return true;
return false;
}
...
if(!STREAMING::HAS_MODEL_LOADED(uParam1.f_4)) return false;
for (i=0;
i <=iLocal_51 - 1;
i=i + 1){
if(!STREAMING::HAS_MODEL_LOADED(uParam1[i])) return false;
}
if(STREAMING::HAS_ANIM_DICT_LOADED("random@gang_intimidation@")) return true;
}else{
for (i=0;
i <=iLocal_51 - 1;
i=i + 1){
...
if(func_108()) return false;
if(func_150()) return false;
if(Global_113637 !=-1) return false;
if(func_22(_GET_CURRENT_PLAYER_CHARACTER()))if(func_102(100f, true) !=-1) return false;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !bParam6)if(entityCoords.f_2 - uLocal_46.f_2 > 50f) return false;
if(!func_149(iParam3)) return false;
if(func_22(_GET_CURRENT_PLAYER_CHARACTER()))if(func_148(_GET_CURRENT_PLAYER_CHARACTER())==4 || func_148(_GET_CURRENT_PLAYER_CHARACTER())==5) return false;
if(func_22(_GET_CURRENT_PLAYER_CHARACTER()))if(!func_147(iParam3, iParam4, 145)) return false;
if(!func_146(Global_113648.f_24997.f_43[iParam3])) return false;
if(MISC::GET_GAME_TIMER() - Global_113639 < 150000)if(iParam3 !=30) return false;
if(func_145()) return false;
if(MISC::GET_MISSION_FLAG()) return false;
if(MISC::GET_RANDOM_EVENT_FLAG()) return false;
if(!func_92(4)) return false;
if(!_CAN_ENTER_FREEROAM_STATE(5)) return false;
if(func_144(iParam3, iParam4) && !bParam5) return false;
...
if(iParam3==9 && iParam4==2 || iParam4==5 && !func_144(0, 0)) return false;
if(Global_32310) return false;
if(func_149(30) && !func_144(30, 0))if(iParam3 !=30)if(SYSTEM::VDIST2(entityCoords, -61.2745f, -1100.4675f, 25.3752f) < 176400f) return false;
if(func_22(_GET_CURRENT_PLAYER_CHARACTER())){
for (i=CHAR_MICHAEL;
i < CHAR_MULTIPLAYER;
i=i + 1){
...
if(func_143(num))if(func_121(i))if(!func_120(vector, 0f, 0f, 0f, false))if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector) < 210f * 210f)if(_GET_CURRENT_PLAYER_CHARACTER() !=i) return false;
}}}
return true;
}
...
var func__133(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7357{
if(bParam0) return uParam1;
return uParam2;
}
...
int num;
int num2;
if(!func_143(iParam1) || !func_143(iParam0)) return 1;
...
if(iParam1 < 1 || iParam1 > func_127(num, num2)) return;
...
if(num6 < 1 || num6 > func_127(num5, num4)) return false;
return true;
}
...
if(!PED::IS_PED_INJURED(pedParam8)) PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedParam8, false);
func_89(false);
func_115(0, uParam0);
}
func_153(-1);
