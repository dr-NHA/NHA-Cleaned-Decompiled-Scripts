...
func_19();
}elseif(HUD::DOES_BLIP_EXIST(Global_1935132)){
func_12();
HUD::SET_BLIP_ROUTE(Global_1935132, 0);
HUD::REMOVE_BLIP(&Global_1935132);
if(MISC::IS_BIT_SET(uLocal_434, 3)){
CUTSCENE::REMOVE_CUTSCENE();
}
MISC::SET_BIT(&(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
...
if(NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()){
if(iLocal_164==0){
MISC::CLEAR_BIT(&uLocal_434, false);
MISC::SET_BIT(&uLocal_434, true);
if(Local_85.f_2 !=-1){
...
if(!MISC::IS_BIT_SET(Local_165[iLocal_164 /*3*/].f_2, 0)){
MISC::CLEAR_BIT(&uLocal_434, true);
}
if(func_4(iVar1, 0, 1)){
if(MISC::IS_BIT_SET(Local_165[iLocal_164 /*3*/].f_2, 1)){
MISC::SET_BIT(&uLocal_434, 12);
if(Local_85.f_2==-1){
if(Local_85.f_2 !=iLocal_164){
Local_85.f_2=iLocal_164;
}}}elseif(Local_85.f_2==iLocal_164){
Local_85.f_2=-1;
}}}
iLocal_164++;
if(iLocal_164==32){
if(MISC::IS_BIT_SET(uLocal_434, 1)){
MISC::SET_BIT(&(Local_85.f_1), false);
}
if(!MISC::IS_BIT_SET(uLocal_434, 12)){
if(Local_85.f_2 !=-1){
Local_85.f_2=-1;
}}
MISC::SET_BIT(&uLocal_434, false);
iLocal_164=0;
}}}
...
case 0:
if(!MISC::IS_BIT_SET(uLocal_434, 2)){
if(!MISC::IS_BIT_SET(uLocal_434, 5)){
if(!func_235()){
if(!func_234()){
if(!func_232()){
...
if(HUD::DOES_BLIP_EXIST(Global_1935132)){
if(!MISC::IS_BIT_SET(uLocal_434, 14)){
if(Local_85.f_2 !=-1){
...
elseif(Local_85.f_2==-1 || Local_85.f_2==NETWORK::PARTICIPANT_ID_TO_INT()){
HUD::SET_BLIP_COLOUR(Global_1935132, 0);
HUD::SET_BLIP_SCALE(Global_1935132, 1f);
MISC::CLEAR_BIT(&uLocal_434, 14);
}}
if(MISC::IS_BIT_SET(uLocal_434, 8)){
MISC::CLEAR_BIT(&uLocal_434, 8);
}
if(func_198()){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if((bLocal_432 && CUTSCENE::HAS_CUTSCENE_LOADED()) || !bLocal_432){
if(!MISC::IS_BIT_SET(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
MISC::SET_BIT(&(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), true);
}
if(MISC::IS_BIT_SET(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
if(Local_85.f_2==NETWORK::PARTICIPANT_ID_TO_INT()){
func_12();
...
MISC::CLEAR_AREA(1274.854f, -1721.154f, 53.6808f, 2f, 1, 0, 0, 1);
if(bLocal_433){
func_194();
uLocal_442=GRAPHICS::REQUEST_SCALEFORM_MOVIE("SECURITY_CAM");
}
Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1=1;
}
elseif(Local_85.f_2 !=-1){
if(!MISC::IS_BIT_SET(uLocal_434, 13)){
if(func_188(1, 1, 1, 1)){
...
if(!MISC::IS_BIT_SET(uLocal_434, 9)){
if(func_188(0, 1, 1, 1)){
if(!func_225()){
...
HUD::SET_BLIP_FLASHES(Global_1935132, 1);
...
if(MISC::IS_BIT_SET(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
MISC::CLEAR_BIT(&(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), true);
}
if(MISC::IS_BIT_SET(uLocal_434, 13)){
...
}elseif(func_184(&uLocal_437, 10, 0)){
...
break;
case 3:
if(!MISC::IS_BIT_SET(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0)){
MISC::SET_BIT(&(Local_165[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
break;
}
...
var func__52(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
switch (iLocal_262){
case 0:
if(!MISC::IS_BIT_SET(uLocal_434, 18)){
if(!PED::IS_PED_INJURED(uLocal_263)){
uLocal_436=HUD::ADD_BLIP_FOR_ENTITY(uLocal_263);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_436, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_436, "FM_LEST_BLP");
func_136("FM_LEST_GTL", 0);
MISC::SET_BIT(&uLocal_434, 18);
}}
if(!MISC::IS_BIT_SET(uLocal_434, 20)){
...
uLocal_266=PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_263, uLocal_266, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_265, uLocal_266, "_LEADIN_ACTION_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, 8f, 4, 1148846080);
MISC::SET_BIT(&uLocal_434, 20);
}}}}
if(!MISC::IS_BIT_SET(uLocal_434, 3)){
CUTSCENE::REQUEST_CUTSCENE(sLocal_435, 8);
MISC::SET_BIT(&uLocal_434, 3);
}elseif(!MISC::IS_BIT_SET(uLocal_434, 10)){
...
if(MISC::IS_BIT_SET(uLocal_434, 10)){
iLocal_262++;
}}}
break;
case 1:
...
if(MISC::IS_BIT_SET(uLocal_434, 25)){
...
if(!MISC::IS_BIT_SET(uLocal_434, 11)){
...
if(!MISC::IS_BIT_SET(uLocal_434, 26)){
if(iLocal_262 > 2){
...
if(MISC::IS_BIT_SET(uLocal_434, 19)){
...
}elseif(!func_93(PLAYER::PLAYER_ID(), 0)){
...
if(!func_184(&(Global_2802593[bParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(bParam0)){
if(!func_96()){
if(CAM::IS_SCREEN_FADED_OUT()){
func_95(&(Global_2802593[bParam0 /*2*/]), 1, 0);
}elseif(!func_93(bParam0, 0)){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_99(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_263)){
uVar0=uLocal_263;
ENTITY::DELETE_ENTITY(&uVar0);
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_265)){
uVar0=uLocal_265;
ENTITY::DELETE_ENTITY(&uVar0);
}
func_12();
...
}elseif(bVar14 || (!func_93(PLAYER::PLAYER_ID(), 0) && !func_100())){
...
if(!func_130(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_442) && func_194()){
func_175();
func_174();
...
func_168(1, 1, 0);
if(!PED::IS_PED_INJURED(uLocal_264)){
MISC::CLEAR_AREA(1273.885f, -1718.004f, 53.7715f, 3f, 1, 0, 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_264);
ENTITY::SET_ENTITY_COORDS(uLocal_264, 1275.256f, -1722.368f, 53.655f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(uLocal_264, 12.6638f);
PED::FORCE_PED_MOTION_STATE(uLocal_264, joaat("MotionState_Walk"), 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
WEAPON::SET_CURRENT_PED_WEAPON(uLocal_264, joaat("weapon_unarmed"), 1);
}
uLocal_443=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
CAM::SET_CAM_ACTIVE(uLocal_443, 1);
CAM::SET_CAM_PARAMS(uLocal_443, 1276.409f, -1719.918f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_442, "SET_DETAILS");
func_167("FM_LEST_CAM");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_442, "SET_LOCATION");
...
if(!MISC::IS_BIT_SET(uLocal_434, 17)){
...
case 1:
if(!PED::IS_PED_INJURED(uLocal_264)){
if(!MISC::IS_BIT_SET(uLocal_434, 21)){
if(func_184(&uLocal_444, 1000, 0)){
TASK::TASK_LOOK_AT_COORD(uLocal_264, 1276.409f, -1719.918f, 56.1054f, -1, 0, 2);
...
if(!PED::IS_PED_INJURED(uLocal_264)){
if(!func_235()){
PED::SET_PED_CONFIG_FLAG(uLocal_264, 104, 1);
MISC::SET_BIT(&uLocal_434, 22);
TASK::TASK_CLEAR_LOOK_AT(uLocal_264);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_264, 1273.576f, -1718.459f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
func_183(&uLocal_444);
func_7(&uLocal_444, 0, 0);
iLocal_441++;
}}
...
case 3:
if(!PED::IS_PED_INJURED(uLocal_264)){
if(func_184(&uLocal_444, 5000, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_264, 1275.138f, -1718.426f, 53.72994f, 1272.451f, -1719.627f, 55.45897f, 1.5625f, 0, 1, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Aiming"), 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}
func_147();
func_90(1, 1, 0, 1);
...
if(MISC::IS_BIT_SET(uLocal_434, 15)){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_442)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_442, "SET_TIME");
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_442, 255, 255, 255, 255, 0);
}}
if(MISC::IS_BIT_SET(uLocal_434, 22)){
if(!PED::IS_PED_INJURED(uLocal_264)){
PED::SET_PED_CONFIG_FLAG(uLocal_264, 104, 1);
PED::SET_PED_RESET_FLAG(uLocal_264, 60, 1);
PED::SET_PED_RESET_FLAG(uLocal_264, 342, 1);
PED::SET_PED_RESET_FLAG(uLocal_264, 348, 1);
}}
if(MISC::IS_BIT_SET(uLocal_434, 23)){
if(func_143()){
...
PED::SET_PED_PROP_INDEX(iLocal_263, 1, 0, 0, 0, 1);
}}}
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_265)){
if(STREAMING::HAS_MODEL_LOADED(joaat("prop_wheelchair_01_s"))){
iLocal_265=OBJECT::CREATE_OBJECT(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, 0, 0, 0);
}}
...
if(!PED::IS_PED_INJURED(iLocal_263)){
uLocal_266=PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_263, uLocal_266, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_265, uLocal_266, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_266, 1);
bVar0=true;
}
if(!bVar0){
return 0;
...
void func_147(){
var uVar0;
if(CAM::DOES_CAM_EXIST(uLocal_443)){
CAM::SET_CAM_ACTIVE(uLocal_443, 0);
CAM::DESTROY_CAM(uLocal_443, 0);
}
...
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_442);
...
iLocal_264=PED::CREATE_PED(4, uVar0, 1273.827f, -1717.873f, 53.7715f, 19.2225f, 0, 0);
...
var func__219(var uParam0, int iParam1){
...
return 1;
}elseif((iParam0 >=17 && iParam0 <=31) && func_223()){
return 1;
}
...
var func__223(){
return MISC::IS_BIT_SET(func_25(2482, -1, 0), 2);
}


var func__224(){
return MISC::IS_BIT_SET(func_25(2482, -1, 0), 1);
}
...
}}elseif(HUD::DOES_BLIP_EXIST(*uParam0) && (HUD::IS_BLIP_SHORT_RANGE(*uParam0) && !func_240())){
...
if(MISC::IS_BIT_SET(uLocal_434, 24)){
