...
fLocal_14=0.001f;
iLocal_17=-1;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(2) || REPLAY::REPLAY_SYSTEM_HAS_REQUESTED_A_SCRIPT_CLEANUP()) SCRIPT::TERMINATE_THIS_THREAD();
func_1();
return;
}
...
if(TASK::GET_SCRIPT_TASK_STATUS(pedLocal_20, SCRIPT_TASK_ANY) !=7) TASK::CLEAR_PED_TASKS(pedLocal_20);
entityCoords={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) 
};
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_20, true);
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
if(!PED::IS_PED_IN_ANY_VEHICLE(pedLocal_20, false))if(!PED::IS_PED_IN_COMBAT(pedLocal_20, 0) && !PED::IS_PED_IN_ANY_VEHICLE(pedLocal_20, false)) TASK::TASK_TURN_PED_TO_FACE_COORD(0, entityCoords, 6000);
...
if(!PED::IS_PED_INJURED(pedLocal_20)) PED::SET_PED_KEEP_TASK(pedLocal_20, true);
...
break;
}}elseif(echLocal_19==CHAR_TREVOR){
switch (_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID())){
case CHAR_FRANKLIN:
...
break;
}}elseif(echLocal_19==CHAR_MICHAEL){
switch (_GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID())){
case CHAR_TREVOR:
...
if(func_8(character)) return func_7(character);
...
if(PED::IS_PED_IN_ANY_VEHICLE(Global_98050[iLocal_18], false)) vehiclePedIsIn=PED::GET_VEHICLE_PED_IS_IN(Global_98050[iLocal_18], false);
