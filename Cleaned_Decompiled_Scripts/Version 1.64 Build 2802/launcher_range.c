...
elseif(!func_100(uLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_51(&iLocal_96);
...
if(func_100(uLocal_94, 2097152)){
if(!func_83(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52)){
func_93(10);
}}
...
if(fVar3 < 400f){
if(!iLocal_134){
if((ENTITY::DOES_ENTITY_EXIST(Local_140[0 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_123)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_123, 1)){
PED::SET_PED_ACCURACY(iLocal_123, 20);
PED::SET_PED_STRAFE_CLIPSET(iLocal_123, "move_ped_strafing");
if(iLocal_138==0){
Var5={
ENTITY::GET_ENTITY_COORDS(Local_140[0 /*6*/].f_1, 1) - Vector(0.75f, 0f, 0f) 
};
}else{
Var5={
ENTITY::GET_ENTITY_COORDS(Local_140[0 /*6*/].f_1, 1) - Vector(0.77f, 0f, 0f) 
};
}
...
if(!iLocal_135){
if((ENTITY::DOES_ENTITY_EXIST(Local_140[1 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_124)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_124, 1)){
PED::SET_PED_ACCURACY(iLocal_124, 20);
PED::SET_PED_STRAFE_CLIPSET(iLocal_124, "move_ped_strafing");
if(iLocal_138==0){
Var5={
ENTITY::GET_ENTITY_COORDS(Local_140[1 /*6*/].f_1, 1) - Vector(0.7f, 0f, 0f) 
};
}else{
Var5={
ENTITY::GET_ENTITY_COORDS(Local_140[1 /*6*/].f_1, 1) - Vector(0.7f, 0f, 0f) 
...
if(!iLocal_136){
if((ENTITY::DOES_ENTITY_EXIST(Local_140[2 /*6*/].f_1) && ENTITY::DOES_ENTITY_EXIST(iLocal_125)) && !PED::IS_PED_DEAD_OR_DYING(iLocal_125, 1)){
PED::SET_PED_ACCURACY(iLocal_125, 20);
PED::SET_PED_STRAFE_CLIPSET(iLocal_125, "move_ped_strafing");
if(iLocal_138==0){
Var5={
ENTITY::GET_ENTITY_COORDS(Local_140[2 /*6*/].f_1, 1) - Vector(0.8f, 0f, 0f) 
};
}else{
Var5={
ENTITY::GET_ENTITY_COORDS(Local_140[2 /*6*/].f_1, 1) - Vector(0.68f, 0f, 0f) 
};
}
TASK::OPEN_SEQUENCE_TASK(&uVar4);
...
uVar0=Global_2805027[iParam0 /*3*/][func_45(iParam1)];
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_123, joaat("weapon_pistol"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_124, joaat("weapon_combatpistol"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_125, joaat("weapon_pistol"), -1, 1, 1);
...
Var18={
Vector(31.58f, -1092.35f, 12.617f) + Var15 * Vector(fVar3, fVar3, fVar3) 
};
Var21={
Vector(31.58f, -1092.35f, 12.617f) + Var15 * Vector(fVar4, fVar4, fVar4) 
};
Var24={
Vector(31.58f, -1092.35f, 12.617f) + Var15 * Vector(fVar5, fVar5, fVar5) 
};
}else{
fVar3=1.35f;
fVar4=1.05f;
...
Var18={
Vector(31.347f, -2168.039f, 824.2375f) + Var15 * Vector(fVar3, fVar3, fVar3) 
};
Var21={
Vector(31.347f, -2168.039f, 824.2375f) + Var15 * Vector(fVar4, fVar4, fVar4) 
};
Var24={
Vector(31.347f, -2168.039f, 824.2375f) + Var15 * Vector(fVar5, fVar5, fVar5) 
};
}
if(iParam0==0){
Var6={
Var12 * Vector(fVar0, fVar0, fVar0) 
};
Var9={
Var18 + Var6 
};
...
Var6={
Var12 * Vector(fVar1, fVar1, fVar1) 
};
Var9={
Var21 + Var6 
};
...
Var6={
Var12 * Vector(fVar2, fVar2, fVar2) 
};
Var9={
Var24 + Var6 
};
}
Local_140[iParam0 /*6*/]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_backboard_b"), Var9, 1, 1, 0);
Local_140[iParam0 /*6*/].f_1=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_bull_b"), Var9, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_1, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
Local_140[iParam0 /*6*/].f_2=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner1"), Var9, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_2, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
Local_140[iParam0 /*6*/].f_3=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner2_b"), Var9, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_3, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
Local_140[iParam0 /*6*/].f_4=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_inner3_b"), Var9, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/].f_4, Local_140[iParam0 /*6*/], 0, 0f, -0.04f, -0.41f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
Local_140[iParam0 /*6*/].f_5=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_target_arm_b"), Var9, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_140[iParam0 /*6*/], Local_140[iParam0 /*6*/].f_5, 0, 0f, 0.007f, -0.76f, 0f, 0f, 180f, 0, 0, 0, 0, 2, 1, 0);
if(iLocal_138==0){
...
ENTITY::FREEZE_ENTITY_POSITION(Local_140[iParam0 /*6*/].f_5, 1);
ENTITY::SET_ENTITY_INVINCIBLE(Local_140[iParam0 /*6*/], 1);
ENTITY::SET_ENTITY_INVINCIBLE(Local_140[iParam0 /*6*/].f_1, 1);
ENTITY::SET_ENTITY_INVINCIBLE(Local_140[iParam0 /*6*/].f_2, 1);
ENTITY::SET_ENTITY_INVINCIBLE(Local_140[iParam0 /*6*/].f_3, 1);
ENTITY::SET_ENTITY_INVINCIBLE(Local_140[iParam0 /*6*/].f_4, 1);
ENTITY::SET_ENTITY_INVINCIBLE(Local_140[iParam0 /*6*/].f_5, 1);
}
