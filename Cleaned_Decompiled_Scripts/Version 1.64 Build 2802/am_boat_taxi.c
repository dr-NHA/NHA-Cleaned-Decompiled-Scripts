...
bool func_25(){
return MISC::IS_BIT_SET(func_26(6427, -1, 0), 19);
}
...
uVar0=Global_2805027[iParam0 /*3*/][func_27(iParam1)];
...
Local_63.f_20=7;
}elseif(!PED::IS_PED_IN_VEHICLE(NETWORK::NET_TO_PED(Local_63.f_3), NETWORK::NET_TO_VEH(Local_63.f_2), 0)){
Local_63.f_20=7;
}}
if(!func_4(Local_63.f_3) && func_72(Local_63.f_2)){
if(Local_63.f_20 !=1){
...
if(Local_63.f_21==3){
Local_63.f_20=4;
}elseif(Local_63.f_21==5){
Local_63.f_20=7;
}elseif(!MISC::IS_BIT_SET(Local_63.f_0, 7) && ENTITY::IS_ENTITY_AT_ENTITY(NETWORK::NET_TO_PED(Local_63.f_3), PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0)){
Local_63.f_20=3;
}
break;
case 4:
MISC::SET_BIT(&uLocal_182, 8);
if(VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(NETWORK::NET_TO_VEH(Local_63.f_2), 0, 1) <=0){
Local_63.f_20=3;
MISC::CLEAR_BIT(&uLocal_182, 8);
}elseif(!MISC::IS_BIT_SET(Local_63.f_0, 7) && ENTITY::IS_ENTITY_AT_COORD(NETWORK::NET_TO_PED(Local_63.f_3), Local_63.f_7, 10f, 10f, 10f, 0, 1, 0)){
Local_63.f_20=5;
}
break;
case 5:
if((VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(NETWORK::NET_TO_VEH(Local_63.f_2), 0, 1) <=0 && !PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_63.f_2))) && func_31(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_63.f_2), 1) >=10f){
Local_63.f_20=6;
}
break;
case 3:
if(VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(NETWORK::NET_TO_VEH(Local_63.f_2), 0, 1) >=1){
Local_63.f_20=4;
}
break;
case 6:
...
if(VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(NETWORK::NET_TO_VEH(Local_63.f_2), 0, 1) > 0){
Local_63.f_21=3;
}elseif(MISC::IS_BIT_SET(Local_63.f_0, 10)){
Local_63.f_21=4;
}
break;
case 3:
...
}}}}elseif(SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_889, &iLocal_890, &uVar0, &uVar0, &uVar3)==2){
iLocal_889=0;
if(iLocal_890==0){
if(func_42(&(Local_63.f_2), joaat("dinghy2"), Local_891, uLocal_894, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0)){
...
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(NETWORK::NET_TO_VEH(Local_63.f_2), 0);
}}else{
iLocal_890=0;
MISC::CLEAR_BIT(&uLocal_182, 10);
}}elseif(SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_889, &iLocal_890, &uVar0, &uVar0, &uVar3)==0){
iLocal_889=0;
MISC::CLEAR_BIT(&uLocal_182, 10);
}}}
if(!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_63.f_2)){
...
*uParam0={
func_62(Local_63.f_10, (100f / 2f), 100f, 10f) 
};
*uParam1=MISC::GET_HEADING_FROM_VECTOR_2D((Local_63.f_10 - *uParam0), (Local_63.f_10.f_1 - uParam0->f_1));
}


Vector3 func__62(struct<3> Param0, float fParam3, float fParam4, float fParam5){
struct<3> Var0;
float fVar3;
Var0={
...
fVar3=(fParam5 / 2f);
Var0={
func_63(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam3, fParam4)) 
};
...
Vector3 func__63(struct<3> Param0, float fParam3){
float fVar0;
if(fParam3==0f){
return 0f, 0f, 0f;
}
...
func_85(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 23, 1), "BTX_ENTER", &uLocal_189, 0);
}}}else{
iVar0=0;
}
if(iVar0==1){
...
uLocal_188=GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
}}
...
func_80(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar2, 1));
if(iVar3 < 363){
func_80(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar3, 1));
}}else{
uVar4=uParam2->f_1[bVar0 /*57*/].f_54;
uVar5=uParam2->f_1[bVar0 /*57*/].f_55;
func_80(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(uVar4, uVar5, 1));
}
...
StringCopy(&Var1, "", 16);
if(!MISC::IS_BIT_SET(uLocal_183, bVar0)){
switch (bVar0){
case 0:
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_106(iParam2), 1);
}
