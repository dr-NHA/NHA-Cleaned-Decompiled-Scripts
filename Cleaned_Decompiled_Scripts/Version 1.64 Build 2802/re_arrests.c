...
fVar4=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), 1);
...
Local_68={
ENTITY::GET_ENTITY_COORDS(iLocal_55, 1) 
};
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, iLocal_55, iLocal_55, 1f, 0, 3f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_55, 5000, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
TASK::TASK_PERFORM_SEQUENCE(iLocal_54, uLocal_73);
...
Var1={
0f, 0f, (ENTITY::GET_ENTITY_HEADING(iLocal_55) * 3f) 
};
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_55, Var1, 2f, -1, 1f, 1024, 1193033728);
iLocal_52=3;
}
break;
case 3:
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_73);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_73);
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(iLocal_57, 1);
...
if(VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_55, iLocal_57, 2, 0, 0)){
if(!PED::IS_PED_INJURED(iLocal_55)){
...
elseif(PED::IS_PED_FACING_PED(iLocal_56, iLocal_55, 180f)){
Local_295={
-2.978f, -0.75f, 1f 
};
}
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_73);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_57, Local_295), iLocal_55, 0.75f, 0, 0.5f, 4f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 60000);
TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_55, -1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
TASK::TASK_PERFORM_SEQUENCE(iLocal_54, uLocal_73);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_73);
...
fVar6=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), ENTITY::GET_ENTITY_COORDS(iLocal_57, 1), 1);
...
TASK::CLEAR_PED_TASKS(iLocal_55);
iLocal_64=1;
}}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_55, sLocal_258, "kneeling_arrest_get_up", 3)){
if(func_72(iLocal_54, iLocal_57)==2){
Local_295={
1.578f, -0.5f, 1f 
};
...
func_177();
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_54, joaat("script_task_enter_vehicle"))==7){
TASK::CLEAR_PED_TASKS(iLocal_54);
...
if(!func_89()){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 20f){
...
TASK::CLEAR_PED_TASKS(iLocal_54);
TASK::OPEN_SEQUENCE_TASK(&uLocal_73);
TASK::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_55, 0), 10000, 0, 2);
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_73);
iLocal_262=1;
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_55, sLocal_259, "enter", 3)){
if(func_5()){
func_74(&uLocal_78, "REARRAU", "REARR_PRAND", 4, iLocal_254, 0, 0);
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_55, sLocal_259, "exit", 3)){}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_55, sLocal_259, sLocal_260, 3)){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_73);
iLocal_262=1;
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_54, sLocal_258, "radio_chatter", 3)){
if(func_5()){
func_74(&uLocal_78, "REARRAU", "REARR_PRAD3", 4, iLocal_254, 0, 0);
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_54, sLocal_258, "radio_exit", 3)){
iLocal_263=0;
func_8();
}}
...
iLocal_56=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_57, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_56, 294, 1);
if(!WEAPON::HAS_PED_GOT_WEAPON(iLocal_56, joaat("weapon_pistol"), 0)){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_56, joaat("weapon_pistol"), -1, 0, 1);
}
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_56, joaat("weapon_pistol"), 1);
...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_57, 1) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Var0 
};
...
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_56, iLocal_57, Var0, 4, 7f, 786471, 5f, -1f, 1);
...
HUD::SET_BLIP_AS_FRIENDLY(uLocal_59, 1);
...
TASK::CLEAR_PED_TASKS(iLocal_55);
TASK::OPEN_SEQUENCE_TASK(&uLocal_73);
TASK::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_54, 0), 1000, 0, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_54, 0), 2f, -1, 3f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_73);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_73);
iLocal_247=2;
...
iLocal_247=6;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, joaat("script_task_perform_sequence"))==7){
TASK::OPEN_SEQUENCE_TASK(&uLocal_73);
TASK::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_54, 0), 1000, 0, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_54, 0), 2f, -1, 3f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
...
iLocal_247=4;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), 75f, 75f, 75f, 0, 1, 0)){
if(!func_89()){
TASK::CLEAR_PED_TASKS(iLocal_55);
TASK::OPEN_SEQUENCE_TASK(&uLocal_73);
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_21() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_21() /*5568*/].f_681.f_10, iParam0);
}
...
PED::SET_PED_KEEP_TASK(iLocal_55, 1);
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, 0) && !PED::IS_PED_RAGDOLL(iLocal_55)){
TASK::CLEAR_PED_TASKS(iLocal_55);
TASK::TASK_COWER(iLocal_55, -1);
PED::SET_PED_KEEP_TASK(iLocal_55, 1);
}
...
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 40f, 40f, 40f, 0, 1, 0)){
func_58();
SYSTEM::WAIT(0);
...
if(PED::IS_PED_INJURED(iLocal_55)){
return 1;
}elseif(!MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_55, 31086, 0f, 0f, 0f), 2f, 1)){
return 1;
}}
...
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_54, 31086, 0f, 0f, 0f) 
};
Var3={
Var3 + PED::GET_PED_BONE_COORDS(iLocal_54, 31086, 0f, 0f, 0f) 
};
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_73);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_73);
PED::FORCE_PED_MOTION_STATE(iLocal_55, joaat("MotionState_Run"), 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_55, 1);
}
else{
TASK::CLEAR_PED_TASKS(iLocal_55);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
TASK::TASK_PERFORM_SEQUENCE(iLocal_56, uLocal_73);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_73);
PED::SET_PED_KEEP_TASK(iLocal_56, 1);
...
if(!PED::IS_PED_INJURED(iLocal_55)){
if(HUD::DOES_BLIP_EXIST(uLocal_59)){
HUD::SET_BLIP_AS_FRIENDLY(uLocal_59, 0);
}
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_55);
}}
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam1, 1f, -0.5f, 0f) 
};
Var9={
Var3 - Var0 
};
...
func_74(&uLocal_78, "REARRAU", "REARR_PRAND", 4, iLocal_254, 0, 0);
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 10f, 10f, 10f, 0, 1, 0)){
func_74(&uLocal_78, "REARRAU", sLocal_268, 4, iLocal_254, 0, 0);
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 10f, 10f, 10f, 0, 1, 0)){
func_74(&uLocal_78, "REARRAU", sLocal_268, 4, iLocal_254, 0, 0);
}else{
func_74(&uLocal_78, "REARRAU", sLocal_272, 4, iLocal_254, 0, 0);
}
...
int func_90(){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, iLocal_54, 3.5f, 3.5f, 3.5f, 0, 1, 0) || func_93()){
...
var uVar0;
struct<3> Var1;
if(MISC::GET_GROUND_Z_AND_NORMAL_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), &uVar0, &Var1)){
...
if(HUD::DOES_BLIP_EXIST(uLocal_59)){
HUD::SET_BLIP_AS_FRIENDLY(uLocal_59, iLocal_248);
if(iLocal_248==1){
iLocal_248=0;
}else{
iLocal_248=1;
...
if(!bLocal_61){
if(HUD::DOES_BLIP_EXIST(uLocal_58)){
HUD::SET_BLIP_AS_FRIENDLY(uLocal_58, iLocal_249);
if(iLocal_249==1){
iLocal_249=0;
}else{
iLocal_249=1;
...
var func__109(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
HUD::SET_BLIP_SCALE(uVar0, func_111(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
if(!bParam2){
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
}else{
HUD::SET_BLIP_COLOUR(uVar0, 2);
}}elseif(ENTITY::IS_ENTITY_A_PED(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_111(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
...
fVar9=220.0087f;
Local_279={
2378.284f, 4863.027f, 32.50883f 
};
Local_282={
2512.797f, 4998.586f, 90.12283f 
};
...
Var2={
2592.637f, 2540.05f, 30.4162f 
};
fVar8=90.5639f;
Var5={
2586.005f, 2541.41f, 31.0379f 
};
fVar9=75.5943f;
Local_279={
2543.135f, 2683.917f, 0.307461f 
};
Local_282={
2597.603f, 2408.885f, 121.901f 
};
...
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_54, joaat("weapon_pistol"), 1);
uLocal_60=OBJECT::CREATE_OBJECT(joaat("prop_ld_binbag_01"), Local_65.f_0, Local_65.f_1, (Local_65.f_2 + 100f), 1, 1, 0);
ENTITY::SET_ENTITY_VISIBLE(uLocal_60, 0, 0);
if(SYSTEM::VDIST(2411.32f, 4958.76f, 45.19f, Local_65) < 10f){
iLocal_53=1;
TASK::OPEN_SEQUENCE_TASK(&uLocal_73);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2473.254f, 4901.651f, 43.1488f, 3f, -1, 2f, 1, Local_250, 1193033728);
TASK::TASK_SMART_FLEE_PED(0, iLocal_54, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_73);
PED::SET_PED_KEEP_TASK(iLocal_55, 1);
...
iLocal_53=2;
TASK::OPEN_SEQUENCE_TASK(&uLocal_73);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2531.445f, 2521.749f, 38.2072f, 3f, -1, 2f, 1, Local_250, 1193033728);
TASK::TASK_SMART_FLEE_PED(0, iLocal_54, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_73);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_73);
PED::SET_PED_KEEP_TASK(iLocal_55, 1);
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_112695) || Global_32166) || func_167()) || func_87(8, -1)) || func_166()) || func_165()) || func_164()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_168()) || Global_32166) || func_167()) || func_87(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_112695) || Global_32166) || func_167()) || func_87(8, -1)) || func_166()) || func_165()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_32166) || func_167()) || func_87(8, -1)) || func_165()) || func_164()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_168()) || func_165()) || Global_112695) || Global_32166) || func_167()) || Global_44446) || func_87(8, -1)) || func_164()) || func_162()) || func_163()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_112695) || Global_32166) || func_167()) || func_87(8, -1)) || func_164()) || func_162()) || func_166()) || func_165()) || func_163()){
return 0;
}
break;
}}else{
...
TASK::TASK_SMART_FLEE_COORD(iLocal_55, ENTITY::GET_ENTITY_COORDS(iLocal_54, 1), 9000f, -1, 0, 0);
}else{
TASK::TASK_SMART_FLEE_COORD(iLocal_55, ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), 9000f, -1, 0, 0);
}
...
if(!PED::IS_PED_INJURED(iLocal_54) && !PED::IS_PED_INJURED(iLocal_55)){
TASK::TASK_GO_STRAIGHT_TO_COORD(iLocal_54, ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), 3f, 20000, 1193033728, 1056964608);
PED::SET_PED_KEEP_TASK(iLocal_54, 1);
SYSTEM::WAIT(0);
}}}