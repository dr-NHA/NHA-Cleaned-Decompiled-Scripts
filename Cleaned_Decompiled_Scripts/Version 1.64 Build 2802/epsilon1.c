...
Local_318={
1971.714f, 2870.046f, 48.9397f 
};
Local_321={
1975.87f, 2865.398f, 49.1545f 
};
fLocal_324=15f;
Local_83={
ScriptParam_0 
...
Var10={
func_14(iParam0, iParam1, iParam2, bParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9) 
};
iVar20=0;
func_13(&iVar20);
...
Global_78341[1 /*14*/]={
func_96(iVar0, iParam1, uVar31[iParam1], -1) 
};
...
Global_78341[1 /*14*/]={
func_96(iVar10, iVar0, func_53(iParam0, iVar0, -1), -1) 
};
...
return 1;
}elseif(func_74(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_73(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_88(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_88(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_88(iParam0));
if(iVar57 > iVar56){
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_88(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_88(iParam1))){
return 1;
}
return 0;
}
...
func_174(&uVar32, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
iLocal_150=VEHICLE::CREATE_VEHICLE(iLocal_149, 1970.362f, 2859.594f, 49.2307f, 151.6095f, 1, 1, 0);
}
if(func_217(iLocal_147)){
PED::SET_PED_CAN_BE_TARGETTED(iLocal_147, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_147, joaat("player"));
PED::SET_PED_KEEP_TASK(iLocal_147, 1);
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_150, 1, 1, 0);
}}
if(func_217(PLAYER::PLAYER_PED_ID())){
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_152, "back_armsdown", 1000f, -8f, -1, 1, 0, 0, 0, 0);
...
uLocal_330=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
CAM::SET_CAM_ACTIVE(uLocal_330, 1);
uLocal_331=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}}elseif(func_217(iLocal_147)){
if(func_217(iLocal_150)){
...
CAM::SET_CAM_ACTIVE(uLocal_331, 0);
func_247(0);
iLocal_145=2;
}elseif(SYSTEM::TIMERA() > 10000){
if(!CAM::IS_CAM_ACTIVE(uLocal_331)){
CAM::SET_CAM_ACTIVE(uLocal_331, 1);
CAM::SET_CAM_ACTIVE(uLocal_330, 0);
CAM::SET_CAM_PARAMS(uLocal_331, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
}}
}
elseif(func_217(PLAYER::PLAYER_PED_ID())){
...
SYSTEM::SETTIMERA(0);
func_220(2000, 0);
CAM::SET_CAM_PARAMS(uLocal_330, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
}
}}else{
TASK::TASK_WARP_PED_INTO_VEHICLE(iLocal_147, iLocal_150, -1);
}}}
...
var func__231(int iParam0, int iParam1){
...
int func_245(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6){
bool bVar0;
float fVar1;
bVar0=false;
if(func_217(iParam0)){
...
void func_246(){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_147)){
iLocal_147=PED::CREATE_PED(26, iLocal_148, Local_321, 0, 1, 1);
}
if(func_217(iLocal_147)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_147, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_147, 1);
PED::SET_PED_KEEP_TASK(iLocal_147, 1);
}}
...
if(!func_289(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_289(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
void func_321(var uParam0, int iParam1, struct<3> Param2, float fParam5){
func_322(uParam0);
...
if(func_165(iVar0) && !PED::IS_PED_INJURED(uParam0)){
