...
func_259(&num);
func_257();
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()) CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION("Barry", 1, 0, 0, 0);
}elseif(num==4){
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()) CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION("BARRY", 1, 0, 0, 0);
}
if(!IS_RC_FINE_AND_IN_RANGE(&num, num !=2)) func_298(&num, true);
func_218(num);
func_211(&iLocal_93, &(num.f_9), vector);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))if(num==2)if(func_208(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f)) func_207(&num, uLocal_97, true, 0);
elseif(num==3) func_208(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
elseif(num==4) func_193(&uLocal_105, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARR3AU", "BARRY3_AMB");
num2=0;
if(func_192(num)){
...
if(func_176(num)) func_173(num, &blLocal_96);
if(!func_2(&num)) func_298(&num, true);
if(func_1(&num)) func_298(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xC8F{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x6AA5{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x71F5{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x7581{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76C0{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x8441{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C43{
...
var func__175(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC0A9{
if(bParam0) return uParam1;
return uParam2;
}
...
func_316("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_181(uParam0->f_27)){
func_180(uParam0->f_27, *uParam0);
func_316("RC5_IN_ACTIVATION_RANGE:
...
if(func_181(true)){
func_180(1, *uParam0);
func_316("RC_IN_ACTIVATION_RANGE:
...
func_316("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if(func_182(playersLastVehicle))if(PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))if(!ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(playersLastVehicle) && !ENTITY::IS_ENTITY_IN_AIR(playersLastVehicle) && ENTITY::GET_ENTITY_SPEED(playersLastVehicle) < 1f) return true;
...
break;
case 1:
if(PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191() || Global_32166 || func_190() || func_189(8, -1) || func_187() || func_96() || func_188() || func_186() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 2:
...
break;
case 4:
if(func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_189(8, -1) || func_186() || func_185() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 5:
if(func_189(8, -1) || func_96() || func_188() || func_185() || func_184()) return false;
...
break;
case 7:
if(PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191() || func_188() || Global_112695 || Global_32166 || func_190() || Global_44446 || func_189(8, -1) || func_187() || func_185() || func_186() || Global_113648.f_7690.f_919[character]==5) return false;
break;
case 8:
...
switch (*uParam0){
case 0:
if(MISC::GET_GAME_TIMER() - iLocal_271 > 5000) *uParam0=1;
break;
case 1:
if(func_206(PLAYER::PLAYER_PED_ID(), uParam1, true) <=20f)if(_CONVERSATION_ADD_LINE(&uLocal_106, sParam4, sParam5, 8, 0, 0, 0)) *uParam0=2;
break;
case 2:
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
iLocal_271=MISC::GET_GAME_TIMER();
*uParam0=0;
}elseif(func_206(PLAYER::PLAYER_PED_ID(), uParam1, true) >=25f){
func_148();
*uParam0=0;
}
break;
...
if(func_198(PLAYER::PLAYER_ID())) return false;
...
int num;
num=32768;
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[iParam10])) return;
if(bParam9) num=num | 512;
...
if(Global_43257==17){
if(*uParam0 !=-1) func_216(uParam0);
}elseif(func_215()){
if(*uParam0 !=-1) func_216(uParam0);
}elseif(*uParam0==-1){
if(func_206(PLAYER::PLAYER_PED_ID(), uParam2, true) <=100f) func_214(uParam0, 1);
}else{
...
if(func_206(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f) func_216(uParam0);
}}}
return;
}
...
int i;
if(*uParam0==-1) return;
if(Global_78555==*uParam0) func_212(*uParam0, false);
...
var unk;
if(Global_78558){
func_316("IS_RC_FINE_AND_IN_RANGE():
The game is running Multiplayer [TERMINATING]");
return false;
}
func_115(*panParam0, &unk);
if(func_256(*panParam0) || func_254(*panParam0) || Global_78804==1) return true;
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_316("IS_RC_FINE_AND_IN_RANGE():
...
if(*panParam0==19) func_249(panParam0->f_28[0]);
func_316("IS_RC_FINE_AND_IN_RANGE():
Script denied by RC Controller [TERMINATING]");
return false;
}
if(panParam0->f_25==1)if(!func_229(panParam0, true, 0)) return false;
elseif(panParam0->f_16==0)if(!func_229(panParam0, false, 0)) return false;
if(*panParam0==16 || *panParam0==9 || *panParam0==18 || *panParam0==22 || *panParam0==32 || *panParam0==51){
if(!CHECK_VEHICLES_OK(panParam0, true, true)){
if(*panParam0==16) func_226(panParam0);
else func_224(panParam0);
return false;
}}elseif(*panParam0==24){
...
if(func_223(&(panParam0->f_48)) && bParam1) func_220(panParam0->f_28[0], &(panParam0->f_48), *panParam0);
return true;
}
...
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
if(func_222(uParam1)) TASK::TASK_PLAY_ANIM_ADVANCED(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0, 2, 0);
...
uParam1->f_3=5;
}elseif(func_222(uParam1) && uParam1->f_4==0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uParam1->f_4=1;
if(func_221(iParam2)) uParam1->f_3=2;
else uParam1->f_3=0;
break;
case 5:
...
if(iParam2==0) func_224(uParam0);
else func_226(uParam0);
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_148();
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0, xSize, xSize, xSize, false, true, 0))if(func_232(pedParam0, iParam1)) return true;
}}
return false;
}
...
if(num !=-1) func_240(&iLocal_37[num /*4*/]);
return false;
}
if(!func_237(pedParam0, pedParam1, iParam2, iParam3)) return false;
if(num==-1){
num=func_236();
if(num==-1) return false;
...
Vector3 func__235(Ped pedParam0, int iParam1) // Position - 0xF070{
...
float num;
unk={
func_239(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_239(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__239(float fParam0, var uParam1, var uParam2) // Position - 0xF231{
float num;
float num2;
...
if(!bParam2){
if(func_247(pedParam0, bParam1, radius, num)) return true;
if(func_244(pedParam0, num, bParam3, bParam4)) return true;
}else{
...
if(bParam3)if(func_245(pedParam0, fParam1)) return true;
else return false;
return true;
}}else{
if(bParam3)if(func_245(pedParam0, fParam1)) return true;
...
float num;
unk={
func_239(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
if(func_253() && !func_252()) return true;
if(!func_251(iParam0))if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0) return true;
...
if(func_255() && Global_100681.f_11==6 && iParam0==func_171(&(Global_100681.f_3), 0)) return true;
return false;
}
...
num=12f;
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))if(func_258(PLAYER::PLAYER_PED_ID(), unk, num, true)) func_155();
return;
}
...
func_260(uParam0);
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0])) PED::APPLY_DAMAGE_TO_PED(uParam0->f_28[0], 1000, true, 0);
}}
return;
}
...
i <=5;
i=i + 1){
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[i])) ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[i], false);
}
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0])){
ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_28[0], false);
...
switch (*uParam0){
case 2:
if(!func_284(uParam0)) return false;
break;
case 3:
if(!func_281(uParam0)) return false;
break;
case 4:
if(!func_275(uParam0)) return false;
break;
case 5:
if(!func_272(uParam0)) return false;
break;
case 6:
if(!func_267(uParam0)) return false;
break;
case 7:
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
-480.99292f, -1712.6495f, 17.452402f 
};
uParam0->f_17[1 /*3*/]={
-443.61295f, -1705.8864f, 27.622137f 
};
uParam0->f_24=31f;
uParam0->f_27=1;
uParam0->f_26=1;
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, vector, vector2, false, false, false, false, 2, true, 0);
else flag=false;
}
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
1198.3666f, -1326.095f, 33.968296f 
};
uParam0->f_17[1 /*3*/]={
1202.2368f, -1235.3735f, 43.976414f 
};
uParam0->f_24=31f;
uParam0->f_27=1;
uParam0->f_26=1;
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])) ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, vector, 0f, 0f, 0f, false, false, true, false, 2, true, 0);
else flag=false;
}
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1])) func_269(&uParam0->f_35[1], num[2], unk10, num3);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0])) func_273(&uParam0->f_28[0], num[3], unk10, num3, PED_TYPE_COP);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1])) func_273(&uParam0->f_28[1], num[3], unk10, num3, PED_TYPE_COP);
if(flag) iLocal_91=3;
break;
case 3:
...
break;
case 1:
if(!func_271(&num) || !func_279(&(uParam0->f_48))) return false;
iLocal_91=2;
break;
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(func_276(&uParam0->f_28[0], CHAR_BARRY, unk3, num2, "RC LAUNCHER:
BARRY 3", 1)) PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
else flag=false;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])){
func_268(&uParam0->f_41[0], num[1], unk3 +{
0f, 0f, 5f 
}
, -115.18f);
...
case 2:
flag=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))if(func_276(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER:
...
if(func_253() && !func_252()) return false;
if(func_293(iParam0)) return false;
if(iParam0==-1) iParam0=func_170();
if(iParam0==-1) return false;
if(!func_256(iParam0)){
if(!func_292(iParam0)) return false;
if(!func_291(iParam0)) return false;
if(func_290(iParam0)) return false;
}
if(iParam0==58)if(func_288(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
if(func_251(iParam0)) return false;
...
int num;
int i;
if(_GET_CURRENT_PLAYER_CHARACTER_0()==CHAR_MICHAEL)if(func_296(2, uParam1, fParam4, uParam0)) return true;
elseif(_GET_CURRENT_PLAYER_CHARACTER_0()==CHAR_TREVOR)if(func_296(3, uParam1, fParam4, uParam0)) return true;
num=4;
num[0]=4;
num[1]=5;
num[2]=6;
...
char* str;
if(bParam1){
func_316("SCRIPT TERMINATING:
Cleaning up entities in Launcher");
func_260(uParam0);
func_305(uParam0, 0, false, false);
}
if(HUD::DOES_BLIP_EXIST(blLocal_96)) HUD::REMOVE_BLIP(&blLocal_96);
if(iLocal_93 !=-1){
func_316("SCRIPT TERMINATING:
Ending off-mission cutscene request");
func_217(&iLocal_93);
}
if(*uParam0==6) PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_95, false);
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))if(func_302(sParam0)) func_300();
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(bParam1) func_225(&uParam0->[i]);
else func_308(&uParam0->[i], false);
}
return;
}
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_274(&uParam0->[i]);
else func_314(&uParam0->[i], false, 1, 0);
}
return;
}
