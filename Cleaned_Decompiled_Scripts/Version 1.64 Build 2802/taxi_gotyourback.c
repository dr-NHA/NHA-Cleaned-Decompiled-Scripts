...
iLocal_954=112;
uLocal_978={
11.8607f, -1123.48f, 27.6801f 
};
uLocal_981={
11.8607f, -1123.48f, 27.6801f 
};
uLocal_984={
144.3291f, -3352.7734f, 3.6651f 
};
uLocal_987={
311.9527f, -3305.6133f, 10.6651f 
};
uLocal_990={
206.636f, -3322.673f, 4.6339f 
};
uLocal_993={
0f, 0f, 24f 
};
uLocal_996={
208.786f, -3319.823f, 4.6339f 
};
uLocal_999={
0f, 0f, 47f 
};
uLocal_1002={
199.51877f, -3326.2012f, 4.78716f 
};
uLocal_1005={
232.99445f, -3327.825f, 4.79877f 
};
...
caLocal_409.f_102=1;
while (true){
if(ENTITY::DOES_ENTITY_EXIST(caLocal_409.f_2)) func_9();
else func_1(&caLocal_409);
SYSTEM::WAIT(0);
}
return;
}
...
if(func_414(&caLocal_409, false)) func_412();
}else{
...
if(caLocal_409.f_410 < 22) func_374(&caLocal_409);
func_373(&caLocal_409, &uLocal_958, false);
if(caLocal_409.f_410 > 5 && !IS_BIT_SET(iLocal_959, 0)){
caLocal_409.f_17={
189.7825f, -3325.6838f, 4.6697f 
};
MISC::SET_BIT(&iLocal_959, 0);
}
if(caLocal_409.f_410 > 2)if(!func_372(&caLocal_409)) func_339();
else func_330(&caLocal_409, "Taxi Not Driveable", func_338(&caLocal_409));
if(caLocal_409.f_410==9) func_306(&caLocal_409, 0, true);
if(ENTITY::DOES_ENTITY_EXIST(caLocal_409.f_3)){
if(ENTITY::IS_ENTITY_DEAD(caLocal_409.f_3, false)){
if(!func_305(&caLocal_409, 0)) func_304(&caLocal_409, 0);
if(caLocal_409.f_410 >=22 || iLocal_933 >=1) bLocal_968=true;
...
break;
case 5:
if(func_233(&caLocal_409, false, 1109393408)) func_293(&caLocal_409, 15);
break;
case 15:
...
if(iLocal_957==8) func_114(&caLocal_409, 0);
func_293(&caLocal_409, 27);
}elseif(func_163(caLocal_409.f_3, true) > 100f){
func_330(&caLocal_409, "Player abandoned passenger", 8);
}
break;
case 27:
...
if(MISC::CREATE_INCIDENT(DT_PoliceVehicleRequest, uLocal_1005, 3, 0f, &uLocal_949, 0, 0)) bLocal_973=true;
}
break;
case 29:
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_946, false)) bLocal_974=true;
...
if(!PED::IS_PED_INJURED(pedLocal_944)) bLocal_974=true;
...
Vector3 vector2;
vector={
func_38(uParam0, 1f, -fParam4, -fParam4, -fParam4) 
};
vector2={
func_38(uParam0, 1f, fParam4, fParam4, fParam4) 
};
...
Vector3 func__38(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1632{
float num;
float value;
float num2;
float num3;
...
Vector3 func__41() // Position - 0x1726{
var unk;
return unk;
}
...
if(func_46()) return;
if(Global_20584)if(func_45()) func_43(true, true);
...
i < 8;
i=i + 1){
if(Global_97614[i /*17*/] && !Global_97614[i /*17*/].f_1)if(Global_97614[i /*17*/].f_3==0)if(Global_97614[i /*17*/].f_5 !=88 && Global_97614[i /*17*/].f_5 !=89 && Global_97614[i /*17*/].f_5 !=92) func_48(Global_97614[i /*17*/].f_5, true);
}
return;
}
...
if(!func_22(Global_113648.f_19099, 64)) func_54(func_61(func_62(uParam0)), 0, 0);
return;
}
...
if(value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_113648.f_10196.f_3853)) func_59(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
if(!DATAFILE::DATAFILE_IS_SAVE_PENDING()){
if(!Global_78558){
if(func_58()==2==false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(NETWORK::NETWORK_IS_CLOUD_AVAILABLE()) Global_113382=0;
if(!Global_63362) func_56();
}}}
return;
}
...
if(func_76(14) && !func_75(iParam0)) return 0;
...
if(func_72(&Global_4542597, iParam0)) return 0;
if(func_65(&Global_4542597, iParam0)) return 1;
}else{
...
if(func_76(14) && !func_75(iParam1)) return false;
if(func_72(uParam0, iParam1)) return false;
if(func_71(uParam0) < 0f) func_70(uParam0, 0);
func_68(&unk);
i=0;
for (i=0;
i < *uParam0 - 1;
...
if(func_76(14) && !func_75(iParam1)) return 0;
if(func_72(uParam0, iParam1)) return 0;
if(func_71(uParam0) < 0f) func_70(uParam0, 0);
for (i=0;
i < *uParam0;
i=i + 1){
...
int outValue;
Hash statHash;
if(func_96(echParam0)==3) return;
if(func_96(echParam0)==4) return;
...
func_82(iParam0);
if(Global_43257==15) func_81(false);
return 1;
}
...
}}elseif(IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_85() /*5568*/].f_681.f_10, iParam0)){
flag=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
int cloudTimeAsInt6;
int num6;
if(iParam0==8) return func_91(129, -1);
if(iParam0==9) return func_91(135, -1);
if(iParam0==10) return func_91(136, -1);
if(iParam0==11) return func_91(137, -1);
if(iParam0==12){
...
if(!func_16(&(uParam0->f_2))) func_103(&(uParam0->f_2));
...
func_103(&(uParam0->f_5));
func_102(uParam0, 1051260355);
}elseif(func_101(&(uParam0->f_5)) > 0.33f){
...
if(!func_16(&uParam0->f_146[iParam1 /*3*/])) func_112(&uParam0->f_146[iParam1 /*3*/]);
return func_101(&uParam0->f_146[iParam1 /*3*/]);
}


void func_112(int* piParam0) // Position - 0x3ED8{
if(!func_16(piParam0)) func_103(piParam0);
return;
}
...
if(!func_22(uParam0->f_55, 1)) func_171(&(uParam0->f_55), 1);
return;
}
...
if(uParam0->f_411==0) func_228(uParam0, 105, 1, false, false);
else func_228(uParam0, 103, 1, false, false);
func_117(1);
...
if(func_161(&caLocal_409)) _DISPLAY_HELP_TEXT("TAXI_VIEW", -1);
bLocal_967=true;
...
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TAXI_VIEW") && GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 80) || !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
...
if(!PED::IS_PED_INJURED(uLocal_839.f_3[3])) PED::SET_PED_RESET_FLAG(uLocal_839.f_3[3], 156, true);
...
iLocal_951=MISC::GET_GAME_TIMER();
}elseif(iLocal_951 > 0 && MISC::GET_GAME_TIMER() - iLocal_951 > 1500 && !IS_BIT_SET(iLocal_959, 9)){
func_157();
...
}elseif(iLocal_951 > 0 && MISC::GET_GAME_TIMER() - iLocal_951 > 1200){
...
break;
case 9:
if(MISC::GET_GAME_TIMER() - iLocal_951 > 5000) iLocal_933=4;
break;
}
break;
case 4:
if(!caLocal_409.f_114) caLocal_409.f_114=1;
...
}elseif(func_305(&caLocal_409, 8) && func_111(&caLocal_409, 8) > 3f){
func_133();
func_130();
iLocal_951=MISC::GET_GAME_TIMER();
iLocal_933=6;
...
break;
case 6:
if(PED::IS_PED_INJURED(uLocal_881.f_3[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_881.f_27[0], false) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_881.f_27[0])) VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_881.f_27[0]);
if(PED::IS_PED_INJURED(uLocal_881.f_3[2]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_881.f_3[2], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_881.f_3[2], caLocal_409.f_3, true) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_881.f_27[1], false) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_881.f_27[1])) VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_881.f_27[1]);
if(HUD::DOES_BLIP_EXIST(uLocal_881.f_37[0]) && !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_881.f_27[0], false)) HUD::REMOVE_BLIP(&uLocal_881.f_37[0]);
if(HUD::DOES_BLIP_EXIST(uLocal_881.f_37[1]) && !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_881.f_27[1], false)) HUD::REMOVE_BLIP(&uLocal_881.f_37[1]);
...
i < uLocal_881.f_3;
i=i + 1){
if(!PED::IS_PED_INJURED(uLocal_881.f_3[i]))if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_881.f_3[i], SCRIPT_TASK_COMBAT_HATED_TARGETS_AROUND_PED) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_881.f_3[i], SCRIPT_TASK_COMBAT_HATED_TARGETS_AROUND_PED) !=0) TASK::TASK_COMBAT_HATED_TARGETS_AROUND_PED(uLocal_881.f_3[i], 1000f, 0);
}}
if(!PED::IS_PED_INJURED(caLocal_409.f_3)){
if(bLocal_975){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_228(&caLocal_409, 140, 1, false, true);
bLocal_975=false;
}}
...
i < *uParam0;
i=i + 1){
if(!PED::IS_PED_INJURED(uParam0->[i])) PED::SET_PED_ACCURACY(uParam0->[i], 1);
}
return;
}
...
if(HUD::DOES_BLIP_EXIST(uLocal_881.f_37[0])) HUD::REMOVE_BLIP(&uLocal_881.f_37[0]);
if(HUD::DOES_BLIP_EXIST(uLocal_881.f_37[1])) HUD::REMOVE_BLIP(&uLocal_881.f_37[1]);
return;
}
...
i < *uParam0;
i=i + 1){
if(!PED::IS_PED_INJURED(uParam0->[i]))if(!PED::IS_PED_IN_ANY_VEHICLE(uParam0->[i], false)) return true;
}
return false;
}
...
if(HUD::DOES_BLIP_EXIST(uParam1->[i])) HUD::REMOVE_BLIP(&uParam1->[i]);
if(func_129(&caLocal_409, uParam0->[i], true)) iLocal_957=iLocal_957 + 1;
...
if(func_129(&caLocal_409, uParam2->[i], true)) iLocal_957=iLocal_957 + 1;
}else{
iLocal_957=0;
num=0;
}}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))if(ENTITY::DOES_ENTITY_EXIST(eParam1))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(eParam1, uParam0->f_4, true)) return true;
if(bParam2)if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))if(ENTITY::DOES_ENTITY_EXIST(eParam1))if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(eParam1, PLAYER::PLAYER_PED_ID(), true)) return true;
return false;
}
...
var func__132(BOOL bParam0, var uParam1, var uParam2) // Position - 0x56EF{
...
if(ENTITY::DOES_ENTITY_EXIST(caLocal_409.f_3)){
if(!PED::IS_PED_INJURED(caLocal_409.f_3)){
if(!HUD::DOES_BLIP_EXIST(caLocal_409.f_8)) caLocal_409.f_8=func_131(caLocal_409.f_3, true, false);
WEAPON::GET_CURRENT_PED_WEAPON(caLocal_409.f_3, &weaponHash, true);
if(weaponHash==joaat("WEAPON_UNARMED")) WEAPON::GIVE_WEAPON_TO_PED(caLocal_409.f_3, joaat("WEAPON_COMBATPISTOL"), 100, false, true);
...
Vector3 func__138(int iParam0) // Position - 0x5BC5{
switch (iParam0){
case 1:
...
if(func_143(PLAYER::PLAYER_ID())) return false;
...
i < *uParam1;
i=i + 1){
if(!PED::IS_PED_INJURED(uParam0->[i]))if(!HUD::DOES_BLIP_EXIST(uParam1->[i])) uParam1->[i]=func_131(uParam0->[i], false, false);
}
return;
}
...
if(iParam0 < iLocal_343 && iParam0 >=0)if(bParam1) func_165(&iLocal_343.f_1[iParam0 /*4*/], 2);
else func_123(&iLocal_343.f_1[iParam0 /*4*/], 2);
return;
}
...
if(func_44(1)) func_42(0);
if(func_33()){
func_169();
return true;
}elseif(func_167(uParam0->f_4, iParam2, 1, 1056964608, false, true, false)){
...
if(func_10(uParam0->f_4, uParam0->f_17, true) <=fParam1 + 1f && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) < 1 && func_174(true, true, true) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(uParam0->f_4)) return func_166(uParam0, true, fParam1);
}elseif(ENTITY::IS_ENTITY_AT_COORD(uParam0->f_4, uParam0->f_17, fParam1 + 1f, fParam1 + 1f, 2f, !uParam0->f_140, true, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) < 1 && func_174(true, true, true) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(uParam0->f_4)){
...
func_304(uParam0, 2);
}elseif(func_177(uParam0)){
if(func_111(uParam0, 2) > iParam1 && !func_305(uParam0, 14)){
if(func_35()) func_228(uParam0, 48, 1, false, false);
else func_228(uParam0, 48, 1, false, false);
func_298(uParam0, 2, 0, false);
if(func_305(uParam0, 10)) func_298(uParam0, 10, 0, false);
}
if(!func_305(uParam0, 3)){
func_298(uParam0, 3, 0, false);
}elseif(func_111(uParam0, 3) >=iParam2){
func_110(uParam0, 3, false);
func_330(uParam0, "Car not moving", 20);
}}}else{
if(func_305(uParam0, 2)) func_110(uParam0, 2, false);
if(func_305(uParam0, 3)) func_110(uParam0, 3, false);
}}
return;
}
...
if(func_181(uParam0)) func_180(uParam0);
return;
}
...
break;
case 2:
if(func_22(uParam0->f_81, 262144) || func_22(uParam0->f_82, 67108864))if(!func_305(uParam0, 22)) func_304(uParam0, 22);
...
if(uParam0->f_410 !=22) func_228(uParam0, 50, 1, true, false);
...
if(uParam0->f_410 !=22) func_228(uParam0, 51, 0, false, false);
uParam0->f_412=3;
...
if(!func_184(uParam0))if(!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())if(func_111(uParam0, 16) > 10f)if(uParam0->f_410 !=22) func_228(uParam0, 51, 1, false, false);
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) < 1){
if(func_186("TAXI_OBJ_POL", 0, 0)) HUD::CLEAR_PRINTS();
if(HUD::DOES_BLIP_EXIST(uParam0->f_9)){
...
case 4:
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()){
if(uParam0->f_410 !=22) func_228(uParam0, 53, 1, false, true);
...
}elseif(func_199(uParam0)){
if(func_186("TAXI_OBJ_PICKUP", 0, 0)) HUD::CLEAR_THIS_PRINT("TAXI_OBJ_PICKUP");
...
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_197(1);
...
if(!func_177(uParam0)){
MISC::GET_GAME_TIMER() % 1000 < 50;
if(PED::IS_PED_IN_ANY_VEHICLE(uParam0->f_2, false))if(func_111(uParam0, 15) > 5f) func_298(uParam0, 15, 0f, true);
if(func_111(uParam0, 14) > 20f) func_330(uParam0, "Player not in taxi. - YELL RETURN", 8);
}elseif(func_111(uParam0, 14) > 20f){
if(func_163(uParam0->f_4, true) > 40f) func_330(uParam0, "Player not in taxi.", 21);
else func_330(uParam0, "Player not in taxi. - YELL RETURN 2", 8);
}}}}
return;
}
...
HUD::SET_BLIP_ROUTE(uParam0->f_9, false);
HUD::CLEAR_PRINTS();
if(func_177(uParam0)) func_228(uParam0, 2, 1, false, false);
else func_195(uParam0, &(uParam0->f_98), 4, 3);
}
...
if(WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(pedParam1, joaat("WEAPON_STUNGUN"), 0) || WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(pedParam1, 0, 2) || WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(pedParam1, 0, 1)) func_330(uParam0, "Passenger injured by player with weapon.", 14);
...
if(func_305(uParam0, 14)) func_200(uParam0);
...
Vector3 func__214(int iParam0) // Position - 0x809E{
switch (iParam0){
case 1:
...
Vector3 func__216(int iParam0) // Position - 0x8177{
switch (iParam0){
case 1:
...
Vector3 func__220(int iParam0) // Position - 0x837E{
switch (iParam0){
case 1:
...
if(!STREAMING::HAS_MODEL_LOADED(hLocal_932)) func_222("TAXI_ASSETS_STREAMED - Loading PROP_BARREL_EXP_01A", &iLocal_950, 1000);
return true;
}
...
if(uParam0->f_141 && func_257(uParam0, uParam0->f_3) > 300f) func_330(uParam0, "Left Passenger", 8);
switch (uParam0->f_48){
case 0:
if(TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, SCRIPT_TASK_PERFORM_SEQUENCE) !=1 || func_170(PLAYER::PLAYER_PED_ID(), uParam0->f_3, true) < 20f && func_10(uParam0->f_3, uParam0->f_11, true) <=28f && func_10(uParam0->f_4, uParam0->f_11, true) <=28f)if(func_254(uParam0, iParam2)) uParam0->f_48=uParam0->f_48 + 1;
break;
case 1:
...
if(!func_161(uParam0)){
TASK::CLEAR_PED_TASKS(uParam0->f_3);
}elseif(TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, SCRIPT_TASK_PERFORM_SEQUENCE) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, SCRIPT_TASK_PERFORM_SEQUENCE) !=0 && TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, SCRIPT_TASK_PERFORM_SEQUENCE) !=7 && func_257(uParam0, uParam0->f_3) > 8f){
...
num=-1;
if(!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_4, false)) func_246();
if(bLocal_94) iLocal_86=10;
if(iLocal_86 < 7 && iLocal_86 > 0 && !bLocal_94)if(func_244(iLocal_88)) iLocal_86=7;
switch (iLocal_86){
case 0:
...
if(ENTITY::GET_ENTITY_SPEED(uParam0->f_4) > 3f && func_111(uParam0, 5) > 15f || ENTITY::IS_ENTITY_UPSIDEDOWN(uParam0->f_4)) return true;
return false;
}
...
if(!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false)){
if(!ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_3) && func_163(uParam0->f_3, true) < fParam2)if(!func_305(uParam0, 5)) func_298(uParam0, 5, 0, false);
elseif(func_305(uParam0, 5)) func_110(uParam0, 5, false);
if(func_111(uParam0, 5) > (float)iParam1 && ENTITY::GET_ENTITY_SPEED(uParam0->f_4) < fParam4 && !ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_3) || func_163(uParam0->f_3, true) <=fParam3) return true;
}
return false;
}
...
case 2:
HUD::CLEAR_PRINTS();
if(uParam0->f_411 !=9)if(!func_22(uParam0->f_44, 128)) func_228(uParam0, 4, 1, false, true);
else func_255(uParam0->f_3, "TAXI_HAIL", uParam0->f_145, 4);
TASK::CLEAR_PED_TASKS(uParam0->f_3);
...
if(!ENTITY::IS_ENTITY_DEAD(veParam1, false))if(func_161(uParam0)) return func_170(uParam0->f_4, veParam1, true);
return 0f;
}
...
if(PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID()) && !func_22(uParam0->f_44, 256)) func_171(&(uParam0->f_44), 256);
...
if(PED::IS_PED_INJURED(uParam0->f_3) || PED::IS_PED_FLEEING(uParam0->f_3) || func_163(uParam0->f_3, true) > 400f) func_330(uParam0, "ped is fleeing or injured", 5);
}else{
...
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TX_VIP_DMGD")) func_171(&(uParam0->f_44), 64);
}}
return false;
}elseif(!flag3 || !flag2){
...
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TX_VIP_CAR")) func_171(&(uParam0->f_44), 32);
}}
return false;
}elseif(!flag4){
...
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("TX_VIP_SMALL")) func_171(&(uParam0->f_44), 16);
}}
return false;
}
return true;
...
}elseif(MISC::IS_PS3_VERSION() || func_265()){
...
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)if(func_275(uParam0->f_85, 32)) return 1;
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_4))if(ENTITY::IS_ENTITY_IN_WATER(uParam0->f_4) && !VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(uParam0->f_4))if(!func_305(uParam0, 25)) func_298(uParam0, 25, 0, false);
elseif(func_111(uParam0, 25) > 2f) return 1;
elseif(func_305(uParam0, 25)) func_110(uParam0, 25, false);
return 0;
}
...
if(!ENTITY::IS_ENTITY_DEAD(uParam0->f_4, false))if(VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))if(VEHICLE::IS_VEHICLE_STOPPED(uParam0->f_4))if(func_275(uParam0->f_86, 8)) return 1;
return 0;
}
...
if(bParam2) func_165(&iLocal_343.f_1[iLocal_343 /*4*/], 2);
...
if(!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_1112)) return false;
...
i < 32;
i=i + 1){
if(iParam2 > 0f) func_104(&uParam0->f_146[i /*3*/], iParam2);
else func_103(&uParam0->f_146[i /*3*/]);
}}elseif(iParam2 > 0f){
...
if(!func_22(Global_113648.f_19099, 128)) func_171(&(Global_113648.f_19099), 128);
return;
}
...
if(weaponHash==joaat("WEAPON_UNARMED")) WEAPON::GIVE_WEAPON_TO_PED(uParam0->[i], joaat("WEAPON_PISTOL"), -1, false, true);
...
}}elseif(func_111(uParam0, 10) > 20f){
if(uParam0->f_112){
func_228(uParam0, 92, 1, false, false);
uParam0->f_112=0;
}else{
...
}elseif(func_101(&(uLocal_190[5 /*10*/].f_6)) > 6f){
if(func_329(uParam0)){
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[0 /*10*/].f_6)) > 5f){
if(func_324(uParam0)){
func_328(uParam0, 1);
func_326(0, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[1 /*10*/].f_6)) > 5f){
if(func_323(uParam0)){
func_328(uParam0, 1);
func_326(1, uParam0);
if(uParam0->f_113){
...
}}elseif(func_101(&(uLocal_190[8 /*10*/].f_6)) > 7f || uLocal_190[8 /*10*/].f_1==0){
if(func_322(uParam0)){
func_328(uParam0, 1);
func_326(8, uParam0);
func_325(uParam0);
...
}elseif(func_101(&(uLocal_190[6 /*10*/].f_6)) > 5f){
if(func_321(uParam0)){
func_328(uParam0, 1);
func_326(6, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[4 /*10*/].f_6)) > 4f){
if(func_320(uParam0)){
func_328(uParam0, 1);
func_326(4, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[7 /*10*/].f_6)) > 5f || uLocal_190[7 /*10*/].f_1==0){
if(func_319(uParam0)){
func_326(7, uParam0);
func_328(uParam0, 1);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[9 /*10*/].f_6)) <=7f){
PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
}elseif(func_101(&(uLocal_190[9 /*10*/].f_6)) > 7f || uLocal_190[9 /*10*/].f_1==0){
if(func_318(uParam0)){
func_328(uParam0, 1);
func_326(9, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[13 /*10*/].f_6)) > 10f){
if(func_312(uParam0)){
func_328(uParam0, 1);
func_326(13, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[14 /*10*/].f_6)) > 7f){
if(func_311(uParam0)){
func_328(uParam0, 1);
func_326(14, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[11 /*10*/].f_6)) > 8f){
if(func_310(uParam0)){
func_328(uParam0, 1);
func_326(11, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[12 /*10*/].f_6)) > 5f){
if(func_309(uParam0)){
func_328(uParam0, 1);
func_326(12, uParam0);
if(uParam0->f_113){
...
}elseif(func_101(&(uLocal_190[2 /*10*/].f_6)) > 5f){
if(func_307(uParam0)){
if(uParam0->f_113){
func_228(uParam0, 93, 1, false, false);
uParam0->f_113=0;
...
if(uParam0->f_37 > 10f) func_112(&(uLocal_190[2 /*10*/].f_3));
}elseif(func_101(&(uLocal_190[2 /*10*/].f_3)) > 0.9f){
...
if(!func_16(piParam0)) func_104(piParam0, fParam1);
return;
}
...
}elseif(func_101(&(uLocal_190[12 /*10*/].f_3)) > 5f){
...
}elseif(func_101(&(uLocal_190[11 /*10*/].f_3)) < 1.5f && MISC::ABSF(fLocal_342) - MISC::ABSF(entitySpeedVector) < 0f){
func_100(&(uLocal_190[11 /*10*/].f_3));
return true;
}elseif(func_101(&(uLocal_190[11 /*10*/].f_3)) >=1.5f){
func_100(&(uLocal_190[11 /*10*/].f_3));
return false;
}}}
return false;
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_5))if(ENTITY::GET_ENTITY_SPEED(uParam0->f_4) > 15f && func_170(uParam0->f_5, uParam0->f_4, true) < 3f && !ENTITY::IS_ENTITY_DEAD(uParam0->f_5, false) && !VEHICLE::IS_VEHICLE_SEAT_FREE(uParam0->f_5, -1, false)) func_112(&(uLocal_190[14 /*10*/].f_3));
}elseif(func_101(&(uLocal_190[14 /*10*/].f_3)) < 1.5f && func_170(uParam0->f_5, uParam0->f_4, true) > 4.5f && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_5)){
func_100(&(uLocal_190[14 /*10*/].f_3));
return true;
}elseif(func_101(&(uLocal_190[14 /*10*/].f_3)) >=1.5f){
func_100(&(uLocal_190[14 /*10*/].f_3));
return false;
...
}elseif(func_101(&(uLocal_190[13 /*10*/].f_3)) > 5f){
...
unk7={
func_317(outPosition2 - outPosition, outPosition2.f_1 - outPosition.f_1, 0f) 
};
unk10={
func_316(unk7, 0) *{
num, num, num 
...
uParam9.f_2=0f;
unk={
func_317(uParam6 - uParam3) 
};
unk4={
func_317(uParam9 - uParam3) 
};
...
Vector3 func__316(float fParam0, var uParam1, var uParam2, int iParam3) // Position - 0xC52B{
float num;
switch (iParam3){
case 0:
num=-fParam0.f_1;
...
Vector3 func__317(float fParam0, float fParam1, float fParam2) // Position - 0xC589{
float num;
float num2;
...
}elseif(func_101(&(uLocal_190[4 /*10*/].f_3)) > 2f){
...
}elseif(func_101(&(uLocal_190[6 /*10*/].f_3)) > 3.5f){
...
}elseif(func_101(&(uLocal_190[1 /*10*/].f_3)) > 1.2f){
...
}elseif(func_101(&(uLocal_190[0 /*10*/].f_3)) > 0.7f){
...
i < 15;
i=i + 1){
if(func_16(&(uLocal_190[i /*10*/].f_6))) func_103(&(uLocal_190[i /*10*/].f_6));
}
func_298(uParam0, 10, 0f, true);
PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
return;
...
}elseif(func_101(&(uLocal_190[5 /*10*/].f_3)) > 3.5f){
...
if(!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false))if(!func_177(uParam0))if(ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, "oddjobs@towingcome_here", "come_here_idle_a", 3)) TASK::STOP_ANIM_TASK(uParam0->f_3, "oddjobs@towingcome_here", "come_here_idle_a", -1056964608);
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, "oddjobs@towingcome_here", "come_here_idle_c", 3)) TASK::STOP_ANIM_TASK(uParam0->f_3, "oddjobs@towingcome_here", "come_here_idle_c", -1056964608);
...
func_336(uParam0, &string1);
TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_130), "TAXI_OBJ_F_SPK", 24);
if(func_177(uParam0))if(VEHICLE::IS_VEHICLE_STOPPED(uParam0->f_4)) func_333(uParam0, 4096, false);
else func_333(uParam0, 0, false);
}elseif(iParam2==6){
...
if(!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false))if(func_170(PLAYER::PLAYER_PED_ID(), uParam0->f_3, true) < 40f && !ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_3)) return true;
return false;
}
...
case 0:
if(caLocal_409.f_410==9)if(!func_369(&caLocal_409))if(func_368("TX_OBJ_GYB_DO") || HUD::DOES_BLIP_EXIST(caLocal_409.f_9)) uLocal_1034.f_27=uLocal_1034.f_27 + 1;
elseif(func_367(&caLocal_409) !=10) func_228(&caLocal_409, 10, 1, false, true);
break;
case 1:
...
switch (uParam0->f_411){
case 0:
if(func_186("TX_OBJ_NEX_DO", 0, 0)) return true;
break;
case 1:
if(func_186("TX_OBJ_TIE_DO", 0, 0)) return true;
break;
case 2:
if(func_186("TX_OBJ_DL_DO", 0, 0)) return true;
break;
case 3:
if(func_186("TX_OBJ_GYB_DO", 0, 0) || func_186("TAXI_OBJ_GYB", 0, 0) || func_186("TAXI_OBJ_GYB_2", 0, 0)) return true;
break;
case 4:
if(func_186("TX_OBJ_TTB_DO", 0, 0)) return true;
break;
case 5:
if(func_186("TX_OBJ_CYI_DO", 0, 0) || func_186("TAXI_OBJ_CYI_01", 0, 0) || func_186("TAXI_OBJ_CYI_02", 0, 0)) return true;
break;
case 6:
if(func_186("TX_OBJ_GYN_DO", 0, 0) || func_186("TAXI_OBJ_GYN", 0, 0) || func_186("TAXI_OBJ_GYN_TG", 0, 0) || func_186("TAXI_OBJ_GYN_GF", 0, 0)) return true;
break;
case 7:
if(func_186("TAXI_OBJ_CC1", 0, 0) || func_186("TAXI_OBJ_CC2", 0, 0) || func_186("TAXI_OBJ_CC3", 0, 0)) return true;
break;
case 8:
if(func_186("TAXI_OBJ_FTC1", 0, 0) || func_186("TAXI_OBJ_FTC2", 0, 0) || func_186("TAXI_OBJ_FTC3", 0, 0)) return true;
break;
case 9:
if(func_186("TX_OBJ_PRO_DO", 0, 0)) return true;
break;
}
...
BOOL flag;
unk13=8;
if(func_346(uParam0)){}elseif(!uParam0->f_110){}elseif(func_305(uParam0, 14)){
...
if(uParam0->f_411 !=9) func_363(uParam0, &unk, 0, false, 8);
}else{
...
if(uParam0->f_411 !=9) func_363(uParam0, &unk, 0, true, 8);
elseif(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "TAXI_WHAT_THE_HELL", uParam0->f_145, 4);
break;
}}elseif(func_111(uParam0, 16) > uParam0->f_411==0 ? 1f :
...
func_230(&unk);
if(uParam0->f_411 !=9) func_363(uParam0, &unk, 0, false, 8);
else func_255(uParam0->f_3, "TAXI_START", uParam0->f_145, 4);
if(uParam0->f_411 !=7 && uParam0->f_411 !=4){
if(!HUD::DOES_BLIP_EXIST(uParam0->f_9)){
uParam0->f_9=func_359(uParam0->f_17, true);
}elseif(HUD::GET_BLIP_ALPHA(uParam0->f_9)==0){
...
TEXT_LABEL_APPEND_STRING(&unk, "_bant2", 24);
if(uParam0->f_411 !=6) func_230(&unk);
}
func_355(unk, uParam1);
func_298(uParam0, 11, 0, false);
func_298(uParam0, 16, 0, false);
...
if(uParam0->f_411==2) func_354(&(uParam0->f_90), 8, &unk, &unk13, true, false);
else func_354(&(uParam0->f_90), 3, &unk, &unk13, true, false);
func_355(unk, uParam1);
...
if(uParam0->f_411==2) func_354(&(uParam0->f_89), 8, &unk, &unk13, true, false);
else func_354(&(uParam0->f_89), 3, &unk, &unk13, true, false);
func_355(unk, uParam1);
...
func_230(&unk);
if(uParam0->f_411==5) func_355(unk, uParam1);
else func_363(uParam0, &unk, 0, false, 8);
...
if(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "CRASH_GENERIC", uParam0->f_145, 4);
}elseif(uParam0->f_411==1){
...
if(uParam0->f_411==0) func_365(&(uParam0->f_95), 8, &unk7, true, true, false);
else func_365(&(uParam0->f_95), 5, &unk7, true, true, false);
func_139(&(uParam0->f_244), uParam0->f_144, &unk, &unk7, 8, 0, 0);
}
...
if(uParam0->f_411==0) func_122(&(uParam0->f_83), 4);
else func_122(&(uParam0->f_83), 1);
func_298(uParam0, 16, 0, false);
...
case 79:
if(uParam0->f_411==1 || uParam0->f_411==0) flag=true;
if(!func_22(uParam0->f_81, 4096)) func_358(uParam0, 4096, unk, "_sideW1", flag, 8);
elseif(!func_22(uParam0->f_81, 8192)) func_358(uParam0, 8192, unk, "_sideW2", flag, 8);
func_364(15, &(uParam0->f_57), &(uParam0->f_55), &(uParam0->f_124), unk, false);
func_259(uParam0, 0, false);
break;
case 80:
if(uParam0->f_411==1 || uParam0->f_411==0) flag=true;
if(!func_22(uParam0->f_81, 16384)) func_358(uParam0, 16384, unk, "_opLne1", flag, 8);
elseif(!func_22(uParam0->f_81, 32768)) func_358(uParam0, 32768, unk, "_opLne2", flag, 8);
func_364(14, &(uParam0->f_57), &(uParam0->f_55), &(uParam0->f_124), unk, false);
func_259(uParam0, 0, false);
break;
case 83:
if(uParam0->f_411==0){
if(!func_22(uParam0->f_82, 8)) func_351(uParam0, 8, unk, "_bored1", 8, false);
elseif(!func_22(uParam0->f_82, 16)) func_351(uParam0, 16, unk, "_bored2", 8, false);
elseif(!func_22(uParam0->f_82, 32)) func_351(uParam0, 32, unk, "_bored3", 8, false);
...
break;
case 81:
if(!func_22(uParam0->f_81, 65536)) func_358(uParam0, 65536, unk, "_runLit1", true, 8);
elseif(!func_22(uParam0->f_81, 131072)) func_358(uParam0, 131072, unk, "_runLit2", true, 8);
func_259(uParam0, 0, false);
break;
case 82:
if(func_352(uParam0)){
...
if(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "CAR_HIT_PED_DRIVEN", uParam0->f_145, 4);
...
if(uParam0->f_411==0) func_122(&(uParam0->f_83), 64);
else func_122(&(uParam0->f_83), 8);
func_298(uParam0, 16, 0, false);
...
break;
case 25:
if(!func_22(uParam0->f_82, 1)) func_351(uParam0, 1, unk, "_close1", 8, false);
elseif(!func_22(uParam0->f_82, 2)) func_351(uParam0, 2, unk, "_close2", 8, false);
elseif(!func_22(uParam0->f_82, 4)) func_351(uParam0, 4, unk, "_close3", 8, false);
func_259(uParam0, 0, false);
break;
case 48:
...
if(uParam0->f_411 !=9) func_139(&(uParam0->f_244), uParam0->f_144, &unk, &unk7, 8, 0, 0);
elseif(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "TAXI_STOPPED", uParam0->f_145, 4);
func_298(uParam0, 16, 0, false);
...
if(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "VEHICLE_FLIPPED", uParam0->f_145, 4);
}else{
...
if(uParam0->f_411 !=9) func_363(uParam0, &unk, 0, false, 8);
elseif(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "POLICE_PURSUIT_DRIVEN", uParam0->f_145, 4);
func_298(uParam0, 16, 0, false);
func_259(uParam0, 0, false);
break;
case 51:
...
break;
case 84:
if(!func_22(uParam0->f_81, 262144)) func_358(uParam0, 262144, unk, "_rdCh1", true, 8);
elseif(!func_22(uParam0->f_81, 1048576))if(uParam0->f_411==0 || uParam0->f_411==1) func_358(uParam0, 1048576, unk, "_rdCh2", true, 8);
else func_358(uParam0, 1048576, unk, "_rdCh2", false, 8);
func_364(7, &(uParam0->f_57), &(uParam0->f_55), &(uParam0->f_124), unk, false);
func_259(uParam0, 0, false);
break;
case 85:
if(!func_22(uParam0->f_82, 67108864))if(uParam0->f_418.f_6) func_349(uParam0, 67108864, unk, "_rdLk1", true, 7);
elseif(!func_22(uParam0->f_82, 134217728)) func_349(uParam0, 134217728, unk, "_rdFv1", false, 7);
...
if(uParam0->f_411==1 || uParam0->f_411==5 || uParam0->f_411==0) func_230(&unk);
func_171(&(uParam0->f_81), 2097152);
if(uParam0->f_411 !=9) func_363(uParam0, &unk, 0, false, 8);
break;
case 102:
...
break;
case 105:
if(!func_22(uParam0->f_81, 33554432) && uParam0->f_411 !=9) func_358(uParam0, 33554432, unk, "_noPay1", true, 8);
elseif(uParam0->f_411==9)if(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "TAXI_NO_PAY", uParam0->f_145, 4);
...
break;
case 107:
if(!func_22(uParam0->f_81, 268435456)) func_358(uParam0, 268435456, unk, "_kPay1", true, 8);
func_228(uParam0, 52, 1, false, false);
break;
case 108:
...
break;
case 109:
if(!func_22(uParam0->f_81, 4194304))if(uParam0->f_411==2 || uParam0->f_411==6) func_358(uParam0, 4194304, unk, "_mPay1", false, 8);
elseif(uParam0->f_411==9)if(!PED::IS_PED_INJURED(uParam0->f_3)) func_255(uParam0->f_3, "APOLOGY_NO_TROUBLE", uParam0->f_145, 4);
else func_358(uParam0, 4194304, unk, "_mPay1", true, 8);
...
break;
case 141:
if(!func_22(uParam0->f_81, 16777216)) func_358(uParam0, 16777216, unk, "_ret1", true, 8);
func_259(uParam0, 0, false);
break;
case 88:
...
func_298(uParam0, 16, 0, false);
TEXT_LABEL_APPEND_STRING(&uParam2, sParam8, 24);
if(uParam0->f_411==1 || uParam0->f_411==0 || uParam0->f_411==5 || uParam0->f_411==8 || uParam0->f_411==2)if(bParam10) func_230(&uParam2);
...
if(!PED::IS_PED_INJURED(uParam0->f_3)) AUDIO::INTERRUPT_CONVERSATION(uParam0->f_3, &uParam1, func_361(uParam0));
return;
}
...
func_298(uParam0, 16, 0, false);
if(bParam3) func_298(uParam0, 17, 0f, true);
...
if(!MISC::IS_STRING_NULL(sParam0))if(func_186(sParam0, 0, 0)) return true;
return false;
}
BOOL func_369(var uParam0) // Position - 0x11F5D{
if(_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) return true;
if(func_305(uParam0, 17)) return true;
if(func_305(uParam0, 14)) return true;
if(func_184(uParam0)) return true;
return false;
}
...
if(func_305(uParam0, 17))if(!func_305(uParam0, 14))if(!func_184(uParam0))if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS()) func_110(uParam0, 17, true);
return;
}
...
if(StackVal) func_165(&iLocal_343.f_1[i /*4*/], 8);
}}}}}else{
...
if(uParam0->f_410 >=3 && uParam0->f_410 <=5) func_376(uParam0);
...
int num;
int num2;
if(!func_396(iParam1) || !func_396(iParam0)) return 1;
...
var func__385(BOOL bParam0, var uParam1, var uParam2) // Position - 0x124B1{
if(bParam0) return uParam1;
return uParam2;
}
...
if(num6 < 1 || num6 > func_394(num5, num4)) return false;
return true;
}
...
var func__398(var uParam0) // Position - 0x12A97{
return uParam0;
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
vehiclePedIsIn=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false))if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(vehiclePedIsIn, -1, false)==PLAYER::PLAYER_PED_ID())if(VEHICLE::IS_VEHICLE_MODEL(vehiclePedIsIn, func_21())) return true;
}}
return false;
}
...
switch (*uParam1){
case 1:
if(func_401(uParam0, false, 1)) func_330(uParam0, "Aggro Aiming", 5);
break;
case 4:
if(func_401(uParam0, false, 4)) func_330(uParam0, "Aggro Shot Near", 8);
break;
case 8:
if(func_401(uParam0, false, 8)) func_330(uParam0, "Aggro Heard Shot", 8);
break;
case 16:
if(func_401(uParam0, true, 1)) func_330(uParam0, "Aggro Attacked", 14);
break;
case 32:
if(func_401(uParam0, false, 1)) func_330(uParam0, "Aggro Minor Attacked", 8);
break;
case 2:
if(!func_22(*uParam2, 2) && func_177(uParam0)) func_330(uParam0, "Aggro Went Wanted", 5);
break;
}
return;
}
...
elseif(!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, false))if(!ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_3))if(iParam2==4) func_228(uParam0, 66, 1, false, true);
else func_228(uParam0, 65, 1, false, true);
return false;
}
...
if(func_404(PLAYER::PLAYER_PED_ID(), pedParam0)) return true;
if(bParam2){
if(PED::IS_PED_RAGDOLL(pedParam0) && func_163(pedParam0, true) < 1.5f) return true;
...
if(PED::IS_PED_PLANTING_BOMB(pedParam0) || func_407(vehiclePedIsIn))if(ENTITY::IS_ENTITY_AT_COORD(pedParam1, ENTITY::GET_ENTITY_COORDS(pedParam0, true), (float)uParam2->f_6 * 3, (float)uParam2->f_6 * 3, (float)uParam2->f_6 * 3, false, true, 0))if(PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam1), pedParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam1, pedParam0, 17)) return true;
}}
...
iLocal_1123=MISC::GET_GAME_TIMER();
unk={
202.0472f, -3314.8298f, 5.9369f 
};
unk4={
-1.9358f, -0.0169f, 169.6817f 
};
num=20.9113f;
func_410(unk, unk4, num);
iLocal_1122=3;
...
iLocal_1123=MISC::GET_GAME_TIMER();
unk={
194.7488f, -3328.101f, 5.9471f 
};
unk4={
-0.3369f, -0.0169f, -55.7257f 
};
num=24.5237f;
func_410(unk, unk4, num);
iLocal_1122=4;
...
}elseif(func_101(&uLocal_1030) > 0.3f){
if(CAM::DOES_CAM_EXIST(caLocal_409)){
if(CAM::IS_CAM_ACTIVE(caLocal_409)){
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
if(!CAM::DOES_CAM_EXIST(caLocal_409)) func_239(&caLocal_409, 0f, 0f, 0f, 0f, 0f, 0f, fParam6);
...
func_435(2);
if(bLocal_968)if(func_10(PLAYER::PLAYER_PED_ID(), caLocal_409.f_17, true) > 50f || func_128(&(uLocal_839.f_3), &(uLocal_839.f_11), &(uLocal_881.f_3), &(uLocal_881.f_11))) func_433();
else func_433();
return;
}
...
if(!VEHICLE::IS_VEHICLE_STOPPED(uParam0->f_4)) func_333(uParam0, 4160, false);
else func_333(uParam0, 0, false);
return true;
}else{
func_333(uParam0, 0, false);
...
caLocal_409.f_23={
107.3107f, -1124.8654f, 28.198f 
};
caLocal_409.f_33=88.9745f;
caLocal_409.f_26={
195.7672f, -2981.732f, 4.8916f 
};
...
if(!func_22(Global_113648.f_19099, 4)) func_171(&(Global_113648.f_19099), 4);
func_425(uParam0);
func_423(uParam0);
