...
sLocal_20="NULL";
while (true){
if(_SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1961986==1) func_6();
if(func_1(&uLocal_21, &Global_297007)) func_6();
SYSTEM::WAIT(0);
}
return;
}
...
Hash tunableContext;
if(uParam0->f_2){
if(MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(MISC::GET_GAME_TIMER(), uParam0->f_1)) >=uParam0->f_3) func_5();
}else{
...
}}elseif(NETWORK::NETWORK_ACCESS_TUNABLE_INT_HASH(tunableContext, num2.f_5, &value)){
...
if(func_14()) return true;
if(Global_2696915) return true;
if(func_13()) return true;
if(_DOES_EVENT_OF_TYPE_EXIST(159))if(!func_11()) return true;
