...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)) func_37(false);
if(func_36(Global_113648.f_20119, 16384)) func_37(false);
while (true){
SYSTEM::WAIT(0);
...
break;
case 1:
iLocal_101=PED::CREATE_SYNCHRONIZED_SCENE(uLocal_91 +{
1f, 0f, 0f 
}
, 0f, 0f, fLocal_94, 2);
...
case 3:
entityCoords={
ENTITY::GET_ENTITY_COORDS(pedLocal_95, true) 
};
...
}}elseif(HUD::DOES_BLIP_EXIST(blLocal_100)){
func_4(&blLocal_100);
}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_101) > 0.9999999f) iLocal_99=1;
...
break;
case 4:
if(HUD::DOES_BLIP_EXIST(blLocal_100)) func_4(&blLocal_100);
if(!PED::IS_PED_RAGDOLL(pedLocal_95)){
if(iLocal_97==1) TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedLocal_95, 723.1315f, 4171.9565f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
else TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedLocal_95, 723.1315f, 4171.9565f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
...
if(iLocal_97==1) TASK::TASK_SMART_FLEE_PED(pedLocal_95, PLAYER::PLAYER_PED_ID(), 100f, -1, false, false);
else TASK::TASK_WANDER_STANDARD(pedLocal_95, 1193033728, 0);
PED::SET_PED_KEEP_TASK(pedLocal_95, true);
iLocal_99=5;
}
break;
case 5:
if(ENTITY::IS_ENTITY_OCCLUDED(pedLocal_95) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(pedLocal_95, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 50f && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_37(true);
break;
case 7:
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) func_37(false);
break;
}}
return;
}
...
float num;
unk={
func_3(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) 
};
...
func_3(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) 
};
...
Vector3 func__3(float fParam0, var uParam1, var uParam2) // Position - 0x546{
float num;
float num2;
...
var func__8(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6CF{
...
if(STREAMING::HAS_MODEL_LOADED(hLocal_90) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_98)) return true;
return false;
}
BOOL func_12() // Position - 0x782{
if(!_CAN_ENTER_FREEROAM_STATE(5)) return true;
if(func_28()) return true;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_27()) return false;
if(func_13(100f, true) !=-1) return true;
return false;
}
...
if(func_25(character)) return func_24(character);
...
if(func_31() && !func_27()) return true;
if(func_30() && func_29()) return true;
return false;
}
...
if(SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_27()) return false;
}
if(func_28()) return true;
if(func_13(100f, true) !=-1) return true;
return false;
...
if(ENTITY::DOES_ENTITY_EXIST(obLocal_96)) OBJECT::DELETE_OBJECT(&obLocal_96);
if(HUD::DOES_BLIP_EXIST(blLocal_100)) func_4(&blLocal_100);
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_95))if(bParam0) PED::DELETE_PED(&pedLocal_95);
else ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_95);
