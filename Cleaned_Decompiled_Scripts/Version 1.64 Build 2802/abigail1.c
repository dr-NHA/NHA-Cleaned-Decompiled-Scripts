...
TASK::TASK_PLAY_ANIM(iLocal_149, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
...
uLocal_150=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
CAM::SET_CAM_PARAMS(uLocal_150, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_150, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SHAKE_CAM(uLocal_150, "HAND_SHAKE", 0.3f);
}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_149, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
}}else{
...
if(iParam4==1){
if(func_281(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam5, &Var0, &uVar3)){
Param0={
Var0 
};
fParam3=uVar3;
...
void func_237(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6){
struct<60> Var0;
...
func_271(iParam5, &Var0, Param1, uParam4, func_274(iParam0));
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_263(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_271(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_268(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
void func_286(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18){
var uVar0;
bool bVar1;
bool bVar2;
int iVar3;
