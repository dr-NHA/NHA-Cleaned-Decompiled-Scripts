...
fLocal_32=180f;
iLocal_35=3;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19)) func_36();
while (true){
SYSTEM::WAIT(0);
...
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !PED::IS_PED_FLEEING(pedLocal_205) && !PED::IS_PED_RAGDOLL(pedLocal_205) && !PED::IS_PED_PRONE(pedLocal_205) && !PED::IS_PED_INJURED(pedLocal_205) && !PED::IS_PED_IN_ANY_VEHICLE(pedLocal_205, false))if(func_27(pedLocal_205, PLAYER::PLAYER_PED_ID(), true) <=2.3f)if(MISC::GET_GAME_TIMER() - iLocal_203 > 8000)if(_CONVERSATION_ADD_LINE(&uLocal_38, "EPS4AUD", "EPS4_FOLLJ", 7, 0, 0, 0)) iLocal_203=MISC::GET_GAME_TIMER();
if(func_27(pedLocal_205, PLAYER::PLAYER_PED_ID(), true) > 150f) func_3(&pedLocal_205);
}else{
func_2(&pedLocal_205, true, 0, 1);
}
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_204)){
if(!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !PED::IS_PED_FLEEING(pedLocal_204) && !PED::IS_PED_RAGDOLL(pedLocal_204) && !PED::IS_PED_PRONE(pedLocal_204) && !PED::IS_PED_INJURED(pedLocal_204) && !PED::IS_PED_IN_ANY_VEHICLE(pedLocal_204, false))if(func_27(pedLocal_204, PLAYER::PLAYER_PED_ID(), true) <=2.7f)if(MISC::GET_GAME_TIMER() - iLocal_203 > 8000)if(_CONVERSATION_ADD_LINE(&uLocal_38, "EPS4AUD", "EPS4_FOLLM", 7, 0, 0, 0)) iLocal_203=MISC::GET_GAME_TIMER();
if(func_27(pedLocal_204, PLAYER::PLAYER_PED_ID(), true) > 150f) func_3(&pedLocal_204);
}else{
func_2(&pedLocal_204, true, 0, 1);
}
if(!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_204) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_205)) iLocal_37=2;
return;
}
...
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(pedLocal_205)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(pedLocal_205, true, false);
...
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(pedLocal_204)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(pedLocal_204, true, false);
