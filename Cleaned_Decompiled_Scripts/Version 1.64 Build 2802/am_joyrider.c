...
ENTITY::SET_ENTITY_HEALTH(NETWORK::NET_TO_PED(Local_61.f_3), SYSTEM::ROUND((200f * Global_262145.f_165)), 0);
...
return MISC::IS_BIT_SET(uLocal_170, 1);
}
...
void func_41(){
if(!MISC::IS_BIT_SET(uLocal_170, 0)){
if(func_4(Local_61.f_2)){
