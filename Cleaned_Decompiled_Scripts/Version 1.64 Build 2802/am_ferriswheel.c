...
func_160();
if(MISC::IS_BIT_SET(uLocal_418, 3)){
...
Local_1142.f_197[iLocal_397 /*2*/].f_1=uVar1;
...
break;
}}elseif((Local_1142.f_3[iLocal_397] !=0 || Local_1142.f_197[iLocal_397 /*2*/] !=-1) || Local_1142.f_197[iLocal_397 /*2*/].f_1 !=0){
...
if(((Local_1142.f_262 !=-1 && !MISC::IS_BIT_SET(Local_1406[Local_1142.f_262 /*5*/].f_2, 6)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYER_PED(Local_1142.f_197[Local_1142.f_262 /*2*/].f_1), -1661.95f, -1127.011f, 12.6973f, 1f, 1f, 2f, 0, 1, 0)) && MISC::IS_BIT_SET(Local_1142.f_2, 2)){
if(!MISC::IS_BIT_SET(Local_1142.f_2, 1)){
MISC::SET_BIT(&(Local_1142.f_2), 1);
}}elseif(MISC::IS_BIT_SET(Local_1142.f_2, 1)){
...
if(MISC::IS_BIT_SET(uLocal_418, 0)){
HUD::CLEAR_HELP(1);
MISC::CLEAR_BIT(&uLocal_418, 0);
}
if(!MISC::IS_BIT_SET(uLocal_418, 1)){
...
elseif(!MISC::IS_BIT_SET(Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 4)){
...
MISC::CLEAR_BIT(&(Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 3);
iLocal_429=1;
}}elseif(!MISC::IS_BIT_SET(Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 8)){
...
}}elseif(MISC::IS_BIT_SET(uLocal_418, 0)){
HUD::CLEAR_HELP(1);
MISC::CLEAR_BIT(&uLocal_418, 0);
}}
}
...
func_91();
}}elseif(((((((!func_147(0) && !func_143(PLAYER::PLAYER_ID())) && !func_142(PLAYER::PLAYER_ID(), 21)) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && VEHICLE::GET_CLOSEST_VEHICLE(-1661.95f, -1127.011f, 12.6973f, 1f, 0, 6)==0) && !func_76()) && !Global_1574582.f_6){
if(!func_137()){
if(MISC::IS_BIT_SET(Local_1142.f_2, 1)){
...
elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1661.95f, -1127.011f, 12.6973f, 1f, 1f, 2f, 0, 1, 0)){
...
func_77(func_78(1));
}}elseif(!MISC::IS_BIT_SET(uLocal_418, 2)){
...
if(!MISC::IS_BIT_SET(uLocal_418, 5)){
...
}}elseif(func_20(&uLocal_422, 2000, 0)){
if(((TASK::IS_PED_WALKING(PLAYER::PLAYER_PED_ID()) || TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) || TASK::IS_PED_SPRINTING(PLAYER::PLAYER_PED_ID())) || TASK::IS_PED_STRAFING(PLAYER::PLAYER_PED_ID())){
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Var0.f_0, Var0.f_1, (Var0.f_2 + 2f), 1, 0, 0, 1);
...
void func_41(){
if(MISC::IS_BIT_SET(uLocal_418, 8)){
func_42(&iLocal_319);
func_42(&iLocal_321);
func_42(&iLocal_322);
func_42(&iLocal_320);
...
if(bParam0){
if(!MISC::IS_BIT_SET(uLocal_418, 6)){
func_52(0, 0);
MISC::SET_BIT(&uLocal_418, 6);
}}elseif(MISC::IS_BIT_SET(uLocal_418, 6)){
func_46();
...
}elseif(bVar14 || (!func_63(PLAYER::PLAYER_ID(), 0) && !func_62())){
...
var uVar6;
Var0={
-1661.914f, -1126.842f, 12.6973f 
};
if(!MISC::IS_BIT_SET(uLocal_418, 7)){
...
}elseif(func_75(Local_424, 4000, 1)){
...
Local_315={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_290[Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], 0f, 0f, 0f) 
};
if(!Local_1142.f_36[Local_1142.f_197[Local_1142.f_262 /*2*/] /*10*/][0]){
Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4=0;
}elseif(!Local_1142.f_36[Local_1142.f_197[Local_1142.f_262 /*2*/] /*10*/][1]){
Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4=1;
}
...
break;
case 2:
uVar6=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uLocal_426);
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_290[Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) 
};
ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_290[Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], 0, Var3, 0f, 0f, ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), 0, 0, 0, 0, 2, 1, 0);
...
Var0.f_6=uParam5;
if(!iParam0==0){
SCRIPT::SEND_TU_SCRIPT_EVEN(1, &Var0, 7, iParam0);
}}
...
void func_92(){
if(MISC::IS_BIT_SET(Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0)){
if(MISC::IS_BIT_SET(uLocal_418, 4)){
...
func_103(&uLocal_431);
func_102(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 236, 1), "AMFW_BTNCV", &uLocal_431, 0);
if(!MISC::IS_BIT_SET(Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 3)){
func_102(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 51, 1), "AMFW_BTNEX", &uLocal_431, 0);
}
iLocal_429=0;
}
...
uLocal_430=GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
...
func_97(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar2, 1));
if(iVar3 < 363){
func_97(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar3, 1));
}}else{
uVar4=uParam2->f_1[bVar0 /*57*/].f_54;
uVar5=uParam2->f_1[bVar0 /*57*/].f_55;
func_97(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(uVar4, uVar5, 1));
}
...
uParam0->f_14=(uParam0->f_14 + func_107(((((Var10.f_0 - uParam0->f_14) * 0.05f) * fVar9) * fParam7), -3f, 3f));
uParam0->f_14.f_1=(uParam0->f_14.f_1 + func_107(((((Var10.f_1 - uParam0->f_14.f_1) * 0.05f) * fVar9) * fParam7), -3f, 3f));
uParam0->f_14.f_2=(uParam0->f_14.f_2 + func_107(((((Var10.f_2 - uParam0->f_14.f_2) * 0.05f) * fVar9) * fParam7), -3f, 3f));
}
if(uParam0->f_26){
...
}elseif(func_44(uParam0->f_8) && func_44(uParam0->f_9)){
...
CAM::ATTACH_CAM_TO_PED_BONE(Local_325.f_0, PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f, 1);
}else{
...
void func_117(){
int iVar0;
if(func_135(1) >=Global_262145.f_8254 || MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_8254, 0, 0, 1, -1, 0)){
if(func_134()){
func_122(1643659499, Global_262145.f_8254, &iVar0, 0, 1, 0);
Global_4535172[iVar0 /*85*/].f_1=2;
}else{
MONEY::NETWORK_BUY_FAIRGROUND_RIDE(Global_262145.f_8254, 2, 0, 1, 0);
}
MISC::SET_BIT(&(Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 8);
}elseif(!MISC::IS_BIT_SET(uLocal_418, 3)){
func_118(0, 31, 5);
...
var func__145(int iParam0, int iParam1){
...
if(((Local_1142.f_262 !=-1 && MISC::IS_BIT_SET(Local_1142.f_2, 0)) && Global_2800917 < Local_1142.f_36[Local_1142.f_197[Local_1142.f_262 /*2*/] /*10*/].f_6) && (Global_2800917 + (fLocal_308 * fVar4)) > Local_1142.f_36[Local_1142.f_197[Local_1142.f_262 /*2*/] /*10*/].f_6){
...
ENTITY::SET_ENTITY_ROTATION(uLocal_307, (-Global_2800917 - (360f / 16f)), 0f, 0f, 2, 1);
...
ENTITY::SET_ENTITY_COORDS(uLocal_307, Local_309, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_307, Global_2800917, 0f, 0f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_307, true);
ENTITY::SET_ENTITY_LOD_DIST(uLocal_307, 1000);
ENTITY::SET_ENTITY_INVINCIBLE(uLocal_307, 1);
ENTITY::SET_ENTITY_USE_MAX_DISTANCE_FOR_WATER_REFLECTION(uLocal_307, 0);
if(!AUDIO::IS_AUDIO_SCENE_ACTIVE("FAIRGROUND_RIDES_FERRIS_WHALE")){
AUDIO::START_AUDIO_SCENE("FAIRGROUND_RIDES_FERRIS_WHALE");
}
iVar0=0;
...
NETWORK::NETWORK_ALLOW_REMOTE_ATTACHMENT_MODIFICATION(uVar2, 1);
...
if(func_13(Var0.f_1, 1, 1)){
NETWORK::NETWORK_ALLOW_REMOTE_ATTACHMENT_MODIFICATION(uVar7, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uVar7, iLocal_290[Var0.f_2], 0, Var0.f_3, 0f, 0f, Var0.f_6, 0, 0, 0, 0, 2, 1, 0);
}}}}
...
void func_202(var uParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_201();
}
