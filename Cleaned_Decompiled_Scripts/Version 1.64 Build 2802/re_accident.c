...
iLocal_352=-1;
Local_523={
-458.4085f, -984.6459f, 22.5892f 
};
Local_526={
-458.1934f, -995.4897f, 22.7427f 
};
Local_305={
...
if(HUD::DOES_BLIP_EXIST(uLocal_326)){
HUD::REMOVE_BLIP(&uLocal_326);
}
iLocal_535=1;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_7(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(iVar0 > 0){
fVar4=(fVar4 + MISC::GET_DISTANCE_BETWEEN_COORDS(Local_229[(iVar0 - 1) /*5*/], Local_229[iVar0 /*5*/], 1));
}
if(Local_229[iVar0 /*5*/].f_4){
if(FIRE::GET_CLOSEST_FIRE_POS(&Var1, Local_229[iVar0 /*5*/])){
fVar6=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_229[iVar0 /*5*/], Var1, 1);
if(fVar6 < fVar7){
fVar7=fVar6;
fVar8=fVar4;
iVar5=iVar0;
...
Local_66[iLocal_226 /*5*/].f_1={
Param0 
};
Local_66[iLocal_226 /*5*/]=FIRE::START_SCRIPT_FIRE(Param0, uLocal_55, iParam3);
iLocal_226++;
if(iLocal_226 >=31){
iLocal_226=0;
}}
...
fVar2=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_59, HUD::GET_BLIP_COORDS(Local_229[iVar0 /*5*/].f_3), 1);
fVar3=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_229[iVar0 /*5*/], HUD::GET_BLIP_COORDS(Local_229[iVar0 /*5*/].f_3), 1);
...
switch (iLocal_302){
case 0:
AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", 0, -1);
...
func_108(&Local_537);
if((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", 0, -1) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction")) && func_104(&Local_537)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_319, 0)){
iLocal_317=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_319, 26, joaat("s_m_m_dockwork_01"), -1, 1, 1);
...
TASK::TASK_PLAY_ANIM(iLocal_317, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, 0, 0, 0);
iLocal_340=OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("p_amb_phone_01"));
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_340, iLocal_317, PED::GET_PED_BONE_INDEX(iLocal_317, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
...
uLocal_318=PED::CREATE_PED(26, joaat("s_m_m_dockwork_01"), -462.2982f, -978.3272f, 65f, 221.4041f, 1, 1);
...
iLocal_339=OBJECT::CREATE_OBJECT(joaat("prop_generator_01a"), Local_526.f_0, (Local_526.f_1 + 0.5f), (Local_526.f_2 - 0.25f), 1, 1, 0);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_357);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_357);
TASK::TASK_PERFORM_SEQUENCE(iLocal_317, uLocal_357);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_357);
func_95();
}
STREAMING::REQUEST_MODEL(joaat("prop_ld_pipe_single_01"));
if((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID())) && func_94(1, 0, 1)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_pipe_single_01"))){
if(!func_134()){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_319, 0) && !HUD::DOES_BLIP_EXIST(uLocal_324)){
uLocal_324=func_96(iLocal_319, 0, 0);
}
}
elseif(!HUD::DOES_BLIP_EXIST(uLocal_323)){
if(HUD::DOES_BLIP_EXIST(uLocal_324)){
HUD::REMOVE_BLIP(&uLocal_324);
}
...
HUD::REMOVE_BLIP(&uLocal_325);
if(!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(iLocal_319, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_317, 0) && !HUD::DOES_BLIP_EXIST(uLocal_324)){
uLocal_324=func_96(iLocal_319, 0, 0);
}}}
}
elseif(!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(iLocal_319, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_317, 0) && HUD::DOES_BLIP_EXIST(uLocal_324)){
HUD::REMOVE_BLIP(&uLocal_324);
if(!HUD::DOES_BLIP_EXIST(uLocal_325)){
...
var func__29(int iParam0, int iParam1){
...
}}}elseif(!HUD::DOES_BLIP_EXIST(uLocal_325)){
uLocal_325=func_96(iLocal_320, 0, 0);
if(HUD::DOES_BLIP_EXIST(uLocal_324)){
HUD::REMOVE_BLIP(&uLocal_324);
}}
...
if(!bLocal_345){
if(!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(iLocal_319, 0)){
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_317, iLocal_319, -1, 0, 0) && !VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_317, iLocal_319, 0, 0, 0)){
func_46();
SYSTEM::WAIT(0);
func_24(&uLocal_358, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
bLocal_345=true;
...
if(VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_317, iLocal_319, -1, 0, 0) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_317, iLocal_319, 0, 0, 0)){
if(VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_317, iLocal_319, -1, 0, 0)){
bLocal_344=true;
Local_314={
ENTITY::GET_ENTITY_COORDS(iLocal_319, 0) + Vector(0f, -1f, -3f) 
};
}
else{
Local_314={
ENTITY::GET_ENTITY_COORDS(iLocal_319, 0) + Vector(0f, 1.5f, -3f) 
};
}
...
case 3:
if(!PED::IS_PED_INJURED(iLocal_317)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_317, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, 0, 1, 0) || (MISC::GET_GAME_TIMER() - iLocal_351) > 10000){
...
case 4:
if(!PED::IS_PED_INJURED(iLocal_317)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_317, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, 0, 1, 0) || (MISC::GET_GAME_TIMER() - iLocal_351) > 10000){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_319, 0)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_319, 0);
ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_319, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
VEHICLE::EXPLODE_VEHICLE(iLocal_319, 1, 0);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_357, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_357);
TASK::TASK_PERFORM_SEQUENCE(iLocal_317, uLocal_357);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_357);
}
...
var func__81(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_308, 30f, 0, 0, 0, 0, 0, 0, 0);
...
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_327[0], 11, 0);
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_327[0], 18, 0);
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_327[0], 19, 0);
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_327[0], 23, 0);
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_327[0], 9, 0);
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_327[0], 12, 0);
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_327[0], 17, 0);
...
TASK::TASK_PLAY_ANIM(iLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0f, 0, 0, 0);
...
if(!PED::IS_PED_INJURED(iLocal_317)){
TASK::TASK_LOOK_AT_COORD(iLocal_317, ENTITY::GET_ENTITY_COORDS(iLocal_317, 1) - Vector(10f, 0f, 2f), 30000, 2080, 2);
}
iLocal_354=MISC::GET_GAME_TIMER();
iLocal_303=7;
}
...
TASK::CLEAR_PED_TASKS(iLocal_317);
TASK::TASK_CLEAR_LOOK_AT(iLocal_317);
TASK::TASK_PLAY_ANIM(iLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0f, 0, 0, 0);
}
...
uLocal_327[1]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -457.8815f, -988.9059f, 22.9554f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[1], -0.1939f, 105.0058f, 77.3964f, 2, 1);
uLocal_327[2]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -451.5131f, -986.8079f, 24.6947f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[2], 24.3941f, 32.5423f, 80.6862f, 2, 1);
uLocal_327[3]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -450.8099f, -985.9972f, 24.7104f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[3], 24.1841f, 110.287f, 78.4357f, 2, 1);
uLocal_327[4]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.6558f, -987.3979f, 22.9537f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[4], -0.0264f, 29.5754f, 79.1811f, 2, 1);
uLocal_327[5]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.1279f, -988.4162f, 22.9889f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[5], -0.6337f, 108.4339f, 77.9539f, 2, 1);
uLocal_327[6]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -457.0807f, -987.3059f, 23.7564f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[6], 0.0929f, 74.2657f, 79.3839f, 2, 1);
uLocal_327[7]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.6558f, -983.7804f, 22.9712f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[7], -0.0264f, 29.5754f, 80.9061f, 2, 1);
uLocal_327[8]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -455.3279f, -983.1712f, 22.9564f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[8], -0.1087f, 109.7339f, 80.9789f, 2, 1);
uLocal_327[9]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.1632f, -983.9359f, 23.7964f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_327[9], -0.3321f, 74.1907f, 81.6089f, 2, 1);
uLocal_327[10]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -454.644f, -994.1709f, 23.3329f, 1, 1, 0);
...
Local_308={
-455.6561f, -985.8071f, 22.4868f 
};
iLocal_319=VEHICLE::CREATE_VEHICLE(joaat("utillitruck2"), Local_308, 80f, 1, 1, 0);
...
iLocal_320=VEHICLE::CREATE_VEHICLE(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, 1, 1, 0);
MISC::CLEAR_AREA(Local_308, 10f, 1, 0, 0, 0);
uLocal_327[0]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_pipe_stack_01"), -453.2f, -986.1f, 59.45f, 1, 1, 0);
...
Local_229[1 /*5*/]={
Local_526 + Vector(0f, 0.5f, 0f) 
};
Local_229[2 /*5*/]={
Local_526 + Vector(0f, 1f, 0f) 
};
Local_229[3 /*5*/]={
Local_526 + Vector(0f, 2.5f, 0f) 
};
Local_229[4 /*5*/]={
Local_526 + Vector(0f, 3f, 0f) 
};
Local_229[5 /*5*/]={
Local_526 + Vector(0f, 3.5f, 0f) 
};
Local_229[6 /*5*/]={
Local_526 + Vector(0f, 4f, 0f) 
};
Local_229[7 /*5*/]={
Local_526 + Vector(0f, 4.5f, 0f) 
};
Local_229[8 /*5*/]={
Local_526 + Vector(0f, 5f, 0f) 
};
Local_229[9 /*5*/]={
Local_526 + Vector(0f, 5.5f, 0f) 
};
Local_229[10 /*5*/]={
Local_526 + Vector(0f, 6f, 0f) 
};
Local_229[11 /*5*/]={
Local_526 + Vector(0f, 6.5f, 0f) 
};
Local_229[12 /*5*/]={
Local_526 + Vector(0f, 7f, 0f) 
};
Local_229[13 /*5*/]={
Local_523 
};
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_172()) || Global_112695) || Global_32166) || func_171()) || func_43(8, -1)) || func_170()) || func_169()) || func_168()) || func_167()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_172()) || Global_32166) || func_171()) || func_43(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_172()) || Global_112695) || Global_32166) || func_171()) || func_43(8, -1)) || func_168()) || func_170()) || func_169()) || func_167()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_172()) || Global_112695) || Global_32166) || func_171()) || func_43(8, -1)) || func_170()) || func_169()) || func_167()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_172()) || Global_32166) || func_171()) || func_43(8, -1)) || func_169()) || func_168()) || func_167()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_172()) || func_169()) || Global_112695) || Global_32166) || func_171()) || Global_44446) || func_43(8, -1)) || func_168()) || func_166()) || func_167()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_172()) || Global_112695) || Global_32166) || func_171()) || func_43(8, -1)) || func_168()) || func_166()) || func_170()) || func_169()) || func_167()){
return 0;
}
break;
}}else{
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_216(iParam0, 0, 0)) || func_216(iParam0, 1, 0)) || func_216(iParam0, 2, 0)) || func_215(iParam0) !=145) || func_214(iParam0)) || func_213(iParam0)) || func_212(iParam0)) || func_211(iParam0)) || !func_200(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_213(iParam0)){
}
if(func_213(iParam0)){
}
