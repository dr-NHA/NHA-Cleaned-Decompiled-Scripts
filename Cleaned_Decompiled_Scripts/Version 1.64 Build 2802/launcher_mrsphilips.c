...
func_236(&num);
iLocal_92=PED::ADD_SCENARIO_BLOCKING_AREA(vector -{
20f, 20f, 20f 
}
, vector +{
20f, 20f, 20f 
...
while (true){
SYSTEM::WAIT(0);
if(!IS_RC_FINE_AND_IN_RANGE(&num, 1)) func_251(&num, true);
func_197(num);
...
if(!func_2(&num)) func_251(&num, true);
if(func_1(&num)) func_251(&num, false);
}}
return;
}
...
var func__15(Hash hParam0) // Position - 0xBBB{
var outValue;
...
Vector3 func__77(int iParam0, BOOL bParam1) // Position - 0x69CA{
switch (iParam0){
case -1:
return 0f, 0f, 0f;
case 0:
...
Vector3 func__78() // Position - 0x711A{
...
Vector3 func__82(int iParam0, int iParam1) // Position - 0x74A6{
var unk;
var unk7;
unk7={
...
Vector3 func__84(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x75E5{
float num;
float num2;
float num3;
...
Vector3 func__91(int iParam0) // Position - 0x836A{
switch (iParam0){
case 1:
...
var func__103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B6C{
...
func_265("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_178(uParam0->f_27)){
func_177(uParam0->f_27, *uParam0);
func_265("RC5_IN_ACTIVATION_RANGE:
...
if(func_178(true)){
func_177(1, *uParam0);
func_265("RC_IN_ACTIVATION_RANGE:
...
func_265("RC_STOP_PLAYER_VEHICLE_CHECK:
...
var unk;
if(Global_78558){
func_265("IS_RC_FINE_AND_IN_RANGE():
...
Vector3 func__214(Ped pedParam0, int iParam1) // Position - 0xE115{
...
Vector3 func__218(float fParam0, var uParam1, var uParam2) // Position - 0xE2D6{
float num;
float num2;
...
uParam0->f_16=5;
uParam0->f_17[0 /*3*/]={
1973.3237f, 3815.594f, 31.42936f 
};
uParam0->f_17[1 /*3*/]={
1974.9358f, 3812.7473f, 34.438004f 
};
uParam0->f_24=6.5f;
uParam0->f_27=0;
...
if(func_246(iParam0)) return false;
if(iParam0==-1) iParam0=func_171();
if(iParam0==-1) return false;
if(!func_235(iParam0)){
...
if(iParam0==58)if(func_241(5)) Global_112735[iParam0 /*10*/].f_3=0;
...
int i;
if(*uParam0==1){
if(func_249(uParam0->[0], uParam2, fParam5, uParam1)) return true;
}else{
for (i=0;
i < *uParam0;
i=i + 1){
...
i <=*uParam0 - 1;
i=i + 1){
if(iParam1==1) func_263(&uParam0->[i]);
else func_262(&uParam0->[i], false, 1, 0);
}
return;
}
