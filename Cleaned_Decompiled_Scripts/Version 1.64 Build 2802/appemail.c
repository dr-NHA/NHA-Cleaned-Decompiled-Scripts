...
if(!MISC::IS_BIT_SET(Global_4542297, 17)){
...
func_13(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
}else{
func_13(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), "CELL_217", &(Global_2028[Global_7568 /*29*/].f_3), 0);
}
func_64(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
func_13(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568 /*10*/].f_4), "CELL_300", &Var0, "CELL_195", 0);
}else{
func_64(Global_20364, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
func_13(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568 /*29*/].f_3), &(Global_2028[Global_7568 /*29*/].f_7), &Var0, &(Global_2028[Global_7568 /*29*/].f_3), 0);
}}
func_64(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
}
func_6();
...
SYSTEM::SETTIMERA(0);
iLocal_71=1;
}}elseif(PAD::IS_CONTROL_PRESSED(2, 172) || PAD::IS_CONTROL_PRESSED(2, 181)){
...
SYSTEM::SETTIMERB(0);
iLocal_71=1;
}}elseif(PAD::IS_CONTROL_PRESSED(2, 173) || PAD::IS_CONTROL_PRESSED(2, 180)){
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20372, 1);
}}elseif(!PAD::IS_CONTROL_PRESSED(2, 174)){
iLocal_66=0;
}
if(!iLocal_67){
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20372, 1);
}}elseif(!PAD::IS_CONTROL_PRESSED(2, 175)){
iLocal_67=0;
}
if(!iLocal_63){
...
iVar2=iVar20;
Var3={
func_32(Global_44465[iVar20 /*12*/].f_1) 
};
...
Var3={
func_32(Global_44465[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(bVar1){
func_29(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_30(iParam1)), 0));
}else{
func_29(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_30(iParam1)), 0));
}
switch (Global_20383){
case 0:
...
Var9={
func_32(Global_44465[iVar8 /*12*/].f_1) 
};
Var25={
func_32(Global_44465[iVar8 /*12*/].f_1) 
};
...
Var7={
func_32(Global_44465[iVar6 /*12*/]) 
};
Var23={
func_32(Global_44465[iVar6 /*12*/].f_1) 
};
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(9);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
...
func_78(0);
}elseif(bVar1 || !func_35(iVar0, iVar4)){
func_78(0);
}else{
func_78(1);
}
...
Var47={
func_32(Global_44465[iVar45 /*12*/]) 
};
Var63={
func_32(Global_44465[iVar45 /*12*/].f_1) 
};
if(Global_53765[iVar43 /*203*/].f_10[iVar3 /*48*/].f_1){
MemCopy(&Var63,{
Global_53765[iVar43 /*203*/].f_10[iVar3 /*48*/].f_2
}
, 16);
}
...
Var18={
func_32(Global_44465[iVar17 /*12*/]) 
};
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(8);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar3);
...
Global_20311={
func_70(Param0, Param3, fVar4) 
};
Global_20314={
func_70(Param6, Param9, fVar4) 
};
}else{
Global_20311={
Param3 
...
Vector3 func__70(struct<3> Param0, struct<3> Param3, float fParam6){
