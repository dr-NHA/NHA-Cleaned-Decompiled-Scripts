...
if(iLocal_21==2){
if(SYSTEM::TIMERB() > 499) SYSTEM::SETTIMERB(0);
if(SYSTEM::TIMERA() > 2200) iLocal_21=3;
}
if(iLocal_21==3) Global_1836103=1;
break;
case 8:
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam7)) func_7(sParam7);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam8)) func_7(sParam8);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam9)) func_7(sParam9);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam10)) func_7(sParam10);
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam11)) func_7(sParam11);
...
if(IS_BIT_SET(Global_8255, 1)) GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0f);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
