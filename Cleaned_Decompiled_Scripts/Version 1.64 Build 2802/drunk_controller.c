...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(32)) func_32();
while (true){
SYSTEM::WAIT(0);
func_31(0);
func_30();
...
if(iLocal_13 >=16) iLocal_13=0;
iLocal_14=iLocal_14 + 1;
if(iLocal_14 >=16) iLocal_14=0;
iLocal_15=iLocal_15 + 1;
if(iLocal_15 >=5) iLocal_15=0;
if(!func_1()) func_32();
}
return;
}
BOOL func_1() // Position - 0xA6{
if(Global_44411) return true;
if(CAM::DOES_CAM_EXIST(Global_44412)) return true;
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("drunk")) > 0) return true;
if(Global_44204 > 0) return true;
return false;
}
...
if(MISC::ABSF(Global_44416 - Global_44417) < 0.01f) Global_44416=Global_44417;
}
if(!CAM::IS_GAMEPLAY_CAM_SHAKING() && !func_8(PLAYER::PLAYER_ID())) CAM::SHAKE_GAMEPLAY_CAM("DRUNK_SHAKE", Global_44416 * num2 * num4);
if(MISC::GET_GAME_TIMER() % 100==0){
if(Global_44413==-1){
}else{
if(fLocal_26==-1f) fLocal_26=num2;
...
if(Global_44415 * num2 * num4 < 1f) CAM::SET_GAMEPLAY_CAM_MAX_MOTION_BLUR_STRENGTH_THIS_UPDATE(Global_44415 * num2 * num4);
else CAM::SET_GAMEPLAY_CAM_MAX_MOTION_BLUR_STRENGTH_THIS_UPDATE(1f);
if(!CAM::IS_CINEMATIC_CAM_SHAKING()) CAM::SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", Global_44416 * Global_44410 * num2 * num4);
CAM::SET_CINEMATIC_CAM_SHAKE_AMPLITUDE(Global_44416 * Global_44410 * num2 * num4);
if(CAM::DOES_CAM_EXIST(Global_44412))if(CAM::IS_CAM_SHAKING(Global_44412)) CAM::SET_CAM_SHAKE_AMPLITUDE(Global_44412, Global_44416 * num2 * num4);
...
}elseif(!GRAPHICS::GET_IS_TIMECYCLE_TRANSITIONING_OUT()){
GRAPHICS::SET_TRANSITION_TIMECYCLE_MODIFIER(&Global_44420, 15f);
fLocal_16=Global_44419;
if(Global_44418 !=1f) GRAPHICS::SET_TIMECYCLE_MODIFIER_STRENGTH(Global_44418);
}}else{
if(GRAPHICS::GET_TIMECYCLE_TRANSITION_MODIFIER_INDEX() !=-1 && GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX() !=-1) fLocal_16=-99f;
AUDIO::SET_AUDIO_SPECIAL_EFFECT_MODE(2);
num6=Global_44413 - gameTimer;
if(num6 <=Global_44414 / 2 && Global_44413 !=-1){
flag=false;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))if(AUDIO::IS_ANY_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) flag=true;
if(func_6(PLAYER::PLAYER_PED_ID())){
Global_44413=Global_44413 + 1000;
}elseif(flag){
Global_44413=Global_44413 + 1000;
}elseif(GRAPHICS::GET_TIMECYCLE_TRANSITION_MODIFIER_INDEX() !=-1){
Global_44413=Global_44413 + 1000;
}elseif(func_5()){
Global_44413=Global_44413 + 1000;
}else{
if(GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX() !=-1) GRAPHICS::SET_TRANSITION_OUT_OF_TIMECYCLE_MODIFIER(SYSTEM::TO_FLOAT(Global_44414 / 2) / 1000f);
fLocal_16=-99f;
Global_44419=0f;
...
if(func_7(pedParam0)==-1) return false;
return true;
}
...
if(value <=Global_44414)if(Global_44413 !=-1) num=SYSTEM::TO_FLOAT(value) / SYSTEM::TO_FLOAT(Global_44414);
return num;
}


void func_15() // Position - 0x757{
if(Global_44206[iLocal_15 /*5*/]==0) func_16(iLocal_15);
return;
}
...
i < 16;
i=i + 1){
if(Global_44232[i /*5*/]==-1) return i;
}
return -1;
}
...
if(num==-1) func_24(Global_44232[iLocal_14 /*5*/]);
else func_21(num);
}
return;
}
...
i < 16;
i=i + 1){
if(iParam0==Global_44313[i /*6*/].f_1) func_21(i);
}
return;
}
...
i < 16;
i=i + 1){
if(iParam1==Global_44313[i /*6*/].f_2)if(iParam0==Global_44313[i /*6*/]) return i;
}
return -1;
}
...
if(Global_44313[iLocal_13 /*6*/]==1) Global_44313[iLocal_13 /*6*/]=0;
return;
}
...
i < 16;
i=i + 1){
if(iParam0==Global_44313[i /*6*/]) func_21(i);
}
return;
}
