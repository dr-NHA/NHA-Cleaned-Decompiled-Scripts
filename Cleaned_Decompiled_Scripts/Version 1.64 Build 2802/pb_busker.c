...
TASK::TASK_PERFORM_SEQUENCE(uLocal_52, uLocal_54);
}
...
uLocal_52=PED::CREATE_PED(19, joaat("g_m_y_mexgoon_02"), Local_45.f_0, Local_45.f_1, Local_48.f_2, 0f, 1, 1);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_52, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_54);
TASK::TASK_TURN_PED_TO_FACE_COORD(0, Local_48, 0);
...
if(iLocal_51==1){
Local_48={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_52, 3.8f, 0.8f, 0f) 
};
iLocal_53=PED::CREATE_PED(5, joaat("a_f_m_bevhills_02"), Local_48, 0f, 1, 1);
