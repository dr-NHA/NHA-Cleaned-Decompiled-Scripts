...
iLocal_42=64;
Local_91={
-131.052f, -1627f, 31.1755f 
};
Local_94={
287.888f, -284.603f, 52.967f 
};
Local_97={
-319.66f, -832.28f, 31.61f 
};
Local_100={
31f, -1019f, 28.5f 
};
...
MISC::CLEAR_AREA_OF_VEHICLES(-127.9025f, -1574.084f, 36.4128f, 10f, 0, 0, 0, 0, 0, 0, 0);
iLocal_156=1;
iLocal_46=1;
}elseif(func_211()){
func_278();
...
if(PED::IS_PED_INJURED(iLocal_63) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 0)){
bVar0=PED::IS_PED_INJURED(iLocal_62);
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_191)){
}
if(bVar0==0 && bLocal_90==1){
PED::SET_PED_TO_RAGDOLL(iLocal_62, 500, 1000, 0, 0, 0, 0);
...
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
}
break;
case 5:
func_160();
...
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
...
func_150();
func_149();
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_62, Local_184, 7f, 7f, 7f, 0, 1, 0)){
iLocal_143=2;
iLocal_48=3;
}
else{
...
elseif(HUD::DOES_BLIP_EXIST(uLocal_66)){
if(HUD::GET_BLIP_COLOUR(iLocal_66)==1){
}
else{
HUD::SET_BLIP_AS_FRIENDLY(iLocal_66, 0);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
iLocal_48=6;
}
else{
func_278();
...
if(SYSTEM::VDIST(Local_184, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 150f){
func_278();
}}
}}elseif(bLocal_149){
if(!PED::IS_PED_INJURED(iLocal_63)){
...
ENTITY::DETACH_ENTITY(iLocal_64, 1, 1);
}}}
}}
if(iLocal_150){
if(!iLocal_163){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_63, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_62, 0)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), ENTITY::GET_ENTITY_COORDS(iLocal_62, 1), 1) > 100f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 100f){
TASK::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
iLocal_163=1;
}}
}}
...
TASK::TASK_SMART_FLEE_PED(iLocal_63, iLocal_62, 200f, -1, 0, 0);
PED::FORCE_PED_MOTION_STATE(iLocal_63, joaat("MotionState_Run"), 1, 0, 0);
iLocal_150=1;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, joaat("script_task_smart_flee_ped")) !=1){
TASK::CLEAR_PED_SECONDARY_TASK(iLocal_63);
TASK::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
PED::FORCE_PED_MOTION_STATE(iLocal_63, joaat("MotionState_Run"), 1, 0, 0);
iLocal_150=1;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_16(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
uParam0->f_5=1;
uParam0->f_7=1;
}}elseif(func_32(bParam1, bParam2, bParam3)){
uParam0->f_4=MISC::GET_GAME_TIMER();
uParam0->f_5=1;
uParam0->f_7=1;
...
uParam0->f_5=0;
}elseif(!func_33(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
uParam0->f_5=0;
}}elseif(func_30(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_31(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
if(PED::IS_PED_INJURED(iLocal_63)){
Local_184={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_63, 1067030938, 1069547520) 
};
}else{
Local_184={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), 1067030938, 1069547520) 
};
}
uLocal_191=OBJECT::CREATE_PICKUP(joaat("pickup_money_wallet"), Local_184, uLocal_144, iLocal_192, 1, iLocal_85);
iLocal_67=func_154(uLocal_191);
func_37(&uLocal_380, 0, 0);
bLocal_60=true;
}}
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
TASK::TASK_WANDER_STANDARD(0, 40000f, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_62, cLocal_359, "flee_forward_loop_shopkeeper", 3)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
TASK::TASK_WANDER_STANDARD(0, 40000f, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
...
TASK::CLEAR_PED_TASKS(iLocal_62);
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_191), 1f, 20000, 0.25f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
}}}
...
TASK::TASK_COMBAT_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_63, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_63, 0, 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_63);
}
if(!PED::IS_PED_INJURED(iLocal_62)){
if(OBJECT::DOES_PICKUP_EXIST(uLocal_191)){
if(OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_191)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_62, OBJECT::GET_PICKUP_COORDS(uLocal_191), 10f, 10f, 10f, 0, 1, 0)){
if(bLocal_90==3){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
iLocal_51=1;
}}elseif((!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_62, cLocal_359, sLocal_370, 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_62, cLocal_359, sLocal_366, 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_62, cLocal_359, sLocal_368, 3)){
TASK::CLEAR_PED_TASKS(iLocal_62);
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_191), 1f, 20000, 0.25f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
...
if(!PED::IS_PED_INJURED(iLocal_63)){
TASK::CLEAR_PED_TASKS(iLocal_63);
TASK::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_63, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_63, 0, 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_63);
}
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_62, joaat("script_task_perform_sequence"))==7){
TASK::CLEAR_PED_TASKS(iLocal_62);
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_360, "pickup_low", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 5f, 5f, 5f, 0, 1, 0) && iVar18==1){
if(func_122(2)){
HUD::CLEAR_HELP(1);
}
if(PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())){
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
while (!func_110(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), uLocal_77, 1, 1056964608, 0, 1, 0) || func_165()){
...
if(!PED::IS_PED_INJURED(iLocal_62)){
PED::SET_PED_CAN_RAGDOLL(iLocal_62, 0);
}
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
...
func_106(ENTITY::GET_ENTITY_COORDS(iLocal_62, 1), &uLocal_76, &uLocal_77);
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 15f, 15f, 15f, 0, 1, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
if(iLocal_47==2){
TASK::TASK_PLAY_ANIM(0, cLocal_377, "RETURNING_FRONT_A", 8f, -1000f, -1, 0, 0, 0, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
PED::FORCE_PED_MOTION_STATE(iLocal_62, joaat("MotionState_Walk"), 0, 0, 0);
iLocal_153=1;
}}
if(bLocal_152){
switch (iLocal_151){
...
Local_128.f_2=265f;
}}elseif(Local_128.f_2 > 45f && Local_128.f_2 < 85f){
...
MISC::GET_GROUND_Z_FOR_3D_COORD(Local_125, &(Local_125.f_2), 0, 0);
Var1={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, Local_125, Local_128, 0f, 2) 
};
Var10={
Var1 - Local_125 
};
...
MISC::GET_GROUND_Z_FOR_3D_COORD(Var1, &(Var1.f_2), 0, 0);
...
if(ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_125, (Var7.f_1 + 1.5f), (Var7.f_1 + 1.5f), 3f, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, Local_125, Local_128, 0, 2), (Var7.f_1 + 1f), (Var7.f_1 + 1f), 3f, 0, 1, 0)){
if(bLocal_90==1){
if(Local_128.f_2 > 40f && Local_128.f_2 < 220f){
Local_80={
-148.3897f, -1647.215f, 31.5867f 
};
fLocal_79=331.9427f;
}
else{
Local_80={
-129.5632f, -1622.282f, 31.1122f 
};
fLocal_79=148.9075f;
}
}
...
Local_80={
-319.709f, -837.0066f, 30.449f 
};
fLocal_79=61.7986f;
}
else{
Local_80={
-346.8735f, -833.8024f, 30.4135f 
};
fLocal_79=269.6216f;
}
}
...
Local_80={
37.222f, -1005.04f, 28.4648f 
};
fLocal_79=156.7986f;
}
else{
Local_80={
29.9887f, -1033.184f, 28.3794f 
};
fLocal_79=344.6216f;
}
}
...
Local_80={
func_101(Local_125, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, Local_125, Local_128, 0, 2)) 
};
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
ENTITY::SET_ENTITY_COORDS(iVar0, Local_80, 1, 0, 0, 1);
...
MISC::CLEAR_AREA(Local_125, 2f, 1, 1, 0, 0);
WEAPON::HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(PLAYER::PLAYER_PED_ID(), 1);
iLocal_64=OBJECT::CREATE_OBJECT(iLocal_85, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1, 1, 0);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_64, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
uLocal_131=PED::CREATE_SYNCHRONIZED_SCENE(Local_125, Local_128, 2);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_131, 0);
...
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_131, cLocal_361, sLocal_362, 1000f, -8f, 0, 0, 1148846080, 0);
if(!PED::IS_PED_INJURED(iLocal_62)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_62);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_62, uLocal_131, cLocal_361, sLocal_363, 1000f, -8f, 0, 0, 1148846080, 0);
}
...
break;
case 1:
if((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_131) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_131) > 0.9f) || func_99(1000)){
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
...
Var1={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, Local_125, Local_128, 1f, 2) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var1, &(Var1.f_2), 0, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_62, Var1, 1, 0, 0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_62, 0);
Var1={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_361, sLocal_363, Local_125, Local_128, 1f, 2) 
};
...
PED::SET_PED_MOVEMENT_CLIPSET(iLocal_62, cLocal_378, 1048576000);
PED::FORCE_PED_MOTION_STATE(iLocal_62, joaat("MotionState_Walk"), 1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_62, 1);
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
...
if(!PED::IS_PED_INJURED(iLocal_62)){
PED::SET_PED_MONEY(iLocal_62, (iLocal_192 - (iLocal_192 / 10)));
PED::SET_PED_CAN_RAGDOLL(iLocal_62, 1);
}
...
func_202(3);
func_197();
}elseif(ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("detach"))){
...
ENTITY::DETACH_ENTITY(iLocal_64, 0, 1);
if(PED::IS_PED_MALE(iLocal_62)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_64, iLocal_62, PED::GET_PED_BONE_INDEX(iLocal_62, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}else{
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_64, iLocal_62, PED::GET_PED_BONE_INDEX(iLocal_62, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
if(!iLocal_61){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_70() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
var func__78(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_73();
}
...
Vector3 func__101(struct<3> Param0, struct<3> Param3){
int iVar0;
struct<3> Var1;
struct<3> Var4;
struct<3> Var7;
...
Var22={
func_102(Var1, 0f, Var10) 
};
Var25={
func_102(Var1, 0f, Var7) 
};
...
Vector3 func__102(struct<3> Param0, float fParam3, struct<2> Param4, var uParam6){
struct<3> Var0;
float fVar3;
float fVar4;
float fVar5;
...
Var13={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(cParam3, sParam4, *uParam1, *uParam2, 0, 2) 
};
}else{
Var13={
...
case 0:
if(iVar1 > 20){
uParam2->f_2=func_104(ENTITY::GET_ENTITY_COORDS(iParam0, 0), *uParam1, 1);
*uParam1={
...
if(func_107(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fVar4, 15f)){
bVar0=true;
}
Var1={
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_116(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78556=0;
}}
...
if(MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_62, 31086, 0f, 0f, 0f), 5f, 1)){
return 1;
}
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_62, 31086, 0f, 0f, 0f) 
};
Var3={
Var3 + PED::GET_PED_BONE_COORDS(iLocal_62, 31086, 0f, 0f, 0f) 
};
...
void func_133(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_62, 0)){
if(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_62, 1)) > (fLocal_165 + 50f)){
func_197();
}elseif(func_124(func_125()) < iLocal_192){
func_197();
}}}
...
void func_134(){
if(!PED::IS_PED_INJURED(iLocal_62)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, Global_19, 0, 1, 0)){
...
if(bLocal_90==1 || bLocal_90==4){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_166, Local_169, fVar0, 0, 1, 0)){
if(!iLocal_157){
if(!PED::IS_PED_INJURED(iLocal_62)){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_172, Local_175, fVar0, 0, 1, 0)){
if(!iLocal_158){
if(!PED::IS_PED_INJURED(iLocal_62)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 0);
iLocal_158=1;
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_178, Local_181, fVar0, 0, 1, 0)){
if(!iLocal_159){
if(!PED::IS_PED_INJURED(iLocal_62)){
iLocal_159=1;
}}}}
if(!iLocal_160){
if(!PED::IS_PED_INJURED(iLocal_62)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 25f, 25f, 5f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_62, PLAYER::PLAYER_PED_ID(), 17)){
...
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
if(iLocal_47==2){
TASK::TASK_PLAY_ANIM(0, cLocal_377, "RETURNING_FRONT_A", 8f, -4f, -1, 0, 0, 0, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
...
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iParam0, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
SYSTEM::SETTIMERA(0);
*uParam1++;
}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_62, 0)){
fLocal_165=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_62, 1));
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_62)){
if(!PED::IS_PED_INJURED(iLocal_62)){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_62, 0);
}}
func_145(0);
OBJECT::REMOVE_PICKUP(uLocal_191);
if(!iLocal_56){
...
if(ENTITY::IS_ENTITY_A_VEHICLE(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_144(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
if(!bParam2){
...
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::CLEAR_PED_TASKS(iLocal_62);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
...
if(!PED::IS_PED_INJURED(iLocal_62)){
if(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_64, iLocal_62)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 18f, 18f, 18f, 0, 1, 0)){
...
void func_149(){
if(!PED::IS_PED_INJURED(iLocal_62)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 8f, 8f, 18f, 0, 1, 0) || ENTITY::IS_ENTITY_ON_SCREEN(iLocal_62)){
HUD::CLEAR_PRINTS();
}}}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
PED::SET_PED_KEEP_TASK(iLocal_63, 1);
SYSTEM::WAIT(0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_63, 0, 1);
...
HUD::SET_BLIP_SCALE(uVar0, func_144(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
return iVar0;
}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_63, 0)){
if(PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 18f, 18f, 18f, 0, 1, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 1)){
SYSTEM::SETTIMERB(0);
iLocal_143=1;
return 1;
}}}
...
iLocal_143=2;
return 1;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 1)){
SYSTEM::SETTIMERB(0);
iLocal_143=2;
if(ENTITY::DOES_ENTITY_EXIST(iLocal_62)){
if(!PED::IS_PED_INJURED(iLocal_62)){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_62)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_62, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 5.3f, 5.3f, 6f, 0, 1, 0)){
...
int func_157(){
if(!PED::IS_PED_INJURED(iLocal_63)){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_63, PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 20f, 0, 1, 0)){
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
...
iLocal_59=1;
}}elseif((func_42(&uLocal_194, cLocal_103, sLocal_107, 4, 0, 0, 0) || func_62()) || func_62()){
iLocal_59=1;
}}}}elseif(func_157()){
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 20f, 20f, 20f, 0, 1, 0)){
if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_62) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_62)){
return 1;
}}}
...
if(MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_62, 31086, 0f, 0f, 0f), 3f, 1)){
return 1;
}
return 0;
}
...
if(bLocal_53){
if(!iLocal_136){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 7f, 7f, 7f, 0, 1, 0)){
...
int func_164(){
if(!PED::IS_PED_INJURED(iLocal_62)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 12f, 12f, 5f, 0, 1, 0)){
return 1;
}}
return 0;
}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_87, 1f, 20000, fVar0, 4, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
iLocal_57=1;
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_87, iLocal_62, 1f, 0, 1.5f, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_62, -1, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
SYSTEM::SETTIMERA(0);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 60f, 60f, 50f, 0, 1, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_62, 0)){
...
TASK::CLEAR_PED_TASKS(iLocal_62);
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_base", 8f, -4f, 7000, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
func_170();
uLocal_191=OBJECT::CREATE_PICKUP(joaat("pickup_money_purse"), OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_62, 0f, 2.5f, 0f), 1067030938, 1069547520), uLocal_144, iLocal_192, 1, iLocal_85);
bLocal_133=true;
}}}
if(bLocal_133){
if(PED::IS_PED_INJURED(iLocal_63)){
...
case 0:
Local_670={
OBJECT::GET_PICKUP_COORDS(uLocal_191) - Vector(0f, 0f, 0.75f) 
};
if(OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_191)){
TASK::CLEAR_PED_TASKS(iLocal_63);
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_670, iLocal_62, 2f, 0, 0.1f, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
...
if(OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_191)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), Local_670, 1) > 1f){
iLocal_669=1;
iLocal_667=4;
}else{
TASK::CLEAR_PED_TASKS(iLocal_63);
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_360, "pickup_low", 8f, -4f, -1, 8224, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
iLocal_667=2;
...
break;
case 4:
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_63, 1, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_63, 0, 0);
bLocal_149=true;
break;
}}}}}
...
TASK::TASK_PLAY_ANIM(iLocal_63, cLocal_359, sLocal_367, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
if(iLocal_47==2){
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, sLocal_368, 8f, -8f, -1, 0, 0, 0, 0, 0);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, sLocal_368, 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
...
TASK::TASK_PLAY_ANIM(iLocal_63, cLocal_359, sLocal_369, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
if(iLocal_47==2){
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, sLocal_370, 8f, -8f, -1, 8, 0.1f, 0, 0, 0);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_PLAY_ANIM(0, cLocal_359, sLocal_370, 8f, -4f, -1, 8, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), 1) < 30f){
iVar0=1;
}}elseif(bLocal_90==4){
...
iVar0=1;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), -325.7037f, -829.31f, 30.5812f, 1) < 95f){
iVar0=1;
}
return iVar0;
}
...
case 0:
if(!PED::IS_PED_INJURED(iLocal_63)){
TASK::TASK_PLAY_ANIM(iLocal_63, cLocal_359, "IG_1_guy_stickup_loop", 8f, -4f, -1, 1, 0, 0, 0, 0);
}
if(!PED::IS_PED_INJURED(iLocal_62)){
TASK::TASK_PLAY_ANIM(iLocal_62, cLocal_361, "ortega_stand_loop_ort", 8f, -4f, -1, 1, 0, 0, 0, 0);
}
iLocal_140++;
break;
case 1:
...
iLocal_190=1;
iLocal_140++;
}}elseif(!PED::IS_PED_INJURED(iLocal_62)){
TASK::TASK_SMART_FLEE_COORD(iLocal_62, Local_145, 250f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_62, 1);
SYSTEM::WAIT(0);
func_209();
}}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_63)){
if(!PED::IS_PED_INJURED(iLocal_63)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 6f, 6f, 15f, 0, 1, 0)){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_63, PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 3f, 3f, 15f, 0, 1, 0)){
...
if(!PED::IS_PED_INJURED(iLocal_63)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_63, 0), 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
PED::SET_PED_KEEP_TASK(iLocal_62, 1);
...
PED::SET_PED_RESET_FLAG(iLocal_63, 156, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_121);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_121);
...
if(!PED::IS_PED_INJURED(iLocal_62) && !PED::IS_PED_INJURED(iLocal_63)){
if((((iLocal_188 - iLocal_187) > 12000 && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 3f, 3f, 35f, 0, 1, 0)) && ENTITY::IS_ENTITY_ON_SCREEN(iLocal_63)) && !func_165()){
if((func_42(&uLocal_194, cLocal_103, "REMG2_FKIT", 4, 0, 0, 0) || func_62()) || func_62()){
PED::SET_PED_RESET_FLAG(iLocal_63, 156, 1);
PED::SET_PED_SHOOTS_AT_COORD(iLocal_63, PED::GET_PED_BONE_COORDS(iLocal_62, 31086, 0f, 0f, 0f), 0);
TASK::CLEAR_PED_TASKS(iLocal_62);
ENTITY::SET_ENTITY_HEALTH(iLocal_62, 99, 0);
TASK::TASK_SMART_FLEE_COORD(iLocal_63, Local_145, 250f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_63, 1);
func_278();
}}}}}}
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 2f, 2f, 2f, 0, 1, 0)){
}}
return 0;
}
...
}}elseif(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_62) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_62)){
SYSTEM::SETTIMERB(0);
return 1;
}}}}}
return 0;
...
TASK::TASK_SMART_FLEE_PED(iLocal_62, iLocal_63, 150f, -1, 0, 0);
}}elseif(iLocal_47==3){
if(!PED::IS_PED_FLEEING(iLocal_62)){
TASK::TASK_SMART_FLEE_COORD(iLocal_62, Local_122, 150f, -1, 0, 0);
}}
PED::SET_PED_KEEP_TASK(iLocal_62, 1);
SYSTEM::WAIT(0);
func_42(&uLocal_194, cLocal_103, sLocal_109, 4, 0, 0, 0);
...
void func_213(){
iLocal_62=PED::CREATE_PED(26, iLocal_83, Local_69, fLocal_75, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_62, 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_62, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_62, 8, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_62, 128, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_62, 512, 1);
AUDIO::STOP_PED_SPEAKING(iLocal_62, 1);
PED::SET_PED_INCREASED_AVOIDANCE_RADIUS(iLocal_62);
PED::SET_PED_MONEY(iLocal_62, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_62, 1);
...
iLocal_63=PED::CREATE_PED(26, iLocal_84, Local_72, fLocal_78, 1, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_63, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_63, 1);
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_63, 1, 0);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_63, joaat("weapon_pistol"), -1, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_63, 13, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_63, 17, 0);
PED::SET_PED_DIES_WHEN_INJURED(iLocal_63, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_63, 42, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_63, 137, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_63, 128, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_63, 2, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_63, iLocal_86);
AUDIO::STOP_PED_SPEAKING(iLocal_63, 1);
...
if(bLocal_90==3){
Local_125={
-325.4189f, -828.8596f, 31.1f 
};
Local_128={
0f, 0f, 180f 
};
uLocal_131=PED::CREATE_SYNCHRONIZED_SCENE(Local_125, Local_128, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_63, uLocal_131, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE", "base", 1000f, -1000f, 0, 0, 1148846080, 0);
}
if(bLocal_90==4){
...
void func_214(){
struct<3> Var0;
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_63, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_359, sLocal_365, Local_371, Local_374, 0, 2), 0, 0, 1);
Var0={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_359, sLocal_365, Local_371, Local_374, 0, 2) 
};
if(Var0.f_2 < 0f){
Var0.f_2=(Var0.f_2 + 360f);
}
ENTITY::SET_ENTITY_HEADING(iLocal_63, Var0.f_2);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_62, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_359, sLocal_366, Local_371, Local_374, 0, 2), 0, 0, 1);
Var0={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_359, sLocal_366, Local_371, Local_374, 0, 2) 
};
if(Var0.f_2 < 0f){
Var0.f_2=(Var0.f_2 + 360f);
}
ENTITY::SET_ENTITY_HEADING(iLocal_62, Var0.f_2);
TASK::TASK_PLAY_ANIM(iLocal_63, cLocal_359, sLocal_365, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(iLocal_62, cLocal_359, sLocal_366, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
}
...
void func_223(){
func_276();
MISC::SET_BIT(&uLocal_144, 3);
MISC::SET_BIT(&uLocal_144, 4);
MISC::SET_BIT(&uLocal_144, true);
if(bLocal_90==1){
...
iLocal_48=2;
Local_145={
-132.2607f, -1628.336f, 31.2107f 
};
iLocal_83=joaat("a_m_y_business_02");
iLocal_84=joaat("g_m_y_strpunk_01");
Local_69={
-138.814f, -1635.975f, 31.357f 
};
fLocal_75=318.519f;
Local_72={
-129.8504f, -1629.676f, 31.2506f 
};
fLocal_78=98f;
Local_371={
Local_69 
...
Local_166={
-103.8951f, -1593.239f, 30.49198f 
};
Local_169={
-89.29615f, -1575.444f, 32.30938f 
};
Local_172={
-152.0367f, -1654.379f, 31.73599f 
};
Local_175={
-169.8183f, -1669.556f, 33.94173f 
};
Local_178={
-152.0367f, -1654.379f, 31.73599f 
};
...
fLocal_79=340.0645f;
Local_80={
-151.0793f, -1650.322f, 31.6504f 
};
Local_87={
-133.6872f, -1630.245f, 31.2527f 
};
...
iLocal_84=joaat("g_m_y_strpunk_01");
Local_69={
288.6728f, -282.4782f, 52.9707f 
};
fLocal_75=260.7569f;
Local_72={
290.5373f, -283.198f, 52.9799f 
};
fLocal_78=45f;
fLocal_79=251f;
Local_80={
297.4484f, -261.2914f, 53.0037f 
};
...
cLocal_359="RANDOM@MUGGING3";
Local_145={
-317.1964f, -824.0751f, 31.4284f 
};
iLocal_83=joaat("a_f_y_hipster_01");
iLocal_84=joaat("a_m_o_tramp_01");
Local_69={
-310.9292f, -833.8435f, 30.6261f 
};
fLocal_75=80.7161f;
Local_72={
-322.5526f, -827.186f, 30.5857f 
};
fLocal_78=336.5502f;
fLocal_79=81.8694f;
Local_80={
-322.3941f, -835.7213f, 30.6001f 
};
Local_87={
-320.9667f, -832.1209f, 30.5979f 
};
...
Local_72={
38.1933f, -1023.579f, 28.4889f 
};
fLocal_78=60.1372f;
fLocal_79=248f;
Local_80={
42.5323f, -990.353f, 28.248f 
};
Local_166={
38.15186f, -1001.485f, 28.42276f 
};
Local_169={
40.13669f, -995.2711f, 30.37197f 
};
Local_172={
37.21758f, -1040.354f, 28.41506f 
};
Local_175={
19.91492f, -1036.814f, 30.28045f 
};
Local_178={
28.4511f, -1035.718f, 28.3329f 
};
Local_181={
38.6536f, -1001.073f, 28.407f 
};
Local_87={
32.536f, -1020.293f, 28.4576f 
};
iLocal_85=joaat("prop_ld_wallet_pickup");
cLocal_103="REMG4AU";
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_266()) || Global_112695) || Global_32166) || func_265()) || func_55(8, -1)) || func_264()) || func_263()) || func_262()) || func_261()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_266()) || Global_32166) || func_265()) || func_55(8, -1)) || func_262()) || func_264()) || func_263()) || func_261()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_266()) || Global_112695) || Global_32166) || func_265()) || func_55(8, -1)) || func_262()) || func_264()) || func_263()) || func_261()) || Global_113648.f_7690.f_919[iVar0]==5) || Global_43804 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_266()) || Global_112695) || Global_32166) || func_265()) || func_55(8, -1)) || func_264()) || func_263()) || func_261()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_266()) || Global_32166) || func_265()) || func_55(8, -1)) || func_263()) || func_262()) || func_261()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_266()) || func_263()) || Global_112695) || Global_32166) || func_265()) || Global_44446) || func_55(8, -1)) || func_262()) || func_260()) || func_261()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_266()) || Global_112695) || Global_32166) || func_265()) || func_55(8, -1)) || func_262()) || func_260()) || func_264()) || func_263()) || func_261()){
return 0;
}
break;
}}else{
...
if(!PED::IS_PED_INJURED(iLocal_63)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
}
PED::SET_PED_KEEP_TASK(iLocal_63, 1);
if(!bLocal_60){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_62)){
if(!PED::IS_PED_INJURED(iLocal_62)){
PED::SET_PED_CAN_BE_TARGETTED(iLocal_62, 1);
...
TASK::TASK_SMART_FLEE_COORD(0, Local_122, 250f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_121);
TASK::TASK_PERFORM_SEQUENCE(iLocal_62, uLocal_121);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_121);
PED::SET_PED_KEEP_TASK(iLocal_62, 1);
