...
func_2();
}}elseif(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_70, 100f, 100f, 100f, 0, 1, 0)){
func_3();
}}else{
if(!PED::IS_PED_INJURED(iLocal_69)){
...
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_69, uLocal_75);
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_68, joaat("player"));
if(!PED::IS_PED_INJURED(iLocal_70)){
TASK::CLEAR_PED_TASKS(iLocal_70);
...
if(MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_69, 31086, 0f, 0f, 0f), 30f, 1)){
return 1;
}
...
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_69, 31086, 0f, 0f, 0f) 
};
Var3={
Var3 + PED::GET_PED_BONE_COORDS(iLocal_69, 31086, 0f, 0f, 0f) 
};
...
if(!bLocal_244){
if(!PED::IS_PED_INJURED(iLocal_70)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_70, joaat("script_task_perform_sequence"))==7 && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_70, PLAYER::PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, 0, 1, 0)){
if(!iLocal_245){
iLocal_250=500;
func_54();
SYSTEM::WAIT(0);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_70, joaat("weapon_pistol"), 200, 1, 1);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_54();
SYSTEM::WAIT(0);
func_37(&uLocal_76, "lurinau", "lurin_other", 4, 0, 0, 0);
...
HUD::SET_BLIP_AS_FRIENDLY(uLocal_71, 0);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_64, PLAYER::PLAYER_PED_ID(), 2f, 0, 0f, 4f, 1, 512, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
func_92(1);
}
func_54();
...
var func__99(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
HUD::SET_BLIP_SCALE(uVar0, func_101(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
if(!bParam2){
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
}else{
HUD::SET_BLIP_COLOUR(uVar0, 2);
}}elseif(ENTITY::IS_ENTITY_A_PED(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_101(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
...
func_37(&uLocal_76, "lurinau", "lurin_gun", 4, 0, 0, 0);
}elseif(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 2)){
func_37(&uLocal_76, "lurinau", "lurin_other", 4, 0, 0, 0);
}
func_2();
}}}}
...
if(!func_133()){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_69, 0)){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_49, 65f, 60f, 60f, 0, 1, 0) || Global_113643){
if(HUD::DOES_BLIP_EXIST(uLocal_73)){
HUD::REMOVE_BLIP(&uLocal_73);
}
uLocal_71=func_99(iLocal_69, 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_71, 0);
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
func_107(1);
}}}
if(!iLocal_241){
if(!PED::IS_PED_INJURED(iLocal_69)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_69, 25f, 25f, 25f, 0, 1, 0) && func_133()){
...
iLocal_242=1;
if(HUD::DOES_BLIP_EXIST(uLocal_71)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_71, 1);
}
TASK::CLEAR_PED_TASKS(iLocal_69);
...
iLocal_69=PED::CREATE_PED(19, joaat("a_f_m_skidrow_01"), Local_58, 79.765f, 1, 1);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_69, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
iLocal_70=PED::CREATE_PED(7, joaat("a_m_m_tramp_01"), Local_52, fLocal_67, 1, 1);
...
void func_119(){
Local_52={
879.8144f, -1047.433f, 32.0067f 
};
fLocal_67=237.0934f;
Local_58={
862.9633f, -1049.857f, 28.5362f 
};
Local_55={
15f, 15f, 15f 
};
Local_61={
881.1367f, -1050.706f, 32.0067f 
};
Local_64={
876.7977f, -1052.52f, 32.0067f 
};
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_112695) || Global_32166) || func_170()) || func_51(8, -1)) || func_169()) || func_168()) || func_167()) || func_166()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_171()) || Global_32166) || func_170()) || func_51(8, -1)) || func_167()) || func_169()) || func_168()) || func_166()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_112695) || Global_32166) || func_170()) || func_51(8, -1)) || func_169()) || func_168()) || func_166()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_171()) || Global_32166) || func_170()) || func_51(8, -1)) || func_168()) || func_167()) || func_166()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_171()) || func_168()) || Global_112695) || Global_32166) || func_170()) || Global_44446) || func_51(8, -1)) || func_167()) || func_165()) || func_166()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_171()) || Global_112695) || Global_32166) || func_170()) || func_51(8, -1)) || func_167()) || func_165()) || func_169()) || func_168()) || func_166()){
return 0;
}
break;
}}else{
