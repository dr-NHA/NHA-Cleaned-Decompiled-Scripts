...
uParam0->f_85.f_1=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
...
func_26(uParam0);
func_18(uParam0);
uVar42=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
...
break;
case 8:
uVar43=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
...
return ENTITY::IS_ENTITY_IN_ANGLED_AREA(uParam0, 416.2457f, 4826.312f, -59.9997f, 376.9388f, 4827.659f, -56.95424f, 15f, 0, 1, 0);
}

int func_70(){
if(Global_1853753 !=func_60()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1853753, 1, 0)){
return 0;
}
...
(uParam1[(*iParam2)[iVar4] /*14*/])->f_8={
func_77(func_78(iVar4), fVar3) + Var0 
};
(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3={
0f, 0f, (fVar3 + 174f) 
};
(uParam1[(*iParam2)[iVar4] /*14*/])->f_1={
func_77(func_76(iVar4), fVar3) + Var0 
};
(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3={
func_77(func_75(iVar4), fVar3) + Var0 
};
...
Vector3 func__77(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
