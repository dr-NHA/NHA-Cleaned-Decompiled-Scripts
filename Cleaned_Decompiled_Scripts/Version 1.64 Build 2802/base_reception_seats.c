...
if(bParam1) _CONTEXT_REMOVE_HELP_TEXT(&(uParam0->f_85.f_5));
return;
}
...
if(func_8(&(uParam0->f_85), 7)) uParam0->f_85.f_14(&uParam0->[iParam1 /*14*/], iParam1, sParam2);
...
func_4(uParam0, true);
func_52(uParam0, 1);
}elseif(uParam0->f_85.f_5==-1){
if(MISC::GET_GAME_TIMER() - uParam0->f_85.f_6 > 150) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_85.f_5), 4, "MPJAC_SIT" /*Press ~INPUT_CONTEXT~ to sit down.*/, 0, 0, 0, 0);
...
if(bParam1){
num=func_13(uParam0);
if(num !=uParam0->f_85.f_8.f_1)if(num==0) randomIntInRange=11 + uParam0->f_85.f_8.f_1;
else randomIntInRange=6 + num;
else randomIntInRange=uParam0->f_85.f_8.f_2;
num=uParam0->f_85.f_8.f_1;
}elseif(uParam0->f_85.f_8.f_2==5){
num=uParam0->f_85.f_8.f_1;
endRange=3;
randomIntInRange=MISC::GET_RANDOM_INT_IN_RANGE(0, endRange);
if(randomIntInRange==uParam0->f_85.f_8.f_3) randomIntInRange=(randomIntInRange + 1) % endRange;
}else{
...
if(uParam0->f_85.f_8==2) return uParam0->f_85.f_8.f_1;
...
if(uParam0->f_85.f_4==6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("block_interrupt")) && !func_8(&(uParam0->f_85), 12))if(num >=0.35f) func_23(uParam0);
...
if(uParam0->f_85.f_5==-1) _CONTEXT_ADD_HELP_TEXT(&(uParam0->f_85.f_5), 4, "MPJAC_EXIT" /*Press ~INPUT_CONTEXT~ to stand up.*/, 0, 0, 0, 0);
if(uParam0->f_85.f_4==6)if(PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_CONTEXT)) func_24(uParam0);
}}}
...
var unk;
unk={
uParam0->[uParam0->f_85.f_2 /*14*/].f_8.f_3 
};
if(func_16() && uParam0->f_85.f_8==0) unk.f_2=unk.f_2 - 4f;
return unk;
}
...
if(playerIndex !=PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true) && func_50(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_85.f_2 /*14*/])) return 1;
}}
return 0;
}
...
i < 1;
i=i + 1){
if(func_50(PLAYER::PLAYER_PED_ID(), &uParam0->[uParam0->f_85.f_2 /*14*/])) return true;
else uParam0->f_85.f_2=(uParam0->f_85.f_2 + 1) % 6;
}
return false;
}
...
if(uParam0->f_85.f_4==6){}elseif(uParam0->f_85.f_4 > 4){
...
}elseif(uParam0->f_85.f_4 > 1){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_55(uParam0));
uParam0->f_85.f_7=MISC::GET_FRAME_COUNT();
}elseif(MISC::GET_FRAME_COUNT() - uParam0->f_85.f_7 < 5){
PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_55(uParam0));
}
return;
}
...
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1853753, true, 0)) return false;
...
if(iParam1==0 || iParam1==1 && TASK::IS_SCENARIO_GROUP_ENABLED("FACILITY_MAIN_3") || TASK::IS_SCENARIO_GROUP_ENABLED("FACILITY_MAIN_2")) return 0;
return 1;
}
...
Vector3 func__75(int iParam0) // Position - 0x19A8{
switch (iParam0){
case 0:
...
Vector3 func__76(int iParam0) // Position - 0x19F6{
switch (iParam0){
case 0:
...
Vector3 func__77(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x1A38{
float num;
float num2;
float num3;
...
Vector3 func__78(int iParam0) // Position - 0x1A7C{
switch (iParam0){
case 0:
return{
...
Vector3 func__79() // Position - 0x1AC8{
return func_80() +{
0f, -8.946f, 47.215f 
};
}
...
Vector3 func__80() // Position - 0x1AE0{
