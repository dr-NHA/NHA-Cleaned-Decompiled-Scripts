...
bVar28=true;
Var29={
ENTITY::GET_ENTITY_COORDS(iScriptParam_0, 1) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iScriptParam_0) * Vector(0.6f, 0.6f, 0.6f) 
};
Var29.f_2=(Var29.f_2 + 0.5f);
Local_128={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_0, Local_125) 
};
Global_1949969=0;
Global_1949965=0;
Global_1950077=0;
...
ENTITY::CREATE_MODEL_HIDE(ENTITY::GET_ENTITY_COORDS(iScriptParam_0, 1), 1f, joaat("prop_laptop_01a"), 0);
Var33={
...
ENTITY::SET_ENTITY_ROTATION(iLocal_122, Var33, 2, 1);
bVar0=true;
}}}
...
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(uVar2[iVar38], "MP_COMMON_MISS", "HACK_LOOP", 3)){
bVar36=true;
}}
iVar38++;
}
...
if((((((((((((((((((((!bVar36 && !Global_32434) && !func_224(0)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && !func_223()) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var29, Var39, 0, 1, 1)) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_122)) && !MISC::IS_BIT_SET(Global_2621446, 15)) && !func_222()) && !(Global_78558 && func_221())) && !(!Global_78558 && func_220())) && !((Global_78558 && MISC::IS_BIT_SET(Global_4718592.f_14, 24)) && NETWORK::NETWORK_IS_ACTIVITY_SESSION())) && !((Global_78558 && func_219()) && func_218())) && !(Global_78558 && func_216(PLAYER::PLAYER_ID())==5)) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE()) && !Global_77328) && !func_213()) && !func_212()) && iVar43) && !func_211()) && !func_210()){
...
iLocal_124=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_128, ENTITY::GET_ENTITY_ROTATION(iLocal_122, 2), 2, 0, 0, 1065353216, 0, 1065353216);
...
struct<16> Var2;
char cVar18[32];
uVar0=Global_2849799[iParam0 /*3*/][func_103(iParam2)];
uVar1=Global_2849799[iParam1 /*3*/][func_103(iParam2)];
...
if(!func_174(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var16, 0.05f, 0) && !func_225(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(iLocal_122), 5f)){
...
GRAPHICS::DRAW_DEBUG_LINE(Var16, ENTITY::GET_ENTITY_COORDS(iLocal_122, 1), 0, 255, 0, 255);
GRAPHICS::DRAW_DEBUG_LINE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var16, 0, 0, 255, 255);
SYSTEM::WAIT(0);
}
func_238(&uLocal_118);
iLocal_123=0;
...
iLocal_124=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_128, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 0, 1065353216, 0, 1065353216);
...
iLocal_124=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_128, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 1, 1065353216, 0, 1065353216);
switch (iVar51){
case 0:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_124, &sVar16, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_124);
StringCopy(&cLocal_131, "idle_a", 16);
iLocal_123=3;
break;
case 1:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_124, &sVar16, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_124);
StringCopy(&cLocal_131, "idle_b", 16);
iLocal_123=3;
break;
case 2:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_124, &sVar16, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_124);
StringCopy(&cLocal_131, "idle_c", 16);
iLocal_123=3;
break;
case 3:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_124, &sVar16, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_124);
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar16, "idle_b", 2)){
GRAPHICS::DRAW_DEBUG_TEXT("idle_b", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 256, 64, 64, 64);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar16, "idle_c", 2)){
GRAPHICS::DRAW_DEBUG_TEXT("idle_c", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 256, 64, 64, 64);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar16, "idle_d", 2)){
...
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_124, &sVar16, sVar48, 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_124);
iLocal_123=3;
return;
}
