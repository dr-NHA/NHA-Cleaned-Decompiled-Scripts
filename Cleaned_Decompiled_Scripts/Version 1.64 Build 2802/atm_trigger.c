...
if(func_98(ENTITY::GET_ENTITY_COORDS(iScriptParam_0, 1))){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}
...
Local_516={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_0, Local_510) 
};
}else{
Local_516={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_0, Local_513) 
};
}
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Local_516, &fVar3, 0, 0)){
...
if((((((((((((((!PED::IS_PED_USING_ANY_SCENARIO(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !func_82(0)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_505, 1f, 1f, 1f, 0, 1, 1)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && !func_81()) && !func_80(iScriptParam_0, 0)) && !func_79()) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f) && func_77(PLAYER::PLAYER_ID()) !=171) && !func_76(Global_4718592.f_166301)) && !func_75(Global_4718592.f_166301)) && !func_74(Global_4718592.f_166301)) && !MISC::IS_BIT_SET(Global_4718592.f_28, 1)) && !func_73(PLAYER::PLAYER_ID())){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_505, 2f, 0)){
bVar5=false;
}
bVar6=false;
...
if(TASK::IS_SCENARIO_OCCUPIED(Local_505, 2f, 1)){
bVar6=true;
}
if(Global_78558){
...
if(!bVar6){
if(iLocal_602==-1){
func_70(&iLocal_602, 4, "FINH_ATMNEAR", 0, 0, 0, 0);
}
bVar4=true;
...
iLocal_509=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_516, ENTITY::GET_ENTITY_ROTATION(iScriptParam_0, 2), 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_509, &Var7, "exit", 8f, -4f, 5, 0, 1148846080, 0);
...
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_603) && !func_64(uParam2, 1)){
SYSTEM::WAIT(0);
func_56();
func_55(uParam2);
}
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_604) && !func_64(uParam2, 1)){
SYSTEM::WAIT(0);
func_56();
func_55(uParam2);
}
...
while (iLocal_610){
iLocal_610=0;
func_26(uParam2, iLocal_603, iParam1);
}}}
if(Global_78558){
func_25(iLocal_603);
}
...
iLocal_609=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uVar0);
switch (*uParam1){
case 0:
switch (iLocal_609){
case 2:
...
uVar0=Global_2805027[iParam0 /*3*/][func_16(uParam1)];
...
var uVar2;
int iVar3;
if(!MONEY::NETWORK_CAN_SPEND_MONEY2(iParam1, 0, 0, 0, &uVar0, -1, 0)){
return 0;
}
if(func_19()){
if(NETSHOPPING::NET_GAMESERVER_TRANSACTION_IN_PROGRESS()){
...
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(2)){
if(fLocal_528==-1f){
fLocal_528=PAD::GET_CONTROL_NORMAL(2, 239);
fLocal_529=PAD::GET_CONTROL_NORMAL(2, 240);
}elseif(fLocal_528 !=PAD::GET_CONTROL_NORMAL(2, 239) || fLocal_529 !=PAD::GET_CONTROL_NORMAL(2, 240)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SHOW_CURSOR");
...
fLocal_528=-1f;
}}elseif((((((!PAD::IS_USING_KEYBOARD_AND_MOUSE(2) || PAD::IS_CONTROL_JUST_PRESSED(2, 188)) || PAD::IS_CONTROL_JUST_PRESSED(2, 187)) || PAD::IS_CONTROL_JUST_PRESSED(2, 189)) || PAD::IS_CONTROL_JUST_PRESSED(2, 190)) || PAD::IS_CONTROL_JUST_PRESSED(2, 201)) || PAD::IS_CONTROL_JUST_PRESSED(2, 202)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SHOW_CURSOR");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(0);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
fLocal_528=-1f;
...
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(iLocal_605, 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam1, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
...
while (!MONEY::HAS_VC_WITHDRAWAL_COMPLETED(iVar0) && !func_64(uParam0, 1)){
func_40();
}
while (iVar1 > MISC::GET_GAME_TIMER() && !func_64(uParam0, 1)){
func_40();
}
return MONEY::WAS_VC_WITHDRAWAL_SUCCESSFU(iVar0);
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
func_54(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 201, 1));
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
if(bParam1){
func_54(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 198, 1));
}else{
func_54(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(2, 7, 1));
}
func_31("MPATM_NAV");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(0);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_604, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
func_54(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 202, 1));
func_31("MPATM_EXIT");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
...
iLocal_509=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_516, ENTITY::GET_ENTITY_ROTATION(uParam0, 2), 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_509, &sVar0, "enter", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_509);
...
iLocal_509=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_516, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 1, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_509, &sVar16, "base", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_509);
iLocal_508=2;
}
break;
...
switch (iVar66){
case 0:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_509, &sVar32, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_509);
StringCopy(&cLocal_519, "idle_a", 16);
iLocal_508=3;
break;
case 1:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_509, &sVar32, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_509);
StringCopy(&cLocal_519, "idle_b", 16);
iLocal_508=3;
break;
case 2:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_509, &sVar32, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_509);
StringCopy(&cLocal_519, "idle_c", 16);
iLocal_508=3;
break;
case 3:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_509, &sVar32, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_509);
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar32, "idle_b", 2)){
GRAPHICS::DRAW_DEBUG_TEXT("idle_b", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 256, 64, 64, 64);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar32, "idle_c", 2)){
GRAPHICS::DRAW_DEBUG_TEXT("idle_c", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 256, 64, 64, 64);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar32, "idle_d", 2)){
...
if(bParam1){
if(!MISC::IS_BIT_SET(Global_96690, bParam0)){
MISC::SET_BIT(&Global_96690, bParam0);
}}elseif(MISC::IS_BIT_SET(Global_96690, bParam0)){
MISC::CLEAR_BIT(&Global_96690, bParam0);
}}


bool func_60(int iParam0){
return MISC::IS_BIT_SET(Global_96691, iParam0);
}
...
if(ENTITY::DOES_ENTITY_EXIST(uParam0) && ENTITY::IS_ENTITY_AN_OBJECT(iParam0)){
...
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_505, 1.5f, 1.5f, 1.5f, 0, 1, 1)){
return 1;
}}
...
iVar3=0;
iVar11=SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_599, &iVar3, &uVar4, &uVar7, &uVar10);
if(iVar11==2){
iLocal_598=0;
if(iVar3 !=0){
iLocal_599=0;
if(ENTITY::IS_ENTITY_A_VEHICLE(uVar10) && !NETWORK::IS_ENTITY_A_GHOST(uVar10)){
iLocal_598=1;
}}
return iLocal_598;
}else{
...
int iVar0;
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(!NETWORK::NETWORK_TRY_TO_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, -1)){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}
func_107(0, -1, 0);
...
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}}elseif(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3)){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}}
