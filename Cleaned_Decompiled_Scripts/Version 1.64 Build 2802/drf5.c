...
uLocal_433=func_272(func_273(), 0, 1);
uLocal_434=func_272(func_273(), 0, 1);
...
func_253(&iLocal_399, &iLocal_402, uLocal_404, iLocal_60);
}
iLocal_82=func_252();
...
func_233(&iLocal_399, iLocal_55, Local_419, fLocal_425, iLocal_432, uLocal_433, uLocal_434);
...
func_137(&cLocal_407, PLAYER::PLAYER_PED_ID(), 0, 2);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_399, 0)){
func_137(&cLocal_413, iLocal_399, 0, 2);
}
bVar5=true;
}}}
if(func_135(&uVar6) > 6f && func_134()){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_399, 0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &cLocal_407, 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_399, &cLocal_413, 0, 0, 0);
}
...
func_131(iLocal_399, &iLocal_401, &iLocal_402, &uLocal_404, &uLocal_83, Local_422, fLocal_427, iLocal_57);
func_129(func_252());
func_243(&uLocal_251);
func_128(&uLocal_275, 0, 0, 0, 1);
...
if(func_97(&uLocal_251, &uLocal_275, &bVar1)){
if(bVar1){
Local_61.f_20=0;
}
else{
...
bVar2=true;
HUD::CLEAR_HELP(1);
}elseif(!bVar3 && func_135(&uLocal_251) >=7f){
StringCopy(&cVar18, "DRF_PROMPT", 16);
func_96(&uLocal_83, &cVar14, &cVar18, 9, 0, 0, 0);
bVar3=true;
}}elseif((func_135(&uLocal_251) > 5f && func_134()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_61.f_20 !=1 || func_135(&uLocal_251) > fVar22) || func_93(iLocal_82, iLocal_399, &uLocal_404)))){
func_90();
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &cLocal_407, 0, 0, 0);
}
...
break;
case 14:
if(CAM::DOES_CAM_EXIST(uLocal_404)){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_402, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_402, func_77(iLocal_402), 1, 0, 0, 1);
...
if(!func_75(&uVar9)){
func_243(&uVar9);
}elseif(func_135(&uVar9) > func_74(func_252())){
if(func_252()==4){
iLocal_400=PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_400, 3, iLocal_432, uLocal_433, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_400, 4, 0, uLocal_434, 0);
PED::SET_PED_MONEY(iLocal_400, (2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301)));
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_400, 1, 1);
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_400, 0)){
func_270(80, 1);
STATS::STAT_SET_BOOL(joaat("sp_killed_dr_friedlander"), 1, 1);
func_96(&uLocal_83, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
if(HUD::DOES_BLIP_EXIST(uLocal_403)){
HUD::SET_BLIP_COLOUR(uLocal_403, 1);
}
iLocal_60=17;
}elseif(!ENTITY::DOES_ENTITY_EXIST(iLocal_400) || func_72(iLocal_400, PLAYER::PLAYER_PED_ID(), 1) > 300f){
func_96(&uLocal_83, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
if(HUD::DOES_BLIP_EXIST(uLocal_403)){
HUD::SET_BLIP_COLOUR(uLocal_403, 3);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_400)){
MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_400, 1), 10f, 0);
}
iLocal_60=17;
}else{
func_55();
PED::SET_PED_CONFIG_FLAG(iLocal_400, 26, 1);
...
uLocal_404=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var26, Var29, 50f, 0, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_404, uLocal_405, 2660, 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_402) && !ENTITY::IS_ENTITY_DEAD(iLocal_402, 0)){
VEHICLE::SET_VEHICLE_FIXED(iLocal_402);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_402, 0);
VEHICLE::SET_VEHICLE_CAN_BREAK(iLocal_402, 1);
}
func_119(&uLocal_263);
iLocal_439=1;
}}elseif(!bVar23){
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
}}elseif(CAM::DOES_CAM_EXIST(uLocal_405)){
...
if(!HUD::DOES_BLIP_EXIST(uLocal_403)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_400, 0)){
uLocal_403=HUD::ADD_BLIP_FOR_ENTITY(iLocal_400);
HUD::SET_BLIP_COLOUR(uLocal_403, 1);
func_119(&uLocal_257);
}}elseif(HUD::GET_BLIP_COLOUR(uLocal_403) !=3){
HUD::SET_BLIP_COLOUR(uLocal_403, 3);
...
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_400, 0)){
iVar0=1;
}
if(!PED::IS_PED_FLEEING(iLocal_400)){
if((((((((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_401, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_401, 1)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 0, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 1, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 2, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_401, 3, 2000)) || (iVar0 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_400, 0))) || func_48(iLocal_401)) || func_44(iLocal_401)){
TASK::TASK_SMART_FLEE_PED(iLocal_400, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
}}
}
elseif(!PED::IS_PED_FLEEING(iLocal_400)){
TASK::TASK_SMART_FLEE_PED(iLocal_400, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
}
if(!bVar25 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_400, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, 1, 0)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_400, 0);
bVar25=true;
}}}
break;
case 16:
...
if(!func_1(80)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_400)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_401) && PED::IS_PED_IN_VEHICLE(iLocal_400, iLocal_401, 0)){
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_8() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_8() /*5568*/].f_681.f_10, iParam0);
}
...
uVar0=Global_2805027[iParam0 /*3*/][func_10(iParam1)];
...
bool bVar5;
float fVar6;
if((!ENTITY::DOES_ENTITY_EXIST(iLocal_400) || ENTITY::IS_ENTITY_DEAD(iLocal_400, 0)) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
return;
}
...
fVar6=SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_400, 1));
if(iLocal_429 < 7){
if(iLocal_429 <=0){
...
if(!MISC::IS_BIT_SET(uLocal_428, bVar5)){
if(bVar4==0){
...
if(iLocal_431 < 8){
if(iLocal_431 <=0){
if(func_135(&uLocal_272) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_400)){
...
bVar5=false;
while (bVar5 >=0){
if(!MISC::IS_BIT_SET(uLocal_430, bVar5)){
if(bVar4==0){
...
Vector3 func__76(struct<3> Param0){
float fVar0;
float fVar1;
...
Vector3 func__86(int iParam0, struct<3> Param1){
var uVar0;
...
void func_88(){
float fVar0;
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_401, 0)){
VEHICLE::DELETE_VEHICLE(&iLocal_401);
iLocal_401=VEHICLE::CREATE_VEHICLE(iLocal_57, Local_422, fLocal_427, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_401, 6);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_399)){
PED::DELETE_PED(&iLocal_399);
}
if((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_401, 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_401, 0)){
...
ENTITY::SET_ENTITY_COORDS(iLocal_401, Local_422, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_401, fLocal_427);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_402)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_402, 0)){
VEHICLE::SET_VEHICLE_FIXED(iLocal_402);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_402, 1);
VEHICLE::SET_VEHICLE_CAN_BREAK(iLocal_402, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_402, func_77(iLocal_402), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_402, 231f);
}}
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_STAND_STILL(PLAYER::PLAYER_PED_ID(), -1);
if((!iLocal_437 || !ENTITY::DOES_ENTITY_EXIST(iLocal_400)) || ENTITY::IS_ENTITY_DEAD(iLocal_400, 0)){
iLocal_400=PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_400, 3, iLocal_432, uLocal_433, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_400, 4, 0, uLocal_434, 0);
PED::SET_PED_MONEY(iLocal_400, (2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301)));
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_400, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_400, 1);
func_73(&uLocal_83, 1, iLocal_400, "FRIEDLANDER", 0, 1);
iLocal_437=1;
}else{
ENTITY::SET_ENTITY_COORDS(iLocal_400, -1899.7f, -562.2f, 10.7945f, 1, 0, 0, 1);
...
fVar0=2f;
if(!PED::IS_PED_INJURED(iLocal_400) && !ENTITY::IS_ENTITY_DEAD(iLocal_401, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_406);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_406);
TASK::TASK_PERFORM_SEQUENCE(iLocal_400, uLocal_406);
PED::FORCE_PED_MOTION_STATE(iLocal_400, joaat("MotionState_Run"), 1, 1, 1);
}
uLocal_403=HUD::ADD_BLIP_FOR_ENTITY(iLocal_400);
HUD::SET_BLIP_COLOUR(uLocal_403, 1);
func_119(&uLocal_257);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
uLocal_405=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
HUD::DISPLAY_RADAR(0);
HUD::DISPLAY_HUD(0);
}
...
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}elseif(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), &cVar1, &Var13) >=0.99f){
return 1;
}}}
return 0;
}
...
func_98(uParam1, 1128792064, 1, 0, 1, 1065353216);
return 0;
}


void func_98(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
int iVar2;
var uVar3;
...
if(!func_103(uParam0->f_1, 256) || (func_103(uParam0->f_1, 8192) && PAD::HAVE_CONTROLS_CHANGED(2))){
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_103(uParam0->f_1, 4096));
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
iVar5=0;
iVar6=0;
...
fVar8=func_54(bParam4, func_54(func_103(uParam0->f_1, 32), 1f, 0f), -1f);
...
struct<4> Var1;
Var1={
func_109(uParam0, &uVar0, iParam1, 1) 
};
if(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX01")){
return 8;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX02")){
return 16;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX03")){
return 32;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX04")){
return 64;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX05")){
return 128;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX06")){
return 256;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX07")){
return 512;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX08")){
return 1024;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX09")){
return 2048;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX10")){
return 4096;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX11")){
return 8192;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTSX12")){
return 16384;
}
return 8;
}
...
iVar2[iParam0]=0;
}elseif((iParam1 > 0 && iParam1 < 13) && !func_115(&(Global_113648.f_19963), iParam1)){
iVar2[iParam1]=0;
}elseif((iParam2 > 0 && iParam2 < 13) && !func_115(&(Global_113648.f_19963), iParam2)){
iVar2[iParam2]=0;
}elseif((iParam3 > 0 && iParam3 < 13) && !func_115(&(Global_113648.f_19963), iParam3)){
iVar2[iParam3]=0;
}elseif((iParam4 > 0 && iParam4 < 13) && !func_115(&(Global_113648.f_19963), iParam4)){
iVar2[iParam4]=0;
}
...
}elseif(iParam3 <=0 || iParam3 >=13){
iVar1=MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
}elseif(iParam4 <=0 || iParam4 >=13){
...
void func_131(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, struct<3> Param5, float fParam8, int iParam9){
int iVar0;
int iVar1;
...
if(!ENTITY::DOES_ENTITY_EXIST(*uParam1)){
*uParam1=VEHICLE::CREATE_VEHICLE(iParam9, Param5, fParam8, 1, 1, 0);
...
return (func_50(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
void func_137(char[4] cParam0, int iParam1, int iParam2, int iParam3){
struct<50> Var0;
int iVar65;
Var0=12;
Var0.f_13=12;
...
Var67={
func_150(iVar81, 2, uParam1->f_59, -1) 
};
...
Var67={
func_150(iVar81, 1, uParam1->f_62, -1) 
};
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_144(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_144(iParam0));
if(iVar57 > iVar56){
...
var uVar0;
var uVar1;
uVar0=Global_2848280[iParam0 /*3*/][func_10(uParam1)];
...
struct<4> Var1;
Var1={
func_225(iParam0, 1, 1, &uVar0) 
};
if(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW01")){
return 128;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW02")){
return 256;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW03")){
return 512;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW04")){
return 1024;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW05")){
return 2048;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW06")){
return 4096;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW07")){
return 8192;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW08")){
return 16384;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW09")){
return 32768;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW10")){
return 65536;
}elseif(MISC::ARE_STRINGS_EQUAL(&Var1, "OBTOW11")){
return 131072;
}
return 128;
}
...
int iVar7;
bool bVar8;
if((((!func_230(&(Global_113648.f_19963), 8) && iParam1) && iParam0 !=4) && func_228(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f){
bVar4=8;
*uParam3=4;
}else{
...
bVar8=true;
while (iVar7 > 0){
if(MISC::IS_BIT_SET(uVar5, bVar8)){
iVar7=(iVar7 - 1);
if(iVar7==0){
bVar4=bVar8;
}}
...
return 32;
}elseif(!func_232(84) && !func_232(85)){
return 16;
}}
break;
}
...
void func_233(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6, var uParam7, var uParam8){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
