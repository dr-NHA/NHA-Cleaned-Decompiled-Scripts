...
if((((!func_185() && !PED::IS_PED_FLEEING(uLocal_53)) && !PED::IS_PED_RAGDOLL(uLocal_53)) && !PED::IS_PED_PRONE(uLocal_53)) && !PED::IS_PED_INJURED(uLocal_53)){
if(func_184(uLocal_53, PLAYER::PLAYER_PED_ID(), 1) <=3f){
if((MISC::GET_GAME_TIMER() - iLocal_220) > 8000){
if(func_173(&uLocal_54, "EPS5AUD", "EP5_FOLLOW", 7, 0, 0, 0)){
iLocal_220=MISC::GET_GAME_TIMER();
}}}}
if(func_184(uLocal_53, PLAYER::PLAYER_PED_ID(), 1) > 150f){
func_172(&uLocal_53);
}}else{
...
void func_41(){
if(((!func_44() && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())){
if(iLocal_49==1){
...
iLocal_52=MISC::GET_GAME_TIMER();
iLocal_49=0;
}}elseif(IntToFloat((MISC::GET_GAME_TIMER() - iLocal_52)) > fLocal_51){
iLocal_49=1;
}}}


void func_42(var uParam0, char* sParam1, int iParam2){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_43(iParam2), 1);
}
...
Global_78341[1 /*14*/]={
func_69(iVar0, iParam1, iParam2, -1) 
};
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_49(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(uParam0, func_49(iParam1))){
return 1;
}
return 0;
}
...
return 1;
}elseif(func_57(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_53(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_49(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_49(iParam2));
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_49(iParam0));
if(iVar57 > iVar56){
...
int iVar30;
Global_78341[1 /*14*/]={
func_69(iParam0, iParam1, iParam2, -1) 
};
...
MemCopy(&Var3,{
func_166(Global_44465[iVar7 /*12*/].f_1)
}
, 4);
}else{
Var3={
...
if(bVar1){
func_163(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_164(iParam1)), 0));
}else{
func_163(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_164(iParam1)), 0));
}
switch (Global_20383){
case 0:
StringCopy(&Global_20372, "Phone_SoundSet_Michael", 24);
...
iVar2=iVar20;
Var3={
func_166(Global_44465[iVar20 /*12*/].f_1) 
};
...
Var3={
func_166(Global_44465[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
iLocal_50=0;
iLocal_222=0;
}elseif(!func_188(func_140(0), 12, 8)){
iLocal_223=func_159();
...
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(uLocal_53)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_53, 1, 0);
}
PED::SET_PED_MONEY(uLocal_53, 0);
PED::SET_PED_CAN_BE_TARGETTED(uLocal_53, 0);
PED::SET_PED_NAME_DEBUG(uLocal_53, "POSTMARNIE");
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_53, joaat("player"));
