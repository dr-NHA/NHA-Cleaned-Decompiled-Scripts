...
bLocal_41=true;
iLocal_606=15;
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(210)) func_53();
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("spaceshipparts")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
func_52(14);
func_50();
...
if(!bLocal_608) bLocal_608=func_11(367701416, 1, 2, 69, 5000, 10000, -1, 179, -1, 32, 1);
if(bLocal_608){
if(!_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) func_1("SSHIP_SWITCH" /*Switch to Franklin to deliver the spaceship parts to Omega.*/, 1, 0, 20000, 10000, 3, 0, 0, 0);
func_53();
}}}
return;
}
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_7(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
if(func_7(character)) return func_10(character);
...
if(OBJECT::DOES_PICKUP_EXIST(uParam1->[uParam0->f_10 /*11*/].f_1)) INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(uParam1->[uParam0->f_10 /*11*/].f_1, "GtaMloRoomTun5");
}elseif(uParam0->f_10==6 || uParam0->f_10==14 || uParam0->f_10==21 || uParam0->f_10==34 || uParam0->f_10==39){
...
if(!Global_78819) func_17(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 0, &iLocal_607, &uLocal_609, "SSHIP_TITLE" /*Part Collected~s~*/, "SSHIP_COLLECT" /*~1~/50 spaceship parts collected.*/);
if(!bLocal_608)if(uParam0->f_1.f_4 >=uParam0->f_1.f_3) bLocal_608=func_11(367701416, 1, 2, 69, 5000, 10000, -1, 179, -1, 32, 1);
...
i < func_24(iParam0);
i=i + 1){
if(IS_BIT_SET(Global_113648.f_10051.f_108, func_23(func_24(iParam0), i))) outValue=outValue + 1;
}}elseif(iParam0==6){
...
if(func_20(num, -1)) outValue=outValue + 1;
}}
return outValue;
}
BOOL func_20(int iParam0, int iParam1) // Position - 0xCA8{
if(iParam1==-1) iParam1=func_21();
...
if(*uParam0==1 || *uParam0==0) func_38(*uParam0, iParam2, true);
PAD::SET_CONTROL_SHAKE(PLAYER_CONTROL, 200, 250);
STATS::STAT_INCREMENT(uParam0->f_6, 1f);
if(bLocal_41) func_37(&(uParam0->f_1), iParam2);
else func_34(&(uParam0->f_1));
func_31();
...
num=num + outValue;
if(outValue > 0) func_32(18, outValue);
STATS::STAT_GET_INT(func_33(1), &outValue, -1);
num=num + outValue;
if(outValue > 0) func_32(19, outValue);
STATS::STAT_GET_INT(func_33(3), &outValue, -1);
num=num + outValue;
if(outValue > 0) func_32(20, outValue);
...
uParam0->f_4=num;
bLocal_40;
if(num==uParam0->f_3 && uParam0->f_2==705) func_35(168, 0);
return;
}
...
bLocal_40;
if(uParam0->f_4==uParam0->f_3 && uParam0->f_2==705) func_35(168, 0);
return;
}
...
if(bParam3) func_44(uParam0->f_3);
...
Vector3 func__51(int iParam0, int iParam1) // Position - 0x1988{
switch (iParam0){
case 0:
return -1219f, -3495.9f, 12.9448f;
case 1:
if(iParam1==1) return 606.8925f, -3250.1875f, 5.06951f;
else return 634.5865f, -3232.7903f, -16.5774f;
break;
case 2:
return 1590.5997f, -2810.174f, 3.4494f;
case 3:
if(iParam1==1) return 327.99f, -2757.61f, 4.99f;
else return 338.4039f, -2762.1057f, 42.6543f;
break;
case 4:
if(iParam1==1) return 1134.4216f, -2607.0237f, 14.77071f;
else return 1133.6882f, -2605.0728f, 14.9729f;
break;
case 5:
if(iParam1==1) return 368.93164f, -2118.5327f, 15.40341f;
else return 369.945f, -2116.7556f, 16.1688f;
break;
case 6:
if(iParam1==1) return 1741.82f, -1623.85f, 111.41f;
else return 1742.0242f, -1618.7767f, 111.8313f;
break;
case 7:
...
case 9:
if(iParam1==1) return -910.01715f, -1147.44f, 1.06785f;
else return -900.3597f, -1165.5511f, 31.8047f;
break;
case 10:
if(iParam1==1) return 1237.7278f, -1099.1497f, 37.52579f;
else return 1231.9734f, -1102.3076f, 34.4289f;
break;
case 11:
if(iParam1==1) return 87.69075f, 810.3736f, 210.12582f;
else return 81.2213f, 814.0283f, 213.2917f;
break;
case 12:
if(iParam1==1) return -1900.9506f, 1389.5819f, 218.1509f;
else return -1907.5149f, 1388.69f, 217.9728f;
break;
case 13:
if(iParam1==1) return 467.36896f, -730.75525f, 26.36373f;
else return 469.8529f, -730.8f, 26.3985f;
break;
case 14:
return 202.1081f, -569.7198f, 128.18f;
case 15:
if(iParam1==1) return 163.0531f, -566.3394f, 21.029f;
else return 159.39f, -563.82f, 21f;
break;
case 16:
if(iParam1==1) return -1183.1521f, -518.5386f, 38.53018f;
else return -1182.5385f, -525.5859f, 39.9114f;
break;
case 17:
...
case 19:
if(iParam1==1) return -1169.3975f, -56.76701f, 44.45705f;
else return -1175.4877f, -65.4649f, 44.6563f;
break;
case 20:
if(iParam1==1) return 1679.0564f, 39.44059f, 160.77364f;
else return 1684.664f, 40.7142f, 153.4074f;
break;
case 21:
if(iParam1==1) return 1964.25f, 553.68f, 160.72f;
else return 1965.58f, 555.99f, 160.79f;
break;
case 22:
if(iParam1==1) return 24.21706f, 637.1212f, 206.38968f;
else return 22.4492f, 638.8155f, 189.6085f;
break;
case 23:
return 2901.204f, 796.1192f, 3.3556f;
case 24:
if(iParam1==1) return -1531.895f, 870.3203f, 180.67746f;
else return -1529.7219f, 871.4257f, 180.6421f;
break;
case 25:
...
case 27:
if(iParam1==1) return 3144.0452f, 2184.4133f, -5.2961f;
else return 3144.0452f, 2184.4133f, -5.2961f;
break;
case 28:
...
case 30:
if(iParam1==1) return -1452.23f, 2127.41f, 42.84f;
else return -1436.87f, 2130.22f, 26.78f;
break;
case 31:
return 1367.4128f, 2180.6316f, 96.6914f;
case 32:
if(iParam1==1) return 170.1652f, 2217.637f, 89.30811f;
else return 172.1426f, 2220.1313f, 89.7842f;
break;
case 33:
return 889.3209f, 2870.0522f, 55.2834f;
case 34:
if(iParam1==1) return 1980.2f, 2914.79f, 45.48f;
else return 1963.55f, 2922.81f, 57.76f;
break;
case 35:
...
case 39:
if(iParam1==1) return 2514.3015f, 3789.5193f, 52.077f;
else return 2516.98f, 3789.35f, 53.79f;
break;
case 40:
if(iParam1==1) return 1517.6129f, 3803.926f, 30.95605f;
else return 1486.0475f, 3857.2168f, 22.2905f;
break;
case 41:
if(iParam1==1) return -530.27386f, 4474.3584f, 59.45993f;
else return -528.8246f, 4440.6436f, 31.7384f;
break;
case 42:
if(iParam1==1) return 3815.055f, 4447.343f, 2.06631f;
else return 3820.8132f, 4441.683f, 1.8007f;
break;
case 43:
if(iParam1==1) return -1946.95f, 4584.36f, 56.06f;
else return -1943.0546f, 4585.1943f, 46.6362f;
break;
case 44:
...
case 47:
if(iParam1==1) return -503.95f, 5673.55f, 51.24f;
else return -503.2193f, 5665.6104f, 48.8487f;
break;
case 48:
if(iParam1==1) return -378.41922f, 6080.782f, 30.44296f;
else return -381.291f, 6086.949f, 38.6147f;
break;
case 49:
