...
fLocal_50=2f * 2f;
uLocal_51={
-1011.7365f, -480.254f, 39.0734f 
};
uLocal_54={
-1003.0779f, -477.962f, 49.1374f 
};
uLocal_57={
...
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83)) func_90();
...
case 2:
case 3:
if(!func_76(iLocal_85))if(func_73() && !func_72() && func_71() && !_IS_MISSION_REPEAT_ACTIVE(false))if(iLocal_87 !=0)if(GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_87)) func_68(iLocal_85, true, false);
break;
case 4:
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_78)) PED::SET_PED_CAPSULE(pedLocal_78, 0.75f);
if(!func_76(4))if(func_73() && func_71() && !_IS_MISSION_REPEAT_ACTIVE(false)) func_68(4, true, false);
break;
case 5:
if(func_63()) func_35();
if(!func_76(5) && iLocal_73==4 && func_71() && !_IS_MISSION_REPEAT_ACTIVE(false)) func_68(5, true, false);
break;
case 6:
if(!func_34(3))if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -580.89136f, 2033.1201f, 130.51126f, -578.47833f, 2035.0287f, 127.561455f, 0.75f, false, true, 0)) func_33(3, true);
...
if(func_6()){
if(!func_5(0)){
if(PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_CONTEXT)) func_3();
...
if(func_11(echParam0, echParam1)==1 && func_10(echParam0, echParam1)==1) bParam2=false;
num=echParam1;
...
if(bParam18) func_32(playersLastVehicle);
...
if(entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)if(func_29(playersLastVehicle, vParam0, vParam3, fParam6)) flag=true;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false)){
...
if(bParam16)if(func_27(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true)) flag=false;
if(flag){
...
for (i=0;
func_28(echParam1, i, &garageName, &num);
i=i + 1){
...
Vector3 func__31(float fParam0, var uParam1, var uParam2) // Position - 0x1412{
float num;
float num2;
...
if(bParam1) MISC::SET_BIT(&iLocal_92, iParam0);
else MISC::CLEAR_BIT(&iLocal_92, iParam0);
return;
}
...
if(WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true))if(weaponHash !=joaat("WEAPON_UNARMED")) WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), false);
...
Vector3 func__42() // Position - 0x4D4F{
...
if(!INTERIOR::IS_INTERIOR_DISABLED(interior)) return;
if(func_46(iParam0)) func_48(iParam0, false);
}
...
float width;
vector={
-1007.013f, -478.36624f, 49.028175f 
};
vector2={
-1007.85004f, -476.95728f, 51.028072f 
};
width=1.75f;
switch (iLocal_73){
case 0:
...
case 1:
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vector, vector2, width, false, true, 0) && !func_5(0)){
if(!func_52(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LOOK_AT_COORD)) TASK::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1007.9945f, -476.8016f, 49.9117f, -1, 0, 2);
...
func_51(false);
HUD::DISPLAY_RADAR(false);
if(!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sLocal_91)) func_53(sLocal_91);
if(PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT)){
...
if(func_59()) return;
if(Global_20584)if(func_58()) func_57(true, true);
...
func_33(4, !bParam0);
if(bParam0) CAM::DO_SCREEN_FADE_IN(iParam1);
else CAM::DO_SCREEN_FADE_OUT(iParam1);
return;
}
BOOL func_62() // Position - 0x52EE{
int clockHours;
clockHours=CLOCK::GET_CLOCK_HOURS();
if(clockHours >=21 || clockHours < 6) return true;
_DISPLAY_HELP_TEXT("MM_SOLBUSY" /*Solomon's office is busy. Come back later.*/, 5000);
return false;
}
BOOL func_63() // Position - 0x5321{
if(iLocal_72==1) return true;
if(!func_71()) return false;
if(!func_66(61)) return false;
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 && iLocal_72==0) return false;
if(_IS_MISSION_REPEAT_ACTIVE(false)) return false;
if(func_65()) return false;
if(func_17(_GET_CURRENT_PLAYER_CHARACTER()))if(func_64(_GET_CURRENT_PLAYER_CHARACTER())==4 || func_64(_GET_CURRENT_PLAYER_CHARACTER())==5) return false;
...
if(!bParam2) AUDIO::PLAY_SOUND_FRONTEND(iLocal_81, sLocal_79, sLocal_80, false);
func_69();
}else{
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID())) return PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false);
return false;
}
...
Vector3 func__75(int iParam0) // Position - 0x55F0{
switch (iParam0){
case 0:
...
Vector3 func__81(int iParam0) // Position - 0x5819{
switch (iParam0){
case 0:
return 1.8941f, 309.6565f, 111.0097f;
case 1:
...
if(_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID())) uLocal_82={
...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("murdermystery")) > 1) SCRIPT::TERMINATE_THIS_THREAD();
for (i=0;
i < 7 && iLocal_85==7;
i=i + 1){
num=i;
if(func_88(uParam0, func_81(num), 1056964608)) iLocal_85=num;
}
func_84();
return;
}
...
break;
case 4:
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_78)) ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_78);
STREAMING::REMOVE_ANIM_DICT(sLocal_88);
break;
case 5:
if(OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(hLocal_75)) OBJECT::REMOVE_DOOR_FROM_SYSTEM(hLocal_75, 0);
if(CAM::DOES_CAM_EXIST(caLocal_74)) CAM::DESTROY_CAM(caLocal_74, false);
if(func_34(4)) CAM::DO_SCREEN_FADE_IN(0);
if(func_34(5)) CLOCK::PAUSE_CLOCK(false);
if(func_34(6)) PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sLocal_90) || _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sLocal_91)) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
break;
case 6:
if(ENTITY::DOES_ENTITY_EXIST(pedLocal_76)) ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_76);
if(ENTITY::DOES_ENTITY_EXIST(obLocal_77)) ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&obLocal_77);
if(func_34(2)) ENTITY::REMOVE_MODEL_HIDE(uLocal_68, 200f, joaat("prop_mineshaft_door"), false);
break;
}
return;
}