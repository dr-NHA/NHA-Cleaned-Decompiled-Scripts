...
fLocal_50=(2f * 2f);
Local_51={
-1011.737f, -480.254f, 39.0734f 
};
Local_54={
-1003.078f, -477.962f, 49.1374f 
};
Local_57={
...
PED::SET_PED_CAPSULE(uLocal_78, 0.75f);
}
if(!func_76(4)){
...
ENTITY::CREATE_MODEL_HIDE(Local_68, 200f, joaat("prop_mineshaft_door"), 0);
func_33(2, 1);
}}
if(func_73() && !func_72()){
...
return MISC::IS_BIT_SET(uLocal_92, iParam0);
}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_51, Local_65, 1, 1, 0)){
if(func_62()){
iLocal_72=2;
func_61(0, 800);
}}}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_54, Local_65, 1, 1, 0)){
func_54(0);
iLocal_72=3;
func_61(0, 800);
}
...
float fVar6;
Var0={
-1007.013f, -478.3662f, 49.02818f 
};
Var3={
-1007.85f, -476.9573f, 51.02807f 
};
fVar6=1.75f;
switch (iLocal_73){
case 0:
...
if(!bParam2){
AUDIO::PLAY_SOUND_FRONTEND(uLocal_81, sLocal_79, sLocal_80, 0);
}
func_69();
}else{
...
return MISC::IS_BIT_SET(Global_113648.f_10051.f_133, iParam0);
}
...
func_85(sLocal_88);
uLocal_78=PED::CREATE_PED(26, joaat("u_f_m_drowned_01"), func_75(4), 184.5548f, 1, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("u_f_m_drowned_01"));
TASK::TASK_PLAY_ANIM(uLocal_78, sLocal_88, sLocal_89, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_78, 1);
PED::SET_PED_KEEP_TASK(uLocal_78, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_78, 1);
AUDIO::STOP_PED_SPEAKING(uLocal_78, 1);
AUDIO::DISABLE_PED_PAIN_AUDIO(uLocal_78, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_78, 118, 0);
PED::SET_PED_CONFIG_FLAG(uLocal_78, 208, 1);
ENTITY::SET_ENTITY_INVINCIBLE(uLocal_78, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_78, joaat("player"));
break;
case 5:
iLocal_75=731806707;
OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_75, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_75, 1, 1, 0);
uLocal_74=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
break;
case 6:
func_86(joaat("u_m_o_filmnoir"));
uLocal_76=PED::CREATE_PED(26, joaat("u_m_o_filmnoir"), func_75(6), 22.9631f, 1, 1);
PED::SET_PED_PROP_INDEX(uLocal_76, 0, 0, 0, 0, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("u_m_o_filmnoir"));
AUDIO::STOP_PED_SPEAKING(uLocal_76, 1);
AUDIO::DISABLE_PED_PAIN_AUDIO(uLocal_76, 1);
PED::EXPLODE_PED_HEAD(uLocal_76, joaat("weapon_sniperrifle"));
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_76, joaat("player"));
uLocal_77=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, 1, 1, 0);
break;
}}
...
if(func_34(2)){
ENTITY::REMOVE_MODEL_HIDE(Local_68, 200f, joaat("prop_mineshaft_door"), 0);
}
break;
}}