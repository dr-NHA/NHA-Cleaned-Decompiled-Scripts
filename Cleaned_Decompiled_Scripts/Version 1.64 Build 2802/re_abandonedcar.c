...
Local_279={
1435.77f, 2983.11f, 40.77f 
};
Local_282={
2162.552f, 2122.646f, 124.7956f 
};
Local_56={
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_252, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_252, 0)){
func_220();
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_253, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_253, 0)){
func_220();
}}
if(!iLocal_260){
func_219();
...
if(!iLocal_261){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_254, 0)){
if(func_205(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_254, 1), 1) < IntToFloat(iLocal_274) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_254)){
if(!iLocal_268){
func_203();
SYSTEM::WAIT(0);
if(iLocal_52==1){
...
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_251, 1);
}
iLocal_268=1;
}}
}
...
if(!iLocal_263){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_254, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_254, 0)){
if(!PED::IS_PED_INJURED(iLocal_252)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_271);
TASK::TASK_ENTER_VEHICLE(0, iLocal_254, -1, -1, 2f, 524296, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_271);
TASK::TASK_PERFORM_SEQUENCE(iLocal_252, uLocal_271);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_271);
...
void func_2(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_252, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 10f, 10f, 10f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
TASK::TASK_PLAY_ANIM(iLocal_252, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0, 0, 0, 0);
...
if(!PED::IS_PED_INJURED(iLocal_252)){
func_168();
uLocal_82=STREAMING::STREAMVOL_CREATE_SPHERE(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
func_160(1);
...
iLocal_255=VEHICLE::CREATE_MISSION_TRAIN(0, 1063.595f, 3227.571f, 39.3899f, 1, 0, 0);
uVar0=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_255, 26, iLocal_258, -1, 1, 1);
uVar0=uVar0;
if(!iLocal_266){
if(AUDIO::REQUEST_SCRIPT_AUDIO_BANK("Train_Horn", 0, -1)){
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Warning_Once", iLocal_255, "TRAIN_HORN", 0, 0);
}}
...
break;
case 3:
STREAMING::STREAMVOL_DELETE(uLocal_82);
...
}}elseif(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), "random@train_tracks", "on_back_c") < 0.1f){
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(-5.2078f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(-15.2963f, 1065353216);
}}
...
if(iParam5==0){
Global_78341[1 /*14*/]={
func_96(iVar10, iParam1, iParam2, -1) 
};
if(!func_95(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78341[1 /*14*/]={
func_96(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_75(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_96(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78341[1 /*14*/]={
func_96(iVar10, iVar0, func_54(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_75(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_96(iVar10, 14, uVar69[iVar1], -1) 
};
func_65(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_88(14);
if(Global_78339==1){
...
Global_78341[1 /*14*/]={
func_96(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78341[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78341[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_55(iParam1)) && Global_78341[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_55(iParam1))){
return 1;
}
return 0;
}
...
Global_78341[1 /*14*/]={
func_96(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_82(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar37=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_55(iParam2));
if(iVar37 <=iVar36){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_55(iParam2));
...
int iVar2;
int iVar3;
uVar0=func_55(iParam3);
iVar1=PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, uVar0);
iVar3=0;
while (iVar3 <=(iVar1 - 1)){
if(iVar3 !=iParam1){
iVar2=(iVar2 + PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, uVar0, iVar3));
}else{
iVar2=(iVar2 + iParam2);
return iVar2;
}
...
if(iVar56 >=0){
iVar57=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_55(iParam0));
if(iVar57 > iVar56){
...
if(!iLocal_267){
if(!PED::IS_PED_INJURED(iLocal_252)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 50f, 50f, 50f, 0, 1, 0)){
func_15();
}}}}elseif(iLocal_52==2){
if(!PED::IS_PED_INJURED(iLocal_252) && !PED::IS_PED_INJURED(iLocal_253)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 200f, 200f, 200f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 200f, 200f, 200f, 0, 1, 0)){
func_15();
}}}}
...
if(iLocal_52==1){
if(!PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_252, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_71, 215f, 215f, 215f, 0, 1, 0)){
if((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_252) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_252)) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_71, 215f, 215f, 215f, 0, 1, 0)){
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_71, 215f, 215f, 215f, 0, 1, 0)){
...
if(iLocal_278 < 3){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 20f, 20f, 10f, 0, 1, 0)){
if(func_177()){
func_176(0);
}}elseif(func_3()){
func_176(1);
...
func_176(1);
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_253, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_253, 31f, 31f, 11f, 0, 1, 0)){
if(func_177()){
func_176(0);
}}elseif(func_3()){
func_176(1);
...
if(!func_3()){
if(!iLocal_270){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 30f, 30f, 10f, 0, 1, 0)){
if(func_202()==0){
...
}}}elseif(!PED::IS_PED_INJURED(iLocal_253)){
...
if(!PED::IS_PED_INJURED(iLocal_252)){
if(!TASK::IS_PED_IN_WRITHE(iLocal_252)){
if((PED::IS_PED_RAGDOLL(iLocal_252) || PED::IS_PED_BEING_STUNNED(iLocal_252, joaat("weapon_stungun"))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_252, PLAYER::PLAYER_PED_ID(), 1)){
func_203();
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_252);
}
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, Local_78, 0, 1, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_252, Local_71, 290f, 290f, 290f, 0, 1, 0)){
...
if(!PED::IS_PED_INJURED(iLocal_252)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_252, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_252, 0), 0)){
...
ENTITY::APPLY_FORCE_TO_ENTITY(PED::GET_VEHICLE_PED_IS_IN(iLocal_252, 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "SUSPENSION_SCRIPT_FORCE", PED::GET_VEHICLE_PED_IS_IN(iLocal_252, 0), 0, 0, 0);
}}
...
if(!PED::IS_PED_INJURED(iLocal_253)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_253, PLAYER::PLAYER_PED_ID(), 1)){
TASK::TASK_PLAY_ANIM(iLocal_253, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0, 0, 0, 0);
}}}}


void func_180(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_254, 0)){
if((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_254, 0)) || iLocal_52==2){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_254, Local_75, 0, 1, 0) || iLocal_260){
if(iLocal_52==1){
Local_59={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(-1f, 8.8f, 0f) 
};
PATHFIND::GET_SAFE_COORD_FOR_PED(Local_59, 0, &Local_59, 0);
Local_62={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(-1f, 0f, 8.8f) 
};
PATHFIND::GET_SAFE_COORD_FOR_PED(Local_62, 0, &Local_62, 0);
Local_65={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(-1f, 8.8f, 0f) 
};
PATHFIND::GET_SAFE_COORD_FOR_PED(Local_65, 0, &Local_65, 0);
Local_68={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(-1f, 0f, 8.8f) 
};
PATHFIND::GET_SAFE_COORD_FOR_PED(Local_68, 0, &Local_68, 0);
if(!CAM::IS_SPHERE_VISIBLE(Local_59, 2f)){
iLocal_252=PED::CREATE_PED(19, iLocal_258, Local_59 - Vector(1f, 0f, 0f), func_185(Local_59, func_186(PLAYER::PLAYER_ID())), 1, 1);
}elseif(!CAM::IS_SPHERE_VISIBLE(Local_62, 2f)){
iLocal_252=PED::CREATE_PED(19, iLocal_258, Local_62 - Vector(1f, 0f, 0f), func_185(Local_62, func_186(PLAYER::PLAYER_ID())), 1, 1);
}elseif(!CAM::IS_SPHERE_VISIBLE(Local_65, 2f)){
iLocal_252=PED::CREATE_PED(19, iLocal_258, Local_65 - Vector(1f, 0f, 0f), func_185(Local_65, func_186(PLAYER::PLAYER_ID())), 1, 1);
}elseif(!CAM::IS_SPHERE_VISIBLE(Local_68, 2f)){
iLocal_252=PED::CREATE_PED(19, iLocal_258, Local_68 - Vector(1f, 0f, 0f), func_185(Local_68, func_186(PLAYER::PLAYER_ID())), 1, 1);
}
if(!PED::IS_PED_INJURED(iLocal_252)){
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_252, "A_M_M_HillBilly_01_WHITE_MINI_02");
WEAPON::GIVE_WEAPON_TO_PED(iLocal_252, joaat("weapon_stungun"), -1, 1, 1);
PED::SET_PED_SHOOT_RATE(iLocal_252, 100);
PED::SET_PED_CONFIG_FLAG(iLocal_252, 137, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_252, 188, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_252, 286, 1);
PED::SET_PED_MIN_GROUND_TIME_FOR_STUNGUN(PLAYER::PLAYER_PED_ID(), 10000);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_252, 0, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_252, 27, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_252, 13, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_252, 50, 1);
...
if(!HUD::DOES_BLIP_EXIST(uLocal_249)){
uLocal_249=func_181(iLocal_252, 1, 145);
}
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_271);
PED::SET_PED_KEEP_TASK(iLocal_252, 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_252, 0, 0);
iLocal_261=1;
}}elseif(iLocal_52==2){
iLocal_260=1;
AUDIO::TRIGGER_MUSIC_EVENT(sLocal_277);
...
if(!PED::IS_PED_INJURED(iLocal_253)){
uLocal_250=func_181(iLocal_253, 1, 145);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_271);
TASK::TASK_PERFORM_SEQUENCE(iLocal_253, uLocal_271);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_271);
PED::SET_PED_KEEP_TASK(iLocal_253, 1);
}
func_203();
SYSTEM::WAIT(0);
if(!PED::IS_PED_INJURED(iLocal_252) && !PED::IS_PED_INJURED(iLocal_253)){
...
var func__181(int iParam0, bool bParam1, int iParam2){
var uVar0;
uVar0=func_182(iParam0, !bParam1, 0);
...
HUD::SET_BLIP_SCALE(uVar0, func_183(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
if(!bParam2){
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
}else{
HUD::SET_BLIP_COLOUR(uVar0, 2);
}}elseif(ENTITY::IS_ENTITY_A_PED(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_183(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
...
var func__185(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5){
...
if(!func_237()){
if(func_205(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_254, 1), 1) < IntToFloat(iLocal_273)){
if(HUD::DOES_BLIP_EXIST(uLocal_251)){
HUD::REMOVE_BLIP(&uLocal_251);
}
uLocal_251=func_218(iLocal_254, 0, 0);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_251, 0);
...
if(iLocal_52==1){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_252, 0)){
if((((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 13f, 13f, 13f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_252, 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_252, PLAYER::PLAYER_PED_ID(), 1)) || CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(iLocal_252, 1), 2f)){
iLocal_260=1;
SYSTEM::SETTIMERB(0);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_252, 0)){
if(!iLocal_83){
...
if(iLocal_52==1){
PED::ADD_SCENARIO_BLOCKING_AREA(Local_71 - Vector(20f, 50f, 50f), Local_71 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
}elseif(iLocal_52==2){
PED::ADD_SCENARIO_BLOCKING_AREA(Local_71 - Vector(50f, 100f, 100f), Local_71 + Vector(50f, 100f, 100f), 0, 1, 1, 1);
}
MISC::CLEAR_AREA_OF_VEHICLES(Local_56, 50f, 0, 0, 0, 0, 0, 0, 0);
...
iLocal_254=VEHICLE::CREATE_VEHICLE(iLocal_259, Local_71, fLocal_74, 1, 1, 0);
...
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_254, "RE_ABANDONED_VEHICLE_MOTORHOME", 0);
...
if(iLocal_52==1){
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_254, 0, 1, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_254, 1, 1, 0);
VEHICLE::SET_VEHICLE_DAMAGE(iLocal_254, Local_71, 0f, 1700f, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_254, 0, 1, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_254, 2);
}elseif(iLocal_52==2){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_254, 0, 1, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_254, 1);
iLocal_252=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_254, 26, iLocal_258, -1, 1, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_252, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_252, iLocal_81);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_252, joaat("weapon_sawnoffshotgun"), -1, 0, 1);
...
iLocal_253=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_254, 26, iLocal_258, 0, 1, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_253, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_253, iLocal_81);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_253, joaat("weapon_pistol"), -1, 0, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_253, 1, 0);
PED::SET_PED_ACCURACY(iLocal_253, 25);
AUDIO::STOP_PED_SPEAKING(iLocal_253, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_253, "A_M_M_HillBilly_02_WHITE_MINI_02");
func_184(&uLocal_84, 5, iLocal_253, "INCESTBRO2", 0, 1);
TASK::TASK_PLAY_ANIM(iLocal_252, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(iLocal_253, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_256, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_256, 50f, 50f, 50f, 0, 1, 0)){
...
TASK::TASK_SMART_FLEE_PED(iLocal_253, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_253, 1);
}}
func_239(-1);
SCRIPT::TERMINATE_THIS_THREAD();
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_291(iParam0, 0, 0)) || func_291(iParam0, 1, 0)) || func_291(iParam0, 2, 0)) || func_290(iParam0) !=145) || func_289(iParam0)) || func_288(iParam0)) || func_287(iParam0)) || func_286(iParam0)) || !func_274(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_288(iParam0)){
}
if(func_288(iParam0)){
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_314()) || Global_112695) || Global_32166) || func_313()) || func_199(8, -1)) || func_312()) || func_311()) || func_310()) || func_309()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_314()) || Global_32166) || func_313()) || func_199(8, -1)) || func_310()) || func_312()) || func_311()) || func_309()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_314()) || Global_112695) || Global_32166) || func_313()) || func_199(8, -1)) || func_312()) || func_311()) || func_309()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_314()) || Global_32166) || func_313()) || func_199(8, -1)) || func_311()) || func_310()) || func_309()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_314()) || func_311()) || Global_112695) || Global_32166) || func_313()) || Global_44446) || func_199(8, -1)) || func_310()) || func_308()) || func_309()) || Global_113648.f_7690.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_314()) || Global_112695) || Global_32166) || func_313()) || func_199(8, -1)) || func_310()) || func_308()) || func_312()) || func_311()) || func_309()){
return 0;
}
break;
}}else{
...
float fVar0;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_279, 1);
bLocal_285=true;
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_282, 1) < fVar0){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_282, 1);
bLocal_285=2;
}
if(bLocal_285==1){
iLocal_52=1;
