...
if(MISC::IS_BIT_SET(iLocal_556, 13)){
uLocal_550=GRAPHICS::REQUEST_SCALEFORM_MOVIE("warehouse");
}else{
uLocal_550=GRAPHICS::REQUEST_SCALEFORM_MOVIE("securoserv");
Global_75697=1;
Global_75698=0;
}
func_782(1);
func_780(1);
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_550)){
SYSTEM::WAIT(0);
}
if(MISC::IS_BIT_SET(iLocal_556, 13)){
...
func_702(1);
}elseif(func_701(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_267.f_33) || func_785()){
if(!MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_267.f_31, 1)){
func_702(1);
}else{
func_702(0);
}}
...
func_674();
while (func_673()){
if(MISC::IS_BIT_SET(Global_1853910[PLAYER::PLAYER_ID() /*862*/].f_267.f_31, 14) || func_672(PLAYER::PLAYER_PED_ID(), Local_753, 1) > 5f){
func_665(0);
}elseif(func_664() || PAD::IS_CONTROL_JUST_RELEASED(2, 199)){
func_665(0);
}elseif(PLAYER::IS_SYSTEM_UI_BEING_DISPLAYED()){
func_665(1);
}
if(MISC::IS_BIT_SET(iLocal_556, 21)){
if(!func_663(&uLocal_930)){
func_662(&uLocal_930, 0, 0);
}elseif(func_661(&uLocal_930, 4000, 0)){
func_660(&uLocal_930);
MISC::CLEAR_BIT(&iLocal_556, 21);
}}
if(!MISC::IS_BIT_SET(iLocal_556, 26)){
if(Global_75860){
Global_75858=1;
func_658();
}else{
...
func_649();
if(!MISC::IS_BIT_SET(iLocal_556, 13)){
if(!MISC::IS_BIT_SET(iLocal_556, 24)){
func_647();
func_624();
}elseif(!MISC::IS_BIT_SET(iLocal_556, 25)){
func_615();
}}elseif(!func_614(iLocal_732)){
func_609();
}
if(MISC::IS_BIT_SET(iLocal_556, 13)){
func_608();
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "REMOVE_ACTIVE_USER");
...
func_596();
if(iLocal_555==0){
if(GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_551) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_552)){
iVar0=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_551);
MISC::CLEAR_BIT(&iLocal_556, 20);
iLocal_558=func_595(GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_552));
switch (iVar0){
case 1001:
break;
case 1002:
...
break;
case 3012:
if(!MISC::IS_BIT_SET(iLocal_556, 8) && !MISC::IS_BIT_SET(iLocal_556, 9)){
iLocal_555=3012;
}else{
...
if(!MISC::IS_BIT_SET(iLocal_556, 8)){
...
case 4003:
iLocal_555=4003;
if(!MISC::IS_BIT_SET(iLocal_556, 4)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "Popup_Confirm_Success", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
}
...
}elseif(func_298(PLAYER::PLAYER_ID())){
...
case 5007:
case 4003:
if(MISC::IS_BIT_SET(iLocal_556, 2)){
...
}elseif(func_291(iVar2, iLocal_1068)){
...
MISC::CLEAR_BIT(&iLocal_556, 2);
}elseif(MISC::IS_BIT_SET(iLocal_556, 3)){
if(func_18(&iVar6)){
func_14();
func_681(1);
func_13(1);
...
Var18={
Global_1312228[Global_1853910[iVar17 /*862*/].f_267[5] /*1951*/].f_38[0 /*27*/].f_23 
};
Var18.f_2=0f;
}else{
return -1;
...
if(func_298(iVar17)){
Var21={
Global_1950108.f_542[func_45(func_300(iVar17)) /*3*/] 
};
Var21.f_2=0f;
}else{
return -1;
...
if(!MISC::IS_BIT_SET((*uParam2)[iVar25], bVar26)){
...
}}elseif(func_55(PLAYER::PLAYER_ID(), Global_1950044[iVar0])){
...
if(iVar1==32){
func_53();
}elseif(Global_1950044[Global_1950043]==0){
func_22();
}}
...
var func__61(int iParam0, int iParam1){
...
case 229:
case 230:
return func_133(iParam1, iParam2, iParam3, PLAYER::INT_TO_PLAYERINDEX(uParam5), iParam4);
case 233:
...
case 229:
case 230:
return func_182(iParam1, iParam3, iParam4, PLAYER::INT_TO_PLAYERINDEX(uParam5), 0, 0, 0);
case 233:
...
if(iVar1==0 || iVar1==11){
if(func_254()){
NETSHOPPING::NET_GAMESERVER_SET_TELEMETRY_NONCE_SEE(func_235(func_236()));
}
MONEY::NETWORK_SPENT_PURCHASE_IMPEXP_WAREHOUSE_PROPERTY(iVar10, &Var17, 0, 1);
}else{
if(iVar0 > 0){
if(func_254()){
NETSHOPPING::NET_GAMESERVER_SET_TELEMETRY_NONCE_SEE(func_235(func_236()));
...
int iVar0;
if(MISC::IS_BIT_SET(iLocal_556, 7)){
switch (iLocal_730){
case 0:
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "ADD_VEHICLE_WAREHOUSE");
...
}elseif(func_268(iParam1) || bParam4){
...
Vector3 func__287(int iParam0){
return func_288(iParam0, 0);
}


Vector3 func__288(int iParam0, int iParam1){
struct<3> Var0;
...
case 60:
*uParam1={
-631.9747f, -1779.181f, 22.9802f 
};
break;
case 61:
*uParam1={
1007.51f, -1855.032f, 30.0398f 
};
break;
case 62:
*uParam1={
-72.3389f, -1820.984f, 25.942f 
};
break;
case 63:
*uParam1={
36.8712f, -1284.028f, 28.2924f 
};
break;
case 64:
*uParam1={
1213.233f, -1251.249f, 35.3258f 
};
break;
case 65:
*uParam1={
808.8002f, -2222.5f, 28.6239f 
};
break;
case 66:
*uParam1={
1754.546f, -1649.167f, 111.6556f 
};
break;
case 67:
*uParam1={
144.3155f, -3005.919f, 6.0309f 
};
break;
case 68:
*uParam1={
-521.2753f, -2196.688f, 5.394f 
};
break;
case 69:
*uParam1={
-1161.292f, -2163.7f, 12.3808f 
};
break;
}}
...
return 0;
}}elseif(func_663(&(Global_2765972.f_146)) && !func_661(&(Global_2765972.f_146), Global_262145.f_19314, 1)){
return 0;
}
return 1;
}
...
Var0={
func_475(iLocal_560, iLocal_559, func_476()) 
};
...
if(*iParam0==3012){
if(MISC::IS_BIT_SET(iLocal_556, 10)){
func_593(0, 0);
bVar4=iLocal_558;
iVar5=-1;
...
MISC::CLEAR_BIT(&iLocal_556, 10);
}elseif(MISC::IS_BIT_SET(iLocal_556, 11)){
...
iVar10=0;
Global_75698=1;
if(MISC::IS_BIT_SET(uLocal_557, 0) && iLocal_559==1){
iVar10=1;
}
MISC::CLEAR_BIT(&(Global_1950108.f_4), 4);
...
MISC::SET_BIT(&iLocal_556, 21);
if(!func_314(7550, -1) && !MISC::IS_BIT_SET(iLocal_556, 14)){
iLocal_729=4;
...
iLocal_737=0;
MISC::SET_BIT(&iLocal_556, 8);
}elseif(func_614(iParam0)){
func_591("MP_WH_SELL", "MP_WH_SELL_FE", "WHOUSE_CONF", "", 0, 0, -1);
iLocal_736=0;
iLocal_737=0;
MISC::SET_BIT(&iLocal_556, 8);
}elseif(func_306(iParam0) || !func_305()){
...
iLocal_737=0;
MISC::SET_BIT(&iLocal_556, 8);
}elseif(iLocal_736 >=Global_262145.f_15577){
MISC::SET_BIT(&iLocal_556, 11);
func_591("MP_WH_SALER", "MP_WH_SELL_W2", "WHOUSE_CONT", "WHOUSE_CANC", 1, 0, -1);
}elseif(iLocal_736 >=Global_262145.f_15576 || iLocal_736 >=Global_262145.f_15574){
MISC::SET_BIT(&iLocal_556, 11);
...
if(MISC::IS_BIT_SET(uLocal_557, 0) && iParam1==1){
...
iVar12=-1;
bVar13=MISC::IS_BIT_SET(iLocal_556, 7);
...
if(iVar9 >=0 && (iVar9==0 || (iVar9 > 0 && (func_254() || MONEY::NETWORK_CAN_SPEND_MONEY(iVar9, 0, 1, 0, -1, 0))))){
if(iVar9 > 0){
...
MONEY::NETWORK_BUY_CONTRABAND_MISSION(iVar7, bParam0, MISC::GET_HASH_KEY(&cVar1), 0, 1);
if(func_254()){
func_231(func_236());
}}elseif(iVar9 < 0){
if(func_254()){
...
iVar7=-1;
bVar8=MISC::IS_BIT_SET(iLocal_556, 7);
...
MONEY::NETWORK_BUY_CONTRABAND_MISSION(0, iParam0, MISC::GET_HASH_KEY(&cVar1), 0, 1);
if(func_254()){
func_231(func_236());
}
return 1;
...
if(!MISC::IS_BIT_SET(bVar2, bVar3)){
func_341(sVar1, 0);
...
if(!MISC::IS_BIT_SET(Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_201, bVar0)){
MISC::SET_BIT(&(Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_201), bVar0);
}
return 1;
}elseif(MISC::IS_BIT_SET(Global_2657589[PLAYER::PLAYER_ID() /*466*/].f_201, bVar0) || func_356(bVar0)){
func_354(bParam0);
...
if(MISC::IS_BIT_SET(Global_2657589[func_358(bParam0) /*466*/].f_201, bVar2)){
return 1;
}}}}
return 0;
}
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "ADD_WAREHOUSE");
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
cVar29={
func_368(Global_1949814) 
};
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "ADD_WAREHOUSE_SHIPMENTS");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_369(bParam0));
iVar35=func_333(1);
iVar36=func_333(2);
iVar37=func_333(3);
...
if(MISC::IS_BIT_SET(uLocal_557, 0)){
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(MISC::IS_BIT_SET(uLocal_557, 0));
...
bVar438=false;
if(iVar436 > 0){
if(!MONEY::NETWORK_CAN_SPEND_MONEY(iVar436, 0, 1, 0, -1, 0)){
...
if(iVar437 > 0){
if(!MONEY::NETWORK_CAN_SPEND_MONEY(iVar437, 0, 1, 0, -1, 0)){
...
if(iVar437 >=0 && (iVar437==0 || (iVar437 > 0 && (func_254() || MONEY::NETWORK_CAN_SPEND_MONEY(iVar437, 0, 1, 0, -1, 0))))){
if(iVar437 > 0){
...
}}elseif((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_415(8, -1)) && !Global_2683862.f_785.f_5){
...
if(!MISC::IS_BIT_SET(uParam0->f_427, 2) && bVar3 > 0){
func_410(1, -1);
...
}}}elseif(!PAD::IS_CONTROL_JUST_RELEASED(2, 176) && !PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 176)){
...
}}elseif(!PAD::IS_CONTROL_PRESSED(2, 202)){
...
GRAPHICS::DRAW_SPRITE(func_437(Global_23270.f_5165), func_434(Global_23270.f_5165, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
...
GRAPHICS::DRAW_SPRITE(func_437(Global_4540953.f_67), func_434(Global_4540953.f_67, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
fVar51=(fVar51 + (((HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_437(26), func_434(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}}
}
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_437(27), func_434(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}}
}
}
iVar25=0;
...
if(iVar5==1){
if(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_437(Global_23270.f_4824[(iVar22 + iVar28)]), func_434(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_437(Global_23270.f_4824[(iVar22 + iVar28)]), func_434(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
}
...
GRAPHICS::DRAW_SPRITE(func_437(Global_23270.f_4824[(iVar22 + iVar14)]), func_434(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (Global_23267 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
elseif(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_437(Global_23270.f_4824[(iVar22 + iVar14)]), func_434(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_437(Global_23270.f_4824[(iVar22 + iVar14)]), func_434(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
}
}
...
GRAPHICS::DRAW_SPRITE(func_437(Global_23270.f_4824[iVar22]), func_434(Global_23270.f_4824[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_418(Global_23270.f_4824[iVar22])), (fVar37 * func_418(Global_23270.f_4824[iVar22])), 0f, iVar47, iVar48, iVar49, iVar50, 0, 0);
}
}
}}
bVar41=true;
...
var func__434(int iParam0, bool bParam1){
char* sVar0[2];
var uVar3;
struct<13> Var19;
...
if(MISC::IS_BIT_SET(uParam0->f_424, 2)){
func_449("REP_WHOUSE_4", 100, 0);
}elseif(MISC::IS_BIT_SET(uParam0->f_424, 5)){
func_449("MP_PROP_HEI_0", 100, 0);
}elseif(MISC::IS_BIT_SET(uParam0->f_424, 6)){
func_449("PROP3RDDIS", 1000, 0);
}elseif(bVar2 > 0 && !func_351(bVar2, bParam1)){
if(func_347(bVar2) > func_347(bParam1)){
func_449("REP_WHOUSE_5a", 1000, 0);
}elseif(!func_614(bVar2)){
func_449("REP_WHOUSE_5b", 1000, 0);
}elseif(bVar2==bParam1){
func_449("REP_WHOUSE_5c", 1000, 0);
}elseif(func_352(bVar2)){
...
if(!MISC::IS_BIT_SET(iLocal_556, 0)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
...
iLocal_933=-1;
}elseif(func_480(iLocal_933, 0)==-1 || func_479()){
if(!MISC::IS_BIT_SET(iLocal_556, 0)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
func_591("SVM_MIS_TI", "SVM_MIS_FL", "", "WHOUSE_CONF", 0, 0, -1);
MISC::SET_BIT(&iLocal_556, false);
...
if(func_541(Var0)){
if(func_30(PLAYER::PLAYER_ID(), 0)){
if(ENTITY::DOES_ENTITY_EXIST(func_538()) && !ENTITY::IS_ENTITY_DEAD(func_538(), 0)){
Var0={
ENTITY::GET_ENTITY_COORDS(func_538(), 1) 
};
Var3={
0f, 0f, ENTITY::GET_ENTITY_HEADING(func_538()) 
};
...
fVar6=50f;
}elseif(func_533(PLAYER::PLAYER_ID())){
Var0={
...
fVar6=50f;
}elseif(func_532(Global_4718592.f_113724) || MISC::IS_BIT_SET(uParam16, 2)){
...
fVar6=42.6052f;
}}elseif(func_530(Global_4718592.f_113724) || MISC::IS_BIT_SET(uParam16, 1)){
Var0={
...
fVar6=50f;
}elseif(MISC::IS_BIT_SET(uParam16, 4) || func_529(Global_4718592.f_113724)){
Var0={
...
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_527(iVar10), func_526(iVar10), 3.5688f, 7.9792f, 4.1641f) 
};
Var3={
-21.6791f, 0f, (func_526(iVar10) + 40.237f) 
};
fVar6=70f;
}elseif(MISC::IS_BIT_SET(uParam16, 6) || func_525()){
...
fVar6=50f;
}elseif(MISC::IS_BIT_SET(uParam16, 8) || func_521(Global_4718592.f_113724)){}elseif(MISC::IS_BIT_SET(uParam16, 9) || (func_519() && func_518(249))){
Var0={
...
if(!func_517()){
iVar9=0;
}}elseif(MISC::IS_BIT_SET(uParam16, 10)){}elseif(func_516(Global_4718592.f_113724)){
Var0={
...
func_485(func_557(), ((MISC::IS_BIT_SET(uParam16, 0) || MISC::IS_BIT_SET(uParam16, 1)) || MISC::IS_BIT_SET(uParam16, 2)));
}
...
struct<3> Var13;
Var0[0 /*6*/]={
func_508(iParam3, bParam4) 
};
Var0[1 /*6*/]={
func_508(iParam0, bParam4) 
};
*uParam2={
func_506(iParam1, iParam3) 
};
Var13={
*uParam2 - Var0[0 /*6*/] 
};
Var13={
func_505(Var13, -Var0[0 /*6*/].f_3.f_2) 
};
Var13={
func_505(Var13, Var0[1 /*6*/].f_3.f_2) 
};
*uParam2={
...
Vector3 func__505(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
*fParam2=69f;
}}elseif(func_523(Global_4718592.f_113724)){
*uParam0={
...
Vector3 func__527(int iParam0){
return Global_4280768[iParam0 /*45*/].f_4;
}


var func__528(int iParam0){
...
Vector3 func__543(int iParam0, int iParam1){
switch (iParam0){
case 11:
...
Vector3 func__544(int iParam0, int iParam1){
switch (iParam0){
case 11:
...
GRAPHICS::ANIMPOSTFX_PLAY(func_547(iParam0), 0, 1);
}}
...
if(func_548(Global_4718592.f_166301) && MISC::IS_BIT_SET(Global_4718592.f_167679.f_2808, 2)){
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "SHOW_OVERLAY");
func_262(cParam0);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "HIDE_OVERLAY");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
func_594();
if(bParam0){
AUDIO::PLAY_SOUND_FRONTEND(-1, "Popup_Cancel", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
...
if(bParam1){
if(MISC::IS_BIT_SET(iLocal_556, 3)){
MISC::CLEAR_BIT(&iLocal_556, 3);
}
if(MISC::IS_BIT_SET(iLocal_556, 2)){
MISC::CLEAR_BIT(&iLocal_556, 2);
...
if(MISC::IS_BIT_SET(iLocal_556, 1)){
...
if(MISC::IS_BIT_SET(iLocal_556, 17)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "IS_WAREHOUSE_PANEL_SHOWING");
uLocal_554=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
MISC::CLEAR_BIT(&iLocal_556, 17);
}elseif(GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_554)){
if(GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_BOOL(uLocal_554)){
MISC::SET_BIT(&iLocal_556, 16);
}else{
...
if(func_598()){
if(!MISC::IS_BIT_SET(iLocal_556, 20)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "GET_CURRENT_SELECTION");
uLocal_551=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "GET_SELECTED_WAREHOUSE_ID");
uLocal_552=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
void func_599(){
if(!MISC::IS_BIT_SET(iLocal_556, 12)){
if(func_598() || func_600()){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "GET_CURRENT_SCREEN_ID");
uLocal_553=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
MISC::SET_BIT(&iLocal_556, 12);
}}elseif(GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_553)){
iLocal_733=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_553);
...
if(iLocal_733==5){
if(func_298(PLAYER::PLAYER_ID())){
if(MISC::IS_BIT_SET(uLocal_557, 2)){
MISC::CLEAR_BIT(&uLocal_557, 2);
}else{
MISC::SET_BIT(&uLocal_557, 2);
}}}
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
}
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 207, 1);
if(PAD::IS_CONTROL_PRESSED(2, 207)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(207), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(PAD::IS_CONTROL_JUST_RELEASED(2, 207)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(207), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 208, 1);
if(PAD::IS_CONTROL_PRESSED(2, 208)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(208), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(PAD::IS_CONTROL_JUST_RELEASED(2, 208)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(208), -1082130432, -1082130432, -1082130432, -1082130432);
}
func_605();
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
}}
PAD::ENABLE_CONTROL_ACTION(2, 202, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 202)){
if(MISC::IS_BIT_SET(iLocal_556, 12)){
}else{
if((func_785() && Global_1969057.f_1) && !MISC::IS_BIT_SET(iLocal_556, 5)){
if(iLocal_733==4 || iLocal_733==1){
func_665(0);
}}
if((iLocal_733 !=4 && iLocal_733 !=6) || !MISC::IS_BIT_SET(iLocal_556, 5)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(iLocal_733==3 || iLocal_733==0){
func_665(0);
}}}
if(PAD::IS_CONTROL_JUST_RELEASED(2, 202)){
if(MISC::IS_BIT_SET(uLocal_557, 3)){
MISC::CLEAR_BIT(&uLocal_557, 3);
}elseif(MISC::IS_BIT_SET(iLocal_556, 5)){
func_593(1, 1);
}elseif(func_604()){
MISC::CLEAR_BIT(&iLocal_556, 16);
}
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(!MISC::IS_BIT_SET(iLocal_556, 13)){
PAD::ENABLE_CONTROL_ACTION(2, 201, 1);
if(PAD::IS_CONTROL_JUST_RELEASED(2, 201)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
}}
if(PAD::IS_USING_CURSOR(2)){
func_603();
if(!MISC::IS_BIT_SET(iLocal_556, 13)){
if(PAD::IS_CONTROL_JUST_RELEASED(2, 237)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(237), -1082130432, -1082130432, -1082130432, -1082130432);
}}
if(!MISC::IS_BIT_SET(iLocal_556, 13)){
if(PAD::IS_CONTROL_JUST_RELEASED(2, 238)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(238), -1082130432, -1082130432, -1082130432, -1082130432);
}}
if(iLocal_733==6){
func_602(0, 1);
}else{
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(241), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 242, 1);
if(PAD::IS_CONTROL_PRESSED(2, 242)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(242), -1082130432, -1082130432, -1082130432, -1082130432);
}}}else{
func_602(1, 1);
}
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "SET_ANALOG_STICK_INPUT");
iLocal_739=iVar0;
iLocal_740=iVar1;
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "SET_MOUSE_INPUT");
...
PAD::ENABLE_CONTROL_ACTION(2, 237, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 237)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(237), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 238, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 238)){
if((iLocal_733 !=4 && iLocal_733 !=6) || !MISC::IS_BIT_SET(iLocal_556, 5)){
...
bool func_604(){
return MISC::IS_BIT_SET(iLocal_556, 16);
}
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 187)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 189, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 189)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 190, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 190)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_550, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
}}
...
if(iLocal_555==0 && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_551)){
iVar0=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_551);
if(iVar0 > 0 && iVar0 < 5){
iLocal_737=iVar0;
...
int iVar3;
int iVar4;
if(!MISC::IS_BIT_SET(iLocal_556, 14) && !MISC::IS_BIT_SET(iLocal_556, 31)){
if(func_613(7654, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, 12)){
sVar0="WH_TUT_1";
iLocal_735=5500;
...
}elseif(func_613(7655, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, 13)){
sVar0="WH_TUT_2";
iLocal_735=5500;
...
}elseif(func_613(7656, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, 14)){
sVar0="WH_TUT_3";
iLocal_735=5500;
...
}elseif((func_613(7657, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, 15)) && func_611(iLocal_732)){
sVar0="WH_TUT_SPEC";
iLocal_735=5500;
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && !MISC::IS_BIT_SET(iLocal_556, 14)){
func_610(sVar0, iLocal_735);
MISC::SET_BIT(&iLocal_556, 14);
}elseif(MISC::IS_BIT_SET(iLocal_556, 14)){
if(!func_663(&uLocal_928)){
func_662(&uLocal_928, 0, 0);
}elseif(func_661(&uLocal_928, iLocal_735, 0)){
...
int iVar5;
int iVar6;
if(!MISC::IS_BIT_SET(iLocal_556, 15) && !MISC::IS_BIT_SET(iLocal_556, 31)){
...
}elseif((func_621(1) && func_604()) && !func_619()){
sVar0="SECURO_WH_TUT";
iLocal_735=6000;
...
}elseif(((iLocal_733==2 && func_474()) && !MISC::IS_BIT_SET(iLocal_556, 19)) && func_621(2)){
...
}elseif((func_621(3) && func_619()) && func_604()){
...
}elseif(iLocal_733==1 && func_621(4)){
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && !MISC::IS_BIT_SET(iLocal_556, 15)){
func_610(sVar0, iLocal_735);
MISC::SET_BIT(&iLocal_556, 15);
}elseif(MISC::IS_BIT_SET(iLocal_556, 15)){
if(!func_663(&uLocal_928)){
func_662(&uLocal_928, 0, 0);
}elseif(func_661(&uLocal_928, iLocal_735, 0)){
...
if(!bVar0){
if(MISC::IS_BIT_SET(uParam0, bVar4)){
iVar2++;
}}elseif(MISC::IS_BIT_SET(uParam1, bVar4)){
iVar2++;
}
iVar1++;
}
...
switch (iParam0){
case 0:
if(func_613(7658, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, bVar0)){
return 1;
}
break;
case 1:
if(func_613(7660, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, bVar0)){
return 1;
}
break;
case 2:
if(func_613(7659, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, bVar0)){
return 1;
}
break;
case 3:
if(func_613(7661, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, bVar0)){
return 1;
}
break;
case 4:
if(func_613(7662, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, bVar0)){
return 1;
}
break;
case 5:
if((func_613(7663, -1) < 3 && !MISC::IS_BIT_SET(Global_1949958, bVar0)) && func_623()){
return 1;
}
break;
case 6:
if(((!func_622(iLocal_934, iLocal_935, 0) && !MISC::IS_BIT_SET(Global_1949958, bVar0)) && MISC::IS_BIT_SET(uLocal_557, 2)) && iLocal_733==5){
return 1;
}
break;
case 7:
if(((((!func_622(iLocal_934, iLocal_935, 3) && !MISC::IS_BIT_SET(Global_1949958, bVar0)) && MISC::IS_BIT_SET(Global_1949958, 8)) && iLocal_733==5) && !func_604()) && func_298(PLAYER::PLAYER_ID())){
return 1;
}
break;
case 8:
if((((!func_622(iLocal_934, iLocal_935, 6) && !MISC::IS_BIT_SET(Global_1949958, bVar0)) && iLocal_733==5) && func_604()) && func_298(PLAYER::PLAYER_ID())){
return 1;
}
break;
case 9:
if((!func_622(iLocal_934, iLocal_935, 9) && !MISC::IS_BIT_SET(Global_1949958, bVar0)) && iLocal_733==4){
return 1;
}
break;
case 10:
if((!func_622(iLocal_934, iLocal_935, 12) && !MISC::IS_BIT_SET(Global_1949958, bVar0)) && !func_299(12)){
if(iLocal_733==4 || iLocal_733==5){
return 1;
}}
break;
case 11:
if((!func_622(iLocal_934, iLocal_935, 15) && !MISC::IS_BIT_SET(Global_1949958, bVar0)) && iLocal_733==6){
return 1;
}
break;
}
...
bVar0=func_620();
if((((!MISC::IS_BIT_SET(iLocal_556, 25) && bVar0 > 0) && func_604()) && func_311(bVar0)) && Global_1949968){
return 1;
}
return 0;
}
...
if(MISC::IS_BIT_SET(uLocal_557, 1)){
switch (iParam0){
case 0:
return "EXCPA_LOGINM";
case 1:
...
void func_647(){
bool bVar0;
if(!MISC::IS_BIT_SET(iLocal_556, 14) && !func_648()){
if(MISC::IS_BIT_SET(iLocal_556, 22) && !func_314(7459, -1)){
bVar0=true;
iLocal_735=6750;
iLocal_729=0;
func_1(7459, 1, -1);
}elseif(iLocal_733==2 && !func_314(7460, -1)){
if(!func_474()){
bVar0=true;
iLocal_735=8000;
iLocal_729=1;
...
func_1(7460, 1, -1);
func_1(3808, 1, -1);
}elseif(MISC::IS_BIT_SET(iLocal_556, 23) && !func_314(7462, -1)){
bVar0=true;
iLocal_735=6000;
iLocal_729=2;
func_1(7462, 1, -1);
}elseif(!func_314(7463, -1) && (func_619() || (((func_604() && bLocal_728==func_388(0)) && bLocal_728 !=0) && iLocal_558==-1))){
bLocal_728=false;
bVar0=true;
iLocal_735=9000;
iLocal_729=3;
func_1(7463, 1, -1);
}elseif(iLocal_733==1 && !func_314(7464, -1)){
bVar0=true;
iLocal_735=6000;
iLocal_729=5;
func_1(7464, 1, -1);
}elseif((iLocal_733==3 && !func_314(3806, -1)) && !func_314(3807, -1)){
if(func_314(7460, -1)){
bVar0=true;
iLocal_735=10000;
iLocal_729=6;
...
func_1(3806, 1, -1);
func_1(3807, 1, -1);
}elseif(iLocal_733==6 && !func_314(3813, -1)){
bVar0=true;
iLocal_735=4000;
iLocal_729=9;
func_1(3813, 1, -1);
}elseif(iLocal_733==5 && !func_314(3809, -1)){
bVar0=true;
iLocal_735=4000;
iLocal_729=10;
func_1(3809, 1, -1);
}elseif((iLocal_733==5 && MISC::IS_BIT_SET(iLocal_556, 6)) && !func_314(3811, -1)){
bVar0=true;
iLocal_735=4000;
iLocal_729=11;
func_1(3811, 1, -1);
}elseif((iLocal_733==4 && !MISC::IS_BIT_SET(iLocal_556, 6)) && !func_314(3810, -1)){
bVar0=true;
iLocal_735=4000;
iLocal_729=12;
func_1(3810, 1, -1);
}elseif((iLocal_733==4 && !MISC::IS_BIT_SET(iLocal_556, 6)) && !func_314(3812, -1)){
bVar0=true;
iLocal_735=4000;
iLocal_729=13;
func_1(3812, 1, -1);
}elseif((func_314(7460, -1) && func_314(7464, -1)) && !func_314(3808, -1)){
...
void func_649(){
if(MISC::IS_BIT_SET(iLocal_556, 31)){
if(!func_663(&uLocal_928)){
func_662(&uLocal_928, 0, 0);
}elseif(func_661(&uLocal_928, 5000, 0)){
MISC::CLEAR_BIT(&iLocal_556, 31);
func_660(&uLocal_928);
}}
if(MISC::IS_BIT_SET(iLocal_556, 13)){
if((!MISC::IS_BIT_SET(iLocal_556, 14) && !MISC::IS_BIT_SET(iLocal_556, 30)) && MISC::IS_BIT_SET(iLocal_556, 28)){
func_610("SECURO_SELL_CD", 5000);
MISC::SET_BIT(&iLocal_556, 31);
MISC::SET_BIT(&iLocal_556, 30);
}}elseif(!MISC::IS_BIT_SET(iLocal_556, 15) && !MISC::IS_BIT_SET(iLocal_556, 31)){
func_650();
if(func_604()){
if((!MISC::IS_BIT_SET(iLocal_556, 29) && MISC::IS_BIT_SET(iLocal_556, 27)) && func_619()){
if(MISC::IS_BIT_SET(uLocal_726, func_620())){
func_610("SECURO_BUY_CD", 5000);
MISC::SET_BIT(&iLocal_556, 31);
MISC::SET_BIT(&iLocal_556, 29);
}}
if(((!MISC::IS_BIT_SET(iLocal_556, 30) && !MISC::IS_BIT_SET(iLocal_556, 31)) && MISC::IS_BIT_SET(iLocal_556, 28)) && func_619()){
func_610("SECURO_SELL_CD", 5000);
MISC::SET_BIT(&iLocal_556, 31);
MISC::SET_BIT(&iLocal_556, 30);
}}}}
...
if(iVar1 !=0 && MISC::IS_BIT_SET(uLocal_726, iVar1)){
...
iVar1=0;
iLocal_738=0;
}}elseif(iLocal_738 !=iVar0){
iVar1=iVar0;
iLocal_738=iVar0;
}
if(iVar1 !=-1){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "UPDATE_COOLDOWN");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar1);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}}
...
GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_550, 255, 255, 255, 255, 0);
func_654();
func_399(0);
func_653(1);
...
func_699(0);
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_550);
func_780(0);
if(!MISC::IS_BIT_SET(iLocal_556, 13)){
Global_75697=1;
...
if(MISC::IS_BIT_SET(iLocal_556, 6) && !func_254()){
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "ADD_ACTIVE_USER");
...
if(!func_560() && !NETWORK::NETWORK_CHECK_USER_CONTENT_PRIVILEGES(0, -1, 1)){
...
return 0;
}}elseif(func_560() || unk_0xEE17703CF2C2875A()){
if(NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)){
if(NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0)){
return 0;
}}}}
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "showScreen");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "SET_PLAYER_DATA");
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "SET_BUYER_DATA");
func_262(&cVar15);
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar50);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "SET_WAREHOUSE_DATA");
func_262(&cVar0);
func_262(&cVar7);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_550, "ADD_SPECIAL_VEHICLE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar1);
func_262(&cVar6);
if(iVar3 !=-1){
...
NETWORK::NETWORK_ACCESS_TUNABLE_FLOAT_MODIFICATION_DETECTION_REGISTRATION_HASH(uVar0, uParam1, uParam2);
}
if(bParam3){}}
...
StringCopy(&(Local_936[iVar7 /*16*/]), HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME_WITH_BYTE_LIMIT(uVar4, iVar5, iVar6, 63), 64);
...
var func__732(int iParam0, int iParam1){
if(iParam0==-1){
return func_733();
}
...
return 1;
}elseif(func_347(iParam0)==1 && func_744()==1){
return 1;
}elseif(func_744()==0){
return 1;
}}elseif(func_311(iParam0)){
return 1;
}
return 0;
}
...
}elseif(bVar14 || (!func_30(PLAYER::PLAYER_ID(), 0) && !func_774())){
...
if(!func_770(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
