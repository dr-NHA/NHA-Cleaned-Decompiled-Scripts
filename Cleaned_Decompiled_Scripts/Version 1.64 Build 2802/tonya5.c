...
if(!iLocal_3345){
if(func_648()){
iLocal_3349=func_647();
if(!Global_94858){
if(iLocal_3349==0){
func_646(Local_3358, fLocal_3361, 1, 0);
...
iLocal_3330=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_3336, fLocal_3339, 1, 1, 0);
iLocal_2934=iLocal_3330;
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_2934, 1, 0);
AUDIO::SET_VEH_RADIO_STATION(iLocal_2934, "RADIO_03_HIPHOP_NEW");
MISC::CLEAR_AREA(Local_3336, 25f, 1, 1, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_3330)){
HUD::REMOVE_BLIP(&uLocal_2767);
...
if(!iLocal_495){
if(!func_533()){
if(func_529(&uLocal_527, "TOWAUD", "TOW_HERE", 8, 0, 0, 0)){
if(!func_216(&uLocal_3352)){
func_542(&uLocal_3352);
}
iLocal_495=1;
}
...
if(!bLocal_3340){
if(func_216(&uLocal_3352)){
if(func_213(&uLocal_3352) > 20f){
if(!func_533()){
if(func_529(&uLocal_527, "TOWAUD", "TOW_WAITING", 8, 0, 0, 0)){
func_392(&uLocal_3352);
}}}
}
}}}
}}else{
...
if(!iLocal_496){
if(!func_533()){
if(func_529(&uLocal_527, "TOWAUD", "TOW_CAR", 8, 0, 0, 0)){
iLocal_496=1;
}
}
}}else{
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
if(!func_533()){
if(func_529(&uLocal_527, "TOWAUD", "TOW_CARWAIT", 8, 0, 0, 0)){
iLocal_3342=1;
}
}}}
}}}}
...
if(func_529(&uLocal_527, "TOWAUD", "TOW_JACK", 8, 0, 0, 0)){
iLocal_3343=1;
}}}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_2766, 0)){
...
case 1:
if(!func_533()){
if(func_529(&uLocal_527, "TOWAUD", "TOW_CHAT", 8, 0, 0, 0)){
iLocal_3350=2;
}}
break;
case 2:
...
case 2:
if(func_216(&uLocal_3355)){
if((func_213(&uLocal_3355) > 3f || (iLocal_3348 && !func_533())) || (func_312(PLAYER::PLAYER_PED_ID(), iLocal_2766, 1) < 3.5f && !func_533())){
iLocal_3318=1;
}}
break;
case 1:
...
uLocal_3351=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_3333, 5f, 5f, 5f, 0f, 0, 7);
func_571();
...
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
func_572(23, 0);
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_3351);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
iLocal_3317=2;
iLocal_3318=0;
break;
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_2934)){
iLocal_2934=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_3336, fLocal_3339, 1, 1, 0);
