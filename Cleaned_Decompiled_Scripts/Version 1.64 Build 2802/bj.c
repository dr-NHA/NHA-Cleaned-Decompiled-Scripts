...
uVar1098=ScriptParam_0.f_1;
}else{
uVar1098=PLAYER::GET_PLAYERS_LAST_VEHICLE();
}
bVar1194=WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("gadget_parachute"), 0);
bVar1195=PLAYER::GET_PLAYER_HAS_RESERVE_PARACHUTE(PLAYER::PLAYER_ID());
if(bVar1194){
PLAYER::GET_PLAYER_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_ID(), &uVar1169);
PLAYER::GET_PLAYER_PARACHUTE_PACK_TINT_INDEX(PLAYER::PLAYER_ID(), &uVar1170);
}
if(bVar1195){
PLAYER::GET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_ID(), &uVar1171);
}
if(ENTITY::DOES_ENTITY_EXIST(uVar1098)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar1098, 1, 1);
}
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()){
CAM::STOP_SCRIPT_GLOBAL_SHAKING(0);
}
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)){
func_560(&Var16, &uVar1115, &iVar1088, &iVar1089, &iVar1091, &iVar1094, &iVar1098, &uVar923, &iVar1100, &iVar1101, &iVar1102, uVar1168, &iVar1163, uVar1109, uVar1110, bVar872, &uVar1099, bVar1194);
}
if(bVar1160 < 0){
return;
}
if(MISC::IS_BIT_SET(Global_113648.f_18969.f_1, bVar1160)){
fVar1148=0.1f;
}
bVar872=bVar1160;
func_559(0);
...
func_558(23, 1);
HUD::SET_FAKE_MINIMAP_MAX_ALTIMETER_HEIGHT(1500f, 0, 21);
func_532(&Var16, bVar872);
if(ENTITY::DOES_ENTITY_EXIST(iVar1100)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar1100, 1, 1);
}
if(ENTITY::DOES_ENTITY_EXIST(iVar1088)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar1088, 1, 1);
...
uVar1099=VEHICLE::ADD_VEHICLE_COMBAT_ANGLED_AVOIDANCE_AREA(-832.271f, -1525.112f, -100f, -1187.833f, -1876.646f, 100f, 50f);
}elseif(bVar872==5){
...
Var1126={
func_475(SYSTEM::COS(Var1126.f_2), SYSTEM::SIN(Var1126.f_2), MISC::TAN(Var1126.f_0)) 
};
if(func_474(bVar872)){
STREAMING::NEW_LOAD_SCENE_START(func_473(bVar872), Var1126, 4000f, 0);
}
}
func_467(&Var16, bVar872, &uVar0, &uVar14, &iVar15, &uVar1115, &iVar1167);
}elseif(func_465(func_466(bVar872))){
Var1141={
Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -SYSTEM::COS((-97.4239f + func_464(&Var16))), SYSTEM::SIN((-97.4239f + func_464(&Var16)))) 
};
Var1138={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar1088, 1.12046f, -0.317773f, 1.3385f) 
};
Var1141={
func_463(Var1141, 8.909f) 
};
if(func_474(bVar872)){
STREAMING::NEW_LOAD_SCENE_START(Var1138 + Var1141, Var1141, 4000f, 0);
}}else{
Var1126={
-10f, 0f, func_464(&Var16) 
};
Var1126={
func_475(SYSTEM::COS(Var1126.f_2), SYSTEM::SIN(Var1126.f_2), MISC::TAN(Var1126.f_0)) 
};
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_473(bVar872), 0, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_464(&Var16));
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 1);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
}
iVar719=2;
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_462(&uVar896) || func_461(&uVar896) > 0.05f)){
...
break;
case 2:
if(func_459(&uVar0, &uVar875, &uVar1115, bVar872, iVar1167, ((bVar872 !=5 && bVar872 !=6) && bVar872 !=12))){
func_458(&uVar875);
func_435(&Var16, &uVar923, &iVar1155, &iVar1088, &iVar1089, &iVar1091, &uVar1090, &uVar1092, &iVar1100, &iVar1101, uVar14, iVar15, &uVar884, bVar872, &iVar1164);
...
break;
case 3:
if(!func_462(&uVar875) && !bVar1176){
func_434(0, 0, 1);
func_486(&uVar875);
}elseif((func_462(&uVar875) && func_461(&uVar875) > 0.2f) || bVar1176){
...
if(func_531(&Var16) !=0){
ENTITY::FREEZE_ENTITY_POSITION(iVar1091, 0);
func_486(&uVar893);
}
iVar719=4;
}else{
...
if(!func_431(func_432(bVar872)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
if(PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID())){
PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), 0, 0);
}
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_432(bVar872), 1, 0, 0, 1);
...
TASK::OPEN_SEQUENCE_TASK(&uVar1112);
if(func_427(bVar872) > 0){
TASK::TASK_STAND_STILL(0, func_427(bVar872));
}
TASK::TASK_GO_STRAIGHT_TO_COORD(0, func_473(bVar872), 1f, -1, func_464(&Var16), 1056964608);
TASK::CLOSE_SEQUENCE_TASK(uVar1112);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar1112);
TASK::CLEAR_SEQUENCE_TASK(&uVar1112);
}
if(!func_465(func_466(bVar872))){
...
if(ENTITY::DOES_ENTITY_EXIST(iVar1094[iVar1165]) && !ENTITY::IS_ENTITY_DEAD(iVar1094[iVar1165], 0)){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar1094[iVar1165], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) < 2500f){
ENTITY::SET_ENTITY_LOD_DIST(iVar1094[iVar1165], 1000);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iVar1094[iVar1165], 5f);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iVar1094[iVar1165], 1, 1);
}}
iVar1165++;
}
}
...
uVar1168=AUDIO::GET_SOUND_ID();
if(bVar1193){
AUDIO::PLAY_SOUND_FROM_ENTITY(uVar1168, "Helicopter_Wind_Idle", iVar1088, "BASEJUMPS_SOUNDS", 0, 0);
}
if(bVar1192){
AUDIO::SCRIPT_OVERRIDES_WIND_ELEVATION(1, 300362576);
}}else{
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()){
CAM::STOP_SCRIPT_GLOBAL_SHAKING(0);
}
...
elseif(func_461(&uVar917) > 4f || (func_465(func_466(bVar872)) && func_461(&uVar917) > 0.5f)){
func_401(&uVar923, "OJBJAUD", func_416(&Var16), 8, 0, 0, 0);
bVar1187=true;
}}
if(!CAM::IS_SCREEN_FADING_OUT() && !bVar1176){
if(func_379(&Var16, bVar872, &iVar1091, &uVar107, &uVar101, &uVar878, &uVar881, &uVar893, &uVar911, iVar1167, &bVar1177, &bVar1189, bVar1181)){
HUD::CLEAR_HELP(1);
bVar1181=false;
if(func_378(&Var16)){
CAM::DO_SCREEN_FADE_OUT(800);
...
if(ENTITY::DOES_ENTITY_EXIST(iVar1089) && !ENTITY::IS_ENTITY_DEAD(iVar1089, 0)){
uVar1109=HUD::ADD_BLIP_FOR_COORD(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar1089, func_370(&Var16)));
HUD::SET_BLIP_COLOUR(uVar1109, 5);
HUD::SHOW_HEIGHT_ON_BLIP(uVar1109, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar1109, "BJ_BLIP_TGT");
}else{
uVar1109=HUD::ADD_BLIP_FOR_COORD(func_369(&Var16, 0));
HUD::SET_BLIP_COLOUR(uVar1109, 5);
if(iVar1155==1){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar1109, "BJ_BLIP_TGT");
}else{
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar1109, "BJ_BLIP_CHK");
}}
HUD::SET_BLIP_SCALE(uVar1109, 1.2f);
if(iVar1155 > 1){
uVar1110=HUD::ADD_BLIP_FOR_COORD(func_369(&Var16, 1));
HUD::SET_BLIP_COLOUR(uVar1110, 5);
HUD::SHOW_HEIGHT_ON_BLIP(uVar1109, 1);
HUD::SET_BLIP_SCALE(uVar1110, 0.7f);
if(iVar1155==2){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar1110, "BJ_BLIP_TGT");
}else{
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar1110, "BJ_BLIP_CHK");
}}
if(ENTITY::DOES_ENTITY_EXIST(iVar1089) && !ENTITY::IS_ENTITY_DEAD(iVar1089, 0)){
...
ENTITY::SET_ENTITY_COORDS(iVar1089, func_369(&Var16, 0), 1, 0, 0, 1);
}}
if(MISC::IS_BIT_SET(Global_113648.f_18969.f_1, (func_366(&Var16) - 125))){
...
CAM::SET_CAM_ACTIVE(func_433(&uVar107, 0), 1);
}
else{
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()){
CAM::STOP_SCRIPT_GLOBAL_SHAKING(0);
...
PED::SET_PED_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_PED_ID(), uVar1169);
if(bVar1195){
if(!PLAYER::GET_PLAYER_HAS_RESERVE_PARACHUTE(PLAYER::PLAYER_ID())){
PLAYER::SET_PLAYER_HAS_RESERVE_PARACHUTE(PLAYER::PLAYER_ID());
}
PED::SET_PED_RESERVE_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_PED_ID(), uVar1171);
}}else{
WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), 1, 0, 1);
...
iVar719=12;
break;
}elseif((bVar1180 || bVar1179) || func_359(&Var16, bVar872, &bVar1182)){
HUD::CLEAR_HELP(1);
HUD::CLEAR_PRINTS();
iVar719=10;
}else{
...
if(bVar1181){
Var1129={
func_369(&Var16, (iVar1155 - 1)) 
};
Var1129.f_2=(Var1129.f_2 + 100f);
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Var1129, 1, 0, 0, 1);
bVar1181=false;
}
if(!bVar1184){
if(bVar872==4){
...
func_358(&uVar884);
func_348(&Var16, iVar1089, iVar1100, &iVar1102, &uVar1113, &uVar1114, &iVar1154, &iVar1156, &iVar1157, iVar1155, &iVar1158, &uVar1109, &uVar1110, &iVar1153, &iVar873, &uVar1149, &uVar1150, &uVar1151, &uVar1178, 0, 1, fVar1148);
func_347(&uVar1116);
if(func_462(&uVar875)){
if(func_461(&uVar875) > 10f){
func_343(&uVar887, &iVar1163);
}}else{
func_342(&uVar875, 0f);
}
if(ENTITY::DOES_ENTITY_EXIST(iVar1091) && !ENTITY::IS_ENTITY_DEAD(iVar1091, 0)){
if(!ENTITY::IS_ENTITY_ON_SCREEN(iVar1091) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iVar1091, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 40000f){
iVar1197=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar1091, -1, 0);
if(!PED::IS_PED_INJURED(iVar1197)){
PED::DELETE_PED(&iVar1197);
}
VEHICLE::DELETE_VEHICLE(&iVar1091);
}}
if(!MISC::IS_BIT_SET(uVar1161, 0)){
if(HUD::IS_MESSAGE_BEING_DISPLAYED() || !func_462(&uVar920)){
func_371(&uVar920);
}
elseif(func_461(&uVar920) > 0.25f){
Var1119={
func_341(bVar872) 
};
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_339(&Var111, 1);
iVar1093=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar1093, 0) && ENTITY::IS_ENTITY_IN_AIR(iVar1093)){
if(!MISC::IS_BIT_SET(uVar1161, 1)){
if(!func_462(&uVar899)){
func_486(&uVar899);
}elseif(func_461(&uVar899) > 0.15f){
...
func_348(&Var16, iVar1089, iVar1100, &iVar1102, &uVar1113, &uVar1114, &iVar1154, &iVar1156, &iVar1157, iVar1155, &iVar1158, &uVar1109, &uVar1110, &iVar1153, &iVar873, &uVar1149, &uVar1150, &uVar1151, &uVar1178, 0, 1, fVar1148);
func_347(&uVar1116);
if(func_465(func_466(bVar872)) && !ENTITY::IS_ENTITY_DEAD(iVar1088, 0)){
...
if(func_332(&Var16, &uVar107, &uVar101, &uVar881, &Var1123, &uVar1135, Var1138, Var1141) || bVar1181){
func_458(&uVar875);
HUD::CLEAR_HELP(1);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::DOES_ENTITY_EXIST(iVar1088) && !ENTITY::IS_ENTITY_DEAD(iVar1088, 0)){
ENTITY::SET_ENTITY_COORDS(iVar1088, func_473(bVar872), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iVar1088, func_464(&Var16));
ENTITY::FREEZE_ENTITY_POSITION(iVar1088, 1);
...
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iVar1164, "oddjobs@basejump@", "Heli_jump", 4f, -4f, 7, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_PHASE(iVar1164, 0.6f);
func_330(iVar1088, &uVar107, &uVar878);
STREAMING::NEW_LOAD_SCENE_STOP();
}
}
if(bVar1192){
AUDIO::SCRIPT_OVERRIDES_WIND_ELEVATION(0, 300362576);
}
AUDIO::PLAY_SOUND_FROM_ENTITY(uVar1168, "Helicopter_Wind", iVar1088, "BASEJUMPS_SOUNDS", 0, 0);
bVar1181=false;
iVar719=8;
}}
break;
...
TASK::OPEN_SEQUENCE_TASK(&uVar1111);
TASK::TASK_FORCE_MOTION_STATE(0, joaat("MotionState_Parachuting"), 0);
TASK::TASK_PARACHUTE(0, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar1111);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar1111);
TASK::CLEAR_SEQUENCE_TASK(&uVar1111);
}}
if(ENTITY::DOES_ENTITY_EXIST(iVar1088)){
if(func_329(&uVar107, &uVar878, Var1138, Var1141, Var1123, &uVar1144, &uVar1147)){
ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(PLAYER::PLAYER_PED_ID(), iVar1088, 0);
...
HUD::CLEAR_PRINTS();
iVar719=10;
}elseif(func_328(&uVar101, 3, 1000) && !Global_23131.f_135){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 1);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 256);
CAM::DO_SCREEN_FADE_OUT(800);
while (CAM::IS_SCREEN_FADING_OUT()){
func_348(&Var16, iVar1089, iVar1101, &iVar1102, &uVar1113, &uVar1114, &iVar1154, &iVar1156, &iVar1157, iVar1155, &iVar1158, &uVar1109, &uVar1110, &iVar1153, &iVar873, &uVar1149, &uVar1150, &uVar1151, &uVar1178, 0, 1, fVar1148);
SYSTEM::WAIT(0);
}
func_282(&Var16, &uVar1115, &Var111, &uVar1161, &iVar1101, &iVar1102, &iVar1098, &iVar1089, &uVar1090, &iVar1091, &iVar1094, &uVar1113, &uVar1114, uVar1109, uVar1110, &iVar1154, &iVar1156, &iVar1157, &iVar1163, &iVar1158, bVar872, &iVar720, &iVar873, &uVar890, &Var908, &uVar1135, &uVar1149, &uVar1150, &uVar1151, &uVar1178, &bVar1177, &bVar1179, &bVar1180, &bVar1181, &bVar1183, &iVar1175, &uVar1099);
bVar1176=true;
iVar719=0;
}else{
func_279(&uVar905, &iVar1102);
if(bVar1181){
Var1129={
func_369(&Var16, (iVar1155 - 1)) 
};
...
func_358(&uVar884);
if(func_367(func_368(&Var16))){
if(!ENTITY::DOES_ENTITY_EXIST(iVar1089) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_369(&Var16, 0), 0) <=200f){
iVar1089=VEHICLE::CREATE_MISSION_TRAIN(6, func_369(&Var16, 0), 1, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(iVar1089, 0)){
VEHICLE::SET_TRAIN_CRUISE_SPEED(iVar1089, 7.5f);
}
}}elseif((ENTITY::DOES_ENTITY_EXIST(iVar1089) && !ENTITY::IS_ENTITY_DEAD(iVar1089, 0)) && !func_431(func_369(&Var16, 0))){
...
Var1198={
-819.7591f, -1512.229f, 0.1336f 
};
}
if(TASK::GET_SCRIPT_TASK_STATUS(iVar1101, joaat("script_task_vehicle_mission")) !=1){
if(bVar872==5){
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar1101, iVar1089, Var1198, 4, 5f, 16785408, 5f, 10f, 1);
}else{
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar1101, iVar1089, Var1198, 4, 5f, 16777216, 4f, -1f, 1);
}}else{
func_271(&iVar1089);
}
}}
iVar720=func_348(&Var16, iVar1089, iVar1101, &iVar1102, &uVar1113, &uVar1114, &iVar1154, &iVar1156, &iVar1157, iVar1155, &iVar1158, &uVar1109, &uVar1110, &iVar1153, &iVar873, &uVar1149, &uVar1150, &uVar1151, &uVar1178, 1, 1, fVar1148);
...
if(bVar872==5){
TASK::CLEAR_PED_TASKS(iVar1101);
PED::SET_PED_CONFIG_FLAG(iVar1101, 296, 1);
}
iVar1201=0;
while (iVar1201 < iVar1102){
if(ENTITY::DOES_ENTITY_EXIST(iVar1102[iVar1201]) && !ENTITY::IS_ENTITY_DEAD(iVar1102[iVar1201], 0)){
...
if(ENTITY::DOES_ENTITY_EXIST(iVar1101) && !ENTITY::IS_ENTITY_DEAD(iVar1101, 0)){
...
if(HUD::DOES_BLIP_EXIST(uVar1109)){
HUD::REMOVE_BLIP(&uVar1109);
}
if(HUD::DOES_BLIP_EXIST(uVar1110)){
HUD::REMOVE_BLIP(&uVar1110);
}
if(iVar1156 > -1){
GRAPHICS::DELETE_CHECKPOINT(uVar1113);
GRAPHICS::DELETE_CHECKPOINT(uVar1114);
iVar1156=-1;
}
func_342(&uVar890, 0f);
}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(((((ENTITY::DOES_ENTITY_EXIST(iVar1089) && !ENTITY::IS_ENTITY_DEAD(iVar1089, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar1089, Var1132, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_369(&Var16, iVar1154), Var1132, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())){
bVar1202=false;
...
bVar1202=true;
}elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())){
bVar1202=true;
}
if(bVar1202){
...
if(((bVar1179 || bVar1180) || bVar1182) || (func_462(&uVar890) && func_461(&uVar890) > 0.25f)){
if(func_462(&uVar890) && func_461(&uVar890) > 0.25f){
func_265(func_369(&Var16, iVar1154), iVar1089, iVar1101, &iVar720, &iVar1158, &fVar1152);
}
func_458(&uVar890);
if(bVar1179 || iVar720==1){
uVar722=func_264();
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uVar722)){
SYSTEM::WAIT(0);
if(func_368(&Var16)==0){
func_269(func_369(&Var16, (iVar1155 - 1)), Var908);
}
...
bVar1166=false;
while (bVar1166 < 13){
if(!MISC::IS_BIT_SET(Global_113648.f_18969.f_1, bVar1166)){
...
func_486(&uVar902);
func_219();
}}elseif((bVar1180 || bVar1182) || iVar720 >=2){
HUD::CLEAR_HELP(1);
HUD::CLEAR_PRINTS();
if(!bVar1182){
func_216();
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
bVar1191=PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0);
}
if(func_368(&Var16)==0){
func_269(func_369(&Var16, (iVar1155 - 1)), Var908);
}
...
func_78(&Var16, &uVar1115, &iVar1088, &iVar1089, &iVar1091, &iVar1094, iVar1098, &uVar923, &iVar1100, &iVar1101, &iVar1102, uVar1168, &iVar1163, uVar1109, uVar1110, bVar872, &uVar1099, bVar1194);
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_77() || func_461(&uVar902) >=2f)){
...
if(func_462(&uVar881)){
if((iVar721==1 || func_461(&uVar881) >=60f) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) || (!bVar1191 && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)))){
if(!bVar1196){
func_76(&(Var111.f_26));
bVar1196=true;
}
...
elseif(bVar1183){
if(func_461(&uVar881) > (60f - 5f)){
func_42(&uVar881, (60f - 5f));
}
}}else{
func_342(&uVar881, 0f);
}}
...
PAD::DISABLE_CONTROL_ACTION(0, 80, 1);
if(bVar1186){
bVar1190=func_16(&uVar866, &Var727, &uVar722, cVar1117, sVar1118, &bVar1176, 78);
}else{
bVar1190=func_3(&uVar722, &Var727, cVar1117, sVar1118, &bVar1176, 79, 7, 1, 1097859072, 1);
}
if(bVar1190){
if(bVar1176){
if(!bVar1179 && !bVar1180){
...
func_2(bVar1186, &Var16, &uVar1115, &iVar1088, &iVar1089, &iVar1091, &iVar1094, iVar1098, &uVar923, &iVar1100, &iVar1101, &iVar1102, uVar1168, &iVar1163, uVar1109, uVar1110, bVar872, &uVar1099, bVar1194);
}
func_1(&uVar722);
}
iVar720=0;
...
if(bParam0){
func_560(uParam1, uParam2, iParam3, iParam4, iParam5, iParam6, &uParam7, uParam8, iParam9, iParam10, iParam11, uParam12, iParam13, uParam14, uParam15, bParam16, uParam17, bParam18);
}else{
func_560(uParam1, uParam2, iParam3, iParam4, iParam5, iParam6, &uParam7, uParam8, iParam9, iParam10, iParam11, uParam12, iParam13, uParam14, uParam15, bParam16, uParam17, bParam18);
}}
...
sVar3=PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar0, iVar1, iVar2);
}
else{
...
func_18(1, 0);
SYSTEM::SETTIMERB(0);
}elseif(IntToFloat(SYSTEM::TIMERB()) > (1500f * 0.075f) || CAM::IS_SCREEN_FADED_OUT()){
if(!CAM::IS_SCREEN_FADED_OUT()){
if(!CAM::IS_SCREEN_FADING_OUT()){
...
}}elseif(MISC::IS_BIT_SET(iLocal_43, 3)){
...
uParam0->f_1=(func_43(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
func_9(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 215, 1));
func_14("ES_HELP");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
func_9(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 216, 1));
func_14("ES_XPAND");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
...
func_71();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_74((2f - 0.5f)) - 0.001388889f)), fVar6, func_65(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
}else{
return;
}
...
fVar12=func_49((fVar11 / (0.6f * func_74(25f))), 0f, 1f);
func_71();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_74((2f * 0.5f))), fVar6, func_65(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
fVar1=(fVar1 + func_74((2f * 0.3f)));
if(uParam0->f_56 > 0){
fVar1=(fVar1 + func_74((25f * 0.2f)));
}}}}
...
var func__58(int iParam0, bool bParam1){
char* sVar0[2];
var uVar3;
struct<13> Var19;
...
GRAPHICS::DRAW_SPRITE("CommonMenu", func_58(7, 0), (fParam4 - 0.006f), ((fParam2 + func_74(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0, 0);
fVar4=(fVar4 - ((fVar5 * 0.38f) + 0.006f));
break;
case 2:
func_54(5, 0, 1, &fVar5, &fVar6, 0);
GRAPHICS::DRAW_SPRITE("CommonMenu", func_58(5, 0), (fParam4 - 0.006f), ((fParam2 + func_74(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0, 0);
fVar4=(fVar4 - ((fVar5 * 0.38f) + 0.006f));
break;
case 3:
func_54(6, 0, 1, &fVar5, &fVar6, 0);
GRAPHICS::DRAW_SPRITE("CommonMenu", func_58(6, 0), (fParam4 - 0.006f), ((fParam2 + func_74(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0, 0);
fVar4=(fVar4 - ((fVar5 * 0.38f) + 0.006f));
break;
}
...
func_560(uParam0, uParam1, iParam2, iParam3, iParam4, iParam5, &uParam6, uParam7, iParam8, iParam9, iParam10, uParam11, iParam12, uParam13, uParam14, bParam15, uParam16, bParam17);
}
...
func_214(uParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 363, 0, 363, 0);
...
func_95(uParam1);
}elseif(func_81(&iLocal_581, 0)){
iLocal_581=0;
*iParam9=0;
func_214(uParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68", 363, 0);
}}else{
...
func_214(uParam1, 0, 202, "HUD_INPUT53", 217, "SCLB_PROFILE", 363, 0, 363, 0);
}}
...
return 0;
}elseif((!*iParam9 && func_328(uParam3, 8, 1000)) && (!PLAYER::IS_PLAYER_ONLINE() || func_263(uParam1, 26))){
*iParam9=1;
if(PLAYER::IS_PLAYER_ONLINE()){
...
func_214(uParam1, 0, 202, "HUD_INPUT53", 363, 0, 363, 0, 363, 0);
}}}}
return 2;
}
...
if(uParam0->f_3[iVar0] !=363){
uParam0->f_12[iVar0]=PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, uParam0->f_3[iVar0], 1);
}
iVar0++;
}
...
func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar25, &cVar9, Global_2097536.f_2780.f_25, Global_2097536.f_2780.f_26);
}
else{
...
if(Global_2097536.f_2780.f_26 > 0){
func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar9, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, Global_2097536.f_2780.f_26);
}
else{
func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar9, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, -1);
}}else{
...
func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar25, &cVar9, 1, Global_2097536.f_2780.f_26);
}else{
func_168(*uParam0, &(Global_2097536.f_2780.f_1), &cVar25, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, -1);
}
}
...
}elseif(func_82(&(Global_2097536.f_2823), 300, 0)){
...
func_118(*uParam0, iVar6, iVar31, Global_2101867[iVar0 /*100*/].f_59, &cVar9, &(Global_2101867[iVar0 /*100*/].f_80));
...
return 1;
}}elseif((!PAD::IS_CONTROL_PRESSED(2, iParam1) && !PAD::IS_DISABLED_CONTROL_PRESSED(2, iParam1)) || func_82(&(uParam0->f_246.f_3), 250, 0)){
return 1;
}
return 0;
}
...
return 0;
}elseif(!func_82(&(Global_2097536.f_2827), 1000, 1)){
return 0;
}}
if(((!NETWORK::NETWORK_HAS_VALID_ROS_CREDENTIALS() || !PLAYER::IS_PLAYER_ONLINE()) || (!NETWORK::NETWORK_HAVE_ONLINE_PRIVILEGES() && NETWORK::NETWORK_HAS_AGE_RESTRICTIONS())) || Global_2097536.f_2832 !=0){
...
}elseif(func_82(&(Global_2097536.f_2830), 30000, 1)){
...
func_130(PLAYER::PLAYER_ID()) 
};
}


Vector3 func__130(int iParam0){
...
elseif(Global_2097157.f_211.f_3[0] >=STATS::LEADERBOARDS2_READ_GET_ROW_DATA_FLOAT(iVar111, false)){
iVar109=iVar111;
}}
func_156(&Var0);
iVar111++;
...
elseif(Global_2097157.f_211.f_3[0] >=STATS::LEADERBOARDS2_READ_GET_ROW_DATA_FLOAT(iVar110, false)){
iVar108=iVar110;
}
func_156(&Var0);
}
...
}elseif(func_120(Var0) && Global_2097536.f_2704[bVar113] < 11){
if(func_119(&Var0, &Var114)){
iVar108=0;
Global_2097536.f_2775[1]=0;
}
MemCopy(&(Global_2097536[1 /*901*/][Global_2097536.f_2704[bVar113] /*75*/]),{
Var0.f_13
}
, 16);
Global_2097536[1 /*901*/][Global_2097536.f_2704[bVar113] /*75*/].f_32={
Var0 
};
...
if(func_169(uParam0->f_44)){
MemCopy(&(Global_2097536[1 /*901*/][Global_2097536.f_2704[bVar113] /*75*/].f_16),{
Var0.f_19.f_1[1 /*16*/].f_8
}
, 16);
}
...
elseif(Global_2097157.f_211.f_3[0] >=STATS::LEADERBOARDS2_READ_GET_ROW_DATA_FLOAT(iVar124, false)){
iVar122=iVar124;
}}
func_156(&Var13);
iVar124++;
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
func_9(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 188, 1));
func_14("ES_HELP_TU");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
func_9(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 187, 1));
func_14("ES_HELP_TD");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
func_9(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 202, 1));
func_14("ES_HELP_AB");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
if(iParam1==156){
}elseif(func_196(iParam0, 4, bVar1)){
...
if(MISC::IS_BIT_SET(Global_2097536.f_2769, Global_2097536.f_2710[bVar16])){
...
uParam0->f_3[6]=363;
uParam0->f_3[7]=363;
uParam0->f_12[0]=func_215(iParam2 !=363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, iParam2, 1), "");
uParam0->f_12[1]=func_215(iParam4 !=363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, iParam4, 1), "");
uParam0->f_12[2]=func_215(iParam6 !=363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, iParam6, 1), "");
uParam0->f_12[3]=func_215(iParam8 !=363, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, iParam8, 1), "");
uParam0->f_12[4]=0;
uParam0->f_12[5]=0;
uParam0->f_12[6]=0;
uParam0->f_12[7]=0;
...
if(bParam2){
MISC::SET_BIT(&(uParam0->f_607), bParam1);
}else{
MISC::CLEAR_BIT(&(uParam0->f_607), bParam1);
}}
...
}}elseif(MISC::IS_BIT_SET(Global_113648.f_20566.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_229() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_229() /*5568*/].f_681.f_10, iParam0);
}
...
return MISC::IS_BIT_SET(uParam0->f_607, iParam1);
}
...
Var24={
ENTITY::GET_ENTITY_COORDS(iVar20, 1) 
};
}}
...
return 1;
}elseif(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iVar0)){
Var9={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) 
};
...
void func_269(struct<3> Param0, var uParam3, var uParam4, var uParam5){
float fVar0;
int iVar1;
if(!func_462(&uParam3)){
return;
}
fVar0=func_461(&uParam3);
if(fVar0 > 1.4f){
return;
}
...
void func_270(var uParam0, var uParam1, bool bParam2, int iParam3){
int iVar0;
...
Var0={
ENTITY::GET_ENTITY_SPEED_VECTOR(ENTITY::GET_ENTITY_ATTACHED_TO(PLAYER::PLAYER_PED_ID()), 0) 
};
}else{
Var0={
ENTITY::GET_ENTITY_SPEED_VECTOR(PLAYER::PLAYER_PED_ID(), 1) 
};
}
fVar21=Var0.f_1;
Var3={
...
uVar24=func_49(func_272(Var18.f_1, fVar22, 0.5f), Var18.f_1, fVar21);
...
float func_276(int iParam0, int iParam1, int iParam2){
struct<3> Var0;
struct<3> Var3;
...
Vector3 func__277(int iParam0, struct<3> Param1){
var uVar0;
...
Var8={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS((*uParam1)[iVar13], 1) 
};
...
Var8={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(uVar0[iVar13], 1) 
};
fVar11=((Var8.f_0 * Var8.f_0) + (Var8.f_1 * Var8.f_1));
if(Var8.f_2 * Var8.f_2) > (3f * fVar11){
bVar15=false;
...
if(!func_326(*iParam9) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam9, -1, 0))){
...
func_286(*uParam6, func_325(bParam20), func_324(bParam20), 24, 0);
ENTITY::SET_ENTITY_VELOCITY(iVar0, 0f, 0f, 0f);
ENTITY::SET_ENTITY_COORDS(iVar0, func_325(bParam20), 1, 0, 0, 1);
...
void func_286(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
func_310(iParam5, &Var0, Param1, uParam4, func_316(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_304(iParam0, 0, 0)) || func_304(iParam0, 1, 0)) || func_304(iParam0, 2, 0)) || func_316(iParam0) !=145) || func_303(iParam0)) || func_302(iParam0)) || func_301(iParam0)) || func_300(iParam0)) || !func_290(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_302(iParam0)){
}
if(func_302(iParam0)){
}
...
void func_310(int iParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6){
if(func_307(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
if(MISC::IS_BIT_SET(uParam0->f_2, bParam1) && !MISC::IS_BIT_SET(uParam0->f_3, bParam1)){
uParam0->f_4=MISC::GET_GAME_TIMER();
return 1;
}}
return 0;
...
int func_329(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8, var uParam11, var uParam12){
struct<3> Var0;
switch (uParam0->f_3){
case 0:
...
var uVar4;
struct<3> Var5;
uVar3=func_433(uParam1, 0);
uVar4=func_433(uParam1, 1);
CAM::SET_CAM_NEAR_CLIP(uVar4, func_331());
Var5={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 2f, -0.3f, -7.7824f) 
};
CAM::SET_CAM_COORD(uVar4, Var5);
Var0={
CAM::GET_CAM_ROT(uVar3, 2) 
};
Var0.f_0=0f;
...
int func_332(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, struct<3> Param6, struct<3> Param9){
var uVar0;
struct<3> Var1;
struct<3> Var4;
uVar0=func_433(uParam1, 0);
Var1={
func_335(uParam2) 
};
...
Var4={
func_463(Param9, uParam4->f_2) 
};
CAM::SET_CAM_COORD(uVar0, Param6 + Var4);
CAM::SET_CAM_ROT(uVar0, (-33f + *uParam4), 0f, ((-88.515f + func_464(uParam0)) + uParam4->f_2), 2);
CAM::SET_CAM_NEAR_CLIP(uVar0, func_331());
if(!CAM::IS_SCREEN_FADED_IN() || !func_462(uParam3)){
func_371(uParam3);
}else{
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
return (MISC::IS_BIT_SET(uParam0->f_2, bParam1) && !MISC::IS_BIT_SET(uParam0->f_3, bParam1));
}
...
if(func_462(uParam0)){
if(func_345(uParam0, (7.5f * IntToFloat(*iParam1)))){
*iParam1++;
...
int func_348(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, int iParam6, int iParam7, var uParam8, int iParam9, var uParam10, var uParam11, var uParam12, int iParam13, int iParam14, var uParam15, var uParam16, var uParam17, var uParam18, bool bParam19, bool bParam20, float fParam21){
struct<3> Var0;
var uVar3;
var uVar6;
struct<3> Var9;
...
Var27={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam1, func_370(uParam0)) 
};
...
GRAPHICS::DRAW_MARKER(6, Var27, 0f, 0f, 1f, 0f, 0f, 0f, 4f, 4f, 4f, 240, 200, 80, func_357(Var27, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var27, 0f, 0f, 1f, 0f, 0f, 0f, 9f, 9f, 9f, 240, 200, 80, func_357(Var27, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var27, 0f, 0f, 1f, 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_357(Var27, 170, 200), 0, 0, 2, 0, 0, 0, 0);
}
if(*iParam7 !=-1){
...
Var15={
func_369(uParam0, *iParam6 + 1) 
};
GRAPHICS::DRAW_MARKER(6, Var12, func_475(Var18), 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_357(Var12, 25, 200), 0, 0, 2, 0, 0, 0, 0);
if(*iParam7 !=*iParam6){
if(*iParam7 >=0){
GRAPHICS::DELETE_CHECKPOINT(*uParam4);
*uParam4=0;
...
*uParam4=GRAPHICS::CREATE_CHECKPOINT(17, Var12, Var15, 9f, uVar39, uVar40, uVar41, func_357(Var27, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
if(*iParam6 < (iParam9 - 2)){
*uParam5=GRAPHICS::CREATE_CHECKPOINT(17, Var15, func_369(uParam0, *iParam6 + 2), (9f * 0.5f), uVar39, uVar40, uVar41, func_357(Var27, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))), 0);
}
*iParam7=*iParam6;
}
if(*iParam6 + 1==(iParam9 - 1)){
GRAPHICS::DRAW_MARKER(6, Var15, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 4f), (0.5f * 4f), (0.5f * 4f), 240, 200, 80, func_357(Var15, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var15, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 9f), (0.5f * 9f), (0.5f * 9f), 240, 200, 80, func_357(Var15, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var15, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_357(Var15, 170, 200), 0, 0, 2, 0, 0, 0, 0);
}else{
GRAPHICS::DRAW_MARKER(6, Var15, func_475(Var9 - Var15), 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_357(Var15, 25, 200), 0, 0, 2, 0, 0, 0, 0);
}
if(*uParam4 !=0){
GRAPHICS::SET_CHECKPOINT_RGBA(*uParam4, uVar39, uVar40, uVar41, func_357(Var12, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
}
if(*uParam5 !=0){
GRAPHICS::SET_CHECKPOINT_RGBA(*uParam5, uVar39, uVar40, uVar41, func_357(Var15, 25, SYSTEM::CEIL((200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170))))));
}}
if(!bParam19){
return 0;
}
...
if(fVar33 < (10f * 10f)){
bVar38=true;
}elseif(func_275(Var0, -Var18 / FtoV(SYSTEM::SQRT(fVar33))) < 0.08f){
bVar38=true;
}
if(bVar38){
*uParam8++;
...
if(*iParam6 < (iParam9 - 1)){
if(!HUD::DOES_BLIP_EXIST(*uParam12)){
*uParam12=HUD::ADD_BLIP_FOR_COORD(func_369(uParam0, *iParam6 + 1));
...
return (func_43(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return 0f;
}
...
GRAPHICS::DRAW_SPRITE("basejumping", "Arrow_Pointer", fVar2, fVar3, fVar6, fVar5, fVar4, 240, 200, 80, 170, 0, 0);
}
*uParam5=fVar4;
}
*uParam3=fVar2;
...
return 0;
}elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iVar0, 1), &fVar7, 0, 0)){
return 0;
}elseif(Var1.f_2 >=(fVar7 + 1.5f)){
return 0;
}}
if(ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())){
return 0;
}elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(Var1, &fVar7, 0, 0)){
return 0;
}elseif(Var1.f_2 >=(fVar7 + 1.5f)){
return 0;
}
...
*uParam2=1;
return 1;
}}elseif(bParam1==6 || bParam1==12){
if(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_473(bParam1)) > 3600f){
*uParam2=1;
return 1;
}}
return 0;
...
Var5={
Vector(1000f, 1000f, 1000f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(*iParam0) 
};
Var5.f_2=200f;
...
Vector3 func__369(var uParam0, int iParam1){
...
int func_379(var uParam0, bool bParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, var uParam10, var uParam11, var uParam12){
...
func_458(uParam7);
*uParam10=1;
}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam2, 0)){
...
if(!func_462(uParam6)){
func_486(uParam6);
}elseif((uParam12 && CAM::IS_SCREEN_FADED_IN()) || (func_461(uParam6) > 0.5f && func_333(uParam4, 2))){
*uParam11=1;
func_458(uParam5);
func_458(uParam6);
return 1;
...
func_458(uParam8);
}elseif(func_461(uParam8) > func_426(bParam1, iParam9)){
switch (iParam9){
case 0:
...
var func__406(int iParam0, int iParam1){
...
struct<3> Var4;
struct<3> Var7;
uVar0=func_433(uParam0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iParam5) && !ENTITY::IS_ENTITY_DEAD(iParam5, 0)){
*uParam2={
10.2986f, 0f, 8.909f 
};
*uParam4={
Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -SYSTEM::COS((-97.4239f + func_464(uParam1))), SYSTEM::SIN((-97.4239f + func_464(uParam1)))) 
};
*uParam3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam5, 1.12046f, -0.317773f, 1.3385f) 
};
Var1={
...
void func_418(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
var func__430(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5){
...
Vector3 func__432(bool bParam0){
switch (bParam0){
case 5:
...
void func_435(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7, int iParam8, var uParam9, int iParam10, int iParam11, var uParam12, bool bParam13, int iParam14){
int iVar0;
int iVar1;
struct<3> Var2;
int iVar5;
...
if(func_431(func_457(uParam0))){}else{
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(func_457(uParam0), func_456(uParam0), 0, 1);
}
iVar5=0;
while (iVar5 < 12){
...
ENTITY::SET_ENTITY_COORDS(*iParam3, func_473(bParam13), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(*iParam3, func_464(uParam0));
}else{
*iParam3=VEHICLE::CREATE_VEHICLE(iVar0, func_473(bParam13), func_464(uParam0), 1, 1, 0);
}
if(func_465(iVar0)){
...
}elseif(func_449(PLAYER::PLAYER_PED_ID(), *iParam3)==1){
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 0);
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam3, 2);
}}
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_473(bParam13), 1, 0, 0, 1);
...
MISC::CLEAR_AREA(func_369(uParam0, 0), 100f, 1, 0, 0, 0);
...
*iParam4=VEHICLE::CREATE_VEHICLE(iVar0, func_369(uParam0, 0), func_440(uParam0), 1, 1, 0);
if(func_439(func_368(uParam0))){
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam4, 11);
}elseif(func_438(func_368(uParam0))){
...
}elseif(!ENTITY::IS_ENTITY_DEAD(*iParam4, 0)){
VEHICLE::SET_VEHICLE_FIXED(*iParam4);
ENTITY::SET_ENTITY_COORDS(*iParam4, func_369(uParam0, 0), 1, 0, 0, 1);
...
*iParam6=VEHICLE::CREATE_VEHICLE(joaat("trflat"), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*iParam4, 0f, -10f, 0f), func_440(uParam0), 1, 1, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(*iParam6, 1, 1);
ENTITY::SET_ENTITY_LOD_DIST(*iParam6, 2000);
}elseif(!ENTITY::IS_ENTITY_DEAD(*iParam6, 0)){
...
func_437(*uParam9, bParam13);
if(bParam13==0){
func_436(uParam1, 2, *uParam9, "EX3MERC1", 0, 1);
}}else{
...
PED::SPECIAL_FUNCTION_DO_NOT_USE(*uParam9, 1);
}
...
unk_0x7E4E6DFA37692889(iParam0, 0, 1);
PED::SET_PED_PROP_INDEX(iParam0, 1, 1, 0, 0, 1);
break;
case 5:
...
unk_0x7E4E6DFA37692889(iParam0, 0, 1);
unk_0x7E4E6DFA37692889(iParam0, 1, 1);
break;
case 7:
PED::SET_PED_COMPONENT_VARIATION(iParam0, 0, 0, 1, 0);
...
PED::SET_PED_PROP_INDEX(iParam0, 0, 0, 2, 0, 1);
break;
}}
...
*uParam1=VEHICLE::CREATE_VEHICLE(func_444(uParam0), func_443(uParam0), func_442(uParam0), 1, 1, 0);
}elseif(ENTITY::IS_ENTITY_DEAD(*uParam1, 0)){
VEHICLE::DELETE_VEHICLE(uParam1);
*iParam1=VEHICLE::CREATE_VEHICLE(func_444(uParam0), func_443(uParam0), func_442(uParam0), 1, 1, 0);
}else{
...
int iVar2;
if(ENTITY::DOES_ENTITY_EXIST(*uParam1)){
if(!func_326(*uParam1) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam1, -1, 0))){
...
iVar2=VEHICLE::CREATE_VEHICLE(func_531(uParam0), func_447(uParam0), func_446(uParam0), 1, 1, 0);
}else{
ENTITY::SET_ENTITY_COORDS(iVar2, func_447(uParam0), 1, 0, 0, 1);
...
PED::SET_PED_HELMET(iVar1, 0);
PED::SET_PED_PROP_INDEX(iVar1, 0, 2, 0, 0, 1);
PED::SET_PED_PROP_INDEX(iVar1, 1, 0, 0, 0, 1);
}
...
PED::SET_PED_PROP_INDEX(iParam0, 1, 0, 0, 0, 1);
break;
case 11:
PED::SET_PED_COMPONENT_VARIATION(iParam0, 0, 1, 0, 0);
...
PED::SET_PED_COMPONENT_VARIATION(iParam0, 4, 0, 2, 0);
PED::SET_PED_PROP_INDEX(iParam0, 0, 1, 2, 0, 1);
PED::SET_PED_PROP_INDEX(iParam0, 1, 1, 0, 0, 1);
break;
}}


Vector3 func__456(var uParam0){
return uParam0->f_67;
}
...
int func_459(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, bool bParam5){
char cVar0[64];
...
if(CAM::IS_SCREEN_FADED_OUT()){
MISC::CLEAR_AREA(func_473(bParam1), 5000f, 1, 0, 0, 0);
}
...
Vector3 func__473(bool bParam0){
switch (bParam0){
case 0:
...
if(CAM::IS_SCREEN_FADED_OUT()){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_473(bParam0), 15f, 15f, 15f, 0, 1, 0)){
return 1;
}
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_473(bParam0), 0, 0, 0, 1);
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_473(bParam0), 15f, 15f, 15f, 0, 1, 0)){
return 1;
}}
return 0;
...
Vector3 func__475(struct<3> Param0){
float fVar0;
float fVar1;
...
Vector3 func__476(bool bParam0){
switch (bParam0){
case 0:
...
uVar6=func_483(uParam1);
if(!CAM::DOES_CAM_EXIST(func_433(uParam0, 0))){
func_482(uParam0, 0, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var3, 1115815936, 0, 2), 1);
}else{
CAM::SET_CAM_COORD(func_433(uParam0, 0), Var0);
CAM::SET_CAM_ROT(func_433(uParam0, 0), Var3, 2);
}
CAM::SET_CAM_FOV(func_433(uParam0, 0), uVar6);
CAM::SET_CAM_ACTIVE(func_433(uParam0, 0), 1);
if(bParam3){
Var7={
Var0 
};
...
func_482(uParam0, 1, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var3, 1115815936, 0, 2), 1);
}else{
...
var func__478(var uParam0){
return uParam0->f_82;
}


Vector3 func__479(var uParam0){
return uParam0->f_58;
}


Vector3 func__480(var uParam0){
return uParam0->f_55;
}
...
void func_482(var uParam0, int iParam1, var uParam2, int iParam3){
if(iParam1 >=2){
return;
}
...
var func__483(var uParam0){
return uParam0->f_81;
}


Vector3 func__484(var uParam0){
return uParam0->f_52;
}


Vector3 func__485(var uParam0){
return uParam0->f_49;
}
...
void func_487(struct<3> Param0, float fParam3, int iParam4){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
void func_504(char* sParam0, var uParam1, bool bParam2){
if(!MISC::IS_BIT_SET(*uParam1, bParam2)){
AUDIO::STOP_AUDIO_SCENE(sParam0);
MISC::SET_BIT(uParam1, bParam2);
}}

int func_505(char* sParam0, char* sParam1, var uParam2, bool bParam3){
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam1)){
if(AUDIO::IS_AUDIO_SCENE_ACTIVE(sParam1)){
AUDIO::STOP_AUDIO_SCENE(sParam1);
}}
if(!MISC::IS_BIT_SET(*uParam2, bParam3)){
if(AUDIO::START_AUDIO_SCENE(sParam0)){
MISC::SET_BIT(uParam2, bParam3);
return 1;
}}else{
return 1;
}
...
}elseif(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_365(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))){
...
if(func_509(func_510(12), &(uParam0->f_607), 12)){
func_508(func_510(16), &(uParam0->f_607), 16);
}}}elseif(iParam1==10 && !func_263(uParam0, 17)){
if(func_509(func_510(13), &(uParam0->f_607), 13)){
func_508(func_510(17), &(uParam0->f_607), 17);
}}}}

int func_508(char* sParam0, var uParam1, bool bParam2){
if(!MISC::IS_BIT_SET(*uParam1, bParam2)){
...
int func_509(char* sParam0, var uParam1, bool bParam2){
if(!MISC::IS_BIT_SET(*uParam1, bParam2)){
if(AUDIO::PREPARE_MUSIC_EVENT(sParam0)){
MISC::SET_BIT(uParam1, bParam2);
return 1;
...
func_518(&uVar3, &uVar4, &iVar5, &iVar6, PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()), PAD::IS_USING_KEYBOARD_AND_MOUSE(2));
...
void func_518(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
var func__525(int iParam0){
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_526(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_560(var uParam0, var uParam1, int iParam2, var uParam3, int iParam4, var uParam5, var uParam6, var uParam7, int iParam8, var uParam9, var uParam10, var uParam11, int iParam12, var uParam13, var uParam14, int iParam15, var uParam16, bool bParam17){
int iVar0;
int iVar1;
int iVar2;
func_376();
...
VEHICLE::SET_PLAYERS_LAST_VEHICLE(*uParam6);
func_286(*uParam6, func_325(iParam15), func_324(iParam15), 24, 0);
}
