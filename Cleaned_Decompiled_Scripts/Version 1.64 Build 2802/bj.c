...
flag20=false;
if(ENTITY::DOES_ENTITY_EXIST(eScriptParam_0.f_1)) playersLastVehicle=eScriptParam_0.f_1;
else playersLastVehicle=PLAYER::GET_PLAYERS_LAST_VEHICLE();
...
if(playerHasReserveParachute) PLAYER::GET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_ID(), &any);
if(ENTITY::DOES_ENTITY_EXIST(playersLastVehicle)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(playersLastVehicle, true, true);
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()) CAM::STOP_SCRIPT_GLOBAL_SHAKING(false);
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(82)) func_560(&unk15, &unk1091, &entity2, &train, &vehicle, &sizeAndVehs, &playersLastVehicle, &unk915, &entity, &ped, &num8, soundId, &num21, vehicleWheelType, vehicleWheelType2, num4, &num7, hasPedGotWeapon);
if(num19 < 0) return;
if(IS_BIT_SET(Global_113648.f_18969.f_1, num19)) num10=0.1f;
num4=num19;
func_559(0);
...
func_532(&unk15, num4);
if(ENTITY::DOES_ENTITY_EXIST(entity)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(entity, true, true);
...
while (true){
if(!flag15) SYSTEM::WAIT(0);
else flag15=false;
if(num >=6 && num <=10 && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) num6=func_520();
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
func_519();
func_511(&unk100);
func_507(&unk110, num);
...
case 0:
func_502();
if(CAM::IS_SCREEN_FADING_OUT()) break;
func_496();
func_495(true);
...
if(ENTITY::DOES_ENTITY_EXIST(entity2)) func_486(&unk888);
...
num9={
func_475(SYSTEM::COS(num9.f_2), SYSTEM::SIN(num9.f_2), MISC::TAN(num9)) 
};
if(func_474(num4)) STREAMING::NEW_LOAD_SCENE_START(func_473(num4), num9, 4000f, 0);
}
func_467(&unk15, num4, &unk, &hash, &hash2, &unk1091, &num22);
}elseif(func_465(func_466(num4))){
vector3={
{
1.2f, 1.2f, 1.2f 
}
*{
0f, -SYSTEM::COS(-97.4239f + func_464(&unk15)), SYSTEM::SIN(-97.4239f + func_464(&unk15)) 
}};
offsetFromEntityInWorldCoords={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(entity2, 1.12046f, -0.317773f, 1.3385f) 
};
vector3={
func_463(vector3, 8.909f) 
};
if(func_474(num4)) STREAMING::NEW_LOAD_SCENE_START(offsetFromEntityInWorldCoords + vector3, vector3, 4000f, 0);
}else{
num9={
-10f, 0f, func_464(&unk15) 
};
num9={
func_475(SYSTEM::COS(num9.f_2), SYSTEM::SIN(num9.f_2), MISC::TAN(num9)) 
};
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) PED::SPECIAL_FUNCTION_DO_NOT_USE(PLAYER::PLAYER_PED_ID(), true);
...
num=2;
}elseif(!CAM::IS_SCREEN_FADING_OUT() && !func_462(&unk888) || func_461(&unk888) > 0.05f){
if(PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID())) CAM::DO_SCREEN_FADE_OUT(2500);
else CAM::DO_SCREEN_FADE_OUT(800);
}
break;
case 2:
...
if(!flag4 && !flag12) func_477(&unk106, &unk15, num4, false);
num=3;
}
break;
case 3:
...
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_MICHAEL) PED::SET_PED_COMPONENT_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_TASK, 5, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) PED::SET_PED_COMPONENT_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_ACCS, 1, 0, 0);
elseif(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) PED::SET_PED_COMPONENT_VARIATION(PLAYER::PLAYER_PED_ID(), PV_COMP_ACCS, 3, 0, 0);
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId2);
if(func_427(num4) > 0) TASK::TASK_STAND_STILL(0, func_427(num4));
...
if(!func_465(func_466(num4))){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) PED::GET_PED_NEARBY_VEHICLES(PLAYER::PLAYER_PED_ID(), &sizeAndVehs);
for (j=0;
j < sizeAndVehs;
j=j + 1){
...
if(func_531(&unk15) !=0) func_486(&unk885);
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
if(func_426(num4, num22) > 0f) func_486(&unk903);
num=4;
}}
break;
case 4:
if(num4==0) VEHICLE::SET_LIGHTS_CUTOFF_DISTANCE_TWEAK(200f);
if(flag6 || flag7){
...
if(flag19) AUDIO::PLAY_SOUND_FROM_ENTITY(soundId, "Helicopter_Wind_Idle", entity2, "BASEJUMPS_SOUNDS", false, 0);
if(flag18) AUDIO::SCRIPT_OVERRIDES_WIND_ELEVATION(true, 300362576);
}else{
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()) CAM::STOP_SCRIPT_GLOBAL_SHAKING(false);
CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, true, 0);
...
elseif(func_461(&unk909) > 4f || func_465(func_466(num4)) && func_461(&unk909) > 0.5f){
...
func_375();
if(CAM::IS_SCREEN_FADED_OUT()){
if(flag4 && flag13) CLOCK::SET_CLOCK_TIME(func_374(num6), func_373(num6), func_372(num6));
SYSTEM::WAIT(2000);
if(flag4){
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
func_371(&unk906);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, true);
...
HUD::SET_BLIP_COLOUR(vehicleWheelType, 5);
if(num14==1) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(vehicleWheelType, "BJ_BLIP_TGT");
else HUD::SET_BLIP_NAME_FROM_TEXT_FILE(vehicleWheelType, "BJ_BLIP_CHK");
}
...
if(num14==2) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(vehicleWheelType2, "BJ_BLIP_TGT");
else HUD::SET_BLIP_NAME_FROM_TEXT_FILE(vehicleWheelType2, "BJ_BLIP_CHK");
}
if(ENTITY::DOES_ENTITY_EXIST(train) && !ENTITY::IS_ENTITY_DEAD(train, false)){
ENTITY::SET_ENTITY_LOD_DIST(train, 2000);
if(ENTITY::DOES_ENTITY_EXIST(ped) && !PED::IS_PED_INJURED(ped)) TASK::CLEAR_PED_TASKS(ped);
if(func_367(_STOPWATCH_IS_INITIALIZED_0(&unk15))) VEHICLE::DELETE_MISSION_TRAIN(&train);
else ENTITY::SET_ENTITY_COORDS(train, func_369(&unk15, 0), true, false, false, true);
}
...
if(num4==5) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 146, true);
...
if(hasPedGotWeapon){
if(!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("GADGET_PARACHUTE"), false)) WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), 1, false, true);
PED::SET_PED_PARACHUTE_TINT_INDEX(PLAYER::PLAYER_PED_ID(), tintIndex);
if(playerHasReserveParachute){
if(!PLAYER::GET_PLAYER_HAS_RESERVE_PARACHUTE(PLAYER::PLAYER_ID())) PLAYER::SET_PLAYER_HAS_RESERVE_PARACHUTE(PLAYER::PLAYER_ID());
...
if(num4==5) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 146, ENTITY::IS_ENTITY_IN_AREA(PLAYER::PLAYER_PED_ID(), -118.4f, -973.1f, 295.2f, -117.1f, -975.7f, 297.7f, false, true, 0));
if(flag8){
vector={
func_369(&unk15, num14 - 1) 
};
...
func_347(&unk1092);
if(func_462(&unk867))if(func_461(&unk867) > 10f) func_343(&unk879, &num21);
else func_342(&unk867, 0f);
...
if(!PED::IS_PED_INJURED(pedInVehicleSeat)) PED::DELETE_PED(&pedInVehicleSeat);
...
if(_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("BJ_VEHHELP")) HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
if(func_462(&unk891)) func_458(&unk891);
}}else{
...
if(num4==5) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 146, false);
...
func_348(&unk15, train, entity, &num8, &checkpoint, &checkpoint2, &num13, &num15, &num16, num14, &num17, &vehicleWheelType, &vehicleWheelType2, &num12, &num5, &unk1117, &unk1118, &unk1119, &unk1120, false, true, num10);
func_347(&unk1092);
if(func_465(func_466(num4)) && !ENTITY::IS_ENTITY_DEAD(entity2, false)) func_336(entity2, func_473(num4));
if(func_462(&unk867))if(func_461(&unk867) > 10f) func_343(&unk879, &num21);
else func_342(&unk867, 0f);
...
if(flag18) AUDIO::SCRIPT_OVERRIDES_WIND_ELEVATION(false, 300362576);
...
case 9:
if(num4==0) VEHICLE::SET_LIGHTS_CUTOFF_DISTANCE_TWEAK(200f);
if(Global_23131.f_135) PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_PARACHUTE_DEPLOY, true);
if(Global_23131.f_135) PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_PARACHUTE_DEPLOY, true);
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
num=12;
break;
...
HUD::CLEAR_PRINTS();
num=10;
}elseif(func_328(&unk100, 3, 1000) && !Global_23131.f_135){
...
if(!ENTITY::IS_ENTITY_DEAD(train, false)) VEHICLE::SET_TRAIN_CRUISE_SPEED(train, 7.5f);
}}elseif(ENTITY::DOES_ENTITY_EXIST(train) && !ENTITY::IS_ENTITY_DEAD(train, false) && !_IS_NULL_VECTOR(func_369(&unk15, 0))){
PED::IS_PED_INJURED(ped);
if(func_276(PLAYER::PLAYER_PED_ID(), train, false) <=325f){
if(num4==5) vector4={
28.8687f, -299.1065f, 46.5693f 
};
else vector4={
-819.7591f, -1512.2285f, 0.1336f 
};
if(TASK::GET_SCRIPT_TASK_STATUS(ped, SCRIPT_TASK_VEHICLE_MISSION) !=1)if(num4==5) TASK::TASK_VEHICLE_MISSION_COORS_TARGET(ped, train, vector4, 4, 5f, 16785408, 5f, 10f, true);
else TASK::TASK_VEHICLE_MISSION_COORS_TARGET(ped, train, vector4, 4, 5f, 16777216, 4f, -1f, true);
else func_271(&train);
}}
...
if(!func_462(&unk882)){
if(!func_462(&unk873)) func_486(&unk873);
if(HUD::DOES_BLIP_EXIST(vehicleWheelType)) HUD::REMOVE_BLIP(&vehicleWheelType);
if(HUD::DOES_BLIP_EXIST(vehicleWheelType2)) HUD::REMOVE_BLIP(&vehicleWheelType2);
if(num15 > -1){
...
if(!func_462(&unk900)) func_486(&unk900);
if(_STOPWATCH_IS_INITIALIZED_0(&unk15)==0) func_269(func_369(&unk15, num14 - 1), unk900);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
flag21=false;
if(ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(train) && !ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), train)) flag21=true;
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) flag21=true;
if(flag21){
...
if(func_462(&unk882) && func_461(&unk882) > 0.25f) func_265(func_369(&unk15, num13), train, ped, &num2, &num17, &num11);
func_458(&unk882);
if(flag6 || num2==1){
for (i=func_264();
!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(i);
i=func_264()){
SYSTEM::WAIT(0);
if(_STOPWATCH_IS_INITIALIZED_0(&unk15)==0) func_269(func_369(&unk15, num14 - 1), unk900);
}
if(num4==0)if(!PED::IS_PED_INJURED(ped)) _CONVERSATION_ADD_LINE(&unk915, "OJBJAUD", "BJ_01D", 8, 1, 1, 0);
num=11;
...
if(func_465(func_466(k))) flag3=false;
else flag2=false;
flag=false;
}}
if(flag && !func_261(98)) func_260(98, 1);
if(flag2) func_257(128, 0, 0);
if(flag3) func_257(129, 0, 0);
func_222(&num16, num14, &num17, &num18, num10);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), false);
func_221(&unk110, 7, true);
func_220(1, 0);
func_486(&unk894);
func_219();
}}elseif(flag7 || flag9 || num2 >=2){
HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
HUD::CLEAR_PRINTS();
if(!flag9) func_216();
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) num23=1;
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) isPedInAnyVehicle=PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false);
if(_STOPWATCH_IS_INITIALIZED_0(&unk15)==0) func_269(func_369(&unk15, num14 - 1), unk900);
if(!flag20){
...
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(num19==0) PATHFIND::SET_ROADS_IN_ANGLED_AREA(-832.271f, -1525.112f, -100f, -1187.833f, -1876.646f, 100f, 50f, false, true, true);
elseif(num19==5) PATHFIND::SET_ROADS_IN_ANGLED_AREA(-129.031f, -726.381f, 35f, -38.185f, -465.801f, 100f, 75f, false, true, true);
...
}elseif(!CAM::IS_SCREEN_FADING_OUT() && !func_77() || func_461(&unk894) >=2f){
...
if(!flag6 && !flag7)if(func_213() && !func_263(&unk110, 26))if(func_190(num4, num17, num11, num18)) func_221(&unk110, 26, true);
func_44(&(unk110.f_26), 0);
func_458(&unk894);
if(num4==0) PATHFIND::SET_ROADS_IN_ANGLED_AREA(-832.271f, -1525.112f, -100f, -1187.833f, -1876.646f, 100f, 50f, false, true, true);
elseif(num4==5) PATHFIND::SET_ROADS_IN_ANGLED_AREA(-129.031f, -726.381f, 35f, -38.185f, -465.801f, 100f, 75f, false, true, true);
func_78(&unk15, &unk1091, &entity2, &train, &vehicle, &sizeAndVehs, playersLastVehicle, &unk915, &entity, &ped, &num8, soundId, &num21, vehicleWheelType, vehicleWheelType2, num4, &num7, hasPedGotWeapon);
}
}
else{
...
if(flag10)if(func_461(&unk873) > 60f - 5f) func_42(&unk873, 60f - 5f);
}}else{
func_342(&unk873, 0f);
}}
break;
...
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) flag13=true;
else flag13=false;
...
if(flag13) func_41(&unk861, 0);
else func_40(&unk722, 1050253722, 1073741824);
...
PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_NEXT_CAMERA, true);
PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_VEH_CIN_CAM, true);
if(flag13) flag17=func_16(&unk861, &unk722, &i, str, str2, &flag4, 78);
else flag17=func_3(&i, &unk722, str, str2, &flag4, 79, 7, true, 1097859072, true);
if(flag17){
if(flag4){
if(!flag6 && !flag7)if(func_213() && !func_263(&unk110, 26))if(func_190(num4, num17, num11, num18)) func_221(&unk110, 26, true);
func_282(&unk15, &unk1091, &unk110, &address, &ped, &num8, &playersLastVehicle, &train, &unk1080, &vehicle, &sizeAndVehs, &checkpoint, &checkpoint2, vehicleWheelType, vehicleWheelType2, &num13, &num15, &num16, &num21, &num17, num4, &num2, &num5, &unk882, &unk900, &unk1106, &unk1117, &unk1118, &unk1119, &unk1120, &flag5, &flag6, &flag7, &flag8, &flag10, &num23, &num7);
...
if(bParam0) func_560(uParam1, uParam2, pveParam3, pveParam4, pveParam5, uParam6, &veParam7, uParam8, ppedParam9, uParam10, uParam11, iParam12, uParam13, blParam14, blParam15, iParam16, uParam17, bParam18);
else func_560(uParam1, uParam2, pveParam3, pveParam4, pveParam5, uParam6, &veParam7, uParam8, ppedParam9, uParam10, uParam11, iParam12, uParam13, blParam14, blParam15, iParam16, uParam17, bParam18);
return;
}
...
if(func_15(iParam5, 4))if(AUDIO::REQUEST_SCRIPT_AUDIO_BANK("generic_failed", false, -1)) *uParam1=1;
else *uParam1=1;
break;
case 1:
...
if(!func_15(iParam5, 1)) PAD::DISABLE_ALL_CONTROL_ACTIONS(PLAYER_CONTROL);
...
if(func_15(iParam5, 4)) AUDIO::PLAY_SOUND_FRONTEND(-1, "ScreenFlash", "MissionFailedSounds", true);
...
if(!func_462(&(uParam1->f_1))) func_486(&(uParam1->f_1));
if(func_15(iParam5, 2))if(!func_462(&(uParam1->f_4))) func_486(&(uParam1->f_4));
*uParam1=2;
break;
case 2:
...
if(!func_15(iParam5, 1)) PAD::ENABLE_ALL_CONTROL_ACTIONS(PLAYER_CONTROL);
func_4(&(uParam1->f_10));
*uParam1=3;
return false;
...
if(func_15(iParam5, 64) && uParam1->f_138) CAM::DO_SCREEN_FADE_OUT(500);
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(controlInstructionalButtonsString)) func_9(controlInstructionalButtonsString);
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_2[i /*15*/])) func_14(uParam0->f_2[i /*15*/]);
if(MISC::IS_PC_VERSION()){
...
value2=bParam4 ? func_15(uParam0->f_1, 32) ? 1f :
0f :
-1f;
...
var func__8(BOOL bParam0, var uParam1, var uParam2) // Position - 0x330E{
...
if(!func_462(&(uParam0->f_2))) func_371(&(uParam0->f_2));
...
uParam0->f_1=0;
uParam0->f_123=0;
if(bParam1) func_7(&(uParam0->f_1), 32);
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0)){
func_7(&(uParam0->f_1), 1);
if(bParam2) GRAPHICS::SET_SCALEFORM_MOVIE_TO_USE_SYSTEM_TIME(*uParam0, true);
}
if(MISC::IS_PC_VERSION())if(bParam3) func_7(&(uParam0->f_1), 4096);
if(bParam4) func_7(&(uParam0->f_1), 8192);
return;
}
...
break;
case 1:
if(func_24() || CAM::IS_SCREEN_FADED_OUT()) *uParam0=2;
...
elseif(!uParam0->f_5) func_17(false);
...
if(func_31()) return;
if(Global_20584)if(func_30()) func_29(true, true);
else func_29(false, false);
if(Global_20383.f_1==10 || Global_20383.f_1==9) MISC::SET_BIT(&Global_8254, 16);
...
if(!func_462(piParam0)) func_486(piParam0);
else func_371(piParam0);
return;
}
...
if(func_39(character)) return func_38(character);
...
if(func_462(&(uParam0->f_1))) func_458(&(uParam0->f_1));
if(func_462(&(uParam0->f_4))) func_458(&(uParam0->f_4));
func_4(&(uParam0->f_10));
...
if(uParam0->f_56 > 0) uParam0->f_564=uParam0->f_564 + func_74(25f * 0.5f);
if(uParam0->f_549) uParam0->f_564=uParam0->f_564 + (func_74(30f) - func_74(2f));
}
flag=true;
while (flag){
func_45(1);
...
if(uParam0->f_566)if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL))if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam0->f_4))if(!uParam0->f_571) func_48(uParam0, !uParam0->f_569 && uParam0->f_56 > 0);
...
func_14(&(uParam0->f_5));
if(uParam0->f_560==4) func_72(&(uParam0->f_13));
else func_14(&(uParam0->f_13));
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_554))) num6=func_69(&(uParam0->f_550), &(uParam0->f_554));
else num6=func_70(&(uParam0->f_550));
...
if(uParam0->f_56 > 0) num=num + func_74(25f * 0.2f);
i=0;
for (i=0;
i < uParam0->f_56;
i=i + 1){
...
HUD::SET_TEXT_SCALE(1f, 0.4f);
if(MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_554))) func_53(&(uParam0->f_550), start2, num + func_74(2f * 2f), false, false, 0);
else func_52(&(uParam0->f_550), &(uParam0->f_554), start2, num + func_74(2f * 2f), false, 0);
HUD::SET_TEXT_WRAP(start2, end2);
...
if(NETWORK::NETWORK_CLAN_GET_EMBLEM_TXD_NAME(&netHandle, &txdName)) return func_59(&txdName);
}else{
...
i <=9;
i=i + 1){
if(num==-1)if(func_68(7, i)==false) num=i;
}
if(num > -1){
...
if(!func_263(uParam1, 6))if(func_181(&(uParam1->f_26), false, 0)) func_221(uParam1, 6, true);
else return 2;
if(func_263(uParam1, 27) && PLAYER::IS_PLAYER_ONLINE()){
if(!func_263(uParam1, 26)) func_214(uParam1, false, INPUT_FRONTEND_ENDSCREEN_ACCEPT, "BJ_CONTINUE", INPUT_FRONTEND_ENDSCREEN_EXPAND, "BJ_RETRY", 363, 0, 363, 0);
...
func_95(uParam1);
}elseif(func_81(&iLocal_581, false)){
iLocal_581=0;
*uParam9=0;
...
*uParam9=0;
func_214(uParam1, false, INPUT_FRONTEND_ENDSCREEN_ACCEPT, "BJ_CONTINUE", INPUT_FRONTEND_ENDSCREEN_EXPAND, "BJ_RETRY", INPUT_FRONTEND_LEADERBOARD, "HUD_INPUT68" /*Online Leaderboard*/, 363, 0);
}}elseif(func_328(uParam3, 5, 1000)){
func_76(&(uParam1->f_26));
return 1;
}elseif(func_328(uParam3, 4, 1000)){
return 0;
}elseif(!*uParam9 && func_328(uParam3, 8, 1000) && !PLAYER::IS_PLAYER_ONLINE() || func_263(uParam1, 26)){
*uParam9=1;
if(PLAYER::IS_PLAYER_ONLINE()){
...
if(func_92())if(NETWORK::NETWORK_IS_NP_AVAILABLE()==false) npUnavailableReason=NETWORK::NETWORK_GET_NP_UNAVAILABLE_REASON();
...
elseif(!func_90()) HUD::SET_WARNING_MESSAGE_WITH_HEADER("PM_INF_QMFT" /*Alert*/, "SCLB_NO_ROS" /*The Rockstar game services are unavailable right now. Please try again later.*/, instructionalKey, 0, false, -1, 0, 0, true, 0);
...
float value;
int j;
if(!func_98(uParam0)) return;
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(*uParam0, 255, 255, 255, 0, 0);
if(PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL)){
for (i=0;
i < uParam0->f_3;
i=i + 1){
if(uParam0->f_3[i] !=363) uParam0->f_12[i]=PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(FRONTEND_CONTROL, uParam0->f_3[i], true);
}
...
func_176(1);
func_175(1);
if(!func_172())if(!AUDIO::IS_AUDIO_SCENE_ACTIVE("LEADERBOARD_SCENE")) AUDIO::START_AUDIO_SCENE("LEADERBOARD_SCENE");
...
if(Global_2097536.f_2780.f_26 > 0) func_168(*uParam0, &(Global_2097536.f_2780.f_1), &unk5, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, Global_2097536.f_2780.f_26);
else func_168(*uParam0, &(Global_2097536.f_2780.f_1), &unk5, &(Global_2097536.f_2780.f_9), Global_2097536.f_2780.f_25, -1);
}else{
...
if(Global_2097536.f_2704[2] < 2 && Global_2097536.f_2775[2]==-1 && !(Global_2097536.f_2704[2] > 0 && Global_2097536.f_2780.f_27 && func_169(uParam1->f_44) && Global_2097536.f_2775[2] !=-1)) flag3=true;
if(flag3) func_166(*uParam0, &num, address, true, false);
else func_166(*uParam0, &num, address, false, false);
unk23[2]=1;
}}
...
if(flag2) func_109(Global_2097536.f_2780, j, Global_2101867[i /*100*/].f_67[j], false, Global_2101867[i /*100*/].f_58);
else func_109(Global_2097536.f_2780, j, Global_2101867[i /*100*/].f_67[j], Global_2101867[i /*100*/].f_74, Global_2101867[i /*100*/].f_58);
}
else{
if(IS_BIT_SET(Global_2097536.f_2768, j))if(Global_2097536.f_2761[j]==Global_2101867[i /*100*/].f_67[j]) flag2=true;
if(flag2) func_106(Global_2097536.f_2780, j, Global_2101867[i /*100*/].f_60[j], false);
else func_106(Global_2097536.f_2780, j, Global_2101867[i /*100*/].f_60[j], Global_2101867[i /*100*/].f_74);
}
}
func_105();
...
if(!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL)) func_103(&unk2, &num4, &unk3, &unk4, false);
...
flag=true;
}}elseif(func_102(uParam1, INPUT_FRONTEND_UP)){
...
_STOPWATCH_DESTROY(&(uParam1->f_246.f_3));
flag=true;
}}elseif(func_102(uParam1, INPUT_FRONTEND_DOWN)){
...
_STOPWATCH_DESTROY(&(uParam1->f_246.f_3));
flag=true;
}}elseif(func_102(uParam1, INPUT_FRONTEND_Y)){
...
if(!MISC::SHOULD_USE_METRIC_MEASUREMENTS())if(uParam0.f_29[iParam43]==19 || uParam0.f_29[iParam43]==20) fParam44=func_108(fParam44);
else fParam44=func_107(fParam44);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER" /*~1~*/);
HUD::ADD_TEXT_COMPONENT_FLOAT(fParam44, 2);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}else{
...
if(!MISC::SHOULD_USE_METRIC_MEASUREMENTS())if(uParam0.f_29[iParam43]==15 || uParam0.f_29[iParam43]==16) hParam44=SYSTEM::FLOOR(func_108(SYSTEM::TO_FLOAT(hParam44)));
else hParam44=SYSTEM::FLOOR(func_107(SYSTEM::TO_FLOAT(hParam44)));
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER" /*~1~*/);
HUD::ADD_TEXT_COMPONENT_INTEGER(hParam44);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}else{
...
break;
default:
if(func_116(iParam0, &unk) !=-1)if(bParam1) return func_115(&(unk.f_31));
else return func_115(&(unk.f_7));
break;
}
...
if(func_119(&(uParam0->[i /*100*/].f_32), &unk)) Global_2097536.f_2775[num - 1]=0;
}
for (j=0;
...
if(!func_162(uParam0)) return false;
if(!func_160(uParam0)) return false;
if(!func_146(uParam0)) return false;
...
if(Global_2100721.f_81[num] !=0) func_131(-1, num);
for (i=0;
i < 12;
i=i + 1){
func_124(&Global_2101737);
...
break;
case 1:
if(func_134(&(uParam0->[1 /*100*/].f_76), &(Global_2103169.f_206), &Global_2103169, &(Global_2103169.f_157))) uParam0->[0 /*100*/].f_76=2;
break;
case 2:
...
i < *iParam1;
i=i + 1){
if(NETWORK::NETWORK_GET_PRIMARY_CLAN_DATA_NEW(&panParam2->[i /*13*/], &unk)) func_135(&unk, &uParam3->[i /*4*/]);
}
...
if(MISC::IS_PC_VERSION()){
return true;
}elseif(func_137() || func_92()){
if(!func_142(uParam0)) return false;
}else{
for (i=0;
i < 12;
i=i + 1){
if(!func_141(&(uParam0->[i /*100*/].f_78), &(uParam0->[i /*100*/].f_32), &uParam0->[i /*100*/])) return false;
}}
return true;
}
...
int i;
int num;
if(!func_137() && !func_92()) return true;
...
i < 12;
i=i + 1){
if(!func_145(&(uParam0->[i /*100*/].f_77), &(uParam0->[i /*100*/].f_16), &(uParam0->[i /*100*/].f_84), &(Global_2097536.f_2833), &(uParam0->[i /*100*/].f_79))) return false;
}}else{
for (i=0;
i < 12;
i=i + 1){
if(!func_144(&(uParam0->[i /*100*/].f_77), uParam0->[i /*100*/].f_16, &(uParam0->[i /*100*/].f_84))) return false;
}}
return true;
}
...
if(Global_2097157.f_374 < 0)if(func_119(&unk, &gamerHandle) || func_119(&unk, &(Global_2097157.f_361))) Global_2097157.f_374=unk.f_96;
...
if(func_169(uParam0->f_44)) TEXT_LABEL_COPY(&(Global_2097536[offset /*901*/][Global_2097536.f_2704[offset] /*75*/].f_16),{
...
if(func_119(&unk, &gamerHandle))if(Global_2097536.f_2775[offset] < 0) Global_2097536.f_2775[offset]=Global_2097536.f_2704[offset];
TEXT_LABEL_COPY(&Global_2097536[offset /*901*/][Global_2097536.f_2704[offset] /*75*/],{
unk.f_13 
}
, 16);
...
if(Global_2097536.f_2704[offset] >=1) func_155(uParam0, &Global_2097536[offset /*901*/][Global_2097536.f_2704[offset] /*75*/], Global_2097536[offset /*901*/][Global_2097536.f_2704[offset] - 1 /*75*/].f_59 + 1);
else func_155(uParam0, &Global_2097536[offset /*901*/][Global_2097536.f_2704[offset] /*75*/], 1);
Global_2097536.f_2775[offset]=Global_2097536.f_2704[offset];
Global_2097536.f_2704[offset]=Global_2097536.f_2704[offset] + 1;
}
uParam0->[offset]=3;
...
if(func_169(uParam0->f_44)) TEXT_LABEL_COPY(&(Global_2097536[offset /*901*/][0 /*75*/].f_16),{
unk.f_19.f_1[1 /*16*/].f_8 
}
, 16);
...
if(HUD::IS_PAUSE_MENU_ACTIVE() && !func_172()) return true;
return false;
}
...
*uParam1=0;
*uParam0=3;
}}elseif(unk_0x76ED2E1021938190(uParam2, unk2, iParam3)){
*uParam0=*uParam0 + 1;
}else{
*uParam1=0;
*uParam0=3;
...
if(func_169(uParam0->f_44))if(Global_2097157.f_374 < 0)if(func_119(&unk, &(Global_2097157.f_361))) Global_2097157.f_374=unk.f_96;
...
if(func_169(uParam0->f_44)) TEXT_LABEL_COPY(&(Global_2097536[1 /*901*/][Global_2097536.f_2704[num3] /*75*/].f_16),{
unk.f_19.f_1[1 /*16*/].f_8 
}
, 16);
...
if(Global_2097536.f_2704[num3] >=1) func_155(uParam0, &Global_2097536[num3 /*901*/][Global_2097536.f_2704[num3] /*75*/], Global_2097536[num3 /*901*/][Global_2097536.f_2704[num3] - 1 /*75*/].f_59 + 1);
else func_155(uParam0, &Global_2097536[num3 /*901*/][Global_2097536.f_2704[num3] /*75*/], 1);
...
if(func_119(&unk, &unk107))if(Global_2097536.f_2775[1] < 0) Global_2097536.f_2775[1]=Global_2097536.f_2704[1];
...
if(func_169(uParam0->f_44)) TEXT_LABEL_COPY(&(Global_2097536[1 /*901*/][Global_2097536.f_2704[1] /*75*/].f_16),{
unk.f_19.f_1[1 /*16*/].f_8 
}
, 16);
for (i=0;
...
if(func_163(uParam0->f_44))if(!Global_2097533) Global_2097533=true;
...
if(Global_2097157.f_374 < 0)if(func_119(&unk14, &unk) || func_119(&unk14, &(Global_2097157.f_361))) Global_2097157.f_374=unk14.f_96;
if(num < 0)if(IS_BIT_SET(Global_2097157.f_142.f_2, 0))if(Global_2097157.f_211.f_36[0] >=STATS::LEADERBOARDS2_READ_GET_ROW_DATA_INT(k, 0)) num=k;
elseif(Global_2097157.f_211.f_3[0] >=STATS::LEADERBOARDS2_READ_GET_ROW_DATA_FLOAT(k, 0)) num=k;
func_156(&unk14);
}
...
if(func_119(&unk14, &unk))if(Global_2097536.f_2775[offset] < 0) Global_2097536.f_2775[offset]=Global_2097536.f_2704[offset];
TEXT_LABEL_COPY(&Global_2097536[offset /*901*/][Global_2097536.f_2704[offset] /*75*/],{
unk14.f_13 
}
, 16);
...
if(uParam0->f_566)if(uParam0->f_571) func_182(uParam0);
elseif(uParam0->f_56 !=0) func_48(uParam0, true);
else func_48(uParam0, false);
Global_78820=1;
return true;
}
...
*uParam5=0;
if(iParam3 > 1)if(iParam2==iParam3) num=SYSTEM::CEIL(100f * fParam6);
...
if(iParam3 > 1){
if(num > 0) func_186(&(uParam0->f_26), 3, "BJ_SC_ALLG_RWD", "", num, 0, 2, 0);
else func_186(&(uParam0->f_26), 3, "BJ_SC_ALLG_RWD", "", 0, 0, 1, 0);
func_186(&(uParam0->f_26), 2, "BJ_SC_GATES", "", iParam2, iParam3, 0, 0);
}
func_186(&(uParam0->f_26), 11, "BJ_SC_LAND_ACC", "", iParam4, 0, 0, 0);
if(iParam3 > 1) func_186(&(uParam0->f_26), 3, "BJ_SC_GATE_RWD", "", num4, 0, 0, 0);
...
any.f_3=32;
any.f_36=32;
if(func_169(uParam0->f_44)) unk175={
Global_2097157.f_361 
};
else unk175={
GET_GAMER_HANDLE_PLAYER(PLAYER::PLAYER_ID()) 
...
i=i + 1){
if(!func_197(uParam0->f_44, i))if(func_196(uParam0->f_44, 4, i)) MISC::SET_BIT(&(Global_2097157.f_142.f_2), i);
...
func_195();
if(Global_2097157.f_4)if(func_194(uParam0->f_44)) Global_2097157=3;
...
if(iParam1==100) func_200(274, 98, 1, 0f, false);
else func_200(274, 98, 0, 0f, false);
...
case 2:
if(iParam4==0){
if(iParam5 > 0 && !func_212()) uParam0->f_44=826;
...
if(iParam5 > 0 && !func_212()) uParam0->f_44=827;
...
if(iParam5 > 0 && !func_212()) uParam0->f_44=828;
...
if(iParam5 > 0 && !func_212()) uParam0->f_44=928;
...
if(iParam5 > 0 && !func_212()) uParam0->f_44=998 + (iParam5 - 1);
...
Global_2097536.f_2780.f_29[1]=5;
Global_2097536.f_2780.f_29[2]=5;
}elseif(func_206(*Global_4718592.f_166301)){
TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[0 /*6*/], "SCLB_C_SCORE" /*SCORE*/, 24);
TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[1 /*6*/], "SCLB_C_DEATH" /*DEATHS*/, 24);
TEXT_LABEL_ASSIGN_STRING(&Global_2097536.f_2717[2 /*6*/], "SCLB_C_RANK" /*POSITION*/, 24);
Global_2097536.f_2710[0]=0;
...
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0)) func_21(&(uParam0->f_1), 1);
return;
}


var func__215(BOOL bParam0, var uParam1, var uParam2) // Position - 0x15057{
if(bParam0) return uParam1;
return uParam2;
}
...
if(bParam2) MISC::SET_BIT(&(uParam0->f_607), iParam1);
else MISC::CLEAR_BIT(&(uParam0->f_607), iParam1);
return;
}

int func_222(var uParam0, int iParam1, var uParam2, var uParam3, float fParam4) // Position - 0x15319{
int num;
if(iParam1 > 1 && *uParam0==iParam1 - 1) num=100;
else num=0;
*uParam3=0;
...
int outValue;
Hash statHash;
if(func_256(echParam0)==3) return;
if(func_256(echParam0)==4) return;
...
func_226(iParam0);
if(Global_43257==15) func_225(false);
return 1;
}
...
}}elseif(IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_229() /*5568*/].f_681.f_10, iParam0)){
flag=true;
MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
int cloudTimeAsInt6;
int num6;
if(iParam0==8) return func_237(129, -1);
if(iParam0==9) return func_237(135, -1);
if(iParam0==10) return func_237(136, -1);
if(iParam0==11) return func_237(137, -1);
if(iParam0==12){
...
if(func_252(14) && !func_251(iParam0)) return 0;
...
if(func_248(&Global_4542597, iParam0)) return 0;
if(func_241(&Global_4542597, iParam0)) return 1;
}else{
...
if(func_252(14) && !func_251(iParam1)) return false;
if(func_248(uParam0, iParam1)) return false;
if(func_247(uParam0) < 0f) func_246(uParam0, 0);
func_244(&unk);
i=0;
for (i=0;
i < *uParam0 - 1;
...
if(func_252(14) && !func_251(iParam1)) return 0;
if(func_248(uParam0, iParam1)) return 0;
if(func_247(uParam0) < 0f) func_246(uParam0, 0);
for (i=0;
i < *uParam0;
i=i + 1){
...
if(value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(Global_113648.f_10196.f_3853)) func_253(13, SYSTEM::FLOOR(Global_113648.f_10196.f_3853));
if(!DATAFILE::DATAFILE_IS_SAVE_PENDING()){
if(!Global_78558){
if(func_259()==2==false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(NETWORK::NETWORK_IS_CLOUD_AVAILABLE()) Global_113382=0;
if(!Global_63362) func_219();
}}}
return;
}
...
entityCoords3={
ENTITY::GET_ENTITY_COORDS(trailer2, true) 
};
}
return;
}
...
if(PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), trainCarriage)) return true;
}}}
if(ENTITY::DOES_ENTITY_EXIST(veParam0)){
VEHICLE::GET_VEHICLE_TRAILER_VEHICLE(veParam0, &trailer);
if(PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), veParam0) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), veParam0) || ENTITY::DOES_ENTITY_EXIST(pedParam1) && !ENTITY::IS_ENTITY_DEAD(pedParam1, false) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam1))if(entityCoords.f_2 < entityCoords2.f_2) return true;
}
...
return true;
}elseif(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), trailer)){
offsetFromEntityGivenWorldCoords={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(trailer, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) 
};
offsetFromEntityGivenWorldCoords=func_267(MISC::ABSF(offsetFromEntityGivenWorldCoords) - 1.305f, 0f);
if(offsetFromEntityGivenWorldCoords.f_1 >=0f) offsetFromEntityGivenWorldCoords.f_1=func_267(offsetFromEntityGivenWorldCoords.f_1 - 5.98f, 0f);
else offsetFromEntityGivenWorldCoords.f_1=func_267(-offsetFromEntityGivenWorldCoords.f_1 - 6.21f, 0f);
if(offsetFromEntityGivenWorldCoords.f_1==0f && offsetFromEntityGivenWorldCoords==0f) return true;
}}}}
return false;
}
...
if(fParam0 > fParam1) return fParam0;
return fParam1;
}
...
if(iParam3 > 1) _SHOW_SUBTITLE_CLEAR_EXISTING("BJ_MG_MTOBJ", 7500, 1);
elseif(hash !=0)if(func_367(hash)) _SHOW_SUBTITLE_CLEAR_EXISTING("BJ_MG_TRAIN", 7500, 1);
else _SHOW_SUBTITLE_CLEAR_EXISTING("BJ_MG_BOAT", 7500, 1);
else _SHOW_SUBTITLE_CLEAR_EXISTING("BJ_MG_STOBJ", 7500, 1);
...
}elseif(!func_263(uParam0, 2)){
if(PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID())==1 || PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID())==2){
HUD::SET_SCRIPT_VARIABLE_HUD_COLOUR(1);
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(PLAYER_CONTROL)) _DISPLAY_HELP_TEXT("BJ_PARAHLP_KM", 10000);
else _DISPLAY_HELP_TEXT("BJ_PARAHLP", 10000);
func_221(uParam0, 2, true);
}}elseif(!func_263(uParam0, 3)){
...
float speed;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(ENTITY::DOES_ENTITY_EXIST(ENTITY::GET_ENTITY_ATTACHED_TO(PLAYER::PLAYER_PED_ID()))) entitySpeedVector={
ENTITY::GET_ENTITY_SPEED_VECTOR(ENTITY::GET_ENTITY_ATTACHED_TO(PLAYER::PLAYER_PED_ID()), false) 
};
else entitySpeedVector={
ENTITY::GET_ENTITY_SPEED_VECTOR(PLAYER::PLAYER_PED_ID(), true) 
};
...
entityVelocity={
ENTITY::GET_ENTITY_VELOCITY(*uParam0) 
};
}
...
unk9={
entityCoords - entityCoords2 
};
unk9.f_2=0f;
num3=MISC::ABSF(func_275(unk9, forwardVector));
if(func_274(*uParam0)) num2=func_49(num - (num3 / num), 2f, 3f);
else num2=func_49(num + (num3 / num), 3f, 10f);
...
if(ENTITY::DOES_ENTITY_EXIST(*uParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, false) && entityVelocity.f_1 > 2f && entityVelocity.f_1 < VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(*uParam0)) TASK::SET_DRIVE_TASK_MAX_CRUISE_SPEED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam0, -1, false), speed);
return;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false)) ENTITY::GET_ENTITY_MATRIX(veParam0, &forwardVector, &rightVector, &rightVector, &position);
unk7={
...
Vector3 func__277(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1762E{
var groundZ;
vParam1.f_2=vParam1.f_2 + 0.15f;
if(MISC::GET_GROUND_Z_FOR_3D_COORD(vParam1, &groundZ, false, false)) vParam1.f_2=groundZ;
if(func_278(pedParam0)) ENTITY::SET_ENTITY_COORDS(pedParam0, vParam1, true, false, false, true);
return vParam1;
}
...
sizeAndPeds=6;
if(!func_462(piParam0)) func_486(piParam0);
if(func_461(piParam0) < 1f) return;
...
num={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(uParam1->[i], true) 
};
num2=(num * num) + (num.f_1 * num.f_1);
if(num.f_2 * num.f_2 < 3f * num2) func_280(&uParam1->[i]);
}}}
if(pedNearbyPeds > 0){
for (i=0;
i < pedNearbyPeds;
...
num={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(sizeAndPeds[i], true) 
};
num2=(num * num) + (num.f_1 * num.f_1);
...
i < *uParam1;
i=i + 1){
if(ENTITY::DOES_ENTITY_EXIST(uParam1->[i]))if(eParam0==uParam1->[i]) return i;
}}
return -1;
}
...
*uParam30=0;
func_327(piParam2);
if(func_462(piParam24)) func_458(piParam24);
if(func_462(piParam23)) func_458(piParam23);
...
if(ENTITY::DOES_ENTITY_EXIST(*pveParam8)) VEHICLE::DELETE_VEHICLE(pveParam8);
...
if(!ENTITY::IS_ENTITY_DEAD(*ppedParam4, false)) ENTITY::SET_PED_AS_NO_LONGER_NEEDED(ppedParam4);
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(vehiclePedIsUsing, true) +{
0f, 0f, 2f 
}
...
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(vehiclePedIsUsing)) ENTITY::SET_ENTITY_AS_MISSION_ENTITY(vehiclePedIsUsing, true, false);
...
if(HUD::DOES_BLIP_EXIST(blParam13)) HUD::REMOVE_BLIP(&blParam13);
if(HUD::DOES_BLIP_EXIST(blParam14)) HUD::REMOVE_BLIP(&blParam14);
for (j=0;
j < *uParam10;
j=j + 1){
...
Vehicle vehicle;
if(iParam0==-1) return;
if(!func_307(&Global_77348.f_555[0 /*21*/], iParam0)) return;
...
if(iParam0==24) Global_113648.f_32751.f_4801=func_520();
if(veParam1 !=Global_77348.f_139[iParam0]){
if(iParam0==24){
vehicle=func_306(iParam0);
if(ENTITY::DOES_ENTITY_EXIST(vehicle) && VEHICLE::IS_VEHICLE_DRIVEABLE(vehicle, false) && veParam1 !=vehicle) func_288(vehicle, _CHAR_NULL);
}
...
if(!func_291(hParam0, false, -1)) return false;
...
if(hParam0==joaat("blimp"))if(!func_298() && !func_297() && !func_296() && !func_295() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED()) return false;
if(hParam0==joaat("hotknife") || hParam0==joaat("carbonrs") || hParam0==joaat("khamelion")){
if(func_137() || MISC::IS_PC_VERSION() || func_92()){
}elseif(!func_296()){
return false;
}}
if(bParam1)if(!func_294(hParam0, iParam2)) return false;
if(!func_292(hParam0)) return false;
return true;
}
...
if(!func_291(entityModel, false, -1)) return true;
return false;
}
...
for (i=0;
func_305(iParam1, i, &garageName, &num);
i=i + 1){
...
if(!func_317(Global_113648.f_32751.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false)) *uParam0={
...
if(IS_BIT_SET(Global_77348.f_555[0 /*21*/].f_9, 13)) func_311(iParam0, false);
}
return;
}
...
if(uParam1->f_65==-1 && !func_321(uParam1->f_66)) uParam1->f_65=0;
...
i <=11;
i=i + 1){
if(VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1)) MISC::SET_BIT(&(uParam1->f_77), func_319(i + 1));
}
...
Vector3 func__325(int iParam0) // Position - 0x1E489{
switch (iParam0){
case 0:
...
if(MISC::GET_GAME_TIMER() - uParam0->f_5 > iParam2) uParam0->f_4=MISC::GET_GAME_TIMER();
...
offsetFromEntityInWorldCoords={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, 2f, -0.3f, -7.7824f) 
};
CAM::SET_CAM_COORD(cam2, offsetFromEntityInWorldCoords);
camRot={
CAM::GET_CAM_ROT(cam, 2) 
};
camRot=0f;
...
if(MISC::IS_PC_VERSION()) return 0.5f;
return 0.84f;
}
...
if(PAD::IS_LOOK_INVERTED()) num.f_1=num.f_1 * -1f;
if(!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL)){
uParam5->f_2=uParam5->f_2 - (num * MISC::GET_FRAME_TIME() * 100f);
*uParam5=*uParam5 + (num.f_1 * MISC::GET_FRAME_TIME() * 100f);
if(MISC::ABSF(uParam5->f_2) > 0.001f) uParam5->f_2=uParam5->f_2 - (uParam5->f_2 * MISC::GET_FRAME_TIME() * 4f);
else uParam5->f_2=0f;
if(MISC::ABSF(*uParam5) > 0.001f) *uParam5=*uParam5 - (*uParam5 * MISC::GET_FRAME_TIME() * 5f);
else *uParam5=0f;
}else{
...
uParam5->f_2=0f;
}elseif(uParam4->f_2 < -0.5f * 43.7465f){
uParam4->f_2=-0.5f * 43.7465f;
uParam5->f_2=0f;
}
...
*uParam4=0.5f * 21.6f;
*uParam5=0f;
}elseif(*uParam4 < -0.5f * 21.6f){
*uParam4=-0.5f * 21.6f;
*uParam5=0f;
}
unk3={
func_463(uParam9, uParam4->f_2) 
};
...
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) func_334("BJ_VLOOKHLP");
...
Vector3 func__335(var uParam0) // Position - 0x1EB66{
...
if(!ENTITY::IS_ENTITY_DEAD(veParam0, false)) ENTITY::SET_ENTITY_COORDS(veParam0, uParam1 +{
num3, num2, num 
}
, true, false, false, true);
return;
...
}}elseif(AUDIO::IS_AUDIO_SCENE_ACTIVE("BASEJUMPS_PREP_FOR_JUMP_MOTO")){
...
if(!func_462(piParam0)) func_42(piParam0, fParam1);
return;
}
...
if(func_462(piParam0))if(func_461(piParam0) > fParam1) return true;
return false;
}
...
if(*phParam0 !=0 && *phParam0 !=joaat("WEAPON_UNARMED") && *phParam0 !=joaat("WEAPON_ELECTRIC_FENCE") && *phParam0 !=joaat("GADGET_PARACHUTE") && *phParam0 !=joaat("OBJECT")) WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), -1, false, true);
PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_SELECT_WEAPON, true);
...
var screenY;
vector={
func_369(uParam0, *uParam6) 
};
flag=*uParam6==iParam9 - 1;
uParam3->[0]=uParam3->[0];
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) ENTITY::GET_ENTITY_MATRIX(PLAYER::PLAYER_PED_ID(), &forwardVector, &rightVector, &upVector, &position);
if(flag){
if(ENTITY::DOES_ENTITY_EXIST(veParam1) && !ENTITY::IS_ENTITY_DEAD(veParam1, false)){
offsetFromEntityInWorldCoords={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam1, func_370(uParam0)) 
};
...
}elseif(_STOPWATCH_IS_INITIALIZED_0(uParam0) !=0){
offsetFromEntityInWorldCoords={
func_369(uParam0, 0) 
};
vector={
...
if(*uParam6 < iParam9 - 2) *uParam5=GRAPHICS::CREATE_CHECKPOINT(17, vector2, func_369(uParam0, *uParam6 + 2), 9f * 0.5f, r, g, b, func_357(offsetFromEntityInWorldCoords, 25, SYSTEM::CEIL(200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170)))), 0);
*uParam7=*uParam6;
}
...
if(*uParam4 !=0) GRAPHICS::SET_CHECKPOINT_RGBA(*uParam4, r, g, b, func_357(vector, 25, SYSTEM::CEIL(200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170)))));
if(*uParam5 !=0) GRAPHICS::SET_CHECKPOINT_RGBA(*uParam5, r, g, b, func_357(vector2, 25, SYSTEM::CEIL(200f * (SYSTEM::TO_FLOAT(113) / SYSTEM::TO_FLOAT(170)))));
}
if(!bParam19) return 0;
...
if(func_462(&uLocal_584)) func_458(&uLocal_584);
}elseif(func_462(&uLocal_584)){
...
if(HUD::DOES_BLIP_EXIST(*pblParam11)) HUD::REMOVE_BLIP(pblParam11);
if(HUD::DOES_BLIP_EXIST(*pblParam12)) HUD::REMOVE_BLIP(pblParam12);
if(!flag) return 2;
num2=SYSTEM::SQRT((num * num) + (num.f_1 * num.f_1));
...
if(PLAYER::GET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID())) PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), false);
}elseif(!flag){
value=SYSTEM::VMAG2(num);
if(value < 22f * 22f){
if(value < 10f * 10f) flag2=true;
elseif(func_275(forwardVector, -num / F2V(SYSTEM::SQRT(value))) < 0.08f) flag2=true;
if(flag2){
*uParam8=*uParam8 + 1;
...
if(!flag2 && !bLocal_583) bLocal_583=true;
}elseif(PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID())==0 || PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID())==-1){
if(num.f_2 < -22f){
...
*pblParam12=0;
HUD::SET_BLIP_SCALE(*pblParam11, 1.2f);
if(*uParam6 >=iParam9 - 1) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*pblParam11, "BJ_BLIP_TGT");
else HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*pblParam11, "BJ_BLIP_CHK");
}
...
if(*uParam6 + 1 >=iParam9 - 1) HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*pblParam12, "BJ_BLIP_TGT");
else HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*pblParam12, "BJ_BLIP_CHK");
}}else{
*pblParam12=0;
}
...
if(PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) && PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID())==3 || PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID())==-1 && ENTITY::GET_ENTITY_HEIGHT_ABOVE_GROUND(PLAYER::PLAYER_PED_ID()) > 50f && !PLAYER::GET_PLAYER_HAS_RESERVE_PARACHUTE(PLAYER::PLAYER_ID())) return true;
return false;
}
BOOL func_352(var uParam0, var uParam1, var uParam2) // Position - 0x1F80F{
Ped ped;
int pedParachuteLandingType;
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) return true;
ped=PLAYER::PLAYER_PED_ID();
if(!*uParam1){
pedParachuteLandingType=PED::GET_PED_PARACHUTE_LANDING_TYPE(ped);
...
if(func_462(piParam0))if(func_354(piParam0)) return piParam0->f_2;
else return func_43(IS_BIT_SET(*piParam0, 4)) - piParam0->f_1;
return 0f;
}
...
if(screenX2 >=0.7999f) heading=90f;
elseif(screenX2 <=0.2f) heading=-90f;
elseif(screenY2 <=0.2f) heading=0f;
elseif(screenY2 >=0.7999f) heading=180f;
...
if(heading !=*uParam5 || *uParam3==0f && *uParam4==0f || MISC::ABSF(screenX2 - *uParam3) < 0.04f && MISC::ABSF(screenY2 - *uParam4) < 0.04f) GRAPHICS::DRAW_SPRITE("basejumping", "Arrow_Pointer", screenX2, screenY2, width, height, heading, 240, 200, 80, 170, false, 0);
*uParam5=heading;
}
*uParam3=screenX2;
*uParam4=screenY2;
...
float screenY;
float num;
if(!func_317(vParam0, 0f, 0f, 0f, false)) HUD::GET_HUD_SCREEN_POSITION_FROM_WORLD_POSITION(vParam0, &screenX, &screenY);
if(screenX >=0.5f) num=screenX - 0.5f;
else num=0.5f - screenX;
if(screenY >=0.5f) num.f_1=screenY - 0.5f;
else num.f_1=0.5f - screenY;
num.f_2=0f;
func_475(num);
num=num * 0.75f;
num.f_1=num.f_1 * 0.75f;
if(screenX >=0.5f) screenX=0.5f + num;
else screenX=0.5f - num;
if(screenY >=0.5f) screenY=0.5f + num.f_1;
else screenY=0.5f - num.f_1;
*uParam3=screenX;
*uParam4=screenY;
return;
}
...
if(func_462(piParam0) && func_461(piParam0) > 7.5f) func_458(piParam0);
return;
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)){
vehiclePedIsIn=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), true);
if(ENTITY::IS_ENTITY_IN_AIR(vehiclePedIsIn)) return false;
elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(vehiclePedIsIn, true), &groundZ, false, false)) return false;
elseif(entityCoords.f_2 >=groundZ + 1.5f) return false;
}
if(ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) return false;
elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(entityCoords, &groundZ, false, false)) return false;
elseif(entityCoords.f_2 >=groundZ + 1.5f) return false;
unk3={
func_369(uParam0, 0) 
};
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, false)) return;
entityCoords={
ENTITY::GET_ENTITY_COORDS(*uParam0, true) 
};
...
TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
if(!bParam1) TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, *uParam0, ENTITY::GET_ENTITY_COORDS(*uParam0, true), 4, 0f, 786469, 2f, 0f, true);
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, *uParam0, entityCoords + ({
5f, 5f, 5f 
}
* ENTITY::GET_ENTITY_FORWARD_VECTOR(*uParam0)) +{
20f, 0f, 0f 
}
, 4, 0.3f * vehicleEstimatedMaxSpeed, 786469, 5f, 10f, true);
unk3={
{
1000f, 1000f, 1000f 
}
...
Vector3 func__369(var uParam0, int iParam1) // Position - 0x1FFDC{
if(iParam1 < 0 || iParam1 >=12) return 0f, 0f, 0f;
return uParam0->f_12[iParam1 /*3*/];
}


Vector3 func__370(var uParam0) // Position - 0x20008{
return uParam0->f_6;
}
...
if(CAM::IS_CAM_INTERPOLATING(func_433(uParam3, 1))) func_371(piParam5);
if(!*uParam10){
if(func_462(piParam7) && func_461(piParam7) >=func_400(uParam0)){
func_362(uParam2, false);
func_458(piParam7);
*uParam10=1;
}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam2, false)){
...
func_486(piParam6);
}elseif(bParam12 && CAM::IS_SCREEN_FADED_IN() || func_461(piParam6) > 0.5f && func_333(uParam4, 2)){
*uParam11=1;
func_458(piParam5);
func_458(piParam6);
return true;
...
func_458(piParam8);
}elseif(func_461(piParam8) > func_426(iParam1, iParam9)){
switch (iParam9){
case 0:
...
if(CAM::IS_SCREEN_FADED_IN()) func_380();
else func_371(piParam6);
return false;
}
...
if(!func_395(0, uParam0)) Global_78815=MISC::GET_GAME_TIMER() - 9000;
HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_AREA_NAME);
HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_VEHICLE_NAME);
HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_VEHICLE_CLASS);
HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_STREET_NAME);
...
text={
func_384(Global_78814, Global_78816, iParam10) 
};
y==-0.014f;
...
if(!func_397(0) || Global_78828 || Global_78817==1 || !CAM::IS_SCREEN_FADED_IN()) return false;
switch (Global_78813){
case 0:
...
if(func_405(PLAYER::PLAYER_ID())) return false;
...
*{
0f, -SYSTEM::COS(-97.4239f + func_464(uParam1)), SYSTEM::SIN(-97.4239f + func_464(uParam1)) 
}};
*uParam3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam5, 1.12046f, -0.317773f, 1.3385f) 
};
unk={
func_463(*uParam4, uParam2->f_2) 
};
vector2={
*uParam3 + unk 
};
*uParam6={
-33f + *uParam2, 0f, -88.515f + func_464(uParam1) 
};
*uParam7=26f;
vector={
*uParam6 
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS())if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_422(PLAYER::PLAYER_ID()) && !_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0) && !func_419() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
elseif(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_422(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5) ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
Global_78556=0;
}
return;
}
...
BOOL flag;
if(player==PLAYER::PLAYER_ID()) flag=func_421(-1, false)==8;
...
if(func_423())if(plParam0==PLAYER::PLAYER_ID()) return true;
...
if(Global_113648.f_2365.f_539.f_4321 !=character && func_39(Global_113648.f_2365.f_539.f_4321)) Global_113648.f_2365.f_539.f_4322=Global_113648.f_2365.f_539.f_4321;
...
Vector3 func__432(int iParam0) // Position - 0x21F2B{
switch (iParam0){
case 5:
...
}elseif(func_449(PLAYER::PLAYER_PED_ID(), *pveParam3)==1){
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), *pveParam3, 2);
}}
...
func_450(uParam1, PLAYER::PLAYER_PED_ID(), func_452());
if(func_378(uParam0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_ON_VEHICLE(PLAYER::PLAYER_PED_ID())) PED::SPECIAL_FUNCTION_DO_NOT_USE(PLAYER::PLAYER_PED_ID(), true);
...
for (j=-1;
j <=VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(*pveParam3) - 1;
j=j + 1){
...
if(func_531(uParam0) !=0) func_445(uParam0, uParam5, iParam13);
if(func_444(uParam0) !=0) func_441(uParam0, pveParam7);
...
if(ENTITY::DOES_ENTITY_EXIST(*pveParam4) && ENTITY::IS_ENTITY_DEAD(*pveParam4, false)) VEHICLE::DELETE_VEHICLE(pveParam4);
...
}elseif(func_438(_STOPWATCH_IS_INITIALIZED_0(uParam0))){
...
}elseif(!ENTITY::IS_ENTITY_DEAD(*pveParam4, false)){
...
if(func_439(_STOPWATCH_IS_INITIALIZED_0(uParam0))){
if(ENTITY::DOES_ENTITY_EXIST(*pveParam6) && ENTITY::IS_ENTITY_DEAD(*pveParam6, false)) VEHICLE::DELETE_VEHICLE(pveParam6);
...
}elseif(!ENTITY::IS_ENTITY_DEAD(*pveParam6, false)){
VEHICLE::SET_VEHICLE_FIXED(*pveParam6);
}
if(!VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(*pveParam4)) VEHICLE::ATTACH_VEHICLE_TO_TRAILER(*pveParam4, *pveParam6, 1065353216);
}
if(ENTITY::DOES_ENTITY_EXIST(*ppedParam9) && ENTITY::IS_ENTITY_DEAD(*ppedParam9, false)) PED::DELETE_PED(ppedParam9);
...
if(iParam13==0) _CONVERSATION_INITIALIZE_ACTOR(uParam1, 2, *ppedParam9, "EX3MERC1", 0, 1);
}else{
...
if(PED::IS_PED_IN_ANY_VEHICLE(*ppedParam9, true)) PED::SPECIAL_FUNCTION_DO_NOT_USE(*ppedParam9, true);
...
}elseif(ENTITY::IS_ENTITY_DEAD(*pveParam1, false)){
...
Vector3 func__443(var uParam0) // Position - 0x22D21{
return uParam0->f_9;
}
...
if(!func_326(*uParam1) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam1, -1, false))) pedInVehicleSeat=VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam1, -1, false);
vehicle=*uParam1;
}
...
if(!ENTITY::DOES_ENTITY_EXIST(pedInVehicleSeat)) pedInVehicleSeat=PED::CREATE_PED_INSIDE_VEHICLE(vehicle, PED_TYPE_MISSION, modelHash, -1, true, true);
...
ENTITY::FREEZE_ENTITY_POSITION(vehicle, true);
if(!ENTITY::DOES_ENTITY_EXIST(pedInVehicleSeat)) pedInVehicleSeat=PED::CREATE_PED_INSIDE_VEHICLE(vehicle, PED_TYPE_MISSION, joaat("S_M_Y_Pilot_01"), -1, true, true);
PED::SET_PED_HELMET(pedInVehicleSeat, false);
...
Vector3 func__447(var uParam0) // Position - 0x22EB4{
return uParam0->f_70;
}
...
int num;
num=func_451();
if(!PED::IS_PED_INJURED(pedParam1)) _CONVERSATION_INITIALIZE_ACTOR(uParam0, num, pedParam1, sParam2, 1, 1);
else _CONVERSATION_INITIALIZE_ACTOR(uParam0, num, 0, sParam2, 0, 1);
return;
}

int func_451() // Position - 0x22FEA{
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_FRANKLIN) return 2;
if(_GET_CURRENT_PLAYER_CHARACTER()==CHAR_TREVOR) return 3;
return 1;
}
...
Vector3 func__456(var uParam0) // Position - 0x2313D{
return uParam0->f_67;
}


Vector3 func__457(var uParam0) // Position - 0x2314B{
return uParam0->f_64;
}
...
var animDict;
if(!func_465(func_466(iParam3))) STREAMING::REQUEST_ADDITIONAL_COLLISION_AT_COORD(func_473(iParam3));
if(func_462(piParam1))if(func_461(piParam1) >=5f) return true;
else func_342(piParam1, 0f);
if(CAM::IS_SCREEN_FADED_OUT())if(!STREAMING::IS_NEW_LOAD_SCENE_LOADED()) return false;
if(func_465(func_466(iParam3)))if(!STREAMING::HAS_ANIM_DICT_LOADED("veh@helicopter@rps@base")) return false;
...
if(!STREAMING::HAS_ANIM_DICT_LOADED(&animDict)) return false;
}
if(func_460(uParam0))if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam2))if(HUD::HAS_ADDITIONAL_TEXT_LOADED(2))if(GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("basejumping"))if(STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@basejump@") && STREAMING::HAS_ANIM_DICT_LOADED("skydive@freefall") && STREAMING::HAS_ANIM_DICT_LOADED("skydive@parachute@chute") && STREAMING::HAS_ANIM_DICT_LOADED("skydive@parachute@"))if(PED::CAN_CREATE_RANDOM_PED(false))if(!bParam5 || CAM::IS_SCREEN_FADED_OUT()) return true;
return false;
}
...
Vector3 func__463(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x23336{
float num;
float num2;
float num3;
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) PED::SET_PED_LOD_MULTIPLIER(PLAYER::PLAYER_PED_ID(), 2f);
switch (iParam1){
case 0:
...
if(CAM::IS_SCREEN_FADED_OUT()) MISC::CLEAR_AREA(func_473(iParam1), 5000f, true, false, false, false);
...
if(func_448(iParam1) !=0) func_470(uParam2, func_448(iParam1));
else func_470(uParam2, joaat("S_M_Y_Pilot_01"));
}
...
if(func_444(uParam0) !=0) func_470(uParam2, func_444(uParam0));
*uParam5=func_171();
func_468(uParam2);
...
if(func_466(iParam1)==0) STREAMING::REQUEST_ADDITIONAL_COLLISION_AT_COORD(func_473(iParam1));
return;
}
...
i < *uParam0;
i=i + 1){
if(uParam0->[i] !=0)if(uParam0->[i]==hParam1) return 0;
}
...
Vector3 func__473(int iParam0) // Position - 0x237DB{
switch (iParam0){
case 0:
...
if(CAM::IS_SCREEN_FADED_OUT()){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_473(iParam0), 15f, 15f, 15f, false, true, 0)) return true;
...
Vector3 func__475(float fParam0, float fParam1, float fParam2) // Position - 0x23995{
float num;
float num2;
...
Vector3 func__476(int iParam0) // Position - 0x239D4{
switch (iParam0){
case 0:
...
if(!CAM::IS_SCREEN_FADED_OUT()) CAM::SET_CAM_ACTIVE_WITH_INTERP(func_433(uParam0, 1), func_433(uParam0, 0), func_481(iParam2), 1, 1);
CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
...
Vector3 func__479(var uParam0) // Position - 0x23C90{
return uParam0->f_58;
}


Vector3 func__480(var uParam0) // Position - 0x23C9E{
return uParam0->f_55;
}
...
if(iParam1 >=2) return;
if(bParam3 && !CAM::DOES_CAM_EXIST(caParam2)) return;
...
Vector3 func__484(var uParam0) // Position - 0x23D12{
return uParam0->f_52;
}


Vector3 func__485(var uParam0) // Position - 0x23D20{
return uParam0->f_49;
}


void func_486(int* piParam0) // Position - 0x23D2E{
if(!func_462(piParam0)) func_371(piParam0);
return;
}
...
i < 68;
i=i + 1){
if(func_307(&Global_77348.f_555[0 /*21*/], i))if(MISC::GET_DISTANCE_BETWEEN_COORDS(fParam0, Global_77348.f_555[0 /*21*/], bParam4) <=fParam3) func_488(i);
}
return;
}
...
if(iParam0 < 0 || iParam0 >=func_490(&Global_113648.f_32751.f_5038[num /*157*/])) return false;
...
if(uParam0->f_4 !=0) func_153(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44));
if(uParam0->[0] !=0 || uParam0->[1] !=0 || uParam0->[2] !=0 || iParam1==1){
func_501(uParam0);
func_500(uParam0);
func_126(&Global_2101867);
}
if(Global_2097536.f_2708 !=0 || Global_2097536.f_3184) func_498();
...
int pedParachuteState;
if(iParam1 < 11){
if(!func_263(uParam0, 19))if(iParam1==4 && !bParam3 && CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN()) func_505(func_506(iParam2, 19), "", &(uParam0->f_607), 19);
if(!func_263(uParam0, 20)){
if(iParam1 > 4) func_505(func_506(iParam2, 20), func_506(iParam2, 19), &(uParam0->f_607), 20);
}elseif(!func_263(uParam0, 21)){
if(iParam1==9) func_505(func_506(iParam2, 21), func_506(iParam2, 20), &(uParam0->f_607), 21);
elseif(iParam1==8) func_505(func_506(iParam2, 21), func_506(iParam2, 20), &(uParam0->f_607), 21);
}elseif(!func_263(uParam0, 22)){
if(iParam1==9){
pedParachuteState=PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID());
if(pedParachuteState==1 || pedParachuteState==2) func_505(func_506(iParam2, 22), func_506(iParam2, 21), &(uParam0->f_607), 22);
}}elseif(iParam1==10 && !func_263(uParam0, 23)){
func_504(func_506(iParam2, 22), &(uParam0->f_607), 23);
}elseif(!func_263(uParam0, 23) && !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))if(AUDIO::IS_AUDIO_SCENE_ACTIVE(sParam1)) AUDIO::STOP_AUDIO_SCENE(sParam1);
...
case 20:
if(func_465(func_466(iParam0))) str="BASEJUMPS_PREP_FOR_JUMP_HELI";
elseif(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_365(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))) str="BASEJUMPS_PREP_FOR_JUMP_MOTO";
else str="BASEJUMPS_PREP_FOR_JUMP_ON_FOOT";
return str;
case 21:
...
if(iParam1 < 11)if(!func_263(uParam0, 15))if(iParam1 >=4 && CAM::IS_SCREEN_FADED_IN() || CAM::IS_SCREEN_FADING_IN())if(func_509(func_510(11), &(uParam0->f_607), 11)) func_508(func_510(15), &(uParam0->f_607), 15);
elseif(!func_263(uParam0, 16))if(iParam1==9)if(func_509(func_510(12), &(uParam0->f_607), 12)) func_508(func_510(16), &(uParam0->f_607), 16);
elseif(iParam1==8)if(func_509(func_510(12), &(uParam0->f_607), 12)) func_508(func_510(16), &(uParam0->f_607), 16);
elseif(iParam1==10 && !func_263(uParam0, 17))if(func_509(func_510(13), &(uParam0->f_607), 13)) func_508(func_510(17), &(uParam0->f_607), 17);
return;
}
...
func_514(uParam0);
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 224)) func_513(uParam0, 0, true);
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 22) || PAD::IS_DISABLED_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_JUMP)) func_513(uParam0, 1, true);
if(func_512()) func_513(uParam0, 2, true);
if(PAD::IS_DISABLED_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_JUMP)) func_513(uParam0, 3, true);
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 216)) func_513(uParam0, 4, true);
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 215) || PAD::IS_DISABLED_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_PAUSE_ALTERNATE)) func_513(uParam0, 5, true);
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 201)) func_513(uParam0, 6, true);
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 202)) func_513(uParam0, 7, true);
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 211)) func_513(uParam0, 8, true);
return;
}
BOOL func_512() // Position - 0x24C72{
if(HUD::IS_PAUSE_MENU_ACTIVE()) return false;
if(GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(0, 18) || GRAPHICS::RESET_PARTICLE_FX_OVERRIDE(2, 18)) return true;
return false;
}


void func_513(var uParam0, int iParam1, BOOL bParam2) // Position - 0x24CA4{
if(bParam2) MISC::SET_BIT(&(uParam0->f_2), iParam1);
else MISC::CLEAR_BIT(&(uParam0->f_2), iParam1);
return;
}
...
if(iParam1 < 1 || iParam1 > func_524(num, num2)) return;
...
var func__526(BOOL bParam0, var uParam1, var uParam2) // Position - 0x250BE{
if(bParam0) return uParam1;
return uParam2;
}
...
func_546(uParam0, 0f);
func_545(uParam0, 0f, 0f, 0f);
if(character==CHAR_MICHAEL) func_544(uParam0, "BJ_04M");
elseif(character==CHAR_FRANKLIN) func_544(uParam0, "BJ_04F");
else func_544(uParam0, "BJ_04T");
...
func_546(uParam0, 0f);
func_545(uParam0, 0f, 0f, 0f);
if(character==CHAR_MICHAEL) func_544(uParam0, "BJ_05M");
elseif(character==CHAR_FRANKLIN) func_544(uParam0, "BJ_05F");
else func_544(uParam0, "BJ_05T");
...
if(character==CHAR_MICHAEL) func_544(uParam0, "BJ_06M");
elseif(character==CHAR_FRANKLIN) func_544(uParam0, "BJ_06F");
else func_544(uParam0, "BJ_06T");
...
func_546(uParam0, 0f);
func_545(uParam0, 0f, 0f, 0f);
if(character==CHAR_MICHAEL) func_544(uParam0, "BJ_07M");
elseif(character==CHAR_FRANKLIN) func_544(uParam0, "BJ_07F");
else func_544(uParam0, "BJ_07T");
...
func_546(uParam0, 0f);
func_545(uParam0, 0f, 0f, 0f);
if(character==CHAR_MICHAEL) func_544(uParam0, "BJ_09M");
elseif(character==CHAR_FRANKLIN) func_544(uParam0, "BJ_09F");
else func_544(uParam0, "BJ_09T");
...
func_546(uParam0, 0f);
func_545(uParam0, 0f, 0f, 0f);
if(character==CHAR_MICHAEL) func_544(uParam0, "BJ_13M");
elseif(character==CHAR_FRANKLIN) func_544(uParam0, "BJ_13F");
else func_544(uParam0, "BJ_13T");
...
Vector3 func__543(int iParam0) // Position - 0x2641D{
switch (iParam0){
case 0:
...
if(iParam1 < 0 || iParam1 >=12) return;
uParam0->f_12[iParam1 /*3*/]={
fParam2 
};
return;
}
...
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()) CAM::STOP_SCRIPT_GLOBAL_SHAKING(true);
if(HUD::DOES_BLIP_EXIST(blParam13)) HUD::REMOVE_BLIP(&blParam13);
if(HUD::DOES_BLIP_EXIST(blParam14)) HUD::REMOVE_BLIP(&blParam14);
func_382();
func_26(false);
...
func_220(0, 0);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
if(iParam15==5) PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 146, false);
...
if(!bParam17) WEAPON::REMOVE_WEAPON_FROM_PED(PLAYER::PLAYER_PED_ID(), joaat("GADGET_PARACHUTE"));
...
if(!PED::IS_PED_INJURED(*ppedParam8))if(!ENTITY::IS_ENTITY_ON_SCREEN(*ppedParam8)) PED::DELETE_PED(ppedParam8);
else ENTITY::SET_PED_AS_NO_LONGER_NEEDED(ppedParam8);
...
if(!ENTITY::IS_ENTITY_DEAD(*pveParam2, false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *pveParam2, false)) PED::SPECIAL_FUNCTION_DO_NOT_USE(PLAYER::PLAYER_PED_ID(), true);
if(!ENTITY::IS_ENTITY_ON_SCREEN(*pveParam2)) VEHICLE::DELETE_VEHICLE(pveParam2);
else ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(pveParam2);
}else{
