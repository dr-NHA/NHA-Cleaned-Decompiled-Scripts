...
unkNETWORK_CANCEL_TRANSITION_MATCHMAKING();
}
if(bVar0){
...
iLocal_274=1;
}}elseif(func_173(2, Global_20235) && !bLocal_208){
func_3();
}}
...
func_121();
func_118(0, 32);
}elseif(iLocal_219==2 || (iLocal_219==1 && bLocal_210==0)){
func_117();
}}elseif(iLocal_219==0 && bLocal_210){
func_121();
func_118(0, 32);
}
...
func_139(1);
func_138(0);
}elseif(Global_262145.f_4704==0 && iLocal_211==0){
...
}elseif(bVar14 || (!func_18(PLAYER::PLAYER_ID(), 0) && !func_17())){
...
Var1={
func_85(func_86(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32)) 
};
if(SYSTEM::VMAG(Var1) > 0f){
return Var1;
}}else{
...
}}}}elseif(func_53(iParam0) && !func_52(iParam0)){
...
}}}}elseif(func_44(iParam0)){
return -366,7f, -1909,6f, 20f;
}elseif(func_43(iParam0)){
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_30(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
...
}}elseif(((Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1 && Global_1575058) && iParam0==PLAYER::PLAYER_ID()) && func_30(iParam0, 1, 0)){
return func_34(Global_2689235[iParam0 /*453*/].f_318.f_6)==20;
}}
return 0;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_30(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
bool func_111(){
return MISC::IS_BIT_SET(func_112(6427, -1, 0), 19);
}
...
iVar0=0;
while (iVar0 < 32){
Global_2715699.f_3893.f_1[iVar0 /*13*/]={
Var1 
};
iVar0++;
}
Global_2715699.f_3893.f_1[0 /*13*/]={
func_108(PLAYER::PLAYER_ID()) 
};
...
Global_2715699.f_3893.f_1[Global_2715699.f_3893 /*13*/]={
Var1 
};
...
int iVar0;
if(bParam1){
iVar0=(unkGET_CONTENT_ID_INDEX(iParam0) - 2018);
if(iVar0 < -1){
iVar0=-1;
}
return iVar0;
}
return unkGET_CONTENT_ID_INDEX(iParam0);
}
...
var func__167(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
bVar0=true;
}elseif(func_179(PLAYER::PLAYER_ID())){
...
var func__185(int iParam0, int iParam1){
...
bVar1=false;
}elseif((iLocal_178==1 && uLocal_245[iLocal_218]==3) && !func_194()){
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("PIM_DMAGUT");
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME((func_195(joaat("MPPLY_H4_COOLDOWN")) - NETWORK::GET_CLOUD_TIME_AS_INT()) * 1000, 14);
bVar1=false;
}elseif(iLocal_178==2 && (uLocal_250[iLocal_218]==4 || uLocal_250[iLocal_218]==3)){
...
if(!MISC::IS_BIT_SET(Global_2815059.f_1809, 30)){
func_175("CH_QM_PHONEN", -1);
MISC::SET_BIT(&(Global_2815059.f_1809), 30);
}}elseif(uLocal_245[iLocal_218]==3 && !func_194()){
if(!MISC::IS_BIT_SET(Global_2815059.f_1809, 31)){
func_175("IH_QM_PHONEN", -1);
MISC::SET_BIT(&(Global_2815059.f_1809), 31);
}}elseif(uLocal_245[iLocal_218]==0 && !Global_262145.f_4706){
func_191(&Local_179);
}}
if(bVar1){
...
bLocal_208=false;
}}elseif(func_228(2, Global_20235, 0) && !bLocal_208){
Global_20244=1;
func_186();
}}
...
if(func_228(2, Global_20236, 0)){
func_224();
}}elseif(func_228(2, Global_20235, 0)){
Global_20244=1;
func_186();
}}
...
if(bParam0){
if(!MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_139, 21)){
MISC::SET_BIT(&(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_139), 21);
}}elseif(MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_139, 21)){
...
iVar0=iParam0;
if(iVar0 > -1){
return MISC::IS_BIT_SET(Global_1853348[iVar0 /*834*/].f_139, 21);
}
return 0;
}
...
iVar50=0;
while (iVar50 <=31){
Global_2715699.f_1.f_845[iVar50 /*57*/]={
Var12 
};
Global_2715699.f_1.f_845[iVar50 /*57*/].f_13={
Var25 
};
...
iVar50=0;
while (iVar50 <=1){
Global_2715699.f_1.f_2670[iVar50 /*57*/]={
Var12 
};
Global_2715699.f_1.f_2670[iVar50 /*57*/].f_13={
Var25 
};
...
if(((((((((((Global_1853348[PLAYER::PLAYER_ID() /*834*/]==14 || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==15) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==13) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==6) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==5) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==32) || func_336()) || MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_833, 6)) || func_331(PLAYER::PLAYER_PED_ID(), 1215605247, 0, uParam0, 0, 500, 1, 0)) || func_330(PLAYER::PLAYER_ID(), 0)) || func_327(PLAYER::PLAYER_ID(), 1, 0)) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==148){
return 9;
}
...
if(func_341()){
return 7;
}}}elseif(!func_317(1, 0) && !func_317(1, 1)){
return 5;
}elseif(func_317(1, 0) && !func_317(1, 1)){}elseif(!func_317(1, 0) && func_317(1, 1)){}
return 0;
}
