...
func_91();
}}elseif(((((((!func_147(0) && !func_143(PLAYER::PLAYER_ID())) && !func_142(PLAYER::PLAYER_ID(), 21)) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && VEHICLE::GET_CLOSEST_VEHICLE(-1661,95f, -1127,011f, 12,6973f, 1f, 0, 6)==0) && !func_76()) && !Global_1574582.f_6){
if(!func_137()){
if(MISC::IS_BIT_SET(Local_1142.f_2, 1)){
...
elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1661,95f, -1127,011f, 12,6973f, 1f, 1f, 2f, false, true, 0)){
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_290[Local_1406[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) 
};
...
if(((Local_1142.f_262 !=-1 && MISC::IS_BIT_SET(Local_1142.f_2, 0)) && Global_2822699 < Local_1142.f_36[Local_1142.f_197[Local_1142.f_262 /*2*/] /*10*/].f_6) && (Global_2822699 + (fLocal_308 * fVar4)) > Local_1142.f_36[Local_1142.f_197[Local_1142.f_262 /*2*/] /*10*/].f_6){
