...
return 1;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_90, false), true) <=4,5f || TASK::GET_SCRIPT_TASK_STATUS(iLocal_90, 242628503)==7){
if(!iLocal_112){
...
return 1;
}}elseif(PED::IS_COP_PED_IN_AREA_3D(Local_126, Local_129) || (MISC::IS_POSITION_OCCUPIED(-61,01321f, -1093,393f, 25,75297f, 2f, false, true, false, false, false, 0, false) && MISC::IS_POSITION_OCCUPIED(-38,59683f, -1109,284f, 25,68742f, 2f, false, true, false, false, false, 0, false))){
if(INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==MISC::GET_HASH_KEY("rm_showroom")){
