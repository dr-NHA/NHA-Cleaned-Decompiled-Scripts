...
elseif(HUD::DOES_BLIP_EXIST(iLocal_66)){
...
iLocal_150=1;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, 1805844857) !=1){
TASK::CLEAR_PED_SECONDARY_TASK(iLocal_63);
TASK::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
PED::FORCE_PED_MOTION_STATE(iLocal_63, joaat("MotionState_Run"), true, 0, false);
iLocal_150=1;
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_16(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(PED::IS_PED_INJURED(iLocal_63)){
Local_184={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_63, 1,2f, 1,5f) 
};
}else{
Local_184={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_63, true), 1,2f, 1,5f) 
};
}
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_62, 242628503)==7){
TASK::CLEAR_PED_TASKS(iLocal_62);
TASK::OPEN_SEQUENCE_TASK(&iLocal_121);
...
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_62, 15f, 15f, 15f, false, true, 0)){
TASK::OPEN_SEQUENCE_TASK(&iLocal_121);
...
Local_80={
func_101(Local_125, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, Local_125, Local_128, 0f, 2)) 
};
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false)){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_70() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_70() /*5567*/].f_681.f_10, iParam0);
}
...
iLocal_143=2;
return 1;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), true)){
SYSTEM::SETTIMERB(0);
iLocal_143=2;
if(ENTITY::DOES_ENTITY_EXIST(iLocal_62)){
if(!PED::IS_PED_INJURED(iLocal_62)){
...
case 0:
Local_670={
OBJECT::GET_PICKUP_COORDS(iLocal_191) - Vector(0f, 0f, 0,75f) 
};
if(OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_191)){
TASK::CLEAR_PED_TASKS(iLocal_63);
TASK::OPEN_SEQUENCE_TASK(&iLocal_121);
...
iVar0=1;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), -325,7037f, -829,31f, 30,5812f, true) < 95f){
iVar0=1;
}
return iVar0;
}
...
Var0={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_359, sLocal_365, Local_371, Local_374, 0f, 2) 
};
if(Var0.f_2 < 0f){
...
Var0={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_359, sLocal_366, Local_371, Local_374, 0f, 2) 
};
if(Var0.f_2 < 0f){
Var0.f_2=(Var0.f_2 + 360f);
}
...
return MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 0);
}
