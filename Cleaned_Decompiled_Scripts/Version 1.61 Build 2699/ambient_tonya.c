...
Vector3 func__80(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_82(Var18, -Var0.f_3.f_2) 
};
Var18={
func_82(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
}elseif(MISC::IS_PS3_VERSION() || func_108()){
...
return 0;
}elseif(func_192(59) && !func_181(103)){
return 0;
}
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
return 0;
