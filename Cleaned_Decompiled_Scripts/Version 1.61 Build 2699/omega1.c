...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_80(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_80(iParam1))){
return 1;
}
return 0;
}
...
float fVar6;
Var0={
func_244(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_244(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var4={
func_304(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
return 1;
}elseif(func_353(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_395(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_396() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_411(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_371(iVar5))){
}else{
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_371(iVar6 + 1))){
...
var func__419(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
