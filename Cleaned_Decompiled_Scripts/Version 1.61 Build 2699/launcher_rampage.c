...
}elseif(MISC::IS_PS3_VERSION() || func_109()){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_141(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
struct<27> Var0;
if(Global_78319){
func_375("IS_RC_FINE_AND_IN_RANGE():
...
if(Var0.f_4 !=17){
if(!MISC::IS_BIT_SET(Var0.f_26, func_229())){
func_375("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_153(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
float fVar6;
Var0={
func_171(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_171(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__171(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_171(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
bVar0=true;
}elseif((func_225(0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) || func_224()){
if(func_2("RAMP_HELP_TRIG")){
if(func_225(0)){
...
while (iVar0 < 5){
Var1={
Global_32338[(iLocal_286 + iVar0) /*23*/][0 /*3*/] 
};
...
func_375("ARE_RC_TRIGGER_CONDITIONS_MET:
RC_TRIG_CHAR - Used special case Eps 4 trigger.");
return 1;
}}
}}else{
return 0;
}}elseif(func_130(uParam0->f_28[0])){
if(func_253(uParam0)){
if(func_256(2)){
if(func_255(uParam0->f_27)){
func_254(uParam0->f_27, *uParam0);
...
if(func_255(uParam0->f_27)){
func_254(uParam0->f_27, *uParam0);
func_375("RC5_IN_ACTIVATION_RANGE:
...
if(func_255(1)){
func_254(1, *uParam0);
func_375("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_375("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if(!func_278(&(uParam0->f_41[0]), joaat("weapon_grenadelauncher"), -1297,84f, 2505,91f, 19,34f, func_335(-0,5f))){}else{
...
}elseif(WEAPON::HAS_WEAPON_GOT_WEAPON_COMPONENT(*iParam0, func_279(&uVar1, iParam1, joaat("gun_root"), 1))){
...
iVar1++;
}elseif(Var54.f_0==joaat("WAPFlshLasr") || Var54.f_0==joaat("WAPFlshLasr_2")){
iVar2++;
}elseif(Var54.f_0==joaat("WAPScop") || Var54.f_0==joaat("WAPScop_2")){
iVar3++;
}elseif(Var54.f_0==joaat("WAPRail") || Var54.f_0==joaat("WAPRail_2")){
iVar4++;
}elseif(Var54.f_0==joaat("WAPGrip") || Var54.f_0==joaat("WAPGrip_2")){
iVar5++;
}elseif(Var54.f_0==joaat("WAPSupp") || Var54.f_0==joaat("WAPSupp_2")){
iVar6++;
}elseif(Var54.f_0==1731751835){
iVar7++;
}elseif(Var54.f_0==joaat("gun_root")){
iVar8++;
}elseif(Var54.f_0==-31573710){
iVar9++;
}elseif(Var54.f_0==-1312077031){
iVar10++;
}else{
iVar11++;
}
...
Var7={
func_301(joaat("mpply_started_mp")) 
};
...
var func__295(struct<7> Param0, int iParam7){
var uVar0;
var uVar1;
var uVar2;
...
var func__299(struct<6> Param0, var uParam6){
var uVar0;
if(Param0.f_0 > 0){
...
case joaat("component_specialcarbine_clip_03"):
return 0;
default:}}elseif(func_319(iParam0)){
...
return MISC::IS_BIT_SET(uVar0, func_324(iVar1));
}
...
var func__327(int iParam0, int iParam1, var uParam2){
var uVar0;
...
Vector3 func__340(int iParam0, struct<3> Param1){
var uVar0;
