...
if(func_225(PLAYER::PLAYER_ID()) !=1 && !MISC::IS_BIT_SET(Global_2815059.f_900.f_7, 0)){
func_226();
}}}
...
if((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60.f_3, 500f, 500f, 500f, false, true, 0) && func_225(PLAYER::PLAYER_ID()) !=1) && !MISC::IS_BIT_SET(Global_2815059.f_900.f_7, 0)){
...
Var6={
Global_4718592.f_658[iVar12 /*22957*/].f_2753[0 /*36*/].f_16 
};
Var9={
Global_4718592.f_658[iVar12 /*22957*/].f_2753[0 /*36*/].f_19 
};
fVar5=Global_4718592.f_658[iVar12 /*22957*/].f_2753[0 /*36*/].f_23;
iVar4=1;
}elseif(Global_4718592.f_658[iVar12 /*22957*/].f_2753[0 /*36*/].f_22 > 0f){
Var6={
Global_4718592.f_658[iVar12 /*22957*/].f_2753[0 /*36*/].f_13 
};
...
}}elseif(MISC::IS_BIT_SET(Local_60.f_1, 8) || func_8(Var6, Var9, fVar5, &Var0, &fVar3, Var13)){
if(Local_60.f_7 >=32 || func_225(PLAYER::PLAYER_ID())==1){
Local_60.f_2=NETWORK::OBJ_TO_NET(OBJECT::CREATE_PORTABLE_PICKUP(joaat("pickup_portable_package"), Var0, true, joaat("prop_drug_package_02")));
}else{
Local_60.f_2=NETWORK::OBJ_TO_NET(OBJECT::CREATE_NON_NETWORKED_PORTABLE_PICKUP(joaat("pickup_portable_package"), Var0, true, joaat("prop_drug_package_02")));
...
return 0;
}}elseif(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2667225.f_2470) < func_183(0)){
return 0;
}}
...
if(func_28(*uParam0, &Var0, iVar68, iParam3, 1)){}else{
bVar67=true;
}
if(bVar67){
Var0={
...
case 0:
*uParam0={
func_21(*uParam0, *uParam1, 0f, 0f, 0f, (uParam1->f_6 + (IntToFloat(Global_2667225.f_2735) * uParam1->f_8)), 0, fParam2, bParam3) 
};
break;
case 1:
*uParam0={
...
Vector3 func__17(struct<3> Param0, struct<3> Param3){
...
Vector3 func__21(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, int iParam10, float fParam11, bool bParam12){
int iVar0;
struct<3> Var1;
switch (iParam10){
case 0:
...
if(iVar0 > -1){
Var1={
func_53(&(Global_2667225.f_45[iVar0 /*12*/])) 
};
if(!func_13(&Var1, 0, 0, 0, 1)){
if(!func_13(&Param0, 0, 0, 0, 1)){
return 1;
...
}}elseif(!func_119(Param0, 25f, PLAYER::PLAYER_ID(), 1, 1)){
if(uParam4->f_15){
fVar1=3,5f;
}else{
fVar1=1f;
...
iVar8 +=128;
iVar8 +=64;
}elseif(!func_116(Param0, fVar1, 1, 1, 60f, 0, -1, 0f, 1)){
iVar8 +=64;
}}
if(uParam4->f_5){
...
iVar8 +=512;
}}elseif(!func_115(&Param0, 0)){
iVar8 +=512;
}}}else{
iVar8 +=512;
}}elseif(!func_114(Param0, 2,5f, 3)){
iVar8 +=512;
}
if(uParam4->f_5){
...
if(uParam4->f_5){}elseif(func_100(Param0, 1, 0, uParam4->f_15, 1060320051, 1086324736, 1065353216, 1088421888)){
iVar8=0;
}
...
return 1;
}}elseif(SYSTEM::VDIST(func_79(iVar1), Param0) < 1f){
return 1;
...
Global_2667225.f_3=(Global_2667225.f_3 + Global_2667225.f_2);
}}elseif(func_175(Param0, 6f, 5f, 5f, 5f, 0, bParam6, iParam7, fParam8, bParam15, -1, 1, 0, 0, fParam13, bParam14, 0)){
Global_2667225.f_3=(Global_2667225.f_3 + Global_2667225.f_2);
if(!func_126(Param0, fParam12)){
Global_2667225.f_3++;
...
return 0;
}elseif((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID())==-1 && !PLAYER::PLAYER_ID()==iVar1) || !func_125(PLAYER::PLAYER_ID(), iVar1, -2, 0)){
...
if(!func_166(Var1)){
Var1={
func_162(Var1, &fVar4, iVar9, uParam2->f_9, *uParam2, bVar10, uParam2->f_11, uParam2->f_34, &bVar11, bVar12, 1, uParam2->f_51, uParam2->f_60) 
};
...
elseif(func_175(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_154(Var1, fVar4, uParam2->f_34, 1, 1, 0, 0, 0, 0)){
iVar23=1;
}
}
...
*uParam5={
func_162(*uParam5, fParam6, iParam9, uParam7->f_9, *uParam7, bParam8, uParam7->f_11, uParam7->f_34, &bParam13, 0, 0, uParam7->f_51, uParam7->f_60) 
};
if(!func_166(*uParam5)){
iVar0=999;
return;
...
return 1;
}}elseif(func_34(func_79(iVar1), Param0, fParam3, iParam4, 1036831949)){
return 1;
}}elseif(Global_2680265.f_261[iVar0]){
if(func_34(Global_2680265.f_131[iVar0 /*3*/], Param0, fParam3, iParam4, 1036831949)){
return 1;
...
Vector3 func__162(struct<3> Param0, float* fParam3, int iParam4, bool bParam5, struct<3> Param6, bool bParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16){
struct<3> Var0;
var uVar3;
var uVar4;
var uVar5;
...
if(bParam1){
*uParam0={
func_21(*uParam0, Global_2667225.f_26.f_10, Global_2667225.f_26.f_13, Global_2667225.f_26.f_16, Global_2667225.f_26.f_17, 1036831949, 0) 
};
}}}
return bVar0;
}
...
bVar12=true;
}}elseif(func_175(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_154(Var3, fVar6, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0)){
bVar12=true;
}
}
if(bVar12){
...
void func_192(){
if(!MISC::IS_BIT_SET(Global_2703735.f_3576, 0)){
...
void func_229(){
if(MISC::IS_BIT_SET(uLocal_168, 4)){
