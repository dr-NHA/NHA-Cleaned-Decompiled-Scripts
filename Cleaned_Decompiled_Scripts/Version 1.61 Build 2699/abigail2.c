...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_84(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_84(iParam1))){
return 1;
}
return 0;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_249(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
func_275();
func_237(4);
}elseif(ENTITY::IS_ENTITY_AT_COORD(iLocal_169, Local_347, 5f, 5f, 5f, false, true, 0)){
func_237(3);
}else{
...
float fVar6;
Var0={
func_287(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_287(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_308() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_308() /*5567*/].f_681.f_10, iParam0);
}
...
Var4={
func_371(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
return 1;
}elseif(func_416(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_458(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_459() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
