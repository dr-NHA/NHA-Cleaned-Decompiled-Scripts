...
func_55(&iLocal_1358);
}elseif(iLocal_1035 < 8 || func_52(&iLocal_1358) > 5f){
if(iLocal_1048==1){
func_37(1);
...
func_37(2);
}}elseif(func_52(&iLocal_1358) > 2,5f){
if(!iLocal_1174){
if(!bLocal_1193){
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_73(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1317)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_1317, true) 
};
...
elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1317, -1, false)==iLocal_1058[iParam0]){
if(!iLocal_1152){
if(ENTITY::IS_ENTITY_DEAD(iLocal_1050, false)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_1058[iParam0], 780511057) !=1){
TASK::TASK_COMBAT_PED(iVar0, PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(!iLocal_1162){
iLocal_1041[iParam0]=8;
}}}
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam1, -1273030092) !=1){
...
}}elseif(!PED::IS_PED_IN_VEHICLE(iParam1, iParam0, false)){
...
TASK::ADD_VEHICLE_SUBTASK_ATTACK_PED(iParam1, PLAYER::PLAYER_PED_ID());
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam1, 780511057) !=1){
TASK::TASK_COMBAT_PED(iParam1, PLAYER::PLAYER_PED_ID(), 0, 16);
}}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam1, 780511057) !=1){
TASK::TASK_COMBAT_PED(iParam1, PLAYER::PLAYER_PED_ID(), 0, 16);
}}}
...
}elseif(TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 1227113341) !=1){
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_1316, true) 
};
}
...
}elseif(func_52(&iLocal_1337) > fLocal_1231[iParam0] || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
func_130(&iVar0);
iLocal_1037[iParam0]=2;
}
break;
...
break;
}elseif(func_52(&iLocal_1337) >=27f && iLocal_1142){
func_129(iVar0, 15f, 15f, 3f);
}elseif(func_52(&iLocal_1337) >=15f){
func_142(iVar0);
}}else{
iLocal_1166=0;
bLocal_1139=true;
...
return 1;
}}elseif(PED::IS_PED_IN_VEHICLE(iLocal_1050, iLocal_1316, false)){
return 1;
}}}
return 0;
}
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam0, -1207174364) !=1){
if(iParam0==iLocal_1061){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_1049, iLocal_1049, 1f, false, -1f, 4f, true, false, joaat("FIRING_PATTERN_FULL_AUTO"));
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam0, 1630799643) !=1){
TASK::TASK_AIM_GUN_AT_ENTITY(iParam0, iLocal_1049, -1, false);
}}}}
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_1051[iParam0], 780511057) !=1){
TASK::TASK_COMBAT_PED(iLocal_1051[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
}
}}elseif(!iLocal_1162){
iLocal_1045[iParam0]=5;
...
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false)){
if(ENTITY::GET_ENTITY_SPEED(iVar0) < 5f){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1050)){
Local_1309={
ENTITY::GET_ENTITY_COORDS(iLocal_1050, false) 
};
}
switch (iLocal_1044){
case 0:
...
TASK::CLEAR_SEQUENCE_TASK(&iVar0);
bLocal_1168=true;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_1050, 1435919172) !=1){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_168() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_168() /*5567*/].f_681.f_10, iParam0);
}
...
Var7={
ENTITY::GET_ENTITY_COORDS(iLocal_1050, true) 
};
fVar10=ENTITY::GET_ENTITY_HEADING(iLocal_1050);
}
Var0[0 /*3*/]={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var7, fVar10, 1f, -1f, 0f) 
};
Var0[1 /*3*/]={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var7, fVar10, -1f, -1f, 0f) 
};
...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_1323, true) 
};
return 1;
}}}
return 0;
...
return func_344(2, 2);
}elseif(func_343(Global_1853185)){
...
Vector3 func__344(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_346(Var18, -Var0.f_3.f_2) 
};
Var18={
func_346(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__346(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_393(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
Vector3 func__403(struct<3> Param0){
float fVar0;
float fVar1;
...
}elseif(func_52(&iLocal_367) > 1f || iParam1==0){
return 1;
}}
return 0;
}
...
elseif(func_422("ASS_VA_LOSECOPS", 0, 0)){
HUD::CLEAR_PRINTS();
}}}elseif(STREAMING::STREAMVOL_HAS_LOADED(iLocal_1134) && func_421()){
func_420();
func_264();
iLocal_1035=8;
}}elseif(!func_425()){
...
if(!MISC::IS_BIT_SET(Global_100441.f_20, 13)){
func_530();
}
func_437(0, -1, 1);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
}elseif((!func_494(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_307(iVar6 + 1))){
...
var func__504(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(func_510(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_511() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
