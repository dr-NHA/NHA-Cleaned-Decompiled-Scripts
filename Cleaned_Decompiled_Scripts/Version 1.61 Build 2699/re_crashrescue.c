...
bLocal_286=true;
iLocal_54=2;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_76, PLAYER::PLAYER_PED_ID(), true) || func_215(iLocal_76, PLAYER::PLAYER_PED_ID(), 1,25f, 1)){
...
iLocal_54=2;
iLocal_283=0;
}elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60, Global_19, true, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722,09f, 3843f, 33,6f, 1740,11f, 3854,94f, 39,22f, 12f, false, true, 0)){
iLocal_54=1;
iLocal_55=0;
}}else{
func_213();
...
}elseif(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75, 20f, 20f, 20f, false, true, 0) || !func_231()){
PED::REMOVE_PED_FROM_GROUP(iLocal_75);
...
return 1;
}elseif(HUD::DOES_BLIP_EXIST(iLocal_73)){
...
Local_63={
ENTITY::GET_ENTITY_COORDS(iLocal_75, true) 
};
