...
if(!MISC::IS_BIT_SET(Global_44241, 10)){
if(Local_242.f_55==1){
if(!Local_242.f_56){
...
Local_63={
ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_242.f_2), true) 
};
...
if(iLocal_58 && !MISC::IS_BIT_SET(Global_44241, 10)){
if(!iLocal_59){
if(func_42(Local_242.f_2)){
...
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
if(!iLocal_56 && !MISC::IS_BIT_SET(Global_44241, 10)){
...
iLocal_56=1;
}}elseif(MISC::IS_BIT_SET(Global_44241, 10) || MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(PLAYER::PLAYER_PED_ID(), joaat("weapon_flare"), 100f, &(Local_300[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), true)){
if(MISC::IS_BIT_SET(Global_44241, 10)){
Local_300[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
...
iLocal_55=1;
}}}}elseif(!iLocal_54 && !MISC::IS_BIT_SET(Global_44241, 10)){
...
if(!iLocal_239 && !MISC::IS_BIT_SET(Global_44241, 10)){
if(!Local_242.f_54){
if(!func_94(Local_242.f_2.f_3)){
if(!func_44(Local_300[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2)){
...
elseif(ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_60, 75f, 75f, 1000f, false, true, 0)){
Local_242.f_53=1;
Local_242.f_50=100;
Local_242.f_54=1;
if(!iLocal_240 && !MISC::IS_BIT_SET(Global_44241, 10)){
if(func_41()){
if(!func_38()){
