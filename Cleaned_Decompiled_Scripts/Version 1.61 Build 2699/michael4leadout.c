...
return 1;
}elseif(func_79(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_102(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_103() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
Global_78130[1 /*14*/]={
func_159(iVar10, iVar0, func_116(iParam0, iVar0, -1), -1) 
};
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_117(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_117(iParam1))){
return 1;
}
return 0;
}
...
return 1;
}elseif(func_144(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
