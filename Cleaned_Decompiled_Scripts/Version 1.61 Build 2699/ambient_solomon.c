...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var3.f_0, Var6.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param4, fParam7, false, true)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, Var6.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param4, fParam7, false, true)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var6.f_0, Var6.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param4, fParam7, false, true)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var3.f_0, Var3.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param4, fParam7, false, true)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 0f, Var3.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param4, fParam7, false, true)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Var6.f_0, Var3.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param4, fParam7, false, true)){
return 1;
}
