...
while (func_531()){
func_530();
if(!MISC::IS_BIT_SET(uLocal_109, 9)){
func_521();
func_498();
}
func_483(iLocal_118);
...
int iVar1;
func_457();
if(MISC::IS_BIT_SET(uLocal_109, 3)){
...
func_219();
}elseif(func_16(PLAYER::PLAYER_ID(), iLocal_298)){
func_219();
}elseif(Global_1640666[func_218(iLocal_298)] >=Global_262145.f_18433){
func_219();
}elseif(func_15(func_218(iLocal_298))){
func_219();
}elseif(!func_39(192)){
...
}elseif(func_224(PLAYER::PLAYER_ID(), func_227(PLAYER::PLAYER_ID()))){
...
return 0;
}}elseif(func_3(&(Global_2789228.f_146)) && !func_1(&(Global_2789228.f_146), Global_262145.f_19359, 1)){
return 0;
}
return 1;
}
...
var func__248(){
return MISC::IS_BIT_SET(uLocal_109, 6);
}
...
func_219();
}elseif(iLocal_297 !=8 && func_254(iLocal_297)){
func_219();
}elseif(!func_39(229)){
...
if(iVar0[iVar24] !=-1){
Var27={
func_324(iParam0, iVar24) 
};
if(!func_323(Var27)){
if(HUD::DOES_BLIP_EXIST(Global_2678393[iVar26])){
Var30={
HUD::GET_BLIP_COORDS(Global_2678393[iVar26]) 
};
...
Var0={
HUD::GET_BLIP_COORDS(Global_2678393[PLAYER::PLAYER_ID()]) 
};
Var0.f_2=PATHFIND::GET_APPROX_FLOOR_FOR_POINT(Var0.f_0, Var0.f_1);
}else{
Var0={
func_268(PLAYER::PLAYER_ID()) 
};
}
...
Var1={
func_319(func_320(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32)) 
};
if(SYSTEM::VMAG(Var1) > 0f){
return Var1;
}}else{
...
}}}}elseif(func_288(iParam0) && !func_287(iParam0)){
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_73(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
...
}}elseif(((Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1 && Global_1575058) && iParam0==PLAYER::PLAYER_ID()) && func_73(iParam0, 1, 0)){
return func_72(Global_2689235[iParam0 /*453*/].f_318.f_6)==20;
}}
return 0;
}
...
if(iParam0 !=func_18()){
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_348, 10);
}
return 0;
}
...
}elseif(func_256(PLAYER::PLAYER_ID())){
...
if(func_330(iVar17)){
Var21={
Global_1946250.f_533[func_418(func_227(iVar17)) /*3*/] 
};
Var21.f_2=0f;
}else{
return -1;
...
}}elseif(func_423(PLAYER::PLAYER_ID(), Global_1946187[iVar0])){
...
if(func_463()){
func_456();
}elseif(MISC::IS_BIT_SET(uLocal_109, 5)){
...
bool func_462(){
return MISC::IS_BIT_SET(uLocal_109, 4);
}


bool func_463(){
return MISC::IS_BIT_SET(uLocal_109, 0);
}
...
func_255(&uLocal_307);
iLocal_112=0;
if(!func_228(12) || MISC::IS_BIT_SET(uLocal_109, 7)){
if(func_1(&uLocal_305, 500, 0)){
func_255(&uLocal_305);
func_484(3);
if(func_228(12)){
...
if(iVar6 !=iVar5){
bVar4=true;
}}elseif(func_13(iLocal_112) !=iVar5){
bVar4=true;
}
if(bVar4){
func_350();
...
void func_521(){
bool bVar0;
if(!MISC::IS_BIT_SET(uLocal_109, 8) && !func_529()){
if(MISC::IS_BIT_SET(uLocal_109, 10)){
if(MISC::IS_BIT_SET(Global_1946102, 16) || MISC::IS_BIT_SET(uLocal_109, 12)){
MISC::SET_BIT(&uLocal_109, 9);
return;
}elseif(MISC::IS_BIT_SET(Global_1946250.f_3, 28)){
if(!MISC::IS_BIT_SET(uLocal_109, 11)){
if(func_527()){
if(!MISC::IS_BIT_SET(Global_1946102, 17)){
bVar0=true;
iLocal_113=9000;
...
if(((MISC::IS_BIT_SET(uLocal_109, 4) && iLocal_118==0) && !func_493(22143, -1)) && !bVar0){
bVar0=true;
iLocal_113=9000;
iLocal_114=2;
func_365(22143, 1, -1);
...
}elseif(MISC::IS_BIT_SET(uLocal_109, 8)){
if(!func_3(&uLocal_311)){
func_2(&uLocal_311, 0, 0);
}elseif(func_1(&uLocal_311, iLocal_113, 0)){
...
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_543(0, 1);
}elseif(func_465() || PAD::IS_CONTROL_JUST_RELEASED(2, 199)){
func_543(0, 1);
