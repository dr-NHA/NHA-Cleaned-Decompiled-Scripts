...
Global_22638=1;
}elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_149, -1, false)==PLAYER::PLAYER_PED_ID()){
...
if(!MISC::IS_BIT_SET(Global_4541229, 13)){
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
if(!MISC::IS_BIT_SET(Global_8137, 28)){
...
if(MISC::IS_BIT_SET(Global_8136, 18)){
func_144();
...
elseif(!MISC::IS_BIT_SET(Global_4541229, 2)){
func_164(iLocal_140, "SHOW_PHOTO_FRAME", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
}
func_126();
func_125(1);
}}elseif(Global_20266.f_1 !=9){
if(Global_22639==1){
if(Global_22638==0){
func_124();
}
}
elseif((Global_8744 - Global_8743) > Global_8745){
...
if(func_160()){
if(((Global_1931426 || Global_1574964) || Global_22641) || MISC::IS_BIT_SET(Global_8136, 21)){
}elseif(func_122() && iLocal_127){
}elseif(!func_123()){
if(iLocal_127==0){
...
if(iLocal_102==0){
if(MISC::IS_BIT_SET(Global_8136, 28)){
func_109();
iLocal_102=1;
}
}
elseif(!MISC::IS_BIT_SET(Global_8136, 28)){
func_109();
iLocal_102=0;
}
if(Global_22638==1){
...
func_164(iLocal_140, "SET_REMAINING_PHOTOS", SYSTEM::TO_FLOAT(iLocal_109), SYSTEM::TO_FLOAT(iLocal_110), -1082130432, -1082130432, -1082130432);
}}}elseif(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_140)){
func_164(iLocal_140, "SHOW_PHOTO_FRAME", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
func_164(iLocal_140, "SET_REMAINING_PHOTOS", SYSTEM::TO_FLOAT(iLocal_109), SYSTEM::TO_FLOAT(iLocal_110), -1082130432, -1082130432, -1082130432);
}
iLocal_104=0;
...
if(MISC::IS_BIT_SET(Global_8137, 14)){
func_159("CELL_299", -1);
}else{
func_139();
func_10();
...
if(MISC::IS_BIT_SET(Global_8136, 22)){
func_1(0);
...
func_1(0);
if(func_122() || MISC::IS_BIT_SET(Global_8137, 28)){
}else{
MISC::SET_GAME_PAUSED(false);
SYSTEM::SETTIMERB(0);
iLocal_136=1;
...
if(!func_63(14)){
if(MISC::IS_BIT_SET(Global_4541229, 10)){
...
}}}elseif(MISC::IS_BIT_SET(Global_4541229, 10)){
MISC::CLEAR_BIT(&Global_4541229, 10);
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}}elseif(PAD::IS_CONTROL_PRESSED(0, 182) && !func_160()){
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20255, true);
iLocal_132=1;
if(!func_63(14)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_140, "SET_FOCUS_LOCK");
...
func_77(iLocal_141, "SET_DATA_SLOT", 2f, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, true), "CELL_SP_2NP_XB");
}}elseif((Global_78319==0 && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("pi_menu")) > 0) && func_62()){
func_53();
}else{
if(PAD::_IS_USING_KEYBOARD(2) || func_4()){
func_77(iLocal_141, "SET_DATA_SLOT", 2f, PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, true), "CELL_SP_2NP_XB");
...
if(Global_4718592.f_163006==1){}elseif(Global_4718592.f_163007==1){}else{
...
if(MISC::IS_BIT_SET(Global_8138, 4)){
...
func_59(0);
iLocal_131=0;
if(MISC::IS_BIT_SET(Global_8136, 30)){
iLocal_118=0;
iLocal_119=0;
iLocal_120=0;
func_99();
...
func_64("CELL_217");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}elseif(func_103(Global_7451, Global_20266)==0){
...
int func_122(){
if(MISC::IS_BIT_SET(Global_8136, 15)){
return 1;
}
return 0;
}
...
return 1;
}elseif(!VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1, false)==PLAYER::PLAYER_PED_ID()){
return 1;
}}}
return 0;
}
