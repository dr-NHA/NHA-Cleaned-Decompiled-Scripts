...
func_2();
}}}elseif(MISC::IS_BIT_SET(uLocal_109, 4)){
if(MISC::IS_STRING_NULL_OR_EMPTY(sLocal_129)){
func_56();
}elseif(SCRIPT::HAS_SCRIPT_LOADED(sLocal_129)){
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_295.f_4, 4);
}
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_295.f_4, 3);
}
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_295.f_4, 2);
}
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_295.f_4, 1);
}
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_295.f_4, 0);
}
...
int iVar2;
bool bVar3;
if(MISC::IS_BIT_SET(uLocal_109, 6)){
...
if(MISC::IS_BIT_SET(uLocal_109, 8)){
...
if(MISC::IS_STRING_NULL_OR_EMPTY(sLocal_129) || Global_1964706==-1){}else{
SCRIPT::REQUEST_SCRIPT(sLocal_129);
...
void func_109(){
if(!MISC::IS_BIT_SET(uLocal_109, 2) && !func_4()){
if(!MISC::IS_BIT_SET(uLocal_109, 6)){
...
void func_137(){
bool bVar0;
if(!MISC::IS_BIT_SET(uLocal_109, 11) && !func_146()){
...
}elseif(MISC::IS_BIT_SET(uLocal_109, 11)){
if(!func_141(&uLocal_123)){
func_140(&uLocal_123, 0, 0);
}elseif(func_139(&uLocal_123, iLocal_110, 0)){
...
func_149(2, 202, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 202) && !MISC::IS_BIT_SET(uLocal_109, 2)){
func_148();
}
func_149(2, 203, 1);
...
func_149(2, 238, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 238) && !MISC::IS_BIT_SET(uLocal_109, 2)){
func_148();
}}else{
func_149(2, 195, 1);
func_149(2, 196, 1);
...
int func_151(){
if(MISC::IS_BIT_SET(uLocal_109, 5) || MISC::IS_BIT_SET(uLocal_109, 4)){
return 1;
}
return 0;
}
...
return 0;
}}elseif(func_172() || unkIS_PROSPERO_VERSION()){
if(NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)){
if(NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0)){
return 0;
}}}}
...
if(((func_215(PLAYER::PLAYER_ID()) || (func_214() && func_213())) && !MISC::IS_BIT_SET(Global_2815059.f_4660, 31)) && !bParam4){
iVar1=func_212();
...
if(bParam1){
if(iParam2 > -1){
if(func_188(iVar0, iParam2, 0) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)){
if(iVar0==iParam2){
return func_187(1);
}else{
return func_187(0);
...
if((func_196(iParam1, iParam0, iVar0, 0) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)) || ((func_188(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(iParam0), 0) && MISC::IS_BIT_SET(Global_4718592.f_15, 23)) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18))){
return func_187(1);
...
if(MISC::IS_BIT_SET(Global_4718592.f_15, 26) && !func_188(iParam0, PLAYER::GET_PLAYER_TEAM(iParam1), 0)){
iVar0=func_195(1);
}}else{
iVar0=1;
}
...
if(MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_139, 2) || MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_139, 5)){
return 0;
}
if(func_241(iParam0)){
return 0;
...
if(MISC::IS_BIT_SET(Global_2815059.f_1801, 15)){
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_7[iVar0], iVar1);
}
...
int iVar0;
if(MISC::IS_BIT_SET(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_101, bParam0)){
...
MISC::NEXT_ONSCREEN_KEYBOARD_RESULT_WILL_DISPLAY_USING_THESE_FONTS(2);
Var10={
Global_4718592.f_169405[iParam30 /*16*/] 
};
if(iParam31 > -1){
Var10={
Global_4718592.f_169486[iParam30 /*65*/][iParam31 /*16*/] 
};
}
...
func_367(1);
}elseif(func_356(PLAYER::PLAYER_ID())){
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_52(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
