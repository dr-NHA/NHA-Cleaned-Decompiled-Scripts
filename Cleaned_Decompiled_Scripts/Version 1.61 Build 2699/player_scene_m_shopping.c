...
}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97771)){
...
Var12={
ENTITY::GET_ENTITY_COORDS(*iParam0, true) - Vector(2f, 2f, 2f) 
};
Var15={
ENTITY::GET_ENTITY_COORDS(*iParam0, true) + Vector(2f, 2f, 2f) 
};
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_280, &cLocal_312, 2)){
}
break;
case 8:
if(func_130(iParam0)){
...
if(fVar4 > (8f * 8f)){
iLocal_350=-1;
}elseif(AUDIO::IS_ANY_SPEECH_PLAYING(iParam0)){
iLocal_350=-1;
}else{
if(iLocal_350 <=0){
...
return 0;
}}elseif(!ENTITY::IS_ENTITY_ON_SCREEN(iParam0) || !ENTITY::IS_ENTITY_VISIBLE(iParam0)){
return 0;
}
bVar12=false;
switch (iParam1){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_54() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_54() /*5567*/].f_681.f_10, iParam0);
}
...
return 0;
}}}elseif(iParam1==func_139(Global_100162) && iParam1 !=0){
Global_100162=0;
}}
return 1;
}
...
case 5:
*uParam1={
Global_113386.f_2363.f_539.f_2300[0 /*3*/] + Vector(-1f, 0f, 0f) 
};
...
case 6:
*uParam1={
Global_113386.f_2363.f_539.f_2300[1 /*3*/] + Vector(-1f, 0f, 0f) 
};
...
case 7:
*uParam1={
Global_113386.f_2363.f_539.f_2300[2 /*3*/] + Vector(-1f, 0f, 0f) 
};
...
iVar5=0;
while (iVar5 < 5){
if(MISC::IS_BIT_SET(Global_113386.f_7229.f_11[iVar5], 0)){
Var6={
Global_95644[iVar5 /*9*/].f_3 
};
...
return 1;
}elseif(((Global_113386.f_18533[2]==300 || Global_113386.f_18533[2]==301) || Global_113386.f_18533[2]==302) || Global_113386.f_18533[2]==303){
*uParam2={
