...
}}elseif(!func_29(Var3, HUD::GET_BLIP_COORDS(iParam0->f_5), 0,1f, 0)){
...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_15()) || !func_27(iParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
return 1;
}}}elseif(func_25(1, 0, 1) || MISC::IS_BIT_SET(iParam0->f_13, 7)){
return 1;
}
return 0;
}
...
iLocal_38=2;
}elseif(VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_96, -1, false) || PED::IS_PED_INJURED(iLocal_90[0])){
func_100(&uLocal_106, 0, 0);
}else{
func_67();
}}}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_79(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
