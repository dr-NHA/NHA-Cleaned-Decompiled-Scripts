...
if(MISC::IS_BIT_SET(Global_1888478.f_7[iParam0 /*8*/].f_5, 0)){
func_25();
...
iVar0=iParam0;
while (iVar0 <=8){
Global_1888478.f_7[iVar0 /*8*/]={
Global_1888478.f_7[iVar0 + 1 /*8*/] 
};
iVar0++;
}
...
return MISC::IS_BIT_SET(Global_1888478.f_3, iParam0);
}
...
iLocal_110=1;
iLocal_83=3;
}elseif(Global_1888478.f_7[iVar0 /*8*/]==0){
func_6(iVar0);
}elseif(Global_1888478.f_7[iVar0 /*8*/]==1){
func_32(iVar0);
}else{
func_7(0);
}}}
...
}}elseif(Global_1888478.f_88[iVar3 /*5*/].f_2){
...
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}}elseif(Global_1888478.f_7[iVar3 /*8*/]==1){
...
return 0;
}}elseif(func_62() || unkIS_PROSPERO_VERSION()){
if(NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)){
if(NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0)){
return 0;
}}}}
...
Var0={
func_82(Global_1888478.f_7[iParam0 /*8*/].f_2) 
};
func_89(&Var0);
