...
bVar28=true;
Var29={
ENTITY::GET_ENTITY_COORDS(iScriptParam_0, true) - ENTITY::GET_ENTITY_FORWARD_VECTOR(iScriptParam_0) * Vector(0,6f, 0,6f, 0,6f) 
};
Var29.f_2=(Var29.f_2 + 0,5f);
Local_126={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_0, Local_123) 
};
Global_1946112=0;
Global_1946108=0;
Global_1946220=0;
...
}elseif(func_238(&uLocal_118, 10000, 0)){
func_237(&uLocal_118);
Global_1946108=0;
}
func_231(0);
...
Var33={
ENTITY::GET_ENTITY_ROTATION(iLocal_120, 2) 
};
...
func_237(&uLocal_118);
iLocal_110=0;
}}elseif((((iLocal_109 !=-1 && PAD::IS_CONTROL_JUST_PRESSED(2, 52)) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())) && func_178()) && func_175()){
if(iLocal_109 !=-1){
func_204(&iLocal_109);
func_5();
}
...
while (MISC::IS_BIT_SET(Global_1946250.f_4, 28)){
SYSTEM::WAIT(0);
}
func_6();
func_4();
...
Var4={
ENTITY::GET_ENTITY_COORDS(iLocal_120, true) 
};
...
WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), true);
Var16={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_120, 0,0328f, -0,8f, 0,3f) 
};
bVar19=false;
func_237(&uLocal_116);
if(func_7(0, &sVar0)){
...
}elseif(func_238(&uLocal_116, 4000, 0)){
bVar19=true;
}
...
var func__175(){
return MISC::IS_BIT_SET(Global_1946250.f_506, 30);
}

int func_176(){
if(func_239(PLAYER::PLAYER_ID())){
if(MISC::IS_BIT_SET(Global_1946250.f_506, 0) || MISC::IS_BIT_SET(Global_1946250.f_506, 2)){
return 1;
}}
return 0;
}
...
}elseif((func_242(&uLocal_114) && func_238(&uLocal_114, 10000, 1)) || !iLocal_111){
...
if(func_207(Global_1853348[iParam0 /*834*/].f_267.f_32, -1) && !MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_30, 1)){
return 1;
}
return 0;
}
...
return 1;
}elseif(ENTITY::IS_ENTITY_IN_AREA(PLAYER::PLAYER_PED_ID(), 1008,467f, -3167,947f, -37,5246f, 1006,903f, -3171,152f, -39,6192f, false, true, 0)){
return 1;
}}}
return 0;
}
...
bool func_211(){
return MISC::IS_BIT_SET(Global_1946250.f_11, 1);
}
