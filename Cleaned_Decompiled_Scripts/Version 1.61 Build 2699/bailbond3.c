...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_213(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_213(iParam1))){
return 1;
}
return 0;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_346(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
}}elseif(!func_64(Local_112.f_9, -875674219)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
}
break;
case 7:
...
if(!func_102(Local_254[0 /*6*/])){
Local_112.f_10=22;
}elseif(((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_116(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f, 1)) || !func_374(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f)){
Local_112.f_10=22;
}elseif(PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_254[0 /*6*/])){
Local_112.f_10=42;
}elseif(!func_64(Local_112.f_9, -1794415470)){
Local_112.f_10=24;
}
...
float fVar6;
Var0={
func_194(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
}}}elseif(Local_112.f_10==33 && func_64(Local_112.f_9, -1519143300)){
if(func_116(Local_112.f_9, Local_680, 25f, 1)){
...
float fVar6;
Var0={
func_194(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return 1;
}elseif(func_465(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if(!func_489() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_180(iVar6 + 1))){
...
Vector3 func__537(struct<5> Param0, var uParam5, var uParam6, var uParam7){
switch (Param0.f_4){
case 0:
...
Vector3 func__538(struct<5> Param0, var uParam5, var uParam6, var uParam7){
switch (Param0.f_4){
case 0:
