...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_150(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_150(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_150(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_150(4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_150(iVar5))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_147(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_146()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_150(iVar6 + 1))){
...
}elseif(func_142(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_143() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
Vector3 func__156(struct<3> Param0){
...
if(func_161(13, -1)){
return 0;
}elseif(func_161(14, -1)){
return 0;
}elseif(func_161(15, -1)){
return 0;
}elseif(func_161(16, -1)){
return 0;
}elseif(func_161(71, -1)){
return 0;
}elseif(func_161(72, -1)){
}
}}elseif(Global_4539561==13){
return 0;
}elseif(Global_4539561==14){
return 0;
}elseif(Global_4539561==15){
return 0;
}elseif(Global_4539561==16){
return 0;
}elseif(Global_4539561==71){
return 0;
}elseif(Global_4539561==72){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78130[1 /*14*/]={
func_205(iVar0, iParam1, iParam2, -1) 
};
...
}}elseif(func_190(iVar0, 4, iParam2, &uVar68)){
return func_189(iParam0, 4, uVar68);
}}
...
return 1;
}elseif(func_194(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
var func__231(var uParam0, int iParam1){
var uVar0;
...
var func__258(bool bParam0){
if(bParam0){
return (MISC::IS_BIT_SET(Global_4718592.f_162497, 12) && func_259());
}
...
elseif(func_110(PLAYER::PLAYER_ID(), 1) && Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_76.f_21 !=0){
return 1;
}}
break;
default:
