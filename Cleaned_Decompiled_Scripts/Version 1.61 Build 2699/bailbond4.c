...
if(!func_102(Local_191[0 /*6*/])){
Local_112.f_10=13;
}elseif(((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_191[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_191[0 /*6*/], Local_191[0 /*6*/].f_1, 3f, 1)) || !func_372(ENTITY::GET_ENTITY_HEADING(Local_191[0 /*6*/]), Local_191[0 /*6*/].f_4, 20f)){
Local_112.f_10=13;
...
Local_132[iVar0 /*19*/].f_14=4;
func_116(&(Local_132[iVar0 /*19*/].f_6));
}}elseif(!func_64(Local_132[iVar0 /*19*/], 780511057)){
func_116(&(Local_132[iVar0 /*19*/].f_6));
...
}elseif(func_493(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_494() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_504(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_515(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_514()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
var func__512(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
Vector3 func__543(struct<5> Param0, var uParam5, var uParam6, var uParam7){
switch (Param0.f_4){
case 0:
