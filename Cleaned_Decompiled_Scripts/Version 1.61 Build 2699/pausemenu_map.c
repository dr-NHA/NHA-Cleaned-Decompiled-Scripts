...
elseif(func_271(iLocal_249, &uLocal_292)){
...
void func_1(){
if(MISC::IS_BIT_SET(Global_1976978, 0)){
...
}elseif(ZONE::GET_HASH_OF_MAP_AREA_AT_COORDS(Local_181)==joaat("City")){
...
var func__7(){
return MISC::IS_BIT_SET(Global_2715699.f_1.f_2809, 7);
}
...
iLocal_288=223;
}elseif(func_167(iLocal_276)){
iLocal_288=224;
}elseif(func_166(iLocal_276)){
iLocal_288=232;
}elseif(func_165(iLocal_276)){
iLocal_288=245;
}elseif(func_164(iLocal_276)){
iLocal_288=246;
}elseif(func_8(iLocal_276)){
iLocal_288=251;
}elseif(func_163(iLocal_276)){
iLocal_288=252;
}elseif(func_162(iLocal_276)){
iLocal_288=253;
}elseif(func_161(iLocal_276)){
iLocal_288=161;
}elseif(func_160(iLocal_276)){
iLocal_288=278;
}elseif(func_159(iLocal_276)){
iLocal_288=279;
}elseif(func_158(iLocal_276)){
iLocal_288=302;
}elseif(func_157(iLocal_276)){
iLocal_288=303;
}elseif((iLocal_288==0 && func_156(iLocal_276, 0)) && !Global_262145.f_10081){
...
elseif(iLocal_235==9){
iLocal_288=165;
}}elseif((iLocal_288==2 && func_154(iLocal_276)) && !Global_262145.f_10081){
iLocal_288=184;
}
iLocal_272=1;
}else{
...
Global_1837297=100;
func_146();
}elseif(((((((((((((((iVar4==545 || iVar4==546) || func_145(iVar4)) || iVar4==565) || iVar4==571) || iVar4==610) || iVar4==611) || iVar4==641) || iVar4==785) || iVar4==786) || iVar4==809) || iVar4==726) || (iVar4==315 && HUD::GET_BLIP_COLOUR(iLocal_180)==func_144(126))) || (iVar4==305 && HUD::GET_BLIP_COLOUR(iLocal_180)==func_144(15))) || iVar4==835) || iVar4==836){
func_146();
}}
...
bool func_77(){
return MISC::IS_BIT_SET(Global_2714762.f_3, 2);
}
...
Var1={
func_139(func_140(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32)) 
};
if(SYSTEM::VMAG(Var1) > 0f){
return Var1;
}}else{
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_84(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
...
}}elseif(((Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1 && Global_1575058) && iParam0==PLAYER::PLAYER_ID()) && func_84(iParam0, 1, 0)){
return func_88(Global_2689235[iParam0 /*453*/].f_318.f_6)==20;
}}
return 0;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_84(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(((((((((((Global_1853348[PLAYER::PLAYER_ID() /*834*/]==14 || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==15) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==13) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==6) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==5) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==32) || func_199()) || MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_833, 6)) || func_192(PLAYER::PLAYER_PED_ID(), 1215605247, 0, uParam0, 0, 500, 1, 0)) || func_191(PLAYER::PLAYER_ID(), 0)) || func_190(PLAYER::PLAYER_ID(), 1, 0)) || Global_1853348[PLAYER::PLAYER_ID() /*834*/]==148){
return 9;
}
...
if(func_204()){
return 7;
}}}elseif(!func_170(1, 0) && !func_170(1, 1)){
return 5;
}elseif(func_170(1, 0) && !func_170(1, 1)){}elseif(!func_170(1, 0) && func_170(1, 1)){}
return 0;
}
...
}}}elseif(OBJECT::IS_PLAYER_ENTIRELY_INSIDE_GARAGE(iParam1, iVar2, fParam4, -1)){
if(bParam6){
return 1;
}elseif(iParam5 <=0 || MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), *uParam3)) >=iParam5){
return 1;
...
return 0;
}}elseif(OBJECT::IS_PLAYER_PARTIALLY_INSIDE_GARAGE(iParam1, iVar2, 2)){
if(bParam6){
return 1;
}elseif(iParam5 <=0 || MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), *uParam3)) >=iParam5){
return 1;
...
return 0;
}}elseif(Var3.f_7 !=0 && OBJECT::IS_PLAYER_PARTIALLY_INSIDE_GARAGE(iParam1, iVar2, 3)){
if(bParam6){
return 1;
}elseif(iParam5 <=0 || MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), *uParam3)) >=iParam5){
return 1;
...
elseif(PED::IS_PED_IN_ANY_VEHICLE(iVar0, false)){
...
int func_200(){
var uVar0;
if(MISC::IS_BIT_SET(Global_2815059.f_1794, 7)){
return 1;
}
...
int func_202(){
if(MISC::IS_BIT_SET(Global_2815059.f_1794, 28) && !MISC::IS_BIT_SET(Global_2815059.f_1794, 29)){
return 1;
}
return 0;
}
...
bool func_203(){
return MISC::IS_BIT_SET(Global_2815059.f_1795, 3);
}
...
var func__210(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
bool func_217(){
return MISC::IS_BIT_SET(func_218(6427, -1, 0), 19);
}
...
}elseif(ZONE::GET_HASH_OF_MAP_AREA_AT_COORDS(Param2)==joaat("City")){
...
func_264(iParam0, 1, iParam1, 1, "PM_TYPE", func_265(iParam12, iParam13, iParam14, iParam15, 0, iParam31), sVar2, iVar0, MISC::IS_BIT_SET(iParam14, 14));
...
iVar3++;
func_264(iParam0, iVar3, iParam1, iVar3, "PM_TYPE", func_265(iParam12, iParam13, iParam14, iParam15, 0, iParam31), sVar2, iVar0, MISC::IS_BIT_SET(iParam14, 14));
iVar3++;
...
if(iVar0 !=-1){
*sParam2={
Global_998606.f_604[iVar0 /*88*/].f_6 
};
*uParam3={
Global_998606.f_604[iVar0 /*88*/].f_22 
};
*uParam4={
Global_998606.f_604[iVar0 /*88*/].f_38 
};
...
if(iVar0 !=-1){
iVar0=Global_1836751.f_31[iVar0];
}}elseif(iVar1==315 && iVar2==func_144(126)){
iVar0=func_292(252);
if(iVar0 !=-1){
iVar0=Global_1836751.f_31[iVar0];
}}elseif(iVar1==305 && iVar2==func_144(126)){
iVar0=func_292(253);
if(iVar0 !=-1){
iVar0=Global_1836751.f_31[iVar0];
}}elseif(iVar1==726){
...
if(iVar0 >=31){
*sParam2={
Global_1020252.f_5[iVar0 /*88*/].f_6 
};
}else{
StringCopy(sParam2, PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_ID()), 64);
}
*uParam3={
Global_1020252.f_5[iVar0 /*88*/].f_22 
};
*uParam4={
Global_1020252.f_5[iVar0 /*88*/].f_38 
};
...
if(iVar0 !=-1){
MemCopy(sParam2,{
Global_2657492.f_356[iVar0 /*75*/].f_10.f_6
}
, 16);
*uParam3={
Global_2657492.f_356[iVar0 /*75*/].f_10.f_12 
};
*uParam4={
Global_2657492.f_356[iVar0 /*75*/].f_10.f_28 
};
...
*uParam17=0;
*uParam18={
Global_2657492.f_356[iVar0 /*75*/].f_10 
};
*uParam20=1;
*uParam21=0;
return 1;
