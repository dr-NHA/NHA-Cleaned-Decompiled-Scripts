...
func_193();
func_41();
if(!MISC::IS_BIT_SET(uLocal_129, 3)){
func_35();
func_9();
}else{
func_1();
...
void func_1(){
if(((!MISC::IS_BIT_SET(uLocal_129, 7) && !MISC::IS_BIT_SET(uLocal_129, 6)) && iLocal_267==1) && !func_8()){
if(!func_7()){
...
void func_35(){
bool bVar0;
if((!MISC::IS_BIT_SET(uLocal_129, 4) && !func_8()) && iLocal_267==1){
...
}elseif(MISC::IS_BIT_SET(uLocal_129, 4)){
if(!func_40(&uLocal_271)){
func_39(&uLocal_271, 0, 0);
}elseif(func_38(&uLocal_271, iLocal_131, 0)){
...
int func_36(){
if((func_5(15378, -1) || MISC::IS_BIT_SET(uLocal_129, 5)) && func_5(15379, -1)){
return 1;
}
return 0;
}
...
int iVar1;
func_191();
if(MISC::IS_BIT_SET(uLocal_129, 0)){
...
Var0={
ENTITY::GET_ENTITY_COORDS(func_128(), true) 
};
Var3={
0f, 0f, ENTITY::GET_ENTITY_HEADING(func_128()) 
};
...
fVar6=50f;
}elseif(func_122(Global_4718592.f_116524) || iParam18){
...
fVar6=42,6052f;
}}elseif(func_120(Global_4718592.f_116524) || iParam17){
Var0={
...
fVar6=50f;
}elseif(iParam20 || func_119(Global_4718592.f_116524)){
Var0={
...
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_117(iVar10), func_116(iVar10), 3,5688f, 7,9792f, 4,1641f) 
};
Var3={
-21,6791f, 0f, (func_116(iVar10) + 40,237f) 
};
fVar6=70f;
}elseif(bParam22 || func_115()){
if(bParam22){
Var0={
...
fVar6=50f;
}elseif(iParam24 || func_111(Global_4718592.f_116524)){}elseif(iParam25 || (func_109() && func_108(249))){
Var0={
...
if(!func_107()){
iVar9=0;
}}elseif(bParam26){}elseif(func_106(Global_4718592.f_116524)){
Var0={
...
}elseif(bVar14 || (!func_148(PLAYER::PLAYER_ID(), 0) && !func_88())){
...
*fParam2=69f;
}}elseif(func_113(Global_4718592.f_116524)){
*uParam0={
...
Vector3 func__133(int iParam0, int iParam1){
switch (iParam0){
case 11:
...
if(func_138(Global_4718592.f_168757) && MISC::IS_BIT_SET(Global_4718592.f_170137.f_2808, 2)){
...
bool func_194(){
return MISC::IS_BIT_SET(uLocal_129, 1);
}
...
func_263(0, 0);
}elseif(func_211(PLAYER::PLAYER_ID())){
func_263(0, 0);
}}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_70(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
}elseif(func_38(&uLocal_269, 750, 0)){
iVar1=-1;
}else{
SYSTEM::WAIT(0);
}}
