...
void func_11(){
func_19(&Local_47);
if(Global_1853191==PLAYER::PLAYER_ID() && !MISC::IS_BIT_SET(Global_1888862[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*120*/].f_38.f_27, 5)){
if(func_18(&Local_47, 1, 1)){
func_17(&Local_47);
}
if(func_18(&Local_47, 0, 0)){
MISC::SET_BIT(&Global_1836144, 1);
if((((((iLocal_484==0 && !MISC::IS_BIT_SET(Global_1888862[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*120*/].f_38.f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225)){
func_12(&Local_47);
}}else{
MISC::CLEAR_BIT(&Global_1836144, 1);
}}else{
...
if(Var20.f_0 !=3){
Var34={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_45(iParam0), func_44(iParam0), 0f, 2) 
};
Var37={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_45(iParam0), func_44(iParam0), 0f, 2) 
};
fVar40=Var37.f_2;
...
if(MISC::IS_BIT_SET(Global_1888862[iParam0 /*120*/].f_38.f_27, 3)){
return 1;
}}}
return 0;
}
