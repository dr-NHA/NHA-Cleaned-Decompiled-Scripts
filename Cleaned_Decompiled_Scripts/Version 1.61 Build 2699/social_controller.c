...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_139, 6);
}
...
iVar26=0;
while (iVar26 < iVar25){
iVar27=SOCIALCLUB::SC_LICENSEPLATE_GET_PLATE(iLocal_334, iVar26);
...
SOCIALCLUB::SC_LICENSEPLATE_SET_PLATE_DATA(iVar27, iVar27, &Var28);
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_14(3763, 0, -1);
...
}elseif(func_7(&(uParam0->f_10), func_188(), 0)){
if(!uParam0->f_168){
bVar0=true;
}}
...
return MISC::IS_BIT_SET(Global_1641031.f_15[iParam0 /*24*/], 1);
}
...
}elseif(DATAFILE::DATADICT_GET_TYPE(sParam0, "camh")==2){
...
Vector3 func__85(char* sParam0, char* sParam1){
struct<3> Var0;
var* uVar3;
if(DATAFILE::DATADICT_GET_TYPE(sParam0, sParam1)==5){
Var0={
DATAFILE::DATADICT_GET_VECTOR(sParam0, sParam1) 
};
}elseif(DATAFILE::DATADICT_GET_TYPE(sParam0, sParam1)==6){
...
Vector3 func__86(char* sParam0){
struct<3> Var0;
if(sParam0==0){
return 0f, 0f, 0f;
}
Var0={
func_85(sParam0, "start") 
};
...
bool func_108(){
return MISC::IS_BIT_SET(Global_2714762, 21);
}


bool func_109(){
return MISC::IS_BIT_SET(Global_2714762, 19);
}
...
var func__114(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7){
var uVar0;
...
return;
}elseif(iParam0==Global_1659759[func_30(-1)]){
return;
}}}
...
}}elseif(func_155() || func_151(PLAYER::PLAYER_ID())){
...
while (iVar0 < 94){
iVar1=iVar0;
if(!MISC::IS_BIT_SET(Global_91229[iVar1 /*34*/].f_15, 6)){
...
char cVar0[16];
if(!MISC::IS_BIT_SET(Global_91229[iParam0 /*34*/].f_15, 7)){
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
Global_2359296[func_191() /*5567*/].f_593.f_56={
func_192() 
};
}else{
...
iLocal_129=0;
iLocal_131=1;
}}}elseif(func_190(&uLocal_125, &uLocal_130)){
...
func_201(3);
}}elseif(Global_2359296[func_191() /*5567*/].f_593.f_63[iLocal_74]==0){
func_200(iLocal_74);
}}}else{
switch (iLocal_73){
case 0:
...
Var26={
Global_113386.f_20118[0 /*43*/] 
};
Var69={
Global_113386.f_20118.f_130[0 /*41*/] 
};
}elseif(iParam0==1){
iVar2=1;
...
Var26={
Global_113386.f_20118[1 /*43*/] 
};
Var69={
Global_113386.f_20118.f_130[1 /*41*/] 
};
}elseif(iParam0==2){
iVar2=2;
...
Var26={
Global_113386.f_20118[2 /*43*/] 
};
Var69={
Global_113386.f_20118.f_130[2 /*41*/] 
};
}elseif(iParam0==3){
iVar3=func_15();
iVar2=(3 + iVar3);
...
Var69={
Global_2359296[func_191() /*5567*/].f_593 
};
...
}}}elseif((iParam0==0 && Global_113386.f_9085.f_99.f_58[135]) || (iParam0==2 && Global_113386.f_9085.f_99.f_58[136])){
...
}}elseif(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_160(PLAYER::PLAYER_ID(), 1, 1)){
...
}elseif(func_404(PLAYER::PLAYER_ID(), 1, 0)){
}elseif(!func_161()){
}elseif(Var69.f_38){
...
elseif(Var69.f_27 > 0 && !MONEY::NETWORK_CAN_SPEND_MONEY(Var69.f_27, false, true, false, -1, 0)){
Var69.f_39=1;
iLocal_122=0;
}
else{
...
Var69.f_35=0;
Var69.f_34=0;
}}elseif(func_290(96, "SOCIAL_CARAPP", VEHICLE::GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Var69.f_0), 0, -99, 0, 0, 0, 0)){
Var69.f_33=0;
Var69.f_36=1;
Var69.f_35=0;
}
...
Var69.f_35=0;
Var69.f_34=0;
}}}elseif((!func_454(0) && !func_454(3)) && !func_454(2)){
...
iVar235=0;
}}elseif(!func_254(iParam0) || func_255()){
iVar235=0;
}
...
}elseif(((!func_172(0) && func_251(1, 0)==0) && (Global_113386.f_9085 || func_250(0))) && (MISC::IS_BIT_SET(Global_113386.f_9085.f_2[27 /*3*/], 1) || func_250(0))){
iLocal_110[iParam0]=1;
...
iVar242=0;
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || MISC::IS_BIT_SET(Global_1585857[iLocal_76 /*142*/].f_103, 17)){
MISC::SET_BIT(&iVar242, 0);
}
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || MISC::IS_BIT_SET(Global_1585857[iLocal_76 /*142*/].f_103, 18)){
...
case 1:
case 2:
Global_113386.f_20118[iParam0 /*43*/]={
Var26 
};
Global_113386.f_20118.f_130[iParam0 /*41*/]={
Var69 
};
break;
case 3:
...
Var7={
func_244(joaat("mpply_started_mp")) 
};
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_229(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
var func__232(struct<7> Param0, int iParam7){
var uVar0;
var uVar1;
var uVar2;
...
var func__242(struct<6> Param0, var uParam6){
var uVar0;
if(Param0.f_0 > 0){
...
if(func_81()==0){
return MISC::IS_BIT_SET(func_47(func_258(iParam0), -1, 0), iParam1);
}}else{
...
var func__266(int iParam0, int iParam1){
...
return 1;
}}elseif(func_279(func_283()) >=iParam0){
return 1;
}}
return 0;
}
...
return 20;
}elseif(func_374(iParam1)){
return 0;
}elseif(func_373(iParam1, -1)){
return 10;
}elseif(iParam1==115){
return 8;
}elseif(iParam1==116){
...
if(MISC::IS_BIT_SET(Global_2689235[Global_1853184 /*453*/].f_197, 24) || func_377(Global_1853184)){
return 1;
}}}}
...
if(!MISC::IS_BIT_SET(Global_1585857[iParam1 /*142*/].f_77, 9)){
if(uParam0->f_18){
iVar0 +=25000;
}}
...
iVar0 +=100;
}elseif(uParam0->f_17==1 && Global_1585857[iParam1 /*142*/].f_9[22] <=0){
iVar0 +=2000;
}}
if(uParam0->f_19 !=-1){
if(uParam0->f_19 !=1 && Global_1585857[iParam1 /*142*/].f_9[18] > 0){
iVar0 +=1000;
}elseif(uParam0->f_19==1 && Global_1585857[iParam1 /*142*/].f_9[18] <=0){
iVar0 +=24000;
}}
...
var func__416(int iParam0, int iParam1){
var uVar0;
int iVar1;
...
var func__417(var uParam0, int iParam1){
var uVar0;
...
return 1;
}elseif(func_427(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
uParam0->f_16=MISC::IS_BIT_SET(Global_1585857[iParam1 /*142*/].f_77, 9);
uParam0->f_19={
Global_1585857[iParam1 /*142*/].f_1 
};
...
uParam0->f_40=MISC::IS_BIT_SET(Global_1585857[iParam1 /*142*/].f_103, 25);
uParam0->f_41=MISC::IS_BIT_SET(Global_1585857[iParam1 /*142*/].f_103, 26);
...
if(MISC::IS_BIT_SET(Global_1585857[iParam1 /*142*/].f_77, 13)){
uParam0->f_1=-1;
}
if(MISC::IS_BIT_SET(Global_1585857[iParam1 /*142*/].f_77, 12)){
uParam0->f_2=-1;
}
...
if(((iVar2 >=0 && Global_1585857[iVar2 /*142*/].f_66 !=0) && (!MISC::IS_BIT_SET(Global_1585857[iVar2 /*142*/].f_103, 1) || MISC::IS_BIT_SET(Global_1585857[iVar2 /*142*/].f_103, 2))) && func_216(Global_1585857[iVar2 /*142*/].f_66)){
if(func_457(iVar2, &iVar3)){
if(!MISC::IS_BIT_SET(Global_1585857[iVar2 /*142*/].f_103, 26)){
...
if(iVar2 >=0 && (Global_1585857[iVar2 /*142*/].f_66==0 || (MISC::IS_BIT_SET(Global_1585857[iVar2 /*142*/].f_103, 1) && !MISC::IS_BIT_SET(Global_1585857[iVar2 /*142*/].f_103, 2)))){
...
case 1:
iVar2=-1;
if(((Global_2359296[func_191() /*5567*/].f_681.f_2 !=Global_2359296[func_191() /*5567*/].f_593.f_85 && Global_2359296[func_191() /*5567*/].f_681.f_2 !=-1) && Global_1585857[Global_2359296[func_191() /*5567*/].f_681.f_2 /*142*/].f_66 !=0) && (!MISC::IS_BIT_SET(Global_1585857[Global_2359296[func_191() /*5567*/].f_681.f_2 /*142*/].f_103, 1) || MISC::IS_BIT_SET(Global_1585857[Global_2359296[func_191() /*5567*/].f_681.f_2 /*142*/].f_103, 2))){
iVar2=Global_2359296[func_191() /*5567*/].f_681.f_2;
Global_2359296[func_191() /*5567*/].f_593.f_85=iVar2;
}elseif(Global_2359296[func_191() /*5567*/].f_593.f_86 !=0){
...
iVar0=0;
while (iVar0 <=362){
if(((func_457(iVar0, &iVar1) && Global_1585857[iVar0 /*142*/].f_66 !=0) && (!MISC::IS_BIT_SET(Global_1585857[iVar0 /*142*/].f_103, 1) || MISC::IS_BIT_SET(Global_1585857[iVar0 /*142*/].f_103, 2))) && func_216(Global_1585857[iVar0 /*142*/].f_66)){
iVar4++;
}
if(iVar4 > (10 - iVar3)){
}
...
if(MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_30, 3)){
return 1;
}}
return 0;
}
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_160(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
...
}elseif(VEHICLE::GET_VEHICLE_CLASS_FROM_NAME(iParam0)==func_477(iParam1)){
return 1;
}
break;
}
...
if(iLocal_76 >=0 && MISC::IS_BIT_SET(Global_1585857[iLocal_76 /*142*/].f_103, 26)){
iVar16=0;
while (iVar16 < 10){
...
iLocal_330=1;
}}elseif((Global_113386.f_20118.f_130[0 /*41*/].f_36 || Global_113386.f_20118.f_130[1 /*41*/].f_36) || Global_113386.f_20118.f_130[2 /*41*/].f_36){
iLocal_330=1;
}
iLocal_86=0;
iLocal_74=0;
...
iLocal_68=20;
}elseif(func_521(PLAYER::PLAYER_ID())){
iLocal_68=12;
}elseif(func_520(PLAYER::PLAYER_ID())){
iLocal_68=13;
}elseif(func_519(PLAYER::PLAYER_ID())){
iLocal_68=14;
}elseif(func_518(PLAYER::PLAYER_ID())){
iLocal_68=16;
}elseif(func_517(PLAYER::PLAYER_ID())){
iLocal_68=15;
}elseif(func_516(PLAYER::PLAYER_ID())){
iLocal_68=19;
}elseif(func_515(PLAYER::PLAYER_ID()) || func_514(PLAYER::PLAYER_ID())){
iLocal_68=18;
}else{
iLocal_68=3;
}}
