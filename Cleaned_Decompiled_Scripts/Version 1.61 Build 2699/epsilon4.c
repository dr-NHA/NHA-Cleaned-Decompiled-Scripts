...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_93(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_93(iParam1))){
return 1;
}
return 0;
}
...
Local_772.f_9=1;
Local_772.f_1=3;
}elseif(ENTITY::IS_ENTITY_DEAD(Local_606[0 /*8*/], false)){
func_242(6);
Local_772.f_9=2;
Local_772.f_1=3;
}elseif(ENTITY::IS_ENTITY_DEAD(Local_606[1 /*8*/], false)){
func_242(6);
Local_772.f_9=3;
Local_772.f_1=3;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_606[0 /*8*/], PLAYER::PLAYER_PED_ID(), true) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_606[0 /*8*/], 0, 2)){
func_242(6);
Local_772.f_9=4;
Local_772.f_1=3;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_606[1 /*8*/], PLAYER::PLAYER_PED_ID(), true) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_606[1 /*8*/], 0, 2)){
func_242(6);
Local_772.f_9=5;
Local_772.f_1=3;
...
float fVar6;
Var0={
func_241(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var2={
ENTITY::GET_ENTITY_COORDS(Local_606[1 /*8*/], true) 
};
...
uParam0->f_1=2;
uParam0->f_2=0;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(*uParam0, 2106541073)==7){
...
Var4={
func_354(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
