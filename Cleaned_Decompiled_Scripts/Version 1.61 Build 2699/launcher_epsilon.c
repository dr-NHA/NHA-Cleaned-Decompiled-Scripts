...
while (!MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 5)){
if(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("mission_stat_watcher")) > 0){
...
Global_106934.f_25[0 /*295*/][iVar1 /*98*/]={
Global_103950.f_25[0 /*295*/][iVar1 /*98*/] 
};
Global_106934.f_25[1 /*295*/][iVar1 /*98*/]={
Global_103950.f_25[1 /*295*/][iVar1 /*98*/] 
};
iVar0=0;
while (iVar0 < 12){
...
iVar0=0;
while (iVar0 < 44){
Global_106934.f_812[iVar1 /*477*/][iVar0 /*5*/]={
Global_103950.f_812[iVar1 /*477*/][iVar0 /*5*/] 
};
iVar0++;
}
iVar0=0;
while (iVar0 < 51){
Global_106934.f_812[iVar1 /*477*/].f_221[iVar0 /*5*/]={
Global_103950.f_812[iVar1 /*477*/].f_221[iVar0 /*5*/] 
};
iVar0++;
}
iVar0=0;
...
Global_106934.f_2884={
Global_103950.f_2884 
};
Global_106934.f_2884.f_3=Global_103950.f_2884.f_3;
Global_106934.f_2890={
Global_103950.f_2890 
};
Global_106934.f_2890.f_3={
Global_103950.f_2890.f_3 
};
...
Global_106934.f_2890.f_12.f_1={
Global_103950.f_2890.f_12.f_1 
};
...
Global_106934.f_2890.f_12.f_9={
Global_103950.f_2890.f_12.f_9 
};
Global_106934.f_2890.f_12.f_59={
Global_103950.f_2890.f_12.f_59 
};
...
Vector3 func__79(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_81(Var18, -Var0.f_3.f_2) 
};
Var18={
func_81(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__81(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
}elseif(MISC::IS_PS3_VERSION() || func_107()){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_139(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
if((MISC::IS_BIT_SET(Global_113386.f_18574[2 /*6*/], 3) || MISC::IS_BIT_SET(Global_113386.f_18574[4 /*6*/], 3)) || MISC::IS_BIT_SET(Global_113386.f_18574[4 /*6*/], 3)){
...
if(MISC::IS_BIT_SET(Global_113386.f_18574[2 /*6*/], 3) || MISC::IS_BIT_SET(Global_113386.f_18574[3 /*6*/], 3)){
HUD::SET_BLIP_SPRITE(*iParam1, 381);
}else{
HUD::SET_BLIP_SPRITE(*iParam1, 66);
}
...
if((MISC::IS_BIT_SET(Global_113386.f_18574[21 /*6*/], 3) || MISC::IS_BIT_SET(Global_113386.f_18574[22 /*6*/], 3)) || MISC::IS_BIT_SET(Global_113386.f_18574[23 /*6*/], 3)){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_182() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_182() /*5567*/].f_681.f_10, iParam0);
}
...
if(iParam5==0){
Global_78130[1 /*14*/]={
func_256(iVar10, iParam1, iParam2, -1) 
};
if(!func_255(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78130[1 /*14*/]={
func_256(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_238(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78130[1 /*14*/]={
func_256(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78130[1 /*14*/]={
func_256(iVar10, iVar0, func_217(iParam0, iVar0, -1), -1) 
};
...
uVar69={
func_238(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78130[1 /*14*/]={
func_256(iVar10, 14, uVar69[iVar1], -1) 
};
func_228(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
func_251(14);
if(Global_78128==1){
...
Global_78130[1 /*14*/]={
func_256(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78130[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_218(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_218(iParam1))){
return 1;
}
return 0;
}
...
Global_78130[1 /*14*/]={
func_256(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_246(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_245(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
func_495("ARE_RC_TRIGGER_CONDITIONS_MET:
RC_TRIG_CHAR - Used special case Eps 4 trigger.");
return 1;
}}
}}else{
return 0;
}}elseif(func_392(uParam0->f_28[0])){
if(func_325(uParam0)){
if(func_329(2)){
if(func_327(uParam0->f_27)){
func_326(uParam0->f_27, *uParam0);
...
elseif((VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), joaat("cargobob")) || VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), joaat("cargobob2"))) || VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), joaat("cargobob3"))){
...
if(func_327(uParam0->f_27)){
func_326(uParam0->f_27, *uParam0);
func_495("RC5_IN_ACTIVATION_RANGE:
...
if(func_327(1)){
func_326(1, *uParam0);
func_495("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_495("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if(!func_364()){
iLocal_97=0;
}elseif(func_343(PLAYER::PLAYER_PED_ID(), 1826,45f, 4699,58f, 38,15f, 1) >=28f){
func_363();
iLocal_97=0;
}
break;
...
if(bParam4){
return 0;
}elseif(func_373(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__377(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_381(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_381(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__381(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_381(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
struct<27> Var0;
if(Global_78319){
func_495("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_415(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
if(!MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 2)){
return 1;
}
return 0;
}
...
return MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 2);
}
...
if(MISC::IS_BIT_SET(Global_113386.f_18574[iParam0 /*6*/], 0)){
