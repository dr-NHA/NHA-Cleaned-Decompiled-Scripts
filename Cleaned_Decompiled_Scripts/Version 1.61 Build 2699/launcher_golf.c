...
bVar2=false;
}}elseif(!ENTITY::IS_ENTITY_AT_COORD(iLocal_85, ScriptParam_0.f_1[0 /*3*/], fLocal_117, fLocal_117, 2f, false, true, iLocal_103)){
bVar2=false;
}
...
}}}elseif(iVar3 < iLocal_118 || iVar3 >=iLocal_119){
func_62(&uLocal_94, 128);
bVar2=false;
if(fLocal_93 < ((fLocal_117 * fLocal_117) + 4f)){
if(!func_90(uLocal_94, 134217728)){
...
elseif(!func_90(uLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_43(&iLocal_96);
