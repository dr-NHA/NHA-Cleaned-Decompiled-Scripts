...
elseif(!HUD::DOES_BLIP_EXIST(iLocal_192)){
...
func_105();
iLocal_47=9;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_114[0], PLAYER::PLAYER_PED_ID(), true)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_167)){
if(ENTITY::IS_ENTITY_ATTACHED(iLocal_167)){
ENTITY::DETACH_ENTITY(iLocal_167, true, true);
}
...
elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117[0], PLAYER::PLAYER_PED_ID(), true)){
func_73(2);
func_53();
}
break;
...
Local_198={
ENTITY::GET_ENTITY_COORDS(iLocal_117[0], false) 
};
if(iLocal_49==1){
Local_198={
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_18() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_18() /*5567*/].f_681.f_10, iParam0);
}
...
Local_107={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_114[0], 1,2f, 1,5f) 
};
}}else{
Local_107={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_114[0], true), 1,2f, 1,5f) 
};
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_175)){
Local_107={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_175, false), 1,2f, 1,5f) 
};
}
Local_107={
...
iLocal_151=1;
}elseif(PED::IS_PED_INJURED(iLocal_184) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_184, false)){
iLocal_151=1;
}
...
struct<3> Var3;
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_167, true) 
};
Var3={
