...
Var1788={
ENTITY::GET_ENTITY_COORDS(ScriptParam_0.f_4, true) 
};
}
...
if(!MISC::IS_BIT_SET(Global_113347, 0)){
...
elseif(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_263[0])){
if(!bVar1775){
if(!func_426(&iVar1804)){
func_441(&iVar1804);
}elseif(func_429(&iVar1804) > 0,5f){
...
if(!func_426(&iVar1804)){
func_441(&iVar1804);
}elseif(func_429(&iVar1804) > 0,25f){
func_425(iLocal_263[1]);
func_427(&iVar1804);
bVar1775=true;
}
...
if(!MISC::IS_BIT_SET(Global_113347, 10)){
...
elseif(Global_113386.f_18970.f_5 >=3 && Global_113386.f_18970.f_7 >=0,66f){
Var0.f_249.f_4=1;
}
else{
Var0.f_249.f_4=0;
...
if(iLocal_267){
Var3={
ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_290 /*26*/], true) 
};
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_62() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_62() /*5567*/].f_681.f_10, iParam0);
}
...
Global_2097536.f_2780.f_29[1]=5;
Global_2097536.f_2780.f_29[2]=5;
}elseif(func_235(Global_4718592.f_168757)){
StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE", 24);
StringCopy(&(Global_2097536.f_2717[1 /*6*/]), "SCLB_C_DEATH", 24);
StringCopy(&(Global_2097536.f_2717[2 /*6*/]), "SCLB_C_RANK", 24);
Global_2097536.f_2710[0]=0;
...
}}elseif(!PED::IS_PED_INJURED((*iParam0)[1])){
...
if(!MISC::IS_BIT_SET(Global_113347, 3)){
...
if(!MISC::IS_BIT_SET(Global_113347, 4)){
...
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_55), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) 
};
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/])){
...
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_11.f_1 + fLocal_55), uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_11.f_2) 
};
...
uParam0->f_24=0;
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_11, (uParam0->f_11.f_1 + fLocal_55), uParam0->f_11.f_2) 
};
ENTITY::SET_ENTITY_COORDS(*uParam0, Var0, true, false, false, true);
return 1;
}
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_2, (uParam0->f_2.f_1 + fLocal_55), uParam0->f_2.f_2) 
};
ENTITY::SET_ENTITY_COORDS(*uParam0, Var0, true, false, false, true);
...
Var7={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, Local_82) 
};
Var10={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_8, (uParam0->f_8.f_1 + fLocal_55), uParam0->f_8.f_2) 
};
...
struct<3> Var0;
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_55), uParam0->f_14.f_2) 
};
if(iParam3==1){
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_55), uParam0->f_14.f_2) 
...
iLocal_95=1;
if(!MISC::IS_BIT_SET(Global_113347, 1)){
...
Var6={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, (uParam0->f_14 + 0,0035f), (uParam0->f_14.f_1 + fLocal_55), uParam0->f_14.f_2) 
};
...
if(iParam0==0){
if(!MISC::IS_BIT_SET(Global_113347, 9)){
...
}}elseif(iParam1 && !MISC::IS_BIT_SET(Global_113347, 7)){
...
if(!MISC::IS_BIT_SET(Global_113347, 8)){
if((!func_309("DARTS_SHT_USE") && !func_309("DARTS_INSTR_W")) && !func_309("DARTS_INSTR_B")){
...
if(!MISC::IS_BIT_SET(Global_113347, 2)){
...
if(iParam0 >=10){
if(!MISC::IS_BIT_SET(Global_113386.f_18970.f_6, 12)){
*uParam1=12;
return 1;
}}
return 0;
...
}elseif(func_402() && MISC::GET_GAME_TIMER() > Global_4539962){
if(Global_4539961==uParam0->f_660){
iVar2=func_401(0);
if(iVar2==-1 || iVar2==1){
iVar1=1;
...
func_381(iParam0);
return 1;
}elseif(func_7(iParam0) > 0,25f){
func_441(iParam0);
return 1;
}}elseif(func_426(iParam0)){
func_427(iParam0);
}
return 0;
}
...
Local_79={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_1, uParam0->f_4, Local_82) 
};
...
*uParam0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, 0f, 0f, 0f) 
};
}
...
*uParam0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam1->f_1, uParam1->f_4, -0,4f, (-2,4f + fLocal_55), -1,7272f) 
};
uParam0->f_3={
...
iParam0->f_18={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param2, fParam5, -0,687645f, -0,350352f, 0,343273f) 
};
iParam0->f_21={
...
Var3={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param0, fParam3, Var22) 
};
Var9={
fVar26, 0f, (fParam3 - fVar25) 
};
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param0, fParam3, Var27) 
};
Var6={
fVar31, 0f, (fParam3 - fVar30) 
};
Var12={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param0, fParam3, Var32) 
};
Var15={
0,8351f, -0,0048f, (fParam3 - 186,5073f) 
};
Var35={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param0, fParam3, Var38) 
};
Var18={
0,8351f, -0,0048f, (fParam3 - 186,5073f) 
};
