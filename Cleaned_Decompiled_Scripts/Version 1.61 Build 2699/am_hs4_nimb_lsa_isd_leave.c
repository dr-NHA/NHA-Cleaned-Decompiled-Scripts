...
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar2))){
}else{
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_154(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_154(4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar5))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_151(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_150()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_154(iVar6 + 1))){
...
}elseif(func_146(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_147() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
Vector3 func__159(struct<3> Param0){
...
if(func_164(13, -1)){
return 0;
}elseif(func_164(14, -1)){
return 0;
}elseif(func_164(15, -1)){
return 0;
}elseif(func_164(16, -1)){
return 0;
}elseif(func_164(71, -1)){
return 0;
}elseif(func_164(72, -1)){
}
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78130[1 /*14*/]={
func_208(iVar0, iParam1, iParam2, -1) 
};
...
}}elseif(func_193(iVar0, 4, iParam2, &uVar68)){
return func_192(iParam0, 4, uVar68);
}}
...
var func__234(var uParam0, int iParam1){
var uVar0;
...
var func__261(bool bParam0){
if(bParam0){
return (MISC::IS_BIT_SET(Global_4718592.f_162497, 12) && func_262());
}
...
elseif(func_114(PLAYER::PLAYER_ID(), 1) && Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_76.f_21 !=0){
return 1;
}}
break;
default:
