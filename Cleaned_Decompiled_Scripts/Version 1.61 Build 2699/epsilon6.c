...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_98(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_98(iParam1))){
return 1;
}
return 0;
}
...
func_245();
}elseif((func_244(PLAYER::PLAYER_PED_ID(), Local_174.f_0, 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_174.f_0, true), 3f, false)) || PED::IS_PED_BEING_JACKED(Local_174.f_0)){
if(iLocal_190 !=5 && iLocal_190 !=3){
bLocal_233=true;
}
iLocal_264=5;
...
func_245();
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_174.f_0, PLAYER::PLAYER_PED_ID(), true)){
...
float fVar6;
Var0={
func_256(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_256(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return func_340(2, 2);
}elseif(func_339(Global_1853185)){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_377(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
iLocal_191=2;
}}}elseif(func_404(PLAYER::PLAYER_PED_ID(), Local_174.f_0, 5f, 1)){
if(func_481(PLAYER::PLAYER_PED_ID()) && func_481(Local_174.f_0)){
Local_764={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
};
Local_767={
ENTITY::GET_ENTITY_COORDS(Local_174.f_0, true) 
};
...
Vector3 func__406(struct<3> Param0){
...
iLocal_214=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_174.f_0, true), true) > fLocal_251){
iLocal_264=2;
iLocal_191=0;
iLocal_190=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
iLocal_214=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, true), true) > 150f){
if(func_417()){
bLocal_233=true;
}
iLocal_264=1;
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, true), true) > 250f){
if(func_417()){
bLocal_233=true;
}
iLocal_264=1;
...
func_415("*** Plane 'entity' health:
", ENTITY::GET_ENTITY_HEALTH(Local_156.f_0));
func_414("*** Plane engine health:
", VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_156.f_0));
func_414("*** Plane petrol tank health:
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, true), true) > 120f){
if(func_417()){
bLocal_233=true;
}
iLocal_264=1;
...
if(func_242()){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_156.f_0, true) 
};
if(Var0.f_2 > 15f){
...
iLocal_190=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_156.f_0, true), true) > 50f){
if(!iLocal_214){
if(AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
...
Var4={
func_454(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
