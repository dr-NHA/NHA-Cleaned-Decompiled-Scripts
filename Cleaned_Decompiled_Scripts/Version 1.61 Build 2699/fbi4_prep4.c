...
return 1;
}elseif(func_136(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if(!func_184() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
var func__209(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(Global_113386.f_2363.f_539.f_2395[1]==-99){
func_243(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
}elseif(Global_113386.f_2363.f_539.f_2395[2]==-99){
...
func_243(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
}elseif(Global_113386.f_2363.f_539.f_2395[0]==-99){
func_243(sLocal_208[0], sLocal_208[1], sLocal_208[2]);
}elseif(Global_113386.f_2363.f_539.f_2395[2]==-99){
func_243(sLocal_208[2], sLocal_208[1], sLocal_208[0]);
}
...
Global_78130[1 /*14*/]={
func_285(iParam0, iParam1, iParam2, -1) 
};
