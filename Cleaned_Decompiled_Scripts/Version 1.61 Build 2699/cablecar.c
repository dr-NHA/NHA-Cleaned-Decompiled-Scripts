...
if(Local_364.f_9){
iVar0++;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -742,3477f, 5587,019f, 40,66549f, -742,1461f, 5602,772f, 49,8471f, 12,25f, false, true, 0)){
if(Local_329.f_9){
iVar0++;
}
if(Local_364.f_9){
...
Global_78130[1 /*14*/]={
func_163(iVar10, iVar0, func_124(iParam0, iVar0, -1), -1) 
};
...
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(5f, 0f, 0f) 
};
