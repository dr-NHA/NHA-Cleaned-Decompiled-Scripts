...
iLocal_1093=1;
}}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_1088, 200f, 200f, 200f, false, true, 0)){
iLocal_1093=0;
}
if(!iLocal_1098){
...
}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_909, false)){
func_36(iLocal_909);
...
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_909, false)){
if(VEHICLE::IS_VEHICLE_SIREN_ON(iLocal_909)){
VEHICLE::SET_VEHICLE_SIREN(iLocal_909, false);
}
...
HUD::CLEAR_PRINTS();
iLocal_1086=0;
}elseif(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_909)){
if(!iLocal_1096){
func_11("AHP_LOSECOPS", 7500, 1);
iLocal_1096=1;
iLocal_1087=MISC::GET_GAME_TIMER();
}}elseif((iLocal_1096 && (MISC::GET_GAME_TIMER() - iLocal_1087) < 7500) && HUD::IS_MESSAGE_BEING_DISPLAYED()){
HUD::CLEAR_PRINTS();
}
...
}}elseif(!HUD::DOES_BLIP_EXIST(iLocal_908)){
iLocal_908=func_40(iParam0, 0, 0);
}}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam0, false)){
if(HUD::DOES_BLIP_EXIST(iLocal_908)){
HUD::REMOVE_BLIP(&iLocal_908);
}
if(!HUD::DOES_BLIP_EXIST(iLocal_907)){
...
return 0;
}}elseif(func_80(&(Global_113386.f_18103.f_175[iVar5 /*19*/].f_9), iParam3, &iVar3, &iVar4, uParam4)){
if(bParam7){
...
}elseif(SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Global_96938.f_9[iLocal_1134], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 2500f && ENTITY::IS_ENTITY_OCCLUDED(Global_96938.f_9[iLocal_1134])){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96938.f_9[iLocal_1134], true, true);
...
bLocal_1099=false;
}}elseif((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_910, false) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_910, false)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_909, iLocal_910)){
bLocal_1099=true;
}}
