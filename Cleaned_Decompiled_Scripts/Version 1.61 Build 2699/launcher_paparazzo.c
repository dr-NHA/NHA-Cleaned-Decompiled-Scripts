...
func_285("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_179(uParam0->f_27)){
func_178(uParam0->f_27, *uParam0);
func_285("RC5_IN_ACTIVATION_RANGE:
...
if(func_179(1)){
func_178(1, *uParam0);
func_285("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_285("RC_STOP_PLAYER_VEHICLE_CHECK:
...
struct<27> Var0;
if(Global_78319){
func_285("IS_RC_FINE_AND_IN_RANGE():
...
Vector3 func__219(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_223(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_223(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__223(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_223(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
