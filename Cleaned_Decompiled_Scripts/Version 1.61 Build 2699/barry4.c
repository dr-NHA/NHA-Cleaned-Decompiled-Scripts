...
Var4={
func_236(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
return 1;
}elseif(func_273(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_317(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_318() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_333(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_291(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_291(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_291(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_291(4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_291(iVar5))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_344(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_343()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_291(iVar6 + 1))){
