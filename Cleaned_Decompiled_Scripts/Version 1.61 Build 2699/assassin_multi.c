...
func_44(&iLocal_1612);
iLocal_1034=1;
}elseif(func_158(&iLocal_1612, 2f)){
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_200(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(*uParam1, -1273030092) !=1){
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_2208[iVar0 /*9*/], 242628503) !=1 && TASK::GET_SCRIPT_TASK_STATUS(Local_2208[iVar0 /*9*/], -2017877118) !=1){
...
if(!func_510(iParam1)){
func_44(iParam1);
}elseif(func_45(iParam1) >=fParam2){
*uParam4=1;
return 1;
}}else{
func_44(iParam1);
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_2208[iVar0 /*9*/], 1805844857) !=1){
...
iLocal_1031=1;
}elseif(func_510(&iLocal_1039) && func_45(&iLocal_1039) < 3f){
iLocal_1031=1;
}
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 2f, 3);
return 1;
...
iLocal_1520=1;
}elseif(!PHYSICS::DOES_ROPE_EXIST(&iLocal_1565)){
if(!PED::IS_PED_INJURED(Local_1049.f_0)){
if(!iLocal_1520){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1049.f_0, true, 1);
PED::SET_PED_TO_RAGDOLL(Local_1049.f_0, 1, 1, 0, true, true, false);
...
Var9={
ENTITY::GET_ENTITY_COORDS(uParam1->f_11[0], true) 
};
}else{
Var9={
uParam0->f_249[0 /*3*/] 
...
return func_338(2, 2);
}elseif(func_337(Global_1853185)){
...
Vector3 func__338(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_340(Var18, -Var0.f_3.f_2) 
};
Var18={
func_340(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__340(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_358(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
}elseif((!func_439(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_458(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_457()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_297(iVar6 + 1))){
...
var func__448(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(func_454(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_455() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_498(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
Vector3 func__506(struct<3> Param0){
float fVar0;
float fVar1;
