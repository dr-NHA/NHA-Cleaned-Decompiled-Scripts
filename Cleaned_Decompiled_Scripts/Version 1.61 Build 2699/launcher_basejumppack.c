...
Var6={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(iLocal_297, false) 
};
Var6.f_2=0f;
...
Var9={
ENTITY::GET_ENTITY_COORDS(iLocal_297, false) + Var6 
};
if(iLocal_122==12){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_297)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_297, true) 
};
