...
return func_118(2, 2);
}elseif(func_117(Global_1853185)){
...
Vector3 func__118(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_120(Var18, -Var0.f_3.f_2) 
};
Var18={
func_120(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__120(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return;
}}}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_ground"))==0){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_48, false)){
