...
elseif(TASK::GET_SCRIPT_TASK_STATUS((*uParam0)[iVar0 /*24*/], 1647992574)==7){
...
if(!PED::IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], true)){
Var7={
ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], true) 
};
Var10={
...
elseif(MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], true), 6f, true, true)){
(uParam0[iVar0 /*24*/])->f_1=7;
}
...
if(!FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())){
FIRE::START_ENTITY_FIRE(PLAYER::PLAYER_PED_ID());
}}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2455,487f, 4997,566f, 43,1101f, 2423,653f, 4962,837f, 57,34888f, 14,4375f, false, true, 0)){
if(Var0.f_2 < 50f){
...
Var2={
ENTITY::GET_ENTITY_COORDS(Local_755[iVar1 /*33*/], false) 
};
...
}}elseif(!func_236(Var3, HUD::GET_BLIP_COORDS(iParam0->f_5), 0,1f, 0)){
...
bVar1=true;
}}elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Param1, Param4, bParam13, bVar6, iVar7)){
bVar1=true;
}
if(bVar1){
bVar1=true;
...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_219()) || !func_234(iParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
}}elseif(!MISC::IS_BIT_SET(iParam0->f_13, 3)){
func_240(iParam0, sParam24, 0);
MISC::SET_BIT(&(iParam0->f_13), 3);
MISC::CLEAR_BIT(&(iParam0->f_13), 4);
}elseif(!MISC::IS_BIT_SET(iParam0->f_13, 4)){
...
return 1;
}}}elseif(func_232(1, 0, 1) || MISC::IS_BIT_SET(iParam0->f_13, 7)){
return 1;
}
return 0;
}
...
Var28={
ENTITY::GET_ENTITY_COORDS(iVar13, true) 
};
if(Var28.f_2 < -1f){
...
iVar6=0;
}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, false)){
...
elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, false)){
uParam0->f_1[iVar0]=func_230(uParam0->f_17[iVar0], 0, 0);
HUD::SET_BLIP_DISPLAY(uParam0->f_1[iVar0], 2);
iVar6=0;
...
return 1;
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam1, fParam2, fParam2, 3f, false, true, 0)){
return 1;
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iParam1, fParam2, fParam2, 3f, false, true, 0)){
if(!bParam3){
iVar0=PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID());
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_342(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_341()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_290(iVar6 + 1))){
...
}elseif(func_338(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_339() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif(func_408(*uParam0, "v_hospital", 307,3065f, -589,9595f, 43,302f)){
*uParam0={
...
if(func_25()==0){
return MISC::IS_BIT_SET(func_393(func_413(iParam0), -1, 0), iParam1);
}}else{
...
Vector3 func__416(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_418(2, 2);
}elseif(func_417(Global_1853185)){
...
Var18={
func_420(Var18, -Var0.f_3.f_2) 
};
Var18={
func_420(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__420(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_437(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
