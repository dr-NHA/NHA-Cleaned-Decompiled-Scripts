...
func_2(2);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_392, PLAYER::PLAYER_PED_ID(), true)){
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_392, -1519143300)==1){
...
float fVar6;
Var0={
func_36(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
}elseif(func_42(iLocal_392) && ENTITY::IS_ENTITY_AT_COORD(iLocal_392, Local_380, 50f, 50f, 50f, false, true, 0)){
func_50(iLocal_392);
}else{
func_53(&iLocal_392, 1, 0, 1);
}}
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_403, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) 
};
if(Var0.f_1 < -1f){
return 1;
}elseif(Var0.f_0 < -1f){
...
return func_299(2, 2);
}elseif(func_298(Global_1853185)){
...
Var18={
func_301(Var18, -Var0.f_3.f_2) 
};
Var18={
func_301(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__301(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_319(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
}elseif(((iVar2==1 && !func_42(iLocal_394[0])) || ((iVar2==2 && !func_42(iLocal_394[0])) && !func_42(iLocal_394[1]))) && !func_351()){
func_349(&uLocal_107, 6, iLocal_394[iVar2], "MEJimmyKidnapper2", 1, 1);
func_28();
func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_2", 7, 0, 0);
}elseif((iVar2==1 && func_42(iLocal_394[0])) || (iVar2==2 && (func_42(iLocal_394[0]) || func_42(iLocal_394[1])))){
...
func_342();
}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_403, false)){
iLocal_277=1;
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS")){
AUDIO::STOP_AUDIO_SCENE("M_E_JIMMY_STOP_KIDNAPPERS");
}
...
Var1={
func_36(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
Var4={
...
fLocal_386=200f;
fLocal_387=500f;
}}elseif(func_226(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_403)){
...
iLocal_316=0;
}}}elseif(((iLocal_310 < 8 && func_226(PLAYER::PLAYER_PED_ID(), iLocal_394[0]) < 50f) && !func_27()) && !func_383("MEJ1_02", 0, 0)){
...
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_421, Local_424, fLocal_433, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_427, Local_430, fLocal_434, false, true, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_403, Local_405, true, false, false, true);
ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
return 1;
}}
...
return 1;
}elseif(func_459(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_268(iVar6 + 1))){
