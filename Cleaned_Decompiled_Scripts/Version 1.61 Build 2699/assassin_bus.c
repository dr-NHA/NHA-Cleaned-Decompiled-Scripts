...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_12() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_12() /*5567*/].f_681.f_10, iParam0);
}
...
}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_multi"))==1){
...
}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_hooker"))==1){
...
}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_bus"))==1){
...
}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_construction"))==1){
...
return (func_169(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
}}
return iParam0->f_1;
}
...
}elseif(func_183(&iLocal_1844, 10f)){
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam0->f_1, false)){
Var3={
ENTITY::GET_ENTITY_COORDS(iParam0->f_1, false) 
};
Var0={
...
iLocal_1755=2;
}}elseif(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && ENTITY::DOES_ENTITY_EXIST(iParam0->f_1)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam0->f_1, false)){
Var3={
ENTITY::GET_ENTITY_COORDS(iParam0->f_1, false) 
};
...
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0->f_1, false)){
if(ENTITY::DOES_ENTITY_EXIST(*iParam0)){
...
func_186(&iLocal_1039);
}}elseif(ENTITY::IS_ENTITY_TOUCHING_ENTITY(iParam0->f_1, *iParam0) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(iParam0->f_1, iParam0->f_8)){
func_186(&iLocal_1039);
}}}}}
...
elseif(func_168(&iLocal_1829) >=IntToFloat(iLocal_1739)){
func_219(iParam0);
}}}
}
else{
...
Local_1783={
ENTITY::GET_ENTITY_COORDS(iParam1->f_1, true) 
};
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
Local_1786={
...
if(func_171(iParam0)){
if(!func_170(iParam0)){
iParam0->f_2=(func_169(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
...
}elseif(((TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 1805844857) !=1 && TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 1805844857) !=0) && TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 242628503) !=1) && TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 242628503) !=0){
TASK::TASK_SMART_FLEE_PED(*iParam0, PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
}}
func_247(iParam0, 0);
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_260(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
func_247(uParam2, 0);
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iParam0, -1794415470) !=1){
func_279(iParam0);
}}}else{
func_279(iParam0);
}}
...
}}}}elseif(func_168(&iLocal_1838) >=2f){
...
CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
}elseif(CAM::DOES_CAM_EXIST(iLocal_1810)){
CAM::DESTROY_CAM(iLocal_1810, false);
}
...
elseif(!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam1->f_8, false)){
}
...
HUD::DISPLAY_HUD(false);
}}elseif(CAM::DOES_CAM_EXIST(iLocal_142)){
if(CAM::IS_CAM_ACTIVE(iLocal_142)){
CAM::SET_CAM_ACTIVE(iLocal_142, false);
CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
HUD::DISPLAY_HUD(true);
...
Var4={
ENTITY::GET_ENTITY_COORDS(uParam0->f_1, true) 
};
fVar10=ENTITY::GET_ENTITY_HEADING(uParam0->f_1);
Var7={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var4, fVar10, 2f, 5,6201f, 0,1098f) 
};
...
if(bLocal_1716){
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Var4, fVar7, 2,519f, 5,6f, 0,1098f) 
};
...
fLocal_1789=160,65f;
Local_1777={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1768, fLocal_1789, Var1) 
};
}elseif(iParam1==1){
Local_1768={
...
if(bLocal_1716){
Local_1765={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1768, fLocal_1789, 2f, 5,6201f, 0,1098f) 
};
}elseif(bLocal_1717){
Local_1765={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_1768, fLocal_1789, 2f, 5,6201f, 0,1098f) 
...
Var11={
ENTITY::GET_ENTITY_SPEED_VECTOR(PLAYER::PLAYER_PED_ID(), false) 
};
Var14={
...
Var1={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_2250[iVar0 /*30*/].f_1, Local_2250[iVar0 /*30*/].f_4, 0f, 3f, 0f) 
};
...
iLocal_1031=1;
}elseif(func_171(&iLocal_1039) && func_168(&iLocal_1039) < 3f){
iLocal_1031=1;
}
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 2f, 3);
return 1;
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_1, false)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, false)){
...
return func_413(2, 2);
}elseif(func_412(Global_1853185)){
...
Vector3 func__413(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_415(Var18, -Var0.f_3.f_2) 
};
Var18={
func_415(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__415(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
iParam0->f_1=(func_169(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
Vector3 func__482(struct<3> Param0){
float fVar0;
float fVar1;
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_521(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_520()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_162(iVar6 + 1))){
...
}elseif(func_517(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_518() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
