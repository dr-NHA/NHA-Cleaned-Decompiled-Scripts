...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_43()) || !func_54(iParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
if(func_96()){
func_337();
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1298,369f, -3062,1f, -71,22691f, 790,9125f, -3068,998f, 63,91419f, 250f, false, false, 0)){
...
return func_157(2, 2);
}elseif(func_156(Global_1853185)){
...
Var18={
func_159(Var18, -Var0.f_3.f_2) 
};
Var18={
func_159(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__159(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
case 1:
Local_430={
ENTITY::GET_ENTITY_COORDS(Local_169[8 /*2*/], true) 
};
if(Local_430.f_2 <=1f){
...
iLocal_445=1;
iLocal_2129++;
}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_381) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_381) >=0,7f){
...
func_266(12);
iLocal_2129++;
}elseif(func_267(func_268(0), 0) && !func_267(func_268(1), 0)){
...
case 5:
Var1={
ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], true) 
};
...
func_195(1);
iLocal_2129=0;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], true), true) < 5f && !iLocal_388){
...
}elseif(iLocal_2128==2 && Local_64[iLocal_382 /*10*/]==Local_64[3 /*10*/]){
...
func_93(10);
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_55[0 /*2*/], true), true) > 700f){
...
iLocal_399=2;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], true), true) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 8,5f){
AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
...
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_64[4 /*10*/], true), true) < 12f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
if(!func_285(Local_64[4 /*10*/], 1464580341, 1)){
TASK::TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0f, false, false, false);
...
}elseif(ENTITY::IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1228,849f, -2986,284f, 8,31909f, 2f, 2f, 2f, false, true, 0)){
TASK::WAYPOINT_PLAYBACK_PAUSE(Local_64[4 /*10*/], false, false);
}
}
else{
...
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_64[4 /*10*/], PLAYER::PLAYER_PED_ID(), true)){
AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
TASK::TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0f, false, false, false);
func_224(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
iLocal_399=3;
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_64[4 /*10*/], 923520851) !=1){
...
iLocal_458=2;
}}elseif(func_287(&uLocal_213, "DHP1AUD", "DHP1_WHSE", "DHP1_WHSE_2", 7, 0, 0)){
iLocal_458=2;
}
break;
case 2:
...
iLocal_458=2;
}}elseif(func_287(&uLocal_213, "DHP1AUD", "DHP1_PARK", "DHP1_PARK_2", 7, 0, 0)){
iLocal_458=2;
}
break;
case 2:
