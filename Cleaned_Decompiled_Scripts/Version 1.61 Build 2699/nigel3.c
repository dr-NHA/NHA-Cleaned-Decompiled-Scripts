...
void func_1(){
iLocal_532=0;
if(!MISC::IS_BIT_SET(Global_113386.f_18574.f_382, 5)){
...
Local_543={
ENTITY::GET_ENTITY_COORDS(Local_165.f_0, true) 
};
}}
...
func_282();
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_165.f_0, true);
...
if(bVar0){
Var4={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_283, "out_trunk_trevor", Local_284, Local_287, PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_290), 2) 
};
...
func_251(&iLocal_294);
iLocal_617=0;
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_165.f_0, false)){
HUD::CLEAR_PRINTS();
func_251(&iLocal_294);
...
Var0={
ENTITY::GET_ENTITY_SPEED_VECTOR(Local_557.f_0, false) 
};
Var3={
ENTITY::GET_ENTITY_SPEED_VECTOR(Local_165.f_0, false) 
};
...
Var9={
ENTITY::GET_ENTITY_COORDS(Local_557.f_0, false) 
};
...
if(func_238(Local_557.f_0)){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_557.f_0, true) 
};
if(!bLocal_624){
if(Var0.f_1 < 1824,36f){
iLocal_625=MISC::GET_GAME_TIMER();
bLocal_624=true;
}elseif(ENTITY::DOES_ENTITY_EXIST(Local_557.f_6) && ENTITY::IS_ENTITY_DEAD(Local_557.f_6, false)){
iLocal_625=MISC::GET_GAME_TIMER();
bLocal_624=true;
}}
if(bLocal_624){
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_304(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
return func_369(2, 2);
}elseif(func_368(Global_1853185)){
...
Vector3 func__369(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_371(Var18, -Var0.f_3.f_2) 
};
Var18={
func_371(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__371(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
iLocal_279=1;
iLocal_158=1;
}elseif(SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_229[0], &(uLocal_258[0]), &(Local_261[0 /*7*/][0 /*3*/]), &(Local_261[0 /*7*/][1 /*3*/]), &(uLocal_276[0])) !=1 && SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_229[1], &(uLocal_258[1]), &(Local_261[1 /*7*/][0 /*3*/]), &(Local_261[1 /*7*/][1 /*3*/]), &(uLocal_276[0])) !=1){
if(uLocal_258[0]==1 || uLocal_258[1]==1){
func_317("N3TRUNK", -1);
iLocal_279=2;
iLocal_158=1;
...
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
iLocal_158=2;
}elseif(ENTITY::IS_ENTITY_AT_COORD(Local_165.f_0, Local_295, 6f, 6f, 2f, true, true, 0)){
iLocal_158=2;
}elseif(bLocal_314){
...
iLocal_157=11;
}elseif(ENTITY::IS_ENTITY_AT_COORD(Local_165.f_0, Local_295, 6f, 6f, 2f, false, true, 0)){
iLocal_157=6;
STREAMING::REQUEST_MODEL(joaat("freightcar"));
STREAMING::REQUEST_MODEL(joaat("freightcont1"));
STREAMING::REQUEST_MODEL(joaat("freightcont2"));
...
Vector3 func__476(struct<3> Param0){
float fVar0;
float fVar1;
...
if(bParam4){
return 0;
}elseif(func_507(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__511(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_476(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_476(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
float fVar6;
Var0={
func_476(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
iLocal_567=3;
return 0;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_176, PLAYER::PLAYER_PED_ID(), true)){
iLocal_567=2;
return 0;
}}else{
iLocal_567=2;
...
iLocal_567=5;
return 0;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_177, PLAYER::PLAYER_PED_ID(), true)){
iLocal_567=4;
return 0;
}}else{
iLocal_567=4;
...
Var4={
func_534(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
