...
elseif((!func_199(Local_49[3 /*6*/]) || (func_199(Local_116[2 /*4*/]) && PED::IS_PED_IN_VEHICLE(Local_49[3 /*6*/], Local_116[2 /*4*/], true))) && (!func_199(Local_49[4 /*6*/]) || (func_199(Local_116[2 /*4*/]) && PED::IS_PED_IN_VEHICLE(Local_49[4 /*6*/], Local_116[2 /*4*/], true)))){
bVar0=true;
}
if(bVar0){
Local_49[iParam0 /*6*/].f_3++;
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 1, false);
Local_49[iParam0 /*6*/].f_3++;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_49[iParam0 /*6*/], -1273030092)==1 && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(Local_49[iParam0 /*6*/])){
TASK::TASK_DRIVE_BY(Local_49[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 0, Local_139, 500f, 100, true, joaat("FIRING_PATTERN_BURST_FIRE"));
}
}
break;
...
elseif(!func_98(Local_49[iParam0 /*6*/], -1794415470, 1)){
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 1, false);
Local_49[iParam0 /*6*/].f_3=5;
}elseif(!func_199(VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(Local_49[iParam0 /*6*/], false), -1, false))){
