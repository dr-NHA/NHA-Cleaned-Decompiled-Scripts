...
iLocal_164=1;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[0], 242628503)==1){
...
VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_58, true);
iLocal_164=1;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_54[1], 242628503)==1){
...
elseif(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iLocal_53)){
PED::SET_ENABLE_HANDCUFFS(iLocal_53, true);
PED::SET_ENABLE_BOUND_ANKLES(iLocal_53, true);
ENTITY::SET_ENTITY_HEALTH(iLocal_53, 0, 0);
}}
...
}}}elseif(((!PED::IS_PED_IN_GROUP(iLocal_53) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_53, false)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, 242628503) !=1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, 242628503) !=0){
...
}}}elseif(!HUD::DOES_BLIP_EXIST(iLocal_114)){
iLocal_114=func_68(iLocal_53, 0, 145);
}
if(!PED::IS_PED_IN_GROUP(iLocal_53)){
...
iLocal_51=1;
return 1;
}elseif(!MISC::IS_BULLET_IN_AREA(Local_88, 100f, true) || !MISC::IS_BULLET_IN_AREA(Local_88, 100f, true)){
iLocal_51=1;
return 1;
}}
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_53, false);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_53, true);
}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_53, false)){
PED::SET_ENABLE_HANDCUFFS(iLocal_53, true);
PED::SET_ENABLE_BOUND_ANKLES(iLocal_53, true);
}}
iVar0=0;
