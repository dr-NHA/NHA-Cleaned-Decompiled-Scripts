...
func_48(iParam0, 1, 0);
func_47(iParam0);
}elseif(func_9(&(iParam0->f_6), 6) && func_50(iParam0)){
...
bool func_29(){
return (!MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_809, 4) && !func_30());
}
...
bool func_49(){
return MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_809, 3);
}
...
bool func_56(){
return MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_809, 2);
}
...
if(MISC::IS_BIT_SET(Global_2689235[iParam0 /*453*/].f_197, 4)){
return 1;
}}
return 0;
}
...
return (iParam0 !=-1 && MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_809, 1));
}
...
var func__75(){
return MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_809, 1);
}
