...
elseif(((!ENTITY::IS_ENTITY_OCCLUDED(iLocal_54) && iLocal_48==4) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_96, Local_99, fLocal_102, false, true, 0)) || func_158()){
func_139(1);
}
...
}}}elseif(((bLocal_109 && !OBJECT::DOES_PICKUP_EXIST(iLocal_137)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, false)) && !bLocal_121){
if(iLocal_511 !=1){
...
iLocal_511=1;
func_135(&uLocal_305, 0, 0);
}}}elseif(OBJECT::DOES_PICKUP_EXIST(iLocal_137)){
if(iLocal_511 !=2){
...
if(bLocal_109){
Param0={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -3,3f, 0f), 1,2f, 1,5f) 
};
}else{
Param0={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_51[iLocal_130], false), 1,2f, 1,5f) 
};
}}
...
Local_477={
ENTITY::GET_ENTITY_COORDS(iLocal_56, true) - ENTITY::GET_ENTITY_COORDS(iLocal_54, true) * Vector(1,5f, 1,5f, 1,5f) 
};
...
}elseif(MISC::GET_RATIO_OF_CLOSEST_POINT_ON_LINE(ENTITY::GET_ENTITY_COORDS(iLocal_56, true), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, Local_470), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, Local_473), false) >=1f){
iLocal_49=3;
iLocal_123[0]=0;
iLocal_123[1]=0;
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_59)){
HUD::REMOVE_BLIP(&iLocal_59);
}
...
}}elseif(HUD::GET_BLIP_ALPHA(iLocal_59) !=255){
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_64)){
...
return 1;
}elseif(!ENTITY::IS_ENTITY_OCCLUDED(iParam0) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true)) < 300f){
return 1;
}}
return 0;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_54, false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
Var0={
func_35(ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true))) 
};
...
Var5[0 /*3*/]={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_54, true), fVar3, 0f, 4,5f, 0f) 
};
Var5[1 /*3*/]={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_54, true), fVar4, 0f, 4,5f, 0f) 
};
func_78(&fVar3);
func_78(&fVar4);
...
Local_491={
PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_panic", Local_485, Local_488, 0f, 2) 
};
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_92(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
return MISC::IS_BIT_SET(Global_113386.f_24995.f_6, iParam0);
}
...
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(iLocal_54, true) 
};
Var3={
ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_54) 
};
Var6={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) 
};
...
Local_491={
PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_calm", Local_485, Local_488, 0f, 2) 
};
bLocal_496=false;
iLocal_497=0;
