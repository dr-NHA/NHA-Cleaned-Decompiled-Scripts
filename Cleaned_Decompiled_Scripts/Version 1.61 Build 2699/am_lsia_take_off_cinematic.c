...
var func__83(int iParam0, bool bParam1){
var uVar0;
bool bVar1;
int iVar2;
bVar1=false;
...
if(func_90()==0){
return MISC::IS_BIT_SET(func_87(func_89(iParam0), -1, 0), iParam1);
}}else{
...
iVar1=iParam0;
return MISC::IS_BIT_SET(uVar0, func_115(iVar1));
}
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_151(iVar6 + 1))){
...
}elseif(func_143(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_144() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
if(bParam0){
return (MISC::IS_BIT_SET(Global_4718592.f_162497, 12) && func_260());
}
...
elseif(func_111(PLAYER::PLAYER_ID(), 1) && Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_76.f_21 !=0){
return 1;
}}
break;
default:
