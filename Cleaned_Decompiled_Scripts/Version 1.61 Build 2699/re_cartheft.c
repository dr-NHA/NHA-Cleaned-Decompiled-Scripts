...
elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_77, PLAYER::PLAYER_PED_ID(), true)){
if(!PED::IS_PED_INJURED(iLocal_76)){
...
elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_77, iLocal_75, 20f, 20f, 7f, false, true, 0)){
func_63();
if(func_62()){
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_63)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_77, false)){
...
Local_310={
ENTITY::GET_ENTITY_COORDS(iLocal_77, true) 
};
Local_313={
...
iLocal_51=4;
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_302) && !bLocal_342){
...
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_302)){
if(iLocal_316==0){
...
}}elseif(!HUD::DOES_BLIP_EXIST(iParam1->f_1)){
iParam1->f_1=0;
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_88(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Local_52 
};
...
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -583,0884f, -2234,249f, 4,523423f, -685,1817f, -2350,904f, 17,07073f, 178f, false, true, 0)){
