...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_211(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_211(iParam1))){
return 1;
}
return 0;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_344(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(!func_102(Local_254[0 /*6*/])){
Local_112.f_10=13;
}elseif(((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f, 1)) || !func_372(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f)){
Local_112.f_10=13;
...
float fVar6;
Var0={
func_192(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
}}}elseif(Local_112.f_10==24 && func_64(Local_112.f_9, -1519143300)){
if(func_112(Local_112.f_9, Local_692, 25f, 1)){
...
float fVar6;
Var0={
func_192(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return 1;
}elseif(func_469(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_492(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_493() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_178(iVar6 + 1))){
