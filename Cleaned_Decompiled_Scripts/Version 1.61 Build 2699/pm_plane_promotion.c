...
func_143();
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_50)){
HUD::CLEAR_PRINTS();
...
bLocal_326=false;
}}elseif(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_332)){
...
}}elseif(!func_41(Var3, HUD::GET_BLIP_COORDS(iParam0->f_5), 0,1f, 0)){
...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_40()) || !func_38(iParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
return 1;
}}}elseif(func_36(1, 0, 1) || MISC::IS_BIT_SET(iParam0->f_13, 7)){
return 1;
}
return 0;
}
