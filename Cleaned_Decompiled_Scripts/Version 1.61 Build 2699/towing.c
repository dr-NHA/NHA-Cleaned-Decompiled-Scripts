...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_3109, true) 
};
}
...
func_59(&(iParam0->f_5));
func_58(iParam0, 1051260355);
}elseif(func_4(&(iParam0->f_5)) > 0,33f){
func_57(&(iParam0->f_2));
return 0;
}}
return 1;
...
}elseif(Global_113386.f_19973.f_3==1){
func_171(&Local_2348, "TOWAUD", "TOW_TUT_ENDB", 9, 0, 0, 0);
}elseif(Global_113386.f_19973.f_3==4){
...
elseif(ENTITY::IS_ENTITY_AT_COORD(iLocal_3109, ENTITY::GET_ENTITY_COORDS(Local_2996[iParam1 /*20*/], true), 50f, 50f, 50f, false, true, 0)){
if(!iLocal_2977){
if(Global_113386.f_19973.f_7==0 || Global_113386.f_19973.f_7==1){
func_257(&Local_2348, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
func_257(&Local_2348, 5, Local_2996[iParam1 /*20*/], "TOWBREAKM", 0, 1);
...
Var12={
ENTITY::GET_ENTITY_COORDS(Local_2996[*uParam4 /*20*/].f_6, true) 
};
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_155(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_2984) && !ENTITY::IS_ENTITY_DEAD(iLocal_2984, false)){
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_2984, true) 
};
}
...
func_120(&iLocal_2598);
}}elseif(!PED::IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, false)){
func_120(&iLocal_2598);
}}
switch (iLocal_3119){
case 0:
...
Var0={
ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_7, true) 
};
...
iLocal_3119=6;
}elseif(func_10(Local_2996[0 /*20*/].f_6, Var0, 1) < 10f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_2996[0 /*20*/].f_6, Local_650[iLocal_2604 /*23*/].f_13, Local_650[iLocal_2604 /*23*/].f_16, Local_650[iLocal_2604 /*23*/].f_19, false, true, 0)){
iLocal_2934=1;
if(!ENTITY::IS_ENTITY_DEAD(iLocal_3109, false) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, false)){
if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6)){
VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(iLocal_3109, Local_2996[0 /*20*/].f_6);
...
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_3109, false) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, false)){
...
}elseif(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], false)){
TASK::OPEN_SEQUENCE_TASK(&iLocal_421);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
...
TASK::TASK_ENTER_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 20000, -1, 2f, 1, 0);
iLocal_3118=7;
}}elseif(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], false) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, false)){
...
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_3109, false)){
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], 1056466932) !=1){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, true);
}}}
}}}}
break;
...
if(ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], false)){
iLocal_3118=8;
}elseif(((fVar1 > 35f || (func_4(&iLocal_3097) > 30f && fVar1 > 5f)) || iVar0) || (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))){
if(bLocal_2964){
func_257(&Local_2348, 5, Local_2996[0 /*20*/], "TOWABDHANDMAN2", 0, 1);
sVar2="TOW_PED_ANCU";
}elseif(bLocal_2965){
...
if(!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, false)){
Var3={
ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, true) 
};
}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
Var0={
...
return;
}elseif(!HUD::DOES_BLIP_EXIST(*iParam1) && bLocal_467){
