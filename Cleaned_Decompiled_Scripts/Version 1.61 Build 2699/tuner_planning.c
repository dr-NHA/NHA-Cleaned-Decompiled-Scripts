...
uParam0->f_726.f_5=0;
uParam0->f_704=0;
}}}}elseif((Global_1974423[uParam0->f_1084 /*25*/].f_23 && func_29(uParam0->f_1084, 1)) && !iLocal_272){
func_27(1);
iLocal_272=1;
}
...
if(iParam0 !=-1){
return MISC::IS_BIT_SET(Global_1977138[iParam0 /*57*/].f_1, 3);
}
return 0;
}
...
if(iParam0 !=-1){
return MISC::IS_BIT_SET(Global_1977138[iParam0 /*57*/].f_1, 2);
}
return 0;
}
...
if(iParam0 !=-1){
return MISC::IS_BIT_SET(Global_1977138[iParam0 /*57*/].f_1, 1);
}
return 0;
}
...
Var0={
ENTITY::GET_ENTITY_COORDS(func_161(), true) 
};
Var3={
0f, 0f, ENTITY::GET_ENTITY_HEADING(func_161()) 
};
if(func_51(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_775, 1, 0)){
Var0={
...
fVar6=50f;
}elseif(func_156(Global_4718592.f_116524) || iParam18){
...
fVar6=42,6052f;
}}elseif(func_154(Global_4718592.f_116524) || iParam17){
Var0={
...
fVar6=50f;
}elseif(iParam20 || func_153(Global_4718592.f_116524)){
Var0={
...
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_151(iVar10), func_150(iVar10), 3,5688f, 7,9792f, 4,1641f) 
};
Var3={
-21,6791f, 0f, (func_150(iVar10) + 40,237f) 
};
fVar6=70f;
}elseif(bParam22 || func_149()){
if(bParam22){
Var0={
...
fVar6=50f;
}elseif(iParam24 || func_145(Global_4718592.f_116524)){}elseif(iParam25 || (func_143() && func_142(249))){
Var0={
...
if(!func_97()){
iVar9=0;
}}elseif(bParam26){}elseif(func_141(Global_4718592.f_116524)){
Var0={
...
*fParam2=69f;
}}elseif(func_147(Global_4718592.f_116524)){
*uParam0={
...
Vector3 func__166(int iParam0, int iParam1){
switch (iParam0){
case 11:
...
if(func_171(Global_4718592.f_168757) && MISC::IS_BIT_SET(Global_4718592.f_170137.f_2808, 2)){
...
Var1={
func_261(func_262(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_32)) 
};
if(SYSTEM::VMAG(Var1) > 0f){
return Var1;
}}else{
...
}}}}elseif(func_231(iParam0) && !func_230(iParam0)){
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_35(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
...
}}elseif(((Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1 && Global_1575058) && iParam0==PLAYER::PLAYER_ID()) && func_35(iParam0, 1, 0)){
return func_159(Global_2689235[iParam0 /*453*/].f_318.f_6)==20;
}}
return 0;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_35(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
Jump @123;
//curOff=61if(func_319(uParam0, iVar0)){
Var2={
func_291() 
};
...
return MISC::IS_BIT_SET(Local_363.f_2[(iParam1 / 32)], (iParam1 % 32));
}


var func__320(var uParam0, int iParam1){
return MISC::IS_BIT_SET(Local_363[(iParam1 / 32)], (iParam1 % 32));
}
...
return 0;
}elseif(PAD::IS_CONTROL_JUST_PRESSED(2, 187) || func_325(uParam0, 0, 1)){
return 1;
}elseif(PAD::IS_CONTROL_JUST_PRESSED(2, 189) || func_325(uParam0, 0, 2)){
return 2;
}elseif(PAD::IS_CONTROL_JUST_PRESSED(2, 190) || func_325(uParam0, 0, 3)){
return 3;
...
if(!MISC::IS_BIT_SET(func_407(9618, -1, 0), 5)){
...
if(!MISC::IS_BIT_SET(Local_363[(iParam1 / 32)], (iParam1 % 32))){}
...
if(MISC::IS_BIT_SET(func_407(9866, -1, 0), bParam0)){
return 0;
}
return 1;
}
...
var func__498(int iParam0, int iParam1){
...
bool func_666(){
return MISC::IS_BIT_SET(func_407(9618, -1, 0), 4);
}
...
if(iParam0==PLAYER::PLAYER_ID()){
return MISC::IS_BIT_SET(func_407(9618, -1, 0), 0);
}
if(iParam0 !=-1){
...
bVar0=false;
while (bVar0 < 9){
if(MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_465.f_2, bVar0)){
return bVar0;
}
bVar0++;
}}
...
if(iParam0 !=-1){
return MISC::IS_BIT_SET(Global_1977138[iParam0 /*57*/].f_3, iParam1);
}
return 0;
}
...
func_689(uParam0, 5);
uParam0->f_1091=1;
}elseif(uParam0->f_726==5 || func_690()){
func_392(2);
uParam0->f_1091=0;
}}}
