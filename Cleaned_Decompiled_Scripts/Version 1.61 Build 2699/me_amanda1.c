...
func_2(2);
}elseif(func_546(iLocal_408) && func_546(PLAYER::PLAYER_PED_ID())){
...
iLocal_406=2;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_408, PLAYER::PLAYER_PED_ID(), true)){
iLocal_406=1;
}}
switch (iLocal_406){
case 0:
...
}elseif(func_546(iLocal_408) && ENTITY::IS_ENTITY_AT_COORD(iLocal_408, Local_390, 50f, 50f, 50f, false, true, 0)){
func_11(iLocal_408);
}else{
func_17(&iLocal_408, 1, 0, 1);
}}
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_86(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_86(iParam1))){
return 1;
}
return 0;
}
...
func_218();
}}elseif(((func_8(iLocal_410) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_410, false)) && PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_410, false)) || (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_410, false) && !PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_410, false))){
func_218();
}
func_216();
...
iLocal_405=0;
iLocal_404=5;
}}elseif(((func_8(iLocal_410) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_408, iLocal_410)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_410, false)) && !func_262(iLocal_410)){
func_238();
iLocal_405=0;
iLocal_404=5;
}}
...
if(!PED::IS_PED_IN_COMBAT(iLocal_416, 0)){
TASK::TASK_ARREST_PED(iLocal_416, PLAYER::PLAYER_PED_ID());
}}elseif(!func_52(iLocal_416, 1392476864)){
TASK::TASK_ARREST_PED(iLocal_416, PLAYER::PLAYER_PED_ID());
}}
...
float fVar6;
Var0={
func_208(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_208(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return func_405(2, 2);
}elseif(func_404(Global_1853185)){
...
Vector3 func__405(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_407(Var18, -Var0.f_3.f_2) 
};
Var18={
func_407(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__407(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return 1;
}elseif(func_485(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_508(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_509() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_519(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_529(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_528()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_359(iVar6 + 1))){
...
var func__526(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
iLocal_449=0;
}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_408, true)){
PED::SET_PED_COMPONENT_VARIATION(iLocal_408, 8, 1, 0, 0);
iLocal_449=1;
}}}
