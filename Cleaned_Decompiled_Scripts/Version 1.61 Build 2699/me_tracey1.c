...
func_34(6);
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false)){
iLocal_305=1;
HUD::CLEAR_PRINTS();
func_33(&iLocal_297);
iLocal_298=func_203(iLocal_273, 1, 5);
...
iLocal_93=0;
iLocal_92=11;
}}elseif(!PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false)){
iLocal_306=1;
iLocal_307=0;
HUD::CLEAR_PRINTS();
func_33(&iLocal_297);
...
return func_252(2, 2);
}elseif(func_251(Global_1853185)){
...
Var18={
func_254(Var18, -Var0.f_3.f_2) 
};
Var18={
func_254(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__254(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
var func__271(int iParam0){
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_272(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
}}}elseif(!bLocal_605 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false)){
func_294(1, 1);
}}}}
...
if(bParam0){
Local_584[5 /*3*/]={
ENTITY::GET_ENTITY_COORDS(iLocal_290, true) 
};
}else{
Local_584[5 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_277.f_0, true) 
};
}}
...
return 1;
}elseif(func_62(iLocal_289, ENTITY::GET_ENTITY_COORDS(iLocal_290, false), 10f, 1)){
return 1;
}elseif(func_303(iLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7)){
return 1;
}elseif(func_303(iLocal_289, iLocal_290, 1126825984, 1, 250, 7)){
return 1;
}}elseif(func_303(iLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7)){
return 1;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_325(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
uParam0->f_5=1;
uParam0->f_7=1;
}}elseif(func_339(bParam1, bParam2, bParam3)){
uParam0->f_4=MISC::GET_GAME_TIMER();
uParam0->f_5=1;
uParam0->f_7=1;
...
uParam0->f_5=0;
}}elseif(func_337(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==1){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_338(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
iLocal_93=0;
iLocal_92=6;
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false)){
iLocal_93=0;
iLocal_92=6;
...
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false)){
iLocal_380=8;
}}elseif(func_347() && (MISC::GET_GAME_TIMER() - iLocal_331) > 6000){
iLocal_380=7;
...
Local_320[2 /*3*/]={
ENTITY::GET_ENTITY_COORDS(iLocal_273, true) 
};
iLocal_330=MISC::GET_GAME_TIMER();
}}
...
iLocal_92=6;
iLocal_93=0;
}elseif(func_295(Local_584[0 /*3*/], Local_584[5 /*3*/], 2f)){
iLocal_92=6;
iLocal_93=0;
}}}}
...
iLocal_613=MISC::GET_GAME_TIMER();
iLocal_617=2;
}elseif((MISC::GET_GAME_TIMER() - iLocal_613) > iLocal_616 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, -0,5f, -1,5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, 6f, 2f), 12f, false, true, 0)){
iLocal_613=MISC::GET_GAME_TIMER();
iLocal_617=1;
}}
if(iLocal_617==1){
if(bLocal_609){
iLocal_617=2;
}elseif((MISC::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_356(1)){
...
Var1={
func_309(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
Var4={
...
iVar0=3;
}}elseif(ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, Local_546[4 /*3*/], false)){
iVar0=4;
}else{
iVar0=5;
}
...
iLocal_306=1;
iLocal_307=0;
}}elseif(func_371(iLocal_289, 1, 1116471296, 1126825984, 0, 0, 0, 0)){
TASK::CLEAR_PED_TASKS(iLocal_289);
...
iLocal_545=0;
iLocal_316=7;
}}elseif(!HUD::DOES_BLIP_EXIST(iLocal_297)){
iLocal_297=func_289(Local_487[iLocal_520 /*8*/], 5, 1);
}else{
func_369();
}
...
if(bParam4){
return 0;
}elseif(func_372(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
}elseif(func_393(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_394() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_480(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_493(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_492()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_219(iVar6 + 1))){
...
var func__490(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(Var0, &Var0, &fVar3, 1, 3f, 0)){
func_515(iParam0, Var0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
}}
...
return 1;
}elseif(func_534(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
Local_341[4 /*3*/]={
func_565("MET1CHASE", 1) 
};
Local_341[5 /*3*/]={
func_565("MET1GETBKT", 1) 
};
Local_341[6 /*3*/]={
func_565("MET1DLT", 1) 
};
...
Local_341[8 /*3*/]={
func_565("MET1HOTEL", 1) 
};
}


Vector3 func__565(char* sParam0, int iParam1){
struct<3> Var0;
Var0.f_2=sParam0;
Var0.f_0=iParam1;
Var0.f_1=0;
