...
return 1;
}}elseif(func_175(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 1) <=10f){
...
return 1;
}elseif((!func_177(PLAYER::PLAYER_PED_ID(), -828834893) && func_207(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_150(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, 0, 1, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}
return 0;
}
...
return 1;
}elseif((!func_177(PLAYER::PLAYER_PED_ID(), -828834893) && func_207(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_150(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, 0, 1, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}
return 0;
}
...
func_309("ARE_RC_TRIGGER_CONDITIONS_MET:
RC_TRIG_CHAR - Used special case Eps 4 trigger.");
return 1;
}}
}}else{
return 0;
}}elseif(func_207(uParam0->f_28[0])){
if(func_181(uParam0)){
if(func_185(2)){
if(func_183(uParam0->f_27)){
func_182(uParam0->f_27, *uParam0);
...
if(func_183(uParam0->f_27)){
func_182(uParam0->f_27, *uParam0);
func_309("RC5_IN_ACTIVATION_RANGE:
...
if(func_183(1)){
func_182(1, *uParam0);
func_309("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_309("RC_STOP_PLAYER_VEHICLE_CHECK:
...
}elseif(func_219(PLAYER::PLAYER_PED_ID(), -1103,44f, 290,18f, 63,28f, 1) >=25f){
func_145();
bLocal_263=true;
iLocal_96=0;
}
...
struct<27> Var0;
if(Global_78319){
func_309("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_223(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
float fVar6;
Var0={
func_239(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_239(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
