...
iLocal_311=1;
}}}}elseif(((!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_93, iLocal_92, 35f, 35f, 35f, false, true, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_93, false)) && !func_80()) && func_2(&uLocal_134, "REBTHAU", "REBTH_PLASTE", 4, 0, 0, 0)){
func_78(0);
...
iLocal_89=4;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_93, iLocal_92, 20f, 20f, 20f, false, true, 0)){
if(func_77()){
...
float fVar6;
Var0={
func_87(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
iLocal_344=1;
}}elseif(!PED::IS_PED_IN_VEHICLE(iLocal_91, iLocal_93, false)){
return 1;
}
...
iLocal_119=0;
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_91, 40f, 40f, 40f, false, true, 0)){
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_123(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(PED::IS_PED_INJURED(iLocal_92)){
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_92, PLAYER::PLAYER_PED_ID(), true)){
func_164();
