...
}}elseif(!func_56(Var3, HUD::GET_BLIP_COORDS(iParam0->f_5), 0,1f, 0)){
...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_40()) || !func_54(iParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
return 1;
}}}elseif(func_52(1, 0, 1) || MISC::IS_BIT_SET(iParam0->f_13, 7)){
return 1;
}
return 0;
}
...
iLocal_455=MISC::GET_GAME_TIMER();
}elseif(func_190(Local_111[iLocal_447 /*14*/], -828834893, 1) || func_190(Local_111[iLocal_447 /*14*/], 451360105, 1)){
...
func_195(5);
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) > 600f){
if(!iLocal_454){
...
PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
iLocal_443=1;
}}elseif(!func_156(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 3, 0, 0)){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
...
}}elseif((ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()) && VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false)) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), true)) < 10000f){
...
}}}}elseif(func_167(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true)){
...
}}}elseif(func_165(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true)){
...
if(!MISC::IS_BIT_SET(Global_96295, bVar0)){
return 0;
}
...
if(MISC::IS_BIT_SET(Global_96294, bVar0)){
...
if(func_37(Local_94[0 /*2*/])){
Local_460={
ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], false) 
};
}
iLocal_436=0;
iLocal_435=0;
...
if(func_37(Local_94[0 /*2*/])){
Local_460={
ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], true) 
};
}
iLocal_436=0;
iLocal_435=0;
...
if(!PED::IS_PED_IN_COMBAT(Local_111[iVar0 /*14*/], 0)){
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*14*/], PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], false), ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], false), true) > (120f / 2f)){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, true);
...
iVar8=-1;
}elseif(VEHICLE::IS_VEHICLE_SEAT_FREE(iVar9, 0, false)){
iVar8=0;
}elseif(VEHICLE::IS_VEHICLE_SEAT_FREE(iVar9, 1, false)){
iVar8=1;
}elseif(VEHICLE::IS_VEHICLE_SEAT_FREE(iVar9, 2, false)){
iVar8=2;
}
if(func_175(iVar9)){
...
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*14*/], PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], false)){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, false);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, true);
PED::REMOVE_PED_DEFENSIVE_AREA(Local_111[iVar0 /*14*/], false);
PED::SET_PED_COMBAT_MOVEMENT(Local_111[iVar0 /*14*/], 2);
...
return 2;
}elseif(func_177(PLAYER::PLAYER_PED_ID(), Local_460, 1) > 120f && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], false)){
return 3;
}}
return 2;
}
...
Var1={
func_185(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) - ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], false)) 
};
Var4={
ENTITY::GET_ENTITY_VELOCITY(Local_94[1 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) 
};
...
Var7={
func_185(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) - ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], false)) 
};
Var10={
ENTITY::GET_ENTITY_VELOCITY(Local_94[2 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) 
};
...
Var13={
func_185(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) - ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], false)) 
};
Var16={
ENTITY::GET_ENTITY_VELOCITY(Local_94[0 /*2*/]) - ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) 
};
...
bool func_183(){
return MISC::IS_BIT_SET(Global_2815059.f_836, 2);
}
...
iLocal_458=0;
iLocal_433=0;
}elseif(PED::IS_PED_IN_ANY_VEHICLE(iLocal_474, false)){
TASK::TASK_VEHICLE_ESCORT(Local_111[4 /*14*/], Local_94[0 /*2*/], Local_94[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_111[0 /*14*/], Local_94[1 /*2*/], &cLocal_475, 786603, 0, 24, -1, 11f, false, 2f);
TASK::TASK_VEHICLE_ESCORT(Local_111[5 /*14*/], Local_94[2 /*2*/], Local_94[0 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
iLocal_458=1;
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_252(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
return func_313(2, 2);
}elseif(func_312(Global_1853185)){
...
Vector3 func__313(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_315(Var18, -Var0.f_3.f_2) 
};
Var18={
func_315(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__315(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
