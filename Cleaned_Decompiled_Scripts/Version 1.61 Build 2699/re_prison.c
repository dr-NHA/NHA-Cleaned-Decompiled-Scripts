...
func_88();
Local_312={
ENTITY::GET_ENTITY_COORDS(iLocal_311, true) 
};
switch (iLocal_310){
case 0:
func_86();
...
if(bLocal_572){
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_569, true) 
};
if(SYSTEM::VDIST2(Local_312, Var3) < 90000f){
if(!iLocal_573){
iLocal_573=1;
}}}}elseif(HUD::DOES_BLIP_EXIST(iLocal_571)){
...
Var1={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_408[iVar0], 0f, 3,5f, -2f) 
};
...
Var1={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[1 /*3*/], Local_629.f_10[1], -2f, 0f, 0f) 
};
Var4={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[1 /*3*/], Local_629.f_10[1], -1f, 0f, 0f) 
};
Var7={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[2 /*3*/], Local_629.f_10[2], 1f, 0f, 0f) 
};
Var10={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_629[2 /*3*/], Local_629.f_10[2], -1f, 0f, 0f) 
};
