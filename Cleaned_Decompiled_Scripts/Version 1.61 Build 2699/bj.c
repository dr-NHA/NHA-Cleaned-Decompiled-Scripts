...
if(MISC::IS_BIT_SET(Global_113386.f_18967.f_1, bVar1160)){
fVar1148=0,1f;
}
bVar872=bVar1160;
func_559(0);
...
iVar719=2;
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_462(&iVar896) || func_461(&iVar896) > 0,05f)){
...
func_434(0, 0, 1);
func_486(&iVar875);
}elseif((func_462(&iVar875) && func_461(&iVar875) > 0,2f) || bVar1176){
...
elseif(func_461(&iVar917) > 4f || (func_465(func_466(bVar872)) && func_461(&iVar917) > 0,5f)){
...
if(MISC::IS_BIT_SET(Global_113386.f_18967.f_1, (func_366(&Var16) - 125))){
...
HUD::CLEAR_PRINTS();
iVar719=10;
}elseif(func_328(&uVar101, 3, 1000) && !Global_23011.f_135){
...
}}elseif((ENTITY::DOES_ENTITY_EXIST(iVar1089) && !ENTITY::IS_ENTITY_DEAD(iVar1089, false)) && !func_431(func_369(&Var16, 0))){
...
bVar1166=false;
while (bVar1166 < 13){
if(!MISC::IS_BIT_SET(Global_113386.f_18967.f_1, bVar1166)){
...
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_77() || func_461(&iVar902) >=2f)){
...
return 0;
}elseif((!*iParam9 && func_328(uParam3, 8, 1000)) && (!PLAYER::IS_PLAYER_ONLINE() || func_263(iParam1, 26))){
*iParam9=1;
if(PLAYER::IS_PLAYER_ONLINE()){
...
Global_2097536.f_2780.f_29[1]=5;
Global_2097536.f_2780.f_29[2]=5;
}elseif(func_206(Global_4718592.f_168757)){
StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE", 24);
StringCopy(&(Global_2097536.f_2717[1 /*6*/]), "SCLB_C_DEATH", 24);
StringCopy(&(Global_2097536.f_2717[2 /*6*/]), "SCLB_C_RANK", 24);
Global_2097536.f_2710[0]=0;
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_229() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_229() /*5567*/].f_681.f_10, iParam0);
}
...
Var24={
ENTITY::GET_ENTITY_COORDS(iVar20, true) 
};
}}
...
Var9={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) 
};
...
Var8={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS((*uParam1)[iVar13], true) 
};
...
Var8={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - ENTITY::GET_ENTITY_COORDS(uVar0[iVar13], true) 
};
fVar11=((Var8.f_0 * Var8.f_0) + (Var8.f_1 * Var8.f_1));
if(Var8.f_2 * Var8.f_2) > (3f * fVar11){
bVar15=false;
...
return 0;
}elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iVar0, true), &fVar7, false, false)){
return 0;
...
return 0;
}elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(Var1, &fVar7, false, false)){
return 0;
}elseif(Var1.f_2 >=(fVar7 + 1,5f)){
return 0;
}
...
func_458(iParam7);
*uParam10=1;
}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam2, false)){
...
if(!func_462(iParam6)){
func_486(iParam6);
}elseif((uParam12 && CAM::IS_SCREEN_FADED_IN()) || (func_461(iParam6) > 0,5f && func_333(uParam4, 2))){
*uParam11=1;
func_458(iParam5);
func_458(iParam6);
return 1;
...
func_458(iParam8);
}elseif(func_461(iParam8) > func_426(bParam1, iParam9)){
switch (iParam9){
case 0:
...
Var4={
func_384(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
}elseif(!ENTITY::IS_ENTITY_DEAD(*iParam4, false)){
...
}elseif(!ENTITY::IS_ENTITY_DEAD(*iParam6, false)){
...
}elseif(ENTITY::IS_ENTITY_DEAD(*iParam1, false)){
...
}elseif(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && func_365(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))){
