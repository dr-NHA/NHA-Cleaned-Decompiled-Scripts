...
func_272("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_175(uParam0->f_27)){
func_174(uParam0->f_27, *uParam0);
func_272("RC5_IN_ACTIVATION_RANGE:
...
if(func_175(1)){
func_174(1, *uParam0);
func_272("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_272("RC_STOP_PLAYER_VEHICLE_CHECK:
...
struct<27> Var0;
if(Global_78319){
func_272("IS_RC_FINE_AND_IN_RANGE():
