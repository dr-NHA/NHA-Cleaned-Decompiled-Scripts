...
if(HUD::DOES_BLIP_EXIST(uLocal_229[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_229[iVar0]));
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_196[iVar0], PLAYER::PLAYER_PED_ID(), 30f, 30f, 30f, false, true, 0)){
if(!func_115()){
...
fLocal_185=0,75f;
fLocal_184=0,999f;
}elseif(Global_113386.f_24995.f_5 >=2){
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_166() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_166() /*5567*/].f_681.f_10, iParam0);
}
...
fLocal_185=0,8f;
fLocal_184=0,968f;
}elseif(Global_113386.f_24995.f_5==1){
...
fLocal_185=0,77f;
fLocal_184=0,999f;
}elseif(Global_113386.f_24995.f_5 >=3){
sLocal_409="ACULT_CAPT";
sLocal_403="cult_p7_guard_01";
sLocal_404="cult_p7_guard_02";
sLocal_405="cult_p7_trv";
