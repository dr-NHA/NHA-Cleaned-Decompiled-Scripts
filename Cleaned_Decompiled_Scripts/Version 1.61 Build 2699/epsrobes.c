...
iLocal_222=2;
}elseif(Global_113386.f_10049.f_105 >=240){
iLocal_222=4;
}elseif(!func_45(14)){
func_41();
iLocal_223=func_159();
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_49(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_49(iParam1))){
return 1;
}
return 0;
}
...
MemCopy(&Var3,{
func_166(Global_44257[iVar7 /*12*/].f_1)
}
, 4);
}else{
Var3={
...
iVar2=iVar20;
Var3={
func_166(Global_44257[iVar20 /*12*/].f_1) 
};
...
Var3={
func_166(Global_44257[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
