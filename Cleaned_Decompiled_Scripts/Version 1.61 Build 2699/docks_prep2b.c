...
}elseif(!PED::IS_PED_IN_VEHICLE(iLocal_31[0], iLocal_49[0], false)){
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_42(iVar6 + 1))){
...
}elseif(func_94(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_95() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
Vector3 func__126(struct<3> Param0){
float fVar0;
float fVar1;
...
}elseif(func_189(*uParam0, "v_hospital", 307,3065f, -589,9595f, 43,302f)){
*uParam0={
...
if(func_195()==0){
return MISC::IS_BIT_SET(func_173(func_194(iParam0), -1, 0), iParam1);
}}else{
...
Vector3 func__198(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_200(2, 2);
}elseif(func_199(Global_1853185)){
...
Vector3 func__200(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_202(Var18, -Var0.f_3.f_2) 
};
Var18={
func_202(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__202(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
}}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_320, -75,8f, -819,9f, 326f, true) > 1600f){
if(iLocal_30 !=0){
iLocal_215[0]=1;
iLocal_30=0;
}
...
Local_317={
ENTITY::GET_ENTITY_COORDS(iLocal_49[0], true) 
};
...
iLocal_296=0;
iLocal_297=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_188 + 10000 && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, false)){
if(iLocal_297==0){
PED::SET_PED_ACCURACY(iLocal_31[0], 100);
iLocal_296=0;
iLocal_297=1;
...
elseif(func_2(iLocal_33[iLocal_193], PLAYER::PLAYER_PED_ID(), 1) > 30f){
...
elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !func_253(0)){
if(func_252(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")){
...
return MISC::IS_BIT_SET(Global_96296, iParam0);
}
