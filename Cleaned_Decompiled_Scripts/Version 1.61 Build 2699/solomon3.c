...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_3233[iLocal_3189], 780511057) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_3233[iLocal_3189], 780511057) !=0){
...
Vector3 func__81(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_83(Var18, -Var0.f_3.f_2) 
};
Var18={
func_83(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__83(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
}elseif((!func_163(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_183(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_182()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_40(iVar6 + 1))){
...
var func__173(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(func_179(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_180() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
iLocal_3349=1;
}}}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3258, false)){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3258)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3121[12], false)){
Local_3315={
ENTITY::GET_ENTITY_COORDS(iLocal_3121[12], true) 
};
}}
Local_3318={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) 
...
Vector3 func__277(struct<3> Param0){
float fVar0;
float fVar1;
...
iLocal_3336=0;
iLocal_3335=1;
}}elseif(func_297(&uLocal_28, 1, 0, 0) && iLocal_3437==0){
...
uParam0->f_5=1;
uParam0->f_7=1;
}}elseif(func_302(bParam1, bParam2, bParam3)){
uParam0->f_4=MISC::GET_GAME_TIMER();
uParam0->f_5=1;
uParam0->f_7=1;
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(func_300(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}}
break;
case 4:
...
Local_2641={
ENTITY::GET_ENTITY_COORDS(iLocal_3164, true) 
};
...
}elseif(!bLocal_102 && ((!MISC::IS_BIT_SET(iLocal_1894[iVar0], 2) && bVar16) || (MISC::IS_BIT_SET(iLocal_1894[iVar0], 2) && bVar17))){
bVar14=true;
}else{
...
elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_3121[iVar0], false) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_3121[iVar0], false)){
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_3121[iVar0], Local_2535[iVar0 /*3*/], false, false, true);
ENTITY::SET_ENTITY_QUATERNION(iLocal_3121[iVar0], fLocal_993[iVar0], fLocal_1029[iVar0], fLocal_1065[iVar0], fLocal_1101[iVar0]);
if(VEHICLE::IS_THIS_MODEL_A_CAR(iLocal_2877[iVar0]) || VEHICLE::IS_THIS_MODEL_A_BIKE(iLocal_2877[iVar0])){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_3121[iVar0], 5f);
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_3121[iVar0], true) 
};
Var6={
...
bVar14=true;
}elseif(!func_332(iLocal_3121[iVar0], iVar2, 45f)){
bVar14=true;
}elseif(func_330(iVar2, iLocal_3121[iVar0], 0)){
bVar14=true;
}}
if(bVar14){
...
Var4={
ENTITY::GET_ENTITY_COORDS(iLocal_3105[iVar0], true) 
};
}
...
bVar17=true;
}}elseif(!bLocal_102 && ((!MISC::IS_BIT_SET(iLocal_1646[iVar0], 2) && bVar19) || (MISC::IS_BIT_SET(iLocal_1646[iVar0], 2) && bVar20))){
bVar17=true;
}else{
STREAMING::REQUEST_MODEL(func_220());
...
Var6={
ENTITY::GET_ENTITY_COORDS(iLocal_2916[iVar0], true) 
};
Var9={
...
Var25={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iParam0, ENTITY::GET_ENTITY_COORDS(iLocal_2916[iVar0], true)) 
};
if(Var25.f_1 < 0f){
...
if(iLocal_1956==0){
Local_2656={
VEHICLE::GET_POSITION_OF_VEHICLE_RECORDING_ID_AT_TIME(iVar0, fLocal_1289) 
};
iLocal_1956++;
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_3121[4], true) 
};
...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_3121[3], true) 
};
...
Var6={
ENTITY::GET_ENTITY_COORDS(iLocal_3121[21], true) 
};
...
uParam0->f_2=2;
}elseif(!func_408(uParam0->f_7, uParam0->f_8)){
if(uParam0->f_5){
CAM::DESTROY_CAM(uParam0->f_4, false);
uParam0->f_4=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", false);
CAM::ADD_CAM_SPLINE_NODE(uParam0->f_4, uParam1->f_2, uParam1->f_5, uParam1->f_15, 3, 2);
...
uParam0->f_9=MISC::GET_GAME_TIMER();
uParam0->f_2=22;
}}}elseif(func_388(uParam0->f_7, 0, &(uParam1->f_18), &(uParam1->f_22), uParam0, -1082130432, 0, 1, 1065353216)){
if(uParam1->f_17 < 0){
uParam0->f_9=MISC::GET_GAME_TIMER();
uParam0->f_2=3;
}else{
...
iParam0->f_1=(func_398(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
return (func_398(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
var func__440(int iParam0, int iParam1){
struct<5> Var0;
Var0={
func_441(iParam0) 
};
