...
*uParam0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(fLocal_580, fLocal_581), 6f) 
};
}
...
iParam0->f_1=(func_380(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
}elseif(!WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, true) || iVar0 !=iParam0){
...
uParam0->f_27={
MISC::GET_CLOSEST_POINT_ON_LINE(Var11, Var5, Var8, false) 
};
...
if(TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 1227113341) !=1){
TASK::TASK_GO_TO_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 20000, 0,5f, 2f, 2f, 0);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -982327190) !=1){
...
float fVar6;
Var0={
func_427(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var4={
func_494(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
if(func_517(&(uParam0->f_28[0]), 49, Var8, fVar11, "RC LAUNCHER:
BARRY 1", 1)){
...
if(func_31(iParam0)){
Global_113386.f_2363.f_539.f_298[iParam0 /*477*/]={
Global_113386.f_2363.f_539.f_1764 
};
}}
