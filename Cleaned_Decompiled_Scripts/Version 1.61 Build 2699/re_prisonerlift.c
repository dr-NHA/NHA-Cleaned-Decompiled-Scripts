...
elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 20f, 20f, 8f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), 17)){
...
elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_75, false)){
if(bLocal_110){
TASK::TASK_COMBAT_PED(iLocal_72, PLAYER::PLAYER_PED_ID(), 0, 16);
func_52();
iLocal_101=1;
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, -1794415470) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, -1794415470) !=0){
...
func_92();
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, 242628503) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_72, 242628503) !=0){
iLocal_55=11;
}elseif(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 200f, 200f, 200f, false, true, 0)){
func_16();
}
}
else{
...
if(!HUD::DOES_BLIP_EXIST(iLocal_70)){
iLocal_70=func_6(Local_86, 1);
}}}}elseif(HUD::DOES_BLIP_EXIST(iLocal_70)){
...
if(!bLocal_100){
Var0[0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(0f, 9f, 0f) 
};
...
Var0[2 /*3*/]={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - Vector(0f, 0f, 9f) 
};
...
TASK::CLEAR_SEQUENCE_TASK(&iLocal_74);
PED::SET_PED_KEEP_TASK(iLocal_72, true);
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_75, false)){
TASK::OPEN_SEQUENCE_TASK(&iLocal_74);
