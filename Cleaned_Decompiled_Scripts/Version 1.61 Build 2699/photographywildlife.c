...
if((!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 0) && func_73()==1) && !func_72()){
func_1();
}else{
SCRIPT::TERMINATE_THIS_THREAD();
}}}
...
func_30();
func_21();
if(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 1) && !bLocal_235){
iLocal_248++;
}
break;
case 1:
if(func_17(&iLocal_229) > 5f){
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 3)){
...
MemCopy(&Var3,{
func_12(Global_44257[iVar7 /*12*/].f_1)
}
, 4);
}else{
Var3={
...
iVar2=iVar20;
Var3={
func_12(Global_44257[iVar20 /*12*/].f_1) 
};
...
Var3={
func_12(Global_44257[iVar26 /*12*/].f_1) 
};
}}
if(!bParam4){
...
while (bVar1 < 32){
if(bVar1 > 3){
if(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, bVar1)){
iVar0++;
}}
bVar1++;
}
...
void func_42(){
if(iLocal_238){
if((func_17(&iLocal_229) > 5f && func_45() >=1) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 1)){
switch (iLocal_251){
case 0:
...
switch (iParam0){
case 0:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 4) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 29)){
return "PW_STRING_1_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 4) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 29)){
...
break;
case 1:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 5) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 6)){
return "PW_STRING_2_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 5) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 6)){
...
break;
case 2:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 7) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 8)){
return "PW_STRING_3_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 7) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 8)){
...
break;
case 3:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 9) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 10)){
return "PW_STRING_4_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 9) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 10)){
...
break;
case 4:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 11) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 14)){
return "PW_STRING_5_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 11) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 14)){
...
break;
case 5:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 16) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 18)){
return "PW_STRING_6_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 16) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 18)){
...
break;
case 6:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 19) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 21)){
return "PW_STRING_7_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 19) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 21)){
...
break;
case 7:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 22) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 23)){
return "PW_STRING_8_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 22) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 23)){
...
break;
case 8:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 24) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 25)){
return "PW_STRING_9_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 24) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 25)){
...
break;
case 9:
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 26) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 31)){
return "PW_STRING_10_1";
}elseif(MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 26) && !MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 31)){
...
case joaat("a_c_chop"):
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 25)){
MISC::SET_BIT(&(Global_113386.f_10049.f_99), 25);
iLocal_82=18;
}
break;
case joaat("a_c_seagull"):
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 26)){
MISC::SET_BIT(&(Global_113386.f_10049.f_99), 26);
iLocal_82=19;
}
break;
case joaat("a_c_shepherd"):
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 29)){
MISC::SET_BIT(&(Global_113386.f_10049.f_99), 29);
iLocal_82=2;
}
break;
case joaat("a_c_westy"):
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 31)){
...
int func_70(){
if(MISC::IS_BIT_SET(Global_8138, 3)){
return 1;
}
return 0;
}
...
void func_82(){
if(!MISC::IS_BIT_SET(Global_113386.f_10049.f_99, 2)){
