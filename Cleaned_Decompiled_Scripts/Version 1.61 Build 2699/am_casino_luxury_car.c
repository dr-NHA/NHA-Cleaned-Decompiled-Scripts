...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Local_83.f_2[iVar0], iVar1);
}
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_101(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_101(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_101(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_101(4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_101(iVar5))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_98(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_97()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_101(iVar6 + 1))){
...
}elseif(func_93(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_94() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
return 1;
}}elseif(func_117(func_252(iVar1), Param0, fParam3, iParam4, 1036831949)){
return 1;
}}elseif(Global_2680265.f_261[iVar0]){
if(func_117(Global_2680265.f_131[iVar0 /*3*/], Param0, fParam3, iParam4, 1036831949)){
return 1;
}}elseif(func_326(iVar1, 0, 0)){
...
if(!func_170(Var1)){
Var1={
func_165(Var1, &fVar4, iVar9, uParam2->f_9, *uParam2, bVar10, uParam2->f_11, uParam2->f_34, &bVar11, bVar12, 1, uParam2->f_51, uParam2->f_60) 
};
...
elseif(func_196(Var1, 6f, 1f, 1f, 5f, iVar19, bVar20, iVar21, fVar22, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_116(Var1, fVar4, uParam2->f_34, 1, 1, 0, 0, 0, 0)){
iVar23=1;
}
}
...
return 1;
}}elseif(SYSTEM::VDIST(func_252(iVar1), Param0) < 1f){
return 1;
}}elseif(Global_2680265.f_261[iVar0]){
if(SYSTEM::VDIST(Global_2680265.f_131[iVar0 /*3*/], Param0) < fParam3){
return 1;
}}elseif(func_326(iVar1, 0, 1)){
...
*uParam5={
func_165(*uParam5, fParam6, iParam9, uParam7->f_9, *uParam7, bParam8, uParam7->f_11, uParam7->f_34, &bParam13, 0, 0, uParam7->f_51, uParam7->f_60) 
};
if(!func_170(*uParam5)){
iVar0=999;
return;
...
Vector3 func__165(struct<3> Param0, float* fParam3, int iParam4, bool bParam5, struct<3> Param6, bool bParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15, var uParam16){
struct<3> Var0;
var uVar3;
var uVar4;
var uVar5;
...
if(bParam1){
*uParam0={
func_181(*uParam0, Global_2667225.f_26.f_10, Global_2667225.f_26.f_13, Global_2667225.f_26.f_16, Global_2667225.f_26.f_17, 1036831949, 0) 
};
}}}
return bVar0;
}
...
Vector3 func__181(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, int iParam10, float fParam11, bool bParam12){
int iVar0;
struct<3> Var1;
switch (iParam10){
case 0:
...
Vector3 func__183(struct<3> Param0, struct<3> Param3){
...
case 0:
*uParam0={
func_181(*uParam0, *uParam1, 0f, 0f, 0f, (uParam1->f_6 + (IntToFloat(Global_2667225.f_2735) * uParam1->f_8)), 0, fParam2, bParam3) 
};
break;
case 1:
*uParam0={
func_181(*uParam0, *uParam1, uParam1->f_3, 0f, 1, fParam2, bParam3) 
};
break;
case 2:
*uParam0={
func_181(*uParam0, *uParam1, uParam1->f_3, uParam1->f_6, 2, fParam2, bParam3) 
};
break;
}}else{
switch (uParam1->f_10){
...
bVar12=true;
}}elseif(func_196(Var3, 6f, 1f, 1f, 5f, iVar8, bVar9, iVar10, fVar11, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_116(Var3, fVar6, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0)){
bVar12=true;
}
}
if(bVar12){
...
break;
}}elseif(func_226(Param0, &iVar2, &iVar6) || (func_203(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam3)))){
func_245();
iVar0=0;
while (iVar0 < iVar2){
if(iVar2[iVar0] > 1000){
...
return 1;
}elseif(func_188(&Param0, 0, 1, 0, 1)){
return 1;
}}else{
iVar0=func_240(Param0, 1008981770);
if(iVar0 > -1){
Var1={
func_239(&(Global_2667225.f_45[iVar0 /*12*/])) 
};
if(!func_188(&Var1, 0, 0, 0, 1)){
if(!func_188(&Param0, 0, 0, 0, 1)){
return 1;
...
func_261();
}}elseif(func_263(PLAYER::PLAYER_ID())){
func_259();
}}
...
iVar0=(iParam1 / 32);
iVar1=(iParam1 % 32);
return MISC::IS_BIT_SET(Local_91[iParam0 /*4*/].f_2[iVar0], iVar1);
}
...
if(!func_265(NETWORK::PARTICIPANT_ID(), 1)){
func_276(1);
}}elseif(func_265(NETWORK::PARTICIPANT_ID(), 1)){
func_275(1);
}
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_140)){
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(uLocal_133[iVar0], iVar1);
}
