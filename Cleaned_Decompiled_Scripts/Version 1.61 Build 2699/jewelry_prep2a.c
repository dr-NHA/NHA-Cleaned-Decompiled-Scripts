...
}elseif(HUD::GET_BLIP_FROM_ENTITY(Local_1343.f_0) !=0){
...
iLocal_94=2;
}elseif((ENTITY::DOES_ENTITY_EXIST(iLocal_1345) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1345, false)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1345, Local_1343.f_0)){
...
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_1345) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1345, Local_1343.f_0)){
iVar8=iLocal_1345;
}
...
}}elseif(!func_59(Var3, HUD::GET_BLIP_COORDS(iParam0->f_5), 0,1f, 0)){
...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_58()) || !func_56(iParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
return 1;
}}}elseif(func_54(1, 0, 1) || MISC::IS_BIT_SET(iParam0->f_13, 7)){
return 1;
}
return 0;
}
...
Var0={
MISC::GET_CLOSEST_POINT_ON_LINE(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343.f_0, Local_87), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343.f_0, Local_90), false) 
};
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_116(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
iLocal_1374=1;
}elseif(WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_briefcase"), false)){
...
func_320(1);
}}elseif(func_204(PLAYER::PLAYER_PED_ID(), Local_1343.f_0, 1) > 250f){
func_320(2);
}}elseif(func_204(PLAYER::PLAYER_PED_ID(), Local_1343.f_0, 1) > 250f){
func_320(2);
}
...
return 1;
}elseif(func_232(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_255(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_256() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_266(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_265()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_184(iVar6 + 1))){
...
if(ENTITY::IS_ENTITY_DEAD(Local_1343.f_0, false)){
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343.f_0, MISC::GET_RANDOM_FLOAT_IN_RANGE(-2,5f, 2,5f), -5f, 0f) 
};
...
if(bParam1){
Var0={
func_313(ENTITY::GET_ENTITY_COORDS(iParam0, true) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1343.f_0, MISC::GET_RANDOM_FLOAT_IN_RANGE(-0,15f, 0,15f), IntToFloat(-MISC::GET_RANDOM_INT_IN_RANGE(3, 6)), MISC::GET_RANDOM_FLOAT_IN_RANGE(-0,1f, 0,1f))) 
};
...
Var1={
func_313(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(Local_1343.f_0, true)) 
};
Var4={
ENTITY::GET_ENTITY_VELOCITY(Local_1343.f_0) - ENTITY::GET_ENTITY_VELOCITY(iVar0) 
};
...
elseif((MISC::GET_GAME_TIMER() - iLocal_1375) > 5000){
...
StringCopy(&cLocal_1364, "", 24);
func_309(uParam0, 5, 0);
}elseif(!func_317(Local_1331.f_0, -235832601, 1)){
...
StringCopy(&cLocal_1364, "", 24);
func_309(uParam0, 5, 0);
}elseif(PED::IS_PED_IN_VEHICLE(Local_1331.f_0, Local_1343.f_0, true)){
...
StringCopy(&cLocal_1364, "", 24);
func_309(uParam0, 5, 0);
}elseif(!func_317(Local_1331.f_0, -1273030092, 1)){
...
}}elseif(!func_317(Local_1331.f_0, 451360105, 1)){
TASK::TASK_LEAVE_VEHICLE(Local_1331.f_0, Local_1343.f_0, 256);
}
}
elseif(!func_317(Local_1331.f_0, 780511057, 1)){
...
iLocal_1362++;
}}elseif(func_42() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_1331.f_0)){
...
elseif(func_316(&uLocal_1151, &cLocal_79, &cLocal_1364, 8, 0, 0, 0)){
iLocal_1362++;
}}}
break;
case 1:
