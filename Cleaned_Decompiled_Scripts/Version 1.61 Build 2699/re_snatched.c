...
elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_155, false)){
...
Local_110={
ENTITY::GET_ENTITY_COORDS(iLocal_155, false) 
};
...
elseif(HUD::DOES_BLIP_EXIST(iLocal_120)){
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_125[iVar5])){
HUD::REMOVE_BLIP(&(iLocal_125[iVar5]));
}
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_128[iVar5])){
HUD::REMOVE_BLIP(&(iLocal_128[iVar5]));
}
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_156[iParam0], false) 
};
...
}elseif(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_144[iVar0], false)) < fVar1){
fVar1=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_144[iVar0], false));
}}
iVar0++;
}
...
}elseif(SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_147[iVar0], false)) < fVar1){
fVar1=SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), ENTITY::GET_ENTITY_COORDS(iLocal_147[iVar0], false));
}}
iVar0++;
}
...
if(!iLocal_367){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_140, false) + Var0 
};
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_140, false) + Var3 
};
if(func_164(&uLocal_176, cLocal_387, "RESNA_MOR", 4, func_205(), 0, 0)){
...
Var2={
ENTITY::GET_ENTITY_COORDS(iLocal_156[iVar1], false) 
};
Var5={
...
struct<3> Var3;
Var0={
Param0 - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) 
};
Var3={
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_134(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
if(PED::IS_PED_INJURED(iLocal_141)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_141, PLAYER::PLAYER_PED_ID(), true)){
bVar0=true;
}
if(PED::IS_PED_INJURED(iLocal_142)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_142, PLAYER::PLAYER_PED_ID(), true)){
bVar0=true;
}
if(PED::IS_PED_INJURED(iLocal_143)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_143, PLAYER::PLAYER_PED_ID(), true)){
bVar0=true;
}
if(PED::IS_PED_INJURED(iLocal_140)){
bVar0=true;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_140, PLAYER::PLAYER_PED_ID(), true)){
bVar0=true;
}
if(bVar0){
func_162();
...
func_161();
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_107) > 0,4f){
func_160();
}}elseif(!PED::IS_PED_INJURED(iLocal_140)){
