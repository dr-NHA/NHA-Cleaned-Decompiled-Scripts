...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_140(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
func_318("ARE_RC_TRIGGER_CONDITIONS_MET:
RC_TRIG_CHAR - Used special case Eps 4 trigger.");
return 1;
}}
}}else{
return 0;
}}elseif(func_129(iParam0->f_28[0])){
if(func_177(iParam0)){
if(func_181(2)){
if(func_179(iParam0->f_27)){
func_178(iParam0->f_27, *iParam0);
...
if(func_179(iParam0->f_27)){
func_178(iParam0->f_27, *iParam0);
func_318("RC5_IN_ACTIVATION_RANGE:
...
if(func_179(1)){
func_178(1, *iParam0);
func_318("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
func_318("RC_STOP_PLAYER_VEHICLE_CHECK:
...
var func__187(int iParam0, int iParam1){
switch (iParam0){
case 5:
if(iParam1 > -1){
...
*uParam10=3;
return 1;
}}}elseif(((func_202(sParam5) && !*uParam10==1) && func_129(PLAYER::PLAYER_PED_ID())) && func_199(PLAYER::PLAYER_PED_ID(), Param1, 1) >=20f){
...
uParam1->f_3=5;
}elseif((func_206(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
struct<27> Var0;
if(Global_78319){
func_318("IS_RC_FINE_AND_IN_RANGE():
...
Vector3 func__230(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_234(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_234(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__234(struct<3> Param0){
float fVar0;
float fVar1;
...
float fVar6;
Var0={
func_234(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
var func__282(int iParam0, int iParam1){
struct<5> Var0;
Var0={
func_283(iParam0) 
};
...
case 2:
bVar6=true;
if(!func_257(&(uParam0->f_28[0]), 64, -1100,5f, 789,8f, 164,34f, 1,82f, "RC:
NIGEL", 1)){
bVar6=false;
}
if(!func_257(&(uParam0->f_28[1]), 63, -1099,35f, 789,15f, 164,47f, 0f, "RC:
MRS THORNHILL", 1)){
bVar6=false;
}
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
