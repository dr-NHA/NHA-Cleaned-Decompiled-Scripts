...
if(Global_20209){
Global_20466=0;
}elseif(Global_113386.f_14051.f_88==1 || Global_113386.f_14051.f_89==1){
Global_20466=0;
}else{
Global_20466=0;
}
...
while (true){
SYSTEM::WAIT(0);
if(MISC::IS_BIT_SET(Global_4541229, 24)){
if(!Global_20465){
...
if(Global_20266.f_1 > 4){
if((MISC::IS_BIT_SET(Global_8136, 14) && Global_4541508==0) && Global_20206==0){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)){
if(func_74()){
...
Global_20467=1;
}}elseif((Global_43052==15 && func_64(0)==0) && Global_8141==0){
if(!Global_20465){
if(Global_20266.f_1==6){
Global_8142=255;
func_112(Global_20247, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
...
Global_20468=1;
}}elseif(!MISC::IS_BIT_SET(Global_8137, 3)){
if(!Global_20465){
if(Global_20266.f_1==6){
func_112(Global_20247, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
func_85();
...
if(Global_21658==1 || MISC::IS_BIT_SET(Global_8137, 23)){
...
if(MISC::IS_BIT_SET(Global_8136, 17)){
...
if(Global_20266.f_1 > 3){
func_51();
}}elseif(Global_20266.f_1 > 3){
if(Global_4541508==1){
func_50();
}
if(MISC::IS_BIT_SET(Global_8137, 25)){
if(Global_78319==1){
func_49();
}}elseif(!MISC::IS_BIT_SET(Global_8137, 24)){
if(MISC::IS_BIT_SET(Global_8137, 26)){
if(func_62(2, Global_20233, 0)){
MISC::SET_BIT(&Global_8137, 25);
MISC::CLEAR_BIT(&Global_8137, 26);
MISC::CLEAR_BIT(&Global_8138, 2);
}}}elseif(Global_78319==1){
func_48();
}}}
if(iLocal_74){
if(Global_20266.f_1==6){
func_44();
}}elseif(!MISC::IS_BIT_SET(Global_8136, 23)){
if(Global_20266.f_1==5 || Global_20266.f_1==6){
if(Global_20464==0){
...
elseif(Global_2725398){
func_42();
}
}}elseif(MISC::IS_BIT_SET(Global_8138, 9)){
func_41();
}else{
func_24();
}}
...
elseif(Global_22664==0){
if(!MISC::IS_BIT_SET(Global_4541229, 3)){
if(Global_78319){
func_21();
}
func_20();
...
if(!MISC::IS_BIT_SET(Global_4541229, 3)){
if(Global_22664==1){
if(MISC::IS_BIT_SET(Global_4541229, 1)){
if(MISC::IS_BIT_SET(Global_8136, 14)){
if(Global_78319){
func_22(7, 0, 1, 0);
}else{
...
elseif(MISC::IS_BIT_SET(Global_8136, 14)){
func_22(7, 0, 1, 0);
Global_22664=0;
}}else{
if(Global_22664==3){
...
}}}}}elseif(SCRIPT::HAS_SCRIPT_LOADED(&(Global_8143[Global_20269 /*15*/].f_5))){
if(Global_20269==0){
...
iVar32=0;
if(Global_20269==23){
if(MISC::IS_BIT_SET(Global_4541229, 4)==0 && Global_1836092==0){
}}
if(Global_20269==2 || iVar32==1){
if(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_8143[Global_20269 /*15*/].f_9)==0){
Global_20264=SYSTEM::START_NEW_SCRIPT(&(Global_8143[Global_20269 /*15*/].f_5), 4592);
}}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(Global_8143[Global_20269 /*15*/].f_9)==0){
...
if(Global_78319){
if(!MISC::IS_BIT_SET(Global_8138, 0)){
...
if(MISC::IS_BIT_SET(Global_4718592.f_37, 17) && (NETWORK::NETWORK_IS_ACTIVITY_SESSION() || Global_1922883)){
func_5(1, 1);
...
iVar35=1;
if(!MISC::IS_BIT_SET(Global_8137, 24)){
if(MISC::IS_BIT_SET(Global_8137, 26)){
MISC::SET_BIT(&Global_8137, 25);
MISC::CLEAR_BIT(&Global_8137, 26);
MISC::CLEAR_BIT(&Global_8138, 2);
...
fVar0=350f;
if(MISC::IS_BIT_SET(Global_8136, 30) || MISC::IS_BIT_SET(Global_8138, 2)){
fVar0=25f;
}
Var1={
Global_20226 
...
if((MISC::IS_BIT_SET(Global_8137, 26) || MISC::IS_BIT_SET(Global_8136, 30)) || MISC::IS_BIT_SET(Global_8138, 2)){
Local_119={
Global_20212[Global_20211 /*3*/] 
};
}else{
...
Global_20194={
func_16(Param0, Param3, fVar4) 
};
Global_20197={
func_16(Param6, Param9, fVar4) 
};
}else{
Global_20194={
Param3 
...
Vector3 func__16(struct<3> Param0, struct<3> Param3, float fParam6){
...
void func_20(){
if(MISC::IS_BIT_SET(Global_8137, 10) || iLocal_122==1){
...
if(MISC::IS_BIT_SET(Global_8137, 10)){
Global_20269=2;
MISC::CLEAR_BIT(&Global_8137, 10);
}
if(iLocal_122==1){
...
if(Global_20269==23){
if(((MISC::IS_BIT_SET(Global_4541229, 4)==0 && Global_1836092==0) && MISC::IS_BIT_SET(Global_4541229, 20)==0) && MISC::IS_BIT_SET(Global_4541229, 22)==0){
}
if((((MISC::IS_BIT_SET(Global_4541229, 20)==1 && MISC::IS_BIT_SET(Global_4541229, 4)==0) && Global_1836092==0) && MISC::IS_BIT_SET(Global_4541229, 22)==0) && MISC::IS_BIT_SET(Global_4541229, 26)==0){
iVar0=1;
...
MISC::CLEAR_BIT(&Global_8136, 17);
Global_20266.f_1=7;
if(MISC::IS_BIT_SET(Global_8136, 23)){
}else{
func_38();
...
float fVar0;
float fVar1;
if(MISC::IS_BIT_SET(Global_8138, 2)){
MISC::SET_BIT(&Global_8137, 8);
MISC::SET_BIT(&Global_8136, 14);
Global_20206=0;
iLocal_18=0;
MOBILE::SET_MOBILE_PHONE_ROTATION(Global_20226, 0);
}elseif(SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appemail")) < 1){
...
if(MISC::IS_BIT_SET(Global_8137, 8)){
if(Global_21652==0){
func_45();
Global_20244=1;
Global_20265=3;
...
if(iLocal_99==0){
if(MISC::IS_BIT_SET(Global_8136, 27)){
iLocal_99=1;
SYSTEM::SETTIMERB(0);
}}else{
if(Global_20266.f_1 > 3){
...
}elseif(!MISC::IS_BIT_SET(Global_8138, 5)){
...
break;
case 7:
if(MISC::IS_BIT_SET(Global_8136, 23)==1){
}
if((Global_8744 - Global_8743) > Global_8745 && MISC::IS_BIT_SET(Global_8136, 23)==0){
...
func_36("CELL_217");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}elseif(func_57(Global_7451, Global_20266)==0){
...
struct<2> Var0;
MOBILE::GET_MOBILE_PHONE_POSITION(&Var0);
if(Global_20212[Global_20211 /*3*/].f_1==Var0.f_1){}else{
Global_4541508=1;
}}
...
Global_2821909=0;
Global_2821909.f_2=0;
}elseif(func_117(Global_2821909.f_20)){
...
}}elseif(Global_113386.f_14051[Global_20266 /*20*/].f_10==1){
...
}}elseif(!MISC::ARE_STRINGS_EQUAL(&(Global_113386.f_14051[Global_20266 /*20*/].f_11), "Silent Ringtone Dummy")){
