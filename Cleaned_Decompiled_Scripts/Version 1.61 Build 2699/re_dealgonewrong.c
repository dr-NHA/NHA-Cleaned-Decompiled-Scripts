...
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_113, fLocal_112, Param7) 
};
if(!func_73(Var0)){
...
HUD::REMOVE_BLIP(&(iLocal_194[iVar0]));
iLocal_124++;
}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_150[iVar0], false)){
if(!HUD::DOES_BLIP_EXIST(iLocal_194[iVar0])){
...
HUD::REMOVE_BLIP(&(iLocal_199[iVar0]));
iLocal_125++;
}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_155[iVar0], false)){
if(!HUD::DOES_BLIP_EXIST(iLocal_199[iVar0])){
...
switch (iLocal_48){
case 0:
if(((PLAYER::GET_IS_PLAYER_DRIVING_ON_HIGHWAY(PLAYER::PLAYER_ID()) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_234 + Vector(0f, 20f, 0f), 170f, 270f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1555,4f, 4730,817f, 49,1791f, 15f, 25f, 15f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1709,211f, 4659,571f, 36,688f, 15f, 25f, 15f, false, true, 0)){
if(!bLocal_267){
...
}}}elseif(!PED::IS_PED_INJURED(iParam1)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
TASK::TASK_VEHICLE_CHASE(iParam1, PLAYER::PLAYER_PED_ID());
}else{
...
if(iVar0==0){
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_184[iVar0])){
...
ENTITY::SET_ENTITY_HEALTH(iLocal_136, 0, 0);
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_183)){
HUD::REMOVE_BLIP(&iLocal_183);
}
iVar0=0;
while (iVar0 < 9){
...
Local_90={
ENTITY::GET_ENTITY_COORDS(iLocal_147[iVar1], true) 
};
Local_93={
...
Local_99={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_160[iVar0], 0f, 0f, 0,5f) 
};
}
iLocal_133=0;
while (iLocal_133 < 5){
