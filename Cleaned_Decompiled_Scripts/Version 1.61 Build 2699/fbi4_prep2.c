...
case 4:
break;
}}elseif(!func_121(iParam1, 1343540250)){
return 1;
}
return 0;
}
...
if(!func_209(Local_252.f_0, PLAYER::PLAYER_PED_ID(), 10f, 1)){
func_210(14);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_252.f_0, PLAYER::PLAYER_PED_ID(), true)){
func_210(14);
}else{
func_210(13);
...
Var1={
func_192(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
Var4={
...
}}elseif(!func_121(Local_252.f_0, 1920390111)){
...
func_210(15);
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_282.f_0, PLAYER::PLAYER_PED_ID(), true)){
...
func_210(15);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_270.f_0, PLAYER::PLAYER_PED_ID(), true)){
if(!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 4)){
func_210(15);
}}}}}
if(func_239()){
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_282(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_282(iParam1))){
return 1;
}
return 0;
}
