...
iLocal_889=1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_604, PLAYER::PLAYER_PED_ID(), true)){
...
float fVar6;
Var0={
func_33(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_33(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
iLocal_522=0;
iLocal_521=10;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_605, PLAYER::PLAYER_PED_ID(), true) || func_47()){
PED::SET_PED_TO_RAGDOLL(iLocal_605, 500, 1000, 0, true, true, false);
iLocal_516=4;
iLocal_522=0;
iLocal_521=10;
}elseif(FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(ENTITY::GET_ENTITY_COORDS(iLocal_605, true), 2f) > 0){
PED::SET_PED_TO_RAGDOLL(iLocal_605, 500, 1000, 0, true, true, false);
iLocal_516=3;
iLocal_522=0;
iLocal_521=10;
...
iLocal_884=1;
}elseif(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_616) && !func_26()){
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_103(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_103(iParam1))){
return 1;
}
return 0;
}
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_605, true)) 
};
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_659.f_0, true);
}}}}}
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_643.f_0, true);
}}}
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_635.f_0, true);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_627.f_0, true);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_667.f_0, true);
func_236();
}}
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_651.f_0, true);
break;
case 5:
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_651.f_0, false) && !PED::IS_PED_FLEEING(Local_651.f_1)){
TASK::CLEAR_PED_TASKS(Local_651.f_1);
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_523[iParam0 /*16*/], ENTITY::GET_ENTITY_COORDS(iLocal_605, true)) 
};
...
Var4={
func_265(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
return 1;
}elseif(func_390(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_432(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_433() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_448(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_459(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_458()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_408(iVar6 + 1))){
