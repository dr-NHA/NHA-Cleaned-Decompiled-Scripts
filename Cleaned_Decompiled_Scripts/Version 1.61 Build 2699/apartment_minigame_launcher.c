...
}}elseif(func_155(PLAYER::PLAYER_ID())){
bVar0=true;
func_153(&iLocal_190);
}elseif(bVar2){
}}
...
bVar3=false;
while (bVar3 <=1){
if(!MISC::IS_BIT_SET(Local_225.f_5, bVar3)){
...
switch (iVar4){
case 0:
if(MISC::IS_BIT_SET(Local_254.f_5, bVar3)){
MISC::CLEAR_BIT(&(Local_254.f_5), bVar3);
}
break;
case 1:
if(MISC::IS_BIT_SET(Local_254.f_6, bVar3)){
...
}elseif(SCRIPT::DOES_SCRIPT_EXIST(Local_225.f_3)){
...
bVar0++;
}}elseif(!MISC::IS_BIT_SET(bParam2->f_5, Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1)){
...
if(NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar2)){
if((Local_380[bVar1 /*5*/].f_1==Param0.f_0 && MISC::IS_BIT_SET(Local_380[bVar1 /*5*/].f_3, 6)) && MISC::IS_BIT_SET(Local_380[bVar1 /*5*/].f_3, 1)){
Local_199.f_5=1;
if(Local_199.f_8 >=0){
if(Local_199.f_8==0 && MISC::IS_BIT_SET(Local_380[bVar1 /*5*/].f_3, 5)){
Local_199.f_6=1;
}elseif(Local_199.f_8==1 && !MISC::IS_BIT_SET(Local_380[bVar1 /*5*/].f_3, 5)){
Local_199.f_6=1;
}
}
}}}
...
if(Local_225.f_4==0){
if(((!Local_199.f_4 && Local_199.f_5) || (Local_199.f_4 && Local_199.f_6)) && MISC::IS_BIT_SET(Local_254.f_1, Param0.f_0)){
...
}elseif(func_14(&iLocal_328) >=1f || !func_19(&(Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 3)){
func_11(&iLocal_328);
...
}}elseif(func_44(&(Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 0, 0)){
}}
if(!func_174(&iLocal_184)){
func_173(&iLocal_184);
}elseif(func_14(&iLocal_184) >=1f){
if(!func_19(&(Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 3)){
func_44(&(Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 3, 1);
}}
if((PAD::IS_CONTROL_JUST_PRESSED(2, func_100(0)) || MISC::IS_BIT_SET(Local_254.f_3, Param0.f_0)) && !bLocal_94){
func_41(&Local_225, 8);
}
...
if((PAD::IS_CONTROL_JUST_PRESSED(2, 201) && MISC::IS_BIT_SET(Local_254.f_2, Param0.f_0)) && !bLocal_94){
func_41(&Local_225, 7);
}
if(Param0.f_2==0){
Local_199.f_1=1;
...
if(MISC::IS_BIT_SET(Local_254.f_2, Param0.f_0)){
if(Local_199.f_1){
...
if(MISC::IS_BIT_SET(Local_254.f_1, Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1)){
func_44(&(Local_380[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 1, 1);
}
...
var func__104(struct<13> Param0, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, int iParam21){
if(PAD::_IS_USING_KEYBOARD(2)){
switch (iParam21){
case 5:
if(Param0.f_0==0){
...
if((!uParam1->f_1[uParam0->f_4] && (*uParam0 >=1 && *uParam0 <=3)) || MISC::IS_BIT_SET(Local_254.f_3, uParam0->f_4)){
bVar21=false;
func_112(uParam0, 4);
}
switch (*uParam0){
...
bVar23=false;
while (bVar23 <=1){
if((bVar23 !=uParam0->f_4 && uParam1->f_1[bVar23]) && !MISC::IS_BIT_SET(Local_254.f_3, bVar23)){
uParam0->f_4=bVar23;
uParam1->f_14=4f;
func_112(uParam0, 1);
break;
...
iVar3=0;
if((MISC::IS_BIT_SET(Local_254.f_1, iVar2) && !NETWORK::NETWORK_IS_SCRIPT_ACTIVE(Local_334[iVar2 /*21*/].f_1, uParam0->f_13, false, 0)) && func_20(&Local_380, iVar2) > 0){
iVar3=1;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_50(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
}elseif(((Global_1575058 || Global_2667225.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_50(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6;
}}
return -1;
}
