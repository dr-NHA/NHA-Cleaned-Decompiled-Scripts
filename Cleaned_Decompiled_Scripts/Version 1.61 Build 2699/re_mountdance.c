...
case 3:
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_95, true) 
};
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_100)){
func_4(&iLocal_100);
}
...
float fVar6;
Var0={
func_3(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_3(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
