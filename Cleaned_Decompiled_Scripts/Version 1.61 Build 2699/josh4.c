...
fVar4=132,53f;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, -1115,984f, 285,5924f, 61,94241f, -1097,599f, 285,1346f, 66,34669f, 33f, false, true, 0)){
Var1={
...
Var4={
func_314(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
...
return 1;
}elseif(func_357(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_399(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_400() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar2))){
}else{
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_375(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_375(4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar5))){
}else{
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_375(iVar6 + 1))){
