...
func_53();
func_51();
}elseif(Global_4539964[iLocal_36 /*104*/].f_30==1){
func_27();
Global_7451=144;
if(Global_20266.f_1 > 3){
Global_20266.f_1=10;
...
}elseif(func_23(Global_7451, Global_20266)==0){
...
if(MISC::IS_BIT_SET(Global_4541229, 25)){
