...
if(*uParam6 > 6){
Global_95464=3;
}}elseif((FIRE::IS_EXPLOSION_IN_AREA(0, Param0, Param3) || FIRE::IS_EXPLOSION_IN_AREA(2, Param0, Param3)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Param0, Param3, joaat("weapon_grenadelauncher"), true)){
Global_95464=5;
}}}
...
if(!func_31(iParam0)){}
if(!MISC::IS_BIT_SET(Global_113386.f_9085.f_2[27 /*3*/], 1)){
return 0;
}
return 1;
}
