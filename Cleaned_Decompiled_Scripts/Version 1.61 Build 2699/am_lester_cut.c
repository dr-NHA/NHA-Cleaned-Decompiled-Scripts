...
func_19();
}elseif(HUD::DOES_BLIP_EXIST(Global_1931382)){
func_12();
HUD::SET_BLIP_ROUTE(Global_1931382, false);
HUD::REMOVE_BLIP(&Global_1931382);
if(MISC::IS_BIT_SET(uLocal_432, 3)){
...
if(!MISC::IS_BIT_SET(Local_163[iLocal_162 /*3*/].f_2, 0)){
MISC::CLEAR_BIT(&uLocal_432, true);
}
if(func_4(iVar1, 0, 1)){
if(MISC::IS_BIT_SET(Local_163[iLocal_162 /*3*/].f_2, 1)){
MISC::SET_BIT(&uLocal_432, 12);
if(Local_83.f_2==-1){
if(Local_83.f_2 !=iLocal_162){
Local_83.f_2=iLocal_162;
}}}elseif(Local_83.f_2==iLocal_162){
Local_83.f_2=-1;
}}}
iLocal_162++;
if(iLocal_162==32){
if(MISC::IS_BIT_SET(uLocal_432, 1)){
MISC::SET_BIT(&(Local_83.f_1), false);
}
if(!MISC::IS_BIT_SET(uLocal_432, 12)){
if(Local_83.f_2 !=-1){
Local_83.f_2=-1;
}}
...
case 0:
if(!MISC::IS_BIT_SET(uLocal_432, 2)){
if(!MISC::IS_BIT_SET(uLocal_432, 5)){
if(!func_228()){
if(!func_227()){
if(!func_225()){
...
if(HUD::DOES_BLIP_EXIST(Global_1931382)){
if(!MISC::IS_BIT_SET(uLocal_432, 14)){
if(Local_83.f_2 !=-1){
...
elseif(Local_83.f_2 !=-1){
if(!MISC::IS_BIT_SET(uLocal_432, 13)){
if(func_188(1, 1, 1, 1)){
...
if(!MISC::IS_BIT_SET(uLocal_432, 9)){
if(func_188(0, 1, 1, 1)){
if(!func_218()){
...
}elseif(func_184(&uLocal_435, 10, 0)){
...
break;
case 3:
if(!MISC::IS_BIT_SET(Local_163[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0)){
MISC::SET_BIT(&(Local_163[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
break;
}
...
switch (iLocal_260){
case 0:
if(!MISC::IS_BIT_SET(uLocal_432, 18)){
...
if(!MISC::IS_BIT_SET(uLocal_432, 20)){
...
}elseif(!MISC::IS_BIT_SET(uLocal_432, 10)){
...
if(MISC::IS_BIT_SET(uLocal_432, 10)){
iLocal_260++;
}}}
break;
case 1:
...
if(MISC::IS_BIT_SET(uLocal_432, 25)){
...
if(!MISC::IS_BIT_SET(uLocal_432, 11)){
...
if(!MISC::IS_BIT_SET(uLocal_432, 26)){
if(iLocal_260 > 2){
...
if(MISC::IS_BIT_SET(uLocal_432, 19)){
...
if(!MISC::IS_BIT_SET(uLocal_432, 17)){
...
case 1:
if(!PED::IS_PED_INJURED(iLocal_262)){
if(!MISC::IS_BIT_SET(uLocal_432, 21)){
...
if(MISC::IS_BIT_SET(uLocal_432, 15)){
...
if(MISC::IS_BIT_SET(uLocal_432, 22)){
if(!PED::IS_PED_INJURED(iLocal_262)){
PED::SET_PED_CONFIG_FLAG(iLocal_262, 104, true);
...
if(MISC::IS_BIT_SET(uLocal_432, 23)){
if(func_143()){
...
return 1;
}}elseif(func_200(PLAYER::PLAYER_ID())){
return 1;
}
return 0;
}
...
var func__214(var uParam0, int iParam1){
...
}}elseif(HUD::DOES_BLIP_EXIST(*uParam0) && (HUD::IS_BLIP_SHORT_RANGE(*uParam0) && !func_233())){
...
if(MISC::IS_BIT_SET(uLocal_432, 24)){
