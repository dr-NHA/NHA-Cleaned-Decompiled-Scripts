...
elseif(!HUD::DOES_BLIP_EXIST(iLocal_323)){
if(HUD::DOES_BLIP_EXIST(iLocal_324)){
HUD::REMOVE_BLIP(&iLocal_324);
}
...
elseif(!PED::IS_PED_INJURED(iLocal_317) && !ENTITY::IS_ENTITY_DEAD(iLocal_319, false)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_317, false) && HUD::DOES_BLIP_EXIST(iLocal_324)){
HUD::REMOVE_BLIP(&iLocal_324);
if(!HUD::DOES_BLIP_EXIST(iLocal_325)){
...
}}}elseif(!HUD::DOES_BLIP_EXIST(iLocal_325)){
iLocal_325=func_96(iLocal_320, 0, 0);
if(HUD::DOES_BLIP_EXIST(iLocal_324)){
HUD::REMOVE_BLIP(&iLocal_324);
}}
...
bLocal_344=true;
Local_314={
ENTITY::GET_ENTITY_COORDS(iLocal_319, false) + Vector(0f, -1f, -3f) 
};
}
else{
Local_314={
ENTITY::GET_ENTITY_COORDS(iLocal_319, false) + Vector(0f, 1,5f, -3f) 
};
}
