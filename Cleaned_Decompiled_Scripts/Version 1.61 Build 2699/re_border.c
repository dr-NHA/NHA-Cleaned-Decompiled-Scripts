...
iLocal_71[iVar0]=0;
iLocal_67[iVar0]=1;
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !iLocal_71[iVar0]){
...
iLocal_67[iVar0]=0;
iLocal_71[iVar0]=1;
}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_85[iVar0], false)){
...
iLocal_79[iVar0]=0;
iLocal_75[iVar0]=1;
}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !iLocal_79[iVar0]){
...
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_85[iVar0])){
iLocal_65=1;
iLocal_64=1;
}
iVar0++;
...
}}}elseif(HUD::DOES_BLIP_EXIST(uLocal_93[iVar0])){
