...
}elseif(Global_4534105[iVar9 /*85*/].f_66.f_11 & 2 !=0){
...
if(Global_4534105[iParam0 /*85*/].f_66.f_10==1){}elseif(Global_4534105[iParam0 /*85*/].f_66.f_10==4){
bVar0=true;
}elseif(Global_4534105[iParam0 /*85*/].f_66.f_10==2){
bVar1=true;
}
Var6=-1;
Var6.f_1=-1;
...
break;
case 1612072658:
unkNETWORK_SPENT_BUY_PASSIVE_MODE(Global_4534105[iParam0 /*85*/].f_66.f_1, bVar1, bVar0, 0);
break;
case -990286235:
...
break;
case 1839532116:
unkNETWORK_SPENT_ROBBED_BY_MUGGER(Global_4534105[iParam0 /*85*/].f_66.f_1, 0, 0, 0);
break;
case 941287179:
...
break;
case -1834046564:
unkNETWORK_SPENT_TAXI(Global_4534105[iParam0 /*85*/].f_66.f_1, bVar1, bVar0, 0);
break;
case 393059668:
...
break;
case -101307780:
unkNETWORK_EARN_WAGE_PAYMENT(Global_4534105[iParam0 /*85*/].f_66.f_1, 0);
break;
case 599804707:
...
break;
case 1280785534:
unkNETWORK_EARN_AUTOSHOP_INCOME(Global_4534105[iParam0 /*85*/].f_66.f_1, 277);
break;
case -168319378:
...
break;
case -2013760296:
unkNETWORK_SPEND_GUNRUNNING(Global_4534105[iParam0 /*85*/].f_66.f_1, 0, 1, Global_4534105[iParam0 /*85*/]);
break;
case 761999406:
unkNETWORK_EARN_SIGHTSEEING_REWARD(Global_4534105[iParam0 /*85*/].f_66.f_1, Global_4534105[iParam0 /*85*/], Global_4534105[iParam0 /*85*/].f_66.f_15, Global_4534105[iParam0 /*85*/].f_66.f_16);
break;
case -1033889004:
unkNETWORK_SPEND_VEHICLE_REQUESTED(Global_4534105[iParam0 /*85*/].f_66.f_1, 0, 1, Global_4534105[iParam0 /*85*/], Global_4534105[iParam0 /*85*/].f_66.f_15);
break;
case -1101941763:
case 1748245957:
case 1036772696:
...
break;
case 1628412596:
unkNETWORK_YOHAN_SOURCE_GOODS(Global_4534105[iParam0 /*85*/].f_66.f_1, Global_4534105[iParam0 /*85*/].f_1, Global_4534105[iParam0 /*85*/].f_9, Global_4534105[iParam0 /*85*/].f_66.f_15);
break;
}
if(func_13()){
if(bParam1){
...
Local_22.f_14={
Global_4534105[Param0.f_33 /*85*/].f_14 
};
