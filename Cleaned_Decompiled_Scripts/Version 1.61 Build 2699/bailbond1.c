...
struct<3> Var1;
Var1={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, fParam4, 0f) 
};
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_212(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_212(iParam1))){
return 1;
}
return 0;
}
...
if(func_24(Local_112.f_9)){
Var1={
ENTITY::GET_ENTITY_COORDS(Local_112.f_9, false) 
};
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_345(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
}elseif(MISC::GET_COORDS_OF_PROJECTILE_TYPE_IN_AREA(Var0, Var3, joaat("weapon_molotov"), uParam0, false)){
}elseif(MISC::GET_COORDS_OF_PROJECTILE_TYPE_IN_AREA(Var0, Var3, joaat("weapon_smokegrenade"), uParam0, false)){
}elseif(MISC::GET_COORDS_OF_PROJECTILE_TYPE_IN_AREA(Var0, Var3, joaat("weapon_bzgas"), uParam0, false)){
}elseif(MISC::GET_COORDS_OF_PROJECTILE_TYPE_IN_AREA(Var0, Var3, joaat("weapon_stickybomb"), uParam0, false)){
}elseif(MISC::GET_COORDS_OF_PROJECTILE_TYPE_IN_AREA(Var0, Var3, joaat("weapon_flare"), uParam0, false)){
}else{
*uParam0={
0f, 0f, 0f 
};
...
}}elseif(!func_65(Local_112.f_9, -875674219)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
}
break;
case 7:
...
Local_112.f_18=(MISC::GET_GAME_TIMER() - 5000);
Local_112.f_10=13;
}elseif((((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_248[0 /*6*/], true) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_248[0 /*6*/], Local_248[0 /*6*/].f_1, 3f, 1)) || !func_373(ENTITY::GET_ENTITY_HEADING(Local_248[0 /*6*/]), Local_248[0 /*6*/].f_4, 20f)) || func_372(Local_248[0 /*6*/], 2)){
Local_112.f_18=(MISC::GET_GAME_TIMER() - 5000);
Local_112.f_10=13;
}elseif(PED::IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_248[0 /*6*/])){
Local_112.f_10=33;
}elseif(!func_65(Local_112.f_9, -1794415470)){
Local_112.f_10=15;
}
break;
case 17:
...
elseif(!PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, true)){
if(!PED::IS_PED_GETTING_INTO_A_VEHICLE(Local_112.f_9)){
TASK::TASK_LOOK_AT_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
}
}
...
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_112.f_9, -1519143300)==1){
TASK::UPDATE_TASK_HANDS_UP_DURATION(Local_112.f_9, -1);
}else{
TASK::TASK_HANDS_UP(Local_112.f_9, -1, PLAYER::PLAYER_PED_ID(), -1, false);
}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, false)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_112.f_9, PLAYER::PLAYER_PED_ID(), -1);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, true);
Local_112.f_10=24;
...
float fVar6;
Var0={
func_193(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
}}}elseif(Local_112.f_10==24 && func_65(Local_112.f_9, -1519143300)){
if(func_112(Local_112.f_9, Local_628, 25f, 1)){
...
return 1;
}elseif(!PED::IS_PED_IN_VEHICLE(iParam0, iParam1, false)){
return 1;
...
float fVar6;
Var0={
func_193(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return 1;
}elseif(func_463(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_486(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_487() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_497(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_508(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_507()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_179(iVar6 + 1))){
...
var func__505(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
Vector3 func__535(struct<5> Param0, var uParam5, var uParam6, var uParam7){
switch (Param0.f_4){
case 0:
...
Vector3 func__536(struct<5> Param0, var uParam5, var uParam6, var uParam7){
switch (Param0.f_4){
case 0:
