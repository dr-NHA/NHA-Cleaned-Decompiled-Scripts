...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_68, true) 
};
...
Var0[1 /*3*/]={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param1, fParam4, -Var34.f_0, -Var34.f_1, -Var34.f_2) 
};
Var0[2 /*3*/]={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Param1, fParam4, Var34.f_0, -Var34.f_1, -Var34.f_2) 
};
...
if(MISC::IS_BIT_SET(Global_32207, bParam0)){
return 1;
}
return 0;
}
...
if(MISC::IS_BIT_SET(Global_32208, bParam0)){
return 1;
}
return 0;
}
...
if(MISC::IS_BIT_SET(Global_32210, bParam0)){
if(iParam1 !=0){
