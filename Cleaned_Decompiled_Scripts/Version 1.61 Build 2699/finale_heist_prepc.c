...
bLocal_28=false;
func_21(1, 1, 1);
}elseif(func_205(1, Local_151, 0)){
if(!func_469()){
if(func_203()){
func_202(func_41());
return 1;
}elseif(func_205(2, Local_151, 0)){
func_202(func_41());
return 1;
}}else{
return 1;
...
return 1;
}elseif(func_102(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_149(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_150() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_169(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_120(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_120(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_120(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_120(4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_120(iVar5))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_181(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_180()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_120(iVar6 + 1))){
...
var func__178(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("gauntlet"), true);
return 1;
}}elseif(Global_100441.f_12[0] !=1 || func_465(0)){
...
func_212(iParam0);
}}elseif(func_211(*iParam0) && !func_50()){
func_212(iParam0);
}else{
func_50();
if(bParam1){
...
func_214(iParam0);
}}}}elseif(func_215(*iParam0) || func_50()){
if(bParam1){
if(Local_119.f_22 !=1){
func_214(iParam0);
}}elseif(Local_96.f_22 !=1){
...
*iParam2=2;
}}elseif(func_224(*iParam0) || func_223(*iParam0)){
func_19(iParam3);
if(func_59(func_53(func_41()), 0, 0)){
HUD::CLEAR_THIS_PRINT(func_53(func_41()));
}
...
}}}}elseif(func_241(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, true)){
...
if(iParam5==0){
Global_78130[1 /*14*/]={
func_324(iVar10, iParam1, iParam2, -1) 
};
if(!func_323(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78130[1 /*14*/]={
func_324(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar28={
func_305(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78130[1 /*14*/]={
func_324(iVar10, 14, uVar28[iVar1], -1) 
};
...
Global_78130[1 /*14*/]={
func_324(iVar10, iVar0, func_284(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78130[1 /*14*/]={
func_324(iVar10, 14, uVar69[iVar1], -1) 
};
func_295(iParam0, Global_78130[1 /*14*/].f_12, Global_78130[1 /*14*/].f_3, Global_78130[1 /*14*/].f_4);
func_318(14);
if(Global_78128==1){
...
Global_78130[1 /*14*/]={
func_324(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_313(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_312(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78130[1 /*14*/]={
func_324(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78130[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_285(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_285(iParam1))){
return 1;
}
return 0;
}
...
var func__402(int iParam0){
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_403(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_439() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_439() /*5567*/].f_681.f_10, iParam0);
}
...
void func_471(){
Local_96={
func_472(1616809629, -440,0352f, -2172,502f, 9,39933f, -440,1235f, -2166,841f, 12,3181f, -440,1479f, -2166,364f, 9,3181f, -439,9046f, -2174,041f, 12,39933f, -442,2598f, -2169,643f, 9,31843f, -438,0615f, -2173,349f, 13,31699f) 
};
Local_119={
func_472(-1380475172, -445,3699f, -2172,47f, 9,39933f, -445,3286f, -2166,688f, 12,31802f, -445,492f, -2166,232f, 9,31686f, -445,2189f, -2174,173f, 12,39933f, -447,3654f, -2169,836f, 9,30682f, -443,38f, -2173,165f, 12,31856f) 
};
}
...
case 80:
Local_178={
func_474(-311,1739f, -771,6993f, 52,2467f, 182,106f, joaat("gauntlet"), 13) 
};
Local_157={
...
case 81:
Local_178={
func_474(-657,8753f, -272,2921f, 34,7628f, 30,6575f, joaat("gauntlet"), 4) 
};
Local_157={
-442,189f, -2183,603f, 9,31981f 
};
...
case 82:
Local_178={
func_474(307,123f, -1084,801f, 28,3597f, 299,7018f, joaat("gauntlet"), 0) 
};
Local_157={
-442,189f, -2183,603f, 9,31981f 
};
...
Global_32004=1;
bVar0=true;
}elseif(Global_31971[iVar1]==iParam0){
Global_31971[iVar1]=iParam0;
Global_31982[iVar1]=bParam1;
Global_31993[iVar1]=(MISC::GET_GAME_TIMER() + iParam3);
Global_32004=1;
