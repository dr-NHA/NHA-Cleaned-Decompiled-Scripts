...
case 1:
Local_47.f_3.f_26=1;
if(iLocal_154==0 && !MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 30)){
if(func_43(&Local_47, 0, 0, 1)){
func_31();
}}else{
if(MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 29)){
if(func_2()){
func_1();
}
}
...
int func_6(){
if(MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 30)){
return 0;
}
if(MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_36.f_18, 29)){
return 1;
...
func_34(uParam0, 2);
}}elseif(func_265(iParam2, uParam0->f_12, iParam4, iParam5, iParam7, uParam1, iParam6, iParam11, iParam12, 0)){
if(iParam2==0){
...
if(MISC::IS_BIT_SET(Global_1835448[iVar1], bVar2)){
iVar3=iVar0;
while (iVar3 <=(iVar4 - 2)){
Global_1031312.f_5[iVar3 /*88*/]={
Global_1031312.f_5[iVar3 + 1 /*88*/] 
};
iVar3++;
}
...
iVar3=iVar0;
while (iVar3 <=(iVar4 - 2)){
Global_1020252.f_5[iVar3 /*88*/]={
Global_1020252.f_5[iVar3 + 1 /*88*/] 
};
iVar3++;
}
MISC::CLEAR_BIT(&(Global_1835448[iVar1]), bVar2);
...
if(NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&Var13, &Var0)){
return 1;
}elseif((unkNETWORK_PERMISSIONS_HAS_GAMER_RECORD(&Var0) && NETWORK::NETWORK_HAS_VIEW_GAMER_USER_CONTENT_RESULT(&Var0)) && !NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0)){
return 0;
}}else{
Var13={
func_55(PLAYER::PLAYER_ID()) 
...
Var7.f_66=-1;
Var7.f_67=2;
Global_1036842.f_33[iVar3 /*88*/]={
Var7 
};
Global_1036842.f_33[iVar3 /*88*/].f_65=iVar4;
Global_1036842.f_33[iVar3 /*88*/].f_56={
func_107(sVar2) 
};
if(DATAFILE::DATADICT_GET_TYPE(sVar2, "cam")==5){
Global_1036842.f_33[iVar3 /*88*/].f_59={
func_106(sVar2, "cam") 
};
}elseif(DATAFILE::DATADICT_GET_TYPE(sVar2, "cam")==6){
...
Global_1036842.f_33[iVar3 /*88*/].f_62={
func_105(sVar2) 
};
...
return 2;
}elseif(NETWORK::UGC_GET_CONTENT_HAS_LO_RES_PHOTO(iParam0)){
return 1;
}
return 1;
}
...
Vector3 func__105(char* sParam0){
struct<3> Var0;
...
Vector3 func__106(char* sParam0, char* sParam1){
struct<3> Var0;
var* uVar3;
...
Vector3 func__107(char* sParam0){
struct<3> Var0;
if(sParam0==0){
return 0f, 0f, 0f;
}
Var0={
func_106(sParam0, "start") 
};
...
Global_1031312++;
uParam0->f_9++;
}}elseif(func_212(uParam0, &(Global_1025782.f_5[iVar0 /*88*/]), iParam1, 1, iParam2, 0)){
Global_1025782++;
...
Global_1020252++;
}}elseif(Global_1036842 < 31){
if(func_212(uParam0, &(Global_1036842.f_33[Global_1036842 /*88*/]), iParam1, 0, iParam2, 0)){
Global_1036842++;
}}
uParam0->f_9++;
}elseif(func_212(uParam0, &(Global_1020252.f_5[iVar0 /*88*/]), iParam1, 1, iParam2, 0)){
func_126(uParam0, iParam1);
if(iParam2==0){
Global_1020252++;
}else{
...
}elseif(Global_1020252.f_5[iParam2 /*88*/].f_65==1){
func_124(Global_1025782.f_5[iParam2 /*88*/].f_22);
}elseif(Global_1020252.f_5[iParam2 /*88*/].f_65==4){
...
MemCopy(&(Global_2676732[iVar0 /*83*/].f_18[3 /*16*/]),{
...
int iVar1;
Global_78130[1 /*14*/]={
func_132(iParam0, iParam1, iParam2, -1) 
};
...
}}elseif(func_187(iParam0, iParam2)){
...
if(((Param0.f_2 < 0f || func_215(Param0, 999, 2f)) || func_214(Param0)) || (Global_4718592.f_95507[0 /*58*/].f_2 < -2f && !MISC::IS_BIT_SET(Global_4718592.f_95507[0 /*58*/].f_29, 5))){
return 1;
}
return 0;
}
...
uParam0->f_604[uParam1->f_9 /*88*/].f_56={
func_107(sVar2) 
};
uParam0->f_604[uParam1->f_9 /*88*/].f_59={
func_106(sVar2, "cam") 
};
uParam0->f_604[uParam1->f_9 /*88*/].f_62={
func_105(sVar2) 
};
...
unkSET_CONTENT_ID_INDEX(uParam0->f_9405[uParam1->f_9 /*13*/].f_1, uParam1->f_9 + 2018);
}
if(func_102() !=2){
...
if(!bParam2){
func_228(uParam0->f_604[uParam1->f_9 /*88*/].f_65, uParam0->f_604[uParam1->f_9 /*88*/].f_68, MISC::IS_BIT_SET(uParam0->f_604[uParam1->f_9 /*88*/].f_76, 14), uParam0->f_604[uParam1->f_9 /*88*/].f_70, 1);
...
Global_1039641[Global_1039641.f_684 /*3*/]={
func_106(sVar2, "area") 
};
...
Global_1039641.f_256[Global_1039641.f_684 /*3*/]={
Global_794709.f_4[uParam0->f_9 /*88*/].f_56 
};
...
unkSET_CONTENT_ID_INDEX(Global_794709.f_177589[uParam0->f_9 /*13*/].f_1, uParam0->f_9);
}
...
}elseif(func_252(uParam0->f_9)){
Global_794709.f_203869[4]++;
}elseif(func_251(uParam0->f_9)){
Global_794709.f_203869[10]++;
}elseif(func_250(uParam0->f_9)){
...
if(!bParam1 && !bVar94){
if(func_19()){
func_228(Global_794709.f_4[uParam0->f_9 /*88*/].f_65, Global_794709.f_4[uParam0->f_9 /*88*/].f_68, MISC::IS_BIT_SET(Global_794709.f_4[uParam0->f_9 /*88*/].f_76, 14), Global_794709.f_4[uParam0->f_9 /*88*/].f_70, 0);
...
func_241(Global_794709.f_4[uParam0->f_9 /*88*/].f_65, Global_794709.f_4[uParam0->f_9 /*88*/].f_68, Global_794709.f_4[uParam0->f_9 /*88*/].f_75, Global_794709.f_4[uParam0->f_9 /*88*/].f_70, MISC::IS_BIT_SET(Global_794709.f_4[uParam0->f_9 /*88*/].f_76, 14));
...
}}elseif(iParam0==Global_262145.f_9502[iVar0]){
Global_794709.f_177589[iParam1 /*13*/].f_12=0;
Global_794709.f_4[iParam1 /*88*/].f_68=8;
Global_794709.f_4[iParam1 /*88*/].f_75=0;
Global_794709.f_4[iParam1 /*88*/].f_78=16777215;
...
Vector3 func__247(int iParam0, int iParam1){
switch (iParam0){
case 0:
switch (iParam1){
case 0:
...
Vector3 func__249(int iParam0, int iParam1){
switch (iParam0){
case 0:
switch (iParam1){
case 0:
...
iVar0=0;
while (iVar0 <=84){
Global_1039641[iVar0 /*3*/]={
0f, 0f, 0f 
};
Global_1039641.f_256[iVar0 /*3*/]={
0f, 0f, 0f 
};
...
return 1;
}}elseif(NETWORK::UGC_GET_MY_CONTENT(iParam1, iParam6, func_267(iParam3), uParam5)){
return 1;
}
break;
case 1:
...
return 1;
}}elseif(NETWORK::UGC_GET_GET_BY_CATEGORY(iParam2, iParam1, iParam6, func_267(iParam3), uParam5)){
return 1;
}
break;
case 6:
...
return 1;
}}elseif(NETWORK::UGC_GET_MOST_RECENTLY_CREATED_CONTENT(iParam1, iParam6, func_267(iParam3), uParam5)){
return 1;
}
break;
}
