...
return func_301(2, 2);
}elseif(func_300(Global_1853185)){
...
Vector3 func__335(int iParam0, struct<3> Param1){
var uVar0;
...
Vector3 func__344(struct<3> Param0){
float fVar0;
float fVar1;
...
Local_215.f_1=3;
func_11(&(Local_647.f_3));
}}elseif(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_647.f_2, true), 4f)){
...
}}}elseif(MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_647.f_2, true), 5f, true, true)){
if(Local_293.f_352 < (Local_293.f_353 - 1)){
if(!func_18()){
func_241(&uLocal_888, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
iParam0->f_1=0;
iParam0->f_2=0;
}elseif(func_395(*iParam0, PLAYER::PLAYER_PED_ID(), iParam0->f_15, 1)){
...
Local_647.f_0=2;
Local_647.f_1=0;
}elseif(func_388(PLAYER::PLAYER_PED_ID(), uParam0->f_1, fVar0, 1)){
Local_647.f_0=2;
Local_647.f_1=0;
}}}
break;
...
Local_647.f_4=0;
Local_647.f_1=1;
}elseif(fVar0==-1f || func_395(Local_647.f_2, PLAYER::PLAYER_PED_ID(), fVar0, 1)){
...
Local_647.f_1=2;
}elseif(Local_293.f_352 >=(Local_293.f_353 - 1) && func_388(Local_647.f_2, uParam0->f_5, 1,5f, 1)){
Local_647.f_1=2;
...
Var0={
func_344(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - uParam0->f_1) 
};
Var3={
func_344(uParam0->f_5 - uParam0->f_1) 
};
...
Local_215.f_9=2;
Local_215.f_1=3;
}elseif((func_435(Local_286.f_0, 0, 70f, 170f, 1, 0, 0, 0) || !func_388(Local_286.f_0, Local_1108, 1,5f, 1)) || PED::IS_PED_RAGDOLL(Local_286.f_0)){
...
Vector3 func__428(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar6;
Var0={
func_344(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var3={
func_344(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
if(bParam4){
return 0;
}elseif(func_424(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
float fVar6;
Var0={
func_344(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
}elseif(PED::IS_PED_IN_ANY_VEHICLE(uParam0->f_2, false)){
bVar24=fVar23 <=(2,5f + fVar25);
}elseif(TASK::IS_PED_RUNNING(uParam0->f_2)){
bVar24=fVar23 <=(0,8f + fVar25);
}elseif(PED::IS_PED_IN_COVER(uParam0->f_2, false)){
...
Var4={
func_476(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
