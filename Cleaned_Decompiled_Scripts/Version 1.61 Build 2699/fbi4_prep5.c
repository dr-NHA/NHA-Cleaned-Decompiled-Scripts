...
return 1;
}elseif(func_138(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_185(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_186() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_204(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_156(iVar5))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_214(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_213()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_156(iVar6 + 1))){
...
}elseif(Global_113386.f_2363.f_539.f_2403[1]==-99){
func_246(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
}elseif(Global_113386.f_2363.f_539.f_2403[2]==-99){
...
func_246(sLocal_80[1], sLocal_80[0], sLocal_80[2]);
}elseif(Global_113386.f_2363.f_539.f_2403[0]==-99){
func_246(sLocal_80[0], sLocal_80[1], sLocal_80[2]);
}elseif(Global_113386.f_2363.f_539.f_2403[2]==-99){
func_246(sLocal_80[2], sLocal_80[1], sLocal_80[0]);
}
...
Global_78130[1 /*14*/]={
func_295(iParam0, iParam1, iParam2, -1) 
};
