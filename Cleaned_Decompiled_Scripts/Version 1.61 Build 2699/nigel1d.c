...
func_533("GS_WAIT_FOR_PLAYER, player threatened Glen;
attacking...");
...
func_12();
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 11f, 11f, 11f, false, true, 0)){
...
func_533("GS_WAIT_FOR_PLAYER, player got too close to Glen (alert_dis);
attacking...");
func_267();
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_782.f_1, Local_455.f_0, PED::GET_PED_BONE_INDEX(Local_455.f_0, 28422), 0,06f, 0,04f, 0f, -90f, 180f, 0f, false, false, false, false, 2, true, 0);
iLocal_170=3;
...
func_533("GS_PLAYER_IN_OUTFIT, player threatened Glen or returned a second time;
attacking...");
func_267();
}else{
...
case 2:
if(func_275(Local_455.f_0, 1, 1116471296, 1126825984, 0, 0, 0, 0)){
func_533("GS_ANGRY_AT_PLAYER, player threatened Glen;
attacking...");
func_267();
}
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455.f_0, 11f, 11f, 11f, false, true, 0)){
...
if(!MISC::IS_BIT_SET(Global_113386.f_18574.f_382, 4)){
...
func_510("Attack player, security guard:
", iVar0);
}
iVar0++;
}
...
float fVar6;
Var0={
func_284(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_284(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_640[iParam0 /*13*/], true), 15f, true)){
...
}}elseif(func_275(Local_640[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || ENTITY::IS_ENTITY_AT_ENTITY(Local_455.f_0, Local_640[iParam0 /*13*/], 30f, 30f, 30f, false, true, 0)){
func_299(Local_640[iParam0 /*13*/], 0);
iLocal_678[iParam0]=3;
}}}
break;
...
if(func_321()){
func_533("Monitor_Security, player has 'mucked about' with the celeb scene;
attacking...");
...
func_533("SS_GUARD_AREA, player threatened Celeb security;
attacking...");
func_267();
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0);
func_533("SS_GUARD_AREA, player tried sniping Celeb security but was spotted;
attacking...");
func_267();
...
func_533("SS_GUARD_AREA, player aimed Sniper Rifle when security could see them;
attacking...");
func_267();
...
func_533("SS_GUARD_AREA, player armed, not wearing outfit, guard has LOS or player within 18m;
attacking...");
func_267();
}}
}
elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, false, true, 0)){
if(iLocal_349==0){
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
func_533("SS_GUARD_AREA, non-outfit, player came back to area after being warned;
attacking");
func_267();
}}}
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 18f, 18f, 18f, false, true, 0)){
...
func_533("SS_GUARD_AREA, outfit, player came back to area after being warned;
attacking");
func_267();
}}
}}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 50f, 50f, 50f, false, true, 0)){
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0)){
func_533("SS_GUARD_AREA, player 50m away from group in non-buggy vehicle;
attacking");
func_267();
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, false, true, 0)){
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0)){
func_533("SS_GUARD_AREA, player went too fast too close to security;
attacking");
func_267();
}}
...
func_510("'You can't drive through here buddy said by ped id:
", iParam0);
if(func_6(Local_481[iParam0 /*13*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_481[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
}
...
func_533("SS_GO_TO_PLAYER, player armed, guard has LOS;
attacking...");
func_267();
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, false, true, 0) && iLocal_351==1){
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
if(func_277(Local_481[iParam0 /*13*/], 1126825984)){
if(func_265(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 1) < 80f){
func_533("SS_WARN_PLAYER, player armed, guard has LOS;
attacking...");
func_267();
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
func_533("SS_WARN_PLAYER, player in vehicle going too fast within 9m of guard;
attacking...");
func_267();
}
}}
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0)){
func_533("SS_WARN_PLAYER, outfit worn, player came back to area after being warned;
attacking");
func_267();
}}}}
break;
...
func_533("SS_AIM_AT_PLAYER, player armed, guard has LOS;
attacking...");
if(iLocal_357==0){
func_267();
}
...
func_510("Attack player, FORCE security guard:
", iParam0);
}}}}else{
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
func_533("SS_AIM_AT_PLAYER, player in vehicle above acceptable speed, within 20m;
attacking...");
func_267();
}
}}
...
iLocal_351=1;
iLocal_667[iParam0]=0;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0)){
...
}}elseif(!func_314(Local_481[iParam0 /*13*/], 242628503)){
TASK::OPEN_SEQUENCE_TASK(&iLocal_775);
TASK::TASK_PAUSE(0, MISC::GET_RANDOM_INT_IN_RANGE(5, 200));
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(iLocal_775);
...
iLocal_351=0;
if(func_275(Local_481[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::HAS_PED_RECEIVED_EVENT(Local_481[iParam0 /*13*/], 61)){
func_533("SS_STANDDOWN, player threatened Glen OR guard thought he'd get run over;
attacking...");
func_267();
}elseif(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_481[iParam0 /*13*/])){
if(func_273()){
...
func_296(&uLocal_174, 7, Local_481[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
func_272(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 0, 0);
func_533("SS_STANDDOWN, player aiming Sniper Rifle, guard has LOS;
attacking...");
func_267();
}}}
break;
...
func_510("Alerted, security guard:
", iVar0);
}
iLocal_667[iVar0]=3;
iVar0++;
...
func_533("HAS_PLAYER_MUCKED_ABOUT():
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_347(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_749.f_0, PLAYER::PLAYER_PED_ID(), true)){
func_510("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_749.f_0));
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_749.f_0);
}}else{
func_533("Celeb dead - returning true");
...
iLocal_671[iVar0]=4;
func_510("This Ambient Golfer is now dead:
", iVar0);
func_375(iVar0);
}}
if(func_514(Local_561[iVar0 /*13*/])){
...
func_533("AS_PLAYGOLF, bullet in area of ambient golfer (no vehicle);
alerted...");
func_318();
iLocal_671[iParam0]=1;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_561[iParam0 /*13*/], 20f, 20f, 20f, false, true, 0)){
...
func_270(iParam0);
func_533("AS_PLAYGOLF, player threatened ambient golfer;
attacking...");
func_318();
iLocal_671[iParam0]=1;
}
...
Local_399={
ENTITY::GET_ENTITY_COORDS(Local_561[iParam0 /*13*/], true) 
};
...
func_270(iParam0);
func_533("AS_PLAYGOLF, player armed and ambient golfer has LOS;
attacking...");
func_318();
iLocal_671[iParam0]=1;
...
func_510("This ambient golfer nearly got run over and is now attacking player:
", iParam0);
PED::SET_PED_CAN_BE_TARGETTED(Local_561[iParam0 /*13*/], true);
TASK::TASK_COMBAT_PED(Local_561[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 0, 16);
func_374();
iLocal_671[iParam0]=1;
}}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_561[iParam0 /*13*/], true), 50f, true)){
func_299(Local_561[iParam0 /*13*/], 1);
func_375(iParam0);
if(!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_306(Local_561[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
}
func_533("AS_PLAYGOLF, bullet in area of ambient golfer (in vehicle);
attacking...");
func_318();
iLocal_671[iParam0]=1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_561[iParam0 /*13*/]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_561[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), true)){
...
func_533("AS_ALERTED, player threatened ambient golfer and was armed;
attacking...");
func_318();
func_270(iParam0);
iLocal_671[iParam0]=3;
...
func_510("Making this Ambient Golfer flee from dead ped:
", iVar0);
func_270(iVar0);
}}}
iVar0++;
...
}}elseif(!CAM::IS_CAM_ACTIVE(iLocal_341)){
...
}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_402[iParam0 /*13*/], true), 30f, true)){
if(!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203)==0){
if(!func_14()){
if(iParam0==0){
func_296(&uLocal_174, 7, Local_402[iParam0 /*13*/], "CONCIERGE", 0, 1);
...
return func_438(2, 2);
}elseif(func_437(Global_1853185)){
...
Vector3 func__438(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_440(Var18, -Var0.f_3.f_2) 
};
Var18={
func_440(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__440(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_458(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
if(func_514(Local_455.f_0)){
Local_782.f_3={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(Local_455.f_0, true), 1,2f, 1,5f) 
};
}
...
Var4={
func_487(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
