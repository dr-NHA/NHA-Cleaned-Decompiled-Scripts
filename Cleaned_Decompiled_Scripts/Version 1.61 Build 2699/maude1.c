...
if(func_17(iLocal_158)){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_158, false) 
};
if(!func_246(0)){
...
float fVar6;
Var0={
func_252(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
float fVar6;
Var0={
func_252(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
return 1;
}elseif(func_399(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_422(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_423() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
}elseif((!func_433(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
iVar6=0;
while (iVar6 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_321(iVar6 + 1))){
