...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_64(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_64(iParam1))){
return 1;
}
return 0;
}
...
return func_310(2, 2);
}elseif(func_309(Global_1853185)){
...
Vector3 func__310(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_312(Var18, -Var0.f_3.f_2) 
};
Var18={
func_312(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
Vector3 func__312(struct<3> Param0, float fParam3){
struct<3> Var0;
float fVar3;
float fVar4;
...
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_330(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_362(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
elseif(func_382(&uLocal_268, sLocal_267, "SOL2_RGOA", 7, 0, 0, 0)){
iLocal_235=-1;
}}}elseif(!func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 365f, 1) && func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 480f, 1)){
if((MISC::GET_GAME_TIMER() - iLocal_235) > 5000){
if(func_382(&uLocal_268, sLocal_267, "SOL2_LOSE", 7, 0, 0, 0)){
iLocal_235=-1;
}}}elseif((!func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 260f, 1) && func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 365f, 1)) && func_384(PLAYER::PLAYER_PED_ID(), Local_237.f_0, 480f, 1)){
...
func_390(&(Local_244.f_6), Local_244.f_0, 0, 1);
iLocal_95=3;
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(Local_237.f_0, false)){
TASK::TASK_COMBAT_PED(Local_244.f_0, PLAYER::PLAYER_PED_ID(), 0, 16);
func_390(&(Local_244.f_6), Local_244.f_0, 0, 1);
iLocal_95=3;
}}
...
iLocal_221=1;
}}elseif(func_384(Local_244.f_0, PLAYER::PLAYER_PED_ID(), 20f, 1)){
...
iLocal_230=1;
}}elseif(!func_384(Local_237.f_0, PLAYER::PLAYER_PED_ID(), 145f, 1)){
...
}}}elseif(!func_409(iParam0, fParam3)){
func_407();
}
return *bParam1;
}
...
void func_478(){
Local_237={
func_479(-1032,97f, -544,14f, 35,3f, -103,17f, joaat("ig_roccopelosi")) 
};
Local_244={
func_479(-1031,72f, -543,42f, 35,26f, 110,43f, joaat("u_m_y_guido_01")) 
};
}
...
void func_480(){
Local_251={
func_481(-1041,64f, -545,08f, 34,81f, 116,57f, joaat("fugitive")) 
};
Local_257={
func_481(-1046,186f, -554,2908f, 33,4636f, 101,5845f, joaat("baller2")) 
};
}
