...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_83(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_83(iParam1))){
return 1;
}
return 0;
}
...
return func_279(2, 2);
}elseif(func_278(Global_1853185)){
...
Vector3 func__279(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var6;
Var6={
...
Var18={
func_281(Var18, -Var0.f_3.f_2) 
};
Var18={
func_281(Var18, Var6.f_3.f_2) 
};
*uParam2={
...
var func__299(int iParam0){
return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_300(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
Local_959[iVar0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, true) 
};
iLocal_687[iVar0]=1;
...
iLocal_715=1;
}elseif(!ENTITY::IS_ENTITY_DEAD(Local_499[iVar0 /*54*/][2 /*17*/].f_6, false)){
...
}}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, true), 2f, false)){
iLocal_624=0;
iLocal_628=1;
iLocal_716=0;
iLocal_716=0;
...
ENTITY::GET_ENTITY_COORDS(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, true) 
};
Local_499[iVar0 /*54*/].f_52=4;
}
...
}elseif(ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, false)){
...
}}elseif(func_328(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >=45f){
if(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4==0){
...
var func__336(int iParam0, int iParam1){
...
func_372(iVar0);
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), true)){
func_372(iVar0);
}}else{
Local_353[iVar0 /*29*/].f_13=15;
}
...
Var4={
ENTITY::GET_ENTITY_COORDS(Local_353[iVar0 /*29*/].f_12, true) 
};
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_353[iVar0 /*29*/].f_12, false)){
...
if(func_311(iLocal_734)){
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_734, true) 
};
...
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_353[iParam0 /*29*/].f_28, 5, false)){
Local_353[iParam0 /*29*/].f_22={
2,5f, -3f, 0f 
};
Local_353[iParam0 /*29*/].f_5=90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_353[iParam0 /*29*/].f_28, 4, false)){
Local_353[iParam0 /*29*/].f_22={
-2,5f, -3f, 0f 
};
Local_353[iParam0 /*29*/].f_5=-90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_353[iParam0 /*29*/].f_28, 0, false)){
Local_353[iParam0 /*29*/].f_22={
-2,5f, 3f, 0f 
};
Local_353[iParam0 /*29*/].f_5=-90f;
...
void func_390(){
Local_353[0 /*29*/]={
func_391(joaat("habanero"), 1155,058f, 3533,135f, 33,9186f, 34,9236f, joaat("a_m_y_hippy_01"), Local_794) 
};
Local_353[1 /*29*/]={
func_391(joaat("dubsta"), 1655,803f, 3492,451f, 35,5714f, 105,5303f, joaat("a_m_m_salton_01"), Local_797) 
};
Local_353[2 /*29*/]={
func_391(joaat("patriot"), 1516,076f, 3376,604f, 36,6333f, 359,8644f, joaat("a_m_m_hillbilly_01"), Local_797) 
};
Local_353[3 /*29*/]={
func_391(joaat("rebel"), 1140,058f, 3533,135f, 33,9186f, 269f, joaat("a_m_m_salton_01"), Local_794) 
};
Local_353[4 /*29*/]={
func_391(joaat("sadler"), 1508,076f, 3372,604f, 36,6333f, 359,8644f, joaat("a_m_y_hippy_01"), Local_797) 
};
}
...
bLocal_630=true;
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), Local_823, false, true, 0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_423(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
...
Vector3 func__436(struct<3> Param0){
float fVar0;
float fVar1;
...
}}elseif(func_311(iLocal_734) && func_311(PLAYER::PLAYER_PED_ID())){
...
if(func_412()){
iLocal_616=1;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_757, Local_760, 7f, false, true, 0) && func_375()){
if(func_488()){
func_383();
...
func_493(0);
iLocal_646[0]=1;
}}elseif(func_331(&uLocal_153, cLocal_739, "HUNT1_DISH", "HUNT1_DISH_1", 7, 0, 0)){
iLocal_616=0;
func_493(0);
iLocal_646[0]=1;
}}elseif(!func_226()){
...
iLocal_646[2]=1;
}elseif(iLocal_722 <=10 && func_374(&uLocal_153, cLocal_739, "HUNT1_TRY3", 7, 0, 0, 0)){
iLocal_646[2]=1;
}elseif(func_374(&uLocal_153, cLocal_739, "HUNT1_TYR4", 7, 0, 0, 0)){
iLocal_646[2]=1;
...
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, false);
iLocal_319=21;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_734, -875674219) !=1){
...
iLocal_659[7]=1;
}}elseif(VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))){
...
return 1;
}}elseif(((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_734, 30f)) && func_376(iLocal_734, PLAYER::PLAYER_PED_ID(), 1) <=2f){
return 1;
}}
return 0;
}
...
Var4={
func_501(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
