...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_49() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_49() /*5567*/].f_681.f_10, iParam0);
}
...
}elseif(PATHFIND::GET_SAFE_COORD_FOR_PED(Var8, false, &Var11, 14)){
...
return 0;
}}}elseif(iParam1==func_138(Global_100162) && iParam1 !=0){
Global_100162=0;
}}
return 1;
}
