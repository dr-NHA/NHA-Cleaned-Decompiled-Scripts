...
while (bVar1 <=(16 - 1)){
if(Local_24[bVar1] !=-1){
if((!MISC::IS_BIT_SET(uLocal_58, bVar1) && iVar0 >=Local_24[bVar1]) && iVar0 < Local_24.f_17[bVar1]){
func_5();
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_13(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
}
Global_78317=0;
}}
