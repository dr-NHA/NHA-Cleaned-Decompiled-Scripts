...
break;
case 2:
if(MISC::IS_BIT_SET(Local_93.f_1, 5)){
func_40(3);
}
func_38();
break;
...
if(MISC::IS_BIT_SET(Local_93.f_1, 1) || MISC::IS_BIT_SET(Local_93.f_1, 7)){
func_12(0);
func_40(2);
}}
...
return MISC::IS_BIT_SET(Global_1648034.f_241.f_136[func_25(10) /*33*/][bParam0], func_24(10));
}
...
while (iVar2 < iVar1){
if(func_42() < 2){
if(MISC::IS_BIT_SET(Local_104[iVar2 /*4*/].f_1, 1)){
func_39(PLAYER::INT_TO_PLAYERINDEX(iVar2));
MISC::SET_BIT(&(Local_93.f_1), true);
}
if(MISC::IS_BIT_SET(Local_104[iVar2 /*4*/].f_1, 4)){
func_39(func_11());
MISC::SET_BIT(&(Local_93.f_1), 7);
}
if(MISC::IS_BIT_SET(Local_104[iVar2 /*4*/].f_1, 0)){
MISC::SET_BIT(&(Local_93.f_1), false);
}
if(MISC::IS_BIT_SET(Local_104[iVar2 /*4*/].f_1, 2)){
MISC::SET_BIT(&(Local_93.f_1), 4);
}}elseif(func_42()==2){
if(MISC::IS_BIT_SET(Local_104[iVar2 /*4*/].f_1, 3)){
iVar0++;
}}
iVar2++;
}
...
}elseif(func_3(&(Local_93.f_6), 10000, 0)){
MISC::SET_BIT(&(Local_93.f_1), 5);
}}}
...
func_50(func_10());
if(Global_2815059.f_5195.f_4 !=func_10()){}else{
func_51(3);
}
...
if(bParam0 !=func_10() && func_9(bParam0, 1, 1)){
return MISC::IS_BIT_SET(Global_2689235[bParam0 /*453*/].f_318, 4);
}
return 0;
}
...
bVar0=true;
}}}elseif(func_102(func_32(PLAYER::PLAYER_ID()))==0 || func_102(func_32(PLAYER::PLAYER_ID()))==3){
bVar0=true;
}
if(bVar0){
if(bParam0){
...
Global_1888306={
Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_105 
};
}
return 1;
}}
...
if(((func_17(PLAYER::PLAYER_ID()) || (func_99() && func_98())) && !MISC::IS_BIT_SET(Global_2815059.f_4660, 31)) && !bParam4){
iVar1=func_97();
...
if((func_81(iParam1, bParam0, iVar0, 0) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)) || ((func_73(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(bParam0), 0) && MISC::IS_BIT_SET(Global_4718592.f_15, 23)) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18))){
return func_72(1);
...
break;
case 1:
if(!MISC::IS_BIT_SET(uLocal_91, 2)){
func_639();
}
...
break;
case 2:
if(!MISC::IS_BIT_SET(Local_104[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3)){
func_416(0, func_10());
func_372();
func_106();
}
...
Var0.f_19=-1;
if(!MISC::IS_BIT_SET(Local_104[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3)){
if((MISC::IS_BIT_SET(Local_93.f_1, 2) || MISC::IS_BIT_SET(Local_93.f_1, 4)) || MISC::IS_BIT_SET(Local_93.f_1, 4)){
...
if(MISC::IS_BIT_SET(Local_93.f_1, 7)){
func_107(151, 1, &Var0, 0);
}else{
func_107(151, MISC::IS_BIT_SET(Local_104[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 1), &Var0, 0);
}
MISC::SET_BIT(&(Local_104[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
}}
...
func_357();
}}elseif(func_358(PLAYER::PLAYER_ID()) > 0){
func_356();
}else{
func_357();
}}else{
...
}elseif(((func_184(iParam0) || iParam0==299) || iParam0==300) || iParam0==301){
...
var func__119(int iParam0, int iParam1, int iParam2){
Global_78130[1 /*14*/]={
func_120(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}}elseif(Global_262145.f_31771[iVar0] !=-1){
return 1;
}}
return 0;
}
...
return MISC::IS_BIT_SET(Global_1853348[bParam0 /*834*/].f_267.f_131, 14);
}
...
return MISC::IS_BIT_SET(Global_1853348[bParam0 /*834*/].f_267.f_30, 26);
}
...
Vector3 func__246(int iParam0, bool bParam1){
struct<3> Var0;
struct<3> Var3;
float fVar6;
struct<3> Var7;
...
var func__252(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7){
var uVar0;
...
return;
}elseif(iParam0==Global_1659759[func_127(-1)]){
return;
}}}
...
Vector3 func__277(bool bParam0){
...
}}elseif(func_285() || func_284(PLAYER::PLAYER_ID())){
...
}}elseif(iVar2 > Global_262145.f_12867){
...
return MISC::IS_BIT_SET(Global_1853348[iParam0 /*834*/].f_267.f_191[iVar0 /*13*/].f_5, iParam2);
}
return 0;
}
...
if((!MISC::IS_BIT_SET(Local_93.f_1, 2) && !MISC::IS_BIT_SET(Local_93.f_1, 4)) && !MISC::IS_BIT_SET(Local_93.f_1, 3)){
if(MISC::IS_BIT_SET(Local_93.f_1, 7)){
sVar1="GBTER_B_SSH";
if(Local_93.f_10){
sVar1="GBTER_B_SSH_A";
...
}}elseif(func_394() !=PLAYER::PLAYER_ID()){
...
}}}elseif(MISC::IS_BIT_SET(Local_93.f_1, 3)){}else{
sVar1="GBTER_BIG_FLEE";
if(func_6(PLAYER::PLAYER_ID(), 1)){
sVar1="GBTER_B_BFLEE";
}
func_374(88, sVar0, sVar1, 1, -1, 2, 1, 0);
if(MISC::IS_BIT_SET(Local_93.f_1, 4) || func_31(func_37(), 1, 0)){
...
return 0;
}}elseif(func_400() || unkIS_PROSPERO_VERSION()){
if(NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)){
if(NETWORK::NETWORK_CAN_VIEW_GAMER_USER_CONTENT(&Var0)){
return 0;
}}}}
...
iVar0=1;
}elseif(func_417(bParam1, PLAYER::PLAYER_ID())){
iVar0=1;
}}}
if(iParam0 || iVar0){
...
func_494(1);
if((!func_493() && !func_492()) || MISC::IS_BIT_SET(Global_2815059.f_4657, 1)){
if(func_491()){
func_490();
}else{
...
var func__425(var uParam0, int iParam1){
...
}elseif(func_435(uParam3)){
func_436("DPAD_FRIEND");
}elseif(func_434(uParam3)){
func_436("DPAD_CREW");
}else{
func_436("");
}
...
if(func_437(uParam2)){
func_436("DPAD_FRIEND");
}elseif(func_435(uParam2)){
func_436("DPAD_FRIEND");
}elseif(func_434(uParam2)){
func_436("DPAD_CREW");
}else{
func_436("");
}
...
var func__486(bool bParam0){
return func_487(&(Global_2689235[bParam0 /*453*/].f_434), 0);
}


var func__487(var uParam0, int iParam1){
...
int func_491(){
if(MISC::IS_BIT_SET(Global_2815059.f_4657, 0) && func_406()){
return 1;
}
if(MISC::IS_BIT_SET(Global_2815059.f_4657, 1) && func_406()){
return 1;
}
return 0;
}
...
if(MISC::IS_STRING_NULL_OR_EMPTY(sParam2)){
func_436(sParam1);
}elseif(func_446(PLAYER::PLAYER_ID())==133){
...
if(func_534()){
return 0;
}elseif(!func_531(PLAYER::PLAYER_ID(), 1, 0) && Global_1573860[0 /*4*/] > 0){
return 0;
}
...
bool bVar4;
iVar0=2;
bVar1=((func_448(bParam0) && !func_477(bParam0)) && !MISC::IS_BIT_SET(Global_1892703[bParam0 /*599*/].f_1, 8));
bVar2=func_205(bParam0);
uVar3=func_26();
bVar4=func_365();
if((bVar1 && (func_445(bParam0) || func_553(bParam0))) || bVar4){
iVar0=0;
}elseif(uVar3 || ((!bVar2 && !func_35(bParam0)) && !func_552(bParam0))){
iVar0=2;
}else{
iVar0=3;
}
...
float fVar0;
float fVar1;
if((((func_448(PLAYER::PLAYER_ID()) && !func_477(PLAYER::PLAYER_ID())) && !MISC::IS_BIT_SET(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_1, 8)) && (func_445(PLAYER::PLAYER_ID()) || func_553(PLAYER::PLAYER_ID()))) || func_598(Param1)){
return;
}
Global_1943920={
Param1 
...
*uParam4=0;
if(func_592(iParam0)){
if(MISC::IS_BIT_SET(Global_1943920.f_3, 0)){
...
if(MISC::IS_BIT_SET(Global_2689235[Global_2703735.f_1571.f_703.f_16 /*453*/].f_416, 0) && func_568()){
iParam0=23;
}}
...
void func_601(){
if(!MISC::IS_BIT_SET(uLocal_91, 3)){
...
}elseif(HUD::DOES_BLIP_EXIST(Global_2678393[bVar0])){
...
if(MISC::IS_BIT_SET(Global_2678393.f_386, iVar0) || MISC::IS_BIT_SET(Global_2678393.f_385, iVar0)){
return 1;
}elseif((MISC::IS_BIT_SET(Global_2678393.f_371, iVar0) || MISC::IS_BIT_SET(Global_2678393.f_370, iVar0)) || MISC::IS_BIT_SET(Global_2678393.f_388, iVar0)){
return func_610(10);
}else{
switch (iVar1){
case 253:
...
elseif(func_608(Global_2703735, bParam0, 1)){
return func_610(6);
}
else{
return func_610(5);
...
if(iVar0 > -1 && iVar0 < 4){
return MISC::IS_BIT_SET(Global_4718592.f_658[iVar0 /*22957*/].f_12180, 4);
}
return 0;
}
...
if(PLAYER::PLAYER_ID() !=func_63()){
if(MISC::IS_BIT_SET(uLocal_91, 0)){
if(!func_406()){
sVar0="GBTER_START";
if(func_6(PLAYER::PLAYER_ID(), 1)){
sVar0="GBTER_BSTART";
...
}}elseif(MISC::IS_BIT_SET(uLocal_91, 0)){
if(!func_406()){
sVar3="GBTER_BOSS";
if(func_6(PLAYER::PLAYER_ID(), 1)){
sVar3="GBTER_BBOSS";
...
if((MISC::IS_BIT_SET(Global_2815059.f_4624, 1) || MISC::IS_BIT_SET(Global_2815059.f_4624, 4)) || MISC::IS_BIT_SET(Global_2815059.f_4624, 0)){
func_101(6);
}
func_650();
}
...
iVar1=iVar0;
if(iVar1 !=-1){
return MISC::IS_BIT_SET(Global_1892703[iVar1 /*599*/].f_1, 16);
}}}
return 0;
}
...
void func_650(){
if(MISC::IS_BIT_SET(Global_2815059.f_4624, 1)){
MISC::CLEAR_BIT(&(Global_2815059.f_4624), true);
}
if(MISC::IS_BIT_SET(Global_2815059.f_4624, 4)){
MISC::CLEAR_BIT(&(Global_2815059.f_4624), 4);
}
if(MISC::IS_BIT_SET(Global_2815059.f_4624, 6)){
...
if(!MISC::IS_BIT_SET(Global_1836844.f_1, 14) && !func_448(PLAYER::PLAYER_ID())){
func_582(0);
}}elseif(func_703(PLAYER::PLAYER_ID()) !=-1){
func_658(-1);
}
func_702(func_10());
if(func_294(16)){
...
if(MISC::IS_BIT_SET(Global_1943920.f_3, 5)){
MISC::CLEAR_BIT(&(Global_1943920.f_3), 5);
}
iVar1=func_694();
if((func_481(iVar1) || iVar1==205) || iVar1==210){
func_693(-1);
}elseif(((iVar1==201 || iVar1==200) || iVar1==179) || func_202(iVar1)){
func_690(-1, 1);
}elseif(((((func_689(iVar1) || func_688(iVar1)) || func_687(iVar1)) || func_192(iVar1)) || func_191(iVar1)) || func_190(iVar1)){}else{
func_690(-1, 1);
}
func_368(19);
func_368(20);
...
if(MISC::IS_BIT_SET(Global_1943920.f_3, 6)){
MISC::ENABLE_DISPATCH_SERVICE(3, true);
MISC::ENABLE_DISPATCH_SERVICE(5, true);
MISC::CLEAR_BIT(&(Global_1943920.f_3), 6);
}
if(MISC::IS_BIT_SET(Global_1943920.f_3, 7)){
MISC::CLEAR_BIT(&(Global_1943920.f_3), 7);
}
if(MISC::IS_BIT_SET(Global_1943920.f_3, 8)){
...
if(bParam1){
if(!MISC::IS_BIT_SET(Global_1943920.f_3, 9)){
AUDIO::START_AUDIO_SCENE(func_675(iParam0));
MISC::SET_BIT(&(Global_1943920.f_3), 9);
}}elseif(MISC::IS_BIT_SET(Global_1943920.f_3, 9)){
...
Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_151[iParam0 /*3*/]={
func_697() 
};
}
if(!func_696(Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_126[iParam0 /*3*/], func_697(), 0)){
Global_1892703[PLAYER::PLAYER_ID() /*599*/].f_10.f_126[iParam0 /*3*/]={
func_697() 
};
}}
...
}elseif(func_724(iParam0, bParam2)){
...
}}elseif(Global_262145.f_32954 && !func_171(34721, -1)){
...
}elseif(func_193(func_703(PLAYER::PLAYER_ID()))){
func_736();
...
func_780(7);
}elseif(((((((((((((((((func_741(0) || func_741(1)) || func_741(2)) || func_741(8)) || func_741(9)) || func_741(10)) || func_741(11)) || func_741(12)) || func_741(13)) || func_741(14)) || func_741(15)) || func_741(16)) || func_741(17)) || func_741(18)) || func_741(19)) || func_741(20)) || func_741(21)) || func_741(22)){
func_780(8);
func_780(0);
func_780(1);
func_780(2);
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_14[iVar0], iVar1);
}
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_35[iVar0], iVar1);
}
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_33[iVar0], iVar1);
}
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_31[iVar0], iVar1);
}
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_26[iVar0], iVar1);
}
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_21[iVar0], iVar1);
}
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(Global_2815059.f_5195.f_19[iVar0], iVar1);
}
