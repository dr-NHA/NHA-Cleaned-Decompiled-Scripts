...
return (func_26(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
}}
return iParam0->f_1;
}
...
iLocal_161=1;
iLocal_328=1;
}elseif(func_25(&iLocal_144) >=10f && !iLocal_162){
iLocal_162=1;
iLocal_328=1;
}}
break;
...
if(bParam1){
return MISC::IS_BIT_SET(Global_32338[iVar0 /*23*/].f_11, 15);
}
return MISC::IS_BIT_SET(Global_32338[iVar0 /*23*/].f_11, 0);
}
