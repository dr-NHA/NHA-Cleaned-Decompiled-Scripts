...
}elseif(ENTITY::IS_ENTITY_DEAD(Local_42[iVar0 /*47*/], false)){
...
return 5;
}elseif(iParam0 >=Global_262145.f_27041){
return 4;
}elseif(iParam0 >=Global_262145.f_27040){
return 3;
}elseif(iParam0 >=Global_262145.f_27039){
return 2;
}
return 1;
}
