...
Local_63.f_10={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false) + Vector(0f, 5f, 0f) 
};
Local_63.f_7={
...
Local_63.f_20=7;
}elseif(!PED::IS_PED_IN_VEHICLE(NETWORK::NET_TO_PED(Local_63.f_3), NETWORK::NET_TO_VEH(Local_63.f_2), false)){
Local_63.f_20=7;
}}
if(!func_4(Local_63.f_3) && func_72(Local_63.f_2)){
if(Local_63.f_20 !=1){
...
Local_63.f_20=7;
}elseif(!MISC::IS_BIT_SET(Local_63.f_0, 7) && ENTITY::IS_ENTITY_AT_ENTITY(NETWORK::NET_TO_PED(Local_63.f_3), PLAYER::PLAYER_PED_ID(), 10f, 10f, 10f, false, true, 0)){
Local_63.f_20=3;
}
break;
case 4:
...
}elseif(!MISC::IS_BIT_SET(Local_63.f_0, 7) && ENTITY::IS_ENTITY_AT_COORD(NETWORK::NET_TO_PED(Local_63.f_3), Local_63.f_7, 10f, 10f, 10f, false, true, 0)){
Local_63.f_20=5;
}
break;
case 5:
