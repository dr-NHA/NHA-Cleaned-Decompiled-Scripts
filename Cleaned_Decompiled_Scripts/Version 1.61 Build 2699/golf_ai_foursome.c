...
Var0={
ENTITY::GET_ENTITY_COORDS(func_250(uParam1), false) 
};
Var3={
...
Var30={
FtoV(func_8(Local_234, Var27)) * Var27 
};
Var24={
FtoV(-(1f + fVar21)) * Var30 + Local_234 
};
Var33={
Local_234 - Var30 
};
...
Var2={
ENTITY::GET_ENTITY_COORDS(func_299(uParam0), true) 
};
if(bParam3){
Var2={
...
return 1;
}}}elseif(TASK::GET_SCRIPT_TASK_STATUS(func_64(uParam0), 242628503) !=1 && TASK::GET_SCRIPT_TASK_STATUS(func_64(uParam0), 242628503) !=0){
return 1;
}
return 0;
}
...
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), (func_116(uParam0) + fVar3), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_270(uParam0) /*34*/])))) * ((func_165(uParam0, 1) * fVar4) / 100f)), 0f, 0f) 
};
}elseif(func_35(uParam0) !=3){
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), func_116(uParam0), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_270(uParam0) /*34*/])))) * (func_165(uParam0, 1) / 100f)), 0f, 0f) 
};
}else{
Var0={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_19(uParam0), func_116(uParam0), Vector(-uParam0->f_1.f_1, -uParam0->f_1.f_1, -uParam0->f_1.f_1) * Vector(0f, 0f, (func_165(uParam0, 1) / 100f))) 
};
}
...
Var1={
OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_278(uParam0), func_117(uParam0), func_229(iVar0)) 
};
Var4={
ENTITY::GET_ENTITY_COORDS(func_299(uParam0), true) 
};
...
func_228();
if(!MISC::IS_BIT_SET(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_267.f_30, 14) && !func_227()){
func_226();
}}
...
if(ENTITY::DOES_ENTITY_EXIST(func_250(uParam1))){
Var0={
ENTITY::GET_ENTITY_COORDS(func_250(uParam1), true) 
};
}}
...
if(iVar12 && bParam3){
func_277(uParam0, 2);
}}elseif((SYSTEM::VDIST2(func_265(uParam0, iParam1), func_41(uParam2, func_313(uParam0))) < 1600f && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_274(uParam0, iParam1), true), func_41(uParam2, func_313(uParam0))) < 1600f) && !func_298(uParam0, iParam1, 67108864)){
func_20(uParam0, uParam2, func_272(uParam0, iParam1), 1, 38306, 7438);
if(bParam3){
func_277(uParam0, 2);
}}elseif(PED::IS_PED_IN_ANY_VEHICLE(func_284(uParam0, iParam1), false)){
...
Var1={
ENTITY::GET_ENTITY_COORDS(func_251(&(uParam1->f_15[iParam2 /*34*/])), false) 
};
if(SYSTEM::VDIST2(Var1, func_41(uParam0, func_313(uParam1))) > (55f * 55f)){
return 0;
}
