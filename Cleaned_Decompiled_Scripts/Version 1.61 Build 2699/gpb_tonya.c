...
Var76={
ENTITY::GET_ENTITY_COORDS(iLocal_240, true) 
};
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_248)){
func_79(&iLocal_248);
}
if(!bLocal_439){
...
if(func_77(iParam0)){
return MISC::IS_BIT_SET(Global_113386.f_26434.f_2, iParam0);
}
return 0;
}
...
iVar0=iParam0;
if(iVar0 >=0 && iVar0 <=31){
return MISC::IS_BIT_SET(Global_113386.f_26434.f_2, iVar0);
}
return 0;
}
...
int func_106(){
if(MISC::IS_BIT_SET(Global_113386.f_18574[58 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113386.f_18574[58 /*6*/], 3)){
return 1;
}
return 0;
}
...
int func_111(){
if(MISC::IS_BIT_SET(Global_113386.f_18574[60 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113386.f_18574[60 /*6*/], 3)){
return 0;
}
if(MISC::IS_BIT_SET(Global_113386.f_18574[61 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113386.f_18574[61 /*6*/], 3)){
return 0;
}
if(MISC::IS_BIT_SET(Global_113386.f_18574[62 /*6*/], 3)){
return 0;
}
if((MISC::IS_BIT_SET(Global_113386.f_18574[58 /*6*/], 2) || MISC::IS_BIT_SET(Global_113386.f_18574[59 /*6*/], 2)) || MISC::IS_BIT_SET(Global_113386.f_18574[62 /*6*/], 2)){
return 1;
}
return 0;
}
