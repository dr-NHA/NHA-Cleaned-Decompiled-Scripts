...
if(MISC::IS_BIT_SET(Global_113386.f_10049.f_108, func_31(func_32(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
...
if(iLocal_386==2){
func_2(3);
}}}elseif(func_48(iLocal_409) && func_48(PLAYER::PLAYER_PED_ID())){
...
}}elseif(HUD::DOES_BLIP_EXIST(iLocal_390)){
HUD::REMOVE_BLIP(&iLocal_390);
}}else{
if(func_61()){
if(!func_25(42)){
