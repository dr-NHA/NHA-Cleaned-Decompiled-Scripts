...
if(func_4()){
func_57();
}}elseif(func_3(2, Global_20234, 0) || MISC::IS_BIT_SET(Global_8137, 12)){
...
func_44();
func_43();
}elseif(Global_113386.f_14141[iLocal_58 /*104*/].f_30==1){
func_22();
Global_7451=144;
if(Global_20266.f_1 > 3){
Global_20266.f_1=10;
...
}elseif(func_17(Global_7451, Global_20266)==0){
...
Var0={
Global_113386.f_14141[iLocal_58 /*104*/] 
};
...
}elseif(func_55(PLAYER::PLAYER_ID())==14){
...
}elseif(func_54(PLAYER::PLAYER_ID())==30){
...
}elseif(func_54(PLAYER::PLAYER_ID())==32){
...
}elseif(func_52(PLAYER::PLAYER_ID())==11){
