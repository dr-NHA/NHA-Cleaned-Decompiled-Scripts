...
if(MISC::IS_BIT_SET(Global_100441.f_20, 17)){
return 0;
}
...
func_246();
iLocal_548=2;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_156, PLAYER::PLAYER_PED_ID(), bParam0) && iLocal_519 < 4){
func_246();
iLocal_548=1;
}}
if(iLocal_548==1){
...
float fVar6;
Var0={
func_259(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_277(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
while (iVar0 < 3){
Local_526[iVar0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], true) 
};
iVar0++;
}}
...
func_298(3);
return 1;
}elseif(!ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], Local_82, 5f, 5f, 100f, false, true, 0)){
...
float fVar6;
Var0={
func_259(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) 
};
...
Var4={
func_408(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
