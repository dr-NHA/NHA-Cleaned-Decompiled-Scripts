...
if(MISC::IS_BIT_SET(Global_2815059.f_2290.f_18, 1)){
func_129(41, 1);
}}
...
case joaat("component_specialcarbine_clip_03"):
return 0;
default:}}elseif(func_72(iParam0)){
...
return MISC::IS_BIT_SET(uVar0, func_78(iVar1));
}
...
var func__81(int iParam0, int iParam1, int iParam2){
var uVar0;
...
return 1;
}elseif(Global_113386.f_1988[1 /*121*/][iVar0 /*10*/].f_8==3){
return 1;
}elseif(Global_113386.f_1988[2 /*121*/][iVar0 /*10*/].f_8==3){
return 1;
}
iVar0++;
}
...
return 1;
}elseif(Global_113386.f_19147[1 /*271*/].f_3[iVar0 /*12*/].f_3==3){
return 1;
}elseif(Global_113386.f_19147[2 /*271*/].f_3[iVar0 /*12*/].f_3==3){
return 1;
}
iVar0++;
}
...
bVar0=false;
while (bVar0 < 4){
if(MISC::IS_BIT_SET(Global_113386.f_24976.f_1, bVar0)){
return 1;
}
bVar0++;
}
...
bVar0=false;
while (bVar0 < 5){
if(MISC::IS_BIT_SET(Global_113386.f_24979.f_2, bVar0)){
return 1;
}
bVar0++;
}
...
return 1;
}}elseif(iParam1 >=Global_63379[iParam0 /*13*/].f_2){
return 1;
}
return 0;
}
...
switch (iParam1){
case 1:
return !MISC::IS_BIT_SET(Global_91229[iParam0 /*34*/].f_15, 5);
break;
case 7:
...
iVar0=0;
iVar1=func_160(2);
if(func_159(iVar1, 0) || MISC::IS_BIT_SET(Global_96292, 2)){
iVar0++;
}
iVar1=func_160(1);
if(func_159(iVar1, 0) || MISC::IS_BIT_SET(Global_96292, 1)){
iVar0++;
}
iVar1=func_160(0);
if(func_159(iVar1, 0) || MISC::IS_BIT_SET(Global_96292, 0)){
iVar0++;
}
return iVar0;
}
