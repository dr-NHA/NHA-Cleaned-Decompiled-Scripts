...
}}elseif(!func_82(1, 1, -1,3389f, 544,1759f, 172,7673f, -1f)){
func_8(&iLocal_30, 1, -1,3389f, 544,1759f, 172,7673f, 124,3018f, 1, 1);
}}
if(!iLocal_28){
...
return 1;
}elseif(func_30(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_77(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_78() && unkIS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
Vector3 func__94(struct<3> Param0){
float fVar0;
float fVar1;
...
Var67={
func_126(iVar81, 2, uParam1->f_59, -1) 
};
...
Var67={
func_126(iVar81, 1, uParam1->f_62, -1) 
};
