...
}}elseif(MISC::IS_BIT_SET(Global_113386.f_20564.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_33() /*5567*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113386.f_20564.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_33() /*5567*/].f_681.f_10, iParam0);
}
...
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_615, true) 
};
...
}}}elseif(func_297(iLocal_579, iLocal_615, 1) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_615, 2, false)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_579, 242628503) !=1 || TASK::GET_SEQUENCE_PROGRESS(iLocal_579) > 0){
TASK::OPEN_SEQUENCE_TASK(&iVar0);
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_615, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
...
iLocal_332=1;
}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_615, false)){
AUDIO::TRIGGER_MUSIC_EVENT("EPS8_ESCAPE");
func_95();
}elseif(iLocal_332==0){
...
return 1;
}}elseif(Global_78130[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_163(iParam1)) && Global_78130[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_163(iParam1))){
return 1;
}
return 0;
}
...
elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, false)){
if(iLocal_270==0){
...
iLocal_258++;
iLocal_295++;
}}elseif(!func_64(iLocal_580[iLocal_256], PLAYER::PLAYER_PED_ID(), fLocal_144, 1)){
if(HUD::DOES_BLIP_EXIST(iLocal_911[iLocal_256])){
...
}elseif(func_93(iLocal_580[iLocal_256])){
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_580[iLocal_256], 780511057) !=1){
TASK::TASK_COMBAT_PED(iLocal_580[iLocal_256], PLAYER::PLAYER_PED_ID(), 0, 16);
}}}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_616[iLocal_256], false)){
...
iLocal_258++;
iLocal_295++;
}}elseif(!func_64(iLocal_588[iLocal_256], PLAYER::PLAYER_PED_ID(), fLocal_144, 1)){
if(HUD::DOES_BLIP_EXIST(iLocal_919[iLocal_256])){
...
iLocal_299=-1;
iLocal_374=0;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[iLocal_299], -1273030092) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[iLocal_299], -1273030092) !=0){
...
iLocal_258++;
iLocal_295++;
}}elseif(!func_64(iLocal_570[iLocal_256], PLAYER::PLAYER_PED_ID(), fLocal_145, 1)){
...
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_597[0])){
...
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_597[1])){
...
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_597[2])){
...
iLocal_336=1;
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_597[3])){
...
iLocal_387=4;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_570[5], 713668775) !=0){
...
if(iLocal_298==0){
Local_218={
ENTITY::GET_ENTITY_COORDS(iLocal_632, true) 
};
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_596, 1435919172)==1){
...
}}}}}elseif(iLocal_336==0 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, false)){
Var8={
func_308() 
};
...
}}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_596, 713668775) !=1){
...
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_580[0], -345,6437f, -85,66679f, 53,65821f, -378,4535f, -73,82299f, 43,15821f, 18,25f, false, true, 0)){
...
func_310();
}}elseif(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_616[0])){
...
}elseif(ENTITY::GET_ENTITY_SPEED(iLocal_616[0]) > fLocal_252){
...
struct<6> Var6;
if(func_19(iLocal_632)){
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(iLocal_632, true);
}
if(func_19(iLocal_616[0])){
if(iLocal_339==0){
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(iLocal_616[0], true);
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(iLocal_616[2], true);
}
if(func_19(iLocal_616[3])){
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(iLocal_616[3], true);
}
if(func_93(iLocal_580[0])){
...
}}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_633, true)){
if(iLocal_297==0){
iLocal_312=1;
}}}
iLocal_334=1;
...
}}elseif(!func_64(PLAYER::PLAYER_PED_ID(), iLocal_580[3], 30f, 1)){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_616[3])){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_580[3], iLocal_616[3], "Eps8LS01", 786468, 18, 8, -1, 40f, false, 2f);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_580[3], -1273030092) !=1){
...
iLocal_387=0;
iLocal_568=6;
}}}}elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -351,6279f, -76,40219f, 41,77763f, -361,8925f, -104,8718f, 48,97791f, fLocal_152, false, true, 0)){
iLocal_311=1;
}}
...
iLocal_382=1;
}}elseif(ENTITY::IS_ENTITY_AT_COORD(iLocal_632, Local_158, 2f, 2f, 2f, false, true, 0)){
func_26(&iLocal_935);
...
}elseif((Global_1575058 && iParam0==PLAYER::PLAYER_ID()) && func_332(iParam0, 1, 0)){
return Global_2689235[iParam0 /*453*/].f_318.f_6 !=-1;
}}
return 0;
}
...
}}}}elseif(func_18(iLocal_634[iLocal_910])){
...
}}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_634[iLocal_910])){
func_20(&(iLocal_642[iLocal_910]));
func_17(&(iLocal_634[iLocal_910]));
}}}
...
}}}elseif(func_18(iLocal_680[iLocal_910])){
...
}}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_680[iLocal_910])){
func_20(&(iLocal_688[iLocal_910]));
func_17(&(iLocal_680[iLocal_910]));
}}}
...
}}}elseif(func_18(iLocal_726[iLocal_910])){
...
}}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_726[iLocal_910])){
func_20(&(iLocal_734[iLocal_910]));
func_17(&(iLocal_726[iLocal_910]));
}}}
...
}}}elseif(func_18(iLocal_772[iLocal_910])){
...
}}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_772[iLocal_910])){
func_20(&(iLocal_780[iLocal_910]));
func_17(&(iLocal_772[iLocal_910]));
}}}
...
}}}elseif(func_18(iLocal_818[iLocal_910])){
...
}}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_818[iLocal_910])){
func_20(&(iLocal_826[iLocal_910]));
func_17(&(iLocal_818[iLocal_910]));
}}}
...
}}}elseif(func_18(iLocal_864[iLocal_910])){
...
}}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_864[iLocal_910])){
func_20(&(iLocal_872[iLocal_910]));
func_17(&(iLocal_864[iLocal_910]));
}}}
iLocal_910++;
...
if(!MISC::IS_BIT_SET(Global_113386.f_18574.f_382, 1)){
...
Var4={
func_465(Global_78574, Global_78576, iParam10) 
};
if(fVar7==-0,014f){
}
